...
class grid_rotacion_inventario_resumo
{
   ...
   var $array_total_f_fechaven;
   var $array_total_d_idpro;
   var $array_total_vendido;
   var $array_total_existencia;
   var $array_total_rotacion;
   ...
   var $sum_f_fechaven_existencia;
   var $sum_f_fechaven_vendido;
   var $sc_proc_quebra_d_idpro;
   var $count_d_idpro;
   var $sum_d_idpro_existencia;
   var $sum_d_idpro_vendido;
   var $sc_proc_quebra_vendido;
   var $count_vendido;
   var $sum_vendido_existencia;
   var $sum_vendido_vendido;
   var $sc_proc_quebra_existencia;
   var $count_existencia;
   var $sum_existencia_existencia;
   var $sum_existencia_vendido;
   var $sc_proc_quebra_rotacion;
   var $count_rotacion;
   var $sum_rotacion_existencia;
   var $sum_rotacion_vendido;
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['arr_total'][$cmp_gb];
          }
      }
      else
      {
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_f_fechaven = "f.fechaven";
          $Lab_d_idpro = "d.idpro";
          $Lab_vendido = "vendido";
          $Lab_existencia = "existencia";
          $Lab_rotacion = "rotacion";
          $Lab_g_nomgrupo = "g.nomgrupo";
       }
       else
       {
       $Lab_f_fechaven = "Fecha";
       $Lab_d_idpro = "Producto";
       $Lab_vendido = "Vendido";
       $Lab_existencia = "Existencia";
       $Lab_rotacion = "Rotacion";
       ...
       $prep_field = array();
       $prep_field['f_fechaven'] = $Lab_f_fechaven;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['f_fechaven'] = $Lab_f_fechaven; 
       $prep_field['d_idpro'] = $Lab_d_idpro;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['d_idpro'] = $Lab_d_idpro; 
       $prep_field['vendido'] = $Lab_vendido;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['vendido'] = $Lab_vendido; 
       $prep_field['existencia'] = $Lab_existencia;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['existencia'] = $Lab_existencia; 
       $prep_field['rotacion'] = $Lab_rotacion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['rotacion'] = $Lab_rotacion; 
       $prep_field['g_nomgrupo'] = $Lab_g_nomgrupo;
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['f_fechaven']['alin'] = "''";
       $Arr_parms['f_fechaven']['link'] = "S";
       $Arr_parms['d_idpro']['alin'] = "''";
       $Arr_parms['d_idpro']['link'] = "S";
       $Arr_parms['vendido']['alin'] = "''";
       $Arr_parms['vendido']['link'] = "S";
       $Arr_parms['existencia']['alin'] = "''";
       $Arr_parms['existencia']['link'] = "S";
       $Arr_parms['rotacion']['alin'] = "''";
       $Arr_parms['rotacion']['link'] = "S";
       $Arr_parms['g_nomgrupo']['alin'] = "''";
       $Arr_parms['g_nomgrupo']['link'] = "S";
       $Arr_parms['f_fechaven']['fill'] = "true";
       $Arr_parms['f_fechaven']['order'] = "value";
       $Arr_parms['f_fechaven']['order_start'] = 'asc';
       $Arr_parms['f_fechaven']['order_invert'] = 'false';
       $Arr_parms['f_fechaven']['order_enabled'] = 'false';
       $Arr_parms['d_idpro']['fill'] = "true";
       $Arr_parms['d_idpro']['order'] = "label";
       $Arr_parms['d_idpro']['order_start'] = 'asc';
       $Arr_parms['d_idpro']['order_invert'] = 'false';
       $Arr_parms['d_idpro']['order_enabled'] = 'false';
       $Arr_parms['vendido']['fill'] = "true";
       $Arr_parms['vendido']['order'] = "label";
       $Arr_parms['vendido']['order_start'] = 'asc';
       $Arr_parms['vendido']['order_invert'] = 'false';
       $Arr_parms['vendido']['order_enabled'] = 'false';
       ...
       $Arr_parms['rotacion']['fill'] = "true";
       $Arr_parms['rotacion']['order'] = "label";
       $Arr_parms['rotacion']['order_start'] = 'asc';
       $Arr_parms['rotacion']['order_invert'] = 'false';
       $Arr_parms['rotacion']['order_enabled'] = 'false';
       $Arr_parms['g_nomgrupo']['fill'] = "true";
       $Arr_parms['g_nomgrupo']['order'] = "label";
       $Arr_parms['g_nomgrupo']['order_start'] = 'asc';
       $Arr_parms['g_nomgrupo']['order_invert'] = 'false';
       $Arr_parms['g_nomgrupo']['order_enabled'] = 'false';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['f_fechaven'] = array(0 => 'f_fechaven', 1 => '@aspass@');
       $prep_links_fl['d_idpro'] = array(0 => 'd_idpro', 1 => '');
       $prep_links_fl['vendido'] = array(0 => 'vendido', 1 => '');
       $prep_links_fl['existencia'] = array(0 => 'existencia', 1 => '');
       $prep_links_fl['rotacion'] = array(0 => 'rotacion', 1 => '');
       $prep_links_fl['g_nomgrupo'] = array(0 => 'g_nomgrupo', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_level'] = 0;
       }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_f_fechaven)),
           ...
           '1' => array(
               ...
               'field_x'  => 'd_idpro',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_d_idpro)),
               'label_y'  => $this->getChartText(strip_tags("Vendido(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           '1' => array(
               ...
               'field_x'  => 'vendido',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_vendido)),
               'label_y'  => $this->getChartText(strip_tags("Vendido(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           '1' => array(
               ...
               'field_x'  => 'rotacion',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_rotacion)),
               'label_y'  => $this->getChartText(strip_tags("Vendido(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      $this->array_total_f_fechaven = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['arr_total']['f_fechaven'];
      $this->array_total_d_idpro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['arr_total']['d_idpro'];
      $this->array_total_vendido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['arr_total']['vendido'];
      $this->array_total_existencia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['arr_total']['existencia'];
      $this->array_total_rotacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['arr_total']['rotacion'];
...
{ 
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_rotacion_inventario/grid_rotacion_inventario_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_existencia, $sum_vendido, $quebra_f_fechaven, $quebra_d_idpro, $quebra_vendido, $quebra_existencia, $quebra_rotacion, $quebra_g_nomgrupo, $quebra_f_fechaven_orig, $quebra_d_idpro_orig, $quebra_vendido_orig, $quebra_existencia_orig, $quebra_rotacion_orig, $quebra_g_nomgrupo_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
   ...
   function compat_arrays()
   {
      ...
      {
          $Arr_gb[]   = $cmp_gb;
          $Arr_name[] = "_SESSION['sc_session'][" . $this->Ini->sc_page . "]['grid_rotacion_inventario']['arr_total']['" .$cmp_gb . "']" . $Control;
      ...
      for ($ix = 0; $ix < sizeof($Arr_gb); $ix++)
      {
          ...
          $Str_gb .= "{";
          $Str_gb .=     "\$this->" . $Arr_tot[$ix] . "[\$campo_" . $Arr_gb[$ix] . "][2] = \$dados_" . $Arr_gb[$ix] . "[1];";
          $Str_gb .=     "\$this->" . $Arr_tot[$ix] . "[\$campo_" . $Arr_gb[$ix] . "][1] = \$dados_" . $Arr_gb[$ix] . "[2];";
      }
      for ($ix = 0; $ix < sizeof($Arr_gb); $ix++)
      {
          $Str_gb .= "}";
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->f_fechaven_orig = $this->f_fechaven;
            $this->d_idpro_orig = $this->d_idpro;
            $this->vendido_orig = $this->vendido;
            $this->existencia_orig = $this->existencia;
            $this->rotacion_orig = $this->rotacion;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->existencia, $this->vendido, $this->f_fechaven, $this->d_idpro, $this->vendido, $this->existencia, $this->rotacion, $this->g_nomgrupo, $this->f_fechaven_orig,  $this->d_idpro_orig,  $this->vendido_orig,  $this->existencia_orig,  $this->rotacion_orig,  $this->g_nomgrupo_orig);
            }
   }
//
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['order_grid'] = $nmgp_order_by;
      ...
      while (!$this->rs_grid->EOF) 
      {
         ...
         $this->GB_d_idpro = $this->d_idpro;
         $this->Lookup->lookup_sc_free_group_by_d_idpro($this->GB_d_idpro, $this->d_idpro);
         $this->GB_existencia = $this->existencia;
         nmgp_Form_Num_Val($this->GB_existencia, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         $this->GB_rotacion = $this->rotacion;
         nmgp_Form_Num_Val($this->GB_rotacion, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->existencia)), NM_encode_input(sc_strip_script($this->vendido)), NM_encode_input(sc_strip_script($this->f_fechaven)), NM_encode_input(sc_strip_script($this->GB_d_idpro)), NM_encode_input(sc_strip_script($this->vendido)), NM_encode_input(sc_strip_script($this->GB_existencia)), NM_encode_input(sc_strip_script($this->GB_rotacion)), sc_strip_script($this->g_nomgrupo), NM_encode_input(sc_strip_script($f_fechaven_orig)), NM_encode_input(sc_strip_script($d_idpro_orig)), NM_encode_input(sc_strip_script($vendido_orig)), NM_encode_input(sc_strip_script($existencia_orig)), NM_encode_input(sc_strip_script($rotacion_orig)), sc_strip_script($g_nomgrupo_orig));
