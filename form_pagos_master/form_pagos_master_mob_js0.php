<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="id_pago" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_pago']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagos_master_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_pagos_master_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagos_master_mob']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_form_pagos_master_mob_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_pagos_master_mob_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
...
function lookup_pagado_a(campo)
{
   dados  = document.F1.pagado_a.value;
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_pagos_master_mob')?>/form_pagos_master_mob.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_pagado_a, "pagado_a", dados, false);
}
function recebe_pagado_a(string)
{
   document.getElementById('id_lookup_pagado_a').innerHTML = string;
}
<?php 
...
{
    document.getElementById('form_pagos_master_mob_form0').style.width='1px';
    document.getElementById('form_pagos_master_mob_form0').style.height='0px';
    document.getElementById('form_pagos_master_mob_form0').style.display='none';
    document.getElementById('form_pagos_master_mob_form0').style.overflow='scroll';
    document.getElementById('form_pagos_master_mob_form1').style.width='1px';
    document.getElementById('form_pagos_master_mob_form1').style.height='0px';
    document.getElementById('form_pagos_master_mob_form1').style.display='none';
    document.getElementById('form_pagos_master_mob_form1').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_pagos_master_mob']['pdf_view']) {
?>
...
?>
   ...
   if ("form_pagos_master_mob_form1" == N_pagina) {
