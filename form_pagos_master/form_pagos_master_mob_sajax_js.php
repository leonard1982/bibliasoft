  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pagos_master_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pagos_master_mob_form();
	}
  ...
  // ---------- Validate prefijo
  function do_ajax_form_pagos_master_mob_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldSelect(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_master_mob_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_pagos_master_mob_validate_prefijo_cb);
  } // do_ajax_form_pagos_master_mob_validate_prefijo

  function do_ajax_form_pagos_master_mob_validate_prefijo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_master_mob_validate_prefijo_cb

  // ---------- Validate numero
  function do_ajax_form_pagos_master_mob_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_master_mob_validate_numero(var_numero, var_script_case_init, do_ajax_form_pagos_master_mob_validate_numero_cb);
  } // do_ajax_form_pagos_master_mob_validate_numero

  function do_ajax_form_pagos_master_mob_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_master_mob_validate_numero_cb

  // ---------- Validate fecha
  function do_ajax_form_pagos_master_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_master_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_pagos_master_mob_validate_fecha_cb);
  } // do_ajax_form_pagos_master_mob_validate_fecha

  function do_ajax_form_pagos_master_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_master_mob_validate_fecha_cb

  // ---------- Validate pagado_a
  function do_ajax_form_pagos_master_mob_validate_pagado_a()
  {
    var nomeCampo_pagado_a = "pagado_a";
    var var_pagado_a = scAjaxGetFieldText(nomeCampo_pagado_a);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_master_mob_validate_pagado_a(var_pagado_a, var_script_case_init, do_ajax_form_pagos_master_mob_validate_pagado_a_cb);
  } // do_ajax_form_pagos_master_mob_validate_pagado_a

  function do_ajax_form_pagos_master_mob_validate_pagado_a_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_master_mob_validate_pagado_a_cb

  // ---------- Validate pagador
  function do_ajax_form_pagos_master_mob_validate_pagador()
  {
    var nomeCampo_pagador = "pagador";
    var var_pagador = scAjaxGetFieldSelect(nomeCampo_pagador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_master_mob_validate_pagador(var_pagador, var_script_case_init, do_ajax_form_pagos_master_mob_validate_pagador_cb);
  } // do_ajax_form_pagos_master_mob_validate_pagador

  function do_ajax_form_pagos_master_mob_validate_pagador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pagador";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_master_mob_validate_pagador_cb

  // ---------- Validate concepto
  function do_ajax_form_pagos_master_mob_validate_concepto()
  {
    var nomeCampo_concepto = "concepto";
    var var_concepto = scAjaxGetFieldText(nomeCampo_concepto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_master_mob_validate_concepto(var_concepto, var_script_case_init, do_ajax_form_pagos_master_mob_validate_concepto_cb);
  } // do_ajax_form_pagos_master_mob_validate_concepto

  function do_ajax_form_pagos_master_mob_validate_concepto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_master_mob_validate_concepto_cb

  // ---------- Validate usuario
  function do_ajax_form_pagos_master_mob_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_master_mob_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_pagos_master_mob_validate_usuario_cb);
  } // do_ajax_form_pagos_master_mob_validate_usuario

  function do_ajax_form_pagos_master_mob_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_master_mob_validate_usuario_cb

  // ---------- Validate id_pago
  function do_ajax_form_pagos_master_mob_validate_id_pago()
  {
    var nomeCampo_id_pago = "id_pago";
    var var_id_pago = scAjaxGetFieldHidden(nomeCampo_id_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_master_mob_validate_id_pago(var_id_pago, var_script_case_init, do_ajax_form_pagos_master_mob_validate_id_pago_cb);
  } // do_ajax_form_pagos_master_mob_validate_id_pago

  function do_ajax_form_pagos_master_mob_validate_id_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_pago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_master_mob_validate_id_pago_cb

  // ---------- Validate total
  function do_ajax_form_pagos_master_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldHidden(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_master_mob_validate_total(var_total, var_script_case_init, do_ajax_form_pagos_master_mob_validate_total_cb);
  } // do_ajax_form_pagos_master_mob_validate_total

  function do_ajax_form_pagos_master_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_master_mob_validate_total_cb

  // ---------- Validate descuento
  function do_ajax_form_pagos_master_mob_validate_descuento()
  {
    var nomeCampo_descuento = "descuento";
    var var_descuento = scAjaxGetFieldHidden(nomeCampo_descuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_master_mob_validate_descuento(var_descuento, var_script_case_init, do_ajax_form_pagos_master_mob_validate_descuento_cb);
  } // do_ajax_form_pagos_master_mob_validate_descuento

  function do_ajax_form_pagos_master_mob_validate_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_master_mob_validate_descuento_cb

  // ---------- Validate neto
  function do_ajax_form_pagos_master_mob_validate_neto()
  {
    var nomeCampo_neto = "neto";
    var var_neto = scAjaxGetFieldHidden(nomeCampo_neto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_master_mob_validate_neto(var_neto, var_script_case_init, do_ajax_form_pagos_master_mob_validate_neto_cb);
  } // do_ajax_form_pagos_master_mob_validate_neto

  function do_ajax_form_pagos_master_mob_validate_neto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "neto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_master_mob_validate_neto_cb

  // ---------- Validate detalle
  function do_ajax_form_pagos_master_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_master_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_pagos_master_mob_validate_detalle_cb);
  } // do_ajax_form_pagos_master_mob_validate_detalle

  function do_ajax_form_pagos_master_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_master_mob_validate_detalle_cb

  // ---------- Event onchange prefijo
  function do_ajax_form_pagos_master_mob_event_prefijo_onchange()
  {
    var var_prefijo = scAjaxGetFieldSelect("prefijo");
    var var_numero = scAjaxGetFieldText("numero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pagos_master_mob_event_prefijo_onchange(var_prefijo, var_numero, var_script_case_init, do_ajax_form_pagos_master_mob_event_prefijo_onchange_cb);
  } // do_ajax_form_pagos_master_mob_event_prefijo_onchange

  function do_ajax_form_pagos_master_mob_event_prefijo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "prefijo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pagos_master_mob_event_prefijo_onchange_cb_after_alert);
  } // do_ajax_form_pagos_master_mob_event_prefijo_onchange_cb
  function do_ajax_form_pagos_master_mob_event_prefijo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pagos_master_mob_event_prefijo_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pagos_master_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pagos_master_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_prefijo = scAjaxGetFieldSelect("prefijo");
    ...
    scAjaxProcOn();
    x_ajax_form_pagos_master_mob_submit_form(var_prefijo, var_numero, var_fecha, var_pagado_a, var_pagador, var_concepto, var_usuario, var_id_pago, var_total, var_descuento, var_neto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pagos_master_mob_submit_form_cb);
  } // do_ajax_form_pagos_master_mob_submit_form

  function do_ajax_form_pagos_master_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pagos_master_mob_submit_form_cb_after_alert);
  } // do_ajax_form_pagos_master_mob_submit_form_cb
  function do_ajax_form_pagos_master_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pagos_master_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detallepagos_terceros_mob"] = "off";

  function do_ajax_form_pagos_master_mob_navigate_form()
  {
    perform_ajax_form_pagos_master_mob_navigate_form();
  }

  function perform_ajax_form_pagos_master_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_pagos_master_mob_navigate_form(var_id_pago, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pagos_master_mob_navigate_form_cb);
  } // do_ajax_form_pagos_master_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagos_master_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pagos_master_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pagos_master_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_pagos_master_mob_navigate_form_cb
  function do_ajax_form_pagos_master_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_pagos_master_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_pagos_master_mob_navigate_form_cb_after_alert
  function sc_hide_form_pagos_master_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_detallepagos_terceros_mob"])
    {
      return true;
    }
    return false;
