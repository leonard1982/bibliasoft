  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_envio_correo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate correo
  function do_ajax_envio_correo_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_envio_correo_validate_correo(var_correo, var_script_case_init, do_ajax_envio_correo_validate_correo_cb);
  } // do_ajax_envio_correo_validate_correo

  function do_ajax_envio_correo_validate_correo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_envio_correo_validate_correo_cb

  // ---------- Validate log
  function do_ajax_envio_correo_validate_log()
  {
    var nomeCampo_log = "log";
    var var_log = scAjaxGetFieldCheckbox(nomeCampo_log, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_envio_correo_validate_log(var_log, var_script_case_init, do_ajax_envio_correo_validate_log_cb);
  } // do_ajax_envio_correo_validate_log

  function do_ajax_envio_correo_validate_log_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "log";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_envio_correo_validate_log_cb

  // ---------- Validate mensaje
  function do_ajax_envio_correo_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldHidden(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_envio_correo_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_envio_correo_validate_mensaje_cb);
  } // do_ajax_envio_correo_validate_mensaje

  function do_ajax_envio_correo_validate_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_envio_correo_validate_mensaje_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_envio_correo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_envio_correo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_correo = scAjaxGetFieldText("correo");
    var var_log = scAjaxGetFieldCheckbox("log", ";");
    ...
    scAjaxProcOn();
    x_ajax_envio_correo_submit_form(var_correo, var_log, var_mensaje, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_envio_correo_submit_form_cb);
  } // do_ajax_envio_correo_submit_form

  function do_ajax_envio_correo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_envio_correo_submit_form_cb_after_alert);
  } // do_ajax_envio_correo_submit_form_cb
  function do_ajax_envio_correo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_envio_correo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_envio_correo_navigate_form()
  {
    perform_ajax_envio_correo_navigate_form();
  }

  function perform_ajax_envio_correo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_envio_correo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['envio_correo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_envio_correo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_envio_correo_navigate_form_cb_after_alert);
  } // do_ajax_envio_correo_navigate_form_cb
  function do_ajax_envio_correo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_envio_correo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_envio_correo_navigate_form_cb_after_alert
  function sc_hide_envio_correo_form()
  {
  ...
  var ajax_error_list = {
    ...
    "log": {"label": "Log", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mensaje": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
