...
$old_error_handler = set_error_handler("form_permisos_scriptcase_error_handler");

function form_permisos_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_permisos']['contr_erro']) && $_SESSION['scriptcase']['form_permisos']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            global $inicial_form_permisos;
            $inicial_form_permisos->contr_form_permisos->Apl_com_erro = true;
            if ($inicial_form_permisos->contr_form_permisos->NM_ajax_flag)
            {
                $inicial_form_permisos->contr_form_permisos->NM_ajax_info['errList']['geral_form_permisos'][] = $msg;
                return;
            }
            form_permisos_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_permisos_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_permisos'])  && '' != $_SESSION['scriptcase']['error_icon']['form_permisos'])  ? $_SESSION['scriptcase']['error_icon']['form_permisos']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_permisos']) && '' != $_SESSION['scriptcase']['error_span_title']['form_permisos']) ? $_SESSION['scriptcase']['error_span_title']['form_permisos'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_permisos']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_permisos']) ? $_SESSION['scriptcase']['error_icon_title']['form_permisos'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_permisos']['error_buffer'] .= ob_get_flush();
}
