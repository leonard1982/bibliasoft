...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "f.fechaven";$Nm_datas[] = "f_fechaven";$Nm_numeric[] = "f_subtotal";$Nm_numeric[] = "f_valoriva";$Nm_numeric[] = "f_total";$Nm_numeric[] = "(d_cantidad)";$Nm_numeric[] = "((d_cantidad*d_valorunit)-(d_cantidad*d_iva))";$Nm_numeric[] = "(d_cantidad*d_valorunit)";$Nm_numeric[] = "month(f_fechaven)";
