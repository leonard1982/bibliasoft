...
class grid_ventas_por_familia_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['summarizing_fields_order']['por_grupo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['summarizing_fields_order']['por_grupo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['summarizing_fields_order']['por_grupo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['summarizing_fields_display']['por_grupo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['summarizing_fields_display']['por_grupo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['summarizing_fields_display']['por_grupo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['summarizing_fields_display']['por_grupo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['summarizing_fields_display']['por_grupo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['summarizing_fields_display']['por_grupo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['summarizing_fields_display']['por_grupo'] as $i_sum => $d_sum)
           {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_por_grupo("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_base, $sum_f_valoriva, $sum_neto, $quebra_grupo, $quebra_grupo_orig)
   {
      //----- Grupo
      if (!isset($this->array_total_grupo[$quebra_grupo_orig]))
      {
         $this->array_total_grupo[$quebra_grupo_orig][0] = 1;
         $this->array_total_grupo[$quebra_grupo_orig][1] = $sum_base;
         $this->array_total_grupo[$quebra_grupo_orig][2] = $sum_f_valoriva;
         $this->array_total_grupo[$quebra_grupo_orig][3] = $sum_neto;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->base, $this->f_valoriva, $this->neto, $this->grupo, $this->grupo_orig);
            }
   }
//
