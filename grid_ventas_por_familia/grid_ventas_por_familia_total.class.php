...
class grid_ventas_por_familia_total
{
   ...
   function quebra_geral_por_grupo($res_limit=false)
   {
      ...
      if ($rt->fields[0] == 0)
      { 
          if (!isset($Contrl_Interat) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['where_pesq_filtro']) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['where_pesq_fast']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['interativ_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['interativ_search']))
          {
              $Contrl_Interat = 1;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['where_pesq']       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['where_sem_interativ'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['interativ_search'] = array();
              $this->quebra_geral_por_grupo();
          }
   ...
   function quebra_geral_asesor_grupo($res_limit=false)
   {
      ...
      { 
          if (!isset($Contrl_Interat) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['where_pesq_filtro']) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['where_pesq_fast']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['interativ_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['interativ_search']))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['where_pesq']       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['where_sem_interativ'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['interativ_search'] = array();
              $this->quebra_geral_asesor_grupo();
          }
