...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['contr_label_graf']['vendedor']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['contr_label_graf']['vendedor']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['contr_label_graf']['vendedor'];
      }
      $this->label[1] = "Grupo";
      ...
      {
         $this->label[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_familia']['contr_label_graf']['grupo'];
      }
   }
