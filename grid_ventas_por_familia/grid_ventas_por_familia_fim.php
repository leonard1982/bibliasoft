...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_ventas_por_familia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_ventas_por_familia"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ventas_por_familia']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ventas_por_familia']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ventas_por_familia']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ventas_por_familia']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ventas_por_familia']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ventas_por_familia</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ventas_por_familia']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ventas_por_familia']['embutida_filho'] as $ind => $sc_init)
          {
