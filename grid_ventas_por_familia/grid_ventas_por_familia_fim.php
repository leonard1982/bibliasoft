...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_ventas_por_familia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_ventas_por_familia"]);
   }
