...
<?php
   ...
   $Ord_Cmp = new grid_ventas_por_familia_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_ventas_por_familia_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["fecha"] : "Fecha";
   ...
   $tab_labels["factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["factura"] : "Factura";
   $tab_ger_campos['codgrupo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['codgrupo'] = "codgrupo";
   }
   else
   {
       $tab_def_campos['codgrupo'] = "g.codigogru";
   }
   $tab_labels["codgrupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["codgrupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["codgrupo"] : "CodGrupo";
   ...
   $tab_labels["grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["grupo"] : "Grupo";
   ...
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["cantidad"] : "Cantidad";
   ...
   $tab_labels["base"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["base"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["base"] : "Base";
   ...
   $tab_labels["f_valoriva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["f_valoriva"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["f_valoriva"] : "IVA";
   ...
   $tab_labels["neto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["neto"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["neto"] : "Neto";
   ...
   {
       $tab_def_campos['periodo'] = "month(f.fechaven)";
   }
   $tab_labels["periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["periodo"] : "Periodo";
   ...
   {
       $tab_def_campos['vendedor'] = "v.nombres";
   }
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['labels']["vendedor"] : "Vendedor";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_ventas_por_familia_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_ventas_por_familia']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
