...
class grid_cartera_090919_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cartera_090919_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cartera_090919_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cartera_090919_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_numfacven($numfacven)
   {
      ...
      {
          $nm_comando = "select distinct numfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE     numfacven!=0  AND  saldo>0 AND credito = 1 ORDER BY fechavenc ASC) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE     saldo>0 AND credito = 1 ORDER BY fechavenc ASC) ) nm_sel_esp where   CAST (numfacven AS TEXT)  like '%" . $numfacven . "%'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE     numfacven!=0  AND  saldo>0 AND credito = 1 ORDER BY fechavenc ASC) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE     saldo>0 AND credito = 1 ORDER BY fechavenc ASC) ) nm_sel_esp where   CAST (numfacven AS VARCHAR)  like '%" . $numfacven . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct numfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE     numfacven!=0  AND  saldo>0 AND credito = 1 ORDER BY fechavenc ASC) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE     saldo>0 AND credito = 1 ORDER BY fechavenc ASC) ) nm_sel_esp where  numfacven like '%" . $numfacven . "%'"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_nremision($nremision)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct nremision from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE     numfacven!=0  AND  saldo>0 AND credito = 1 ORDER BY fechavenc ASC) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE     saldo>0 AND credito = 1 ORDER BY fechavenc ASC) ) nm_sel_esp where   CAST (nremision AS TEXT)  like '%" . $nremision . "%'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct nremision from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE     numfacven!=0  AND  saldo>0 AND credito = 1 ORDER BY fechavenc ASC) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE     saldo>0 AND credito = 1 ORDER BY fechavenc ASC) ) nm_sel_esp where   CAST (nremision AS VARCHAR)  like '%" . $nremision . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct nremision from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE     numfacven!=0  AND  saldo>0 AND credito = 1 ORDER BY fechavenc ASC) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE     saldo>0 AND credito = 1 ORDER BY fechavenc ASC) ) nm_sel_esp where  nremision like '%" . $nremision . "%'"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fechaven";$Nm_datas[] = "fechaven";$Nm_datas[] = "fechavenc";$Nm_datas[] = "fechavenc";$Nm_numeric[] = "idfacven";$Nm_numeric[] = "numfacven";$Nm_numeric[] = "nremision";$Nm_numeric[] = "credito";$Nm_numeric[] = "idcli";$Nm_numeric[] = "subtotal";$Nm_numeric[] = "valoriva";$Nm_numeric[] = "total";$Nm_numeric[] = "asentada";$Nm_numeric[] = "saldo";$Nm_numeric[] = "adicional";$Nm_numeric[] = "adicional2";$Nm_numeric[] = "adicional3";$Nm_numeric[] = "resolucion";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cartera_090919/grid_cartera_090919_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cartera_090919_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cartera_090919_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_cartera_090919_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_cartera_090919']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_cartera_090919']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_numfacven_input_2#NMF#' + search_get_text('SC_numfacven_input_2') + '@NMF@';
  ...
  str_out += 'SC_nremision_input_2#NMF#' + search_get_text('SC_nremision_input_2') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>CARTERA</span></td>
...
<?php
   ...
   {
      global 
             $numfacven_cond, $numfacven, $numfacven_input_2, $numfacven_autocomp,
             $nremision_cond, $nremision, $nremision_input_2, $nremision_autocomp,
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $numfacven = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['numfacven']; 
          $numfacven_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['numfacven_input_2']; 
          $numfacven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['numfacven_cond']; 
          $nremision = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['nremision']; 
          $nremision_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['nremision_input_2']; 
          $nremision_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['nremision_cond']; 
          $credito = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['credito']; 
          $credito_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['credito_cond']; 
          $fechaven_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_dia']; 
          $fechaven_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_mes']; 
          $fechaven_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_ano']; 
          $fechaven_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_input_2_dia']; 
          $fechaven_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_input_2_mes']; 
          $fechaven_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_input_2_ano']; 
          $fechaven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_cond']; 
          $fechavenc_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_dia']; 
          $fechavenc_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_mes']; 
          $fechavenc_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_ano']; 
          $fechavenc_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_input_2_dia']; 
          $fechavenc_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_input_2_mes']; 
          $fechavenc_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_input_2_ano']; 
          $fechavenc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['NM_operador']; 
      } 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_numfacven_cond" name="numfacven_cond" onChange="nm_campos_between(document.getElementById('id_vis_numfacven'), this, 'numfacven')">
       <OPTION value="eq" <?php if ("eq" == $numfacven_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $numfacven_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_numfacven"  <?php echo $str_hide_numfacven?>><?php
      if ($numfacven != "")
      {
      $numfacven_look = substr($this->Db->qstr($numfacven), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE     numfacven!=0  AND  saldo>0 AND credito = 1 ORDER BY fechavenc ASC) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE     saldo>0 AND credito = 1 ORDER BY fechavenc ASC) ) nm_sel_esp where numfacven = $numfacven_look"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE     numfacven!=0  AND  saldo>0 AND credito = 1 ORDER BY fechavenc ASC) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE     saldo>0 AND credito = 1 ORDER BY fechavenc ASC) ) nm_sel_esp where numfacven = $numfacven_look"; 
...
?>
<INPUT  type="text" id="SC_numfacven" name="numfacven" value="<?php echo NM_encode_input($numfacven) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterSubmit: true}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numfacven" id="id_ac_numfacven" name="numfacven_autocomp"><?php if ('' !=  $numfacven) { ?><option value="<?php echo $numfacven ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_numfacven"  <?php echo $str_display_numfacven; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_numfacven_input_2" name="numfacven_input_2" value="<?php echo NM_encode_input($numfacven_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterSubmit: true}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectEven" alt="{autoTab: false, enterSubmit: true}" id="SC_nremision_cond" name="nremision_cond" onChange="nm_campos_between(document.getElementById('id_vis_nremision'), this, 'nremision')">
       <OPTION value="eq" <?php if ("eq" == $nremision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $nremision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_nremision"  <?php echo $str_hide_nremision?>><?php
      if ($nremision != "")
      {
      $nremision_look = substr($this->Db->qstr($nremision), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct nremision from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE     numfacven!=0  AND  saldo>0 AND credito = 1 ORDER BY fechavenc ASC) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE     saldo>0 AND credito = 1 ORDER BY fechavenc ASC) ) nm_sel_esp where nremision = $nremision_look"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct nremision from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE     numfacven!=0  AND  saldo>0 AND credito = 1 ORDER BY fechavenc ASC) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE     saldo>0 AND credito = 1 ORDER BY fechavenc ASC) ) nm_sel_esp where nremision = $nremision_look"; 
...
?>
<INPUT  type="text" id="SC_nremision" name="nremision" value="<?php echo NM_encode_input($nremision) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterSubmit: true}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-nremision" id="id_ac_nremision" name="nremision_autocomp"><?php if ('' !=  $nremision) { ?><option value="<?php echo $nremision ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_nremision"  <?php echo $str_display_nremision; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_nremision_input_2" name="nremision_input_2" value="<?php echo NM_encode_input($nremision_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterSubmit: true}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_credito_cond" name="credito_cond" onChange="nm_campos_between(document.getElementById('id_vis_credito'), this, 'credito')">
       <OPTION value="eq" <?php if ("eq" == $credito_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_credito"  <?php echo $str_hide_credito?>> 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['psq_check_ret']['credito'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['psq_check_ret']['credito'][] = "1";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['psq_check_ret']['credito'][] = "2";
 ?>

 <SELECT class="scFilterObjectOdd" id="SC_credito"  name="credito"  size="1">
 <OPTION value="1##@@SI"<?php if ($credito == "1") { echo " selected" ;} ?>>SI</option>
 <OPTION value="2##@@NO"<?php if ($credito == "2") { echo " selected" ;} ?>>NO</option>
 </SELECT>
 </TD>
    ...
    <TD nowrap class="scFilterLabelEven" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['fechaven'])) ? $this->New_label['fechaven'] : "Fecha Factura";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectEven" alt="{autoTab: false, enterSubmit: true}" id="SC_fechaven_cond" name="fechaven_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechaven'), this, 'fechaven')">
       <OPTION value="eq" <?php if ("eq" == $fechaven_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $fechaven_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $fechaven_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $fechaven_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_fechaven"  <?php echo $str_hide_fechaven?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechaven_dia" name="fechaven_dia" value="<?php echo NM_encode_input($fechaven_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechaven_mes" name="fechaven_mes" value="<?php echo NM_encode_input($fechaven_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechaven_ano" name="fechaven_ano" value="<?php echo NM_encode_input($fechaven_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterSubmit: true}">
 </span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechaven_input_2_dia" name="fechaven_input_2_dia" value="<?php echo NM_encode_input($fechaven_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechaven_input_2_mes" name="fechaven_input_2_mes" value="<?php echo NM_encode_input($fechaven_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechaven_input_2_ano" name="fechaven_input_2_ano" value="<?php echo NM_encode_input($fechaven_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterSubmit: true}">
 </span>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_fechavenc_cond" name="fechavenc_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechavenc'), this, 'fechavenc')">
      ...
      <br><span id="id_hide_fechavenc"  <?php echo $str_hide_fechavenc?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
  $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechavenc_dia" name="fechavenc_dia" value="<?php echo NM_encode_input($fechavenc_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechavenc_mes" name="fechavenc_mes" value="<?php echo NM_encode_input($fechavenc_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechavenc_ano" name="fechavenc_ano" value="<?php echo NM_encode_input($fechavenc_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterSubmit: true}">
 </span>
...
?>
        <SPAN id="id_css_fechavenc"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fechavenc"  <?php echo $str_display_fechavenc; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?> 
         <BR>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechavenc_input_2_dia" name="fechavenc_input_2_dia" value="<?php echo NM_encode_input($fechavenc_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechavenc_input_2_mes" name="fechavenc_input_2_mes" value="<?php echo NM_encode_input($fechavenc_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechavenc_input_2_ano" name="fechavenc_input_2_ano" value="<?php echo NM_encode_input($fechavenc_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterSubmit: true}">
 </span>
...
?>
<?php
   if (is_file("grid_cartera_090919_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cartera_090919']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cartera_090919']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.numfacven_cond.value = 'eq';
   ...
   document.F1.numfacven_input_2.value = "";
   document.F1.nremision_cond.value = 'eq';
   ...
   document.F1.nremision_input_2.value = "";
   ...
   document.F1.credito.value = "";
   document.F1.fechaven_cond.value = 'eq';
 ...
 {
    $('#SC_fechaven_dia').bind('change', function() {sc_grid_cartera_090919_valida_dia(this)});
    $('#SC_fechaven_input_2_dia').bind('change', function() {sc_grid_cartera_090919_valida_dia(this)});
    $('#SC_fechaven_input_2_mes').bind('change', function() {sc_grid_cartera_090919_valida_mes(this)});
    $('#SC_fechaven_mes').bind('change', function() {sc_grid_cartera_090919_valida_mes(this)});
    $('#SC_fechavenc_dia').bind('change', function() {sc_grid_cartera_090919_valida_dia(this)});
    $('#SC_fechavenc_input_2_dia').bind('change', function() {sc_grid_cartera_090919_valida_dia(this)});
    $('#SC_fechavenc_input_2_mes').bind('change', function() {sc_grid_cartera_090919_valida_mes(this)});
    $('#SC_fechavenc_mes').bind('change', function() {sc_grid_cartera_090919_valida_mes(this)});
 }
 function sc_grid_cartera_090919_valida_dia(obj)
 {
 ...
 function sc_grid_cartera_090919_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEB_V2/grid_cartera_090919";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "FACILWEB_V2/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
          $NM_patch .= "grid_cartera_090919/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   {
      global $numfacven_cond, $numfacven, $numfacven_input_2, $numfacven_autocomp,
             $nremision_cond, $nremision, $nremision_input_2, $nremision_autocomp,
             $credito_cond, $credito,
             $fechaven_cond, $fechaven, $fechaven_dia, $fechaven_mes, $fechaven_ano, $fechaven_input_2_dia, $fechaven_input_2_mes, $fechaven_input_2_ano,
             $fechavenc_cond, $fechavenc, $fechavenc_dia, $fechavenc_mes, $fechavenc_ano, $fechavenc_input_2_dia, $fechavenc_input_2_mes, $fechavenc_input_2_ano, $nmgp_tab_label;
      ...
      if ($numfacven_cond != "in")
      {
          nm_limpa_numero($numfacven_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      ...
      if ($nremision_cond != "in")
      {
          nm_limpa_numero($nremision_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $tmp_pos = strpos($credito, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $credito;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['psq_check_ret']['credito'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Crédito : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['numfacven'] = $numfacven; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['numfacven_input_2'] = $numfacven_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['numfacven_cond'] = $numfacven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['nremision'] = $nremision; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['nremision_input_2'] = $nremision_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['nremision_cond'] = $nremision_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['credito'] = $credito; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['credito_cond'] = $credito_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_dia'] = $fechaven_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_mes'] = $fechaven_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_ano'] = $fechaven_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_input_2_dia'] = $fechaven_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_input_2_mes'] = $fechaven_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_input_2_ano'] = $fechaven_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_cond'] = $fechaven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_dia'] = $fechavenc_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_mes'] = $fechavenc_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_ano'] = $fechavenc_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_input_2_dia'] = $fechavenc_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_input_2_mes'] = $fechavenc_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_input_2_ano'] = $fechavenc_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_cond'] = $fechavenc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca'] = $Temp_Busca;
      }
      if ($numfacven_cond != "in" && $numfacven_cond != "bw" && !empty($numfacven) && !is_numeric($numfacven))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Factura";
      }
   ...
   { 
      ...
      $Conteudo = $numfacven_input_2;
      if (strtoupper($numfacven_cond) != "II" && strtoupper($numfacven_cond) != "QP" && strtoupper($numfacven_cond) != "NP" && strtoupper($numfacven_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['numfacven_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($nremision != '') {
      $nremision_look = substr($this->Db->qstr($nremision), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      $Conteudo = $nremision_input_2;
      if (strtoupper($nremision_cond) != "II" && strtoupper($nremision_cond) != "QP" && strtoupper($nremision_cond) != "NP" && strtoupper($nremision_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['nremision_input_2'] = $Conteudo;
      $Conteudo = $credito;
      ...
      {
         $this->monta_condicao("numfacven", $numfacven_cond, $numfacven, $numfacven_input_2, "numfacven");
      }
      ...
      {
         $this->monta_condicao("nremision", $nremision_cond, $nremision, $nremision_input_2, "nremision");
      }
      ...
      if ($fechaven_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven'] = $val[0];
          ...
          if ($fechaven_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechaven_input_2'] = $val[1];
      ...
      if ($fechavenc_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc'] = $val[0];
          ...
          if ($fechavenc_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']['fechavenc_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['cond_pesq'] .= $this->NM_operador;
