...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['contr_label_graf']['fechavenc']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['contr_label_graf']['fechavenc']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['contr_label_graf']['fechavenc'];
      }
   }
