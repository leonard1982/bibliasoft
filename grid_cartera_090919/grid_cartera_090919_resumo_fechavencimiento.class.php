...
class grid_cartera_090919_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_fechavenc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['arr_total']['fechavenc'];
      }
      else
      {
          $this->array_total_fechavenc = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['arr_total']['fechavenc'] = $this->array_total_fechavenc;
   ...
   function completeMatrix()
   {
       ...
       {
       $Lab_fechavenc = "Fecha vencimiento";
       }
       $this->comp_field = array(
           $Lab_fechavenc,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['summarizing_fields_order']['fechavencimiento']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['summarizing_fields_order']['fechavencimiento'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['summarizing_fields_order']['fechavencimiento'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['summarizing_fields_display']['fechavencimiento'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['summarizing_fields_display']['fechavencimiento'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['summarizing_fields_display']['fechavencimiento'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['summarizing_fields_display']['fechavencimiento'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['summarizing_fields_display']['fechavencimiento'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['summarizing_fields_display']['fechavencimiento'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera_090919']['summarizing_fields_display']['fechavencimiento'] as $i_sum => $d_sum)
           {
