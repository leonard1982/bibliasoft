 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_numfacven_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['numfacven'])) ? $this->New_label['numfacven'] : "Factura"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="sc-js-input scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_numfacven_cond" name="numfacven_cond" onChange="nm_campos_between(document.getElementById('id_vis_numfacven'), this, 'numfacven')">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numfacven" id="id_ac_numfacven" name="numfacven_autocomp"><?php if ('' !=  $numfacven) { ?><option value="<?php echo $numfacven ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       ...
       <TR valign="top">
        <TD id="id_vis_numfacven"  <?php echo $str_display_numfacven; ?> class="scFilterFieldFontOdd">
         ...
         <BR>
         <INPUT type="text" id="SC_numfacven_input_2" name="numfacven_input_2" value="<?php echo NM_encode_input($numfacven_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterSubmit: true}" class="sc-js-input sc-js-input scFilterObjectOdd">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="sc-js-input scFilterObjectEven" alt="{autoTab: false, enterSubmit: true}" id="SC_nremision_cond" name="nremision_cond" onChange="nm_campos_between(document.getElementById('id_vis_nremision'), this, 'nremision')">
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-nremision" id="id_ac_nremision" name="nremision_autocomp"><?php if ('' !=  $nremision) { ?><option value="<?php echo $nremision ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       ...
       <TR valign="top">
        <TD id="id_vis_nremision"  <?php echo $str_display_nremision; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_nremision_input_2" name="nremision_input_2" value="<?php echo NM_encode_input($nremision_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterSubmit: true}" class="sc-js-input sc-js-input scFilterObjectEven">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="sc-js-input scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_credito_cond" name="credito_cond" onChange="nm_campos_between(document.getElementById('id_vis_credito'), this, 'credito')">
...
<?php
 ...
 <OPTION value="2##@@NO"<?php if ($credito == "2") { echo " selected" ;} ?>>NO</option>
      ...
      <TD id='SC_fechaven_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fechaven'])) ? $this->New_label['fechaven'] : "Fecha Factura"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="sc-js-input scFilterObjectEven" alt="{autoTab: false, enterSubmit: true}" id="SC_fechaven_cond" name="fechaven_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechaven'), this, 'fechaven')">
...
?>
      ...
      <TD id='SC_fechavenc_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fechavenc'])) ? $this->New_label['fechavenc'] : "Fecha vencimiento"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="sc-js-input scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_fechavenc_cond" name="fechavenc_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechavenc'), this, 'fechavenc')">
