...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_cloud_copias"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_cloud_copias"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_copias']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_cloud_copias']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_copias']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cloud_copias']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_copias']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cloud_copias']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cloud_copias']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_copias']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cloud_copias']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_cloud_copias' || $achou)
          {
