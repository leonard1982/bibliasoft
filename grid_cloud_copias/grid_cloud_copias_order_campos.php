...
<?php
   ...
   $Ord_Cmp = new grid_cloud_copias_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cloud_copias_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_copia'] = "id_copia";
   $tab_labels["id_copia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["id_copia"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["id_copia"] : "Id";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['nombre_archivo'] = "on";
   $tab_def_campos['nombre_archivo'] = "nombre_archivo";
   $tab_labels["nombre_archivo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["nombre_archivo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["nombre_archivo"] : "Nombre Archivo";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["descripcion"] : "Descargar";
   $tab_ger_campos['subida'] = "on";
   $tab_def_campos['subida'] = "subida";
   $tab_labels["subida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["subida"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["subida"] : "Nube";
   ...
   {
       $tab_def_campos['imagen'] = "";
   }
   $tab_labels["imagen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["imagen"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["imagen"] : "";
   $tab_ger_campos['borrar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['borrar'] = "borrar";
   }
   else
   {
       $tab_def_campos['borrar'] = "";
   }
   $tab_labels["borrar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["borrar"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['labels']["borrar"] : "";
   $tab_ger_campos['imagen'] = "none";
   $tab_ger_campos['borrar'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cloud_copias_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cloud_copias']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
