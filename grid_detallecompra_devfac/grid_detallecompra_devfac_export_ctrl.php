<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detallecompra_devfac']['sc_process_barr'] = true;
require_once('../grid_detallecompra_devfac/index.php');
unset($_SESSION['scriptcase']['grid_detallecompra_devfac']['sc_process_barr']);
$ExportCtrl = new grid_detallecompra_devfac_export_control;
$ExportCtrl->Export_barr();

class grid_detallecompra_devfac_export_control
{
