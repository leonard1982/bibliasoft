...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallecompra_devfac"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallecompra_devfac"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallecompra_devfac']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detallecompra_devfac']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallecompra_devfac']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detallecompra_devfac']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detallecompra_devfac']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detallecompra_devfac</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallecompra_devfac']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detallecompra_devfac']['embutida_filho'] as $ind => $sc_init)
          {
