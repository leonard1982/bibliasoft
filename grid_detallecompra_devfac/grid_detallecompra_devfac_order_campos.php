<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_detallecompra_devfac']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_detallecompra_devfac_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detallecompra_devfac_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['iddet'] = "on";
   $tab_def_campos['iddet'] = "iddet";
   $tab_labels["iddet"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["iddet"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["iddet"] : "";
   $tab_ger_campos['idpro'] = "on";
   $tab_def_campos['idpro'] = "idpro";
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["idpro"] : "Producto";
   $tab_ger_campos['colores'] = "on";
   $tab_def_campos['colores'] = "colores";
   $tab_labels["colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["colores"] : "Color";
   $tab_ger_campos['tallas'] = "on";
   $tab_def_campos['tallas'] = "tallas";
   $tab_labels["tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["tallas"] : "Talla";
   $tab_ger_campos['sabor'] = "on";
   $tab_def_campos['sabor'] = "sabor";
   $tab_labels["sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["sabor"] : "Sabor";
   $tab_ger_campos['vencimiento'] = "on";
   $tab_def_campos['vencimiento'] = "vencimiento";
   $tab_labels["vencimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["vencimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["vencimiento"] : "F. Venc.";
   $tab_ger_campos['lote'] = "on";
   $tab_def_campos['lote'] = "lote";
   $tab_labels["lote"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["lote"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["lote"] : "Lote";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['valorunit'] = "on";
   $tab_def_campos['valorunit'] = "valorunit";
   $tab_labels["valorunit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["valorunit"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["valorunit"] : "Costo unidad";
   $tab_ger_campos['porc_desc'] = "on";
   $tab_def_campos['porc_desc'] = "porc_desc";
   $tab_labels["porc_desc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["porc_desc"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["porc_desc"] : "% Desc. Un.";
   $tab_ger_campos['descuento'] = "on";
   $tab_def_campos['descuento'] = "descuento";
   $tab_labels["descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["descuento"] : "Desc. x Un.";
   $tab_ger_campos['valorpar'] = "on";
   $tab_def_campos['valorpar'] = "valorpar";
   $tab_labels["valorpar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["valorpar"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["valorpar"] : "Subtotal";
   $tab_ger_campos['iva'] = "on";
   $tab_def_campos['iva'] = "iva";
   $tab_labels["iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["iva"] : "IVA";
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['labels']["total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - detallecompra</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detallecompra_devfac_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detallecompra_devfac']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
