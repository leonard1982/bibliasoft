...
<?php
   ...
   $Ord_Cmp = new grid_detalleremision_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detalleremision_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["idpro"] : "Producto";
   $tab_ger_campos['colores'] = "on";
   $tab_def_campos['colores'] = "colores";
   $tab_labels["colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["colores"] : "Color";
   $tab_ger_campos['tallas'] = "on";
   $tab_def_campos['tallas'] = "tallas";
   $tab_labels["tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["tallas"] : "Talla";
   $tab_ger_campos['sabor'] = "on";
   $tab_def_campos['sabor'] = "sabor";
   $tab_labels["sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["sabor"] : "Sabor";
   $tab_ger_campos['idbod'] = "on";
   $tab_def_campos['idbod'] = "idbod";
   $tab_labels["idbod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["idbod"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["idbod"] : "Ubicación";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['valorunit'] = "on";
   $tab_def_campos['valorunit'] = "valorunit";
   $tab_labels["valorunit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["valorunit"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["valorunit"] : "Valor unit.";
   $tab_ger_campos['valorpar'] = "on";
   $tab_def_campos['valorpar'] = "valorpar";
   $tab_labels["valorpar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["valorpar"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["valorpar"] : "Valor parcial";
   $tab_ger_campos['iva'] = "on";
   $tab_def_campos['iva'] = "iva";
   $tab_labels["iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["iva"] : "IVA";
   $tab_ger_campos['descuento'] = "on";
   $tab_def_campos['descuento'] = "descuento";
   $tab_labels["descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["descuento"] : "Descuento";
   ...
   $tab_labels["unidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["unidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['labels']["unidad"] : "Unidad";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detalleremision_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detalleremision']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
