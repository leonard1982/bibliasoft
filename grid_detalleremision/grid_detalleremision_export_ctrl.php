<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalleremision']['sc_process_barr'] = true;
require_once('../grid_detalleremision/index.php');
unset($_SESSION['scriptcase']['grid_detalleremision']['sc_process_barr']);
$ExportCtrl = new grid_detalleremision_export_control;
$ExportCtrl->Export_barr();

class grid_detalleremision_export_control
{
