<?php
@session_start() ;
$_SESSION['scriptcase']['grid_venta_x_producto_dia']['sc_process_barr'] = true;
require_once('../grid_venta_x_producto_dia/index.php');
unset($_SESSION['scriptcase']['grid_venta_x_producto_dia']['sc_process_barr']);
$ExportCtrl = new grid_venta_x_producto_dia_export_control;
$ExportCtrl->Export_barr();

class grid_venta_x_producto_dia_export_control
{
