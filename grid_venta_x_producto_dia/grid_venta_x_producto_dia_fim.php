...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_venta_x_producto_dia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_venta_x_producto_dia"]);
   }
