...
class grid_venta_x_producto_dia_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_venta_x_producto_dia']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_venta_x_producto_dia']['campos_busca']))
      { 
