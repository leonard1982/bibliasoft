...
class grid_ventas_por_cliente_190422_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_ventas_por_cliente_190422_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_ventas_por_cliente_190422_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_ventas_por_cliente_190422_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_t_documento')
      {
          $t_documento = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_t_documento($t_documento);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_t_documento($t_documento)
   {
      $t_documento = substr($this->Db->qstr($t_documento), 1, -1);
            $t_documento_look = substr($this->Db->qstr($t_documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct t.documento from " . $this->Ini->nm_tabela . " where  t.documento like '%" . $t_documento . "%' order by t.documento"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_cliente($cliente)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct t.nombres from " . $this->Ini->nm_tabela . " where  t.nombres like '%" . $cliente . "%' order by t.nombres"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_ventas_por_cliente_190422/grid_ventas_por_cliente_190422_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_ventas_por_cliente_190422_ajax_search.js"></script>
 <script type="text/javascript" src="grid_ventas_por_cliente_190422_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_ventas_por_cliente_190422_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_ventas_por_cliente_190422']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_ventas_por_cliente_190422']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['ajax_nav'])
           { 
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_t_documento_cond#NMF#' + search_get_sel_txt('SC_t_documento_cond') + '@NMF@';
  str_out += 'SC_t_documento#NMF#' + search_get_text('SC_t_documento') + '@NMF@';
  str_out += 'id_ac_t_documento#NMF#' + search_get_title('select2-id_ac_t_documento-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-t_documento").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_t_documento",
      max_itens: "10",
   ...
   $("#SC_t_documento").val(e.params.data.id);
  });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $t_documento_cond, $t_documento, $t_documento_autocomp,
             $cliente_cond, $cliente, $cliente_autocomp,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_cliente_190422']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_cliente_190422']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_cliente_190422']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_ventas_por_cliente_190422", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_cond']; 
          $t_documento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['t_documento']; 
          $t_documento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['t_documento_cond']; 
          $cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['cliente']; 
          $cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['cliente_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['NM_operador']; 
      } 
      if (!isset($fecha_cond) || empty($fecha_cond))
      {
         $fecha_cond = "bw";
      }
      if (!isset($t_documento_cond) || empty($t_documento_cond))
      {
         $t_documento_cond = "qp";
      }
      ...
      $str_hide_t_documento = (in_array($t_documento_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_t_documento = ('bw' == $t_documento_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($t_documento) || $t_documento == "")
      {
          $t_documento = "";
      }
      if (isset($t_documento) && !empty($t_documento))
      {
...
?>
      ...
      <TD id='SC_t_documento_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['t_documento'])) ? $this->New_label['t_documento'] : "Documento"; ?></TD>
      
      <INPUT type="hidden" id="SC_t_documento_cond" name="t_documento_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_t_documento" <?php echo $str_hide_t_documento?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['t_documento'])) ? $this->New_label['t_documento'] : "Documento";
 $nmgp_tab_label .= "t_documento?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $t_documento_look = substr($this->Db->qstr($t_documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct t.documento from " . $this->Ini->nm_tabela . " where t.documento = '$t_documento_look' order by t.documento"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$t_documento]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$t_documento];
      }
      else
      {
          $sAutocompValue = $t_documento;
      }
?>
<INPUT  type="text" id="SC_t_documento" name="t_documento" value="<?php echo NM_encode_input($t_documento) ?>"  size=42 alt="{datatype: 'text', maxLength: 42, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-t_documento" id="id_ac_t_documento" name="t_documento_autocomp"><?php if ('' !=  $t_documento) { ?><option value="<?php echo $t_documento ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
      ...
      $cliente_look = substr($this->Db->qstr($cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct t.nombres from " . $this->Ini->nm_tabela . " where t.nombres = '$cliente_look' order by t.nombres"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<?php
   if (is_file("grid_ventas_por_cliente_190422_help.txt"))
   {
      $Arq_WebHelp = file("grid_ventas_por_cliente_190422_help.txt"); 
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['opc_psq'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['sc_modal'])
       {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.t_documento_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_t_documento'), document.F1.t_documento_cond, 't_documento');
   document.F1.t_documento.value = "";
   document.F1.t_documento_autocomp.value = "";
   $('#select2-id_ac_t_documento-container').html('<?php echo $this->Val_init_t_documento['desc'] ?>');;
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_ventas_por_cliente_190422_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_ventas_por_cliente_190422_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_ventas_por_cliente_190422_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_ventas_por_cliente_190422_valida_mes(this)});
 }
 function sc_grid_ventas_por_cliente_190422_valida_dia(obj)
 {
 ...
 function sc_grid_ventas_por_cliente_190422_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_t_documento_cond'] = 'cond';
      $tp_fields['SC_t_documento'] = 'text_aut';
      $tp_fields['id_ac_t_documento'] = 'select2_aut';
   ...
   function trata_campos()
   {
      ...
      if (!empty($t_documento_autocomp) && empty($t_documento))
      {
          $t_documento = $t_documento_autocomp;
      }
      ...
      $t_documento_cond_salva = $t_documento_cond; 
      if (!isset($t_documento_input_2) || $t_documento_input_2 == "")
      {
          $t_documento_input_2 = $t_documento;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['t_documento'] = $t_documento; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['t_documento_cond'] = $t_documento_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['cliente'] = $cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['cliente_cond'] = $cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($t_documento != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['t_documento'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['t_documento'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['t_documento'] = $t_documento;
      }
      $nmgp_def_dados = array();
    if ($cliente != '') {
      $cliente_look = substr($this->Db->qstr($cliente), 1, -1); 
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']['fecha_input_2'] = $val[1];
          ...
          {
              $this->monta_condicao("f.fechaven", $fecha_cond, $fecha, $fecha_input_2, 'fecha', 'DATE');
          }
      }

      //----- $t_documento
      $this->Date_part = false;
      if (isset($t_documento) || $t_documento_cond == "nu" || $t_documento_cond == "nn" || $t_documento_cond == "ep" || $t_documento_cond == "ne")
      {
         $this->monta_condicao("t.documento", $t_documento_cond, $t_documento, "", "t_documento");
      }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['fast_search']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['interativ_search'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['int_search_dados'] = array();
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_cliente_190422']['where_pesq'];
