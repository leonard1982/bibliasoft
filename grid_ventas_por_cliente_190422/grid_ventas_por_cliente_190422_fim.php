...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_ventas_por_cliente_190422"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_ventas_por_cliente_190422"]);
   }
