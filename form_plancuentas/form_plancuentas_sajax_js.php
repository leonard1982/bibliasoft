  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_plancuentas" == sTestField)
        {
...
?>
  ...
  // ---------- Validate codigo
  function do_ajax_form_plancuentas_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plancuentas_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_plancuentas_validate_codigo_cb);
  } // do_ajax_form_plancuentas_validate_codigo

  function do_ajax_form_plancuentas_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plancuentas_validate_codigo_cb

  // ---------- Validate nombre
  function do_ajax_form_plancuentas_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plancuentas_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_plancuentas_validate_nombre_cb);
  } // do_ajax_form_plancuentas_validate_nombre

  function do_ajax_form_plancuentas_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plancuentas_validate_nombre_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_plancuentas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_plancuentas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_plancuentas_submit_form(var_codigo, var_nombre, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_plancuentas_submit_form_cb);
  } // do_ajax_form_plancuentas_submit_form

  function do_ajax_form_plancuentas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_plancuentas']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_plancuentas']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_plancuentas']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_plancuentas_submit_form_cb_after_alert);
  } // do_ajax_form_plancuentas_submit_form_cb
  function do_ajax_form_plancuentas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_plancuentas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_plancuentas_navigate_form()
  {
    perform_ajax_form_plancuentas_navigate_form();
  }

  function perform_ajax_form_plancuentas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("codigo");
    scAjaxHideErrorDisplay("nombre");
    var var_id_plancuenta = document.F2.id_plancuenta.value;
    ...
    scAjaxProcOn();
    x_ajax_form_plancuentas_navigate_form(var_id_plancuenta, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_plancuentas_navigate_form_cb);
  } // do_ajax_form_plancuentas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_plancuentas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_plancuentas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_plancuenta.value = scAjaxGetKeyValue("id_plancuenta");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_plancuentas_navigate_form_cb_after_alert);
  } // do_ajax_form_plancuentas_navigate_form_cb
  function do_ajax_form_plancuentas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_plancuentas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_plancuentas_navigate_form_cb_after_alert
  function sc_hide_form_plancuentas_form()
  {
