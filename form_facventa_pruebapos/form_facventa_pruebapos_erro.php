...
$old_error_handler = set_error_handler("form_facventa_pruebapos_scriptcase_error_handler");

function form_facventa_pruebapos_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_facventa_pruebapos']['contr_erro']) && $_SESSION['scriptcase']['form_facventa_pruebapos']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            global $inicial_form_facventa_pruebapos;
            $inicial_form_facventa_pruebapos->contr_form_facventa_pruebapos->Apl_com_erro = true;
            if ($inicial_form_facventa_pruebapos->contr_form_facventa_pruebapos->NM_ajax_flag)
            {
                $inicial_form_facventa_pruebapos->contr_form_facventa_pruebapos->NM_ajax_info['errList']['geral_form_facventa_pruebapos'][] = $msg;
                return;
            }
            form_facventa_pruebapos_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_facventa_pruebapos_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_facventa_pruebapos'])  && '' != $_SESSION['scriptcase']['error_icon']['form_facventa_pruebapos'])  ? $_SESSION['scriptcase']['error_icon']['form_facventa_pruebapos']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_facventa_pruebapos']) && '' != $_SESSION['scriptcase']['error_close']['form_facventa_pruebapos']) ? $_SESSION['scriptcase']['error_close']['form_facventa_pruebapos'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_facventa_pruebapos']) && '' != $_SESSION['scriptcase']['error_span_title']['form_facventa_pruebapos']) ? $_SESSION['scriptcase']['error_span_title']['form_facventa_pruebapos'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_facventa_pruebapos']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_facventa_pruebapos']) ? $_SESSION['scriptcase']['error_icon_title']['form_facventa_pruebapos'] : '';
?>
