...
<?php
include_once("form_facventa_pruebapos_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_facventa_pruebapos_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['recarga'];
}
?>
...
<?php
 include_once("form_facventa_pruebapos_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_facventa_pruebapos'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_facventa_pruebapos'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
    ...
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['Vender'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "vender", "sc_btn_Vender()", "sc_btn_Vender()", "sc_Vender_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "pagar", "sc_btn_Pagar()", "sc_btn_Pagar()", "sc_Pagar_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['empty_filter'] = true;
       }
  }
  else
  {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['Lookup_idcli']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['Lookup_idcli'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['Lookup_idcli']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['Lookup_idcli'] = array(); 
}
...
ORDER BY documento, nombres";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['Lookup_idcli'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php $sStyleHidden_inicio_dumb = ('' == $sStyleHidden_inicio) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_inicio_dumb" style="<?php echo $sStyleHidden_inicio_dumb; ?>"></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['Lookup_pagada'][] = 'NO'; ?>
 <option value="SI" <?php  if ($this->pagada == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['Lookup_pagada'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<?php $sStyleHidden_fechavenc_dumb = ('' == $sStyleHidden_fechavenc) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fechavenc_dumb" style="<?php echo $sStyleHidden_fechavenc_dumb; ?>"></TD>
...
<?php
 ...
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_detalle']['embutida_pai']        = "form_facventa_pruebapos";
 ...
 if (isset($this->Ini->sc_lig_md5["grid_facturaven_pos_detalle"]) && $this->Ini->sc_lig_md5["grid_facturaven_pos_detalle"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_facventa_pruebapos@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_facventa_pruebapos_empty.htm' : $this->Ini->link_grid_facturaven_pos_detalle_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=400' . $parms_lig_cons;
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['masterValue'] as $cmp_master => $val_master)
{
?>
    parent.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
}
unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['masterValue']);
?>
}
<?php
}
...
?>
<script>
 parent.scAjaxDetailStatus("form_facventa_pruebapos");
 parent.scAjaxDetailHeight("form_facventa_pruebapos", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facventa_pruebapos']['sc_modal'])
{
?>
