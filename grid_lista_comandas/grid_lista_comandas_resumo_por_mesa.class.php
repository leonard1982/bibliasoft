...
$_SESSION['scriptcase']['grid_lista_comandas']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['arr_total']['cliente'];
      }
      else
      {
          $this->array_total_cliente = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['arr_total']['cliente'] = $this->array_total_cliente;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_order']['por_mesa']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_order']['por_mesa'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_order']['por_mesa'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_mesa'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_mesa'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_mesa'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_mesa'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_mesa'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_mesa'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_mesa'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_cliente as $i_cliente => $d_cliente) {
           if (!in_array($i_cliente, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_cliente[2] ] = $d_cliente[1];
               $this->comp_label[0][ $d_cliente[2] ] = $d_cliente[1];
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_por_mesa("res");
...
{ 
   ...
   function adiciona_registro($quebra_cliente, $quebra_cliente_orig)
   {
      ...
      if (!isset($this->array_total_cliente[$quebra_cliente_orig]))
      {
         ...
         $this->array_total_cliente[$quebra_cliente_orig][1] = $quebra_cliente;
         $this->array_total_cliente[$quebra_cliente_orig][2] = $quebra_cliente_orig;
      }
      else
      {
...
$_SESSION['scriptcase']['grid_lista_comandas']['contr_erro'] = 'off'; 
     ...
     $campos_order = $this->Ini->Get_date_order_groupby("c.nombres", 'asc', $format, $campos_order);
