...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "s.fechaven";$Nm_datas[] = "s_fechaven";$Nm_numeric[] = "d_iddet";$Nm_numeric[] = "d_cantidad";
...
<TABLE id="main_table" align="center" valign="top" width="1200px">
<tr>
<td>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_pedido"  <?php echo $str_hide_pedido?>><INPUT  type="text" id="SC_pedido" name="pedido" value="<?php echo NM_encode_input($pedido) ?>"  size=10 alt="{datatype: 'text', maxLength: 93, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" onChange="nm_submit_form()" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cliente" name="cliente_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 360, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" onChange="nm_submit_form()">
...
<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_estado" name="estado[]" value="1##@@PENDIENTE" onClick="nm_submit_form();" <?php if (in_array("1", $estado))  { echo " checked" ;} ?><?php  if (empty($estado)) { echo " checked" ;} ?>>PENDIENTE</TD>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_estado" name="estado[]" value="2##@@PROCESO" onClick="nm_submit_form();" <?php if (in_array("2", $estado))  { echo " checked" ;} ?><?php  if (empty($estado)) { echo " checked" ;} ?>>PROCESO</TD>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_estado" name="estado[]" value="3##@@TERMINADO" onClick="nm_submit_form();" <?php if (in_array("3", $estado))  { echo " checked" ;} ?>>TERMINADO</TD>
</TR><TR>
 <TD colspan=3>
  ...
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('estado', 'N'); return false;" style="cursor: pointer">
   ...
   <td class="scFilterLabelEven" nowrap='' style='text-align:right'>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
     ?>
