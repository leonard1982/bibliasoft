...
$_SESSION['scriptcase']['grid_lista_comandas']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_estado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['arr_total']['estado'];
      }
      else
      {
          $this->array_total_estado = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['arr_total']['estado'] = $this->array_total_estado;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_order']['por_estado']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_order']['por_estado'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_order']['por_estado'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_estado'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_estado'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_estado'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_estado'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_estado'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_estado'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_estado'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_estado as $i_estado => $d_estado) {
           if (!in_array($i_estado, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_estado[2] ] = $d_estado[1];
               $this->comp_label[0][ $d_estado[2] ] = $d_estado[1];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_estado => $l_estado) {
           if (isset($this->array_total_estado[$i_estado])) {
               $this->comp_group[$i_estado] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_estado;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_por_estado("res");
...
{ 
   ...
   //---- 
   function adiciona_registro($quebra_estado, $quebra_estado_orig)
   {
      //----- 
      if (!isset($this->array_total_estado[$quebra_estado_orig]))
      {
         $this->array_total_estado[$quebra_estado_orig][0] = 1;
         $this->array_total_estado[$quebra_estado_orig][1] = $quebra_estado;
         $this->array_total_estado[$quebra_estado_orig][2] = $quebra_estado_orig;
      }
      else
      {
         $this->array_total_estado[$quebra_estado_orig][0]++;
      }
   }
...
$_SESSION['scriptcase']['grid_lista_comandas']['contr_erro'] = 'off'; 
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'estado');
     $campos_order = $this->Ini->Get_date_order_groupby("d.estado_comanda", 'asc', $format, $campos_order);
...
$_SESSION['scriptcase']['grid_lista_comandas']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->estado, $this->estado_orig);
            }
   }
//
