...
<?php
   ...
   $Ord_Cmp = new grid_lista_comandas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_lista_comandas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       ...
       $tab_def_seq[30] = "inicio";
   }
   else
   {
       $tab_def_campos['inicio'] = "d.hora_inicio";
       $tab_def_seq[30] = "d.hora_inicio";
   }
   $tab_labels["inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["inicio"] : "INICIO: ";
   $tab_ger_campos['pedido'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pedido'] = "pedido";
       $tab_def_seq[40] = "pedido";
   }
   else
   {
       $tab_def_campos['pedido'] = "concat(r.prefijo,'/',s.numpedido)";
       $tab_def_seq[40] = "concat(r.prefijo,'/',s.numpedido)";
   }
   $tab_labels["pedido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["pedido"])) ? $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["pedido"] : "PEDIDO: ";
   $tab_ger_campos['cliente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cliente'] = "cliente";
       $tab_def_seq[50] = "cliente";
   }
   else
   {
       $tab_def_campos['cliente'] = "c.nombres";
       $tab_def_seq[50] = "c.nombres";
   }
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["cliente"] : "MESA/CLIENTE: ";
   $tab_ger_campos['producto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['producto'] = "producto";
       $tab_def_seq[60] = "producto";
   }
   else
   {
       $tab_def_campos['producto'] = "p.nompro";
       $tab_def_seq[60] = "p.nompro";
   }
   $tab_labels["producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["producto"] : "";
   $tab_ger_campos['cantidad'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cantidad'] = "cantidad";
       $tab_def_seq[70] = "cantidad";
   }
   else
   {
       $tab_def_campos['cantidad'] = "d.cantidad";
       $tab_def_seq[70] = "d.cantidad";
   }
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["cantidad"] : "CANTIDAD: ";
   $tab_ger_campos['observacion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['observacion'] = "observacion";
       $tab_def_seq[80] = "observacion";
   }
   else
   {
       $tab_def_campos['observacion'] = "coalesce(d.observ,'')";
       $tab_def_seq[80] = "coalesce(d.observ,'')";
   }
   $tab_labels["observacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["observacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["observacion"] : "";
   $tab_ger_campos['estado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['estado'] = "estado";
       $tab_def_seq[100] = "estado";
   }
   else
   {
       $tab_def_campos['estado'] = "d.estado_comanda";
       $tab_def_seq[100] = "d.estado_comanda";
   }
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["estado"] : "";
   ...
   $tab_labels["img"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["img"])) ? $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['labels']["img"] : "";
   $tab_ger_campos['img'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_lista_comandas']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_lista_comandas']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_lista_comandas']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
function Sel_processa_out_regr($sel_regra)
{
   ...
   foreach ($regras_ord as $cada_regra)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_select'][$tab_def_seq[$seq]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_lista_comandas_order_campos.php",
    data: {
   ...
   <table class="<?php echo ($embbed)? '':'scGridTabela'; ?>" style="border-width: 0; border-collapse: collapse; width:100%;" cellspacing=0 cellpadding=0>
    ...
    <td colspan=5>
     <select  name="sel_regra" id="id_sel_regra_sel_ord" size=1 class="scAppDivToolbarInput">
       <OPTION value=""></OPTION>
       <OPTION value="+;10;ID">Fecha</OPTION>
    </select>
<?php
   if (!$embbed)
   {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_lista_comandas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
