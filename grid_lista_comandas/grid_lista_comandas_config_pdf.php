...
*/
    ...
    $SC_apl_proc = "grid_lista_comandas";
    $SC_ver_93   = true;
    $SC_conf_opt = explode(",","tem_res_cons,tem_res_res,cor_imp,papel,orientacao,bookmarks,all_cab,page_break");
/* sc_apl_default */
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['grid_lista_comandas']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['grid_lista_comandas']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['grid_lista_comandas']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['grid_lista_comandas']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['grid_lista_comandas']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['grid_lista_comandas']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['grid_lista_comandas']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['grid_lista_comandas']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
...
<?php
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['grid_lista_comandas']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['grid_lista_comandas']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
