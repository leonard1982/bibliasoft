...
class grid_lista_comandas_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['arr_total']['producto'];
      }
      else
      {
          $this->array_total_producto = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['arr_total']['producto'] = $this->array_total_producto;
   ...
   function completeMatrix()
   {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['labels']['observacion'] = "OBSERVACIÓN: "; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['labels']['estado'] = "ESTADO: "; 
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_order']['por_producto']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_order']['por_producto'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_order']['por_producto'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_producto'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_producto'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_producto'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_producto'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_producto'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_producto'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['summarizing_fields_display']['por_producto'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_producto as $i_producto => $d_producto) {
           if (!in_array($i_producto, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_producto[2] ] = $d_producto[1];
               $this->comp_label[0][ $d_producto[2] ] = $d_producto[1];
           }
       }
...
{ 
   ...
   //---- 
   function adiciona_registro($quebra_producto, $quebra_producto_orig)
   {
      //----- 
      if (!isset($this->array_total_producto[$quebra_producto_orig]))
      {
         $this->array_total_producto[$quebra_producto_orig][0] = 1;
         $this->array_total_producto[$quebra_producto_orig][1] = $quebra_producto;
         $this->array_total_producto[$quebra_producto_orig][2] = $quebra_producto_orig;
      }
      else
      {
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT d.hora_inicio as inicio, concat(r.prefijo,'/',s.numpedido) as pedido, c.nombres as cliente, concat(p.codigobar,' - ',p.nompro) as producto, d.cantidad as cantidad, coalesce(d.observ,'') as observacion, d.estado_comanda as estado from " . $this->Ini->nm_tabela; 
     } 
     ...
     $campos_order = $this->Ini->Get_date_order_groupby("concat(p.codigobar,' - ',p.nompro)", 'asc', $format, $campos_order);
...
$_SESSION['scriptcase']['grid_lista_comandas']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->producto, $this->producto_orig);
            }
   }
//
