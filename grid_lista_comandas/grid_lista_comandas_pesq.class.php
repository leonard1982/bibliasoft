...
class grid_lista_comandas_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
   ...
   function lookup_ajax_cliente($cliente)
   {
      ...
      $nm_comando = "select distinct c.nombres from " . $this->Ini->nm_tabela . " where g.comanda = 'SI' 			and d.cerrado = 'SI'                         and g.idgrupo = '" . $_SESSION['gGrupoUsuarioComanda'] . "' and  c.nombres like '%" . $cliente . "%' order by c.nombres"; 
   ...
   function lookup_ajax_producto($producto)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct p.nompro from " . $this->Ini->nm_tabela . " where g.comanda = 'SI' 			and d.cerrado = 'SI'                         and g.idgrupo = '" . $_SESSION['gGrupoUsuarioComanda'] . "' and  p.nompro like '%" . $producto . "%' order by p.nompro"; 
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      {
          $nm_comando = str_replace($nm_cada_col, $nm_nova_col, $nm_comando); 
      }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "s.fechaven";$Nm_datas[] = "s_fechaven";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
{
   parent.document.getElementById('nmsc_iframe_grid_lista_comandas').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_lista_comandas').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>';
}
</SCRIPT>
</BODY>
</HTML>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_lista_comandas/grid_lista_comandas_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_lista_comandas_ajax_search.js"></script>
 <script type="text/javascript" src="grid_lista_comandas_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_lista_comandas_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_lista_comandas']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_lista_comandas']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript">
 $(function() {
   ...
   scClass = $("#id_ac_producto").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_producto").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
...
<TABLE align="center" valign="top" width="1200px" cellpadding=0 cellspacing=0>
<tr>
<td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $pedido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['pedido']; 
          $pedido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['pedido_cond']; 
          $cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['cliente']; 
          $cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['cliente_cond']; 
          $producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['producto']; 
          $producto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['producto_cond']; 
          $estado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['estado']; 
          $estado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['estado_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['NM_operador']; 
      } 
      if (!isset($pedido_cond) || empty($pedido_cond))
      {
         $pedido_cond = "eq";
      }
      ...
      $str_hide_pedido = (in_array($pedido_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($pedido, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $pedido = substr($pedido, 0, $tmp_pos);
         }
      }
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <INPUT type="hidden" id="SC_pedido_cond" name="pedido_cond" value="eq">
 ...
 $nmgp_tab_label .= "pedido?#?" . $SC_Label . "?@?";
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_pedido"  <?php echo $str_hide_pedido?>><INPUT  type="text" id="SC_pedido" name="pedido" value="<?php echo NM_encode_input($pedido) ?>"  size=10 alt="{datatype: 'text', maxLength: 93, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" onChange="nm_submit_form()" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_cliente"  <?php echo $str_hide_cliente?>><?php
      if ($cliente != "")
      {
      $cliente_look = substr($this->Db->qstr($cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct c.nombres from " . $this->Ini->nm_tabela . " where g.comanda = 'SI' 			and d.cerrado = 'SI'                         and g.idgrupo = '" . $_SESSION['gGrupoUsuarioComanda'] . "' and c.nombres = '$cliente_look' order by c.nombres"; 
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      {
          $nm_comando = str_replace($nm_cada_col, $nm_nova_col, $nm_comando); 
      }
...
?>
<INPUT  type="text" id="SC_cliente" name="cliente" value="<?php echo NM_encode_input($cliente) ?>"  size=30 alt="{datatype: 'text', maxLength: 360, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" onChange="nm_submit_form()" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cliente" name="cliente_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 360, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" onChange="nm_submit_form()">

 </TD>
   
   
      <INPUT type="hidden" id="SC_producto_cond" name="producto_cond" value="eq">
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_producto"  <?php echo $str_hide_producto?>><?php
      if ($producto != "")
      {
      $producto_look = substr($this->Db->qstr($producto), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct p.nompro from " . $this->Ini->nm_tabela . " where g.comanda = 'SI' 			and d.cerrado = 'SI'                         and g.idgrupo = '" . $_SESSION['gGrupoUsuarioComanda'] . "' and p.nompro = '$producto_look' order by p.nompro"; 
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      {
          $nm_comando = str_replace($nm_cada_col, $nm_nova_col, $nm_comando); 
      }
...
?>
<INPUT  type="text" id="SC_producto" name="producto" value="<?php echo NM_encode_input($producto) ?>"  size=40 alt="{datatype: 'text', maxLength: 600, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" onChange="nm_submit_form()" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_producto" name="producto_autocomp" size="40"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 600, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" onChange="nm_submit_form()">
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_estado"  <?php echo $str_hide_estado?>> 
<?php
  if (!isset($estado)) {$estado = explode("", $estado);}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['psq_check_ret']['estado'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['psq_check_ret']['estado'][] = "1";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['psq_check_ret']['estado'][] = "2";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['psq_check_ret']['estado'][] = "3";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_estado" name="estado[]" value="1##@@PENDIENTE" onClick="nm_submit_form();" <?php if (in_array("1", $estado))  { echo " checked" ;} ?><?php  if (empty($estado)) { echo " checked" ;} ?>>PENDIENTE</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_estado" name="estado[]" value="2##@@PROCESO" onClick="nm_submit_form();" <?php if (in_array("2", $estado))  { echo " checked" ;} ?><?php  if (empty($estado)) { echo " checked" ;} ?>>PROCESO</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_estado" name="estado[]" value="3##@@TERMINADO" onClick="nm_submit_form();" <?php if (in_array("3", $estado))  { echo " checked" ;} ?>>TERMINADO</TD>
</TR><TR>
 <TD colspan=3>
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_all.gif" ALIGN="absmiddle" onClick="nm_marca_check('estado', 'N'); return false;" style="cursor: pointer">&nbsp;
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('estado', 'N'); return false;" style="cursor: pointer">
 </TD>
</TR></TABLE>
 </TD>
...
?>
<?php
   if (is_file("grid_lista_comandas_help.txt"))
   {
...
?>
   <?php echo nmButtonOutput($this->arr_buttons, "bpesquisa", "document.F1.bprocessa.value='pesq'; setTimeout(function() {nm_submit_form()}, 200);", "document.F1.bprocessa.value='pesq'; setTimeout(function() {nm_submit_form()}, 200);", "sc_b_pesq_fields_right", "", " ", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "" . $this->Ini->Nm_lang['lang_btns_srch_lone_hint'] . "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
<?php
   if (is_file("grid_lista_comandas_help.txt"))
   {
...
{
?>
<iframe id="nmsc_iframe_grid_lista_comandas" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_lista_comandas" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
}
else
{
...
?>
<iframe id="nmsc_iframe_grid_lista_comandas_pesq"  name="nm_iframe_grid_lista_comandas_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 ...
 {
    document.F1.target = "nm_iframe_grid_lista_comandas_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_lista_comandas').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   NM_apaga_erro();
   document.F1.pedido_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_pedido'), document.F1.pedido_cond, 'pedido');
   document.F1.pedido.value = "";
   ...
   document.F1.producto_cond.value = 'eq';
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      $pedido_cond_salva = $pedido_cond; 
      if (!isset($pedido_input_2) || $pedido_input_2 == "")
      {
          $pedido_input_2 = $pedido;
      }
      ...
      if (is_array($estado)) {
          foreach ($estado as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['psq_check_ret']['estado'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['pedido'] = $pedido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['pedido_cond'] = $pedido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['cliente'] = $cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['cliente_cond'] = $cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['producto'] = $producto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['producto_cond'] = $producto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['estado'] = $estado; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['estado_cond'] = $estado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $Conteudo = $pedido;
      $this->cmp_formatado['pedido'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($cliente != '') {
      $cliente_look = substr($this->Db->qstr($cliente), 1, -1); 
      $nmgp_def_dados = array(); 
    ...
    if ($producto != '') {
      ...
      $this->cmp_formatado['estado'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']['estado'];
      $this->cmp_formatado['estado_input_2'] = $estado_input_2;

      //----- $pedido
      $this->Date_part = false;
      if (isset($pedido) || $pedido_cond == "nu" || $pedido_cond == "nn" || $pedido_cond == "ep" || $pedido_cond == "ne")
      {
         $this->monta_condicao("concat(r.prefijo,'/',s.numpedido)", $pedido_cond, $pedido, "", "pedido");
      }
      ...
      {
         $this->monta_condicao("c.nombres", $cliente_cond, $cliente, "", "cliente");
      }
      ...
      {
         $this->monta_condicao("p.nompro", $producto_cond, $producto, "", "producto");
      }
      ...
      if (is_array($estado) && count($estado) != 0)
      {
         ...
         {
             $this->comando        .= " d.estado_comanda not in (";
             $this->comando_sum    .= " .d.estado_comanda not in (";
             $this->comando_filtro .= " d.estado_comanda not in (";
         }
         else
         {
             $this->comando        .= " d.estado_comanda in (";
             $this->comando_sum    .= " .d.estado_comanda in (";
             $this->comando_filtro .= " d.estado_comanda in (";
         }
         $x                     = count($estado);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $nmgp_tab_label['estado'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($estado) || $estado_cond == "nu" || $estado_cond == "nn" || $estado_cond == "ep" || $estado_cond == "ne")
      {
         $this->monta_condicao("d.estado_comanda", $estado_cond, $estado, "", "estado");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lista_comandas']['cond_pesq'] .= $this->NM_operador;
