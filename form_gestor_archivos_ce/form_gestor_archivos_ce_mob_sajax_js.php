  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_gestor_archivos_ce_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_gestor_archivos_ce_mob_form();
	}
  ...
  // ---------- Validate id_gestor
  function do_ajax_form_gestor_archivos_ce_mob_validate_id_gestor()
  {
    var nomeCampo_id_gestor = "id_gestor";
    var var_id_gestor = scAjaxGetFieldHidden(nomeCampo_id_gestor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_ce_mob_validate_id_gestor(var_id_gestor, var_script_case_init, do_ajax_form_gestor_archivos_ce_mob_validate_id_gestor_cb);
  } // do_ajax_form_gestor_archivos_ce_mob_validate_id_gestor

  function do_ajax_form_gestor_archivos_ce_mob_validate_id_gestor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_gestor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_ce_mob_validate_id_gestor_cb

  // ---------- Validate fecha
  function do_ajax_form_gestor_archivos_ce_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldHidden(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_ce_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_gestor_archivos_ce_mob_validate_fecha_cb);
  } // do_ajax_form_gestor_archivos_ce_mob_validate_fecha

  function do_ajax_form_gestor_archivos_ce_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_ce_mob_validate_fecha_cb

  // ---------- Validate nombre
  function do_ajax_form_gestor_archivos_ce_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_ce_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_gestor_archivos_ce_mob_validate_nombre_cb);
  } // do_ajax_form_gestor_archivos_ce_mob_validate_nombre

  function do_ajax_form_gestor_archivos_ce_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_ce_mob_validate_nombre_cb

  // ---------- Validate tipo
  function do_ajax_form_gestor_archivos_ce_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldHidden(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_ce_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_gestor_archivos_ce_mob_validate_tipo_cb);
  } // do_ajax_form_gestor_archivos_ce_mob_validate_tipo

  function do_ajax_form_gestor_archivos_ce_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_ce_mob_validate_tipo_cb

  // ---------- Validate editado
  function do_ajax_form_gestor_archivos_ce_mob_validate_editado()
  {
    var nomeCampo_editado = "editado";
    var var_editado = scAjaxGetFieldHidden(nomeCampo_editado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_ce_mob_validate_editado(var_editado, var_script_case_init, do_ajax_form_gestor_archivos_ce_mob_validate_editado_cb);
  } // do_ajax_form_gestor_archivos_ce_mob_validate_editado

  function do_ajax_form_gestor_archivos_ce_mob_validate_editado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "editado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_ce_mob_validate_editado_cb

  // ---------- Validate peso
  function do_ajax_form_gestor_archivos_ce_mob_validate_peso()
  {
    var nomeCampo_peso = "peso";
    var var_peso = scAjaxGetFieldHidden(nomeCampo_peso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_ce_mob_validate_peso(var_peso, var_script_case_init, do_ajax_form_gestor_archivos_ce_mob_validate_peso_cb);
  } // do_ajax_form_gestor_archivos_ce_mob_validate_peso

  function do_ajax_form_gestor_archivos_ce_mob_validate_peso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "peso";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_ce_mob_validate_peso_cb

  // ---------- Validate usuario
  function do_ajax_form_gestor_archivos_ce_mob_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_ce_mob_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_gestor_archivos_ce_mob_validate_usuario_cb);
  } // do_ajax_form_gestor_archivos_ce_mob_validate_usuario

  function do_ajax_form_gestor_archivos_ce_mob_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_ce_mob_validate_usuario_cb

  // ---------- Validate descripcion
  function do_ajax_form_gestor_archivos_ce_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_ce_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_gestor_archivos_ce_mob_validate_descripcion_cb);
  } // do_ajax_form_gestor_archivos_ce_mob_validate_descripcion

  function do_ajax_form_gestor_archivos_ce_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_ce_mob_validate_descripcion_cb

  // ---------- Validate cctercero
  function do_ajax_form_gestor_archivos_ce_mob_validate_cctercero()
  {
    var nomeCampo_cctercero = "cctercero";
    var var_cctercero = scAjaxGetFieldText(nomeCampo_cctercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_ce_mob_validate_cctercero(var_cctercero, var_script_case_init, do_ajax_form_gestor_archivos_ce_mob_validate_cctercero_cb);
  } // do_ajax_form_gestor_archivos_ce_mob_validate_cctercero

  function do_ajax_form_gestor_archivos_ce_mob_validate_cctercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cctercero";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_ce_mob_validate_cctercero_cb

  // ---------- Validate tipodoc
  function do_ajax_form_gestor_archivos_ce_mob_validate_tipodoc()
  {
    var nomeCampo_tipodoc = "tipodoc";
    var var_tipodoc = scAjaxGetFieldText(nomeCampo_tipodoc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_ce_mob_validate_tipodoc(var_tipodoc, var_script_case_init, do_ajax_form_gestor_archivos_ce_mob_validate_tipodoc_cb);
  } // do_ajax_form_gestor_archivos_ce_mob_validate_tipodoc

  function do_ajax_form_gestor_archivos_ce_mob_validate_tipodoc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipodoc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_ce_mob_validate_tipodoc_cb

  // ---------- Validate numero
  function do_ajax_form_gestor_archivos_ce_mob_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_ce_mob_validate_numero(var_numero, var_script_case_init, do_ajax_form_gestor_archivos_ce_mob_validate_numero_cb);
  } // do_ajax_form_gestor_archivos_ce_mob_validate_numero

  function do_ajax_form_gestor_archivos_ce_mob_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_ce_mob_validate_numero_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_gestor_archivos_ce_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_gestor_archivos_ce_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_gestor = scAjaxGetFieldHidden("id_gestor");
    var var_fecha = scAjaxGetFieldHidden("fecha");
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_tipo = scAjaxGetFieldHidden("tipo");
    var var_editado = scAjaxGetFieldHidden("editado");
    var var_peso = scAjaxGetFieldHidden("peso");
    var var_usuario = scAjaxGetFieldText("usuario");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_cctercero = scAjaxGetFieldText("cctercero");
    var var_tipodoc = scAjaxGetFieldText("tipodoc");
    var var_numero = scAjaxGetFieldText("numero");
    var var_nombre_ul_name = scAjaxSpecCharProtect(document.F1.nombre_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_nombre_ul_type = document.F1.nombre_ul_type.value;
    var var_nombre_salva = scAjaxSpecCharProtect(document.F1.nombre_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_nombre_limpa = document.F1.nombre_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_gestor_archivos_ce_mob_submit_form(var_id_gestor, var_fecha, var_nombre, var_tipo, var_editado, var_peso, var_usuario, var_descripcion, var_cctercero, var_tipodoc, var_numero, var_nombre_ul_name, var_nombre_ul_type, var_nombre_salva, var_nombre_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_gestor_archivos_ce_mob_submit_form_cb);
  } // do_ajax_form_gestor_archivos_ce_mob_submit_form

  function do_ajax_form_gestor_archivos_ce_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_gestor");
      ...
      scAjaxHideErrorDisplay("cctercero");
      scAjaxHideErrorDisplay("tipodoc");
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.nombre_limpa && document.F1.nombre_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldDocument("nombre", oImgTemp, "", "");
      }
      else if (document.getElementById("id_ajax_doc_nombre") && "" != document.getElementById("id_ajax_doc_nombre").innerHTML)
      {
        document.getElementById("id_ajax_doc_nombre").style.display = "";
      }
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_gestor_archivos_ce_mob_submit_form_cb_after_alert);
  } // do_ajax_form_gestor_archivos_ce_mob_submit_form_cb
  function do_ajax_form_gestor_archivos_ce_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_gestor_archivos_ce_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_gestor_archivos_ce_mob_navigate_form()
  {
    perform_ajax_form_gestor_archivos_ce_mob_navigate_form();
  }

  function perform_ajax_form_gestor_archivos_ce_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tipodoc");
    scAjaxHideErrorDisplay("numero");
    var var_id_gestor = document.F2.id_gestor.value;
    ...
    scAjaxProcOn();
    x_ajax_form_gestor_archivos_ce_mob_navigate_form(var_id_gestor, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_gestor_archivos_ce_mob_navigate_form_cb);
  } // do_ajax_form_gestor_archivos_ce_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_gestor_archivos_ce_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_gestor_archivos_ce_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_gestor.value = scAjaxGetKeyValue("id_gestor");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_gestor_archivos_ce_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_gestor_archivos_ce_mob_navigate_form_cb
  function do_ajax_form_gestor_archivos_ce_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_gestor_archivos_ce_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_gestor_archivos_ce_mob_navigate_form_cb_after_alert
  function sc_hide_form_gestor_archivos_ce_mob_form()
  {
  ...
  ajax_field_list[0] = "id_gestor";
  ajax_field_list[1] = "fecha";
  ajax_field_list[2] = "nombre";
  ajax_field_list[3] = "tipo";
  ajax_field_list[4] = "editado";
  ajax_field_list[5] = "peso";
  ajax_field_list[6] = "usuario";
  ajax_field_list[7] = "descripcion";
  ajax_field_list[8] = "cctercero";
  ajax_field_list[9] = "tipodoc";
  ...
  var ajax_error_list = {
    "id_gestor": {"label": "Número", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha": {"label": "Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombre": {"label": "Archivo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "peso": {"label": "Peso KB", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "cctercero": {"label": "Cctercero", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipodoc": {"label": "Tipodoc", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["id_gestor"][1] = "id_gestor";
  ...
  ajax_field_mult["cctercero"][1] = "cctercero";
  ajax_field_mult["tipodoc"][1] = "tipodoc";
