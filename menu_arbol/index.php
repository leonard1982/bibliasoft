<?php
include_once('menu_arbol_session.php');
...
$_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod']      = "";
$_SESSION['scriptcase']['menu_arbol']['glo_nm_perfil']         = "conn_mysql";
$_SESSION['scriptcase']['menu_arbol']['glo_nm_path_imag_temp'] = "";
$_SESSION['scriptcase']['menu_arbol']['glo_nm_usa_grupo']      = "";
...
//check prod
if(empty($_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod']))
{
   /*check prod*/$_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check tmp
if(empty($_SESSION['scriptcase']['menu_arbol']['glo_nm_path_imag_temp']))
{
   /*check tmp*/$_SESSION['scriptcase']['menu_arbol']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
...
class menu_arbol_class
{
 ...
 function menu_arbol_menu()
 {
    global $menu_arbol_menuData;
...
$nm_versao_sc  = "" ; 
$_SESSION['scriptcase']['menu_arbol']['contr_erro'] = 'off';
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_arbol'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_arbol'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_arbol'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod'] . "/third";
$url_third      = $_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_arbol/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$path_lib_php   = $str_root . $path_link . "_lib/lib/php";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_arbol']['glo_nm_path_imag_temp'];
$menu_largura   = '200';
$menu_mobile_hide          = 'S';
...
if(function_exists('set_php_timezone')) set_php_timezone('menu_arbol');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_arbol_erro.php");
}
include_once(dirname(__FILE__) . "/menu_arbol_erro.class.php"); 
$this->Erro = new menu_arbol_erro();
$str_path = substr($_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_arbol']['glo_nm_conexao']);
}
/* Definiciones de las rutas */
$menu_arbol_menuData          = array();
$menu_arbol_menuData['path']  = array();
$menu_arbol_menuData['url']   = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_arbol_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_arbol_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_arbol_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_arbol_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_arbol_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_arbol_menuData['url']['web']   = str_replace("\\", '/', $menu_arbol_menuData['url']['web']);
$menu_arbol_menuData['path']['root'] = substr($menu_arbol_menuData['path']['sys'],  0, -1 * strlen($menu_arbol_menuData['url']['web']));
$menu_arbol_menuData['path']['app']  = substr($menu_arbol_menuData['path']['sys'],  0, strrpos($menu_arbol_menuData['path']['sys'],  '/'));
$menu_arbol_menuData['path']['link'] = substr($menu_arbol_menuData['path']['app'],  0, strrpos($menu_arbol_menuData['path']['app'],  '/'));
$menu_arbol_menuData['path']['link'] = substr($menu_arbol_menuData['path']['link'], 0, strrpos($menu_arbol_menuData['path']['link'], '/')) . '/';
$menu_arbol_menuData['path']['app'] .= '/';
$menu_arbol_menuData['url']['app']   = substr($menu_arbol_menuData['url']['web'],  0, strrpos($menu_arbol_menuData['url']['web'],  '/'));
$menu_arbol_menuData['url']['link']  = substr($menu_arbol_menuData['url']['app'],  0, strrpos($menu_arbol_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_arbol']['glo_nm_usa_grupo'] == "S")
{
    $menu_arbol_menuData['url']['link']  = substr($menu_arbol_menuData['url']['link'], 0, strrpos($menu_arbol_menuData['url']['link'], '/'));
}
$menu_arbol_menuData['url']['link']  .= '/';
$menu_arbol_menuData['url']['app']   .= '/';

$_SESSION['scriptcase']['menu_arbol']['sc_apl_link'] = $menu_arbol_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['menu_arbol']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_arbol']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['menu_arbol']['actual_lang']) || $_SESSION['scriptcase']['menu_arbol']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['menu_arbol']['actual_lang'] = $this->str_lang;
...
if ($_SESSION['scriptcase']['menu_arbol']['glo_nm_usa_grupo'] != "S")
{
    ...
    $_SESSION['scriptcase']['menu_atual'] = "menu_arbol";
    $_SESSION['scriptcase']['menu_apls']['menu_arbol'] = array();
    if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
    {
        foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
        {
            if (isset($_SESSION['scriptcase']['menu_arbol']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_arbol']['glo_nm_conexao'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['menu_arbol']['glo_nm_conexao'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['menu_arbol']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_arbol']['glo_nm_perfil'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['menu_arbol']['glo_nm_perfil'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['menu_arbol']['glo_con_' . $NM_con_orig]))
            {
                $_SESSION['scriptcase']['menu_arbol']['glo_con_' . $NM_con_orig] = $NM_con_dest;
            }
        }
    }
...
if (isset($_SESSION['scriptcase']['menu_arbol']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_arbol']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_arbol']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_arbol']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_arbol']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_arbol']['session_timeout']);
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_arbol']['session_timeout']['redir']))
{
...
if (isset($script_case_init))
{
    $_SESSION['sc_session'][1]['menu_arbol']['init'] = $script_case_init;
}
elseif (!isset($_SESSION['sc_session'][1]['menu_arbol']['init']))
{
    $_SESSION['sc_session'][1]['menu_arbol']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_arbol']['init'];
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['menu_arbol']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['menu_arbol']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['menu_arbol']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod'], 'FACILWEBv2', 2); 
}
if (isset($_SESSION['scriptcase']['menu_arbol']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['menu_arbol']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['menu_arbol']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['menu_arbol']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['menu_arbol']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['menu_arbol']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['menu_arbol']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['menu_arbol']['sc_outra_jan']) && $_SESSION['sc_session'][1]['menu_arbol']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['menu_arbol']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['menu_arbol']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['menu_arbol']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod'], 'FACILWEBv2'); 
} 
else 
{ 
...
if (in_array(strtolower($nm_tpbanco), $this->nm_bases_oracle))
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['menu_arbol']['decimal_db'] = ".";
} 
//
if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_arbol'))
{
    $_SESSION['sc_session'][1]['menu_arbol']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_arbol'] = "javascript:window.close()";
}

/* Menú de configuración de las variables */
$menu_arbol_menuData['iframe'] = TRUE;

$menu_arbol_menuData['height'] = '100%';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$_SESSION['scriptcase']['menu_arbol']['contr_erro'] = 'on';
 unset($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"]);
if (!isset($_SESSION['scriptcase']['sc_def_menu']))
{
    $_SESSION['scriptcase']['sc_def_menu'] = array();
}
if (!isset($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"] = array();
}
$vsql="select id,descripcion,enlace,icono,posicion,indicio,item from menu_arbol where activo='SI' and enlace is null";
      ...
      { 
          ...
          { 
                 ...
                 { 
                        $this->vMenu[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vmenu[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vMenu = false;
          $this->vMenu_erro = $this->Db->ErrorMsg();
          $this->vmenu = false;
          $this->vmenu_erro = $this->Db->ErrorMsg();
      } 
;

if(isset($this->vmenu[0][0])){
	for($i=0;$i<count($this->vmenu );$i++){
		$vid=$this->vmenu[$i][0];
		$vdescripcion=$this->vmenu[$i][1];
		$venlace=$this->vmenu[$i][2];
		$vicono=$this->vmenu[$i][3];
		$vindicio=$this->vmenu[$i][4];
		$vitem=$this->vmenu[$i][6];
		$vposicion=$this->vmenu[$i][4];
		if (isset($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]                   = array();
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['pai']            = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['label']          = $vdescripcion;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['link']           = $venlace;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['parm']           = "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['icon']           = $vicono;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['hint']           = $vindicio;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['target']         = $vindicio;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['name']           = $venlace;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['display']         = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['display_position']= "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['icon_fa']         = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['icon_color']      = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['icon_color_hover']= "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['icon_color_disabled']= "";
    $Temp_url = $venlace;
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['lnk_url'] = true;
    }
    else
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['lnk_url'] = false;
        if (!empty($Temp_url))
        {
            $Temp_url = SC_dir_app_name($Temp_url) . "/";
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['target']) == '_blank')
            {
                $Temp_url .= "?nmgp_outra_jan=true&nm_apl_menu=" . "menu_arbol";
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['target']) == '_self')
            {
                $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['sc_init'] = $this->Gera_sc_init($venlace);
                $Temp_url .= "?nm_run_menu=1&nm_apl_menu=" . "menu_arbol" . "&script_case_init=" . $this->Gera_sc_init($venlace);
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['target']) == '_parent')
            {
                $Temp_url .= "?nm_run_menu=1&script_case_init=" . $_SESSION['sc_session'][1]["menu_arbol"]['init'];
            }
        }
    }
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem]['url'] = $Temp_url;
}
$vsql="select id,descripcion,enlace,icono,posicion,indicio,item from menu_arbol where activo='SI' and id_menu=$vid";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSub[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsub[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vSub = false;
          $this->vSub_erro = $this->Db->ErrorMsg();
          $this->vsub = false;
          $this->vsub_erro = $this->Db->ErrorMsg();
      } 
;
		if(isset($this->vsub[0][0])){
			for($j=0;$j<count($this->vsub );$j++){
				$vid_s=$this->vsub[$j][0];
				$vdescripcion_s=$this->vsub[$j][1];
				$venlace_s=$this->vsub[$j][2];
				$vicono_s=$this->vsub[$j][3];
				$vindicio_s=$this->vsub[$j][5];
				$vitem_s=$this->vsub[$j][6];
				$vposicion_s=$this->vsub[$j][4];
				if (isset($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]                   = array();
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['pai']            = $vitem;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['label']          = $vdescripcion_s;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['link']           = $venlace_s;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['parm']           = "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['icon']           = $vicono_s;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['hint']           = $vindicio_s;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['target']         = $vindicio_s;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['name']           = $venlace_s;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['display']         = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['display_position']= "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['icon_fa']         = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['icon_color']      = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['icon_color_hover']= "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['icon_color_disabled']= "";
    $Temp_url = $venlace_s;
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['lnk_url'] = true;
    }
    else
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['lnk_url'] = false;
        if (!empty($Temp_url))
        {
            $Temp_url = SC_dir_app_name($Temp_url) . "/";
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['target']) == '_blank')
            {
                $Temp_url .= "?nmgp_outra_jan=true&nm_apl_menu=" . "menu_arbol";
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['target']) == '_self')
            {
                $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['sc_init'] = $this->Gera_sc_init($venlace_s);
                $Temp_url .= "?nm_run_menu=1&nm_apl_menu=" . "menu_arbol" . "&script_case_init=" . $this->Gera_sc_init($venlace_s);
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['target']) == '_parent')
            {
                $Temp_url .= "?nm_run_menu=1&script_case_init=" . $_SESSION['sc_session'][1]["menu_arbol"]['init'];
            }
        }
    }
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s]['url'] = $Temp_url;
}
$vsql="select id,descripcion,enlace,icono,posicion,indicio,item from menu_arbol where activo='SI' and id_menu=$vid_s";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSub1[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsub1[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vSub1 = false;
          $this->vSub1_erro = $this->Db->ErrorMsg();
          $this->vsub1 = false;
          $this->vsub1_erro = $this->Db->ErrorMsg();
      } 
;
				if(isset($this->vsub1[0][0])){
					for($k=0;$k<count($this->vsub1 );$k++){
						$vid1=$this->vsub1[$k][0];
						$vdescripcion_s1=$this->vsub1[$k][1];
						$venlace_s1=$this->vsub1[$k][2];
						$vicono_s1=$this->vsub1[$k][3];
						$vindicio_s1=$this->vsub1[$k][5];
						$vitem_s1=$this->vsub1[$k][6];
						$vposicion_s1=$this->vsub1[$k][4];
						if (isset($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]                   = array();
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['pai']            = $vitem_s;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['label']          = $vdescripcion_s1;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['link']           = $venlace_s1;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['parm']           = "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['icon']           = $vicono_s1;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['hint']           = $vindicio_s1;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['target']         = $vindicio_s1;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['name']           = $venlace_s1;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['display']         = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['display_position']= "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['icon_fa']         = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['icon_color']      = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['icon_color_hover']= "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['icon_color_disabled']= "";
    $Temp_url = $venlace_s1;
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['lnk_url'] = true;
    }
    else
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['lnk_url'] = false;
        if (!empty($Temp_url))
        {
            $Temp_url = SC_dir_app_name($Temp_url) . "/";
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['target']) == '_blank')
            {
                $Temp_url .= "?nmgp_outra_jan=true&nm_apl_menu=" . "menu_arbol";
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['target']) == '_self')
            {
                $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['sc_init'] = $this->Gera_sc_init($venlace_s1);
                $Temp_url .= "?nm_run_menu=1&nm_apl_menu=" . "menu_arbol" . "&script_case_init=" . $this->Gera_sc_init($venlace_s1);
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['target']) == '_parent')
            {
                $Temp_url .= "?nm_run_menu=1&script_case_init=" . $_SESSION['sc_session'][1]["menu_arbol"]['init'];
            }
        }
    }
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s1]['url'] = $Temp_url;
}
$vsql="select id,descripcion,enlace,icono,posicion,indicio,item from menu_arbol where activo='SI' and id_menu=$vid1";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSub2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsub2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vSub2 = false;
          $this->vSub2_erro = $this->Db->ErrorMsg();
          $this->vsub2 = false;
          $this->vsub2_erro = $this->Db->ErrorMsg();
      } 
;
						if(isset($this->vsub2[0][0])){
							for($l=0;$l<count($this->vsub2 );$l++){
								$vid2=$this->vsub2[$l][0];
								$vdescripcion_s2=$this->vsub2[$l][1];
								$venlace_s2=$this->vsub2[$l][2];
								$vicono_s2=$this->vsub2[$l][3];
								$vindicio_s2=$this->vsub2[$l][5];
								$vitem_s2=$this->vsub2[$l][6];
								$vposicion_s2=$this->vsub2[$l][4];
								if (isset($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]                   = array();
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['pai']            = $vitem_s1;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['label']          = $vdescripcion_s2;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['link']           = $venlace_s2;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['parm']           = "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['icon']           = $vicono_s2;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['hint']           = $vindicio_s2;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['target']         = $vindicio_s2;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['name']           = $venlace_s2;
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['display']         = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['display_position']= "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['icon_fa']         = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['icon_color']      = "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['icon_color_hover']= "";
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['icon_color_disabled']= "";
    $Temp_url = $venlace_s2;
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['lnk_url'] = true;
    }
    else
    {
        $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['lnk_url'] = false;
        if (!empty($Temp_url))
        {
            $Temp_url = SC_dir_app_name($Temp_url) . "/";
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['target']) == '_blank')
            {
                $Temp_url .= "?nmgp_outra_jan=true&nm_apl_menu=" . "menu_arbol";
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['target']) == '_self')
            {
                $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['sc_init'] = $this->Gera_sc_init($venlace_s2);
                $Temp_url .= "?nm_run_menu=1&nm_apl_menu=" . "menu_arbol" . "&script_case_init=" . $this->Gera_sc_init($venlace_s2);
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['target']) == '_parent')
            {
                $Temp_url .= "?nm_run_menu=1&script_case_init=" . $_SESSION['sc_session'][1]["menu_arbol"]['init'];
            }
        }
    }
    $_SESSION['scriptcase']['sc_def_menu']["menu_arbol"][$vitem_s2]['url'] = $Temp_url;
}
}
						}	
					}
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_arbol']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menu_arbol_message.js"></script>
...
?> 
        ...
        <script  type="text/javascript">
                        ...
                        $(document).ready(function () {
                                ...
                                $('#css3menut').jstree({
                                        'state' : { 'key' : 'menu_arbol', 'filter' : function (k) { delete k.core.selected; return k; } },
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_arbol'];
$menu_arbol_menuData['data'] = array();
$nextLevelToBeWrite = false;

if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_arbol']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_arbol']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_arbol');
    $menu_arbol_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_arbol_help.txt"))
{
    $Arq_WebHelp = file("menu_arbol_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_arbol_menuData['data'][] = array(
                    ...
                    'target'   => "" . $this->menu_arbol_target('_blank') . "",
                    'sc_id'    => "item_Help",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_arbol']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_arbol']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_arbol_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_arbol']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_arbol_menuData['data'][$i_menu]);
       }
    ...
    $menu_arbol_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_arbol']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_arbol']))
{
    $disable_menu = false;
    foreach ($menu_arbol_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_arbol']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_arbol_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
foreach ($menu_arbol_menuData['data'] as $chave => $cada_menu)
{
        if($level_to_delete !== false && $menu_arbol_menuData['data'][$chave]['level'] > $level_to_delete)
        {
                unset($menu_arbol_menuData['data'][$chave]);
        }
        else
        {
                $level_to_delete = false;
                
                if ($menu_arbol_menuData['data'][$chave]['disabled'] == 'Y')
                {
                        $level_to_delete = $menu_arbol_menuData['data'][$chave]['level'];
                        unset($menu_arbol_menuData['data'][$chave]);
                }
        }
}
$menu_arbol_menuData['data'] = array_values($menu_arbol_menuData['data']);
$flag = 1;
while ($flag == 1)
{
    $flag = 0;
    foreach ($menu_arbol_menuData['data'] as $chave => $cada_menu)
    {
        if (!empty($cada_menu))
        {
            if ($menu_arbol_menuData['data'][$chave]['disabled'] == 'Y')
            {
                    unset($menu_arbol_menuData['data'][$chave]['disabled']);
                    foreach ($menu_arbol_menuData['data'] as $_key => $_val)
                    {
                            if($_key > $chave)
                            {
                                    if($menu_arbol_menuData['data'][$_key]['level'] > $menu_arbol_menuData['data'][$chave]['level'])
                                    {
                                            unset($menu_arbol_menuData['data'][$_key]);
                                    }
                                    else
                                    {
                                            break;
            ...
            if (isset($menu_arbol_menuData['data'][$chave + 1]) && !empty($menu_arbol_menuData['data'][$chave + 1]))
            {
                if ($menu_arbol_menuData['data'][$chave]['link'] == "#")
                {
                    if ($menu_arbol_menuData['data'][$chave]['level'] >= $menu_arbol_menuData['data'][$chave + 1]['level'] )
                    {
                        unset($menu_arbol_menuData['data'][$chave]);
                        $flag = 1;
                    }
            ...
            elseif ($menu_arbol_menuData['data'][$chave]['link'] == "#")
            {
                unset($menu_arbol_menuData['data'][$chave]);
            }
        }
...
<table width="100%" height="67px" class="scMenuTHeader">
        <tr>
                <td width="5px"></td>
        <td width="67px" class="scMenuTHeaderFont"></td>
               <td class="scMenuTHeaderFont"><span id="lin1_col1"></span><br /><span id="lin2_col1"></span></td>
               <td align="right" class="scMenuTHeaderFont"><span  id="lin1_col2"></span><br /><span id="lin2_col2"></span></td>
        <td width="5px"></td>
    </tr>
</table>
</div>
<?php
    $_SESSION['scriptcase']['menu_arbol']['apl_inicial'] = ($NM_scr_iframe != "") ? $NM_scr_iframe : "menu_arbol_pag_ini.php";
    $_SESSION['scriptcase']['menu_arbol']['path_link'] = $path_link;
?>
        ...
        <td class="scMenuTTableM" valign="top">
                <table cellpadding=0 cellspacing=0>
                    <tr>
                      ...
                      <?php
                      echo $this->menu_arbol_escreveMenu($menu_arbol_menuData['data']);
                      ?>
                            </td>
                    </tr>
                </table>
...
<div class="ui-layout-center">
  <table cellspacing=0 cellpadding=0 style="height: 100%; width: 100%" cellpadding=0 cellspacing=0>
    ...
    $(document).ready(function () {
        ...
        <iframe name="menu_arbol_iframe" id="iframe_menu_arbol" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;" src="<?php echo $_SESSION['scriptcase']['menu_arbol']['apl_inicial']?>"></iframe>
<?php
?>
        </td>
      </tr>
...
Iframe_atual = "menu_arbol_iframe";
...
<?php
 $seq = 0;
 if(isset($menu_arbol_menuData['data']) && !empty($menu_arbol_menuData['data']))
 {
   foreach ($menu_arbol_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($menu_arbol_menuData['data_vertical']) && !empty($menu_arbol_menuData['data_vertical']))
 {
   foreach ($menu_arbol_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_arbol_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'menu_arbol'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_menu_arbol').hide();
    if (str_id == "")
    {
        $('#iframe_menu_arbol').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="menu_arbol_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
            ...
            Iframe_atual = "menu_arbol_" + Tab_iframes[i] + '_iframe';
...
{
  str_target_sv = "";
  if (str_id != "iframe_menu_arbol")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("menu_arbol_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    if (str_target == "menu_arbol_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "menu_arbol")
        {
            $('#links_abas').css('display','');
            $('#id_links_abas').css('display','');
        }
        if (str_id != "menu_arbol" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    if(str_target != '_blank' && $('#iframe_menu_arbol').length)
        $('#iframe_menu_arbol')[0].contentWindow.focus();
  }
}
</script>
</body>
...
/* Control de Target */
function menu_arbol_escreveMenu($arr_menu)
{
    $aMenuItemList = array();
            ...
            <?php
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    ?>
                    <li <?php echo $iconHtml; ?> class="scMenuTItems scMenuTItem" style="<?php echo $li_style; ?>"><a href="javascript:" onclick="openMenuItem('menu_arbol_<?php echo $aMenuItemList[$i]['id']; ?>'); <?php echo $focusFrame; ?>" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>"<?php echo $aMenuItemList[$i]['target']; ?> class="scMenuTItem"><?php echo $aMenuItemList[$i]['label']; ?></a>
                    <?php
                  }
                }
                if ($aMenuItemList[$i + 1] && $aMenuItemList[$i]['level'] == $aMenuItemList[$i + 1]['level']) {
...
/* Control de Target */
   function menu_arbol_target($str_target)
   {
       global $menu_arbol_menuData;
       ...
       elseif ($menu_arbol_menuData['iframe'])
       {
           return 'menu_arbol_iframe';
       }
       else
       {
           return $str_target;
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "javascript:parent.nm_out_menu('menu_arbol_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_arbol_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_arbol']['glo_nm_usa_grupo'] . "')";  
               }
               else
               {
                    $str_line['link'] = "menu_arbol_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_arbol_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_arbol']['glo_nm_usa_grupo'] . ""; 
               }
           }
           elseif ($arr_item['target'] == '_parent')
           {
               $str_line['link'] = "javascript:parent.nm_out_menu('" . $_SESSION['scriptcase']['sc_saida_menu_arbol'] . "')"; 
           }
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_arbol_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['menu_arbol']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_arbol']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['menu_arbol']['sc_init'][$apl_menu];
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_arbol']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_arbol']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_arbol") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_arbol']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_arbol']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['menu_arbol']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
            $_SESSION['scriptcase']['menu_arbol']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
        }
    }
}
...
$contr_menu_arbol = new menu_arbol_class;
$contr_menu_arbol->menu_arbol_menu();
