  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_linea" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_linea_
  function do_ajax_form_linea_validate_id_linea_(iNumLinha)
  {
    var nomeCampo_id_linea_ = "id_linea_" + iNumLinha;
    var var_id_linea_ = scAjaxGetFieldHidden(nomeCampo_id_linea_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_linea_validate_id_linea_(var_id_linea_, iNumLinha, var_script_case_init, do_ajax_form_linea_validate_id_linea__cb);
  } // do_ajax_form_linea_validate_id_linea_

  function do_ajax_form_linea_validate_id_linea__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_linea_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_linea_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_linea_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_linea_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_linea_validate_id_linea__cb

  // ---------- Validate cod_linea_
  function do_ajax_form_linea_validate_cod_linea_(iNumLinha)
  {
    var nomeCampo_cod_linea_ = "cod_linea_" + iNumLinha;
    var var_cod_linea_ = scAjaxGetFieldText(nomeCampo_cod_linea_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_linea_validate_cod_linea_(var_cod_linea_, iNumLinha, var_script_case_init, do_ajax_form_linea_validate_cod_linea__cb);
  } // do_ajax_form_linea_validate_cod_linea_

  function do_ajax_form_linea_validate_cod_linea__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cod_linea_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cod_linea_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cod_linea_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cod_linea_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_linea_validate_cod_linea__cb

  // ---------- Validate nombre_linea_
  function do_ajax_form_linea_validate_nombre_linea_(iNumLinha)
  {
    var nomeCampo_nombre_linea_ = "nombre_linea_" + iNumLinha;
    var var_nombre_linea_ = scAjaxGetFieldText(nomeCampo_nombre_linea_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_linea_validate_nombre_linea_(var_nombre_linea_, iNumLinha, var_script_case_init, do_ajax_form_linea_validate_nombre_linea__cb);
  } // do_ajax_form_linea_validate_nombre_linea_

  function do_ajax_form_linea_validate_nombre_linea__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nombre_linea_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nombre_linea_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nombre_linea_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nombre_linea_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_linea_validate_nombre_linea__cb

  // ---------- Validate presupuesto_venta_
  function do_ajax_form_linea_validate_presupuesto_venta_(iNumLinha)
  {
    var nomeCampo_presupuesto_venta_ = "presupuesto_venta_" + iNumLinha;
    var var_presupuesto_venta_ = scAjaxGetFieldText(nomeCampo_presupuesto_venta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_linea_validate_presupuesto_venta_(var_presupuesto_venta_, iNumLinha, var_script_case_init, do_ajax_form_linea_validate_presupuesto_venta__cb);
  } // do_ajax_form_linea_validate_presupuesto_venta_

  function do_ajax_form_linea_validate_presupuesto_venta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "presupuesto_venta_" + iLineNumber;
    }
    else
    {
      sFieldValid = "presupuesto_venta_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "presupuesto_venta_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "presupuesto_venta_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_linea_validate_presupuesto_venta__cb

  // ---------- Validate tienda_
  function do_ajax_form_linea_validate_tienda_(iNumLinha)
  {
    var nomeCampo_tienda_ = "tienda_" + iNumLinha;
    var var_tienda_ = scAjaxGetFieldCheckbox(nomeCampo_tienda_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_linea_validate_tienda_(var_tienda_, iNumLinha, var_script_case_init, do_ajax_form_linea_validate_tienda__cb);
  } // do_ajax_form_linea_validate_tienda_

  function do_ajax_form_linea_validate_tienda__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tienda_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tienda_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tienda_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tienda_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_linea_validate_tienda__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_linea_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_linea_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_linea_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_linea_add_new_line_cb);
  } // do_ajax_form_linea_add_new_line

  function do_ajax_form_linea_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_linea_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_linea_backup_line(iNumLinha)
  {
    var var_id_linea_ = scAjaxGetFieldHidden("id_linea_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_linea_backup_line(var_id_linea_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_linea_backup_line_cb);
  } // do_ajax_form_linea_backup_line

  function do_ajax_form_linea_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_linea_backup_line_cb

  function do_ajax_form_linea_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_linea_cancel_insert

  function do_ajax_form_linea_cancel_update(iSeqVert)
  {
    do_ajax_form_linea_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_linea_cancel_update

  function do_ajax_form_linea_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_linea_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_linea_table_refresh()
  {
    var var_id_linea_ = document.F2.id_linea_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_linea_table_refresh(var_id_linea_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_linea_table_refresh_cb);
  } //  do_ajax_form_linea_table_refresh

  function do_ajax_form_linea_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_linea_.value = scAjaxGetKeyValue("id_linea_");
    ...
    scAjaxAlert(do_ajax_form_linea_table_refresh_cb_after_alert);
  } // do_ajax_form_linea_table_refresh_cb
  function do_ajax_form_linea_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_linea_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_linea_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_linea_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_linea_ = scAjaxGetFieldHidden("id_linea_" + iNumLinha);
    var var_cod_linea_ = scAjaxGetFieldText("cod_linea_" + iNumLinha);
    var var_nombre_linea_ = scAjaxGetFieldText("nombre_linea_" + iNumLinha);
    var var_presupuesto_venta_ = scAjaxGetFieldText("presupuesto_venta_" + iNumLinha);
    var var_tienda_ = scAjaxGetFieldCheckbox("tienda_" + iNumLinha, ";");
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_linea_submit_form(var_id_linea_, var_cod_linea_, var_nombre_linea_, var_presupuesto_venta_, var_tienda_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_linea_submit_form_cb);
  } // do_ajax_form_linea_submit_form

  function do_ajax_form_linea_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_linea_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cod_linea_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_linea_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("presupuesto_venta_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tienda_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_linea_submit_form_cb_after_alert);
  } // do_ajax_form_linea_submit_form_cb
  function do_ajax_form_linea_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_linea_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_linea_navigate_form()
  {
    perform_ajax_form_linea_navigate_form();
  }

  function perform_ajax_form_linea_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_linea_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_linea_" + iNavForm);
      scAjaxHideErrorDisplay("cod_linea_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_linea_" + iNavForm);
      scAjaxHideErrorDisplay("presupuesto_venta_" + iNavForm);
      scAjaxHideErrorDisplay("tienda_" + iNavForm);
    }
    var var_id_linea_ = document.F2.id_linea_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_linea_navigate_form(var_id_linea_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_linea_navigate_form_cb);
  } // do_ajax_form_linea_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_linea']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_linea_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_linea_.value = scAjaxGetKeyValue("id_linea_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_linea_navigate_form_cb_after_alert);
  } // do_ajax_form_linea_navigate_form_cb
  function do_ajax_form_linea_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_linea_navigate_form_cb_after_alert
  function sc_hide_form_linea_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_linea_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cod_linea_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_linea_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "presupuesto_venta_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tienda_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_linea_" + iNumLinha] = {"label": "Id Linea<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cod_linea_" + iNumLinha] = {"label": "Código<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nombre_linea_" + iNumLinha] = {"label": "Nombre Linea<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["presupuesto_venta_" + iNumLinha] = {"label": "Presupuesto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tienda_" + iNumLinha] = {"label": "Tienda<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_linea_"][iNumLinha] = "id_linea_" + iNumLinha;
    ajax_field_mult["cod_linea_"][iNumLinha] = "cod_linea_" + iNumLinha;
    ajax_field_mult["nombre_linea_"][iNumLinha] = "nombre_linea_" + iNumLinha;
    ajax_field_mult["presupuesto_venta_"][iNumLinha] = "presupuesto_venta_" + iNumLinha;
    ajax_field_mult["tienda_"][iNumLinha] = "tienda_" + iNumLinha;
    ajax_field_id["cod_linea_" + iNumLinha] = new Array("hidden_field_label_cod_linea_", "hidden_field_data_cod_linea_" + iNumLinha);
    ajax_field_id["nombre_linea_" + iNumLinha] = new Array("hidden_field_label_nombre_linea_", "hidden_field_data_nombre_linea_" + iNumLinha);
    ajax_field_id["presupuesto_venta_" + iNumLinha] = new Array("hidden_field_label_presupuesto_venta_", "hidden_field_data_presupuesto_venta_" + iNumLinha);
    ajax_field_id["tienda_" + iNumLinha] = new Array("hidden_field_label_tienda_", "hidden_field_data_tienda_" + iNumLinha);
    ajax_error_count["id_linea_" + iNumLinha] = "off";
    ajax_error_count["cod_linea_" + iNumLinha] = "off";
    ajax_error_count["nombre_linea_" + iNumLinha] = "off";
    ajax_error_count["presupuesto_venta_" + iNumLinha] = "off";
    ajax_error_count["tienda_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_linea_" + iNumLinha] = "on";
    ajax_read_only["cod_linea_" + iNumLinha] = "off";
    ajax_read_only["nombre_linea_" + iNumLinha] = "off";
    ajax_read_only["presupuesto_venta_" + iNumLinha] = "off";
    ajax_read_only["tienda_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_linea_" + iNumLinha] = "on";
    ajax_read_only["cod_linea_" + iNumLinha] = "on";
    ajax_read_only["nombre_linea_" + iNumLinha] = "on";
    ajax_read_only["presupuesto_venta_" + iNumLinha] = "on";
    ajax_read_only["tienda_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_linea_" + iNumLinha] = null;
    ajax_error_list["cod_linea_" + iNumLinha] = null;
    ajax_error_list["nombre_linea_" + iNumLinha] = null;
    ajax_error_list["presupuesto_venta_" + iNumLinha] = null;
    ajax_error_list["tienda_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_linea_": new Array(),
    "cod_linea_": new Array(),
    "nombre_linea_": new Array(),
    "presupuesto_venta_": new Array(),
    "tienda_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_linea_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_linea_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_linea_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_linea_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_linea_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cod_linea_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cod_linea_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cod_linea_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cod_linea_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cod_linea_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nombre_linea_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nombre_linea_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nombre_linea_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nombre_linea_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nombre_linea_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["presupuesto_venta_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["presupuesto_venta_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["presupuesto_venta_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["presupuesto_venta_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["presupuesto_venta_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tienda_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tienda_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tienda_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tienda_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tienda_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_linea_'])) ? $this->nmgp_cmp_readonly['id_linea_'] : 'on';
?>
    scAjaxFieldRead("id_linea_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cod_linea_'])) ? $this->nmgp_cmp_readonly['cod_linea_'] : 'off';
?>
    scAjaxFieldRead("cod_linea_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nombre_linea_'])) ? $this->nmgp_cmp_readonly['nombre_linea_'] : 'off';
?>
    scAjaxFieldRead("nombre_linea_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['presupuesto_venta_'])) ? $this->nmgp_cmp_readonly['presupuesto_venta_'] : 'off';
?>
    scAjaxFieldRead("presupuesto_venta_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tienda_'])) ? $this->nmgp_cmp_readonly['tienda_'] : 'off';
?>
    scAjaxFieldRead("tienda_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_linea_" + iSeq, "on");
    scAjaxFieldRead("cod_linea_" + iSeq, "on");
    scAjaxFieldRead("nombre_linea_" + iSeq, "on");
    scAjaxFieldRead("presupuesto_venta_" + iSeq, "on");
    scAjaxFieldRead("tienda_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_linea_" + iRow] || "on" == ajax_error_count["cod_linea_" + iRow] || "on" == ajax_error_count["nombre_linea_" + iRow] || "on" == ajax_error_count["presupuesto_venta_" + iRow] || "on" == ajax_error_count["tienda_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_linea_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cod_linea_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_linea_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_presupuesto_venta_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tienda_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_linea_" + iRow] && "off" == ajax_error_count["cod_linea_" + iRow] && "off" == ajax_error_count["nombre_linea_" + iRow] && "off" == ajax_error_count["presupuesto_venta_" + iRow] && "off" == ajax_error_count["tienda_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_linea_" + iRow] = "off";
        ajax_error_count["cod_linea_" + iRow] = "off";
        ajax_error_count["nombre_linea_" + iRow] = "off";
        ajax_error_count["presupuesto_venta_" + iRow] = "off";
        ajax_error_count["tienda_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_linea_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cod_linea_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_linea_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_presupuesto_venta_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tienda_" + iRow).removeClass("scFormErrorLine");
    }
  }
