...
<?php echo "<b>Tienda</b><br>" . nl2br("Si se marca como tienda estará disponible para la tienda en línea si dispone de ese servicio."); ?>
</body>
</html>
<?php
        }
