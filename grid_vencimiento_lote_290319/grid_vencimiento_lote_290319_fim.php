...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_vencimiento_lote_290319"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_vencimiento_lote_290319"]);
   }
