...
class pdfreport_remision_xls
{
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          foreach ($todo as $param)
          {
               ...
               if (1 < sizeof($cadapar))
               {
                   ...
                   nm_limpa_str_pdfreport_remision($cadapar[1]);
                   nm_protect_num_pdfreport_remision($cadapar[0], $cadapar[1]);
                   if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                   $Tmp_par   = $cadapar[0];
                   $$Tmp_par = $cadapar[1];
                   if ($Tmp_par == "nmgp_opcao")
                   {
                       $_SESSION['sc_session'][$script_case_init]['pdfreport_remision']['opcao'] = $cadapar[1];
                   }
               }
          }
      }
      ...
      {
          $_SESSION['nit'] = $nit;
          nm_limpa_str_pdfreport_remision($_SESSION["nit"]);
      }
      if (isset($par_numfacventa)) 
      {
          $_SESSION['par_numfacventa'] = $par_numfacventa;
          nm_limpa_str_pdfreport_remision($_SESSION["par_numfacventa"]);
      }
      if (isset($gconsolidaritems)) 
      {
          $_SESSION['gconsolidaritems'] = $gconsolidaritems;
          nm_limpa_str_pdfreport_remision($_SESSION["gconsolidaritems"]);
      }
      if (isset($gconsolidararticulos)) 
      {
          $_SESSION['gconsolidararticulos'] = $gconsolidararticulos;
          nm_limpa_str_pdfreport_remision($_SESSION["gconsolidararticulos"]);
      }
      if (isset($empresa)) 
      {
          $_SESSION['empresa'] = $empresa;
          nm_limpa_str_pdfreport_remision($_SESSION["empresa"]);
      }
      if (isset($direccion)) 
      {
          $_SESSION['direccion'] = $direccion;
          nm_limpa_str_pdfreport_remision($_SESSION["direccion"]);
      }
      if (isset($tele)) 
      {
          $_SESSION['tele'] = $tele;
          nm_limpa_str_pdfreport_remision($_SESSION["tele"]);
      }
      if (isset($subt)) 
      {
          $_SESSION['subt'] = $subt;
          nm_limpa_str_pdfreport_remision($_SESSION["subt"]);
      }
      if (isset($eliva)) 
      {
          $_SESSION['eliva'] = $eliva;
          nm_limpa_str_pdfreport_remision($_SESSION["eliva"]);
      }
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "pdfreport_remision/pdfreport_remision_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "pdfreport_remision_res_xls.class.php");
              $this->Res_xls = new pdfreport_remision_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_pdfreport_remision.zip";
          $this->Arquivo   .= "_pdfreport_remision" . $this->Xls_tp;
          $this->Tit_doc    = "pdfreport_remision" . $this->Xls_tp;
          $this->Tit_zip    = "pdfreport_remision.zip";
      ...
      require_once($this->Ini->path_aplicacao . "pdfreport_remision_total.class.php"); 
      $this->Tot = new pdfreport_remision_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
       $this->Tot->quebra_geral() ; 
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['tot_geral'][1];
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['embutida'] && !$this->Ini->sc_export_ajax) {
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['pdfreport_remision']['glo_nm_path_imag_temp'] . "/");
          $this->pb->setProgressbarMd5($_GET['pbmd5']);
          $this->pb->initialize();
          $this->pb->setReturnUrl("./");
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['field_order'] as $Cada_cmp)
      {
      ...
      { 
          ...
          $this->adicional2 = $Busca_temp['adicional2']; 
          $tmp_pos = strpos($this->adicional2, "##@@");
          if ($tmp_pos !== false && !is_array($this->adicional2))
          {
              $this->adicional2 = substr($this->adicional2, 0, $tmp_pos);
          }
...
$_SESSION['scriptcase']['pdfreport_remision']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count = "SELECT count(*) AS countTest from (SELECT      idfacven,     numfacven, nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, vendedor, pedido,      resolucion,     dirdelcliente,  (select e.logo from datosemp e where e.nit='" . $_SESSION['nit'] . "') as logo FROM      remisiones WHERE idfacven=" . $_SESSION['par_numfacventa'] . ") nm_sel_esp"; 
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->dirdelcliente = $rs->fields[20] ;  
         $this->dirdelcliente = (string)$this->dirdelcliente;
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $this->logo = "";  
              if (is_file($rs_grid->fields[21])) 
              { 
                  $this->logo = file_get_contents($rs_grid->fields[21]);  
              } 
          } 
         elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
         { 
             $this->logo = $this->Db->BlobDecode($rs->fields[21]) ;  
         } 
         elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
         { 
             $this->logo = $this->Db->BlobDecode($rs->fields[21]) ;  
     ...
     $nm_houve_quebra = "N";
         ...
         //----- lookup - docu_pedido
         $this->Lookup->lookup_docu_pedido($this->docu_pedido, $this->pedido, $this->array_docu_pedido); 
         $this->docu_pedido = str_replace("<br>", " ", $this->docu_pedido); 
         $this->docu_pedido = ($this->docu_pedido == "&nbsp;") ? "" : $this->docu_pedido; 
         //----- lookup - num_pedido
         $this->Lookup->lookup_num_pedido($this->num_pedido, $this->pedido, $this->array_num_pedido); 
         $this->num_pedido = str_replace("<br>", " ", $this->num_pedido); 
         $this->num_pedido = ($this->num_pedido == "&nbsp;") ? "" : $this->num_pedido; 
         $_SESSION['scriptcase']['pdfreport_remision']['contr_erro'] = 'on';
...
if (!isset($this->sc_temp_subt)) {$this->sc_temp_subt = (isset($_SESSION['subt'])) ? $_SESSION['subt'] : "";}
  $this->trae_documento();
      ...
      $nm_select = "select idmuni, direc, telefono, obs  from direccion where iddireccion=$this->dirdelcliente  "; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds = array();
     if ($this->dirdelcliente !== "")
     { 
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
...
$this->sc_temp_eliva=$this->total -$this->sc_temp_subt;
...
$_SESSION['scriptcase']['pdfreport_remision']['contr_erro'] = 'off'; 
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['field_order'] as $Cada_col)
         { 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
      ...
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   function proc_label()
   { 
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['dirdelcliente'])) ? $this->New_label['dirdelcliente'] : "Dirdelcliente"; 
          if ($Cada_col == "dirdelcliente" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          $SC_Label = (isset($this->New_label['docu_pedido'])) ? $this->New_label['docu_pedido'] : "docu_pedido"; 
          if ($Cada_col == "docu_pedido" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          $SC_Label = (isset($this->New_label['num_pedido'])) ? $this->New_label['num_pedido'] : "num_pedido"; 
          if ($Cada_col == "num_pedido" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   function NM_export_nremision()
   {
         ...
         if (is_numeric($this->nremision))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->nremision);
         $this->Xls_col++;
   }
   //----- credito
   ...
   function NM_export_asentada()
   {
         ...
         if (is_numeric($this->asentada))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->asentada);
         $this->Xls_col++;
   }
   //----- observaciones
   ...
   function NM_export_resolucion()
   {
         ...
         if (is_numeric($this->resolucion))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->resolucion);
         $this->Xls_col++;
   }
   //----- dirdelcliente
   function NM_export_dirdelcliente()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->dirdelcliente = NM_charset_to_utf8($this->dirdelcliente);
         if (is_numeric($this->dirdelcliente))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->dirdelcliente);
         $this->Xls_col++;
   }
   //----- logo
   function NM_export_logo()
   {
         ...
         $in_logo = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_logo_" . $_SESSION['scriptcase']['sc_num_img'] . session_id() . ".jpg";
         $_SESSION['scriptcase']['sc_num_img']++;
         $arq_logo = fopen($in_logo, "w");
   ...
   function NM_export_colores()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->colores, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->colores, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- colores_iddet
   function NM_export_colores_iddet()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->colores_iddet = NM_charset_to_utf8($this->colores_iddet);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->colores_iddet, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->colores_iddet, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- colores_iddet2
   function NM_export_colores_iddet2()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->colores_iddet2 = NM_charset_to_utf8($this->colores_iddet2);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->colores_iddet2, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->colores_iddet2, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- detalleventa
   function NM_export_detalleventa()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalleventa, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalleventa, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_detalleventa_cantidad()
   {
         ...
         if (is_numeric($this->detalleventa_cantidad))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalleventa_cantidad);
         $this->Xls_col++;
   }
   ...
   function NM_export_detalleventa_fl_adicional()
   {
         ...
         if (is_numeric($this->detalleventa_fl_adicional))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalleventa_fl_adicional);
         $this->Xls_col++;
   }
   ...
   function NM_export_detalleventa_fl_factor()
   {
         ...
         if (is_numeric($this->detalleventa_fl_factor))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalleventa_fl_factor);
         $this->Xls_col++;
   }
   //----- detalleventa_fl_iva
   function NM_export_detalleventa_fl_iva()
   {
         ...
         if (is_numeric($this->detalleventa_fl_iva))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalleventa_fl_iva);
         $this->Xls_col++;
   }
   ...
   function NM_export_detalleventa_fl_unidadmayor()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalleventa_fl_unidadmayor, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalleventa_fl_unidadmayor, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- detalleventa_idpro
   function NM_export_detalleventa_idpro()
   {
         ...
         if (is_numeric($this->detalleventa_idpro))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalleventa_idpro);
         $this->Xls_col++;
   }
   ...
   function NM_export_detalleventa_p_codigobar()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalleventa_p_codigobar, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalleventa_p_codigobar, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_detalleventa_p_nompro()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalleventa_p_nompro, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalleventa_p_nompro, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_detalleventa_parcial()
   {
         ...
         if (is_numeric($this->detalleventa_parcial))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalleventa_parcial);
         $this->Xls_col++;
   }
   //----- detalleventa_unidad
   function NM_export_detalleventa_unidad()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalleventa_unidad, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalleventa_unidad, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_detalleventa_valorunita()
   {
         ...
         if (is_numeric($this->detalleventa_valorunita))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalleventa_valorunita);
         $this->Xls_col++;
   }
   //----- digito
   function NM_export_digito()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->digito = NM_charset_to_utf8($this->digito);
         if (is_numeric($this->digito))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->digito);
         $this->Xls_col++;
   }
   //----- direccion
   ...
   function NM_export_etiqueta()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->etiqueta, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->etiqueta, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fechares
   function NM_export_fechares()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fechares, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fechares, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ladireccion
   function NM_export_ladireccion()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ladireccion, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ladireccion, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- municipio
   ...
   function NM_export_nomsucursal()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->nomsucursal = html_entity_decode($this->nomsucursal, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nomsucursal = strip_tags($this->nomsucursal);
         $this->nomsucursal = NM_charset_to_utf8($this->nomsucursal);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nomsucursal, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nomsucursal, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- npagina
   function NM_export_npagina()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->npagina = html_entity_decode($this->npagina, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->npagina = strip_tags($this->npagina);
         $this->npagina = NM_charset_to_utf8($this->npagina);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->npagina, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->npagina, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- numnit
   function NM_export_numnit()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->numnit, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->numnit, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- numtele
   function NM_export_numtele()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->numtele, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->numtele, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- prefijo
   ...
   function NM_export_rangofac()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->rangofac, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->rangofac, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- tallas
   function NM_export_tallas()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tallas, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tallas, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- tallas_iddet
   function NM_export_tallas_iddet()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->tallas_iddet = NM_charset_to_utf8($this->tallas_iddet);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tallas_iddet, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tallas_iddet, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- telefono
   ...
   //----- docu_pedido
   function NM_export_docu_pedido()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->docu_pedido = NM_charset_to_utf8($this->docu_pedido);
         if (is_numeric($this->docu_pedido))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->docu_pedido);
         $this->Xls_col++;
   }
   //----- num_pedido
   function NM_export_num_pedido()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->num_pedido = NM_charset_to_utf8($this->num_pedido);
         if (is_numeric($this->num_pedido))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->num_pedido);
         $this->Xls_col++;
   }
   //----- idfacven
   ...
   //----- nremision
   function NM_sub_cons_nremision()
   {
         $this->nremision = NM_charset_to_utf8($this->nremision);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nremision;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
         $this->resolucion = NM_charset_to_utf8($this->resolucion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->resolucion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- dirdelcliente
   function NM_sub_cons_dirdelcliente()
   {
         $this->dirdelcliente = NM_charset_to_utf8($this->dirdelcliente);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->dirdelcliente;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
         $this->colores = NM_charset_to_utf8($this->colores);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->colores;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- colores_iddet
   function NM_sub_cons_colores_iddet()
   {
         $this->colores_iddet = NM_charset_to_utf8($this->colores_iddet);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->colores_iddet;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- colores_iddet2
   function NM_sub_cons_colores_iddet2()
   {
         $this->colores_iddet2 = NM_charset_to_utf8($this->colores_iddet2);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->colores_iddet2;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
         $this->detalleventa = NM_charset_to_utf8($this->detalleventa);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalleventa;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detalleventa_cantidad
   function NM_sub_cons_detalleventa_cantidad()
   {
         $this->detalleventa_cantidad = NM_charset_to_utf8($this->detalleventa_cantidad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalleventa_cantidad;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   //----- detalleventa_fl_adicional
   function NM_sub_cons_detalleventa_fl_adicional()
   {
         $this->detalleventa_fl_adicional = NM_charset_to_utf8($this->detalleventa_fl_adicional);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalleventa_fl_adicional;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detalleventa_fl_factor
   function NM_sub_cons_detalleventa_fl_factor()
   {
         $this->detalleventa_fl_factor = NM_charset_to_utf8($this->detalleventa_fl_factor);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalleventa_fl_factor;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detalleventa_fl_iva
   function NM_sub_cons_detalleventa_fl_iva()
   {
         $this->detalleventa_fl_iva = NM_charset_to_utf8($this->detalleventa_fl_iva);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalleventa_fl_iva;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detalleventa_fl_unidadmayor
   function NM_sub_cons_detalleventa_fl_unidadmayor()
   {
         $this->detalleventa_fl_unidadmayor = html_entity_decode($this->detalleventa_fl_unidadmayor, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->detalleventa_fl_unidadmayor = strip_tags($this->detalleventa_fl_unidadmayor);
         $this->detalleventa_fl_unidadmayor = NM_charset_to_utf8($this->detalleventa_fl_unidadmayor);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalleventa_fl_unidadmayor;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detalleventa_idpro
   function NM_sub_cons_detalleventa_idpro()
   {
         $this->detalleventa_idpro = NM_charset_to_utf8($this->detalleventa_idpro);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalleventa_idpro;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detalleventa_p_codigobar
   function NM_sub_cons_detalleventa_p_codigobar()
   {
         $this->detalleventa_p_codigobar = html_entity_decode($this->detalleventa_p_codigobar, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->detalleventa_p_codigobar = strip_tags($this->detalleventa_p_codigobar);
         $this->detalleventa_p_codigobar = NM_charset_to_utf8($this->detalleventa_p_codigobar);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalleventa_p_codigobar;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detalleventa_p_nompro
   function NM_sub_cons_detalleventa_p_nompro()
   {
         $this->detalleventa_p_nompro = html_entity_decode($this->detalleventa_p_nompro, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->detalleventa_p_nompro = strip_tags($this->detalleventa_p_nompro);
         $this->detalleventa_p_nompro = NM_charset_to_utf8($this->detalleventa_p_nompro);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalleventa_p_nompro;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detalleventa_parcial
   function NM_sub_cons_detalleventa_parcial()
   {
         $this->detalleventa_parcial = NM_charset_to_utf8($this->detalleventa_parcial);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalleventa_parcial;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- detalleventa_unidad
   function NM_sub_cons_detalleventa_unidad()
   {
         $this->detalleventa_unidad = html_entity_decode($this->detalleventa_unidad, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->detalleventa_unidad = strip_tags($this->detalleventa_unidad);
         $this->detalleventa_unidad = NM_charset_to_utf8($this->detalleventa_unidad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalleventa_unidad;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detalleventa_valorunita
   function NM_sub_cons_detalleventa_valorunita()
   {
         $this->detalleventa_valorunita = NM_charset_to_utf8($this->detalleventa_valorunita);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalleventa_valorunita;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- digito
   function NM_sub_cons_digito()
   {
         $this->digito = NM_charset_to_utf8($this->digito);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->digito;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- etiqueta
   function NM_sub_cons_etiqueta()
   {
         $this->etiqueta = html_entity_decode($this->etiqueta, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->etiqueta = strip_tags($this->etiqueta);
         $this->etiqueta = NM_charset_to_utf8($this->etiqueta);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->etiqueta;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- fechares
   function NM_sub_cons_fechares()
   {
         $this->fechares = html_entity_decode($this->fechares, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fechares = strip_tags($this->fechares);
         $this->fechares = NM_charset_to_utf8($this->fechares);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fechares;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- ladireccion
   function NM_sub_cons_ladireccion()
   {
         $this->ladireccion = html_entity_decode($this->ladireccion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ladireccion = strip_tags($this->ladireccion);
         $this->ladireccion = NM_charset_to_utf8($this->ladireccion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ladireccion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- nomsucursal
   function NM_sub_cons_nomsucursal()
   {
         $this->nomsucursal = html_entity_decode($this->nomsucursal, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nomsucursal = strip_tags($this->nomsucursal);
         $this->nomsucursal = NM_charset_to_utf8($this->nomsucursal);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nomsucursal;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- npagina
   function NM_sub_cons_npagina()
   {
         $this->npagina = html_entity_decode($this->npagina, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->npagina = strip_tags($this->npagina);
         $this->npagina = NM_charset_to_utf8($this->npagina);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->npagina;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- numnit
   function NM_sub_cons_numnit()
   {
         $this->numnit = html_entity_decode($this->numnit, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->numnit = strip_tags($this->numnit);
         $this->numnit = NM_charset_to_utf8($this->numnit);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->numnit;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- numtele
   function NM_sub_cons_numtele()
   {
         $this->numtele = html_entity_decode($this->numtele, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->numtele = strip_tags($this->numtele);
         $this->numtele = NM_charset_to_utf8($this->numtele);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->numtele;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- rangofac
   function NM_sub_cons_rangofac()
   {
         $this->rangofac = html_entity_decode($this->rangofac, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->rangofac = strip_tags($this->rangofac);
         $this->rangofac = NM_charset_to_utf8($this->rangofac);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->rangofac;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
         $this->tallas = NM_charset_to_utf8($this->tallas);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tallas;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- tallas_iddet
   function NM_sub_cons_tallas_iddet()
   {
         $this->tallas_iddet = NM_charset_to_utf8($this->tallas_iddet);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tallas_iddet;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- docu_pedido
   function NM_sub_cons_docu_pedido()
   {
         $this->docu_pedido = NM_charset_to_utf8($this->docu_pedido);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->docu_pedido;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- num_pedido
   function NM_sub_cons_num_pedido()
   {
         $this->num_pedido = NM_charset_to_utf8($this->num_pedido);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->num_pedido;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_titl'] ?> - facturaven :: Excel</TITLE>
...
<form name="Fdown" method="get" action="pdfreport_remision_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="pdfreport_remision"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<FORM name="F0" method=post action="./"> 
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
