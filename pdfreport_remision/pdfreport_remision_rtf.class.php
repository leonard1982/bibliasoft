...
class pdfreport_remision_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "pdfreport_remision.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['pdfreport_remision']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['rtf_name']);
      }
...
$_SESSION['scriptcase']['pdfreport_remision']['contr_erro'] = 'off'; 
   ...
   function NM_export_dirdelcliente()
   {
         ...
         $this->dirdelcliente = str_replace('<', '&lt;', $this->dirdelcliente);
         $this->dirdelcliente = str_replace('>', '&gt;', $this->dirdelcliente);
         $this->Texto_tag .= "<td>" . $this->dirdelcliente . "</td>\r\n";
   }
   //----- logo
   ...
   function NM_export_colores_iddet()
   {
         ...
         $this->colores_iddet = str_replace('<', '&lt;', $this->colores_iddet);
         $this->colores_iddet = str_replace('>', '&gt;', $this->colores_iddet);
         $this->Texto_tag .= "<td>" . $this->colores_iddet . "</td>\r\n";
   }
   //----- colores_iddet2
   function NM_export_colores_iddet2()
   {
         $this->colores_iddet2 = NM_charset_to_utf8($this->colores_iddet2);
         $this->colores_iddet2 = str_replace('<', '&lt;', $this->colores_iddet2);
         $this->colores_iddet2 = str_replace('>', '&gt;', $this->colores_iddet2);
         $this->Texto_tag .= "<td>" . $this->colores_iddet2 . "</td>\r\n";
   }
   //----- detalleventa
   ...
   function NM_export_digito()
   {
         ...
         $this->digito = str_replace('<', '&lt;', $this->digito);
         $this->digito = str_replace('>', '&gt;', $this->digito);
         $this->Texto_tag .= "<td>" . $this->digito . "</td>\r\n";
   }
   //----- direccion
   ...
   function NM_export_nomsucursal()
   {
         ...
         $this->nomsucursal = str_replace('<', '&lt;', $this->nomsucursal);
         $this->nomsucursal = str_replace('>', '&gt;', $this->nomsucursal);
         $this->Texto_tag .= "<td>" . $this->nomsucursal . "</td>\r\n";
   }
   //----- npagina
   function NM_export_npagina()
   {
         ...
         $this->npagina = str_replace('<', '&lt;', $this->npagina);
         $this->npagina = str_replace('>', '&gt;', $this->npagina);
         $this->Texto_tag .= "<td>" . $this->npagina . "</td>\r\n";
   }
   //----- numnit
   ...
   function NM_export_tallas_iddet()
   {
         ...
         $this->tallas_iddet = str_replace('<', '&lt;', $this->tallas_iddet);
         $this->tallas_iddet = str_replace('>', '&gt;', $this->tallas_iddet);
         $this->Texto_tag .= "<td>" . $this->tallas_iddet . "</td>\r\n";
   }
   //----- telefono
   ...
   function NM_export_docu_pedido()
   {
         ...
         $this->docu_pedido = str_replace('<', '&lt;', $this->docu_pedido);
         $this->docu_pedido = str_replace('>', '&gt;', $this->docu_pedido);
         $this->Texto_tag .= "<td>" . $this->docu_pedido . "</td>\r\n";
   }
   //----- num_pedido
   function NM_export_num_pedido()
   {
         ...
         $this->num_pedido = str_replace('<', '&lt;', $this->num_pedido);
         $this->num_pedido = str_replace('>', '&gt;', $this->num_pedido);
         $this->Texto_tag .= "<td>" . $this->num_pedido . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
