...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_mini']['glo_nm_perfil']         = "conn_mysql";
    $_SESSION['scriptcase']['menu_mini']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo']      = "";
...
class menu_mini_class
{
 ...
 function menu_mini_menu()
 {
    global $menu_mini_menuData, $nm_data_fixa;
...
$path_img_old   = $str_root . $path_link . "menu_mini/img";
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_mini');
...
include_once(dirname(__FILE__) . "/menu_mini_erro.class.php"); 
$this->Erro = new menu_mini_erro();
$str_path = substr($_SESSION['scriptcase']['menu_mini']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_mini']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_mini']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$menu_mini_menuData         = array();
$menu_mini_menuData['path'] = array();
$menu_mini_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_mini_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_mini_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_mini_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_mini_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_mini_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_mini_menuData['url']['web']   = str_replace("\\", '/', $menu_mini_menuData['url']['web']);
$menu_mini_menuData['path']['root'] = substr($menu_mini_menuData['path']['sys'],  0, -1 * strlen($menu_mini_menuData['url']['web']));
$menu_mini_menuData['path']['app']  = substr($menu_mini_menuData['path']['sys'],  0, strrpos($menu_mini_menuData['path']['sys'],  '/'));
$menu_mini_menuData['path']['link'] = substr($menu_mini_menuData['path']['app'],  0, strrpos($menu_mini_menuData['path']['app'],  '/'));
$menu_mini_menuData['path']['link'] = substr($menu_mini_menuData['path']['link'], 0, strrpos($menu_mini_menuData['path']['link'], '/')) . '/';
$menu_mini_menuData['path']['app'] .= '/';
$menu_mini_menuData['url']['app']   = substr($menu_mini_menuData['url']['web'],  0, strrpos($menu_mini_menuData['url']['web'],  '/'));
$menu_mini_menuData['url']['link']  = substr($menu_mini_menuData['url']['app'],  0, strrpos($menu_mini_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] == "S")
{
    $menu_mini_menuData['url']['link']  = substr($menu_mini_menuData['url']['link'], 0, strrpos($menu_mini_menuData['url']['link'], '/'));
}
$menu_mini_menuData['url']['link']  .= '/';
$menu_mini_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menu_mini']['sc_apl_link'] = $menu_mini_menuData['url']['link'];
...
include_once("menu_mini_toolbar.php");
...
if ($_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_mini";
     $_SESSION['scriptcase']['menu_apls']['menu_mini'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_mini']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_mini']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_mini']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_mini']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_mini']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_mini']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_mini']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_mini']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
{
    $_SESSION['sc_session'][1]['menu_mini']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_mini']['init']))
{
    $_SESSION['sc_session'][1]['menu_mini']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_mini']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_mini']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_mini'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_mini'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_mini'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
      $_SESSION['scriptcase']['menu_mini']['contr_erro'] = 'on';
 ...
 if(empty($this->sc_temp_gusuariologueado))
{
 ...
 {
$this->nmgp_redireciona_form($menu_mini_menuData['url']['link'] . $this->tab_grupo[0] . "" . SC_dir_app_name('blank_iniciar_sesion') . "/", "menu_mini.php", "","_self", 440, 630);
 };
}
if (isset($this->sc_temp_gusuariologueado)) {$_SESSION['gusuariologueado'] = $this->sc_temp_gusuariologueado;}
$_SESSION['scriptcase']['menu_mini']['contr_erro'] = 'off';
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_mini']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_mini']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_mini'))
{
    $_SESSION['sc_session'][1]['menu_mini']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_mini'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$menu_mini_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_menu_rapido_mini") . "/grid_menu_rapido_mini_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_menu_rapido_mini']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_menu_rapido_mini'] = "on";
    }
}
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_clientes_mini") . "/grid_clientes_mini_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes_mini']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_clientes_mini'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_productos_mini") . "/grid_productos_mini_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_productos_mini']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_productos_mini'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_facturaven_pos_mini") . "/grid_facturaven_pos_mini_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven_pos_mini']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven_pos_mini'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[2]))
{
 ...
 $nm_var_lab[3] = "Acerca de nosotros";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[2]))
{
 ...
 $nm_var_hint[3] = "Acerca de nosotros";
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_mini'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes_mini']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes_mini']) == "on")
{
    $menu_mini_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "|menu_mini_form_php.php?sc_item_menu=item_1&sc_apl_menu=grid_clientes_mini&sc_apl_link=" . urlencode($menu_mini_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "|usr__NM__bg__NM__community_users_12977.png|" . $this->menu_mini_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_productos_mini']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_productos_mini']) == "on")
{
    $menu_mini_menuData['data'] .= "item_7|.|" . $nm_var_lab[1] . "|menu_mini_form_php.php?sc_item_menu=item_7&sc_apl_menu=grid_productos_mini&sc_apl_link=" . urlencode($menu_mini_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "|scriptcase__NM__ico__NM__product_green_32.png|" . $this->menu_mini_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven_pos_mini']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven_pos_mini']) == "on")
{
    $menu_mini_menuData['data'] .= "item_14|.|" . $nm_var_lab[2] . "|menu_mini_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_facturaven_pos_mini&sc_apl_link=" . urlencode($menu_mini_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "|usr__NM__bg__NM__business_salesreport_salesreport_negocio_2353.png|" . $this->menu_mini_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank']) == "on")
{
    $menu_mini_menuData['data'] .= "item_16|.|" . $nm_var_lab[3] . "|menu_mini_form_php.php?sc_item_menu=item_16&sc_apl_menu=blank&sc_apl_link=" . urlencode($menu_mini_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "|usr__NM__ico__NM__copyright_icon-icons.com_76791.png|" . $this->menu_mini_target('_self') . "|" . "\n";
}
...
$str_disabled = "N";
$str_link = "menu_mini_form_php.php?sc_item_menu=item_1&sc_apl_menu=grid_clientes_mini&sc_apl_link=" . urlencode($menu_mini_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes_mini']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes_mini']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $icon_aba = "usr__NM__bg__NM__community_users_12977.png";
    $icon_aba_inactive = "usr__NM__bg__NM__community_users_12977.png";
    ...
    $menu_mini_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->menu_mini_target('_self') . "\"",
        'sc_id'    => "item_1",
...
$str_disabled = "N";
$str_link = "menu_mini_form_php.php?sc_item_menu=item_7&sc_apl_menu=grid_productos_mini&sc_apl_link=" . urlencode($menu_mini_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_productos_mini']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_productos_mini']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $icon_aba = "scriptcase__NM__ico__NM__product_green_32.png";
    $icon_aba_inactive = "scriptcase__NM__ico__NM__product_green_32.png";
    if(empty($icon_aba) && isset($arr_menuicons['cons']['active']))
    {
        $icon_aba = $arr_menuicons['cons']['active'];
    }
...
$str_disabled = "N";
$str_link = "menu_mini_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_facturaven_pos_mini&sc_apl_link=" . urlencode($menu_mini_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven_pos_mini']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven_pos_mini']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $icon_aba = "usr__NM__bg__NM__business_salesreport_salesreport_negocio_2353.png";
    $icon_aba_inactive = "usr__NM__bg__NM__business_salesreport_salesreport_negocio_2353.png";
    if(empty($icon_aba) && isset($arr_menuicons['cons']['active']))
    {
        $icon_aba = $arr_menuicons['cons']['active'];
    }
...
$str_disabled = "N";
$str_link = "menu_mini_form_php.php?sc_item_menu=item_16&sc_apl_menu=blank&sc_apl_link=" . urlencode($menu_mini_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_mini_form_php.php?sc_item_menu=item_15&sc_apl_menu=blank_fin_sesion&sc_apl_link=" . urlencode($menu_mini_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_fin_sesion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_fin_sesion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $icon_aba = "scriptcase__NM__ico__NM__exit_32.png";
    $icon_aba_inactive = "scriptcase__NM__ico__NM__exit_32.png";
    if(empty($icon_aba) && isset($arr_menuicons['blank']['active']))
    {
        $icon_aba = $arr_menuicons['blank']['active'];
    }
    ...
    $menu_mini_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->menu_mini_target('_parent') . "\"",
        'sc_id'    => "item_15",
        'disabled' => $str_disabled,
        'display'     => "",
        'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_mini']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_mini']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_mini');
    $menu_mini_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_mini_help.txt"))
{
    $Arq_WebHelp = file("menu_mini_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_mini_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_mini_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_mini']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_mini']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_mini_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_mini']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_mini_menuData['data'][$i_menu]);
       }
    ...
    $menu_mini_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_mini']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_mini']))
{
    $disable_menu = false;
    foreach ($menu_mini_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_mini']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_mini_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
foreach ($menu_mini_menuData['data'] as $chave => $cada_menu)
{
        if($level_to_delete !== false && $menu_mini_menuData['data'][$chave]['level'] > $level_to_delete)
        {
                unset($menu_mini_menuData['data'][$chave]);
        }
        else
        {
                $level_to_delete = false;
                
                if ($menu_mini_menuData['data'][$chave]['disabled'] == 'Y')
                {
                        $level_to_delete = $menu_mini_menuData['data'][$chave]['level'];
                        unset($menu_mini_menuData['data'][$chave]);
                }
        }
}
$menu_mini_menuData['data'] = array_values($menu_mini_menuData['data']);
$flag = 1;
while ($flag == 1)
{
    $flag = 0;
    foreach ($menu_mini_menuData['data'] as $chave => $cada_menu)
    {
        if (!empty($cada_menu))
        {
            if (isset($menu_mini_menuData['data'][$chave + 1]) && !empty($menu_mini_menuData['data'][$chave + 1]))
            {
                if ($menu_mini_menuData['data'][$chave]['link'] == "#")
                {
                    if ($menu_mini_menuData['data'][$chave]['level'] >= $menu_mini_menuData['data'][$chave + 1]['level'] )
                    {
                        unset($menu_mini_menuData['data'][$chave]);
                        $flag = 1;
                    }
            ...
            elseif ($menu_mini_menuData['data'][$chave]['link'] == "#")
            {
                unset($menu_mini_menuData['data'][$chave]);
            }
        }
...
/* Cabecera HTML */
if ($menu_mini_menuData['iframe'])
{
    $menu_mini_menuData['height'] = '100%';
...
{
    $menu_mini_menuData['height'] = '30px';
}

/* Archivos JS */
?>
<script type="text/javascript" src="../_lib/lib/js/jquery-3.6.0.min.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_mini']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_mini']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_mini']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_mini']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->str_schema_all ?>_sweetalert.css" />
<script type="text/javascript" src="menu_mini_message.js"></script>
...
<?php
 $seq = 0;
echo "Tab_iframes[" . $seq . "] = \"menu_mini\";\r\n";
echo "Tab_labels['menu_mini'] = \"Inicio\";\r\n";
echo "Tab_hints['menu_mini'] = \"Inicio\";\r\n";
echo "Tab_abas['menu_mini']   = \"none\";\r\n";
echo "Tab_refresh['menu_mini']   = \"\";\r\n";
echo "Tab_icons['menu_mini'] = \"scriptcase__NM__ico__NM__sc_menu_home_e.png\";\r\n";
echo "Tab_icons_inactive['menu_mini'] = \"scriptcase__NM__ico__NM__sc_menu_home_d.png\";\r\n";
echo "Tab_icon_fa['menu_mini']   = \"\";\r\n";
echo "Tab_icon_fa_inactive['menu_mini']   = \"\";\r\n";
echo "Tab_display['menu_mini']   = \"\";\r\n";
echo "Tab_display_position['menu_mini']   = \"\";\r\n";
echo "Tab_links['menu_mini']   = \"\";\r\n";
         $seq++;
 if(isset($menu_mini_menuData['data']) && !empty($menu_mini_menuData['data']))
 {
 ...
 if(isset($menu_mini_menuData['data_vertical']) && !empty($menu_mini_menuData['data_vertical']))
 {
   foreach ($menu_mini_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_mini_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'menu_mini'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_menu_mini').hide();
    if (str_id == "")
    {
        $('#iframe_menu_mini').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            if (Tab_iframes[i] != 'menu_mini') 
            {
                Iframe_atual = "menu_mini_" + Tab_iframes[i] + '_iframe';
            }
...
function del_aba_td(str_id)
{
    ...
    if (Aba_atual == str_id)
    {
        ...
        if (str_id == "" && Aba_atual != "menu_mini")
        {
            document.getElementById('iframe_menu_mini').click();
        }
        else
        {
            mudaIframe(str_id);
        ...
        }function openMenuItem(str_id)
{
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_menu_mini', 'menu_mini');
    if (str_target == "menu_mini_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
    ...
    if(str_target != '_blank' && $('#iframe_menu_mini').length)
        $('#iframe_menu_mini')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_menu_rapido_mini']) && $_SESSION['scriptcase']['sc_apl_seg']['grid_menu_rapido_mini'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_mini');\" item-href=\"menu_mini_form_php.php?sc_item_menu=menu_mini&sc_apl_menu=grid_menu_rapido_mini&sc_apl_link=" . urlencode($menu_mini_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_mini_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_mini_pag_ini.php");
} 
?>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_menu_mini').click()";
    echo "</script>";
}
...
/* Control de Target */
function menu_mini_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function menu_mini_target($str_target)
{
    global $menu_mini_menuData;
    ...
    elseif ($menu_mini_menuData['iframe'])
    {
        return 'menu_mini_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_mini_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_mini_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_mini_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_mini_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_mini_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mini']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_mini_target( $arr_item['target']) : "_self"; 
           }
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        return  $_SESSION['scriptcase']['menu_mini']['sc_init'][$apl_menu];
   }
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0)
   {
      ...
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][1]['menu_mini'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      {
          $nm_apl_dest = str_replace(".php", "", $nm_apl_dest);
          $nm_apl_dest = $menu_mini_menuData['url']['link'] . $this->tab_grupo[0] .$nm_apl_dest . "/" . $nm_apl_dest . ".php";
      }
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
$contr_menu_mini = new menu_mini_class;
$contr_menu_mini->menu_mini_menu();
