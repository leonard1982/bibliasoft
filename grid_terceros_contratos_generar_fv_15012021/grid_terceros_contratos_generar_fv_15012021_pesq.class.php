...
class grid_terceros_contratos_generar_fv_15012021_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['opcao'] = "igual";
    if (!$this->NM_ajax_flag && (!isset($bprocessa) || $bprocessa != "pesq"))
    {
      global $zona_cond, $zona,
             $fecha_documento_cond, $fecha_documento, $fecha_documento_dia, $fecha_documento_mes, $fecha_documento_ano,
             ...
             $numero_contrato_cond, $numero_contrato, $numero_contrato_autocomp,
             $cliente_cond, $cliente, $cliente_autocomp,
             $estado_cond, $estado;
      $_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_15012021']['contr_erro'] = 'on';
 $anio_liquidar     = date("Y");
$periodo_liquidar  = str_pad(date("m"),2,"0", STR_PAD_LEFT);
$fecha_documento   = date("Y-m-d");
$_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_15012021']['contr_erro'] = 'off'; 
      if (isset($fecha_documento_day))
      {
          $fecha_documento_dia = $fecha_documento_day; 
      }
      if (isset($fecha_documento_month))
      {
          $fecha_documento_mes = $fecha_documento_month; 
      }
      if (isset($fecha_documento_year))
      {
          $fecha_documento_ano = $fecha_documento_year; 
      }
      if (isset($fecha_documento))
      {
          $fecha_documento = str_replace("0000", "", $fecha_documento);
          $fecha_documento = str_replace("-00", "-", $fecha_documento);
          $fecha_documentoXX = explode("-", $fecha_documento);
          if (isset($fecha_documentoXX[2]))
          {
              $fecha_documento_dia = $fecha_documentoXX[2]; 
          }
          if (isset($fecha_documentoXX[1]))
          {
              $fecha_documento_mes = $fecha_documentoXX[1]; 
          }
          if (isset($fecha_documentoXX[0]))
          {
              $fecha_documento_ano = $fecha_documentoXX[0]; 
          }
      }
      if (isset($fecha_inicio_day))
      {
          $fecha_inicio_dia = $fecha_inicio_day; 
      }
      if (isset($fecha_inicio_month))
      {
          $fecha_inicio_mes = $fecha_inicio_month; 
      }
      if (isset($fecha_inicio_year))
      {
          $fecha_inicio_ano = $fecha_inicio_year; 
      }
      if (isset($fecha_inicio))
      {
          $fecha_inicio = str_replace("0000", "", $fecha_inicio);
          $fecha_inicio = str_replace("-00", "-", $fecha_inicio);
          $fecha_inicioXX = explode("-", $fecha_inicio);
          if (isset($fecha_inicioXX[2]))
          {
              $fecha_inicio_dia = $fecha_inicioXX[2]; 
          }
          if (isset($fecha_inicioXX[1]))
          {
              $fecha_inicio_mes = $fecha_inicioXX[1]; 
          }
          if (isset($fecha_inicioXX[0]))
          {
              $fecha_inicio_ano = $fecha_inicioXX[0]; 
          }
      }
      if (isset($fecha_inicio_input_2_day))
      {
          $fecha_inicio_input_2_dia = $fecha_inicio_input_2_day; 
      }
      if (isset($fecha_inicio_input_2_month))
      {
          $fecha_inicio_input_2_mes = $fecha_inicio_input_2_month; 
      }
      if (isset($fecha_inicio_input_2_year))
      {
          $fecha_inicio_input_2_ano = $fecha_inicio_input_2_year; 
      }
      if (isset($fecha_inicio_2))
      {
          $fecha_inicio_2 = str_replace("0000", "", $fecha_inicio_2);
          $fecha_inicio_2 = str_replace("-00", "-", $fecha_inicio_2);
          $fecha_inicioXX = explode("-", $fecha_inicio_2);
          if (isset($fecha_inicioXX[2]))
          {
              $fecha_inicio_input_2_dia = $fecha_inicioXX[2]; 
          }
          if (isset($fecha_inicioXX[1]))
          {
              $fecha_inicio_input_2_mes = $fecha_inicioXX[1]; 
          }
          if (isset($fecha_inicioXX[0]))
          {
              $fecha_inicio_input_2_ano = $fecha_inicioXX[0]; 
          }
      }
    }
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_terceros_contratos_generar_fv_15012021_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_terceros_contratos_generar_fv_15012021_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_terceros_contratos_generar_fv_15012021_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_cliente($cliente)
   {
      ...
      { 
          $nm_comando = "select idtercero, documento + ' - ' + nombres from terceros where  documento + ' - ' + nombres like '%" . $cliente . "%' order by documento, nombres" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "select idtercero, concat(documento,' - ',nombres) from terceros where  concat(documento,' - ',nombres) like '%" . $cliente . "%' order by documento, nombres" ; 
      } 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Generar Factura a Contratos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_terceros_contratos_generar_fv_15012021/grid_terceros_contratos_generar_fv_15012021_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_terceros_contratos_generar_fv_15012021_ajax_search.js"></script>
 <script type="text/javascript" src="grid_terceros_contratos_generar_fv_15012021_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_terceros_contratos_generar_fv_15012021_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_15012021']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_15012021']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['ajax_nav'])
           { 
...
function scJQCalendarAdd() {
  $("#sc_fecha_inicio_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fecha_inicio_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_inicio_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_inicio_ano').value;
          document.getElementById('sc_fecha_inicio_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fecha_inicio_dia').value = aParts[0];
          document.getElementById('SC_fecha_inicio_mes').value = aParts[1];
          document.getElementById('SC_fecha_inicio_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_fecha_inicio_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fecha_inicio_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_inicio_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_inicio_input_2_ano').value;
          document.getElementById('sc_fecha_inicio_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fecha_inicio_input_2_dia').value = aParts[0];
          document.getElementById('SC_fecha_inicio_input_2_mes').value = aParts[1];
          document.getElementById('SC_fecha_inicio_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_fecha_documento_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fecha_documento_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_documento_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_documento_ano').value;
          document.getElementById('sc_fecha_documento_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fecha_documento_dia').value = aParts[0];
          document.getElementById('SC_fecha_documento_mes').value = aParts[1];
          document.getElementById('SC_fecha_documento_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_fecha_documento_cond#NMF#' + search_get_sel_txt('SC_fecha_documento_cond') + '@NMF@';
  str_out += 'SC_fecha_documento_dia#NMF#' + search_get_sel_txt('SC_fecha_documento_dia') + '@NMF@';
  str_out += 'SC_fecha_documento_mes#NMF#' + search_get_sel_txt('SC_fecha_documento_mes') + '@NMF@';
  str_out += 'SC_fecha_documento_ano#NMF#' + search_get_sel_txt('SC_fecha_documento_ano') + '@NMF@';
  str_out += 'SC_fecha_documento_input_2_dia#NMF#' + search_get_sel_txt('SC_fecha_documento_input_2_dia') + '@NMF@';
  str_out += 'SC_fecha_documento_input_2_mes#NMF#' + search_get_sel_txt('SC_fecha_documento_input_2_mes') + '@NMF@';
  str_out += 'SC_fecha_documento_input_2_ano#NMF#' + search_get_sel_txt('SC_fecha_documento_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Generar Factura a Contratos</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_contratos_generar_fv_15012021']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_contratos_generar_fv_15012021']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_contratos_generar_fv_15012021']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_terceros_contratos_generar_fv_15012021", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $zona = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['zona']; 
          $zona_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['zona_cond']; 
          $fecha_documento_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_documento_dia']; 
          $fecha_documento_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_documento_mes']; 
          $fecha_documento_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_documento_ano']; 
          $fecha_documento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_documento_cond']; 
          $fecha_inicio_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_dia']; 
          $fecha_inicio_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_mes']; 
          $fecha_inicio_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_ano']; 
          $fecha_inicio_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_input_2_dia']; 
          $fecha_inicio_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_input_2_mes']; 
          $fecha_inicio_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_input_2_ano']; 
          $fecha_inicio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_cond']; 
          $numero_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['numero_contrato']; 
          $numero_contrato_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['numero_contrato_cond']; 
          $cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['cliente']; 
          $cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['cliente_cond']; 
          $estado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['estado']; 
          $estado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['estado_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['NM_operador']; 
      } 
      if (!isset($zona_cond) || empty($zona_cond))
      {
         $zona_cond = "eq";
      }
      if (!isset($fecha_documento_cond) || empty($fecha_documento_cond))
      {
         $fecha_documento_cond = "eq";
      }
      if (!isset($fecha_inicio_cond) || empty($fecha_inicio_cond))
      {
         $fecha_inicio_cond = "bw";
      }
      if (!isset($numero_contrato_cond) || empty($numero_contrato_cond))
      {
         $numero_contrato_cond = "eq";
      }
      ...
      $str_hide_fecha_documento = (in_array($fecha_documento_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_fecha_documento = ('bw' == $fecha_documento_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($fecha_documento) || $fecha_documento == "")
      {
          $fecha_documento = "";
      }
      if (isset($fecha_documento) && !empty($fecha_documento))
      {
         $tmp_pos = strpos($fecha_documento, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fecha_documento = substr($fecha_documento, 0, $tmp_pos);
         }
      }
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['psq_check_ret']['zona'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['psq_check_ret']['zona'][] = trim($rs->fields[0]);
...
?>
      ...
      <TD id='SC_fecha_documento_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fecha_documento'])) ? $this->New_label['fecha_documento'] : "Fecha documento"; ?> <span class="scFilterRequiredOdd">*</span></TD>
      
      <INPUT type="hidden" id="SC_fecha_documento_cond" name="fecha_documento_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fecha_documento" <?php echo $str_hide_fecha_documento?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['fecha_documento'])) ? $this->New_label['fecha_documento'] : "Fecha documento";
 $nmgp_tab_label .= "fecha_documento?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
         ...
         <span id='id_date_part_fecha_documento_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_documento_dia" name="fecha_documento_dia" value="<?php echo NM_encode_input($fecha_documento_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
</span>
<span id='id_date_part_fecha_documento_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_documento_mes" name="fecha_documento_mes" value="<?php echo NM_encode_input($fecha_documento_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
</span>
<span id='id_date_part_fecha_documento_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_documento_ano" name="fecha_documento_ano" value="<?php echo NM_encode_input($fecha_documento_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: true}">
 <INPUT type="hidden" id="sc_fecha_documento_jq">
</span>
      ...
      <INPUT type="hidden" id="SC_fecha_inicio_cond" name="fecha_inicio_cond" value="bw">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_inicio_dia" name="fecha_inicio_dia" value="<?php echo NM_encode_input($fecha_inicio_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_inicio_mes" name="fecha_inicio_mes" value="<?php echo NM_encode_input($fecha_inicio_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_inicio_ano" name="fecha_inicio_ano" value="<?php echo NM_encode_input($fecha_inicio_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: true}">
 <INPUT type="hidden" id="sc_fecha_inicio_jq">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_inicio_input_2_dia" name="fecha_inicio_input_2_dia" value="<?php echo NM_encode_input($fecha_inicio_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_inicio_input_2_mes" name="fecha_inicio_input_2_mes" value="<?php echo NM_encode_input($fecha_inicio_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_inicio_input_2_ano" name="fecha_inicio_input_2_ano" value="<?php echo NM_encode_input($fecha_inicio_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: true}">
 <INPUT type="hidden" id="sc_fecha_inicio_jq2">
</span>
...
?>
      ...
      <TD id='SC_numero_contrato_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['numero_contrato'])) ? $this->New_label['numero_contrato'] : "Contrato"; ?></TD>
      
      <INPUT type="hidden" id="SC_numero_contrato_cond" name="numero_contrato_cond" value="eq">
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-numero_contrato" id="id_ac_numero_contrato" name="numero_contrato_autocomp"><?php if ('' !=  $numero_contrato) { ?><option value="<?php echo $numero_contrato ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_comando = "select idtercero, documento + ' - ' + nombres from terceros where idtercero = '$cliente_look' order by documento, nombres" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "select idtercero, concat(documento,' - ',nombres) from terceros where idtercero = '$cliente_look' order by documento, nombres" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select idtercero, documento&' - '&nombres from terceros where idtercero = '$cliente_look' order by documento, nombres" ; 
...
?>
<INPUT  type="text" id="SC_cliente" name="cliente" value="<?php echo NM_encode_input($cliente) ?>"  size=14 alt="{datatype: 'text', maxLength: 14, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: true}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cliente" name="cliente_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: true}">
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['psq_check_ret']['estado'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['psq_check_ret']['estado'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
<?php
   if (is_file("grid_terceros_contratos_generar_fv_15012021_help.txt"))
   {
      $Arq_WebHelp = file("grid_terceros_contratos_generar_fv_15012021_help.txt"); 
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['opc_psq'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['sc_modal'])
       {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fecha_documento_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fecha_documento'), document.F1.fecha_documento_cond, 'fecha_documento');
   document.F1.fecha_documento_dia.value = "";
   document.F1.fecha_documento_mes.value = "";
   document.F1.fecha_documento_ano.value = "";
   document.F1.fecha_inicio_cond.value = 'bw';
   ...
   document.F1.numero_contrato_cond.value = 'eq';
 ...
 {
    $('#SC_fecha_documento_dia').bind('change', function() {sc_grid_terceros_contratos_generar_fv_15012021_valida_dia(this)});
    $('#SC_fecha_documento_mes').bind('change', function() {sc_grid_terceros_contratos_generar_fv_15012021_valida_mes(this)});
    $('#SC_fecha_inicio_dia').bind('change', function() {sc_grid_terceros_contratos_generar_fv_15012021_valida_dia(this)});
    $('#SC_fecha_inicio_input_2_dia').bind('change', function() {sc_grid_terceros_contratos_generar_fv_15012021_valida_dia(this)});
    $('#SC_fecha_inicio_input_2_mes').bind('change', function() {sc_grid_terceros_contratos_generar_fv_15012021_valida_mes(this)});
    $('#SC_fecha_inicio_mes').bind('change', function() {sc_grid_terceros_contratos_generar_fv_15012021_valida_mes(this)});
 }
 function sc_grid_terceros_contratos_generar_fv_15012021_valida_dia(obj)
 {
 ...
 function sc_grid_terceros_contratos_generar_fv_15012021_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_terceros_contratos_generar_fv_15012021";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_terceros_contratos_generar_fv_15012021/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fecha_documento_cond'] = 'cond';
      $tp_fields['SC_fecha_documento_dia'] = 'text';
      $tp_fields['SC_fecha_documento_mes'] = 'text';
      $tp_fields['SC_fecha_documento_ano'] = 'text';
      $tp_fields['SC_fecha_documento_input_2_dia'] = 'text';
      $tp_fields['SC_fecha_documento_input_2_mes'] = 'text';
      $tp_fields['SC_fecha_documento_input_2_ano'] = 'text';
   ...
   function trata_campos()
   {
      global $zona_cond, $zona,
             ...
             $numero_contrato_cond, $numero_contrato, $numero_contrato_autocomp,
             $cliente_cond, $cliente, $cliente_autocomp,
             $estado_cond, $estado, $nmgp_tab_label;
      ...
      $fecha_documento_cond_salva = $fecha_documento_cond; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca'];
      }
      if (!$this->NM_ajax_flag || $this->NM_ajax_opcao != "ajax_grid_search")
      {
          if ($zona_cond != "nu" && $zona_cond != "nn" && $zona_cond != "ep" && $zona_cond != "ne")
          {
              if ($zona == "")
              {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['psq_check_ret']['zona'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Zona : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      if (!$this->NM_ajax_flag || $this->NM_ajax_opcao != "ajax_grid_search")
      {
          if ($fecha_documento_cond != "nu" && $fecha_documento_cond != "nn" && $fecha_documento_cond != "ep" && $fecha_documento_cond != "ne")
          {
              if ($fecha_documento_dia == "" && $fecha_documento_mes == "" && $fecha_documento_ano == "")
              {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Fecha documento : " . $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
              }
          }
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['psq_check_ret']['estado'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['zona'] = $zona; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['zona_cond'] = $zona_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_documento_dia'] = $fecha_documento_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_documento_mes'] = $fecha_documento_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_documento_ano'] = $fecha_documento_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_documento_cond'] = $fecha_documento_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_dia'] = $fecha_inicio_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_mes'] = $fecha_inicio_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_ano'] = $fecha_inicio_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_input_2_dia'] = $fecha_inicio_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_input_2_mes'] = $fecha_inicio_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_input_2_ano'] = $fecha_inicio_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_cond'] = $fecha_inicio_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['numero_contrato'] = $numero_contrato; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['numero_contrato_cond'] = $numero_contrato_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['cliente'] = $cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['cliente_cond'] = $cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['estado'] = $estado; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['estado_cond'] = $estado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca'] = $Temp_Busca;
      }
      if ($numero_contrato_cond != "in" && $numero_contrato_cond != "bw" && !empty($numero_contrato) && !is_numeric($numero_contrato))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Contrato";
      }
      ...
      $fecha_documento_year  = $fecha_documento_ano; 
      $fecha_documento_diaSv = $fecha_documento_dia; 
      $fecha_documento_mesSv = $fecha_documento_mes; 
      $fecha_documento_anoSv = $fecha_documento_ano; 
      $fecha_documento  = str_repeat(0, (4 - strlen($fecha_documento_ano))) . $fecha_documento_ano . "-"; 
      $fecha_documento .= str_repeat(0, (2 - strlen($fecha_documento_mes))) . $fecha_documento_mes . "-"; 
      $fecha_documento .= str_repeat(0, (2 - strlen($fecha_documento_dia))) . $fecha_documento_dia; 
      $fecha_inicio_day   = $fecha_inicio_dia; 
      $fecha_inicio_month = $fecha_inicio_mes; 
      $fecha_inicio_year  = $fecha_inicio_ano; 
      $fecha_inicio_diaSv = $fecha_inicio_dia; 
      $fecha_inicio_mesSv = $fecha_inicio_mes; 
      $fecha_inicio_anoSv = $fecha_inicio_ano; 
      $fecha_inicio  = str_repeat(0, (4 - strlen($fecha_inicio_ano))) . $fecha_inicio_ano . "-"; 
      $fecha_inicio .= str_repeat(0, (2 - strlen($fecha_inicio_mes))) . $fecha_inicio_mes . "-"; 
      $fecha_inicio .= str_repeat(0, (2 - strlen($fecha_inicio_dia))) . $fecha_inicio_dia; 
      $fecha_inicio_input_2_day   = $fecha_inicio_input_2_dia; 
      $fecha_inicio_input_2_month = $fecha_inicio_input_2_mes; 
      $fecha_inicio_input_2_year  = $fecha_inicio_input_2_ano; 
      $fecha_inicio_input_2_diaSv = $fecha_inicio_input_2_dia; 
      $fecha_inicio_input_2_mesSv = $fecha_inicio_input_2_mes; 
      $fecha_inicio_input_2_anoSv = $fecha_inicio_input_2_ano; 
      $fecha_inicio_2  = str_repeat(0, (4 - strlen($fecha_inicio_input_2_ano))) . $fecha_inicio_input_2_ano . "-"; 
      $fecha_inicio_2 .= str_repeat(0, (2 - strlen($fecha_inicio_input_2_mes))) . $fecha_inicio_input_2_mes . "-"; 
      $fecha_inicio_2 .= str_repeat(0, (2 - strlen($fecha_inicio_input_2_dia))) . $fecha_inicio_input_2_dia; 
      $_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_15012021']['contr_erro'] = 'on';
if (!isset($_SESSION['gresolucion'])) {$_SESSION['gresolucion'] = "";}
if (!isset($this->sc_temp_gresolucion)) {$this->sc_temp_gresolucion = (isset($_SESSION['gresolucion'])) ? $_SESSION['gresolucion'] : "";}
...
if (!isset($_SESSION['gdia'])) {$_SESSION['gdia'] = "";}
if (!isset($this->sc_temp_gdia)) {$this->sc_temp_gdia = (isset($_SESSION['gdia'])) ? $_SESSION['gdia'] : "";}
if (!isset($_SESSION['gfecha_documento'])) {$_SESSION['gfecha_documento'] = "";}
if (!isset($this->sc_temp_gfecha_documento)) {$this->sc_temp_gfecha_documento = (isset($_SESSION['gfecha_documento'])) ? $_SESSION['gfecha_documento'] : "";}
...
if (!isset($_SESSION['gcodzona'])) {$_SESSION['gcodzona'] = "";}
if (!isset($this->sc_temp_gcodzona)) {$this->sc_temp_gcodzona = (isset($_SESSION['gcodzona'])) ? $_SESSION['gcodzona'] : "";}
if (!isset($_SESSION['gperiodo'])) {$_SESSION['gperiodo'] = "";}
if (!isset($this->sc_temp_gperiodo)) {$this->sc_temp_gperiodo = (isset($_SESSION['gperiodo'])) ? $_SESSION['gperiodo'] : "";}
if (!isset($_SESSION['ganio'])) {$_SESSION['ganio'] = "";}
if (!isset($this->sc_temp_ganio)) {$this->sc_temp_ganio = (isset($_SESSION['ganio'])) ? $_SESSION['ganio'] : "";}
 $this->sc_temp_ganio       = date("Y");
$this->sc_temp_gperiodo    = date("m");
$this->sc_temp_gcodzona    = $zona ;
$this->sc_temp_gmensaje    = "";
$this->sc_temp_gfecha_documento = $fecha_documento ;
$this->sc_temp_gdia        = date("d");   
$vsql = "select prefijo,Idres from resdian where Idres=(select zc.resolucion from zona_clientes zc where zc.codigo='".$zona ."' limit 1)";
...
if(isset($vpj[0][0]))
{
	$this->sc_temp_gprefijo    = $vpj[0][0];
	$this->sc_temp_gresolucion = $vpj[0][1];
}
else
{
	$this->sc_temp_gprefijo    = "";
	$this->sc_temp_gresolucion = "";
}

if(empty($this->sc_temp_gprefijo))
{
	
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "La zona no tiene relacionado un prefijo de factura electrónica, ir a Menú/Terceros/Zona Terceros y asignar uno.";
;
}

$vdiagenerac = date("d");
$vperiodoactual = date("Y-m");
$vdiagenerac = str_pad($vdiagenerac, 2, "0", STR_PAD_LEFT);
$v_fap          = $this->sc_temp_gfecha_documento;
$v_fap          = date_create($v_fap);
$v_anio         = date_format($v_fap,"Y");
$v_periodo      = date_format($v_fap,"m");
$v_dia          = date_format($v_fap,"d");
$this->sc_temp_ganio         = $v_anio;
$this->sc_temp_gperiodo      = $v_periodo;
$this->sc_temp_gdia          = $v_dia;
$vfecha      = $this->sc_temp_ganio."-".str_pad($this->sc_temp_gperiodo, 2, "0", STR_PAD_LEFT)."-".$vdiagenerac;
$vfecha      = date_create($vfecha);
$vperiodoseleccionado = date_format($vfecha,"Y-m");

if($vperiodoactual!=$vperiodoseleccionado)
{
	$this->sc_temp_gmensaje = "<div style='color:red;'>LA EL PERIODO ACTUAL Y EL PERIODO SELECCIONADO SON DISTINTOS!!!</div>";
}
if (isset($this->sc_temp_ganio)) {$_SESSION['ganio'] = $this->sc_temp_ganio;}
if (isset($this->sc_temp_gperiodo)) {$_SESSION['gperiodo'] = $this->sc_temp_gperiodo;}
if (isset($this->sc_temp_gcodzona)) {$_SESSION['gcodzona'] = $this->sc_temp_gcodzona;}
if (isset($this->sc_temp_gmensaje)) {$_SESSION['gmensaje'] = $this->sc_temp_gmensaje;}
if (isset($this->sc_temp_gfecha_documento)) {$_SESSION['gfecha_documento'] = $this->sc_temp_gfecha_documento;}
if (isset($this->sc_temp_gdia)) {$_SESSION['gdia'] = $this->sc_temp_gdia;}
if (isset($this->sc_temp_gprefijo)) {$_SESSION['gprefijo'] = $this->sc_temp_gprefijo;}
if (isset($this->sc_temp_gresolucion)) {$_SESSION['gresolucion'] = $this->sc_temp_gresolucion;}
$_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_15012021']['contr_erro'] = 'off'; 
      if ($zona_LKP == $zona)
      {
          $zona = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['zona'];
      ...
      {
          $fecha_documento_dia = $fecha_documento_day; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_documento_dia'] = $fecha_documento_dia; 
      }
      if ($fecha_documento_month != $fecha_documento_mesSv)
      {
          $fecha_documento_mes = $fecha_documento_month; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_documento_mes'] = $fecha_documento_mes; 
      }
      if ($fecha_documento_year != $fecha_documento_anoSv)
      {
          $fecha_documento_ano = $fecha_documento_year; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_documento_ano'] = $fecha_documento_ano; 
      }
      $fecha_documento = str_replace("0000", "", $fecha_documento);
      $fecha_documento = str_replace("-00", "-", $fecha_documento);
      $fecha_documentoXX = explode("-", $fecha_documento);
      if (isset($fecha_documentoXX[2]) && $fecha_documentoXX[2] != $fecha_documento_diaSv)
      {
          $fecha_documento_dia = $fecha_documentoXX[2]; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_documento_dia'] = $fecha_documentoXX[2]; 
      }
      if (isset($fecha_documentoXX[1]) && $fecha_documentoXX[1] != $fecha_documento_mesSv)
      {
          $fecha_documento_mes = $fecha_documentoXX[1]; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_documento_mes'] = $fecha_documentoXX[1]; 
      }
      if (isset($fecha_documentoXX[0]) && $fecha_documentoXX[0] != $fecha_documento_anoSv)
      {
          $fecha_documento_ano = $fecha_documentoXX[0]; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_documento_ano'] = $fecha_documentoXX[0]; 
      }
      if ($fecha_inicio_day != $fecha_inicio_diaSv)
      {
          $fecha_inicio_dia = $fecha_inicio_day; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_inicio_dia'] = $fecha_inicio_dia; 
      }
      if ($fecha_inicio_month != $fecha_inicio_mesSv)
      {
          $fecha_inicio_mes = $fecha_inicio_month; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_inicio_mes'] = $fecha_inicio_mes; 
      }
      if ($fecha_inicio_year != $fecha_inicio_anoSv)
      {
          $fecha_inicio_ano = $fecha_inicio_year; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_inicio_ano'] = $fecha_inicio_ano; 
      }
      $fecha_inicio = str_replace("0000", "", $fecha_inicio);
      $fecha_inicio = str_replace("-00", "-", $fecha_inicio);
      $fecha_inicioXX = explode("-", $fecha_inicio);
      if (isset($fecha_inicioXX[2]) && $fecha_inicioXX[2] != $fecha_inicio_diaSv)
      {
          $fecha_inicio_dia = $fecha_inicioXX[2]; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_inicio_dia'] = $fecha_inicioXX[2]; 
      }
      if (isset($fecha_inicioXX[1]) && $fecha_inicioXX[1] != $fecha_inicio_mesSv)
      {
          $fecha_inicio_mes = $fecha_inicioXX[1]; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_inicio_mes'] = $fecha_inicioXX[1]; 
      }
      if (isset($fecha_inicioXX[0]) && $fecha_inicioXX[0] != $fecha_inicio_anoSv)
      {
          $fecha_inicio_ano = $fecha_inicioXX[0]; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_inicio_ano'] = $fecha_inicioXX[0]; 
      }
      if ($fecha_inicio_input_2_day != $fecha_inicio_input_2_diaSv)
      {
          $fecha_inicio_input_2_dia = $fecha_inicio_input_2_day; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_inicio_input_2_dia'] = $fecha_inicio_input_2_dia; 
      }
      if ($fecha_inicio_input_2_month != $fecha_inicio_input_2_mesSv)
      {
          $fecha_inicio_input_2_mes = $fecha_inicio_input_2_month; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_inicio_input_2_mes'] = $fecha_inicio_input_2_mes; 
      }
      if ($fecha_inicio_input_2_year != $fecha_inicio_input_2_anoSv)
      {
          $fecha_inicio_input_2_ano = $fecha_inicio_input_2_year; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_inicio_input_2_ano'] = $fecha_inicio_input_2_ano; 
      }
      $fecha_inicio_2 = str_replace("0000", "", $fecha_inicio_2);
      $fecha_inicio_2 = str_replace("-00", "-", $fecha_inicio_2);
      $fecha_inicioXX = explode("-", $fecha_inicio_2);
      if (isset($fecha_inicioXX[2]) && $fecha_inicioXX[2] != $fecha_inicio_input_2_diaSv)
      {
          $fecha_inicio_input_2_dia = $fecha_inicioXX[2]; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_inicio_input_2_dia'] = $fecha_inicioXX[2]; 
      }
      if (isset($fecha_inicioXX[1]) && $fecha_inicioXX[1] != $fecha_inicio_input_2_mesSv)
      {
          $fecha_inicio_input_2_mes = $fecha_inicioXX[1]; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_inicio_input_2_mes'] = $fecha_inicioXX[1]; 
      }
      if (isset($fecha_inicioXX[0]) && $fecha_inicioXX[0] != $fecha_inicio_input_2_anoSv)
      {
          $fecha_inicio_input_2_ano = $fecha_inicioXX[0]; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['']['campos_busca']['fecha_inicio_input_2_ano'] = $fecha_inicioXX[0]; 
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
   ...
   { 
    ...
    if ($cliente != '') {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca_ant']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca'];
      }
      ...
      //----- $fecha_documento
      $this->Date_part = false;
      if ($fecha_documento_cond != "bi_TP")
      {
          $fecha_documento_cond = strtoupper($fecha_documento_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $fecha_documento_ano;
          $Dtxt .= $fecha_documento_mes;
          $Dtxt .= $fecha_documento_dia;
          $val[0]['ano'] = $fecha_documento_ano;
          $val[0]['mes'] = $fecha_documento_mes;
          $val[0]['dia'] = $fecha_documento_dia;
          if ($fecha_documento_cond == "BW")
          {
              $val[1]['ano'] = $fecha_documento_input_2_ano;
              $val[1]['mes'] = $fecha_documento_input_2_mes;
              $val[1]['dia'] = $fecha_documento_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $fecha_documento_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $fecha_documento_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fecha_documento = $val[0];
          $this->cmp_formatado['fecha_documento'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_documento'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fecha_documento'], "YYYY-MM-DD");
          $this->cmp_formatado['fecha_documento'] = $this->nm_data->FormataSaida("d/m/Y");
          if ($fecha_documento_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $fecha_documento_input_2     = $val[1];
              $this->cmp_formatado['fecha_documento_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_documento_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fecha_documento_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['fecha_documento_input_2'] = $this->nm_data->FormataSaida("d/m/Y");
          }
      }
      ...
      if ($fecha_inicio_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio'] = $val[0];
          ...
          if ($fecha_inicio_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']['fecha_inicio_input_2'] = $val[1];
      ...
      {
         $this->monta_condicao("numero_contrato", $numero_contrato_cond, $numero_contrato, "", "numero_contrato");
      }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['where_pesq_ant'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca_ant'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['campos_busca'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_15012021']['where_pesq'];
