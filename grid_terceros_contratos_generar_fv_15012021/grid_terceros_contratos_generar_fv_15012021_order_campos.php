...
<?php
   ...
   $Ord_Cmp = new grid_terceros_contratos_generar_fv_15012021_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_terceros_contratos_generar_fv_15012021_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['numero_contrato'] = "numero_contrato";
   $tab_labels["numero_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["numero_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["numero_contrato"] : "Contrato";
   $tab_ger_campos['cliente'] = "on";
   $tab_def_campos['cliente'] = "cliente";
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["cliente"] : "Cliente";
   $tab_ger_campos['fecha_inicio'] = "on";
   $tab_def_campos['fecha_inicio'] = "fecha_inicio";
   $tab_labels["fecha_inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["fecha_inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["fecha_inicio"] : "Fecha Inicio";
   $tab_ger_campos['zona'] = "on";
   $tab_def_campos['zona'] = "zona";
   $tab_labels["zona"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["zona"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["zona"] : "Zona";
   $tab_ger_campos['estado'] = "on";
   $tab_def_campos['estado'] = "estado";
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["estado"] : "Estado";
   $tab_ger_campos['mensualidad'] = "on";
   $tab_def_campos['mensualidad'] = "mensualidad";
   $tab_labels["mensualidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["mensualidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["mensualidad"] : "Mensualidad";
   ...
   $tab_labels["detalle"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["detalle"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["detalle"] : "Detalle";
   $tab_ger_campos['novedades'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['novedades'] = "novedades";
   }
   else
   {
       $tab_def_campos['novedades'] = "";
   }
   $tab_labels["novedades"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["novedades"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["novedades"] : "Novedades";
   $tab_ger_campos['fecha_factura'] = "on";
   $tab_def_campos['fecha_factura'] = "fecha_factura";
   $tab_labels["fecha_factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["fecha_factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['labels']["fecha_factura"] : "U.Factura";
   $tab_ger_campos['detalle'] = "none";
   $tab_ger_campos['novedades'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_terceros_contratos_generar_fv_15012021_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos_generar_fv_15012021']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
