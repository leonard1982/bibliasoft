  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_gestor_archivos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_gestor_archivos_form();
	}
...
?>
  ...
  // ---------- Validate id_gestor
  function do_ajax_form_gestor_archivos_validate_id_gestor()
  {
    var nomeCampo_id_gestor = "id_gestor";
    var var_id_gestor = scAjaxGetFieldHidden(nomeCampo_id_gestor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_validate_id_gestor(var_id_gestor, var_script_case_init, do_ajax_form_gestor_archivos_validate_id_gestor_cb);
  } // do_ajax_form_gestor_archivos_validate_id_gestor

  function do_ajax_form_gestor_archivos_validate_id_gestor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_validate_id_gestor_cb

  // ---------- Validate fecha
  function do_ajax_form_gestor_archivos_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldHidden(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_gestor_archivos_validate_fecha_cb);
  } // do_ajax_form_gestor_archivos_validate_fecha

  function do_ajax_form_gestor_archivos_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_validate_fecha_cb

  // ---------- Validate nombre
  function do_ajax_form_gestor_archivos_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_gestor_archivos_validate_nombre_cb);
  } // do_ajax_form_gestor_archivos_validate_nombre

  function do_ajax_form_gestor_archivos_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_validate_nombre_cb

  // ---------- Validate tipo
  function do_ajax_form_gestor_archivos_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldHidden(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_gestor_archivos_validate_tipo_cb);
  } // do_ajax_form_gestor_archivos_validate_tipo

  function do_ajax_form_gestor_archivos_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_validate_tipo_cb

  // ---------- Validate editado
  function do_ajax_form_gestor_archivos_validate_editado()
  {
    var nomeCampo_editado = "editado";
    var var_editado = scAjaxGetFieldHidden(nomeCampo_editado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_validate_editado(var_editado, var_script_case_init, do_ajax_form_gestor_archivos_validate_editado_cb);
  } // do_ajax_form_gestor_archivos_validate_editado

  function do_ajax_form_gestor_archivos_validate_editado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "editado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_validate_editado_cb

  // ---------- Validate peso
  function do_ajax_form_gestor_archivos_validate_peso()
  {
    var nomeCampo_peso = "peso";
    var var_peso = scAjaxGetFieldHidden(nomeCampo_peso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_validate_peso(var_peso, var_script_case_init, do_ajax_form_gestor_archivos_validate_peso_cb);
  } // do_ajax_form_gestor_archivos_validate_peso

  function do_ajax_form_gestor_archivos_validate_peso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "peso";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_validate_peso_cb

  // ---------- Validate usuario
  function do_ajax_form_gestor_archivos_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_gestor_archivos_validate_usuario_cb);
  } // do_ajax_form_gestor_archivos_validate_usuario

  function do_ajax_form_gestor_archivos_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_validate_usuario_cb

  // ---------- Validate descripcion
  function do_ajax_form_gestor_archivos_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_archivos_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_gestor_archivos_validate_descripcion_cb);
  } // do_ajax_form_gestor_archivos_validate_descripcion

  function do_ajax_form_gestor_archivos_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_archivos_validate_descripcion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_gestor_archivos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_gestor_archivos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_gestor_archivos_submit_form(var_id_gestor, var_fecha, var_nombre, var_tipo, var_editado, var_peso, var_usuario, var_descripcion, var_nombre_ul_name, var_nombre_ul_type, var_nombre_salva, var_nombre_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_gestor_archivos_submit_form_cb);
  } // do_ajax_form_gestor_archivos_submit_form

  function do_ajax_form_gestor_archivos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_gestor_archivos_submit_form_cb_after_alert);
  } // do_ajax_form_gestor_archivos_submit_form_cb
  function do_ajax_form_gestor_archivos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_gestor_archivos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_gestor_archivos_navigate_form()
  {
    perform_ajax_form_gestor_archivos_navigate_form();
  }

  function perform_ajax_form_gestor_archivos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_gestor_archivos_navigate_form(var_id_gestor, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_gestor_archivos_navigate_form_cb);
  } // do_ajax_form_gestor_archivos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_gestor_archivos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_gestor_archivos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_gestor_archivos_navigate_form_cb_after_alert);
  } // do_ajax_form_gestor_archivos_navigate_form_cb
  function do_ajax_form_gestor_archivos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_gestor_archivos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_gestor_archivos_navigate_form_cb_after_alert
  function sc_hide_form_gestor_archivos_form()
  {
