  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_activacion_licencia" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_activacion_licencia_form();
	}
...
?>
  ...
  // ---------- Validate logo
  function do_ajax_control_activacion_licencia_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_activacion_licencia_validate_logo(var_logo, var_script_case_init, do_ajax_control_activacion_licencia_validate_logo_cb);
  } // do_ajax_control_activacion_licencia_validate_logo

  function do_ajax_control_activacion_licencia_validate_logo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_activacion_licencia_validate_logo_cb

  // ---------- Validate cod_cliente
  function do_ajax_control_activacion_licencia_validate_cod_cliente()
  {
    var nomeCampo_cod_cliente = "cod_cliente";
    var var_cod_cliente = scAjaxGetFieldText(nomeCampo_cod_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_activacion_licencia_validate_cod_cliente(var_cod_cliente, var_script_case_init, do_ajax_control_activacion_licencia_validate_cod_cliente_cb);
  } // do_ajax_control_activacion_licencia_validate_cod_cliente

  function do_ajax_control_activacion_licencia_validate_cod_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cod_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_activacion_licencia_validate_cod_cliente_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_activacion_licencia_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_activacion_licencia_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_logo = "";
    var var_cod_cliente = scAjaxGetFieldText("cod_cliente");
    ...
    scAjaxProcOn();
    x_ajax_control_activacion_licencia_submit_form(var_logo, var_cod_cliente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_activacion_licencia_submit_form_cb);
  } // do_ajax_control_activacion_licencia_submit_form

  function do_ajax_control_activacion_licencia_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_activacion_licencia_submit_form_cb_after_alert);
  } // do_ajax_control_activacion_licencia_submit_form_cb
  function do_ajax_control_activacion_licencia_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_activacion_licencia_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_activacion_licencia_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_activacion_licencia_navigate_form, function() {});
    } else {
      perform_ajax_control_activacion_licencia_navigate_form();
    }
  }

  function perform_ajax_control_activacion_licencia_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_activacion_licencia_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_activacion_licencia']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_activacion_licencia_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_activacion_licencia_navigate_form_cb_after_alert);
  } // do_ajax_control_activacion_licencia_navigate_form_cb
  function do_ajax_control_activacion_licencia_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_activacion_licencia_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_activacion_licencia_navigate_form_cb_after_alert
  function sc_hide_control_activacion_licencia_form()
  {
  ...
  var ajax_error_list = {
    ...
    "cod_cliente": {"label": "Código del Cliente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "logo": new Array(),
    "cod_cliente": new Array()
  };
  ajax_field_mult["logo"][1] = "logo";
  ajax_field_mult["cod_cliente"][1] = "cod_cliente";

  var ajax_field_id = {
    "logo": new Array("hidden_field_label_logo", "hidden_field_data_logo"),
    "cod_cliente": new Array("hidden_field_label_cod_cliente", "hidden_field_data_cod_cliente")
  };
