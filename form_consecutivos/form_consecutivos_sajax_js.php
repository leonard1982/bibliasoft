  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_consecutivos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_consecutivos_form();
	}
...
?>
  ...
  // ---------- Validate tipodoc_
  function do_ajax_form_consecutivos_validate_tipodoc_(iNumLinha)
  {
    var nomeCampo_tipodoc_ = "tipodoc_" + iNumLinha;
    var var_tipodoc_ = scAjaxGetFieldText(nomeCampo_tipodoc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consecutivos_validate_tipodoc_(var_tipodoc_, iNumLinha, var_script_case_init, do_ajax_form_consecutivos_validate_tipodoc__cb);
  } // do_ajax_form_consecutivos_validate_tipodoc_

  function do_ajax_form_consecutivos_validate_tipodoc__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tipodoc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipodoc_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tipodoc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tipodoc_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consecutivos_validate_tipodoc__cb

  // ---------- Validate prefijo_
  function do_ajax_form_consecutivos_validate_prefijo_(iNumLinha)
  {
    var nomeCampo_prefijo_ = "prefijo_" + iNumLinha;
    var var_prefijo_ = scAjaxGetFieldText(nomeCampo_prefijo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consecutivos_validate_prefijo_(var_prefijo_, iNumLinha, var_script_case_init, do_ajax_form_consecutivos_validate_prefijo__cb);
  } // do_ajax_form_consecutivos_validate_prefijo_

  function do_ajax_form_consecutivos_validate_prefijo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "prefijo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "prefijo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "prefijo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "prefijo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consecutivos_validate_prefijo__cb

  // ---------- Validate consecutivo_
  function do_ajax_form_consecutivos_validate_consecutivo_(iNumLinha)
  {
    var nomeCampo_consecutivo_ = "consecutivo_" + iNumLinha;
    var var_consecutivo_ = scAjaxGetFieldText(nomeCampo_consecutivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consecutivos_validate_consecutivo_(var_consecutivo_, iNumLinha, var_script_case_init, do_ajax_form_consecutivos_validate_consecutivo__cb);
  } // do_ajax_form_consecutivos_validate_consecutivo_

  function do_ajax_form_consecutivos_validate_consecutivo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_consecutivos_validate_consecutivo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_consecutivos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_consecutivos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_consecutivos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_consecutivos_add_new_line_cb);
  } // do_ajax_form_consecutivos_add_new_line

  function do_ajax_form_consecutivos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_consecutivos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_consecutivos_backup_line(iNumLinha)
  {
    var var_id_consecutivo_ = scAjaxGetFieldText("id_consecutivo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_consecutivos_backup_line(var_id_consecutivo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_consecutivos_backup_line_cb);
  } // do_ajax_form_consecutivos_backup_line

  function do_ajax_form_consecutivos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_consecutivos_backup_line_cb

  function do_ajax_form_consecutivos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_consecutivos_cancel_insert

  function do_ajax_form_consecutivos_cancel_update(iSeqVert)
  {
    do_ajax_form_consecutivos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_consecutivos_cancel_update

  function do_ajax_form_consecutivos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_consecutivos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_consecutivos_table_refresh()
  {
    var var_id_consecutivo_ = document.F2.id_consecutivo_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_consecutivos_table_refresh(var_id_consecutivo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_consecutivos_table_refresh_cb);
  } //  do_ajax_form_consecutivos_table_refresh

  function do_ajax_form_consecutivos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_consecutivo_.value = scAjaxGetKeyValue("id_consecutivo_");
    ...
    scAjaxAlert(do_ajax_form_consecutivos_table_refresh_cb_after_alert);
  } // do_ajax_form_consecutivos_table_refresh_cb
  function do_ajax_form_consecutivos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_consecutivos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_consecutivos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_consecutivos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_tipodoc_ = scAjaxGetFieldText("tipodoc_" + iNumLinha);
    var var_prefijo_ = scAjaxGetFieldText("prefijo_" + iNumLinha);
    var var_consecutivo_ = scAjaxGetFieldText("consecutivo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_consecutivos_submit_form(var_tipodoc_, var_prefijo_, var_consecutivo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_consecutivos_submit_form_cb);
  } // do_ajax_form_consecutivos_submit_form

  function do_ajax_form_consecutivos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tipodoc_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("prefijo_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_consecutivos_submit_form_cb_after_alert);
  } // do_ajax_form_consecutivos_submit_form_cb
  function do_ajax_form_consecutivos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_consecutivos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_consecutivos_navigate_form()
  {
    perform_ajax_form_consecutivos_navigate_form();
  }

  function perform_ajax_form_consecutivos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_consecutivos_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tipodoc_" + iNavForm);
      scAjaxHideErrorDisplay("prefijo_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_consecutivos_navigate_form(var_id_consecutivo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_consecutivos_navigate_form_cb);
  } // do_ajax_form_consecutivos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_consecutivos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_consecutivos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_consecutivo_.value = scAjaxGetKeyValue("id_consecutivo_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_consecutivos_navigate_form_cb_after_alert);
  } // do_ajax_form_consecutivos_navigate_form_cb
  function do_ajax_form_consecutivos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_consecutivos_navigate_form_cb_after_alert
  function sc_hide_form_consecutivos_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tipodoc_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "prefijo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "consecutivo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tipodoc_" + iNumLinha] = {"label": "Tipo Doc<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["prefijo_" + iNumLinha] = {"label": "Prefijo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["consecutivo_" + iNumLinha] = {"label": "Consecutivo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tipodoc_"][iNumLinha] = "tipodoc_" + iNumLinha;
    ajax_field_mult["prefijo_"][iNumLinha] = "prefijo_" + iNumLinha;
    ajax_field_mult["consecutivo_"][iNumLinha] = "consecutivo_" + iNumLinha;
    ajax_field_id["tipodoc_" + iNumLinha] = new Array("hidden_field_label_tipodoc_", "hidden_field_data_tipodoc_" + iNumLinha);
    ajax_field_id["prefijo_" + iNumLinha] = new Array("hidden_field_label_prefijo_", "hidden_field_data_prefijo_" + iNumLinha);
    ajax_field_id["consecutivo_" + iNumLinha] = new Array("hidden_field_label_consecutivo_", "hidden_field_data_consecutivo_" + iNumLinha);
    ajax_error_count["tipodoc_" + iNumLinha] = "off";
    ajax_error_count["prefijo_" + iNumLinha] = "off";
    ajax_error_count["consecutivo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tipodoc_" + iNumLinha] = "off";
    ajax_read_only["prefijo_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["tipodoc_" + iNumLinha] = "on";
    ajax_read_only["prefijo_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["tipodoc_" + iNumLinha] = null;
    ajax_error_list["prefijo_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tipodoc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipodoc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipodoc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipodoc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipodoc_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["prefijo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["prefijo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["prefijo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["prefijo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["prefijo_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipodoc_'])) ? $this->nmgp_cmp_readonly['tipodoc_'] : 'off';
?>
    scAjaxFieldRead("tipodoc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['prefijo_'])) ? $this->nmgp_cmp_readonly['prefijo_'] : 'off';
?>
    scAjaxFieldRead("prefijo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("tipodoc_" + iSeq, "on");
    scAjaxFieldRead("prefijo_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tipodoc_" + iRow] || "on" == ajax_error_count["prefijo_" + iRow] || "on" == ajax_error_count["consecutivo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tipodoc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_prefijo_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tipodoc_" + iRow] && "off" == ajax_error_count["prefijo_" + iRow] && "off" == ajax_error_count["consecutivo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tipodoc_" + iRow] = "off";
        ajax_error_count["prefijo_" + iRow] = "off";
      ...
      $("#hidden_field_data_tipodoc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_prefijo_" + iRow).removeClass("scFormErrorLine");
