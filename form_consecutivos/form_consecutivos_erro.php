...
$old_error_handler = set_error_handler("form_consecutivos_scriptcase_error_handler");

function form_consecutivos_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_consecutivos']['contr_erro']) && $_SESSION['scriptcase']['form_consecutivos']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            global $inicial_form_consecutivos;
            $inicial_form_consecutivos->contr_form_consecutivos->Apl_com_erro = true;
            if ($inicial_form_consecutivos->contr_form_consecutivos->NM_ajax_flag)
            {
                $inicial_form_consecutivos->contr_form_consecutivos->NM_ajax_info['errList']['geral_form_consecutivos'][] = $msg;
                return;
            }
            form_consecutivos_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_consecutivos_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_consecutivos'])  && '' != $_SESSION['scriptcase']['error_icon']['form_consecutivos'])  ? $_SESSION['scriptcase']['error_icon']['form_consecutivos']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_consecutivos']) && '' != $_SESSION['scriptcase']['error_span_title']['form_consecutivos']) ? $_SESSION['scriptcase']['error_span_title']['form_consecutivos'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_consecutivos']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_consecutivos']) ? $_SESSION['scriptcase']['error_icon_title']['form_consecutivos'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_consecutivos']['error_buffer'] .= ob_get_flush();
}
