...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idpro' + iSeqRow).bind('blur', function() { sc_detalleventa_pos_idpro_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_detalleventa_pos_idpro_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_detalleventa_pos_idpro_onfocus(this, iSeqRow) });
  $('#id_sc_field_idbod' + iSeqRow).bind('blur', function() { sc_detalleventa_pos_idbod_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_detalleventa_pos_idbod_onfocus(this, iSeqRow) });
  $('#id_sc_field_cantidad' + iSeqRow).bind('blur', function() { sc_detalleventa_pos_cantidad_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_detalleventa_pos_cantidad_onfocus(this, iSeqRow) });
  $('#id_sc_field_valorunit' + iSeqRow).bind('blur', function() { sc_detalleventa_pos_valorunit_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_detalleventa_pos_valorunit_onfocus(this, iSeqRow) });
  $('#id_sc_field_valorpar' + iSeqRow).bind('blur', function() { sc_detalleventa_pos_valorpar_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_detalleventa_pos_valorpar_onfocus(this, iSeqRow) });
  $('#id_sc_field_iva' + iSeqRow).bind('blur', function() { sc_detalleventa_pos_iva_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_detalleventa_pos_iva_onfocus(this, iSeqRow) });
  $('#id_sc_field_descuento' + iSeqRow).bind('blur', function() { sc_detalleventa_pos_descuento_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_detalleventa_pos_descuento_onfocus(this, iSeqRow) });
  $('#id_sc_field_adicional' + iSeqRow).bind('blur', function() { sc_detalleventa_pos_adicional_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_detalleventa_pos_adicional_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_detalleventa_pos_idpro_onblur(oThis, iSeqRow) {
  do_ajax_detalleventa_pos_mob_validate_idpro();
  scCssBlur(oThis);
}

function sc_detalleventa_pos_idpro_onchange(oThis, iSeqRow) {
  do_ajax_detalleventa_pos_mob_event_idpro_onchange();
}

function sc_detalleventa_pos_idpro_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_detalleventa_pos_idbod_onblur(oThis, iSeqRow) {
  do_ajax_detalleventa_pos_mob_validate_idbod();
  scCssBlur(oThis);
}

function sc_detalleventa_pos_idbod_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_detalleventa_pos_cantidad_onblur(oThis, iSeqRow) {
  do_ajax_detalleventa_pos_mob_validate_cantidad();
  scCssBlur(oThis);
}

function sc_detalleventa_pos_cantidad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_detalleventa_pos_valorunit_onblur(oThis, iSeqRow) {
  do_ajax_detalleventa_pos_mob_validate_valorunit();
  scCssBlur(oThis);
}

function sc_detalleventa_pos_valorunit_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_detalleventa_pos_valorpar_onblur(oThis, iSeqRow) {
  do_ajax_detalleventa_pos_mob_validate_valorpar();
  scCssBlur(oThis);
}

function sc_detalleventa_pos_valorpar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_detalleventa_pos_iva_onblur(oThis, iSeqRow) {
  do_ajax_detalleventa_pos_mob_validate_iva();
  scCssBlur(oThis);
}

function sc_detalleventa_pos_iva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_detalleventa_pos_descuento_onblur(oThis, iSeqRow) {
  do_ajax_detalleventa_pos_mob_validate_descuento();
  scCssBlur(oThis);
}

function sc_detalleventa_pos_descuento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_detalleventa_pos_adicional_onblur(oThis, iSeqRow) {
  do_ajax_detalleventa_pos_mob_validate_adicional();
  scCssBlur(oThis);
}

function sc_detalleventa_pos_adicional_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_detalleventa_pos_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'detalleventa_pos_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
