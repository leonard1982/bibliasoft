  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_detalleventa_pos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_detalleventa_pos_mob_form();
	}
...
?>
  ...
  // ---------- Validate idpro
  function do_ajax_detalleventa_pos_mob_validate_idpro()
  {
    var nomeCampo_idpro = "idpro";
    var var_idpro = scAjaxGetFieldSelect(nomeCampo_idpro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_pos_mob_validate_idpro(var_idpro, var_script_case_init, do_ajax_detalleventa_pos_mob_validate_idpro_cb);
  } // do_ajax_detalleventa_pos_mob_validate_idpro

  function do_ajax_detalleventa_pos_mob_validate_idpro_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_pos_mob_validate_idpro_cb

  // ---------- Validate cantidad
  function do_ajax_detalleventa_pos_mob_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_pos_mob_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_detalleventa_pos_mob_validate_cantidad_cb);
  } // do_ajax_detalleventa_pos_mob_validate_cantidad

  function do_ajax_detalleventa_pos_mob_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_pos_mob_validate_cantidad_cb

  // ---------- Validate valorunit
  function do_ajax_detalleventa_pos_mob_validate_valorunit()
  {
    var nomeCampo_valorunit = "valorunit";
    var var_valorunit = scAjaxGetFieldText(nomeCampo_valorunit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_pos_mob_validate_valorunit(var_valorunit, var_script_case_init, do_ajax_detalleventa_pos_mob_validate_valorunit_cb);
  } // do_ajax_detalleventa_pos_mob_validate_valorunit

  function do_ajax_detalleventa_pos_mob_validate_valorunit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_pos_mob_validate_valorunit_cb

  // ---------- Validate valorpar
  function do_ajax_detalleventa_pos_mob_validate_valorpar()
  {
    var nomeCampo_valorpar = "valorpar";
    var var_valorpar = scAjaxGetFieldText(nomeCampo_valorpar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_pos_mob_validate_valorpar(var_valorpar, var_script_case_init, do_ajax_detalleventa_pos_mob_validate_valorpar_cb);
  } // do_ajax_detalleventa_pos_mob_validate_valorpar

  function do_ajax_detalleventa_pos_mob_validate_valorpar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_pos_mob_validate_valorpar_cb

  // ---------- Validate iva
  function do_ajax_detalleventa_pos_mob_validate_iva()
  {
    var nomeCampo_iva = "iva";
    var var_iva = scAjaxGetFieldText(nomeCampo_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_pos_mob_validate_iva(var_iva, var_script_case_init, do_ajax_detalleventa_pos_mob_validate_iva_cb);
  } // do_ajax_detalleventa_pos_mob_validate_iva

  function do_ajax_detalleventa_pos_mob_validate_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "iva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_pos_mob_validate_iva_cb

  // ---------- Validate descuento
  function do_ajax_detalleventa_pos_mob_validate_descuento()
  {
    var nomeCampo_descuento = "descuento";
    var var_descuento = scAjaxGetFieldText(nomeCampo_descuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_pos_mob_validate_descuento(var_descuento, var_script_case_init, do_ajax_detalleventa_pos_mob_validate_descuento_cb);
  } // do_ajax_detalleventa_pos_mob_validate_descuento

  function do_ajax_detalleventa_pos_mob_validate_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_pos_mob_validate_descuento_cb

  // ---------- Validate adicional
  function do_ajax_detalleventa_pos_mob_validate_adicional()
  {
    var nomeCampo_adicional = "adicional";
    var var_adicional = scAjaxGetFieldText(nomeCampo_adicional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_pos_mob_validate_adicional(var_adicional, var_script_case_init, do_ajax_detalleventa_pos_mob_validate_adicional_cb);
  } // do_ajax_detalleventa_pos_mob_validate_adicional

  function do_ajax_detalleventa_pos_mob_validate_adicional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_pos_mob_validate_adicional_cb

  // ---------- Validate idbod
  function do_ajax_detalleventa_pos_mob_validate_idbod()
  {
    var nomeCampo_idbod = "idbod";
    var var_idbod = scAjaxGetFieldSelect(nomeCampo_idbod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_pos_mob_validate_idbod(var_idbod, var_script_case_init, do_ajax_detalleventa_pos_mob_validate_idbod_cb);
  } // do_ajax_detalleventa_pos_mob_validate_idbod

  function do_ajax_detalleventa_pos_mob_validate_idbod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idbod";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_pos_mob_validate_idbod_cb

  // ---------- Event onchange idpro
  function do_ajax_detalleventa_pos_mob_event_idpro_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_detalleventa_pos_mob_event_idpro_onchange(var_idpro, var_valorunit, var_cantidad, var_script_case_init, do_ajax_detalleventa_pos_mob_event_idpro_onchange_cb);
  } // do_ajax_detalleventa_pos_mob_event_idpro_onchange

  function do_ajax_detalleventa_pos_mob_event_idpro_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idpro";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalleventa_pos_mob_event_idpro_onchange_cb_after_alert);
  } // do_ajax_detalleventa_pos_mob_event_idpro_onchange_cb
  function do_ajax_detalleventa_pos_mob_event_idpro_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detalleventa_pos_mob_event_idpro_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_detalleventa_pos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_detalleventa_pos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpro = scAjaxGetFieldSelect("idpro");
    ...
    scAjaxProcOn();
    x_ajax_detalleventa_pos_mob_submit_form(var_idpro, var_cantidad, var_valorunit, var_valorpar, var_iva, var_descuento, var_adicional, var_idbod, var_iddet, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_detalleventa_pos_mob_submit_form_cb);
  } // do_ajax_detalleventa_pos_mob_submit_form

  function do_ajax_detalleventa_pos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_detalleventa_pos_mob_submit_form_cb_after_alert);
  } // do_ajax_detalleventa_pos_mob_submit_form_cb
  function do_ajax_detalleventa_pos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_detalleventa_pos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_detalleventa_pos_mob_navigate_form()
  {
    perform_ajax_detalleventa_pos_mob_navigate_form();
  }

  function perform_ajax_detalleventa_pos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_detalleventa_pos_mob_navigate_form(var_iddet, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_detalleventa_pos_mob_navigate_form_cb);
  } // do_ajax_detalleventa_pos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_pos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_detalleventa_pos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_detalleventa_pos_mob_navigate_form_cb_after_alert);
  } // do_ajax_detalleventa_pos_mob_navigate_form_cb
  function do_ajax_detalleventa_pos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_detalleventa_pos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_detalleventa_pos_mob_navigate_form_cb_after_alert
  function sc_hide_detalleventa_pos_mob_form()
  {
