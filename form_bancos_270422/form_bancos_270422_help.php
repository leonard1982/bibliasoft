...
<?php echo "<b>Cajero</b><br>" . nl2br("Buscamos el usuario del sistema que tiene asignado el tercero que es cajero."); ?>
</body>
</html>
<?php
        }
        if ($nm_cod_campo ==  "numero_cuenta")
        {
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
...
<body class="scFormHelpPage">
<?php echo "<b>No Cuenta</b><br>" . nl2br("Número de cuenta si es un banco"); ?>
</body>
</html>
<?php
        }
...
$exec_help = new form_bancos_270422_help();
?>
