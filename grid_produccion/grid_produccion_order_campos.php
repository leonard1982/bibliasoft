...
<?php
   ...
   $Ord_Cmp = new grid_produccion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_produccion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produccion']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_produccion']['labels']["numero"] : "Número";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produccion']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_produccion']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['id_bodega'] = "on";
   $tab_def_campos['id_bodega'] = "id_bodega";
   $tab_labels["id_bodega"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produccion']['labels']["id_bodega"])) ? $_SESSION['sc_session'][$sc_init]['grid_produccion']['labels']["id_bodega"] : "Dirigido a";
   $tab_ger_campos['observ'] = "on";
   $tab_def_campos['observ'] = "observ";
   $tab_labels["observ"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produccion']['labels']["observ"])) ? $_SESSION['sc_session'][$sc_init]['grid_produccion']['labels']["observ"] : "Observaciones";
   $tab_ger_campos['vtotal'] = "on";
   $tab_def_campos['vtotal'] = "vtotal";
   $tab_labels["vtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produccion']['labels']["vtotal"])) ? $_SESSION['sc_session'][$sc_init]['grid_produccion']['labels']["vtotal"] : "Costo materia prima";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produccion']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_produccion']['labels']["imprimir"] : "imprimir";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_produccion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_produccion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_produccion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_produccion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_produccion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
