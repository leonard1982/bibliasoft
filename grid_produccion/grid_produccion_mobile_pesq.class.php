...
class grid_produccion_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_produccion_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_produccion_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_produccion_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_vtotal')
      {
          $vtotal = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_vtotal($vtotal);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_numero($numero)
   {
      ...
      {
          $nm_comando = "select distinct numero from " . $this->Ini->nm_tabela . " where   CAST (numero AS TEXT)  like '%" . $numero . "%' order by numero"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numero from " . $this->Ini->nm_tabela . " where   CAST (numero AS VARCHAR)  like '%" . $numero . "%' order by numero"; 
      }
      else
      {
          $nm_comando = "select distinct numero from " . $this->Ini->nm_tabela . " where  numero like '%" . $numero . "%' order by numero"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_vtotal($vtotal)
   {
      $vtotal = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $vtotal);
      $vtotal = str_replace($_SESSION['scriptcase']['reg_conf']['dec_num'], ".", $vtotal);
      $vtotal = substr($this->Db->qstr($vtotal), 1, -1);
            $vtotal_look = substr($this->Db->qstr($vtotal), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct vtotal from " . $this->Ini->nm_tabela . " where   CAST (vtotal AS TEXT)  like '%" . $vtotal . "%' order by vtotal"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct vtotal from " . $this->Ini->nm_tabela . " where   CAST (vtotal AS VARCHAR)  like '%" . $vtotal . "%' order by vtotal"; 
      }
      else
      {
          $nm_comando = "select distinct vtotal from " . $this->Ini->nm_tabela . " where  vtotal like '%" . $vtotal . "%' order by vtotal"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      { 
         while (!$rs->EOF) 
         { 
              nmgp_Form_Num_Val($rs->fields[0], $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
            $cmp1 = NM_charset_to_utf8(trim($rs->fields[0]));
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
            $rs->MoveNext() ; 
         } 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha";$Nm_numeric[] = "idmat";$Nm_numeric[] = "numero";$Nm_numeric[] = "vtotal";$Nm_numeric[] = "asentada";$Nm_numeric[] = "id_bodega";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Lista Traslado de materia Prima a Producción</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_produccion/grid_produccion_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_produccion_ajax_search.js"></script>
 <script type="text/javascript" src="grid_produccion_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_produccion_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_produccion']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_produccion']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['ajax_nav'])
           { 
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_numero_input_2#NMF#' + search_get_text('SC_numero_input_2') + '@NMF@';
  ...
  str_out += 'SC_vtotal_cond#NMF#' + search_get_sel_txt('SC_vtotal_cond') + '@NMF@';
  str_out += 'SC_vtotal#NMF#' + search_get_text('SC_vtotal') + '@NMF@';
  str_out += 'id_ac_vtotal#NMF#' + search_get_title('select2-id_ac_vtotal-container') + '@NMF@';
  str_out += 'SC_vtotal_input_2#NMF#' + search_get_text('SC_vtotal_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  ...
  $(".sc-ui-autocomp-vtotal").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_vtotal",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_vtotal").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Lista Traslado de materia Prima a Producción</span></td>
...
<?php
   ...
   {
      global 
             $numero_cond, $numero, $numero_input_2, $numero_autocomp,
             $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano, $fecha_input_2_dia, $fecha_input_2_mes, $fecha_input_2_ano,
             $vtotal_cond, $vtotal, $vtotal_input_2, $vtotal_autocomp,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_produccion']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_produccion']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_produccion']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_produccion", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $numero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['numero']; 
          $numero_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['numero_input_2']; 
          $numero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['numero_cond']; 
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_cond']; 
          $vtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['vtotal']; 
          $vtotal_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['vtotal_input_2']; 
          $vtotal_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['vtotal_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($vtotal_cond) || empty($vtotal_cond))
      {
         $vtotal_cond = "gt";
      }
      ...
      $str_hide_vtotal = (in_array($vtotal_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_vtotal = ('bw' == $vtotal_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($vtotal) || $vtotal == "")
      {
          $vtotal = "";
      }
      if (isset($vtotal) && !empty($vtotal))
      {
         $tmp_pos = strpos($vtotal, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $vtotal = substr($vtotal, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_numero_cond" name="numero_cond" onChange="nm_campos_between(document.getElementById('id_vis_numero'), this, 'numero')">
       <OPTION value="gt" <?php if ("gt" == $numero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $numero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $numero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $numero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_numero"  <?php echo $str_hide_numero?>><?php
      if ($numero != "")
      {
      $numero_look = substr($this->Db->qstr($numero), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numero from " . $this->Ini->nm_tabela . " where numero = $numero_look order by numero"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numero from " . $this->Ini->nm_tabela . " where numero = $numero_look order by numero"; 
...
?>
<INPUT  type="text" id="SC_numero" name="numero" value="<?php echo NM_encode_input($numero) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numero" id="id_ac_numero" name="numero_autocomp"><?php if ('' !=  $numero) { ?><option value="<?php echo $numero ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_numero"  <?php echo $str_display_numero; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_numero_input_2" name="numero_input_2" value="<?php echo NM_encode_input($numero_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
    ...
    <TD nowrap class="scFilterLabelOdd" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['vtotal'])) ? $this->New_label['vtotal'] : "Costo materia prima";
 $nmgp_tab_label .= "vtotal?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_vtotal_cond" name="vtotal_cond" onChange="nm_campos_between(document.getElementById('id_vis_vtotal'), this, 'vtotal')">
       <OPTION value="gt" <?php if ("gt" == $vtotal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $vtotal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $vtotal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $vtotal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_vtotal"  <?php echo $str_hide_vtotal?>><?php
      if ($vtotal != "")
      {
      $vtotal_look = substr($this->Db->qstr($vtotal), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($vtotal))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct vtotal from " . $this->Ini->nm_tabela . " where vtotal = $vtotal_look order by vtotal"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct vtotal from " . $this->Ini->nm_tabela . " where vtotal = $vtotal_look order by vtotal"; 
      ...
      if (isset($nmgp_def_dados[0][$vtotal]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$vtotal];
      }
      else
      {
              nmgp_Form_Num_Val($vtotal, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "2", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $vtotal;
      }
?>
<INPUT  type="text" id="SC_vtotal" name="vtotal" value="<?php echo NM_encode_input($vtotal) ?>" size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-vtotal" id="id_ac_vtotal" name="vtotal_autocomp"><?php if ('' !=  $vtotal) { ?><option value="<?php echo $vtotal ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_vtotal"  <?php echo $str_display_vtotal; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_vtotal_input_2" name="vtotal_input_2" value="<?php echo NM_encode_input($vtotal_input_2) ?>"  size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<?php
   if (is_file("grid_produccion_help.txt"))
   {
      $Arq_WebHelp = file("grid_produccion_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_produccion']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_produccion']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_produccion']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_produccion']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.numero_cond.value = 'gt';
   ...
   document.F1.numero_input_2.value = "";
   ...
   document.F1.vtotal_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_vtotal'), document.F1.vtotal_cond, 'vtotal');
   document.F1.vtotal.value = "";
   document.F1.vtotal_autocomp.value = "";
   $('#select2-id_ac_vtotal-container').html('<?php echo $this->Val_init_vtotal['desc'] ?>');;
   document.F1.vtotal_input_2.value = "";
   Sc_carga_select2('all');
 }
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_produccion_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_produccion_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_produccion_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_produccion_valida_mes(this)});
 }
 function sc_grid_produccion_valida_dia(obj)
 {
 ...
 function sc_grid_produccion_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_produccion";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_numero_input_2'] = 'text';
      ...
      $tp_fields['SC_vtotal_cond'] = 'cond';
      $tp_fields['SC_vtotal'] = 'text_aut';
      $tp_fields['id_ac_vtotal'] = 'select2_aut';
      $tp_fields['SC_vtotal_input_2'] = 'text';
   ...
   {
      global $numero_cond, $numero, $numero_input_2, $numero_autocomp,
             $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano, $fecha_input_2_dia, $fecha_input_2_mes, $fecha_input_2_ano,
             $vtotal_cond, $vtotal, $vtotal_input_2, $vtotal_autocomp, $nmgp_tab_label;
      ...
      if (!empty($vtotal_autocomp) && empty($vtotal))
      {
          $vtotal = $vtotal_autocomp;
      }
      ...
      $vtotal_cond_salva = $vtotal_cond; 
      if (!isset($vtotal_input_2) || $vtotal_input_2 == "")
      {
          $vtotal_input_2 = $vtotal;
      }
      if ($numero_cond != "in")
      {
      ...
      if ($numero_cond != "in")
      {
          nm_limpa_numero($numero_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($vtotal_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($vtotal, $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
      }
      if ($vtotal_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($vtotal_input_2, $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['numero'] = $numero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['numero_input_2'] = $numero_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['numero_cond'] = $numero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['vtotal'] = $vtotal; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['vtotal_input_2'] = $vtotal_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['vtotal_cond'] = $vtotal_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca'] = $Temp_Busca;
      }
      ...
      if ($vtotal_cond != "in" && $vtotal_cond != "bw" && !empty($vtotal) && !is_numeric($vtotal))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Costo materia prima";
      }
      if ($vtotal_cond == "bw" && ((!empty($vtotal) && !is_numeric($vtotal)) || (!empty($vtotal_input_2) && !is_numeric($vtotal_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Costo materia prima";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      $Conteudo = $numero_input_2;
      if (strtoupper($numero_cond) != "II" && strtoupper($numero_cond) != "QP" && strtoupper($numero_cond) != "NP" && strtoupper($numero_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['numero_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($vtotal != '') {
      $vtotal_look = substr($this->Db->qstr($vtotal), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['vtotal'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['vtotal'] = $cmp1;
      }
      else
      {
          $cmp1 = $vtotal;
          nmgp_Form_Num_Val($cmp1, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
          $this->cmp_formatado['vtotal'] = $cmp1;
      }
      $Conteudo = $vtotal_input_2;
      if (strtoupper($vtotal_cond) != "II" && strtoupper($vtotal_cond) != "QP" && strtoupper($vtotal_cond) != "NP" && strtoupper($vtotal_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['vtotal_input_2'] = $Conteudo;

      //----- $numero
      $this->Date_part = false;
      if (isset($numero) || $numero_cond == "nu" || $numero_cond == "nn" || $numero_cond == "ep" || $numero_cond == "ne")
      {
         $this->monta_condicao("numero", $numero_cond, $numero, $numero_input_2, "numero");
      }
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']['fecha_input_2'] = $val[1];
      ...
      //----- $vtotal
      $this->Date_part = false;
      if (isset($vtotal) || $vtotal_cond == "nu" || $vtotal_cond == "nn" || $vtotal_cond == "ep" || $vtotal_cond == "ne")
      {
         $this->monta_condicao("vtotal", $vtotal_cond, $vtotal, $vtotal_input_2, "vtotal");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produccion']['where_pesq'];
