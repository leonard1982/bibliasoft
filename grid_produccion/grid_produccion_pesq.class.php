 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_numero_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['numero'])) ? $this->New_label['numero'] : "Número"; ?></TD>
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numero" id="id_ac_numero" name="numero_autocomp"><?php if ('' !=  $numero) { ?><option value="<?php echo $numero ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_numero"  <?php echo $str_display_numero; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_numero_input_2" name="numero_input_2" value="<?php echo NM_encode_input($numero_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
...
?>
      ...
      <TD id='SC_vtotal_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['vtotal'])) ? $this->New_label['vtotal'] : "Costo materia prima"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_vtotal_cond" name="vtotal_cond" onChange="nm_campos_between(document.getElementById('id_vis_vtotal'), this, 'vtotal')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_vtotal" <?php echo $str_hide_vtotal?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-vtotal" id="id_ac_vtotal" name="vtotal_autocomp"><?php if ('' !=  $vtotal) { ?><option value="<?php echo $vtotal ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_vtotal"  <?php echo $str_display_vtotal; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_vtotal_input_2" name="vtotal_input_2" value="<?php echo NM_encode_input($vtotal_input_2) ?>"  size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
