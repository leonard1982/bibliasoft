 ...
 */
   ...
   // scriptcase
   include_once('form_pedido_CW_session.php');
   @session_start();
   // ----------
...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['form_pedido_CW']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['form_pedido_CW']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['form_pedido_CW']['upload_field_info'][ $_POST['param_field'] ];
