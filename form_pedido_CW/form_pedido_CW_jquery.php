...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idpedido' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_idpedido_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_pedido_CW_idpedido_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nremision' + iSeqRow).bind('change', function() { sc_form_pedido_CW_nremision_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_subtotal' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_subtotal_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_pedido_CW_subtotal_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_valoriva' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_valoriva_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_pedido_CW_valoriva_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_total_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_pedido_CW_total_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_facturado' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_facturado_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_pedido_CW_facturado_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_observaciones_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_pedido_CW_observaciones_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_saldo' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_saldo_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_pedido_CW_saldo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_adicional' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_adicional_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_pedido_CW_adicional_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pedido_CW_adicional_onfocus(this, iSeqRow) });
  $('#id_sc_field_formapago' + iSeqRow).bind('change', function() { sc_form_pedido_CW_formapago_onchange(this, iSeqRow) });
  $('#id_sc_field_adicional2' + iSeqRow).bind('change', function() { sc_form_pedido_CW_adicional2_onchange(this, iSeqRow) });
  $('#id_sc_field_adicional3' + iSeqRow).bind('change', function() { sc_form_pedido_CW_adicional3_onchange(this, iSeqRow) });
  $('#id_sc_field_obspago' + iSeqRow).bind('change', function() { sc_form_pedido_CW_obspago_onchange(this, iSeqRow) });
  $('#id_sc_field_vendedor' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_vendedor_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_pedido_CW_vendedor_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dircliente' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_dircliente_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_pedido_CW_dircliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_numpedido' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_numpedido_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_pedido_CW_numpedido_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tipo_doc' + iSeqRow).bind('change', function() { sc_form_pedido_CW_tipo_doc_onchange(this, iSeqRow) });
  $('#id_sc_field_usuario' + iSeqRow).bind('change', function() { sc_form_pedido_CW_usuario_onchange(this, iSeqRow) });
  $('#id_sc_field_fechadocu' + iSeqRow).bind('change', function() { sc_form_pedido_CW_fechadocu_onchange(this, iSeqRow) });
  $('#id_sc_field_fechadocu_hora' + iSeqRow).bind('change', function() { sc_form_pedido_CW_fechadocu_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_origen' + iSeqRow).bind('change', function() { sc_form_pedido_CW_origen_onchange(this, iSeqRow) });
  $('#id_sc_field_iddocumento' + iSeqRow).bind('change', function() { sc_form_pedido_CW_iddocumento_onchange(this, iSeqRow) });
  $('#id_sc_field_cupo' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_cupo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_pedido_CW_cupo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cupodis' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_cupodis_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_pedido_CW_cupodis_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_detallepedidos' + iSeqRow).bind('blur', function() { sc_form_pedido_CW_detallepedidos_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_pedido_CW_detallepedidos_onchange(this, iSeqRow) })
...
function sc_form_pedido_CW_idpedido_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_nremision_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_subtotal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_valoriva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_facturado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_observaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_saldo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_adicional_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_formapago_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pedido_CW_adicional2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pedido_CW_adicional3_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pedido_CW_obspago_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_vendedor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_dircliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_numpedido_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_tipo_doc_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pedido_CW_usuario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pedido_CW_fechadocu_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pedido_CW_fechadocu_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pedido_CW_origen_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pedido_CW_iddocumento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_cupo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_cupodis_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pedido_CW_detallepedidos_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_field_detallepedidos(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_detallepedido_CW")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_detallepedido_CW")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_pedido_CW_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechaven" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pedido_CW_validate_fechaven(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pedido_CW_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_pedido_CW')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
