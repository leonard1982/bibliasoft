...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_CW_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_pedido_CW_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_Eliminar_ok()
{
    ...
    document.F1.action = "form_pedido_CW_mob.php";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_CW_mob']['where_detal']))
  {
?>  
...
function lookup_numfacven(campo)
{
   ...
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_pedido_CW_mob')?>/form_pedido_CW_mob.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_numfacven, "numfacven", dados, false);
}
