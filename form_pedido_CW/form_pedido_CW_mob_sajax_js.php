...
?>
  ...
  function do_ajax_form_pedido_CW_mob_event_asentada_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pedido_CW_mob_event_asentada_onchange(var_total, var_asentada, var_idpedido, var_script_case_init, do_ajax_form_pedido_CW_mob_event_asentada_onchange_cb);
...
?>
  ...
  function perform_ajax_form_pedido_CW_mob_navigate_form()
  {
    ...
    x_ajax_form_pedido_CW_mob_navigate_form(var_idpedido, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pedido_CW_mob_navigate_form_cb);
