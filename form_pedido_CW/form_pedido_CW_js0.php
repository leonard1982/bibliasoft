...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_CW']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_pedido_CW"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var Crtl_btn_salida = false;
function sc_btn_salida()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_salida(); }, 500);
      return;
    }
    if (Crtl_btn_salida) {return;}
    sc_btn_salida_ok();
}
function sc_btn_salida_cancel()
{
}
function sc_btn_salida_ok()
{
    Crtl_btn_salida = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?salida?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_CW']['where_detal']))
  {
?>  
...
function lookup_numfacven(campo)
{
   ...
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_pedido_CW')?>/form_pedido_CW.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_numfacven, "numfacven", dados, false);
}
