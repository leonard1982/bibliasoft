...
<?php
   ...
   $Ord_Cmp = new grid_terceros_cuentas_porpagar_161219_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_terceros_cuentas_porpagar_161219_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["prefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["prefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["prefijo"] : "PJ";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "numero";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["numero"] : "Numero";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['tercero'] = "on";
   $tab_def_campos['tercero'] = "tercero";
   $tab_labels["tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["tercero"] : "Tercero";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['numero_documento'] = "on";
   $tab_def_campos['numero_documento'] = "numero_documento";
   $tab_labels["numero_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["numero_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["numero_documento"] : "Documento";
   $tab_ger_campos['valor_total'] = "on";
   $tab_def_campos['valor_total'] = "valor_total";
   $tab_labels["valor_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["valor_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["valor_total"] : "Valor";
   $tab_ger_campos['saldo'] = "on";
   $tab_def_campos['saldo'] = "saldo";
   $tab_labels["saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["saldo"] : "Saldo";
   $tab_ger_campos['usuario'] = "on";
   $tab_def_campos['usuario'] = "usuario";
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['cod_cuenta'] = "on";
   $tab_def_campos['cod_cuenta'] = "cod_cuenta";
   $tab_labels["cod_cuenta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["cod_cuenta"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["cod_cuenta"] : "Cuenta";
   $tab_ger_campos['concepto'] = "on";
   $tab_def_campos['concepto'] = "concepto";
   $tab_labels["concepto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["concepto"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["concepto"] : "Concepto";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['labels']["pagada"] : "Pagada";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_terceros_cuentas_porpagar_161219_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porpagar_161219']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
