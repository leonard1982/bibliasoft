...
class grid_terceros_cuentas_porpagar_161219_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_order']['INGRESO_EGRESO']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_order']['INGRESO_EGRESO'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_order']['INGRESO_EGRESO'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['INGRESO_EGRESO'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['INGRESO_EGRESO'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['INGRESO_EGRESO'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['INGRESO_EGRESO'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['INGRESO_EGRESO'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['INGRESO_EGRESO'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['INGRESO_EGRESO'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_ie as $i_ie => $d_ie) {
           if (!in_array($i_ie, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_ie[4] ] = $d_ie[3];
               $this->comp_label[0][ $d_ie[4] ] = $d_ie[3];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_ie => $l_ie) {
           if (isset($this->array_total_ie[$i_ie])) {
               $this->comp_group[$i_ie] = array();
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_INGRESO_EGRESO("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor_total, $quebra_ie, $quebra_ie_orig)
   {
      //----- IE
      if (!isset($this->array_total_ie[$quebra_ie_orig]))
      {
         $this->array_total_ie[$quebra_ie_orig][0] = 1;
         $this->array_total_ie[$quebra_ie_orig][1] = $sum_valor_total;
         $this->array_total_ie[$quebra_ie_orig][2] = 1;
         $this->array_total_ie[$quebra_ie_orig][3] = $quebra_ie;
         $this->array_total_ie[$quebra_ie_orig][4] = $quebra_ie_orig;
      }
      else
      {
         $this->array_total_ie[$quebra_ie_orig][0]++;
         $this->array_total_ie[$quebra_ie_orig][1] += $sum_valor_total;
         $this->array_total_ie[$quebra_ie_orig][2]++;
      }
   }
...
$_SESSION['scriptcase']['grid_terceros_cuentas_porpagar_161219']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor_total, $this->ie, $this->ie_orig);
            }
   }
//
