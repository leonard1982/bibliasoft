...
class grid_terceros_cuentas_porpagar_161219_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_tercero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['arr_total']['tercero'];
          $this->array_total_ie = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['arr_total']['ie'];
      }
      else
      {
          $this->array_total_tercero = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['arr_total']['ie'] = $this->array_total_ie;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['labels']['ie'] = $Lab_ie; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_order']['IE_TERCERO']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_order']['IE_TERCERO'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_order']['IE_TERCERO'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['IE_TERCERO'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['IE_TERCERO'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['IE_TERCERO'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['IE_TERCERO'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['IE_TERCERO'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['IE_TERCERO'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['IE_TERCERO'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_tercero as $i_tercero => $d_tercero) {
           if (!in_array($i_tercero, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tercero[4] ] = $d_tercero[3];
               $this->comp_label[0][ $d_tercero[4] ] = $d_tercero[3];
           }
           foreach ($this->array_total_ie[$i_tercero] as $i_ie => $d_ie) {
               if (!in_array($i_ie, $this->comp_label[1][ $d_tercero[4] ], true)) {
                   $this->comp_index[1][ $d_ie[4] ] = $d_ie[3];
                   $this->comp_label[1][ $d_tercero[4] ][ $d_ie[4] ] = $d_ie[3];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'tercero', 'prot' => ''),
           array('name' => 'ie', 'prot' => '@aspass@'),
       );
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['pivot_order_level'] = -1;
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_tercero => $l_tercero) {
           if (isset($this->array_total_tercero[$i_tercero])) {
               $this->comp_group[$i_tercero] = array();
           }
           foreach ($this->comp_label[1][$i_tercero] as $i_ie => $l_ie) {
               if (isset($this->array_total_ie[$i_tercero][$i_ie])) {
                   $this->comp_group[$i_tercero][$i_ie] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_tercero;
       }
       elseif (1 == $level) {
           $return = $this->array_total_ie;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           ...
           '1|1' => array(
               ...
               'field_x'  => 'ie',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_ie)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '1|2' => array(
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_IE_TERCERO("res");
      ...
      ksort($this->array_total_tercero);
      ksort($this->array_total_ie);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor_total, $quebra_tercero, $quebra_ie, $quebra_tercero_orig, $quebra_ie_orig)
   {
      //----- Tercero
      if (!isset($this->array_total_tercero[$quebra_tercero_orig]))
      {
         $this->array_total_tercero[$quebra_tercero_orig][0] = 1;
         $this->array_total_tercero[$quebra_tercero_orig][1] = $sum_valor_total;
         $this->array_total_tercero[$quebra_tercero_orig][2] = 1;
         $this->array_total_tercero[$quebra_tercero_orig][3] = $quebra_tercero;
         $this->array_total_tercero[$quebra_tercero_orig][4] = $quebra_tercero_orig;
      }
      else
      {
         $this->array_total_tercero[$quebra_tercero_orig][0]++;
         $this->array_total_tercero[$quebra_tercero_orig][1] += $sum_valor_total;
         $this->array_total_tercero[$quebra_tercero_orig][2]++;
      }
      //----- IE
      if (!isset($this->array_total_ie[$quebra_tercero_orig][$quebra_ie_orig]))
      {
         $this->array_total_ie[$quebra_tercero_orig][$quebra_ie_orig][0] = 1;
         $this->array_total_ie[$quebra_tercero_orig][$quebra_ie_orig][1] = $sum_valor_total;
         $this->array_total_ie[$quebra_tercero_orig][$quebra_ie_orig][2] = 1;
         $this->array_total_ie[$quebra_tercero_orig][$quebra_ie_orig][3] = $quebra_ie;
         $this->array_total_ie[$quebra_tercero_orig][$quebra_ie_orig][4] = $quebra_ie_orig;
      }
      else
      {
         $this->array_total_ie[$quebra_tercero_orig][$quebra_ie_orig][0]++;
         $this->array_total_ie[$quebra_tercero_orig][$quebra_ie_orig][1] += $sum_valor_total;
         $this->array_total_ie[$quebra_tercero_orig][$quebra_ie_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'tercero');
     $campos_order = $this->Ini->Get_date_order_groupby("tercero", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'ie');
     $campos_order = $this->Ini->Get_date_order_groupby("ie", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $_SESSION['scriptcase']['grid_terceros_cuentas_porpagar_161219']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['grid_terceros_cuentas_porpagar_161219']['contr_erro'] = 'off'; 
            $this->tercero_orig = $this->tercero;
            $this->ie_orig = $this->ie;
            $this->tercero = $this->look_tercero ;
            $this->tipo = $this->look_tipo ;
            $this->usuario = $this->look_usuario ;
            $this->concepto = $this->look_concepto ;
            $this->ie = $this->look_ie ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor_total, $this->tercero, $this->ie, $this->tercero_orig,  $this->ie_orig);
            }
   }
//
