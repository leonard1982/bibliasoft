...
class grid_terceros_cuentas_porpagar_161219_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_cod_cuenta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['arr_total']['cod_cuenta'];
      }
      else
      {
          $this->array_total_cod_cuenta = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_order']['cuenta']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_order']['cuenta'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_order']['cuenta'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['cuenta'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['cuenta'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['cuenta'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['cuenta'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['cuenta'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['cuenta'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['summarizing_fields_display']['cuenta'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_cod_cuenta as $i_cod_cuenta => $d_cod_cuenta) {
           if (!in_array($i_cod_cuenta, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_cod_cuenta[4] ] = $d_cod_cuenta[3];
               $this->comp_label[0][ $d_cod_cuenta[4] ] = $d_cod_cuenta[3];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'cod_cuenta', 'prot' => '@aspass@'),
       );
       ...
       //-----
       foreach ($this->comp_label[0] as $i_cod_cuenta => $l_cod_cuenta) {
           if (isset($this->array_total_cod_cuenta[$i_cod_cuenta])) {
               $this->comp_group[$i_cod_cuenta] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_cod_cuenta;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_cuenta("res");
      ...
      krsort($this->array_total_cod_cuenta);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar_161219']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor_total, $quebra_cod_cuenta, $quebra_cod_cuenta_orig)
   {
      //----- Cuenta
      if (!isset($this->array_total_cod_cuenta[$quebra_cod_cuenta_orig]))
      {
         $this->array_total_cod_cuenta[$quebra_cod_cuenta_orig][0] = 1;
         $this->array_total_cod_cuenta[$quebra_cod_cuenta_orig][1] = $sum_valor_total;
         $this->array_total_cod_cuenta[$quebra_cod_cuenta_orig][2] = 1;
         $this->array_total_cod_cuenta[$quebra_cod_cuenta_orig][3] = $quebra_cod_cuenta;
         $this->array_total_cod_cuenta[$quebra_cod_cuenta_orig][4] = $quebra_cod_cuenta_orig;
      }
      else
      {
         $this->array_total_cod_cuenta[$quebra_cod_cuenta_orig][0]++;
         $this->array_total_cod_cuenta[$quebra_cod_cuenta_orig][1] += $sum_valor_total;
         $this->array_total_cod_cuenta[$quebra_cod_cuenta_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'cod_cuenta');
     $campos_order = $this->Ini->Get_date_order_groupby("cod_cuenta", 'desc', $format, $campos_order);
...
$_SESSION['scriptcase']['grid_terceros_cuentas_porpagar_161219']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor_total, $this->cod_cuenta, $this->cod_cuenta_orig);
            }
   }
//
