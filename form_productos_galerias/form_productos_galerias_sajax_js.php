  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_productos_galerias" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_productos_galerias_form();
	}
...
?>
  ...
  // ---------- Validate idproducto_galeria_
  function do_ajax_form_productos_galerias_validate_idproducto_galeria_(iNumLinha)
  {
    var nomeCampo_idproducto_galeria_ = "idproducto_galeria_" + iNumLinha;
    var var_idproducto_galeria_ = scAjaxGetFieldHidden(nomeCampo_idproducto_galeria_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_galerias_validate_idproducto_galeria_(var_idproducto_galeria_, iNumLinha, var_script_case_init, do_ajax_form_productos_galerias_validate_idproducto_galeria__cb);
  } // do_ajax_form_productos_galerias_validate_idproducto_galeria_

  function do_ajax_form_productos_galerias_validate_idproducto_galeria__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idproducto_galeria_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idproducto_galeria_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idproducto_galeria_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idproducto_galeria_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_galerias_validate_idproducto_galeria__cb

  // ---------- Validate idproducto_
  function do_ajax_form_productos_galerias_validate_idproducto_(iNumLinha)
  {
    var nomeCampo_idproducto_ = "idproducto_" + iNumLinha;
    var var_idproducto_ = scAjaxGetFieldText(nomeCampo_idproducto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_galerias_validate_idproducto_(var_idproducto_, iNumLinha, var_script_case_init, do_ajax_form_productos_galerias_validate_idproducto__cb);
  } // do_ajax_form_productos_galerias_validate_idproducto_

  function do_ajax_form_productos_galerias_validate_idproducto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_galerias_validate_idproducto__cb

  // ---------- Validate imagen_
  function do_ajax_form_productos_galerias_validate_imagen_(iNumLinha)
  {
    var nomeCampo_imagen_ = "imagen_" + iNumLinha;
    var var_imagen_ = scAjaxGetFieldText(nomeCampo_imagen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_galerias_validate_imagen_(var_imagen_, iNumLinha, var_script_case_init, do_ajax_form_productos_galerias_validate_imagen__cb);
  } // do_ajax_form_productos_galerias_validate_imagen_

  function do_ajax_form_productos_galerias_validate_imagen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_galerias_validate_imagen__cb

  // ---------- Validate descripcion_
  function do_ajax_form_productos_galerias_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_galerias_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_productos_galerias_validate_descripcion__cb);
  } // do_ajax_form_productos_galerias_validate_descripcion_

  function do_ajax_form_productos_galerias_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_galerias_validate_descripcion__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_productos_galerias_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_productos_galerias_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_galerias_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_productos_galerias_add_new_line_cb);
  } // do_ajax_form_productos_galerias_add_new_line

  function do_ajax_form_productos_galerias_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_productos_galerias_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_productos_galerias_backup_line(iNumLinha)
  {
    var var_idproducto_galeria_ = scAjaxGetFieldHidden("idproducto_galeria_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_galerias_backup_line(var_idproducto_galeria_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_productos_galerias_backup_line_cb);
  } // do_ajax_form_productos_galerias_backup_line

  function do_ajax_form_productos_galerias_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_productos_galerias_backup_line_cb

  function do_ajax_form_productos_galerias_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_productos_galerias_cancel_insert

  function do_ajax_form_productos_galerias_cancel_update(iSeqVert)
  {
    do_ajax_form_productos_galerias_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_productos_galerias_cancel_update

  function do_ajax_form_productos_galerias_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_productos_galerias_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_productos_galerias_table_refresh()
  {
    var var_idproducto_galeria_ = document.F2.idproducto_galeria_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_productos_galerias_table_refresh(var_idproducto_galeria_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_productos_galerias_table_refresh_cb);
  } //  do_ajax_form_productos_galerias_table_refresh

  function do_ajax_form_productos_galerias_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idproducto_galeria_.value = scAjaxGetKeyValue("idproducto_galeria_");
    ...
    scAjaxAlert(do_ajax_form_productos_galerias_table_refresh_cb_after_alert);
  } // do_ajax_form_productos_galerias_table_refresh_cb
  function do_ajax_form_productos_galerias_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_productos_galerias_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_productos_galerias_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_productos_galerias_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_imagen__salva = document.F1.elements["imagen_" + iNumLinha + "_salva"] ? eval('document.F1.imagen_' + iNumLinha + '_salva.value') : "";
...
?>
    x_ajax_form_productos_galerias_submit_form(var_idproducto_galeria_, var_idproducto_, var_imagen_, var_descripcion_, var_imagen__ul_name, var_imagen__ul_type, var_imagen__salva, var_imagen__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_productos_galerias_submit_form_cb);
  } // do_ajax_form_productos_galerias_submit_form

  function do_ajax_form_productos_galerias_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idproducto_galeria_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_galerias_submit_form_cb_after_alert);
  } // do_ajax_form_productos_galerias_submit_form_cb
  function do_ajax_form_productos_galerias_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_productos_galerias_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_productos_galerias_navigate_form()
  {
    perform_ajax_form_productos_galerias_navigate_form();
  }

  function perform_ajax_form_productos_galerias_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("idproducto_galeria_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_productos_galerias_navigate_form(var_idproducto_galeria_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_productos_galerias_navigate_form_cb);
  } // do_ajax_form_productos_galerias_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_galerias']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_productos_galerias_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idproducto_galeria_.value = scAjaxGetKeyValue("idproducto_galeria_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_productos_galerias_navigate_form_cb_after_alert);
  } // do_ajax_form_productos_galerias_navigate_form_cb
  function do_ajax_form_productos_galerias_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_productos_galerias_navigate_form_cb_after_alert
  function sc_hide_form_productos_galerias_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idproducto_galeria_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_error_list["idproducto_galeria_" + iNumLinha] = {"label": "Idproducto Galeria<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["idproducto_galeria_"][iNumLinha] = "idproducto_galeria_" + iNumLinha;
    ...
    ajax_error_count["idproducto_galeria_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["idproducto_galeria_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["idproducto_galeria_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idproducto_galeria_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idproducto_galeria_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idproducto_galeria_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idproducto_galeria_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idproducto_galeria_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idproducto_galeria_'])) ? $this->nmgp_cmp_readonly['idproducto_galeria_'] : 'on';
?>
    scAjaxFieldRead("idproducto_galeria_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idproducto_'])) ? $this->nmgp_cmp_readonly['idproducto_'] : 'off';
?>
...
?>
  ...
  {
    scAjaxFieldRead("idproducto_galeria_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idproducto_galeria_" + iRow] || "on" == ajax_error_count["idproducto_" + iRow] || "on" == ajax_error_count["imagen_" + iRow] || "on" == ajax_error_count["descripcion_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idproducto_galeria_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idproducto_galeria_" + iRow] && "off" == ajax_error_count["idproducto_" + iRow] && "off" == ajax_error_count["imagen_" + iRow] && "off" == ajax_error_count["descripcion_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idproducto_galeria_" + iRow] = "off";
      ...
      $("#hidden_field_data_idproducto_galeria_" + iRow).removeClass("scFormErrorLine");
