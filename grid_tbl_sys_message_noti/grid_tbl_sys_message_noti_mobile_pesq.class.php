...
class grid_tbl_sys_message_noti_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tbl_sys_message_noti_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tbl_sys_message_noti_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tbl_sys_message_noti_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "start_date";$Nm_datas[] = "start_date";$Nm_datas[] = "end_date";$Nm_datas[] = "end_date";$Nm_numeric[] = "id";$Nm_numeric[] = "cod_group";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "start_date";$Nm_datas[] = "start_date";$Nm_datas[] = "end_date";$Nm_datas[] = "end_date";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tbl_sys_message_noti/grid_tbl_sys_message_noti_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tbl_sys_message_noti_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tbl_sys_message_noti_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tbl_sys_message_noti_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbl_sys_message_noti']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tbl_sys_message_noti']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_start_date_cond#NMF#' + search_get_sel_txt('SC_start_date_cond') + '@NMF@';
  str_out += 'SC_start_date_dia#NMF#' + search_get_sel_txt('SC_start_date_dia') + '@NMF@';
  str_out += 'SC_start_date_mes#NMF#' + search_get_sel_txt('SC_start_date_mes') + '@NMF@';
  str_out += 'SC_start_date_ano#NMF#' + search_get_sel_txt('SC_start_date_ano') + '@NMF@';
  str_out += 'SC_start_date_input_2_dia#NMF#' + search_get_sel_txt('SC_start_date_input_2_dia') + '@NMF@';
  str_out += 'SC_start_date_input_2_mes#NMF#' + search_get_sel_txt('SC_start_date_input_2_mes') + '@NMF@';
  str_out += 'SC_start_date_input_2_ano#NMF#' + search_get_sel_txt('SC_start_date_input_2_ano') + '@NMF@';
  str_out += 'SC_id_cond#NMF#' + search_get_sel_txt('SC_id_cond') + '@NMF@';
  str_out += 'SC_id#NMF#' + search_get_text('SC_id') + '@NMF@';
  str_out += 'SC_cod_group_cond#NMF#' + search_get_sel_txt('SC_cod_group_cond') + '@NMF@';
  str_out += 'SC_cod_group#NMF#' + search_get_text('SC_cod_group') + '@NMF@';
  str_out += 'SC_text_message_cond#NMF#' + search_get_sel_txt('SC_text_message_cond') + '@NMF@';
  str_out += 'SC_text_message#NMF#' + search_get_text('SC_text_message') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> tbl_sys_message</div>
...
<?php
   ...
   {
      global 
             $start_date_cond, $start_date, $start_date_dia, $start_date_mes, $start_date_ano, $start_date_input_2_dia, $start_date_input_2_mes, $start_date_input_2_ano,
             $id_cond, $id,
             $cod_group_cond, $cod_group,
             $text_message_cond, $text_message,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_sys_message_noti']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_sys_message_noti']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_sys_message_noti']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_tbl_sys_message_noti", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $start_date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_dia']; 
          $start_date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_mes']; 
          $start_date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_ano']; 
          $start_date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_input_2_dia']; 
          $start_date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_input_2_mes']; 
          $start_date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_input_2_ano']; 
          $start_date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['id_cond']; 
          $cod_group = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['cod_group']; 
          $cod_group_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['cod_group_cond']; 
          $text_message = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['text_message']; 
          $text_message_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['text_message_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['NM_operador']; 
          ...
          if (strtoupper($cod_group_cond) != "II" && strtoupper($cod_group_cond) != "QP" && strtoupper($cod_group_cond) != "NP" && strtoupper($cod_group_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($cod_group, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($start_date_cond) || empty($start_date_cond))
      {
         $start_date_cond = "eq";
      }
      ...
      if (!isset($cod_group_cond) || empty($cod_group_cond))
      {
         $cod_group_cond = "gt";
      }
      if (!isset($text_message_cond) || empty($text_message_cond))
      {
         $text_message_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_start_date = (in_array($start_date_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id = (in_array($id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cod_group = (in_array($cod_group_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_text_message = (in_array($text_message_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_start_date = ('bw' == $start_date_cond) ? $display_aberto : $display_fechado;
      $str_display_id = ('bw' == $id_cond) ? $display_aberto : $display_fechado;
      $str_display_cod_group = ('bw' == $cod_group_cond) ? $display_aberto : $display_fechado;
      $str_display_text_message = ('bw' == $text_message_cond) ? $display_aberto : $display_fechado;
      ...
      {
         $tmp_pos = strpos($start_date, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $start_date = substr($start_date, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
      ...
      if (!isset($cod_group) || $cod_group == "")
      {
          $cod_group = "";
      }
      if (isset($cod_group) && !empty($cod_group))
      {
         $tmp_pos = strpos($cod_group, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cod_group = substr($cod_group, 0, $tmp_pos);
         }
      }
      if (!isset($text_message) || $text_message == "")
      {
          $text_message = "";
      }
      if (isset($text_message) && !empty($text_message))
      {
         $tmp_pos = strpos($text_message, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $text_message = substr($text_message, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
 ...
 $SC_Label = (isset($this->New_label['start_date'])) ? $this->New_label['start_date'] : "Start Date";
 $nmgp_tab_label .= "start_date?#?" . $SC_Label . "?@?";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_start_date_cond" name="start_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_start_date'), this, 'start_date')">
       <OPTION value="eq" <?php if ("eq" == $start_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $start_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $start_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $start_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_start_date"  <?php echo $str_hide_start_date?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
<?php
  ...
  {
?>
<span id='id_date_part_start_date_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_start_date_dia" name="start_date_dia" value="<?php echo NM_encode_input($start_date_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_start_date_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_start_date_mes" name="start_date_mes" value="<?php echo NM_encode_input($start_date_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_start_date_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_start_date_ano" name="start_date_ano" value="<?php echo NM_encode_input($start_date_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_start_date"  class="scFilterFieldFontOdd">
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_start_date"  <?php echo $str_display_start_date; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_start_date_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_start_date_input_2_dia" name="start_date_input_2_dia" value="<?php echo NM_encode_input($start_date_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_start_date_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_start_date_input_2_mes" name="start_date_input_2_mes" value="<?php echo NM_encode_input($start_date_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_start_date_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_start_date_input_2_ano" name="start_date_input_2_ano" value="<?php echo NM_encode_input($start_date_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
    ...
    <TD nowrap class="scFilterLabelOdd" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['cod_group'])) ? $this->New_label['cod_group'] : "Cod Group";
 $nmgp_tab_label .= "cod_group?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cod_group_cond" name="cod_group_cond" onChange="nm_campos_between(document.getElementById('id_vis_cod_group'), this, 'cod_group')">
       <OPTION value="gt" <?php if ("gt" == $cod_group_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $cod_group_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cod_group_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_cod_group"  <?php echo $str_hide_cod_group?>><INPUT  type="text" id="SC_cod_group" name="cod_group" value="<?php echo NM_encode_input($cod_group) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
    ...
    <TD nowrap class="scFilterLabelEven" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['text_message'])) ? $this->New_label['text_message'] : "Text Message";
 $nmgp_tab_label .= "text_message?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_text_message_cond" name="text_message_cond" onChange="nm_campos_between(document.getElementById('id_vis_text_message'), this, 'text_message')">
       <OPTION value="qp" <?php if ("qp" == $text_message_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $text_message_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $text_message_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $text_message_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_text_message"  <?php echo $str_hide_text_message?>><INPUT  type="text" id="SC_text_message" name="text_message" value="<?php echo NM_encode_input($text_message) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_tbl_sys_message_noti_help.txt"))
   {
      $Arq_WebHelp = file("grid_tbl_sys_message_noti_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_sys_message_noti']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tbl_sys_message_noti']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.start_date_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_start_date'), document.F1.start_date_cond, 'start_date');
   document.F1.start_date_dia.value = "";
   document.F1.start_date_mes.value = "";
   document.F1.start_date_ano.value = "";
   document.F1.start_date_input_2_dia.value = "";
   document.F1.start_date_input_2_mes.value = "";
   document.F1.start_date_input_2_ano.value = "";
   ...
   document.F1.cod_group_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_cod_group'), document.F1.cod_group_cond, 'cod_group');
   document.F1.cod_group.value = "";
   document.F1.text_message_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_text_message'), document.F1.text_message_cond, 'text_message');
   document.F1.text_message.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_start_date_dia').bind('change', function() {sc_grid_tbl_sys_message_noti_valida_dia(this)});
    $('#SC_start_date_input_2_dia').bind('change', function() {sc_grid_tbl_sys_message_noti_valida_dia(this)});
    $('#SC_start_date_input_2_mes').bind('change', function() {sc_grid_tbl_sys_message_noti_valida_mes(this)});
    $('#SC_start_date_mes').bind('change', function() {sc_grid_tbl_sys_message_noti_valida_mes(this)});
 }
 function sc_grid_tbl_sys_message_noti_valida_dia(obj)
 {
 ...
 function sc_grid_tbl_sys_message_noti_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['pesq_tab_label'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_tbl_sys_message_noti/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_start_date_cond'] = 'cond';
      $tp_fields['SC_start_date_dia'] = 'text';
      $tp_fields['SC_start_date_mes'] = 'text';
      $tp_fields['SC_start_date_ano'] = 'text';
      $tp_fields['SC_start_date_input_2_dia'] = 'text';
      $tp_fields['SC_start_date_input_2_mes'] = 'text';
      $tp_fields['SC_start_date_input_2_ano'] = 'text';
      $tp_fields['SC_id_cond'] = 'cond';
      $tp_fields['SC_id'] = 'text';
      $tp_fields['SC_cod_group_cond'] = 'cond';
      $tp_fields['SC_cod_group'] = 'text';
      $tp_fields['SC_text_message_cond'] = 'cond';
      $tp_fields['SC_text_message'] = 'text';
   ...
   {
      global $start_date_cond, $start_date, $start_date_dia, $start_date_mes, $start_date_ano, $start_date_input_2_dia, $start_date_input_2_mes, $start_date_input_2_ano,
             $id_cond, $id,
             $cod_group_cond, $cod_group,
             $text_message_cond, $text_message, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq'] = array();
      $start_date_cond_salva = $start_date_cond; 
      if (!isset($start_date_input_2_dia) || $start_date_input_2_dia == "")
      {
          $start_date_input_2_dia = $start_date_dia;
      }
      if (!isset($start_date_input_2_mes) || $start_date_input_2_mes == "")
      {
          $start_date_input_2_mes = $start_date_mes;
      }
      if (!isset($start_date_input_2_ano) || $start_date_input_2_ano == "")
      {
          $start_date_input_2_ano = $start_date_ano;
      }
      ...
      $cod_group_cond_salva = $cod_group_cond; 
      if (!isset($cod_group_input_2) || $cod_group_input_2 == "")
      {
          $cod_group_input_2 = $cod_group;
      }
      $text_message_cond_salva = $text_message_cond; 
      if (!isset($text_message_input_2) || $text_message_input_2 == "")
      {
          $text_message_input_2 = $text_message;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($cod_group_cond != "in")
      {
          nm_limpa_numero($cod_group, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_dia'] = $start_date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_mes'] = $start_date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_ano'] = $start_date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_input_2_dia'] = $start_date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_input_2_mes'] = $start_date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_input_2_ano'] = $start_date_input_2_ano; 
      if (!empty($start_date_dia) || !empty($start_date_mes) || !empty($start_date_ano) || $start_date_cond_salva == "nu" || $start_date_cond_salva == "nn" || $start_date_cond_salva == "ep" || $start_date_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $start_date_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $start_date_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $start_date_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $start_date_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $start_date_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $start_date_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_cond'] = $start_date_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['cmp'] = "start_date"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['opc'] = $start_date_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq']['start_date'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['id'] = $id; 
      if (is_array($id) && !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['val'][0] = $id;
      }
      elseif ($id_cond_salva == "nu" || $id_cond_salva == "nn" || $id_cond_salva == "ep" || $id_cond_salva == "ne" || !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['val'][0][0] = $id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['id_cond'] = $id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['cmp'] = "id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['opc'] = $id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq']['id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['cod_group'] = $cod_group; 
      if (is_array($cod_group) && !empty($cod_group))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['val'][0] = $cod_group;
      }
      elseif ($cod_group_cond_salva == "nu" || $cod_group_cond_salva == "nn" || $cod_group_cond_salva == "ep" || $cod_group_cond_salva == "ne" || !empty($cod_group))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['val'][0][0] = $cod_group;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['cod_group_cond'] = $cod_group_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['cmp'] = "cod_group"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['opc'] = $cod_group_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq']['cod_group'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['text_message'] = $text_message; 
      if (is_array($text_message) && !empty($text_message))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['val'][0] = $text_message;
      }
      elseif ($text_message_cond_salva == "nu" || $text_message_cond_salva == "nn" || $text_message_cond_salva == "ep" || $text_message_cond_salva == "ne" || !empty($text_message))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['val'][0][0] = $text_message;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['text_message_cond'] = $text_message_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['cmp'] = "text_message"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid]['opc'] = $text_message_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq']['text_message'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['cod_group'] = $Conteudo;
      $Conteudo = $text_message;
      $this->cmp_formatado['text_message'] = $Conteudo;

      //----- $start_date
      $this->Date_part = false;
      if ($start_date_cond != "bi_TP")
      {
          $start_date_cond = strtoupper($start_date_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $start_date_ano;
          $Dtxt .= $start_date_mes;
          $Dtxt .= $start_date_dia;
          $val[0]['ano'] = $start_date_ano;
          $val[0]['mes'] = $start_date_mes;
          $val[0]['dia'] = $start_date_dia;
          if ($start_date_cond == "BW")
          {
              $val[1]['ano'] = $start_date_input_2_ano;
              $val[1]['mes'] = $start_date_input_2_mes;
              $val[1]['dia'] = $start_date_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $start_date_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $start_date_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $start_date = $val[0];
          $this->cmp_formatado['start_date'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['start_date'], "YYYY-MM-DD");
          $this->cmp_formatado['start_date'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($start_date_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $start_date_input_2     = $val[1];
              $this->cmp_formatado['start_date_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']['start_date_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['start_date_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['start_date_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $start_date_cond == "NU" || $start_date_cond == "NN"|| $start_date_cond == "EP"|| $start_date_cond == "NE")
          {
              $this->monta_condicao("start_date", $start_date_cond, $start_date, $start_date_input_2, 'start_date', 'DATE');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq']['start_date']['label'] = $nmgp_tab_label['start_date'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq']['start_date']['descr'] = $nmgp_tab_label['start_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['grid_pesq']['start_date']['hint']  = $nmgp_tab_label['start_date'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      //----- $cod_group
      $this->Date_part = false;
      if (isset($cod_group) || $cod_group_cond == "nu" || $cod_group_cond == "nn" || $cod_group_cond == "ep" || $cod_group_cond == "ne")
      {
         $this->monta_condicao("cod_group", $cod_group_cond, $cod_group, "", "cod_group");
      }

      //----- $text_message
      $this->Date_part = false;
      if (isset($text_message) || $text_message_cond == "nu" || $text_message_cond == "nn" || $text_message_cond == "ep" || $text_message_cond == "ne")
      {
         $this->monta_condicao("text_message", $text_message_cond, $text_message, "", "text_message");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_sys_message_noti']['cond_pesq'] .= $this->NM_operador;
