...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_tbl_sys_message_noti"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_tbl_sys_message_noti"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbl_sys_message_noti'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_sys_message_noti']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_sys_message_noti']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_sys_message_noti']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_sys_message_noti']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_sys_message_noti']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbl_sys_message_noti</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_sys_message_noti']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbl_sys_message_noti']['embutida_filho'] as $ind => $sc_init)
          {
