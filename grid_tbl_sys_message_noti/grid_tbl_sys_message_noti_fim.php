...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_tbl_sys_message_noti"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_tbl_sys_message_noti"]);
   }
