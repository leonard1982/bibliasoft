...
<?php
   ...
   $Ord_Cmp = new grid_tbl_sys_message_noti_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbl_sys_message_noti_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['labels']["id"] : "Id";
   $tab_ger_campos['cod_group'] = "on";
   $tab_def_campos['cod_group'] = "cod_group";
   $tab_labels["cod_group"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['labels']["cod_group"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['labels']["cod_group"] : "Cod Group";
   $tab_ger_campos['text_message'] = "on";
   $tab_def_campos['text_message'] = "text_message";
   $tab_labels["text_message"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['labels']["text_message"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['labels']["text_message"] : "Text Message";
   $tab_ger_campos['start_date'] = "on";
   $tab_def_campos['start_date'] = "start_date";
   $tab_labels["start_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['labels']["start_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['labels']["start_date"] : "Start Date";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbl_sys_message_noti_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbl_sys_message_noti']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
