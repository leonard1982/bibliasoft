...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> tbl_sys_message</TITLE>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_start_date_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['start_date'])) ? $this->New_label['start_date'] : "Start Date"; ?></TD>
...
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_cod_group_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cod_group'])) ? $this->New_label['cod_group'] : "Cod Group"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cod_group_cond" name="cod_group_cond" onChange="nm_campos_between(document.getElementById('id_vis_cod_group'), this, 'cod_group')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cod_group" <?php echo $str_hide_cod_group?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
?>
<INPUT  type="text" id="SC_cod_group" name="cod_group" value="<?php echo NM_encode_input($cod_group) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_text_message_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['text_message'])) ? $this->New_label['text_message'] : "Text Message"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_text_message_cond" name="text_message_cond" onChange="nm_campos_between(document.getElementById('id_vis_text_message'), this, 'text_message')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_text_message" <?php echo $str_hide_text_message?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
?>
<INPUT  type="text" id="SC_text_message" name="text_message" value="<?php echo NM_encode_input($text_message) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
