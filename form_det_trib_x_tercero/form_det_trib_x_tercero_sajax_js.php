  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_det_trib_x_tercero" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_det_trib_x_tercero_form();
	}
...
?>
  ...
  // ---------- Validate id_dt_ter
  function do_ajax_form_det_trib_x_tercero_validate_id_dt_ter()
  {
    var nomeCampo_id_dt_ter = "id_dt_ter";
    var var_id_dt_ter = scAjaxGetFieldHidden(nomeCampo_id_dt_ter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_det_trib_x_tercero_validate_id_dt_ter(var_id_dt_ter, var_script_case_init, do_ajax_form_det_trib_x_tercero_validate_id_dt_ter_cb);
  } // do_ajax_form_det_trib_x_tercero_validate_id_dt_ter

  function do_ajax_form_det_trib_x_tercero_validate_id_dt_ter_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_det_trib_x_tercero_validate_id_dt_ter_cb

  // ---------- Validate id_tercero
  function do_ajax_form_det_trib_x_tercero_validate_id_tercero()
  {
    var nomeCampo_id_tercero = "id_tercero";
    var var_id_tercero = scAjaxGetFieldText(nomeCampo_id_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_det_trib_x_tercero_validate_id_tercero(var_id_tercero, var_script_case_init, do_ajax_form_det_trib_x_tercero_validate_id_tercero_cb);
  } // do_ajax_form_det_trib_x_tercero_validate_id_tercero

  function do_ajax_form_det_trib_x_tercero_validate_id_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_det_trib_x_tercero_validate_id_tercero_cb

  // ---------- Validate decripcion_dt
  function do_ajax_form_det_trib_x_tercero_validate_decripcion_dt()
  {
    var nomeCampo_decripcion_dt = "decripcion_dt";
    var var_decripcion_dt = scAjaxGetFieldText(nomeCampo_decripcion_dt);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_det_trib_x_tercero_validate_decripcion_dt(var_decripcion_dt, var_script_case_init, do_ajax_form_det_trib_x_tercero_validate_decripcion_dt_cb);
  } // do_ajax_form_det_trib_x_tercero_validate_decripcion_dt

  function do_ajax_form_det_trib_x_tercero_validate_decripcion_dt_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_det_trib_x_tercero_validate_decripcion_dt_cb

  // ---------- Validate cod_det_trib
  function do_ajax_form_det_trib_x_tercero_validate_cod_det_trib()
  {
    var nomeCampo_cod_det_trib = "cod_det_trib";
    var var_cod_det_trib = scAjaxGetFieldSelect(nomeCampo_cod_det_trib);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_det_trib_x_tercero_validate_cod_det_trib(var_cod_det_trib, var_script_case_init, do_ajax_form_det_trib_x_tercero_validate_cod_det_trib_cb);
  } // do_ajax_form_det_trib_x_tercero_validate_cod_det_trib

  function do_ajax_form_det_trib_x_tercero_validate_cod_det_trib_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_det_trib_x_tercero_validate_cod_det_trib_cb

  // ---------- Event onchange cod_det_trib
  function do_ajax_form_det_trib_x_tercero_event_cod_det_trib_onchange()
  {
    var var_cod_det_trib = scAjaxGetFieldSelect("cod_det_trib");
    var var_decripcion_dt = scAjaxGetFieldText("decripcion_dt");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_det_trib_x_tercero_event_cod_det_trib_onchange(var_cod_det_trib, var_decripcion_dt, var_script_case_init, do_ajax_form_det_trib_x_tercero_event_cod_det_trib_onchange_cb);
  } // do_ajax_form_det_trib_x_tercero_event_cod_det_trib_onchange

  function do_ajax_form_det_trib_x_tercero_event_cod_det_trib_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cod_det_trib";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_det_trib_x_tercero_event_cod_det_trib_onchange_cb_after_alert);
  } // do_ajax_form_det_trib_x_tercero_event_cod_det_trib_onchange_cb
  function do_ajax_form_det_trib_x_tercero_event_cod_det_trib_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_det_trib_x_tercero_event_cod_det_trib_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_det_trib_x_tercero_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_det_trib_x_tercero_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_det_trib_x_tercero_submit_form(var_id_dt_ter, var_id_tercero, var_decripcion_dt, var_cod_det_trib, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_det_trib_x_tercero_submit_form_cb);
  } // do_ajax_form_det_trib_x_tercero_submit_form

  function do_ajax_form_det_trib_x_tercero_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_det_trib_x_tercero_submit_form_cb_after_alert);
  } // do_ajax_form_det_trib_x_tercero_submit_form_cb
  function do_ajax_form_det_trib_x_tercero_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_det_trib_x_tercero_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_det_trib_x_tercero_navigate_form()
  {
    perform_ajax_form_det_trib_x_tercero_navigate_form();
  }

  function perform_ajax_form_det_trib_x_tercero_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_det_trib_x_tercero_navigate_form(var_id_dt_ter, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_det_trib_x_tercero_navigate_form_cb);
  } // do_ajax_form_det_trib_x_tercero_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_trib_x_tercero']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_det_trib_x_tercero_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_det_trib_x_tercero_navigate_form_cb_after_alert);
  } // do_ajax_form_det_trib_x_tercero_navigate_form_cb
  function do_ajax_form_det_trib_x_tercero_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('');
...
{
?>
    do_ajax_form_det_trib_x_tercero_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_det_trib_x_tercero_navigate_form_cb_after_alert
  function sc_hide_form_det_trib_x_tercero_form()
  {
