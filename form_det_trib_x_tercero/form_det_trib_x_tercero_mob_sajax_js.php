  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_det_trib_x_tercero_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_det_trib_x_tercero_mob_form();
	}
  ...
  // ---------- Validate id_dt_ter
  function do_ajax_form_det_trib_x_tercero_mob_validate_id_dt_ter()
  {
    var nomeCampo_id_dt_ter = "id_dt_ter";
    var var_id_dt_ter = scAjaxGetFieldHidden(nomeCampo_id_dt_ter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_det_trib_x_tercero_mob_validate_id_dt_ter(var_id_dt_ter, var_script_case_init, do_ajax_form_det_trib_x_tercero_mob_validate_id_dt_ter_cb);
  } // do_ajax_form_det_trib_x_tercero_mob_validate_id_dt_ter

  function do_ajax_form_det_trib_x_tercero_mob_validate_id_dt_ter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_dt_ter";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_det_trib_x_tercero_mob_validate_id_dt_ter_cb

  // ---------- Validate id_tercero
  function do_ajax_form_det_trib_x_tercero_mob_validate_id_tercero()
  {
    var nomeCampo_id_tercero = "id_tercero";
    var var_id_tercero = scAjaxGetFieldText(nomeCampo_id_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_det_trib_x_tercero_mob_validate_id_tercero(var_id_tercero, var_script_case_init, do_ajax_form_det_trib_x_tercero_mob_validate_id_tercero_cb);
  } // do_ajax_form_det_trib_x_tercero_mob_validate_id_tercero

  function do_ajax_form_det_trib_x_tercero_mob_validate_id_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_det_trib_x_tercero_mob_validate_id_tercero_cb

  // ---------- Validate decripcion_dt
  function do_ajax_form_det_trib_x_tercero_mob_validate_decripcion_dt()
  {
    var nomeCampo_decripcion_dt = "decripcion_dt";
    var var_decripcion_dt = scAjaxGetFieldText(nomeCampo_decripcion_dt);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_det_trib_x_tercero_mob_validate_decripcion_dt(var_decripcion_dt, var_script_case_init, do_ajax_form_det_trib_x_tercero_mob_validate_decripcion_dt_cb);
  } // do_ajax_form_det_trib_x_tercero_mob_validate_decripcion_dt

  function do_ajax_form_det_trib_x_tercero_mob_validate_decripcion_dt_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "decripcion_dt";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_det_trib_x_tercero_mob_validate_decripcion_dt_cb

  // ---------- Validate cod_det_trib
  function do_ajax_form_det_trib_x_tercero_mob_validate_cod_det_trib()
  {
    var nomeCampo_cod_det_trib = "cod_det_trib";
    var var_cod_det_trib = scAjaxGetFieldSelect(nomeCampo_cod_det_trib);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_det_trib_x_tercero_mob_validate_cod_det_trib(var_cod_det_trib, var_script_case_init, do_ajax_form_det_trib_x_tercero_mob_validate_cod_det_trib_cb);
  } // do_ajax_form_det_trib_x_tercero_mob_validate_cod_det_trib

  function do_ajax_form_det_trib_x_tercero_mob_validate_cod_det_trib_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cod_det_trib";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_det_trib_x_tercero_mob_validate_cod_det_trib_cb

  // ---------- Event onchange cod_det_trib
  function do_ajax_form_det_trib_x_tercero_mob_event_cod_det_trib_onchange()
  {
    var var_cod_det_trib = scAjaxGetFieldSelect("cod_det_trib");
    var var_decripcion_dt = scAjaxGetFieldText("decripcion_dt");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_det_trib_x_tercero_mob_event_cod_det_trib_onchange(var_cod_det_trib, var_decripcion_dt, var_script_case_init, do_ajax_form_det_trib_x_tercero_mob_event_cod_det_trib_onchange_cb);
  } // do_ajax_form_det_trib_x_tercero_mob_event_cod_det_trib_onchange

  function do_ajax_form_det_trib_x_tercero_mob_event_cod_det_trib_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cod_det_trib";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_det_trib_x_tercero_mob_event_cod_det_trib_onchange_cb_after_alert);
  } // do_ajax_form_det_trib_x_tercero_mob_event_cod_det_trib_onchange_cb
  function do_ajax_form_det_trib_x_tercero_mob_event_cod_det_trib_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_det_trib_x_tercero_mob_event_cod_det_trib_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_det_trib_x_tercero_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_det_trib_x_tercero_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_dt_ter = scAjaxGetFieldHidden("id_dt_ter");
    ...
    scAjaxProcOn();
    x_ajax_form_det_trib_x_tercero_mob_submit_form(var_id_dt_ter, var_id_tercero, var_decripcion_dt, var_cod_det_trib, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_det_trib_x_tercero_mob_submit_form_cb);
  } // do_ajax_form_det_trib_x_tercero_mob_submit_form

  function do_ajax_form_det_trib_x_tercero_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_dt_ter");
      scAjaxHideErrorDisplay("id_tercero");
      scAjaxHideErrorDisplay("decripcion_dt");
      scAjaxHideErrorDisplay("cod_det_trib");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_det_trib_x_tercero_mob_submit_form_cb_after_alert);
  } // do_ajax_form_det_trib_x_tercero_mob_submit_form_cb
  function do_ajax_form_det_trib_x_tercero_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_det_trib_x_tercero_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_det_trib_x_tercero_mob_navigate_form()
  {
    perform_ajax_form_det_trib_x_tercero_mob_navigate_form();
  }

  function perform_ajax_form_det_trib_x_tercero_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("decripcion_dt");
    scAjaxHideErrorDisplay("cod_det_trib");
    var var_id_dt_ter = document.F2.id_dt_ter.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_det_trib_x_tercero_mob_navigate_form(var_id_dt_ter, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_det_trib_x_tercero_mob_navigate_form_cb);
  } // do_ajax_form_det_trib_x_tercero_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_det_trib_x_tercero_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_det_trib_x_tercero_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_dt_ter.value = scAjaxGetKeyValue("id_dt_ter");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_det_trib_x_tercero_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_det_trib_x_tercero_mob_navigate_form_cb
  function do_ajax_form_det_trib_x_tercero_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('');
...
{
?>
    do_ajax_form_det_trib_x_tercero_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_det_trib_x_tercero_mob_navigate_form_cb_after_alert
  function sc_hide_form_det_trib_x_tercero_mob_form()
  {
  ...
  ajax_field_list[0] = "id_dt_ter";
  ajax_field_list[1] = "id_tercero";
  ajax_field_list[2] = "decripcion_dt";
  ajax_field_list[3] = "cod_det_trib";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_dt_ter": {"label": "Id Dt Ter", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_tercero": {"label": "Cliente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "decripcion_dt": {"label": "Descripción Detalle tributario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cod_det_trib": {"label": "Descripción Detalle tributario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "decripcion_dt": new Array(),
    "cod_det_trib": new Array()
  };
  ajax_field_mult["id_dt_ter"][1] = "id_dt_ter";
  ajax_field_mult["id_tercero"][1] = "id_tercero";
  ajax_field_mult["decripcion_dt"][1] = "decripcion_dt";
  ajax_field_mult["cod_det_trib"][1] = "cod_det_trib";

  var ajax_field_id = {
    "cod_det_trib": new Array("hidden_field_label_cod_det_trib", "hidden_field_data_cod_det_trib")
  };
