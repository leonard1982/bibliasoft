<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_dt_ter" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_dt_ter']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_trib_x_tercero']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_det_trib_x_tercero"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_det_trib_x_tercero']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_form_det_trib_x_tercero_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_det_trib_x_tercero_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
...
function lookup_id_tercero(campo)
{
   dados  = document.F1.id_tercero.value;
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_det_trib_x_tercero')?>/form_det_trib_x_tercero.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_id_tercero, "id_tercero", dados, false);
}
function recebe_id_tercero(string)
{
   document.getElementById('id_lookup_id_tercero').innerHTML = string;
}
<?php 
