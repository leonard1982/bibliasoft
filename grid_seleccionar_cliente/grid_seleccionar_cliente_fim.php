...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_seleccionar_cliente"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_seleccionar_cliente"]);
   }
