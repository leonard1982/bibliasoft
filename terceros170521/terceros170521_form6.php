<div id="terceros170521_form6" style='<?php echo ($this->tabCssClass["terceros170521_form6"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_es_restaurante_line"> <div class="sc radio">
<?php $tempOptionId = "id-opt-es_restaurante" . $sc_seq_vert . "-1"; ?>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['Lookup_es_restaurante'][] = 'NO'; ?>
<?php  if ("NO" == $this->es_restaurante)  { echo " checked" ;} ?><?php  if (empty($this->es_restaurante)) { echo " checked" ;} ?>  onClick="" ><span></span>
<label for="<?php echo $tempOptionId ?>">NO</label> </div>
</TD>
</TR>
<TR>
  <TD class="scFormDataFontOdd css_es_restaurante_line"> <div class="sc radio">
<?php $tempOptionId = "id-opt-es_restaurante" . $sc_seq_vert . "-2"; ?>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['Lookup_es_restaurante'][] = 'SI'; ?>
<?php  if ("SI" == $this->es_restaurante)  { echo " checked" ;} ?>  onClick="" ><span></span>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script> 
<?php
 $NM_pag_atual = "terceros170521_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "terceros170521_form" . $this->nmgp_ancora;
 }
?>
<?php
...
?>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['masterValue']))
{
...
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['masterValue'] as $cmp_master => $val_master)
        {
?>
    dbParentFrame[0].contentWindow.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
        }
        unset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['masterValue']);
?>
}
<?php
    }
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("terceros170521");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("terceros170521");
 parent.scAjaxDetailHeight("terceros170521", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['sc_modal'])
{
?>
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
