 ...
 */
   ...
   // scriptcase
   include_once('terceros170521_session.php');
   @session_start();
   // ----------
...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['terceros170521']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['terceros170521']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['terceros170521']['upload_field_info'][ $_POST['param_field'] ];
