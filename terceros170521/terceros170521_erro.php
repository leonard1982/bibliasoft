...
$old_error_handler = set_error_handler("terceros170521_scriptcase_error_handler");

function terceros170521_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['terceros170521']['contr_erro']) && $_SESSION['scriptcase']['terceros170521']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_terceros170521->contr_terceros170521->Apl_com_erro = true;
            if ($inicial_terceros170521->contr_terceros170521->NM_ajax_flag)
            {
                $inicial_terceros170521->contr_terceros170521->NM_ajax_info['errList']['geral_terceros170521'][] = $msg;
                return;
            }
            terceros170521_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function terceros170521_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['terceros170521'])  && '' != $_SESSION['scriptcase']['error_icon']['terceros170521'])  ? $_SESSION['scriptcase']['error_icon']['terceros170521']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['terceros170521']) && '' != $_SESSION['scriptcase']['error_close']['terceros170521']) ? $_SESSION['scriptcase']['error_close']['terceros170521'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['terceros170521']) && '' != $_SESSION['scriptcase']['error_span_title']['terceros170521']) ? $_SESSION['scriptcase']['error_span_title']['terceros170521'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['terceros170521']) && '' != $_SESSION['scriptcase']['error_icon_title']['terceros170521']) ? $_SESSION['scriptcase']['error_icon_title']['terceros170521'] : '';
?>
