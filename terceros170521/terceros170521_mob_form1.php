<div id="terceros170521_mob_form1" style='<?php echo ($this->tabCssClass["terceros170521_mob_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_credito'][] = 'NO'; ?>
 <option  value="SI" <?php  if ($this->credito == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_credito'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_efec_retencion'][] = 'N'; ?>
 <option  value="S" <?php  if ($this->efec_retencion == "S") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_efec_retencion'][] = 'S'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_listaprecios'][] = '1'; ?>
 <option  value="2" <?php  if ($this->listaprecios == "2") { echo " selected" ;} ?>>Precio Intermedio</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_listaprecios'][] = '2'; ?>
 <option  value="3" <?php  if ($this->listaprecios == "3") { echo " selected" ;} ?>>Precio Mínimo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_listaprecios'][] = '3'; ?>
 </select></span>
</span><?php  }?>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_loatiende']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_loatiende'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_loatiende']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_loatiende'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_loatiende'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_loatiende'][] = ''; 
...
$autorizado_look = "";
 if ($this->autorizado == "SI") { $autorizado_look .= "" ;} 
...
<span id="id_read_on_autorizado" class="css_autorizado_line" style="<?php echo $sStyleReadLab_autorizado; ?>"><?php echo $this->form_format_readonly("autorizado", $this->form_encode_input($autorizado_look)); ?></span><span id="id_read_off_autorizado" class="css_read_off_autorizado css_autorizado_line" style="<?php echo $sStyleReadInp_autorizado; ?>"><?php echo "<div id=\"idAjaxCheckbox_autorizado\" style=\"display: inline-block\" class=\"css_autorizado_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_autorizado'][] = 'SI'; ?>
<?php  if (in_array("SI", $this->autorizado_1))  { echo " checked" ;} ?> onClick="" ><label for="<?php echo $tempOptionId ?>"></label></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<TABLE align="center" id="hidden_bloco_7" class="scFormTable<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont"><?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && !$this->Ini->Export_img_zip) { echo "<table style=\"border-collapse: collapse; height: 100%; width: 100%\"><tr><td style=\"vertical-align: middle; border-width: 0px; padding: 0px 2px 0px 0px\"><img id=\"SC_blk_pdf7\" src=\"" . $this->Ini->path_icones . "/" . $this->Ini->Block_img_col . "\" style=\"border: 0px; float: left\" class=\"sc-ui-block-control\"></td><td style=\"border-width: 0px; padding: 0px; width: 100%;\" class=\"scFormBlockAlign\">"; } ?>Datos contacto y cumpleaños<?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && !$this->Ini->Export_img_zip) { echo "</td></tr></table>"; } ?></TD>
...
<TABLE align="center" id="hidden_bloco_8" class="scFormTable<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont"><?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && !$this->Ini->Export_img_zip) { echo "<table style=\"border-collapse: collapse; height: 100%; width: 100%\"><tr><td style=\"vertical-align: middle; border-width: 0px; padding: 0px 2px 0px 0px\"><img id=\"SC_blk_pdf8\" src=\"" . $this->Ini->path_icones . "/" . $this->Ini->Block_img_col . "\" style=\"border: 0px; float: left\" class=\"sc-ui-block-control\"></td><td style=\"border-width: 0px; padding: 0px; width: 100%;\" class=\"scFormBlockAlign\">"; } ?>REQUERIDOS DIAN<?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && !$this->Ini->Export_img_zip) { echo "</td></tr></table>"; } ?></TD>
...
$sucur_cliente_look = "";
 if ($this->sucur_cliente == "NO") { $sucur_cliente_look .= "NO" ;} 
...
$sucur_cliente_look = "";
 ...
 if (empty($sucur_cliente_look)) { $sucur_cliente_look = $this->sucur_cliente; }
?>
<span id="id_read_on_sucur_cliente" class="css_sucur_cliente_line"  style="<?php echo $sStyleReadLab_sucur_cliente; ?>"><?php echo $this->form_format_readonly("sucur_cliente", $this->form_encode_input($sucur_cliente_look)); ?></span><span id="id_read_off_sucur_cliente" class="css_read_off_sucur_cliente<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap; <?php echo $sStyleReadInp_sucur_cliente; ?>">
 <span id="idAjaxSelect_sucur_cliente" class="<?php echo $this->classes_100perc_fields['span_select'] ?>"><select class="sc-js-input scFormObjectOdd css_sucur_cliente_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_sucur_cliente" name="sucur_cliente" size="1" alt="{type: 'select', enterTab: true}">
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_sucur_cliente'][] = ''; ?>
 <option value="">  </option>
 <option  value="NO" <?php  if ($this->sucur_cliente == "NO") { echo " selected" ;} ?><?php  if (empty($this->sucur_cliente)) { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_sucur_cliente'][] = 'NO'; ?>
 <option  value="SI" <?php  if ($this->sucur_cliente == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros170521_mob']['Lookup_sucur_cliente'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<TABLE align="center" id="hidden_bloco_11" class="scFormTable<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;">   <tr>
