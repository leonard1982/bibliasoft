...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'es_tecnico':
      case 'activo':
        sc_exib_ocult_pag('terceros170521_mob_form0');
        break;
      case 'credito':
      case 'cupo':
      case 'cupodis':
      ...
      case 'saldo':
      case 'afiliacion':
        sc_exib_ocult_pag('terceros170521_mob_form1');
        break;
      case 'es_cajero':
      case 'cupo_vendedor':
        sc_exib_ocult_pag('terceros170521_mob_form2');
        break;
      case 'autoretenedor':
      case 'creditoprov':
      case 'dias':
      ...
      case 'fechultcomp':
      case 'saldoapagar':
        sc_exib_ocult_pag('terceros170521_mob_form3');
        break;
      case 'codigo_ter':
      case 'zona_clientes':
      ...
      case 'puc_retefuente_servicios_prov':
        sc_exib_ocult_pag('terceros170521_mob_form4');
        break;
      case 'archivos':
        sc_exib_ocult_pag('terceros170521_mob_form5');
        break;
      case 'es_restaurante':
      case 'porcentaje_propina_sugerida':
        sc_exib_ocult_pag('terceros170521_mob_form6');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idtercero' + iSeqRow).bind('blur', function() { sc_terceros170521_idtercero_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros170521_idtercero_onfocus(this, iSeqRow) });
  $('#id_sc_field_documento' + iSeqRow).bind('blur', function() { sc_terceros170521_documento_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros170521_documento_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros170521_documento_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombres' + iSeqRow).bind('blur', function() { sc_terceros170521_nombres_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros170521_nombres_onfocus(this, iSeqRow) });
  $('#id_sc_field_direccion' + iSeqRow).bind('blur', function() { sc_terceros170521_direccion_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros170521_direccion_onfocus(this, iSeqRow) });
  $('#id_sc_field_tel_cel' + iSeqRow).bind('blur', function() { sc_terceros170521_tel_cel_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros170521_tel_cel_onfocus(this, iSeqRow) });
  $('#id_sc_field_nacimiento' + iSeqRow).bind('blur', function() { sc_terceros170521_nacimiento_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_terceros170521_nacimiento_onfocus(this, iSeqRow) });
  $('#id_sc_field_sexo' + iSeqRow).bind('blur', function() { sc_terceros170521_sexo_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_terceros170521_sexo_onfocus(this, iSeqRow) });
  $('#id_sc_field_urlmail' + iSeqRow).bind('blur', function() { sc_terceros170521_urlmail_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros170521_urlmail_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechault' + iSeqRow).bind('blur', function() { sc_terceros170521_fechault_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros170521_fechault_onfocus(this, iSeqRow) });
  $('#id_sc_field_saldo' + iSeqRow).bind('blur', function() { sc_terceros170521_saldo_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_terceros170521_saldo_onfocus(this, iSeqRow) });
  $('#id_sc_field_afiliacion' + iSeqRow).bind('blur', function() { sc_terceros170521_afiliacion_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_terceros170521_afiliacion_onfocus(this, iSeqRow) });
  $('#id_sc_field_idmuni' + iSeqRow).bind('blur', function() { sc_terceros170521_idmuni_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_terceros170521_idmuni_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_terceros170521_idmuni_onfocus(this, iSeqRow) });
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_terceros170521_observaciones_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros170521_observaciones_onfocus(this, iSeqRow) });
  $('#id_sc_field_credito' + iSeqRow).bind('blur', function() { sc_terceros170521_credito_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros170521_credito_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros170521_credito_onfocus(this, iSeqRow) });
  $('#id_sc_field_cupo' + iSeqRow).bind('blur', function() { sc_terceros170521_cupo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_terceros170521_cupo_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_terceros170521_cupo_onfocus(this, iSeqRow) });
  $('#id_sc_field_listaprecios' + iSeqRow).bind('blur', function() { sc_terceros170521_listaprecios_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_terceros170521_listaprecios_onfocus(this, iSeqRow) });
  $('#id_sc_field_loatiende' + iSeqRow).bind('blur', function() { sc_terceros170521_loatiende_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros170521_loatiende_onfocus(this, iSeqRow) });
  $('#id_sc_field_efec_retencion' + iSeqRow).bind('blur', function() { sc_terceros170521_efec_retencion_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_terceros170521_efec_retencion_onfocus(this, iSeqRow) });
  $('#id_sc_field_regimen' + iSeqRow).bind('blur', function() { sc_terceros170521_regimen_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros170521_regimen_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros170521_regimen_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo' + iSeqRow).bind('blur', function() { sc_terceros170521_tipo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_terceros170521_tipo_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_terceros170521_tipo_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliente' + iSeqRow).bind('blur', function() { sc_terceros170521_cliente_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros170521_cliente_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros170521_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_empleado' + iSeqRow).bind('blur', function() { sc_terceros170521_empleado_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros170521_empleado_onfocus(this, iSeqRow) });
  $('#id_sc_field_proveedor' + iSeqRow).bind('blur', function() { sc_terceros170521_proveedor_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros170521_proveedor_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros170521_proveedor_onfocus(this, iSeqRow) });
  $('#id_sc_field_contacto' + iSeqRow).bind('blur', function() { sc_terceros170521_contacto_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros170521_contacto_onfocus(this, iSeqRow) });
  $('#id_sc_field_telefonos_prov' + iSeqRow).bind('blur', function() { sc_terceros170521_telefonos_prov_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_terceros170521_telefonos_prov_onfocus(this, iSeqRow) });
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_terceros170521_email_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_terceros170521_email_onfocus(this, iSeqRow) });
  $('#id_sc_field_url' + iSeqRow).bind('blur', function() { sc_terceros170521_url_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_terceros170521_url_onfocus(this, iSeqRow) });
  $('#id_sc_field_creditoprov' + iSeqRow).bind('blur', function() { sc_terceros170521_creditoprov_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_terceros170521_creditoprov_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_terceros170521_creditoprov_onfocus(this, iSeqRow) });
  $('#id_sc_field_dias' + iSeqRow).bind('blur', function() { sc_terceros170521_dias_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_terceros170521_dias_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechultcomp' + iSeqRow).bind('blur', function() { sc_terceros170521_fechultcomp_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_terceros170521_fechultcomp_onfocus(this, iSeqRow) });
  $('#id_sc_field_saldoapagar' + iSeqRow).bind('blur', function() { sc_terceros170521_saldoapagar_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_terceros170521_saldoapagar_onfocus(this, iSeqRow) });
  $('#id_sc_field_autoretenedor' + iSeqRow).bind('blur', function() { sc_terceros170521_autoretenedor_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros170521_autoretenedor_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_documento' + iSeqRow).bind('blur', function() { sc_terceros170521_tipo_documento_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_terceros170521_tipo_documento_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_terceros170521_tipo_documento_onfocus(this, iSeqRow) });
  $('#id_sc_field_dv' + iSeqRow).bind('blur', function() { sc_terceros170521_dv_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_terceros170521_dv_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre1' + iSeqRow).bind('blur', function() { sc_terceros170521_nombre1_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros170521_nombre1_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros170521_nombre1_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre2' + iSeqRow).bind('blur', function() { sc_terceros170521_nombre2_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros170521_nombre2_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros170521_nombre2_onfocus(this, iSeqRow) });
  $('#id_sc_field_apellido1' + iSeqRow).bind('blur', function() { sc_terceros170521_apellido1_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros170521_apellido1_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros170521_apellido1_onfocus(this, iSeqRow) });
  $('#id_sc_field_apellido2' + iSeqRow).bind('blur', function() { sc_terceros170521_apellido2_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros170521_apellido2_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros170521_apellido2_onfocus(this, iSeqRow) });
  $('#id_sc_field_sucur_cliente' + iSeqRow).bind('blur', function() { sc_terceros170521_sucur_cliente_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_terceros170521_sucur_cliente_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros170521_sucur_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_representante' + iSeqRow).bind('blur', function() { sc_terceros170521_representante_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros170521_representante_onfocus(this, iSeqRow) });
  $('#id_sc_field_imagenter' + iSeqRow).bind('blur', function() { sc_terceros170521_imagenter_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros170521_imagenter_onfocus(this, iSeqRow) });
  $('#id_sc_field_es_restaurante' + iSeqRow).bind('blur', function() { sc_terceros170521_es_restaurante_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_terceros170521_es_restaurante_onfocus(this, iSeqRow) });
  $('#id_sc_field_dias_credito' + iSeqRow).bind('blur', function() { sc_terceros170521_dias_credito_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_terceros170521_dias_credito_onfocus(this, iSeqRow) });
  $('#id_sc_field_dias_mora' + iSeqRow).bind('blur', function() { sc_terceros170521_dias_mora_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros170521_dias_mora_onfocus(this, iSeqRow) });
  $('#id_sc_field_cupo_vendedor' + iSeqRow).bind('blur', function() { sc_terceros170521_cupo_vendedor_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros170521_cupo_vendedor_onfocus(this, iSeqRow) });
  $('#id_sc_field_codigo_ter' + iSeqRow).bind('blur', function() { sc_terceros170521_codigo_ter_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_terceros170521_codigo_ter_onfocus(this, iSeqRow) });
  $('#id_sc_field_es_cajero' + iSeqRow).bind('blur', function() { sc_terceros170521_es_cajero_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros170521_es_cajero_onfocus(this, iSeqRow) });
  $('#id_sc_field_autorizado' + iSeqRow).bind('blur', function() { sc_terceros170521_autorizado_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_terceros170521_autorizado_onfocus(this, iSeqRow) });
  $('#id_sc_field_zona_clientes' + iSeqRow).bind('blur', function() { sc_terceros170521_zona_clientes_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros170521_zona_clientes_onfocus(this, iSeqRow) });
  $('#id_sc_field_clasificacion_clientes' + iSeqRow).bind('blur', function() { sc_terceros170521_clasificacion_clientes_onblur(this, iSeqRow) })
                                                    .bind('focus', function() { sc_terceros170521_clasificacion_clientes_onfocus(this, iSeqRow) });
  $('#id_sc_field_ciudad' + iSeqRow).bind('blur', function() { sc_terceros170521_ciudad_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_terceros170521_ciudad_onfocus(this, iSeqRow) });
  $('#id_sc_field_codigo_postal' + iSeqRow).bind('blur', function() { sc_terceros170521_codigo_postal_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros170521_codigo_postal_onfocus(this, iSeqRow) });
  $('#id_sc_field_lenguaje' + iSeqRow).bind('blur', function() { sc_terceros170521_lenguaje_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros170521_lenguaje_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_comercil' + iSeqRow).bind('blur', function() { sc_terceros170521_nombre_comercil_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_terceros170521_nombre_comercil_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_terceros170521_nombre_comercil_onfocus(this, iSeqRow) });
  $('#id_sc_field_notificar' + iSeqRow).bind('blur', function() { sc_terceros170521_notificar_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros170521_notificar_onfocus(this, iSeqRow) });
  $('#id_sc_field_puc_auxiliar_deudores' + iSeqRow).bind('blur', function() { sc_terceros170521_puc_auxiliar_deudores_onblur(this, iSeqRow) })
                                                   .bind('focus', function() { sc_terceros170521_puc_auxiliar_deudores_onfocus(this, iSeqRow) });
  $('#id_sc_field_puc_retefuente_ventas' + iSeqRow).bind('blur', function() { sc_terceros170521_puc_retefuente_ventas_onblur(this, iSeqRow) })
                                                   .bind('focus', function() { sc_terceros170521_puc_retefuente_ventas_onfocus(this, iSeqRow) });
  $('#id_sc_field_puc_retefuente_servicios_clie' + iSeqRow).bind('blur', function() { sc_terceros170521_puc_retefuente_servicios_clie_onblur(this, iSeqRow) })
                                                           .bind('focus', function() { sc_terceros170521_puc_retefuente_servicios_clie_onfocus(this, iSeqRow) });
  $('#id_sc_field_puc_auxiliar_proveedores' + iSeqRow).bind('blur', function() { sc_terceros170521_puc_auxiliar_proveedores_onblur(this, iSeqRow) })
                                                      .bind('focus', function() { sc_terceros170521_puc_auxiliar_proveedores_onfocus(this, iSeqRow) });
  $('#id_sc_field_puc_retefuente_compras' + iSeqRow).bind('blur', function() { sc_terceros170521_puc_retefuente_compras_onblur(this, iSeqRow) })
                                                    .bind('focus', function() { sc_terceros170521_puc_retefuente_compras_onfocus(this, iSeqRow) });
  $('#id_sc_field_puc_retefuente_servicios_prov' + iSeqRow).bind('blur', function() { sc_terceros170521_puc_retefuente_servicios_prov_onblur(this, iSeqRow) })
                                                           .bind('focus', function() { sc_terceros170521_puc_retefuente_servicios_prov_onfocus(this, iSeqRow) });
  $('#id_sc_field_activo' + iSeqRow).bind('blur', function() { sc_terceros170521_activo_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_terceros170521_activo_onfocus(this, iSeqRow) });
  $('#id_sc_field_es_tecnico' + iSeqRow).bind('blur', function() { sc_terceros170521_es_tecnico_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_terceros170521_es_tecnico_onfocus(this, iSeqRow) });
  $('#id_sc_field_codigo_tercero' + iSeqRow).bind('blur', function() { sc_terceros170521_codigo_tercero_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_terceros170521_codigo_tercero_onfocus(this, iSeqRow) });
  $('#id_sc_field_porcentaje_propina_sugerida' + iSeqRow).bind('blur', function() { sc_terceros170521_porcentaje_propina_sugerida_onblur(this, iSeqRow) })
                                                         .bind('focus', function() { sc_terceros170521_porcentaje_propina_sugerida_onfocus(this, iSeqRow) });
  $('#id_sc_field_archivos' + iSeqRow).bind('blur', function() { sc_terceros170521_archivos_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros170521_archivos_onfocus(this, iSeqRow) });
  $('#id_sc_field_c_postal' + iSeqRow).bind('blur', function() { sc_terceros170521_c_postal_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros170521_c_postal_onfocus(this, iSeqRow) });
  $('#id_sc_field_ciiu' + iSeqRow).bind('blur', function() { sc_terceros170521_ciiu_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_terceros170521_ciiu_onfocus(this, iSeqRow) });
  $('#id_sc_field_cupodis' + iSeqRow).bind('blur', function() { sc_terceros170521_cupodis_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros170521_cupodis_onfocus(this, iSeqRow) });
  $('#id_sc_field_departamento' + iSeqRow).bind('blur', function() { sc_terceros170521_departamento_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_terceros170521_departamento_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_terceros170521_departamento_onfocus(this, iSeqRow) });
  $('#id_sc_field_detalle_tributario' + iSeqRow).bind('blur', function() { sc_terceros170521_detalle_tributario_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_terceros170521_detalle_tributario_onfocus(this, iSeqRow) });
  $('#id_sc_field_r_social' + iSeqRow).bind('blur', function() { sc_terceros170521_r_social_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_terceros170521_r_social_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros170521_r_social_onfocus(this, iSeqRow) });
  $('#id_sc_field_relleno2' + iSeqRow).bind('blur', function() { sc_terceros170521_relleno2_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros170521_relleno2_onfocus(this, iSeqRow) });
  $('#id_sc_field_responsabilidad_fiscal' + iSeqRow).bind('blur', function() { sc_terceros170521_responsabilidad_fiscal_onblur(this, iSeqRow) })
                                                    .bind('focus', function() { sc_terceros170521_responsabilidad_fiscal_onfocus(this, iSeqRow) });
  $('#id_sc_field_sucursales' + iSeqRow).bind('blur', function() { sc_terceros170521_sucursales_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_terceros170521_sucursales_onfocus(this, iSeqRow) });
...
function sc_terceros170521_idtercero_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_idtercero();
  scCssBlur(oThis);
}

function sc_terceros170521_idtercero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_documento_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_documento();
  scCssBlur(oThis);
}

function sc_terceros170521_documento_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_documento_onchange();
}

function sc_terceros170521_documento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_nombres_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_nombres();
  scCssBlur(oThis);
  do_ajax_terceros170521_mob_event_nombres_onblur();
}

function sc_terceros170521_nombres_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
  do_ajax_terceros170521_mob_event_nombres_onfocus();
}

function sc_terceros170521_direccion_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_direccion();
  scCssBlur(oThis);
}

function sc_terceros170521_direccion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_tel_cel_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_tel_cel();
  scCssBlur(oThis);
}

function sc_terceros170521_tel_cel_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_nacimiento_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_nacimiento();
  scCssBlur(oThis);
}

function sc_terceros170521_nacimiento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_sexo_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_sexo();
  scCssBlur(oThis);
}

function sc_terceros170521_sexo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_urlmail_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_urlmail();
  scCssBlur(oThis);
}

function sc_terceros170521_urlmail_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_fechault_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_fechault();
  scCssBlur(oThis);
}

function sc_terceros170521_fechault_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_saldo_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_saldo();
  scCssBlur(oThis);
}

function sc_terceros170521_saldo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_afiliacion_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_afiliacion();
  scCssBlur(oThis);
}

function sc_terceros170521_afiliacion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_idmuni_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_idmuni();
  scCssBlur(oThis);
}

function sc_terceros170521_idmuni_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_refresh_idmuni();
}

function sc_terceros170521_idmuni_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_observaciones();
  scCssBlur(oThis);
}

function sc_terceros170521_observaciones_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_credito_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_credito();
  scCssBlur(oThis);
}

function sc_terceros170521_credito_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_credito_onchange();
}

function sc_terceros170521_credito_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_cupo_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_cupo();
  scCssBlur(oThis);
}

function sc_terceros170521_cupo_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_cupo_onchange();
}

function sc_terceros170521_cupo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_listaprecios_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_listaprecios();
  scCssBlur(oThis);
}

function sc_terceros170521_listaprecios_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_loatiende_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_loatiende();
  scCssBlur(oThis);
}

function sc_terceros170521_loatiende_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_efec_retencion_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_efec_retencion();
  scCssBlur(oThis);
}

function sc_terceros170521_efec_retencion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_regimen_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_regimen();
  scCssBlur(oThis);
}

function sc_terceros170521_regimen_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_regimen_onchange();
}

function sc_terceros170521_regimen_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_tipo_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_tipo();
  scCssBlur(oThis);
}

function sc_terceros170521_tipo_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_tipo_onchange();
}

function sc_terceros170521_tipo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_cliente_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_cliente();
  scCssBlur(oThis);
}

function sc_terceros170521_cliente_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_cliente_onchange();
}

function sc_terceros170521_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_empleado_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_empleado();
  scCssBlur(oThis);
}

function sc_terceros170521_empleado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_proveedor_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_proveedor();
  scCssBlur(oThis);
}

function sc_terceros170521_proveedor_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_proveedor_onchange();
}

function sc_terceros170521_proveedor_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_contacto_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_contacto();
  scCssBlur(oThis);
}

function sc_terceros170521_contacto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_telefonos_prov_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_telefonos_prov();
  scCssBlur(oThis);
}

function sc_terceros170521_telefonos_prov_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_email_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_email();
  scCssBlur(oThis);
}

function sc_terceros170521_email_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_url_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_url();
  scCssBlur(oThis);
}

function sc_terceros170521_url_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_creditoprov_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_creditoprov();
  scCssBlur(oThis);
}

function sc_terceros170521_creditoprov_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_creditoprov_onchange();
}

function sc_terceros170521_creditoprov_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_dias_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_dias();
  scCssBlur(oThis);
}

function sc_terceros170521_dias_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_fechultcomp_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_fechultcomp();
  scCssBlur(oThis);
}

function sc_terceros170521_fechultcomp_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_saldoapagar_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_saldoapagar();
  scCssBlur(oThis);
}

function sc_terceros170521_saldoapagar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_autoretenedor_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_autoretenedor();
  scCssBlur(oThis);
}

function sc_terceros170521_autoretenedor_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_tipo_documento_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_tipo_documento();
  scCssBlur(oThis);
}

function sc_terceros170521_tipo_documento_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_tipo_documento_onchange();
}

function sc_terceros170521_tipo_documento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_dv_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_dv();
  scCssBlur(oThis);
}

function sc_terceros170521_dv_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_nombre1_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_nombre1();
  scCssBlur(oThis);
}

function sc_terceros170521_nombre1_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_nombre1_onchange();
}

function sc_terceros170521_nombre1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_nombre2_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_nombre2();
  scCssBlur(oThis);
}

function sc_terceros170521_nombre2_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_nombre2_onchange();
}

function sc_terceros170521_nombre2_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_apellido1_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_apellido1();
  scCssBlur(oThis);
}

function sc_terceros170521_apellido1_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_apellido1_onchange();
}

function sc_terceros170521_apellido1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_apellido2_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_apellido2();
  scCssBlur(oThis);
}

function sc_terceros170521_apellido2_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_apellido2_onchange();
}

function sc_terceros170521_apellido2_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_sucur_cliente_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_sucur_cliente();
  scCssBlur(oThis);
}

function sc_terceros170521_sucur_cliente_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_sucur_cliente_onchange();
}

function sc_terceros170521_sucur_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_representante_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_representante();
  scCssBlur(oThis);
}

function sc_terceros170521_representante_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_imagenter_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_terceros170521_imagenter_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros170521_es_restaurante_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_es_restaurante();
  scCssBlur(oThis);
}

function sc_terceros170521_es_restaurante_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_dias_credito_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_dias_credito();
  scCssBlur(oThis);
}

function sc_terceros170521_dias_credito_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_dias_mora_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_dias_mora();
  scCssBlur(oThis);
}

function sc_terceros170521_dias_mora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_cupo_vendedor_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_cupo_vendedor();
  scCssBlur(oThis);
}

function sc_terceros170521_cupo_vendedor_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_codigo_ter_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_codigo_ter();
  scCssBlur(oThis);
}

function sc_terceros170521_codigo_ter_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_es_cajero_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_es_cajero();
  scCssBlur(oThis);
}

function sc_terceros170521_es_cajero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_autorizado_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_autorizado();
  scCssBlur(oThis);
}

function sc_terceros170521_autorizado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_zona_clientes_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_zona_clientes();
  scCssBlur(oThis);
}

function sc_terceros170521_zona_clientes_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_clasificacion_clientes_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_clasificacion_clientes();
  scCssBlur(oThis);
}

function sc_terceros170521_clasificacion_clientes_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_ciudad_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_ciudad();
  scCssBlur(oThis);
}

function sc_terceros170521_ciudad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_codigo_postal_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_codigo_postal();
  scCssBlur(oThis);
}

function sc_terceros170521_codigo_postal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_lenguaje_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_lenguaje();
  scCssBlur(oThis);
}

function sc_terceros170521_lenguaje_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_nombre_comercil_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_nombre_comercil();
  scCssBlur(oThis);
}

function sc_terceros170521_nombre_comercil_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_nombre_comercil_onchange();
}

function sc_terceros170521_nombre_comercil_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_notificar_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_notificar();
  scCssBlur(oThis);
}

function sc_terceros170521_notificar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_puc_auxiliar_deudores_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_puc_auxiliar_deudores();
  scCssBlur(oThis);
}

function sc_terceros170521_puc_auxiliar_deudores_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros170521_puc_retefuente_ventas_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_puc_retefuente_ventas();
  scCssBlur(oThis);
}

function sc_terceros170521_puc_retefuente_ventas_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros170521_puc_retefuente_servicios_clie_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_puc_retefuente_servicios_clie();
  scCssBlur(oThis);
}

function sc_terceros170521_puc_retefuente_servicios_clie_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros170521_puc_auxiliar_proveedores_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_puc_auxiliar_proveedores();
  scCssBlur(oThis);
}

function sc_terceros170521_puc_auxiliar_proveedores_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros170521_puc_retefuente_compras_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_puc_retefuente_compras();
  scCssBlur(oThis);
}

function sc_terceros170521_puc_retefuente_compras_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros170521_puc_retefuente_servicios_prov_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_puc_retefuente_servicios_prov();
  scCssBlur(oThis);
}

function sc_terceros170521_puc_retefuente_servicios_prov_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros170521_activo_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_activo();
  scCssBlur(oThis);
}

function sc_terceros170521_activo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_es_tecnico_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_es_tecnico();
  scCssBlur(oThis);
}

function sc_terceros170521_es_tecnico_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_codigo_tercero_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_codigo_tercero();
  scCssBlur(oThis);
}

function sc_terceros170521_codigo_tercero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_porcentaje_propina_sugerida_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_porcentaje_propina_sugerida();
  scCssBlur(oThis);
}

function sc_terceros170521_porcentaje_propina_sugerida_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_archivos_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_archivos();
  scCssBlur(oThis);
}

function sc_terceros170521_archivos_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_c_postal_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_c_postal();
  scCssBlur(oThis);
}

function sc_terceros170521_c_postal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_ciiu_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_ciiu();
  scCssBlur(oThis);
}

function sc_terceros170521_ciiu_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_cupodis_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_cupodis();
  scCssBlur(oThis);
}

function sc_terceros170521_cupodis_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_departamento_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_departamento();
  scCssBlur(oThis);
}

function sc_terceros170521_departamento_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_refresh_departamento();
}

function sc_terceros170521_departamento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_detalle_tributario_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_detalle_tributario();
  scCssBlur(oThis);
}

function sc_terceros170521_detalle_tributario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_r_social_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_r_social();
  scCssBlur(oThis);
}

function sc_terceros170521_r_social_onchange(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_event_r_social_onchange();
}

function sc_terceros170521_r_social_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_relleno2_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_relleno2();
  scCssBlur(oThis);
}

function sc_terceros170521_relleno2_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_responsabilidad_fiscal_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_responsabilidad_fiscal();
  scCssBlur(oThis);
}

function sc_terceros170521_responsabilidad_fiscal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros170521_sucursales_onblur(oThis, iSeqRow) {
  do_ajax_terceros170521_mob_validate_sucursales();
  scCssBlur(oThis);
}

function sc_terceros170521_sucursales_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_field_notificar(row, status) {
	if ("on" == status) {
		if ("all" == row) {
			var fieldList = $(".css_notificar__obj");
			for (var i = 0; i < fieldList.length; i++) {
				$($(fieldList[i]).attr("id")).select2("destroy");
			}
		}
		else {
			$("#id_sc_field_notificar" + row).select2("destroy");
		}
		scJQSelect2Add(row, "notificar");
	}
}
...
function displayChange_field_empleado(row, status) {
	if ("on" == status) {
		if ("all" == row) {
			var fieldList = $(".css_empleado__obj");
			for (var i = 0; i < fieldList.length; i++) {
				$($(fieldList[i]).attr("id")).select2("destroy");
			}
		}
		else {
			$("#id_sc_field_empleado" + row).select2("destroy");
		}
		scJQSelect2Add(row, "empleado");
	}
}
...
function displayChange_field_es_tecnico(row, status) {
	if ("on" == status) {
		if ("all" == row) {
			var fieldList = $(".css_es_tecnico__obj");
			for (var i = 0; i < fieldList.length; i++) {
				$($(fieldList[i]).attr("id")).select2("destroy");
			}
		}
		else {
			$("#id_sc_field_es_tecnico" + row).select2("destroy");
		}
		scJQSelect2Add(row, "es_tecnico");
	}
}
...
function displayChange_field_sucur_cliente(row, status) {
	if ("on" == status) {
		if ("all" == row) {
			var fieldList = $(".css_sucur_cliente__obj");
			for (var i = 0; i < fieldList.length; i++) {
				$($(fieldList[i]).attr("id")).select2("destroy");
			}
		}
		else {
			$("#id_sc_field_sucur_cliente" + row).select2("destroy");
		}
		scJQSelect2Add(row, "sucur_cliente");
	}
}
...
function scRecreateSelect2() {
	...
	displayChange_field_notificar("all", "on");
	...
	displayChange_field_empleado("all", "on");
	displayChange_field_es_tecnico("all", "on");
	...
	displayChange_field_sucur_cliente("all", "on");
...
function scHidePage(pageNo) {
	$("#id_terceros170521_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_nacimiento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros170521_mob_validate_nacimiento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechault" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros170521_mob_validate_fechault(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_afiliacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros170521_mob_validate_afiliacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_con_actual" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_terceros170521_mob_validate_con_actual(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_terceros170521_mob_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_imagenter" + iSeqRow).fileupload({
    datatype: "json",
    url: "terceros170521_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'terceros170521_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
...
function scJQSelect2Add(seqRow, specificField) {
  ...
  if (null == specificField || "notificar" == specificField) {
    scJQSelect2Add_notificar(seqRow);
  }
  ...
  if (null == specificField || "es_tecnico" == specificField) {
    scJQSelect2Add_es_tecnico(seqRow);
  }
...
function scJQSelect2Add_notificar(seqRow) {
  var elemSelector = "all" == seqRow ? ".css_notificar_obj" : "#id_sc_field_notificar" + seqRow;
  $(elemSelector).select2(
    {
      containerCssClass: 'css_notificar_obj',
      dropdownCssClass: 'css_notificar_obj',
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
        },
...
function scJQSelect2Add_es_tecnico(seqRow) {
  var elemSelector = "all" == seqRow ? ".css_es_tecnico_obj" : "#id_sc_field_es_tecnico" + seqRow;
  $(elemSelector).select2(
    {
      containerCssClass: 'css_es_tecnico_obj',
      dropdownCssClass: 'css_es_tecnico_obj',
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
        },
...
function scJQElementsAdd(iLine) {
  ...
  setTimeout(function () { if ('function' == typeof displayChange_field_notificar) { displayChange_field_notificar(iLine, "on"); } }, 150);
  ...
  setTimeout(function () { if ('function' == typeof displayChange_field_es_tecnico) { displayChange_field_es_tecnico(iLine, "on"); } }, 150);
