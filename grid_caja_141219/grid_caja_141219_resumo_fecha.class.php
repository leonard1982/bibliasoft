...
class grid_caja_141219_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['arr_total']['fecha'];
      }
      else
      {
          $this->array_total_fecha = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['summarizing_fields_order']['fecha']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['summarizing_fields_order']['fecha'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['summarizing_fields_order']['fecha'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['summarizing_fields_display']['fecha'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['summarizing_fields_display']['fecha'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['summarizing_fields_display']['fecha'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['summarizing_fields_display']['fecha'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['summarizing_fields_display']['fecha'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['summarizing_fields_display']['fecha'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['summarizing_fields_display']['fecha'] as $i_sum => $d_sum)
           {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['pivot_order_level'] = -1;
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $quebra_fecha, $quebra_fecha_orig)
   {
      ...
      if (!isset($this->array_total_fecha[$quebra_fecha_orig]))
      {
         ...
         $this->array_total_fecha[$quebra_fecha_orig][1] = $sum_cantidad;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = $this->Ini->Get_date_order_groupby("fecha", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->cliente = $this->look_cliente ;
            $this->banco = $this->look_banco ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->fecha, $this->fecha_orig);
            }
   }
//
