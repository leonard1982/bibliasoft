...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['contr_label_graf']['resolucion']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['contr_label_graf']['resolucion']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['contr_label_graf']['resolucion'];
      }
   }
