...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['contr_label_graf']['documento']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['contr_label_graf']['documento']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_141219']['contr_label_graf']['documento'];
      }
   }
