...
$old_error_handler = set_error_handler("form_detalle_notasDC_270521_scriptcase_error_handler");

function form_detalle_notasDC_270521_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_detalle_notasDC_270521']['contr_erro']) && $_SESSION['scriptcase']['form_detalle_notasDC_270521']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_detalle_notasDC_270521->contr_form_detalle_notasDC_270521->Apl_com_erro = true;
            if ($inicial_form_detalle_notasDC_270521->contr_form_detalle_notasDC_270521->NM_ajax_flag)
            {
                $inicial_form_detalle_notasDC_270521->contr_form_detalle_notasDC_270521->NM_ajax_info['errList']['geral_form_detalle_notasDC_270521'][] = $msg;
                return;
            }
            form_detalle_notasDC_270521_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_detalle_notasDC_270521_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_detalle_notasDC_270521'])  && '' != $_SESSION['scriptcase']['error_icon']['form_detalle_notasDC_270521'])  ? $_SESSION['scriptcase']['error_icon']['form_detalle_notasDC_270521']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_detalle_notasDC_270521']) && '' != $_SESSION['scriptcase']['error_span_title']['form_detalle_notasDC_270521']) ? $_SESSION['scriptcase']['error_span_title']['form_detalle_notasDC_270521'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_detalle_notasDC_270521']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_detalle_notasDC_270521']) ? $_SESSION['scriptcase']['error_icon_title']['form_detalle_notasDC_270521'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_detalle_notasDC_270521']['error_buffer'] .= ob_get_flush();
}
