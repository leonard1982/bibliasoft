  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_iva_270422" == sTestField)
        {
...
?>
  ...
  // ---------- Validate trifa
  function do_ajax_form_iva_270422_validate_trifa()
  {
    var nomeCampo_trifa = "trifa";
    var var_trifa = scAjaxGetFieldText(nomeCampo_trifa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_270422_validate_trifa(var_trifa, var_script_case_init, do_ajax_form_iva_270422_validate_trifa_cb);
  } // do_ajax_form_iva_270422_validate_trifa

  function do_ajax_form_iva_270422_validate_trifa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_validate_trifa_cb

  // ---------- Validate tipo_impuesto
  function do_ajax_form_iva_270422_validate_tipo_impuesto()
  {
    var nomeCampo_tipo_impuesto = "tipo_impuesto";
    var var_tipo_impuesto = scAjaxGetFieldText(nomeCampo_tipo_impuesto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_270422_validate_tipo_impuesto(var_tipo_impuesto, var_script_case_init, do_ajax_form_iva_270422_validate_tipo_impuesto_cb);
  } // do_ajax_form_iva_270422_validate_tipo_impuesto

  function do_ajax_form_iva_270422_validate_tipo_impuesto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_validate_tipo_impuesto_cb

  // ---------- Validate codigo
  function do_ajax_form_iva_270422_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_270422_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_iva_270422_validate_codigo_cb);
  } // do_ajax_form_iva_270422_validate_codigo

  function do_ajax_form_iva_270422_validate_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_validate_codigo_cb

  // ---------- Validate puc
  function do_ajax_form_iva_270422_validate_puc()
  {
  } // do_ajax_form_iva_270422_validate_puc

  function do_ajax_form_iva_270422_validate_puc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_validate_puc_cb

  // ---------- Validate puc_dv_ventas
  function do_ajax_form_iva_270422_validate_puc_dv_ventas()
  {
  } // do_ajax_form_iva_270422_validate_puc_dv_ventas

  function do_ajax_form_iva_270422_validate_puc_dv_ventas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_validate_puc_dv_ventas_cb

  // ---------- Validate puc_compras
  function do_ajax_form_iva_270422_validate_puc_compras()
  {
  } // do_ajax_form_iva_270422_validate_puc_compras

  function do_ajax_form_iva_270422_validate_puc_compras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_validate_puc_compras_cb

  // ---------- Validate puc_dv_compras
  function do_ajax_form_iva_270422_validate_puc_dv_compras()
  {
  } // do_ajax_form_iva_270422_validate_puc_dv_compras

  function do_ajax_form_iva_270422_validate_puc_dv_compras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_validate_puc_dv_compras_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_iva_270422_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_iva_270422_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_iva_270422_submit_form(var_trifa, var_tipo_impuesto, var_codigo, var_puc, var_puc_dv_ventas, var_puc_compras, var_puc_dv_compras, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_iva_270422_submit_form_cb);
  } // do_ajax_form_iva_270422_submit_form

  function do_ajax_form_iva_270422_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iva_270422']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iva_270422']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_iva_270422']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_iva_270422_submit_form_cb_after_alert);
  } // do_ajax_form_iva_270422_submit_form_cb
  function do_ajax_form_iva_270422_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_iva_270422_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_iva_270422_navigate_form()
  {
    perform_ajax_form_iva_270422_navigate_form();
  }

  function perform_ajax_form_iva_270422_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_iva_270422_navigate_form(var_idiva, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_iva_270422_navigate_form_cb);
  } // do_ajax_form_iva_270422_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_iva_270422']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_iva_270422_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_iva_270422_navigate_form_cb_after_alert);
  } // do_ajax_form_iva_270422_navigate_form_cb
  function do_ajax_form_iva_270422_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('trifa');
...
{
?>
    do_ajax_form_iva_270422_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_iva_270422_navigate_form_cb_after_alert
  function sc_hide_form_iva_270422_form()
  {
