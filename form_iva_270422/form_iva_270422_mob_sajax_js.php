  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_iva_270422_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_iva_270422_mob_form();
	}
...
?>
  ...
  // ---------- Validate trifa
  function do_ajax_form_iva_270422_mob_validate_trifa()
  {
    var nomeCampo_trifa = "trifa";
    var var_trifa = scAjaxGetFieldText(nomeCampo_trifa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_270422_mob_validate_trifa(var_trifa, var_script_case_init, do_ajax_form_iva_270422_mob_validate_trifa_cb);
  } // do_ajax_form_iva_270422_mob_validate_trifa

  function do_ajax_form_iva_270422_mob_validate_trifa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_mob_validate_trifa_cb

  // ---------- Validate tipo_impuesto
  function do_ajax_form_iva_270422_mob_validate_tipo_impuesto()
  {
    var nomeCampo_tipo_impuesto = "tipo_impuesto";
    var var_tipo_impuesto = scAjaxGetFieldText(nomeCampo_tipo_impuesto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_270422_mob_validate_tipo_impuesto(var_tipo_impuesto, var_script_case_init, do_ajax_form_iva_270422_mob_validate_tipo_impuesto_cb);
  } // do_ajax_form_iva_270422_mob_validate_tipo_impuesto

  function do_ajax_form_iva_270422_mob_validate_tipo_impuesto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_impuesto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_mob_validate_tipo_impuesto_cb

  // ---------- Validate codigo
  function do_ajax_form_iva_270422_mob_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_270422_mob_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_iva_270422_mob_validate_codigo_cb);
  } // do_ajax_form_iva_270422_mob_validate_codigo

  function do_ajax_form_iva_270422_mob_validate_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_mob_validate_codigo_cb

  // ---------- Validate puc
  function do_ajax_form_iva_270422_mob_validate_puc()
  {
  } // do_ajax_form_iva_270422_mob_validate_puc

  function do_ajax_form_iva_270422_mob_validate_puc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_mob_validate_puc_cb

  // ---------- Validate puc_dv_ventas
  function do_ajax_form_iva_270422_mob_validate_puc_dv_ventas()
  {
  } // do_ajax_form_iva_270422_mob_validate_puc_dv_ventas

  function do_ajax_form_iva_270422_mob_validate_puc_dv_ventas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puc_dv_ventas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_mob_validate_puc_dv_ventas_cb

  // ---------- Validate puc_compras
  function do_ajax_form_iva_270422_mob_validate_puc_compras()
  {
  } // do_ajax_form_iva_270422_mob_validate_puc_compras

  function do_ajax_form_iva_270422_mob_validate_puc_compras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puc_compras";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_mob_validate_puc_compras_cb

  // ---------- Validate puc_dv_compras
  function do_ajax_form_iva_270422_mob_validate_puc_dv_compras()
  {
  } // do_ajax_form_iva_270422_mob_validate_puc_dv_compras

  function do_ajax_form_iva_270422_mob_validate_puc_dv_compras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puc_dv_compras";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_270422_mob_validate_puc_dv_compras_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_iva_270422_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_iva_270422_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_trifa = scAjaxGetFieldText("trifa");
    var var_tipo_impuesto = scAjaxGetFieldText("tipo_impuesto");
    var var_codigo = scAjaxGetFieldText("codigo");
    var var_puc = scAjaxGetFieldText("puc");
    var var_puc_dv_ventas = scAjaxGetFieldText("puc_dv_ventas");
    var var_puc_compras = scAjaxGetFieldText("puc_compras");
    var var_puc_dv_compras = scAjaxGetFieldText("puc_dv_compras");
    var var_idiva = scAjaxGetFieldText("idiva");
    ...
    scAjaxProcOn();
    x_ajax_form_iva_270422_mob_submit_form(var_trifa, var_tipo_impuesto, var_codigo, var_puc, var_puc_dv_ventas, var_puc_compras, var_puc_dv_compras, var_idiva, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_iva_270422_mob_submit_form_cb);
  } // do_ajax_form_iva_270422_mob_submit_form

  function do_ajax_form_iva_270422_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("trifa");
      scAjaxHideErrorDisplay("tipo_impuesto");
      scAjaxHideErrorDisplay("codigo");
      scAjaxHideErrorDisplay("puc");
      scAjaxHideErrorDisplay("puc_dv_ventas");
      scAjaxHideErrorDisplay("puc_compras");
      scAjaxHideErrorDisplay("puc_dv_compras");
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_iva_270422_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_iva_270422_mob']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_iva_270422_mob']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_iva_270422_mob_submit_form_cb_after_alert);
  } // do_ajax_form_iva_270422_mob_submit_form_cb
  function do_ajax_form_iva_270422_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_iva_270422_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_iva_270422_mob_navigate_form()
  {
    perform_ajax_form_iva_270422_mob_navigate_form();
  }

  function perform_ajax_form_iva_270422_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("puc_compras");
    scAjaxHideErrorDisplay("puc_dv_compras");
    var var_idiva = document.F2.idiva.value;
    ...
    scAjaxProcOn();
    x_ajax_form_iva_270422_mob_navigate_form(var_idiva, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_iva_270422_mob_navigate_form_cb);
  } // do_ajax_form_iva_270422_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_iva_270422_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_iva_270422_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idiva.value = scAjaxGetKeyValue("idiva");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_iva_270422_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_iva_270422_mob_navigate_form_cb
  function do_ajax_form_iva_270422_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('trifa');
...
{
?>
    do_ajax_form_iva_270422_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_iva_270422_mob_navigate_form_cb_after_alert
  function sc_hide_form_iva_270422_mob_form()
  {
  ...
  ajax_field_list[0] = "trifa";
  ajax_field_list[1] = "tipo_impuesto";
  ajax_field_list[2] = "codigo";
  ajax_field_list[3] = "puc";
  ajax_field_list[4] = "puc_dv_ventas";
  ajax_field_list[5] = "puc_compras";
  ajax_field_list[6] = "puc_dv_compras";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "trifa": {"label": "Tasa IVA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_impuesto": {"label": "Tipo de Impuesto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "codigo": {"label": "Codigo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "puc": {"label": "Cuenta Ventas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "puc_dv_ventas": {"label": "Cuenta Devolución Ventas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "puc_compras": {"label": "Cuenta Compras", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "puc_dv_compras": {"label": "Cuenta Devolución Compras", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "trifa": new Array(),
    "tipo_impuesto": new Array(),
    "codigo": new Array(),
    "puc": new Array(),
    "puc_dv_ventas": new Array(),
    "puc_compras": new Array(),
    "puc_dv_compras": new Array()
  };
  ajax_field_mult["trifa"][1] = "trifa";
  ajax_field_mult["tipo_impuesto"][1] = "tipo_impuesto";
  ajax_field_mult["codigo"][1] = "codigo";
  ajax_field_mult["puc"][1] = "puc";
  ajax_field_mult["puc_dv_ventas"][1] = "puc_dv_ventas";
  ajax_field_mult["puc_compras"][1] = "puc_compras";
  ajax_field_mult["puc_dv_compras"][1] = "puc_dv_compras";

  var ajax_field_id = {
    "trifa": new Array("hidden_field_label_trifa", "hidden_field_data_trifa"),
    "tipo_impuesto": new Array("hidden_field_label_tipo_impuesto", "hidden_field_data_tipo_impuesto"),
    "puc": new Array("hidden_field_label_puc", "hidden_field_data_puc"),
    "puc_dv_ventas": new Array("hidden_field_label_puc_dv_ventas", "hidden_field_data_puc_dv_ventas"),
    "puc_compras": new Array("hidden_field_label_puc_compras", "hidden_field_data_puc_compras"),
    "puc_dv_compras": new Array("hidden_field_label_puc_dv_compras", "hidden_field_data_puc_dv_compras")
  };
