...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['contr_label_graf']['fechacom']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['contr_label_graf']['fechacom']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['contr_label_graf']['fechacom'];
      }
   }
