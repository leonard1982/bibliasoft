...
class grid_compras_new_resumo
{
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_tipo_com = array();
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_tipo_com = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['tipo_com'];
      }
      else
      {
          $this->array_total_tipo_com = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['tipo_com'] = $this->array_total_tipo_com;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_order']['tipo_com']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_order']['tipo_com'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_order']['tipo_com'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['tipo_com'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['tipo_com'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['tipo_com'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['tipo_com'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['tipo_com'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['tipo_com'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['tipo_com'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_tipo_com as $i_tipo_com => $d_tipo_com) {
           if (!in_array($i_tipo_com, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tipo_com[2] ] = $d_tipo_com[1];
               $this->comp_label[0][ $d_tipo_com[2] ] = $d_tipo_com[1];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'tipo_com', 'prot' => '@aspass@'),
       );
       ...
       //-----
       foreach ($this->comp_label[0] as $i_tipo_com => $l_tipo_com) {
           if (isset($this->array_total_tipo_com[$i_tipo_com])) {
               $this->comp_group[$i_tipo_com] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_tipo_com;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_tipo_com("res");
      ...
      ksort($this->array_total_tipo_com);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_tipo_com, $quebra_tipo_com_orig)
   {
      //----- Tipo
      if (!isset($this->array_total_tipo_com[$quebra_tipo_com_orig]))
      {
         $this->array_total_tipo_com[$quebra_tipo_com_orig][0] = 1;
         $this->array_total_tipo_com[$quebra_tipo_com_orig][1] = $quebra_tipo_com;
         $this->array_total_tipo_com[$quebra_tipo_com_orig][2] = $quebra_tipo_com_orig;
      }
      else
      {
         $this->array_total_tipo_com[$quebra_tipo_com_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'tipo_com');
     $campos_order = $this->Ini->Get_date_order_groupby("tipo_com", 'asc', $format, $campos_order);
...
$_SESSION['scriptcase']['grid_compras_new']['contr_erro'] = 'off'; 
            $this->tipo_com_orig = $this->tipo_com;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tipo_com, $this->tipo_com_orig);
            }
   }
//
