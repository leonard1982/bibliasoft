...
class grid_compras_new_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['asentada'];
      }
      else
      {
          $this->array_total_asentada = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_order']['asentada']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_order']['asentada'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_order']['asentada'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['asentada'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['asentada'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['asentada'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['asentada'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['asentada'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['asentada'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['asentada'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_asentada as $i_asentada => $d_asentada) {
           if (!in_array($i_asentada, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_asentada[10] ] = $d_asentada[9];
               $this->comp_label[0][ $d_asentada[10] ] = $d_asentada[9];
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $sum_subtotal, $sum_valoriva, $sum_a_pagar, $sum_val_ica, $sum_val_ret, $sum_val_retiva, $quebra_asentada, $quebra_asentada_orig)
   {
      //----- Asentada
      if (!isset($this->array_total_asentada[$quebra_asentada_orig]))
      {
         ...
         $this->array_total_asentada[$quebra_asentada_orig][4] = $sum_a_pagar;
         $this->array_total_asentada[$quebra_asentada_orig][5] = $sum_val_ica;
         $this->array_total_asentada[$quebra_asentada_orig][6] = $sum_val_ret;
         $this->array_total_asentada[$quebra_asentada_orig][7] = $sum_val_retiva;
         $this->array_total_asentada[$quebra_asentada_orig][8] = 1;
         $this->array_total_asentada[$quebra_asentada_orig][9] = $quebra_asentada;
         $this->array_total_asentada[$quebra_asentada_orig][10] = $quebra_asentada_orig;
      }
      else
      {
         ...
         $this->array_total_asentada[$quebra_asentada_orig][6] += $sum_val_ret;
         $this->array_total_asentada[$quebra_asentada_orig][7] += $sum_val_retiva;
         $this->array_total_asentada[$quebra_asentada_orig][8]++;
      }
      //----- Total
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['asentada'] as $campo_asentada => $dados_asentada)
      {
         $this->array_total_asentada[$campo_asentada][2] = $dados_asentada[1];
         $this->array_total_asentada[$campo_asentada][7] = $dados_asentada[2];
         $this->array_total_asentada[$campo_asentada][4] = $dados_asentada[3];
         $this->array_total_asentada[$campo_asentada][8] = $dados_asentada[4];
         $this->array_total_asentada[$campo_asentada][5] = $dados_asentada[5];
         $this->array_total_asentada[$campo_asentada][3] = $dados_asentada[6];
         $this->array_total_asentada[$campo_asentada][6] = $dados_asentada[7];
         $this->array_total_asentada[$campo_asentada][1] = $dados_asentada[8];
      }
   }
   //---- 
...
$_SESSION['scriptcase']['grid_compras_new']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->subtotal, $this->valoriva, $this->a_pagar, $this->val_ica, $this->val_ret, $this->val_retiva, $this->asentada, $this->asentada_orig);
            }
   }
//
...
$_SESSION['scriptcase']['grid_compras_new']['contr_erro'] = 'off';
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['asentada'] = $this->array_total_asentada;
      }
   }
