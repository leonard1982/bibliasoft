...
class grid_compras_new_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_compras_new.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['grid_compras_new']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_compras_new']['contr_erro'] = 'off'; 
   ...
   function NM_export_acciones()
   {
         ...
         $this->acciones = str_replace('<', '&lt;', $this->acciones);
         $this->acciones = str_replace('>', '&gt;', $this->acciones);
         $this->Texto_tag .= "<td>" . $this->acciones . "</td>\r\n";
   }
   //----- idfaccom
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
