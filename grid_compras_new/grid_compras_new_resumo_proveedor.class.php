...
class grid_compras_new_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_idprov = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['idprov'];
      }
      else
      {
          $this->array_total_idprov = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_order']['proveedor']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_order']['proveedor'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_order']['proveedor'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['proveedor'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['proveedor'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['proveedor'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['proveedor'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['proveedor'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['proveedor'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['summarizing_fields_display']['proveedor'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_idprov as $i_idprov => $d_idprov) {
           if (!in_array($i_idprov, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_idprov[10] ] = $d_idprov[9];
               $this->comp_label[0][ $d_idprov[10] ] = $d_idprov[9];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_idprov => $l_idprov) {
           if (isset($this->array_total_idprov[$i_idprov])) {
               $this->comp_group[$i_idprov] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_idprov;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_idprov)),
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $sum_subtotal, $sum_valoriva, $sum_a_pagar, $sum_val_ica, $sum_val_ret, $sum_val_retiva, $quebra_idprov, $quebra_idprov_orig)
   {
      //----- Proveedor
      if (!isset($this->array_total_idprov[$quebra_idprov_orig]))
      {
         $this->array_total_idprov[$quebra_idprov_orig][0] = 1;
         $this->array_total_idprov[$quebra_idprov_orig][1] = $sum_total;
         $this->array_total_idprov[$quebra_idprov_orig][2] = $sum_subtotal;
         $this->array_total_idprov[$quebra_idprov_orig][3] = $sum_valoriva;
         $this->array_total_idprov[$quebra_idprov_orig][4] = $sum_a_pagar;
         $this->array_total_idprov[$quebra_idprov_orig][5] = $sum_val_ica;
         $this->array_total_idprov[$quebra_idprov_orig][6] = $sum_val_ret;
         $this->array_total_idprov[$quebra_idprov_orig][7] = $sum_val_retiva;
         $this->array_total_idprov[$quebra_idprov_orig][8] = 1;
         $this->array_total_idprov[$quebra_idprov_orig][9] = $quebra_idprov;
         $this->array_total_idprov[$quebra_idprov_orig][10] = $quebra_idprov_orig;
      }
      else
      {
         $this->array_total_idprov[$quebra_idprov_orig][0]++;
         $this->array_total_idprov[$quebra_idprov_orig][1] += $sum_total;
         $this->array_total_idprov[$quebra_idprov_orig][2] += $sum_subtotal;
         $this->array_total_idprov[$quebra_idprov_orig][3] += $sum_valoriva;
         $this->array_total_idprov[$quebra_idprov_orig][4] += $sum_a_pagar;
         ...
         $this->array_total_idprov[$quebra_idprov_orig][6] += $sum_val_ret;
         $this->array_total_idprov[$quebra_idprov_orig][7] += $sum_val_retiva;
         $this->array_total_idprov[$quebra_idprov_orig][8]++;
      }
      //----- Total
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['idprov'] as $campo_idprov => $dados_idprov)
      {
         $this->array_total_idprov[$campo_idprov][2] = $dados_idprov[1];
         $this->array_total_idprov[$campo_idprov][7] = $dados_idprov[2];
         $this->array_total_idprov[$campo_idprov][4] = $dados_idprov[3];
         $this->array_total_idprov[$campo_idprov][8] = $dados_idprov[4];
         $this->array_total_idprov[$campo_idprov][5] = $dados_idprov[5];
         $this->array_total_idprov[$campo_idprov][3] = $dados_idprov[6];
         $this->array_total_idprov[$campo_idprov][6] = $dados_idprov[7];
         $this->array_total_idprov[$campo_idprov][1] = $dados_idprov[8];
      }
   }
   //---- 
...
$_SESSION['scriptcase']['grid_compras_new']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->subtotal, $this->valoriva, $this->a_pagar, $this->val_ica, $this->val_ret, $this->val_retiva, $this->idprov, $this->idprov_orig);
            }
   }
//
...
$_SESSION['scriptcase']['grid_compras_new']['contr_erro'] = 'off';
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['idprov'] = $this->array_total_idprov;
      }
   }
