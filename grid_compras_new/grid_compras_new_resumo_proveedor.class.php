   ...
   function completeMatrix()
   {
       ...
       foreach ($this->array_total_idprov as $i_idprov => $d_idprov) {
           if (!in_array($i_idprov, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_idprov[7] ] = $d_idprov[6];
               $this->comp_label[0][ $d_idprov[7] ] = $d_idprov[6];
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_a_pagar, $sum_val_ica, $sum_val_ret, $sum_val_retiva, $quebra_idprov, $quebra_idprov_orig)
   {
      //----- Proveedor
      if (!isset($this->array_total_idprov[$quebra_idprov_orig]))
      {
         $this->array_total_idprov[$quebra_idprov_orig][0] = 1;
         $this->array_total_idprov[$quebra_idprov_orig][1] = $sum_a_pagar;
         $this->array_total_idprov[$quebra_idprov_orig][2] = $sum_val_ica;
         $this->array_total_idprov[$quebra_idprov_orig][3] = $sum_val_ret;
         $this->array_total_idprov[$quebra_idprov_orig][4] = $sum_val_retiva;
         $this->array_total_idprov[$quebra_idprov_orig][5] = 1;
         $this->array_total_idprov[$quebra_idprov_orig][6] = $quebra_idprov;
         $this->array_total_idprov[$quebra_idprov_orig][7] = $quebra_idprov_orig;
      }
      else
      {
         ...
         $this->array_total_idprov[$quebra_idprov_orig][3] += $sum_val_ret;
         $this->array_total_idprov[$quebra_idprov_orig][4] += $sum_val_retiva;
         $this->array_total_idprov[$quebra_idprov_orig][5]++;
      }
      //----- Total
   ...
   function compat_arrays()
   {
      ...
      {
         $this->array_total_idprov[$campo_idprov][5] = $dados_idprov[1];
         $this->array_total_idprov[$campo_idprov][3] = $dados_idprov[2];
         $this->array_total_idprov[$campo_idprov][2] = $dados_idprov[3];
         $this->array_total_idprov[$campo_idprov][4] = $dados_idprov[4];
         $this->array_total_idprov[$campo_idprov][1] = $dados_idprov[5];
      }
   }
   //---- 
...
$_SESSION['scriptcase']['grid_compras_new']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->a_pagar, $this->val_ica, $this->val_ret, $this->val_retiva, $this->idprov, $this->idprov_orig);
            }
   }
//
...
$_SESSION['scriptcase']['grid_compras_new']['contr_erro'] = 'off';
         ...
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->a_pagar)), NM_encode_input(sc_strip_script($this->val_ica)), NM_encode_input(sc_strip_script($this->val_ret)), NM_encode_input(sc_strip_script($this->val_retiva)), sc_strip_script($this->GB_idprov), sc_strip_script($idprov_orig));
