...
class grid_compras_new_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_compras_new/grid_compras_new_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_compras_new_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_compras_new.zip";
          $this->Arquivo   .= "_grid_compras_new" . $this->Xls_tp;
      ...
      if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['SC_Ind_Groupby'], $this->GB_tot_php))
      {
          $Tot_Gb = "totaliza_php_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['SC_Ind_Groupby'];
          $this->$Tot_Gb();
      }
      else
      {
...
$_SESSION['scriptcase']['grid_compras_new']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      while (!$rs->EOF)
      {
         ...
         elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['SC_Ind_Groupby'] == "_NM_SC_")
         {
             $this->arg_sum_fechacom = " = " . $this->Db->qstr($this->fechacom);
         }
         ...
         $this->arg_sum_asentada = ($this->asentada == "") ? " is null " : " = " . $this->asentada;
          ...
          if ($Cmp_tst != $this->fechacom_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['SC_Ind_Groupby'] == "fecha") 
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
          ...
          if ($this->pagada !== $this->pagada_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['SC_Ind_Groupby'] == "pagada") 
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
          ...
          if ($this->asentada !== $this->asentada_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['SC_Ind_Groupby'] == "asentada") 
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
          ...
          if (($this->tipo_com !== $this->tipo_com_Old || $NM_prim_qb) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['SC_Ind_Groupby'] == "tipo_com") 
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
          ...
          if (($this->prefijo_com !== $this->prefijo_com_Old || $NM_prim_qb) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['SC_Ind_Groupby'] == "prefijo_com") 
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
...
$_SESSION['scriptcase']['grid_compras_new']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['embutida'])
      { 
      ...
      if ($this->groupby_show == "S") {
          ...
          $this->Xls_col = 0;
          $this->Xls_row++;
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['SC_Ind_Groupby'] . "_bot";
          $this->$Gb_geral();
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['embutida'])
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['nolabel'])
       {
 ...
 function quebra_idprov_proveedor($idprov) 
 {
   ...
   $tot_idprov[0] = $idprov;
   $tot_idprov[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['idprov'][$idprov][0];
   $tot_idprov[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['idprov'][$idprov][1];
 ...
 function quebra_fechacom_fecha($fechacom) 
 {
   ...
   $tot_fechacom[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['fechacom'][$fechacom][0];
   $tot_fechacom[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['fechacom'][$fechacom][1];
 ...
 function quebra_pagada_pagada($pagada) 
 {
   ...
   $tot_pagada[0] = $pagada;
   $tot_pagada[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['pagada'][$pagada][0];
   $tot_pagada[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['pagada'][$pagada][1];
 ...
 function quebra_asentada_asentada($asentada) 
 {
   ...
   $tot_asentada[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['asentada'][$asentada][0];
   $tot_asentada[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['asentada'][$asentada][1];
...
$_SESSION['scriptcase']['grid_compras_new']['contr_erro'] = 'off';
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['SC_Ind_Groupby'] == "proveedor")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new']['arr_total']['idprov'] = $this->Res->array_total_idprov;
      }
   }
