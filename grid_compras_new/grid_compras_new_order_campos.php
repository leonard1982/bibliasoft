...
<?php
   ...
   $Ord_Cmp = new grid_compras_new_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_compras_new_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tipo_com"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["tipo_com"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["tipo_com"] : "Tipo";
   $tab_ger_campos['prefijo_com'] = "on";
   $tab_def_campos['prefijo_com'] = "prefijo_com";
   $tab_labels["prefijo_com"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["prefijo_com"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["prefijo_com"] : "Prefijo";
   $tab_ger_campos['numero_com'] = "on";
   $tab_def_campos['numero_com'] = "numero_com";
   $tab_labels["numero_com"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["numero_com"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["numero_com"] : "Consecutivo";
   $tab_ger_campos['numfacom'] = "on";
   $tab_def_campos['numfacom'] = "numfacom";
   $tab_labels["numfacom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["numfacom"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["numfacom"] : "Ref. Compra";
   $tab_ger_campos['formapago'] = "on";
   $tab_def_campos['formapago'] = "formapago";
   $tab_labels["formapago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["formapago"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["formapago"] : "F.Pago";
   $tab_ger_campos['fechacom'] = "on";
   $tab_def_campos['fechacom'] = "fechacom";
   $tab_labels["fechacom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["fechacom"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["fechacom"] : "Fecha";
   $tab_ger_campos['fechavenc'] = "on";
   $tab_def_campos['fechavenc'] = "fechavenc";
   $tab_labels["fechavenc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["fechavenc"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["fechavenc"] : "Vence";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["pagada"] : "Pagada";
   ...
   $tab_labels["pagos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["pagos"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["pagos"] : "Abonos";
   $tab_ger_campos['idprov'] = "on";
   $tab_def_campos['idprov'] = "idprov";
   $tab_labels["idprov"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["idprov"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["idprov"] : "Proveedor";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_new']['labels']["total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_compras_new']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_compras_new']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_compras_new_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_compras_new']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
