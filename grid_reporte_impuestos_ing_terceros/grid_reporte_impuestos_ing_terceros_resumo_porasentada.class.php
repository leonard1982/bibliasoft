...
class grid_reporte_impuestos_ing_terceros_resumo
{
   ...
   var $sum_asentada_base_iva_19;
   var $sum_asentada_valor_iva_19;
   var $sum_asentada_base_iva_5;
   var $sum_asentada_valor_iva_5;
   var $sum_asentada_excento;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_asentada = array();
...
$_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['arr_total']['asentada'];
      }
      else
      {
          $this->array_total_asentada = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['arr_total']['asentada'] = $this->array_total_asentada;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['labels']['asentada'] = $Lab_asentada; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_order']['porasentada']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_order']['porasentada'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_order']['porasentada'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porasentada'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porasentada'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porasentada'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porasentada'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porasentada'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porasentada'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porasentada'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_asentada as $i_asentada => $d_asentada) {
           if (!in_array($i_asentada, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_asentada[12] ] = $d_asentada[11];
               $this->comp_label[0][ $d_asentada[12] ] = $d_asentada[11];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_asentada => $l_asentada) {
           if (isset($this->array_total_asentada[$i_asentada])) {
               $this->comp_group[$i_asentada] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_asentada;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_asentada)),
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_porasentada("res");
      ...
      ksort($this->array_total_asentada);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_reporte_impuestos_ing_terceros_jquery.js\"></script>\r\n");
...
$nm_saida->saida("                  {\r\n");
$nm_saida->saida("                      nm_gp_move('resumo', '0');\r\n");
$nm_saida->saida("                  }\r\n");
...
$nm_saida->saida("}\r\n");
     ...
     if (!$_SESSION['scriptcase']['proc_mobile']) { 
           ...
           $nm_saida->saida("       }\r\n");
           $nm_saida->saida("       if(($('#save_grid_' + pos).position().left + $('#id_div_save_grid_new_' + pos).outerWidth() +10) >= $(document).width())\r\n");
           $nm_saida->saida("       {\r\n");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_subtotal, $sum_base_iva_19, $sum_valor_iva_19, $sum_base_iva_5, $sum_valor_iva_5, $sum_excento, $sum_total, $sum_valoriva, $sum_adicional, $quebra_asentada, $quebra_asentada_orig)
   {
      //----- Asentada
      if (!isset($this->array_total_asentada[$quebra_asentada_orig]))
      {
         $this->array_total_asentada[$quebra_asentada_orig][0] = 1;
         $this->array_total_asentada[$quebra_asentada_orig][1] = $sum_subtotal;
         $this->array_total_asentada[$quebra_asentada_orig][2] = $sum_base_iva_19;
         $this->array_total_asentada[$quebra_asentada_orig][3] = $sum_valor_iva_19;
         $this->array_total_asentada[$quebra_asentada_orig][4] = $sum_base_iva_5;
         $this->array_total_asentada[$quebra_asentada_orig][5] = $sum_valor_iva_5;
         $this->array_total_asentada[$quebra_asentada_orig][6] = $sum_excento;
         $this->array_total_asentada[$quebra_asentada_orig][7] = $sum_total;
         $this->array_total_asentada[$quebra_asentada_orig][8] = $sum_valoriva;
         $this->array_total_asentada[$quebra_asentada_orig][9] = $sum_adicional;
         $this->array_total_asentada[$quebra_asentada_orig][10] = 1;
         $this->array_total_asentada[$quebra_asentada_orig][11] = $quebra_asentada;
         $this->array_total_asentada[$quebra_asentada_orig][12] = $quebra_asentada_orig;
      }
      else
      {
         $this->array_total_asentada[$quebra_asentada_orig][0]++;
         $this->array_total_asentada[$quebra_asentada_orig][1] += $sum_subtotal;
         $this->array_total_asentada[$quebra_asentada_orig][2] += $sum_base_iva_19;
         $this->array_total_asentada[$quebra_asentada_orig][3] += $sum_valor_iva_19;
         $this->array_total_asentada[$quebra_asentada_orig][4] += $sum_base_iva_5;
         ...
         $this->array_total_asentada[$quebra_asentada_orig][8] += $sum_valoriva;
         $this->array_total_asentada[$quebra_asentada_orig][9] += $sum_adicional;
         $this->array_total_asentada[$quebra_asentada_orig][10]++;
      }
   }
...
$_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['contr_erro'] = 'off'; 
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'asentada');
     $campos_order = $this->Ini->Get_date_order_groupby("asentada", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->idcli = $rs_res->fields[5] ;  
            $this->numcontrato = $rs_res->fields[6] ;  
            $this->subtotal = $rs_res->fields[7] ;  
            $this->subtotal =  str_replace(",", ".", $this->subtotal);
            $this->base_iva_19 = $rs_res->fields[8] ;  
            $this->base_iva_19 =  str_replace(",", ".", $this->base_iva_19);
            $this->valor_iva_19 = $rs_res->fields[9] ;  
            $this->valor_iva_19 =  str_replace(",", ".", $this->valor_iva_19);
            $this->base_iva_5 = $rs_res->fields[10] ;  
            $this->base_iva_5 =  str_replace(",", ".", $this->base_iva_5);
            $this->valor_iva_5 = $rs_res->fields[11] ;  
            $this->valor_iva_5 =  str_replace(",", ".", $this->valor_iva_5);
            $this->excento = $rs_res->fields[12] ;  
            $this->excento =  str_replace(",", ".", $this->excento);
            $this->ing_terceros = $rs_res->fields[13] ;  
            $this->ing_terceros =  str_replace(",", ".", $this->ing_terceros);
            $this->total = $rs_res->fields[14] ;  
            $this->total =  str_replace(",", ".", $this->total);
            $this->idfacven = $rs_res->fields[15] ;  
            $this->numfacven = $rs_res->fields[16] ;  
            $this->credito = $rs_res->fields[17] ;  
            $this->fechavenc = $rs_res->fields[18] ;  
            $this->valoriva = $rs_res->fields[19] ;  
            $this->valoriva =  str_replace(",", ".", $this->valoriva);
            $this->pagada = $rs_res->fields[20] ;  
            $this->asentada = $rs_res->fields[21] ;  
            $this->observaciones = $rs_res->fields[22] ;  
            $this->saldo = $rs_res->fields[23] ;  
            $this->saldo =  str_replace(",", ".", $this->saldo);
            $this->adicional = $rs_res->fields[24] ;  
            $this->adicional =  str_replace(",", ".", $this->adicional);
            $this->adicional2 = $rs_res->fields[25] ;  
            $this->adicional3 = $rs_res->fields[26] ;  
            $this->resolucion = $rs_res->fields[27] ;  
            $this->vendedor = $rs_res->fields[28] ;  
            $this->creado = $rs_res->fields[29] ;  
            $this->editado = $rs_res->fields[30] ;  
            $this->usuario_crea = $rs_res->fields[31] ;  
            $this->inicio = $rs_res->fields[32] ;  
            $this->fin = $rs_res->fields[33] ;  
            $this->banco = $rs_res->fields[34] ;  
            $this->dias_decredito = $rs_res->fields[35] ;  
            $this->tipo = $rs_res->fields[36] ;  
            $this->cod_cuenta = $rs_res->fields[37] ;  
            $this->enviada_a_tns = $rs_res->fields[38] ;  
            $this->factura_tns = $rs_res->fields[39] ;  
            $this->cufe = $rs_res->fields[40] ;  
            $this->enviada = $rs_res->fields[41] ;  
...
$_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['contr_erro'] = 'off'; 
            $this->asentada_orig = $this->asentada;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->subtotal, $this->base_iva_19, $this->valor_iva_19, $this->base_iva_5, $this->valor_iva_5, $this->excento, $this->total, $this->valoriva, $this->adicional, $this->asentada, $this->asentada_orig);
            }
   }
//
