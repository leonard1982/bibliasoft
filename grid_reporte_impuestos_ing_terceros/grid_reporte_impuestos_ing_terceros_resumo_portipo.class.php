...
$_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['arr_total']['tipo'];
      }
      else
      {
          $this->array_total_tipo = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_order']['portipo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_order']['portipo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_order']['portipo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['portipo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['portipo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['portipo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['portipo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['portipo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['portipo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['portipo'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_tipo as $i_tipo => $d_tipo) {
           if (!in_array($i_tipo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tipo[12] ] = $d_tipo[11];
               $this->comp_label[0][ $d_tipo[12] ] = $d_tipo[11];
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_subtotal, $sum_base_iva_19, $sum_valor_iva_19, $sum_base_iva_5, $sum_valor_iva_5, $sum_excento, $sum_total, $sum_valoriva, $sum_adicional, $quebra_tipo, $quebra_tipo_orig)
   {
      //----- Tipo
      if (!isset($this->array_total_tipo[$quebra_tipo_orig]))
      {
         $this->array_total_tipo[$quebra_tipo_orig][0] = 1;
         $this->array_total_tipo[$quebra_tipo_orig][1] = $sum_subtotal;
         $this->array_total_tipo[$quebra_tipo_orig][2] = $sum_base_iva_19;
         $this->array_total_tipo[$quebra_tipo_orig][3] = $sum_valor_iva_19;
         $this->array_total_tipo[$quebra_tipo_orig][4] = $sum_base_iva_5;
         $this->array_total_tipo[$quebra_tipo_orig][5] = $sum_valor_iva_5;
         $this->array_total_tipo[$quebra_tipo_orig][6] = $sum_excento;
         $this->array_total_tipo[$quebra_tipo_orig][7] = $sum_total;
         $this->array_total_tipo[$quebra_tipo_orig][8] = $sum_valoriva;
         $this->array_total_tipo[$quebra_tipo_orig][9] = $sum_adicional;
         $this->array_total_tipo[$quebra_tipo_orig][10] = 1;
         $this->array_total_tipo[$quebra_tipo_orig][11] = $quebra_tipo;
         $this->array_total_tipo[$quebra_tipo_orig][12] = $quebra_tipo_orig;
      }
      else
      {
         ...
         $this->array_total_tipo[$quebra_tipo_orig][8] += $sum_valoriva;
         $this->array_total_tipo[$quebra_tipo_orig][9] += $sum_adicional;
         $this->array_total_tipo[$quebra_tipo_orig][10]++;
      }
   }
...
$_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->subtotal, $this->base_iva_19, $this->valor_iva_19, $this->base_iva_5, $this->valor_iva_5, $this->excento, $this->total, $this->valoriva, $this->adicional, $this->tipo, $this->tipo_orig);
            }
   }
//
