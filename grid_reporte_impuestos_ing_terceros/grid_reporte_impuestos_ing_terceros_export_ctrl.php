<?php
@session_start() ;
$_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['sc_process_barr'] = true;
require_once('../grid_reporte_impuestos_ing_terceros/index.php');
unset($_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['sc_process_barr']);
$ExportCtrl = new grid_reporte_impuestos_ing_terceros_export_control;
$ExportCtrl->Export_barr();

class grid_reporte_impuestos_ing_terceros_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['glo_nm_path_imag_temp'];
