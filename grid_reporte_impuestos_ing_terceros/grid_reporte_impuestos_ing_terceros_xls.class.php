...
class grid_reporte_impuestos_ing_terceros_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $sum_pagada_base_iva_19;
   var $sum_pagada_valor_iva_19;
   var $sum_pagada_base_iva_5;
   var $sum_pagada_valor_iva_5;
   var $sum_pagada_excento;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_reporte_impuestos_ing_terceros/grid_reporte_impuestos_ing_terceros_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_reporte_impuestos_ing_terceros_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_reporte_impuestos_ing_terceros.zip";
          $this->Arquivo   .= "_grid_reporte_impuestos_ing_terceros" . $this->Xls_tp;
          $this->Tit_doc    = "grid_reporte_impuestos_ing_terceros" . $this->Xls_tp;
      ...
      {
          $this->sum_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['tot_geral'][2];
          ...
          $this->sum_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['tot_geral'][8];
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      { 
          $nmgp_select = "SELECT anio, periodo, zona, EXTEND(fechaven, YEAR TO DAY), numero2, ccnit, idcli, numcontrato, subtotal, base_iva_19, valor_iva_19, base_iva_5, valor_iva_5, excento, ing_terceros, total, idfacven, numfacven, credito, EXTEND(fechavenc, YEAR TO DAY), valoriva, pagada, asentada, observaciones, saldo, adicional, adicional2, adicional3, resolucion, vendedor, EXTEND(creado, YEAR TO FRACTION), EXTEND(editado, YEAR TO FRACTION), usuario_crea, EXTEND(inicio, YEAR TO FRACTION), EXTEND(fin, YEAR TO FRACTION), banco, dias_decredito, tipo, cod_cuenta, enviada_a_tns, factura_tns, cufe, enviada from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat((select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2,     qr_base64,     fecha_validacion,     cufe,      direccion as direccion2,     (MONTH(fechaven)) as periodo,     (YEAR(fechaven)) as anio,     (select b.descripcion from terceros_contratos tc inner join terceros_contratos_factura tcf on tc.id_ter_cont=tcf.id_contrato inner join barrios b on tc.barrio=b.codigo where tcf.factura = f.idfacven limit 1) as barrio,     (select zc.nombre from terceros_contratos tc inner join terceros_contratos_factura tcf on tc.id_ter_cont=tcf.id_contrato inner join zona_clientes zc on tc.zona=zc.codigo where tcf.factura = f.idfacven limit 1) as zona, numcontrato,     enviada,     coalesce((select sum(v.valorpar-v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='19'),0) as base_iva_19,     coalesce((select sum(v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='19'),0) as valor_iva_19,     coalesce((select sum(v.valorpar-v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='5'),0) as base_iva_5,     coalesce((select sum(v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='5'),0) as valor_iva_5,     coalesce((select sum(v.valorpar-v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='0'),0) as excento, coalesce((select sum(v.valorpar-v.iva) from detalleventa v left join productos p on v.idpro=p.idprod where v.numfac=idfacven and v.adicional='0' and p.tipo_producto='RE'),0) as ing_terceros,  (select t.documento from terceros t where t.idtercero=f.idcli) as ccnit FROM      facturaven_contratos f WHERE           espos = 'SI' and enviada='SI' and asentada='1' ) nm_sel_esp"; 
       } 
      else 
      { 
          $nmgp_select = "SELECT anio, periodo, zona, fechaven, numero2, ccnit, idcli, numcontrato, subtotal, base_iva_19, valor_iva_19, base_iva_5, valor_iva_5, excento, ing_terceros, total, idfacven, numfacven, credito, fechavenc, valoriva, pagada, asentada, observaciones, saldo, adicional, adicional2, adicional3, resolucion, vendedor, creado, editado, usuario_crea, inicio, fin, banco, dias_decredito, tipo, cod_cuenta, enviada_a_tns, factura_tns, cufe, enviada from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat((select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2,     qr_base64,     fecha_validacion,     cufe,      direccion as direccion2,     (MONTH(fechaven)) as periodo,     (YEAR(fechaven)) as anio,     (select b.descripcion from terceros_contratos tc inner join terceros_contratos_factura tcf on tc.id_ter_cont=tcf.id_contrato inner join barrios b on tc.barrio=b.codigo where tcf.factura = f.idfacven limit 1) as barrio,     (select zc.nombre from terceros_contratos tc inner join terceros_contratos_factura tcf on tc.id_ter_cont=tcf.id_contrato inner join zona_clientes zc on tc.zona=zc.codigo where tcf.factura = f.idfacven limit 1) as zona, numcontrato,     enviada,     coalesce((select sum(v.valorpar-v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='19'),0) as base_iva_19,     coalesce((select sum(v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='19'),0) as valor_iva_19,     coalesce((select sum(v.valorpar-v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='5'),0) as base_iva_5,     coalesce((select sum(v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='5'),0) as valor_iva_5,     coalesce((select sum(v.valorpar-v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='0'),0) as excento, coalesce((select sum(v.valorpar-v.iva) from detalleventa v left join productos p on v.idpro=p.idprod where v.numfac=idfacven and v.adicional='0' and p.tipo_producto='RE'),0) as ing_terceros,  (select t.documento from terceros t where t.idtercero=f.idcli) as ccnit FROM      facturaven_contratos f WHERE           espos = 'SI' and enviada='SI' and asentada='1' ) nm_sel_esp"; 
      ...
      while (!$rs->EOF)
      {
         ...
         $this->numfacven = $rs->fields[17] ;  
         $this->numfacven = (string)$this->numfacven;
         $this->credito = $rs->fields[18] ;  
         $this->credito = (string)$this->credito;
         $this->fechavenc = $rs->fields[19] ;  
         $this->valoriva = $rs->fields[20] ;  
         $this->valoriva =  str_replace(",", ".", $this->valoriva);
         $this->valoriva = (string)$this->valoriva;
         $this->pagada = $rs->fields[21] ;  
         $this->asentada = $rs->fields[22] ;  
         $this->asentada = (string)$this->asentada;
         $this->observaciones = $rs->fields[23] ;  
         $this->saldo = $rs->fields[24] ;  
         $this->saldo =  str_replace(",", ".", $this->saldo);
         $this->saldo = (string)$this->saldo;
         $this->adicional = $rs->fields[25] ;  
         $this->adicional =  str_replace(",", ".", $this->adicional);
         $this->adicional = (string)$this->adicional;
         $this->adicional2 = $rs->fields[26] ;  
         $this->adicional2 = (string)$this->adicional2;
         $this->adicional3 = $rs->fields[27] ;  
         $this->adicional3 = (string)$this->adicional3;
         $this->resolucion = $rs->fields[28] ;  
         $this->resolucion = (string)$this->resolucion;
         $this->vendedor = $rs->fields[29] ;  
         $this->vendedor = (string)$this->vendedor;
         $this->creado = $rs->fields[30] ;  
         $this->editado = $rs->fields[31] ;  
         $this->usuario_crea = $rs->fields[32] ;  
         $this->usuario_crea = (string)$this->usuario_crea;
         $this->inicio = $rs->fields[33] ;  
         $this->fin = $rs->fields[34] ;  
         $this->banco = $rs->fields[35] ;  
         $this->banco = (string)$this->banco;
         $this->dias_decredito = $rs->fields[36] ;  
         $this->dias_decredito = (string)$this->dias_decredito;
         $this->tipo = $rs->fields[37] ;  
         $this->cod_cuenta = $rs->fields[38] ;  
         $this->enviada_a_tns = $rs->fields[39] ;  
         $this->factura_tns = $rs->fields[40] ;  
         $this->cufe = $rs->fields[41] ;  
         $this->enviada = $rs->fields[42] ;  
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_orig']))
         {
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_orig'] as $Cmp_clone => $Cmp_orig)
             {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Ind_Groupby'] == "sc_free_group_by")
         {
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
             {
                 $Cmp_orig = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
         ...
         elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Ind_Groupby'] == "_NM_SC_")
         {
         ...
         $this->arg_sum_tipo = " = " . $this->Db->qstr($this->tipo);
          ...
          if ($Cmp_tst != $this->fechaven_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Ind_Groupby'] == "fecha") 
          {  
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
          ...
          {  
              $SC_arg_Gby = array();
              $SC_arg_Sql = array();
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_orig'][$cmp] : $cmp;
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
              ...
              $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_cmp']);
              krsort ($SC_lst_Gby);
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
          ...
          if ($this->idcli !== $this->idcli_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Ind_Groupby'] == "cliente") 
          {  
...
$_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida'])
      { 
      ...
      if ($this->groupby_show == "S") {
          $this->Xls_col = 0;
          $this->Xls_row++;
       if (isset($this->fechaven_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Ind_Groupby'] == "fecha")
       {
           $this->quebra_fechaven_fecha_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
       ...
       if (isset($this->idcli_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Ind_Groupby'] == "cliente")
       {
           $this->quebra_idcli_cliente_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
          ...
          $this->Xls_col = 0;
          $this->Xls_row++;
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['SC_Ind_Groupby'] . "_bot";
          $this->$Gb_geral();
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida'])
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['ccnit'])) ? $this->New_label['ccnit'] : "CC/NIT"; 
          ...
          $SC_Label = (isset($this->New_label['numcontrato'])) ? $this->New_label['numcontrato'] : "Cod/Cliente"; 
   ...
   function NM_export_numcontrato()
   {
         ...
         if (is_numeric($this->numcontrato))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->numcontrato);
         $this->Xls_col++;
   }
   //----- subtotal
   ...
   //----- numcontrato
   function NM_sub_cons_numcontrato()
   {
         $this->numcontrato = NM_charset_to_utf8($this->numcontrato);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->numcontrato;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['nolabel'])
       {
 ...
 function quebra_fechaven_fecha($fechaven) 
 {
   ...
   $this->sum_fechaven_base_iva_19 = $tot_fechaven[3];
   $this->sum_fechaven_valor_iva_19 = $tot_fechaven[4];
   $this->sum_fechaven_base_iva_5 = $tot_fechaven[5];
   $this->sum_fechaven_valor_iva_5 = $tot_fechaven[6];
   $this->sum_fechaven_excento = $tot_fechaven[7];
   $this->sum_fechaven_total = $tot_fechaven[8];
   $this->sum_fechaven_valoriva = $tot_fechaven[9];
   $this->sum_fechaven_adicional = $tot_fechaven[10];
 ...
 function quebra_credito_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_credito_subtotal = $tot_credito[2];
   $this->sum_credito_base_iva_19 = $tot_credito[3];
   $this->sum_credito_valor_iva_19 = $tot_credito[4];
   $this->sum_credito_base_iva_5 = $tot_credito[5];
   $this->sum_credito_valor_iva_5 = $tot_credito[6];
   $this->sum_credito_excento = $tot_credito[7];
   $this->sum_credito_total = $tot_credito[8];
   $this->sum_credito_valoriva = $tot_credito[9];
   $this->sum_credito_adicional = $tot_credito[10];
 ...
 function quebra_fechavenc_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_fechavenc_subtotal = $tot_fechavenc[2];
   $this->sum_fechavenc_base_iva_19 = $tot_fechavenc[3];
   $this->sum_fechavenc_valor_iva_19 = $tot_fechavenc[4];
   $this->sum_fechavenc_base_iva_5 = $tot_fechavenc[5];
   $this->sum_fechavenc_valor_iva_5 = $tot_fechavenc[6];
   $this->sum_fechavenc_excento = $tot_fechavenc[7];
   $this->sum_fechavenc_total = $tot_fechavenc[8];
   $this->sum_fechavenc_valoriva = $tot_fechavenc[9];
   $this->sum_fechavenc_adicional = $tot_fechavenc[10];
   $Temp_cmp_quebra = array(); 
 ...
 function quebra_idcli_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_idcli_subtotal = $tot_idcli[2];
   $this->sum_idcli_base_iva_19 = $tot_idcli[3];
   $this->sum_idcli_valor_iva_19 = $tot_idcli[4];
   $this->sum_idcli_base_iva_5 = $tot_idcli[5];
   $this->sum_idcli_valor_iva_5 = $tot_idcli[6];
   $this->sum_idcli_excento = $tot_idcli[7];
   $this->sum_idcli_total = $tot_idcli[8];
   $this->sum_idcli_valoriva = $tot_idcli[9];
   $this->sum_idcli_adicional = $tot_idcli[10];
   $Temp_cmp_quebra = array(); 
 ...
 function quebra_pagada_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_pagada_base_iva_19 = $tot_pagada[3];
   $this->sum_pagada_valor_iva_19 = $tot_pagada[4];
   $this->sum_pagada_base_iva_5 = $tot_pagada[5];
   $this->sum_pagada_valor_iva_5 = $tot_pagada[6];
   $this->sum_pagada_excento = $tot_pagada[7];
   $this->sum_pagada_total = $tot_pagada[8];
   $this->sum_pagada_valoriva = $tot_pagada[9];
   $this->sum_pagada_adicional = $tot_pagada[10];
   $Temp_cmp_quebra = array(); 
 ...
 function quebra_asentada_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_asentada_base_iva_19 = $tot_asentada[3];
   $this->sum_asentada_valor_iva_19 = $tot_asentada[4];
   $this->sum_asentada_base_iva_5 = $tot_asentada[5];
   $this->sum_asentada_valor_iva_5 = $tot_asentada[6];
   $this->sum_asentada_excento = $tot_asentada[7];
   $this->sum_asentada_total = $tot_asentada[8];
   $this->sum_asentada_valoriva = $tot_asentada[9];
   $this->sum_asentada_adicional = $tot_asentada[10];
   $Temp_cmp_quebra = array(); 
 ...
 function quebra_resolucion_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_resolucion_subtotal = $tot_resolucion[2];
   $this->sum_resolucion_base_iva_19 = $tot_resolucion[3];
   $this->sum_resolucion_valor_iva_19 = $tot_resolucion[4];
   $this->sum_resolucion_base_iva_5 = $tot_resolucion[5];
   $this->sum_resolucion_valor_iva_5 = $tot_resolucion[6];
   $this->sum_resolucion_excento = $tot_resolucion[7];
   $this->sum_resolucion_total = $tot_resolucion[8];
   $this->sum_resolucion_valoriva = $tot_resolucion[9];
   $this->sum_resolucion_adicional = $tot_resolucion[10];
   $Temp_cmp_quebra = array(); 
 ...
 function quebra_vendedor_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_vendedor_subtotal = $tot_vendedor[2];
   $this->sum_vendedor_base_iva_19 = $tot_vendedor[3];
   $this->sum_vendedor_valor_iva_19 = $tot_vendedor[4];
   $this->sum_vendedor_base_iva_5 = $tot_vendedor[5];
   $this->sum_vendedor_valor_iva_5 = $tot_vendedor[6];
   $this->sum_vendedor_excento = $tot_vendedor[7];
   $this->sum_vendedor_total = $tot_vendedor[8];
   $this->sum_vendedor_valoriva = $tot_vendedor[9];
   $this->sum_vendedor_adicional = $tot_vendedor[10];
   $Temp_cmp_quebra = array(); 
 ...
 function quebra_tipo_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_tipo_subtotal = $tot_tipo[2];
   $this->sum_tipo_base_iva_19 = $tot_tipo[3];
   $this->sum_tipo_valor_iva_19 = $tot_tipo[4];
   $this->sum_tipo_base_iva_5 = $tot_tipo[5];
   $this->sum_tipo_valor_iva_5 = $tot_tipo[6];
   $this->sum_tipo_excento = $tot_tipo[7];
   $this->sum_tipo_total = $tot_tipo[8];
   $this->sum_tipo_valoriva = $tot_tipo[9];
   $this->sum_tipo_adicional = $tot_tipo[10];
   $Temp_cmp_quebra = array(); 
 ...
 function quebra_idcli_cliente($idcli) 
 {
   ...
   function quebra_fechaven_fecha_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['field_order'] as $Cada_cmp)
       {
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_pagada_sc_free_group_by_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_pagada_base_iva_19;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_pagada_valor_iva_19;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_pagada_base_iva_5;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_pagada_valor_iva_5;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_pagada_excento;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_asentada_sc_free_group_by_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_asentada_base_iva_19;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_asentada_valor_iva_19;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_asentada_base_iva_5;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_asentada_valor_iva_5;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_asentada_excento;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_geral_fecha_bot()
   {
       ...
       $prim_cmp = true;
       $mens_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['tot_geral'][0];
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['field_order'] as $Cada_cmp)
       {
           if ($Cada_cmp == "subtotal" && (!isset($this->NM_cmp_hidden['subtotal']) || $this->NM_cmp_hidden['subtotal'] != "off"))
           {
               $Format_Num = "#,##0.00";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['tot_geral'][2];
               $prim_cmp = false;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['tot_geral'][3];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['tot_geral'][4];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['tot_geral'][5];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['tot_geral'][6];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['tot_geral'][7];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['tot_geral'][8];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0.00";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['tot_geral'][9];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['tot_geral'][10];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
