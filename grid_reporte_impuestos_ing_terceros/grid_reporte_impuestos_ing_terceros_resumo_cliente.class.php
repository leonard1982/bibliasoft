...
$_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['contr_erro'] = 'off'; 
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['tot_geral'][2];
   ...
   function completeMatrix()
   {
       ...
       //-----
       $this->comp_sum = array(
           2 => "Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_order']['cliente']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_order']['cliente'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_order']['cliente'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['cliente'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['cliente'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['cliente'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['cliente'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['cliente'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['cliente'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['cliente'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_idcli as $i_idcli => $d_idcli) {
           if (!in_array($i_idcli, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_idcli[3] ] = $d_idcli[2];
               $this->comp_label[0][ $d_idcli[3] ] = $d_idcli[2];
           }
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               'title'    => $this->getChartText(strip_tags("Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'idcli',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_idcli)),
               'label_y'  => $this->getChartText(strip_tags("Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_cliente("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $quebra_idcli, $quebra_idcli_orig)
   {
      //----- Cliente
      if (!isset($this->array_total_idcli[$quebra_idcli_orig]))
      {
         $this->array_total_idcli[$quebra_idcli_orig][0] = 1;
         $this->array_total_idcli[$quebra_idcli_orig][1] = $sum_total;
         $this->array_total_idcli[$quebra_idcli_orig][2] = $quebra_idcli;
         $this->array_total_idcli[$quebra_idcli_orig][3] = $quebra_idcli_orig;
      }
      else
      {
...
$_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->idcli, $this->idcli_orig);
            }
   }
//
