<?php
class grid_reporte_impuestos_ing_terceros_lookup
{
//  
...
//  
   function lookup_sc_free_group_by_credito(&$credito) 
   {
      $conteudo = "" ; 
      if ($credito == "1")
      { 
...
//  
   function lookup_sc_free_group_by_idcli(&$conteudo , $idcli) 
   {   
      static $save_conteudo = "" ; 
      static $save_conteudo1 = "" ; 
      $tst_cache = $idcli; 
...
//  
   function lookup_sc_free_group_by_asentada(&$asentada) 
   {
      $conteudo = "" ; 
      if ($asentada == "0")
      { 
...
//  
   function lookup_sc_free_group_by_resolucion(&$conteudo , $resolucion) 
   {   
      static $save_conteudo = "" ; 
      static $save_conteudo1 = "" ; 
      $tst_cache = $resolucion; 
