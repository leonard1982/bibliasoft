...
$_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_idcli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['arr_total']['idcli'];
      }
      else
      {
          $this->array_total_idcli = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['arr_total']['idcli'] = $this->array_total_idcli;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['labels']['idcli'] = $Lab_idcli; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_order']['porcliente']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_order']['porcliente'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_order']['porcliente'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porcliente'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porcliente'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porcliente'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porcliente'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porcliente'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porcliente'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['summarizing_fields_display']['porcliente'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_idcli as $i_idcli => $d_idcli) {
           if (!in_array($i_idcli, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_idcli[12] ] = $d_idcli[11];
               $this->comp_label[0][ $d_idcli[12] ] = $d_idcli[11];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_idcli => $l_idcli) {
           if (isset($this->array_total_idcli[$i_idcli])) {
               $this->comp_group[$i_idcli] = array();
           }
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_idcli)),
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos_ing_terceros']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_porcliente("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_subtotal, $sum_base_iva_19, $sum_valor_iva_19, $sum_base_iva_5, $sum_valor_iva_5, $sum_excento, $sum_total, $sum_valoriva, $sum_adicional, $quebra_idcli, $quebra_idcli_orig)
   {
      //----- Cliente
      if (!isset($this->array_total_idcli[$quebra_idcli_orig]))
      {
         $this->array_total_idcli[$quebra_idcli_orig][0] = 1;
         $this->array_total_idcli[$quebra_idcli_orig][1] = $sum_subtotal;
         $this->array_total_idcli[$quebra_idcli_orig][2] = $sum_base_iva_19;
         $this->array_total_idcli[$quebra_idcli_orig][3] = $sum_valor_iva_19;
         $this->array_total_idcli[$quebra_idcli_orig][4] = $sum_base_iva_5;
         $this->array_total_idcli[$quebra_idcli_orig][5] = $sum_valor_iva_5;
         $this->array_total_idcli[$quebra_idcli_orig][6] = $sum_excento;
         $this->array_total_idcli[$quebra_idcli_orig][7] = $sum_total;
         $this->array_total_idcli[$quebra_idcli_orig][8] = $sum_valoriva;
         $this->array_total_idcli[$quebra_idcli_orig][9] = $sum_adicional;
         $this->array_total_idcli[$quebra_idcli_orig][10] = 1;
         $this->array_total_idcli[$quebra_idcli_orig][11] = $quebra_idcli;
         $this->array_total_idcli[$quebra_idcli_orig][12] = $quebra_idcli_orig;
      }
      else
      {
         $this->array_total_idcli[$quebra_idcli_orig][0]++;
         $this->array_total_idcli[$quebra_idcli_orig][1] += $sum_subtotal;
         $this->array_total_idcli[$quebra_idcli_orig][2] += $sum_base_iva_19;
         $this->array_total_idcli[$quebra_idcli_orig][3] += $sum_valor_iva_19;
         $this->array_total_idcli[$quebra_idcli_orig][4] += $sum_base_iva_5;
         ...
         $this->array_total_idcli[$quebra_idcli_orig][8] += $sum_valoriva;
         $this->array_total_idcli[$quebra_idcli_orig][9] += $sum_adicional;
         $this->array_total_idcli[$quebra_idcli_orig][10]++;
      }
   }
...
$_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['contr_erro'] = 'off'; 
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'idcli');
     $campos_order = $this->Ini->Get_date_order_groupby("idcli", 'asc', $format, $campos_order);
...
$_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->subtotal, $this->base_iva_19, $this->valor_iva_19, $this->base_iva_5, $this->valor_iva_5, $this->excento, $this->total, $this->valoriva, $this->adicional, $this->idcli, $this->idcli_orig);
            }
   }
//
