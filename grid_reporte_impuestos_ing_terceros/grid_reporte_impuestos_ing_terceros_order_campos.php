<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_reporte_impuestos_ing_terceros']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_V2.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_reporte_impuestos_ing_terceros_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_reporte_impuestos_ing_terceros_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["anio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["anio"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["anio"] : "Año";
   $tab_ger_campos['periodo'] = "on";
   $tab_def_campos['periodo'] = "periodo";
   $tab_labels["periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["periodo"] : "Periodo";
   $tab_ger_campos['zona'] = "on";
   $tab_def_campos['zona'] = "zona";
   $tab_labels["zona"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["zona"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["zona"] : "Zona";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["fechaven"] : "Fecha";
   $tab_ger_campos['numero2'] = "on";
   $tab_def_campos['numero2'] = "numero2";
   $tab_labels["numero2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["numero2"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["numero2"] : "Número";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["idcli"] : "Cliente";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["total"] : "Total";
   $tab_ger_campos['numcontrato'] = "on";
   $tab_def_campos['numcontrato'] = "numcontrato";
   $tab_labels["numcontrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["numcontrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["numcontrato"] : "Código";
   $tab_ger_campos['base_iva_19'] = "on";
   $tab_def_campos['base_iva_19'] = "base_iva_19";
   $tab_labels["base_iva_19"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["base_iva_19"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["base_iva_19"] : "Base19%";
   $tab_ger_campos['valor_iva_19'] = "on";
   $tab_def_campos['valor_iva_19'] = "valor_iva_19";
   $tab_labels["valor_iva_19"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["valor_iva_19"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["valor_iva_19"] : "IVA19%";
   $tab_ger_campos['base_iva_5'] = "on";
   $tab_def_campos['base_iva_5'] = "base_iva_5";
   $tab_labels["base_iva_5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["base_iva_5"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["base_iva_5"] : "Base5%";
   $tab_ger_campos['valor_iva_5'] = "on";
   $tab_def_campos['valor_iva_5'] = "valor_iva_5";
   $tab_labels["valor_iva_5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["valor_iva_5"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["valor_iva_5"] : "IVA5%";
   $tab_ger_campos['excento'] = "on";
   $tab_def_campos['excento'] = "excento";
   $tab_labels["excento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["excento"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["excento"] : "Excento";
   $tab_ger_campos['ing_terceros'] = "on";
   $tab_def_campos['ing_terceros'] = "ing_terceros";
   $tab_labels["ing_terceros"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["ing_terceros"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["ing_terceros"] : "Ing Terceros";
   ...
   $tab_labels["a4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["a4"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['labels']["a4"] : "Ver";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_reporte_impuestos_ing_terceros_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_reporte_impuestos_ing_terceros']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
