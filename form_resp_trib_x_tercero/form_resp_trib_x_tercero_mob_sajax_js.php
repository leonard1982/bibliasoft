  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_resp_trib_x_tercero_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_resp_trib_x_tercero_mob_form();
	}
...
?>
  ...
  function do_ajax_form_resp_trib_x_tercero_mob_validate_id_resp_tr_ter()
  {
    ...
    x_ajax_form_resp_trib_x_tercero_mob_validate_id_resp_tr_ter(var_id_resp_tr_ter, var_script_case_init, do_ajax_form_resp_trib_x_tercero_mob_validate_id_resp_tr_ter_cb);
  } // do_ajax_form_resp_trib_x_tercero_mob_validate_id_resp_tr_ter

  function do_ajax_form_resp_trib_x_tercero_mob_validate_id_resp_tr_ter_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resp_trib_x_tercero_mob_validate_id_resp_tr_ter_cb

  // ---------- Validate id_tercero
  function do_ajax_form_resp_trib_x_tercero_mob_validate_id_tercero()
  {
    var nomeCampo_id_tercero = "id_tercero";
    var var_id_tercero = scAjaxGetFieldText(nomeCampo_id_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resp_trib_x_tercero_mob_validate_id_tercero(var_id_tercero, var_script_case_init, do_ajax_form_resp_trib_x_tercero_mob_validate_id_tercero_cb);
  } // do_ajax_form_resp_trib_x_tercero_mob_validate_id_tercero

  function do_ajax_form_resp_trib_x_tercero_mob_validate_id_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resp_trib_x_tercero_mob_validate_id_tercero_cb

  // ---------- Validate codigo_rt
  function do_ajax_form_resp_trib_x_tercero_mob_validate_codigo_rt()
  {
    var nomeCampo_codigo_rt = "codigo_rt";
    var var_codigo_rt = scAjaxGetFieldSelect(nomeCampo_codigo_rt);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resp_trib_x_tercero_mob_validate_codigo_rt(var_codigo_rt, var_script_case_init, do_ajax_form_resp_trib_x_tercero_mob_validate_codigo_rt_cb);
  } // do_ajax_form_resp_trib_x_tercero_mob_validate_codigo_rt

  function do_ajax_form_resp_trib_x_tercero_mob_validate_codigo_rt_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resp_trib_x_tercero_mob_validate_codigo_rt_cb

  // ---------- Validate decripcion_rt
  function do_ajax_form_resp_trib_x_tercero_mob_validate_decripcion_rt()
  {
    var nomeCampo_decripcion_rt = "decripcion_rt";
    var var_decripcion_rt = scAjaxGetFieldText(nomeCampo_decripcion_rt);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resp_trib_x_tercero_mob_validate_decripcion_rt(var_decripcion_rt, var_script_case_init, do_ajax_form_resp_trib_x_tercero_mob_validate_decripcion_rt_cb);
  } // do_ajax_form_resp_trib_x_tercero_mob_validate_decripcion_rt

  function do_ajax_form_resp_trib_x_tercero_mob_validate_decripcion_rt_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resp_trib_x_tercero_mob_validate_decripcion_rt_cb

  // ---------- Event onchange codigo_rt
  function do_ajax_form_resp_trib_x_tercero_mob_event_codigo_rt_onchange()
  {
    var var_codigo_rt = scAjaxGetFieldSelect("codigo_rt");
    var var_decripcion_rt = scAjaxGetFieldText("decripcion_rt");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_resp_trib_x_tercero_mob_event_codigo_rt_onchange(var_codigo_rt, var_decripcion_rt, var_script_case_init, do_ajax_form_resp_trib_x_tercero_mob_event_codigo_rt_onchange_cb);
  } // do_ajax_form_resp_trib_x_tercero_mob_event_codigo_rt_onchange

  function do_ajax_form_resp_trib_x_tercero_mob_event_codigo_rt_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "codigo_rt";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_resp_trib_x_tercero_mob_event_codigo_rt_onchange_cb_after_alert);
  } // do_ajax_form_resp_trib_x_tercero_mob_event_codigo_rt_onchange_cb
  function do_ajax_form_resp_trib_x_tercero_mob_event_codigo_rt_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_resp_trib_x_tercero_mob_event_codigo_rt_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_resp_trib_x_tercero_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_resp_trib_x_tercero_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_resp_trib_x_tercero_mob_submit_form(var_id_resp_tr_ter, var_id_tercero, var_codigo_rt, var_decripcion_rt, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_resp_trib_x_tercero_mob_submit_form_cb);
  } // do_ajax_form_resp_trib_x_tercero_mob_submit_form

  function do_ajax_form_resp_trib_x_tercero_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_resp_trib_x_tercero_mob_submit_form_cb_after_alert);
  } // do_ajax_form_resp_trib_x_tercero_mob_submit_form_cb
  function do_ajax_form_resp_trib_x_tercero_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_resp_trib_x_tercero_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_resp_trib_x_tercero_mob_navigate_form()
  {
    perform_ajax_form_resp_trib_x_tercero_mob_navigate_form();
  }

  function perform_ajax_form_resp_trib_x_tercero_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_resp_trib_x_tercero_mob_navigate_form(var_id_tercero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_resp_trib_x_tercero_mob_navigate_form_cb);
  } // do_ajax_form_resp_trib_x_tercero_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_resp_trib_x_tercero_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_resp_trib_x_tercero_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_resp_trib_x_tercero_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_resp_trib_x_tercero_mob_navigate_form_cb
  function do_ajax_form_resp_trib_x_tercero_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_resp_trib_x_tercero_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_resp_trib_x_tercero_mob_navigate_form_cb_after_alert
  function sc_hide_form_resp_trib_x_tercero_mob_form()
  {
