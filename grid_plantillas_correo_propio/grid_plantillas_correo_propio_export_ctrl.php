<?php
@session_start() ;
$_SESSION['scriptcase']['grid_plantillas_correo_propio']['sc_process_barr'] = true;
require_once('../grid_plantillas_correo_propio/index.php');
unset($_SESSION['scriptcase']['grid_plantillas_correo_propio']['sc_process_barr']);
$ExportCtrl = new grid_plantillas_correo_propio_export_control;
$ExportCtrl->Export_barr();

class grid_plantillas_correo_propio_export_control
{
