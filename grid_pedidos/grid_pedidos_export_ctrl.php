<?php
@session_start() ;
$_SESSION['scriptcase']['grid_pedidos']['sc_process_barr'] = true;
require_once('../grid_pedidos/index.php');
unset($_SESSION['scriptcase']['grid_pedidos']['sc_process_barr']);
$ExportCtrl = new grid_pedidos_export_control;
$ExportCtrl->Export_barr();

class grid_pedidos_export_control
{
