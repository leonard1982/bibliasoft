<?php
   ...
   $_SESSION['scriptcase']['grid_pedidos']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['grid_pedidos']['glo_nm_path_doc']        = "";
   $_SESSION['scriptcase']['grid_pedidos']['glo_con_conn_facilweb']         = "conn_facilweb";
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['grid_pedidos']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_pedidos']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
...
// 
      ...
      $this->path_cache  = $_SESSION['scriptcase']['grid_pedidos']['glo_nm_path_cache'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_pedidos']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_pedidos']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['grid_pedidos']['save_session']['data'] = '';
      } 
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['grid_pedidos']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['grid_pedidos']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['grid_pedidos']['actual_lang']) || $_SESSION['scriptcase']['grid_pedidos']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['grid_pedidos']['actual_lang'] = $this->str_lang;
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_pedidos']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_pedidos']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      ...
      $this->sc_lig_target["C_@scinf_imprimir_@scinf_pdfreport_pedidos_cti_proforma"] = '_blank';
      $Tmp_apl_lig = "grid_detallepedido";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/grid_detallepedido_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/grid_detallepedido_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/grid_detallepedido_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/grid_detallepedido_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["grid_detallepedido"] = 'S';
          }
      }
      $this->sc_lig_target["C_@scinf_detalle"] = '_blank';
      $this->sc_lig_target["C_@scinf_detalle_@scinf_grid_detallepedido"] = '_blank';
      $Tmp_apl_lig = "form_pagar_pedido";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/form_pagar_pedido_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/form_pagar_pedido_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/form_pagar_pedido_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/form_pagar_pedido_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["form_pagar_pedido"] = 'S';
          }
      }
      $this->sc_lig_target["C_@scinf_cobrar"] = '_self';
      $this->sc_lig_target["C_@scinf_cobrar_@scinf_form_pagar_pedido"] = '_self';
      $Tmp_apl_lig = "form_pedido_CW";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/form_pedido_CW_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/form_pedido_CW_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/form_pedido_CW_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/form_pedido_CW_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["form_pedido_CW"] = 'S';
          }
      }
      $this->sc_lig_target["C_@scinf_observaciones"] = '_self';
      $this->sc_lig_target["C_@scinf_observaciones_@scinf_form_pedido_CW"] = '_self';
      $Tmp_apl_lig = "form_pedidos_cambia_clienteyvendedor";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/form_pedidos_cambia_clienteyvendedor_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/form_pedidos_cambia_clienteyvendedor_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/form_pedidos_cambia_clienteyvendedor_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/form_pedidos_cambia_clienteyvendedor_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["form_pedidos_cambia_clienteyvendedor"] = 'S';
          }
      }
      $this->sc_lig_target["C_@scinf_cambiar_cliente"] = 'modal';
      $this->sc_lig_target["C_@scinf_cambiar_cliente_@scinf_form_pedidos_cambia_clienteyvendedor"] = 'modal';
      if ($_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_pedidos"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_pedidos"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      $this->link_form_pedidos_cambia_clienteyvendedor_edit =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_pedidos_cambia_clienteyvendedor') . "/" ; 
      ...
      $this->link_form_pedido_CW_edit =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_pedido_CW') . "/" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['grid_pedidos']['session_timeout']['redir']))
      {
...
// 
      ...
      $this->arr_buttons_usr['reneraracaja']['hint']             = "";
      $this->arr_buttons_usr['reneraracaja']['type']             = "button";
      $this->arr_buttons_usr['reneraracaja']['value']            = "Regenerar a Caja";
      $this->arr_buttons_usr['reneraracaja']['display']          = "only_text";
      $this->arr_buttons_usr['reneraracaja']['display_position'] = "text_right";
      $this->arr_buttons_usr['reneraracaja']['style']            = "default";
      $this->arr_buttons_usr['reneraracaja']['image']            = "";

      $this->arr_buttons_usr['Vender']['hint']             = "Venta sin llenar master";
      $this->arr_buttons_usr['Vender']['type']             = "button";
      $this->arr_buttons_usr['Vender']['value']            = "Venta Rápida";
      $this->arr_buttons_usr['Vender']['display']          = "only_text";
      $this->arr_buttons_usr['Vender']['display_position'] = "text_right";
      $this->arr_buttons_usr['Vender']['style']            = "default";
      $this->arr_buttons_usr['Vender']['image']            = "";

      $this->arr_buttons_usr['regenerarainventario']['hint']             = "Funciona sólo cuando está seleccionado modificar el inventario desde pedidos de venta";
      $this->arr_buttons_usr['regenerarainventario']['type']             = "button";
      $this->arr_buttons_usr['regenerarainventario']['value']            = "Regenerar a inventario";
      $this->arr_buttons_usr['regenerarainventario']['display']          = "only_text";
      $this->arr_buttons_usr['regenerarainventario']['display_position'] = "text_right";
      $this->arr_buttons_usr['regenerarainventario']['style']            = "default";
      $this->arr_buttons_usr['regenerarainventario']['image']            = "";
      ...
      if (isset($_SESSION['scriptcase']['grid_pedidos']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['grid_pedidos']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['grid_pedidos']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['grid_pedidos']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['grid_pedidos']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['grid_pedidos']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['initialize'])  
      { 
...
{
	alertify.confirm('Confirme', '¿Desea imprimir a ticket el pedido?', 
		...
		{ 
			$.post("../frm_pos_impresion_pedidos/index.php",{
				...
				if(r3==1)
				{
					...
					alertify.error('No ha configurado una impresora pos.');
				}
...
$_SESSION['scriptcase']['grid_pedidos']['contr_erro'] = 'off'; 
          $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['initialize'] = false;
      } 
      $this->conectDB();
      $this->conectExtra();
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_detallepedido']['ind_tree'] = 0;
      if (!isset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['emb_linha']))
      {
          $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['emb_linha'] = 0;
      }
   }
...
/*NM*/            $_SESSION['scriptcase']['grid_pedidos']['glo_nm_perfil'] = $NM_con_dest;
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['grid_pedidos']['glo_con_conn_facilweb'], $this->path_libs, "S", $this->path_conf);
          $this->nm_con_conn_facilweb['servidor']               = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_conn_facilweb['usuario']                = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_conn_facilweb['banco']                  = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_conn_facilweb['senha']                  = $_SESSION['scriptcase']['glo_senha'];
...
// 
      ...
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_pedidos']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_pedidos']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
class grid_pedidos_sub_css
{
   function __construct()
   {
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_detallepedido']['SC_herda_css'] = "S"; 
      $_SESSION['sc_session'][$script_case_init]['grid_detallepedido']['embutida'] = true;
      include_once ($this->Ini->link_grid_detallepedido_cons_emb);
      $this->grid_detallepedido = new grid_detallepedido_sub_css ;
      $_SESSION['sc_session'][$script_case_init]['grid_detallepedido']['embutida'] = false;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_pedidos']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_pedidos'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida'] || $Parms_form_pdf)
      { 
      ...
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_pedidos_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
       ...
       { 
           ...
           {
                $cadapar  = explode("?#?", $param);
                if ($cadapar[0] == "facturado")  
                { 
                    $cadapar[0] = str_replace("facturado", "SELECT sc_concat(res.prefijo,'/',fac.numfacven) 
FROM facturaven fac
left join resdian res on fac.resolucion=res.Idres
WHERE idfacven = {numfacven} 
ORDER BY fac.numfacven, fac.resolucion", $cadapar[0]);
                } 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_pedidos']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_pedidos']['label'] = "Lista de pedidos, cotizaciones y proformas";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_grid_pedidos_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              ...
              if (($_POST['opc'] == "igual" || $_POST['opc'] == "resumo") && isset($_POST['parm']) && ($_POST['parm'] == "reload" || $_POST['parm'] == "breload"))
              {
                  ...
                  $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['pivot_tabular']);
              }
      ...
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_event")
      {
          $this->Ini->Arr_result = array();
          ob_start();
          if ($_POST['nmgp_event'] == "idpedido_onClick")
          {
              $this->idpedido = NM_charset_decode($_POST['idpedido']);
              $this->asentada = NM_charset_decode($_POST['asentada']);
              $this->Ini->sc_page = filter_input(INPUT_POST, 'script_case_init', FILTER_SANITIZE_NUMBER_INT);
              $this->idpedido_onClick();
          }
          $Temp = ob_get_clean();
          if ($Temp !== false)
          {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_All_Groupby'] = array('_NM_SC_' => 'grid', 'prefijo' => 'all', 'vendedor' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Ind_Groupby'] == "prefijo")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['Labels_GB'][] = "PJ";
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Ind_Groupby'] == "vendedor")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['Labels_GB'][] = "Vendedor";
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Ind_Groupby'] == "_NM_SC_")
      {
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_display']['prefijo']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_display']['prefijo'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_order']['prefijo'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_display']['prefijo'][3] = array('label' => "Total Pedido(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_order']['prefijo'][] = 3;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_control']['prefijo']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_control']['prefijo'] = array(
               array(
                   'cmp_res' => "NM_Count",
               ...
               array(
                   'cmp_res' => "total",
                   'label' => "Total Pedido(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
                   'label_field' => "Total",
                   'options' => array(
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_display']['vendedor']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_display']['vendedor'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_order']['vendedor'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_display']['vendedor'][3] = array('label' => "Total Pedido(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_order']['vendedor'][] = 3;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_control']['vendedor']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_control']['vendedor'] = array(
               array(
                   'cmp_res' => "NM_Count",
                   'label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "grid_pedidos_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "grid_pedidos_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_grid_pedidos_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_grid_pedidos_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          ...
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['graf_disp']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['graf_disp']        = array('Bar', 'Pie', 'Line', 'Area');
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_tipo']        = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_larg']        = '800';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_alt']         = '600';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['graf_exibe_val']    = '0';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_barra_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_pyram_forma'] = 'S';
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['proc_pdf_vert'] = false;
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "numero2";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "asentada";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "facturado";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "idcli";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "cambiar_cliente";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "fechaven";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "total";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "vendedor";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "imprimir";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "pos";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "cobrar";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "creado_en_movil";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "disponible_en_movil";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "idpedido";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "numfacven";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "nremision";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "credito";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "fechavenc";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['field_order'][] = "observaciones";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['usr_cmp_sel']['idpedido'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['usr_cmp_sel']['numfacven'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['usr_cmp_sel']['nremision'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['usr_cmp_sel']['credito'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['usr_cmp_sel']['fechavenc'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['usr_cmp_sel']['observaciones'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['usr_cmp_sel'];
      } 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['use_pass_pdf'] = "";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_liga']['paginacao'];
          } 
      ...
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = "res_print";
          }
      } 
      ...
      { 
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['interativ_refresh'] = true;
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] == "interativ_search")
      { 
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['tot_geral']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = 'inicio';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_int_search'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['interativ_refresh'] = true;
      } 
...
//
      ...
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['use_pass_pdf']);
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['campos_busca']      = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['grid_pesq']         = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['Grid_search']       = "";
      ...
      { 
          if ($nm_call_php == "reneraracaja")
          { 
              $this->reneraracaja();
          } 
          if ($nm_call_php == "Vender")
          { 
              $this->Vender();
          } 
          if ($nm_call_php == "regenerarainventario")
          { 
              $this->regenerarainventario();
          } 
          $this->Db->Close(); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_pedidos.pdf";
            ...
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grid_pedidos_html_" . session_id() . ".html";
...
//----------------------------------->
      ...
      { 
          ...
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['word_name'] .= ".doc";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_pedidos/grid_pedidos_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_pedidos_res_xls.class.php"); 
          } 
          $this->xls  = new grid_pedidos_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_pedidos/grid_pedidos_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_pedidos_res_xml.class.php"); 
          } 
          $this->xml  = new grid_pedidos_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_pedidos/grid_pedidos_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_pedidos_json.class.php"); 
          } 
          $this->json  = new grid_pedidos_json();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_pedidos/grid_pedidos_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_pedidos_res_csv.class.php"); 
          } 
          $this->csv  = new grid_pedidos_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_pedidos/grid_pedidos_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_pedidos_res_rtf.class.php"); 
          } 
          $this->rtf  = new grid_pedidos_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      ...
      { 
          ...
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] = "grid";
              }
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ajax_nav'])
         {
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "ajax_detalhe")  
             {
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_pedidos_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
            ...
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['pdf_name'], 1);
                }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_pedidos_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_pedidos_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "grid_pedidos.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['sc_sql_btn_run']))
{
    foreach ($NM_index_reg as $Run_register)
    {
       if (!is_numeric($Run_register)) { continue; }
       $this->rs_grid->fields = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['sc_sql_btn_run'][$Run_register];
...
if(isset($this->vsimodificainv[0][0]))
{
	if($this->vsimodificainv[0][0]=="SI")
	{
      ...
      { 
          $nm_select = "select total,prefijo_ped,numpedido,str_replace (convert(char(10),fechaven,102), '.', '-') + ' ' + convert(char(8),fechaven,20),fechadocu from pedidos where idpedido='".$idfactura."'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_select = "select total,prefijo_ped,numpedido,convert(char(23),fechaven,121),fechadocu from pedidos where idpedido='".$idfactura."'"; 
      }
      else
      { 
          $nm_select = "select total,prefijo_ped,numpedido,fechaven,fechadocu from pedidos where idpedido='".$idfactura."'"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
;
			...
			if(isset($this->vdatospedido[0][0]))
			{
				...
				$vfec         = $this->vdatospedido[0][3];
				$vhor         = $this->vdatospedido[0][4];
				$vtimestamp   = $this->vdatospedido[0][4];
				$vhor         = date_create($vhor);
				$vhor         = date_format($vhor,'H:i:s');

				 
      $nm_select = "select idpedido from caja where idpedido='".$idfactura."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiNoExiste = array();
      $this->vsinoexiste = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiNoExiste[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsinoexiste[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiNoExiste = false;
          $this->vSiNoExiste_erro = $this->Db->ErrorMsg();
          $this->vsinoexiste = false;
          $this->vsinoexiste_erro = $this->Db->ErrorMsg();
      } 
;

				if(!isset($this->vsinoexiste[0][0]))
				{
					$vsql3 = "insert into caja set fecha='".$vfec."', detalle='PED. CONTADO', nota='VENTA', cantidad='".$vtotalpedido."', cierredia='NO',resolucion='".$vprefijo_ped."', documento='".$vnumpedido."', idpedido='".$idfactura."', hora='".$vhor."', creado='".$vtimestamp ."'";
    ...
    $this->Ini->sc_tem_trans_banco = true;
     ...
     $nm_select = $vsql3; 
      ...
      ;
					...
					echo "Documento regenerado a caja: ".$vnumpedido."<br>";
					if ($this->Ini->sc_tem_trans_banco)
{
    $this->Db->CommitTrans();
    $this->Ini->sc_tem_trans_banco = false;
		...
		{
			echo "Documento no asentado: ".$this->numpedido ."<br>";
		}
	}
	else
	{
		echo "No está configurado para generar registro de caja desde pedidos.<br>";
	}
}
$_SESSION['scriptcase']['grid_pedidos']['contr_erro'] = 'off'; 
    }  
...
$vIdped=0;
$hoy= date('d-m-Y');
$fechven= date("Y-m-d", strtotime($hoy));

 
      $nm_select = "select idpedido, numpedido from pedidos where tipo_doc='PV' order by idpedido Desc Limit 1"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $dt = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
...
if(isset($dt[0][0]))
	...
	$nup=$dt[0][1]+1;
     ...
     $nm_select = "insert pedidos set credito=2, fechaven='".$fechven."', fechavenc='".$fechven."', idcli=1, subtotal=0.00, 				 valoriva=0.00, total=0.00, facturado='NO', asentada=0, observaciones='00', dircliente=8, numpedido=$nup, prefijo_ped=4,tipo_doc='PV', usuario=$vUsuario"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
if ($this->Ini->sc_tem_trans_banco)
{
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('form_pedido_CW') . "/", $this->nm_location, "par_pedido?#?" . NM_encode_input($vIdped) . "?@?","_self", 440, 630);
 };
if (isset($this->sc_temp_gidtercero)) {$_SESSION['gidtercero'] = $this->sc_temp_gidtercero;}
$_SESSION['scriptcase']['grid_pedidos']['contr_erro'] = 'off'; 
?>
...
if(isset($this->vsimodificainv[0][0]))
{
	if($this->vsimodificainv[0][0]=="SI")
	{
      ...
      $nm_select = "select d.iddet,(select concat(p.codigobar,' -- ',p.nompro) from productos p where p.idprod=d.idpro) as producto,(select r.prefijo from resdian r where r.Idres='".$this->prefijo_ped  ."') as prefijo from detallepedido d where d.idpedid='".$this->idpedido  ."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vIddet = array();
      $this->viddet = array();
     if ($this->prefijo_ped !== "" && $this->idpedido !== "")
     { 
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
...
;
			...
			if(isset($this->viddet[0][0]))
			{
				...
				for($i=0;$i<count($this->viddet );$i++)
				{
					$viddettmp        = $this->viddet[$i][0];
					$vnombre_producto = $this->viddet[$i][1];
					$vprefijotmp      = $this->viddet[$i][2];
						
					 
      $nm_select = "select iddetalle,nufacvta from inventario where iddetalle='".$this->viddet[$i][0] ."' and idped='".$this->idpedido  ."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExisteEnInventario = array();
      $this->vsiexisteeninventario = array();
     if ($this->idpedido !== "")
     { 
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExisteEnInventario[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexisteeninventario[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExisteEnInventario = false;
          $this->vSiExisteEnInventario_erro = $this->Db->ErrorMsg();
          $this->vsiexisteeninventario = false;
          $this->vsiexisteeninventario_erro = $this->Db->ErrorMsg();
      } 
     } 
;
					...
					if(isset($this->vsiexisteeninventario[0][0]))
					{
						
						echo "El inventario del producto: ".$vnombre_producto." del documento: ".$vprefijotmp." ".$this->numpedido ." ya existe.<br><br>";
					
					}
					else
					{
						$this->fGestionaStock($viddettmp,2);
						echo "El inventario del producto: ".$vnombre_producto." del documento: ".$vprefijotmp." ".$this->numpedido ." fué regenerado.<br><br>";					
					}
				}
			}
		}
	...
	{
		echo "No está configurado para generar registro de inventario desde pedidos.<br>";
	}
}
$_SESSION['scriptcase']['grid_pedidos']['contr_erro'] = 'off'; 
    }  
...
?>
  ...
  function close_emb()
  {
      ...
      if(isset($this->Ini->nm_db_conn_facilweb)){ 
        $this->Ini->nm_db_conn_facilweb->Close(); 
      }
  }
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_interativ'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_interativ'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_interativ'] . ")"; 
              }
          }
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_interativ'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_interativ'] . ")";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['fast_search'][0] = $in_fields;
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      if (isset($Nm_datas[$campo_join]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_sep_date']))
      {
   ...
   function SC_proc_interativ_search($Parms)
   {
       ...
       $cmd_sql = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['int_search_sql'][$tmp[0]];
       $vls     = "";
       $bol_numeric = false;
       if ($tmp[3] == "clear_interativ_all") {
           ...
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['interativ_search'][$tmp[0]]);
           if ($tmp[3] != "clear_interativ")
           {
               ...
               if ($tmp[2] == "dt" || $tmp[2] == "dh" || $tmp[2] == "hh")
               {
                   ...
                   {
                       $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_sep_date'];
                       $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['SC_sep_date1'];
                   }
               }
           }
       }
       if (!empty($vls))
       {
           $prep = "";
           $bol_has_empty = false;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['interativ_search'][$tmp[0]]['tp_obj'] = $tmp[2];
           foreach ($vls as $cada_val)
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['interativ_search'][$tmp[0]]['lab'][$tmp[1]][] = $descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['interativ_search'][$tmp[0]]['val_sel'][] = $cada_val;
               if ($cada_val == "")
               {
                   $bol_has_empty = true;
               }
           ...
           if ($prep == "" && $bol_numeric)
           {
               if (in_array(strtolower($this->nm_tpbanco), $this->nm_bases_postgres))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " is null";
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " = '' or " . $cmd_sql . " is null";
               }
           }
           elseif ($prep == "" && $delim != "")
           {
           ...
           elseif ( $tmp[2] == "bw")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " between " . $delim . $range_bw[0] .  $delim1 . " and " . $delim . $range_bw[1] .  $delim1 . $str_add_null_or;
           }
           elseif ( $tmp[2] == "dt")
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " IN (" . $prep . ")" . $str_add_null_or;
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " IN (" . $prep . ")" . $str_add_null_or;
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_fast'])) 
      {
          if (!empty($tmp_cmd)) 
          {
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_fast'] . ")";
          }
          else 
          {
              $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_fast'] . ")";
          }
      }
      ...
      { 
          if (empty($tmp_where)) 
          { 
              $tmp_cmd = "where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_resumo']; 
          } 
          else
          { 
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_resumo'] . ")"; 
          } 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_sem_interativ']  = $tmp_cmd;
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['interativ_search'])) 
      {
          $prim = true;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['interativ_search'] as $cmp => $val) 
          {
              if (!$prim)
              {
                 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_interativ'] .= " AND ";
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_interativ'] .= "(" . $val['val'] . ")";
              $prim = false;
          }
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq_interativ'])) 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['where_pesq'] = $tmp_cmd;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['refresh_interativ'] = (isset($tmp[5])) ? $tmp[5] : "S";
  ...
  function idpedido_onClick()
  {
    $Old_idpedido = $this->idpedido;
    $Old_asentada = $this->asentada;
  ...
  if($this->asentada ==0)
	...
	$ped=$this->idpedido ;
     ...
     $nm_select = "UPDATE pedidos set asentada=1 where idpedido=$ped"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
;
	...
	{
	echo "PEDIDO YA ESTÁ ASENTADO";
	}
$_SESSION['scriptcase']['grid_pedidos']['contr_erro'] = 'off'; 
    $this->Ini->Arr_result['setValue']     = array();
    $this->Ini->Arr_result['fieldDisplay'] = array();
    if ($Old_idpedido != $this->idpedido)
    {
        $this->Ini->Arr_result['setValue'][] = array('field' => 'idpedido_Hidden', 'value' => NM_charset_to_utf8($this->idpedido));
        $this->Format_Ajax_return("idpedido");
        $this->Ini->Arr_result['setValue'][] = array('field' => 'idpedido', 'value' => NM_charset_to_utf8($this->idpedido));
    }
    if ($Old_asentada != $this->asentada)
    {
        $this->Ini->Arr_result['setValue'][] = array('field' => 'asentada_Hidden', 'value' => NM_charset_to_utf8($this->asentada));
        $this->Format_Ajax_return("asentada");
        $this->Ini->Arr_result['setValue'][] = array('field' => 'asentada', 'value' => NM_charset_to_utf8($this->asentada));
    }
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>Lista de pedidos, cotizaciones y proformas :: Doc</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 <META http-equiv="Expires" content="Fri, Jan 01 1900 00:00:00 GMT"/>
 <META http-equiv="Last-Modified" content="<?php echo gmdate("D, d M Y H:i:s"); ?> GMT"/>
 <META http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"/>
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_pedidos']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['grid_pedidos']['sc_process_barr'])) {
       return;
   }
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_pedidos']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_pedidos']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "grid_pedidos") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['grid_pedidos']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['grid_pedidos']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['grid_pedidos']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
               $_SESSION['scriptcase']['grid_pedidos']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['grid_pedidos']['master_pai']) && $_SESSION['sc_session'][$init_filho]['grid_pedidos']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['master_pai']))
   {
       ...
       $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['grid_pedidos']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['grid_pedidos']['embutida_form_full'] : false;
   ...
   elseif (isset($script_case_init))
   {
       ...
       unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_form_full']);
   ...
   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   ...
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['contr_total_geral'] = "NAO";
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['mostra_edit'] = "S";
       }
...
// 
       ...
       if (isset($nmgp_parms_ret)) 
       {
           ...
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       ...
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['grid_pedidos']['embutida_form_full'])
           {
...
//
   ...
   function grid_pedidos_pack_protect_string($sString)
   {
    ...
    function grid_pedidos_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
