...
ORDER BY fac.numfacven, fac.resolucion", $cadapar[0]);
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['cfg_graf']['graf_tipo']))
      {
