<?php
@session_start() ;
$_SESSION['scriptcase']['grid_inve_final_resumen']['sc_process_barr'] = true;
require_once('../grid_inve_final_resumen/index.php');
unset($_SESSION['scriptcase']['grid_inve_final_resumen']['sc_process_barr']);
$ExportCtrl = new grid_inve_final_resumen_export_control;
$ExportCtrl->Export_barr();

class grid_inve_final_resumen_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_inve_final_resumen']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_inve_final_resumen']['glo_nm_path_imag_temp'];
...
<HEAD>
 <TITLE>Resumen Inventario al: </TITLE>
