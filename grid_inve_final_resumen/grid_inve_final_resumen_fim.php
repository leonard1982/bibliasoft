...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_inve_final_resumen"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_inve_final_resumen"]);
   }
