...
<?php
   ...
   $Ord_Cmp = new grid_inve_final_resumen_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_inve_final_resumen_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["idpro"] : "Artículo o Producto";
   ...
   $tab_labels["presentacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["presentacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["presentacion"] : "Presentación";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["cantidad"] : "Existencia";
   $tab_ger_campos['costo'] = "on";
   $tab_def_campos['costo'] = "costo";
   $tab_labels["costo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["costo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["costo"] : "Costo promedio";
   $tab_ger_campos['valorparcial'] = "on";
   $tab_def_campos['valorparcial'] = "valorparcial";
   $tab_labels["valorparcial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["valorparcial"])) ? $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["valorparcial"] : "Valorparcial";
   $tab_ger_campos['costoultimo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['costoultimo'] = "costoultimo";
   }
   else
   {
       $tab_def_campos['costoultimo'] = "";
   }
   $tab_labels["costoultimo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["costoultimo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["costoultimo"] : "Costo según Ultima compra";
   $tab_ger_campos['valor_par_ultimo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['valor_par_ultimo'] = "Valor_par_ultimo";
   }
   else
   {
       $tab_def_campos['valor_par_ultimo'] = "";
   }
   $tab_labels["valor_par_ultimo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["valor_par_ultimo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['labels']["valor_par_ultimo"] : "Valor del Stock";
   $tab_ger_campos['presentacion'] = "none";
   $tab_ger_campos['costoultimo'] = "none";
   $tab_ger_campos['valor_par_ultimo'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
   $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['graf_lab'] = "";
?>
    <script language="javascript"> 
<?php
   if (!$embbed)
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_inve_final_resumen_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_inve_final_resumen']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
