<?php
@session_start() ;
$_SESSION['scriptcase']['grid_contabilidad_detalle']['sc_process_barr'] = true;
require_once('../grid_contabilidad_detalle/index.php');
unset($_SESSION['scriptcase']['grid_contabilidad_detalle']['sc_process_barr']);
$ExportCtrl = new grid_contabilidad_detalle_export_control;
$ExportCtrl->Export_barr();

class grid_contabilidad_detalle_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_contabilidad_detalle']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_contabilidad_detalle']['glo_nm_path_imag_temp'];
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> contabilidad_detalle</TITLE>
