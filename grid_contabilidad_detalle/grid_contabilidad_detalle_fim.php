...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_contabilidad_detalle"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_contabilidad_detalle"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_contabilidad_detalle'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_contabilidad_detalle']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_contabilidad_detalle']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contabilidad_detalle']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_contabilidad_detalle']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contabilidad_detalle']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_contabilidad_detalle']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_contabilidad_detalle']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_contabilidad_detalle</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_contabilidad_detalle']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_contabilidad_detalle']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_contabilidad_detalle' || $achou)
          {
