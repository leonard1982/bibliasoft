...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_contabilidad_detalle"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_contabilidad_detalle"]);
   }
