...
<?php
   ...
   $Ord_Cmp = new grid_contabilidad_detalle_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_contabilidad_detalle_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['id_puc_aux'] = "id_puc_aux";
   }
   else
   {
       $tab_def_campos['id_puc_aux'] = "(id_puc)";
   }
   $tab_labels["id_puc_aux"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['labels']["id_puc_aux"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['labels']["id_puc_aux"] : "Cuenta";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['labels']["valor"] : "Valor";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['id_tercero'] = "on";
   $tab_def_campos['id_tercero'] = "id_tercero";
   $tab_labels["id_tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['labels']["id_tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['labels']["id_tercero"] : "Tercero";
   $tab_ger_campos['notas'] = "on";
   $tab_def_campos['notas'] = "notas";
   $tab_labels["notas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['labels']["notas"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['labels']["notas"] : "Notas";
   $tab_ger_campos['ndocumento'] = "on";
   $tab_def_campos['ndocumento'] = "ndocumento";
   $tab_labels["ndocumento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['labels']["ndocumento"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['labels']["ndocumento"] : "N° documento";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_contabilidad_detalle_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_contabilidad_detalle']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
