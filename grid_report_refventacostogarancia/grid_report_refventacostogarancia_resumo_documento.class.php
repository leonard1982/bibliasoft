...
class grid_report_refventacostogarancia_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_f_idfacven = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['arr_total']['f_idfacven'];
      }
      else
      {
          $this->array_total_f_idfacven = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['arr_total']['f_idfacven'] = $this->array_total_f_idfacven;
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_f_idfacven = "f.idfacven";
       }
       else
       {
       $Lab_f_idfacven = "Documento";
       }
       $this->comp_field = array(
           $Lab_f_idfacven,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['labels']['f_idfacven'] = $Lab_f_idfacven; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['documento']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['documento'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['documento'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['documento'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['documento'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['documento'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['documento'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['documento'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['documento'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['documento'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_f_idfacven as $i_f_idfacven => $d_f_idfacven) {
           if (!in_array($i_f_idfacven, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_f_idfacven[7] ] = $d_f_idfacven[6];
               $this->comp_label[0][ $d_f_idfacven[7] ] = $d_f_idfacven[6];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_f_idfacven => $l_f_idfacven) {
           if (isset($this->array_total_f_idfacven[$i_f_idfacven])) {
               $this->comp_group[$i_f_idfacven] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_f_idfacven;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_f_idfacven)),
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      ksort($this->array_total_f_idfacven);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_valor_parcial, $sum_costop, $sum_gananciap, $quebra_f_idfacven, $quebra_f_idfacven_orig)
   {
      //----- Documento
      if (!isset($this->array_total_f_idfacven[$quebra_f_idfacven_orig]))
      {
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][0] = 1;
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][1] = $sum_cantidad;
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][2] = $sum_valor_parcial;
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][3] = $sum_costop;
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][4] = $sum_gananciap;
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][5] = 1;
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][6] = $quebra_f_idfacven;
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][7] = $quebra_f_idfacven_orig;
      }
      else
      {
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][0]++;
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][1] += $sum_cantidad;
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][2] += $sum_valor_parcial;
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][3] += $sum_costop;
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][4] += $sum_gananciap;
         $this->array_total_f_idfacven[$quebra_f_idfacven_orig][5]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'f_idfacven');
     $campos_order = $this->Ini->Get_date_order_groupby("f.idfacven", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->f_idfacven_orig = $this->f_idfacven;
            $this->f_idfacven = $this->look_f_idfacven ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->valor_parcial, $this->costop, $this->gananciap, $this->f_idfacven, $this->f_idfacven_orig);
            }
   }
//
