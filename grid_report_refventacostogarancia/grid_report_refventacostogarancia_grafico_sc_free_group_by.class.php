...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $prep_label    = array();
      $prep_label['referencia'] = "Referencia";
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
