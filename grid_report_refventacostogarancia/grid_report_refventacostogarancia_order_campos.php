...
<?php
   ...
   $Ord_Cmp = new grid_report_refventacostogarancia_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_report_refventacostogarancia_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['f_idfacven'] = "f_idfacven";
       $tab_def_seq[110] = "f_idfacven";
   }
   else
   {
       $tab_def_campos['f_idfacven'] = "f.idfacven";
       $tab_def_seq[110] = "f.idfacven";
   }
   $tab_labels["f_idfacven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["f_idfacven"])) ? $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["f_idfacven"] : "Documento";
   $tab_ger_campos['fecha_inicial'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fecha_inicial'] = "fecha_inicial";
       $tab_def_seq[70] = "fecha_inicial";
   }
   else
   {
       $tab_def_campos['fecha_inicial'] = "f.fechaven";
       $tab_def_seq[70] = "f.fechaven";
   }
   $tab_labels["fecha_inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["fecha_inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["fecha_inicial"] : "Fecha";
   $tab_ger_campos['devolucion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['devolucion'] = "devolucion";
       $tab_def_seq[160] = "devolucion";
   }
   else
   {
       $tab_def_campos['devolucion'] = "if(d.cantidad<0,'S','N')";
       $tab_def_seq[160] = "if(d.cantidad<0,'S','N')";
   }
   $tab_labels["devolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["devolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["devolucion"] : "DV";
   $tab_ger_campos['referencia'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['referencia'] = "referencia";
       $tab_def_seq[10] = "referencia";
   }
   else
   {
       $tab_def_campos['referencia'] = "p.codigobar";
       $tab_def_seq[10] = "p.codigobar";
   }
   $tab_labels["referencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["referencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["referencia"] : "Referencia";
   $tab_ger_campos['descripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['descripcion'] = "descripcion";
       $tab_def_seq[60] = "descripcion";
   }
   else
   {
       $tab_def_campos['descripcion'] = "p.nompro";
       $tab_def_seq[60] = "p.nompro";
   }
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["descripcion"] : "Descripcion";
   $tab_ger_campos['cantidad'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cantidad'] = "cantidad";
       $tab_def_seq[20] = "cantidad";
   }
   else
   {
       $tab_def_campos['cantidad'] = "d.cantidad";
       $tab_def_seq[20] = "d.cantidad";
   }
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['precioventa'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['precioventa'] = "precioventa";
       $tab_def_seq[30] = "precioventa";
   }
   else
   {
       $tab_def_campos['precioventa'] = "((d.valorpar-d.iva)/d.cantidad)";
       $tab_def_seq[30] = "((d.valorpar-d.iva)/d.cantidad)";
   }
   $tab_labels["precioventa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["precioventa"])) ? $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["precioventa"] : "Base/U";
   $tab_ger_campos['valor_parcial'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['valor_parcial'] = "valor_parcial";
       $tab_def_seq[130] = "valor_parcial";
   }
   else
   {
       $tab_def_campos['valor_parcial'] = "(d.cantidad * ((d.valorpar-d.iva)/d.cantidad))";
       $tab_def_seq[130] = "(d.cantidad * ((d.valorpar-d.iva)/d.cantidad))";
   }
   $tab_labels["valor_parcial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["valor_parcial"])) ? $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["valor_parcial"] : "Total";
   $tab_ger_campos['costop'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['costop'] = "costop";
       $tab_def_seq[230] = "costop";
   }
   else
   {
       $tab_def_campos['costop'] = "(d.cantidad * p.costomen)";
       $tab_def_seq[230] = "(d.cantidad * p.costomen)";
   }
   $tab_labels["costop"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["costop"])) ? $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["costop"] : "Costo";
   $tab_ger_campos['gananciap'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gananciap'] = "gananciap";
       $tab_def_seq[240] = "gananciap";
   }
   else
   {
       $tab_def_campos['gananciap'] = "(d.cantidad * (((d.valorpar-d.iva)/d.cantidad)-p.costomen))";
       $tab_def_seq[240] = "(d.cantidad * (((d.valorpar-d.iva)/d.cantidad)-p.costomen))";
   }
   $tab_labels["gananciap"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["gananciap"])) ? $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["gananciap"] : "Ganancia";
   $tab_ger_campos['b_codigo_banco'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_codigo_banco'] = "b_codigo_banco";
       $tab_def_seq[260] = "b_codigo_banco";
   }
   else
   {
       $tab_def_campos['b_codigo_banco'] = "b.codigo_banco";
       $tab_def_seq[260] = "b.codigo_banco";
   }
   $tab_labels["b_codigo_banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["b_codigo_banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['labels']["b_codigo_banco"] : "Banco";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_select'] = array();
   }
   ...
   elseif ($fsel_ok == "regra" && !empty($sel_regra) && !$this->restore)
   {
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
function Sel_processa_out_regr($sel_regra)
{
   ...
   foreach ($regras_ord as $cada_regra)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_select'][$tab_def_seq[$seq]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_report_refventacostogarancia_order_campos.php",
    data: {
   ...
   <table class="<?php echo ($embbed)? '':'scGridTabela'; ?>" style="border-width: 0; border-collapse: collapse; width:100%;" cellspacing=0 cellpadding=0>
    ...
    <td colspan=5>
     <select  name="sel_regra" id="id_sel_regra_sel_ord" size=1 class="scAppDivToolbarInput">
       ...
       <OPTION value="+;60;descripcion"></OPTION>
       <OPTION value="-;50;ganancia"></OPTION>
    </select>
<?php
   if (!$embbed)
   {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_report_refventacostogarancia']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
