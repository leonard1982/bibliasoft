...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['contr_label_graf']['fecha_inicial']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['contr_label_graf']['fecha_inicial']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['contr_label_graf']['fecha_inicial'];
      }
   }
