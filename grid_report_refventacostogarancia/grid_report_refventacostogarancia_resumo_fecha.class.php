...
class grid_report_refventacostogarancia_resumo
{
   ...
   var $sum_fecha_inicial_cantidad;
   var $sum_fecha_inicial_valor_parcial;
   var $sum_fecha_inicial_costop;
   var $sum_fecha_inicial_gananciap;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_fecha_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['arr_total']['fecha_inicial'];
      }
      else
      {
          $this->array_total_fecha_inicial = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['arr_total']['fecha_inicial'] = $this->array_total_fecha_inicial;
   ...
   function completeMatrix()
   {
       ...
       {
       $Lab_fecha_inicial = "Fecha";
       }
       $this->comp_field = array(
           $Lab_fecha_inicial,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['labels']['fecha_inicial'] = $Lab_fecha_inicial; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['fecha']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['fecha'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['fecha'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['fecha'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['fecha'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['fecha'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['fecha'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['fecha'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['fecha'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['fecha'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_fecha_inicial as $i_fecha_inicial => $d_fecha_inicial) {
           if (!in_array($i_fecha_inicial, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_fecha_inicial[7] ] = $d_fecha_inicial[6];
               $this->comp_label[0][ $d_fecha_inicial[7] ] = $d_fecha_inicial[6];
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_valor_parcial, $sum_costop, $sum_gananciap, $quebra_fecha_inicial, $quebra_fecha_inicial_orig)
   {
      ...
      if (!isset($this->array_total_fecha_inicial[$quebra_fecha_inicial_orig]))
      {
         ...
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][1] = $sum_cantidad;
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][2] = $sum_valor_parcial;
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][3] = $sum_costop;
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][4] = $sum_gananciap;
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][5] = 1;
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][6] = $quebra_fecha_inicial;
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][7] = $quebra_fecha_inicial_orig;
      }
      else
      {
         ...
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][3] += $sum_costop;
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][4] += $sum_gananciap;
         $this->array_total_fecha_inicial[$quebra_fecha_inicial_orig][5]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'fecha_inicial');
     $campos_order = $this->Ini->Get_date_order_groupby("f.fechaven", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $Format_tst = $this->Ini->Get_Gb_date_format('fecha', 'fecha_inicial');
            $Prefix_dat = $this->Ini->Get_Gb_prefix_date_format('fecha', 'fecha_inicial');
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->valor_parcial, $this->costop, $this->gananciap, $this->fecha_inicial, $this->fecha_inicial_orig);
            }
   }
//
