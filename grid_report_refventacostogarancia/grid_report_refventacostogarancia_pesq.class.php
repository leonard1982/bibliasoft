 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_referencia_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['referencia'])) ? $this->New_label['referencia'] : "Referencia"; ?></TD>
      
      <INPUT type="hidden" id="SC_referencia_cond" name="referencia_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_referencia" <?php echo $str_hide_referencia?> valign="top">
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-descripcion" id="id_ac_descripcion" name="descripcion_autocomp"><?php if ('' !=  $descripcion) { ?><option value="<?php echo $descripcion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_fecha_inicial_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fecha_inicial'])) ? $this->New_label['fecha_inicial'] : "Fecha desde"; ?></TD>
...
?>
      ...
      <TD id='SC_fecha_final_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fecha_final'])) ? $this->New_label['fecha_final'] : "Fecha hasta"; ?></TD>
...
?>
      ...
      <TD id='SC_f_tipo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['f_tipo'])) ? $this->New_label['f_tipo'] : "Tipo"; ?></TD>
      
      <INPUT type="hidden" id="SC_f_tipo_cond" name="f_tipo_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_f_tipo" <?php echo $str_hide_f_tipo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
 ...
 <OPTION value="RS##@@Remisión"<?php if ($f_tipo == "RS") { echo " selected" ;} ?>>Remisión</option>
      ...
      <TD id='SC_devolucion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['devolucion'])) ? $this->New_label['devolucion'] : "Quitar devoluciones"; ?></TD>
      
      <INPUT type="hidden" id="SC_devolucion_cond" name="devolucion_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_devolucion" <?php echo $str_hide_devolucion?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_devolucion" name="devolucion[]" value="N##@@"  <?php if (in_array("N", $devolucion))  { echo " checked" ;} ?>></TD>
      ...
      <TD id='SC_numfac_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['numfac'])) ? $this->New_label['numfac'] : "Número Factura"; ?></TD>
...
?>
<INPUT  type="text" id="SC_numfac" name="numfac" value="<?php echo NM_encode_input($numfac) ?>"  size=50 alt="{datatype: 'text', maxLength: 90, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
