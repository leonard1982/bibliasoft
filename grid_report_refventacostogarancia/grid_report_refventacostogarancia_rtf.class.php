...
class grid_report_refventacostogarancia_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_report_refventacostogarancia.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['rtf_name']);
      }
   ...
   function NM_export_f_idfacven()
   {
         ...
         $this->look_f_idfacven = str_replace('<', '&lt;', $this->look_f_idfacven);
         $this->look_f_idfacven = str_replace('>', '&gt;', $this->look_f_idfacven);
         $this->Texto_tag .= "<td>" . $this->look_f_idfacven . "</td>\r\n";
   }
   //----- fecha_inicial
   ...
   function NM_export_valor_parcial()
   {
         ...
         $this->valor_parcial = str_replace('<', '&lt;', $this->valor_parcial);
         $this->valor_parcial = str_replace('>', '&gt;', $this->valor_parcial);
         $this->Texto_tag .= "<td>" . $this->valor_parcial . "</td>\r\n";
   }
   //----- costop
   ...
   function NM_export_gananciap()
   {
         ...
         $this->gananciap = str_replace('<', '&lt;', $this->gananciap);
         $this->gananciap = str_replace('>', '&gt;', $this->gananciap);
         $this->Texto_tag .= "<td>" . $this->gananciap . "</td>\r\n";
   }
   //----- b_codigo_banco
   function NM_export_b_codigo_banco()
   {
         ...
         $this->b_codigo_banco = str_replace('<', '&lt;', $this->b_codigo_banco);
         $this->b_codigo_banco = str_replace('>', '&gt;', $this->b_codigo_banco);
         $this->Texto_tag .= "<td>" . $this->b_codigo_banco . "</td>\r\n";
   }
   //----- f_pagada
   function NM_export_f_pagada()
   {
         ...
         $this->f_pagada = str_replace('<', '&lt;', $this->f_pagada);
         $this->f_pagada = str_replace('>', '&gt;', $this->f_pagada);
         $this->Texto_tag .= "<td>" . $this->f_pagada . "</td>\r\n";
   }
   //----- remision
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Referencia Venta/Costo/Ganancia :: RTF</TITLE>
