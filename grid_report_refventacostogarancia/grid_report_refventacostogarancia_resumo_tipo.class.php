...
class grid_report_refventacostogarancia_resumo
{
   ...
   var $sum_costop;
   var $sum_gananciap;
   var $sc_proc_quebra_f_tipo;
   var $count_f_tipo;
   var $sum_f_tipo_cantidad;
   var $sum_f_tipo_valor_parcial;
   var $sum_f_tipo_costop;
   var $sum_f_tipo_gananciap;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_f_tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['arr_total']['f_tipo'];
      }
      else
      {
          $this->array_total_f_tipo = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['arr_total']['f_tipo'] = $this->array_total_f_tipo;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['labels']['f_tipo'] = $Lab_f_tipo; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['tipo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['tipo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['tipo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['tipo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['tipo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['tipo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['tipo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['tipo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['tipo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['tipo'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_f_tipo as $i_f_tipo => $d_f_tipo) {
           if (!in_array($i_f_tipo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_f_tipo[7] ] = $d_f_tipo[6];
               $this->comp_label[0][ $d_f_tipo[7] ] = $d_f_tipo[6];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_f_tipo => $l_f_tipo) {
           if (isset($this->array_total_f_tipo[$i_f_tipo])) {
               $this->comp_group[$i_f_tipo] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_f_tipo;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_f_tipo)),
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_valor_parcial, $sum_costop, $sum_gananciap, $quebra_f_tipo, $quebra_f_tipo_orig)
   {
      //----- Tipo
      if (!isset($this->array_total_f_tipo[$quebra_f_tipo_orig]))
      {
         $this->array_total_f_tipo[$quebra_f_tipo_orig][0] = 1;
         $this->array_total_f_tipo[$quebra_f_tipo_orig][1] = $sum_cantidad;
         $this->array_total_f_tipo[$quebra_f_tipo_orig][2] = $sum_valor_parcial;
         $this->array_total_f_tipo[$quebra_f_tipo_orig][3] = $sum_costop;
         $this->array_total_f_tipo[$quebra_f_tipo_orig][4] = $sum_gananciap;
         $this->array_total_f_tipo[$quebra_f_tipo_orig][5] = 1;
         $this->array_total_f_tipo[$quebra_f_tipo_orig][6] = $quebra_f_tipo;
         $this->array_total_f_tipo[$quebra_f_tipo_orig][7] = $quebra_f_tipo_orig;
      }
      else
      {
         $this->array_total_f_tipo[$quebra_f_tipo_orig][0]++;
         $this->array_total_f_tipo[$quebra_f_tipo_orig][1] += $sum_cantidad;
         $this->array_total_f_tipo[$quebra_f_tipo_orig][2] += $sum_valor_parcial;
         $this->array_total_f_tipo[$quebra_f_tipo_orig][3] += $sum_costop;
         $this->array_total_f_tipo[$quebra_f_tipo_orig][4] += $sum_gananciap;
         $this->array_total_f_tipo[$quebra_f_tipo_orig][5]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'f_tipo');
     $campos_order = $this->Ini->Get_date_order_groupby("f.tipo", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->f_tipo_orig = $this->f_tipo;
            $this->f_idfacven = $this->look_f_idfacven ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->valor_parcial, $this->costop, $this->gananciap, $this->f_tipo, $this->f_tipo_orig);
            }
   }
//
