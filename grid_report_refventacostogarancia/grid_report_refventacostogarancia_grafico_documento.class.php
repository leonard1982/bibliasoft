...
<?php
   ...
   function inicializa_vars()
   {
      ...
      //---- 
      $this->array_total_f_idfacven = array();
      //---- 
      ...
      //---- Label
      $this->label    = array();
      $this->label[0] = "Documento";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['contr_label_graf']['f_idfacven']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['contr_label_graf']['f_idfacven']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['contr_label_graf']['f_idfacven'];
      }
   }
