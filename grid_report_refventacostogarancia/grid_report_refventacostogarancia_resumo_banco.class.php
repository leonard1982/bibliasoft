...
class grid_report_refventacostogarancia_resumo
{
   ...
   var $array_total_b_codigo_banco;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_b_codigo_banco = array();
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_b_codigo_banco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['arr_total']['b_codigo_banco'];
      }
      else
      {
          $this->array_total_b_codigo_banco = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['arr_total']['b_codigo_banco'] = $this->array_total_b_codigo_banco;
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_b_codigo_banco = "b.codigo_banco";
       }
       else
       {
       $Lab_b_codigo_banco = "Banco";
       }
       $this->comp_field = array(
           $Lab_b_codigo_banco,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['labels']['b_codigo_banco'] = $Lab_b_codigo_banco; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['banco']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['banco'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['banco'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['banco'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['banco'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['banco'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['banco'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['banco'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['banco'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['banco'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_b_codigo_banco as $i_b_codigo_banco => $d_b_codigo_banco) {
           if (!in_array($i_b_codigo_banco, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_b_codigo_banco[7] ] = $d_b_codigo_banco[6];
               $this->comp_label[0][ $d_b_codigo_banco[7] ] = $d_b_codigo_banco[6];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'b_codigo_banco', 'prot' => '@aspass@'),
       );
       ...
       //-----
       foreach ($this->comp_label[0] as $i_b_codigo_banco => $l_b_codigo_banco) {
           if (isset($this->array_total_b_codigo_banco[$i_b_codigo_banco])) {
               $this->comp_group[$i_b_codigo_banco] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_b_codigo_banco;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'b.codigo_banco',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_b_codigo_banco)),
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      ksort($this->array_total_b_codigo_banco);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_valor_parcial, $sum_costop, $sum_gananciap, $quebra_b_codigo_banco, $quebra_b_codigo_banco_orig)
   {
      //----- Banco
      if (!isset($this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig]))
      {
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][0] = 1;
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][1] = $sum_cantidad;
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][2] = $sum_valor_parcial;
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][3] = $sum_costop;
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][4] = $sum_gananciap;
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][5] = 1;
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][6] = $quebra_b_codigo_banco;
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][7] = $quebra_b_codigo_banco_orig;
      }
      else
      {
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][0]++;
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][1] += $sum_cantidad;
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][2] += $sum_valor_parcial;
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][3] += $sum_costop;
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][4] += $sum_gananciap;
         $this->array_total_b_codigo_banco[$quebra_b_codigo_banco_orig][5]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'b_codigo_banco');
     $campos_order = $this->Ini->Get_date_order_groupby("b.codigo_banco", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->b_codigo_banco_orig = $this->b_codigo_banco;
            $this->f_idfacven = $this->look_f_idfacven ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->valor_parcial, $this->costop, $this->gananciap, $this->b_codigo_banco, $this->b_codigo_banco_orig);
            }
   }
//
