...
class grid_report_refventacostogarancia_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_report_refventacostogarancia']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_report_refventacostogarancia']['campos_busca']))
      { 
   ...
   //---- 
   function quebra_geral_Referencia($res_limit=false)
   {
      global $nada, $nm_lang , $f_idfacven;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(d.cantidad), sum((d.cantidad * ((d.valorpar-d.iva)/d.cantidad))), sum((d.cantidad * p.costomen)), sum((d.cantidad * (((d.valorpar-d.iva)/d.cantidad)-p.costomen))) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['tot_geral'][3] = $rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $rt->fields[3] = (string)$rt->fields[3]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['tot_geral'][4] = $rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $rt->fields[4] = (string)$rt->fields[4]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['tot_geral'][5] = $rt->fields[4]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['contr_total_geral'] = "OK";
   } 

   //---- 
   function quebra_geral_Descripcion($res_limit=false)
   {
      global $nada, $nm_lang , $f_idfacven;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['contr_total_geral'] == "OK") 
      { 
   ...
   //-----  referencia
   function quebra_referencia_Referencia($referencia, $arg_sum_referencia) 
   {
      global $tot_referencia, $f_idfacven;
      $tot_referencia = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(d.cantidad), sum((d.cantidad * ((d.valorpar-d.iva)/d.cantidad))), sum((d.cantidad * p.costomen)), sum((d.cantidad * (((d.valorpar-d.iva)/d.cantidad)-p.costomen))) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq']; 
      } 
      ...
      { 
         $nm_comando .= " where p.codigobar" . $arg_sum_referencia ; 
      } 
      else 
      { 
         $nm_comando .= " and p.codigobar" . $arg_sum_referencia ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_referencia[0] = sc_strip_script($referencia) ; 
      $tot_referencia[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_referencia[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_referencia[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_referencia[4] = (string)$rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $tot_referencia[5] = (string)$rt->fields[4]; 
      $rt->Close(); 
   } 

   //-----  descripcion
   function quebra_descripcion_Descripcion($descripcion, $arg_sum_descripcion) 
   {
      global $tot_descripcion, $f_idfacven;
      $tot_descripcion = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(d.cantidad), sum((d.cantidad * ((d.valorpar-d.iva)/d.cantidad))), sum((d.cantidad * p.costomen)), sum((d.cantidad * (((d.valorpar-d.iva)/d.cantidad)-p.costomen))) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq']; 
      } 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq'])) 
      { 
         $nm_comando .= " where p.nompro" . $arg_sum_descripcion ; 
      } 
      else 
      { 
         $nm_comando .= " and p.nompro" . $arg_sum_descripcion ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_descripcion[0] = sc_strip_script($descripcion) ; 
      $tot_descripcion[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_descripcion[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_descripcion[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_descripcion[4] = (string)$rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $tot_descripcion[5] = (string)$rt->fields[4]; 
      $rt->Close(); 
   } 

   //-----  referencia
   function quebra_referencia_sc_free_group_by($referencia, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $f_idfacven;
      $tot_referencia = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(d.cantidad), sum((d.cantidad * ((d.valorpar-d.iva)/d.cantidad))), sum((d.cantidad * p.costomen)), sum((d.cantidad * (((d.valorpar-d.iva)/d.cantidad)-p.costomen))) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq']; 
      ...
      $tot_referencia[5] = (string)$rt->fields[4]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_referencia;
   } 

   //-----  descripcion
   function quebra_descripcion_sc_free_group_by($descripcion, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $f_idfacven;
      $tot_descripcion = array() ;  
      ...
      $tot_descripcion[5] = (string)$rt->fields[4]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_descripcion;
   } 

   //-----  b_codigo_banco
   function quebra_b_codigo_banco_banco($b_codigo_banco, $arg_sum_b_codigo_banco) 
   {
      global $tot_b_codigo_banco, $f_idfacven;
      $tot_b_codigo_banco = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(d.cantidad), sum((d.cantidad * ((d.valorpar-d.iva)/d.cantidad))), sum((d.cantidad * p.costomen)), sum((d.cantidad * (((d.valorpar-d.iva)/d.cantidad)-p.costomen))) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq']; 
      } 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq'])) 
      { 
         $nm_comando .= " where b.codigo_banco" . $arg_sum_b_codigo_banco ; 
      } 
      else 
      { 
         $nm_comando .= " and b.codigo_banco" . $arg_sum_b_codigo_banco ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_b_codigo_banco[0] = sc_strip_script($b_codigo_banco) ; 
      $tot_b_codigo_banco[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_b_codigo_banco[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_b_codigo_banco[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_b_codigo_banco[4] = (string)$rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $tot_b_codigo_banco[5] = (string)$rt->fields[4]; 
      $rt->Close(); 
   } 

   //-----  f_tipo
   function quebra_f_tipo_tipo($f_tipo, $arg_sum_f_tipo) 
   {
      global $tot_f_tipo, $f_idfacven;
      $tot_f_tipo = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(d.cantidad), sum((d.cantidad * ((d.valorpar-d.iva)/d.cantidad))), sum((d.cantidad * p.costomen)), sum((d.cantidad * (((d.valorpar-d.iva)/d.cantidad)-p.costomen))) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq']; 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq'])) 
      { 
         $nm_comando .= " where f.tipo" . $arg_sum_f_tipo ; 
      } 
      else 
      { 
         $nm_comando .= " and f.tipo" . $arg_sum_f_tipo ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_f_tipo[0] = sc_strip_script($f_tipo) ; 
      $tot_f_tipo[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_f_tipo[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_f_tipo[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_f_tipo[4] = (string)$rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $tot_f_tipo[5] = (string)$rt->fields[4]; 
      $rt->Close(); 
   } 

   //-----  fecha_inicial
   function quebra_fecha_inicial_fecha($fecha_inicial, $arg_sum_fecha_inicial) 
   {
      global $tot_fecha_inicial, $f_idfacven;
      ...
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $tot_fecha_inicial[5] = (string)$rt->fields[4]; 
      $rt->Close(); 
   } 

   //-----  f_idfacven
   function quebra_f_idfacven_documento($f_idfacven, $arg_sum_f_idfacven) 
   {
      global $tot_f_idfacven, $f_idfacven;
      $tot_f_idfacven = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(d.cantidad), sum((d.cantidad * ((d.valorpar-d.iva)/d.cantidad))), sum((d.cantidad * p.costomen)), sum((d.cantidad * (((d.valorpar-d.iva)/d.cantidad)-p.costomen))) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq']; 
      } 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq'])) 
      { 
         $nm_comando .= " where f.idfacven" . $arg_sum_f_idfacven ; 
      } 
      else 
      { 
         $nm_comando .= " and f.idfacven" . $arg_sum_f_idfacven ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_f_idfacven[0] = NM_encode_input(sc_strip_script($f_idfacven)) ; 
      $tot_f_idfacven[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_f_idfacven[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_f_idfacven[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_f_idfacven[4] = (string)$rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $tot_f_idfacven[5] = (string)$rt->fields[4]; 
      $rt->Close(); 
   } 


   //----- 
   function Calc_resumo_Referencia($destino_resumo)
   {
      global $nm_lang, $f_idfacven;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('referencia' => "p.codigobar");
      $cmps_quebra_atual = array("referencia");
      ...
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          ...
          $this->Res_Totaliza_Referencia($ind_qb, $cmp_gb, $arr_tots, $group, $join, $cmps_gb, $cmps_gb1, $cmps_gb2, $cmps_gbS, $cmp_dim, $cmps_quebra_atual, $cmp_sql_def);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }

   function Res_Totaliza_Referencia($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      $sc_having = ((isset($parms_sub_sel['having']))) ? "  having " . $parms_sub_sel['having'] : "";
      $Tem_estat_manual = false;
      $where_ok = $this->sc_where_atual;
      $cmp_sql_tp_num = array('cantidad' => 'N','precioventa' => 'N','costo' => 'N','ganancia' => 'N','f_idfacven' => 'N','d_valorunit' => 'N','valor_parcial' => 'N','costo_parcial' => 'N','ganancia_parcial' => 'N','precio_full_unitario' => 'N','precio_full_parcial' => 'N','ganancia_pfull_unitario' => 'N','ganancia_pfull_parcial' => 'N','costop' => 'N','gananciap' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), sum(d.cantidad), sum((d.cantidad * ((d.valorpar-d.iva)/d.cantidad))), sum((d.cantidad * p.costomen)), sum((d.cantidad * (((d.valorpar-d.iva)/d.cantidad)-p.costomen)))#@#cmps_quebras#@# from " . $this->Ini->nm_tabela . " " . $where_ok;
         $comando  = "select count(*), sum(SC_metric1), sum(SC_metric2), sum(SC_metric3), sum(SC_metric4)#@#cmps_quebras#@# from (";
         $comando .= "select d.cantidad as SC_metric1,(d.cantidad * ((d.valorpar-d.iva)/d.cantidad)) as SC_metric2,(d.cantidad * p.costomen) as SC_metric3,(d.cantidad * (((d.valorpar-d.iva)/d.cantidad)-p.costomen)) as SC_metric4, " . $cmps_quebras1 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . ") SC_sel1 INNER JOIN (";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['referencia']['reg'] = "S";
      $format_dimensions['referencia']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              $SC_prep = $this->Ini->Get_format_dimension($Ind_sql, 'Referencia', $Cada_dim, $rt, $format_dimensions[$Cada_dim]['reg'], $format_dimensions[$Cada_dim]['msk']);
              $SC_orig = $Cada_dim . "_orig";
              $SC_graf = "val_grafico_" . $Cada_dim;
              $$Cada_dim = $SC_prep['fmt'];
              $$SC_orig = $SC_prep['orig'];
              if ($Cada_dim == "referencia") {
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
          ...
          if ($Tem_estat_manual)
          {
              ...
              $vl_statistic = $this->Calc_statist_manual_Referencia($where_ok);
   ...
   //----- 
   function Calc_resumo_Descripcion($destino_resumo)
   {
      global $nm_lang, $f_idfacven;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['sql_tot_res']);
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('descripcion' => "p.nompro");
      $cmps_quebra_atual = array("descripcion");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
      ...
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          ...
          $this->Res_Totaliza_Descripcion($ind_qb, $cmp_gb, $arr_tots, $group, $join, $cmps_gb, $cmps_gb1, $cmps_gb2, $cmps_gbS, $cmp_dim, $cmps_quebra_atual, $cmp_sql_def);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
   ...
   function Res_Totaliza_Descripcion($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      $sc_having = ((isset($parms_sub_sel['having']))) ? "  having " . $parms_sub_sel['having'] : "";
      $Tem_estat_manual = false;
      $where_ok = $this->sc_where_atual;
      ...
      $format_dimensions = array();
      $format_dimensions['descripcion']['reg'] = "S";
      $format_dimensions['descripcion']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              $prep_look  = $Cada_dim . "_SC_look";
              $$prep_look = $rt->fields[$Ind_sql];
              $SC_prep = $this->Ini->Get_format_dimension($Ind_sql, 'Descripcion', $Cada_dim, $rt, $format_dimensions[$Cada_dim]['reg'], $format_dimensions[$Cada_dim]['msk']);
              $SC_orig = $Cada_dim . "_orig";
              $SC_graf = "val_grafico_" . $Cada_dim;
              $$Cada_dim = $SC_prep['fmt'];
              $$SC_orig = $SC_prep['orig'];
              if ($Cada_dim == "descripcion") {
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
          ...
          {
              $where_ok = (empty($this->sc_where_atual)) ? " where " . $sql_where : $this->sc_where_atual . " and " . $sql_where;
              $vl_statistic = $this->Calc_statist_manual_Descripcion($where_ok);
              foreach ($vl_statistic as $ind => $val)
              {
                  $rt->fields[$ind] = $val;
              }
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('referencia' => "p.codigobar",'descripcion' => "p.nompro");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
   ...
   function Calc_resumo_banco($destino_resumo)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('b_codigo_banco' => "b.codigo_banco");
      $cmps_quebra_atual = array("b_codigo_banco");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
   ...
   function Res_Totaliza_banco($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $format_dimensions = array();
      $format_dimensions['b_codigo_banco']['reg'] = "S";
      $format_dimensions['b_codigo_banco']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
   ...
   function Calc_resumo_tipo($destino_resumo)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('f_tipo' => "f.tipo");
      $cmps_quebra_atual = array("f_tipo");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
   ...
   function Res_Totaliza_tipo($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $format_dimensions = array();
      $format_dimensions['f_tipo']['reg'] = "S";
      $format_dimensions['f_tipo']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
   ...
   function Calc_resumo_fecha($destino_resumo)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('fecha_inicial' => "f.fechaven");
   ...
   function Calc_resumo_documento($destino_resumo)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('f_idfacven' => "f.idfacven");
      $cmps_quebra_atual = array("f_idfacven");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
   ...
   function Res_Totaliza_documento($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $format_dimensions = array();
      $format_dimensions['f_idfacven']['reg'] = "S";
      $format_dimensions['f_idfacven']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              $$Cada_dim = $SC_prep['fmt'];
              $$SC_orig = $SC_prep['orig'];
              if ($Cada_dim == "f_idfacven") {
                  $this->Lookup->lookup_documento_f_idfacven($$Cada_dim,  $f_idfacven);
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
