...
class grid_report_refventacostogarancia_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_report_refventacostogarancia_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_report_refventacostogarancia_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_report_refventacostogarancia_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_referencia')
      {
          $referencia = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_referencia($referencia);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_referencia($referencia)
   {
      $referencia = substr($this->Db->qstr($referencia), 1, -1);
            $referencia_look = substr($this->Db->qstr($referencia), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct p.codigobar from " . $this->Ini->nm_tabela . " where f.asentada='1' and  p.codigobar like '%" . $referencia . "%' order by p.codigobar"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_descripcion($descripcion)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct p.nompro from " . $this->Ini->nm_tabela . " where f.asentada='1' and  p.nompro like '%" . $descripcion . "%' order by p.nompro"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "f.fechaven";$Nm_datas[] = "f_fechaven";$Nm_datas[] = "f.fechaven";$Nm_datas[] = "f_fechaven";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_report_refventacostogarancia/grid_report_refventacostogarancia_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_report_refventacostogarancia_ajax_search.js"></script>
 <script type="text/javascript" src="grid_report_refventacostogarancia_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_report_refventacostogarancia_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_report_refventacostogarancia']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_report_refventacostogarancia']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_fecha_inicial_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fecha_inicial_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_inicial_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_inicial_ano').value;
          document.getElementById('sc_fecha_inicial_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fecha_inicial_dia').value = aParts[0];
          document.getElementById('SC_fecha_inicial_mes').value = aParts[1];
          document.getElementById('SC_fecha_inicial_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_fecha_final_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fecha_final_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_final_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_final_ano').value;
          document.getElementById('sc_fecha_final_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fecha_final_dia').value = aParts[0];
          document.getElementById('SC_fecha_final_mes').value = aParts[1];
          document.getElementById('SC_fecha_final_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_referencia_cond#NMF#' + search_get_sel_txt('SC_referencia_cond') + '@NMF@';
  str_out += 'SC_referencia#NMF#' + search_get_text('SC_referencia') + '@NMF@';
  str_out += 'id_ac_referencia#NMF#' + search_get_title('select2-id_ac_referencia-container') + '@NMF@';
  ...
  str_out += 'SC_f_tipo_cond#NMF#' + search_get_sel_txt('SC_f_tipo_cond') + '@NMF@';
  str_out += 'SC_f_tipo#NMF#' + search_get_select('SC_f_tipo') + '@NMF@';
  str_out += 'SC_devolucion_cond#NMF#' + search_get_sel_txt('SC_devolucion_cond') + '@NMF@';
  str_out += 'SC_devolucion#NMF#' + search_get_checkbox('SC_devolucion') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-referencia").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_referencia",
      max_itens: "10",
   ...
   $("#SC_referencia").val(e.params.data.id);
  });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Referencia Venta/Costo/Ganancia</span></td>
...
<?php
   ...
   {
      global 
             $referencia_cond, $referencia, $referencia_autocomp,
             $descripcion_cond, $descripcion, $descripcion_autocomp,
             $fecha_inicial_cond, $fecha_inicial, $fecha_inicial_dia, $fecha_inicial_mes, $fecha_inicial_ano,
             $fecha_final_cond, $fecha_final, $fecha_final_dia, $fecha_final_mes, $fecha_final_ano,
             $f_tipo_cond, $f_tipo,
             $devolucion_cond, $devolucion,
             $numfac_cond, $numfac,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $referencia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['referencia']; 
          $referencia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['referencia_cond']; 
          $descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['descripcion']; 
          $descripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['descripcion_cond']; 
          $fecha_inicial_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_inicial_dia']; 
          $fecha_inicial_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_inicial_mes']; 
          $fecha_inicial_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_inicial_ano']; 
          $fecha_inicial_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_inicial_cond']; 
          $fecha_final_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_final_dia']; 
          $fecha_final_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_final_mes']; 
          $fecha_final_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_final_ano']; 
          $fecha_final_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_final_cond']; 
          $f_tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['f_tipo']; 
          $f_tipo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['f_tipo_cond']; 
          $devolucion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['devolucion']; 
          $devolucion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['devolucion_cond']; 
          $numfac = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['numfac']; 
          $numfac_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['numfac_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['NM_operador']; 
      } 
      ...
      {
         $fecha_inicial_cond = "ge";
      }
      if (!isset($fecha_final_cond) || empty($fecha_final_cond))
      {
         $fecha_final_cond = "le";
      }
      if (!isset($f_tipo_cond) || empty($f_tipo_cond))
      {
         $f_tipo_cond = "eq";
      }
      if (!isset($devolucion_cond) || empty($devolucion_cond))
      {
         $devolucion_cond = "eq";
      }
      ...
      $str_hide_referencia = (in_array($referencia_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_f_tipo = (in_array($f_tipo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_devolucion = (in_array($devolucion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_numfac = (in_array($numfac_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      // devolucion
      if (is_array($devolucion) && !empty($devolucion))
      {
         $tmp_array = array();
         $devolucion_val_str = "";
         foreach ($devolucion as $tmp_val_cmp)
         {
            if ("" != $devolucion_val_str)
            {
               $devolucion_val_str .= ",";
            }
            ...
            $devolucion_val_str .= "'$tmp_val_cmp'";
         }
         $devolucion = $tmp_array;
      }
      else
      {
         $devolucion_val_str = "''";
      ...
      if (!isset($f_tipo) || $f_tipo == "")
      {
          $f_tipo = "";
      }
      if (isset($f_tipo) && !empty($f_tipo))
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <INPUT type="hidden" id="SC_referencia_cond" name="referencia_cond" value="qp">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_referencia"  <?php echo $str_hide_referencia?>><?php
      if ($referencia != "")
      {
      $referencia_look = substr($this->Db->qstr($referencia), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct p.codigobar from " . $this->Ini->nm_tabela . " where f.asentada='1' and p.codigobar = '$referencia_look' order by p.codigobar"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$referencia]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$referencia];
      }
      else
      {
          $sAutocompValue = $referencia;
      }
?>
<INPUT  type="text" id="SC_referencia" name="referencia" value="<?php echo NM_encode_input($referencia) ?>"  size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-referencia" id="id_ac_referencia" name="referencia_autocomp"><?php if ('' !=  $referencia) { ?><option value="<?php echo $referencia ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_descripcion"  <?php echo $str_hide_descripcion?>><?php
      ...
      $descripcion_look = substr($this->Db->qstr($descripcion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct p.nompro from " . $this->Ini->nm_tabela . " where f.asentada='1' and p.nompro = '$descripcion_look' order by p.nompro"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_descripcion" name="descripcion" value="<?php echo NM_encode_input($descripcion) ?>"  size=70 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-descripcion" id="id_ac_descripcion" name="descripcion_autocomp"><?php if ('' !=  $descripcion) { ?><option value="<?php echo $descripcion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <INPUT type="hidden" id="SC_fecha_inicial_cond" name="fecha_inicial_cond" value="ge">

    <TD nowrap class="scFilterLabelOdd" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['fecha_inicial'])) ? $this->New_label['fecha_inicial'] : "Fecha desde";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_fecha_inicial"  <?php echo $str_hide_fecha_inicial?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_inicial_dia" name="fecha_inicial_dia" value="<?php echo NM_encode_input($fecha_inicial_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_inicial_mes" name="fecha_inicial_mes" value="<?php echo NM_encode_input($fecha_inicial_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_inicial_ano" name="fecha_inicial_ano" value="<?php echo NM_encode_input($fecha_inicial_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_fecha_inicial_jq">
</span>
...
?>
      ...
      <INPUT type="hidden" id="SC_fecha_final_cond" name="fecha_final_cond" value="le">

    <TD nowrap class="scFilterLabelEven" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['fecha_final'])) ? $this->New_label['fecha_final'] : "Fecha hasta";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_fecha_final"  <?php echo $str_hide_fecha_final?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
  $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_final_dia" name="fecha_final_dia" value="<?php echo NM_encode_input($fecha_final_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_final_mes" name="fecha_final_mes" value="<?php echo NM_encode_input($fecha_final_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_final_ano" name="fecha_final_ano" value="<?php echo NM_encode_input($fecha_final_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_fecha_final_jq">
</span>
...
?>
      ...
      <INPUT type="hidden" id="SC_f_tipo_cond" name="f_tipo_cond" value="eq">

    <TD nowrap class="scFilterLabelOdd" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['f_tipo'])) ? $this->New_label['f_tipo'] : "Tipo";
 $nmgp_tab_label .= "f_tipo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_f_tipo"  <?php echo $str_hide_f_tipo?>> 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['psq_check_ret']['f_tipo'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['psq_check_ret']['f_tipo'][] = "FV";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['psq_check_ret']['f_tipo'][] = "RS";
 ?>

 <SELECT class="scFilterObjectOdd" id="SC_f_tipo"  name="f_tipo"  size="1">
 <OPTION value="">SELECCIONE</option>
 <OPTION value="FV##@@Factura"<?php if ($f_tipo == "FV") { echo " selected" ;} ?>>Factura</option>
 <OPTION value="RS##@@Remisión"<?php if ($f_tipo == "RS") { echo " selected" ;} ?>>Remisión</option>
 </SELECT>
 </TD>
      ...
      <INPUT type="hidden" id="SC_devolucion_cond" name="devolucion_cond" value="eq">

    <TD nowrap class="scFilterLabelEven" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['devolucion'])) ? $this->New_label['devolucion'] : "Quitar devoluciones";
 $nmgp_tab_label .= "devolucion?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_devolucion"  <?php echo $str_hide_devolucion?>> 
<?php
  if (!isset($devolucion)) {$devolucion = explode("", $devolucion);}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['psq_check_ret']['devolucion'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['psq_check_ret']['devolucion'][] = "N";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_devolucion" name="devolucion[]" value="N##@@"  <?php if (in_array("N", $devolucion))  { echo " checked" ;} ?>></TD>
</TR></TABLE>
 </TD>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_numfac_cond" name="numfac_cond" onChange="nm_campos_between(document.getElementById('id_vis_numfac'), this, 'numfac')">
       ...
       <OPTION value="qp" <?php if ("qp" == $numfac_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $numfac_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_numfac"  <?php echo $str_hide_numfac?>><INPUT  type="text" id="SC_numfac" name="numfac" value="<?php echo NM_encode_input($numfac) ?>"  size=50 alt="{datatype: 'text', maxLength: 90, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php
   if (is_file("grid_report_refventacostogarancia_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['opc_psq'])
   {
...
<?php
   ...
   {
?>
          <?php echo nmButtonOutput($this->arr_buttons, "blimpar", "limpa_form();", "limpa_form();", "limpa_frm_bot", "", "Borrar busqueda", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
<?php
   }
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.referencia_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_referencia'), document.F1.referencia_cond, 'referencia');
   document.F1.referencia.value = "";
   document.F1.referencia_autocomp.value = "";
   $('#select2-id_ac_referencia-container').html('<?php echo $this->Val_init_referencia['desc'] ?>');;
   ...
   document.F1.fecha_inicial_cond.value = 'ge';
   ...
   document.F1.fecha_final_cond.value = 'le';
   ...
   document.F1.f_tipo_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_f_tipo'), document.F1.f_tipo_cond, 'f_tipo');
   document.F1.f_tipo.value = "";
   document.F1.devolucion_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_devolucion'), document.F1.devolucion_cond, 'devolucion');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'devolucion[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
   document.F1.numfac_cond.value = 'eq';
 ...
 {
    if (Field == 'all' || Field == 'f_tipo') {
       Sc_carga_select2_f_tipo();
    }
 }
 function Sc_carga_select2_f_tipo()
 {
  $("#SC_f_tipo").select2(
    {
      language: {
 ...
 {
    $('#SC_fecha_final_dia').bind('change', function() {sc_grid_report_refventacostogarancia_valida_dia(this)});
    $('#SC_fecha_final_mes').bind('change', function() {sc_grid_report_refventacostogarancia_valida_mes(this)});
    $('#SC_fecha_inicial_dia').bind('change', function() {sc_grid_report_refventacostogarancia_valida_dia(this)});
    $('#SC_fecha_inicial_mes').bind('change', function() {sc_grid_report_refventacostogarancia_valida_mes(this)});
 }
 function sc_grid_report_refventacostogarancia_valida_dia(obj)
 {
 ...
 function sc_grid_report_refventacostogarancia_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_referencia_cond'] = 'cond';
      $tp_fields['SC_referencia'] = 'text_aut';
      $tp_fields['id_ac_referencia'] = 'select2_aut';
      ...
      $tp_fields['SC_f_tipo_cond'] = 'cond';
      $tp_fields['SC_f_tipo'] = 'select';
      $tp_fields['SC_devolucion_cond'] = 'cond';
      $tp_fields['SC_devolucion'] = 'checkbox';
      $tp_fields['SC_numfac_cond'] = 'cond';
      $tp_fields['SC_numfac'] = 'text';
   ...
   {
      global $referencia_cond, $referencia, $referencia_autocomp,
             $descripcion_cond, $descripcion, $descripcion_autocomp,
             $fecha_inicial_cond, $fecha_inicial, $fecha_inicial_dia, $fecha_inicial_mes, $fecha_inicial_ano,
             $fecha_final_cond, $fecha_final, $fecha_final_dia, $fecha_final_mes, $fecha_final_ano,
             $f_tipo_cond, $f_tipo,
             $devolucion_cond, $devolucion,
             $numfac_cond, $numfac, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($referencia_autocomp) && empty($referencia))
      {
          $referencia = $referencia_autocomp;
      }
      ...
      $f_tipo_cond_salva = $f_tipo_cond; 
      if (!isset($f_tipo_input_2) || $f_tipo_input_2 == "")
      {
          $f_tipo_input_2 = $f_tipo;
      }
      $devolucion_cond_salva = $devolucion_cond; 
      if (!isset($devolucion_input_2) || $devolucion_input_2 == "")
      {
          $devolucion_input_2 = $devolucion;
      }
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($f_tipo, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['psq_check_ret']['f_tipo'])) {
      ...
      if (is_array($devolucion)) {
          foreach ($devolucion as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['psq_check_ret']['devolucion'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Quitar devoluciones : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['referencia'] = $referencia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['referencia_cond'] = $referencia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['descripcion'] = $descripcion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['descripcion_cond'] = $descripcion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_inicial_dia'] = $fecha_inicial_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_inicial_mes'] = $fecha_inicial_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_inicial_ano'] = $fecha_inicial_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_inicial_cond'] = $fecha_inicial_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_final_dia'] = $fecha_final_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_final_mes'] = $fecha_final_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_final_ano'] = $fecha_final_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_final_cond'] = $fecha_final_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['f_tipo'] = $f_tipo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['f_tipo_cond'] = $f_tipo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['devolucion'] = $devolucion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['devolucion_cond'] = $devolucion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['numfac'] = $numfac; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['numfac_cond'] = $numfac_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($referencia != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['referencia'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['referencia'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['referencia'] = $referencia;
      }
      $nmgp_def_dados = array();
    if ($descripcion != '') {
      $descripcion_look = substr($this->Db->qstr($descripcion), 1, -1); 
      ...
      $this->cmp_formatado['f_tipo'] = $Conteudo;
      $this->cmp_formatado['devolucion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['devolucion'];
      $this->cmp_formatado['devolucion_input_2'] = $devolucion_input_2;
      $Conteudo = $numfac;
      $this->cmp_formatado['numfac'] = $Conteudo;

      //----- $referencia
      $this->Date_part = false;
      if (isset($referencia) || $referencia_cond == "nu" || $referencia_cond == "nn" || $referencia_cond == "ep" || $referencia_cond == "ne")
      {
         $this->monta_condicao("p.codigobar", $referencia_cond, $referencia, "", "referencia");
      }
      ...
      if ($fecha_inicial_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_inicial'] = $val[0];
          ...
          if ($fecha_inicial_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_inicial_input_2'] = $val[1];
          ...
          {
              $this->monta_condicao("f.fechaven", $fecha_inicial_cond, $fecha_inicial, $fecha_inicial_input_2, 'fecha_inicial', 'DATE');
          }
      }

      //----- $fecha_final
      $this->Date_part = false;
      if ($fecha_final_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_final'] = $val[0];
          ...
          if ($fecha_final_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']['fecha_final_input_2'] = $val[1];
          ...
          {
              $this->monta_condicao("f.fechaven", $fecha_final_cond, $fecha_final, $fecha_final_input_2, 'fecha_final', 'DATE');
          }
      }
      ...
      if (isset($f_tipo))
      {
         $this->monta_condicao("f.tipo", $f_tipo_cond, $f_tipo, "", "f_tipo");
      }
      ...
      $nm_aspas = "'";
      if ($devolucion_cond == "nu" || $devolucion_cond == "nn" || $devolucion_cond == "ep" || $devolucion_cond == "ne")
      {
          $devolucion = array();
      }
      if (is_array($devolucion) && count($devolucion) != 0)
      {
         foreach ($devolucion as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($devolucion_cond == "df" || $devolucion_cond == "np")
         {
             $this->comando        .= " if(d.cantidad<0,'S','N') not in (";
             $this->comando_sum    .= " if(d.cantidad<0,'S','N') not in (";
             $this->comando_filtro .= " if(d.cantidad<0,'S','N') not in (";
         }
         else
         {
             $this->comando        .= " if(d.cantidad<0,'S','N') in (";
             $this->comando_sum    .= " if(d.cantidad<0,'S','N') in (";
             $this->comando_filtro .= " if(d.cantidad<0,'S','N') in (";
         }
         $x                     = count($devolucion);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr_final = isset($Lang_descr[$devolucion_cond]) ? $Lang_descr[$devolucion_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $nmgp_tab_label['devolucion'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($devolucion) || $devolucion_cond == "nu" || $devolucion_cond == "nn" || $devolucion_cond == "ep" || $devolucion_cond == "ne")
      {
         $this->monta_condicao("if(d.cantidad<0,'S','N')", $devolucion_cond, $devolucion, "", "devolucion");
      }
      ...
      {
         $this->monta_condicao("concat(r.prefijo,f.numfacven)", $numfac_cond, $numfac, "", "numfac");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['cond_pesq'] .= $this->NM_operador;
