...
class grid_report_refventacostogarancia_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['arr_total']['descripcion'];
      }
      else
      {
          $this->array_total_descripcion = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['Descripcion']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['Descripcion'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_order']['Descripcion'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['Descripcion'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['Descripcion'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['Descripcion'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['Descripcion'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['Descripcion'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['Descripcion'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['summarizing_fields_display']['Descripcion'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_descripcion as $i_descripcion => $d_descripcion) {
           if (!in_array($i_descripcion, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_descripcion[7] ] = $d_descripcion[6];
               $this->comp_label[0][ $d_descripcion[7] ] = $d_descripcion[6];
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_refventacostogarancia']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_Descripcion("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_valor_parcial, $sum_costop, $sum_gananciap, $quebra_descripcion, $quebra_descripcion_orig)
   {
      //----- Descripcion
      if (!isset($this->array_total_descripcion[$quebra_descripcion_orig]))
      {
         ...
         $this->array_total_descripcion[$quebra_descripcion_orig][2] = $sum_valor_parcial;
         $this->array_total_descripcion[$quebra_descripcion_orig][3] = $sum_costop;
         $this->array_total_descripcion[$quebra_descripcion_orig][4] = $sum_gananciap;
         $this->array_total_descripcion[$quebra_descripcion_orig][5] = 1;
         $this->array_total_descripcion[$quebra_descripcion_orig][6] = $quebra_descripcion;
         $this->array_total_descripcion[$quebra_descripcion_orig][7] = $quebra_descripcion_orig;
      }
      else
      {
         ...
         $this->array_total_descripcion[$quebra_descripcion_orig][3] += $sum_costop;
         $this->array_total_descripcion[$quebra_descripcion_orig][4] += $sum_gananciap;
         $this->array_total_descripcion[$quebra_descripcion_orig][5]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->valor_parcial, $this->costop, $this->gananciap, $this->descripcion, $this->descripcion_orig);
            }
   }
//
