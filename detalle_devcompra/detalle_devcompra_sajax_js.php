  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_detalle_devcompra" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_detalle_devcompra_form();
	}
...
?>
  ...
  function do_ajax_detalle_devcompra_validate_cod_barras_(iNumLinha)
  {
    var nomeCampo_cod_barras_ = "cod_barras_" + iNumLinha;
    var var_cod_barras_ = scAjaxGetFieldText(nomeCampo_cod_barras_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_cod_barras_(var_cod_barras_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_cod_barras__cb);
  } // do_ajax_detalle_devcompra_validate_cod_barras_

  function do_ajax_detalle_devcompra_validate_cod_barras__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_cod_barras__cb

  // ---------- Validate idpro_
  function do_ajax_detalle_devcompra_validate_idpro_(iNumLinha)
  {
  } // do_ajax_detalle_devcompra_validate_idpro_

  function do_ajax_detalle_devcompra_validate_idpro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_idpro__cb

  // ---------- Validate ver_
  function do_ajax_detalle_devcompra_validate_ver_(iNumLinha)
  {
    var nomeCampo_ver_ = "ver_" + iNumLinha;
    var var_ver_ = scAjaxGetFieldHidden(nomeCampo_ver_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_ver_(var_ver_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_ver__cb);
  } // do_ajax_detalle_devcompra_validate_ver_

  function do_ajax_detalle_devcompra_validate_ver__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_ver__cb

  // ---------- Validate colores_
  function do_ajax_detalle_devcompra_validate_colores_(iNumLinha)
  {
    var nomeCampo_colores_ = "colores_" + iNumLinha;
    var var_colores_ = scAjaxGetFieldSelect(nomeCampo_colores_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_colores_(var_colores_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_colores__cb);
  } // do_ajax_detalle_devcompra_validate_colores_

  function do_ajax_detalle_devcompra_validate_colores__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_colores__cb

  // ---------- Validate tallas_
  function do_ajax_detalle_devcompra_validate_tallas_(iNumLinha)
  {
    var nomeCampo_tallas_ = "tallas_" + iNumLinha;
    var var_tallas_ = scAjaxGetFieldSelect(nomeCampo_tallas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_tallas_(var_tallas_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_tallas__cb);
  } // do_ajax_detalle_devcompra_validate_tallas_

  function do_ajax_detalle_devcompra_validate_tallas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_tallas__cb

  // ---------- Validate sabor_
  function do_ajax_detalle_devcompra_validate_sabor_(iNumLinha)
  {
    var nomeCampo_sabor_ = "sabor_" + iNumLinha;
    var var_sabor_ = scAjaxGetFieldSelect(nomeCampo_sabor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_sabor_(var_sabor_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_sabor__cb);
  } // do_ajax_detalle_devcompra_validate_sabor_

  function do_ajax_detalle_devcompra_validate_sabor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_sabor__cb

  // ---------- Validate cantidad_
  function do_ajax_detalle_devcompra_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_cantidad__cb);
  } // do_ajax_detalle_devcompra_validate_cantidad_

  function do_ajax_detalle_devcompra_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_cantidad__cb

  // ---------- Validate presentacion_
  function do_ajax_detalle_devcompra_validate_presentacion_(iNumLinha)
  {
    var nomeCampo_presentacion_ = "presentacion_" + iNumLinha;
    var var_presentacion_ = scAjaxGetFieldHidden(nomeCampo_presentacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_presentacion_(var_presentacion_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_presentacion__cb);
  } // do_ajax_detalle_devcompra_validate_presentacion_

  function do_ajax_detalle_devcompra_validate_presentacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_presentacion__cb

  // ---------- Validate valorunit_
  function do_ajax_detalle_devcompra_validate_valorunit_(iNumLinha)
  {
    var nomeCampo_valorunit_ = "valorunit_" + iNumLinha;
    var var_valorunit_ = scAjaxGetFieldText(nomeCampo_valorunit_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_valorunit_(var_valorunit_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_valorunit__cb);
  } // do_ajax_detalle_devcompra_validate_valorunit_

  function do_ajax_detalle_devcompra_validate_valorunit__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_valorunit__cb

  // ---------- Validate porc_desc_
  function do_ajax_detalle_devcompra_validate_porc_desc_(iNumLinha)
  {
    var nomeCampo_porc_desc_ = "porc_desc_" + iNumLinha;
    var var_porc_desc_ = scAjaxGetFieldText(nomeCampo_porc_desc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_porc_desc_(var_porc_desc_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_porc_desc__cb);
  } // do_ajax_detalle_devcompra_validate_porc_desc_

  function do_ajax_detalle_devcompra_validate_porc_desc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_porc_desc__cb

  // ---------- Validate descuento_
  function do_ajax_detalle_devcompra_validate_descuento_(iNumLinha)
  {
    var nomeCampo_descuento_ = "descuento_" + iNumLinha;
    var var_descuento_ = scAjaxGetFieldText(nomeCampo_descuento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_descuento_(var_descuento_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_descuento__cb);
  } // do_ajax_detalle_devcompra_validate_descuento_

  function do_ajax_detalle_devcompra_validate_descuento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_descuento__cb

  // ---------- Validate valorpar_
  function do_ajax_detalle_devcompra_validate_valorpar_(iNumLinha)
  {
    var nomeCampo_valorpar_ = "valorpar_" + iNumLinha;
    var var_valorpar_ = scAjaxGetFieldHidden(nomeCampo_valorpar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_valorpar_(var_valorpar_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_valorpar__cb);
  } // do_ajax_detalle_devcompra_validate_valorpar_

  function do_ajax_detalle_devcompra_validate_valorpar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_valorpar__cb

  // ---------- Validate iva_
  function do_ajax_detalle_devcompra_validate_iva_(iNumLinha)
  {
    var nomeCampo_iva_ = "iva_" + iNumLinha;
    var var_iva_ = scAjaxGetFieldHidden(nomeCampo_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_iva_(var_iva_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_iva__cb);
  } // do_ajax_detalle_devcompra_validate_iva_

  function do_ajax_detalle_devcompra_validate_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_iva__cb

  // ---------- Validate idbod_
  function do_ajax_detalle_devcompra_validate_idbod_(iNumLinha)
  {
    var nomeCampo_idbod_ = "idbod_" + iNumLinha;
    var var_idbod_ = scAjaxGetFieldSelect(nomeCampo_idbod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_idbod_(var_idbod_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_idbod__cb);
  } // do_ajax_detalle_devcompra_validate_idbod_

  function do_ajax_detalle_devcompra_validate_idbod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_idbod__cb

  // ---------- Validate tasaiva_
  function do_ajax_detalle_devcompra_validate_tasaiva_(iNumLinha)
  {
    var nomeCampo_tasaiva_ = "tasaiva_" + iNumLinha;
    var var_tasaiva_ = scAjaxGetFieldText(nomeCampo_tasaiva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_tasaiva_(var_tasaiva_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_tasaiva__cb);
  } // do_ajax_detalle_devcompra_validate_tasaiva_

  function do_ajax_detalle_devcompra_validate_tasaiva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_tasaiva__cb

  // ---------- Validate tasadesc_
  function do_ajax_detalle_devcompra_validate_tasadesc_(iNumLinha)
  {
    var nomeCampo_tasadesc_ = "tasadesc_" + iNumLinha;
    var var_tasadesc_ = scAjaxGetFieldText(nomeCampo_tasadesc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_tasadesc_(var_tasadesc_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_tasadesc__cb);
  } // do_ajax_detalle_devcompra_validate_tasadesc_

  function do_ajax_detalle_devcompra_validate_tasadesc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_tasadesc__cb

  // ---------- Validate devuelto_
  function do_ajax_detalle_devcompra_validate_devuelto_(iNumLinha)
  {
    var nomeCampo_devuelto_ = "devuelto_" + iNumLinha;
    var var_devuelto_ = scAjaxGetFieldText(nomeCampo_devuelto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_devuelto_(var_devuelto_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_devuelto__cb);
  } // do_ajax_detalle_devcompra_validate_devuelto_

  function do_ajax_detalle_devcompra_validate_devuelto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_devuelto__cb

  // ---------- Validate vencimiento_
  function do_ajax_detalle_devcompra_validate_vencimiento_(iNumLinha)
  {
    var nomeCampo_vencimiento_ = "vencimiento_" + iNumLinha;
    var var_vencimiento_ = scAjaxGetFieldText(nomeCampo_vencimiento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_vencimiento_(var_vencimiento_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_vencimiento__cb);
  } // do_ajax_detalle_devcompra_validate_vencimiento_

  function do_ajax_detalle_devcompra_validate_vencimiento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_vencimiento__cb

  // ---------- Validate lote_
  function do_ajax_detalle_devcompra_validate_lote_(iNumLinha)
  {
    var nomeCampo_lote_ = "lote_" + iNumLinha;
    var var_lote_ = scAjaxGetFieldText(nomeCampo_lote_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_lote_(var_lote_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_lote__cb);
  } // do_ajax_detalle_devcompra_validate_lote_

  function do_ajax_detalle_devcompra_validate_lote__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_lote__cb

  // ---------- Validate serial_codbarra_
  function do_ajax_detalle_devcompra_validate_serial_codbarra_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_serial_codbarra_(var_serial_codbarra_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_serial_codbarra__cb);
  } // do_ajax_detalle_devcompra_validate_serial_codbarra_

  function do_ajax_detalle_devcompra_validate_serial_codbarra__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_serial_codbarra__cb

  // ---------- Validate iddet_
  function do_ajax_detalle_devcompra_validate_iddet_(iNumLinha)
  {
    var nomeCampo_iddet_ = "iddet_" + iNumLinha;
    var var_iddet_ = scAjaxGetFieldHidden(nomeCampo_iddet_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_iddet_(var_iddet_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_iddet__cb);
  } // do_ajax_detalle_devcompra_validate_iddet_

  function do_ajax_detalle_devcompra_validate_iddet__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_iddet__cb

  // ---------- Validate idfaccom_
  function do_ajax_detalle_devcompra_validate_idfaccom_(iNumLinha)
  {
    var nomeCampo_idfaccom_ = "idfaccom_" + iNumLinha;
    var var_idfaccom_ = scAjaxGetFieldText(nomeCampo_idfaccom_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_idfaccom_(var_idfaccom_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_idfaccom__cb);
  } // do_ajax_detalle_devcompra_validate_idfaccom_

  function do_ajax_detalle_devcompra_validate_idfaccom__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_idfaccom__cb

  // ---------- Validate num_ndevolucion_
  function do_ajax_detalle_devcompra_validate_num_ndevolucion_(iNumLinha)
  {
    var nomeCampo_num_ndevolucion_ = "num_ndevolucion_" + iNumLinha;
    var var_num_ndevolucion_ = scAjaxGetFieldText(nomeCampo_num_ndevolucion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_validate_num_ndevolucion_(var_num_ndevolucion_, iNumLinha, var_script_case_init, do_ajax_detalle_devcompra_validate_num_ndevolucion__cb);
  } // do_ajax_detalle_devcompra_validate_num_ndevolucion_

  function do_ajax_detalle_devcompra_validate_num_ndevolucion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "num_ndevolucion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "num_ndevolucion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "num_ndevolucion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "num_ndevolucion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_validate_num_ndevolucion__cb

  // ---------- Refresh idpro_
  function do_ajax_detalle_devcompra_refresh_idpro_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_detalle_devcompra_refresh_idpro_(var_idpro_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_detalle_devcompra_refresh_idpro__cb);
  } // do_ajax_detalle_devcompra_refresh_idpro_

  function do_ajax_detalle_devcompra_refresh_idpro__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalle_devcompra_refresh_idpro__cb

  // ---------- Event onchange cantidad_
  function do_ajax_detalle_devcompra_event_cantidad__onchange(iSeqForm)
  {
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_detalle_devcompra_event_cantidad__onchange(var_idpro_, var_colores_, var_tallas_, var_sabor_, var_valorunit_, var_cantidad_, var_valorpar_, var_descuento_, var_tasaiva_, var_iva_, var_script_case_init, var_nmgp_refresh_row, do_ajax_detalle_devcompra_event_cantidad__onchange_cb);
  } // do_ajax_detalle_devcompra_event_cantidad__onchange

  function do_ajax_detalle_devcompra_event_cantidad__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalle_devcompra_event_cantidad__onchange_cb_after_alert);
  } // do_ajax_detalle_devcompra_event_cantidad__onchange_cb
  function do_ajax_detalle_devcompra_event_cantidad__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detalle_devcompra_event_cantidad__onchange_cb_after_alert

  // ---------- Event onfocus cantidad_
  function do_ajax_detalle_devcompra_event_cantidad__onfocus(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn();
    x_ajax_detalle_devcompra_event_cantidad__onfocus(var_cantidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_detalle_devcompra_event_cantidad__onfocus_cb);
  } // do_ajax_detalle_devcompra_event_cantidad__onfocus

  function do_ajax_detalle_devcompra_event_cantidad__onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalle_devcompra_event_cantidad__onfocus_cb_after_alert);
  } // do_ajax_detalle_devcompra_event_cantidad__onfocus_cb
  function do_ajax_detalle_devcompra_event_cantidad__onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detalle_devcompra_event_cantidad__onfocus_cb_after_alert

  // ---------- Event onchange cod_barras_
  function do_ajax_detalle_devcompra_event_cod_barras__onchange(iSeqForm)
  {
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_detalle_devcompra_event_cod_barras__onchange(var_cod_barras_, var_idpro_, var_ver_, var_cantidad_, var_tasaiva_, var_valorunit_, var_valorpar_, var_iva_, var_tasadesc_, var_devuelto_, var_presentacion_, var_vencimiento_, var_lote_, var_serial_codbarra_, var_colores_, var_tallas_, var_sabor_, var_script_case_init, var_nmgp_refresh_row, do_ajax_detalle_devcompra_event_cod_barras__onchange_cb);
  } // do_ajax_detalle_devcompra_event_cod_barras__onchange

  function do_ajax_detalle_devcompra_event_cod_barras__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalle_devcompra_event_cod_barras__onchange_cb_after_alert);
  } // do_ajax_detalle_devcompra_event_cod_barras__onchange_cb
  function do_ajax_detalle_devcompra_event_cod_barras__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detalle_devcompra_event_cod_barras__onchange_cb_after_alert

  // ---------- Event onchange colores_
  function do_ajax_detalle_devcompra_event_colores__onchange(iSeqForm)
  {
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_detalle_devcompra_event_colores__onchange(var_script_case_init, var_nmgp_refresh_row, do_ajax_detalle_devcompra_event_colores__onchange_cb);
  } // do_ajax_detalle_devcompra_event_colores__onchange

  function do_ajax_detalle_devcompra_event_colores__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalle_devcompra_event_colores__onchange_cb_after_alert);
  } // do_ajax_detalle_devcompra_event_colores__onchange_cb
  function do_ajax_detalle_devcompra_event_colores__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detalle_devcompra_event_colores__onchange_cb_after_alert

  // ---------- Event onchange descuento_
  function do_ajax_detalle_devcompra_event_descuento__onchange(iSeqForm)
  {
    var var_valorpar_ = scAjaxGetFieldHidden("valorpar_" + iSeqForm);
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_detalle_devcompra_event_descuento__onchange(var_valorpar_, var_cantidad_, var_valorunit_, var_descuento_, var_tasaiva_, var_iva_, var_script_case_init, var_nmgp_refresh_row, do_ajax_detalle_devcompra_event_descuento__onchange_cb);
  } // do_ajax_detalle_devcompra_event_descuento__onchange

  function do_ajax_detalle_devcompra_event_descuento__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalle_devcompra_event_descuento__onchange_cb_after_alert);
  } // do_ajax_detalle_devcompra_event_descuento__onchange_cb
  function do_ajax_detalle_devcompra_event_descuento__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detalle_devcompra_event_descuento__onchange_cb_after_alert

  // ---------- Event onchange idpro_
  function do_ajax_detalle_devcompra_event_idpro__onchange(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_ver_ = scAjaxGetFieldHidden("ver_" + iSeqForm);
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_detalle_devcompra_event_idpro__onchange(var_idpro_, var_ver_, var_cantidad_, var_tasaiva_, var_valorunit_, var_valorpar_, var_iva_, var_tasadesc_, var_devuelto_, var_presentacion_, var_vencimiento_, var_lote_, var_serial_codbarra_, var_colores_, var_tallas_, var_sabor_, var_script_case_init, var_nmgp_refresh_row, do_ajax_detalle_devcompra_event_idpro__onchange_cb);
  } // do_ajax_detalle_devcompra_event_idpro__onchange

  function do_ajax_detalle_devcompra_event_idpro__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalle_devcompra_event_idpro__onchange_cb_after_alert);
  } // do_ajax_detalle_devcompra_event_idpro__onchange_cb
  function do_ajax_detalle_devcompra_event_idpro__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_detalle_devcompra_refresh_idpro_(iLineNumber);
    scAjaxRedir();
  } // do_ajax_detalle_devcompra_event_idpro__onchange_cb_after_alert

  // ---------- Event onchange porc_desc_
  function do_ajax_detalle_devcompra_event_porc_desc__onchange(iSeqForm)
  {
    var var_descuento_ = scAjaxGetFieldText("descuento_" + iSeqForm);
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_detalle_devcompra_event_porc_desc__onchange(var_descuento_, var_valorunit_, var_porc_desc_, var_valorpar_, var_cantidad_, var_tasaiva_, var_iva_, var_script_case_init, var_nmgp_refresh_row, do_ajax_detalle_devcompra_event_porc_desc__onchange_cb);
  } // do_ajax_detalle_devcompra_event_porc_desc__onchange

  function do_ajax_detalle_devcompra_event_porc_desc__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalle_devcompra_event_porc_desc__onchange_cb_after_alert);
  } // do_ajax_detalle_devcompra_event_porc_desc__onchange_cb
  function do_ajax_detalle_devcompra_event_porc_desc__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detalle_devcompra_event_porc_desc__onchange_cb_after_alert

  // ---------- Event onchange sabor_
  function do_ajax_detalle_devcompra_event_sabor__onchange(iSeqForm)
  {
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_detalle_devcompra_event_sabor__onchange(var_script_case_init, var_nmgp_refresh_row, do_ajax_detalle_devcompra_event_sabor__onchange_cb);
  } // do_ajax_detalle_devcompra_event_sabor__onchange

  function do_ajax_detalle_devcompra_event_sabor__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalle_devcompra_event_sabor__onchange_cb_after_alert);
  } // do_ajax_detalle_devcompra_event_sabor__onchange_cb
  function do_ajax_detalle_devcompra_event_sabor__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detalle_devcompra_event_sabor__onchange_cb_after_alert

  // ---------- Event onchange tallas_
  function do_ajax_detalle_devcompra_event_tallas__onchange(iSeqForm)
  {
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_detalle_devcompra_event_tallas__onchange(var_script_case_init, var_nmgp_refresh_row, do_ajax_detalle_devcompra_event_tallas__onchange_cb);
  } // do_ajax_detalle_devcompra_event_tallas__onchange

  function do_ajax_detalle_devcompra_event_tallas__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalle_devcompra_event_tallas__onchange_cb_after_alert);
  } // do_ajax_detalle_devcompra_event_tallas__onchange_cb
  function do_ajax_detalle_devcompra_event_tallas__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detalle_devcompra_event_tallas__onchange_cb_after_alert

  // ---------- Event onblur valorunit_
  function do_ajax_detalle_devcompra_event_valorunit__onblur(iSeqForm)
  {
    var var_valorpar_ = scAjaxGetFieldHidden("valorpar_" + iSeqForm);
    var var_descuento_ = scAjaxGetFieldText("descuento_" + iSeqForm);
    var var_iva_ = scAjaxGetFieldHidden("iva_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_detalle_devcompra_event_valorunit__onblur(var_valorpar_, var_descuento_, var_iva_, var_script_case_init, var_nmgp_refresh_row, do_ajax_detalle_devcompra_event_valorunit__onblur_cb);
  } // do_ajax_detalle_devcompra_event_valorunit__onblur

  function do_ajax_detalle_devcompra_event_valorunit__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalle_devcompra_event_valorunit__onblur_cb_after_alert);
  } // do_ajax_detalle_devcompra_event_valorunit__onblur_cb
  function do_ajax_detalle_devcompra_event_valorunit__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detalle_devcompra_event_valorunit__onblur_cb_after_alert

  // ---------- Event onchange valorunit_
  function do_ajax_detalle_devcompra_event_valorunit__onchange(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_valorpar_ = scAjaxGetFieldHidden("valorpar_" + iSeqForm);
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_detalle_devcompra_event_valorunit__onchange(var_cantidad_, var_valorpar_, var_valorunit_, var_descuento_, var_tasaiva_, var_iva_, var_script_case_init, var_nmgp_refresh_row, do_ajax_detalle_devcompra_event_valorunit__onchange_cb);
  } // do_ajax_detalle_devcompra_event_valorunit__onchange

  function do_ajax_detalle_devcompra_event_valorunit__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalle_devcompra_event_valorunit__onchange_cb_after_alert);
  } // do_ajax_detalle_devcompra_event_valorunit__onchange_cb
  function do_ajax_detalle_devcompra_event_valorunit__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detalle_devcompra_event_valorunit__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_detalle_devcompra_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_detalle_devcompra_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_detalle_devcompra_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_detalle_devcompra_add_new_line_cb);
  } // do_ajax_detalle_devcompra_add_new_line

  function do_ajax_detalle_devcompra_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_detalle_devcompra_add_new_line_cb

  // ---------- backup_line
  function do_ajax_detalle_devcompra_backup_line(iNumLinha)
  {
    var var_iddet_ = scAjaxGetFieldHidden("iddet_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalle_devcompra_backup_line(var_iddet_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_detalle_devcompra_backup_line_cb);
  } // do_ajax_detalle_devcompra_backup_line

  function do_ajax_detalle_devcompra_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_detalle_devcompra_backup_line_cb

  function do_ajax_detalle_devcompra_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_detalle_devcompra_cancel_insert

  function do_ajax_detalle_devcompra_cancel_update(iSeqVert)
  {
    do_ajax_detalle_devcompra_backup_line(iSeqVert);
...
?>
  } // do_ajax_detalle_devcompra_cancel_update

  function do_ajax_detalle_devcompra_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_detalle_devcompra_restore_buttons

  // ---------- table_refresh
  function do_ajax_detalle_devcompra_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_detalle_devcompra_table_refresh(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_detalle_devcompra_table_refresh_cb);
  } //  do_ajax_detalle_devcompra_table_refresh

  function do_ajax_detalle_devcompra_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_detalle_devcompra_table_refresh_cb_after_alert);
  } // do_ajax_detalle_devcompra_table_refresh_cb
  function do_ajax_detalle_devcompra_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_detalle_devcompra_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_detalle_devcompra_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_detalle_devcompra_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_num_ndevolucion_ = scAjaxGetFieldText("num_ndevolucion_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_detalle_devcompra_submit_form(var_cod_barras_, var_idpro_, var_ver_, var_colores_, var_tallas_, var_sabor_, var_cantidad_, var_presentacion_, var_valorunit_, var_porc_desc_, var_descuento_, var_valorpar_, var_iva_, var_idbod_, var_tasaiva_, var_tasadesc_, var_devuelto_, var_vencimiento_, var_lote_, var_serial_codbarra_, var_iddet_, var_idfaccom_, var_num_ndevolucion_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_detalle_devcompra_submit_form_cb);
  } // do_ajax_detalle_devcompra_submit_form

  function do_ajax_detalle_devcompra_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("num_ndevolucion_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalle_devcompra_submit_form_cb_after_alert);
  } // do_ajax_detalle_devcompra_submit_form_cb
  function do_ajax_detalle_devcompra_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_detalle_devcompra_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_detalle_devcompra_navigate_form()
  {
    perform_ajax_detalle_devcompra_navigate_form();
  }

  function perform_ajax_detalle_devcompra_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("num_ndevolucion_" + iNavForm);
    }
    var var_iddet_ = document.F2.iddet_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_detalle_devcompra_navigate_form(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_detalle_devcompra_navigate_form_cb);
  } // do_ajax_detalle_devcompra_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_detalle_devcompra_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_detalle_devcompra_navigate_form_cb_after_alert);
  } // do_ajax_detalle_devcompra_navigate_form_cb
  function do_ajax_detalle_devcompra_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_detalle_devcompra_navigate_form_cb_after_alert
  function sc_hide_detalle_devcompra_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "num_ndevolucion_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["iva_" + iNumLinha] = {"label": "Valor de IVA<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["num_ndevolucion_" + iNumLinha] = {"label": "Num Ndevolucion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["num_ndevolucion_"][iNumLinha] = "num_ndevolucion_" + iNumLinha;
    ...
    ajax_field_id["ver_" + iNumLinha] = new Array("hidden_field_label_ver_", "hidden_field_data_ver_" + iNumLinha);
    ...
    ajax_field_id["vencimiento_" + iNumLinha] = new Array("hidden_field_label_vencimiento_", "hidden_field_data_vencimiento_" + iNumLinha);
    ajax_field_id["lote_" + iNumLinha] = new Array("hidden_field_label_lote_", "hidden_field_data_lote_" + iNumLinha);
    ajax_field_id["serial_codbarra_" + iNumLinha] = new Array("hidden_field_label_serial_codbarra_", "hidden_field_data_serial_codbarra_" + iNumLinha);
    ...
    ajax_error_count["num_ndevolucion_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["num_ndevolucion_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["num_ndevolucion_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["num_ndevolucion_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["num_ndevolucion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["num_ndevolucion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["num_ndevolucion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["num_ndevolucion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["num_ndevolucion_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['num_ndevolucion_'])) ? $this->nmgp_cmp_readonly['num_ndevolucion_'] : 'off';
?>
    scAjaxFieldRead("num_ndevolucion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("num_ndevolucion_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["cod_barras_" + iRow] || "on" == ajax_error_count["idpro_" + iRow] || "on" == ajax_error_count["ver_" + iRow] || "on" == ajax_error_count["colores_" + iRow] || "on" == ajax_error_count["tallas_" + iRow] || "on" == ajax_error_count["sabor_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["presentacion_" + iRow] || "on" == ajax_error_count["valorunit_" + iRow] || "on" == ajax_error_count["porc_desc_" + iRow] || "on" == ajax_error_count["descuento_" + iRow] || "on" == ajax_error_count["valorpar_" + iRow] || "on" == ajax_error_count["iva_" + iRow] || "on" == ajax_error_count["idbod_" + iRow] || "on" == ajax_error_count["tasaiva_" + iRow] || "on" == ajax_error_count["tasadesc_" + iRow] || "on" == ajax_error_count["devuelto_" + iRow] || "on" == ajax_error_count["vencimiento_" + iRow] || "on" == ajax_error_count["lote_" + iRow] || "on" == ajax_error_count["serial_codbarra_" + iRow] || "on" == ajax_error_count["iddet_" + iRow] || "on" == ajax_error_count["idfaccom_" + iRow] || "on" == ajax_error_count["num_ndevolucion_" + iRow]))
    {
      ...
      $("#hidden_field_data_num_ndevolucion_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["cod_barras_" + iRow] && "off" == ajax_error_count["idpro_" + iRow] && "off" == ajax_error_count["ver_" + iRow] && "off" == ajax_error_count["colores_" + iRow] && "off" == ajax_error_count["tallas_" + iRow] && "off" == ajax_error_count["sabor_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["presentacion_" + iRow] && "off" == ajax_error_count["valorunit_" + iRow] && "off" == ajax_error_count["porc_desc_" + iRow] && "off" == ajax_error_count["descuento_" + iRow] && "off" == ajax_error_count["valorpar_" + iRow] && "off" == ajax_error_count["iva_" + iRow] && "off" == ajax_error_count["idbod_" + iRow] && "off" == ajax_error_count["tasaiva_" + iRow] && "off" == ajax_error_count["tasadesc_" + iRow] && "off" == ajax_error_count["devuelto_" + iRow] && "off" == ajax_error_count["vencimiento_" + iRow] && "off" == ajax_error_count["lote_" + iRow] && "off" == ajax_error_count["serial_codbarra_" + iRow] && "off" == ajax_error_count["iddet_" + iRow] && "off" == ajax_error_count["idfaccom_" + iRow] && "off" == ajax_error_count["num_ndevolucion_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["num_ndevolucion_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_num_ndevolucion_" + iRow).removeClass("scFormErrorLine");
    }
  }
