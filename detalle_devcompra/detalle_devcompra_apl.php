...
class detalle_devcompra_apl
{
   ...
   var $form_vert_detalle_devcompra = array();
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['num_ndevolucion_']))
          {
              $this->num_ndevolucion_ = $this->NM_ajax_info['param']['num_ndevolucion_'];
          }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_idfaccom)) 
          {
              $_SESSION['par_idfaccom'] = $this->par_idfaccom;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new detalle_devcompra_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['initialize'])
          {
              $_SESSION['scriptcase']['detalle_devcompra']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['detalle_devcompra']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['detalle_devcompra']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['detalle_devcompra']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['detalle_devcompra'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['detalle_devcompra']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['detalle_devcompra']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('detalle_devcompra') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['detalle_devcompra']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - detallecompra";
      ...
      $_SESSION['scriptcase']['error_icon']['detalle_devcompra']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['detalle_devcompra'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_orig'] = " where num_ndevolucion=" . $_SESSION['par_idfaccom'] . "
and cantidad <0";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_pesq'] = " where num_ndevolucion=" . $_SESSION['par_idfaccom'] . "
and cantidad <0";
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalle_devcompra']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['detalle_devcompra'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['detalle_devcompra'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['exit'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("detalle_devcompra", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'detalle_devcompra_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'detalle_devcompra_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'detalle_devcompra/detalle_devcompra_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "detalle_devcompra_erro.class.php"); 
      }
      $this->Erro      = new detalle_devcompra_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_max_reg']) == "all")
      {
      ...
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['opcao']))
         { 
             if ($this->iddet_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['final'];
      }
      else
      {
      }
...
$_SESSION['scriptcase']['detalle_devcompra']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['detalle_devcompra']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['detalle_devcompra']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($this->num_ndevolucion_)) { $this->nm_limpa_alfa($this->num_ndevolucion_); }
         if (isset($this->Sc_num_lin_alt) && $this->Sc_num_lin_alt > 0) 
         {
             $sc_seq_vert = $this->Sc_num_lin_alt;
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_form'][$sc_seq_vert];
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_detalle_devcompra']) || !is_array($this->NM_ajax_info['errList']['geral_detalle_devcompra']))
                  {
                      $this->NM_ajax_info['errList']['geral_detalle_devcompra'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_detalle_devcompra'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_detalle_devcompra'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_detalle_devcompra'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_redir_atualiz'] == "ok")
          {
      ...
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
         ...
         $Campos_Erros = array();
          ...
          if ('validate_num_ndevolucion_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'num_ndevolucion_');
          }
          detalle_devcompra_pack_ajax_response();
          exit;
      }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(detalle_devcompra_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', detalle_devcompra_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      { 
         ...
         $this->num_ndevolucion_ = $GLOBALS["num_ndevolucion_" . $sc_seq_vert]; 
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_form'][$sc_seq_vert];
             $this->descr_ = $this->nmgp_dados_form['descr_']; 
         ...
         if (isset($this->porc_desc_)) { $this->nm_limpa_alfa($this->porc_desc_); }
         if (isset($this->num_ndevolucion_)) { $this->nm_limpa_alfa($this->num_ndevolucion_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert];
         }
         if ($this->nmgp_opcao != "recarga" && (!in_array($sc_seq_vert, $sc_check_excl) && !in_array($sc_seq_vert, $sc_check_incl) ))
         { }
         else
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['cod_barras_'] =  $this->cod_barras_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['ver_'] =  $this->ver_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['colores_'] =  $this->colores_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['tallas_'] =  $this->tallas_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['sabor_'] =  $this->sabor_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['cantidad_'] =  $this->cantidad_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['presentacion_'] =  $this->presentacion_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['valorunit_'] =  $this->valorunit_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['porc_desc_'] =  $this->porc_desc_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['descuento_'] =  $this->descuento_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['valorpar_'] =  $this->valorpar_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['iva_'] =  $this->iva_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['idbod_'] =  $this->idbod_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['tasaiva_'] =  $this->tasaiva_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['tasadesc_'] =  $this->tasadesc_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['devuelto_'] =  $this->devuelto_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['vencimiento_'] =  $this->vencimiento_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['lote_'] =  $this->lote_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['serial_codbarra_'] =  $this->serial_codbarra_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['iddet_'] =  $this->iddet_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['idfaccom_'] =  $this->idfaccom_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['num_ndevolucion_'] =  $this->num_ndevolucion_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['descr_'] =  $this->descr_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['fecha_fab_'] =  $this->fecha_fab_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['unidad_c_'] =  $this->unidad_c_; 
         }
         $sc_seq_vert++; 
      } 
...
$_SESSION['scriptcase']['detalle_devcompra']['contr_erro'] = 'off'; 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_detalle_devcompra);
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "detalle_devcompra.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="detalle_devcompra_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="detalle_devcompra"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_detalle_devcompra'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'num_ndevolucion_' == $filtro)) || (is_array($filtro) && in_array('num_ndevolucion_', $filtro)))
        $this->ValidateField_num_ndevolucion_($Campos_Crit, $Campos_Falta, $Campos_Erros);
//-- converter datas   
          $this->nm_converte_datas();
//---
...
if(isset($this->ds_fls[0][0]) and $this->ds_fls[0][0]=='SI' )
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_detalle_devcompra';
...
;
    ...
    function ValidateField_colores_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->colores_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['Lookup_colores_']) && !in_array($this->colores_, $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['Lookup_colores_']))
               {
                   $hasError = true;
    ...
    function ValidateField_tallas_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->tallas_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['Lookup_tallas_']) && !in_array($this->tallas_, $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['Lookup_tallas_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_sabor_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->sabor_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['Lookup_sabor_']) && !in_array($this->sabor_, $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['Lookup_sabor_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cantidad_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              elseif ('-' == substr($this->cantidad_, -1))
              {
                  $iTestSize++;
                  $this->cantidad_ = '-' . substr($this->cantidad_, 0, -1);
              }
              ...
              if ($teste_validade->Valor($this->cantidad_, 10, 2, 0, 0, "S") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_valorpar_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              elseif ('-' == substr($this->valorpar_, -1))
              {
                  $iTestSize++;
                  $this->valorpar_ = '-' . substr($this->valorpar_, 0, -1);
              }
              ...
              if ($teste_validade->Valor($this->valorpar_, 10, 2, 0, 0, "S") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_iva_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              elseif ('-' == substr($this->iva_, -1))
              {
                  $iTestSize++;
                  $this->iva_ = '-' . substr($this->iva_, 0, -1);
              }
              ...
              if ($teste_validade->Valor($this->iva_, 11, 0, 0, 0, "S") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_idbod_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idbod_ == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['php_cmp_required']['idbod_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['php_cmp_required']['idbod_'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idbod_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['Lookup_idbod_']) && !in_array($this->idbod_, $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['Lookup_idbod_']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idbod_']))
    ...
    function ValidateField_idfaccom_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['php_cmp_required']['idfaccom_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['php_cmp_required']['idfaccom_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_num_ndevolucion_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->num_ndevolucion_ != '')  
          { 
              $iTestSize = 20;
              if (strlen($this->num_ndevolucion_) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Num Ndevolucion: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['num_ndevolucion_']))
                  {
                      $Campos_Erros['num_ndevolucion_'] = array();
                  }
                  $Campos_Erros['num_ndevolucion_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['num_ndevolucion_']) || !is_array($this->NM_ajax_info['errList']['num_ndevolucion_']))
                  {
                      $this->NM_ajax_info['errList']['num_ndevolucion_'] = array();
                  }
                  $this->NM_ajax_info['errList']['num_ndevolucion_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->num_ndevolucion_, 20, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Num Ndevolucion; " ; 
                  if (!isset($Campos_Erros['num_ndevolucion_']))
                  {
                      $Campos_Erros['num_ndevolucion_'] = array();
                  }
                  $Campos_Erros['num_ndevolucion_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['num_ndevolucion_']) || !is_array($this->NM_ajax_info['errList']['num_ndevolucion_']))
                  {
                      $this->NM_ajax_info['errList']['num_ndevolucion_'] = array();
                  }
                  $this->NM_ajax_info['errList']['num_ndevolucion_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'num_ndevolucion_';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_num_ndevolucion_
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
      ...
      if ('' !== $this->num_ndevolucion_ || (!empty($format_fields) && isset($format_fields['num_ndevolucion_'])))
      {
          nmgp_Form_Num_Val($this->num_ndevolucion_, $this->field_config['num_ndevolucion_']['symbol_grp'], $this->field_config['num_ndevolucion_']['symbol_dec'], "0", "S", $this->field_config['num_ndevolucion_']['format_neg'], "", "", "-", $this->field_config['num_ndevolucion_']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['iddet_']['keyVal'] = detalle_devcompra_pack_protect_string($this->nmgp_dados_form['iddet_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['cod_barras_'] = $this->cod_barras_;
                  }
                  if (isset($this->NM_ajax_changed['idpro_']) && $this->NM_ajax_changed['idpro_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['idpro_'] = $this->idpro_;
                  }
                  if (isset($this->NM_ajax_changed['ver_']) && $this->NM_ajax_changed['ver_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['ver_'] = $this->ver_;
                  }
                  if (isset($this->NM_ajax_changed['colores_']) && $this->NM_ajax_changed['colores_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['colores_'] = $this->colores_;
                  }
                  if (isset($this->NM_ajax_changed['tallas_']) && $this->NM_ajax_changed['tallas_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['tallas_'] = $this->tallas_;
                  }
                  if (isset($this->NM_ajax_changed['sabor_']) && $this->NM_ajax_changed['sabor_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['sabor_'] = $this->sabor_;
                  }
                  if (isset($this->NM_ajax_changed['cantidad_']) && $this->NM_ajax_changed['cantidad_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['cantidad_'] = $this->cantidad_;
                  }
                  if (isset($this->NM_ajax_changed['presentacion_']) && $this->NM_ajax_changed['presentacion_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['presentacion_'] = $this->presentacion_;
                  }
                  if (isset($this->NM_ajax_changed['valorunit_']) && $this->NM_ajax_changed['valorunit_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['valorunit_'] = $this->valorunit_;
                  }
                  if (isset($this->NM_ajax_changed['porc_desc_']) && $this->NM_ajax_changed['porc_desc_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['porc_desc_'] = $this->porc_desc_;
                  }
                  if (isset($this->NM_ajax_changed['descuento_']) && $this->NM_ajax_changed['descuento_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['descuento_'] = $this->descuento_;
                  }
                  if (isset($this->NM_ajax_changed['valorpar_']) && $this->NM_ajax_changed['valorpar_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['valorpar_'] = $this->valorpar_;
                  }
                  if (isset($this->NM_ajax_changed['iva_']) && $this->NM_ajax_changed['iva_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['iva_'] = $this->iva_;
                  }
                  if (isset($this->NM_ajax_changed['idbod_']) && $this->NM_ajax_changed['idbod_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['idbod_'] = $this->idbod_;
                  }
                  if (isset($this->NM_ajax_changed['tasaiva_']) && $this->NM_ajax_changed['tasaiva_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['tasaiva_'] = $this->tasaiva_;
                  }
                  if (isset($this->NM_ajax_changed['tasadesc_']) && $this->NM_ajax_changed['tasadesc_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['tasadesc_'] = $this->tasadesc_;
                  }
                  if (isset($this->NM_ajax_changed['devuelto_']) && $this->NM_ajax_changed['devuelto_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['devuelto_'] = $this->devuelto_;
                  }
                  if (isset($this->NM_ajax_changed['vencimiento_']) && $this->NM_ajax_changed['vencimiento_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['vencimiento_'] = $this->vencimiento_;
                  }
                  if (isset($this->NM_ajax_changed['lote_']) && $this->NM_ajax_changed['lote_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['lote_'] = $this->lote_;
                  }
                  if (isset($this->NM_ajax_changed['serial_codbarra_']) && $this->NM_ajax_changed['serial_codbarra_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['serial_codbarra_'] = $this->serial_codbarra_;
                  }
                  if (isset($this->NM_ajax_changed['iddet_']) && $this->NM_ajax_changed['iddet_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['iddet_'] = $this->iddet_;
                  }
                  if (isset($this->NM_ajax_changed['idfaccom_']) && $this->NM_ajax_changed['idfaccom_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['idfaccom_'] = $this->idfaccom_;
                  }
                  if (isset($this->NM_ajax_changed['num_ndevolucion_']) && $this->NM_ajax_changed['num_ndevolucion_'])
                  {
                      $this->form_vert_detalle_devcompra[$this->nmgp_refresh_row]['num_ndevolucion_'] = $this->num_ndevolucion_;
                  }
              }
          }
          ...
          foreach($this->form_vert_detalle_devcompra as $sc_seq_vert => $aRecData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['idpro_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][detalle_devcompra_pack_protect_string($aRecData['idpro_'])]),
              );
              }
...
$aLookup[] = array(detalle_devcompra_pack_protect_string('0') => str_replace('<', '&lt;',detalle_devcompra_pack_protect_string(' ')));
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['colores_' . $sc_seq_vert]['valList'][$i] = detalle_devcompra_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tallas_' . $sc_seq_vert]['valList'][$i] = detalle_devcompra_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['sabor_' . $sc_seq_vert]['valList'][$i] = detalle_devcompra_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idbod_' . $sc_seq_vert]['valList'][$i] = detalle_devcompra_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          $aLookupOrig = $aLookup;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("num_ndevolucion_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['num_ndevolucion_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['num_ndevolucion_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->iddet_)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
$sql="select idinv from inventario where idpro=$vElidp and idfaccom=$idfaco and detalle like'%Devolución-Compra%' and iddetalle='".$this->iddet_ ."'";
...
$_SESSION['scriptcase']['detalle_devcompra']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['idpro_'] = $this->idpro_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['colores_'] = $this->colores_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['tallas_'] = $this->tallas_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['sabor_'] = $this->sabor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['cantidad_'] = $this->cantidad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['valorunit_'] = $this->valorunit_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['porc_desc_'] = $this->porc_desc_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['descuento_'] = $this->descuento_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['valorpar_'] = $this->valorpar_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['iva_'] = $this->iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['idbod_'] = $this->idbod_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['tasaiva_'] = $this->tasaiva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['tasadesc_'] = $this->tasadesc_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['devuelto_'] = $this->devuelto_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['vencimiento_'] = $this->vencimiento_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['lote_'] = $this->lote_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['serial_codbarra_'] = $this->serial_codbarra_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['iddet_'] = $this->iddet_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['idfaccom_'] = $this->idfaccom_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert]['num_ndevolucion_'] = $this->num_ndevolucion_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "idfaccom = $this->idfaccom_, idpro = $this->idpro_, idbod = $this->idbod_, cantidad = $this->cantidad_, valorunit = $this->valorunit_, valorpar = $this->valorpar_, iva = $this->iva_, descuento = $this->descuento_, tasaiva = $this->tasaiva_, tasadesc = $this->tasadesc_, devuelto = $this->devuelto_, colores = $this->colores_, tallas = $this->tallas_, sabor = $this->sabor_, vencimiento = #$this->vencimiento_#, lote = '$this->lote_', serial_codbarra = '$this->serial_codbarra_', porc_desc = $this->porc_desc_, num_ndevolucion = $this->num_ndevolucion_"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "idfaccom = $this->idfaccom_, idpro = $this->idpro_, idbod = $this->idbod_, cantidad = $this->cantidad_, valorunit = $this->valorunit_, valorpar = $this->valorpar_, iva = $this->iva_, descuento = $this->descuento_, tasaiva = $this->tasaiva_, tasadesc = $this->tasadesc_, devuelto = $this->devuelto_, colores = $this->colores_, tallas = $this->tallas_, sabor = $this->sabor_, vencimiento = " . $this->Ini->date_delim . $this->vencimiento_ . $this->Ini->date_delim1 . ", lote = '$this->lote_', serial_codbarra = '$this->serial_codbarra_', porc_desc = $this->porc_desc_, num_ndevolucion = $this->num_ndevolucion_"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "idfaccom = $this->idfaccom_, idpro = $this->idpro_, idbod = $this->idbod_, cantidad = $this->cantidad_, valorunit = $this->valorunit_, valorpar = $this->valorpar_, iva = $this->iva_, descuento = $this->descuento_, tasaiva = $this->tasaiva_, tasadesc = $this->tasadesc_, devuelto = $this->devuelto_, colores = $this->colores_, tallas = $this->tallas_, sabor = $this->sabor_, vencimiento = EXTEND('$this->vencimiento_', YEAR TO DAY), lote = '$this->lote_', serial_codbarra = '$this->serial_codbarra_', porc_desc = $this->porc_desc_, num_ndevolucion = $this->num_ndevolucion_"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['num_ndevolucion_'])) { $this->num_ndevolucion_ = $NM_val_form['num_ndevolucion_']; }
              elseif (isset($this->num_ndevolucion_)) { $this->nm_limpa_alfa($this->num_ndevolucion_); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('cod_barras_', 'idpro_', 'ver_', 'colores_', 'tallas_', 'sabor_', 'cantidad_', 'presentacion_', 'valorunit_', 'porc_desc_', 'descuento_', 'valorpar_', 'iva_', 'idbod_', 'tasaiva_', 'tasadesc_', 'devuelto_', 'vencimiento_', 'lote_', 'serial_codbarra_', 'iddet_', 'idfaccom_', 'num_ndevolucion_'), $aDoNotUpdate);
              ...
              if (isset($this->Embutida_ronly) && $this->Embutida_ronly)
              {
                  ...
                  $this->NM_ajax_info['readOnly']['num_ndevolucion_' . $this->nmgp_refresh_row] = 'on';
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == detalle_devcompra_pack_protect_string(NM_charset_to_utf8($this->colores_)))
              {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == detalle_devcompra_pack_protect_string(NM_charset_to_utf8($this->tallas_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == detalle_devcompra_pack_protect_string(NM_charset_to_utf8($this->sabor_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == detalle_devcompra_pack_protect_string(NM_charset_to_utf8($this->idbod_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
          $tmpLabel_idbod_ = $sLabelTemp;
                  ...
                  $this->NM_ajax_info['fldList']['num_ndevolucion_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['num_ndevolucion_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->num_ndevolucion_)));
                  $this->NM_ajax_info['fldList']['num_ndevolucion_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_num_ndevolucion_)));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['num_ndevolucion_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['num_ndevolucion_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] = 0; 
              }
...
if($Vfechavenc!='')
	...
	if($vLote!='')
     ...
     $nm_select ="INSERT inventario SET fecha='$this->ds', cantidad=$this->cantidad_ , idpro=$this->idpro_ , costo=$this->valorunit_ , valorparcial=$this->valorpar_ , idbod=$this->idbod_ , tipo=1, detalle='Compra', idmov=1, idfaccom=$this->idfaccom_ , nufacvta=0, iddetalle=$last_id, fechavenc=$Vfechavenc, colores=$this->colores_ , tallas=$this->tallas_ , sabor=$this->sabor_ , codigobar_2='$vSerial', lote2='$vLote'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT inventario SET fecha='$this->ds', cantidad=$this->cantidad_ , idpro=$this->idpro_ , costo=$this->valorunit_ , valorparcial=$this->valorpar_ , idbod=$this->idbod_ , tipo=1, detalle='Compra', idmov=1, idfaccom=$this->idfaccom_ , nufacvta=0, iddetalle=$last_id, fechavenc=$Vfechavenc, colores=$this->colores_ , tallas=$this->tallas_ , sabor=$this->sabor_ , lote2='$vLote'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT inventario SET fecha='$this->ds', cantidad=$this->cantidad_ , idpro=$this->idpro_ , costo=$this->valorunit_ , valorparcial=$this->valorpar_ , idbod=$this->idbod_ , tipo=1, detalle='Compra', idmov=1, idfaccom=$this->idfaccom_ , nufacvta=0, iddetalle=$last_id, fechavenc=$Vfechavenc, colores=$this->colores_ , tallas=$this->tallas_ , sabor=$this->sabor_ , codigobar_2='$vSerial' "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT inventario SET fecha='$this->ds', cantidad=$this->cantidad_ , idpro=$this->idpro_ , costo=$this->valorunit_ , valorparcial=$this->valorpar_ , idbod=$this->idbod_ , tipo=1, detalle='Compra', idmov=1, idfaccom=$this->idfaccom_ , nufacvta=0, iddetalle=$last_id, fechavenc=$Vfechavenc, colores=$this->colores_ , tallas=$this->tallas_ , sabor=$this->sabor_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	if($vLote!='')
     ...
     $nm_select ="INSERT inventario SET fecha='$this->ds', cantidad=$this->cantidad_ , idpro=$this->idpro_ , costo=$this->valorunit_ , valorparcial=$this->valorpar_ , idbod=$this->idbod_ , tipo=1, detalle='Compra', idmov=1, idfaccom=$this->idfaccom_ , nufacvta=0, iddetalle=$last_id,  colores=$this->colores_ , tallas=$this->tallas_ , sabor=$this->sabor_ , codigobar_2='$vSerial', lote2='$vLote'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT inventario SET fecha='$this->ds', cantidad=$this->cantidad_ , idpro=$this->idpro_ , costo=$this->valorunit_ , valorparcial=$this->valorpar_ , idbod=$this->idbod_ , tipo=1, detalle='Compra', idmov=1, idfaccom=$this->idfaccom_ , nufacvta=0, iddetalle=$last_id, colores=$this->colores_ , tallas=$this->tallas_ , sabor=$this->sabor_ , lote2='$vLote'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT inventario SET fecha='$this->ds', cantidad=$this->cantidad_ , idpro=$this->idpro_ , costo=$this->valorunit_ , valorparcial=$this->valorpar_ , idbod=$this->idbod_ , tipo=1, detalle='Compra', idmov=1, idfaccom=$this->idfaccom_ , nufacvta=0, iddetalle=$last_id, colores=$this->colores_ , tallas=$this->tallas_ , sabor=$this->sabor_ , codigobar_2='$vSerial' "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT inventario SET fecha='$this->ds', cantidad=$this->cantidad_ , idpro=$this->idpro_ , costo=$this->valorunit_ , valorparcial=$this->valorpar_ , idbod=$this->idbod_ , tipo=1, detalle='Compra', idmov=1, idfaccom=$this->idfaccom_ , nufacvta=0, iddetalle=$last_id,  colores=$this->colores_ , tallas=$this->tallas_ , sabor=$this->sabor_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_idfaccom_ = $this->idfaccom_;
    $original_idpro_ = $this->idpro_;
    $original_num_ndevolucion_ = $this->num_ndevolucion_;
    $original_sabor_ = $this->sabor_;
    $original_tallas_ = $this->tallas_;
    $original_valorpar_ = $this->valorpar_;
    $original_valorunit_ = $this->valorunit_;
  ...
  $vIddet=$this->iddet_ ;
      ...
      $nm_select = "select idpro from detallecompra where iddet=$vIddet"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds_p = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
...
$Vcosto=0;
      ...
      $nm_select = "select idinv from inventario where detalle='Devolución-Compra' and idfaccom='".$this->idfaccom_ ."' and iddetalle='".$this->iddet_ ."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->d_inv = array();
     if ($this->idfaccom_ != "" && $this->iddet_ != "")
     { 
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
...
if(isset($this->d_inv[0][0]))
	{
     ...
     $nm_select ="UPDATE inventario SET cantidad=$this->cantidad_ , idpro=$Vidpro, costo=$this->valorunit_ , valorparcial=$this->valorpar_ , idbod=$this->idbod_  WHERE detalle like'%Devolución-Compra%' and idfaccom=$idfaco and iddetalle=$this->iddet_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	{
	$sql="SELECT fechacom FROM facturacom WHERE idfaccom='".$this->num_ndevolucion_ ."'";
...
;
	...
	$Vcosto=$this->valorunit_ -$this->descuento_ ;
	
     $nm_select ="INSERT inventario SET fecha='$fec', cantidad='".$this->cantidad_ ."', idpro=$Vidpro, costo=$Vcosto, 	valorparcial='".$this->valorpar_ ."', idbod='".$this->idbod_ ."', tipo=2, detalle='Devolución-Compra', idmov=1, idfaccom='".$this->idfaccom_ ."', nufacvta=0, iddetalle='".$this->iddet_ ."', colores='".$this->colores_ ."', tallas='".$this->tallas_ ."', sabor='".$this->sabor_ ."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
      ...
      $nm_select = "select stockmen from productos where idprod=$Vidpro"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vPro = array();
      $this->vpro = array();
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->vPro[$SCy] [$SCx] = $SCrx->fields[$SCx];
                      $this->vpro[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vPro = false;
          $this->vPro_erro = $this->Db->ErrorMsg();
          $this->vpro = false;
          $this->vpro_erro = $this->Db->ErrorMsg();
      } 
;
	if(isset($this->vpro[0][0]))
		{
		$existencia=$this->vpro[0][0]+$this->cantidad_ ;
		
     $nm_select ="UPDATE productos SET stockmen = $existencia WHERE idprod=$Vidpro"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_num_ndevolucion_ != $this->num_ndevolucion_ || (isset($bFlagRead_num_ndevolucion_) && $bFlagRead_num_ndevolucion_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['num_ndevolucion_' . $this->nmgp_refresh_row]['type']    = 'text';
        $this->NM_ajax_info['fldList']['num_ndevolucion_' . $this->nmgp_refresh_row]['valList'] = array($this->num_ndevolucion_);
        $this->NM_ajax_changed['num_ndevolucion_'] = true;
    }
    if (($original_sabor_ != $this->sabor_ || (isset($bFlagRead_sabor_) && $bFlagRead_sabor_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['sabor_' . $this->nmgp_refresh_row]['type']    = 'select';
...
$_SESSION['scriptcase']['detalle_devcompra']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['parms'] = "iddet_?#?$this->iddet_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['detalle_devcompra']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_detalle_devcompra = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter'] . ")";
          }
      }
      $sc_where = trim("num_ndevolucion=" . $_SESSION['par_idfaccom'] . "
and cantidad <0");
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['total']))
          {
              ...
              $qt_geral_reg_detalle_devcompra = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['total'] = $qt_geral_reg_detalle_devcompra;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['total']) || $this->sc_teve_excl || $this->sc_teve_incl)
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->iddet_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_detalle_devcompra = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_detalle_devcompra) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] += $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] > $qt_geral_reg_detalle_devcompra)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] = $qt_geral_reg_detalle_devcompra - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] = ($qt_geral_reg_detalle_devcompra + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['ordem_ord']; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
      ...
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['run_iframe'] == "R")
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              $rs = $this->Db->Execute($nmgp_select) ; 
          } 
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['parms'] = "iddet_?#?$this->iddet_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['cod_barras_'] =  $this->cod_barras_; 
             $this->form_vert_detalle_devcompra[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
          ...
          ksort ($this->form_vert_detalle_devcompra); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          {
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['total'] + 1; 
          }
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] < (($qt_geral_reg_detalle_devcompra + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['embutida_multi']) 
          { 
          } 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['reg_start'] + $this->sc_max_reg;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$proid=$this->idpro_ ;
$cost=$this->valorunit_ ;
if(($this->sc_temp_edit_cantidad*-1)>($this->cantidad_ *-1))
{
	$sql="UPDATE productos SET stockmen = (SELECT SUM(cantidad) FROM inventario WHERE idpro=$proid) WHERE idprod=$proid";
...
$IdDet=$this->iddet_ ; 
      ...
      $nm_select = "select idinv from inventario where idpro=$proid and detalle='Devolución-Compra' and iddetalle=$IdDet"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds_inv = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
...
if(isset($this->ds_inv[0][0]))
	{
	$sql_costo="select costo from inventario where idpro=$this->idpro_  and detalle like 'Devolución-Compra' order by idinv desc limit 1,1";
...
$this->nm_formatar_campos('idpro_', 'colores_', 'tallas_', 'sabor_', 'valorunit_', 'cantidad_', 'valorpar_', 'descuento_', 'tasaiva_', 'iva_');
...
$modificado_tallas_ = $this->tallas_;
$modificado_sabor_ = $this->sabor_;
$this->nm_formatar_campos('cod_barras_', 'idpro_', 'ver_', 'cantidad_', 'tasaiva_', 'valorunit_', 'valorpar_', 'iva_', 'tasadesc_', 'devuelto_', 'presentacion_', 'vencimiento_', 'lote_', 'serial_codbarra_', 'colores_', 'tallas_', 'sabor_');
$this->nmgp_refresh_fields = array();
...
$modificado_tallas_ = $this->tallas_;
$modificado_sabor_ = $this->sabor_;
$this->nm_formatar_campos('idpro_', 'ver_', 'cantidad_', 'tasaiva_', 'valorunit_', 'valorpar_', 'iva_', 'tasadesc_', 'devuelto_', 'presentacion_', 'vencimiento_', 'lote_', 'serial_codbarra_', 'colores_', 'tallas_', 'sabor_');
$this->nmgp_refresh_fields = array();
if ($original_idpro_ !== $modificado_idpro_ || isset($this->nmgp_cmp_readonly['idpro_']) || (isset($bFlagRead_idpro_) && $bFlagRead_idpro_))
{
    $this->nmgp_refresh_fields[] = 'idpro_';
...
$sql="SELECT sum(valorpar), sum(iva) FROM detallecompra WHERE num_ndevolucion=$this->sc_temp_par_idfaccom";
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter_form'] . " and (num_ndevolucion=" . $_SESSION['par_idfaccom'] . "
and cantidad <0) and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where num_ndevolucion=" . $_SESSION['par_idfaccom'] . "
and cantidad <0 and (" . $comando . ")";
      }
      $nmgp_select = "SELECT count(*) AS countTest from " . $this->Ini->nm_tabela . $sc_where; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      ...
      $qt_geral_reg_detalle_devcompra = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['total'] = $qt_geral_reg_detalle_devcompra;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          detalle_devcompra_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "detalle_devcompra_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['nm_run_menu'] = 2;
       $nmgp_saida_form = "detalle_devcompra_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['masterValue']))
{
  ...
  exit;
    ...
    function sc_set_focus($sFieldName)
    {
        ...
        $aFocus = array(
                        ...
                        'iddet' => 'iddet_',
                        'idfaccom' => 'idfaccom_',
                        'num_ndevolucion' => 'num_ndevolucion_',
                       );
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['detalle_devcompra']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
