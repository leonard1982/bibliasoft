<?php
@session_start() ;
$_SESSION['scriptcase']['grid_saldo_terceros']['sc_process_barr'] = true;
require_once('../grid_saldo_terceros/index.php');
unset($_SESSION['scriptcase']['grid_saldo_terceros']['sc_process_barr']);
$ExportCtrl = new grid_saldo_terceros_export_control;
$ExportCtrl->Export_barr();

class grid_saldo_terceros_export_control
{
