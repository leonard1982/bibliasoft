...
*/
    ...
    $SC_apl_proc = "reporte_recibos_ing_caja";
    $SC_ver_93   = true;
    $SC_conf_opt = explode(",","tem_res_cons,tem_res_res,cor_imp,papel,orientacao,bookmarks");
/* sc_apl_default */
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['reporte_recibos_ing_caja']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['reporte_recibos_ing_caja']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
...
<?php
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['reporte_recibos_ing_caja']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['reporte_recibos_ing_caja']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
