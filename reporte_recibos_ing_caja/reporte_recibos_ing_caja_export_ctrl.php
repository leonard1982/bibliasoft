<?php
@session_start() ;
$_SESSION['scriptcase']['reporte_recibos_ing_caja']['sc_process_barr'] = true;
require_once('../reporte_recibos_ing_caja/index.php');
unset($_SESSION['scriptcase']['reporte_recibos_ing_caja']['sc_process_barr']);
$ExportCtrl = new reporte_recibos_ing_caja_export_control;
$ExportCtrl->Export_barr();

class reporte_recibos_ing_caja_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['reporte_recibos_ing_caja']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['reporte_recibos_ing_caja']['glo_nm_path_imag_temp'];
