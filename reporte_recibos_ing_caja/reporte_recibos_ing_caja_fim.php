...
//----- 
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>reporte_recibos_ing_caja</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ing_caja']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'reporte_recibos_ing_caja' || $achou)
          {
