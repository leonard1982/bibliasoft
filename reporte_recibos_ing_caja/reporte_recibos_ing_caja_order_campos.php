<?php
   include_once('reporte_recibos_ing_caja_session.php');
   session_start();
   $_SESSION['scriptcase']['reporte_recibos_ing_caja']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['reporte_recibos_ing_caja']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['reporte_recibos_ing_caja']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['reporte_recibos_ing_caja']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new reporte_recibos_ing_caja_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class reporte_recibos_ing_caja_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("reporte_recibos_ing_caja_json.php");
   }
   ...
   {
       $tab_def_campos['titulo'] = "SELECT concat('RECIBO DE CAJA<br>',razonsoc)
FROM datosemp 
WHERE iddatos = '1' 
ORDER BY razonsoc";
   }
   $tab_labels["titulo"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["titulo"])) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["titulo"] : "titulo";
   $tab_ger_campos['numero_rc'] = "on";
   $tab_def_campos['numero_rc'] = "numero_rc";
   $tab_labels["numero_rc"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["numero_rc"])) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["numero_rc"] : "Número:";
   $tab_ger_campos['fecha_rc'] = "on";
   $tab_def_campos['fecha_rc'] = "fecha_rc";
   $tab_labels["fecha_rc"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["fecha_rc"])) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["fecha_rc"] : "Fecha:";
   $tab_ger_campos['monto_rc'] = "on";
   $tab_def_campos['monto_rc'] = "monto_rc";
   $tab_labels["monto_rc"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["monto_rc"])) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["monto_rc"] : "Valor:";
   $tab_ger_campos['contrato'] = "on";
   $tab_def_campos['contrato'] = "contrato";
   $tab_labels["contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["contrato"])) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["contrato"] : "Contrato o código:";
   $tab_ger_campos['tercero'] = "on";
   $tab_def_campos['tercero'] = "tercero";
   $tab_labels["tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["tercero"])) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["tercero"] : "Dirección:";
   $tab_ger_campos['barr'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['barr'] = "barr";
   }
   else
   {
       $tab_def_campos['barr'] = "";
   }
   $tab_labels["barr"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["barr"])) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["barr"] : "Barrio:";
   $tab_ger_campos['detalle1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['detalle1'] = "detalle1";
   }
   else
   {
       $tab_def_campos['detalle1'] = "";
   }
   $tab_labels["detalle1"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["detalle1"])) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["detalle1"] : "detalle1";
   $tab_ger_campos['detalle2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['detalle2'] = "detalle2";
   }
   else
   {
       $tab_def_campos['detalle2'] = "";
   }
   $tab_labels["detalle2"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["detalle2"])) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['labels']["detalle2"] : "detalle2";
   $tab_ger_campos['titulo'] = "none";
   $tab_ger_campos['barr'] = "none";
   $tab_ger_campos['detalle1'] = "none";
   $tab_ger_campos['detalle2'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['reporte_recibos_ing_caja']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['reporte_recibos_ing_caja']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['reporte_recibos_ing_caja']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - recibos_ing_caja</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "reporte_recibos_ing_caja_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['reporte_recibos_ing_caja']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
