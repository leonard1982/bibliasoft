...
class grid_aplicaciones_menu_asignarpermisos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
    ...
    if (!$this->NM_ajax_flag && (!isset($bprocessa) || $bprocessa != "pesq"))
    {
     ...
     $nm_select = "update aplicaciones_menu set usuario_tmp='0'"; 
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_aplicaciones_menu_asignarpermisos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_aplicaciones_menu_asignarpermisos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_aplicaciones_menu_asignarpermisos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idaplicacion";$Nm_numeric[] = "usuario_tmp";$Nm_numeric[] = "idaplicacion";$Nm_numeric[] = "usuario_tmp";
      ...
      else
      {
         ...
         $nome_sum = "aplicaciones_menu.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_aplicaciones_menu_asignarpermisos/grid_aplicaciones_menu_asignarpermisos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_aplicaciones_menu_asignarpermisos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_aplicaciones_menu_asignarpermisos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_aplicaciones_menu_asignarpermisos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_aplicaciones_menu_asignarpermisos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_aplicaciones_menu_asignarpermisos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_usuario_tmp_cond#NMF#' + search_get_sel_txt('SC_usuario_tmp_cond') + '@NMF@';
  str_out += 'SC_usuario_tmp#NMF#' + search_get_select('SC_usuario_tmp') + '@NMF@';
  str_out += 'SC_modulo_cond#NMF#' + search_get_sel_txt('SC_modulo_cond') + '@NMF@';
  str_out += 'SC_modulo#NMF#' + search_get_select('SC_modulo') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Permisos Menú/Usuario</span></td>
            <td id="lin1_col2" class="scFilterHeaderFont"><span><IMG src="<?php echo $this->Ini->path_imag_cab; ?>/scriptcase__NM__ico__NM__form_red_edit_32.png" border="0"></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $usuario_tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']['usuario_tmp']; 
          $usuario_tmp_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']['usuario_tmp_cond']; 
          $modulo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']['modulo']; 
          $modulo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']['modulo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']['NM_operador']; 
      } 
      if (!isset($usuario_tmp_cond) || empty($usuario_tmp_cond))
      {
         $usuario_tmp_cond = "eq";
      }
      if (!isset($modulo_cond) || empty($modulo_cond))
      {
         $modulo_cond = "eq";
      }
      ...
      $str_hide_usuario_tmp = (in_array($usuario_tmp_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_modulo = (in_array($modulo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($usuario_tmp) || $usuario_tmp == "")
      {
          $usuario_tmp = "";
      }
      if (isset($usuario_tmp) && !empty($usuario_tmp))
      {
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <INPUT type="hidden" id="SC_usuario_tmp_cond" name="usuario_tmp_cond" value="eq">
 ...
 $nmgp_tab_label .= "usuario_tmp?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_usuario_tmp"  <?php echo $str_hide_usuario_tmp?>>
<?php
      $usuario_tmp_look = substr($this->Db->qstr($usuario_tmp), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT tercero, usuario  FROM usuarios  WHERE grupo <> '1' ORDER BY usuario"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['psq_check_ret']['usuario_tmp'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['psq_check_ret']['usuario_tmp'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_usuario_tmp">
      <SELECT class="scFilterObjectOdd" id="SC_usuario_tmp" name="usuario_tmp"  size="1">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $usuario_tmp)
            {
                    $usuario_tmp_sel = ($nm_opc_cod === $usuario_tmp) ? "selected" : "";
            }
            else
            {
               $usuario_tmp_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $usuario_tmp_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <INPUT type="hidden" id="SC_modulo_cond" name="modulo_cond" value="eq">
 ...
 $nmgp_tab_label .= "modulo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_modulo"  <?php echo $str_hide_modulo?>>
<?php
      $modulo_look = substr($this->Db->qstr($modulo), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "select distinct modulo from aplicaciones_menu order by modulo asc"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['psq_check_ret']['modulo'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['psq_check_ret']['modulo'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_modulo">
      <SELECT class="scFilterObjectEven" id="SC_modulo" name="modulo" onChange="nm_submit_form();" size="1">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $modulo)
            {
                    $modulo_sel = ($nm_opc_cod === $modulo) ? "selected" : "";
            }
            else
            {
               $modulo_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $modulo_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<INPUT type="hidden" id="SC_NM_operador" name="NM_operador" value="and">  </TD>
 ...
 <TR align="center">
  <TD class="scFilterTableTd">
   ...
   <?php echo nmButtonOutput($this->arr_buttons, "bpesquisa", "document.F1.bprocessa.value='pesq'; setTimeout(function() {nm_submit_form()}, 200);", "document.F1.bprocessa.value='pesq'; setTimeout(function() {nm_submit_form()}, 200);", "sc_b_pesq_bot", "", "Ir", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "" . $this->Ini->Nm_lang['lang_btns_srch_lone_hint'] . "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
<?php
...
?>
<?php
   if (is_file("grid_aplicaciones_menu_asignarpermisos_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.usuario_tmp_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_usuario_tmp'), document.F1.usuario_tmp_cond, 'usuario_tmp');
   document.F1.usuario_tmp.value = "";
   document.F1.modulo_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_modulo'), document.F1.modulo_cond, 'modulo');
   document.F1.modulo.value = "";
   Sc_carga_select2('all');
 }
 function Sc_carga_select2(Field)
 {
    if (Field == 'all' || Field == 'modulo') {
       Sc_carga_select2_modulo();
    }
    if (Field == 'all' || Field == 'usuario_tmp') {
       Sc_carga_select2_usuario_tmp();
    }
 }
 function Sc_carga_select2_modulo()
 {
  $("#SC_modulo").select2(
    {
      language: {
 ...
 function Sc_carga_select2_usuario_tmp()
 {
  $("#SC_usuario_tmp").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv2/grid_aplicaciones_menu_asignarpermisos";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_aplicaciones_menu_asignarpermisos/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_usuario_tmp_cond'] = 'cond';
      $tp_fields['SC_usuario_tmp'] = 'select';
      $tp_fields['SC_modulo_cond'] = 'cond';
      $tp_fields['SC_modulo'] = 'select';
   ...
   {
      global $usuario_tmp_cond, $usuario_tmp,
             $modulo_cond, $modulo, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $usuario_tmp_cond_salva = $usuario_tmp_cond; 
      if (!isset($usuario_tmp_input_2) || $usuario_tmp_input_2 == "")
      {
          $usuario_tmp_input_2 = $usuario_tmp;
      }
      $modulo_cond_salva = $modulo_cond; 
      if (!isset($modulo_input_2) || $modulo_input_2 == "")
      {
          $modulo_input_2 = $modulo;
      }
      $tmp_pos = strpos($usuario_tmp, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $usuario_tmp;
      }
      else {
          $L_lookup = substr($usuario_tmp, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['psq_check_ret']['usuario_tmp'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($modulo, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['psq_check_ret']['modulo'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Modulo : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']['usuario_tmp'] = $usuario_tmp; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']['usuario_tmp_cond'] = $usuario_tmp_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']['modulo'] = $modulo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']['modulo_cond'] = $modulo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca'] = $Temp_Busca;
      }
      $usuario_tmp_LKP = $usuario_tmp;
      $Tmp_pos = strpos($usuario_tmp, "##@@");
      if ($Tmp_pos !== false)
      {
          $usuario_tmp = substr($usuario_tmp, 0, $Tmp_pos);
     ...
     $nm_select = "update aplicaciones_menu set usuario_tmp='".$usuario_tmp  ."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
      ...
      ;
$_SESSION['scriptcase']['grid_aplicaciones_menu_asignarpermisos']['contr_erro'] = 'off'; 
      if ($usuario_tmp_LKP == $usuario_tmp)
      {
          $usuario_tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']['usuario_tmp'];
      }
      if ($modulo_LKP == $modulo)
      {
          $modulo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']['modulo'];
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      $Conteudo = $usuario_tmp;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['usuario_tmp'] = $Conteudo;
      $Conteudo = $modulo;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['modulo'] = $Conteudo;

      //----- $usuario_tmp
      $this->Date_part = false;
      if (isset($usuario_tmp))
      {
         $this->monta_condicao("usuario_tmp", $usuario_tmp_cond, $usuario_tmp, "", "usuario_tmp");
      }
      ...
      if (isset($modulo))
      {
         $this->monta_condicao("modulo", $modulo_cond, $modulo, "", "modulo");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "usuario_tmp" : return ('class="scFilterObjectOdd"'); break;
         case "modulo" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
