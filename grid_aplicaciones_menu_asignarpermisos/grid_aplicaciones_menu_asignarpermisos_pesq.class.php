...
?>
<?php echo $SC_Label ?><br><span id="id_hide_usuario_tmp"  <?php echo $str_hide_usuario_tmp?>>
<?php
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_modulo"  <?php echo $str_hide_modulo?>>
<?php
...
?>
   <span id="idAjaxSelect_modulo">
      <SELECT class="scFilterObjectOdd" id="SC_modulo" name="modulo" onChange="nm_submit_form();" size="1">
...
$_SESSION['scriptcase']['grid_aplicaciones_menu_asignarpermisos']['contr_erro'] = 'off'; 
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "modulo" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
