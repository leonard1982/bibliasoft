<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_aplicaciones_menu_asignarpermisos']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_V2_SIN.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_aplicaciones_menu_asignarpermisos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_aplicaciones_menu_asignarpermisos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["modulo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['labels']["modulo"])) ? $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['labels']["modulo"] : "Modulo";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['labels']["descripcion"] : "Descripcion";
   $tab_ger_campos['usuario_tmp'] = "on";
   $tab_def_campos['usuario_tmp'] = "usuario_tmp";
   $tab_labels["usuario_tmp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['labels']["usuario_tmp"])) ? $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['labels']["usuario_tmp"] : "Usuario";
   $tab_ger_campos['ver'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ver'] = "ver";
   }
   else
   {
       $tab_def_campos['ver'] = "";
   }
   $tab_labels["ver"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['labels']["ver"])) ? $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['labels']["ver"] : "";
   $tab_ger_campos['seleccionar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['seleccionar'] = "seleccionar";
   }
   else
   {
       $tab_def_campos['seleccionar'] = "";
   }
   $tab_labels["seleccionar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['labels']["seleccionar"])) ? $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['labels']["seleccionar"] : "Ver";
   $tab_ger_campos['ver'] = "none";
   $tab_ger_campos['seleccionar'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_aplicaciones_menu_asignarpermisos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_aplicaciones_menu_asignarpermisos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
