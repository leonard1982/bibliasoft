...
//----- 
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_aplicaciones_menu_asignarpermisos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_aplicaciones_menu_asignarpermisos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_aplicaciones_menu_asignarpermisos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_aplicaciones_menu_asignarpermisos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_aplicaciones_menu_asignarpermisos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_aplicaciones_menu_asignarpermisos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_aplicaciones_menu_asignarpermisos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_aplicaciones_menu_asignarpermisos']['embutida_filho'] as $ind => $sc_init)
          {
