...
class grid_aplicaciones_menu_asignarpermisos_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_aplicaciones_menu_asignarpermisos']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_aplicaciones_menu_asignarpermisos']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['contr_total_geral'] == "OK")
      {
          $this->array_total_modulo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['arr_total']['modulo'];
      }
      else
      {
          $this->array_total_modulo = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['arr_total']['modulo'] = $this->array_total_modulo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['json_use_label'])
       {
          $Lab_modulo = "modulo";
       }
       else
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['modulo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['modulo'] = "Modulo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['descripcion'] = "Descripcion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['usuario_tmp']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['usuario_tmp'] = "Usuario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['ver']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['ver'] = ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['seleccionar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['seleccionar'] = "Ver"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['idaplicacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['idaplicacion'] = "Idaplicacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['item_menu']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['item_menu'] = "Item Menu"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['nombre'] = "Nombre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['imagen']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['imagen'] = "Imagen"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['verificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['labels']['verificacion'] = "Verificacion"; 
       }
       //-----
       $this->comp_field_nm = array(
           'modulo' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['summarizing_fields_order']['modulo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['summarizing_fields_order']['modulo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['summarizing_fields_order']['modulo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['summarizing_fields_display']['modulo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['summarizing_fields_display']['modulo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['summarizing_fields_display']['modulo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['summarizing_fields_display']['modulo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['summarizing_fields_display']['modulo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['summarizing_fields_display']['modulo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['summarizing_fields_display']['modulo'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_modulo as $i_modulo => $d_modulo) {
           if (!in_array($i_modulo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_modulo[3] ] = $d_modulo[2];
               $this->comp_label[0][ $d_modulo[3] ] = $d_modulo[2];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_modulo => $l_modulo) {
           if (isset($this->array_total_modulo[$i_modulo])) {
               $this->comp_group[$i_modulo] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_modulo;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_aplicaciones_menu_asignarpermisos@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_aplicaciones_menu_asignarpermisos_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_modulo("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_modulo);
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_aplicaciones_menu_asignarpermisos/grid_aplicaciones_menu_asignarpermisos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_aplicaciones_menu_asignarpermisos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_aplicaciones_menu_asignarpermisos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_aplicaciones_menu_asignarpermisos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_aplicaciones_menu_asignarpermisos/grid_aplicaciones_menu_asignarpermisos_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_aplicaciones_menu_asignarpermisos_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_aplicaciones_menu_asignarpermisos']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_aplicaciones_menu_asignarpermisos']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_aplicaciones_menu_asignarpermisos_config_pivot.php?nome_apl=grid_aplicaciones_menu_asignarpermisos&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_aplicaciones_menu_asignarpermisos_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_aplicaciones_menu_asignarpermisos/grid_aplicaciones_menu_asignarpermisos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aplicaciones_menu_asignarpermisos']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $usuario_tmp = $Busca_temp['usuario_tmp']; 
          $tmp_pos = strpos($usuario_tmp, "##@@");
          if ($tmp_pos !== false && !is_array($usuario_tmp))
          {
              $usuario_tmp = substr($usuario_tmp, 0, $tmp_pos);
          }
          $modulo = $Busca_temp['modulo']; 
          $tmp_pos = strpos($modulo, "##@@");
          if ($tmp_pos !== false && !is_array($modulo))
          {
              $modulo = substr($modulo, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($quebra_modulo, $quebra_modulo_orig)
   {
      //----- Modulo
      if (!isset($this->array_total_modulo[$quebra_modulo_orig]))
      {
         $this->array_total_modulo[$quebra_modulo_orig][0] = 1;
         $this->array_total_modulo[$quebra_modulo_orig][1] = 1;
         $this->array_total_modulo[$quebra_modulo_orig][2] = $quebra_modulo;
         $this->array_total_modulo[$quebra_modulo_orig][3] = $quebra_modulo_orig;
      }
      else
      {
         $this->array_total_modulo[$quebra_modulo_orig][0]++;
         $this->array_total_modulo[$quebra_modulo_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'modulo');
     $campos_order = $this->Ini->Get_date_order_groupby("modulo", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->modulo = $rs_res->fields[0] ;  
            $this->descripcion = $rs_res->fields[1] ;  
            $this->usuario_tmp = $rs_res->fields[2] ;  
            $this->idaplicacion = $rs_res->fields[3] ;  
            $this->item_menu = $rs_res->fields[4] ;  
            $this->nombre = $rs_res->fields[5] ;  
            $this->imagen = $rs_res->fields[6] ;  
...
$_SESSION['scriptcase']['grid_aplicaciones_menu_asignarpermisos']['contr_erro'] = 'off'; 
            $this->modulo_orig = $this->modulo;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->modulo, $this->modulo_orig);
            }
   }
//
