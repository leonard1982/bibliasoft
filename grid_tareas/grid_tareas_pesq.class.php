...
?>
      ...
      <TD id='SC_asesor_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['asesor'])) ? $this->New_label['asesor'] : "Asesor"; ?></TD>
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-descripcion" id="id_ac_descripcion" name="descripcion_autocomp"><?php if ('' !=  $descripcion) { ?><option value="<?php echo $descripcion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_realizada_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['realizada'])) ? $this->New_label['realizada'] : "Realizada"; ?></TD>
      
      <INPUT type="hidden" id="SC_realizada_cond" name="realizada_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_realizada" <?php echo $str_hide_realizada?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
