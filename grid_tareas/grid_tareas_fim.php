...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_tareas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_tareas"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tareas'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_tareas']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_tareas']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tareas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tareas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tareas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tareas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tareas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tareas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tareas']['embutida_filho'] as $ind => $sc_init)
          {
