...
<?php
   ...
   $Ord_Cmp = new grid_tareas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tareas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_tarea'] = "id_tarea";
   $tab_labels["id_tarea"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["id_tarea"])) ? $_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["id_tarea"] : "Id";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['asesor'] = "on";
   $tab_def_campos['asesor'] = "asesor";
   $tab_labels["asesor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["asesor"])) ? $_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["asesor"] : "Asesor";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["descripcion"] : "Descripcion";
   ...
   $tab_labels["cambiar_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["cambiar_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["cambiar_estado"] : "Realizada";
   $tab_ger_campos['creado'] = "on";
   $tab_def_campos['creado'] = "creado";
   $tab_labels["creado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["creado"])) ? $_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["creado"] : "Creado";
   $tab_ger_campos['editado'] = "on";
   $tab_def_campos['editado'] = "editado";
   $tab_labels["editado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["editado"])) ? $_SESSION['sc_session'][$sc_init]['grid_tareas']['labels']["editado"] : "Editado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tareas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tareas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tareas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tareas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tareas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
