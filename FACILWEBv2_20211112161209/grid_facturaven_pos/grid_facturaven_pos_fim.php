...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_facturaven_pos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_facturaven_pos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_facturaven_pos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos']['embutida_filho'] as $ind => $sc_init)
          {
