...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____reporte_compra_300322"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____reporte_compra_300322"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['reporte_compra_300322']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['reporte_compra_300322']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_compra_300322']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['reporte_compra_300322']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_compra_300322']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['reporte_compra_300322']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['reporte_compra_300322']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>reporte_compra_300322</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['reporte_compra_300322']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['reporte_compra_300322']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'reporte_compra_300322' || $achou)
          {
