...
class reporte_compra_300322_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$this->Graf         = new reporte_compra_300322_grafico();
		$this->Graf->Db     = $this->Db;
		$this->Graf->Erro   = $this->Erro;
		$this->Graf->Ini    = $this->Ini;
		$this->Graf->Lookup = $this->Lookup;

		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['reporte_compra_300322']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['reporte_compra_300322']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['contr_total_geral'] == "OK")
      {
          $this->array_total_idprov = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['arr_total']['idprov'];
      }
      else
      {
          $this->array_total_idprov = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][4];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][7];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][3];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][6];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][8];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][2];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][5];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['arr_total']['idprov'] = $this->array_total_idprov;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['json_use_label'])
       {
          $Lab_idprov = "idprov";
       }
       else
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['titulo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['titulo'] = ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['tmp']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['tmp'] = "tmp"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['numfacom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['numfacom'] = "Número"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['fechacom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['fechacom'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['fechavenc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['fechavenc'] = "Vence"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['formapago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['formapago'] = "F.Pago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['pagada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['pagada'] = "Pagada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['idprov']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['idprov'] = "Proveedor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['subtotal'] = "Subtotal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['valoriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['valoriva'] = "Valoriva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['iva_0']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['iva_0'] = "BASE 0%"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['base5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['base5'] = "Base 5%"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['iva_5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['iva_5'] = "IVA 5%"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['base19']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['base19'] = "Base 19%"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['iva_19']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['iva_19'] = "IVA 19%"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['observaciones'] = "Obs."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['detalle']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['detalle'] = "detalle"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['idfaccom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['idfaccom'] = "#"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['asentada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['asentada'] = "Asentada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['saldo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['saldo'] = "Saldo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['id_pedidocom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['id_pedidocom'] = "Pedido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['retencion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['retencion'] = "Retención %"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['reteica']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['reteica'] = "Reteica"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['reteiva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['reteiva'] = "Reteiva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['cod_cuenta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['cod_cuenta'] = "Cod Cuenta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['a_pagar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['a_pagar'] = "Val a Pagar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['devolucion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['devolucion'] = "Devolución"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['pagos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['pagos'] = "Abonos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['tasa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['tasa'] = "Tasa %"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['val_ica']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['val_ica'] = "$ ReteICA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['val_ret']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['val_ret'] = "$ Retención"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['val_retiva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['labels']['val_retiva'] = "$ ReteIVA"; 
       }
       //-----
       $this->comp_field_nm = array(
           'idprov' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_order']['proveedor']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_order']['proveedor'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_order']['proveedor'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['proveedor'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['proveedor'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['proveedor'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['proveedor'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['proveedor'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['proveedor'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['proveedor'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@reporte_compra_300322@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] = "print";
      ...
      $this->Total   = new reporte_compra_300322_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_proveedor("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "reporte_compra_300322/reporte_compra_300322_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reporte_compra_300322_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_reporte_compra_300322_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reporte_compra_300322_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "reporte_compra_300322/reporte_compra_300322_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "reporte_compra_300322/reporte_compra_300322_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "reporte_compra_300322/reporte_compra_300322_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "reporte_compra_300322/reporte_compra_300322_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("reporte_compra_300322_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['reporte_compra_300322']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['reporte_compra_300322']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'reporte_compra_300322_config_pivot.php?nome_apl=reporte_compra_300322&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_reporte_compra_300322_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "reporte_compra_300322/reporte_compra_300322_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($sum_subtotal, $sum_valoriva, $sum_total, $sum_a_pagar, $sum_val_ica, $sum_val_ret, $sum_val_retiva, $quebra_idprov, $quebra_idprov_orig)
   {
      //----- Proveedor
      if (!isset($this->array_total_idprov[$quebra_idprov_orig]))
      {
         $this->array_total_idprov[$quebra_idprov_orig][0] = 1;
         $this->array_total_idprov[$quebra_idprov_orig][1] = $sum_subtotal;
         $this->array_total_idprov[$quebra_idprov_orig][2] = $sum_valoriva;
         $this->array_total_idprov[$quebra_idprov_orig][3] = $sum_total;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->numfacom = $rs_res->fields[0] ;  
            $this->fechacom = $rs_res->fields[1] ;  
            $this->fechavenc = $rs_res->fields[2] ;  
            $this->formapago = $rs_res->fields[3] ;  
            $this->pagada = $rs_res->fields[4] ;  
            $this->idprov = $rs_res->fields[5] ;  
            ...
            $this->observaciones = $rs_res->fields[9] ;  
            $this->idfaccom = $rs_res->fields[10] ;  
            $this->asentada = $rs_res->fields[11] ;  
            $this->retencion = $rs_res->fields[12] ;  
            $this->reteica = $rs_res->fields[13] ;  
            $this->reteiva = $rs_res->fields[14] ;  
...
$_SESSION['scriptcase']['reporte_compra_300322']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->subtotal, $this->valoriva, $this->total, $this->a_pagar, $this->val_ica, $this->val_ret, $this->val_retiva, $this->idprov, $this->idprov_orig);
            }
   }
//
