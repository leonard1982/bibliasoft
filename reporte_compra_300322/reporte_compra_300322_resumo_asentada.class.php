...
class reporte_compra_300322_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['arr_total']['asentada'];
      }
      else
      {
          $this->array_total_asentada = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['arr_total']['asentada'] = $this->array_total_asentada;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_order']['asentada']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_order']['asentada'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_order']['asentada'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['asentada'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['asentada'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['asentada'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['asentada'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['asentada'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['asentada'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['summarizing_fields_display']['asentada'] as $i_sum => $d_sum)
           {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_asentada("res");
...
{ 
   ...
   //---- 
   function adiciona_registro($sum_subtotal, $sum_valoriva, $sum_total, $sum_a_pagar, $sum_val_ica, $sum_val_ret, $sum_val_retiva, $quebra_asentada, $quebra_asentada_orig)
   {
      //----- Asentada
      if (!isset($this->array_total_asentada[$quebra_asentada_orig]))
      {
         ...
         $this->array_total_asentada[$quebra_asentada_orig][2] = $sum_valoriva;
         $this->array_total_asentada[$quebra_asentada_orig][3] = $sum_total;
...
$_SESSION['scriptcase']['reporte_compra_300322']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->subtotal, $this->valoriva, $this->total, $this->a_pagar, $this->val_ica, $this->val_ret, $this->val_retiva, $this->asentada, $this->asentada_orig);
            }
   }
//
