...
class reporte_compra_300322_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "reporte_compra_300322.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['rtf_name']);
      }
      ...
      { 
          ...
          if ($Cada_col == "tmp" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
...
$_SESSION['scriptcase']['reporte_compra_300322']['contr_erro'] = 'off'; 
   ...
   function NM_export_tmp()
   {
         ...
         $this->tmp = str_replace('<', '&lt;', $this->tmp);
         $this->tmp = str_replace('>', '&gt;', $this->tmp);
         $this->Texto_tag .= "<td>" . $this->tmp . "</td>\r\n";
   }
   //----- numfacom
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
