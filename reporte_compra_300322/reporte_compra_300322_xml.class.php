...
class reporte_compra_300322_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xml()
   {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          foreach ($todo as $param)
          {
               ...
               if (1 < sizeof($cadapar))
               {
                   ...
                   nm_limpa_str_reporte_compra_300322($cadapar[1]);
                   nm_protect_num_reporte_compra_300322($cadapar[0], $cadapar[1]);
                   if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                   $Tmp_par   = $cadapar[0];
                   $$Tmp_par = $cadapar[1];
                   if ($Tmp_par == "nmgp_opcao")
                   {
                       $_SESSION['sc_session'][$script_case_init]['reporte_compra_300322']['opcao'] = $cadapar[1];
                   }
               }
          }
      }
      ...
      if (isset($gCompra)) 
      {
          ...
          nm_limpa_str_reporte_compra_300322($_SESSION["gCompra"]);
      }
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "reporte_compra_300322/reporte_compra_300322_res_xml.class.php"))
      {
          $this->Tem_xml_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_label']))
      {
          $this->Xml_tag_label = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_label'];
          $this->New_Format    = true;
      }
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      require_once($this->Ini->path_aplicacao . "reporte_compra_300322_total.class.php"); 
      ...
      if (method_exists($this->Tot,$Gb_geral))
      {
          ...
          {
              $this->sum_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][2];
              $this->sum_valoriva = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][3];
              $this->sum_total = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][4];
              $this->sum_a_pagar = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][5];
              $this->sum_val_ica = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][6];
              $this->sum_val_ret = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][7];
              $this->sum_val_retiva = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['tot_geral'][8];
          }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_return']);
          if ($this->Tem_xml_res) {
      ...
      $this->Arq_zip      = $this->Arquivo . "_reporte_compra_300322.zip";
      $this->Arquivo     .= "_reporte_compra_300322";
      $this->Arquivo_view = $this->Arquivo . "_view.xml";
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "reporte_compra_300322.xml";
      $this->Tit_zip      = "reporte_compra_300322.zip";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_name'] .= ".xml";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['embutida'])
         { 
             $this->xml_registro .= "<" . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['embutida_tit'] . ">\r\n";
         }
         elseif ($this->New_Format)
         {
             $this->xml_registro = "<reporte_compra_300322>\r\n";
         }
         else
         {
             $this->xml_registro = "<reporte_compra_300322";
...
$_SESSION['scriptcase']['reporte_compra_300322']['contr_erro'] = 'off'; 
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['field_order'] as $Cada_col)
         { 
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "reporte_compra_300322_res_xml.class.php");
              $this->Res = new reporte_compra_300322_res_xml();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_res_grid'] = true;
              $this->Res->monta_xml();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_res_file']['xml'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_res_file']['xml']);
              }
              if ($this->Grava_view)
              {
                  $str_zip    = "";
                  ...
                  { 
                      $str_zip   = "";
                      $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_res_file']['view'];
                      $Arq_input = (FALSE !== strpos($Arq_res, ' ')) ? " \"" . $Arq_res . "\"" :  $Arq_res;
                      if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                      {
                          $str_zip = "zip.exe " . strtoupper($Parm_pass) . " -j -u " . $this->Xml_password . " " . $Zip_f . " " . $Arq_input;
                      ...
                      unlink($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_res_file']['view']);
                  }
              } 
              else 
              {
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_res_grid']);
          } 
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   //----- titulo
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->tmp))
         {
             $this->tmp = sc_convert_encoding($this->tmp, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->tmp) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->tmp) . "\"";
         }
   }
   //----- numfacom
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322'][$path_doc_md5][1] = $this->Tit_doc;
...
<form name="Fdown" method="get" action="reporte_compra_300322_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="reporte_compra_300322"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<FORM name="F0" method=post action="./" style="display: none"> 
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra_300322']['xml_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
