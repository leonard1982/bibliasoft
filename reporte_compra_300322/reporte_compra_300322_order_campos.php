...
<?php
   ...
   $Ord_Cmp = new reporte_compra_300322_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class reporte_compra_300322_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['titulo'] = "";
   }
   $tab_labels["titulo"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["titulo"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["titulo"] : "";
   $tab_ger_campos['tmp'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tmp'] = "tmp";
   }
   else
   {
       $tab_def_campos['tmp'] = "";
   }
   $tab_labels["tmp"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["tmp"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["tmp"] : "tmp";
   $tab_ger_campos['numfacom'] = "on";
   $tab_def_campos['numfacom'] = "numfacom";
   $tab_labels["numfacom"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["numfacom"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["numfacom"] : "Número";
   $tab_ger_campos['fechacom'] = "on";
   $tab_def_campos['fechacom'] = "fechacom";
   $tab_labels["fechacom"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["fechacom"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["fechacom"] : "Fecha";
   $tab_ger_campos['fechavenc'] = "on";
   $tab_def_campos['fechavenc'] = "fechavenc";
   $tab_labels["fechavenc"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["fechavenc"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["fechavenc"] : "Vence";
   $tab_ger_campos['formapago'] = "on";
   $tab_def_campos['formapago'] = "formapago";
   $tab_labels["formapago"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["formapago"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["formapago"] : "F.Pago";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["pagada"] : "Pagada";
   $tab_ger_campos['idprov'] = "on";
   $tab_def_campos['idprov'] = "idprov";
   $tab_labels["idprov"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["idprov"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["idprov"] : "Proveedor";
   $tab_ger_campos['subtotal'] = "on";
   $tab_def_campos['subtotal'] = "subtotal";
   $tab_labels["subtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["subtotal"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["subtotal"] : "Subtotal";
   $tab_ger_campos['valoriva'] = "on";
   $tab_def_campos['valoriva'] = "valoriva";
   $tab_labels["valoriva"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["valoriva"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["valoriva"] : "Valoriva";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["total"] : "Total";
   ...
   $tab_labels["iva_0"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["iva_0"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["iva_0"] : "BASE 0%";
   ...
   $tab_labels["base5"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["base5"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["base5"] : "Base 5%";
   ...
   $tab_labels["iva_5"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["iva_5"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["iva_5"] : "IVA 5%";
   ...
   $tab_labels["base19"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["base19"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["base19"] : "Base 19%";
   ...
   $tab_labels["iva_19"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["iva_19"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["iva_19"] : "IVA 19%";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["observaciones"] : "Obs.";
   ...
   $tab_labels["detalle"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["detalle"])) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['labels']["detalle"] : "detalle";
   $tab_ger_campos['titulo'] = "none";
   $tab_ger_campos['tmp'] = "none";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['reporte_compra_300322']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['reporte_compra_300322']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['reporte_compra_300322']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "reporte_compra_300322_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['reporte_compra_300322']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
