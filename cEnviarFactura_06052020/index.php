<?php
   include_once('cEnviarFactura_06052020_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_perfil']          = "conn_firebird";
   $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_doc']        = "";
   $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_con_conn_mysql']         = "conn_mysql";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class cEnviarFactura_06052020_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "cEnviarFactura_06052020"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['cEnviarFactura_06052020']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['cEnviarFactura_06052020']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['cEnviarFactura_06052020']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/cEnviarFactura_06052020';
      ...
      $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['cEnviarFactura_06052020']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['cEnviarFactura_06052020']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['cEnviarFactura_06052020']['actual_lang']) || $_SESSION['scriptcase']['cEnviarFactura_06052020']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['cEnviarFactura_06052020']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("cEnviarFactura_06052020_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["cEnviarFactura_06052020"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["cEnviarFactura_06052020"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['cEnviarFactura_06052020']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "cEnviarFactura_06052020_erro.class.php"); 
      $this->Erro = new cEnviarFactura_06052020_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('cEnviarFactura_06052020'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['cEnviarFactura_06052020']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['cEnviarFactura_06052020']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['cEnviarFactura_06052020']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['cEnviarFactura_06052020']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['cEnviarFactura_06052020']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['cEnviarFactura_06052020']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
      $this->conectExtra();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_conexao']) && $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_perfil']) && $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_perfil'];
      }
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_con_conn_mysql'], $this->path_libs, "S", $this->path_conf);
          $this->nm_con_conn_mysql['servidor']               = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_conn_mysql['usuario']                = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_conn_mysql['banco']                  = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_conn_mysql['senha']                  = $_SESSION['scriptcase']['glo_senha'];
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEB_FE_73', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura_06052020']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class cEnviarFactura_06052020_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new cEnviarFactura_06052020_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cEnviarFactura_06052020']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['cEnviarFactura_06052020']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['cEnviarFactura_06052020']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['cEnviarFactura_06052020'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cEnviarFactura_06052020']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cEnviarFactura_06052020']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('cEnviarFactura_06052020') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cEnviarFactura_06052020']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "cEnviarFactura_06052020")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cEnviarFactura_06052020']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['cEnviarFactura_06052020']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['cEnviarFactura_06052020']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "cEnviarFactura_06052020_erro.class.php"); 
      $this->Erro      = new cEnviarFactura_06052020_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['cEnviarFactura_06052020']['contr_erro'] = 'on';
  $vsql1 = "SELECT RDB\$FIELD_NAME AS CAMPO FROM RDB\$RELATION_FIELDS WHERE RDB\$RELATION_NAME = 'KARDEX' AND RDB\$FIELD_NAME = 'SN_CUFE'";

 
      $nm_select = $vsql1; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste1 = array();
      $this->vsiexiste1 = array();
      ...
      { 
          ...
          { 
                 ...
                 { 
                        $this->vSiExiste1[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste1[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vSiExiste1 = false;
          $this->vSiExiste1_erro = $this->Db->ErrorMsg();
          $this->vsiexiste1 = false;
          $this->vsiexiste1_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste1[0][0]))
{
	
     $nm_select = "ALTER TABLE KARDEX ADD SN_CUFE VARCHAR(300)"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
$vsql2 = "SELECT RDB\$FIELD_NAME AS CAMPO FROM RDB\$RELATION_FIELDS WHERE RDB\$RELATION_NAME = 'KARDEX' AND RDB\$FIELD_NAME = 'SN_PJFE'";

 
      $nm_select = $vsql2; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste2 = array();
      $this->vsiexiste2 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste2 = false;
          $this->vSiExiste2_erro = $this->Db->ErrorMsg();
          $this->vsiexiste2 = false;
          $this->vsiexiste2_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste2[0][0]))
{
	
     $nm_select = "ALTER TABLE KARDEX ADD SN_PJFE VARCHAR(10)"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql3 = "SELECT RDB\$FIELD_NAME AS CAMPO FROM RDB\$RELATION_FIELDS WHERE RDB\$RELATION_NAME = 'KARDEX' AND RDB\$FIELD_NAME = 'SN_RUTAQR'";

 
      $nm_select = $vsql3; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste3 = array();
      $this->vsiexiste3 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste3[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste3[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste3 = false;
          $this->vSiExiste3_erro = $this->Db->ErrorMsg();
          $this->vsiexiste3 = false;
          $this->vsiexiste3_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste3[0][0]))
{
	
     $nm_select = "ALTER TABLE KARDEX ADD SN_RUTAQR VARCHAR(200)"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
if(!isset($this->vsiexiste4[0][0]))
{
     ...
     $nm_select = "UPDATE KARDEX SET SN_CONSECUTIVO=CAST(NUMERO AS INT) WHERE SN_PJFE IS NOT NULL AND SN_PJFE <> '' AND NUMERO IS NULL"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql5 = "SELECT RDB\$FIELD_NAME AS CAMPO FROM RDB\$RELATION_FIELDS WHERE RDB\$RELATION_NAME = 'KARDEX' AND RDB\$FIELD_NAME = 'SN_FE_VALIDACION'";

 
      $nm_select = $vsql5; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste5 = array();
      $this->vsiexiste5 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste5[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste5[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste5 = false;
          $this->vSiExiste5_erro = $this->Db->ErrorMsg();
          $this->vsiexiste5 = false;
          $this->vsiexiste5_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste5[0][0]))
{
	
     $nm_select = "ALTER TABLE KARDEX ADD SN_FE_VALIDACION TIMESTAMP"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
if(isset($_POST["kardexid"]))
{
	...
	$this->fEnviarFE($vkardexid);
}
$_SESSION['scriptcase']['cEnviarFactura_06052020']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
...
if (!isset($this->sc_temp_gidempresa)) {$this->sc_temp_gidempresa = (isset($_SESSION['gidempresa'])) ? $_SESSION['gidempresa'] : "";}
		...
		$vsql1 = "select k.codprefijo,cast(k.numero as int) as numero,k.total,t.nittri,k.fecha,k.fecvence,k.formapago,t.nit,k.observ,k.horacrea,k.vrbase from kardex k inner join terceros t on k.cliente=t.terid where k.kardexid='".$vkardexid."'";
...
;
		...
		if(isset($vdatoskardex[0][0]))
		{
			...
			$vobserv      = $vdatoskardex[0][8];
			$vconsecutivo = $vnumero;
			$vhoracrea    = $vdatoskardex[0][9];
			$vhoracrea    = date_create($vfecha2." ".$vhoracrea.":00");
      ...
      $nm_select = "select prefijo from cloud_prefijos where tipo='FV' and cod_prefijo='".$vcodprefijo."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $vPJFE2 = array();
      $vpjfe2 = array();
...
;
		...
		if(isset($ds_fv[0][0]) and (isset($ds_fv[0][1])) and (isset($ds_fv[0][2])) and (isset($ds_fv[0][3])))
		{
			if(!empty(($ds_fv[0][0])) and (!empty($ds_fv[0][1])) and (!empty($ds_fv[0][2])) and (!empty($ds_fv[0][3])))
			{
				...
				if(checkPuerto2('emision21.thefactoryhka.com.co','80'))
				{
					
				}
				else
				{
					echo "No hay conexión con el Servidor. Verifique su conexión de internet.";
					exit(1);
				}
      ...
      $nm_select = "select ccnit,celular,correo,codsucursal,cantidadDecimales,valorTributoUnidad,no_validar_mail,email_alternativo from cloud_empresas where id_empresa='".$this->sc_temp_gidempresa."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $vDataEmisor = array();
      $vdataemisor = array();
...
;
		...
		if(isset($vdataemisor[0][0]))
		{
			...
			$correodestinatario2->string          = trim($vemailemisor);
			$destinatarios2->email                = $correodestinatario2;
			$destinatarios2->nitProveedorReceptor = $vnitemisor;
			$destinatarios2->telefono             = str_replace(' ','',$vcelemisor);	
			$factura->cliente->destinatario[1]    = $destinatarios2;
			...
			if($vnovalidaremail=="SI")
			{
				...
				{
					$vvalida = false;
					$vmensaje .= "Si su configuración es: 'No validar correo',por lo tanto, debe especificar un correo alternativo.<br>";
				}
			}
		...
		if($vvalida)
		{
			$vsql_cliente = "select nittri,iif(tipodociden='C','13','31') as tipoiden,nombre,nomregtri,direcc1,telef1,email,iif(natjuridica='N',2,1) as naturaleza from terceros where nit='".$vnit."' or nittri='".$vnit."'";
...
;	
			...
			if(isset($ds_fe[0][0]) and !empty($ds_fe[0][0]))
			{
				...
				$vnomregtri   = $ds_fe[0][3];
				if(empty($vnomregtri))
				{
					$vvalida   = false;
					$vmensaje .= "El tercero no tiene nombre tributario en TNS: ".$vnit.".<br>";
				}
				$vdirecc1     = $ds_fe[0][4];
				$direccion    = $vdirecc1;
				if(empty($vdirecc1))
...
;
		...
		if($vvalida)
		{
			...
			$correodestinatario1->string = trim($vemail);
			$destinatarios1->email = $correodestinatario1;
			$destinatarios1->nitProveedorReceptor = $vnit;
			$destinatarios1->telefono = str_replace(' ','',$vtelef1);
			...
			$DireccionFiscal[0]->distrito = $vdirecc1;
			...
			$DireccionFiscal[1]->distrito = $vdirecc1;
			...
			$vsql0 = "select codproducto from cloud_exclusiones where id_empresa='".$this->sc_temp_gidempresa."' and tipo in('OCULTO','EXTENSIBLE')";
...
;
			...
			$vsql_detalle = "select d.canlista, p.codigo, p.descrip, p.codigo as codigo2, (d.preciobase*d.canlista)as preciobase, (iif(d.porciva='08','02','01')) as codigoimpuesto, d.porciva, (d.parcvta-(d.preciobase*d.canlista)) as precioiva, d.descuento, (d.preciobase*d.canlista) as bas_br,dekardexid,coalesce(mc.descrip,'SIN MARCA') as marca,p.unidad,p.unimay,p.factor,p.factorglb,d.tipund,d.preciobase FROM dekardex d left join material p on d.matid=p.matid left join marcaart mc on p.marcaartid=mc.marcaartid where d.kardexid='".$vkardexid."' and p.codigo not in(".$vexclusiones.")";
...
;
			...
			if(isset($vdetalle[0][0]))
			{
				...
				for($i=0;$i<count($vdetalle );$i++)
				{
					...
					$codest	=$vdetalle[$i][3];
					$base	=floatval($vdetalle[$i][4]);
					$codImp	=$vdetalle[$i][5];
					$Timp	=$vdetalle[$i][6];
					$Timp	=$Timp;
					$eliva	=floatval($vdetalle[$i][7]);
					$eldesc	=$vdetalle[$i][8];
					$bas_br	=floatval($vdetalle[$i][9]);
					$tot	=$base+$eliva;
					$tot	=strval ($tot);
					$vriva += $eliva;
...
;
      ...
      $nm_select = "select id_mandatorio,dv_mandatorio,tipo_id from cloud_exclusiones where codproducto='".$codbp."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $vCodMan = array();
      $vcodman = array();
...
;
			...
			$vsql_tipo_impuesto = "select sum(d.preciobase*d.canmat) as base, iif(d.porciva='08','02','01') as codigoimpuesto, d.porciva as porcentaje, (sum(d.parcvta)-sum(d.preciobase*d.canlista)) as iva from dekardex d inner join material p on d.matid=p.matid where d.kardexid='".$vkardexid."' and p.codigo not in(".$vexclusiones.") group by d.porciva";
...
;
			...
			{								
				...
				{		
					$base		=floatval($dt_impfac[$t][0]);
					$base		=strval($base);
					$codImp		=$dt_impfac[$t][1];
					$codImp		=strval($codImp);
					$Timp		=$dt_impfac[$t][2];
					$Timp		=$Timp;
					$eliva		=floatval($dt_impfac[$t][3]);
			...
			$vsql_iva = "select (iif(d.porciva='08','02','01')) as codigoimpuesto, (sum(d.parcvta)-sum(d.preciobase*d.canlista)) as iva, sum(d.preciobase*d.canlista) as base from dekardex d inner join material p on d.matid=p.matid where d.kardexid='".$vkardexid."' and p.codigo not in(".$vexclusiones.") group by iif(d.porciva='08','02','01')";
...
;
			...
			if(isset($dt_imptfac[0][0]))
			{
				...
				$codImp	= strval($codImp);
				$eliva	= floatval($dt_imptfac[0][1]);
				$base	= floatval($dt_imptfac[0][2]);
				$tot	= $base+$eliva;
			...
			if($resultado["codigo"]==200 or $resultado["codigo"]==201)
			{
				...
				$vfechavalidacion = substr($vfechavalidacion, 0, -6);
				
				$vpasos      .= "9. Envio del documento satisfactorio, ";
				
				$sql="insert into cloud_kardex SET cufe = '".$vcufe."',numero_fe='".$vcodprefijo.$vnumero."', estado='".$vestado."', avisos='".$vavisos."', id_empresa='".$this->sc_temp_gidempresa."',tipo='FV',prefijo='".$vcodprefijo."',numero='".$vnumero."',tercero='".$vnit2."',fecha_factura='".$vfecha2."',horacrea='".$vhoracrea."',fecha_validacion='".$vfechavalidacion."'";

				 
      if (in_array(strtolower($this->Ini->nm_con_conn_mysql['tpbanco']), $this->Ini->nm_bases_sybase))
      { 
          $nm_select = "select * from cloud_kardex where id_empresa='".$this->sc_temp_gidempresa."' and tipo='FV' and prefijo='".$vcodprefijo."' and numero='".$vnumero."'"; 
      }
      else
      { 
          $nm_select = "select * from cloud_kardex where id_empresa='".$this->sc_temp_gidempresa."' and tipo='FV' and prefijo='".$vcodprefijo."' and numero='".$vnumero."'"; 
...
;
				...
				if(isset($vsi[0][0]))
				{
					$sql="update cloud_kardex SET cufe = '".$vcufe."', numero_fe='".$vcodprefijo.$vnumero."', estado='".$vestado."', avisos='".$vavisos."' where id_empresa='".$this->sc_temp_gidempresa."' and tipo='FV' and prefijo='".$vcodprefijo."' and numero='".$vnumero."'";
				}
     ...
     $nm_select = $vsql_update; 
      ...
      ;
				...
				if(!empty($vcufe))
				{
					...
					$vsql_update = "update kardex set sn_rutaqr='".$vrutaqr2."' where kardexid='".$vkardexid."'";
     ...
     $nm_select = $vsql_update; 
      ...
      ;
			...
			else
			{
				...
				$sql="insert into cloud_kardex_rechazos SET estado='".$vestado."', avisos='".$vavisos."', id_empresa='".$this->sc_temp_gidempresa."',tipo='FV',prefijo='".$vcodprefijo."',numero='".$vnumero."',tercero='".$vnit2."',fecha_factura='".$vfecha2."'";

				 
      if (in_array(strtolower($this->Ini->nm_con_conn_mysql['tpbanco']), $this->Ini->nm_bases_sybase))
      { 
          $nm_select = "select * from cloud_kardex_rechazos where id_empresa='".$this->sc_temp_gidempresa."' and tipo='FV' and prefijo='".$vcodprefijo."' and numero='".$vnumero."'"; 
      }
      else
      { 
          $nm_select = "select * from cloud_kardex_rechazos where id_empresa='".$this->sc_temp_gidempresa."' and tipo='FV' and prefijo='".$vcodprefijo."' and numero='".$vnumero."'"; 
...
;
				...
				if(isset($vsi[0][0]))
				{
					$sql="update cloud_kardex_rechazos SET estado='".$vestado."', avisos='".$vavisos."' where id_empresa='".$this->sc_temp_gidempresa."' and tipo='FV' and prefijo='".$vcodprefijo."' and numero='".$vnumero."'";
				}
     ...
     $nm_select = $sql; 
      ...
      ;
			...
			switch($resultado["codigo"])
			{
				...
				break;
				case 109:
					$vmen = 'Hubo un problema al enviar el documento: '.$vmensaje;
					echo $vmen;
				break;
				default:
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_cEnviarFactura_06052020($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['cEnviarFactura_06052020']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "cEnviarFactura_06052020") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['cEnviarFactura_06052020']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['cEnviarFactura_06052020']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['cEnviarFactura_06052020']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEB_FE_73'])) {
               $_SESSION['scriptcase']['cEnviarFactura_06052020']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEB_FE_73'];
           }
       }
   }
   ...
   if (isset($_POST["gidempresa"])) 
   {
       ...
       nm_limpa_str_cEnviarFactura_06052020($_SESSION["gidempresa"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "cEnviarFactura_06052020";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'cEnviarFactura_06052020' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('cEnviarFactura_06052020' == $sReferer || 'cEnviarFactura_06052020_' == substr($sReferer, 0, 24))
       {
           $_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'cEnviarFactura_06052020')
   {
       $_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['cEnviarFactura_06052020']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/cEnviarFactura_06052020_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_cEnviarFactura_06052020($cadapar[1]);
   ...
   $contr_cEnviarFactura_06052020 = new cEnviarFactura_06052020_apl();
   $contr_cEnviarFactura_06052020->controle();
//
   function nm_limpa_str_cEnviarFactura_06052020(&$str)
   {
