<?php
@session_start() ;
$_SESSION['scriptcase']['grid_reciboingreso_211019']['sc_process_barr'] = true;
require_once('../grid_reciboingreso_211019/index.php');
unset($_SESSION['scriptcase']['grid_reciboingreso_211019']['sc_process_barr']);
$ExportCtrl = new grid_reciboingreso_211019_export_control;
$ExportCtrl->Export_barr();

class grid_reciboingreso_211019_export_control
{
