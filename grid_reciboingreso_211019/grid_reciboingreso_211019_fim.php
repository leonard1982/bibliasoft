...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_reciboingreso_211019"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_reciboingreso_211019"]);
   }
