...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_reciboingreso_211019"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_reciboingreso_211019"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_reciboingreso'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_reciboingreso_211019']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_reciboingreso_211019']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reciboingreso_211019']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_reciboingreso_211019']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reciboingreso_211019']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_reciboingreso_211019']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_reciboingreso_211019']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_reciboingreso_211019</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_reciboingreso_211019']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_reciboingreso_211019']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_reciboingreso_211019' || $achou)
          {
