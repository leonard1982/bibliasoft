<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sucursales_todas']['sc_process_barr'] = true;
require_once('../grid_sucursales_todas/index.php');
unset($_SESSION['scriptcase']['grid_sucursales_todas']['sc_process_barr']);
$ExportCtrl = new grid_sucursales_todas_export_control;
$ExportCtrl->Export_barr();

class grid_sucursales_todas_export_control
{
