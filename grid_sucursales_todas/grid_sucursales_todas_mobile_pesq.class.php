...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_sucursal";$Nm_numeric[] = "puerto";$Nm_numeric[] = "id_sucursal";$Nm_numeric[] = "puerto";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_sucursal_cond" name="id_sucursal_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_sucursal'), this, 'id_sucursal')">
      ...
      <br><span id="id_hide_id_sucursal"  <?php echo $str_hide_id_sucursal?>><?php
      if ($id_sucursal != "")
      {
      $id_sucursal_look = substr($this->Db->qstr($id_sucursal), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-id_sucursal" id="id_ac_id_sucursal" name="id_sucursal_autocomp"><?php if ('' !=  $id_sucursal) { ?><option value="<?php echo $id_sucursal ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_id_sucursal"  <?php echo $str_display_id_sucursal; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_sucursal_input_2" name="id_sucursal_input_2" value="<?php echo NM_encode_input($id_sucursal_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_codigo_suc_cond" name="codigo_suc_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_suc'), this, 'codigo_suc')">
      ...
      <br><span id="id_hide_codigo_suc"  <?php echo $str_hide_codigo_suc?>><?php
      if ($codigo_suc != "")
      {
      $codigo_suc_look = substr($this->Db->qstr($codigo_suc), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_observacion_suc_cond" name="observacion_suc_cond" onChange="nm_campos_between(document.getElementById('id_vis_observacion_suc'), this, 'observacion_suc')">
      ...
      <br><span id="id_hide_observacion_suc"  <?php echo $str_hide_observacion_suc?>><?php
      if ($observacion_suc != "")
      {
      $observacion_suc_look = substr($this->Db->qstr($observacion_suc), 1, -1); 
      $nmgp_def_dados = array(); 
