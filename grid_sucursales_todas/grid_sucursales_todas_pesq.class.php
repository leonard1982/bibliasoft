...
class grid_sucursales_todas_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_sucursales_todas_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_sucursales_todas_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_sucursales_todas_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_sucursal')
      {
          $id_sucursal = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_sucursal($id_sucursal);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codigo_suc')
      {
          $codigo_suc = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codigo_suc($codigo_suc);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_observacion_suc')
      {
          $observacion_suc = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_observacion_suc($observacion_suc);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_id_sucursal($id_sucursal)
   {
      $id_sucursal = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $id_sucursal);
      $id_sucursal = substr($this->Db->qstr($id_sucursal), 1, -1);
            $id_sucursal_look = substr($this->Db->qstr($id_sucursal), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_sucursal from " . $this->Ini->nm_tabela . " where   CAST (id_sucursal AS TEXT)  like '%" . $id_sucursal . "%' order by id_sucursal"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct id_sucursal from " . $this->Ini->nm_tabela . " where   CAST (id_sucursal AS VARCHAR)  like '%" . $id_sucursal . "%' order by id_sucursal"; 
      }
      else
      {
          $nm_comando = "select distinct id_sucursal from " . $this->Ini->nm_tabela . " where  id_sucursal like '%" . $id_sucursal . "%' order by id_sucursal"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_codigo_suc($codigo_suc)
   {
      $codigo_suc = substr($this->Db->qstr($codigo_suc), 1, -1);
            $codigo_suc_look = substr($this->Db->qstr($codigo_suc), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct codigo_suc from " . $this->Ini->nm_tabela . " where  codigo_suc like '%" . $codigo_suc . "%' order by codigo_suc"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_observacion_suc($observacion_suc)
   {
      $observacion_suc = substr($this->Db->qstr($observacion_suc), 1, -1);
            $observacion_suc_look = substr($this->Db->qstr($observacion_suc), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct observacion_suc from " . $this->Ini->nm_tabela . " where  observacion_suc like '%" . $observacion_suc . "%' order by observacion_suc"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_sucursales_todas/grid_sucursales_todas_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_sucursales_todas_ajax_search.js"></script>
 <script type="text/javascript" src="grid_sucursales_todas_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_sucursales_todas_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_sucursales_todas']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_sucursales_todas']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_sucursal_cond#NMF#' + search_get_sel_txt('SC_id_sucursal_cond') + '@NMF@';
  str_out += 'SC_id_sucursal#NMF#' + search_get_text('SC_id_sucursal') + '@NMF@';
  str_out += 'id_ac_id_sucursal#NMF#' + search_get_title('select2-id_ac_id_sucursal-container') + '@NMF@';
  str_out += 'SC_id_sucursal_input_2#NMF#' + search_get_text('SC_id_sucursal_input_2') + '@NMF@';
  str_out += 'SC_codigo_suc_cond#NMF#' + search_get_sel_txt('SC_codigo_suc_cond') + '@NMF@';
  str_out += 'SC_codigo_suc#NMF#' + search_get_text('SC_codigo_suc') + '@NMF@';
  str_out += 'id_ac_codigo_suc#NMF#' + search_get_title('select2-id_ac_codigo_suc-container') + '@NMF@';
  str_out += 'SC_observacion_suc_cond#NMF#' + search_get_sel_txt('SC_observacion_suc_cond') + '@NMF@';
  str_out += 'SC_observacion_suc#NMF#' + search_get_text('SC_observacion_suc') + '@NMF@';
  str_out += 'id_ac_observacion_suc#NMF#' + search_get_title('select2-id_ac_observacion_suc-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-codigo_suc").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_codigo_suc",
      max_itens: "10",
   ...
   $("#SC_codigo_suc").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-observacion_suc").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_observacion_suc",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_observacion_suc").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-id_sucursal").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_id_sucursal",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_id_sucursal").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Sucursales</span></td>
...
<?php
   ...
   {
      global 
             $id_sucursal_cond, $id_sucursal, $id_sucursal_input_2, $id_sucursal_autocomp,
             $codigo_suc_cond, $codigo_suc, $codigo_suc_autocomp,
             $observacion_suc_cond, $observacion_suc, $observacion_suc_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_sucursal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['id_sucursal']; 
          $id_sucursal_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['id_sucursal_input_2']; 
          $id_sucursal_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['id_sucursal_cond']; 
          $codigo_suc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['codigo_suc']; 
          $codigo_suc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['codigo_suc_cond']; 
          $observacion_suc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['observacion_suc']; 
          $observacion_suc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['observacion_suc_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_sucursal_cond) || empty($id_sucursal_cond))
      {
         $id_sucursal_cond = "gt";
      }
      if (!isset($codigo_suc_cond) || empty($codigo_suc_cond))
      {
         $codigo_suc_cond = "qp";
      }
      if (!isset($observacion_suc_cond) || empty($observacion_suc_cond))
      {
         $observacion_suc_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_id_sucursal = (in_array($id_sucursal_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_codigo_suc = (in_array($codigo_suc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_observacion_suc = (in_array($observacion_suc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_sucursal = ('bw' == $id_sucursal_cond) ? $display_aberto : $display_fechado;
      $str_display_codigo_suc = ('bw' == $codigo_suc_cond) ? $display_aberto : $display_fechado;
      $str_display_observacion_suc = ('bw' == $observacion_suc_cond) ? $display_aberto : $display_fechado;

      if (!isset($id_sucursal) || $id_sucursal == "")
      {
          $id_sucursal = "";
      }
      if (isset($id_sucursal) && !empty($id_sucursal))
      {
         $tmp_pos = strpos($id_sucursal, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_sucursal = substr($id_sucursal, 0, $tmp_pos);
         }
      }
      if (!isset($codigo_suc) || $codigo_suc == "")
      {
          $codigo_suc = "";
      }
      if (isset($codigo_suc) && !empty($codigo_suc))
      {
         $tmp_pos = strpos($codigo_suc, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $codigo_suc = substr($codigo_suc, 0, $tmp_pos);
         }
      }
      if (!isset($observacion_suc) || $observacion_suc == "")
      {
          $observacion_suc = "";
      }
      if (isset($observacion_suc) && !empty($observacion_suc))
      {
         $tmp_pos = strpos($observacion_suc, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $observacion_suc = substr($observacion_suc, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_id_sucursal_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_sucursal'])) ? $this->New_label['id_sucursal'] : "Id Sucursal"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_sucursal_cond" name="id_sucursal_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_sucursal'), this, 'id_sucursal')">
       <OPTION value="gt" <?php if ("gt" == $id_sucursal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_sucursal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_sucursal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_sucursal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_sucursal" <?php echo $str_hide_id_sucursal?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_sucursal'])) ? $this->New_label['id_sucursal'] : "Id Sucursal";
 $nmgp_tab_label .= "id_sucursal?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_sucursal from " . $this->Ini->nm_tabela . " where id_sucursal = $id_sucursal_look order by id_sucursal"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct id_sucursal from " . $this->Ini->nm_tabela . " where id_sucursal = $id_sucursal_look order by id_sucursal"; 
      ...
      if (isset($nmgp_def_dados[0][$id_sucursal]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_sucursal];
      }
      else
      {
            nmgp_Form_Num_Val($id_sucursal, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $id_sucursal;
      }
?>
<INPUT  type="text" id="SC_id_sucursal" name="id_sucursal" value="<?php echo NM_encode_input($id_sucursal) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-id_sucursal" id="id_ac_id_sucursal" name="id_sucursal_autocomp"><?php if ('' !=  $id_sucursal) { ?><option value="<?php echo $id_sucursal ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_sucursal"  <?php echo $str_display_id_sucursal; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_sucursal_input_2" name="id_sucursal_input_2" value="<?php echo NM_encode_input($id_sucursal_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_codigo_suc_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['codigo_suc'])) ? $this->New_label['codigo_suc'] : "Codigo"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_codigo_suc_cond" name="codigo_suc_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_suc'), this, 'codigo_suc')">
       <OPTION value="qp" <?php if ("qp" == $codigo_suc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $codigo_suc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codigo_suc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $codigo_suc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codigo_suc" <?php echo $str_hide_codigo_suc?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['codigo_suc'])) ? $this->New_label['codigo_suc'] : "Codigo";
 $nmgp_tab_label .= "codigo_suc?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $codigo_suc_look = substr($this->Db->qstr($codigo_suc), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct codigo_suc from " . $this->Ini->nm_tabela . " where codigo_suc = '$codigo_suc_look' order by codigo_suc"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$codigo_suc]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$codigo_suc];
      }
      else
      {
          $sAutocompValue = $codigo_suc;
      }
?>
<INPUT  type="text" id="SC_codigo_suc" name="codigo_suc" value="<?php echo NM_encode_input($codigo_suc) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-codigo_suc" id="id_ac_codigo_suc" name="codigo_suc_autocomp"><?php if ('' !=  $codigo_suc) { ?><option value="<?php echo $codigo_suc ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_observacion_suc_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['observacion_suc'])) ? $this->New_label['observacion_suc'] : "Descripción"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_observacion_suc_cond" name="observacion_suc_cond" onChange="nm_campos_between(document.getElementById('id_vis_observacion_suc'), this, 'observacion_suc')">
       <OPTION value="qp" <?php if ("qp" == $observacion_suc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $observacion_suc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $observacion_suc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $observacion_suc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_observacion_suc" <?php echo $str_hide_observacion_suc?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['observacion_suc'])) ? $this->New_label['observacion_suc'] : "Descripción";
 $nmgp_tab_label .= "observacion_suc?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $observacion_suc_look = substr($this->Db->qstr($observacion_suc), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct observacion_suc from " . $this->Ini->nm_tabela . " where observacion_suc = '$observacion_suc_look' order by observacion_suc"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$observacion_suc]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$observacion_suc];
      }
      else
      {
          $sAutocompValue = $observacion_suc;
      }
?>
<INPUT  type="text" id="SC_observacion_suc" name="observacion_suc" value="<?php echo NM_encode_input($observacion_suc) ?>"  size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-observacion_suc" id="id_ac_observacion_suc" name="observacion_suc_autocomp"><?php if ('' !=  $observacion_suc) { ?><option value="<?php echo $observacion_suc ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
?>
<?php
   if (is_file("grid_sucursales_todas_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_sucursales_todas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_sucursales_todas']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_sucursal_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_sucursal'), document.F1.id_sucursal_cond, 'id_sucursal');
   document.F1.id_sucursal.value = "";
   document.F1.id_sucursal_autocomp.value = "";
   $('#select2-id_ac_id_sucursal-container').html('<?php echo $this->Val_init_id_sucursal['desc'] ?>');;
   document.F1.id_sucursal_input_2.value = "";
   document.F1.codigo_suc_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_codigo_suc'), document.F1.codigo_suc_cond, 'codigo_suc');
   document.F1.codigo_suc.value = "";
   document.F1.codigo_suc_autocomp.value = "";
   $('#select2-id_ac_codigo_suc-container').html('<?php echo $this->Val_init_codigo_suc['desc'] ?>');;
   document.F1.observacion_suc_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_observacion_suc'), document.F1.observacion_suc_cond, 'observacion_suc');
   document.F1.observacion_suc.value = "";
   document.F1.observacion_suc_autocomp.value = "";
   $('#select2-id_ac_observacion_suc-container').html('<?php echo $this->Val_init_observacion_suc['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_sucursales_todas";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_sucursales_todas/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_sucursal_cond'] = 'cond';
      $tp_fields['SC_id_sucursal'] = 'text_aut';
      $tp_fields['id_ac_id_sucursal'] = 'select2_aut';
      $tp_fields['SC_id_sucursal_input_2'] = 'text';
      $tp_fields['SC_codigo_suc_cond'] = 'cond';
      $tp_fields['SC_codigo_suc'] = 'text_aut';
      $tp_fields['id_ac_codigo_suc'] = 'select2_aut';
      $tp_fields['SC_observacion_suc_cond'] = 'cond';
      $tp_fields['SC_observacion_suc'] = 'text_aut';
      $tp_fields['id_ac_observacion_suc'] = 'select2_aut';
   ...
   {
      global $id_sucursal_cond, $id_sucursal, $id_sucursal_input_2, $id_sucursal_autocomp,
             $codigo_suc_cond, $codigo_suc, $codigo_suc_autocomp,
             $observacion_suc_cond, $observacion_suc, $observacion_suc_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($id_sucursal_autocomp) && empty($id_sucursal))
      {
          $id_sucursal = $id_sucursal_autocomp;
      }
      if (!empty($codigo_suc_autocomp) && empty($codigo_suc))
      {
          $codigo_suc = $codigo_suc_autocomp;
      }
      if (!empty($observacion_suc_autocomp) && empty($observacion_suc))
      {
          $observacion_suc = $observacion_suc_autocomp;
      }
      $id_sucursal_cond_salva = $id_sucursal_cond; 
      if (!isset($id_sucursal_input_2) || $id_sucursal_input_2 == "")
      {
          $id_sucursal_input_2 = $id_sucursal;
      }
      $codigo_suc_cond_salva = $codigo_suc_cond; 
      if (!isset($codigo_suc_input_2) || $codigo_suc_input_2 == "")
      {
          $codigo_suc_input_2 = $codigo_suc;
      }
      $observacion_suc_cond_salva = $observacion_suc_cond; 
      if (!isset($observacion_suc_input_2) || $observacion_suc_input_2 == "")
      {
          $observacion_suc_input_2 = $observacion_suc;
      }
      if ($id_sucursal_cond != "in")
      {
          nm_limpa_numero($id_sucursal, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_sucursal_cond != "in")
      {
          nm_limpa_numero($id_sucursal_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['id_sucursal'] = $id_sucursal; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['id_sucursal_input_2'] = $id_sucursal_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['id_sucursal_cond'] = $id_sucursal_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['codigo_suc'] = $codigo_suc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['codigo_suc_cond'] = $codigo_suc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['observacion_suc'] = $observacion_suc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['observacion_suc_cond'] = $observacion_suc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca'] = $Temp_Busca;
      }
      if ($id_sucursal_cond != "in" && $id_sucursal_cond != "bw" && !empty($id_sucursal) && !is_numeric($id_sucursal))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Sucursal";
      }
      if ($id_sucursal_cond == "bw" && ((!empty($id_sucursal) && !is_numeric($id_sucursal)) || (!empty($id_sucursal_input_2) && !is_numeric($id_sucursal_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Sucursal";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_sucursal'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_sucursal'] = $cmp1;
      }
      else
      {
          $cmp1 = $id_sucursal;
      ...
      $Conteudo = $id_sucursal_input_2;
      if (strtoupper($id_sucursal_cond) != "II" && strtoupper($id_sucursal_cond) != "QP" && strtoupper($id_sucursal_cond) != "NP" && strtoupper($id_sucursal_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_sucursal_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($codigo_suc != '') {
      $codigo_suc_look = substr($this->Db->qstr($codigo_suc), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codigo_suc'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['codigo_suc'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['codigo_suc'] = $codigo_suc;
      }
      $nmgp_def_dados = array();
    if ($observacion_suc != '') {
      $observacion_suc_look = substr($this->Db->qstr($observacion_suc), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['observacion_suc'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['observacion_suc'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['observacion_suc'] = $observacion_suc;
      }

      //----- $id_sucursal
      $this->Date_part = false;
      if (isset($id_sucursal) || $id_sucursal_cond == "nu" || $id_sucursal_cond == "nn" || $id_sucursal_cond == "ep" || $id_sucursal_cond == "ne")
      {
         $this->monta_condicao("id_sucursal", $id_sucursal_cond, $id_sucursal, $id_sucursal_input_2, "id_sucursal");
      }

      //----- $codigo_suc
      $this->Date_part = false;
      if (isset($codigo_suc) || $codigo_suc_cond == "nu" || $codigo_suc_cond == "nn" || $codigo_suc_cond == "ep" || $codigo_suc_cond == "ne")
      {
         $this->monta_condicao("codigo_suc", $codigo_suc_cond, $codigo_suc, "", "codigo_suc");
      }

      //----- $observacion_suc
      $this->Date_part = false;
      if (isset($observacion_suc) || $observacion_suc_cond == "nu" || $observacion_suc_cond == "nn" || $observacion_suc_cond == "ep" || $observacion_suc_cond == "ne")
      {
         $this->monta_condicao("observacion_suc", $observacion_suc_cond, $observacion_suc, "", "observacion_suc");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales_todas']['cond_pesq'] .= $this->NM_operador;
