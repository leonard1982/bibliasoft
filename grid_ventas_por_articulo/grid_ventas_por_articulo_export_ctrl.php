<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ventas_por_articulo']['sc_process_barr'] = true;
require_once('../grid_ventas_por_articulo/index.php');
unset($_SESSION['scriptcase']['grid_ventas_por_articulo']['sc_process_barr']);
$ExportCtrl = new grid_ventas_por_articulo_export_control;
$ExportCtrl->Export_barr();

class grid_ventas_por_articulo_export_control
{
