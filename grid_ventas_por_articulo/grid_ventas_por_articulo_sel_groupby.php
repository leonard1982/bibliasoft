<?php
   ...
   $Sel_Groupby = new grid_ventas_por_articulo_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_ventas_por_articulo_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_Ind_Groupby'];
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['pivot_tabular']);
       if ($sel_groupby == "sc_free_group_by")
       {
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['codigo'] = array('cmp' => "p.codigobar", 'ind' => 0);
           $tab_arr_groubby_cmp['descripcion'] = array('cmp' => "p.nompro", 'ind' => 1);
           $tab_arr_groubby_cmp['fecha'] = array('cmp' => "f.fechaven", 'ind' => 2);
           $tab_arr_groubby_cmp['factura'] = array('cmp' => "concat(r.prefijo,'/',f.numfacven)", 'ind' => 3);
           $tab_arr_groubby_cmp['cantidad'] = array('cmp' => "(d.cantidad)", 'ind' => 4);
           $tab_arr_groubby_cmp['base'] = array('cmp' => "((d.cantidad*d.valorunit)-(d.cantidad*d.iva))", 'ind' => 5);
           $tab_arr_groubby_cmp['neto'] = array('cmp' => "(d.cantidad*d.valorunit)", 'ind' => 6);
           $tab_arr_groubby_cmp['iva'] = array('cmp' => "(d.cantidad*d.iva)", 'ind' => 7);
           ...
           $tab_arr_groubby_sql[4] = array('cmp' => "(d.cantidad)", 'ord' => 'asc');
           $tab_arr_groubby_sql[5] = array('cmp' => "((d.cantidad*d.valorunit)-(d.cantidad*d.iva))", 'ord' => 'asc');
           $tab_arr_groubby_sql[6] = array('cmp' => "(d.cantidad*d.valorunit)", 'ord' => 'asc');
           $tab_arr_groubby_sql[7] = array('cmp' => "(d.cantidad*d.iva)", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_Gb_Free_cmp'] = array();
           $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_Gb_Free_sql'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_Gb_Free_sql'][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
               }
           }
       }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo")
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['summarizing_fields_display'] as $i_sum => $d_sum)
       {
           $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['summarizing_fields_display'][$i_sum]['display'] = in_array($i_sum, $summ_fields);
       }
       $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['summarizing_fields_order'] = $summ_fields;
   }
?>
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['codigo']  = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['codigo'])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['codigo'] : "Codigo";
   $arr_campos_free['descripcion']  = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['descripcion'])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['descripcion'] : "Descripcion";
   $arr_campos_free['fecha']  = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['fecha'])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['fecha'] : "Fecha";
   $arr_campos_free['factura']  = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['factura'])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['factura'] : "Factura";
   $arr_campos_free['cantidad']  = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['cantidad'])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['cantidad'] : "Cantidad";
   $arr_campos_free['base']  = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['base'])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['base'] : "Base";
   $arr_campos_free['neto']  = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['neto'])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['neto'] : "Neto";
   $arr_campos_free['iva']  = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['iva'])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']['iva'] : "Iva";
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_ventas_por_articulo_sel_groupby.php",
    data: {
...
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['summarizing_fields_control'] as $l_field => $d_field)
    {
...
{
?>
   $("#sc_id_summ_available").css("min-height", "<?php echo sizeof($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['summarizing_fields_display']) * 29 ?>px");
   $("#sc_id_summ_selected").css("min-height", "<?php echo sizeof($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['summarizing_fields_display']) * 29 ?>px");
<?php
}
?>
  }
...
<?php
    ...
    $iTabCount            = 1;
    foreach ($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_All_Groupby'] as $QB => $Tp)
    {
        if (!in_array($QB, $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_Groupby_hide']))
        {
...
?>
 <tr id="sc_id_static_groupby">
  <td>
<?php
     if (!in_array("por_producto", $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_Groupby_hide']))
     {
...
?>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" name="sel_groupby" value="por_producto" id="sc_id_sel_groupby_por_producto"<?php echo $check ?> /><label for="sc_id_sel_groupby_por_producto" style="font-weight: bold">Producto</label>
      <br />
      <span style="padding-left: 30px">Descripcion</span>
      <br /><br />
<?php
     }
?>
 ...
 <tr id="sc_id_free_groupby">
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_Groupby_hide']))
     {
...
<?php
        ...
        foreach ($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_Gb_Free_cmp'] as $NM_cada_field => $resto)
        {
        ...
        if ($bSummaryPage)
        {
            ...
            foreach ($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['pivot_x_axys'] as $temp)
            {
                reset($aTmpGroupBy);
...
<?php
        ...
        {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['SC_Gb_Free_cmp'][$NM_cada_field]))
           {
?>
...
<?php
        foreach ($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['summarizing_fields_order'] as $i_sum)
        {
            if ('' != $i_sum && isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['summarizing_fields_display'][$i_sum]))
            {
                $d_sum = $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['summarizing_fields_display'][$i_sum];
                if ($d_sum['display'])
                {
                    $sLabel = $d_sum['label'];
                    $sId    = '';
