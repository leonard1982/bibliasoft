...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_ventas_por_articulo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_ventas_por_articulo"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_ventas_por_articulo']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_ventas_por_articulo']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ventas_por_articulo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ventas_por_articulo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ventas_por_articulo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ventas_por_articulo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ventas_por_articulo']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ventas_por_articulo</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ventas_por_articulo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ventas_por_articulo']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_ventas_por_articulo' || $achou)
          {
