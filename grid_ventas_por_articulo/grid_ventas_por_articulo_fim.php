...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_ventas_por_articulo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_ventas_por_articulo"]);
   }
