...
class grid_ventas_por_articulo_gantt
{
    var $Db;
    var $Erro;
    var $Ini;
    ...
    function grid_ventas_por_articulo_gantt()
    {
    ...
    function getChartData()
    {
        ...
        $sSelect .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['where_pesq'];
    ...
    function displayChart()
    {
        ...
        if (!$this->chart_only)
        {
            ...
            $nm_saida->saida(" <title>grid_ventas_por_articulo</title>\r\n");
        ...
        else
        {
            ...
            @fwrite($rTempXml, "<chart dateFormat='" . $this->output_formatted . "' caption='grid_ventas_por_articulo' ganttPaneDuration='12' ganttPaneDurationUnit='m'>\n");
