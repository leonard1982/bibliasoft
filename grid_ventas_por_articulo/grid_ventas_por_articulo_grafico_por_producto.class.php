...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['contr_label_graf']['descripcion']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['contr_label_graf']['descripcion']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['contr_label_graf']['descripcion'];
      }
   }
