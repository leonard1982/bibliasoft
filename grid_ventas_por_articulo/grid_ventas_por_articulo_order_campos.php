...
<?php
   ...
   $Ord_Cmp = new grid_ventas_por_articulo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_ventas_por_articulo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['fecha'] = "f.fechaven";
   }
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["fecha"] : "Fecha";
   ...
   {
       $tab_def_campos['factura'] = "concat(r.prefijo,'/',f.numfacven)";
   }
   $tab_labels["factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["factura"] : "Factura";
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["codigo"] : "Codigo";
   ...
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["descripcion"] : "Descripcion";
   ...
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["cantidad"] : "Cantidad";
   ...
   {
       $tab_def_campos['unidad'] = "if(d.unidadmayor='SI',p.unimay,p.unimen)";
   }
   $tab_labels["unidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["unidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["unidad"] : "Unidad";
   $tab_ger_campos['base'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['base'] = "base";
   }
   else
   {
       $tab_def_campos['base'] = "((d.cantidad*d.valorunit)-(d.cantidad*d.iva))";
   }
   $tab_labels["base"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["base"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["base"] : "Base";
   ...
   {
       $tab_def_campos['iva'] = "(d.cantidad*d.iva)";
   }
   $tab_labels["iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["iva"] : "Iva";
   $tab_ger_campos['neto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['neto'] = "neto";
   }
   else
   {
       $tab_def_campos['neto'] = "(d.cantidad*d.valorunit)";
   }
   $tab_labels["neto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["neto"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['labels']["neto"] : "Neto";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_ventas_por_articulo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_ventas_por_articulo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
