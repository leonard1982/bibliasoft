...
class grid_ventas_por_articulo_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $count_codigo;
   var $sum_codigo_cantidad;
   var $sum_codigo_base;
   var $sum_codigo_iva;
   var $sum_codigo_neto;
   var $sc_proc_quebra_descripcion;
   var $count_descripcion;
   var $sum_descripcion_cantidad;
   var $sum_descripcion_base;
   var $sum_descripcion_iva;
   var $sum_descripcion_neto;
   ...
   var $sum_cantidad_iva;
   var $sum_cantidad_neto;
   var $sc_proc_quebra_base;
   var $count_base;
   var $sum_base_cantidad;
   var $sum_base_base;
   var $sum_base_iva;
   var $sum_base_neto;
   var $sc_proc_quebra_neto;
   var $count_neto;
   var $sum_neto_cantidad;
   var $sum_neto_base;
   var $sum_neto_iva;
   var $sum_neto_neto;
   var $sc_proc_quebra_iva;
   var $count_iva;
   var $sum_iva_cantidad;
   var $sum_iva_base;
   var $sum_iva_iva;
   var $sum_iva_neto;

   //---- 
   function grid_ventas_por_articulo_resumo($tipo = "")
   {
      ...
      $this->array_total_descripcion = array();
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_articulo']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_articulo']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_articulo']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['campos_busca'];
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['contr_total_geral'] == "OK")
      {
          $this->array_total_codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['codigo'];
          $this->array_total_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['descripcion'];
          $this->array_total_fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['fecha'];
          $this->array_total_factura = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['factura'];
          $this->array_total_cantidad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['cantidad'];
          $this->array_total_base = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['base'];
          $this->array_total_neto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['neto'];
          $this->array_total_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['iva'];
      }
      else
      {
          $this->array_total_codigo = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['tot_geral'][3];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['tot_geral'][5];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['tot_geral'][4];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['codigo'] = $this->array_total_codigo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['descripcion'] = $this->array_total_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['fecha'] = $this->array_total_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['factura'] = $this->array_total_factura;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['cantidad'] = $this->array_total_cantidad;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['base'] = $this->array_total_base;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['neto'] = $this->array_total_neto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_total']['iva'] = $this->array_total_iva;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $prep_field = array();
       $prep_field['codigo'] = "Codigo";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels'][''] = "Codigo"; 
       $prep_field['descripcion'] = "Descripcion";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels'][''] = "Descripcion"; 
       $prep_field['fecha'] = "Fecha";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels'][''] = "Fecha"; 
       $prep_field['factura'] = "Factura";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels'][''] = "Factura"; 
       $prep_field['cantidad'] = "Cantidad";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels'][''] = "Cantidad"; 
       $prep_field['base'] = "Base";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels'][''] = "Base"; 
       $prep_field['neto'] = "Neto";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels'][''] = "Neto"; 
       $prep_field['iva'] = "Iva";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels'][''] = "Iva"; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       $this->comp_sum = array(
           ...
           2 => "Cantidad(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['summarizing_fields_control'] = array(
               'NM_Count' => array(
               ...
               'iva' => array(
                   ...
                   'select' => "<select class=\"sc-ui-select-iva\" onChange=\"scSummChange($(this))\"><option value=\"5\" class=\"sc-ui-select-option-S\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "</option></select>",
               ),
           );
       }
       //-----
       ...
       $this->comp_sum_lnk = array(
           ...
           2 => array('field' => "cantidad", 'show' => true),
           3 => array('field' => "base", 'show' => true),
           4 => array('field' => "neto", 'show' => true),
           5 => array('field' => "iva", 'show' => true),
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['descripcion']['alin'] = "''";
       $Arr_parms['descripcion']['link'] = "S";
       ...
       $Arr_parms['iva']['alin'] = "''";
       $Arr_parms['iva']['link'] = "S";
       $Arr_parms['codigo']['fill'] = "false";
       $Arr_parms['codigo']['order'] = "label";
       $Arr_parms['descripcion']['fill'] = "false";
       $Arr_parms['descripcion']['order'] = "label";
       $Arr_parms['fecha']['fill'] = "false";
       $Arr_parms['fecha']['order'] = "label";
       $Arr_parms['factura']['fill'] = "false";
       $Arr_parms['factura']['order'] = "label";
       $Arr_parms['cantidad']['fill'] = "false";
       $Arr_parms['cantidad']['order'] = "label";
       $Arr_parms['base']['fill'] = "false";
       $Arr_parms['base']['order'] = "label";
       $Arr_parms['neto']['fill'] = "false";
       $Arr_parms['neto']['order'] = "label";
       $Arr_parms['iva']['fill'] = "false";
       $Arr_parms['iva']['order'] = "label";
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['descripcion'] = array(0 => 'descripcion', 1 => '@aspass@');
       ...
       $prep_links_fl['iva'] = array(0 => 'iva', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Codigo")),
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Descripcion")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           '1' => array(
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Factura")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           '1' => array(
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Cantidad")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           '1' => array(
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Base")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           '1' => array(
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Neto")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           '1' => array(
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Iva")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           '1' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['comb_table_def']  = array();

       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_ventas_por_articulo_grafico();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_grid_ventas_por_articulo_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_grid_ventas_por_articulo_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       $compl_css = "";
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['embutida'])
       {
           include($this->Ini->path_btn . $this->Ini->Str_btn_grid);
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_ventas_por_articulo']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_ventas_por_articulo']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_ventas_por_articulo']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_ventas_por_articulo']) . "_";
               } 
           }
       }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function resumo_final()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opcao'] != "pdf")
         {
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_ventas_por_articulo_total.class.php"); 
      }
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['doc_word'])
      { 
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opcao'] = "print";
      ...
      $this->total   = new grid_ventas_por_articulo_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_codigo, $this->array_total_descripcion, $this->array_total_fecha, $this->array_total_factura, $this->array_total_cantidad, $this->array_total_base, $this->array_total_neto, $this->array_total_iva);
      ksort($this->array_total_codigo);
      ksort($this->array_total_descripcion);
      ksort($this->array_total_fecha);
      ksort($this->array_total_factura);
      ksort($this->array_total_cantidad);
      ksort($this->array_total_base);
      ksort($this->array_total_neto);
      ksort($this->array_total_iva);
      if ("out" == $this->NM_tipo)
      {
         $this->total->quebra_geral();
      }
...
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
      ...
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>Ventas por Producto</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_ventas_por_articulo_ajax.js\"></script>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_ventas_por_articulo_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_ventas_por_articulo_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_ventas_por_articulo_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_ventas_por_articulo/grid_ventas_por_articulo_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_ventas_por_articulo/grid_ventas_por_articulo_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_ventas_por_articulo/grid_ventas_por_articulo_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_ventas_por_articulo/grid_ventas_por_articulo_config_graf_flash.php?nome_apl=grid_ventas_por_articulo&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_ventas_por_articulo/grid_ventas_por_articulo_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_ventas_por_articulo/grid_ventas_por_articulo_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
      if (!$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_ventas_por_articulo_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_ventas_por_articulo_help.txt"); 
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_ventas_por_articulo_config_pivot.php?nome_apl=grid_ventas_por_articulo&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_ventas_por_articulo/grid_ventas_por_articulo_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['grid_ventas_por_articulo_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_ventas_por_articulo@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      $nm_saida->saida("  if (\"pdf_res\" == x)\r\n");
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grid_ventas_por_articulo/grid_ventas_por_articulo_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_ventas_por_articulo_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_ventas_por_articulo/grid_ventas_por_articulo_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
           $nm_saida->saida("<TD style=\"padding: 0px\">\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_charts']);
      ...
      if (!isset($this->progress_fp) || !$this->progress_fp)
      {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['pivot_charts'] as $chart_index => $chart_data)
       {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
   $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['cond_pesq'], 0, $trab_pos);
      ...
      $nm_saida->saida("          Ventas por Producto\r\n");
      $nm_saida->saida("        </TD>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_base, $sum_iva, $sum_neto, $quebra_codigo, $quebra_descripcion, $quebra_fecha, $quebra_factura, $quebra_cantidad, $quebra_base, $quebra_neto, $quebra_iva, $quebra_codigo_orig, $quebra_descripcion_orig, $quebra_fecha_orig, $quebra_factura_orig, $quebra_cantidad_orig, $quebra_base_orig, $quebra_neto_orig, $quebra_iva_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (!isset($this->' . $arr_name . '))
          {
              ...
              $this->' . $arr_name . '[2] = ' . $sum_base . ';
              $this->' . $arr_name . '[3] = ' . $sum_iva . ';
              $this->' . $arr_name . '[4] = ' . $sum_neto . ';
              $this->' . $arr_name . '[5] = "' . $$cmp_look . '";
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT str_replace (convert(char(10),f.fechaven,102), '.', '-') + ' ' + convert(char(8),f.fechaven,20) as fecha, concat(r.prefijo,'/',f.numfacven) as factura, p.codigobar as codigo, p.nompro as descripcion, (d.cantidad) as cantidad, ((d.cantidad*d.valorunit)-(d.cantidad*d.iva)) as base, (d.cantidad*d.iva) as iva, (d.cantidad*d.valorunit) as neto from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT f.fechaven as fecha, concat(r.prefijo,'/',f.numfacven) as factura, p.codigobar as codigo, p.nompro as descripcion, (d.cantidad) as cantidad, ((d.cantidad*d.valorunit)-(d.cantidad*d.iva)) as base, (d.cantidad*d.iva) as iva, (d.cantidad*d.valorunit) as neto from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT f.fechaven as fecha, concat(r.prefijo,'/',f.numfacven) as factura, p.codigobar as codigo, p.nompro as descripcion, (d.cantidad) as cantidad, ((d.cantidad*d.valorunit)-(d.cantidad*d.iva)) as base, (d.cantidad*d.iva) as iva, (d.cantidad*d.valorunit) as neto from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['where_pesq']; 
     $temp = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['SC_Gb_Free_sql'] as $cmp_gb => $ord)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            nmgp_Form_Num_Val($this->base, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            nmgp_Form_Num_Val($this->neto, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            nmgp_Form_Num_Val($this->iva, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->base, $this->iva, $this->neto, $this->codigo, $this->descripcion, $this->fecha, $this->factura, $this->cantidad, $this->base, $this->neto, $this->iva, $this->codigo_orig,  $this->descripcion_orig,  $this->fecha_orig,  $this->factura_orig,  $this->cantidad_orig,  $this->base_orig,  $this->neto_orig,  $this->iva_orig);
            }
   }
//
