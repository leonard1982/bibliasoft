...
class grid_ventas_por_articulo_resumo
{
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels']['codigo'] = "Codigo"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels']['descripcion'] = "Descripcion"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels']['fecha'] = "Fecha"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels']['factura'] = "Factura"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels']['cantidad'] = "Cantidad"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels']['base'] = "Base"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels']['neto'] = "Neto"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_articulo']['labels']['iva'] = "Iva"; 
       ...
       //-----
       foreach ($this->array_total_descripcion as $i_descripcion => $d_descripcion) {
           if (!in_array($i_descripcion, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_descripcion[6] ] = $d_descripcion[5];
               $this->comp_label[0][ $d_descripcion[6] ] = $d_descripcion[5];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_descripcion => $l_descripcion) {
           if (isset($this->array_total_descripcion[$i_descripcion])) {
               $this->comp_group[$i_descripcion] = array();
           }
       }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function totaliza()
   {
      $this->total->resumo_por_producto("res", $this->array_total_descripcion);
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_base, $sum_iva, $sum_neto, $quebra_descripcion, $quebra_descripcion_orig)
   {
      //----- Descripcion
      if (!isset($this->array_total_descripcion[$quebra_descripcion_orig]))
      {
         $this->array_total_descripcion[$quebra_descripcion_orig][0] = 1;
         $this->array_total_descripcion[$quebra_descripcion_orig][1] = $sum_cantidad;
         $this->array_total_descripcion[$quebra_descripcion_orig][2] = $sum_base;
         $this->array_total_descripcion[$quebra_descripcion_orig][3] = $sum_iva;
         $this->array_total_descripcion[$quebra_descripcion_orig][4] = $sum_neto;
         $this->array_total_descripcion[$quebra_descripcion_orig][5] = $quebra_descripcion;
         $this->array_total_descripcion[$quebra_descripcion_orig][6] = $quebra_descripcion_orig;
      }
      else
      {
         $this->array_total_descripcion[$quebra_descripcion_orig][0]++;
         $this->array_total_descripcion[$quebra_descripcion_orig][1] += $sum_cantidad;
         $this->array_total_descripcion[$quebra_descripcion_orig][2] += $sum_base;
         $this->array_total_descripcion[$quebra_descripcion_orig][3] += $sum_iva;
         $this->array_total_descripcion[$quebra_descripcion_orig][4] += $sum_neto;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $nmgp_order_by = " order by  p.nompro asc"; 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->base, $this->iva, $this->neto, $this->descripcion, $this->descripcion_orig);
            }
   }
//
