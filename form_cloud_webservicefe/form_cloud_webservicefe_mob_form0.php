...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_cloud_webservicefe_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cloud_webservicefe_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body . $vertical_center; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_cloud_webservicefe']['error_buffer']) && '' != $_SESSION['scriptcase']['form_cloud_webservicefe']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_cloud_webservicefe']['error_buffer'];
}
...
<?php
 include_once("form_cloud_webservicefe_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_cloud_webservicefe_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cloud_webservicefe_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cloud_webservicefe_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['fast_search'][2] : "";
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['empty_filter'] = true;
       }
  }
?>
<script type="text/javascript">
var pag_ativa = "form_cloud_webservicefe_mob_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_cloud_webservicefe_mob_form0' => array(
            'title' => "Datos",
            'class' => $nmgp_num_form == "form_cloud_webservicefe_mob_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_cloud_webservicefe_mob_form1' => array(
            'title' => "Pruebas",
            'class' => $nmgp_num_form == "form_cloud_webservicefe_mob_form1" ? "scTabActive" : "scTabInactive",
        ),
        'form_cloud_webservicefe_mob_form2' => array(
            'title' => "Proveedor Anterior",
            'class' => $nmgp_num_form == "form_cloud_webservicefe_mob_form2" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('Datos' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_cloud_webservicefe_mob_form0']['class'] = 'scTabInactive';
                        }
                        if ('Pruebas' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_cloud_webservicefe_mob_form1']['class'] = 'scTabInactive';
                        }
                        if ('Proveedor Anterior' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_cloud_webservicefe_mob_form2']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_cloud_webservicefe_mob_form0"]['class'];
?>
   <li id="id_form_cloud_webservicefe_mob_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_cloud_webservicefe_mob_form0')">
     Datos
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_cloud_webservicefe_mob_form1"]['class'];
?>
   <li id="id_form_cloud_webservicefe_mob_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_cloud_webservicefe_mob_form1')">
     Pruebas
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_cloud_webservicefe_mob_form2"]['class'];
?>
   <li id="id_form_cloud_webservicefe_mob_form2" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_cloud_webservicefe_mob_form2')">
     Proveedor Anterior
    </a>
   </li>
</ul>
...
<div id="form_cloud_webservicefe_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['Lookup_proveedor'][] = ''; ?>
 <option value="">SELECCIONE</option>
 <option  value="HKA" <?php  if ($this->proveedor == "HKA") { echo " selected" ;} ?>>THE FACTORY HKA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['Lookup_proveedor'][] = 'HKA'; ?>
 <option  value="DATAICO" <?php  if ($this->proveedor == "DATAICO") { echo " selected" ;} ?>>DATAICO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['Lookup_proveedor'][] = 'DATAICO'; ?>
 <option  value="FACILWEB" <?php  if ($this->proveedor == "FACILWEB") { echo " selected" ;} ?>>FACILWEB</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['Lookup_proveedor'][] = 'FACILWEB'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['Lookup_modo'][] = 'DESARROLLO'; ?>
 <option  value="PRODUCCION" <?php  if ($this->modo == "PRODUCCION") { echo " selected" ;} ?>>PRODUCCIÓN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['Lookup_modo'][] = 'PRODUCCION'; ?>
 </select></span>
</span><?php  }?>
