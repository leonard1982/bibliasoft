  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_webservicefe" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_webservicefe_form();
	}
  ...
  function do_ajax_form_cloud_webservicefe_validate_idwebservicefe()
  {
    ...
    x_ajax_form_cloud_webservicefe_validate_idwebservicefe(var_idwebservicefe, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_idwebservicefe_cb);
  } // do_ajax_form_cloud_webservicefe_validate_idwebservicefe

  function do_ajax_form_cloud_webservicefe_validate_idwebservicefe_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_idwebservicefe_cb

  // ---------- Validate id_empresa
  function do_ajax_form_cloud_webservicefe_validate_id_empresa()
  {
    var nomeCampo_id_empresa = "id_empresa";
    var var_id_empresa = scAjaxGetFieldText(nomeCampo_id_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_id_empresa(var_id_empresa, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_id_empresa_cb);
  } // do_ajax_form_cloud_webservicefe_validate_id_empresa

  function do_ajax_form_cloud_webservicefe_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_id_empresa_cb

  // ---------- Validate proveedor
  function do_ajax_form_cloud_webservicefe_validate_proveedor()
  {
    var nomeCampo_proveedor = "proveedor";
    var var_proveedor = scAjaxGetFieldSelect(nomeCampo_proveedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_proveedor(var_proveedor, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_proveedor_cb);
  } // do_ajax_form_cloud_webservicefe_validate_proveedor

  function do_ajax_form_cloud_webservicefe_validate_proveedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_proveedor_cb

  // ---------- Validate modo
  function do_ajax_form_cloud_webservicefe_validate_modo()
  {
    var nomeCampo_modo = "modo";
    var var_modo = scAjaxGetFieldSelect(nomeCampo_modo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_modo(var_modo, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_modo_cb);
  } // do_ajax_form_cloud_webservicefe_validate_modo

  function do_ajax_form_cloud_webservicefe_validate_modo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_modo_cb

  // ---------- Validate servidor1
  function do_ajax_form_cloud_webservicefe_validate_servidor1()
  {
    var nomeCampo_servidor1 = "servidor1";
    var var_servidor1 = scAjaxGetFieldText(nomeCampo_servidor1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_servidor1(var_servidor1, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_servidor1_cb);
  } // do_ajax_form_cloud_webservicefe_validate_servidor1

  function do_ajax_form_cloud_webservicefe_validate_servidor1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_servidor1_cb

  // ---------- Validate servidor2
  function do_ajax_form_cloud_webservicefe_validate_servidor2()
  {
    var nomeCampo_servidor2 = "servidor2";
    var var_servidor2 = scAjaxGetFieldText(nomeCampo_servidor2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_servidor2(var_servidor2, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_servidor2_cb);
  } // do_ajax_form_cloud_webservicefe_validate_servidor2

  function do_ajax_form_cloud_webservicefe_validate_servidor2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_servidor2_cb

  // ---------- Validate servidor3
  function do_ajax_form_cloud_webservicefe_validate_servidor3()
  {
    var nomeCampo_servidor3 = "servidor3";
    var var_servidor3 = scAjaxGetFieldText(nomeCampo_servidor3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_servidor3(var_servidor3, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_servidor3_cb);
  } // do_ajax_form_cloud_webservicefe_validate_servidor3

  function do_ajax_form_cloud_webservicefe_validate_servidor3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_servidor3_cb

  // ---------- Validate tokenempresa
  function do_ajax_form_cloud_webservicefe_validate_tokenempresa()
  {
    var nomeCampo_tokenempresa = "tokenempresa";
    var var_tokenempresa = scAjaxGetFieldText(nomeCampo_tokenempresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_tokenempresa(var_tokenempresa, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_tokenempresa_cb);
  } // do_ajax_form_cloud_webservicefe_validate_tokenempresa

  function do_ajax_form_cloud_webservicefe_validate_tokenempresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_tokenempresa_cb

  // ---------- Validate tokenpassword
  function do_ajax_form_cloud_webservicefe_validate_tokenpassword()
  {
    var nomeCampo_tokenpassword = "tokenpassword";
    var var_tokenpassword = scAjaxGetFieldText(nomeCampo_tokenpassword);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_tokenpassword(var_tokenpassword, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_tokenpassword_cb);
  } // do_ajax_form_cloud_webservicefe_validate_tokenpassword

  function do_ajax_form_cloud_webservicefe_validate_tokenpassword_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_tokenpassword_cb

  // ---------- Validate servidor1_pruebas
  function do_ajax_form_cloud_webservicefe_validate_servidor1_pruebas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_servidor1_pruebas(var_servidor1_pruebas, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_servidor1_pruebas_cb);
  } // do_ajax_form_cloud_webservicefe_validate_servidor1_pruebas

  function do_ajax_form_cloud_webservicefe_validate_servidor1_pruebas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_servidor1_pruebas_cb

  // ---------- Validate servidor2_pruebas
  function do_ajax_form_cloud_webservicefe_validate_servidor2_pruebas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_servidor2_pruebas(var_servidor2_pruebas, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_servidor2_pruebas_cb);
  } // do_ajax_form_cloud_webservicefe_validate_servidor2_pruebas

  function do_ajax_form_cloud_webservicefe_validate_servidor2_pruebas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_servidor2_pruebas_cb

  // ---------- Validate servidor3_pruebas
  function do_ajax_form_cloud_webservicefe_validate_servidor3_pruebas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_servidor3_pruebas(var_servidor3_pruebas, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_servidor3_pruebas_cb);
  } // do_ajax_form_cloud_webservicefe_validate_servidor3_pruebas

  function do_ajax_form_cloud_webservicefe_validate_servidor3_pruebas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_servidor3_pruebas_cb

  // ---------- Validate token_pruebas
  function do_ajax_form_cloud_webservicefe_validate_token_pruebas()
  {
    var nomeCampo_token_pruebas = "token_pruebas";
    var var_token_pruebas = scAjaxGetFieldText(nomeCampo_token_pruebas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_token_pruebas(var_token_pruebas, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_token_pruebas_cb);
  } // do_ajax_form_cloud_webservicefe_validate_token_pruebas

  function do_ajax_form_cloud_webservicefe_validate_token_pruebas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_token_pruebas_cb

  // ---------- Validate password_pruebas
  function do_ajax_form_cloud_webservicefe_validate_password_pruebas()
  {
    var nomeCampo_password_pruebas = "password_pruebas";
    var var_password_pruebas = scAjaxGetFieldText(nomeCampo_password_pruebas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_password_pruebas(var_password_pruebas, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_password_pruebas_cb);
  } // do_ajax_form_cloud_webservicefe_validate_password_pruebas

  function do_ajax_form_cloud_webservicefe_validate_password_pruebas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_password_pruebas_cb

  // ---------- Validate testsetid
  function do_ajax_form_cloud_webservicefe_validate_testsetid()
  {
    var nomeCampo_testsetid = "testsetid";
    var var_testsetid = scAjaxGetFieldText(nomeCampo_testsetid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_testsetid(var_testsetid, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_testsetid_cb);
  } // do_ajax_form_cloud_webservicefe_validate_testsetid

  function do_ajax_form_cloud_webservicefe_validate_testsetid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_testsetid_cb

  // ---------- Validate clave_tecnica
  function do_ajax_form_cloud_webservicefe_validate_clave_tecnica()
  {
    var nomeCampo_clave_tecnica = "clave_tecnica";
    var var_clave_tecnica = scAjaxGetFieldText(nomeCampo_clave_tecnica);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_clave_tecnica(var_clave_tecnica, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_clave_tecnica_cb);
  } // do_ajax_form_cloud_webservicefe_validate_clave_tecnica

  function do_ajax_form_cloud_webservicefe_validate_clave_tecnica_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_clave_tecnica_cb

  // ---------- Validate proveedor_anterior
  function do_ajax_form_cloud_webservicefe_validate_proveedor_anterior()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_proveedor_anterior(var_proveedor_anterior, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_proveedor_anterior_cb);
  } // do_ajax_form_cloud_webservicefe_validate_proveedor_anterior

  function do_ajax_form_cloud_webservicefe_validate_proveedor_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_proveedor_anterior_cb

  // ---------- Validate token_anterior
  function do_ajax_form_cloud_webservicefe_validate_token_anterior()
  {
    var nomeCampo_token_anterior = "token_anterior";
    var var_token_anterior = scAjaxGetFieldText(nomeCampo_token_anterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_token_anterior(var_token_anterior, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_token_anterior_cb);
  } // do_ajax_form_cloud_webservicefe_validate_token_anterior

  function do_ajax_form_cloud_webservicefe_validate_token_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_token_anterior_cb

  // ---------- Validate passwor_anterior
  function do_ajax_form_cloud_webservicefe_validate_passwor_anterior()
  {
    var nomeCampo_passwor_anterior = "passwor_anterior";
    var var_passwor_anterior = scAjaxGetFieldText(nomeCampo_passwor_anterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_validate_passwor_anterior(var_passwor_anterior, var_script_case_init, do_ajax_form_cloud_webservicefe_validate_passwor_anterior_cb);
  } // do_ajax_form_cloud_webservicefe_validate_passwor_anterior

  function do_ajax_form_cloud_webservicefe_validate_passwor_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_validate_passwor_anterior_cb

  // ---------- Event onchange proveedor
  function do_ajax_form_cloud_webservicefe_event_proveedor_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_cloud_webservicefe_event_proveedor_onchange(var_proveedor, var_servidor1, var_servidor2, var_servidor3, var_servidor1_pruebas, var_servidor2_pruebas, var_servidor3_pruebas, var_script_case_init, do_ajax_form_cloud_webservicefe_event_proveedor_onchange_cb);
  } // do_ajax_form_cloud_webservicefe_event_proveedor_onchange

  function do_ajax_form_cloud_webservicefe_event_proveedor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "proveedor";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cloud_webservicefe_event_proveedor_onchange_cb_after_alert);
  } // do_ajax_form_cloud_webservicefe_event_proveedor_onchange_cb
  function do_ajax_form_cloud_webservicefe_event_proveedor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cloud_webservicefe_event_proveedor_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_webservicefe_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_webservicefe_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_webservicefe_submit_form(var_idwebservicefe, var_id_empresa, var_proveedor, var_modo, var_servidor1, var_servidor2, var_servidor3, var_tokenempresa, var_tokenpassword, var_servidor1_pruebas, var_servidor2_pruebas, var_servidor3_pruebas, var_token_pruebas, var_password_pruebas, var_testsetid, var_clave_tecnica, var_proveedor_anterior, var_token_anterior, var_passwor_anterior, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_webservicefe_submit_form_cb);
  } // do_ajax_form_cloud_webservicefe_submit_form

  function do_ajax_form_cloud_webservicefe_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_webservicefe_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_webservicefe_submit_form_cb
  function do_ajax_form_cloud_webservicefe_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_webservicefe_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_webservicefe_navigate_form()
  {
    perform_ajax_form_cloud_webservicefe_navigate_form();
  }

  function perform_ajax_form_cloud_webservicefe_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cloud_webservicefe_navigate_form(var_idwebservicefe, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_webservicefe_navigate_form_cb);
  } // do_ajax_form_cloud_webservicefe_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_webservicefe_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_webservicefe_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_webservicefe_navigate_form_cb
  function do_ajax_form_cloud_webservicefe_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cloud_webservicefe_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cloud_webservicefe_navigate_form_cb_after_alert
  function sc_hide_form_cloud_webservicefe_form()
  {
