  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_webservicefe_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_webservicefe_mob_form();
	}
  ...
  // ---------- Validate idwebservicefe
  function do_ajax_form_cloud_webservicefe_mob_validate_idwebservicefe()
  {
    var nomeCampo_idwebservicefe = "idwebservicefe";
    var var_idwebservicefe = scAjaxGetFieldHidden(nomeCampo_idwebservicefe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_idwebservicefe(var_idwebservicefe, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_idwebservicefe_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_idwebservicefe

  function do_ajax_form_cloud_webservicefe_mob_validate_idwebservicefe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idwebservicefe";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_idwebservicefe_cb

  // ---------- Validate id_empresa
  function do_ajax_form_cloud_webservicefe_mob_validate_id_empresa()
  {
    var nomeCampo_id_empresa = "id_empresa";
    var var_id_empresa = scAjaxGetFieldText(nomeCampo_id_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_id_empresa(var_id_empresa, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_id_empresa_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_id_empresa

  function do_ajax_form_cloud_webservicefe_mob_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_id_empresa_cb

  // ---------- Validate proveedor
  function do_ajax_form_cloud_webservicefe_mob_validate_proveedor()
  {
    var nomeCampo_proveedor = "proveedor";
    var var_proveedor = scAjaxGetFieldSelect(nomeCampo_proveedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_proveedor(var_proveedor, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_proveedor_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_proveedor

  function do_ajax_form_cloud_webservicefe_mob_validate_proveedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_proveedor_cb

  // ---------- Validate modo
  function do_ajax_form_cloud_webservicefe_mob_validate_modo()
  {
    var nomeCampo_modo = "modo";
    var var_modo = scAjaxGetFieldSelect(nomeCampo_modo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_modo(var_modo, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_modo_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_modo

  function do_ajax_form_cloud_webservicefe_mob_validate_modo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_modo_cb

  // ---------- Validate servidor1
  function do_ajax_form_cloud_webservicefe_mob_validate_servidor1()
  {
    var nomeCampo_servidor1 = "servidor1";
    var var_servidor1 = scAjaxGetFieldText(nomeCampo_servidor1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_servidor1(var_servidor1, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_servidor1_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_servidor1

  function do_ajax_form_cloud_webservicefe_mob_validate_servidor1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_servidor1_cb

  // ---------- Validate servidor2
  function do_ajax_form_cloud_webservicefe_mob_validate_servidor2()
  {
    var nomeCampo_servidor2 = "servidor2";
    var var_servidor2 = scAjaxGetFieldText(nomeCampo_servidor2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_servidor2(var_servidor2, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_servidor2_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_servidor2

  function do_ajax_form_cloud_webservicefe_mob_validate_servidor2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_servidor2_cb

  // ---------- Validate servidor3
  function do_ajax_form_cloud_webservicefe_mob_validate_servidor3()
  {
    var nomeCampo_servidor3 = "servidor3";
    var var_servidor3 = scAjaxGetFieldText(nomeCampo_servidor3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_servidor3(var_servidor3, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_servidor3_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_servidor3

  function do_ajax_form_cloud_webservicefe_mob_validate_servidor3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_servidor3_cb

  // ---------- Validate tokenempresa
  function do_ajax_form_cloud_webservicefe_mob_validate_tokenempresa()
  {
    var nomeCampo_tokenempresa = "tokenempresa";
    var var_tokenempresa = scAjaxGetFieldText(nomeCampo_tokenempresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_tokenempresa(var_tokenempresa, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_tokenempresa_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_tokenempresa

  function do_ajax_form_cloud_webservicefe_mob_validate_tokenempresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_tokenempresa_cb

  // ---------- Validate tokenpassword
  function do_ajax_form_cloud_webservicefe_mob_validate_tokenpassword()
  {
    var nomeCampo_tokenpassword = "tokenpassword";
    var var_tokenpassword = scAjaxGetFieldText(nomeCampo_tokenpassword);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_tokenpassword(var_tokenpassword, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_tokenpassword_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_tokenpassword

  function do_ajax_form_cloud_webservicefe_mob_validate_tokenpassword_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_tokenpassword_cb

  // ---------- Validate servidor1_pruebas
  function do_ajax_form_cloud_webservicefe_mob_validate_servidor1_pruebas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_servidor1_pruebas(var_servidor1_pruebas, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_servidor1_pruebas_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_servidor1_pruebas

  function do_ajax_form_cloud_webservicefe_mob_validate_servidor1_pruebas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_servidor1_pruebas_cb

  // ---------- Validate servidor2_pruebas
  function do_ajax_form_cloud_webservicefe_mob_validate_servidor2_pruebas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_servidor2_pruebas(var_servidor2_pruebas, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_servidor2_pruebas_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_servidor2_pruebas

  function do_ajax_form_cloud_webservicefe_mob_validate_servidor2_pruebas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_servidor2_pruebas_cb

  // ---------- Validate servidor3_pruebas
  function do_ajax_form_cloud_webservicefe_mob_validate_servidor3_pruebas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_servidor3_pruebas(var_servidor3_pruebas, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_servidor3_pruebas_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_servidor3_pruebas

  function do_ajax_form_cloud_webservicefe_mob_validate_servidor3_pruebas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_servidor3_pruebas_cb

  // ---------- Validate token_pruebas
  function do_ajax_form_cloud_webservicefe_mob_validate_token_pruebas()
  {
    var nomeCampo_token_pruebas = "token_pruebas";
    var var_token_pruebas = scAjaxGetFieldText(nomeCampo_token_pruebas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_token_pruebas(var_token_pruebas, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_token_pruebas_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_token_pruebas

  function do_ajax_form_cloud_webservicefe_mob_validate_token_pruebas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_token_pruebas_cb

  // ---------- Validate password_pruebas
  function do_ajax_form_cloud_webservicefe_mob_validate_password_pruebas()
  {
    var nomeCampo_password_pruebas = "password_pruebas";
    var var_password_pruebas = scAjaxGetFieldText(nomeCampo_password_pruebas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_password_pruebas(var_password_pruebas, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_password_pruebas_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_password_pruebas

  function do_ajax_form_cloud_webservicefe_mob_validate_password_pruebas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_password_pruebas_cb

  // ---------- Validate testsetid
  function do_ajax_form_cloud_webservicefe_mob_validate_testsetid()
  {
    var nomeCampo_testsetid = "testsetid";
    var var_testsetid = scAjaxGetFieldText(nomeCampo_testsetid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_testsetid(var_testsetid, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_testsetid_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_testsetid

  function do_ajax_form_cloud_webservicefe_mob_validate_testsetid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "testsetid";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_testsetid_cb

  // ---------- Validate clave_tecnica
  function do_ajax_form_cloud_webservicefe_mob_validate_clave_tecnica()
  {
    var nomeCampo_clave_tecnica = "clave_tecnica";
    var var_clave_tecnica = scAjaxGetFieldText(nomeCampo_clave_tecnica);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_clave_tecnica(var_clave_tecnica, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_clave_tecnica_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_clave_tecnica

  function do_ajax_form_cloud_webservicefe_mob_validate_clave_tecnica_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "clave_tecnica";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_clave_tecnica_cb

  // ---------- Validate proveedor_anterior
  function do_ajax_form_cloud_webservicefe_mob_validate_proveedor_anterior()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_proveedor_anterior(var_proveedor_anterior, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_proveedor_anterior_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_proveedor_anterior

  function do_ajax_form_cloud_webservicefe_mob_validate_proveedor_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_proveedor_anterior_cb

  // ---------- Validate token_anterior
  function do_ajax_form_cloud_webservicefe_mob_validate_token_anterior()
  {
    var nomeCampo_token_anterior = "token_anterior";
    var var_token_anterior = scAjaxGetFieldText(nomeCampo_token_anterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_token_anterior(var_token_anterior, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_token_anterior_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_token_anterior

  function do_ajax_form_cloud_webservicefe_mob_validate_token_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_token_anterior_cb

  // ---------- Validate passwor_anterior
  function do_ajax_form_cloud_webservicefe_mob_validate_passwor_anterior()
  {
    var nomeCampo_passwor_anterior = "passwor_anterior";
    var var_passwor_anterior = scAjaxGetFieldText(nomeCampo_passwor_anterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_webservicefe_mob_validate_passwor_anterior(var_passwor_anterior, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_validate_passwor_anterior_cb);
  } // do_ajax_form_cloud_webservicefe_mob_validate_passwor_anterior

  function do_ajax_form_cloud_webservicefe_mob_validate_passwor_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "passwor_anterior";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_webservicefe_mob_validate_passwor_anterior_cb

  // ---------- Event onchange proveedor
  function do_ajax_form_cloud_webservicefe_mob_event_proveedor_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_cloud_webservicefe_mob_event_proveedor_onchange(var_proveedor, var_servidor1, var_servidor2, var_servidor3, var_servidor1_pruebas, var_servidor2_pruebas, var_servidor3_pruebas, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_event_proveedor_onchange_cb);
  } // do_ajax_form_cloud_webservicefe_mob_event_proveedor_onchange

  function do_ajax_form_cloud_webservicefe_mob_event_proveedor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "proveedor";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cloud_webservicefe_mob_event_proveedor_onchange_cb_after_alert);
  } // do_ajax_form_cloud_webservicefe_mob_event_proveedor_onchange_cb
  function do_ajax_form_cloud_webservicefe_mob_event_proveedor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cloud_webservicefe_mob_event_proveedor_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_webservicefe_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_webservicefe_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idwebservicefe = scAjaxGetFieldHidden("idwebservicefe");
    ...
    var var_testsetid = scAjaxGetFieldText("testsetid");
    var var_clave_tecnica = scAjaxGetFieldText("clave_tecnica");
    ...
    var var_passwor_anterior = scAjaxGetFieldText("passwor_anterior");
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_webservicefe_mob_submit_form(var_idwebservicefe, var_id_empresa, var_proveedor, var_modo, var_servidor1, var_servidor2, var_servidor3, var_tokenempresa, var_tokenpassword, var_servidor1_pruebas, var_servidor2_pruebas, var_servidor3_pruebas, var_token_pruebas, var_password_pruebas, var_testsetid, var_clave_tecnica, var_proveedor_anterior, var_token_anterior, var_passwor_anterior, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_webservicefe_mob_submit_form_cb);
  } // do_ajax_form_cloud_webservicefe_mob_submit_form

  function do_ajax_form_cloud_webservicefe_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idwebservicefe");
      ...
      scAjaxHideErrorDisplay("testsetid");
      scAjaxHideErrorDisplay("clave_tecnica");
      scAjaxHideErrorDisplay("proveedor_anterior");
      scAjaxHideErrorDisplay("token_anterior");
      scAjaxHideErrorDisplay("passwor_anterior");
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_webservicefe_mob_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_webservicefe_mob_submit_form_cb
  function do_ajax_form_cloud_webservicefe_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_webservicefe_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_webservicefe_mob_navigate_form()
  {
    perform_ajax_form_cloud_webservicefe_mob_navigate_form();
  }

  function perform_ajax_form_cloud_webservicefe_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cloud_webservicefe_mob_navigate_form(var_idwebservicefe, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_webservicefe_mob_navigate_form_cb);
  } // do_ajax_form_cloud_webservicefe_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_webservicefe_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_webservicefe_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_webservicefe_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_webservicefe_mob_navigate_form_cb
  function do_ajax_form_cloud_webservicefe_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cloud_webservicefe_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_cloud_webservicefe_mob_navigate_form_cb_after_alert
  function sc_hide_form_cloud_webservicefe_mob_form()
  {
  ...
  ajax_field_list[0] = "idwebservicefe";
  ajax_field_list[1] = "id_empresa";
  ajax_field_list[2] = "proveedor";
  ajax_field_list[3] = "modo";
  ajax_field_list[4] = "servidor1";
  ajax_field_list[5] = "servidor2";
  ajax_field_list[6] = "servidor3";
  ajax_field_list[7] = "tokenempresa";
  ajax_field_list[8] = "tokenpassword";
  ajax_field_list[9] = "servidor1_pruebas";
  ajax_field_list[10] = "servidor2_pruebas";
  ajax_field_list[11] = "servidor3_pruebas";
  ajax_field_list[12] = "token_pruebas";
  ajax_field_list[13] = "password_pruebas";
  ajax_field_list[14] = "testsetid";
  ajax_field_list[15] = "clave_tecnica";
  ajax_field_list[16] = "proveedor_anterior";
  ajax_field_list[17] = "token_anterior";
  ajax_field_list[18] = "passwor_anterior";
  ...
  var ajax_error_list = {
    "idwebservicefe": {"label": "Idwebservicefe", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "testsetid": {"label": "TestSetId", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "clave_tecnica": {"label": "Clave Técnica", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "passwor_anterior": {"label": "Passwor Anterior", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "testsetid": new Array(),
    "clave_tecnica": new Array(),
    "proveedor_anterior": new Array(),
    "token_anterior": new Array(),
    "passwor_anterior": new Array()
  };
  ajax_field_mult["idwebservicefe"][1] = "idwebservicefe";
  ...
  ajax_field_mult["testsetid"][1] = "testsetid";
  ajax_field_mult["clave_tecnica"][1] = "clave_tecnica";
  ajax_field_mult["proveedor_anterior"][1] = "proveedor_anterior";
  ajax_field_mult["token_anterior"][1] = "token_anterior";
  ajax_field_mult["passwor_anterior"][1] = "passwor_anterior";
  ...
  var ajax_field_id = {
    ...
    "testsetid": new Array("hidden_field_label_testsetid", "hidden_field_data_testsetid"),
    "clave_tecnica": new Array("hidden_field_label_clave_tecnica", "hidden_field_data_clave_tecnica"),
    ...
    "passwor_anterior": new Array("hidden_field_label_passwor_anterior", "hidden_field_data_passwor_anterior")
  };
