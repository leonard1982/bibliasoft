...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'tokenempresa':
      case 'tokenpassword':
        sc_exib_ocult_pag('form_cloud_webservicefe_mob_form0');
        break;
      ...
      case 'testsetid':
      case 'clave_tecnica':
        sc_exib_ocult_pag('form_cloud_webservicefe_mob_form1');
        break;
      case 'proveedor_anterior':
      case 'token_anterior':
      case 'passwor_anterior':
        sc_exib_ocult_pag('form_cloud_webservicefe_mob_form2');
        break;
    }
  }
...
function scHidePage(pageNo) {
	$("#id_form_cloud_webservicefe_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_cloud_webservicefe_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
