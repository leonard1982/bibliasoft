<?php
@session_start() ;
$_SESSION['scriptcase']['grid_venta_productos_entre_fechas']['sc_process_barr'] = true;
require_once('../grid_venta_productos_entre_fechas/index.php');
unset($_SESSION['scriptcase']['grid_venta_productos_entre_fechas']['sc_process_barr']);
$ExportCtrl = new grid_venta_productos_entre_fechas_export_control;
$ExportCtrl->Export_barr();

class grid_venta_productos_entre_fechas_export_control
{
