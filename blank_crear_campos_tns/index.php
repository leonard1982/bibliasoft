<?php
   include_once('blank_crear_campos_tns_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_perfil']          = "conn_firebird";
   $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class blank_crear_campos_tns_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "blank_crear_campos_tns"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['blank_crear_campos_tns']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['blank_crear_campos_tns']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['blank_crear_campos_tns']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/blank_crear_campos_tns';
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['blank_crear_campos_tns']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['blank_crear_campos_tns']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['blank_crear_campos_tns']['actual_lang']) || $_SESSION['scriptcase']['blank_crear_campos_tns']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['blank_crear_campos_tns']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("blank_crear_campos_tns_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_crear_campos_tns"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_crear_campos_tns"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['blank_crear_campos_tns']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "blank_crear_campos_tns_erro.class.php"); 
      $this->Erro = new blank_crear_campos_tns_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blank_crear_campos_tns'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['blank_crear_campos_tns']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['blank_crear_campos_tns']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['blank_crear_campos_tns']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['blank_crear_campos_tns']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['blank_crear_campos_tns']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['blank_crear_campos_tns']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_conexao']) && $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_perfil']) && $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEB_FE_73', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_crear_campos_tns']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class blank_crear_campos_tns_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blank_crear_campos_tns_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_crear_campos_tns']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blank_crear_campos_tns']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_crear_campos_tns']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_crear_campos_tns'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_crear_campos_tns']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_crear_campos_tns']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blank_crear_campos_tns') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_crear_campos_tns']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['blank_crear_campos_tns']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['blank_crear_campos_tns']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['blank_crear_campos_tns']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blank_crear_campos_tns_erro.class.php"); 
      $this->Erro      = new blank_crear_campos_tns_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['blank_crear_campos_tns']['contr_erro'] = 'on';
...
if (!isset($this->sc_temp_gprefijos)) {$this->sc_temp_gprefijos = (isset($_SESSION['gprefijos'])) ? $_SESSION['gprefijos'] : "";}
 $vsql = "SELECT RDB\$RELATION_NAME AS NombreTabla FROM RDB\$RELATIONS WHERE RDB\$RELATION_NAME = 'CORREOS_VALIDADOS'";
 
      $nm_select = $vsql; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste23 = array();
      $this->vsiexiste23 = array();
      ...
      { 
          ...
          { 
                 ...
                 { 
                        $this->vSiExiste23[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste23[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vSiExiste23 = false;
          $this->vSiExiste23_erro = $this->Db->ErrorMsg();
          $this->vsiexiste23 = false;
          $this->vsiexiste23_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste23[0][0]))
{
	$vsql = "CREATE TABLE CORREOS_VALIDADOS(CORREO VARCHAR(120) NOT NULL, NIT VARCHAR(20) NOT NULL, FECHA TIMESTAMP DEFAULT CURRENT_TIMESTAMP, VALIDO VARCHAR(2) NOT NULL,JSON VARCHAR(500));";
...
$vsql = "SELECT FIRST 1 * FROM KARDEX WHERE CODCOMP='FV'";
      ...
      { 
          ...
          $this->vSiKardex_erro = $this->Db->ErrorMsg();
          $this->vsikardex = false;
          $this->vsikardex_erro = $this->Db->ErrorMsg();
      } 
;
...
$vsql6 = "SELECT CODIGO FROM MOTIVODEV WHERE CODIGO='1'";

 
      $nm_select = $vsql6; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste6 = array();
      $this->vsiexiste6 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste6[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste6[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste6 = false;
          $this->vSiExiste6_erro = $this->Db->ErrorMsg();
          $this->vsiexiste6 = false;
          $this->vsiexiste6_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste6[0][0]))
{
	
     $nm_select = "insert into motivodev(codigo,descripcion)values('1','DEVOLUCION DE PARTE DE LOS BIENES')"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
else
{
     ...
     $nm_select = "update motivodev set descripcion='DEVOLUCION DE PARTE DE LOS BIENES' where codigo='1'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql7 = "SELECT CODIGO FROM MOTIVODEV WHERE CODIGO='2'";

 
      $nm_select = $vsql7; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste7 = array();
      $this->vsiexiste7 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste7[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste7[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste7 = false;
          $this->vSiExiste7_erro = $this->Db->ErrorMsg();
          $this->vsiexiste7 = false;
          $this->vsiexiste7_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste7[0][0]))
{
	
     $nm_select = "insert into motivodev(codigo,descripcion)values('2','ANULACION DE FACTURA ELECTRONICA')"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
else
{
     ...
     $nm_select = "update motivodev set descripcion='ANULACION DE FACTURA ELECTRONICA' where codigo='2'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql8 = "SELECT CODIGO FROM MOTIVODEV WHERE CODIGO='3'";

 
      $nm_select = $vsql8; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste8 = array();
      $this->vsiexiste8 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste8[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste8[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste8 = false;
          $this->vSiExiste8_erro = $this->Db->ErrorMsg();
          $this->vsiexiste8 = false;
          $this->vsiexiste8_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste8[0][0]))
{
	
     $nm_select = "insert into motivodev(codigo,descripcion)values('3','REBAJA TOTAL APLICADA')"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
else
{
     ...
     $nm_select = "update motivodev set descripcion='REBAJA TOTAL APLICADA' where codigo='3'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql9 = "SELECT CODIGO FROM MOTIVODEV WHERE CODIGO='4'";

 
      $nm_select = $vsql9; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste9 = array();
      $this->vsiexiste9 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste9[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste9[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste9 = false;
          $this->vSiExiste9_erro = $this->Db->ErrorMsg();
          $this->vsiexiste9 = false;
          $this->vsiexiste9_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste9[0][0]))
{
	
     $nm_select = "insert into motivodev(codigo,descripcion)values('4','DESCUENTO TOTAL APLICADO')"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
else
{
     ...
     $nm_select = "update motivodev set descripcion='DESCUENTO TOTAL APLICADO' where codigo='4'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql10 = "SELECT CODIGO FROM MOTIVODEV WHERE CODIGO='5'";

 
      $nm_select = $vsql10; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste10 = array();
      $this->vsiexiste10 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste10[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste10[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste10 = false;
          $this->vSiExiste10_erro = $this->Db->ErrorMsg();
          $this->vsiexiste10 = false;
          $this->vsiexiste10_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste10[0][0]))
{
	
     $nm_select = "insert into motivodev(codigo,descripcion)values('5','NULIDAD POR FALTA DE REQUISITOS')"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
else
{
     ...
     $nm_select = "update motivodev set descripcion='NULIDAD POR FALTA DE REQUISITOS' where codigo='5'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql11 = "SELECT CODIGO FROM MOTIVODEV WHERE CODIGO='6'";

 
      $nm_select = $vsql11; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste11 = array();
      $this->vsiexiste11 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste11[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste11[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste11 = false;
          $this->vSiExiste11_erro = $this->Db->ErrorMsg();
          $this->vsiexiste11 = false;
          $this->vsiexiste11_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste11[0][0]))
{
	
     $nm_select = "insert into motivodev(codigo,descripcion)values('6','OTROS')"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
else
{
     ...
     $nm_select = "update motivodev set descripcion='OTROS' where codigo='6'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql12 = "SELECT RDB\$FIELD_NAME AS CAMPO FROM RDB\$RELATION_FIELDS WHERE RDB\$RELATION_NAME = 'KARDEX' AND RDB\$FIELD_NAME = 'SN_QR_BASE64'";

 
      $nm_select = $vsql12; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste12 = array();
      $this->vsiexiste12 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste12[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste12[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste12 = false;
          $this->vSiExiste12_erro = $this->Db->ErrorMsg();
          $this->vsiexiste12 = false;
          $this->vsiexiste12_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste12[0][0]))
{
	
     $nm_select = "ALTER TABLE KARDEX ADD SN_QR_BASE64 BLOB"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql13 = "SELECT RDB\$FIELD_NAME AS CAMPO FROM RDB\$RELATION_FIELDS WHERE RDB\$RELATION_NAME = 'KARDEX' AND RDB\$FIELD_NAME = 'SN_MENSAJESFE'";

 
      $nm_select = $vsql13; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste13 = array();
      $this->vsiexiste13 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste13[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste13[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste13 = false;
          $this->vSiExiste13_erro = $this->Db->ErrorMsg();
          $this->vsiexiste13 = false;
          $this->vsiexiste13_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste13[0][0]))
{
	
     $nm_select = "ALTER TABLE KARDEX ADD SN_MENSAJESFE VARCHAR(2000)"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql14 = "SELECT RDB\$FIELD_NAME AS CAMPO FROM RDB\$RELATION_FIELDS WHERE RDB\$RELATION_NAME = 'KARDEX' AND RDB\$FIELD_NAME = 'SN_NOMBRE_ARCHIVOS'";

 
      $nm_select = $vsql14; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste14 = array();
      $this->vsiexiste14 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste14[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste14[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste14 = false;
          $this->vSiExiste14_erro = $this->Db->ErrorMsg();
          $this->vsiexiste14 = false;
          $this->vsiexiste14_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste14[0][0]))
{
	
     $nm_select = "ALTER TABLE KARDEX ADD SN_NOMBRE_ARCHIVOS VARCHAR(120)"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql15 = "SELECT RDB\$FIELD_NAME AS CAMPO FROM RDB\$RELATION_FIELDS WHERE RDB\$RELATION_NAME = 'KARDEX' AND RDB\$FIELD_NAME = 'ESTADODIAN'";

 
      $nm_select = $vsql15; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste15 = array();
      $this->vsiexiste15 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste15[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste15[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste15 = false;
          $this->vSiExiste15_erro = $this->Db->ErrorMsg();
          $this->vsiexiste15 = false;
          $this->vsiexiste15_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste15[0][0]))
{
	
     $nm_select = "ALTER TABLE KARDEX ADD ESTADODIAN VARCHAR(20)"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql16 = "SELECT RDB\$FIELD_NAME AS CAMPO FROM RDB\$RELATION_FIELDS WHERE RDB\$RELATION_NAME = 'KARDEX' AND RDB\$FIELD_NAME = 'CUFE'";

 
      $nm_select = $vsql16; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste16 = array();
      $this->vsiexiste16 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste16[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste16[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste16 = false;
          $this->vSiExiste16_erro = $this->Db->ErrorMsg();
          $this->vsiexiste16 = false;
          $this->vsiexiste16_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste16[0][0]))
{
	
     $nm_select = "ALTER TABLE KARDEX ADD CUFE VARCHAR(500)"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql17 = "SELECT RDB\$FIELD_NAME AS CAMPO FROM RDB\$RELATION_FIELDS WHERE RDB\$RELATION_NAME = 'KARDEX' AND RDB\$FIELD_NAME = 'SN_ENLACEPDF'";

 
      $nm_select = $vsql17; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste17 = array();
      $this->vsiexiste17 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste17[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste17[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste17 = false;
          $this->vSiExiste17_erro = $this->Db->ErrorMsg();
          $this->vsiexiste17 = false;
          $this->vsiexiste17_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste17[0][0]))
{
	
     $nm_select = "ALTER TABLE KARDEX ADD SN_ENLACEPDF VARCHAR(300)"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql18 = "SELECT RDB\$FIELD_NAME AS CAMPO FROM RDB\$RELATION_FIELDS WHERE RDB\$RELATION_NAME = 'KARDEX' AND RDB\$FIELD_NAME = 'SN_ENLACEXML'";

 
      $nm_select = $vsql18; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExiste18 = array();
      $this->vsiexiste18 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExiste18[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexiste18[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExiste18 = false;
          $this->vSiExiste18_erro = $this->Db->ErrorMsg();
          $this->vsiexiste18 = false;
          $this->vsiexiste18_erro = $this->Db->ErrorMsg();
      } 
;
if(!isset($this->vsiexiste18[0][0]))
{
	
     $nm_select = "ALTER TABLE KARDEX ADD SN_ENLACEXML VARCHAR(300)"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
echo "Campos creados con éxito";

?>
<script>
	window.onload = function(){
		location.href = "../grid_menu";
	}
</script>
<?php
if (isset($this->sc_temp_gprefijos)) {$_SESSION['gprefijos'] = $this->sc_temp_gprefijos;}
$_SESSION['scriptcase']['blank_crear_campos_tns']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blank_crear_campos_tns($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_crear_campos_tns']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank_crear_campos_tns") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['blank_crear_campos_tns']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['blank_crear_campos_tns']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['blank_crear_campos_tns']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEB_FE_73'])) {
               $_SESSION['scriptcase']['blank_crear_campos_tns']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEB_FE_73'];
           }
       }
   }
   ...
   if (isset($_POST["gprefijos"])) 
   {
       ...
       nm_limpa_str_blank_crear_campos_tns($_SESSION["gprefijos"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "blank_crear_campos_tns";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'blank_crear_campos_tns' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blank_crear_campos_tns' == $sReferer || 'blank_crear_campos_tns_' == substr($sReferer, 0, 23))
       {
           $_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'blank_crear_campos_tns')
   {
       $_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['blank_crear_campos_tns']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blank_crear_campos_tns_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blank_crear_campos_tns($cadapar[1]);
   ...
   $contr_blank_crear_campos_tns = new blank_crear_campos_tns_apl();
   $contr_blank_crear_campos_tns->controle();
//
   function nm_limpa_str_blank_crear_campos_tns(&$str)
   {
