<?php
@session_start() ;
$_SESSION['scriptcase']['grid_terceros_nube']['sc_process_barr'] = true;
require_once('../grid_terceros_nube/index.php');
unset($_SESSION['scriptcase']['grid_terceros_nube']['sc_process_barr']);
$ExportCtrl = new grid_terceros_nube_export_control;
$ExportCtrl->Export_barr();

class grid_terceros_nube_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_terceros_nube']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_terceros_nube']['glo_nm_path_imag_temp'];
