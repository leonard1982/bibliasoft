...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_terceros_nube"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_terceros_nube"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_nube']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_terceros_nube']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_nube']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_terceros_nube']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_terceros_nube']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_terceros_nube</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_nube']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_terceros_nube']['embutida_filho'] as $ind => $sc_init)
          {
