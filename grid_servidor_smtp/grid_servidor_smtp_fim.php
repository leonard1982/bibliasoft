...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_servidor_smtp"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_servidor_smtp"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_servidor_smtp'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_servidor_smtp']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_servidor_smtp']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_servidor_smtp']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_servidor_smtp']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_servidor_smtp']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_servidor_smtp</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_servidor_smtp']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_servidor_smtp']['embutida_filho'] as $ind => $sc_init)
          {
