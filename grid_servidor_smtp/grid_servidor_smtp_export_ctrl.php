<?php
@session_start() ;
$_SESSION['scriptcase']['grid_servidor_smtp']['sc_process_barr'] = true;
require_once('../grid_servidor_smtp/index.php');
unset($_SESSION['scriptcase']['grid_servidor_smtp']['sc_process_barr']);
$ExportCtrl = new grid_servidor_smtp_export_control;
$ExportCtrl->Export_barr();

class grid_servidor_smtp_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_servidor_smtp']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_servidor_smtp']['glo_nm_path_imag_temp'];
