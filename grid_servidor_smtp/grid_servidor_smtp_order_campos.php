<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_servidor_smtp']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_servidor_smtp_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_servidor_smtp_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["servidor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['labels']["servidor"])) ? $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['labels']["servidor"] : "Servidor";
   $tab_ger_campos['puerto'] = "on";
   $tab_def_campos['puerto'] = "puerto";
   $tab_labels["puerto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['labels']["puerto"])) ? $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['labels']["puerto"] : "Puerto";
   $tab_ger_campos['usuario'] = "on";
   $tab_def_campos['usuario'] = "usuario";
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['tls_ssl'] = "on";
   $tab_def_campos['tls_ssl'] = "tls_ssl";
   $tab_labels["tls_ssl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['labels']["tls_ssl"])) ? $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['labels']["tls_ssl"] : "TLS/SSL";
   $tab_ger_campos['activo'] = "on";
   $tab_def_campos['activo'] = "activo";
   $tab_labels["activo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['labels']["activo"])) ? $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['labels']["activo"] : "Activo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_servidor_smtp_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_servidor_smtp']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
