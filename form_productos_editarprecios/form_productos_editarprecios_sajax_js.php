  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_productos_editarprecios" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_productos_editarprecios_form();
	}
...
?>
  ...
  // ---------- Validate codigobar_
  function do_ajax_form_productos_editarprecios_validate_codigobar_(iNumLinha)
  {
    var nomeCampo_codigobar_ = "codigobar_" + iNumLinha;
    var var_codigobar_ = scAjaxGetFieldHidden(nomeCampo_codigobar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarprecios_validate_codigobar_(var_codigobar_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarprecios_validate_codigobar__cb);
  } // do_ajax_form_productos_editarprecios_validate_codigobar_

  function do_ajax_form_productos_editarprecios_validate_codigobar__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarprecios_validate_codigobar__cb

  // ---------- Validate codigoprod_
  function do_ajax_form_productos_editarprecios_validate_codigoprod_(iNumLinha)
  {
    var nomeCampo_codigoprod_ = "codigoprod_" + iNumLinha;
    var var_codigoprod_ = scAjaxGetFieldHidden(nomeCampo_codigoprod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarprecios_validate_codigoprod_(var_codigoprod_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarprecios_validate_codigoprod__cb);
  } // do_ajax_form_productos_editarprecios_validate_codigoprod_

  function do_ajax_form_productos_editarprecios_validate_codigoprod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codigoprod_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigoprod_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codigoprod_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigoprod_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarprecios_validate_codigoprod__cb

  // ---------- Validate nompro_
  function do_ajax_form_productos_editarprecios_validate_nompro_(iNumLinha)
  {
    var nomeCampo_nompro_ = "nompro_" + iNumLinha;
    var var_nompro_ = scAjaxGetFieldHidden(nomeCampo_nompro_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarprecios_validate_nompro_(var_nompro_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarprecios_validate_nompro__cb);
  } // do_ajax_form_productos_editarprecios_validate_nompro_

  function do_ajax_form_productos_editarprecios_validate_nompro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarprecios_validate_nompro__cb

  // ---------- Validate preciomen_
  function do_ajax_form_productos_editarprecios_validate_preciomen_(iNumLinha)
  {
    var nomeCampo_preciomen_ = "preciomen_" + iNumLinha;
    var var_preciomen_ = scAjaxGetFieldText(nomeCampo_preciomen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarprecios_validate_preciomen_(var_preciomen_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarprecios_validate_preciomen__cb);
  } // do_ajax_form_productos_editarprecios_validate_preciomen_

  function do_ajax_form_productos_editarprecios_validate_preciomen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarprecios_validate_preciomen__cb

  // ---------- Validate preciomen2_
  function do_ajax_form_productos_editarprecios_validate_preciomen2_(iNumLinha)
  {
    var nomeCampo_preciomen2_ = "preciomen2_" + iNumLinha;
    var var_preciomen2_ = scAjaxGetFieldText(nomeCampo_preciomen2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarprecios_validate_preciomen2_(var_preciomen2_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarprecios_validate_preciomen2__cb);
  } // do_ajax_form_productos_editarprecios_validate_preciomen2_

  function do_ajax_form_productos_editarprecios_validate_preciomen2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "preciomen2_" + iLineNumber;
    }
    else
    {
      sFieldValid = "preciomen2_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "preciomen2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "preciomen2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarprecios_validate_preciomen2__cb

  // ---------- Validate preciomen3_
  function do_ajax_form_productos_editarprecios_validate_preciomen3_(iNumLinha)
  {
    var nomeCampo_preciomen3_ = "preciomen3_" + iNumLinha;
    var var_preciomen3_ = scAjaxGetFieldText(nomeCampo_preciomen3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarprecios_validate_preciomen3_(var_preciomen3_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarprecios_validate_preciomen3__cb);
  } // do_ajax_form_productos_editarprecios_validate_preciomen3_

  function do_ajax_form_productos_editarprecios_validate_preciomen3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "preciomen3_" + iLineNumber;
    }
    else
    {
      sFieldValid = "preciomen3_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "preciomen3_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "preciomen3_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarprecios_validate_preciomen3__cb

  // ---------- Validate precio2_
  function do_ajax_form_productos_editarprecios_validate_precio2_(iNumLinha)
  {
    var nomeCampo_precio2_ = "precio2_" + iNumLinha;
    var var_precio2_ = scAjaxGetFieldText(nomeCampo_precio2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarprecios_validate_precio2_(var_precio2_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarprecios_validate_precio2__cb);
  } // do_ajax_form_productos_editarprecios_validate_precio2_

  function do_ajax_form_productos_editarprecios_validate_precio2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "precio2_" + iLineNumber;
    }
    else
    {
      sFieldValid = "precio2_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "precio2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "precio2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarprecios_validate_precio2__cb

  // ---------- Validate preciomay_
  function do_ajax_form_productos_editarprecios_validate_preciomay_(iNumLinha)
  {
    var nomeCampo_preciomay_ = "preciomay_" + iNumLinha;
    var var_preciomay_ = scAjaxGetFieldText(nomeCampo_preciomay_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarprecios_validate_preciomay_(var_preciomay_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarprecios_validate_preciomay__cb);
  } // do_ajax_form_productos_editarprecios_validate_preciomay_

  function do_ajax_form_productos_editarprecios_validate_preciomay__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "preciomay_" + iLineNumber;
    }
    else
    {
      sFieldValid = "preciomay_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "preciomay_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "preciomay_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarprecios_validate_preciomay__cb

  // ---------- Validate preciofull_
  function do_ajax_form_productos_editarprecios_validate_preciofull_(iNumLinha)
  {
    var nomeCampo_preciofull_ = "preciofull_" + iNumLinha;
    var var_preciofull_ = scAjaxGetFieldText(nomeCampo_preciofull_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarprecios_validate_preciofull_(var_preciofull_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarprecios_validate_preciofull__cb);
  } // do_ajax_form_productos_editarprecios_validate_preciofull_

  function do_ajax_form_productos_editarprecios_validate_preciofull__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "preciofull_" + iLineNumber;
    }
    else
    {
      sFieldValid = "preciofull_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "preciofull_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "preciofull_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarprecios_validate_preciofull__cb

  // ---------- Validate costomen_
  function do_ajax_form_productos_editarprecios_validate_costomen_(iNumLinha)
  {
    var nomeCampo_costomen_ = "costomen_" + iNumLinha;
    var var_costomen_ = scAjaxGetFieldText(nomeCampo_costomen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarprecios_validate_costomen_(var_costomen_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarprecios_validate_costomen__cb);
  } // do_ajax_form_productos_editarprecios_validate_costomen_

  function do_ajax_form_productos_editarprecios_validate_costomen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarprecios_validate_costomen__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_productos_editarprecios_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_productos_editarprecios_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_editarprecios_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_productos_editarprecios_add_new_line_cb);
  } // do_ajax_form_productos_editarprecios_add_new_line

  function do_ajax_form_productos_editarprecios_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_productos_editarprecios_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_productos_editarprecios_backup_line(iNumLinha)
  {
    var var_idprod_ = scAjaxGetFieldText("idprod_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarprecios_backup_line(var_idprod_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_productos_editarprecios_backup_line_cb);
  } // do_ajax_form_productos_editarprecios_backup_line

  function do_ajax_form_productos_editarprecios_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_productos_editarprecios_backup_line_cb

  function do_ajax_form_productos_editarprecios_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_productos_editarprecios_cancel_insert

  function do_ajax_form_productos_editarprecios_cancel_update(iSeqVert)
  {
    do_ajax_form_productos_editarprecios_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_productos_editarprecios_cancel_update

  function do_ajax_form_productos_editarprecios_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_productos_editarprecios_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_productos_editarprecios_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_productos_editarprecios_table_refresh(var_idprod_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_productos_editarprecios_table_refresh_cb);
  } //  do_ajax_form_productos_editarprecios_table_refresh

  function do_ajax_form_productos_editarprecios_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_productos_editarprecios_table_refresh_cb_after_alert);
  } // do_ajax_form_productos_editarprecios_table_refresh_cb
  function do_ajax_form_productos_editarprecios_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_productos_editarprecios_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_productos_editarprecios_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_productos_editarprecios_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_codigoprod_ = scAjaxGetFieldHidden("codigoprod_" + iNumLinha);
    var var_nompro_ = scAjaxGetFieldHidden("nompro_" + iNumLinha);
    var var_preciomen_ = scAjaxGetFieldText("preciomen_" + iNumLinha);
    var var_preciomen2_ = scAjaxGetFieldText("preciomen2_" + iNumLinha);
    var var_preciomen3_ = scAjaxGetFieldText("preciomen3_" + iNumLinha);
    var var_precio2_ = scAjaxGetFieldText("precio2_" + iNumLinha);
    var var_preciomay_ = scAjaxGetFieldText("preciomay_" + iNumLinha);
    var var_preciofull_ = scAjaxGetFieldText("preciofull_" + iNumLinha);
...
?>
    x_ajax_form_productos_editarprecios_submit_form(var_codigobar_, var_codigoprod_, var_nompro_, var_preciomen_, var_preciomen2_, var_preciomen3_, var_precio2_, var_preciomay_, var_preciofull_, var_costomen_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_productos_editarprecios_submit_form_cb);
  } // do_ajax_form_productos_editarprecios_submit_form

  function do_ajax_form_productos_editarprecios_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("codigoprod_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nompro_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("preciomen_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("preciomen2_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("preciomen3_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("precio2_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("preciomay_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("preciofull_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_editarprecios_submit_form_cb_after_alert);
  } // do_ajax_form_productos_editarprecios_submit_form_cb
  function do_ajax_form_productos_editarprecios_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_productos_editarprecios_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_productos_editarprecios_navigate_form()
  {
    perform_ajax_form_productos_editarprecios_navigate_form();
  }

  function perform_ajax_form_productos_editarprecios_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("codigoprod_" + iNavForm);
      scAjaxHideErrorDisplay("nompro_" + iNavForm);
      scAjaxHideErrorDisplay("preciomen_" + iNavForm);
      scAjaxHideErrorDisplay("preciomen2_" + iNavForm);
      scAjaxHideErrorDisplay("preciomen3_" + iNavForm);
      scAjaxHideErrorDisplay("precio2_" + iNavForm);
      scAjaxHideErrorDisplay("preciomay_" + iNavForm);
      scAjaxHideErrorDisplay("preciofull_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_productos_editarprecios_navigate_form(var_idprod_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_productos_editarprecios_navigate_form_cb);
  } // do_ajax_form_productos_editarprecios_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_editarprecios']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_productos_editarprecios_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_productos_editarprecios_navigate_form_cb_after_alert);
  } // do_ajax_form_productos_editarprecios_navigate_form_cb
  function do_ajax_form_productos_editarprecios_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_productos_editarprecios_navigate_form_cb_after_alert
  function sc_hide_form_productos_editarprecios_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigoprod_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nompro_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "preciomen_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "preciomen2_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "preciomen3_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "precio2_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "preciomay_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "preciofull_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "costomen_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["codigobar_" + iNumLinha] = {"label": "CodBarra<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codigoprod_" + iNumLinha] = {"label": "Codigo Producto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["preciomen2_" + iNumLinha] = {"label": "Precio Especial Menudeo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["preciomen3_" + iNumLinha] = {"label": "Precio al Mayor Menudeo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["precio2_" + iNumLinha] = {"label": "Precio Full<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["preciomay_" + iNumLinha] = {"label": "Precio Especial<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["preciofull_" + iNumLinha] = {"label": "Precio al Mayor<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["costomen_" + iNumLinha] = {"label": "Costo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["codigobar_"][iNumLinha] = "codigobar_" + iNumLinha;
    ajax_field_mult["codigoprod_"][iNumLinha] = "codigoprod_" + iNumLinha;
    ajax_field_mult["nompro_"][iNumLinha] = "nompro_" + iNumLinha;
    ajax_field_mult["preciomen_"][iNumLinha] = "preciomen_" + iNumLinha;
    ajax_field_mult["preciomen2_"][iNumLinha] = "preciomen2_" + iNumLinha;
    ajax_field_mult["preciomen3_"][iNumLinha] = "preciomen3_" + iNumLinha;
    ajax_field_mult["precio2_"][iNumLinha] = "precio2_" + iNumLinha;
    ajax_field_mult["preciomay_"][iNumLinha] = "preciomay_" + iNumLinha;
    ajax_field_mult["preciofull_"][iNumLinha] = "preciofull_" + iNumLinha;
    ...
    ajax_field_id["codigoprod_" + iNumLinha] = new Array("hidden_field_label_codigoprod_", "hidden_field_data_codigoprod_" + iNumLinha);
    ...
    ajax_field_id["preciomen2_" + iNumLinha] = new Array("hidden_field_label_preciomen2_", "hidden_field_data_preciomen2_" + iNumLinha);
    ajax_field_id["preciomen3_" + iNumLinha] = new Array("hidden_field_label_preciomen3_", "hidden_field_data_preciomen3_" + iNumLinha);
    ajax_field_id["precio2_" + iNumLinha] = new Array("hidden_field_label_precio2_", "hidden_field_data_precio2_" + iNumLinha);
    ajax_field_id["preciomay_" + iNumLinha] = new Array("hidden_field_label_preciomay_", "hidden_field_data_preciomay_" + iNumLinha);
    ajax_field_id["preciofull_" + iNumLinha] = new Array("hidden_field_label_preciofull_", "hidden_field_data_preciofull_" + iNumLinha);
    ...
    ajax_error_count["codigoprod_" + iNumLinha] = "off";
    ajax_error_count["nompro_" + iNumLinha] = "off";
    ajax_error_count["preciomen_" + iNumLinha] = "off";
    ajax_error_count["preciomen2_" + iNumLinha] = "off";
    ajax_error_count["preciomen3_" + iNumLinha] = "off";
    ajax_error_count["precio2_" + iNumLinha] = "off";
    ajax_error_count["preciomay_" + iNumLinha] = "off";
    ajax_error_count["preciofull_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["codigoprod_" + iNumLinha] = "off";
    ajax_read_only["nompro_" + iNumLinha] = "off";
    ajax_read_only["preciomen_" + iNumLinha] = "off";
    ajax_read_only["preciomen2_" + iNumLinha] = "off";
    ajax_read_only["preciomen3_" + iNumLinha] = "off";
    ajax_read_only["precio2_" + iNumLinha] = "off";
    ajax_read_only["preciomay_" + iNumLinha] = "off";
    ajax_read_only["preciofull_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["codigoprod_" + iNumLinha] = "on";
    ajax_read_only["nompro_" + iNumLinha] = "on";
    ajax_read_only["preciomen_" + iNumLinha] = "on";
    ajax_read_only["preciomen2_" + iNumLinha] = "on";
    ajax_read_only["preciomen3_" + iNumLinha] = "on";
    ajax_read_only["precio2_" + iNumLinha] = "on";
    ajax_read_only["preciomay_" + iNumLinha] = "on";
    ajax_read_only["preciofull_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["codigoprod_" + iNumLinha] = null;
    ajax_error_list["nompro_" + iNumLinha] = null;
    ajax_error_list["preciomen_" + iNumLinha] = null;
    ajax_error_list["preciomen2_" + iNumLinha] = null;
    ajax_error_list["preciomen3_" + iNumLinha] = null;
    ajax_error_list["precio2_" + iNumLinha] = null;
    ajax_error_list["preciomay_" + iNumLinha] = null;
    ajax_error_list["preciofull_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    ...
    "codigoprod_": new Array(),
    "nompro_": new Array(),
    "preciomen_": new Array(),
    "preciomen2_": new Array(),
    "preciomen3_": new Array(),
    "precio2_": new Array(),
    "preciomay_": new Array(),
    "preciofull_": new Array(),
    "costomen_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["codigoprod_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigoprod_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigoprod_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigoprod_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigoprod_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["preciomen2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["preciomen2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["preciomen2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["preciomen2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["preciomen2_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["preciomen3_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["preciomen3_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["preciomen3_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["preciomen3_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["preciomen3_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["precio2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["precio2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["precio2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["precio2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["precio2_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["preciomay_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["preciomay_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["preciomay_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["preciomay_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["preciomay_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["preciofull_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["preciofull_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["preciofull_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["preciofull_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["preciofull_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigoprod_'])) ? $this->nmgp_cmp_readonly['codigoprod_'] : 'off';
?>
    scAjaxFieldRead("codigoprod_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['preciomen2_'])) ? $this->nmgp_cmp_readonly['preciomen2_'] : 'off';
?>
    scAjaxFieldRead("preciomen2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['preciomen3_'])) ? $this->nmgp_cmp_readonly['preciomen3_'] : 'off';
?>
    scAjaxFieldRead("preciomen3_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['precio2_'])) ? $this->nmgp_cmp_readonly['precio2_'] : 'off';
?>
    scAjaxFieldRead("precio2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['preciomay_'])) ? $this->nmgp_cmp_readonly['preciomay_'] : 'off';
?>
    scAjaxFieldRead("preciomay_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['preciofull_'])) ? $this->nmgp_cmp_readonly['preciofull_'] : 'off';
?>
    scAjaxFieldRead("preciofull_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("codigoprod_" + iSeq, "on");
    scAjaxFieldRead("nompro_" + iSeq, "on");
    scAjaxFieldRead("preciomen_" + iSeq, "on");
    scAjaxFieldRead("preciomen2_" + iSeq, "on");
    scAjaxFieldRead("preciomen3_" + iSeq, "on");
    scAjaxFieldRead("precio2_" + iSeq, "on");
    scAjaxFieldRead("preciomay_" + iSeq, "on");
    scAjaxFieldRead("preciofull_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["codigobar_" + iRow] || "on" == ajax_error_count["codigoprod_" + iRow] || "on" == ajax_error_count["nompro_" + iRow] || "on" == ajax_error_count["preciomen_" + iRow] || "on" == ajax_error_count["preciomen2_" + iRow] || "on" == ajax_error_count["preciomen3_" + iRow] || "on" == ajax_error_count["precio2_" + iRow] || "on" == ajax_error_count["preciomay_" + iRow] || "on" == ajax_error_count["preciofull_" + iRow] || "on" == ajax_error_count["costomen_" + iRow]))
    {
      ...
      $("#hidden_field_data_codigoprod_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nompro_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_preciomen_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_preciomen2_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_preciomen3_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_precio2_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_preciomay_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_preciofull_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["codigobar_" + iRow] && "off" == ajax_error_count["codigoprod_" + iRow] && "off" == ajax_error_count["nompro_" + iRow] && "off" == ajax_error_count["preciomen_" + iRow] && "off" == ajax_error_count["preciomen2_" + iRow] && "off" == ajax_error_count["preciomen3_" + iRow] && "off" == ajax_error_count["precio2_" + iRow] && "off" == ajax_error_count["preciomay_" + iRow] && "off" == ajax_error_count["preciofull_" + iRow] && "off" == ajax_error_count["costomen_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["codigobar_" + iRow] = "off";
        ajax_error_count["codigoprod_" + iRow] = "off";
        ajax_error_count["nompro_" + iRow] = "off";
        ajax_error_count["preciomen_" + iRow] = "off";
        ajax_error_count["preciomen2_" + iRow] = "off";
        ajax_error_count["preciomen3_" + iRow] = "off";
        ajax_error_count["precio2_" + iRow] = "off";
        ajax_error_count["preciomay_" + iRow] = "off";
        ajax_error_count["preciofull_" + iRow] = "off";
      ...
      $("#hidden_field_data_codigoprod_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nompro_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_preciomen_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_preciomen2_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_preciomen3_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_precio2_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_preciomay_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_preciofull_" + iRow).removeClass("scFormErrorLine");
