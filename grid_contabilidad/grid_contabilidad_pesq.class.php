 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_tipodoc_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['tipodoc'])) ? $this->New_label['tipodoc'] : "Tipo doc."; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tipodoc" name="tipodoc_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 5, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_prefijo_cond" name="prefijo_cond" onChange="nm_campos_between(document.getElementById('id_vis_prefijo'), this, 'prefijo')">
...
?>
<INPUT  type="text" id="SC_numero" name="numero" value="<?php echo NM_encode_input($numero) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
      ...
      <TD id='SC_importado_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['importado'])) ? $this->New_label['importado'] : "Importado"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_importado_cond" name="importado_cond" onChange="nm_campos_between(document.getElementById('id_vis_importado'), this, 'importado')">
       <OPTION value="eq" <?php if ("eq" == $importado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_importado" <?php echo $str_hide_importado?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
