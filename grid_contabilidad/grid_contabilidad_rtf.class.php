...
class grid_contabilidad_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_grid_contabilidad";
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_contabilidad.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contabilidad']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contabilidad']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contabilidad']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contabilidad']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contabilidad']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contabilidad']['rtf_name']);
      }
   ...
   {
             nmgp_Form_Num_Val($this->numero, "", "", "0", "S", "2", "", "N:1", "-") ; 
   ...
   function NM_export_notas()
   {
         ...
         $this->notas = str_replace('<', '&lt;', $this->notas);
         $this->notas = str_replace('>', '&gt;', $this->notas);
         $this->Texto_tag .= "<td>" . $this->notas . "</td>\r\n";
   }
   //----- fecha
   ...
   {
             nmgp_Form_Num_Val($this->total_debito, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
         $this->total_debito = NM_charset_to_utf8($this->total_debito);
         $this->total_debito = str_replace('<', '&lt;', $this->total_debito);
         $this->total_debito = str_replace('>', '&gt;', $this->total_debito);
         $this->Texto_tag .= "<td>" . $this->total_debito . "</td>\r\n";
   }
   //----- total_credito
   function NM_export_total_credito()
   {
             nmgp_Form_Num_Val($this->total_credito, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
         $this->total_credito = NM_charset_to_utf8($this->total_credito);
         $this->total_credito = str_replace('<', '&lt;', $this->total_credito);
         $this->total_credito = str_replace('>', '&gt;', $this->total_credito);
         $this->Texto_tag .= "<td>" . $this->total_credito . "</td>\r\n";
   }
   //----- periodo
   ...
   function NM_export_tercero()
   {
         ...
         $this->tercero = str_replace('<', '&lt;', $this->tercero);
         $this->tercero = str_replace('>', '&gt;', $this->tercero);
         $this->Texto_tag .= "<td>" . $this->tercero . "</td>\r\n";
   }
   //----- id
   ...
   function NM_export_actualizado()
   {
         ...
         $this->actualizado = str_replace('<', '&lt;', $this->actualizado);
         $this->actualizado = str_replace('>', '&gt;', $this->actualizado);
         $this->Texto_tag .= "<td>" . $this->actualizado . "</td>\r\n";
   }
   //----- importado
   function NM_export_importado()
   {
         ...
         $this->importado = str_replace('<', '&lt;', $this->importado);
         $this->importado = str_replace('>', '&gt;', $this->importado);
         $this->Texto_tag .= "<td>" . $this->importado . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contabilidad']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contabilidad']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Comprobantes de Contabilidad :: RTF</TITLE>
