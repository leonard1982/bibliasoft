...
<?php
   ...
   $Ord_Cmp = new grid_contabilidad_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_contabilidad_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tipodoc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["tipodoc"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["tipodoc"] : "Tipo doc.";
   $tab_ger_campos['prefijo'] = "on";
   $tab_def_campos['prefijo'] = "prefijo";
   $tab_labels["prefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["prefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["prefijo"] : "Prefijo";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "numero";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["numero"] : "Número";
   $tab_ger_campos['notas'] = "on";
   $tab_def_campos['notas'] = "notas";
   $tab_labels["notas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["notas"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["notas"] : "Notas";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['asentada'] = "on";
   $tab_def_campos['asentada'] = "asentada";
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["asentada"] : "Asentada";
   $tab_ger_campos['total_debito'] = "on";
   $tab_def_campos['total_debito'] = "total_debito";
   $tab_labels["total_debito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["total_debito"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["total_debito"] : "Total Débito";
   $tab_ger_campos['total_credito'] = "on";
   $tab_def_campos['total_credito'] = "total_credito";
   $tab_labels["total_credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["total_credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['labels']["total_credito"] : "Total Crédito";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_contabilidad_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_contabilidad']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
