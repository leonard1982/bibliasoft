<?php
@session_start() ;
$_SESSION['scriptcase']['grid_contabilidad']['sc_process_barr'] = true;
require_once('../grid_contabilidad/index.php');
unset($_SESSION['scriptcase']['grid_contabilidad']['sc_process_barr']);
$ExportCtrl = new grid_contabilidad_export_control;
$ExportCtrl->Export_barr();

class grid_contabilidad_export_control
{
