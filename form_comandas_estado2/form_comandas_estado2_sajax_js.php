  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_comandas_estado2" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_comandas_estado2_form();
	}
  ...
  // ---------- Validate iddet
  function do_ajax_form_comandas_estado2_validate_iddet()
  {
    var nomeCampo_iddet = "iddet";
    var var_iddet = scAjaxGetFieldHidden(nomeCampo_iddet);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comandas_estado2_validate_iddet(var_iddet, var_script_case_init, do_ajax_form_comandas_estado2_validate_iddet_cb);
  } // do_ajax_form_comandas_estado2_validate_iddet

  function do_ajax_form_comandas_estado2_validate_iddet_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comandas_estado2_validate_iddet_cb

  // ---------- Validate estado_comanda
  function do_ajax_form_comandas_estado2_validate_estado_comanda()
  {
    var nomeCampo_estado_comanda = "estado_comanda";
    var var_estado_comanda = scAjaxGetFieldSelect(nomeCampo_estado_comanda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comandas_estado2_validate_estado_comanda(var_estado_comanda, var_script_case_init, do_ajax_form_comandas_estado2_validate_estado_comanda_cb);
  } // do_ajax_form_comandas_estado2_validate_estado_comanda

  function do_ajax_form_comandas_estado2_validate_estado_comanda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado_comanda";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comandas_estado2_validate_estado_comanda_cb

  // ---------- Event onchange estado_comanda
  function do_ajax_form_comandas_estado2_event_estado_comanda_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_comandas_estado2_event_estado_comanda_onchange(var_script_case_init, do_ajax_form_comandas_estado2_event_estado_comanda_onchange_cb);
  } // do_ajax_form_comandas_estado2_event_estado_comanda_onchange

  function do_ajax_form_comandas_estado2_event_estado_comanda_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "estado_comanda";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_comandas_estado2_event_estado_comanda_onchange_cb_after_alert);
  } // do_ajax_form_comandas_estado2_event_estado_comanda_onchange_cb
  function do_ajax_form_comandas_estado2_event_estado_comanda_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_comandas_estado2_event_estado_comanda_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_comandas_estado2_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_comandas_estado2_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_iddet = scAjaxGetFieldHidden("iddet");
    var var_estado_comanda = scAjaxGetFieldSelect("estado_comanda");
    ...
    scAjaxProcOn();
    x_ajax_form_comandas_estado2_submit_form(var_iddet, var_estado_comanda, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_comandas_estado2_submit_form_cb);
  } // do_ajax_form_comandas_estado2_submit_form

  function do_ajax_form_comandas_estado2_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("iddet");
      scAjaxHideErrorDisplay("estado_comanda");
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comandas_estado2']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_comandas_estado2']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_comandas_estado2']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_comandas_estado2_submit_form_cb_after_alert);
  } // do_ajax_form_comandas_estado2_submit_form_cb
  function do_ajax_form_comandas_estado2_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_comandas_estado2_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_comandas_estado2_navigate_form()
  {
    perform_ajax_form_comandas_estado2_navigate_form();
  }

  function perform_ajax_form_comandas_estado2_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_comandas_estado2_navigate_form(var_iddet, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_comandas_estado2_navigate_form_cb);
  } // do_ajax_form_comandas_estado2_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_comandas_estado2']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_comandas_estado2_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_comandas_estado2_navigate_form_cb_after_alert);
  } // do_ajax_form_comandas_estado2_navigate_form_cb
  function do_ajax_form_comandas_estado2_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_comandas_estado2_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_comandas_estado2_navigate_form_cb_after_alert
  function sc_hide_form_comandas_estado2_form()
  {
  ...
  ajax_field_list[0] = "iddet";
  ajax_field_list[1] = "estado_comanda";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "iddet": {"label": "Iddet", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "estado_comanda": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "iddet": new Array(),
    "estado_comanda": new Array()
  };
  ajax_field_mult["iddet"][1] = "iddet";
  ajax_field_mult["estado_comanda"][1] = "estado_comanda";

  var ajax_field_id = {
    "estado_comanda": new Array("hidden_field_label_estado_comanda", "hidden_field_data_estado_comanda")
  };
