<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_recibo" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_recibo']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_recibos"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_btn_asentar()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('¿Desea asentar el recibo?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_btn_asentar_ok, sc_btn_btn_asentar_cancel)
}
...
function sc_btn_btn_reversar()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('¿Desea reversar el recibo?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_btn_reversar_ok, sc_btn_btn_reversar_cancel)
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_detal']))
  {
?>  
