...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["descuentos" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["monto_a_pagar" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["descuentos" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["descuentos" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["monto_a_pagar" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["monto_a_pagar" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_recibo' + iSeqRow).bind('blur', function() { sc_form_recibos_id_recibo_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_recibos_id_recibo_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha' + iSeqRow).bind('blur', function() { sc_form_recibos_fecha_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_recibos_fecha_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha_hora' + iSeqRow).bind('blur', function() { sc_form_recibos_fecha_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_recibos_fecha_onfocus(this, iSeqRow) });
  $('#id_sc_field_prefijo' + iSeqRow).bind('blur', function() { sc_form_recibos_prefijo_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_recibos_prefijo_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_recibos_prefijo_onfocus(this, iSeqRow) });
  $('#id_sc_field_numero' + iSeqRow).bind('blur', function() { sc_form_recibos_numero_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_recibos_numero_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_cliente' + iSeqRow).bind('blur', function() { sc_form_recibos_id_cliente_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_recibos_id_cliente_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_recibos_id_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_asentado' + iSeqRow).bind('blur', function() { sc_form_recibos_asentado_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_recibos_asentado_onfocus(this, iSeqRow) });
  $('#id_sc_field_monto_a_pagar' + iSeqRow).bind('blur', function() { sc_form_recibos_monto_a_pagar_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_recibos_monto_a_pagar_onfocus(this, iSeqRow) });
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_form_recibos_observaciones_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_recibos_observaciones_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_usuario' + iSeqRow).bind('blur', function() { sc_form_recibos_id_usuario_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_recibos_id_usuario_onfocus(this, iSeqRow) });
  $('#id_sc_field_descuentos' + iSeqRow).bind('blur', function() { sc_form_recibos_descuentos_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_recibos_descuentos_onfocus(this, iSeqRow) });
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_form_recibos_total_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_recibos_total_onfocus(this, iSeqRow) });
  $('#id_sc_field_detalle' + iSeqRow).bind('blur', function() { sc_form_recibos_detalle_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_recibos_detalle_onfocus(this, iSeqRow) });
  $('#id_sc_field_formapago' + iSeqRow).bind('blur', function() { sc_form_recibos_formapago_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_recibos_formapago_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_recibos_id_recibo_onblur(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_validate_id_recibo();
  scCssBlur(oThis);
}

function sc_form_recibos_id_recibo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_recibos_fecha_onblur(oThis, iSeqRow) {
...
function sc_form_recibos_fecha_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_recibos_prefijo_onblur(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_validate_prefijo();
  scCssBlur(oThis);
}

function sc_form_recibos_prefijo_onchange(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_event_prefijo_onchange();
}

function sc_form_recibos_prefijo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_recibos_numero_onblur(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_validate_numero();
  scCssBlur(oThis);
}

function sc_form_recibos_numero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_recibos_id_cliente_onblur(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_validate_id_cliente();
  scCssBlur(oThis);
}

function sc_form_recibos_id_cliente_onchange(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_event_id_cliente_onchange();
}

function sc_form_recibos_id_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_recibos_asentado_onblur(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_validate_asentado();
  scCssBlur(oThis);
}

function sc_form_recibos_asentado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_recibos_monto_a_pagar_onblur(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_validate_monto_a_pagar();
  scCssBlur(oThis);
}

function sc_form_recibos_monto_a_pagar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_recibos_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_validate_observaciones();
  scCssBlur(oThis);
}

function sc_form_recibos_observaciones_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_recibos_id_usuario_onblur(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_validate_id_usuario();
  scCssBlur(oThis);
}

function sc_form_recibos_id_usuario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_recibos_descuentos_onblur(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_validate_descuentos();
  scCssBlur(oThis);
}

function sc_form_recibos_descuentos_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_recibos_total_onblur(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_validate_total();
  scCssBlur(oThis);
}

function sc_form_recibos_total_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_recibos_detalle_onblur(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_validate_detalle();
  scCssBlur(oThis);
}

function sc_form_recibos_detalle_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_recibos_formapago_onblur(oThis, iSeqRow) {
  do_ajax_form_recibos_mob_validate_formapago();
  scCssBlur(oThis);
}

function sc_form_recibos_formapago_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_2(status) {
	...
	displayChange_field("descuentos", "", status);
	displayChange_field("monto_a_pagar", "", status);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_descuentos(row, status);
	displayChange_field_monto_a_pagar(row, status);
...
function displayChange_field_descuentos(row, status) {
}

function displayChange_field_monto_a_pagar(row, status) {
}
...
function displayChange_field_detalle(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_grid_recibos_detalle")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_grid_recibos_detalle")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_formapago(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_grid_recibos_formapago")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_grid_recibos_formapago")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_recibos_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_recibos_mob_validate_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_recibos_mob_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_actualizado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_recibos_mob_validate_actualizado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_recibos_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
