...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_recibos']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_recibos']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_recibos']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_recibos']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_recibos']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_recibos']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_recibos']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_recibos']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->gidtercero)) 
          {
              $_SESSION['gidtercero'] = $this->gidtercero;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_recibos']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_recibos']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_recibos']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_recibos']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_recibos']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_recibos']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_recibos']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_recibos']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_recibos']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_recibos_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_recibos']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_recibos']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_recibos'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recibos']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recibos']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_recibos') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recibos']['label'] = "Editar Recibo";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['pdf_view'] = false;
      if ($this->nmgp_opcao == "pdf" || $this->nmgp_opcao == "print")
      { 
          $this->use_100perc_fields = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['pdf_view'] = true;
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opc_ant'] == "novo")
          {
              $this->nmgp_opcao = "novo";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opcao'] = "novo";
          }
          else
          {
              $this->nmgp_opcao = "igual";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opcao'] = "igual";
          }
      } 
      $this->Db = $this->Ini->Db; 
      ...
      $_SESSION['scriptcase']['error_icon']['form_recibos']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_recibos'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recibos']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_recibos'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_recibos'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_recibos", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_recibos/form_recibos_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_recibos_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_recibos_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_recibos_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_recibos/form_recibos_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_recibos_erro.class.php"); 
      }
      $this->Erro      = new form_recibos_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opcao']))
         { 
             if ($this->id_recibo != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opcao'] = "igual" ;  
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_recibos']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['btn_asentar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['botoes']['btn_asentar'];
          $this->nmgp_botoes['btn_reversar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['botoes']['btn_reversar'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_recibos']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_recibos']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['sc_redir_atualiz'] == "ok")
          {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['pdf_view'])
      { 
...
//--------------------------------------------------------------------------------------
   function NM_pdf_output()
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['pdf_view'])
      { 
          $arq_pdf_in = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_form_recibos_html_" . session_id() . ".html";
          $url_pdf_in = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_form_recibos_html_" . session_id() . ".html";
          $str_htm    =  ob_get_contents();
          ob_end_clean();
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['prt_view'])
          { 
              if (isset($this->nmgp_password) && $this->nmgp_password != "")
              { 
                  $arq_prt_base = "/sc_form_recibos_html_" . session_id() . ".html";
          ...
          fwrite($arq_htm, $str_htm); 
          fclose($arq_htm);
          $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "form_recibos";
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['pdf_name']))
          {
              $nm_arquivo_pdf_base = str_replace(".pdf", "", $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['pdf_name']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['pdf_name']);
          }
          ...
          $NM_tit_doc = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['pdf_name'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['pdf_name'] : "form_recibos";
          if (isset($this->pdf_zip) && $this->pdf_zip == "S")
          {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos'][$path_doc_md5][0] = $nm_arquivo_pdf_url;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos'][$path_doc_md5][1] = $NM_tit_doc_x;
?>
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_recibos.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_recibos_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_recibos"> 
...
<?php
include_once("form_recibos_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->asentado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['asentado']))
          {
              $varloc_btn_php['asentado'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['asentado'];
          }
          if (!isset($this->id_recibo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['id_recibo']))
          {
              $varloc_btn_php['id_recibo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['id_recibo'];
          }
          if (!isset($this->id_recibo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['id_recibo']))
          {
              $varloc_btn_php['id_recibo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['id_recibo'];
          ...
          if (!isset($this->vrecorre) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['vrecorre']))
          {
              $varloc_btn_php['vrecorre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['vrecorre'];
          }
          if (!isset($this->id_recibo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['id_recibo']))
          {
              $varloc_btn_php['id_recibo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['id_recibo'];
          }
          if (!isset($this->id_cliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['id_cliente']))
          {
              $varloc_btn_php['id_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['id_cliente'];
          }
          if (!isset($this->id_recibo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['id_recibo']))
          {
              $varloc_btn_php['id_recibo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['id_recibo'];
          ...
          if (!isset($this->prefijo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['prefijo']))
          {
              $varloc_btn_php['prefijo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['prefijo'];
          }
          if (!isset($this->numero) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['numero']))
          {
              $varloc_btn_php['numero'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['numero'];
          }
          if (!isset($this->id_recibo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['id_recibo']))
          {
              $varloc_btn_php['id_recibo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form']['id_recibo'];
      ...
      $_SESSION['scriptcase']['form_recibos']['contr_erro'] = 'on';
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_recibos']) || !is_array($this->NM_ajax_info['errList']['geral_form_recibos']))
              {
                  $this->NM_ajax_info['errList']['geral_form_recibos'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_recibos'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_fecha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['php_cmp_required']['fecha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['php_cmp_required']['fecha'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha" ; 
              if (!isset($Campos_Erros['fecha']))
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['php_cmp_required']['fecha_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['php_cmp_required']['fecha_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha" ; 
              if (!isset($Campos_Erros['fecha_hora']))
    ...
    function ValidateField_prefijo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->prefijo == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['php_cmp_required']['prefijo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['php_cmp_required']['prefijo'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->prefijo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_prefijo']) && !in_array($this->prefijo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_prefijo']))
          {
              $hasError = true;
    ...
    function ValidateField_id_cliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->id_cliente == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['php_cmp_required']['id_cliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['php_cmp_required']['id_cliente'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->id_cliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_id_cliente']) && !in_array($this->id_cliente, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_id_cliente']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['id_cliente']))
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_recibo']['keyVal'] = form_recibos_pack_protect_string($this->nmgp_dados_form['id_recibo']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['grid_recibos_detalle_script_case_init'] ]['grid_recibos_detalle']['embutida_form_full'] = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['grid_recibos_detalle_script_case_init'] ]['grid_recibos_detalle']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['grid_recibos_detalle_script_case_init'] ]['grid_recibos_detalle']['embutida_pai']        = "form_recibos";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['grid_recibos_detalle_script_case_init'] ]['grid_recibos_detalle']['embutida_form_parms'] = "gidrecibo*scin" . $this->nmgp_dados_form['id_recibo'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['grid_recibos_detalle_script_case_init'] ]['grid_recibos_detalle']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['grid_recibos_detalle_script_case_init'] ]['grid_recibos_detalle']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['grid_recibos_formapago_script_case_init'] ]['grid_recibos_formapago']['embutida_form_full'] = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['grid_recibos_formapago_script_case_init'] ]['grid_recibos_formapago']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['grid_recibos_formapago_script_case_init'] ]['grid_recibos_formapago']['embutida_pai']        = "form_recibos";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['grid_recibos_formapago_script_case_init'] ]['grid_recibos_formapago']['embutida_form_parms'] = "gidrecibo*scin" . $this->nmgp_dados_form['id_recibo'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['grid_recibos_formapago_script_case_init'] ]['grid_recibos_formapago']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['grid_recibos_formapago_script_case_init'] ]['grid_recibos_formapago']['total']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_prefijo']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_prefijo'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_prefijo']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_prefijo'] = array(); 
}
$aLookup[] = array(form_recibos_pack_protect_string('') => str_replace('<', '&lt;',form_recibos_pack_protect_string('Seleccione')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_prefijo'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_recibos_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_recibos_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_prefijo'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['prefijo']['valList'][$i] = form_recibos_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_id_cliente']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_id_cliente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_id_cliente']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_id_cliente'] = array(); 
}
$aLookup[] = array(form_recibos_pack_protect_string('') => str_replace('<', '&lt;',form_recibos_pack_protect_string('Seleccione')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_id_cliente'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['Lookup_id_cliente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_cliente']['valList'][$i] = form_recibos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_formapago($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->id_recibo)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
$_SESSION['scriptcase']['form_recibos']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['parms'] = "id_recibo?#?$this->id_recibo?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_recibos = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['total'] = $qt_geral_reg_form_recibos;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_recibo))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_recibos = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] > $qt_geral_reg_form_recibos)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] = $qt_geral_reg_form_recibos; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_recibos) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['btn_asentar'] = $this->nmgp_botoes['btn_asentar'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['btn_reversar'] = $this->nmgp_botoes['btn_reversar'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] < $qt_geral_reg_form_recibos;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_recibos_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_recibos = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['total'] = $qt_geral_reg_form_recibos;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_recibos_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_recibos_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_recibos_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['masterValue']))
{
...
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['masterValue'] as $cmp_master => $val_master)
        {
?>
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            ...
            case "btn_reversar":
                ...
                break;
            case "pdf":
                return array("sc_b_pdf_t.sc-unique-btn-6");
                break;
            case "help":
