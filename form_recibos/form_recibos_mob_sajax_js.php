  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_recibos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate fecha
  function do_ajax_form_recibos_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_recibos_mob_validate_fecha_cb);
  } // do_ajax_form_recibos_mob_validate_fecha

  function do_ajax_form_recibos_mob_validate_fecha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_mob_validate_fecha_cb

  // ---------- Validate prefijo
  function do_ajax_form_recibos_mob_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldSelect(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_mob_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_recibos_mob_validate_prefijo_cb);
  } // do_ajax_form_recibos_mob_validate_prefijo

  function do_ajax_form_recibos_mob_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_mob_validate_prefijo_cb

  // ---------- Validate numero
  function do_ajax_form_recibos_mob_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldHidden(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_mob_validate_numero(var_numero, var_script_case_init, do_ajax_form_recibos_mob_validate_numero_cb);
  } // do_ajax_form_recibos_mob_validate_numero

  function do_ajax_form_recibos_mob_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_mob_validate_numero_cb

  // ---------- Validate asentado
  function do_ajax_form_recibos_mob_validate_asentado()
  {
    var nomeCampo_asentado = "asentado";
    var var_asentado = scAjaxGetFieldHidden(nomeCampo_asentado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_mob_validate_asentado(var_asentado, var_script_case_init, do_ajax_form_recibos_mob_validate_asentado_cb);
  } // do_ajax_form_recibos_mob_validate_asentado

  function do_ajax_form_recibos_mob_validate_asentado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_mob_validate_asentado_cb

  // ---------- Validate id_cliente
  function do_ajax_form_recibos_mob_validate_id_cliente()
  {
    var nomeCampo_id_cliente = "id_cliente";
    var var_id_cliente = scAjaxGetFieldSelect(nomeCampo_id_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_mob_validate_id_cliente(var_id_cliente, var_script_case_init, do_ajax_form_recibos_mob_validate_id_cliente_cb);
  } // do_ajax_form_recibos_mob_validate_id_cliente

  function do_ajax_form_recibos_mob_validate_id_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_mob_validate_id_cliente_cb

  // ---------- Validate total
  function do_ajax_form_recibos_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldHidden(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_mob_validate_total(var_total, var_script_case_init, do_ajax_form_recibos_mob_validate_total_cb);
  } // do_ajax_form_recibos_mob_validate_total

  function do_ajax_form_recibos_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_mob_validate_total_cb

  // ---------- Validate descuentos
  function do_ajax_form_recibos_mob_validate_descuentos()
  {
    var nomeCampo_descuentos = "descuentos";
    var var_descuentos = scAjaxGetFieldHidden(nomeCampo_descuentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_mob_validate_descuentos(var_descuentos, var_script_case_init, do_ajax_form_recibos_mob_validate_descuentos_cb);
  } // do_ajax_form_recibos_mob_validate_descuentos

  function do_ajax_form_recibos_mob_validate_descuentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_mob_validate_descuentos_cb

  // ---------- Validate monto_a_pagar
  function do_ajax_form_recibos_mob_validate_monto_a_pagar()
  {
    var nomeCampo_monto_a_pagar = "monto_a_pagar";
    var var_monto_a_pagar = scAjaxGetFieldHidden(nomeCampo_monto_a_pagar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_mob_validate_monto_a_pagar(var_monto_a_pagar, var_script_case_init, do_ajax_form_recibos_mob_validate_monto_a_pagar_cb);
  } // do_ajax_form_recibos_mob_validate_monto_a_pagar

  function do_ajax_form_recibos_mob_validate_monto_a_pagar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_mob_validate_monto_a_pagar_cb

  // ---------- Validate observaciones
  function do_ajax_form_recibos_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_recibos_mob_validate_observaciones_cb);
  } // do_ajax_form_recibos_mob_validate_observaciones

  function do_ajax_form_recibos_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_mob_validate_observaciones_cb

  // ---------- Validate id_recibo
  function do_ajax_form_recibos_mob_validate_id_recibo()
  {
    var nomeCampo_id_recibo = "id_recibo";
    var var_id_recibo = scAjaxGetFieldHidden(nomeCampo_id_recibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_mob_validate_id_recibo(var_id_recibo, var_script_case_init, do_ajax_form_recibos_mob_validate_id_recibo_cb);
  } // do_ajax_form_recibos_mob_validate_id_recibo

  function do_ajax_form_recibos_mob_validate_id_recibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_mob_validate_id_recibo_cb

  // ---------- Validate id_usuario
  function do_ajax_form_recibos_mob_validate_id_usuario()
  {
    var nomeCampo_id_usuario = "id_usuario";
    var var_id_usuario = scAjaxGetFieldText(nomeCampo_id_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_mob_validate_id_usuario(var_id_usuario, var_script_case_init, do_ajax_form_recibos_mob_validate_id_usuario_cb);
  } // do_ajax_form_recibos_mob_validate_id_usuario

  function do_ajax_form_recibos_mob_validate_id_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_mob_validate_id_usuario_cb

  // ---------- Validate detalle
  function do_ajax_form_recibos_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_recibos_mob_validate_detalle_cb);
  } // do_ajax_form_recibos_mob_validate_detalle

  function do_ajax_form_recibos_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_mob_validate_detalle_cb

  // ---------- Validate formapago
  function do_ajax_form_recibos_mob_validate_formapago()
  {
    var nomeCampo_formapago = "formapago";
    var var_formapago = scAjaxGetFieldText(nomeCampo_formapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_mob_validate_formapago(var_formapago, var_script_case_init, do_ajax_form_recibos_mob_validate_formapago_cb);
  } // do_ajax_form_recibos_mob_validate_formapago

  function do_ajax_form_recibos_mob_validate_formapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_mob_validate_formapago_cb

  // ---------- Event onchange id_cliente
  function do_ajax_form_recibos_mob_event_id_cliente_onchange()
  {
    var var_id_cliente = scAjaxGetFieldSelect("id_cliente");
    var var_id_recibo = scAjaxGetFieldHidden("id_recibo");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recibos_mob_event_id_cliente_onchange(var_id_cliente, var_id_recibo, var_script_case_init, do_ajax_form_recibos_mob_event_id_cliente_onchange_cb);
  } // do_ajax_form_recibos_mob_event_id_cliente_onchange

  function do_ajax_form_recibos_mob_event_id_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_mob_event_id_cliente_onchange_cb_after_alert);
  } // do_ajax_form_recibos_mob_event_id_cliente_onchange_cb
  function do_ajax_form_recibos_mob_event_id_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recibos_mob_event_id_cliente_onchange_cb_after_alert

  // ---------- Event onchange prefijo
  function do_ajax_form_recibos_mob_event_prefijo_onchange()
  {
    var var_prefijo = scAjaxGetFieldSelect("prefijo");
    var var_numero = scAjaxGetFieldHidden("numero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recibos_mob_event_prefijo_onchange(var_prefijo, var_numero, var_script_case_init, do_ajax_form_recibos_mob_event_prefijo_onchange_cb);
  } // do_ajax_form_recibos_mob_event_prefijo_onchange

  function do_ajax_form_recibos_mob_event_prefijo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "prefijo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_mob_event_prefijo_onchange_cb_after_alert);
  } // do_ajax_form_recibos_mob_event_prefijo_onchange_cb
  function do_ajax_form_recibos_mob_event_prefijo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recibos_mob_event_prefijo_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_recibos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_recibos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_recibos_mob_submit_form(var_fecha, var_prefijo, var_numero, var_asentado, var_id_cliente, var_total, var_descuentos, var_monto_a_pagar, var_observaciones, var_id_recibo, var_id_usuario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_recibos_mob_submit_form_cb);
  } // do_ajax_form_recibos_mob_submit_form

  function do_ajax_form_recibos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_recibos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_recibos_mob_submit_form_cb
  function do_ajax_form_recibos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_recibos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_recibos_detalle"] = "off";
  scStatusDetail["grid_recibos_formapago"] = "off";

  function do_ajax_form_recibos_mob_navigate_form()
  {
    perform_ajax_form_recibos_mob_navigate_form();
  }

  function perform_ajax_form_recibos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_recibos_mob_navigate_form(var_id_recibo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_recibos_mob_navigate_form_cb);
  } // do_ajax_form_recibos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_recibos_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_recibos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_recibos_mob_navigate_form_cb
  function do_ajax_form_recibos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_recibos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_recibos_mob_navigate_form_cb_after_alert
  function sc_hide_form_recibos_mob_form()
  {
  ...
  function do_ajax_form_recibos_mob_lkpedt_refresh_concepto()
  {
    var var_concepto = scAjaxGetFieldSelect("concepto");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "concepto";
    x_ajax_form_recibos_mob_lkpedt_refresh_concepto(var_concepto, nmgp_refresh_fields, var_script_case_init, do_ajax_form_recibos_mob_lkpedt_refresh_concepto_cb);
  } // do_ajax_form_recibos_mob_lkpedt_refresh_concepto

  function do_ajax_form_recibos_mob_lkpedt_refresh_concepto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_recibos_mob_lkpedt_refresh_concepto_cb
