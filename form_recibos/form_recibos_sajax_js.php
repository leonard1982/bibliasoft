  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_recibos" == sTestField)
        {
...
?>
  ...
  // ---------- Validate fecha
  function do_ajax_form_recibos_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_recibos_validate_fecha_cb);
  } // do_ajax_form_recibos_validate_fecha

  function do_ajax_form_recibos_validate_fecha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_validate_fecha_cb

  // ---------- Validate prefijo
  function do_ajax_form_recibos_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldSelect(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_recibos_validate_prefijo_cb);
  } // do_ajax_form_recibos_validate_prefijo

  function do_ajax_form_recibos_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_validate_prefijo_cb

  // ---------- Validate numero
  function do_ajax_form_recibos_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldHidden(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_validate_numero(var_numero, var_script_case_init, do_ajax_form_recibos_validate_numero_cb);
  } // do_ajax_form_recibos_validate_numero

  function do_ajax_form_recibos_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_validate_numero_cb

  // ---------- Validate asentado
  function do_ajax_form_recibos_validate_asentado()
  {
    var nomeCampo_asentado = "asentado";
    var var_asentado = scAjaxGetFieldHidden(nomeCampo_asentado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_validate_asentado(var_asentado, var_script_case_init, do_ajax_form_recibos_validate_asentado_cb);
  } // do_ajax_form_recibos_validate_asentado

  function do_ajax_form_recibos_validate_asentado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_validate_asentado_cb

  // ---------- Validate id_cliente
  function do_ajax_form_recibos_validate_id_cliente()
  {
    var nomeCampo_id_cliente = "id_cliente";
    var var_id_cliente = scAjaxGetFieldSelect(nomeCampo_id_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_validate_id_cliente(var_id_cliente, var_script_case_init, do_ajax_form_recibos_validate_id_cliente_cb);
  } // do_ajax_form_recibos_validate_id_cliente

  function do_ajax_form_recibos_validate_id_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_validate_id_cliente_cb

  // ---------- Validate total
  function do_ajax_form_recibos_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldHidden(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_validate_total(var_total, var_script_case_init, do_ajax_form_recibos_validate_total_cb);
  } // do_ajax_form_recibos_validate_total

  function do_ajax_form_recibos_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_validate_total_cb

  // ---------- Validate descuentos
  function do_ajax_form_recibos_validate_descuentos()
  {
    var nomeCampo_descuentos = "descuentos";
    var var_descuentos = scAjaxGetFieldHidden(nomeCampo_descuentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_validate_descuentos(var_descuentos, var_script_case_init, do_ajax_form_recibos_validate_descuentos_cb);
  } // do_ajax_form_recibos_validate_descuentos

  function do_ajax_form_recibos_validate_descuentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descuentos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_validate_descuentos_cb

  // ---------- Validate monto_a_pagar
  function do_ajax_form_recibos_validate_monto_a_pagar()
  {
    var nomeCampo_monto_a_pagar = "monto_a_pagar";
    var var_monto_a_pagar = scAjaxGetFieldHidden(nomeCampo_monto_a_pagar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_validate_monto_a_pagar(var_monto_a_pagar, var_script_case_init, do_ajax_form_recibos_validate_monto_a_pagar_cb);
  } // do_ajax_form_recibos_validate_monto_a_pagar

  function do_ajax_form_recibos_validate_monto_a_pagar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "monto_a_pagar";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_validate_monto_a_pagar_cb

  // ---------- Validate observaciones
  function do_ajax_form_recibos_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_recibos_validate_observaciones_cb);
  } // do_ajax_form_recibos_validate_observaciones

  function do_ajax_form_recibos_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_validate_observaciones_cb

  // ---------- Validate id_recibo
  function do_ajax_form_recibos_validate_id_recibo()
  {
    var nomeCampo_id_recibo = "id_recibo";
    var var_id_recibo = scAjaxGetFieldHidden(nomeCampo_id_recibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_validate_id_recibo(var_id_recibo, var_script_case_init, do_ajax_form_recibos_validate_id_recibo_cb);
  } // do_ajax_form_recibos_validate_id_recibo

  function do_ajax_form_recibos_validate_id_recibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_validate_id_recibo_cb

  // ---------- Validate id_usuario
  function do_ajax_form_recibos_validate_id_usuario()
  {
    var nomeCampo_id_usuario = "id_usuario";
    var var_id_usuario = scAjaxGetFieldText(nomeCampo_id_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_validate_id_usuario(var_id_usuario, var_script_case_init, do_ajax_form_recibos_validate_id_usuario_cb);
  } // do_ajax_form_recibos_validate_id_usuario

  function do_ajax_form_recibos_validate_id_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_validate_id_usuario_cb

  // ---------- Validate detalle
  function do_ajax_form_recibos_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_recibos_validate_detalle_cb);
  } // do_ajax_form_recibos_validate_detalle

  function do_ajax_form_recibos_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_validate_detalle_cb

  // ---------- Validate formapago
  function do_ajax_form_recibos_validate_formapago()
  {
    var nomeCampo_formapago = "formapago";
    var var_formapago = scAjaxGetFieldText(nomeCampo_formapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_validate_formapago(var_formapago, var_script_case_init, do_ajax_form_recibos_validate_formapago_cb);
  } // do_ajax_form_recibos_validate_formapago

  function do_ajax_form_recibos_validate_formapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_validate_formapago_cb

  // ---------- Event onchange id_cliente
  function do_ajax_form_recibos_event_id_cliente_onchange()
  {
    var var_id_cliente = scAjaxGetFieldSelect("id_cliente");
    var var_id_recibo = scAjaxGetFieldHidden("id_recibo");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recibos_event_id_cliente_onchange(var_id_cliente, var_id_recibo, var_script_case_init, do_ajax_form_recibos_event_id_cliente_onchange_cb);
  } // do_ajax_form_recibos_event_id_cliente_onchange

  function do_ajax_form_recibos_event_id_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_event_id_cliente_onchange_cb_after_alert);
  } // do_ajax_form_recibos_event_id_cliente_onchange_cb
  function do_ajax_form_recibos_event_id_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recibos_event_id_cliente_onchange_cb_after_alert

  // ---------- Event onchange prefijo
  function do_ajax_form_recibos_event_prefijo_onchange()
  {
    var var_prefijo = scAjaxGetFieldSelect("prefijo");
    var var_numero = scAjaxGetFieldHidden("numero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recibos_event_prefijo_onchange(var_prefijo, var_numero, var_script_case_init, do_ajax_form_recibos_event_prefijo_onchange_cb);
  } // do_ajax_form_recibos_event_prefijo_onchange

  function do_ajax_form_recibos_event_prefijo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "prefijo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_event_prefijo_onchange_cb_after_alert);
  } // do_ajax_form_recibos_event_prefijo_onchange_cb
  function do_ajax_form_recibos_event_prefijo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recibos_event_prefijo_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_recibos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_recibos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_descuentos = scAjaxGetFieldHidden("descuentos");
    var var_monto_a_pagar = scAjaxGetFieldHidden("monto_a_pagar");
    var var_observaciones = scAjaxGetFieldText("observaciones");
    var var_id_recibo = scAjaxGetFieldHidden("id_recibo");
    var var_id_usuario = scAjaxGetFieldText("id_usuario");
    ...
    scAjaxProcOn();
    x_ajax_form_recibos_submit_form(var_fecha, var_prefijo, var_numero, var_asentado, var_id_cliente, var_total, var_descuentos, var_monto_a_pagar, var_observaciones, var_id_recibo, var_id_usuario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_recibos_submit_form_cb);
  } // do_ajax_form_recibos_submit_form

  function do_ajax_form_recibos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("descuentos");
      scAjaxHideErrorDisplay("monto_a_pagar");
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_recibos_submit_form_cb_after_alert);
  } // do_ajax_form_recibos_submit_form_cb
  function do_ajax_form_recibos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_recibos_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_recibos_detalle"] = "off";
  scStatusDetail["grid_recibos_formapago"] = "off";

  function do_ajax_form_recibos_navigate_form()
  {
    perform_ajax_form_recibos_navigate_form();
  }

  function perform_ajax_form_recibos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["grid_recibos_detalle"] = "on";
    scStatusDetail["grid_recibos_formapago"] = "on";
    x_ajax_form_recibos_navigate_form(var_id_recibo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_recibos_navigate_form_cb);
  } // do_ajax_form_recibos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_recibos_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_recibos_detalle"] && "nmsc_iframe_liga_grid_recibos_detalle" != scMasterDetailIframe["nmsc_iframe_liga_grid_recibos_detalle"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_recibos_detalle"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_recibos_detalle').contentWindow.nm_move('apl_detalhe', true, '400');
        }
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_recibos_formapago"] && "nmsc_iframe_liga_grid_recibos_formapago" != scMasterDetailIframe["nmsc_iframe_liga_grid_recibos_formapago"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_recibos_formapago"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_recibos_formapago').contentWindow.nm_move('apl_detalhe', true, '500');
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_recibos_navigate_form_cb_after_alert);
  } // do_ajax_form_recibos_navigate_form_cb
  function do_ajax_form_recibos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_recibos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_recibos_navigate_form_cb_after_alert
  function sc_hide_form_recibos_form()
  {
  ...
  function do_ajax_form_recibos_lkpedt_refresh_concepto()
  {
    var var_concepto = scAjaxGetFieldSelect("concepto");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "concepto";
    x_ajax_form_recibos_lkpedt_refresh_concepto(var_concepto, nmgp_refresh_fields, var_script_case_init, do_ajax_form_recibos_lkpedt_refresh_concepto_cb);
  } // do_ajax_form_recibos_lkpedt_refresh_concepto

  function do_ajax_form_recibos_lkpedt_refresh_concepto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_recibos_lkpedt_refresh_concepto_cb
  ...
  {
    if ("off" == scStatusDetail["grid_recibos_detalle"] && "off" == scStatusDetail["grid_recibos_formapago"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[3] = "asentado";
  ajax_field_list[4] = "id_cliente";
  ajax_field_list[5] = "total";
  ajax_field_list[6] = "descuentos";
  ajax_field_list[7] = "monto_a_pagar";
  ajax_field_list[8] = "observaciones";
  ajax_field_list[9] = "id_recibo";
  ajax_field_list[10] = "id_usuario";
  ajax_field_list[11] = "detalle";
  ajax_field_list[12] = "formapago";
  ...
  var ajax_error_list = {
    ...
    "id_cliente": {"label": "Cliente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "total": {"label": "Total", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descuentos": {"label": "Descuentos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "monto_a_pagar": {"label": "Neto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "formapago": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["descuentos"][1] = "descuentos";
  ajax_field_mult["monto_a_pagar"][1] = "monto_a_pagar";
  ...
  var ajax_field_id = {
    ...
    "descuentos": new Array("hidden_field_label_descuentos", "hidden_field_data_descuentos"),
    "monto_a_pagar": new Array("hidden_field_label_monto_a_pagar", "hidden_field_data_monto_a_pagar"),
