  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pagos_soporte" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pagos_soporte_form();
	}
...
?>
  ...
  // ---------- Validate soporte_
  function do_ajax_form_pagos_soporte_validate_soporte_(iNumLinha)
  {
    var nomeCampo_soporte_ = "soporte_" + iNumLinha;
    var var_soporte_ = scAjaxGetFieldText(nomeCampo_soporte_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_soporte_validate_soporte_(var_soporte_, iNumLinha, var_script_case_init, do_ajax_form_pagos_soporte_validate_soporte__cb);
  } // do_ajax_form_pagos_soporte_validate_soporte_

  function do_ajax_form_pagos_soporte_validate_soporte__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "soporte_" + iLineNumber;
    }
    else
    {
      sFieldValid = "soporte_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "soporte_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "soporte_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_soporte_validate_soporte__cb

  // ---------- Validate nombre_archivo_
  function do_ajax_form_pagos_soporte_validate_nombre_archivo_(iNumLinha)
  {
    var nomeCampo_nombre_archivo_ = "nombre_archivo_" + iNumLinha;
    var var_nombre_archivo_ = scAjaxGetFieldHidden(nomeCampo_nombre_archivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_soporte_validate_nombre_archivo_(var_nombre_archivo_, iNumLinha, var_script_case_init, do_ajax_form_pagos_soporte_validate_nombre_archivo__cb);
  } // do_ajax_form_pagos_soporte_validate_nombre_archivo_

  function do_ajax_form_pagos_soporte_validate_nombre_archivo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nombre_archivo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nombre_archivo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nombre_archivo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nombre_archivo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_soporte_validate_nombre_archivo__cb

  // ---------- Validate tamanio_archivo_
  function do_ajax_form_pagos_soporte_validate_tamanio_archivo_(iNumLinha)
  {
    var nomeCampo_tamanio_archivo_ = "tamanio_archivo_" + iNumLinha;
    var var_tamanio_archivo_ = scAjaxGetFieldHidden(nomeCampo_tamanio_archivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_soporte_validate_tamanio_archivo_(var_tamanio_archivo_, iNumLinha, var_script_case_init, do_ajax_form_pagos_soporte_validate_tamanio_archivo__cb);
  } // do_ajax_form_pagos_soporte_validate_tamanio_archivo_

  function do_ajax_form_pagos_soporte_validate_tamanio_archivo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tamanio_archivo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tamanio_archivo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tamanio_archivo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tamanio_archivo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagos_soporte_validate_tamanio_archivo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_pagos_soporte_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_pagos_soporte_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pagos_soporte_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_pagos_soporte_add_new_line_cb);
  } // do_ajax_form_pagos_soporte_add_new_line

  function do_ajax_form_pagos_soporte_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_pagos_soporte_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_pagos_soporte_backup_line(iNumLinha)
  {
    var var_idpagos_soporte_ = scAjaxGetFieldText("idpagos_soporte_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagos_soporte_backup_line(var_idpagos_soporte_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_pagos_soporte_backup_line_cb);
  } // do_ajax_form_pagos_soporte_backup_line

  function do_ajax_form_pagos_soporte_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_pagos_soporte_backup_line_cb

  function do_ajax_form_pagos_soporte_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_pagos_soporte_cancel_insert

  function do_ajax_form_pagos_soporte_cancel_update(iSeqVert)
  {
    do_ajax_form_pagos_soporte_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_pagos_soporte_cancel_update

  function do_ajax_form_pagos_soporte_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_pagos_soporte_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_pagos_soporte_table_refresh()
  {
    var var_idpagos_soporte_ = document.F2.idpagos_soporte_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_pagos_soporte_table_refresh(var_idpagos_soporte_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pagos_soporte_table_refresh_cb);
  } //  do_ajax_form_pagos_soporte_table_refresh

  function do_ajax_form_pagos_soporte_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idpagos_soporte_.value = scAjaxGetKeyValue("idpagos_soporte_");
    ...
    scAjaxAlert(do_ajax_form_pagos_soporte_table_refresh_cb_after_alert);
  } // do_ajax_form_pagos_soporte_table_refresh_cb
  function do_ajax_form_pagos_soporte_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_pagos_soporte_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_pagos_soporte_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_pagos_soporte_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_soporte_ = scAjaxGetFieldText("soporte_" + iNumLinha);
    var var_nombre_archivo_ = scAjaxGetFieldHidden("nombre_archivo_" + iNumLinha);
    var var_tamanio_archivo_ = scAjaxGetFieldHidden("tamanio_archivo_" + iNumLinha);
    var var_soporte__ul_name = scAjaxSpecCharProtect(eval('document.F1.soporte__ul_name' + iNumLinha + '.value'));
    var var_soporte__ul_type = eval('document.F1.soporte__ul_type' + iNumLinha + '.value');
    var var_soporte__limpa = eval('document.F1.soporte__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_pagos_soporte_submit_form(var_soporte_, var_nombre_archivo_, var_tamanio_archivo_, var_soporte__ul_name, var_soporte__ul_type, var_soporte__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pagos_soporte_submit_form_cb);
  } // do_ajax_form_pagos_soporte_submit_form

  function do_ajax_form_pagos_soporte_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("soporte_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_archivo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tamanio_archivo_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
<?php
        ...
        {
?>
          if (document.F1.elements["soporte__limpa" + sc_num_ult_line] && document.F1.elements["soporte__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldDocument("soporte_" + sc_num_ult_line, oImgTemp, "", "");
            document.F1.elements["soporte__limpa" + sc_num_ult_line].checked = false;
          }
          else if (document.getElementById("id_ajax_doc_soporte_" + sc_num_ult_line) && "" != document.getElementById("id_ajax_doc_soporte_" + sc_num_ult_line).innerHTML)
          {
            document.getElementById("id_ajax_doc_soporte_" + sc_num_ult_line).style.display = "";
          }
<?php
        }
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pagos_soporte_submit_form_cb_after_alert);
  } // do_ajax_form_pagos_soporte_submit_form_cb
  function do_ajax_form_pagos_soporte_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pagos_soporte_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_pagos_soporte_navigate_form()
  {
    perform_ajax_form_pagos_soporte_navigate_form();
  }

  function perform_ajax_form_pagos_soporte_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_pagos_soporte_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("soporte_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_archivo_" + iNavForm);
      scAjaxHideErrorDisplay("tamanio_archivo_" + iNavForm);
    }
    var var_idpagos_soporte_ = document.F2.idpagos_soporte_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_pagos_soporte_navigate_form(var_idpagos_soporte_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pagos_soporte_navigate_form_cb);
  } // do_ajax_form_pagos_soporte_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagos_soporte']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pagos_soporte_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idpagos_soporte_.value = scAjaxGetKeyValue("idpagos_soporte_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pagos_soporte_navigate_form_cb_after_alert);
  } // do_ajax_form_pagos_soporte_navigate_form_cb
  function do_ajax_form_pagos_soporte_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_pagos_soporte_navigate_form_cb_after_alert
  function sc_hide_form_pagos_soporte_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "soporte_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_archivo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tamanio_archivo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["soporte_" + iNumLinha] = {"label": "Soporte<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nombre_archivo_" + iNumLinha] = {"label": "Nombre<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tamanio_archivo_" + iNumLinha] = {"label": "Tamaño<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["soporte_"][iNumLinha] = "soporte_" + iNumLinha;
    ajax_field_mult["nombre_archivo_"][iNumLinha] = "nombre_archivo_" + iNumLinha;
    ajax_field_mult["tamanio_archivo_"][iNumLinha] = "tamanio_archivo_" + iNumLinha;
    ajax_field_id["soporte_" + iNumLinha] = new Array("hidden_field_label_soporte_", "hidden_field_data_soporte_" + iNumLinha);
    ajax_field_id["nombre_archivo_" + iNumLinha] = new Array("hidden_field_label_nombre_archivo_", "hidden_field_data_nombre_archivo_" + iNumLinha);
    ajax_field_id["tamanio_archivo_" + iNumLinha] = new Array("hidden_field_label_tamanio_archivo_", "hidden_field_data_tamanio_archivo_" + iNumLinha);
    ajax_error_count["soporte_" + iNumLinha] = "off";
    ajax_error_count["nombre_archivo_" + iNumLinha] = "off";
    ajax_error_count["tamanio_archivo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["soporte_" + iNumLinha] = "off";
    ajax_read_only["nombre_archivo_" + iNumLinha] = "off";
    ajax_read_only["tamanio_archivo_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["soporte_" + iNumLinha] = "on";
    ajax_read_only["nombre_archivo_" + iNumLinha] = "on";
    ajax_read_only["tamanio_archivo_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["soporte_" + iNumLinha] = null;
    ajax_error_list["nombre_archivo_" + iNumLinha] = null;
    ajax_error_list["tamanio_archivo_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "soporte_": new Array(),
    "nombre_archivo_": new Array(),
    "tamanio_archivo_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["soporte_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["soporte_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["soporte_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["soporte_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["soporte_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nombre_archivo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nombre_archivo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nombre_archivo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nombre_archivo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nombre_archivo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tamanio_archivo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tamanio_archivo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tamanio_archivo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tamanio_archivo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tamanio_archivo_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['soporte_'])) ? $this->nmgp_cmp_readonly['soporte_'] : 'off';
?>
    scAjaxFieldRead("soporte_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nombre_archivo_'])) ? $this->nmgp_cmp_readonly['nombre_archivo_'] : 'off';
?>
    scAjaxFieldRead("nombre_archivo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tamanio_archivo_'])) ? $this->nmgp_cmp_readonly['tamanio_archivo_'] : 'off';
?>
    scAjaxFieldRead("tamanio_archivo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("soporte_" + iSeq, "on");
    scAjaxFieldRead("nombre_archivo_" + iSeq, "on");
    scAjaxFieldRead("tamanio_archivo_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["soporte_" + iRow] || "on" == ajax_error_count["nombre_archivo_" + iRow] || "on" == ajax_error_count["tamanio_archivo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_soporte_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_archivo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tamanio_archivo_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["soporte_" + iRow] && "off" == ajax_error_count["nombre_archivo_" + iRow] && "off" == ajax_error_count["tamanio_archivo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["soporte_" + iRow] = "off";
        ajax_error_count["nombre_archivo_" + iRow] = "off";
        ajax_error_count["tamanio_archivo_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_soporte_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_archivo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tamanio_archivo_" + iRow).removeClass("scFormErrorLine");
    }
  }
