...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_remisiones_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_remisiones_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
  nm_gp_submit('<?php echo $this->Ini->link_pdfreport_remision_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "par_numfacventa*scin' + var_btn_imprimir_par_numfacventa + '*scout"; ?>', 'inicio', '_blank', '0', '0', 'pdfreport_remision');
}
...
function sc_btn_Eliminar_ok()
{
    ...
    document.F1.action = "form_remisiones_mob.php";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_remisiones_mob']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_form_remisiones_mob_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_remisiones_mob_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
