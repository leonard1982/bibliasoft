...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idfacven' + iSeqRow).bind('change', function() { sc_form_remisiones_idfacven_onchange(this, iSeqRow) });
  $('#id_sc_field_numfacven' + iSeqRow).bind('blur', function() { sc_form_remisiones_numfacven_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_remisiones_numfacven_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nremision' + iSeqRow).bind('blur', function() { sc_form_remisiones_nremision_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_remisiones_nremision_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_subtotal' + iSeqRow).bind('blur', function() { sc_form_remisiones_subtotal_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_remisiones_subtotal_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_valoriva' + iSeqRow).bind('blur', function() { sc_form_remisiones_valoriva_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_remisiones_valoriva_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_form_remisiones_total_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_remisiones_total_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pagada' + iSeqRow).bind('blur', function() { sc_form_remisiones_pagada_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_remisiones_pagada_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_form_remisiones_observaciones_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_remisiones_observaciones_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_saldo' + iSeqRow).bind('blur', function() { sc_form_remisiones_saldo_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_remisiones_saldo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_adicional' + iSeqRow).bind('blur', function() { sc_form_remisiones_adicional_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_remisiones_adicional_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_remisiones_adicional_onfocus(this, iSeqRow) });
  $('#id_sc_field_formapago' + iSeqRow).bind('change', function() { sc_form_remisiones_formapago_onchange(this, iSeqRow) });
  $('#id_sc_field_adicional2' + iSeqRow).bind('change', function() { sc_form_remisiones_adicional2_onchange(this, iSeqRow) });
  $('#id_sc_field_adicional3' + iSeqRow).bind('change', function() { sc_form_remisiones_adicional3_onchange(this, iSeqRow) });
  $('#id_sc_field_obspago' + iSeqRow).bind('change', function() { sc_form_remisiones_obspago_onchange(this, iSeqRow) });
  $('#id_sc_field_vendedor' + iSeqRow).bind('blur', function() { sc_form_remisiones_vendedor_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_remisiones_vendedor_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dirdelcliente' + iSeqRow).bind('blur', function() { sc_form_remisiones_dirdelcliente_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_remisiones_dirdelcliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cupo' + iSeqRow).bind('blur', function() { sc_form_remisiones_cupo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_remisiones_cupo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cupodis' + iSeqRow).bind('blur', function() { sc_form_remisiones_cupodis_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_remisiones_cupodis_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_detalle' + iSeqRow).bind('blur', function() { sc_form_remisiones_detalle_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_remisiones_detalle_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pref_pedido' + iSeqRow).bind('blur', function() { sc_form_remisiones_pref_pedido_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_remisiones_pref_pedido_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_remisiones_pref_pedido_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_remisiones_idfacven_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_numfacven_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_nremision_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_subtotal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_valoriva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_pagada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_observaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_saldo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_adicional_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_formapago_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_remisiones_adicional2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_remisiones_adicional3_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_remisiones_obspago_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_vendedor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_dirdelcliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_cupo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_cupodis_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_detalle_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_remisiones_pref_pedido_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_field_detalle(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_detalleventaremis")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_detalleventaremis")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_remisiones_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechaven" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_remisiones_validate_fechaven(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_remisiones_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_remisiones')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
