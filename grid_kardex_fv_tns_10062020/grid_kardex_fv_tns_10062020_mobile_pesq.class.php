...
class grid_kardex_fv_tns_10062020_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['opcao'] = "igual";
...
$_SESSION['scriptcase']['grid_kardex_fv_tns_10062020']['contr_erro'] = 'off'; 
      ...
      if (isset($fecha_month))
      {
          $fecha_mes = $fecha_month; 
      }
      if (isset($fecha_year))
      {
          $fecha_ano = $fecha_year; 
      }
      if (isset($fecha))
      {
          $fecha = str_replace("0000", "", $fecha);
          $fecha = str_replace("-00", "-", $fecha);
          $fechaTT = explode(" ", $fecha);
          $fechaXX = explode("-", $fechaTT[0]);
          if (isset($fechaXX[2]))
          {
              $fecha_dia = $fechaXX[2]; 
          }
      ...
      if (isset($fecha_input_2_day))
      {
          $fecha_input_2_dia = $fecha_input_2_day; 
      }
      if (isset($fecha_input_2_month))
      {
          $fecha_input_2_mes = $fecha_input_2_month; 
      }
      if (isset($fecha_input_2_year))
      {
          $fecha_input_2_ano = $fecha_input_2_year; 
      }
      if (isset($fecha_2))
      {
          $fecha_2 = str_replace("0000", "", $fecha_2);
          $fecha_2 = str_replace("-00", "-", $fecha_2);
          $fechaTT = explode(" ", $fecha_2);
          $fechaXX = explode("-", $fechaTT[0]);
          if (isset($fechaXX[2]))
          {
              $fecha_input_2_dia = $fechaXX[2]; 
          }
          if (isset($fechaXX[1]))
          {
              $fecha_input_2_mes = $fechaXX[1]; 
          }
          if (isset($fechaXX[0]))
          {
              $fecha_input_2_ano = $fechaXX[0]; 
          }
          if (isset($fechaTT[1]))
          {
              $fechaXX = explode(":", $fechaTT[1]);
              if (isset($fechaXX[2]))
              {
                  $fecha_input_2_seg = $fechaXX[2]; 
              }
              if (isset($fechaXX[1]))
              {
                  $fecha_input_2_min = $fechaXX[1]; 
              }
              if (isset($fechaXX[0]))
              {
                  $fecha_input_2_hor = $fechaXX[0]; 
              }
          }
      }
    }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_kardex_fv_tns_10062020_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_kardex_fv_tns_10062020_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_kardex_fv_tns_10062020_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_kardex_fv_tns_10062020/grid_kardex_fv_tns_10062020_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_kardex_fv_tns_10062020_ajax_search.js"></script>
 <script type="text/javascript" src="grid_kardex_fv_tns_10062020_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_kardex_fv_tns_10062020_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_kardex_fv_tns_10062020']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_kardex_fv_tns_10062020']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['ajax_nav'])
           { 
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_numero").attr('class').split(' ');
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['dashboard_info']['compact_mode'])
      {
          return;
      }
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
            ...
            <td id="lin1_col2" class="scFilterHeaderFont"><span><IMG src="<?php echo $this->Ini->path_imag_cab; ?>/scriptcase__NM__ico__NM__document_notebook_32.png" border="0"></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_kardex_fv_tns_10062020']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_kardex_fv_tns_10062020']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_kardex_fv_tns_10062020']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_kardex_fv_tns_10062020", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $codcomp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['codcomp']; 
          $codcomp_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['codcomp_cond']; 
          $codprefijo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['codprefijo']; 
          $codprefijo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['codprefijo_cond']; 
          $numero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['numero']; 
          $numero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['numero_cond']; 
          $periodo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['periodo']; 
          $periodo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['periodo_cond']; 
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_input_2_ano']; 
          $fecha_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_hor']; 
          $fecha_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_min']; 
          $fecha_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_seg']; 
          $fecha_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_input_2_hor']; 
          $fecha_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_input_2_min']; 
          $fecha_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_input_2_seg']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_cond']; 
          $cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['cliente']; 
          $cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['cliente_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['NM_operador']; 
      } 
      ...
      if (isset($codprefijo) && !empty($codprefijo))
      {
         ...
         {
         $codprefijo = substr($codprefijo, 0, $tmp_pos);
         }
      }
    ...
    <TR>
     <TD colspan="1" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_0"><?php echo $Img_tit_blk_i ?>bl2<?php echo $Img_tit_blk_f ?></TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_codcomp"  <?php echo $str_hide_codcomp?>> 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['codcomp'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['codcomp'][] = "FV";
 ?>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_codprefijo"  <?php echo $str_hide_codprefijo?>>
<?php
      $codprefijo_look = substr($this->Ini->nm_db_conn_mysql->qstr($codprefijo), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT DISTINCT cod_prefijo FROM cloud_prefijos  WHERE tipo='FV' ORDER BY cod_prefijo"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Ini->nm_db_conn_mysql->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['codprefijo'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['codprefijo'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_codprefijo">
      <SELECT class="scFilterObjectEven" id="SC_codprefijo" name="codprefijo"  size="1">
<?php
...
?>
    ...
    <TR>
     <TD colspan="1" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_1"><?php echo $Img_tit_blk_i ?>grid_KARDEX_TNS<?php echo $Img_tit_blk_f ?></TD>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'][] = "01";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'][] = "02";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'][] = "03";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'][] = "04";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'][] = "05";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'][] = "06";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'][] = "07";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'][] = "08";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'][] = "09";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'][] = "10";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'][] = "11";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'][] = "12";
 ?>
...
?>
<?php
   if (is_file("grid_kardex_fv_tns_10062020_help.txt"))
   {
      $Arq_WebHelp = file("grid_kardex_fv_tns_10062020_help.txt"); 
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['opc_psq'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['sc_modal'])
       {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_kardex_fv_tns_10062020_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_kardex_fv_tns_10062020_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_kardex_fv_tns_10062020_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_kardex_fv_tns_10062020_valida_mes(this)});
 }
 function sc_grid_kardex_fv_tns_10062020_valida_dia(obj)
 {
 ...
 function sc_grid_kardex_fv_tns_10062020_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEB_FE_73/grid_kardex_fv_tns_10062020";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_kardex_fv_tns_10062020/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['codcomp'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($codprefijo, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['codprefijo'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "PJ/TNS : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($periodo, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $periodo;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['psq_check_ret']['periodo'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['codcomp'] = $codcomp; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['codcomp_cond'] = $codcomp_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['codprefijo'] = $codprefijo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['codprefijo_cond'] = $codprefijo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['numero'] = $numero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['numero_cond'] = $numero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['periodo'] = $periodo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['periodo_cond'] = $periodo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_hor'] = $fecha_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_min'] = $fecha_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_seg'] = $fecha_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_input_2_hor'] = $fecha_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_input_2_min'] = $fecha_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_input_2_seg'] = $fecha_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['cliente'] = $cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['cliente_cond'] = $cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca'] = $Temp_Busca;
      }
      if ($cliente_cond != "in" && $cliente_cond != "bw" && !empty($cliente) && !is_numeric($cliente))
      {
      ...
      if ($cliente_cond == "bw" && ((!empty($cliente) && !is_numeric($cliente)) || (!empty($cliente_input_2) && !is_numeric($cliente_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : CLIENTE";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "TIMESTAMP", $fecha_cond, "", "datahora");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fecha = $val[0];
          $this->cmp_formatado['fecha'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']['fecha_input_2'] = $val[1];
          ...
          {
              $this->monta_condicao("FECHA", $fecha_cond, $fecha, $fecha_input_2, 'fecha', 'TIMESTAMP');
          }
      }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['where_pesq'];
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if ($nm_target == "modal")
      {
          ...
          $par_modal = "?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&nmgp_outra_jan=true&nmgp_url_saida=modal&NMSC_modal=ok&";
           if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['embutida_form_full']) || (isset($this->grid_emb_form_full) && $this->grid_emb_form_full))
           {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_10062020']['iframe_print'] )
      {
          $target = "_parent";
      }
...
?>
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "codprefijo" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
