<?php
   include_once('grid_kardex_fv_tns_10062020_session.php');
   session_start();
   $_SESSION['scriptcase']['grid_kardex_fv_tns_10062020']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['grid_kardex_fv_tns_10062020']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['grid_kardex_fv_tns_10062020']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_kardex_fv_tns_10062020']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_kardex_fv_tns_10062020_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_kardex_fv_tns_10062020_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_kardex_fv_tns_10062020_json.php");
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['num'] = "on";
   $tab_def_campos['num'] = "NUM";
   $tab_labels["num"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["num"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["num"] : "# TNS";
   ...
   $tab_labels["enviar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["enviar"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["enviar"] : "ENVIAR";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "FECHA";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["fecha"] : "FECHA";
   $tab_ger_campos['numfe'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['numfe'] = "numfe";
   }
   else
   {
       $tab_def_campos['numfe'] = "";
   }
   $tab_labels["numfe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["numfe"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["numfe"] : "DOC";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "NOMBRE";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["nombre"] : "NOMBRE";
   ...
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["email"] : "EMAIL";
   ...
   $tab_labels["ico_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["ico_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["ico_cliente"] : "";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "TOTAL";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["total"] : "TOTAL";
   ...
   $tab_labels["detalle"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["detalle"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["detalle"] : "DETALLE";
   ...
   $tab_labels["pdf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["pdf"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["pdf"] : "PDF";
   ...
   $tab_labels["avisos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["avisos"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["avisos"] : "XML";
   $tab_ger_campos['adjuntos'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['adjuntos'] = "adjuntos";
   }
   else
   {
       $tab_def_campos['adjuntos'] = "";
   }
   $tab_labels["adjuntos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["adjuntos"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["adjuntos"] : "";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["sc_field_0"] : "";
   $tab_ger_campos['kardexid'] = "on";
   $tab_def_campos['kardexid'] = "KARDEXID";
   $tab_labels["kardexid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["kardexid"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['labels']["kardexid"] : "ID";
   $tab_ger_campos['enviar'] = "none";
   $tab_ger_campos['numfe'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_kardex_fv_tns_10062020_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns_10062020']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
