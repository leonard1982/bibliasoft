...
<body id="bodMain" class="BakcBilling" style="height: 100%; overflow: auto;background:white;">
...
//recorremos las facturas de un periodo
$vsql = "select k.idfacven from facturaven_contratos k left join terceros t on k.idcli=t.idtercero left join resdian r on k.resolucion=r.Idres left join direccion dr on dr.iddireccion=k.dircliente where YEAR(k.fechaven)='".$vanio."' and MONTH(k.fechaven)='".$vperiodo."' and k.resolucion='".$vidresolucion."'";
$cx2 = $conexion->consulta($vsql);
	
while($rx2 = mysqli_fetch_array($cx2))
{
...
<div id="container_fluid" class="">
        <div id="divS" class="" style="background: white">
            <div id="ctl15_ucControlPane0_ctl00_divContent" class="container_Shadow"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="SKYPE_TOOLBAR" content="SKYPE_TOOLBAR_PARSER_COMPATIBLE"><title>Factura - Facilweb FE</title>
				...
				<span style="color:#000; font-size:12px;">
					...
					<br>
					Tel: <?php if($vsn_pjfe=="MAFE"){echo "3158274103";}else{echo $celular;} ?>
					<br>
					<?php echo $correo; ?>
					<br>
					<?php echo $pagina_web; ?>
