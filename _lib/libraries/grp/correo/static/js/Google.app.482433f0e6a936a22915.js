...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (oAppData) {
		var
			...
			Settings = __webpack_require__(/*! modules/Google/js/Settings.js */ 291),
					...
					ModulesManager.run('AdminPanelWebclient', 'registerAdminPanelTab', [
						function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/Google/js/views/AdminSettingsView.js */ 293));
								});
						},
			...
			return {
				start: function (ModulesManager) {
					ModulesManager.run('SettingsWebclient', 'registerSettingsTab', [
						function () { return __webpack_require__(/*! modules/Google/js/views/GoogleSettingsFormView.js */ 292); },
						Settings.HashModuleName,
						TextUtils.i18n('GOOGLE/LABEL_SETTINGS_TAB')
					]);
				}
