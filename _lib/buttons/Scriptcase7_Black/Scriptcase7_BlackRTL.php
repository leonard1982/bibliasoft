<?php
  ...
  $this->arr_buttons['bstepretorna']['image'] = 'scriptcase__NM__nm_Scriptcase7_Black_bcons_avanca.gif';
  ...
  $this->arr_buttons['bstepavanca']['image'] = 'scriptcase__NM__nm_Scriptcase7_Black_bretorna.gif';
