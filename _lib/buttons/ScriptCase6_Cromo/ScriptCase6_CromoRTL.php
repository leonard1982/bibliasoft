<?php
  ...
  $this->arr_buttons['bstepretorna']['image'] = 'scriptcase__NM__nm_ScriptCase6_Cromo_bcons_avanca.gif';
  ...
  $this->arr_buttons['bstepavanca']['image'] = 'scriptcase__NM__nm_ScriptCase6_Cromo_bretorna.gif';
  ...
  $this->arr_buttons['bfilref_apply']['image'] = 'scriptcase__NM__nm_ScriptCase6_Cromo_bpesquisa.gif';
  ...
  $this->arr_buttons['bfilref_limpar']['image'] = 'scriptcase__NM__nm_ScriptCase6_Cromo_blimpar.gif';
  ...
  $this->arr_buttons['bfilref_close']['image'] = 'scriptcase__NM__nm_ScriptCase6_Cromo_bajaxclose.gif';
