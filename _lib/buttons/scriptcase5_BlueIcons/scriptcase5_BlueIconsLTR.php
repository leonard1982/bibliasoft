<?php
  ...
  $this->arr_buttons['bstepretorna']['image'] = 'scriptcase__NM__nm_scriptcase5_BlueIcons_bretorna.gif';
  ...
  $this->arr_buttons['bstepavanca']['image'] = 'scriptcase__NM__nm_scriptcase5_BlueIcons_bavanca.gif';
