<?php
  ...
  $this->arr_buttons['bsalvar']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_bsalvar.gif';
  ...
  $this->arr_buttons['bexportemail']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_bdownload.gif';
  ...
  $this->arr_buttons['bsweetalert_ok']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_bsweetalert_ok.gif';
  ...
  $this->arr_buttons['bsweetalert_cancel']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_bsweetalert_cancel.gif';
  ...
  $this->arr_buttons['bapply_appdiv']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_bapply_appdiv.gif';
  ...
  $this->arr_buttons['bok_appdiv']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_bok_appdiv.gif';
  ...
  $this->arr_buttons['blimpar_appdiv']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_blimpar_appdiv.gif';
  ...
  $this->arr_buttons['brestore_appdiv']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_brestore_appdiv.gif';
  ...
  $this->arr_buttons['bsair_appdiv']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_bsair_appdiv.gif';
  ...
  $this->arr_buttons['bcancelar_appdiv']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_bcancelar_appdiv.gif';
  ...
  $this->arr_buttons['bsalvar_appdiv']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_bsalvar_appdiv.gif';
  ...
  $this->arr_buttons['bexcluir_appdiv']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_bexcluir_appdiv.gif';
  ...
  $this->arr_buttons['bstepretorna']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_bcons_avanca.gif';
  ...
  $this->arr_buttons['bstepavanca']['image'] = 'scriptcase__NM__nm_scriptcase8_granada_bretorna.gif';
