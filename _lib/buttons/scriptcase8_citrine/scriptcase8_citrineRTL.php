<?php
  ...
  $this->arr_buttons['bstepretorna']['image'] = 'scriptcase__NM__nm_scriptcase8_citrine_bcons_avanca.gif';
  ...
  $this->arr_buttons['bstepavanca']['image'] = 'scriptcase__NM__nm_scriptcase8_citrine_bretorna.gif';
