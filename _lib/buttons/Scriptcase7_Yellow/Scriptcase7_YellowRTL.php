<?php
  ...
  $this->arr_buttons['bstepretorna']['image'] = 'scriptcase__NM__nm_Scriptcase7_Yellow_bavanca_off.gif';
  ...
  $this->arr_buttons['bstepavanca']['image'] = 'scriptcase__NM__nm_Scriptcase7_Yellow_bcons_retorna_off.gif';
