...
*/
    ...
    include_once('grid_productos_ventas_comparativo_codtns_session.php');
    session_start();
    $_SESSION['scriptcase']['grid_productos_ventas_comparativo_codtns']['glo_nm_path_imag_temp']  = "";
    //check tmp
    if(empty($_SESSION['scriptcase']['grid_productos_ventas_comparativo_codtns']['glo_nm_path_imag_temp']))
    {
        $str_path_apl_url = $_SERVER['PHP_SELF'];
        $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
        $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
        $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
        /*check tmp*/$_SESSION['scriptcase']['grid_productos_ventas_comparativo_codtns']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    $SC_cod_proj = "FACILWEB_V2";
    $SC_apl_proc = "grid_productos_ventas_comparativo_codtns";
/* sc_apl_default */
