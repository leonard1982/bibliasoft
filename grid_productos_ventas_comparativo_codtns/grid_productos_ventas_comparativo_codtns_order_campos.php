...
<?php
   ...
   $Ord_Cmp = new grid_productos_ventas_comparativo_codtns_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_productos_ventas_comparativo_codtns_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['p_codigobar'] = "p_codigobar";
   }
   else
   {
       $tab_def_campos['p_codigobar'] = "p.codigobar";
   }
   $tab_labels["p_codigobar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['labels']["p_codigobar"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['labels']["p_codigobar"] : "Codigo";
   $tab_ger_campos['p_nompro'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['p_nompro'] = "p_nompro";
   }
   else
   {
       $tab_def_campos['p_nompro'] = "p.nompro";
   }
   $tab_labels["p_nompro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['labels']["p_nompro"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['labels']["p_nompro"] : "Descripcion";
   $tab_ger_campos['tns'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tns'] = "tns";
   }
   else
   {
       $tab_def_campos['tns'] = "";
   }
   $tab_labels["tns"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['labels']["tns"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['labels']["tns"] : "TNS";
   $tab_ger_campos['tns'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_productos_ventas_comparativo_codtns_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_productos_ventas_comparativo_codtns']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
