  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contacto_clientes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_contacto_clientes_form();
	}
  ...
  // ---------- Validate tercero_
  function do_ajax_form_contacto_clientes_validate_tercero_(iNumLinha)
  {
  } // do_ajax_form_contacto_clientes_validate_tercero_

  function do_ajax_form_contacto_clientes_validate_tercero__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tercero_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tercero_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tercero_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tercero_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contacto_clientes_validate_tercero__cb

  // ---------- Validate contacto_
  function do_ajax_form_contacto_clientes_validate_contacto_(iNumLinha)
  {
    var nomeCampo_contacto_ = "contacto_" + iNumLinha;
    var var_contacto_ = scAjaxGetFieldText(nomeCampo_contacto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contacto_clientes_validate_contacto_(var_contacto_, iNumLinha, var_script_case_init, do_ajax_form_contacto_clientes_validate_contacto__cb);
  } // do_ajax_form_contacto_clientes_validate_contacto_

  function do_ajax_form_contacto_clientes_validate_contacto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "contacto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "contacto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "contacto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "contacto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contacto_clientes_validate_contacto__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_contacto_clientes_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_contacto_clientes_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contacto_clientes_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_contacto_clientes_add_new_line_cb);
  } // do_ajax_form_contacto_clientes_add_new_line

  function do_ajax_form_contacto_clientes_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_contacto_clientes_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_contacto_clientes_backup_line(iNumLinha)
  {
    var var_id_contato_cliente_ = scAjaxGetFieldText("id_contato_cliente_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contacto_clientes_backup_line(var_id_contato_cliente_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_contacto_clientes_backup_line_cb);
  } // do_ajax_form_contacto_clientes_backup_line

  function do_ajax_form_contacto_clientes_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_contacto_clientes_backup_line_cb

  function do_ajax_form_contacto_clientes_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_contacto_clientes_cancel_insert

  function do_ajax_form_contacto_clientes_cancel_update(iSeqVert)
  {
    do_ajax_form_contacto_clientes_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_contacto_clientes_cancel_update

  function do_ajax_form_contacto_clientes_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_contacto_clientes_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_contacto_clientes_table_refresh()
  {
    var var_id_contato_cliente_ = document.F2.id_contato_cliente_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_contacto_clientes_table_refresh(var_id_contato_cliente_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contacto_clientes_table_refresh_cb);
  } //  do_ajax_form_contacto_clientes_table_refresh

  function do_ajax_form_contacto_clientes_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_contato_cliente_.value = scAjaxGetKeyValue("id_contato_cliente_");
    ...
    scAjaxAlert(do_ajax_form_contacto_clientes_table_refresh_cb_after_alert);
  } // do_ajax_form_contacto_clientes_table_refresh_cb
  function do_ajax_form_contacto_clientes_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_contacto_clientes_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_contacto_clientes_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_contacto_clientes_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_tercero_ = scAjaxGetFieldText("tercero_" + iNumLinha);
    var var_contacto_ = scAjaxGetFieldText("contacto_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_contacto_clientes_submit_form(var_tercero_, var_contacto_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contacto_clientes_submit_form_cb);
  } // do_ajax_form_contacto_clientes_submit_form

  function do_ajax_form_contacto_clientes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tercero_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("contacto_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contacto_clientes_submit_form_cb_after_alert);
  } // do_ajax_form_contacto_clientes_submit_form_cb
  function do_ajax_form_contacto_clientes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contacto_clientes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_contacto_clientes_navigate_form()
  {
    perform_ajax_form_contacto_clientes_navigate_form();
  }

  function perform_ajax_form_contacto_clientes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_contacto_clientes_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tercero_" + iNavForm);
      scAjaxHideErrorDisplay("contacto_" + iNavForm);
    }
    var var_id_contato_cliente_ = document.F2.id_contato_cliente_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_contacto_clientes_navigate_form(var_id_contato_cliente_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contacto_clientes_navigate_form_cb);
  } // do_ajax_form_contacto_clientes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contacto_clientes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contacto_clientes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_contato_cliente_.value = scAjaxGetKeyValue("id_contato_cliente_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contacto_clientes_navigate_form_cb_after_alert);
  } // do_ajax_form_contacto_clientes_navigate_form_cb
  function do_ajax_form_contacto_clientes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_contacto_clientes_navigate_form_cb_after_alert
  function sc_hide_form_contacto_clientes_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tercero_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "contacto_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tercero_" + iNumLinha] = {"label": "Tercero<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["contacto_" + iNumLinha] = {"label": "Contacto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tercero_"][iNumLinha] = "tercero_" + iNumLinha;
    ajax_field_mult["contacto_"][iNumLinha] = "contacto_" + iNumLinha;
    ajax_field_id["tercero_" + iNumLinha] = new Array("hidden_field_label_tercero_", "hidden_field_data_tercero_" + iNumLinha);
    ajax_error_count["tercero_" + iNumLinha] = "off";
    ajax_error_count["contacto_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tercero_" + iNumLinha] = "off";
    ajax_read_only["contacto_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["tercero_" + iNumLinha] = "on";
    ajax_read_only["contacto_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["tercero_" + iNumLinha] = null;
    ajax_error_list["contacto_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tercero_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tercero_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tercero_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tercero_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tercero_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["contacto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["contacto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["contacto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["contacto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["contacto_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tercero_'])) ? $this->nmgp_cmp_readonly['tercero_'] : 'off';
?>
    scAjaxFieldRead("tercero_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['contacto_'])) ? $this->nmgp_cmp_readonly['contacto_'] : 'off';
?>
    scAjaxFieldRead("contacto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("tercero_" + iSeq, "on");
    scAjaxFieldRead("contacto_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tercero_" + iRow] || "on" == ajax_error_count["contacto_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tercero_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_contacto_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tercero_" + iRow] && "off" == ajax_error_count["contacto_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tercero_" + iRow] = "off";
        ajax_error_count["contacto_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_tercero_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_contacto_" + iRow).removeClass("scFormErrorLine");
    }
  }
