...
<?php
   ...
   $Ord_Cmp = new reporte_recibos_ingcaja_detalle_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class reporte_recibos_ingcaja_detalle_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["factura"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['labels']["factura"])) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['labels']["factura"] : "Factura";
   $tab_ger_campos['valor_factura'] = "on";
   $tab_def_campos['valor_factura'] = "valor_factura";
   $tab_labels["valor_factura"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['labels']["valor_factura"])) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['labels']["valor_factura"] : "Valor Factura";
   $tab_ger_campos['valor_pagado'] = "on";
   $tab_def_campos['valor_pagado'] = "valor_pagado";
   $tab_labels["valor_pagado"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['labels']["valor_pagado"])) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['labels']["valor_pagado"] : "Valor Pagado";
   $tab_ger_campos['saldo_factura'] = "on";
   $tab_def_campos['saldo_factura'] = "saldo_factura";
   $tab_labels["saldo_factura"]   = (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['labels']["saldo_factura"])) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['labels']["saldo_factura"] : "Saldo Factura";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "reporte_recibos_ingcaja_detalle_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['reporte_recibos_ingcaja_detalle']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
