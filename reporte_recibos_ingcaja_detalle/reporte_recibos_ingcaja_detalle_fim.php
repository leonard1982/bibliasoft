...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____reporte_recibos_ingcaja_detalle"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____reporte_recibos_ingcaja_detalle"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ingcaja_detalle']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['reporte_recibos_ingcaja_detalle']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ingcaja_detalle']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['reporte_recibos_ingcaja_detalle']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ingcaja_detalle']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>reporte_recibos_ingcaja_detalle</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ingcaja_detalle']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['reporte_recibos_ingcaja_detalle']['embutida_filho'] as $ind => $sc_init)
          {
