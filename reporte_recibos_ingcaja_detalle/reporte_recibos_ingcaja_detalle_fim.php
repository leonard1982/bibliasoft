...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____reporte_recibos_ingcaja_detalle"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____reporte_recibos_ingcaja_detalle"]);
   }
