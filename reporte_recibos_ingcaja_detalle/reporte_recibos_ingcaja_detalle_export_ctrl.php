<?php
@session_start() ;
$_SESSION['scriptcase']['reporte_recibos_ingcaja_detalle']['sc_process_barr'] = true;
require_once('../reporte_recibos_ingcaja_detalle/index.php');
unset($_SESSION['scriptcase']['reporte_recibos_ingcaja_detalle']['sc_process_barr']);
$ExportCtrl = new reporte_recibos_ingcaja_detalle_export_control;
$ExportCtrl->Export_barr();

class reporte_recibos_ingcaja_detalle_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['reporte_recibos_ingcaja_detalle']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['reporte_recibos_ingcaja_detalle']['glo_nm_path_imag_temp'];
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - recibos_ingcaja_detalle</TITLE>
