...
class reporte_recibos_ingcaja_detalle_json
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "reporte_recibos_ingcaja_detalle/reporte_recibos_ingcaja_detalle_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "reporte_recibos_ingcaja_detalle.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_name']);
      }
...
$_SESSION['scriptcase']['reporte_recibos_ingcaja_detalle']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "reporte_recibos_ingcaja_detalle_res_json.class.php");
              $this->Res = new reporte_recibos_ingcaja_detalle_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_res_grid']);
          } 
      }
   ...
   function NM_export_valor_factura()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->valor_factura;
   }
   //----- valor_pagado
   function NM_export_valor_pagado()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->valor_pagado;
   }
   //----- saldo_factura
   function NM_export_saldo_factura()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->saldo_factura;
   }
   //----- id_detalle
   function NM_export_id_detalle()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->id_detalle;
   }
   //----- id_recibo
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - recibos_ingcaja_detalle :: JSON</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_recibos_ingcaja_detalle']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
