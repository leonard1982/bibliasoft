...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fechultcomp_cond" name="fechultcomp_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechultcomp'), this, 'fechultcomp')">
      ...
      <br><span id="id_hide_fechultcomp"  <?php echo $str_hide_fechultcomp?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fechultcomp"  <?php echo $str_display_fechultcomp; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_saldoapagar_cond" name="saldoapagar_cond" onChange="nm_campos_between(document.getElementById('id_vis_saldoapagar'), this, 'saldoapagar')">
      ...
      <br><span id="id_hide_saldoapagar"  <?php echo $str_hide_saldoapagar?>><?php
      if ($saldoapagar != "")
      {
      $saldoapagar_look = substr($this->Db->qstr($saldoapagar), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-saldoapagar" id="id_ac_saldoapagar" name="saldoapagar_autocomp"><?php if ('' !=  $saldoapagar) { ?><option value="<?php echo $saldoapagar ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_saldoapagar"  <?php echo $str_display_saldoapagar; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_saldoapagar_input_2" name="saldoapagar_input_2" value="<?php echo NM_encode_input($saldoapagar_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
