...
<?php
   ...
   $Ord_Cmp = new grid_tesoreria_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tesoreria_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["documento"] : "Documento";
   $tab_ger_campos['nombres'] = "on";
   $tab_def_campos['nombres'] = "nombres";
   $tab_labels["nombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["nombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["nombres"] : "Nombre";
   $tab_ger_campos['direccion'] = "on";
   $tab_def_campos['direccion'] = "direccion";
   $tab_labels["direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["direccion"] : "Dirección";
   $tab_ger_campos['telefonos_prov'] = "on";
   $tab_def_campos['telefonos_prov'] = "telefonos_prov";
   $tab_labels["telefonos_prov"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["telefonos_prov"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["telefonos_prov"] : "Teléfonos";
   $tab_ger_campos['saldoapagar'] = "on";
   $tab_def_campos['saldoapagar'] = "saldoapagar";
   $tab_labels["saldoapagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["saldoapagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["saldoapagar"] : "Saldo apagar";
   $tab_ger_campos['fechultcomp'] = "on";
   $tab_def_campos['fechultcomp'] = "fechultcomp";
   $tab_labels["fechultcomp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["fechultcomp"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["fechultcomp"] : "Última Compra";
   $tab_ger_campos['autoretenedor'] = "on";
   $tab_def_campos['autoretenedor'] = "autoretenedor";
   $tab_labels["autoretenedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["autoretenedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["autoretenedor"] : "Auto retenedor";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["email"] : "Email";
   $tab_ger_campos['url'] = "on";
   $tab_def_campos['url'] = "url";
   $tab_labels["url"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["url"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["url"] : "URL";
   $tab_ger_campos['obligaciones'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['obligaciones'] = "obligaciones";
   }
   else
   {
       $tab_def_campos['obligaciones'] = "";
   }
   $tab_labels["obligaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["obligaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['labels']["obligaciones"] : "Listar Obligaciones";
   $tab_ger_campos['obligaciones'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tesoreria_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tesoreria']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
