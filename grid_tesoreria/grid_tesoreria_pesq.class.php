...
class grid_tesoreria_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tesoreria_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tesoreria_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tesoreria_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_saldoapagar')
      {
          $saldoapagar = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_saldoapagar($saldoapagar);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_documento($documento)
   {
      ...
      $nm_comando = "select distinct documento from " . $this->Ini->nm_tabela . " where proveedor='SI' and  documento like '%" . $documento . "%' order by documento"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_nombres($nombres)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombres from " . $this->Ini->nm_tabela . " where proveedor='SI' and  nombres like '%" . $nombres . "%' order by nombres"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_saldoapagar($saldoapagar)
   {
      $saldoapagar = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $saldoapagar);
      $saldoapagar = substr($this->Db->qstr($saldoapagar), 1, -1);
            $saldoapagar_look = substr($this->Db->qstr($saldoapagar), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct saldoapagar from " . $this->Ini->nm_tabela . " where proveedor='SI' and   CAST (saldoapagar AS TEXT)  like '%" . $saldoapagar . "%' order by saldoapagar"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct saldoapagar from " . $this->Ini->nm_tabela . " where proveedor='SI' and   CAST (saldoapagar AS VARCHAR)  like '%" . $saldoapagar . "%' order by saldoapagar"; 
      }
      else
      {
          $nm_comando = "select distinct saldoapagar from " . $this->Ini->nm_tabela . " where proveedor='SI' and  saldoapagar like '%" . $saldoapagar . "%' order by saldoapagar"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tesoreria/grid_tesoreria_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tesoreria_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tesoreria_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tesoreria_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tesoreria']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tesoreria']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_fechultcomp_cond#NMF#' + search_get_sel_txt('SC_fechultcomp_cond') + '@NMF@';
  str_out += 'SC_fechultcomp_dia#NMF#' + search_get_sel_txt('SC_fechultcomp_dia') + '@NMF@';
  str_out += 'SC_fechultcomp_mes#NMF#' + search_get_sel_txt('SC_fechultcomp_mes') + '@NMF@';
  str_out += 'SC_fechultcomp_ano#NMF#' + search_get_sel_txt('SC_fechultcomp_ano') + '@NMF@';
  str_out += 'SC_fechultcomp_input_2_dia#NMF#' + search_get_sel_txt('SC_fechultcomp_input_2_dia') + '@NMF@';
  str_out += 'SC_fechultcomp_input_2_mes#NMF#' + search_get_sel_txt('SC_fechultcomp_input_2_mes') + '@NMF@';
  str_out += 'SC_fechultcomp_input_2_ano#NMF#' + search_get_sel_txt('SC_fechultcomp_input_2_ano') + '@NMF@';
  str_out += 'SC_saldoapagar_cond#NMF#' + search_get_sel_txt('SC_saldoapagar_cond') + '@NMF@';
  str_out += 'SC_saldoapagar#NMF#' + search_get_text('SC_saldoapagar') + '@NMF@';
  str_out += 'id_ac_saldoapagar#NMF#' + search_get_title('select2-id_ac_saldoapagar-container') + '@NMF@';
  str_out += 'SC_saldoapagar_input_2#NMF#' + search_get_text('SC_saldoapagar_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  ...
  $(".sc-ui-autocomp-saldoapagar").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_saldoapagar",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_saldoapagar").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $fechultcomp_cond, $fechultcomp, $fechultcomp_dia, $fechultcomp_mes, $fechultcomp_ano, $fechultcomp_input_2_dia, $fechultcomp_input_2_mes, $fechultcomp_input_2_ano,
             $saldoapagar_cond, $saldoapagar, $saldoapagar_input_2, $saldoapagar_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $documento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['documento']; 
          $documento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['documento_cond']; 
          $nombres = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['nombres']; 
          $nombres_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['nombres_cond']; 
          $fechultcomp_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_dia']; 
          $fechultcomp_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_mes']; 
          $fechultcomp_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_ano']; 
          $fechultcomp_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_input_2_dia']; 
          $fechultcomp_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_input_2_mes']; 
          $fechultcomp_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_input_2_ano']; 
          $fechultcomp_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_cond']; 
          $saldoapagar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['saldoapagar']; 
          $saldoapagar_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['saldoapagar_input_2']; 
          $saldoapagar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['saldoapagar_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($fechultcomp_cond) || empty($fechultcomp_cond))
      {
         $fechultcomp_cond = "eq";
      }
      if (!isset($saldoapagar_cond) || empty($saldoapagar_cond))
      {
         $saldoapagar_cond = "gt";
      }
      ...
      $str_hide_fechultcomp = (in_array($fechultcomp_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_saldoapagar = (in_array($saldoapagar_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_fechultcomp = ('bw' == $fechultcomp_cond) ? $display_aberto : $display_fechado;
      $str_display_saldoapagar = ('bw' == $saldoapagar_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($fechultcomp) || $fechultcomp == "")
      {
          $fechultcomp = "";
      }
      if (isset($fechultcomp) && !empty($fechultcomp))
      {
         $tmp_pos = strpos($fechultcomp, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fechultcomp = substr($fechultcomp, 0, $tmp_pos);
         }
      }
      if (!isset($saldoapagar) || $saldoapagar == "")
      {
          $saldoapagar = "";
      }
      if (isset($saldoapagar) && !empty($saldoapagar))
      {
         $tmp_pos = strpos($saldoapagar, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $saldoapagar = substr($saldoapagar, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
      ...
      $documento_look = substr($this->Db->qstr($documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct documento from " . $this->Ini->nm_tabela . " where proveedor='SI' and documento = '$documento_look' order by documento"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-documento" id="id_ac_documento" name="documento_autocomp"><?php if ('' !=  $documento) { ?><option value="<?php echo $documento ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_nombres_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nombres'])) ? $this->New_label['nombres'] : "Nombre"; ?></TD>
...
<?php
      ...
      $nombres_look = substr($this->Db->qstr($nombres), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombres from " . $this->Ini->nm_tabela . " where proveedor='SI' and nombres = '$nombres_look' order by nombres"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-nombres" id="id_ac_nombres" name="nombres_autocomp"><?php if ('' !=  $nombres) { ?><option value="<?php echo $nombres ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_fechultcomp_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fechultcomp'])) ? $this->New_label['fechultcomp'] : "Última Compra"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_fechultcomp_cond" name="fechultcomp_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechultcomp'), this, 'fechultcomp')">
       <OPTION value="eq" <?php if ("eq" == $fechultcomp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $fechultcomp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $fechultcomp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $fechultcomp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fechultcomp" <?php echo $str_hide_fechultcomp?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fechultcomp'])) ? $this->New_label['fechultcomp'] : "Última Compra";
 $nmgp_tab_label .= "fechultcomp?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_fechultcomp_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechultcomp_dia" name="fechultcomp_dia" value="<?php echo NM_encode_input($fechultcomp_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechultcomp_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechultcomp_mes" name="fechultcomp_mes" value="<?php echo NM_encode_input($fechultcomp_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechultcomp_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechultcomp_ano" name="fechultcomp_ano" value="<?php echo NM_encode_input($fechultcomp_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_fechultcomp"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_fechultcomp"  <?php echo $str_display_fechultcomp; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_fechultcomp_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechultcomp_input_2_dia" name="fechultcomp_input_2_dia" value="<?php echo NM_encode_input($fechultcomp_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechultcomp_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechultcomp_input_2_mes" name="fechultcomp_input_2_mes" value="<?php echo NM_encode_input($fechultcomp_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechultcomp_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechultcomp_input_2_ano" name="fechultcomp_input_2_ano" value="<?php echo NM_encode_input($fechultcomp_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
      ...
      <TD id='SC_saldoapagar_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['saldoapagar'])) ? $this->New_label['saldoapagar'] : "Saldo apagar"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_saldoapagar_cond" name="saldoapagar_cond" onChange="nm_campos_between(document.getElementById('id_vis_saldoapagar'), this, 'saldoapagar')">
       <OPTION value="gt" <?php if ("gt" == $saldoapagar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $saldoapagar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $saldoapagar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $saldoapagar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_saldoapagar" <?php echo $str_hide_saldoapagar?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['saldoapagar'])) ? $this->New_label['saldoapagar'] : "Saldo apagar";
 $nmgp_tab_label .= "saldoapagar?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct saldoapagar from " . $this->Ini->nm_tabela . " where proveedor='SI' and saldoapagar = $saldoapagar_look order by saldoapagar"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct saldoapagar from " . $this->Ini->nm_tabela . " where proveedor='SI' and saldoapagar = $saldoapagar_look order by saldoapagar"; 
      ...
      if (isset($nmgp_def_dados[0][$saldoapagar]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$saldoapagar];
      }
      else
      {
            nmgp_Form_Num_Val($saldoapagar, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $saldoapagar;
      }
?>
<INPUT  type="text" id="SC_saldoapagar" name="saldoapagar" value="<?php echo NM_encode_input($saldoapagar) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-saldoapagar" id="id_ac_saldoapagar" name="saldoapagar_autocomp"><?php if ('' !=  $saldoapagar) { ?><option value="<?php echo $saldoapagar ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_saldoapagar"  <?php echo $str_display_saldoapagar; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_saldoapagar_input_2" name="saldoapagar_input_2" value="<?php echo NM_encode_input($saldoapagar_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
...
?>
<?php
   if (is_file("grid_tesoreria_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tesoreria']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tesoreria']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.documento_cond.value = 'eq';
   ...
   document.F1.fechultcomp_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fechultcomp'), document.F1.fechultcomp_cond, 'fechultcomp');
   document.F1.fechultcomp_dia.value = "";
   document.F1.fechultcomp_mes.value = "";
   document.F1.fechultcomp_ano.value = "";
   document.F1.fechultcomp_input_2_dia.value = "";
   document.F1.fechultcomp_input_2_mes.value = "";
   document.F1.fechultcomp_input_2_ano.value = "";
   document.F1.saldoapagar_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_saldoapagar'), document.F1.saldoapagar_cond, 'saldoapagar');
   document.F1.saldoapagar.value = "";
   document.F1.saldoapagar_autocomp.value = "";
   $('#select2-id_ac_saldoapagar-container').html('<?php echo $this->Val_init_saldoapagar['desc'] ?>');;
   document.F1.saldoapagar_input_2.value = "";
   Sc_carga_select2('all');
 }
 ...
 {
    $('#SC_fechultcomp_dia').bind('change', function() {sc_grid_tesoreria_valida_dia(this)});
    $('#SC_fechultcomp_input_2_dia').bind('change', function() {sc_grid_tesoreria_valida_dia(this)});
    $('#SC_fechultcomp_input_2_mes').bind('change', function() {sc_grid_tesoreria_valida_mes(this)});
    $('#SC_fechultcomp_mes').bind('change', function() {sc_grid_tesoreria_valida_mes(this)});
 }
 function sc_grid_tesoreria_valida_dia(obj)
 {
 ...
 function sc_grid_tesoreria_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_tesoreria";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fechultcomp_cond'] = 'cond';
      $tp_fields['SC_fechultcomp_dia'] = 'text';
      $tp_fields['SC_fechultcomp_mes'] = 'text';
      $tp_fields['SC_fechultcomp_ano'] = 'text';
      $tp_fields['SC_fechultcomp_input_2_dia'] = 'text';
      $tp_fields['SC_fechultcomp_input_2_mes'] = 'text';
      $tp_fields['SC_fechultcomp_input_2_ano'] = 'text';
      $tp_fields['SC_saldoapagar_cond'] = 'cond';
      $tp_fields['SC_saldoapagar'] = 'text_aut';
      $tp_fields['id_ac_saldoapagar'] = 'select2_aut';
      $tp_fields['SC_saldoapagar_input_2'] = 'text';
   ...
   function trata_campos()
   {
      global $documento_cond, $documento, $documento_autocomp,
             $nombres_cond, $nombres, $nombres_autocomp,
             $fechultcomp_cond, $fechultcomp, $fechultcomp_dia, $fechultcomp_mes, $fechultcomp_ano, $fechultcomp_input_2_dia, $fechultcomp_input_2_mes, $fechultcomp_input_2_ano,
             $saldoapagar_cond, $saldoapagar, $saldoapagar_input_2, $saldoapagar_autocomp, $nmgp_tab_label;
      ...
      if (!empty($saldoapagar_autocomp) && empty($saldoapagar))
      {
          $saldoapagar = $saldoapagar_autocomp;
      }
      ...
      $fechultcomp_cond_salva = $fechultcomp_cond; 
      if (!isset($fechultcomp_input_2_dia) || $fechultcomp_input_2_dia == "")
      {
          $fechultcomp_input_2_dia = $fechultcomp_dia;
      }
      if (!isset($fechultcomp_input_2_mes) || $fechultcomp_input_2_mes == "")
      {
          $fechultcomp_input_2_mes = $fechultcomp_mes;
      }
      if (!isset($fechultcomp_input_2_ano) || $fechultcomp_input_2_ano == "")
      {
          $fechultcomp_input_2_ano = $fechultcomp_ano;
      }
      $saldoapagar_cond_salva = $saldoapagar_cond; 
      if (!isset($saldoapagar_input_2) || $saldoapagar_input_2 == "")
      {
          $saldoapagar_input_2 = $saldoapagar;
      }
      if ($saldoapagar_cond != "in")
      {
          nm_limpa_numero($saldoapagar, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($saldoapagar_cond != "in")
      {
          nm_limpa_numero($saldoapagar_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['documento'] = $documento; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['documento_cond'] = $documento_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['nombres'] = $nombres; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['nombres_cond'] = $nombres_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_dia'] = $fechultcomp_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_mes'] = $fechultcomp_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_ano'] = $fechultcomp_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_input_2_dia'] = $fechultcomp_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_input_2_mes'] = $fechultcomp_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_input_2_ano'] = $fechultcomp_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_cond'] = $fechultcomp_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['saldoapagar'] = $saldoapagar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['saldoapagar_input_2'] = $saldoapagar_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['saldoapagar_cond'] = $saldoapagar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca'] = $Temp_Busca;
      }
      if ($saldoapagar_cond != "in" && $saldoapagar_cond != "bw" && !empty($saldoapagar) && !is_numeric($saldoapagar))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Saldo apagar";
      }
      if ($saldoapagar_cond == "bw" && ((!empty($saldoapagar) && !is_numeric($saldoapagar)) || (!empty($saldoapagar_input_2) && !is_numeric($saldoapagar_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Saldo apagar";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['saldoapagar'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['saldoapagar'] = $cmp1;
      }
      else
      {
          $cmp1 = $saldoapagar;
      ...
      $Conteudo = $saldoapagar_input_2;
      if (strtoupper($saldoapagar_cond) != "II" && strtoupper($saldoapagar_cond) != "QP" && strtoupper($saldoapagar_cond) != "NP" && strtoupper($saldoapagar_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['saldoapagar_input_2'] = $Conteudo;
      ...
      //----- $fechultcomp
      $this->Date_part = false;
      if ($fechultcomp_cond != "bi_TP")
      {
          $fechultcomp_cond = strtoupper($fechultcomp_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $fechultcomp_ano;
          $Dtxt .= $fechultcomp_mes;
          $Dtxt .= $fechultcomp_dia;
          $val[0]['ano'] = $fechultcomp_ano;
          $val[0]['mes'] = $fechultcomp_mes;
          $val[0]['dia'] = $fechultcomp_dia;
          if ($fechultcomp_cond == "BW")
          {
              $val[1]['ano'] = $fechultcomp_input_2_ano;
              $val[1]['mes'] = $fechultcomp_input_2_mes;
              $val[1]['dia'] = $fechultcomp_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $fechultcomp_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $fechultcomp_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fechultcomp = $val[0];
          $this->cmp_formatado['fechultcomp'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fechultcomp'], "YYYY-MM-DD");
          $this->cmp_formatado['fechultcomp'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($fechultcomp_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $fechultcomp_input_2     = $val[1];
              $this->cmp_formatado['fechultcomp_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']['fechultcomp_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fechultcomp_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['fechultcomp_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $fechultcomp_cond == "NU" || $fechultcomp_cond == "NN"|| $fechultcomp_cond == "EP"|| $fechultcomp_cond == "NE")
          {
              $this->monta_condicao("fechultcomp", $fechultcomp_cond, $fechultcomp, $fechultcomp_input_2, 'fechultcomp', 'DATE');
          }
      }

      //----- $saldoapagar
      $this->Date_part = false;
      if (isset($saldoapagar) || $saldoapagar_cond == "nu" || $saldoapagar_cond == "nn" || $saldoapagar_cond == "ep" || $saldoapagar_cond == "ne")
      {
         $this->monta_condicao("saldoapagar", $saldoapagar_cond, $saldoapagar, $saldoapagar_input_2, "saldoapagar");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria']['cond_pesq'] .= $this->NM_operador;
