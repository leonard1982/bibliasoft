<?php
class grid_ventas_por_vendedor_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['charts_html'] = '';
   ...
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "grid_ventas_por_vendedor/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new grid_ventas_por_vendedor_resumo();
       $this->Res->Db     = $this->Db;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_int_search'] = false;
       $nm_saida->saida("      </TD>\r\n");
       $nm_saida->saida("      <TD class=\"scGridRefinedSearchMolduraResult\" valign='top'>\r\n");
       $nm_saida->saida("       <table width='100%' cellspacing=0 cellpadding=0>\r\n");
       } 
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_ventas_por_vendedor'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['save_grid']))
       {
           $this->refresh_interativ_search();
       }
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['graf_pdf'] == "S")
       { 
           ...
           elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "pdf" && $Gera_graf)
           { 
               $this->grafico_pdf();
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] = "grid";
           } 
       ...
       { 
           ...
           if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "pdf")
           { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_pdf']['label_group'] : "S";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_pdf']['all_cab'] : "N";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_pdf']['all_label'] : "N";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_ventas_por_vendedor/grid_ventas_por_vendedor_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_cmp']) > 1)
   {
       $this->width_tabula_quebra  = (((count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_cmp']) - 1) * 13) + 3) . "px";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_form_full'])
       {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_ventas_por_vendedor", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] = "muda_qt_linhas";
   } 
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_ventas_por_vendedor/grid_ventas_por_vendedor_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_ventas_por_vendedor_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid']; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_quebra'] = array(); 
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_sql'] as $cmp_var => $resto)
           {
               ...
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_quebra'][$cmp_var][$SC_Sql_col] = $SC_Sql_order;
               }
           }
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao']       = "igual" ; 
...
// 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_reg_grid'] == "all") 
   { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       ...
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['contr_array_resumo']))  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_orig']))
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_orig'] as $Cmp_clone => $Cmp_orig)
           {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby'] == "sc_free_group_by")
       {
           ...
           {
               $Cmp_orig = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
               if ($Cmp_orig == "fecha")
               {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby'] == "sc_free_group_by") 
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_cmp'] as $cmp => $sql)
           {
               $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_orig'][$cmp] : $cmp;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_ventas_por_vendedor_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_ventas_por_vendedor_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_ventas_por_vendedor_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_ventas_por_vendedor_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_ventas_por_vendedor_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_reg_grid']) . ";\r\n");
           }
           $gridWidthCorrection = '';
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_ventas_por_vendedor-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-ca5bb8f7\");\r\n");
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_ventas_por_vendedor_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'])
       {
 ...
 { 
       ...
       elseif ($this->NM_opcao == "print" || $this->Print_All)
       {
           ...
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_ventas_por_vendedor_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_ventas_por_vendedor_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_ventas_por_vendedor/grid_ventas_por_vendedor_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".grid_ventas_por_vendedor_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida']) ? "grid_ventas_por_vendedor_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['sv_dt_head'] = array();
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['sv_dt_head'][1] = $sc_data_cab1;
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['sv_dt_head']['fix'] = $nm_data_fixa;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf")
   { 
   ...
   { 
     ...
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf_vert']) 
     {
   ...
   {
       $this->Ini->Img_export_zip[] = $this->Ini->root . $this->Ini->path_imag_cab . "/scriptcase__NM__ico__NM__user_find_32.png";
       $img_NM_CAB_LOGOTIPO = "scriptcase__NM__ico__NM__user_find_32.png";
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['doc_word'] || $this->Img_embbed || $this->Ini->sc_export_ajax_img)
   {
       $loc_img_word = $this->Ini->root . $this->Ini->path_imag_cab . "/scriptcase__NM__ico__NM__user_find_32.png";
   ...
   {
       $img_NM_CAB_LOGOTIPO = $this->NM_raiz_img . $this->Ini->path_imag_cab . "/scriptcase__NM__ico__NM__user_find_32.png";
   }
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_ventas_por_vendedor__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_ventas_por_vendedor-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_label']) { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_f_total_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['exibe_seq'] == "S")) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_f_total_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".grid_ventas_por_vendedor_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_t_documento()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf")
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_cmp'] == $NM_cmp_class)
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ordem_label'] == "desc")
          {
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['t_documento'])) ? $this->New_label['t_documento'] : "Documento"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['labels']['t_documento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cliente'])) ? $this->New_label['cliente'] : "Vendedor"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['labels']['cliente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "Fecha"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['labels']['fecha'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['factura'])) ? $this->New_label['factura'] : "Factura"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['labels']['factura'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['f_subtotal'])) ? $this->New_label['f_subtotal'] : "Base"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['labels']['f_subtotal'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['f_valoriva'])) ? $this->New_label['f_valoriva'] : "IVA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['labels']['f_valoriva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['f_total'])) ? $this->New_label['f_total'] : "Neto"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['labels']['f_total'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_ventas_por_vendedor']['lig_edit'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ajax_nav'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['interativ_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['interativ_refresh'])
   {
       $this->refresh_interativ_search();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['interativ_refresh'] = false;
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_ventas_por_vendedor#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_grid_ventas_por_vendedor#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-ca5bb8f7\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['Config_Page_break_PDF'] = "N";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['Page_break_PDF'] = array();
       }
   }
   $this->SC_top       = array();
   $this->SC_bot       = array();
   ...
   $this->SC_bot[]     = "factura"; 
   $this->SC_top[]     = "factura"; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final'] == 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       $Nivel_gb = 1;
       $this->Tab_Nv_tree = array();
       $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_cmp']);
   ...
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_ventas_por_vendedor_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->arg_sum_factura = " = " . $this->Db->qstr($this->factura);
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final'] + 1; 
          ...
          {  
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
              ...
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
                      $sql_where .= (!empty($sql_where)) ? " and " : "";
              ...
              {
                  $cmp = $SC_lst_Gby[0];
                  if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby']][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['Page_break_PDF'][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
              }
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['exibe_seq'] == "S")) { 
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby'] . "_bot";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_grid'])
 ...
 function NM_grid_t_documento()
 {
      ...
      if (!isset($this->NM_cmp_hidden['t_documento']) || $this->NM_cmp_hidden['t_documento'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] && !empty($conteudo)) 
          { 
 ...
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_pdf'] == "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['exibe_seq'] != "S" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf")
       {
           $this->NM_colspan--; 
       }
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_t_documento_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   $tot_t_documento = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['t_documento'] : 0;
   ...
   { 
       ...
       if ($this->SC_tab_quebra > 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida_grid'])
       {
 ...
 function quebra_t_documento_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao_print'] == "print" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['exibe_seq'] != "S" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf")
       {
           $colspan--; 
       }
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['field_order'] as $Cada_cmp)
   {
 ...
 function quebra_cliente_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_cliente = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['cliente'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
 ...
 function quebra_fecha_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_fecha = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['fecha'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
 ...
 function quebra_factura_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_factura = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['factura'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
 ...
 function quebra_geral_sc_free_group_by_bot() 
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "pdf" && !$this->Print_All)
   {
      $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" .  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['tot_geral'][0] . "</H1></div>";
   }
   $tit_lin_sumariza      =  $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['tot_geral'][1] . ")";
   $tit_lin_sumariza_orig =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['tot_geral'][1] . ")";
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "f_subtotal" && (!isset($this->NM_cmp_hidden['f_subtotal']) || $this->NM_cmp_hidden['f_subtotal'] != "off"))
    {
      ...
      $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['tot_geral'][2] ; 
      nmgp_Form_Num_Val($conteudo, ".", ",", "0", "S", "2", "$", "V:3:3", "-"); 
    ...
    if ($Cada_cmp == "f_valoriva" && (!isset($this->NM_cmp_hidden['f_valoriva']) || $this->NM_cmp_hidden['f_valoriva'] != "off"))
    {
      ...
      $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['tot_geral'][3] ; 
      nmgp_Form_Num_Val($conteudo, ".", ",", "0", "S", "2", "$", "V:3:3", "-"); 
    ...
    if ($Cada_cmp == "f_total" && (!isset($this->NM_cmp_hidden['f_total']) || $this->NM_cmp_hidden['f_total'] != "off"))
    {
      ...
      $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['tot_geral'][4] ; 
      nmgp_Form_Num_Val($conteudo, ".", ",", "0", "S", "2", "$", "V:3:3", "-"); 
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ajax_nav'])
          {
      ...
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
              $UseAlias =  "N";
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Groupby_hide']))
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          $Tem_word_res = "s";
      ...
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          $Tem_xls_res = "s";
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          $Tem_xml_res = "s";
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          $Tem_csv_res = "s";
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $Tem_pdf_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_cmp']))
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['SC_Gb_Free_cmp']))
            { }
            else {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full)
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao_print'] != "print") 
      {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] == 50) ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] == 100) ? " selected" : "";
              $nm_saida->saida("           <option value=\"100\" " . $obj_sel . ">100</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] == 200) ? " selected" : "";
              $nm_saida->saida("           <option value=\"200\" " . $obj_sel . ">200</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] == 400) ? " selected" : "";
              $nm_saida->saida("           <option value=\"400\" " . $obj_sel . ">400</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] == 800) ? " selected" : "";
              $nm_saida->saida("           <option value=\"800\" " . $obj_sel . ">800</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] == 1600) ? " selected" : "";
              $nm_saida->saida("           <option value=\"1600\" " . $obj_sel . ">1600</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] == all) ? " selected" : "";
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['qt_lin_grid'];
              $Max_link   = 5;
   ...
   function nmgp_embbed_placeholder_bot()
   {
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field ], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field ], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field ]))) == 0)
                    {
                        $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campos_busca'][ $field ]));
                    }
                }
            }
        }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array('cliente', 'fecha', 'factura'))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
   ...
   function html_interativ_search()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['int_search_label']['cliente'] = (isset($this->New_label['cliente'])) ? $this->New_label['cliente'] : 'Vendedor';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['int_search_sql']['cliente']   = "t.nombres";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['int_search_label']['fecha'] = (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : 'Fecha';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['int_search_sql']['fecha']   = "f.fechaven";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['int_search_label']['factura'] = (isset($this->New_label['factura'])) ? $this->New_label['factura'] : 'Factura';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['int_search_sql']['factura']   = "concat(r.prefijo,'/',f.numfacven)";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['int_search_label']['t_documento'] = (isset($this->New_label['t_documento'])) ? $this->New_label['t_documento'] : 'Documento';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['int_search_sql']['t_documento']   = "t.documento";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['int_search_label']['f_subtotal'] = (isset($this->New_label['f_subtotal'])) ? $this->New_label['f_subtotal'] : 'Base';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['int_search_sql']['f_subtotal']   = "f.subtotal";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['int_search_label']['f_valoriva'] = (isset($this->New_label['f_valoriva'])) ? $this->New_label['f_valoriva'] : 'IVA';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['int_search_sql']['f_valoriva']   = "f.valoriva";
...
";
   ...
   function interativ_search_f_subtotal($bol_refin_use_modal)
   {
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['interativ_search']['f_subtotal'])) ? "" : "none";
     ...
     if(count($result) >=2)
     {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_subtotal'])) {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_subtotal']['min'] = $range_min;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_subtotal']['max'] = $range_max;
           $range_min_orig = $range_min;
           $range_max_orig = $range_max;
       }
       else {
           $range_min_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_subtotal']['min'];
           $range_max_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_subtotal']['max'];
       }
...
";
   ...
   function interativ_search_f_valoriva($bol_refin_use_modal)
   {
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['interativ_search']['f_valoriva'])) ? "" : "none";
     ...
     if(count($result) >=2)
     {
       ...
       $range_min = $range_min - ($range_min % 5);
       $range_max = $range_max - (($range_max - $range_min) % 5) + 5;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_valoriva'])) {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_valoriva']['min'] = $range_min;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_valoriva']['max'] = $range_max;
           $range_min_orig = $range_min;
           $range_max_orig = $range_max;
       }
       else {
           $range_min_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_valoriva']['min'];
           $range_max_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_valoriva']['max'];
       }
       $lin_obj  .= "   <div class='scGridRefinedSearchCampo'>";
               $range_min_formatado  = str_replace(",", ".", $range_min);
               $range_max_formatado  = str_replace(",", ".", $range_max);
...
";
   ...
   function interativ_search_f_total($bol_refin_use_modal)
   {
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['interativ_search']['f_total'])) ? "" : "none";
     ...
     if(count($result) >=2)
     {
       ...
       $range_min = $range_min - ($range_min % 5);
       $range_max = $range_max - (($range_max - $range_min) % 5) + 5;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_total'])) {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_total']['min'] = $range_min;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_total']['max'] = $range_max;
           $range_min_orig = $range_min;
           $range_max_orig = $range_max;
       }
       else {
           $range_min_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_total']['min'];
           $range_max_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['refin_slider_f_total']['max'];
       }
       $lin_obj  .= "   <div class='scGridRefinedSearchCampo'>";
               $range_min_formatado  = str_replace(",", ".", $range_min);
               $range_max_formatado  = str_replace(",", ".", $range_max);
...
//--- 
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_ventas_por_vendedor', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_ventas_por_vendedor\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_ventas_por_vendedor_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_ventas_por_vendedor']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_ventas_por_vendedor_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_por_vendedor']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_ventas_por_vendedor')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_ventas_por_vendedor', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
