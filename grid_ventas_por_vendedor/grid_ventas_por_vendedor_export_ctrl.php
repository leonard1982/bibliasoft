<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ventas_por_vendedor']['sc_process_barr'] = true;
require_once('../grid_ventas_por_vendedor/index.php');
unset($_SESSION['scriptcase']['grid_ventas_por_vendedor']['sc_process_barr']);
$ExportCtrl = new grid_ventas_por_vendedor_export_control;
$ExportCtrl->Export_barr();

class grid_ventas_por_vendedor_export_control
{
