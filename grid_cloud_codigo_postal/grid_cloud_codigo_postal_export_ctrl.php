<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cloud_codigo_postal']['sc_process_barr'] = true;
require_once('../grid_cloud_codigo_postal/index.php');
unset($_SESSION['scriptcase']['grid_cloud_codigo_postal']['sc_process_barr']);
$ExportCtrl = new grid_cloud_codigo_postal_export_control;
$ExportCtrl->Export_barr();

class grid_cloud_codigo_postal_export_control
{
