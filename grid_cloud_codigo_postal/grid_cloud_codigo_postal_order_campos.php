...
<?php
   ...
   $Ord_Cmp = new grid_cloud_codigo_postal_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cloud_codigo_postal_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idmuni"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["idmuni"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["idmuni"] : "Municipio";
   $tab_ger_campos['codigo_postal'] = "on";
   $tab_def_campos['codigo_postal'] = "codigo_postal";
   $tab_labels["codigo_postal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["codigo_postal"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["codigo_postal"] : "Codigo Postal";
   $tab_ger_campos['limite_norte'] = "on";
   $tab_def_campos['limite_norte'] = "limite_norte";
   $tab_labels["limite_norte"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["limite_norte"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["limite_norte"] : "Limite Norte";
   $tab_ger_campos['limite_sur'] = "on";
   $tab_def_campos['limite_sur'] = "limite_sur";
   $tab_labels["limite_sur"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["limite_sur"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["limite_sur"] : "Limite Sur";
   $tab_ger_campos['limite_este'] = "on";
   $tab_def_campos['limite_este'] = "limite_este";
   $tab_labels["limite_este"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["limite_este"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["limite_este"] : "Limite Este";
   $tab_ger_campos['limite_oeste'] = "on";
   $tab_def_campos['limite_oeste'] = "limite_oeste";
   $tab_labels["limite_oeste"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["limite_oeste"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["limite_oeste"] : "Limite Oeste";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['barrios_contenidos'] = "on";
   $tab_def_campos['barrios_contenidos'] = "barrios_contenidos";
   $tab_labels["barrios_contenidos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["barrios_contenidos"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['labels']["barrios_contenidos"] : "Barrios Contenidos";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cloud_codigo_postal_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cloud_codigo_postal']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
