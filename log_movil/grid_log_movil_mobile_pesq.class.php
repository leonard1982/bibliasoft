...
class grid_log_movil_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_log_movil_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_log_movil_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_log_movil_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idlog_movil')
      {
          $idlog_movil = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idlog_movil($idlog_movil);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_funcion')
      {
          $funcion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_funcion($funcion);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_idlog_movil($idlog_movil)
   {
      $idlog_movil = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idlog_movil);
      $idlog_movil = substr($this->Db->qstr($idlog_movil), 1, -1);
            $idlog_movil_look = substr($this->Db->qstr($idlog_movil), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idlog_movil from " . $this->Ini->nm_tabela . " where   CAST (idlog_movil AS TEXT)  like '%" . $idlog_movil . "%' order by idlog_movil"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idlog_movil from " . $this->Ini->nm_tabela . " where   CAST (idlog_movil AS VARCHAR)  like '%" . $idlog_movil . "%' order by idlog_movil"; 
      }
      else
      {
          $nm_comando = "select distinct idlog_movil from " . $this->Ini->nm_tabela . " where  idlog_movil like '%" . $idlog_movil . "%' order by idlog_movil"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_funcion($funcion)
   {
      $funcion = substr($this->Db->qstr($funcion), 1, -1);
            $funcion_look = substr($this->Db->qstr($funcion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct funcion from " . $this->Ini->nm_tabela . " where  funcion like '%" . $funcion . "%' order by funcion"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idlog_movil";$Nm_numeric[] = "idlog_movil";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>log_movil/grid_log_movil_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_log_movil_ajax_search.js"></script>
 <script type="text/javascript" src="grid_log_movil_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_log_movil_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_log_movil']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_log_movil']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idlog_movil_cond#NMF#' + search_get_sel_txt('SC_idlog_movil_cond') + '@NMF@';
  str_out += 'SC_idlog_movil#NMF#' + search_get_text('SC_idlog_movil') + '@NMF@';
  str_out += 'id_ac_idlog_movil#NMF#' + search_get_title('select2-id_ac_idlog_movil-container') + '@NMF@';
  str_out += 'SC_idlog_movil_input_2#NMF#' + search_get_text('SC_idlog_movil_input_2') + '@NMF@';
  str_out += 'SC_funcion_cond#NMF#' + search_get_sel_txt('SC_funcion_cond') + '@NMF@';
  str_out += 'SC_funcion#NMF#' + search_get_text('SC_funcion') + '@NMF@';
  str_out += 'id_ac_funcion#NMF#' + search_get_title('select2-id_ac_funcion-container') + '@NMF@';
  str_out += 'SC_log_cond#NMF#' + search_get_sel_txt('SC_log_cond') + '@NMF@';
  str_out += 'SC_log#NMF#' + search_get_text('SC_log') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-idlog_movil").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_idlog_movil",
      max_itens: "10",
   ...
   $("#SC_idlog_movil").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-funcion").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_funcion",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_funcion").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>LOG MOVIL</span></td>
...
<?php
   ...
   {
      global 
             $idlog_movil_cond, $idlog_movil, $idlog_movil_input_2, $idlog_movil_autocomp,
             $funcion_cond, $funcion, $funcion_autocomp,
             $log_cond, $log,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idlog_movil = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['idlog_movil']; 
          $idlog_movil_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['idlog_movil_input_2']; 
          $idlog_movil_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['idlog_movil_cond']; 
          $funcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['funcion']; 
          $funcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['funcion_cond']; 
          $log = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['log']; 
          $log_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['log_cond']; 
          $creado_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_dia']; 
          $creado_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_mes']; 
          $creado_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_ano']; 
          $creado_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_input_2_dia']; 
          $creado_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_input_2_mes']; 
          $creado_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_input_2_ano']; 
          $creado_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_hor']; 
          $creado_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_min']; 
          $creado_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_seg']; 
          $creado_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_input_2_hor']; 
          $creado_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_input_2_min']; 
          $creado_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_input_2_seg']; 
          $creado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['NM_operador']; 
      } 
      if (!isset($idlog_movil_cond) || empty($idlog_movil_cond))
      {
         $idlog_movil_cond = "gt";
      }
      if (!isset($funcion_cond) || empty($funcion_cond))
      {
         $funcion_cond = "qp";
      }
      if (!isset($log_cond) || empty($log_cond))
      {
         $log_cond = "qp";
      }
      ...
      $str_hide_idlog_movil = (in_array($idlog_movil_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_funcion = (in_array($funcion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_log = (in_array($log_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_creado = (in_array($creado_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_idlog_movil = ('bw' == $idlog_movil_cond) ? $display_aberto : $display_fechado;
      $str_display_funcion = ('bw' == $funcion_cond) ? $display_aberto : $display_fechado;
      $str_display_log = ('bw' == $log_cond) ? $display_aberto : $display_fechado;
      $str_display_creado = ('bw' == $creado_cond) ? $display_aberto : $display_fechado;

      if (!isset($idlog_movil) || $idlog_movil == "")
      {
          $idlog_movil = "";
      }
      if (isset($idlog_movil) && !empty($idlog_movil))
      {
         $tmp_pos = strpos($idlog_movil, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idlog_movil = substr($idlog_movil, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($funcion, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $funcion = substr($funcion, 0, $tmp_pos);
         }
      }
      if (!isset($log) || $log == "")
      {
...
?>
 ...
 $nmgp_tab_label .= "idlog_movil?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idlog_movil_cond" name="idlog_movil_cond" onChange="nm_campos_between(document.getElementById('id_vis_idlog_movil'), this, 'idlog_movil')">
       <OPTION value="gt" <?php if ("gt" == $idlog_movil_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idlog_movil_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idlog_movil_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idlog_movil_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_idlog_movil"  <?php echo $str_hide_idlog_movil?>><?php
      if ($idlog_movil != "")
      {
      $idlog_movil_look = substr($this->Db->qstr($idlog_movil), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($idlog_movil))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idlog_movil from " . $this->Ini->nm_tabela . " where idlog_movil = $idlog_movil_look order by idlog_movil"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idlog_movil from " . $this->Ini->nm_tabela . " where idlog_movil = $idlog_movil_look order by idlog_movil"; 
      ...
      if (isset($nmgp_def_dados[0][$idlog_movil]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idlog_movil];
      }
      else
      {
            nmgp_Form_Num_Val($idlog_movil, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idlog_movil;
      }
?>
<INPUT  type="text" id="SC_idlog_movil" name="idlog_movil" value="<?php echo NM_encode_input($idlog_movil) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idlog_movil" id="id_ac_idlog_movil" name="idlog_movil_autocomp"><?php if ('' !=  $idlog_movil) { ?><option value="<?php echo $idlog_movil ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_idlog_movil"  <?php echo $str_display_idlog_movil; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idlog_movil_input_2" name="idlog_movil_input_2" value="<?php echo NM_encode_input($idlog_movil_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
 ...
 $nmgp_tab_label .= "funcion?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_funcion_cond" name="funcion_cond" onChange="nm_campos_between(document.getElementById('id_vis_funcion'), this, 'funcion')">
       <OPTION value="qp" <?php if ("qp" == $funcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $funcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $funcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $funcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_funcion"  <?php echo $str_hide_funcion?>><?php
      if ($funcion != "")
      {
      $funcion_look = substr($this->Db->qstr($funcion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct funcion from " . $this->Ini->nm_tabela . " where funcion = '$funcion_look' order by funcion"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$funcion]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$funcion];
      }
      else
      {
          $sAutocompValue = $funcion;
      }
?>
<INPUT  type="text" id="SC_funcion" name="funcion" value="<?php echo NM_encode_input($funcion) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-funcion" id="id_ac_funcion" name="funcion_autocomp"><?php if ('' !=  $funcion) { ?><option value="<?php echo $funcion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_log_cond" name="log_cond" onChange="nm_campos_between(document.getElementById('id_vis_log'), this, 'log')">
       <OPTION value="qp" <?php if ("qp" == $log_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $log_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $log_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $log_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_log"  <?php echo $str_hide_log?>><INPUT  type="text" id="SC_log" name="log" value="<?php echo NM_encode_input($log) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_creado_cond" name="creado_cond" onChange="nm_campos_between(document.getElementById('id_vis_creado'), this, 'creado')">
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_creado_dia" name="creado_dia" value="<?php echo NM_encode_input($creado_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_creado_mes" name="creado_mes" value="<?php echo NM_encode_input($creado_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_creado_hor" name="creado_hor" value="<?php echo NM_encode_input($creado_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_creado_min" name="creado_min" value="<?php echo NM_encode_input($creado_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_creado_seg" name="creado_seg" value="<?php echo NM_encode_input($creado_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_creado_input_2_dia" name="creado_input_2_dia" value="<?php echo NM_encode_input($creado_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_creado_input_2_mes" name="creado_input_2_mes" value="<?php echo NM_encode_input($creado_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_creado_input_2_hor" name="creado_input_2_hor" value="<?php echo NM_encode_input($creado_input_2_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_creado_input_2_min" name="creado_input_2_min" value="<?php echo NM_encode_input($creado_input_2_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_creado_input_2_seg" name="creado_input_2_seg" value="<?php echo NM_encode_input($creado_input_2_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
<?php
   if (is_file("grid_log_movil_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_log_movil']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_log_movil']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idlog_movil_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idlog_movil'), document.F1.idlog_movil_cond, 'idlog_movil');
   document.F1.idlog_movil.value = "";
   document.F1.idlog_movil_autocomp.value = "";
   $('#select2-id_ac_idlog_movil-container').html('<?php echo $this->Val_init_idlog_movil['desc'] ?>');;
   document.F1.idlog_movil_input_2.value = "";
   document.F1.funcion_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_funcion'), document.F1.funcion_cond, 'funcion');
   document.F1.funcion.value = "";
   document.F1.funcion_autocomp.value = "";
   $('#select2-id_ac_funcion-container').html('<?php echo $this->Val_init_funcion['desc'] ?>');;
   document.F1.log_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_log'), document.F1.log_cond, 'log');
 ...
 {
    $('#SC_creado_dia').bind('change', function() {sc_grid_log_movil_valida_dia(this)});
    $('#SC_creado_hor').bind('change', function() {sc_grid_log_movil_valida_hora(this)});
    $('#SC_creado_input_2_dia').bind('change', function() {sc_grid_log_movil_valida_dia(this)});
    $('#SC_creado_input_2_hor').bind('change', function() {sc_grid_log_movil_valida_hora(this)});
    $('#SC_creado_input_2_mes').bind('change', function() {sc_grid_log_movil_valida_mes(this)});
    $('#SC_creado_input_2_min').bind('change', function() {sc_grid_log_movil_valida_min(this)});
    $('#SC_creado_input_2_seg').bind('change', function() {sc_grid_log_movil_valida_seg(this)});
    $('#SC_creado_mes').bind('change', function() {sc_grid_log_movil_valida_mes(this)});
    $('#SC_creado_min').bind('change', function() {sc_grid_log_movil_valida_min(this)});
    $('#SC_creado_seg').bind('change', function() {sc_grid_log_movil_valida_seg(this)});
 }
 function sc_grid_log_movil_valida_dia(obj)
 {
 ...
 function sc_grid_log_movil_valida_mes(obj)
 {
 ...
 function sc_grid_log_movil_valida_hora(obj)
 {
 ...
 function sc_grid_log_movil_valida_min(obj)
 {
 ...
 function sc_grid_log_movil_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv2/grid_log_movil";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idlog_movil_cond'] = 'cond';
      $tp_fields['SC_idlog_movil'] = 'text_aut';
      $tp_fields['id_ac_idlog_movil'] = 'select2_aut';
      $tp_fields['SC_idlog_movil_input_2'] = 'text';
      $tp_fields['SC_funcion_cond'] = 'cond';
      $tp_fields['SC_funcion'] = 'text_aut';
      $tp_fields['id_ac_funcion'] = 'select2_aut';
      $tp_fields['SC_log_cond'] = 'cond';
      $tp_fields['SC_log'] = 'text';
   ...
   {
      global $idlog_movil_cond, $idlog_movil, $idlog_movil_input_2, $idlog_movil_autocomp,
             $funcion_cond, $funcion, $funcion_autocomp,
             $log_cond, $log,
      ...
      if (!empty($idlog_movil_autocomp) && empty($idlog_movil))
      {
          $idlog_movil = $idlog_movil_autocomp;
      }
      if (!empty($funcion_autocomp) && empty($funcion))
      {
          $funcion = $funcion_autocomp;
      }
      $idlog_movil_cond_salva = $idlog_movil_cond; 
      if (!isset($idlog_movil_input_2) || $idlog_movil_input_2 == "")
      {
          $idlog_movil_input_2 = $idlog_movil;
      }
      $funcion_cond_salva = $funcion_cond; 
      if (!isset($funcion_input_2) || $funcion_input_2 == "")
      {
          $funcion_input_2 = $funcion;
      }
      $log_cond_salva = $log_cond; 
      if (!isset($log_input_2) || $log_input_2 == "")
      {
          $log_input_2 = $log;
      }
      ...
      if ($idlog_movil_cond != "in")
      {
          nm_limpa_numero($idlog_movil, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idlog_movil_cond != "in")
      {
          nm_limpa_numero($idlog_movil_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['idlog_movil'] = $idlog_movil; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['idlog_movil_input_2'] = $idlog_movil_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['idlog_movil_cond'] = $idlog_movil_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['funcion'] = $funcion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['funcion_cond'] = $funcion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['log'] = $log; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['log_cond'] = $log_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_dia'] = $creado_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_mes'] = $creado_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_ano'] = $creado_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_input_2_dia'] = $creado_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_input_2_mes'] = $creado_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_input_2_ano'] = $creado_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_hor'] = $creado_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_min'] = $creado_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_seg'] = $creado_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_input_2_hor'] = $creado_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_input_2_min'] = $creado_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_input_2_seg'] = $creado_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_cond'] = $creado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca'] = $Temp_Busca;
      }
      if ($idlog_movil_cond != "in" && $idlog_movil_cond != "bw" && !empty($idlog_movil) && !is_numeric($idlog_movil))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID";
      }
      if ($idlog_movil_cond == "bw" && ((!empty($idlog_movil) && !is_numeric($idlog_movil)) || (!empty($idlog_movil_input_2) && !is_numeric($idlog_movil_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idlog_movil'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['idlog_movil'] = $cmp1;
      }
      else
      {
          $cmp1 = $idlog_movil;
      ...
      $Conteudo = $idlog_movil_input_2;
      if (strtoupper($idlog_movil_cond) != "II" && strtoupper($idlog_movil_cond) != "QP" && strtoupper($idlog_movil_cond) != "NP" && strtoupper($idlog_movil_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idlog_movil_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($funcion != '') {
      $funcion_look = substr($this->Db->qstr($funcion), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['funcion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['funcion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['funcion'] = $funcion;
      }
      $Conteudo = $log;
      $this->cmp_formatado['log'] = $Conteudo;

      //----- $idlog_movil
      $this->Date_part = false;
      if (isset($idlog_movil) || $idlog_movil_cond == "nu" || $idlog_movil_cond == "nn" || $idlog_movil_cond == "ep" || $idlog_movil_cond == "ne")
      {
         $this->monta_condicao("idlog_movil", $idlog_movil_cond, $idlog_movil, $idlog_movil_input_2, "idlog_movil");
      }

      //----- $funcion
      $this->Date_part = false;
      if (isset($funcion) || $funcion_cond == "nu" || $funcion_cond == "nn" || $funcion_cond == "ep" || $funcion_cond == "ne")
      {
         $this->monta_condicao("funcion", $funcion_cond, $funcion, "", "funcion");
      }

      //----- $log
      $this->Date_part = false;
      if (isset($log) || $log_cond == "nu" || $log_cond == "nn" || $log_cond == "ep" || $log_cond == "ne")
      {
         $this->monta_condicao("log", $log_cond, $log, "", "log");
      }
      ...
      if ($creado_cond != "bi_TP")
      {
          ...
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "TIMESTAMP", $creado_cond, "", "datahora");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $creado = $val[0];
          $this->cmp_formatado['creado'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado'] = $val[0];
          ...
          if ($creado_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']['creado_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['cond_pesq'] .= $this->NM_operador;
