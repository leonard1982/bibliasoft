<?php
@session_start() ;
$_SESSION['scriptcase']['grid_log_movil']['sc_process_barr'] = true;
require_once('../log_movil/index.php');
unset($_SESSION['scriptcase']['grid_log_movil']['sc_process_barr']);
$ExportCtrl = new grid_log_movil_export_control;
$ExportCtrl->Export_barr();

class grid_log_movil_export_control
{
