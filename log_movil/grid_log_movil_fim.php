...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_log_movil"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_log_movil"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_log_movil']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_log_movil']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_log_movil']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_log_movil']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_log_movil']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_log_movil']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_log_movil']['embutida_filho'] as $ind => $sc_init)
          {
