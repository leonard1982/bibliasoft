 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idlog_movil_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idlog_movil'])) ? $this->New_label['idlog_movil'] : "ID"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idlog_movil_cond" name="idlog_movil_cond" onChange="nm_campos_between(document.getElementById('id_vis_idlog_movil'), this, 'idlog_movil')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idlog_movil" <?php echo $str_hide_idlog_movil?> valign="top">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idlog_movil" id="id_ac_idlog_movil" name="idlog_movil_autocomp"><?php if ('' !=  $idlog_movil) { ?><option value="<?php echo $idlog_movil ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idlog_movil"  <?php echo $str_display_idlog_movil; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idlog_movil_input_2" name="idlog_movil_input_2" value="<?php echo NM_encode_input($idlog_movil_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_funcion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['funcion'])) ? $this->New_label['funcion'] : "Funcion"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_funcion_cond" name="funcion_cond" onChange="nm_campos_between(document.getElementById('id_vis_funcion'), this, 'funcion')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_funcion" <?php echo $str_hide_funcion?> valign="top">
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-funcion" id="id_ac_funcion" name="funcion_autocomp"><?php if ('' !=  $funcion) { ?><option value="<?php echo $funcion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_log_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['log'])) ? $this->New_label['log'] : "Log"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_log_cond" name="log_cond" onChange="nm_campos_between(document.getElementById('id_vis_log'), this, 'log')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_log" <?php echo $str_hide_log?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
?>
<INPUT  type="text" id="SC_log" name="log" value="<?php echo NM_encode_input($log) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
      ...
      <TD id='SC_creado_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['creado'])) ? $this->New_label['creado'] : "Creado"; ?></TD>
     <TD class="scFilterFieldEven"> 
