...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['campos_busca']      = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['grid_pesq']         = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_movil']['Grid_search']       = "";
...
// 
       ...
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_log_movil']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_log_movil']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
