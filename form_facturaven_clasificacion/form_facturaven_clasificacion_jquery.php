...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_form_facturaven_clasificacion_id__onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_facturaven_clasificacion_id__onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_facturaven_clasificacion_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_descripcion_' + iSeqRow).bind('blur', function() { sc_form_facturaven_clasificacion_descripcion__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_facturaven_clasificacion_descripcion__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_facturaven_clasificacion_descripcion__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_facturaven_clasificacion_id__onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_clasificacion_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_facturaven_clasificacion_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_facturaven_clasificacion_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_facturaven_clasificacion_descripcion__onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_clasificacion_validate_descripcion_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_facturaven_clasificacion_descripcion__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_facturaven_clasificacion_descripcion__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_facturaven_clasificacion_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_facturaven_clasificacion')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
