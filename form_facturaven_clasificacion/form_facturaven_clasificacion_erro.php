...
$old_error_handler = set_error_handler("form_facturaven_clasificacion_scriptcase_error_handler");

function form_facturaven_clasificacion_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_facturaven_clasificacion']['contr_erro']) && $_SESSION['scriptcase']['form_facturaven_clasificacion']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_facturaven_clasificacion->contr_form_facturaven_clasificacion->Apl_com_erro = true;
            if ($inicial_form_facturaven_clasificacion->contr_form_facturaven_clasificacion->NM_ajax_flag)
            {
                $inicial_form_facturaven_clasificacion->contr_form_facturaven_clasificacion->NM_ajax_info['errList']['geral_form_facturaven_clasificacion'][] = $msg;
                return;
            }
            form_facturaven_clasificacion_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_facturaven_clasificacion_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_facturaven_clasificacion'])  && '' != $_SESSION['scriptcase']['error_icon']['form_facturaven_clasificacion'])  ? $_SESSION['scriptcase']['error_icon']['form_facturaven_clasificacion']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_facturaven_clasificacion']) && '' != $_SESSION['scriptcase']['error_span_title']['form_facturaven_clasificacion']) ? $_SESSION['scriptcase']['error_span_title']['form_facturaven_clasificacion'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_facturaven_clasificacion']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_facturaven_clasificacion']) ? $_SESSION['scriptcase']['error_icon_title']['form_facturaven_clasificacion'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_facturaven_clasificacion']['error_buffer'] .= ob_get_flush();
}
