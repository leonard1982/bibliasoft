...
<?php
   ...
   $Ord_Cmp = new grid_dev_com_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_dev_com_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["fecha"] : "Fecha Ingreso";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["cantidad"] : "Cantidad";
   ...
   $tab_labels["presentacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["presentacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["presentacion"] : "Presentación";
   $tab_ger_campos['idpro'] = "on";
   $tab_def_campos['idpro'] = "idpro";
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["idpro"] : "Producto";
   $tab_ger_campos['colores'] = "on";
   $tab_def_campos['colores'] = "colores";
   $tab_labels["colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["colores"] : "Color";
   $tab_ger_campos['tallas'] = "on";
   $tab_def_campos['tallas'] = "tallas";
   $tab_labels["tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["tallas"] : "Talla";
   $tab_ger_campos['sabor'] = "on";
   $tab_def_campos['sabor'] = "sabor";
   $tab_labels["sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["sabor"] : "Sabor";
   $tab_ger_campos['costo'] = "on";
   $tab_def_campos['costo'] = "costo";
   $tab_labels["costo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["costo"])) ? $_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["costo"] : "Costo";
   $tab_ger_campos['valorparcial'] = "on";
   $tab_def_campos['valorparcial'] = "valorparcial";
   $tab_labels["valorparcial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["valorparcial"])) ? $_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["valorparcial"] : "Valorparcial";
   $tab_ger_campos['devo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['devo'] = "devo";
   }
   else
   {
       $tab_def_campos['devo'] = "";
   }
   $tab_labels["devo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["devo"])) ? $_SESSION['sc_session'][$sc_init]['grid_dev_com']['labels']["devo"] : "Devolver";
   $tab_ger_campos['presentacion'] = "none";
   $tab_ger_campos['devo'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_dev_com']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_dev_com']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_dev_com_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_dev_com']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
