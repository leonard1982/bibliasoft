<?php
@session_start() ;
$_SESSION['scriptcase']['grid_dev_com']['sc_process_barr'] = true;
require_once('../grid_dev_com/index.php');
unset($_SESSION['scriptcase']['grid_dev_com']['sc_process_barr']);
$ExportCtrl = new grid_dev_com_export_control;
$ExportCtrl->Export_barr();

class grid_dev_com_export_control
{
