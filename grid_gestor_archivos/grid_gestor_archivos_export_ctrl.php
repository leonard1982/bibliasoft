<?php
@session_start() ;
$_SESSION['scriptcase']['grid_gestor_archivos']['sc_process_barr'] = true;
require_once('../grid_gestor_archivos/index.php');
unset($_SESSION['scriptcase']['grid_gestor_archivos']['sc_process_barr']);
$ExportCtrl = new grid_gestor_archivos_export_control;
$ExportCtrl->Export_barr();

class grid_gestor_archivos_export_control
{
