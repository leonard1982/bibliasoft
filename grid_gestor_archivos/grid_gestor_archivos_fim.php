...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_gestor_archivos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_gestor_archivos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_gestor_archivos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_gestor_archivos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos']['embutida_filho'] as $ind => $sc_init)
          {
