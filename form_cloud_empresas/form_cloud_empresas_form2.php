<div id="form_cloud_empresas_form2" style='<?php echo ($this->tabCssClass["form_cloud_empresas_form2"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_enviar_documento_online'][] = 'SI'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_smtp_tipo'][] = 'NO'; ?>
 <option  value="S" <?php  if ($this->smtp_tipo == "S") { echo " selected" ;} ?>>SSL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_smtp_tipo'][] = 'S'; ?>
 <option  value="T" <?php  if ($this->smtp_tipo == "T") { echo " selected" ;} ?>>TLS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_smtp_tipo'][] = 'T'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_enviar_datos_establecimiento'][] = 'SI'; ?>
