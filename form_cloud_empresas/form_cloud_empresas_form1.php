<div id="form_cloud_empresas_form1" style='<?php echo ($this->tabCssClass["form_cloud_empresas_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_proveedor'][] = 'HKA'; ?>
 <option  value="DATAICO" <?php  if ($this->proveedor == "DATAICO") { echo " selected" ;} ?>>DATAICO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_proveedor'][] = 'DATAICO'; ?>
 <option  value="TECH" <?php  if ($this->proveedor == "TECH") { echo " selected" ;} ?>>FACTURA TECH</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_proveedor'][] = 'TECH'; ?>
 <option  value="FACILWEB" <?php  if ($this->proveedor == "FACILWEB") { echo " selected" ;} ?>>FACILWEB</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_proveedor'][] = 'FACILWEB'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_modo'][] = 'DESARROLLO'; ?>
 <option  value="PRODUCCION" <?php  if ($this->modo == "PRODUCCION") { echo " selected" ;} ?>>PRODUCCIÓN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_modo'][] = 'PRODUCCION'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_enviar_dian'][] = '1'; ?>
 <option  value="0" <?php  if ($this->enviar_dian == "0") { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_enviar_dian'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_enviar_cliente'][] = '1'; ?>
 <option  value="0" <?php  if ($this->enviar_cliente == "0") { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_enviar_cliente'][] = '0'; ?>
 </select></span>
</span><?php  }?>
