...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'regimen':
      case 'observaciones':
        sc_exib_ocult_pag('form_cloud_empresas_mob_form0');
        break;
      case 'proveedor':
      case 'modo':
      case 'enviar_dian':
      ...
      case 'password_pruebas':
        sc_exib_ocult_pag('form_cloud_empresas_mob_form1');
        break;
      ...
      case 'enviar_datos_establecimiento':
        sc_exib_ocult_pag('form_cloud_empresas_mob_form2');
        break;
      case 'nombre_pc_red':
      ...
      case 'url_validar_licencia':
        sc_exib_ocult_pag('form_cloud_empresas_mob_form3');
        break;
    }
  }
...
function scHidePage(pageNo) {
	$("#id_form_cloud_empresas_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cloud_empresas_mob_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_editado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cloud_empresas_mob_validate_editado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_logo" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_cloud_empresas_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_cloud_empresas_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
