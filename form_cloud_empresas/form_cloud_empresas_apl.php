...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_cloud_empresas_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_cloud_empresas']['upload_field_info']['logo'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_cloud_empresas',
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_cloud_empresas']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_cloud_empresas'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cloud_empresas']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cloud_empresas']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_cloud_empresas') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cloud_empresas']['label'] = "Empresas";
      ...
      $_SESSION['scriptcase']['error_icon']['form_cloud_empresas']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_cloud_empresas'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['upload_field_ul_name'][$this->logo_ul_name]))
          {
              $this->NM_ajax_info['param']['logo_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['upload_field_ul_name'][$this->logo_ul_name];
          }
      ...
      elseif (isset($this->logo_ul_name) && '' != $this->logo_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['upload_field_ul_name'][$this->logo_ul_name]))
          {
              $this->logo_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['upload_field_ul_name'][$this->logo_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cloud_empresas']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_cloud_empresas'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_cloud_empresas'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_cloud_empresas", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_cloud_empresas_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_cloud_empresas_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_cloud_empresas/form_cloud_empresas_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_cloud_empresas_erro.class.php"); 
      }
      $this->Erro      = new form_cloud_empresas_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao']))
         { 
             if ($this->id_empresa != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_cloud_empresas']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_cloud_empresas']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_cloud_empresas']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_cloud_empresas.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_cloud_empresas_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_cloud_empresas"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_cloud_empresas']) || !is_array($this->NM_ajax_info['errList']['geral_form_cloud_empresas']))
              {
                  $this->NM_ajax_info['errList']['geral_form_cloud_empresas'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_cloud_empresas'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_smtp_puerto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->smtp_puerto, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Puerto; " ; 
                  if (!isset($Campos_Erros['smtp_puerto']))
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if (!$hasError && "" != $this->logo && "S" != $this->logo_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_cloud_empresas_doc_name.php';
                }
    ...
    function ValidateField_cantidaddecimales(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->cantidaddecimales, 1, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_tiempo_bouncer(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->tiempo_bouncer, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_empresa']['keyVal'] = form_cloud_empresas_pack_protect_string($this->nmgp_dados_form['id_empresa']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('SI') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("SI")));
$aLookup[] = array(form_cloud_empresas_pack_protect_string('NO') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_activo'][] = 'SI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_activo'][] = 'NO';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['activo']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('RESPONSABLE DE IVA') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("RESPONSABLE DE IVA")));
$aLookup[] = array(form_cloud_empresas_pack_protect_string('NO RESPONSABLE DE IVA') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("NO RESPONSABLE DE IVA")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_regimen'][] = 'RESPONSABLE DE IVA';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_regimen'][] = 'NO RESPONSABLE DE IVA';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['regimen']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('HKA') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("THE FACTORY")));
$aLookup[] = array(form_cloud_empresas_pack_protect_string('DATAICO') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("DATAICO")));
$aLookup[] = array(form_cloud_empresas_pack_protect_string('TECH') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("FACTURA TECH")));
$aLookup[] = array(form_cloud_empresas_pack_protect_string('FACILWEB') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("FACILWEB")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_proveedor'][] = 'HKA';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_proveedor'][] = 'DATAICO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_proveedor'][] = 'TECH';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_proveedor'][] = 'FACILWEB';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['proveedor']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('DESARROLLO') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("DESARROLLO")));
$aLookup[] = array(form_cloud_empresas_pack_protect_string('PRODUCCION') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("PRODUCCIÓN")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_modo'][] = 'DESARROLLO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_modo'][] = 'PRODUCCION';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"modo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['modo']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('1') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("SI")));
$aLookup[] = array(form_cloud_empresas_pack_protect_string('0') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_enviar_dian'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_enviar_dian'][] = '0';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['enviar_dian']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('1') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("SI")));
$aLookup[] = array(form_cloud_empresas_pack_protect_string('0') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_enviar_cliente'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_enviar_cliente'][] = '0';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['enviar_cliente']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('SI') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_enviar_documento_online'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['enviar_documento_online']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('NO') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("NO")));
$aLookup[] = array(form_cloud_empresas_pack_protect_string('S') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("SSL")));
$aLookup[] = array(form_cloud_empresas_pack_protect_string('T') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("TLS")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_smtp_tipo'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_smtp_tipo'][] = 'S';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_smtp_tipo'][] = 'T';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['smtp_tipo']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('SI') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_enviar_datos_establecimiento'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['enviar_datos_establecimiento']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('SI') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_sumarimpuestosdeldetalle'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['sumarimpuestosdeldetalle']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('SI') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_conf_auto_tercero'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['conf_auto_tercero']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('SI') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_no_validar_mail'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['no_validar_mail']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('SI') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_tomar_municipio_tns'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['tomar_municipio_tns']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('SI') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_validar_codcliente_tns'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['validar_codcliente_tns']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('SI') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_desactivar_xml_enlista'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['desactivar_xml_enlista']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cloud_empresas_pack_protect_string('SI') => str_replace('<', '&lt;',form_cloud_empresas_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['Lookup_validar_correo_enlinea'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['validar_correo_enlinea']['valList'][$i] = form_cloud_empresas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_url_validar_licencia($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id_empresa)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opcao'] = '';
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->id_empresa)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['logo_salva'] = array(
                      'row'     => '',
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['parms'] = "id_empresa?#?$this->id_empresa?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "insert" || $this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['parms'] = "id_empresa?#?$this->id_empresa?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['sub_dir'][0]  = "/logos/" . $this->nm_tira_formatacao_id_empresa($this->id_empresa) . "/";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out1_logo))
       {
        ...
        $this->initFormPages();
        include_once("form_cloud_empresas_form0.php");
        include_once("form_cloud_empresas_form1.php");
        include_once("form_cloud_empresas_form2.php");
        include_once("form_cloud_empresas_form3.php");
        $this->hideFormPages();
 }
...
<?php
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_cloud_empresas = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['total'] = $qt_geral_reg_form_cloud_empresas;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_cloud_empresas_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_cloud_empresas_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_cloud_empresas_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas']['masterValue']))
{
