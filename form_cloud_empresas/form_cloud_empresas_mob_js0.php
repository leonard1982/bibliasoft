<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="id_empresa" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_empresa']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_cloud_empresas_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas_mob']['where_detal']))
  {
?>  
...
{
    NovaJanela = window.open ("form_cloud_empresas_mob_help.php?nm_cod_campo=" + campo + "&language=<?php echo $this->Ini->path_lang . $this->Ini->str_lang?>&help_css=<?php echo '../_lib/css/' . $this->Ini->str_schema_all . '_form.css'; ?>", "ScriptCase", "height=100, width=300, resizable, scrollbars");
}
...
{
    document.getElementById('form_cloud_empresas_mob_form0').style.width='1px';
    document.getElementById('form_cloud_empresas_mob_form0').style.height='0px';
    document.getElementById('form_cloud_empresas_mob_form0').style.display='none';
    document.getElementById('form_cloud_empresas_mob_form0').style.overflow='scroll';
    document.getElementById('form_cloud_empresas_mob_form1').style.width='1px';
    document.getElementById('form_cloud_empresas_mob_form1').style.height='0px';
    document.getElementById('form_cloud_empresas_mob_form1').style.display='none';
    document.getElementById('form_cloud_empresas_mob_form1').style.overflow='scroll';
    document.getElementById('form_cloud_empresas_mob_form2').style.width='1px';
    document.getElementById('form_cloud_empresas_mob_form2').style.height='0px';
    document.getElementById('form_cloud_empresas_mob_form2').style.display='none';
    document.getElementById('form_cloud_empresas_mob_form2').style.overflow='scroll';
    document.getElementById('form_cloud_empresas_mob_form3').style.width='1px';
    document.getElementById('form_cloud_empresas_mob_form3').style.height='0px';
    document.getElementById('form_cloud_empresas_mob_form3').style.display='none';
    document.getElementById('form_cloud_empresas_mob_form3').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas_mob']['pdf_view']) {
?>
