<?php
@session_start() ;
$_SESSION['scriptcase']['grid_movimiento']['sc_process_barr'] = true;
require_once('../grid_movimiento/index.php');
unset($_SESSION['scriptcase']['grid_movimiento']['sc_process_barr']);
$ExportCtrl = new grid_movimiento_export_control;
$ExportCtrl->Export_barr();

class grid_movimiento_export_control
{
