...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_movimiento"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_movimiento"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_movimiento'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_movimiento']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_movimiento']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_movimiento']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_movimiento']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_movimiento']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_movimiento']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_movimiento']['embutida_filho'] as $ind => $sc_init)
          {
