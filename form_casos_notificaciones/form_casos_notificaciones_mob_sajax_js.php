  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_casos_notificaciones_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_casos_notificaciones_mob_form();
	}
  ...
  // ---------- Validate caso
  function do_ajax_form_casos_notificaciones_mob_validate_caso()
  {
    var nomeCampo_caso = "caso";
    var var_caso = scAjaxGetFieldHidden(nomeCampo_caso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_notificaciones_mob_validate_caso(var_caso, var_script_case_init, do_ajax_form_casos_notificaciones_mob_validate_caso_cb);
  } // do_ajax_form_casos_notificaciones_mob_validate_caso

  function do_ajax_form_casos_notificaciones_mob_validate_caso_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_notificaciones_mob_validate_caso_cb

  // ---------- Validate fecha_y_hora
  function do_ajax_form_casos_notificaciones_mob_validate_fecha_y_hora()
  {
    var nomeCampo_fecha_y_hora = "fecha_y_hora";
    var var_fecha_y_hora = scAjaxGetFieldHidden(nomeCampo_fecha_y_hora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_notificaciones_mob_validate_fecha_y_hora(var_fecha_y_hora, var_script_case_init, do_ajax_form_casos_notificaciones_mob_validate_fecha_y_hora_cb);
  } // do_ajax_form_casos_notificaciones_mob_validate_fecha_y_hora

  function do_ajax_form_casos_notificaciones_mob_validate_fecha_y_hora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_y_hora";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_notificaciones_mob_validate_fecha_y_hora_cb

  // ---------- Validate medio
  function do_ajax_form_casos_notificaciones_mob_validate_medio()
  {
    var nomeCampo_medio = "medio";
    var var_medio = scAjaxGetFieldSelect(nomeCampo_medio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_notificaciones_mob_validate_medio(var_medio, var_script_case_init, do_ajax_form_casos_notificaciones_mob_validate_medio_cb);
  } // do_ajax_form_casos_notificaciones_mob_validate_medio

  function do_ajax_form_casos_notificaciones_mob_validate_medio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_notificaciones_mob_validate_medio_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_casos_notificaciones_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_casos_notificaciones_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_caso = scAjaxGetFieldHidden("caso");
    var var_fecha_y_hora = scAjaxGetFieldHidden("fecha_y_hora");
    var var_medio = scAjaxGetFieldSelect("medio");
    var var_id_casos_notificacion = scAjaxGetFieldText("id_casos_notificacion");
    ...
    scAjaxProcOn();
    x_ajax_form_casos_notificaciones_mob_submit_form(var_caso, var_fecha_y_hora, var_medio, var_id_casos_notificacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_casos_notificaciones_mob_submit_form_cb);
  } // do_ajax_form_casos_notificaciones_mob_submit_form

  function do_ajax_form_casos_notificaciones_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("caso");
      scAjaxHideErrorDisplay("fecha_y_hora");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_casos_notificaciones_mob_submit_form_cb_after_alert);
  } // do_ajax_form_casos_notificaciones_mob_submit_form_cb
  function do_ajax_form_casos_notificaciones_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_casos_notificaciones_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_casos_notificaciones_mob_navigate_form()
  {
    perform_ajax_form_casos_notificaciones_mob_navigate_form();
  }

  function perform_ajax_form_casos_notificaciones_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("fecha_y_hora");
    scAjaxHideErrorDisplay("medio");
    var var_id_casos_notificacion = document.F2.id_casos_notificacion.value;
    ...
    scAjaxProcOn();
    x_ajax_form_casos_notificaciones_mob_navigate_form(var_id_casos_notificacion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_casos_notificaciones_mob_navigate_form_cb);
  } // do_ajax_form_casos_notificaciones_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_notificaciones_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_casos_notificaciones_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_casos_notificacion.value = scAjaxGetKeyValue("id_casos_notificacion");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_casos_notificaciones_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_casos_notificaciones_mob_navigate_form_cb
  function do_ajax_form_casos_notificaciones_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('medio');
...
{
?>
    do_ajax_form_casos_notificaciones_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_casos_notificaciones_mob_navigate_form_cb_after_alert
  function sc_hide_form_casos_notificaciones_mob_form()
  {
  ...
  ajax_field_list[0] = "caso";
  ajax_field_list[1] = "fecha_y_hora";
  ajax_field_list[2] = "medio";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "caso": {"label": "Caso", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_y_hora": {"label": "Fecha y Hora", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "caso": new Array(),
    "fecha_y_hora": new Array(),
    "medio": new Array()
  };
  ajax_field_mult["caso"][1] = "caso";
  ajax_field_mult["fecha_y_hora"][1] = "fecha_y_hora";
  ajax_field_mult["medio"][1] = "medio";

  var ajax_field_id = {
    "caso": new Array("hidden_field_label_caso", "hidden_field_data_caso"),
    "fecha_y_hora": new Array("hidden_field_label_fecha_y_hora", "hidden_field_data_fecha_y_hora"),
