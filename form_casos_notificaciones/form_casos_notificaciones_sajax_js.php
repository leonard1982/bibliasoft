  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_casos_notificaciones" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_casos_notificaciones_form();
	}
  ...
  // ---------- Validate caso
  function do_ajax_form_casos_notificaciones_validate_caso()
  {
    var nomeCampo_caso = "caso";
    var var_caso = scAjaxGetFieldHidden(nomeCampo_caso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_notificaciones_validate_caso(var_caso, var_script_case_init, do_ajax_form_casos_notificaciones_validate_caso_cb);
  } // do_ajax_form_casos_notificaciones_validate_caso

  function do_ajax_form_casos_notificaciones_validate_caso_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_notificaciones_validate_caso_cb

  // ---------- Validate fecha_y_hora
  function do_ajax_form_casos_notificaciones_validate_fecha_y_hora()
  {
    var nomeCampo_fecha_y_hora = "fecha_y_hora";
    var var_fecha_y_hora = scAjaxGetFieldHidden(nomeCampo_fecha_y_hora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_notificaciones_validate_fecha_y_hora(var_fecha_y_hora, var_script_case_init, do_ajax_form_casos_notificaciones_validate_fecha_y_hora_cb);
  } // do_ajax_form_casos_notificaciones_validate_fecha_y_hora

  function do_ajax_form_casos_notificaciones_validate_fecha_y_hora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_notificaciones_validate_fecha_y_hora_cb

  // ---------- Validate medio
  function do_ajax_form_casos_notificaciones_validate_medio()
  {
    var nomeCampo_medio = "medio";
    var var_medio = scAjaxGetFieldSelect(nomeCampo_medio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_notificaciones_validate_medio(var_medio, var_script_case_init, do_ajax_form_casos_notificaciones_validate_medio_cb);
  } // do_ajax_form_casos_notificaciones_validate_medio

  function do_ajax_form_casos_notificaciones_validate_medio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_notificaciones_validate_medio_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_casos_notificaciones_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_casos_notificaciones_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_casos_notificaciones_submit_form(var_caso, var_fecha_y_hora, var_medio, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_casos_notificaciones_submit_form_cb);
  } // do_ajax_form_casos_notificaciones_submit_form

  function do_ajax_form_casos_notificaciones_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_casos_notificaciones_submit_form_cb_after_alert);
  } // do_ajax_form_casos_notificaciones_submit_form_cb
  function do_ajax_form_casos_notificaciones_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_casos_notificaciones_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_casos_notificaciones_navigate_form()
  {
    perform_ajax_form_casos_notificaciones_navigate_form();
  }

  function perform_ajax_form_casos_notificaciones_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_casos_notificaciones_navigate_form(var_id_casos_notificacion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_casos_notificaciones_navigate_form_cb);
  } // do_ajax_form_casos_notificaciones_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_notificaciones']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_casos_notificaciones_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_casos_notificaciones_navigate_form_cb_after_alert);
  } // do_ajax_form_casos_notificaciones_navigate_form_cb
  function do_ajax_form_casos_notificaciones_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('medio');
...
{
?>
    do_ajax_form_casos_notificaciones_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_casos_notificaciones_navigate_form_cb_after_alert
  function sc_hide_form_casos_notificaciones_form()
  {
