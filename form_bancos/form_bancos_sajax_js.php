  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_bancos" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_bancos_validate_codigo_banco()
  {
    var nomeCampo_codigo_banco = "codigo_banco";
    var var_codigo_banco = scAjaxGetFieldText(nomeCampo_codigo_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bancos_validate_codigo_banco(var_codigo_banco, var_script_case_init, do_ajax_form_bancos_validate_codigo_banco_cb);
  } // do_ajax_form_bancos_validate_codigo_banco

  function do_ajax_form_bancos_validate_codigo_banco_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bancos_validate_codigo_banco_cb

  // ---------- Validate descripcion
  function do_ajax_form_bancos_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bancos_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_bancos_validate_descripcion_cb);
  } // do_ajax_form_bancos_validate_descripcion

  function do_ajax_form_bancos_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bancos_validate_descripcion_cb

  // ---------- Validate numero_cuenta
  function do_ajax_form_bancos_validate_numero_cuenta()
  {
    var nomeCampo_numero_cuenta = "numero_cuenta";
    var var_numero_cuenta = scAjaxGetFieldText(nomeCampo_numero_cuenta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bancos_validate_numero_cuenta(var_numero_cuenta, var_script_case_init, do_ajax_form_bancos_validate_numero_cuenta_cb);
  } // do_ajax_form_bancos_validate_numero_cuenta

  function do_ajax_form_bancos_validate_numero_cuenta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bancos_validate_numero_cuenta_cb

  // ---------- Validate comportamiento
  function do_ajax_form_bancos_validate_comportamiento()
  {
    var nomeCampo_comportamiento = "comportamiento";
    var var_comportamiento = scAjaxGetFieldCheckbox(nomeCampo_comportamiento, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bancos_validate_comportamiento(var_comportamiento, var_script_case_init, do_ajax_form_bancos_validate_comportamiento_cb);
  } // do_ajax_form_bancos_validate_comportamiento

  function do_ajax_form_bancos_validate_comportamiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bancos_validate_comportamiento_cb

  // ---------- Validate cajero
  function do_ajax_form_bancos_validate_cajero()
  {
    var nomeCampo_cajero = "cajero";
    var var_cajero = scAjaxGetFieldSelect(nomeCampo_cajero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bancos_validate_cajero(var_cajero, var_script_case_init, do_ajax_form_bancos_validate_cajero_cb);
  } // do_ajax_form_bancos_validate_cajero

  function do_ajax_form_bancos_validate_cajero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cajero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bancos_validate_cajero_cb

  // ---------- Validate entrada
  function do_ajax_form_bancos_validate_entrada()
  {
    var nomeCampo_entrada = "entrada";
    var var_entrada = scAjaxGetFieldHidden(nomeCampo_entrada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bancos_validate_entrada(var_entrada, var_script_case_init, do_ajax_form_bancos_validate_entrada_cb);
  } // do_ajax_form_bancos_validate_entrada

  function do_ajax_form_bancos_validate_entrada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "entrada";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bancos_validate_entrada_cb

  // ---------- Validate salida
  function do_ajax_form_bancos_validate_salida()
  {
    var nomeCampo_salida = "salida";
    var var_salida = scAjaxGetFieldHidden(nomeCampo_salida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bancos_validate_salida(var_salida, var_script_case_init, do_ajax_form_bancos_validate_salida_cb);
  } // do_ajax_form_bancos_validate_salida

  function do_ajax_form_bancos_validate_salida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "salida";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bancos_validate_salida_cb

  // ---------- Validate saldo
  function do_ajax_form_bancos_validate_saldo()
  {
    var nomeCampo_saldo = "saldo";
    var var_saldo = scAjaxGetFieldHidden(nomeCampo_saldo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bancos_validate_saldo(var_saldo, var_script_case_init, do_ajax_form_bancos_validate_saldo_cb);
  } // do_ajax_form_bancos_validate_saldo

  function do_ajax_form_bancos_validate_saldo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "saldo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bancos_validate_saldo_cb

  // ---------- Validate estado
  function do_ajax_form_bancos_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldHidden(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bancos_validate_estado(var_estado, var_script_case_init, do_ajax_form_bancos_validate_estado_cb);
  } // do_ajax_form_bancos_validate_estado

  function do_ajax_form_bancos_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bancos_validate_estado_cb

  // ---------- Validate puc
  function do_ajax_form_bancos_validate_puc()
  {
    var nomeCampo_puc = "puc";
    var var_puc = scAjaxGetFieldSelect(nomeCampo_puc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bancos_validate_puc(var_puc, var_script_case_init, do_ajax_form_bancos_validate_puc_cb);
  } // do_ajax_form_bancos_validate_puc

  function do_ajax_form_bancos_validate_puc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puc";
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_bancos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_bancos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_bancos_submit_form_cb_after_alert);
  } // do_ajax_form_bancos_submit_form_cb
  function do_ajax_form_bancos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_bancos_submit_form_cb_after_alert
  ...
  function perform_ajax_form_bancos_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_bancos_navigate_form(var_idcaja_vta, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_bancos_navigate_form_cb);
  } // do_ajax_form_bancos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_bancos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_bancos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_bancos_navigate_form_cb_after_alert);
  } // do_ajax_form_bancos_navigate_form_cb
...
{
?>
    do_ajax_form_bancos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_bancos_navigate_form_cb_after_alert
  function sc_hide_form_bancos_form()
  {
