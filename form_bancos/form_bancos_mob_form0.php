...
<span id="id_read_on_comportamiento" class="css_comportamiento_line" style="<?php echo $sStyleReadLab_comportamiento; ?>"><?php echo $this->form_format_readonly("comportamiento", $this->form_encode_input($comportamiento_look)); ?></span><span id="id_read_off_comportamiento" class="css_read_off_comportamiento css_comportamiento_line" style="<?php echo $sStyleReadInp_comportamiento; ?>"><?php echo "<div id=\"idAjaxCheckbox_comportamiento\" style=\"display: inline-block\" class=\"css_comportamiento_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_bancos_mob']['Lookup_comportamiento'][] = 'SI'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_puc_auxiliar_line" id="hidden_field_data_id_puc_auxiliar" style="<?php echo $sStyleHidden_id_puc_auxiliar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_puc_auxiliar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_puc_auxiliar_label" style=""><span id="id_label_id_puc_auxiliar"><?php echo $this->nm_new_label['id_puc_auxiliar']; ?></span></span><br>
...
<?php
   ...
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "SC_glo_par_gidcta*scingIdcta*scoutnm_evt_ret_edit*scindo_ajax_form_bancos_mob_lkpedt_refresh_id_puc_auxiliar*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_bancos_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_bancos_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "SC_glo_par_gidcta*scingIdcta*scoutnm_evt_ret_edit*scindo_ajax_form_bancos_mob_lkpedt_refresh_id_puc_auxiliar*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
