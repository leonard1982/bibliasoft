...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_bancos_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_bancos_mob_submit_form(var_codigo_banco, var_descripcion, var_numero_cuenta, var_comportamiento, var_cajero, var_entrada, var_salida, var_saldo, var_estado, var_puc, var_idcaja_vta, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_bancos_mob_submit_form_cb);
...
?>
  ...
  function perform_ajax_form_bancos_mob_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_bancos_mob_navigate_form(var_idcaja_vta, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_bancos_mob_navigate_form_cb);
