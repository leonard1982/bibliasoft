...
;
	...
	$vsql = "select 
			 ...
			 d.adicional,
			 d.adicional1,
			 concat(".$vtipocodigo.",' - ',p.nompro,if(d.unidadmayor='SI',if(p.unimay <> '',concat(' -- ',p.unimay),''),if(p.unimen <>'',concat(' -- ',p.unimen),''))) as nompro
			 from 
			 detalleventa d 
