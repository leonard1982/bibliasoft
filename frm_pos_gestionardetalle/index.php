...
;
	...
	$vsql = "select 
			 ...
			 d.adicional,
			 d.adicional1,
			 concat(".$vtipocodigo.",' - ',p.nompro,if(d.unidadmayor='SI',if(p.unimay <> '',concat(' -- ',(select um.descripcion_um from  unidades_medida um where um.codigo_um=p.unimay limit 1)),''),if(p.unimen <>'',concat(' -- ',(select um.descripcion_um from  unidades_medida um where um.codigo_um=p.unimen limit 1)),''))) as nompro
			 from 
			 detalleventa d 
