<?php
   include_once('frm_pos_gestionardetalle_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class frm_pos_gestionardetalle_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "frm_pos_gestionardetalle"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['frm_pos_gestionardetalle']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['frm_pos_gestionardetalle']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/frm_pos_gestionardetalle';
      ...
      $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['frm_pos_gestionardetalle']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['actual_lang']) || $_SESSION['scriptcase']['frm_pos_gestionardetalle']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['frm_pos_gestionardetalle']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("frm_pos_gestionardetalle_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["frm_pos_gestionardetalle"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["frm_pos_gestionardetalle"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "frm_pos_gestionardetalle_erro.class.php"); 
      $this->Erro = new frm_pos_gestionardetalle_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('frm_pos_gestionardetalle'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['frm_pos_gestionardetalle']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['frm_pos_gestionardetalle']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['frm_pos_gestionardetalle']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['frm_pos_gestionardetalle']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_conexao']) && $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_perfil']) && $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionardetalle']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class frm_pos_gestionardetalle_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new frm_pos_gestionardetalle_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_pos_gestionardetalle']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['frm_pos_gestionardetalle']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['frm_pos_gestionardetalle']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['frm_pos_gestionardetalle'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['frm_pos_gestionardetalle']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['frm_pos_gestionardetalle']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('frm_pos_gestionardetalle') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['frm_pos_gestionardetalle']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "frm_pos_gestionardetalle")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['frm_pos_gestionardetalle']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['frm_pos_gestionardetalle']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['frm_pos_gestionardetalle']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "frm_pos_gestionardetalle_erro.class.php"); 
      $this->Erro      = new frm_pos_gestionardetalle_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['frm_pos_gestionardetalle']['contr_erro'] = 'on';
  ...
  if(isset($_POST['insertaritem']))
{
	...
	$unidmaymen = $_POST['unidmaymen'];
	$vventaunidad = $_POST['ventaunidad'];
	$costo      = $_POST['costo'];
	$cantidad   = $_POST['cantidad'];
	$iva        = $_POST['iva'];
	$vsipropina = $_POST['sipropina'];
	$vval_propina = 0;
	
	$descuento  = $_POST['descuento'];
	$descuento2 = $_POST['descuento'];
	$descuento3 = 0;
	$vdesgeneral= "NO";
...
;
	...
	$vsql = "INSERT INTO detalleventa(numfac,idpro,unidadmayor,factor,idbod,costop,cantidad,valorunit,valorpar,iva,descuento,adicional,vencimiento,lote,serial_codbarra,adicional1,tbase,tneto)VALUES('".$idfactura."','".$articulo."','".$unidmaymen."','".$recmayamen."','".$idbodega."','".$costo."','".$cantidad."','".$precio."','".$vneto."','".$valoriva."','".$valordescuento."','".$tasaiva."' ".$vvence." ".$vlote." ".$vserial.",'".$descuento."','".$valorparcial."','".$vnetocondescuento."')";
	
	$vsql2 = "select max(iddet) from detalleventa";
    ...
    $this->Ini->sc_tem_trans_banco = false;
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vIddet[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->viddet[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vIddet = false;
          $this->vIddet_erro = $this->Db->ErrorMsg();
          $this->viddet = false;
          $this->viddet_erro = $this->Db->ErrorMsg();
      } 
;

		if(isset($this->viddet[0][0]))
		{
			$iddet = $this->viddet[0][0];
		}
...
;
	...
	if(isset($this->vinfodoc[0][0]))
	{
     ...
     $nm_select = "insert into log set usuario='".$this->sc_temp_gidtercero."',accion='AGREGAR',observaciones='EL USUARIO AGREGÓ UN ITEM A LA VENTA: ".$vnumdoc.", CLIENTE: ".$vnomcli.", FECHA VENTA: ".$vfechaven.", PRODUCTO: ".$vcodigoproducto." - ".$vnomproducto.", CANTIDAD: ".$cantidad.", TOTAL LINEA: ".$vneto."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
if(isset($_POST['iddetalle'])){
	...
	$cantidad  = $_POST['cantidadadicionar'];
	$idfactura = $_POST['idfactura'];
	...
	$vsql = "update 
			...
			set 
			cantidad=".$cantidad.", 
			valorpar=cantidad*valorunit,
			iva=round(valorpar-(valorpar/((adicional/100)+1)))
			where 
			iddet='".$iddet."'
			";
	...
	$this->fActualizarTotalFactura($idfactura);		
}
...
if(isset($_POST['iddet'])){
	...
	$vval_propina = 0;
      ...
      $nm_select = "select idpro, cantidad,numfac,valorpar from detalleventa where iddet='".$iddet."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vDatos = array();
      $this->vdatos = array();
...
;
	...
	{
		$idfactura = $this->vdatos[0][2];
		$vcantidad = $this->vdatos[0][1];
		$vnetolinea= $this->vdatos[0][3];
		
		
		$this->fGestionaStock($iddet,1);
	}
	
	$vsql2 = "select v.idfacven,c.nombres,v.total,concat(p.prefijo,'/',v.numfacven) as numero,v.fechaven from facturaven v left join terceros c on v.idcli=c.idtercero left join resdian p on v.resolucion=p.Idres where v.idfacven='".$idfactura."'";
...
;
	...
	if(!empty($vnumdoc))
	{
     ...
     $nm_select = "insert into log set usuario='".$this->sc_temp_gidtercero."',accion='ELIMINAR',observaciones='EL USUARIO ELIMINÓ UN ITEM A LA VENTA: ".$vnumdoc.", CLIENTE: ".$vnomcli.", FECHA VENTA: ".$vfechaven.", PRODUCTO: ".$vcodigoproducto." - ".$vnomproducto.", CANTIDAD: ".$vcantidad.", TOTAL LINEA: ".$vnetolinea."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
if(isset($_POST['vaciar'])){
    ...
    $idfactura = $_POST['idfactura'];
      ...
      $nm_select = "select iddet,cantidad,numfac,idpro from detalleventa where numfac='".$idfactura."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
	...
	if (strpos(strtolower($this->Ini->nm_tpbanco), "access") === false && !$this->Ini->sc_tem_trans_banco)
{
	...
	{
		$registros = count($this->vdatosdetalle );
		
		for($i=0;$i<$registros;$i++)
		{
			$this->viddet = $this->vdatosdetalle[$i][0];
			$vidpro = $this->vdatosdetalle[$i][3];

			$this->fGestionaStock($this->viddet,1);
		}
	
	}
		
	$vsql = "delete from detalleventa where numfac='".$idfactura."'";
	...
	$vsql2 = "update facturaven set total='0',valoriva='0', subtotal='0' where idfacven='".$idfactura."'";
...
;
	...
	if(isset($this->vdatos[0][0]))
	{
		for($i=0;$i<count($this->vdatos );$i++) {
			...
			$iddet      = $this->vdatos[$i][0];
			$cantidad   = $this->vdatos[$i][1];
			$valorunit  = $this->vdatos[$i][2];
			$valorpar   = $this->vdatos[$i][3];
			$iva        = $this->vdatos[$i][4];
			$descuento  = $this->vdatos[$i][5];
			...
			$registros[$contador] = [
				...
				"valorpar"  =>$neto,
				"iva"       =>$iva,
				"descuento" =>$adicional1,
				"adicional" =>$adicional,
				"adicional1"=>$adicional1,
				"descripcionproducto"=>$nompro
			];
...
if(isset($_POST["silote"]))
{
	$vcodigo   = $_POST["codigo"];
	$vidbodega = $_POST["idbodega"];
	...
	if(isset($_POST["cantidadmanual"]))
	{
		if($_POST["cantidadmanual"]>1)
		{
			$vcantidadmanual = $_POST["cantidadmanual"];
		}
	}
	
	$vsql1 = "select p.idprod,(select v.trifa from iva v where v.idiva=p.idiva) as tasaiva,p.costomen,p.unidmaymen,p.recmayamen,if('".$vunidad."'='MAYOR',p.preciofull,p.preciomen) as precio, concat(p.codigobar,' - ',p.nompro) as producto,if('".$vunidad."'='MAYOR',p.unimay,p.unimen) as unidad from productos p where p.codigobar='".$vcodigo."'";
	
	 
      $nm_select = $vsql1; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vidproducto = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          $nm_count = $SCrx->FieldCount();
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vidproducto[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vidproducto = false;
          $this->vidproducto_erro = $this->Db->ErrorMsg();
      } 
;
	
	
	
	if(isset($this->vidproducto[0][0]))
	{
		$tasaiva   = $this->vidproducto[0][1];
		$vcosto    = $this->vidproducto[0][2];
		$valoriva  = 0;
		$unidmaymen= $this->vidproducto[0][3];
		if($vunidad=="MAYOR")
		{
		$unidadmayor = "SI";
		}
		...
		$vfactor   = $this->vidproducto[0][4];
		$vprecio   = $this->vidproducto[0][5];
		$vprodesc  = $this->vidproducto[0][6];
		$vunidad2  = $this->vidproducto[0][7];
		$vcantidad = 0;
		$vcantidadtotal = 0;
		
		$vsql2 = "select v.idproducto,v.idbodega,v.fecha_vencimiento,v.lote,v.existencia,(select b.bodega from bodegas b where b.idbodega=v.idbodega) as bodega, TIMESTAMPDIFF(DAY, NOW(), v.fecha_vencimiento) AS dias_vencimiento from vencimiento_lote v where v.idproducto='".$this->vidproducto[0][0]."' and v.existencia>0";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vlotes[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->vlotes = false;
          $this->vlotes_erro = $this->Db->ErrorMsg();
      } 
;	
		
		$contador = 1;
		
		if(isset($this->vlotes[0][0]))
		{
			for($i=0;$i<count($this->vlotes );$i++)
			{
				$vidprod    = $this->vlotes[$i][0];
				$vidbodega2 = $this->vlotes[$i][1];
				$vfechavenc = $this->vlotes[$i][2];
				$vfechavenc2= date_create($vfechavenc);
				$vfechavenc2= date_format($vfechavenc2,"d/m/y");
				$vlote2     = $this->vlotes[$i][3];
				$vcantidad  = $this->vlotes[$i][4];
				$vbodega    = $this->vlotes[$i][5];
				$vdiasvence = $this->vlotes[$i][6];

					
				if($i==0)
				{
					echo "<table border='0' width='100%' style='font-size:14px;font-family:Arial;'>";
					
					echo "<tr>";
					echo "<th style='background-color: #34495e;padding:5px;color:white;'>PRODUCTO</th>";
					echo "<th style='background-color: #34495e;padding:5px;color:white;' colspan='8'>".$vprodesc."</th>";
					echo "</tr>";
					
					echo "<tr>";
					echo "<th style='background-color: #34495e;padding:5px;color:white;'></th>";
					echo "<th style='background-color: #34495e;padding:5px;color:white;'>BD</th>";
					echo "<th style='background-color: #34495e;padding:5px;color:white;'>VENCE</th>";
					
					if($vdiasvence<90)
					{
					echo "<th style='background-color: red;padding:5px;color:white;'>DIAS</th>";
					}
					else
					{
					echo "<th style='background-color: #34495e;padding:5px;color:white;'>DIAS</th>";
					}
					
					echo "<th style='background-color: #088A08;padding:5px;color:white;'>EXIST.</th>";
					echo "<th style='background-color: #34495e;padding:5px;color:white;'>UND</th>";
					echo "<th style='background-color: #088A08;padding:5px;color:white;'>PRECIO</th>";
					echo "<th style='background-color: #34495e;padding:5px;color:white;'>CANT.</th>";
					echo "</tr>";
				...
				echo "<input type='button' name='lotes' 
				onclick='fIrInput3(
						\"".$vcodigo."\",
						\"".$vidprod."\",
						\"".$vidbodega2."\",
				...
				echo "</td>";
				echo "<td>".$vbodega."</td>";
				echo "<td>".$vfechavenc2."</td>";
				
				if($vdiasvence<90)
					{
					echo "<td style='text-align:center;background-color: #f86c4f;color:white;'>".$vdiasvence."</td>";
					}
					else
					{
					echo "<td style='text-align:center;'>".$vdiasvence."</td>";
					}
				
				
				echo "<td style='text-align:right;'>";
				if($unidmaymen=="SI" and $vunidad=='MAYOR')
				{
					echo $vcantidad;
				}
				if($unidmaymen=="NO" and $vunidad=='MENOR')
				{
					echo $vcantidad;
				}
				if($unidmaymen=="SI" and $vunidad=='MENOR')
				{
				...
				echo "<td>".$vunidad2."</td>";
				echo "<td>".number_format($vprecio)."</td>";
				echo "<td><input id='inputcantidad".$i."' type='text' value='".$vcantidadmanual."'  style='text-align:center;' size='6'/></td>";
				echo "</tr>";
			...
			if($contador>1)
			{
				echo "<tr><td colspan='4' style='text-align:right;'><b>Cantidad Total:</b></td><td style='text-align:right;'><b>$vcantidadtotal</b></td><td colspan='3'></td></tr>";
				echo "</tbody>";
				echo "</table>";
			}
		}
...
if(isset($_POST["consultarlvs"]))
{
	$viddet2  = $_POST["viddet2"];
	
		
	$vsql2 = "select v.idpro,v.fechavenc,v.lote2,(select b.bodega from bodegas b where b.idbodega=v.idbod) as bodega,(select concat(p.codigobar,' -- ',p.nompro) from productos p where p.idprod=v.idpro) as producto from inventario v where v.iddetalle='".$viddet2."'";
...
;	
	...
	if(isset($this->vlotes[0][0]))
	{
		$vidprod    = $this->vlotes[0][0];
		$vfechavenc = $this->vlotes[0][1];
		$vfechavenc = date_create($vfechavenc);
		$vfechavenc = date_format($vfechavenc,"d/m/y");
		$vlote2     = $this->vlotes[0][2];
		$vbodega    = $this->vlotes[0][3];
		$vprodesc   = $this->vlotes[0][4];
		
		if(!empty($vlote2) or $vfechavenc >0)
		{
			...
			echo "<tr>";
			echo "<th style='background-color: #34495e;padding:5px;color:white;'>PRODUCTO</th>";
			echo "<th style='background-color: #34495e;padding:5px;color:white;' colspan='2'>".$vprodesc."</th>";
			echo "</tr>";
					
			echo "<tr>";
			echo "<th style='background-color: #34495e;padding:5px;color:white;'>BODEGA</th>";
			echo "<th style='background-color: #34495e;padding:5px;color:white;'>VENCE</th>";
			echo "</tr>";
		...
		{
			echo "<h3>El producto no maneja lote, fecha vencimiento y/o serial.</h3>";
		}
	}
}

if(isset($_POST["observacionitem"]))
{
	$viddet2  = $_POST["viddet2"];
	
		
	$vsql2 = "select obs from detalleventa where iddet='".$viddet2."'";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vObs[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vobs[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vObs = false;
          $this->vObs_erro = $this->Db->ErrorMsg();
          $this->vobs = false;
          $this->vobs_erro = $this->Db->ErrorMsg();
      } 
;	
	...
	if(isset($this->vobs[0][0]))
	{
		$vobservacion = $this->vobs[0][0];
		echo $vobservacion;
	}
}

if(isset($_POST["cambiarobservacionitem"]))
{
	$viddet2  = $_POST["viddet2"];
	$vobser   = $_POST["observaciones"];
	$vsql2 = "update detalleventa set obs='".$vobser."' where iddet='".$viddet2."'";
	echo $vsql2;
...
if(isset($_POST['agregaritemcalculadora']))
{
	...
	$vsql = "select p.preciomen, p.costomen,i.trifa,p.codigobar,p.nompro from productos p inner join iva i on p.idiva=i.idiva where p.idprod='".$idprod."'";
...
;
	if(isset($this->vdatos[0][0]))
	{
		$precio   = $this->vdatos[0][0];
		$costo    = $this->vdatos[0][1];
		$tasaiva  = $this->vdatos[0][2];
		$vcodigoproducto = $this->vdatos[0][3];
		$vnomproducto    = $this->vdatos[0][4];
		...
		{
			$valoriva = $valorparcial-($valorparcial/(($tasaiva/100)+1));
			$vbase    = $valorparcial/(($tasaiva/100)+1);
		}

		$vneto = $valorparcial;


		$vsql = "INSERT INTO detalleventa(numfac,idpro,unidadmayor,factor,idbod,costop,cantidad,valorunit,valorpar,iva,descuento,adicional,vencimiento,lote,serial_codbarra,adicional1,tbase,tneto)VALUES('".$idfactura."','".$idprod."','NO','0','".$idbodega."','".$costo."','".$cantidad."','".$precio."','".$vneto."','".$valoriva."','0','".$tasaiva."',NULL,NULL,'','0','".$vbase."','".$vneto."')";
...
;
		...
		$vsql3 = "select v.idfacven,c.nombres,v.total,concat(p.prefijo,'/',v.numfacven) as numero,v.fechaven from facturaven v left join terceros c on v.idcli=c.idtercero left join resdian p on v.resolucion=p.Idres where v.idfacven='".$idfactura."'";
...
;
		...
		if(isset($this->vinfodoc[0][0]))
		{
			...
			$vsql4 = "insert into log set usuario='".$this->sc_temp_gidtercero."',accion='AGREGAR',observaciones='EL USUARIO AGREGÓ UN ITEM A LA VENTA POR CALCULADORA: ".$vnumdoc.", CLIENTE: ".$vnomcli.", FECHA VENTA: ".$vfechaven.", PRODUCTO: ".$vcodigoproducto." - ".$vnomproducto.", CANTIDAD: ".$cantidad.", TOTAL LINEA: ".$vneto."'";
	...
	echo json_encode(array(
		...
		"accion"=>"insertar item calculadora",
		"iddetallefactura"=>$iddet,
		"idfactura"=>$idfactura
	));
}
...
$_SESSION['scriptcase']['frm_pos_gestionardetalle']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
function fActualizarTotalFactura($idfac, $sipropina=NO)
{
$_SESSION['scriptcase']['frm_pos_gestionardetalle']['contr_erro'] = 'on';
...
;
		...
		if(isset($vconfiguraciones[0][0]))
		{
			...
			{
				$vsql = "select coalesce(sum(d.tneto),0) from detalleventa d where d.numfac='".$idfac."'";
...
;
	...
	$vsqltotal = "update 
		  ...
		  porcentaje_propina_sugerida='".$vporcentaje_propina_sugerida."',
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_frm_pos_gestionardetalle($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['frm_pos_gestionardetalle']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "frm_pos_gestionardetalle") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['frm_pos_gestionardetalle']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['frm_pos_gestionardetalle']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['frm_pos_gestionardetalle']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
               $_SESSION['scriptcase']['frm_pos_gestionardetalle']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
           }
       }
   }
   ...
   if (isset($_POST["gidtercero"])) 
   {
       ...
       nm_limpa_str_frm_pos_gestionardetalle($_SESSION["gidtercero"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "frm_pos_gestionardetalle";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'frm_pos_gestionardetalle' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('frm_pos_gestionardetalle' == $sReferer || 'frm_pos_gestionardetalle_' == substr($sReferer, 0, 25))
       {
           $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'frm_pos_gestionardetalle')
   {
       $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionardetalle']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/frm_pos_gestionardetalle_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_frm_pos_gestionardetalle($cadapar[1]);
   ...
   $contr_frm_pos_gestionardetalle = new frm_pos_gestionardetalle_apl();
   $contr_frm_pos_gestionardetalle->controle();
//
   function nm_limpa_str_frm_pos_gestionardetalle(&$str)
   {
