...
class grid_importar_articulos_TNS_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_importar_articulos_TNS_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_importar_articulos_TNS_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_importar_articulos_TNS_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_importar_articulos_TNS_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_m_codigo')
      {
          $m_codigo = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_m_codigo($m_codigo);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_m_codigo($m_codigo)
   {
      $m_codigo = substr($this->Db->qstr($m_codigo), 1, -1);
            $m_codigo_look = substr($this->Db->qstr($m_codigo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct M.CODIGO from " . $this->Ini->nm_tabela . " where  M.CODIGO like '%" . $m_codigo . "%'"; 
   ...
   function lookup_ajax_descrip($descrip)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct CAST(SUBSTRING(M.DESCRIP FROM 1 FOR 90) AS CHAR(90)) from " . $this->Ini->nm_tabela . " where  CAST(SUBSTRING(M.DESCRIP FROM 1 FOR 90) AS CHAR(90)) like '%" . $descrip . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "m_factor";$Nm_numeric[] = "m_factorglb";$Nm_numeric[] = "s_precio1";$Nm_numeric[] = "s_precio2";$Nm_numeric[] = "s_precio3";$Nm_numeric[] = "s_preciom1";$Nm_numeric[] = "s_preciom2";$Nm_numeric[] = "s_preciom3";$Nm_numeric[] = "s_costo";$Nm_numeric[] = "m_factor";$Nm_numeric[] = "m_factorglb";$Nm_numeric[] = "s_precio1";$Nm_numeric[] = "s_precio2";$Nm_numeric[] = "s_precio3";$Nm_numeric[] = "s_preciom1";$Nm_numeric[] = "s_preciom2";$Nm_numeric[] = "s_preciom3";$Nm_numeric[] = "s_costo";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Importar Artículos de TNS</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_importar_articulos_TNS/grid_importar_articulos_TNS_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_importar_articulos_TNS_ajax_search.js"></script>
 <script type="text/javascript" src="grid_importar_articulos_TNS_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_m_codigo_cond#NMF#' + search_get_sel_txt('SC_m_codigo_cond') + '@NMF@';
  str_out += 'SC_m_codigo#NMF#' + search_get_text('SC_m_codigo') + '@NMF@';
  str_out += 'id_ac_m_codigo#NMF#' + search_get_text('id_ac_m_codigo') + '@NMF@';
   ...
   $("#id_ac_m_codigo").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_m_codigo",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_m_codigo").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_m_codigo").val( $(this).val() );
       }
     }
   });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Importar Artículos de TNS</span></td>
...
<?php
   ...
   {
      global 
             $m_codigo_cond, $m_codigo, $m_codigo_autocomp,
             $descrip_cond, $descrip, $descrip_autocomp,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_importar_articulos_TNS']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_importar_articulos_TNS']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_importar_articulos_TNS']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_importar_articulos_TNS", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $m_codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca']['m_codigo']; 
          $m_codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca']['m_codigo_cond']; 
          $descrip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca']['descrip']; 
          $descrip_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca']['descrip_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca']['NM_operador']; 
      } 
      if (!isset($m_codigo_cond) || empty($m_codigo_cond))
      {
         $m_codigo_cond = "qp";
      }
      ...
      $str_hide_m_codigo = (in_array($m_codigo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_descrip = (in_array($descrip_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($m_codigo) || $m_codigo == "")
      {
          $m_codigo = "";
      }
      if (isset($m_codigo) && !empty($m_codigo))
      {
         $tmp_pos = strpos($m_codigo, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $m_codigo = substr($m_codigo, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_importar_articulos_TNS_help.txt"))
   {
      $Arq_WebHelp = file("grid_importar_articulos_TNS_help.txt"); 
...
?>
 ...
 $SC_Label = (isset($this->New_label['m_codigo'])) ? $this->New_label['m_codigo'] : "CODIGO";
 $nmgp_tab_label .= "m_codigo?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br>
      <SELECT class="scFilterObjectOdd" id="SC_m_codigo_cond" name="m_codigo_cond" onChange="nm_campos_between(document.getElementById('id_vis_m_codigo'), this, 'm_codigo')">
       <OPTION value="qp" <?php if ("qp" == $m_codigo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $m_codigo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $m_codigo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $m_codigo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_m_codigo"  <?php echo $str_hide_m_codigo?>><?php
      $m_codigo_look = substr($this->Db->qstr($m_codigo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct M.CODIGO from " . $this->Ini->nm_tabela . " where M.CODIGO = '$m_codigo_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$m_codigo]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$m_codigo];
      }
      else
      {
          $sAutocompValue = $m_codigo;
      }
?>
<INPUT  type="text" id="SC_m_codigo" name="m_codigo" value="<?php echo NM_encode_input($m_codigo) ?>" size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_m_codigo" name="m_codigo_autocomp" size="25" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_descrip"  <?php echo $str_hide_descrip?>><?php
      $descrip_look = substr($this->Db->qstr($descrip), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct CAST(SUBSTRING(M.DESCRIP FROM 1 FOR 90) AS CHAR(90)) from " . $this->Ini->nm_tabela . " where CAST(SUBSTRING(M.DESCRIP FROM 1 FOR 90) AS CHAR(90)) = '$descrip_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_descrip" name="descrip" value="<?php echo NM_encode_input($descrip) ?>" size=50 alt="{datatype: 'text', maxLength: 90, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_descrip" name="descrip_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_importar_articulos_TNS']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_importar_articulos_TNS']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_importar_articulos_TNS']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_importar_articulos_TNS']['start'] == 'filter')
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_m_codigo'), document.F1.m_codigo_cond, 'm_codigo');
   document.F1.m_codigo.value = "";
   document.F1.m_codigo_autocomp.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "facilweb2019/grid_importar_articulos_TNS";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "facilweb2019/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
          $NM_patch .= "grid_importar_articulos_TNS/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_m_codigo_cond'] = 'cond';
      $tp_fields['SC_m_codigo'] = 'text_aut';
      $tp_fields['id_ac_m_codigo'] = 'text_aut';
   ...
   {
      global $m_codigo_cond, $m_codigo, $m_codigo_autocomp,
             $descrip_cond, $descrip, $descrip_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($m_codigo_autocomp) && empty($m_codigo))
      {
          $m_codigo = $m_codigo_autocomp;
      }
      if (!empty($descrip_autocomp) && empty($descrip))
      {
          $descrip = $descrip_autocomp;
      }
      $m_codigo_cond_salva = $m_codigo_cond; 
      if (!isset($m_codigo_input_2) || $m_codigo_input_2 == "")
      {
          $m_codigo_input_2 = $m_codigo;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca']['m_codigo'] = $m_codigo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca']['m_codigo_cond'] = $m_codigo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca']['descrip'] = $descrip; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca']['descrip_cond'] = $descrip_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['m_codigo'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['m_codigo'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['m_codigo'] = $m_codigo;
      }
      $descrip_look = substr($this->Db->qstr($descrip), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct CAST(SUBSTRING(M.DESCRIP FROM 1 FOR 90) AS CHAR(90)) from " . $this->Ini->nm_tabela . " where CAST(SUBSTRING(M.DESCRIP FROM 1 FOR 90) AS CHAR(90)) = '$descrip_look'"; 
      ...
      if (isset($m_codigo) || $m_codigo_cond == "nu" || $m_codigo_cond == "nn" || $m_codigo_cond == "ep" || $m_codigo_cond == "ne")
      {
         $this->monta_condicao("M.CODIGO", $m_codigo_cond, $m_codigo, "", "m_codigo");
      }
      ...
      {
         $this->monta_condicao("CAST(SUBSTRING(M.DESCRIP FROM 1 FOR 90) AS CHAR(90))", $descrip_cond, $descrip, "", "descrip");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['where_pesq_fast'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_importar_articulos_TNS']['fast_search']);
