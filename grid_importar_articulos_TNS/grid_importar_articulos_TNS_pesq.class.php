...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "m_factor";$Nm_numeric[] = "m_factorglb";$Nm_numeric[] = "s_precio1";$Nm_numeric[] = "s_precio2";$Nm_numeric[] = "s_precio3";$Nm_numeric[] = "s_preciom1";$Nm_numeric[] = "s_preciom2";$Nm_numeric[] = "s_preciom3";$Nm_numeric[] = "s_costo";
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['m_codigo'])) ? $this->New_label['m_codigo'] : "CODIGO"; ?></TD>
     <TD class="scFilterFieldOdd"> 
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_m_codigo" <?php echo $str_hide_m_codigo?> valign="top">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_m_codigo" name="m_codigo_autocomp" size="25" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['descrip'])) ? $this->New_label['descrip'] : "DESCRIP"; ?></TD>
     <TD class="scFilterFieldEven"> 
