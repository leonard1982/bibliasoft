...
class grid_seleccionar_contratos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_seleccionar_contratos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_seleccionar_contratos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_seleccionar_contratos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_ter_cont')
      {
          $id_ter_cont = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_ter_cont($id_ter_cont);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_id_ter_cont($id_ter_cont)
   {
      $id_ter_cont = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $id_ter_cont);
      $id_ter_cont = substr($this->Db->qstr($id_ter_cont), 1, -1);
            $id_ter_cont_look = substr($this->Db->qstr($id_ter_cont), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_ter_cont from " . $this->Ini->nm_tabela . " where   CAST (id_ter_cont AS TEXT)  like '%" . $id_ter_cont . "%' order by id_ter_cont"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct id_ter_cont from " . $this->Ini->nm_tabela . " where   CAST (id_ter_cont AS VARCHAR)  like '%" . $id_ter_cont . "%' order by id_ter_cont"; 
      }
      else
      {
          $nm_comando = "select distinct id_ter_cont from " . $this->Ini->nm_tabela . " where  id_ter_cont like '%" . $id_ter_cont . "%' order by id_ter_cont"; 
      }
      unset($cmp1,$cmp2);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha_contrato";$Nm_datas[] = "fecha_contrato";$Nm_datas[] = "fecha_inicio";$Nm_datas[] = "fecha_inicio";$Nm_datas[] = "fecha_corte";$Nm_datas[] = "fecha_corte";$Nm_datas[] = "creado";$Nm_datas[] = "creado";$Nm_datas[] = "editado";$Nm_datas[] = "editado";$Nm_datas[] = "fecha_limitepago";$Nm_datas[] = "fecha_limitepago";$Nm_datas[] = "fecha_ultimopago";$Nm_datas[] = "fecha_ultimopago";$Nm_datas[] = "fecha_factura";$Nm_datas[] = "fecha_factura";$Nm_numeric[] = "id_ter_cont";$Nm_numeric[] = "numero_contrato";$Nm_numeric[] = "usuario_crea";$Nm_numeric[] = "usuario_edita";$Nm_numeric[] = "valorpagado";$Nm_numeric[] = "saldoanterior";$Nm_numeric[] = "saldoactual";$Nm_numeric[] = "valor_ultimafactura";$Nm_numeric[] = "mensualidad";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_seleccionar_contratos/grid_seleccionar_contratos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_seleccionar_contratos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_seleccionar_contratos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_seleccionar_contratos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_seleccionar_contratos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_seleccionar_contratos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_ter_cont_cond#NMF#' + search_get_sel_txt('SC_id_ter_cont_cond') + '@NMF@';
  str_out += 'SC_id_ter_cont#NMF#' + search_get_text('SC_id_ter_cont') + '@NMF@';
  str_out += 'id_ac_id_ter_cont#NMF#' + search_get_title('select2-id_ac_id_ter_cont-container') + '@NMF@';
  str_out += 'SC_id_ter_cont_input_2#NMF#' + search_get_text('SC_id_ter_cont_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  ...
  $(".sc-ui-autocomp-id_ter_cont").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_id_ter_cont",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_id_ter_cont").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>SELECCIONAR CLIENTE/CONTRATO</span></td>
...
<?php
   ...
   {
      global 
             $id_ter_cont_cond, $id_ter_cont, $id_ter_cont_input_2, $id_ter_cont_autocomp,
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_seleccionar_contratos']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_seleccionar_contratos']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_seleccionar_contratos']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_seleccionar_contratos", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_ter_cont = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['id_ter_cont']; 
          $id_ter_cont_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['id_ter_cont_input_2']; 
          $id_ter_cont_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['id_ter_cont_cond']; 
          $numero_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['numero_contrato']; 
          $numero_contrato_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['numero_contrato_input_2']; 
          $numero_contrato_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['numero_contrato_cond']; 
          $cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['cliente']; 
          $cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['cliente_cond']; 
          $fecha_contrato_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_dia']; 
          $fecha_contrato_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_mes']; 
          $fecha_contrato_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_ano']; 
          $fecha_contrato_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_input_2_dia']; 
          $fecha_contrato_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_input_2_mes']; 
          $fecha_contrato_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_input_2_ano']; 
          $fecha_contrato_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_ter_cont_cond) || empty($id_ter_cont_cond))
      {
         $id_ter_cont_cond = "gt";
      }
      ...
      $str_hide_id_ter_cont = (in_array($id_ter_cont_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_id_ter_cont = ('bw' == $id_ter_cont_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($id_ter_cont) || $id_ter_cont == "")
      {
          $id_ter_cont = "";
      }
      if (isset($id_ter_cont) && !empty($id_ter_cont))
      {
         $tmp_pos = strpos($id_ter_cont, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_ter_cont = substr($id_ter_cont, 0, $tmp_pos);
         }
      }
...
?>
 ...
 $nmgp_tab_label .= "id_ter_cont?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_ter_cont_cond" name="id_ter_cont_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_ter_cont'), this, 'id_ter_cont')">
       <OPTION value="gt" <?php if ("gt" == $id_ter_cont_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_ter_cont_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_ter_cont_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_ter_cont_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_id_ter_cont"  <?php echo $str_hide_id_ter_cont?>><?php
      if ($id_ter_cont != "")
      {
      $id_ter_cont_look = substr($this->Db->qstr($id_ter_cont), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_ter_cont))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_ter_cont from " . $this->Ini->nm_tabela . " where id_ter_cont = $id_ter_cont_look order by id_ter_cont"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct id_ter_cont from " . $this->Ini->nm_tabela . " where id_ter_cont = $id_ter_cont_look order by id_ter_cont"; 
      ...
      if (isset($nmgp_def_dados[0][$id_ter_cont]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_ter_cont];
      }
      else
      {
            nmgp_Form_Num_Val($id_ter_cont, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $id_ter_cont;
      }
?>
<INPUT  type="text" id="SC_id_ter_cont" name="id_ter_cont" value="<?php echo NM_encode_input($id_ter_cont) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-id_ter_cont" id="id_ac_id_ter_cont" name="id_ter_cont_autocomp"><?php if ('' !=  $id_ter_cont) { ?><option value="<?php echo $id_ter_cont ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_id_ter_cont"  <?php echo $str_display_id_ter_cont; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_ter_cont_input_2" name="id_ter_cont_input_2" value="<?php echo NM_encode_input($id_ter_cont_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_numero_contrato_cond" name="numero_contrato_cond" onChange="nm_campos_between(document.getElementById('id_vis_numero_contrato'), this, 'numero_contrato')">
      ...
      <br><span id="id_hide_numero_contrato"  <?php echo $str_hide_numero_contrato?>><?php
      if ($numero_contrato != "")
      {
      $numero_contrato_look = substr($this->Db->qstr($numero_contrato), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<INPUT  type="text" id="SC_numero_contrato" name="numero_contrato" value="<?php echo NM_encode_input($numero_contrato) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-numero_contrato" id="id_ac_numero_contrato" name="numero_contrato_autocomp"><?php if ('' !=  $numero_contrato) { ?><option value="<?php echo $numero_contrato ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_numero_contrato"  <?php echo $str_display_numero_contrato; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_numero_contrato_input_2" name="numero_contrato_input_2" value="<?php echo NM_encode_input($numero_contrato_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cliente_cond" name="cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_cliente'), this, 'cliente')">
      ...
      <br><span id="id_hide_cliente"  <?php echo $str_hide_cliente?>><?php
      if ($cliente != "")
      {
      $cliente_look = substr($this->Db->qstr($cliente), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<INPUT  type="text" id="SC_cliente" name="cliente" value="<?php echo NM_encode_input($cliente) ?>"  size=14 alt="{datatype: 'text', maxLength: 14, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_fecha_contrato_cond" name="fecha_contrato_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha_contrato'), this, 'fecha_contrato')">
      ...
      <br><span id="id_hide_fecha_contrato"  <?php echo $str_hide_fecha_contrato?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_contrato_dia" name="fecha_contrato_dia" value="<?php echo NM_encode_input($fecha_contrato_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_contrato_mes" name="fecha_contrato_mes" value="<?php echo NM_encode_input($fecha_contrato_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_contrato_ano" name="fecha_contrato_ano" value="<?php echo NM_encode_input($fecha_contrato_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_fecha_contrato"  class="scFilterFieldFontEven">
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fecha_contrato"  <?php echo $str_display_fecha_contrato; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?> 
         <BR>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_contrato_input_2_dia" name="fecha_contrato_input_2_dia" value="<?php echo NM_encode_input($fecha_contrato_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_contrato_input_2_mes" name="fecha_contrato_input_2_mes" value="<?php echo NM_encode_input($fecha_contrato_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_contrato_input_2_ano" name="fecha_contrato_input_2_ano" value="<?php echo NM_encode_input($fecha_contrato_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
<?php
   if (is_file("grid_seleccionar_contratos_help.txt"))
   {
      $Arq_WebHelp = file("grid_seleccionar_contratos_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_seleccionar_contratos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_seleccionar_contratos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_ter_cont_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_ter_cont'), document.F1.id_ter_cont_cond, 'id_ter_cont');
   document.F1.id_ter_cont.value = "";
   document.F1.id_ter_cont_autocomp.value = "";
   $('#select2-id_ac_id_ter_cont-container').html('<?php echo $this->Val_init_id_ter_cont['desc'] ?>');;
   document.F1.id_ter_cont_input_2.value = "";
 ...
 {
    $('#SC_fecha_contrato_dia').bind('change', function() {sc_grid_seleccionar_contratos_valida_dia(this)});
    $('#SC_fecha_contrato_input_2_dia').bind('change', function() {sc_grid_seleccionar_contratos_valida_dia(this)});
    $('#SC_fecha_contrato_input_2_mes').bind('change', function() {sc_grid_seleccionar_contratos_valida_mes(this)});
    $('#SC_fecha_contrato_mes').bind('change', function() {sc_grid_seleccionar_contratos_valida_mes(this)});
 }
 function sc_grid_seleccionar_contratos_valida_dia(obj)
 {
 ...
 function sc_grid_seleccionar_contratos_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_seleccionar_contratos";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_seleccionar_contratos/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_ter_cont_cond'] = 'cond';
      $tp_fields['SC_id_ter_cont'] = 'text_aut';
      $tp_fields['id_ac_id_ter_cont'] = 'select2_aut';
      $tp_fields['SC_id_ter_cont_input_2'] = 'text';
   ...
   {
      global $id_ter_cont_cond, $id_ter_cont, $id_ter_cont_input_2, $id_ter_cont_autocomp,
             $numero_contrato_cond, $numero_contrato, $numero_contrato_input_2, $numero_contrato_autocomp,
             $cliente_cond, $cliente, $cliente_autocomp,
             $fecha_contrato_cond, $fecha_contrato, $fecha_contrato_dia, $fecha_contrato_mes, $fecha_contrato_ano, $fecha_contrato_input_2_dia, $fecha_contrato_input_2_mes, $fecha_contrato_input_2_ano, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($id_ter_cont_autocomp) && empty($id_ter_cont))
      {
          $id_ter_cont = $id_ter_cont_autocomp;
      }
      ...
      $id_ter_cont_cond_salva = $id_ter_cont_cond; 
      if (!isset($id_ter_cont_input_2) || $id_ter_cont_input_2 == "")
      {
          $id_ter_cont_input_2 = $id_ter_cont;
      }
      ...
      if ($id_ter_cont_cond != "in")
      {
          nm_limpa_numero($id_ter_cont, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_ter_cont_cond != "in")
      {
          nm_limpa_numero($id_ter_cont_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['id_ter_cont'] = $id_ter_cont; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['id_ter_cont_input_2'] = $id_ter_cont_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['id_ter_cont_cond'] = $id_ter_cont_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['numero_contrato'] = $numero_contrato; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['numero_contrato_input_2'] = $numero_contrato_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['numero_contrato_cond'] = $numero_contrato_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['cliente'] = $cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['cliente_cond'] = $cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_dia'] = $fecha_contrato_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_mes'] = $fecha_contrato_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_ano'] = $fecha_contrato_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_input_2_dia'] = $fecha_contrato_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_input_2_mes'] = $fecha_contrato_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_input_2_ano'] = $fecha_contrato_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_cond'] = $fecha_contrato_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca'] = $Temp_Busca;
      }
      if ($id_ter_cont_cond != "in" && $id_ter_cont_cond != "bw" && !empty($id_ter_cont) && !is_numeric($id_ter_cont))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Ter Cont";
      }
      if ($id_ter_cont_cond == "bw" && ((!empty($id_ter_cont) && !is_numeric($id_ter_cont)) || (!empty($id_ter_cont_input_2) && !is_numeric($id_ter_cont_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Ter Cont";
      }
      if ($numero_contrato_cond != "in" && $numero_contrato_cond != "bw" && !empty($numero_contrato) && !is_numeric($numero_contrato))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Contrato o código";
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_ter_cont'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_ter_cont'] = $cmp1;
      }
      else
      {
          $cmp1 = $id_ter_cont;
      ...
      $Conteudo = $id_ter_cont_input_2;
      if (strtoupper($id_ter_cont_cond) != "II" && strtoupper($id_ter_cont_cond) != "QP" && strtoupper($id_ter_cont_cond) != "NP" && strtoupper($id_ter_cont_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_ter_cont_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($numero_contrato != '') {
      $numero_contrato_look = substr($this->Db->qstr($numero_contrato), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
    ...
    if ($cliente != '') {
      ...
      if (isset($id_ter_cont) || $id_ter_cont_cond == "nu" || $id_ter_cont_cond == "nn" || $id_ter_cont_cond == "ep" || $id_ter_cont_cond == "ne")
      {
         $this->monta_condicao("id_ter_cont", $id_ter_cont_cond, $id_ter_cont, $id_ter_cont_input_2, "id_ter_cont");
      }
      ...
      if ($fecha_contrato_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato'] = $val[0];
          ...
          if ($fecha_contrato_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']['fecha_contrato_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seleccionar_contratos']['cond_pesq'] .= $this->NM_operador;
