<?php
@session_start() ;
$_SESSION['scriptcase']['grid_seleccionar_contratos']['sc_process_barr'] = true;
require_once('../grid_seleccionar_contratos/index.php');
unset($_SESSION['scriptcase']['grid_seleccionar_contratos']['sc_process_barr']);
$ExportCtrl = new grid_seleccionar_contratos_export_control;
$ExportCtrl->Export_barr();

class grid_seleccionar_contratos_export_control
{
