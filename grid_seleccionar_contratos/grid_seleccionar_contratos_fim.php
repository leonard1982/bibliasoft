...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_seleccionar_contratos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_seleccionar_contratos"]);
   }
