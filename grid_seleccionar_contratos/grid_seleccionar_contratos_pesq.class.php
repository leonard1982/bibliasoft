 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_id_ter_cont_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_ter_cont'])) ? $this->New_label['id_ter_cont'] : "Id Ter Cont"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_ter_cont_cond" name="id_ter_cont_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_ter_cont'), this, 'id_ter_cont')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_ter_cont" <?php echo $str_hide_id_ter_cont?> valign="top">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-id_ter_cont" id="id_ac_id_ter_cont" name="id_ter_cont_autocomp"><?php if ('' !=  $id_ter_cont) { ?><option value="<?php echo $id_ter_cont ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_ter_cont"  <?php echo $str_display_id_ter_cont; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_ter_cont_input_2" name="id_ter_cont_input_2" value="<?php echo NM_encode_input($id_ter_cont_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_numero_contrato_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['numero_contrato'])) ? $this->New_label['numero_contrato'] : "Contrato o código"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_numero_contrato_cond" name="numero_contrato_cond" onChange="nm_campos_between(document.getElementById('id_vis_numero_contrato'), this, 'numero_contrato')">
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-numero_contrato" id="id_ac_numero_contrato" name="numero_contrato_autocomp"><?php if ('' !=  $numero_contrato) { ?><option value="<?php echo $numero_contrato ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_numero_contrato"  <?php echo $str_display_numero_contrato; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_numero_contrato_input_2" name="numero_contrato_input_2" value="<?php echo NM_encode_input($numero_contrato_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_cliente_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cliente'])) ? $this->New_label['cliente'] : "Cliente o usuario"; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cliente" id="id_ac_cliente" name="cliente_autocomp"><?php if ('' !=  $cliente) { ?><option value="<?php echo $cliente ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_fecha_contrato_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fecha_contrato'])) ? $this->New_label['fecha_contrato'] : "Fecha Contrato"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_fecha_contrato_cond" name="fecha_contrato_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha_contrato'), this, 'fecha_contrato')">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_fecha_contrato"  <?php echo $str_display_fecha_contrato; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>
         <BR>
