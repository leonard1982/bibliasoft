<?php
//
class form_notas_270521_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_POST["gCupoilimitado"]) && isset($this->gCupoilimitado)) 
      {
          $_SESSION['gCupoilimitado'] = $this->gCupoilimitado;
      }
      ...
      if (isset($_POST["elped"]) && isset($this->elped)) 
      {
          $_SESSION['elped'] = $this->elped;
      }
      ...
      if (isset($_GET["gCupoilimitado"]) && isset($this->gCupoilimitado)) 
      {
          $_SESSION['gCupoilimitado'] = $this->gCupoilimitado;
      }
      ...
      if (isset($_GET["elped"]) && isset($this->elped)) 
      {
          $_SESSION['elped'] = $this->elped;
      }
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_notas_270521_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['form_detalle_notasDC_mob_script_case_init'] ]['form_detalle_notasDC_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['form_detalle_notasDC_mob_script_case_init'] ]['form_detalle_notasDC_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->gCupoilimitado) && isset($this->gcupoilimitado)) 
          {
              $this->gCupoilimitado = $this->gcupoilimitado;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_notas_270521_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_notas_270521_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_notas_270521_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_notas_270521_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_notas_270521_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_notas_270521_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_notas_270521_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_notas_270521_mob']['label'] = "Editar Nota";
      ...
      $_SESSION['scriptcase']['error_icon']['form_notas_270521_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_notas_270521_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_orig'] = " where id_fact>0";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_pesq'] = " where id_fact>0";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_notas_270521_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_notas_270521_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_notas_270521_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_notas_270521_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_notas_270521/form_notas_270521_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_notas_270521_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_notas_270521_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_notas_270521_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_notas_270521/form_notas_270521_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_notas_270521_mob_erro.class.php"); 
      }
      $this->Erro      = new form_notas_270521_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opcao']))
         { 
             if ($this->idfacven != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_notas_270521_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['imprimir'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['botoes']['imprimir'];
          $this->nmgp_botoes['Eliminar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['botoes']['Eliminar'];
          $this->nmgp_botoes['rc'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['botoes']['rc'];
          $this->nmgp_botoes['autorizar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['botoes']['autorizar'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['form_detalle_notasDC_mob_script_case_init'] ]['form_detalle_notasDC_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['form_detalle_notasDC_mob_script_case_init'] ]['form_detalle_notasDC_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['form_detalle_notasDC_mob_script_case_init'] ]['form_detalle_notasDC_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['form_detalle_notasDC_mob_script_case_init'] ]['form_detalle_notasDC_mob']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_detalle_notasDC_mob') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_detalle_notasDC_mob') . "/form_detalle_notasDC_mob_apl.php");
          $this->form_detalle_notasDC_mob = new form_detalle_notasDC_mob_apl;
      }
      ...
      {
      $_SESSION['scriptcase']['form_notas_270521_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_notas_270521_mob']['contr_erro'] = 'off'; 
      }
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_notas_270521_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_notas_270521_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_notas_270521_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_vendedor']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_vendedor'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_vendedor']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_vendedor'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_notas_270521_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_notas_270521_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_vendedor'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          if ('autocomp_num_fac' == $this->NM_ajax_opcao)
          {
              if (isset($_GET['term'])) {
                  $this->num_fac = ($_SESSION['scriptcase']['charset'] != "UTF-8") ? NM_utf8_decode(sc_convert_encoding($_GET['term'], $_SESSION['scriptcase']['charset'], 'UTF-8')) : $_GET['term'];
              } else {
                  $this->num_fac = '';
              }
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_num_fac']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_num_fac'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_num_fac']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_num_fac'] = array(); 
    }
   ...
   {
       $nm_comando = "SELECT idfacven, numfacven FROM facturaven WHERE (tipo= 'FV'  and resolucion = '$this->prefijo_fac') AND  CAST (numfacven AS TEXT)  LIKE '%" . substr($this->Db->qstr($this->num_fac), 1, -1) . "%'";
   }
   else
   {
       $nm_comando = "SELECT idfacven, numfacven FROM facturaven WHERE (tipo= 'FV'  and resolucion = '$this->prefijo_fac') AND numfacven LIKE '%" . substr($this->Db->qstr($this->num_fac), 1, -1) . "%'";
   }
   ...
   $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
   $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 20, 0))
   {
       while (!$rs->EOF) 
       { 
              $rs->fields[0] = str_replace(',', '.', $rs->fields[0]);
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_num_fac'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['tipo']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['tipo'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['resolucion']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->resolucion = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['resolucion'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['idcli']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idcli = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['idcli'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['observaciones']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->observaciones = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['observaciones'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['numfacven']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->numfacven = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['numfacven'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['pagada']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->pagada = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['pagada'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['fechaven']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fechaven = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['fechaven'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['fechavenc']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fechavenc = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['fechavenc'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['credito']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->credito = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['credito'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['pedido']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->pedido = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['pedido'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['asentada']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select']['asentada'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_notas_270521_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_notas_270521_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_notas_270521_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_notas_270521_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
include_once("form_notas_270521_mob_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->total) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_form']['total']))
          {
              $varloc_btn_php['total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_form']['total'];
          }
          if (!isset($this->idfacven) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_form']['idfacven']))
          {
              $varloc_btn_php['idfacven'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_form']['idfacven'];
          }
      }
      $nm_f_saida = "form_notas_270521_mob.php";
...
<?php
      ...
      {
          if (!isset($this->idcli) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_form']['idcli']))
          {
              $varloc_btn_php['idcli'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_form']['idcli'];
          }
          if (!isset($this->idcli) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_form']['idcli']))
          {
              $varloc_btn_php['idcli'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_form']['idcli'];
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_notas_270521_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_notas_270521_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_notas_270521_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_notas_270521_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if($this->tipo =='NC')
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_notas_270521_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_notas_270521_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_tipo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['php_cmp_required']['tipo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['php_cmp_required']['tipo'] == "on")
        { 
          $hasError = true;
    ...
    function ValidateField_resolucion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->resolucion == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['php_cmp_required']['resolucion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['php_cmp_required']['resolucion'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->resolucion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_resolucion']) && !in_array($this->resolucion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_resolucion']))
          {
              $hasError = true;
    ...
    function ValidateField_pedido(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->pedido) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_pedido']) && !in_array($this->pedido, $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_pedido']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_prefijo_fac(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->prefijo_fac) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_prefijo_fac']) && !in_array($this->prefijo_fac, $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_prefijo_fac']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_num_fac(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->num_fac) > 20) 
          { 
              $hasError = true;
              $Campos_Crit .= "FACTURA N°: " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['num_fac']))
              {
                  $Campos_Erros['num_fac'] = array();
              }
              $Campos_Erros['num_fac'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['num_fac'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
...
;
      ...
      $Teste_compara = $this->num_fac ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $Teste_critica = 0 ; 
          for ($x = 0; $x < mb_strlen($this->num_fac, $_SESSION['scriptcase']['charset']); $x++) 
          { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "FACTURA N°: " . $this->Ini->Nm_lang['lang_errm_ivch']; 
              if (!isset($Campos_Erros['num_fac']))
              {
                  $Campos_Erros['num_fac'] = array();
              }
              $Campos_Erros['num_fac'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
              if (!isset($this->NM_ajax_info['errList']['num_fac']) || !is_array($this->NM_ajax_info['errList']['num_fac']))
              {
                  $this->NM_ajax_info['errList']['num_fac'] = array();
              }
              $this->NM_ajax_info['errList']['num_fac'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_id_fact(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->id_fact, 20, 0, -0, 1.0E+20, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_idcli(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idcli == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['php_cmp_required']['idcli']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['php_cmp_required']['idcli'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idcli) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_idcli']) && !in_array($this->idcli, $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_idcli']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idcli']))
    ...
    function ValidateField_credito(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['php_cmp_required']['credito']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['php_cmp_required']['credito'] == "on")
        { 
          $hasError = true;
    ...
    function ValidateField_mot_nc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->mot_nc) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nc']) && !in_array($this->mot_nc, $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nc']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_mot_nd(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->mot_nd) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nd']) && !in_array($this->mot_nd, $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nd']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_nremision(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->nremision, 20, 0, -0, 1.0E+20, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_saldo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->saldo, 10, 2, -0, 999999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "; " ; 
                  if (!isset($Campos_Erros['saldo']))
    ...
    function ValidateField_retefuente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->retefuente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_retefuente']) && !in_array($this->retefuente, $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_retefuente']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cree(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cree) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_cree']) && !in_array($this->cree, $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_cree']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_reteica(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->reteica) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_reteica']) && !in_array($this->reteica, $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_reteica']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_reteiva(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->reteiva, 7, 3, -0, 9999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "RETEIVA %:; " ; 
                  if (!isset($Campos_Erros['reteiva']))
    ...
    function ValidateField_imconsumo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->imconsumo, 8, 2, -0, 9999999999, "N") == false)  
              { 
                  $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idfacven']['keyVal'] = form_notas_270521_mob_pack_protect_string($this->nmgp_dados_form['idfacven']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['form_detalle_notasDC_mob_script_case_init'] ]['form_detalle_notasDC_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['form_detalle_notasDC_mob_script_case_init'] ]['form_detalle_notasDC_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['form_detalle_notasDC_mob_script_case_init'] ]['form_detalle_notasDC_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['form_detalle_notasDC_mob_script_case_init'] ]['form_detalle_notasDC'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['form_detalle_notasDC_mob_script_case_init'] ]['form_detalle_notasDC_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['form_detalle_notasDC_mob_script_case_init'] ]['form_detalle_notasDC_mob']['total']);
              }
          }
...
$aLookup[] = array(form_notas_270521_mob_pack_protect_string('NC') => str_replace('<', '&lt;',form_notas_270521_mob_pack_protect_string("NOTA CRÉDITO")));
$aLookup[] = array(form_notas_270521_mob_pack_protect_string('ND') => str_replace('<', '&lt;',form_notas_270521_mob_pack_protect_string("NOTA DÉBITO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_tipo'][] = 'NC';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_tipo'][] = 'ND';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"tipo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['tipo']['valList'][$i] = form_notas_270521_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_resolucion']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_resolucion'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_resolucion']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_resolucion'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_resolucion'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['resolucion']['valList'][$i] = form_notas_270521_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_pedido']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_pedido'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_pedido']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_pedido'] = array(); 
}
$aLookup[] = array(form_notas_270521_mob_pack_protect_string('') => str_replace('<', '&lt;',form_notas_270521_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_pedido'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_pedido'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pedido']['valList'][$i] = form_notas_270521_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_notas_270521_mob_pack_protect_string('0') => str_replace('<', '&lt;',form_notas_270521_mob_pack_protect_string("No")));
$aLookup[] = array(form_notas_270521_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_notas_270521_mob_pack_protect_string("Sí")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_asentada'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_asentada'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['asentada']['valList'][$i] = form_notas_270521_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_prefijo_fac']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_prefijo_fac'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_prefijo_fac']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_prefijo_fac'] = array(); 
}
$aLookup[] = array(form_notas_270521_mob_pack_protect_string('') => str_replace('<', '&lt;',form_notas_270521_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_prefijo_fac'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_prefijo_fac'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['prefijo_fac']['valList'][$i] = form_notas_270521_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $nm_comando = "SELECT idfacven, numfacven FROM facturaven WHERE (tipo= 'FV'  and resolucion = '$this->prefijo_fac') AND idfacven = '" . substr($this->Db->qstr($this->num_fac), 1, -1) . "'";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_notas_270521_mob_pack_protect_string(NM_charset_to_utf8($this->num_fac))]) ? $aLookup[0][form_notas_270521_mob_pack_protect_string(NM_charset_to_utf8($this->num_fac))] : "";
          $this->NM_ajax_info['fldList']['num_fac_autocomp'] = array(
               'type'    => 'text',
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_idcli']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_idcli'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_idcli']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_idcli'] = array(); 
}
$aLookup[] = array(form_notas_270521_mob_pack_protect_string('') => str_replace('<', '&lt;',form_notas_270521_mob_pack_protect_string('Seleccione')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_idcli'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_idcli'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idcli']['valList'][$i] = form_notas_270521_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_notas_270521_mob_pack_protect_string(NM_charset_to_utf8($this->vendedor))]) ? $aLookup[0][form_notas_270521_mob_pack_protect_string(NM_charset_to_utf8($this->vendedor))] : "";
...
$aLookup[] = array(form_notas_270521_mob_pack_protect_string('2') => str_replace('<', '&lt;',form_notas_270521_mob_pack_protect_string("No")));
$aLookup[] = array(form_notas_270521_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_notas_270521_mob_pack_protect_string("Sí")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_credito'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_credito'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['credito']['valList'][$i] = form_notas_270521_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nc']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nc'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nc']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nc'] = array(); 
}
$aLookup[] = array(form_notas_270521_mob_pack_protect_string('') => str_replace('<', '&lt;',form_notas_270521_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nc'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nc'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['mot_nc']['valList'][$i] = form_notas_270521_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nd']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nd'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nd']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nd'] = array(); 
}
$aLookup[] = array(form_notas_270521_mob_pack_protect_string('') => str_replace('<', '&lt;',form_notas_270521_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nd'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_mot_nd'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['mot_nd']['valList'][$i] = form_notas_270521_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_retefuente']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_retefuente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_retefuente']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_retefuente'] = array(); 
}
$aLookup[] = array(form_notas_270521_mob_pack_protect_string('0.000') => str_replace('<', '&lt;',form_notas_270521_mob_pack_protect_string('%')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_retefuente'][] = '0.000';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $rs->fields[0] = (strpos(strtolower($rs->fields[0]), "e")) ? (float)$rs->fields[0] : $rs->fields[0];
              $rs->fields[0] = (string)$rs->fields[0];
              $aLookup[] = array(form_notas_270521_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_notas_270521_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_retefuente'][] = $rs->fields[0];
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['retefuente']['valList'][$i] = form_notas_270521_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_cree']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_cree'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_cree']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_cree'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $rs->fields[0] = (string)$rs->fields[0];
              $aLookup[] = array(form_notas_270521_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_notas_270521_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_cree'][] = $rs->fields[0];
              $nmgp_def_dados .= $rs->fields[0] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $rs->MoveNext() ; 
       } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cree']['valList'][$i] = form_notas_270521_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_reteica']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_reteica'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_reteica']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_reteica'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $rs->fields[0] = (string)$rs->fields[0];
              $aLookup[] = array(form_notas_270521_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_notas_270521_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['Lookup_reteica'][] = $rs->fields[0];
              $nmgp_def_dados .= $rs->fields[0] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $rs->MoveNext() ; 
       } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['reteica']['valList'][$i] = form_notas_270521_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_detalle($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
$_SESSION['scriptcase']['form_notas_270521_mob']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_notas_270521_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['parms'] = "idfacven?#?$this->idfacven?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_form_notas_270521_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['total'] = $qt_geral_reg_form_notas_270521_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idfacven))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_notas_270521_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'] > $qt_geral_reg_form_notas_270521_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'] = $qt_geral_reg_form_notas_270521_mob; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_notas_270521_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'] < $qt_geral_reg_form_notas_270521_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['reg_start'] + 1;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
;
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_select = "select * from detalleventa where numfac=$vIdFV"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_select = "select * from detalleventa where numfac=$vIdFV"; 
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->dt_dtv[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->dt_dtv = false;
          $this->dt_dtv_erro = $this->Db->ErrorMsg();
      } 
;
		if(isset($this->dt_dtv[0][0]))
			{
			foreach($this->dt_dtv  as $ads)
				{
				$i=$i+1;
				if($ads[28]=='DEV')
					{
      ...
      $nm_select = "select idgrup from productos where idprod=$idproducto"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->d_grup = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->d_grup[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->d_grup = false;
          $this->d_grup_erro = $this->Db->ErrorMsg();
      } 
;
					if(isset($this->d_grup[0][0]))
						{
						if($this->d_grup[0][0]==1)
							{
							$vGrupo=1;
							}
						else
      ...
      $nm_select = "select stockmen from productos where idprod=$idproducto"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->dt_pr = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->dt_pr[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->dt_pr = false;
          $this->dt_pr_erro = $this->Db->ErrorMsg();
      } 
;
							if(isset($this->dt_pr[0][0]))
								{
								$existencia=$this->dt_pr[0][0];
								}
							else
								{
								$existencia=0;
							...
							$facto=$ads[5];
							$cant=$ads[8];
							if($unimay=='NO' and $facto>0)
								{
								$aux=$cant/$facto;
								$cant=round($aux, 3);
								
								
     $nm_select ="INSERT inventario SET fecha='$fec', cantidad=$cant, idpro=$idproducto, costo=$ads[7], valorparcial=$ads[10]-$ads[12], idbod=$ads[6], tipo=1, detalle='Devolución en Venta NC', idmov=1, nufacvta=$vIdFV, iddetalle=$ads[0], colores=$ads[16], tallas=$ads[17], sabor=$ads[18], idped=0"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
      ...
      ;
								...
								$sql="UPDATE productos SET stockmen = ($existencia+$cant) WHERE idprod=$idproducto";
     ...
     $nm_select ="INSERT inventario SET fecha='$fec', cantidad=$cant, idpro=$idproducto,costo=$ads[7], valorparcial=$ads[10]-$ads[12], idbod=$ads[6], tipo=1, detalle='Devolución en Venta NC', idmov=1, nufacvta=$vIdFV, iddetalle=$ads[0], colores=$ads[16], tallas=$ads[17], sabor=$ads[18], idped=0"; 
      ...
      ;
								...
								$sql1="UPDATE productos SET stockmen = ($existencia+$cant) WHERE idprod=$idproducto";
...
;
     ...
     $nm_select ="UPDATE facturaven set saldo=$this->total +$vSaldoF, pagada='AB' where idfacven=$vIdFacinter"; 
      ...
      $nm_select = "select idinv from inventario where  nufacvta=$vIdFV"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->dat_inv = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->dat_inv[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->dat_inv = false;
          $this->dat_inv_erro = $this->Db->ErrorMsg();
      } 
;
			if(isset($this->dat_inv [0][0]))
				{
				
     $nm_select ="DELETE FROM inventario WHERE nufacvta=$vIdFV"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$this->nm_formatar_campos('idfacven', 'fechaven', 'id_fact', 'total', 'asentada', 'idcli', 'tipo');
...
$modificado_vendedor = $this->vendedor;
$modificado_dircliente = $this->dircliente;
$this->nm_formatar_campos('prefijo_fac', 'num_fac', 'idcli', 'fechavenc', 'retefuente', 'reteiva', 'reteica', 'direccion', 'vendedor', 'dircliente');
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_notas_270521_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter_form'] . " and (id_fact>0) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_notas_270521_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['total'] = $qt_geral_reg_form_notas_270521_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_notas_270521_mob_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_notas_270521_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_notas_270521_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC_mob']['reg_start'] = "";
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC_mob']['total']);
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_notas_270521_mob']['retorno_edit'] = "";
   }
