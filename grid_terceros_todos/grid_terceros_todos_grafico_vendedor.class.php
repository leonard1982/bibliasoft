...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['contr_label_graf']['loatiende']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['contr_label_graf']['loatiende']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['contr_label_graf']['loatiende'];
      }
   }
