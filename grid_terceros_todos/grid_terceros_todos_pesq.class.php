...
class grid_terceros_todos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_terceros_todos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_terceros_todos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_terceros_todos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_nombres($nombres)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombres from " . $this->Ini->nm_tabela . " where  nombres like '%" . $nombres . "%' order by nombres"; 
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      {
          $nm_comando = str_replace($nm_cada_col, $nm_nova_col, $nm_comando); 
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_terceros_todos/grid_terceros_todos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_terceros_todos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_terceros_todos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_terceros_todos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_terceros_todos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_terceros_todos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_documento_input_2#NMF#' + search_get_text('SC_documento_input_2') + '@NMF@';
  ...
  str_out += 'SC_nombres_input_2#NMF#' + search_get_text('SC_nombres_input_2') + '@NMF@';
  str_out += 'SC_loatiende_cond#NMF#' + search_get_sel_txt('SC_loatiende_cond') + '@NMF@';
  str_out += 'SC_loatiende#NMF#' + search_get_select('SC_loatiende') + '@NMF@';
  str_out += 'SC_estado_cond#NMF#' + search_get_sel_txt('SC_estado_cond') + '@NMF@';
  str_out += 'SC_estado#NMF#' + search_get_select('SC_estado') + '@NMF@';
  str_out += 'SC_clasificacion_clientes_cond#NMF#' + search_get_sel_txt('SC_clasificacion_clientes_cond') + '@NMF@';
  str_out += 'SC_clasificacion_clientes#NMF#' + search_get_select('SC_clasificacion_clientes') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Terceros</span></td>
...
<?php
   ...
   {
      global 
             $documento_cond, $documento, $documento_input_2, $documento_autocomp,
             $nombres_cond, $nombres, $nombres_input_2, $nombres_autocomp,
             $loatiende_cond, $loatiende,
             $estado_cond, $estado,
             $clasificacion_clientes_cond, $clasificacion_clientes,
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $documento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['documento']; 
          $documento_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['documento_input_2']; 
          $documento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['documento_cond']; 
          $nombres = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['nombres']; 
          $nombres_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['nombres_input_2']; 
          $nombres_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['nombres_cond']; 
          $loatiende = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['loatiende']; 
          $loatiende_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['loatiende_cond']; 
          $estado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['estado']; 
          $estado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['estado_cond']; 
          $clasificacion_clientes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['clasificacion_clientes']; 
          $clasificacion_clientes_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['clasificacion_clientes_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($loatiende_cond) || empty($loatiende_cond))
      {
         $loatiende_cond = "eq";
      }
      ...
      if (!isset($clasificacion_clientes_cond) || empty($clasificacion_clientes_cond))
      {
         $clasificacion_clientes_cond = "eq";
      }
      ...
      $str_hide_loatiende = (in_array($loatiende_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_estado = (in_array($estado_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_clasificacion_clientes = (in_array($clasificacion_clientes_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_loatiende = ('bw' == $loatiende_cond) ? $display_aberto : $display_fechado;
      $str_display_estado = ('bw' == $estado_cond) ? $display_aberto : $display_fechado;
      $str_display_clasificacion_clientes = ('bw' == $clasificacion_clientes_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($loatiende) || $loatiende == "")
      {
          $loatiende = "";
      }
      if (isset($loatiende) && !empty($loatiende))
      {
      ...
      if (!isset($clasificacion_clientes) || $clasificacion_clientes == "")
      {
          $clasificacion_clientes = "";
      }
      if (isset($clasificacion_clientes) && !empty($clasificacion_clientes))
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_documento_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['documento'])) ? $this->New_label['documento'] : "Cédula/Nit"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_documento_cond" name="documento_cond" onChange="nm_campos_between(document.getElementById('id_vis_documento'), this, 'documento')">
       ...
       <OPTION value="df" <?php if ("df" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="ge" <?php if ("ge" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr_equl'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="le" <?php if ("le" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less_equl'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
       <OPTION value="in" <?php if ("in" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw_sevr'] ?></OPTION>
       <OPTION value="ne" <?php if ("ne" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_nempty'] ?></OPTION>
       <OPTION value="nu" <?php if ("nu" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_null'] ?></OPTION>
       <OPTION value="nn" <?php if ("nn" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_nnul'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-documento" id="id_ac_documento" name="documento_autocomp"><?php if ('' !=  $documento) { ?><option value="<?php echo $documento ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_documento"  <?php echo $str_display_documento; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_documento_input_2" name="documento_input_2" value="<?php echo NM_encode_input($documento_input_2) ?>"    size="300" class="sc-js-input scFilterObjectOdd">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nombres_cond" name="nombres_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombres'), this, 'nombres')">
       ...
       <OPTION value="df" <?php if ("df" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="ge" <?php if ("ge" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr_equl'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="le" <?php if ("le" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less_equl'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
       <OPTION value="in" <?php if ("in" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw_sevr'] ?></OPTION>
       <OPTION value="ne" <?php if ("ne" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_nempty'] ?></OPTION>
       <OPTION value="nu" <?php if ("nu" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_null'] ?></OPTION>
       <OPTION value="nn" <?php if ("nn" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_nnul'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      $nombres_look = substr($this->Db->qstr($nombres), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombres from " . $this->Ini->nm_tabela . " where nombres = '$nombres_look' order by nombres"; 
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      {
          $nm_comando = str_replace($nm_cada_col, $nm_nova_col, $nm_comando); 
      }
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-nombres" id="id_ac_nombres" name="nombres_autocomp"><?php if ('' !=  $nombres) { ?><option value="<?php echo $nombres ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_nombres"  <?php echo $str_display_nombres; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_nombres_input_2" name="nombres_input_2" value="<?php echo NM_encode_input($nombres_input_2) ?>"    size="300" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_loatiende_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['loatiende'])) ? $this->New_label['loatiende'] : "Lo Atiende"; ?></TD>
      
      <INPUT type="hidden" id="SC_loatiende_cond" name="loatiende_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_loatiende" <?php echo $str_hide_loatiende?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['loatiende'])) ? $this->New_label['loatiende'] : "Lo Atiende";
 $nmgp_tab_label .= "loatiende?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $loatiende_look = substr($this->Db->qstr($loatiende), 1, -1); 
      $nmgp_def_dados = "" ; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['psq_check_ret']['loatiende'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['psq_check_ret']['loatiende'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_loatiende">
      <SELECT class="scFilterObjectOdd" id="SC_loatiende" name="loatiende"  size="1">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $loatiende)
            {
                    $loatiende_sel = ($nm_opc_cod === $loatiende) ? "selected" : "";
            }
            else
            {
               $loatiende_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $loatiende_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "select distinct estado from " . $this->Ini->nm_tabela . " order by estado"; 
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      {
          $nm_comando = str_replace($nm_cada_col, $nm_nova_col, $nm_comando); 
      }
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['psq_check_ret']['estado'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['psq_check_ret']['estado'][] = trim($rs->fields[0]);
...
?>
      ...
      <TD id='SC_clasificacion_clientes_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['clasificacion_clientes'])) ? $this->New_label['clasificacion_clientes'] : "Clasificación Clientes"; ?></TD>
      
      <INPUT type="hidden" id="SC_clasificacion_clientes_cond" name="clasificacion_clientes_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_clasificacion_clientes" <?php echo $str_hide_clasificacion_clientes?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['clasificacion_clientes'])) ? $this->New_label['clasificacion_clientes'] : "Clasificación Clientes";
 $nmgp_tab_label .= "clasificacion_clientes?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $clasificacion_clientes_look = substr($this->Db->qstr($clasificacion_clientes), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT idclasificacion_cliente, nombre  FROM clasificacion_clientes  ORDER BY nombre"; 
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      {
          $nm_comando = str_replace($nm_cada_col, $nm_nova_col, $nm_comando); 
      }
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['psq_check_ret']['clasificacion_clientes'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['psq_check_ret']['clasificacion_clientes'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_clasificacion_clientes">
      <SELECT class="scFilterObjectOdd" id="SC_clasificacion_clientes" name="clasificacion_clientes"  size="1">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            list($nm_opc_val, $nm_opc_cod, $nm_opc_sel) = $temp_bug_list;
            if ($nm_opc_cod == "@ ") {$nm_opc_cod = trim($nm_opc_cod); }
            if ("" != $clasificacion_clientes)
            {
                    $clasificacion_clientes_sel = ($nm_opc_cod === $clasificacion_clientes) ? "selected" : "";
            }
            else
            {
               $clasificacion_clientes_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $clasificacion_clientes_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
   if (is_file("grid_terceros_todos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_todos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_todos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.documento_input_2.value = "";
   ...
   document.F1.nombres_input_2.value = "";
   document.F1.loatiende_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_loatiende'), document.F1.loatiende_cond, 'loatiende');
   document.F1.loatiende.value = "";
   ...
   document.F1.clasificacion_clientes_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_clasificacion_clientes'), document.F1.clasificacion_clientes_cond, 'clasificacion_clientes');
   document.F1.clasificacion_clientes.value = "";
   Sc_carga_select2('all');
 }
 function Sc_carga_select2(Field)
 {
    if (Field == 'all' || Field == 'loatiende') {
       Sc_carga_select2_loatiende();
    }
    if (Field == 'all' || Field == 'clasificacion_clientes') {
       Sc_carga_select2_clasificacion_clientes();
    }
    if (Field == 'all' || Field == 'estado') {
       Sc_carga_select2_estado();
    }
 }
 function Sc_carga_select2_loatiende()
 {
  $("#SC_loatiende").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
 ...
 function Sc_carga_select2_clasificacion_clientes()
 {
  $("#SC_clasificacion_clientes").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['where_orig']))
      {
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_documento_input_2'] = 'text';
      $tp_fields['SC_nombres_cond'] = 'cond';
      $tp_fields['SC_nombres'] = 'text_aut';
      $tp_fields['id_ac_nombres'] = 'select2_aut';
      $tp_fields['SC_nombres_input_2'] = 'text';
      $tp_fields['SC_loatiende_cond'] = 'cond';
      $tp_fields['SC_loatiende'] = 'select';
      $tp_fields['SC_estado_cond'] = 'cond';
      $tp_fields['SC_estado'] = 'select';
      $tp_fields['SC_clasificacion_clientes_cond'] = 'cond';
      $tp_fields['SC_clasificacion_clientes'] = 'select';
   ...
   {
      global $documento_cond, $documento, $documento_input_2, $documento_autocomp,
             $nombres_cond, $nombres, $nombres_input_2, $nombres_autocomp,
             $loatiende_cond, $loatiende,
             $estado_cond, $estado,
             $clasificacion_clientes_cond, $clasificacion_clientes, $nmgp_tab_label;
      ...
      $loatiende_cond_salva = $loatiende_cond; 
      if (!isset($loatiende_input_2) || $loatiende_input_2 == "")
      {
          $loatiende_input_2 = $loatiende;
      }
      ...
      $clasificacion_clientes_cond_salva = $clasificacion_clientes_cond; 
      if (!isset($clasificacion_clientes_input_2) || $clasificacion_clientes_input_2 == "")
      {
          $clasificacion_clientes_input_2 = $clasificacion_clientes;
      }
      $tmp_pos = strpos($loatiende, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $loatiende;
          ...
          $L_lookup = substr($loatiende, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['psq_check_ret']['loatiende'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Lo Atiende : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($estado, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $estado;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['psq_check_ret']['estado'])) {
      ...
      $tmp_pos = strpos($clasificacion_clientes, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $clasificacion_clientes;
      }
      else {
          $L_lookup = substr($clasificacion_clientes, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['psq_check_ret']['clasificacion_clientes'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Clasificación Clientes : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['documento'] = $documento; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['documento_input_2'] = $documento_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['documento_cond'] = $documento_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['nombres'] = $nombres; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['nombres_input_2'] = $nombres_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['nombres_cond'] = $nombres_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['loatiende'] = $loatiende; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['loatiende_cond'] = $loatiende_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['estado'] = $estado; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['estado_cond'] = $estado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['clasificacion_clientes'] = $clasificacion_clientes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['clasificacion_clientes_cond'] = $clasificacion_clientes_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($documento != '') {
      ...
      $Conteudo = $documento_input_2;
      $this->cmp_formatado['documento_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($nombres != '') {
      $nombres_look = substr($this->Db->qstr($nombres), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      $Conteudo = $nombres_input_2;
      $this->cmp_formatado['nombres_input_2'] = $Conteudo;
      $Conteudo = $loatiende;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['loatiende'] = $Conteudo;
      $Conteudo = $estado;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      ...
      $Conteudo = $clasificacion_clientes;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['clasificacion_clientes'] = $Conteudo;

      //----- $documento
      $this->Date_part = false;
      if (isset($documento) || $documento_cond == "nu" || $documento_cond == "nn" || $documento_cond == "ep" || $documento_cond == "ne")
      {
         $this->monta_condicao("documento", $documento_cond, $documento, $documento_input_2, "documento");
      }
      ...
      {
         $this->monta_condicao("nombres", $nombres_cond, $nombres, $nombres_input_2, "nombres");
      }
      ...
      if (isset($loatiende))
      {
         $this->monta_condicao("loatiende", $loatiende_cond, $loatiende, "", "loatiende");
      }
      ...
      //----- $clasificacion_clientes
      $this->Date_part = false;
      if (isset($clasificacion_clientes))
      {
         $this->monta_condicao("clasificacion_clientes", $clasificacion_clientes_cond, $clasificacion_clientes, "", "clasificacion_clientes");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "loatiende" : return ('class="scFilterObjectOdd"'); break;
         case "estado" : return ('class="scFilterObjectEven"'); break;
         case "clasificacion_clientes" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
