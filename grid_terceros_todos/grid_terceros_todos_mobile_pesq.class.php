...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-documento" id="id_ac_documento" name="documento_autocomp"><?php if ('' !=  $documento) { ?><option value="<?php echo $documento ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_documento"  <?php echo $str_display_documento; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_documento_input_2" name="documento_input_2" value="<?php echo NM_encode_input($documento_input_2) ?>"    size="300" class="sc-js-input scFilterObjectOdd">         </SPAN>
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-nombres" id="id_ac_nombres" name="nombres_autocomp"><?php if ('' !=  $nombres) { ?><option value="<?php echo $nombres ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_nombres"  <?php echo $str_display_nombres; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_nombres_input_2" name="nombres_input_2" value="<?php echo NM_encode_input($nombres_input_2) ?>"    size="300" class="sc-js-input scFilterObjectEven">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_loatiende"  <?php echo $str_hide_loatiende?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_clasificacion_clientes"  <?php echo $str_hide_clasificacion_clientes?>>
<?php
