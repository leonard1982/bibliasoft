<?php
@session_start() ;
$_SESSION['scriptcase']['grid_terceros_todos']['sc_process_barr'] = true;
require_once('../grid_terceros_todos/index.php');
unset($_SESSION['scriptcase']['grid_terceros_todos']['sc_process_barr']);
$ExportCtrl = new grid_terceros_todos_export_control;
$ExportCtrl->Export_barr();

class grid_terceros_todos_export_control
{
