...
class grid_terceros_todos_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_terceros_todos/grid_terceros_todos_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_terceros_todos_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_terceros_todos.zip";
          $this->Arquivo   .= "_grid_terceros_todos" . $this->Xls_tp;
          $this->Tit_doc    = "grid_terceros_todos" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['grid_terceros_todos']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      while (!$rs->EOF)
      {
         ...
         $this->arg_sum_loatiende = ($this->loatiende == "") ? " is null " : " = " . $this->loatiende;
          if ($this->loatiende !== $this->loatiende_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['SC_Ind_Groupby'] == "vendedor") 
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
          ...
          {  
              $SC_arg_Gby = array();
              $SC_arg_Sql = array();
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['SC_Gb_Free_orig'][$cmp] : $cmp;
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
              ...
              $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['SC_Gb_Free_cmp']);
              krsort ($SC_lst_Gby);
              $Qb_page = true;
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
...
$_SESSION['scriptcase']['grid_terceros_todos']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_proveedor()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->proveedor, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->proveedor, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- empleado
   function NM_export_empleado()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->empleado, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->empleado, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- si_nomina
   function NM_export_si_nomina()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->si_nomina, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->si_nomina, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- idtercero
   ...
   function NM_export_regimen()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->regimen, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->regimen, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- tipo
   ...
   function NM_export_cupo()
   {
         ...
         if (is_numeric($this->cupo))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->cupo);
         $this->Xls_col++;
   }
   //----- listaprecios
   function NM_export_listaprecios()
   {
         ...
         if (is_numeric($this->listaprecios))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->listaprecios);
         $this->Xls_col++;
   }
   //----- con_actual
   function NM_export_con_actual()
   {
      ...
      if (!empty($this->con_actual))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->con_actual, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->con_actual, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- efec_retencion
   function NM_export_efec_retencion()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->efec_retencion, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->efec_retencion, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- urlmail_1
   function NM_export_urlmail_1()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->urlmail_1, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->urlmail_1, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- nombre1
   function NM_export_nombre1()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nombre1, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nombre1, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- nombre2
   function NM_export_nombre2()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nombre2, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nombre2, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- apellido1
   function NM_export_apellido1()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->apellido1, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->apellido1, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- apellido2
   function NM_export_apellido2()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->apellido2, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->apellido2, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sucur_cliente
   function NM_export_sucur_cliente()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sucur_cliente, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sucur_cliente, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- representante
   function NM_export_representante()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->representante, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->representante, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- es_restaurante
   function NM_export_es_restaurante()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->es_restaurante, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->es_restaurante, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- dias_credito
   function NM_export_dias_credito()
   {
         ...
         if (is_numeric($this->dias_credito))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->dias_credito);
         $this->Xls_col++;
   }
   //----- dias_mora
   function NM_export_dias_mora()
   {
         ...
         if (is_numeric($this->dias_mora))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->dias_mora);
         $this->Xls_col++;
   }
   //----- cupo_vendedor
   function NM_export_cupo_vendedor()
   {
         ...
         if (is_numeric($this->cupo_vendedor))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->cupo_vendedor);
         $this->Xls_col++;
   }
   //----- codigo_ter
   function NM_export_codigo_ter()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->codigo_ter, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->codigo_ter, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- es_cajero
   function NM_export_es_cajero()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->es_cajero, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->es_cajero, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- autorizado
   function NM_export_autorizado()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->autorizado, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->autorizado, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- zona_clientes
   function NM_export_zona_clientes()
   {
         ...
         if (is_numeric($this->zona_clientes))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->zona_clientes);
         $this->Xls_col++;
   }
   ...
   function NM_export_clasificacion_clientes()
   {
         ...
         if (is_numeric($this->clasificacion_clientes))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->clasificacion_clientes);
         $this->Xls_col++;
   }
   //----- creado
   ...
   function NM_export_id_pedido_tmp()
   {
         ...
         if (is_numeric($this->id_pedido_tmp))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->id_pedido_tmp);
         $this->Xls_col++;
   }
   //----- n_pedido_tmp
   function NM_export_n_pedido_tmp()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->n_pedido_tmp, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->n_pedido_tmp, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- total_pedido_tmp
   function NM_export_total_pedido_tmp()
   {
         ...
         if (is_numeric($this->total_pedido_tmp))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->total_pedido_tmp);
         $this->Xls_col++;
   }
   //----- obs_pedido_tmp
   function NM_export_obs_pedido_tmp()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->obs_pedido_tmp, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->obs_pedido_tmp, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- vend_pedido_tmp
   function NM_export_vend_pedido_tmp()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->vend_pedido_tmp, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->vend_pedido_tmp, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ciudad
   ...
   function NM_export_lenguaje()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lenguaje, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lenguaje, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- nombre_comercil
   function NM_export_nombre_comercil()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nombre_comercil, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nombre_comercil, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- notificar
   ...
   function NM_export_puc_auxiliar_deudores()
   {
         ...
         if (is_numeric($this->puc_auxiliar_deudores))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->puc_auxiliar_deudores);
         $this->Xls_col++;
   }
   ...
   function NM_export_puc_retefuente_ventas()
   {
         ...
         if (is_numeric($this->puc_retefuente_ventas))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->puc_retefuente_ventas);
         $this->Xls_col++;
   }
   ...
   function NM_export_puc_retefuente_servicios_clie()
   {
         ...
         if (is_numeric($this->puc_retefuente_servicios_clie))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->puc_retefuente_servicios_clie);
         $this->Xls_col++;
   }
   ...
   function NM_export_puc_auxiliar_proveedores()
   {
         ...
         if (is_numeric($this->puc_auxiliar_proveedores))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->puc_auxiliar_proveedores);
         $this->Xls_col++;
   }
   ...
   function NM_export_puc_retefuente_compras()
   {
         ...
         if (is_numeric($this->puc_retefuente_compras))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->puc_retefuente_compras);
         $this->Xls_col++;
   }
   ...
   function NM_export_puc_retefuente_servicios_prov()
   {
         ...
         if (is_numeric($this->puc_retefuente_servicios_prov))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->puc_retefuente_servicios_prov);
         $this->Xls_col++;
   }
   //----- nube
   ...
   function NM_export_tipo_documento()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tipo_documento, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tipo_documento, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- estado
   ...
   function NM_export_sc_asigna_vendedor()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_asigna_vendedor, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_asigna_vendedor, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ccnit
   ...
   //----- proveedor
   function NM_sub_cons_proveedor()
   {
         $this->proveedor = html_entity_decode($this->proveedor, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->proveedor = strip_tags($this->proveedor);
         $this->proveedor = NM_charset_to_utf8($this->proveedor);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->proveedor;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- si_nomina
   function NM_sub_cons_si_nomina()
   {
         $this->si_nomina = html_entity_decode($this->si_nomina, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->si_nomina = strip_tags($this->si_nomina);
         $this->si_nomina = NM_charset_to_utf8($this->si_nomina);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->si_nomina;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- regimen
   function NM_sub_cons_regimen()
   {
         $this->regimen = html_entity_decode($this->regimen, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->regimen = strip_tags($this->regimen);
         $this->regimen = NM_charset_to_utf8($this->regimen);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->regimen;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- cupo
   function NM_sub_cons_cupo()
   {
         $this->cupo = NM_charset_to_utf8($this->cupo);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cupo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- listaprecios
   function NM_sub_cons_listaprecios()
   {
         $this->listaprecios = NM_charset_to_utf8($this->listaprecios);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->listaprecios;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- con_actual
   function NM_sub_cons_con_actual()
   {
      if (!empty($this->con_actual))
      {
         if (substr($this->con_actual, 10, 1) == "-") 
         ...
         $this->con_actual = NM_charset_to_utf8($this->con_actual);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->con_actual;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- efec_retencion
   function NM_sub_cons_efec_retencion()
   {
         $this->efec_retencion = html_entity_decode($this->efec_retencion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->efec_retencion = strip_tags($this->efec_retencion);
         $this->efec_retencion = NM_charset_to_utf8($this->efec_retencion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->efec_retencion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- urlmail_1
   function NM_sub_cons_urlmail_1()
   {
         $this->urlmail_1 = html_entity_decode($this->urlmail_1, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->urlmail_1 = strip_tags($this->urlmail_1);
         $this->urlmail_1 = NM_charset_to_utf8($this->urlmail_1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->urlmail_1;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- nombre1
   function NM_sub_cons_nombre1()
   {
         $this->nombre1 = html_entity_decode($this->nombre1, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nombre1 = strip_tags($this->nombre1);
         $this->nombre1 = NM_charset_to_utf8($this->nombre1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nombre1;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- nombre2
   function NM_sub_cons_nombre2()
   {
         $this->nombre2 = html_entity_decode($this->nombre2, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nombre2 = strip_tags($this->nombre2);
         $this->nombre2 = NM_charset_to_utf8($this->nombre2);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nombre2;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- apellido1
   function NM_sub_cons_apellido1()
   {
         $this->apellido1 = html_entity_decode($this->apellido1, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->apellido1 = strip_tags($this->apellido1);
         $this->apellido1 = NM_charset_to_utf8($this->apellido1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->apellido1;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- apellido2
   function NM_sub_cons_apellido2()
   {
         $this->apellido2 = html_entity_decode($this->apellido2, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->apellido2 = strip_tags($this->apellido2);
         $this->apellido2 = NM_charset_to_utf8($this->apellido2);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->apellido2;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sucur_cliente
   function NM_sub_cons_sucur_cliente()
   {
         $this->sucur_cliente = html_entity_decode($this->sucur_cliente, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sucur_cliente = strip_tags($this->sucur_cliente);
         $this->sucur_cliente = NM_charset_to_utf8($this->sucur_cliente);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sucur_cliente;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- representante
   function NM_sub_cons_representante()
   {
         $this->representante = html_entity_decode($this->representante, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->representante = strip_tags($this->representante);
         $this->representante = NM_charset_to_utf8($this->representante);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->representante;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- es_restaurante
   function NM_sub_cons_es_restaurante()
   {
         $this->es_restaurante = html_entity_decode($this->es_restaurante, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->es_restaurante = strip_tags($this->es_restaurante);
         $this->es_restaurante = NM_charset_to_utf8($this->es_restaurante);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->es_restaurante;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- dias_credito
   function NM_sub_cons_dias_credito()
   {
         $this->dias_credito = NM_charset_to_utf8($this->dias_credito);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->dias_credito;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- dias_mora
   function NM_sub_cons_dias_mora()
   {
         $this->dias_mora = NM_charset_to_utf8($this->dias_mora);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->dias_mora;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- cupo_vendedor
   function NM_sub_cons_cupo_vendedor()
   {
         $this->cupo_vendedor = NM_charset_to_utf8($this->cupo_vendedor);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cupo_vendedor;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   //----- codigo_ter
   function NM_sub_cons_codigo_ter()
   {
         $this->codigo_ter = html_entity_decode($this->codigo_ter, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->codigo_ter = strip_tags($this->codigo_ter);
         $this->codigo_ter = NM_charset_to_utf8($this->codigo_ter);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->codigo_ter;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- es_cajero
   function NM_sub_cons_es_cajero()
   {
         $this->es_cajero = html_entity_decode($this->es_cajero, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->es_cajero = strip_tags($this->es_cajero);
         $this->es_cajero = NM_charset_to_utf8($this->es_cajero);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->es_cajero;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- autorizado
   function NM_sub_cons_autorizado()
   {
         $this->autorizado = html_entity_decode($this->autorizado, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->autorizado = strip_tags($this->autorizado);
         $this->autorizado = NM_charset_to_utf8($this->autorizado);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->autorizado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- zona_clientes
   function NM_sub_cons_zona_clientes()
   {
         $this->zona_clientes = NM_charset_to_utf8($this->zona_clientes);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->zona_clientes;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- clasificacion_clientes
   function NM_sub_cons_clasificacion_clientes()
   {
         $this->clasificacion_clientes = NM_charset_to_utf8($this->clasificacion_clientes);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->clasificacion_clientes;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- id_pedido_tmp
   function NM_sub_cons_id_pedido_tmp()
   {
         $this->id_pedido_tmp = NM_charset_to_utf8($this->id_pedido_tmp);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->id_pedido_tmp;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- n_pedido_tmp
   function NM_sub_cons_n_pedido_tmp()
   {
         $this->n_pedido_tmp = html_entity_decode($this->n_pedido_tmp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->n_pedido_tmp = strip_tags($this->n_pedido_tmp);
         $this->n_pedido_tmp = NM_charset_to_utf8($this->n_pedido_tmp);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->n_pedido_tmp;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- total_pedido_tmp
   function NM_sub_cons_total_pedido_tmp()
   {
         $this->total_pedido_tmp = NM_charset_to_utf8($this->total_pedido_tmp);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->total_pedido_tmp;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- obs_pedido_tmp
   function NM_sub_cons_obs_pedido_tmp()
   {
         $this->obs_pedido_tmp = html_entity_decode($this->obs_pedido_tmp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->obs_pedido_tmp = strip_tags($this->obs_pedido_tmp);
         $this->obs_pedido_tmp = NM_charset_to_utf8($this->obs_pedido_tmp);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->obs_pedido_tmp;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- vend_pedido_tmp
   function NM_sub_cons_vend_pedido_tmp()
   {
         $this->vend_pedido_tmp = html_entity_decode($this->vend_pedido_tmp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->vend_pedido_tmp = strip_tags($this->vend_pedido_tmp);
         $this->vend_pedido_tmp = NM_charset_to_utf8($this->vend_pedido_tmp);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->vend_pedido_tmp;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lenguaje
   function NM_sub_cons_lenguaje()
   {
         $this->lenguaje = html_entity_decode($this->lenguaje, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lenguaje = strip_tags($this->lenguaje);
         $this->lenguaje = NM_charset_to_utf8($this->lenguaje);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lenguaje;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- nombre_comercil
   function NM_sub_cons_nombre_comercil()
   {
         $this->nombre_comercil = html_entity_decode($this->nombre_comercil, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nombre_comercil = strip_tags($this->nombre_comercil);
         $this->nombre_comercil = NM_charset_to_utf8($this->nombre_comercil);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nombre_comercil;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- puc_auxiliar_deudores
   function NM_sub_cons_puc_auxiliar_deudores()
   {
         $this->puc_auxiliar_deudores = NM_charset_to_utf8($this->puc_auxiliar_deudores);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->puc_auxiliar_deudores;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- puc_retefuente_ventas
   function NM_sub_cons_puc_retefuente_ventas()
   {
         $this->puc_retefuente_ventas = NM_charset_to_utf8($this->puc_retefuente_ventas);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->puc_retefuente_ventas;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- puc_retefuente_servicios_clie
   function NM_sub_cons_puc_retefuente_servicios_clie()
   {
         $this->puc_retefuente_servicios_clie = NM_charset_to_utf8($this->puc_retefuente_servicios_clie);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->puc_retefuente_servicios_clie;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- puc_auxiliar_proveedores
   function NM_sub_cons_puc_auxiliar_proveedores()
   {
         $this->puc_auxiliar_proveedores = NM_charset_to_utf8($this->puc_auxiliar_proveedores);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->puc_auxiliar_proveedores;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- puc_retefuente_compras
   function NM_sub_cons_puc_retefuente_compras()
   {
         $this->puc_retefuente_compras = NM_charset_to_utf8($this->puc_retefuente_compras);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->puc_retefuente_compras;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- puc_retefuente_servicios_prov
   function NM_sub_cons_puc_retefuente_servicios_prov()
   {
         $this->puc_retefuente_servicios_prov = NM_charset_to_utf8($this->puc_retefuente_servicios_prov);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->puc_retefuente_servicios_prov;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- tipo_documento
   function NM_sub_cons_tipo_documento()
   {
         $this->tipo_documento = html_entity_decode($this->tipo_documento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tipo_documento = strip_tags($this->tipo_documento);
         $this->tipo_documento = NM_charset_to_utf8($this->tipo_documento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tipo_documento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sc_asigna_vendedor
   function NM_sub_cons_sc_asigna_vendedor()
   {
         $this->sc_asigna_vendedor = html_entity_decode($this->sc_asigna_vendedor, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sc_asigna_vendedor = strip_tags($this->sc_asigna_vendedor);
         $this->sc_asigna_vendedor = NM_charset_to_utf8($this->sc_asigna_vendedor);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sc_asigna_vendedor;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['nolabel'])
       {
 ...
 function quebra_loatiende_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   function quebra_loatiende_vendedor_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['field_order'] as $Cada_cmp)
       {
           if (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_loatiende_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_loatiende_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
