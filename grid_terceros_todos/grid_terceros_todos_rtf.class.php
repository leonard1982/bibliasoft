...
class grid_terceros_todos_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Tot      = new grid_terceros_todos_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['SC_Ind_Groupby'];
      if (method_exists($this->Tot,$Gb_geral))
      {
          $this->Tot->$Gb_geral();
          $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['tot_geral'][1];
      }
      if (!$this->Ini->sc_export_ajax) {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_terceros_todos.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['grid_terceros_todos']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_terceros_todos']['contr_erro'] = 'off'; 
   ...
   function NM_export_ccnit()
   {
         ...
         $this->ccnit = str_replace('<', '&lt;', $this->ccnit);
         $this->ccnit = str_replace('>', '&gt;', $this->ccnit);
         $this->Texto_tag .= "<td>" . $this->ccnit . "</td>\r\n";
   }
   //----- nombres
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_todos']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
