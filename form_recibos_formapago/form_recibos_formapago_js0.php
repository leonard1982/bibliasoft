<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_recibos_formapago" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_recibos_formapago']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_formapago']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_recibos_formapago"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_btn_traer_total()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_btn_traer_total(); }, 500);
      return;
    }
    sc_btn_btn_traer_total_ok();
}
function sc_btn_btn_traer_total_cancel()
{
}
function sc_btn_btn_traer_total_ok()
{
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_formapago']['where_detal']))
  {
?>  
