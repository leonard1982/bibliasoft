  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_recibos_formapago" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_recibos_formapago_form();
	}
  ...
  // ---------- Validate id_formapago
  function do_ajax_form_recibos_formapago_validate_id_formapago()
  {
    var nomeCampo_id_formapago = "id_formapago";
    var var_id_formapago = scAjaxGetFieldSelect(nomeCampo_id_formapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_validate_id_formapago(var_id_formapago, var_script_case_init, do_ajax_form_recibos_formapago_validate_id_formapago_cb);
  } // do_ajax_form_recibos_formapago_validate_id_formapago

  function do_ajax_form_recibos_formapago_validate_id_formapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_formapago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_validate_id_formapago_cb

  // ---------- Validate monto
  function do_ajax_form_recibos_formapago_validate_monto()
  {
    var nomeCampo_monto = "monto";
    var var_monto = scAjaxGetFieldText(nomeCampo_monto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_validate_monto(var_monto, var_script_case_init, do_ajax_form_recibos_formapago_validate_monto_cb);
  } // do_ajax_form_recibos_formapago_validate_monto

  function do_ajax_form_recibos_formapago_validate_monto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "monto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_validate_monto_cb

  // ---------- Validate nombre_banco
  function do_ajax_form_recibos_formapago_validate_nombre_banco()
  {
    var nomeCampo_nombre_banco = "nombre_banco";
    var var_nombre_banco = scAjaxGetFieldText(nomeCampo_nombre_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_validate_nombre_banco(var_nombre_banco, var_script_case_init, do_ajax_form_recibos_formapago_validate_nombre_banco_cb);
  } // do_ajax_form_recibos_formapago_validate_nombre_banco

  function do_ajax_form_recibos_formapago_validate_nombre_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_banco";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_validate_nombre_banco_cb

  // ---------- Validate numero_cheque
  function do_ajax_form_recibos_formapago_validate_numero_cheque()
  {
    var nomeCampo_numero_cheque = "numero_cheque";
    var var_numero_cheque = scAjaxGetFieldText(nomeCampo_numero_cheque);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_validate_numero_cheque(var_numero_cheque, var_script_case_init, do_ajax_form_recibos_formapago_validate_numero_cheque_cb);
  } // do_ajax_form_recibos_formapago_validate_numero_cheque

  function do_ajax_form_recibos_formapago_validate_numero_cheque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero_cheque";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_validate_numero_cheque_cb

  // ---------- Validate fecha_cheque
  function do_ajax_form_recibos_formapago_validate_fecha_cheque()
  {
    var nomeCampo_fecha_cheque = "fecha_cheque";
    var var_fecha_cheque = scAjaxGetFieldText(nomeCampo_fecha_cheque);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_validate_fecha_cheque(var_fecha_cheque, var_script_case_init, do_ajax_form_recibos_formapago_validate_fecha_cheque_cb);
  } // do_ajax_form_recibos_formapago_validate_fecha_cheque

  function do_ajax_form_recibos_formapago_validate_fecha_cheque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_cheque";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_validate_fecha_cheque_cb

  // ---------- Validate id_banco_caja
  function do_ajax_form_recibos_formapago_validate_id_banco_caja()
  {
    var nomeCampo_id_banco_caja = "id_banco_caja";
    var var_id_banco_caja = scAjaxGetFieldSelect(nomeCampo_id_banco_caja);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_validate_id_banco_caja(var_id_banco_caja, var_script_case_init, do_ajax_form_recibos_formapago_validate_id_banco_caja_cb);
  } // do_ajax_form_recibos_formapago_validate_id_banco_caja

  function do_ajax_form_recibos_formapago_validate_id_banco_caja_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_banco_caja";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_validate_id_banco_caja_cb

  // ---------- Validate id_recibos_formapago
  function do_ajax_form_recibos_formapago_validate_id_recibos_formapago()
  {
    var nomeCampo_id_recibos_formapago = "id_recibos_formapago";
    var var_id_recibos_formapago = scAjaxGetFieldHidden(nomeCampo_id_recibos_formapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_validate_id_recibos_formapago(var_id_recibos_formapago, var_script_case_init, do_ajax_form_recibos_formapago_validate_id_recibos_formapago_cb);
  } // do_ajax_form_recibos_formapago_validate_id_recibos_formapago

  function do_ajax_form_recibos_formapago_validate_id_recibos_formapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_recibos_formapago";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_validate_id_recibos_formapago_cb

  // ---------- Event onclick scajaxbutton_btn_traer_total
  function do_ajax_form_recibos_formapago_event_scajaxbutton_btn_traer_total_onclick()
  {
    var var_monto = scAjaxGetFieldText("monto");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recibos_formapago_event_scajaxbutton_btn_traer_total_onclick(var_monto, var_script_case_init, do_ajax_form_recibos_formapago_event_scajaxbutton_btn_traer_total_onclick_cb);
  } // do_ajax_form_recibos_formapago_event_scajaxbutton_btn_traer_total_onclick

  function do_ajax_form_recibos_formapago_event_scajaxbutton_btn_traer_total_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "scajaxbutton_btn_traer_total";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_formapago_event_scajaxbutton_btn_traer_total_onclick_cb_after_alert);
  } // do_ajax_form_recibos_formapago_event_scajaxbutton_btn_traer_total_onclick_cb
  function do_ajax_form_recibos_formapago_event_scajaxbutton_btn_traer_total_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recibos_formapago_event_scajaxbutton_btn_traer_total_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_recibos_formapago_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_recibos_formapago_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_formapago = scAjaxGetFieldSelect("id_formapago");
    var var_monto = scAjaxGetFieldText("monto");
    var var_nombre_banco = scAjaxGetFieldText("nombre_banco");
    var var_numero_cheque = scAjaxGetFieldText("numero_cheque");
    var var_fecha_cheque = scAjaxGetFieldText("fecha_cheque");
    var var_id_banco_caja = scAjaxGetFieldSelect("id_banco_caja");
    var var_id_recibos_formapago = scAjaxGetFieldHidden("id_recibos_formapago");
    ...
    scAjaxProcOn();
    x_ajax_form_recibos_formapago_submit_form(var_id_formapago, var_monto, var_nombre_banco, var_numero_cheque, var_fecha_cheque, var_id_banco_caja, var_id_recibos_formapago, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_recibos_formapago_submit_form_cb);
  } // do_ajax_form_recibos_formapago_submit_form

  function do_ajax_form_recibos_formapago_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_formapago");
      scAjaxHideErrorDisplay("monto");
      scAjaxHideErrorDisplay("nombre_banco");
      scAjaxHideErrorDisplay("numero_cheque");
      scAjaxHideErrorDisplay("fecha_cheque");
      scAjaxHideErrorDisplay("id_banco_caja");
      scAjaxHideErrorDisplay("id_recibos_formapago");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_recibos_formapago_submit_form_cb_after_alert);
  } // do_ajax_form_recibos_formapago_submit_form_cb
  function do_ajax_form_recibos_formapago_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_recibos_formapago_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_recibos_formapago_navigate_form()
  {
    perform_ajax_form_recibos_formapago_navigate_form();
  }

  function perform_ajax_form_recibos_formapago_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("id_banco_caja");
    scAjaxHideErrorDisplay("id_recibos_formapago");
    var var_id_recibos_formapago = document.F2.id_recibos_formapago.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_recibos_formapago_navigate_form(var_id_recibos_formapago, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_recibos_formapago_navigate_form_cb);
  } // do_ajax_form_recibos_formapago_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_formapago']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_recibos_formapago_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_recibos_formapago.value = scAjaxGetKeyValue("id_recibos_formapago");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_recibos_formapago_navigate_form_cb_after_alert);
  } // do_ajax_form_recibos_formapago_navigate_form_cb
  function do_ajax_form_recibos_formapago_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_recibos_formapago_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_recibos_formapago_navigate_form_cb_after_alert
  function sc_hide_form_recibos_formapago_form()
  {
  ...
  ajax_field_list[0] = "id_formapago";
  ajax_field_list[1] = "monto";
  ajax_field_list[2] = "nombre_banco";
  ajax_field_list[3] = "numero_cheque";
  ajax_field_list[4] = "fecha_cheque";
  ajax_field_list[5] = "id_banco_caja";
  ajax_field_list[6] = "id_recibos_formapago";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_formapago": {"label": "Forma Pago", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "monto": {"label": "Monto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombre_banco": {"label": "Nombre Banco", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "numero_cheque": {"label": "No Cheque", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_cheque": {"label": "Fecha Cheque", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_banco_caja": {"label": "Banco/Caja", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_recibos_formapago": {"label": "Id Recibos Formapago", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_formapago": new Array(),
    "monto": new Array(),
    "nombre_banco": new Array(),
    "numero_cheque": new Array(),
    "fecha_cheque": new Array(),
    "id_banco_caja": new Array(),
    "id_recibos_formapago": new Array()
  };
  ajax_field_mult["id_formapago"][1] = "id_formapago";
  ajax_field_mult["monto"][1] = "monto";
  ajax_field_mult["nombre_banco"][1] = "nombre_banco";
  ajax_field_mult["numero_cheque"][1] = "numero_cheque";
  ajax_field_mult["fecha_cheque"][1] = "fecha_cheque";
  ajax_field_mult["id_banco_caja"][1] = "id_banco_caja";
  ajax_field_mult["id_recibos_formapago"][1] = "id_recibos_formapago";

  var ajax_field_id = {
    "id_formapago": new Array("hidden_field_label_id_formapago", "hidden_field_data_id_formapago"),
    "monto": new Array("hidden_field_label_monto", "hidden_field_data_monto"),
    "nombre_banco": new Array("hidden_field_label_nombre_banco", "hidden_field_data_nombre_banco"),
    "numero_cheque": new Array("hidden_field_label_numero_cheque", "hidden_field_data_numero_cheque"),
    "fecha_cheque": new Array("hidden_field_label_fecha_cheque", "hidden_field_data_fecha_cheque"),
    "id_banco_caja": new Array("hidden_field_label_id_banco_caja", "hidden_field_data_id_banco_caja")
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("id_recibos_formapago" == sIndex)
    {
