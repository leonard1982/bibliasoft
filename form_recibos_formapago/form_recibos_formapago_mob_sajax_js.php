  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_recibos_formapago_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_recibos_formapago_mob_form();
	}
  ...
  function do_ajax_form_recibos_formapago_mob_validate_id_formapago()
  {
    var nomeCampo_id_formapago = "id_formapago";
    var var_id_formapago = scAjaxGetFieldSelect(nomeCampo_id_formapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_mob_validate_id_formapago(var_id_formapago, var_script_case_init, do_ajax_form_recibos_formapago_mob_validate_id_formapago_cb);
  } // do_ajax_form_recibos_formapago_mob_validate_id_formapago

  function do_ajax_form_recibos_formapago_mob_validate_id_formapago_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_mob_validate_id_formapago_cb

  // ---------- Validate monto
  function do_ajax_form_recibos_formapago_mob_validate_monto()
  {
    var nomeCampo_monto = "monto";
    var var_monto = scAjaxGetFieldText(nomeCampo_monto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_mob_validate_monto(var_monto, var_script_case_init, do_ajax_form_recibos_formapago_mob_validate_monto_cb);
  } // do_ajax_form_recibos_formapago_mob_validate_monto

  function do_ajax_form_recibos_formapago_mob_validate_monto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "monto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_mob_validate_monto_cb

  // ---------- Validate nombre_banco
  function do_ajax_form_recibos_formapago_mob_validate_nombre_banco()
  {
    var nomeCampo_nombre_banco = "nombre_banco";
    var var_nombre_banco = scAjaxGetFieldText(nomeCampo_nombre_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_mob_validate_nombre_banco(var_nombre_banco, var_script_case_init, do_ajax_form_recibos_formapago_mob_validate_nombre_banco_cb);
  } // do_ajax_form_recibos_formapago_mob_validate_nombre_banco

  function do_ajax_form_recibos_formapago_mob_validate_nombre_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_mob_validate_nombre_banco_cb

  // ---------- Validate numero_cheque
  function do_ajax_form_recibos_formapago_mob_validate_numero_cheque()
  {
    var nomeCampo_numero_cheque = "numero_cheque";
    var var_numero_cheque = scAjaxGetFieldText(nomeCampo_numero_cheque);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_mob_validate_numero_cheque(var_numero_cheque, var_script_case_init, do_ajax_form_recibos_formapago_mob_validate_numero_cheque_cb);
  } // do_ajax_form_recibos_formapago_mob_validate_numero_cheque

  function do_ajax_form_recibos_formapago_mob_validate_numero_cheque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_mob_validate_numero_cheque_cb

  // ---------- Validate fecha_cheque
  function do_ajax_form_recibos_formapago_mob_validate_fecha_cheque()
  {
    var nomeCampo_fecha_cheque = "fecha_cheque";
    var var_fecha_cheque = scAjaxGetFieldText(nomeCampo_fecha_cheque);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_mob_validate_fecha_cheque(var_fecha_cheque, var_script_case_init, do_ajax_form_recibos_formapago_mob_validate_fecha_cheque_cb);
  } // do_ajax_form_recibos_formapago_mob_validate_fecha_cheque

  function do_ajax_form_recibos_formapago_mob_validate_fecha_cheque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_mob_validate_fecha_cheque_cb

  // ---------- Validate id_banco_caja
  function do_ajax_form_recibos_formapago_mob_validate_id_banco_caja()
  {
    var nomeCampo_id_banco_caja = "id_banco_caja";
    var var_id_banco_caja = scAjaxGetFieldSelect(nomeCampo_id_banco_caja);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_mob_validate_id_banco_caja(var_id_banco_caja, var_script_case_init, do_ajax_form_recibos_formapago_mob_validate_id_banco_caja_cb);
  } // do_ajax_form_recibos_formapago_mob_validate_id_banco_caja

  function do_ajax_form_recibos_formapago_mob_validate_id_banco_caja_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_mob_validate_id_banco_caja_cb

  // ---------- Validate id_recibos_formapago
  function do_ajax_form_recibos_formapago_mob_validate_id_recibos_formapago()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_formapago_mob_validate_id_recibos_formapago(var_id_recibos_formapago, var_script_case_init, do_ajax_form_recibos_formapago_mob_validate_id_recibos_formapago_cb);
  } // do_ajax_form_recibos_formapago_mob_validate_id_recibos_formapago

  function do_ajax_form_recibos_formapago_mob_validate_id_recibos_formapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_formapago_mob_validate_id_recibos_formapago_cb

  // ---------- Event onclick scajaxbutton_btn_traer_total
  function do_ajax_form_recibos_formapago_mob_event_scajaxbutton_btn_traer_total_onclick()
  {
    var var_monto = scAjaxGetFieldText("monto");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recibos_formapago_mob_event_scajaxbutton_btn_traer_total_onclick(var_monto, var_script_case_init, do_ajax_form_recibos_formapago_mob_event_scajaxbutton_btn_traer_total_onclick_cb);
  } // do_ajax_form_recibos_formapago_mob_event_scajaxbutton_btn_traer_total_onclick

  function do_ajax_form_recibos_formapago_mob_event_scajaxbutton_btn_traer_total_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_formapago_mob_event_scajaxbutton_btn_traer_total_onclick_cb_after_alert);
  } // do_ajax_form_recibos_formapago_mob_event_scajaxbutton_btn_traer_total_onclick_cb
  function do_ajax_form_recibos_formapago_mob_event_scajaxbutton_btn_traer_total_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recibos_formapago_mob_event_scajaxbutton_btn_traer_total_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_recibos_formapago_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_recibos_formapago_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_recibos_formapago_mob_submit_form(var_id_formapago, var_monto, var_nombre_banco, var_numero_cheque, var_fecha_cheque, var_id_banco_caja, var_id_recibos_formapago, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_recibos_formapago_mob_submit_form_cb);
  } // do_ajax_form_recibos_formapago_mob_submit_form

  function do_ajax_form_recibos_formapago_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_recibos_formapago_mob_submit_form_cb_after_alert);
  } // do_ajax_form_recibos_formapago_mob_submit_form_cb
  function do_ajax_form_recibos_formapago_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_recibos_formapago_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_recibos_formapago_mob_navigate_form()
  {
    perform_ajax_form_recibos_formapago_mob_navigate_form();
  }

  function perform_ajax_form_recibos_formapago_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_recibos_formapago_mob_navigate_form(var_id_recibos_formapago, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_recibos_formapago_mob_navigate_form_cb);
  } // do_ajax_form_recibos_formapago_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_formapago_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_recibos_formapago_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_recibos_formapago_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_recibos_formapago_mob_navigate_form_cb
  function do_ajax_form_recibos_formapago_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_recibos_formapago_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_recibos_formapago_mob_navigate_form_cb_after_alert
  function sc_hide_form_recibos_formapago_mob_form()
  {
