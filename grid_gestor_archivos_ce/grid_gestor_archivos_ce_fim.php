...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_gestor_archivos_ce"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_gestor_archivos_ce"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_gestor_archivos_ce'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos_ce']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos_ce']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos_ce']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos_ce']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos_ce']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_gestor_archivos_ce</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos_ce']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_gestor_archivos_ce']['embutida_filho'] as $ind => $sc_init)
          {
