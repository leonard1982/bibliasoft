...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_gestor_archivos_ce"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_gestor_archivos_ce"]);
   }
