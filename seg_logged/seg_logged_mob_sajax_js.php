...
?>
  ...
  {
    var nomeCampo_html = "html";
    var var_html = scAjaxGetFieldHidden(nomeCampo_html);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_logged_mob_validate_html(var_html, var_script_case_init, do_ajax_seg_logged_mob_validate_html_cb);
  ...
  // ---------- Validate html_icon
  function do_ajax_seg_logged_mob_validate_html_icon()
  {
    var nomeCampo_html_icon = "html_icon";
    var var_html_icon = scAjaxGetFieldHidden(nomeCampo_html_icon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_logged_mob_validate_html_icon(var_html_icon, var_script_case_init, do_ajax_seg_logged_mob_validate_html_icon_cb);
  } // do_ajax_seg_logged_mob_validate_html_icon

  function do_ajax_seg_logged_mob_validate_html_icon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "html_icon";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_logged_mob_validate_html_icon_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_seg_logged_mob_submit_form()
  {
    ...
    var var_html_icon = scAjaxGetFieldHidden("html_icon");
    ...
    scAjaxProcOn();
    x_ajax_seg_logged_mob_submit_form(var_html, var_html_icon, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_seg_logged_mob_submit_form_cb);
...
?>
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_seg_logged_mob_navigate_form, function() {});
    } else {
...
?>
  ...
  ajax_field_list[1] = "html_icon";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "html": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "html_icon": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["html_icon"][1] = "html_icon";

  var ajax_field_id = {
    "html": new Array("hidden_field_label_html", "hidden_field_data_html"),
    "html_icon": new Array("hidden_field_label_html_icon", "hidden_field_data_html_icon")
  };
