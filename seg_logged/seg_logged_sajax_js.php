...
?>
  ...
  function do_ajax_seg_logged_validate_html()
  {
    ...
    x_ajax_seg_logged_validate_html(var_html, var_script_case_init, do_ajax_seg_logged_validate_html_cb);
  ...
  // ---------- Validate html_icon
  function do_ajax_seg_logged_validate_html_icon()
  {
    var nomeCampo_html_icon = "html_icon";
    var var_html_icon = scAjaxGetFieldHidden(nomeCampo_html_icon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_logged_validate_html_icon(var_html_icon, var_script_case_init, do_ajax_seg_logged_validate_html_icon_cb);
  } // do_ajax_seg_logged_validate_html_icon

  function do_ajax_seg_logged_validate_html_icon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_logged_validate_html_icon_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_seg_logged_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_seg_logged_submit_form(var_html, var_html_icon, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_seg_logged_submit_form_cb);
...
?>
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_seg_logged_navigate_form, function() {});
    } else {
