...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("control_codbarras_filtro_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('control_codbarras_filtro_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("control_codbarras_filtro_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_codbarras_filtro'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_codbarras_filtro'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_familia_label" id="hidden_field_label_familia" style="<?php echo $sStyleHidden_familia; ?>"><span id="id_label_familia"><?php echo $this->nm_new_label['familia']; ?></span></TD>
    <TD class="scFormDataOdd css_familia_line" id="hidden_field_data_familia" style="<?php echo $sStyleHidden_familia; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tamanio_label" id="hidden_field_label_tamanio" style="<?php echo $sStyleHidden_tamanio; ?>"><span id="id_label_tamanio"><?php echo $this->nm_new_label['tamanio']; ?></span></TD>
    <TD class="scFormDataOdd css_tamanio_line" id="hidden_field_data_tamanio" style="<?php echo $sStyleHidden_tamanio; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipoletra_label" id="hidden_field_label_tipoletra" style="<?php echo $sStyleHidden_tipoletra; ?>"><span id="id_label_tipoletra"><?php echo $this->nm_new_label['tipoletra']; ?></span></TD>
    <TD class="scFormDataOdd css_tipoletra_line" id="hidden_field_data_tipoletra" style="<?php echo $sStyleHidden_tipoletra; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipoletra'][] = 'Arial'; ?>
 <option  value="Helvetica" <?php  if ($this->tipoletra == "Helvetica") { echo " selected" ;} ?>>Helvetica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipoletra'][] = 'Helvetica'; ?>
 <option  value="sans" <?php  if ($this->tipoletra == "sans") { echo " selected" ;} ?>>sans-serif</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipoletra'][] = 'sans'; ?>
 <option  value="Tahoma" <?php  if ($this->tipoletra == "Tahoma") { echo " selected" ;} ?>>Tahoma</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipoletra'][] = 'Tahoma'; ?>
 <option  value="Georgia" <?php  if ($this->tipoletra == "Georgia") { echo " selected" ;} ?>>Georgia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipoletra'][] = 'Georgia'; ?>
 <option  value="Verdana" <?php  if ($this->tipoletra == "Verdana") { echo " selected" ;} ?>>Verdana</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipoletra'][] = 'Verdana'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numerocolumnas_label" id="hidden_field_label_numerocolumnas" style="<?php echo $sStyleHidden_numerocolumnas; ?>"><span id="id_label_numerocolumnas"><?php echo $this->nm_new_label['numerocolumnas']; ?></span></TD>
    <TD class="scFormDataOdd css_numerocolumnas_line" id="hidden_field_data_numerocolumnas" style="<?php echo $sStyleHidden_numerocolumnas; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipocodbarras_label" id="hidden_field_label_tipocodbarras" style="<?php echo $sStyleHidden_tipocodbarras; ?>"><span id="id_label_tipocodbarras"><?php echo $this->nm_new_label['tipocodbarras']; ?></span></TD>
    <TD class="scFormDataOdd css_tipocodbarras_line" id="hidden_field_data_tipocodbarras" style="<?php echo $sStyleHidden_tipocodbarras; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipocodbarras'][] = 'TYPE_EAN_13'; ?>
 <option  value="TYPE_EAN_8" <?php  if ($this->tipocodbarras == "TYPE_EAN_8") { echo " selected" ;} ?>>TYPE_EAN_8</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipocodbarras'][] = 'TYPE_EAN_8'; ?>
 <option  value="TYPE_EAN_5" <?php  if ($this->tipocodbarras == "TYPE_EAN_5") { echo " selected" ;} ?>>TYPE_EAN_5</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipocodbarras'][] = 'TYPE_EAN_5'; ?>
 <option  value="TYPE_CODE_39" <?php  if ($this->tipocodbarras == "TYPE_CODE_39") { echo " selected" ;} ?>>TYPE_CODE_39</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipocodbarras'][] = 'TYPE_CODE_39'; ?>
 <option  value="TYPE_CODE_128" <?php  if ($this->tipocodbarras == "TYPE_CODE_128") { echo " selected" ;} ?>>TYPE_CODE_128</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipocodbarras'][] = 'TYPE_CODE_128'; ?>
 <option  value="TYPE_CODE_11" <?php  if ($this->tipocodbarras == "TYPE_CODE_11") { echo " selected" ;} ?>>TYPE_CODE_11</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipocodbarras'][] = 'TYPE_CODE_11'; ?>
 <option  value="TYPE_PHARMA_CODE" <?php  if ($this->tipocodbarras == "TYPE_PHARMA_CODE") { echo " selected" ;} ?>>TYPE_PHARMA_CODE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipocodbarras'][] = 'TYPE_PHARMA_CODE'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipoimagen_label" id="hidden_field_label_tipoimagen" style="<?php echo $sStyleHidden_tipoimagen; ?>"><span id="id_label_tipoimagen"><?php echo $this->nm_new_label['tipoimagen']; ?></span></TD>
    <TD class="scFormDataOdd css_tipoimagen_line" id="hidden_field_data_tipoimagen" style="<?php echo $sStyleHidden_tipoimagen; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipoimagen'][] = 'BarcodeGeneratorPNG'; ?>
 <option  value="BarcodeGeneratorSVG" <?php  if ($this->tipoimagen == "BarcodeGeneratorSVG") { echo " selected" ;} ?>>SVG</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipoimagen'][] = 'BarcodeGeneratorSVG'; ?>
 <option  value="BarcodeGeneratorJPG" <?php  if ($this->tipoimagen == "BarcodeGeneratorJPG") { echo " selected" ;} ?>>JPG</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipoimagen'][] = 'BarcodeGeneratorJPG'; ?>
 <option  value="BarcodeGeneratorHTML" <?php  if ($this->tipoimagen == "BarcodeGeneratorHTML") { echo " selected" ;} ?>>HTML</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_tipoimagen'][] = 'BarcodeGeneratorHTML'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_altura_line" id="hidden_field_data_altura" style="<?php echo $sStyleHidden_altura; ?>">
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vercodigo_label" id="hidden_field_label_vercodigo" style="<?php echo $sStyleHidden_vercodigo; ?>"><span id="id_label_vercodigo"><?php echo $this->nm_new_label['vercodigo']; ?></span></TD>
    <TD class="scFormDataOdd css_vercodigo_line" id="hidden_field_data_vercodigo" style="<?php echo $sStyleHidden_vercodigo; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_vercodigo'][] = 'SI'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_verdescripcion_label" id="hidden_field_label_verdescripcion" style="<?php echo $sStyleHidden_verdescripcion; ?>"><span id="id_label_verdescripcion"><?php echo $this->nm_new_label['verdescripcion']; ?></span></TD>
    <TD class="scFormDataOdd css_verdescripcion_line" id="hidden_field_data_verdescripcion" style="<?php echo $sStyleHidden_verdescripcion; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_verdescripcion'][] = 'SI'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_verprecio_label" id="hidden_field_label_verprecio" style="<?php echo $sStyleHidden_verprecio; ?>"><span id="id_label_verprecio"><?php echo $this->nm_new_label['verprecio']; ?></span></TD>
    <TD class="scFormDataOdd css_verprecio_line" id="hidden_field_data_verprecio" style="<?php echo $sStyleHidden_verprecio; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_verprecio'][] = ''; ?>
 <option value="">No Mostrar</option>
 <option  value="preciomen" <?php  if ($this->verprecio == "preciomen") { echo " selected" ;} ?>>PRECIO1</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_verprecio'][] = 'preciomen'; ?>
 <option  value="preciomen2" <?php  if ($this->verprecio == "preciomen2") { echo " selected" ;} ?>>PRECIO2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_verprecio'][] = 'preciomen2'; ?>
 <option  value="preciomen3" <?php  if ($this->verprecio == "preciomen3") { echo " selected" ;} ?>>PRECIO3</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_verprecio'][] = 'preciomen3'; ?>
 <option  value="preciofull" <?php  if ($this->verprecio == "preciofull") { echo " selected" ;} ?>>PRECIOM1</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_verprecio'][] = 'preciofull'; ?>
 <option  value="precio2" <?php  if ($this->verprecio == "precio2") { echo " selected" ;} ?>>PRECIOM2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_verprecio'][] = 'precio2'; ?>
 <option  value="preciomay" <?php  if ($this->verprecio == "preciomay") { echo " selected" ;} ?>>PRECIOM3</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['Lookup_verprecio'][] = 'preciomay'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_titulopersonalizado_label" id="hidden_field_label_titulopersonalizado" style="<?php echo $sStyleHidden_titulopersonalizado; ?>"><span id="id_label_titulopersonalizado"><?php echo $this->nm_new_label['titulopersonalizado']; ?></span></TD>
    <TD class="scFormDataOdd css_titulopersonalizado_line" id="hidden_field_data_titulopersonalizado" style="<?php echo $sStyleHidden_titulopersonalizado; ?>">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['resetar'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = '';
        $buttonMacroLabel = "";
        
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['resetar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['resetar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_label']['resetar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_label']['resetar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_label']['resetar'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "resetar", "scBtnFn_resetar()", "scBtnFn_resetar()", "sc_resetar_bot", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['btn_label']['ok'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_codbarras_filtro");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_codbarras_filtro");
 parent.scAjaxDetailHeight("control_codbarras_filtro", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
