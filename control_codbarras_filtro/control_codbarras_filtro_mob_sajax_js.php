  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_codbarras_filtro_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_codbarras_filtro_mob_form();
	}
...
?>
  ...
  // ---------- Validate familia
  function do_ajax_control_codbarras_filtro_mob_validate_familia()
  {
    var nomeCampo_familia = "familia";
    var var_familia = scAjaxGetFieldSelect(nomeCampo_familia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_mob_validate_familia(var_familia, var_script_case_init, do_ajax_control_codbarras_filtro_mob_validate_familia_cb);
  } // do_ajax_control_codbarras_filtro_mob_validate_familia

  function do_ajax_control_codbarras_filtro_mob_validate_familia_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_mob_validate_familia_cb

  // ---------- Validate codigo
  function do_ajax_control_codbarras_filtro_mob_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_mob_validate_codigo(var_codigo, var_script_case_init, do_ajax_control_codbarras_filtro_mob_validate_codigo_cb);
  } // do_ajax_control_codbarras_filtro_mob_validate_codigo

  function do_ajax_control_codbarras_filtro_mob_validate_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_mob_validate_codigo_cb

  // ---------- Validate descripcion
  function do_ajax_control_codbarras_filtro_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_control_codbarras_filtro_mob_validate_descripcion_cb);
  } // do_ajax_control_codbarras_filtro_mob_validate_descripcion

  function do_ajax_control_codbarras_filtro_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_mob_validate_descripcion_cb

  // ---------- Validate tamanio
  function do_ajax_control_codbarras_filtro_mob_validate_tamanio()
  {
    var nomeCampo_tamanio = "tamanio";
    var var_tamanio = scAjaxGetFieldText(nomeCampo_tamanio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_mob_validate_tamanio(var_tamanio, var_script_case_init, do_ajax_control_codbarras_filtro_mob_validate_tamanio_cb);
  } // do_ajax_control_codbarras_filtro_mob_validate_tamanio

  function do_ajax_control_codbarras_filtro_mob_validate_tamanio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tamanio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_mob_validate_tamanio_cb

  // ---------- Validate tipoletra
  function do_ajax_control_codbarras_filtro_mob_validate_tipoletra()
  {
    var nomeCampo_tipoletra = "tipoletra";
    var var_tipoletra = scAjaxGetFieldSelect(nomeCampo_tipoletra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_mob_validate_tipoletra(var_tipoletra, var_script_case_init, do_ajax_control_codbarras_filtro_mob_validate_tipoletra_cb);
  } // do_ajax_control_codbarras_filtro_mob_validate_tipoletra

  function do_ajax_control_codbarras_filtro_mob_validate_tipoletra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipoletra";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_mob_validate_tipoletra_cb

  // ---------- Validate numerocolumnas
  function do_ajax_control_codbarras_filtro_mob_validate_numerocolumnas()
  {
    var nomeCampo_numerocolumnas = "numerocolumnas";
    var var_numerocolumnas = scAjaxGetFieldText(nomeCampo_numerocolumnas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_mob_validate_numerocolumnas(var_numerocolumnas, var_script_case_init, do_ajax_control_codbarras_filtro_mob_validate_numerocolumnas_cb);
  } // do_ajax_control_codbarras_filtro_mob_validate_numerocolumnas

  function do_ajax_control_codbarras_filtro_mob_validate_numerocolumnas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numerocolumnas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_mob_validate_numerocolumnas_cb

  // ---------- Validate tipocodbarras
  function do_ajax_control_codbarras_filtro_mob_validate_tipocodbarras()
  {
    var nomeCampo_tipocodbarras = "tipocodbarras";
    var var_tipocodbarras = scAjaxGetFieldSelect(nomeCampo_tipocodbarras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_mob_validate_tipocodbarras(var_tipocodbarras, var_script_case_init, do_ajax_control_codbarras_filtro_mob_validate_tipocodbarras_cb);
  } // do_ajax_control_codbarras_filtro_mob_validate_tipocodbarras

  function do_ajax_control_codbarras_filtro_mob_validate_tipocodbarras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipocodbarras";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_mob_validate_tipocodbarras_cb

  // ---------- Validate tipoimagen
  function do_ajax_control_codbarras_filtro_mob_validate_tipoimagen()
  {
    var nomeCampo_tipoimagen = "tipoimagen";
    var var_tipoimagen = scAjaxGetFieldSelect(nomeCampo_tipoimagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_mob_validate_tipoimagen(var_tipoimagen, var_script_case_init, do_ajax_control_codbarras_filtro_mob_validate_tipoimagen_cb);
  } // do_ajax_control_codbarras_filtro_mob_validate_tipoimagen

  function do_ajax_control_codbarras_filtro_mob_validate_tipoimagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipoimagen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_mob_validate_tipoimagen_cb

  // ---------- Validate altura
  function do_ajax_control_codbarras_filtro_mob_validate_altura()
  {
    var nomeCampo_altura = "altura";
    var var_altura = scAjaxGetFieldText(nomeCampo_altura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_mob_validate_altura(var_altura, var_script_case_init, do_ajax_control_codbarras_filtro_mob_validate_altura_cb);
  } // do_ajax_control_codbarras_filtro_mob_validate_altura

  function do_ajax_control_codbarras_filtro_mob_validate_altura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "altura";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_mob_validate_altura_cb

  // ---------- Validate vercodigo
  function do_ajax_control_codbarras_filtro_mob_validate_vercodigo()
  {
    var nomeCampo_vercodigo = "vercodigo";
    var var_vercodigo = scAjaxGetFieldCheckbox(nomeCampo_vercodigo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_mob_validate_vercodigo(var_vercodigo, var_script_case_init, do_ajax_control_codbarras_filtro_mob_validate_vercodigo_cb);
  } // do_ajax_control_codbarras_filtro_mob_validate_vercodigo

  function do_ajax_control_codbarras_filtro_mob_validate_vercodigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vercodigo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_mob_validate_vercodigo_cb

  // ---------- Validate verdescripcion
  function do_ajax_control_codbarras_filtro_mob_validate_verdescripcion()
  {
    var nomeCampo_verdescripcion = "verdescripcion";
    var var_verdescripcion = scAjaxGetFieldCheckbox(nomeCampo_verdescripcion, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_mob_validate_verdescripcion(var_verdescripcion, var_script_case_init, do_ajax_control_codbarras_filtro_mob_validate_verdescripcion_cb);
  } // do_ajax_control_codbarras_filtro_mob_validate_verdescripcion

  function do_ajax_control_codbarras_filtro_mob_validate_verdescripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "verdescripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_mob_validate_verdescripcion_cb

  // ---------- Validate verprecio
  function do_ajax_control_codbarras_filtro_mob_validate_verprecio()
  {
    var nomeCampo_verprecio = "verprecio";
    var var_verprecio = scAjaxGetFieldSelect(nomeCampo_verprecio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_mob_validate_verprecio(var_verprecio, var_script_case_init, do_ajax_control_codbarras_filtro_mob_validate_verprecio_cb);
  } // do_ajax_control_codbarras_filtro_mob_validate_verprecio

  function do_ajax_control_codbarras_filtro_mob_validate_verprecio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "verprecio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_mob_validate_verprecio_cb

  // ---------- Validate titulopersonalizado
  function do_ajax_control_codbarras_filtro_mob_validate_titulopersonalizado()
  {
    var nomeCampo_titulopersonalizado = "titulopersonalizado";
    var var_titulopersonalizado = scAjaxGetFieldText(nomeCampo_titulopersonalizado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_mob_validate_titulopersonalizado(var_titulopersonalizado, var_script_case_init, do_ajax_control_codbarras_filtro_mob_validate_titulopersonalizado_cb);
  } // do_ajax_control_codbarras_filtro_mob_validate_titulopersonalizado

  function do_ajax_control_codbarras_filtro_mob_validate_titulopersonalizado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "titulopersonalizado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_mob_validate_titulopersonalizado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_codbarras_filtro_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_codbarras_filtro_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_familia = scAjaxGetFieldSelect("familia");
    var var_codigo = scAjaxGetFieldText("codigo");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_tamanio = scAjaxGetFieldText("tamanio");
    var var_tipoletra = scAjaxGetFieldSelect("tipoletra");
    var var_numerocolumnas = scAjaxGetFieldText("numerocolumnas");
    var var_tipocodbarras = scAjaxGetFieldSelect("tipocodbarras");
    var var_tipoimagen = scAjaxGetFieldSelect("tipoimagen");
    var var_altura = scAjaxGetFieldText("altura");
    var var_vercodigo = scAjaxGetFieldCheckbox("vercodigo", ";");
    var var_verdescripcion = scAjaxGetFieldCheckbox("verdescripcion", ";");
    var var_verprecio = scAjaxGetFieldSelect("verprecio");
    var var_titulopersonalizado = scAjaxGetFieldText("titulopersonalizado");
    ...
    scAjaxProcOn();
    x_ajax_control_codbarras_filtro_mob_submit_form(var_familia, var_codigo, var_descripcion, var_tamanio, var_tipoletra, var_numerocolumnas, var_tipocodbarras, var_tipoimagen, var_altura, var_vercodigo, var_verdescripcion, var_verprecio, var_titulopersonalizado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_codbarras_filtro_mob_submit_form_cb);
  } // do_ajax_control_codbarras_filtro_mob_submit_form

  function do_ajax_control_codbarras_filtro_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_codbarras_filtro_mob_submit_form_cb_after_alert);
  } // do_ajax_control_codbarras_filtro_mob_submit_form_cb
  function do_ajax_control_codbarras_filtro_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_codbarras_filtro_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_codbarras_filtro_mob_navigate_form()
  {
    perform_ajax_control_codbarras_filtro_mob_navigate_form();
  }

  function perform_ajax_control_codbarras_filtro_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_codbarras_filtro_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_codbarras_filtro_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_codbarras_filtro_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_codbarras_filtro_mob_navigate_form_cb
  function do_ajax_control_codbarras_filtro_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_codbarras_filtro_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_codbarras_filtro_mob_navigate_form_cb_after_alert
  function sc_hide_control_codbarras_filtro_mob_form()
  {
  ...
  ajax_field_list[0] = "familia";
  ajax_field_list[1] = "codigo";
  ajax_field_list[2] = "descripcion";
  ajax_field_list[3] = "tamanio";
  ajax_field_list[4] = "tipoletra";
  ajax_field_list[5] = "numerocolumnas";
  ajax_field_list[6] = "tipocodbarras";
  ajax_field_list[7] = "tipoimagen";
  ajax_field_list[8] = "altura";
  ajax_field_list[9] = "vercodigo";
  ajax_field_list[10] = "verdescripcion";
  ajax_field_list[11] = "verprecio";
  ajax_field_list[12] = "titulopersonalizado";
  ...
  var ajax_error_list = {
    "familia": {"label": "Grupo/Familia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "tamanio": {"label": "Tamaño Letra", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipoletra": {"label": "Tipo Letra", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "numerocolumnas": {"label": "Columnas  por Hoja", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipocodbarras": {"label": "Tipo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipoimagen": {"label": "Tipo Imagen", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "altura": {"label": "Altura", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vercodigo": {"label": "Ver Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "verdescripcion": {"label": "Ver Descripción", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "verprecio": {"label": " Ver Precio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "titulopersonalizado": {"label": "Titulo Reporte", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "tamanio": new Array(),
    "tipoletra": new Array(),
    "numerocolumnas": new Array(),
    "tipocodbarras": new Array(),
    "tipoimagen": new Array(),
    "altura": new Array(),
    "vercodigo": new Array(),
    "verdescripcion": new Array(),
    "verprecio": new Array(),
    "titulopersonalizado": new Array()
  };
  ajax_field_mult["familia"][1] = "familia";
  ajax_field_mult["codigo"][1] = "codigo";
  ajax_field_mult["descripcion"][1] = "descripcion";
  ajax_field_mult["tamanio"][1] = "tamanio";
  ajax_field_mult["tipoletra"][1] = "tipoletra";
  ajax_field_mult["numerocolumnas"][1] = "numerocolumnas";
  ajax_field_mult["tipocodbarras"][1] = "tipocodbarras";
  ajax_field_mult["tipoimagen"][1] = "tipoimagen";
  ajax_field_mult["altura"][1] = "altura";
  ajax_field_mult["vercodigo"][1] = "vercodigo";
  ajax_field_mult["verdescripcion"][1] = "verdescripcion";
  ajax_field_mult["verprecio"][1] = "verprecio";
  ajax_field_mult["titulopersonalizado"][1] = "titulopersonalizado";

  var ajax_field_id = {
    "familia": new Array("hidden_field_label_familia", "hidden_field_data_familia"),
    ...
    "tamanio": new Array("hidden_field_label_tamanio", "hidden_field_data_tamanio"),
    "tipoletra": new Array("hidden_field_label_tipoletra", "hidden_field_data_tipoletra"),
    "numerocolumnas": new Array("hidden_field_label_numerocolumnas", "hidden_field_data_numerocolumnas"),
    "tipocodbarras": new Array("hidden_field_label_tipocodbarras", "hidden_field_data_tipocodbarras"),
    "tipoimagen": new Array("hidden_field_label_tipoimagen", "hidden_field_data_tipoimagen"),
    "altura": new Array("hidden_field_label_altura", "hidden_field_data_altura"),
    "vercodigo": new Array("hidden_field_label_vercodigo", "hidden_field_data_vercodigo"),
    "verdescripcion": new Array("hidden_field_label_verdescripcion", "hidden_field_data_verdescripcion"),
    "verprecio": new Array("hidden_field_label_verprecio", "hidden_field_data_verprecio"),
    "titulopersonalizado": new Array("hidden_field_label_titulopersonalizado", "hidden_field_data_titulopersonalizado")
  };
