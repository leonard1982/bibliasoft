  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_codbarras_filtro" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_codbarras_filtro_form();
	}
  ...
  // ---------- Validate familia
  function do_ajax_control_codbarras_filtro_validate_familia()
  {
    var nomeCampo_familia = "familia";
    var var_familia = scAjaxGetFieldSelect(nomeCampo_familia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_validate_familia(var_familia, var_script_case_init, do_ajax_control_codbarras_filtro_validate_familia_cb);
  } // do_ajax_control_codbarras_filtro_validate_familia

  function do_ajax_control_codbarras_filtro_validate_familia_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_validate_familia_cb

  // ---------- Validate codigo
  function do_ajax_control_codbarras_filtro_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_validate_codigo(var_codigo, var_script_case_init, do_ajax_control_codbarras_filtro_validate_codigo_cb);
  } // do_ajax_control_codbarras_filtro_validate_codigo

  function do_ajax_control_codbarras_filtro_validate_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_validate_codigo_cb

  // ---------- Validate descripcion
  function do_ajax_control_codbarras_filtro_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_control_codbarras_filtro_validate_descripcion_cb);
  } // do_ajax_control_codbarras_filtro_validate_descripcion

  function do_ajax_control_codbarras_filtro_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_validate_descripcion_cb

  // ---------- Validate tamanio
  function do_ajax_control_codbarras_filtro_validate_tamanio()
  {
    var nomeCampo_tamanio = "tamanio";
    var var_tamanio = scAjaxGetFieldText(nomeCampo_tamanio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_validate_tamanio(var_tamanio, var_script_case_init, do_ajax_control_codbarras_filtro_validate_tamanio_cb);
  } // do_ajax_control_codbarras_filtro_validate_tamanio

  function do_ajax_control_codbarras_filtro_validate_tamanio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tamanio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_validate_tamanio_cb

  // ---------- Validate tipoletra
  function do_ajax_control_codbarras_filtro_validate_tipoletra()
  {
    var nomeCampo_tipoletra = "tipoletra";
    var var_tipoletra = scAjaxGetFieldSelect(nomeCampo_tipoletra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_validate_tipoletra(var_tipoletra, var_script_case_init, do_ajax_control_codbarras_filtro_validate_tipoletra_cb);
  } // do_ajax_control_codbarras_filtro_validate_tipoletra

  function do_ajax_control_codbarras_filtro_validate_tipoletra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_validate_tipoletra_cb

  // ---------- Validate numerocolumnas
  function do_ajax_control_codbarras_filtro_validate_numerocolumnas()
  {
    var nomeCampo_numerocolumnas = "numerocolumnas";
    var var_numerocolumnas = scAjaxGetFieldText(nomeCampo_numerocolumnas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_validate_numerocolumnas(var_numerocolumnas, var_script_case_init, do_ajax_control_codbarras_filtro_validate_numerocolumnas_cb);
  } // do_ajax_control_codbarras_filtro_validate_numerocolumnas

  function do_ajax_control_codbarras_filtro_validate_numerocolumnas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_validate_numerocolumnas_cb

  // ---------- Validate tipocodbarras
  function do_ajax_control_codbarras_filtro_validate_tipocodbarras()
  {
    var nomeCampo_tipocodbarras = "tipocodbarras";
    var var_tipocodbarras = scAjaxGetFieldSelect(nomeCampo_tipocodbarras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_validate_tipocodbarras(var_tipocodbarras, var_script_case_init, do_ajax_control_codbarras_filtro_validate_tipocodbarras_cb);
  } // do_ajax_control_codbarras_filtro_validate_tipocodbarras

  function do_ajax_control_codbarras_filtro_validate_tipocodbarras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_validate_tipocodbarras_cb

  // ---------- Validate tipoimagen
  function do_ajax_control_codbarras_filtro_validate_tipoimagen()
  {
    var nomeCampo_tipoimagen = "tipoimagen";
    var var_tipoimagen = scAjaxGetFieldSelect(nomeCampo_tipoimagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_validate_tipoimagen(var_tipoimagen, var_script_case_init, do_ajax_control_codbarras_filtro_validate_tipoimagen_cb);
  } // do_ajax_control_codbarras_filtro_validate_tipoimagen

  function do_ajax_control_codbarras_filtro_validate_tipoimagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_validate_tipoimagen_cb

  // ---------- Validate altura
  function do_ajax_control_codbarras_filtro_validate_altura()
  {
    var nomeCampo_altura = "altura";
    var var_altura = scAjaxGetFieldText(nomeCampo_altura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_validate_altura(var_altura, var_script_case_init, do_ajax_control_codbarras_filtro_validate_altura_cb);
  } // do_ajax_control_codbarras_filtro_validate_altura

  function do_ajax_control_codbarras_filtro_validate_altura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "altura";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_validate_altura_cb

  // ---------- Validate vercodigo
  function do_ajax_control_codbarras_filtro_validate_vercodigo()
  {
    var nomeCampo_vercodigo = "vercodigo";
    var var_vercodigo = scAjaxGetFieldCheckbox(nomeCampo_vercodigo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_validate_vercodigo(var_vercodigo, var_script_case_init, do_ajax_control_codbarras_filtro_validate_vercodigo_cb);
  } // do_ajax_control_codbarras_filtro_validate_vercodigo

  function do_ajax_control_codbarras_filtro_validate_vercodigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_validate_vercodigo_cb

  // ---------- Validate verdescripcion
  function do_ajax_control_codbarras_filtro_validate_verdescripcion()
  {
    var nomeCampo_verdescripcion = "verdescripcion";
    var var_verdescripcion = scAjaxGetFieldCheckbox(nomeCampo_verdescripcion, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_validate_verdescripcion(var_verdescripcion, var_script_case_init, do_ajax_control_codbarras_filtro_validate_verdescripcion_cb);
  } // do_ajax_control_codbarras_filtro_validate_verdescripcion

  function do_ajax_control_codbarras_filtro_validate_verdescripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_validate_verdescripcion_cb

  // ---------- Validate verprecio
  function do_ajax_control_codbarras_filtro_validate_verprecio()
  {
    var nomeCampo_verprecio = "verprecio";
    var var_verprecio = scAjaxGetFieldSelect(nomeCampo_verprecio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_validate_verprecio(var_verprecio, var_script_case_init, do_ajax_control_codbarras_filtro_validate_verprecio_cb);
  } // do_ajax_control_codbarras_filtro_validate_verprecio

  function do_ajax_control_codbarras_filtro_validate_verprecio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_validate_verprecio_cb

  // ---------- Validate titulopersonalizado
  function do_ajax_control_codbarras_filtro_validate_titulopersonalizado()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_codbarras_filtro_validate_titulopersonalizado(var_titulopersonalizado, var_script_case_init, do_ajax_control_codbarras_filtro_validate_titulopersonalizado_cb);
  } // do_ajax_control_codbarras_filtro_validate_titulopersonalizado

  function do_ajax_control_codbarras_filtro_validate_titulopersonalizado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_codbarras_filtro_validate_titulopersonalizado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_codbarras_filtro_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_codbarras_filtro_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_codbarras_filtro_submit_form(var_familia, var_codigo, var_descripcion, var_tamanio, var_tipoletra, var_numerocolumnas, var_tipocodbarras, var_tipoimagen, var_altura, var_vercodigo, var_verdescripcion, var_verprecio, var_titulopersonalizado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_codbarras_filtro_submit_form_cb);
  } // do_ajax_control_codbarras_filtro_submit_form

  function do_ajax_control_codbarras_filtro_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_codbarras_filtro_submit_form_cb_after_alert);
  } // do_ajax_control_codbarras_filtro_submit_form_cb
  function do_ajax_control_codbarras_filtro_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_codbarras_filtro_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_codbarras_filtro_navigate_form()
  {
    perform_ajax_control_codbarras_filtro_navigate_form();
  }

  function perform_ajax_control_codbarras_filtro_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_codbarras_filtro_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_codbarras_filtro']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_codbarras_filtro_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_codbarras_filtro_navigate_form_cb_after_alert);
  } // do_ajax_control_codbarras_filtro_navigate_form_cb
  function do_ajax_control_codbarras_filtro_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_codbarras_filtro_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_codbarras_filtro_navigate_form_cb_after_alert
  function sc_hide_control_codbarras_filtro_form()
  {
