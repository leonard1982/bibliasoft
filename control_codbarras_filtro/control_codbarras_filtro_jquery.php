...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_familia' + iSeqRow).bind('blur', function() { sc_control_codbarras_filtro_familia_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_control_codbarras_filtro_familia_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_codigo' + iSeqRow).bind('blur', function() { sc_control_codbarras_filtro_codigo_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_control_codbarras_filtro_codigo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_descripcion' + iSeqRow).bind('blur', function() { sc_control_codbarras_filtro_descripcion_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_control_codbarras_filtro_descripcion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tamanio' + iSeqRow).bind('blur', function() { sc_control_codbarras_filtro_tamanio_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_control_codbarras_filtro_tamanio_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tipoletra' + iSeqRow).bind('blur', function() { sc_control_codbarras_filtro_tipoletra_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_control_codbarras_filtro_tipoletra_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_numerocolumnas' + iSeqRow).bind('blur', function() { sc_control_codbarras_filtro_numerocolumnas_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_control_codbarras_filtro_numerocolumnas_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tipocodbarras' + iSeqRow).bind('blur', function() { sc_control_codbarras_filtro_tipocodbarras_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_control_codbarras_filtro_tipocodbarras_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tipoimagen' + iSeqRow).bind('blur', function() { sc_control_codbarras_filtro_tipoimagen_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_control_codbarras_filtro_tipoimagen_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_titulopersonalizado' + iSeqRow).bind('blur', function() { sc_control_codbarras_filtro_titulopersonalizado_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_control_codbarras_filtro_titulopersonalizado_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_vercodigo' + iSeqRow).bind('blur', function() { sc_control_codbarras_filtro_vercodigo_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_control_codbarras_filtro_vercodigo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_verdescripcion' + iSeqRow).bind('blur', function() { sc_control_codbarras_filtro_verdescripcion_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_control_codbarras_filtro_verdescripcion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_verprecio' + iSeqRow).bind('blur', function() { sc_control_codbarras_filtro_verprecio_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_control_codbarras_filtro_verprecio_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_altura' + iSeqRow).bind('blur', function() { sc_control_codbarras_filtro_altura_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_control_codbarras_filtro_altura_onchange(this, iSeqRow) })
...
function sc_control_codbarras_filtro_familia_onblur(oThis, iSeqRow) {
  do_ajax_control_codbarras_filtro_validate_familia();
  scCssBlur(oThis);
}

function sc_control_codbarras_filtro_familia_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_codbarras_filtro_codigo_onblur(oThis, iSeqRow) {
  do_ajax_control_codbarras_filtro_validate_codigo();
  scCssBlur(oThis);
}

function sc_control_codbarras_filtro_codigo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_codbarras_filtro_descripcion_onblur(oThis, iSeqRow) {
  do_ajax_control_codbarras_filtro_validate_descripcion();
  scCssBlur(oThis);
}

function sc_control_codbarras_filtro_descripcion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_codbarras_filtro_tamanio_onblur(oThis, iSeqRow) {
  do_ajax_control_codbarras_filtro_validate_tamanio();
  scCssBlur(oThis);
}

function sc_control_codbarras_filtro_tamanio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_codbarras_filtro_tipoletra_onblur(oThis, iSeqRow) {
  do_ajax_control_codbarras_filtro_validate_tipoletra();
  scCssBlur(oThis);
}

function sc_control_codbarras_filtro_tipoletra_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_codbarras_filtro_numerocolumnas_onblur(oThis, iSeqRow) {
  do_ajax_control_codbarras_filtro_validate_numerocolumnas();
  scCssBlur(oThis);
}

function sc_control_codbarras_filtro_numerocolumnas_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_codbarras_filtro_tipocodbarras_onblur(oThis, iSeqRow) {
  do_ajax_control_codbarras_filtro_validate_tipocodbarras();
  scCssBlur(oThis);
}

function sc_control_codbarras_filtro_tipocodbarras_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_codbarras_filtro_tipoimagen_onblur(oThis, iSeqRow) {
  do_ajax_control_codbarras_filtro_validate_tipoimagen();
  scCssBlur(oThis);
}

function sc_control_codbarras_filtro_tipoimagen_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_codbarras_filtro_titulopersonalizado_onblur(oThis, iSeqRow) {
  do_ajax_control_codbarras_filtro_validate_titulopersonalizado();
  scCssBlur(oThis);
}

function sc_control_codbarras_filtro_titulopersonalizado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_codbarras_filtro_vercodigo_onblur(oThis, iSeqRow) {
  do_ajax_control_codbarras_filtro_validate_vercodigo();
  scCssBlur(oThis);
}

function sc_control_codbarras_filtro_vercodigo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_codbarras_filtro_verdescripcion_onblur(oThis, iSeqRow) {
  do_ajax_control_codbarras_filtro_validate_verdescripcion();
  scCssBlur(oThis);
}

function sc_control_codbarras_filtro_verdescripcion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_codbarras_filtro_verprecio_onblur(oThis, iSeqRow) {
  do_ajax_control_codbarras_filtro_validate_verprecio();
  scCssBlur(oThis);
}

function sc_control_codbarras_filtro_verprecio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_codbarras_filtro_altura_onblur(oThis, iSeqRow) {
  do_ajax_control_codbarras_filtro_validate_altura();
  scCssBlur(oThis);
}

function sc_control_codbarras_filtro_altura_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_control_codbarras_filtro_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'control_codbarras_filtro')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
