<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_log_25092021']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_log_25092021_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_log_25092021_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idlog"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_25092021']['labels']["idlog"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['labels']["idlog"] : "Idlog";
   $tab_ger_campos['fechayhora'] = "on";
   $tab_def_campos['fechayhora'] = "fechayhora";
   $tab_labels["fechayhora"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_25092021']['labels']["fechayhora"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['labels']["fechayhora"] : "Fechayhora";
   $tab_ger_campos['usuario'] = "on";
   $tab_def_campos['usuario'] = "usuario";
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_25092021']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['accion'] = "on";
   $tab_def_campos['accion'] = "accion";
   $tab_labels["accion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_25092021']['labels']["accion"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['labels']["accion"] : "Accion";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_25092021']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['labels']["observaciones"] : "Observaciones";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_log_25092021']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_log_25092021']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_log_25092021']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_log_25092021_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_log_25092021']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
