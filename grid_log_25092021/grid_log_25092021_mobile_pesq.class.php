...
class grid_log_25092021_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_log_25092021_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_log_25092021_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_log_25092021_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_usuario($usuario)
   {
      ...
      { 
          $nm_comando = "select idtercero, documento||' - '||nombres from terceros where   CAST (documento||' - '||nombres AS TEXT)  like '%" . $usuario . "%' order by documento, nombres" ; 
      } 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_log_25092021/grid_log_25092021_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_log_25092021_ajax_search.js"></script>
 <script type="text/javascript" src="grid_log_25092021_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_log_25092021_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_log_25092021']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_log_25092021']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_fechayhora_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fechayhora_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fechayhora_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fechayhora_ano').value;
          document.getElementById('sc_fechayhora_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fechayhora_dia').value = aParts[0];
          document.getElementById('SC_fechayhora_mes').value = aParts[1];
          document.getElementById('SC_fechayhora_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_fechayhora_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fechayhora_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fechayhora_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fechayhora_input_2_ano').value;
          document.getElementById('sc_fechayhora_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fechayhora_input_2_dia').value = aParts[0];
          document.getElementById('SC_fechayhora_input_2_mes').value = aParts[1];
          document.getElementById('SC_fechayhora_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_fechayhora_ano#NMF#' + search_get_sel_txt('SC_fechayhora_ano') + '@NMF@';
  str_out += 'SC_fechayhora_input_2_dia#NMF#' + search_get_sel_txt('SC_fechayhora_input_2_dia') + '@NMF@';
  str_out += 'SC_fechayhora_input_2_mes#NMF#' + search_get_sel_txt('SC_fechayhora_input_2_mes') + '@NMF@';
  str_out += 'SC_fechayhora_input_2_ano#NMF#' + search_get_sel_txt('SC_fechayhora_input_2_ano') + '@NMF@';
  str_out += 'SC_fechayhora_hor#NMF#' + search_get_sel_txt('SC_fechayhora_hor') + '@NMF@';
  str_out += 'SC_fechayhora_min#NMF#' + search_get_sel_txt('SC_fechayhora_min') + '@NMF@';
  str_out += 'SC_fechayhora_seg#NMF#' + search_get_sel_txt('SC_fechayhora_seg') + '@NMF@';
  str_out += 'SC_fechayhora_input_2_hor#NMF#' + search_get_sel_txt('SC_fechayhora_input_2_hor') + '@NMF@';
  str_out += 'SC_fechayhora_input_2_min#NMF#' + search_get_sel_txt('SC_fechayhora_input_2_min') + '@NMF@';
  str_out += 'SC_fechayhora_input_2_seg#NMF#' + search_get_sel_txt('SC_fechayhora_input_2_seg') + '@NMF@';
  ...
  str_out += 'SC_accion_cond#NMF#' + search_get_sel_txt('SC_accion_cond') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Log de auditoría de usuarios</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fechayhora_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_dia']; 
          $fechayhora_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_mes']; 
          $fechayhora_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_ano']; 
          $fechayhora_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_input_2_dia']; 
          $fechayhora_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_input_2_mes']; 
          $fechayhora_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_input_2_ano']; 
          $fechayhora_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_hor']; 
          $fechayhora_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_min']; 
          $fechayhora_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_seg']; 
          $fechayhora_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_input_2_hor']; 
          $fechayhora_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_input_2_min']; 
          $fechayhora_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_input_2_seg']; 
          $fechayhora_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_cond']; 
          $usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['usuario']; 
          $usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['usuario_cond']; 
          $accion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['accion']; 
          $accion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['accion_cond']; 
          $observaciones = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['observaciones']; 
          $observaciones_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['observaciones_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($accion_cond) || empty($accion_cond))
      {
         $accion_cond = "eq";
      }
      ...
      if (isset($fechayhora) && !empty($fechayhora))
      {
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <INPUT type="hidden" id="SC_fechayhora_cond" name="fechayhora_cond" value="bw">
 ...
 $nmgp_tab_label .= "fechayhora?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_fechayhora"  <?php echo $str_hide_fechayhora?>>
<?php
...
<?php
  ...
  {
?>
<span id='id_date_part_fechayhora_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechayhora_dia" name="fechayhora_dia" value="<?php echo NM_encode_input($fechayhora_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechayhora_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechayhora_mes" name="fechayhora_mes" value="<?php echo NM_encode_input($fechayhora_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechayhora_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechayhora_ano" name="fechayhora_ano" value="<?php echo NM_encode_input($fechayhora_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechayhora_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechayhora_hor" name="fechayhora_hor" value="<?php echo NM_encode_input($fechayhora_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechayhora_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechayhora_min" name="fechayhora_min" value="<?php echo NM_encode_input($fechayhora_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechayhora_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechayhora_seg" name="fechayhora_seg" value="<?php echo NM_encode_input($fechayhora_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<INPUT type="hidden" id="sc_fechayhora_jq">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechayhora_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechayhora_input_2_dia" name="fechayhora_input_2_dia" value="<?php echo NM_encode_input($fechayhora_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechayhora_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechayhora_input_2_mes" name="fechayhora_input_2_mes" value="<?php echo NM_encode_input($fechayhora_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechayhora_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechayhora_input_2_ano" name="fechayhora_input_2_ano" value="<?php echo NM_encode_input($fechayhora_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechayhora_input_2_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechayhora_input_2_hor" name="fechayhora_input_2_hor" value="<?php echo NM_encode_input($fechayhora_input_2_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechayhora_input_2_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechayhora_input_2_min" name="fechayhora_input_2_min" value="<?php echo NM_encode_input($fechayhora_input_2_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechayhora_input_2_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechayhora_input_2_seg" name="fechayhora_input_2_seg" value="<?php echo NM_encode_input($fechayhora_input_2_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<INPUT type="hidden" id="sc_fechayhora_jq2">
</span>
...
?>
 ...
 $SC_Label = (isset($this->New_label['usuario'])) ? $this->New_label['usuario'] : "Usuario Tercero";
...
?>
<INPUT  type="text" id="SC_usuario" name="usuario" value="<?php echo NM_encode_input($usuario) ?>"  size=11 alt="{datatype: 'text', maxLength: 11, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_usuario" name="usuario_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <INPUT type="hidden" id="SC_accion_cond" name="accion_cond" value="eq">

    <TD nowrap class="scFilterLabelOdd" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['accion'])) ? $this->New_label['accion'] : "Accion";
 $nmgp_tab_label .= "accion?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_accion"  <?php echo $str_hide_accion?>> 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['psq_check_ret']['accion'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['psq_check_ret']['accion'][] = "AGREGAR";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['psq_check_ret']['accion'][] = "EDITAR";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['psq_check_ret']['accion'][] = "ELIMINAR";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['psq_check_ret']['accion'][] = "CONSULTAR";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['psq_check_ret']['accion'][] = "OTRO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['psq_check_ret']['accion'][] = "ABRIR";
 ?>
<?php if (!isset($accion)) {$accion = explode(";", $accion);} ?>
 <SELECT class="scFilterObjectOdd" id="SC_accion" name="accion[]"  size="7" multiple>
 <OPTION value="AGREGAR##@@AGREGAR" <?php if (in_array("AGREGAR", $accion)) { echo " selected" ;} ?>>AGREGAR</option>
 <OPTION value="EDITAR##@@EDITAR" <?php if (in_array("EDITAR", $accion)) { echo " selected" ;} ?>>EDITAR</option>
 <OPTION value="ELIMINAR##@@ELIMINAR" <?php if (in_array("ELIMINAR", $accion)) { echo " selected" ;} ?>>ELIMINAR</option>
 <OPTION value="CONSULTAR##@@CONSULTAR" <?php if (in_array("CONSULTAR", $accion)) { echo " selected" ;} ?>>CONSULTAR</option>
 <OPTION value="OTRO##@@OTRO" <?php if (in_array("OTRO", $accion)) { echo " selected" ;} ?>>OTRO</option>
 <OPTION value="ABRIR##@@ABRIR" <?php if (in_array("ABRIR", $accion)) { echo " selected" ;} ?>>ABRIR</option>
 </SELECT>
 </TD>
...
<?php
   if (is_file("grid_log_25092021_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_log_25092021']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_log_25092021']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fechayhora_mes.value = "";
   document.F1.fechayhora_ano.value = "";
   document.F1.fechayhora_input_2_dia.value = "";
   document.F1.fechayhora_input_2_mes.value = "";
   document.F1.fechayhora_input_2_ano.value = "";
   document.F1.fechayhora_hor.value = "";
   document.F1.fechayhora_min.value = "";
   document.F1.fechayhora_seg.value = "";
   document.F1.fechayhora_input_2_hor.value = "";
   document.F1.fechayhora_input_2_min.value = "";
   document.F1.fechayhora_input_2_seg.value = "";
   ...
   document.F1.accion_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_accion'), document.F1.accion_cond, 'accion');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'accion[]')
      {
 ...
 {
    $('#SC_fechayhora_dia').bind('change', function() {sc_grid_log_25092021_valida_dia(this)});
    $('#SC_fechayhora_hor').bind('change', function() {sc_grid_log_25092021_valida_hora(this)});
    $('#SC_fechayhora_input_2_dia').bind('change', function() {sc_grid_log_25092021_valida_dia(this)});
    $('#SC_fechayhora_input_2_hor').bind('change', function() {sc_grid_log_25092021_valida_hora(this)});
    $('#SC_fechayhora_input_2_mes').bind('change', function() {sc_grid_log_25092021_valida_mes(this)});
    $('#SC_fechayhora_input_2_min').bind('change', function() {sc_grid_log_25092021_valida_min(this)});
    $('#SC_fechayhora_input_2_seg').bind('change', function() {sc_grid_log_25092021_valida_seg(this)});
    $('#SC_fechayhora_mes').bind('change', function() {sc_grid_log_25092021_valida_mes(this)});
    $('#SC_fechayhora_min').bind('change', function() {sc_grid_log_25092021_valida_min(this)});
    $('#SC_fechayhora_seg').bind('change', function() {sc_grid_log_25092021_valida_seg(this)});
 }
 function sc_grid_log_25092021_valida_dia(obj)
 {
 ...
 function sc_grid_log_25092021_valida_mes(obj)
 {
 ...
 function sc_grid_log_25092021_valida_hora(obj)
 {
 ...
 function sc_grid_log_25092021_valida_min(obj)
 {
 ...
 function sc_grid_log_25092021_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fechayhora_ano'] = 'text';
      $tp_fields['SC_fechayhora_input_2_dia'] = 'text';
      $tp_fields['SC_fechayhora_input_2_mes'] = 'text';
      $tp_fields['SC_fechayhora_input_2_ano'] = 'text';
      $tp_fields['SC_fechayhora_hor'] = 'text';
      $tp_fields['SC_fechayhora_min'] = 'text';
      $tp_fields['SC_fechayhora_seg'] = 'text';
      $tp_fields['SC_fechayhora_input_2_hor'] = 'text';
      $tp_fields['SC_fechayhora_input_2_min'] = 'text';
      $tp_fields['SC_fechayhora_input_2_seg'] = 'text';
   ...
   function trata_campos()
   {
      ...
      {
          $fechayhora_input_2_dia = $fechayhora_dia;
      }
      if (!isset($fechayhora_input_2_mes) || $fechayhora_input_2_mes == "")
      {
          $fechayhora_input_2_mes = $fechayhora_mes;
      }
      if (!isset($fechayhora_input_2_ano) || $fechayhora_input_2_ano == "")
      {
          $fechayhora_input_2_ano = $fechayhora_ano;
      }
      if (!isset($fechayhora_input_2_hor) || $fechayhora_input_2_hor == "")
      {
          $fechayhora_input_2_hor = $fechayhora_hor;
      }
      if (!isset($fechayhora_input_2_min) || $fechayhora_input_2_min == "")
      {
          $fechayhora_input_2_min = $fechayhora_min;
      }
      if (!isset($fechayhora_input_2_seg) || $fechayhora_input_2_seg == "")
      {
          $fechayhora_input_2_seg = $fechayhora_seg;
      }
      ...
      $accion_cond_salva = $accion_cond; 
      if (!isset($accion_input_2) || $accion_input_2 == "")
      {
          $accion_input_2 = $accion;
      }
      ...
      if (is_array($accion)) {
          foreach ($accion as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['psq_check_ret']['accion'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Accion : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_dia'] = $fechayhora_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_mes'] = $fechayhora_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_ano'] = $fechayhora_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_input_2_dia'] = $fechayhora_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_input_2_mes'] = $fechayhora_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_input_2_ano'] = $fechayhora_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_hor'] = $fechayhora_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_min'] = $fechayhora_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_seg'] = $fechayhora_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_input_2_hor'] = $fechayhora_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_input_2_min'] = $fechayhora_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_input_2_seg'] = $fechayhora_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_cond'] = $fechayhora_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['usuario'] = $usuario; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['usuario_cond'] = $usuario_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['accion'] = $accion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['accion_cond'] = $accion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['observaciones'] = $observaciones; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['observaciones_cond'] = $observaciones_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca'] = $Temp_Busca;
      }
      if ($usuario_cond != "in" && $usuario_cond != "bw" && !empty($usuario) && !is_numeric($usuario))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Usuario Tercero";
      }
      if ($usuario_cond == "bw" && ((!empty($usuario) && !is_numeric($usuario)) || (!empty($usuario_input_2) && !is_numeric($usuario_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Usuario Tercero";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      $this->cmp_formatado['accion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['accion'];
      ...
      if ($fechayhora_cond != "bi_TP")
      {
          $fechayhora_cond = strtoupper($fechayhora_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $fechayhora_ano;
          $Dtxt .= $fechayhora_mes;
          ...
          $Dtxt .= $fechayhora_min;
          $Dtxt .= $fechayhora_seg;
          $val[0]['ano'] = $fechayhora_ano;
          $val[0]['mes'] = $fechayhora_mes;
          $val[0]['dia'] = $fechayhora_dia;
          $val[0]['hor'] = $fechayhora_hor;
          $val[0]['min'] = $fechayhora_min;
          $val[0]['seg'] = $fechayhora_seg;
          if ($fechayhora_cond == "BW")
          {
              $val[1]['ano'] = $fechayhora_input_2_ano;
              $val[1]['mes'] = $fechayhora_input_2_mes;
              $val[1]['dia'] = $fechayhora_input_2_dia;
              $val[1]['hor'] = $fechayhora_input_2_hor;
              $val[1]['min'] = $fechayhora_input_2_min;
              $val[1]['seg'] = $fechayhora_input_2_seg;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "TIMESTAMP", $fechayhora_cond, "", "datahora");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fechayhora = $val[0];
          $this->cmp_formatado['fechayhora'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fechayhora'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['fechayhora'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          if ($fechayhora_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $fechayhora_input_2     = $val[1];
              $this->cmp_formatado['fechayhora_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']['fechayhora_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fechayhora_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['fechayhora_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          }
          if (!empty($Dtxt) || $fechayhora_cond == "NU" || $fechayhora_cond == "NN"|| $fechayhora_cond == "EP"|| $fechayhora_cond == "NE")
          {
              $this->monta_condicao("fechayhora", $fechayhora_cond, $fechayhora, $fechayhora_input_2, 'fechayhora', 'TIMESTAMP');
          }
      }
      ...
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($accion_cond == "nu" || $accion_cond == "nn" || $accion_cond == "ep" || $accion_cond == "ne")
      {
          $accion = array();
      }
      if (is_array($accion) && count($accion) != 0)
      {
         foreach ($accion as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($accion_cond == "df" || $accion_cond == "np")
         {
             $this->comando        .= " accion not in (";
             $this->comando_sum    .= " log.accion not in (";
             $this->comando_filtro .= " accion not in (";
         }
         else
         {
             $this->comando        .= " accion in (";
             $this->comando_sum    .= " log.accion in (";
             $this->comando_filtro .= " accion in (";
         }
         $x                     = count($accion);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr_final = isset($Lang_descr[$accion_cond]) ? $Lang_descr[$accion_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $nmgp_tab_label['accion'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($accion) || $accion_cond == "nu" || $accion_cond == "nn" || $accion_cond == "ep" || $accion_cond == "ne")
      {
         $this->monta_condicao("accion", $accion_cond, $accion, "", "accion");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_25092021']['cond_pesq'] .= $this->NM_operador;
