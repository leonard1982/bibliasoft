  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_kardex_nc" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_kardex_nc_form();
	}
  ...
  // ---------- Validate tipo
  function do_ajax_form_cloud_kardex_nc_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_nc_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_cloud_kardex_nc_validate_tipo_cb);
  } // do_ajax_form_cloud_kardex_nc_validate_tipo

  function do_ajax_form_cloud_kardex_nc_validate_tipo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_nc_validate_tipo_cb

  // ---------- Validate prefijo
  function do_ajax_form_cloud_kardex_nc_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldHidden(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_nc_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_cloud_kardex_nc_validate_prefijo_cb);
  } // do_ajax_form_cloud_kardex_nc_validate_prefijo

  function do_ajax_form_cloud_kardex_nc_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_nc_validate_prefijo_cb

  // ---------- Validate numero
  function do_ajax_form_cloud_kardex_nc_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldHidden(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_nc_validate_numero(var_numero, var_script_case_init, do_ajax_form_cloud_kardex_nc_validate_numero_cb);
  } // do_ajax_form_cloud_kardex_nc_validate_numero

  function do_ajax_form_cloud_kardex_nc_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_nc_validate_numero_cb

  // ---------- Validate tercero
  function do_ajax_form_cloud_kardex_nc_validate_tercero()
  {
    var nomeCampo_tercero = "tercero";
    var var_tercero = scAjaxGetFieldHidden(nomeCampo_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_nc_validate_tercero(var_tercero, var_script_case_init, do_ajax_form_cloud_kardex_nc_validate_tercero_cb);
  } // do_ajax_form_cloud_kardex_nc_validate_tercero

  function do_ajax_form_cloud_kardex_nc_validate_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tercero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_nc_validate_tercero_cb

  // ---------- Validate fac_devuelta
  function do_ajax_form_cloud_kardex_nc_validate_fac_devuelta()
  {
    var nomeCampo_fac_devuelta = "fac_devuelta";
    var var_fac_devuelta = scAjaxGetFieldText(nomeCampo_fac_devuelta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_nc_validate_fac_devuelta(var_fac_devuelta, var_script_case_init, do_ajax_form_cloud_kardex_nc_validate_fac_devuelta_cb);
  } // do_ajax_form_cloud_kardex_nc_validate_fac_devuelta

  function do_ajax_form_cloud_kardex_nc_validate_fac_devuelta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_nc_validate_fac_devuelta_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_kardex_nc_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_kardex_nc_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_kardex_nc_submit_form(var_tipo, var_prefijo, var_numero, var_tercero, var_fac_devuelta, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_kardex_nc_submit_form_cb);
  } // do_ajax_form_cloud_kardex_nc_submit_form

  function do_ajax_form_cloud_kardex_nc_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_kardex_nc_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_kardex_nc_submit_form_cb
  function do_ajax_form_cloud_kardex_nc_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_kardex_nc_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_kardex_nc_navigate_form()
  {
    perform_ajax_form_cloud_kardex_nc_navigate_form();
  }

  function perform_ajax_form_cloud_kardex_nc_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_kardex_nc_navigate_form(var_id_cloud_kardex, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_kardex_nc_navigate_form_cb);
  } // do_ajax_form_cloud_kardex_nc_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_kardex_nc']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_kardex_nc_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_kardex_nc_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_kardex_nc_navigate_form_cb
  function do_ajax_form_cloud_kardex_nc_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cloud_kardex_nc_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cloud_kardex_nc_navigate_form_cb_after_alert
  function sc_hide_form_cloud_kardex_nc_form()
  {
