  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_kardex_nc_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_kardex_nc_mob_form();
	}
  ...
  // ---------- Validate tipo
  function do_ajax_form_cloud_kardex_nc_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_nc_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_cloud_kardex_nc_mob_validate_tipo_cb);
  } // do_ajax_form_cloud_kardex_nc_mob_validate_tipo

  function do_ajax_form_cloud_kardex_nc_mob_validate_tipo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_nc_mob_validate_tipo_cb

  // ---------- Validate prefijo
  function do_ajax_form_cloud_kardex_nc_mob_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldHidden(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_nc_mob_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_cloud_kardex_nc_mob_validate_prefijo_cb);
  } // do_ajax_form_cloud_kardex_nc_mob_validate_prefijo

  function do_ajax_form_cloud_kardex_nc_mob_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_nc_mob_validate_prefijo_cb

  // ---------- Validate numero
  function do_ajax_form_cloud_kardex_nc_mob_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldHidden(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_nc_mob_validate_numero(var_numero, var_script_case_init, do_ajax_form_cloud_kardex_nc_mob_validate_numero_cb);
  } // do_ajax_form_cloud_kardex_nc_mob_validate_numero

  function do_ajax_form_cloud_kardex_nc_mob_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_nc_mob_validate_numero_cb

  // ---------- Validate tercero
  function do_ajax_form_cloud_kardex_nc_mob_validate_tercero()
  {
    var nomeCampo_tercero = "tercero";
    var var_tercero = scAjaxGetFieldHidden(nomeCampo_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_nc_mob_validate_tercero(var_tercero, var_script_case_init, do_ajax_form_cloud_kardex_nc_mob_validate_tercero_cb);
  } // do_ajax_form_cloud_kardex_nc_mob_validate_tercero

  function do_ajax_form_cloud_kardex_nc_mob_validate_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tercero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_nc_mob_validate_tercero_cb

  // ---------- Validate fac_devuelta
  function do_ajax_form_cloud_kardex_nc_mob_validate_fac_devuelta()
  {
    var nomeCampo_fac_devuelta = "fac_devuelta";
    var var_fac_devuelta = scAjaxGetFieldText(nomeCampo_fac_devuelta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_nc_mob_validate_fac_devuelta(var_fac_devuelta, var_script_case_init, do_ajax_form_cloud_kardex_nc_mob_validate_fac_devuelta_cb);
  } // do_ajax_form_cloud_kardex_nc_mob_validate_fac_devuelta

  function do_ajax_form_cloud_kardex_nc_mob_validate_fac_devuelta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_devuelta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_nc_mob_validate_fac_devuelta_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_kardex_nc_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_kardex_nc_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tipo = scAjaxGetFieldSelect("tipo");
    var var_prefijo = scAjaxGetFieldHidden("prefijo");
    var var_numero = scAjaxGetFieldHidden("numero");
    var var_tercero = scAjaxGetFieldHidden("tercero");
    var var_fac_devuelta = scAjaxGetFieldText("fac_devuelta");
    var var_id_cloud_kardex = scAjaxGetFieldText("id_cloud_kardex");
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_kardex_nc_mob_submit_form(var_tipo, var_prefijo, var_numero, var_tercero, var_fac_devuelta, var_id_cloud_kardex, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_kardex_nc_mob_submit_form_cb);
  } // do_ajax_form_cloud_kardex_nc_mob_submit_form

  function do_ajax_form_cloud_kardex_nc_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("fac_devuelta");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_kardex_nc_mob_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_kardex_nc_mob_submit_form_cb
  function do_ajax_form_cloud_kardex_nc_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_kardex_nc_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_kardex_nc_mob_navigate_form()
  {
    perform_ajax_form_cloud_kardex_nc_mob_navigate_form();
  }

  function perform_ajax_form_cloud_kardex_nc_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tercero");
    scAjaxHideErrorDisplay("fac_devuelta");
    var var_id_cloud_kardex = document.F2.id_cloud_kardex.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_kardex_nc_mob_navigate_form(var_id_cloud_kardex, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_kardex_nc_mob_navigate_form_cb);
  } // do_ajax_form_cloud_kardex_nc_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_kardex_nc_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_kardex_nc_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_cloud_kardex.value = scAjaxGetKeyValue("id_cloud_kardex");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_kardex_nc_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_kardex_nc_mob_navigate_form_cb
  function do_ajax_form_cloud_kardex_nc_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cloud_kardex_nc_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_cloud_kardex_nc_mob_navigate_form_cb_after_alert
  function sc_hide_form_cloud_kardex_nc_mob_form()
  {
  ...
  ajax_field_list[3] = "tercero";
  ajax_field_list[4] = "fac_devuelta";
  ...
  var ajax_error_list = {
    ...
    "fac_devuelta": {"label": "Factura a devolver", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["fac_devuelta"][1] = "fac_devuelta";
  ...
  var ajax_field_id = {
    ...
    "fac_devuelta": new Array("hidden_field_label_fac_devuelta", "hidden_field_data_fac_devuelta")
  };
