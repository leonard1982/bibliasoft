<?php
   include_once('blank_mantener_viva_la_sesion_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_doc']        = "";
   $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_con_conn_facilweb']         = "conn_facilweb";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class blank_mantener_viva_la_sesion_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "blank_mantener_viva_la_sesion"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/blank_mantener_viva_la_sesion';
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['actual_lang']) || $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("blank_mantener_viva_la_sesion_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_mantener_viva_la_sesion"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_mantener_viva_la_sesion"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "blank_mantener_viva_la_sesion_erro.class.php"); 
      $this->Erro = new blank_mantener_viva_la_sesion_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blank_mantener_viva_la_sesion'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
      $this->conectExtra();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_conexao']) && $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_perfil']) && $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_perfil'];
      }
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_con_conn_facilweb'], $this->path_libs, "S", $this->path_conf);
          $this->nm_con_conn_facilweb['servidor']               = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_conn_facilweb['usuario']                = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_conn_facilweb['banco']                  = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_conn_facilweb['senha']                  = $_SESSION['scriptcase']['glo_senha'];
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_mantener_viva_la_sesion']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class blank_mantener_viva_la_sesion_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blank_mantener_viva_la_sesion_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_mantener_viva_la_sesion']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blank_mantener_viva_la_sesion']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_mantener_viva_la_sesion']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_mantener_viva_la_sesion'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_mantener_viva_la_sesion']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_mantener_viva_la_sesion']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blank_mantener_viva_la_sesion') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_mantener_viva_la_sesion']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "blank_mantener_viva_la_sesion")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['blank_mantener_viva_la_sesion']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['blank_mantener_viva_la_sesion']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['blank_mantener_viva_la_sesion']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blank_mantener_viva_la_sesion_erro.class.php"); 
      $this->Erro      = new blank_mantener_viva_la_sesion_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['contr_erro'] = 'on';
 ...
 if(isset($_POST["activar"]))
{
	...
	$activarlog  = "NO";
	$vtmpsesion  = "";
	$vusuariologueo  = $this->sc_temp_gusuario_logueo;
	$vpasswordlogueo = $this->sc_temp_gpassword_logueo;
	
	if($this->sc_temp_grestaurar=='NO')
	{
	
		 
      $nm_select = "select activar_console_log from configuraciones order by idconfiguraciones desc limit 1"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vconsolelog = array();
      ...
      { 
          ...
          { 
                 ...
                 { 
                        $this->vconsolelog[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->vconsolelog = false;
          $this->vconsolelog_erro = $this->Db->ErrorMsg();
      } 
;

		if(isset($this->vconsolelog[0][0]))
		{
			$activarlog = $this->vconsolelog[0][0];
		}

		$vtmpsesion = session_id();
...
;
      ...
      $nm_select = "select sesion_id from usuarios where usuario='".$this->sc_temp_gusuario_logueo."' and password='".$this->sc_temp_gpassword_logueo."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vidsesion = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          $nm_count = $SCrx->FieldCount();
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vidsesion[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vidsesion = false;
          $this->vidsesion_erro = $this->Db->ErrorMsg();
      } 
;

			if(isset($this->vidsesion[0][0]))
			{
				$v_idsesion = $this->vidsesion[0][0];

				if($vtmpsesion != $v_idsesion)
				{
					$vsalir = "SI";
				}
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiAperturaCaja[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiaperturacaja[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiAperturaCaja = false;
          $this->vSiAperturaCaja_erro = $this->Db->ErrorMsg();
          $this->vsiaperturacaja = false;
          $this->vsiaperturacaja_erro = $this->Db->ErrorMsg();
      } 
;

				if(isset($this->vsiaperturacaja[0][0]))
				{
					if($this->vsiaperturacaja[0][0]=="SI")
					{
...
;
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vCajaLogueada[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vcajalogueada[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vCajaLogueada = false;
          $this->vCajaLogueada_erro = $this->Db->ErrorMsg();
          $this->vcajalogueada = false;
          $this->vcajalogueada_erro = $this->Db->ErrorMsg();
      } 
;

								if(isset($this->vcajalogueada[0][0]))
								{
									$vcaja = $this->vcajalogueada[0][0];

									 
      $nm_select = "select coalesce(detalle,'') as detalle from caja where detalle in('BASE','CUADRE') and banco='".$vcaja."' and usuario='".$this->sc_temp_gidtercero."' order by idcaja desc limit 1"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
;
     ...
     $nm_select = "update bancos set cajero=null where idcaja_vta='".$vcaja."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	echo json_encode(array("sesion"=>$vfechayhora,"salir"=>$vsalir,"gsesion_id"=>$v_idsesion,"sesion_id_tmp"=>$vtmpsesion,"usuario"=>$vusuariologueo,"password"=>$vpasswordlogueo,"cajacerrada"=>$cajacerrada,"activarconsolelog"=>$activarlog,"restaurar"=>$this->sc_temp_grestaurar));
}
...
$_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blank_mantener_viva_la_sesion($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank_mantener_viva_la_sesion") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
               $_SESSION['scriptcase']['blank_mantener_viva_la_sesion']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
           }
       }
   }
   ...
   if (isset($_POST["gusuario_logueo"])) 
   {
       ...
       nm_limpa_str_blank_mantener_viva_la_sesion($_SESSION["gusuario_logueo"]);
   }
   ...
   if (isset($_POST["gpassword_logueo"])) 
   {
       ...
       nm_limpa_str_blank_mantener_viva_la_sesion($_SESSION["gpassword_logueo"]);
   }
   ...
   if (isset($_POST["gbd_seleccionada"])) 
   {
       ...
       nm_limpa_str_blank_mantener_viva_la_sesion($_SESSION["gbd_seleccionada"]);
   }
   ...
   if (isset($_POST["gidtercero"])) 
   {
       ...
       nm_limpa_str_blank_mantener_viva_la_sesion($_SESSION["gidtercero"]);
   }
   ...
   if (isset($_POST["grestaurar"])) 
   {
       ...
       nm_limpa_str_blank_mantener_viva_la_sesion($_SESSION["grestaurar"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "blank_mantener_viva_la_sesion";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'blank_mantener_viva_la_sesion' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blank_mantener_viva_la_sesion' == $sReferer || 'blank_mantener_viva_la_sesion_' == substr($sReferer, 0, 30))
       {
           $_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'blank_mantener_viva_la_sesion')
   {
       $_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['blank_mantener_viva_la_sesion']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blank_mantener_viva_la_sesion_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blank_mantener_viva_la_sesion($cadapar[1]);
   ...
   $contr_blank_mantener_viva_la_sesion = new blank_mantener_viva_la_sesion_apl();
   $contr_blank_mantener_viva_la_sesion->controle();
//
   function nm_limpa_str_blank_mantener_viva_la_sesion(&$str)
   {
