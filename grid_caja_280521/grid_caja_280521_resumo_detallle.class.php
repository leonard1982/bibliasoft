...
class grid_caja_280521_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_detalle = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['arr_total']['detalle'];
      }
      else
      {
          $this->array_total_detalle = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['arr_total']['detalle'] = $this->array_total_detalle;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['labels']['detalle'] = $Lab_detalle; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_order']['detallle']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_order']['detallle'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_order']['detallle'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['detallle'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['detallle'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['detallle'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['detallle'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['detallle'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['detallle'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['detallle'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_detalle as $i_detalle => $d_detalle) {
           if (!in_array($i_detalle, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_detalle[4] ] = $d_detalle[3];
               $this->comp_label[0][ $d_detalle[4] ] = $d_detalle[3];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'detalle', 'prot' => '@aspass@'),
       );
       ...
       //-----
       foreach ($this->comp_label[0] as $i_detalle => $l_detalle) {
           if (isset($this->array_total_detalle[$i_detalle])) {
               $this->comp_group[$i_detalle] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_detalle;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_detallle("res");
      ...
      ksort($this->array_total_detalle);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $quebra_detalle, $quebra_detalle_orig)
   {
      //----- Detalle
      if (!isset($this->array_total_detalle[$quebra_detalle_orig]))
      {
         $this->array_total_detalle[$quebra_detalle_orig][0] = 1;
         $this->array_total_detalle[$quebra_detalle_orig][1] = $sum_cantidad;
         $this->array_total_detalle[$quebra_detalle_orig][2] = 1;
         $this->array_total_detalle[$quebra_detalle_orig][3] = $quebra_detalle;
         $this->array_total_detalle[$quebra_detalle_orig][4] = $quebra_detalle_orig;
      }
      else
      {
         $this->array_total_detalle[$quebra_detalle_orig][0]++;
         $this->array_total_detalle[$quebra_detalle_orig][1] += $sum_cantidad;
         $this->array_total_detalle[$quebra_detalle_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'detalle');
     $campos_order = $this->Ini->Get_date_order_groupby("detalle", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->detalle, $this->detalle_orig);
            }
   }
//
