...
class grid_caja_280521_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_resolucion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['arr_total']['resolucion'];
      }
      else
      {
          $this->array_total_resolucion = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['arr_total']['resolucion'] = $this->array_total_resolucion;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['labels']['resolucion'] = $Lab_resolucion; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_order']['prefijo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_order']['prefijo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_order']['prefijo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['prefijo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['prefijo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['prefijo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['prefijo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['prefijo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['prefijo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['summarizing_fields_display']['prefijo'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_resolucion as $i_resolucion => $d_resolucion) {
           if (!in_array($i_resolucion, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_resolucion[4] ] = $d_resolucion[3];
               $this->comp_label[0][ $d_resolucion[4] ] = $d_resolucion[3];
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $quebra_resolucion, $quebra_resolucion_orig)
   {
      //----- PJ
      if (!isset($this->array_total_resolucion[$quebra_resolucion_orig]))
      {
         $this->array_total_resolucion[$quebra_resolucion_orig][0] = 1;
         $this->array_total_resolucion[$quebra_resolucion_orig][1] = $sum_cantidad;
         $this->array_total_resolucion[$quebra_resolucion_orig][2] = 1;
         $this->array_total_resolucion[$quebra_resolucion_orig][3] = $quebra_resolucion;
         $this->array_total_resolucion[$quebra_resolucion_orig][4] = $quebra_resolucion_orig;
      }
      else
      {
         $this->array_total_resolucion[$quebra_resolucion_orig][0]++;
         $this->array_total_resolucion[$quebra_resolucion_orig][1] += $sum_cantidad;
         $this->array_total_resolucion[$quebra_resolucion_orig][2]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->resolucion, $this->resolucion_orig);
            }
   }
//
