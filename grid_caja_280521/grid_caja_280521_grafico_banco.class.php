...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "Banco";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['contr_label_graf']['banco']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['contr_label_graf']['banco']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_280521']['contr_label_graf']['banco'];
      }
   }
