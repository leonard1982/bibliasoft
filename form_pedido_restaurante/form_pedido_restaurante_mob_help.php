...
@session_start() ;
class form_pedido_restaurante_mob_help
{
...
<?php echo "<b>Disponible En Movil</b><br>" . nl2br("Para activar nuevamente el pedido en el móvil"); ?>
</body>
</html>
<?php
        }
...
$exec_help = new form_pedido_restaurante_mob_help();
?>
