<?php
@session_start() ;
$_SESSION['scriptcase']['grid_productos_x_pedido_dia']['sc_process_barr'] = true;
require_once('../grid_productos_x_pedido_dia/index.php');
unset($_SESSION['scriptcase']['grid_productos_x_pedido_dia']['sc_process_barr']);
$ExportCtrl = new grid_productos_x_pedido_dia_export_control;
$ExportCtrl->Export_barr();

class grid_productos_x_pedido_dia_export_control
{
