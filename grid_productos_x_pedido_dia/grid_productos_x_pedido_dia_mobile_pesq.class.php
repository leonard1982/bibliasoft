...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "f.fechaven";$Nm_datas[] = "f_fechaven";$Nm_numeric[] = "sum(d_cantidad)";$Nm_numeric[] = "sum(d_valorpar)";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span> <span class="scFilterRequiredOdd">*</span><br><span id="id_hide_f_fechaven"  <?php echo $str_hide_f_fechaven?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
