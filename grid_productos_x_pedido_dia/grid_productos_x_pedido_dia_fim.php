...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_productos_x_pedido_dia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_productos_x_pedido_dia"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_productos_x_pedido_dia']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_productos_x_pedido_dia']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_productos_x_pedido_dia']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_productos_x_pedido_dia']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_productos_x_pedido_dia']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_productos_x_pedido_dia</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_productos_x_pedido_dia']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_productos_x_pedido_dia']['embutida_filho'] as $ind => $sc_init)
          {
