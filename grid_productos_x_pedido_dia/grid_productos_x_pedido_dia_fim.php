...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_productos_x_pedido_dia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_productos_x_pedido_dia"]);
   }
