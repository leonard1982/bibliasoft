  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detallepagos_rc" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detallepagos_rc_form();
	}
...
?>
  ...
  // ---------- Validate idrc_
  function do_ajax_form_detallepagos_rc_validate_idrc_(iNumLinha)
  {
    var nomeCampo_idrc_ = "idrc_" + iNumLinha;
    var var_idrc_ = scAjaxGetFieldText(nomeCampo_idrc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_validate_idrc_(var_idrc_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_validate_idrc__cb);
  } // do_ajax_form_detallepagos_rc_validate_idrc_

  function do_ajax_form_detallepagos_rc_validate_idrc__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_validate_idrc__cb

  // ---------- Validate idfact_
  function do_ajax_form_detallepagos_rc_validate_idfact_(iNumLinha)
  {
    var nomeCampo_idfact_ = "idfact_" + iNumLinha;
    var var_idfact_ = scAjaxGetFieldText(nomeCampo_idfact_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_validate_idfact_(var_idfact_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_validate_idfact__cb);
  } // do_ajax_form_detallepagos_rc_validate_idfact_

  function do_ajax_form_detallepagos_rc_validate_idfact__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_validate_idfact__cb

  // ---------- Validate idbanco_caja_
  function do_ajax_form_detallepagos_rc_validate_idbanco_caja_(iNumLinha)
  {
    var nomeCampo_idbanco_caja_ = "idbanco_caja_" + iNumLinha;
    var var_idbanco_caja_ = scAjaxGetFieldSelect(nomeCampo_idbanco_caja_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_validate_idbanco_caja_(var_idbanco_caja_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_validate_idbanco_caja__cb);
  } // do_ajax_form_detallepagos_rc_validate_idbanco_caja_

  function do_ajax_form_detallepagos_rc_validate_idbanco_caja__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_validate_idbanco_caja__cb

  // ---------- Validate idfp_
  function do_ajax_form_detallepagos_rc_validate_idfp_(iNumLinha)
  {
    var nomeCampo_idfp_ = "idfp_" + iNumLinha;
    var var_idfp_ = scAjaxGetFieldSelect(nomeCampo_idfp_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_validate_idfp_(var_idfp_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_validate_idfp__cb);
  } // do_ajax_form_detallepagos_rc_validate_idfp_

  function do_ajax_form_detallepagos_rc_validate_idfp__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_validate_idfp__cb

  // ---------- Validate monto_
  function do_ajax_form_detallepagos_rc_validate_monto_(iNumLinha)
  {
    var nomeCampo_monto_ = "monto_" + iNumLinha;
    var var_monto_ = scAjaxGetFieldText(nomeCampo_monto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_validate_monto_(var_monto_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_validate_monto__cb);
  } // do_ajax_form_detallepagos_rc_validate_monto_

  function do_ajax_form_detallepagos_rc_validate_monto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_validate_monto__cb

  // ---------- Validate banco_
  function do_ajax_form_detallepagos_rc_validate_banco_(iNumLinha)
  {
    var nomeCampo_banco_ = "banco_" + iNumLinha;
    var var_banco_ = scAjaxGetFieldText(nomeCampo_banco_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_validate_banco_(var_banco_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_validate_banco__cb);
  } // do_ajax_form_detallepagos_rc_validate_banco_

  function do_ajax_form_detallepagos_rc_validate_banco__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_validate_banco__cb

  // ---------- Validate numcheque_
  function do_ajax_form_detallepagos_rc_validate_numcheque_(iNumLinha)
  {
    var nomeCampo_numcheque_ = "numcheque_" + iNumLinha;
    var var_numcheque_ = scAjaxGetFieldText(nomeCampo_numcheque_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_validate_numcheque_(var_numcheque_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_validate_numcheque__cb);
  } // do_ajax_form_detallepagos_rc_validate_numcheque_

  function do_ajax_form_detallepagos_rc_validate_numcheque__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_validate_numcheque__cb

  // ---------- Validate fechacob_
  function do_ajax_form_detallepagos_rc_validate_fechacob_(iNumLinha)
  {
    var nomeCampo_fechacob_ = "fechacob_" + iNumLinha;
    var var_fechacob_ = scAjaxGetFieldText(nomeCampo_fechacob_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_validate_fechacob_(var_fechacob_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_validate_fechacob__cb);
  } // do_ajax_form_detallepagos_rc_validate_fechacob_

  function do_ajax_form_detallepagos_rc_validate_fechacob__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_validate_fechacob__cb

  // ---------- Event onchange idfp_
  function do_ajax_form_detallepagos_rc_event_idfp__onchange(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_detallepagos_rc_event_idfp__onchange(var_idfp_, var_banco_, var_numcheque_, var_fechacob_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepagos_rc_event_idfp__onchange_cb);
  } // do_ajax_form_detallepagos_rc_event_idfp__onchange

  function do_ajax_form_detallepagos_rc_event_idfp__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepagos_rc_event_idfp__onchange_cb_after_alert);
  } // do_ajax_form_detallepagos_rc_event_idfp__onchange_cb
  function do_ajax_form_detallepagos_rc_event_idfp__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepagos_rc_event_idfp__onchange_cb_after_alert

  // ---------- Event onchange monto_
  function do_ajax_form_detallepagos_rc_event_monto__onchange(iSeqForm)
  {
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepagos_rc_event_monto__onchange(var_monto_, var_idfact_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepagos_rc_event_monto__onchange_cb);
  } // do_ajax_form_detallepagos_rc_event_monto__onchange

  function do_ajax_form_detallepagos_rc_event_monto__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepagos_rc_event_monto__onchange_cb_after_alert);
  } // do_ajax_form_detallepagos_rc_event_monto__onchange_cb
  function do_ajax_form_detallepagos_rc_event_monto__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepagos_rc_event_monto__onchange_cb_after_alert

  // ---------- Event onfocus monto_
  function do_ajax_form_detallepagos_rc_event_monto__onfocus(iSeqForm)
  {
    var var_monto_ = scAjaxGetFieldText("monto_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn();
    x_ajax_form_detallepagos_rc_event_monto__onfocus(var_monto_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepagos_rc_event_monto__onfocus_cb);
  } // do_ajax_form_detallepagos_rc_event_monto__onfocus

  function do_ajax_form_detallepagos_rc_event_monto__onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepagos_rc_event_monto__onfocus_cb_after_alert);
  } // do_ajax_form_detallepagos_rc_event_monto__onfocus_cb
  function do_ajax_form_detallepagos_rc_event_monto__onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepagos_rc_event_monto__onfocus_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detallepagos_rc_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detallepagos_rc_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detallepagos_rc_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detallepagos_rc_add_new_line_cb);
  } // do_ajax_form_detallepagos_rc_add_new_line

  function do_ajax_form_detallepagos_rc_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_detallepagos_rc_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detallepagos_rc_backup_line(iNumLinha)
  {
    var var_iddetall_ = scAjaxGetFieldText("iddetall_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_backup_line(var_iddetall_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detallepagos_rc_backup_line_cb);
  } // do_ajax_form_detallepagos_rc_backup_line

  function do_ajax_form_detallepagos_rc_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detallepagos_rc_backup_line_cb

  function do_ajax_form_detallepagos_rc_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detallepagos_rc_cancel_insert

  function do_ajax_form_detallepagos_rc_cancel_update(iSeqVert)
  {
    do_ajax_form_detallepagos_rc_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detallepagos_rc_cancel_update

  function do_ajax_form_detallepagos_rc_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detallepagos_rc_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detallepagos_rc_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallepagos_rc_table_refresh(var_iddetall_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallepagos_rc_table_refresh_cb);
  } //  do_ajax_form_detallepagos_rc_table_refresh

  function do_ajax_form_detallepagos_rc_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_detallepagos_rc_table_refresh_cb_after_alert);
  } // do_ajax_form_detallepagos_rc_table_refresh_cb
  function do_ajax_form_detallepagos_rc_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_detallepagos_rc_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detallepagos_rc_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detallepagos_rc_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_detallepagos_rc_submit_form(var_idrc_, var_idfact_, var_idbanco_caja_, var_idfp_, var_monto_, var_banco_, var_numcheque_, var_fechacob_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detallepagos_rc_submit_form_cb);
  } // do_ajax_form_detallepagos_rc_submit_form

  function do_ajax_form_detallepagos_rc_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepagos_rc_submit_form_cb_after_alert);
  } // do_ajax_form_detallepagos_rc_submit_form_cb
  function do_ajax_form_detallepagos_rc_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detallepagos_rc_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detallepagos_rc_navigate_form()
  {
    perform_ajax_form_detallepagos_rc_navigate_form();
  }

  function perform_ajax_form_detallepagos_rc_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallepagos_rc_navigate_form(var_iddetall_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallepagos_rc_navigate_form_cb);
  } // do_ajax_form_detallepagos_rc_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepagos_rc']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detallepagos_rc_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detallepagos_rc_navigate_form_cb_after_alert);
  } // do_ajax_form_detallepagos_rc_navigate_form_cb
  function do_ajax_form_detallepagos_rc_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('idfp_1');
...
?>
  ...
  } // do_ajax_form_detallepagos_rc_navigate_form_cb_after_alert
  function sc_hide_form_detallepagos_rc_form()
  {
