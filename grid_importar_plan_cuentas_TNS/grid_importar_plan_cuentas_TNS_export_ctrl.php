<?php
@session_start() ;
$_SESSION['scriptcase']['grid_importar_plan_cuentas_TNS']['sc_process_barr'] = true;
require_once('../grid_importar_plan_cuentas_TNS/index.php');
unset($_SESSION['scriptcase']['grid_importar_plan_cuentas_TNS']['sc_process_barr']);
$ExportCtrl = new grid_importar_plan_cuentas_TNS_export_control;
$ExportCtrl->Export_barr();

class grid_importar_plan_cuentas_TNS_export_control
{
