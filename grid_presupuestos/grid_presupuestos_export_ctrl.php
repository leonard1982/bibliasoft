<?php
@session_start() ;
$_SESSION['scriptcase']['grid_presupuestos']['sc_process_barr'] = true;
require_once('../grid_presupuestos/index.php');
unset($_SESSION['scriptcase']['grid_presupuestos']['sc_process_barr']);
$ExportCtrl = new grid_presupuestos_export_control;
$ExportCtrl->Export_barr();

class grid_presupuestos_export_control
{
