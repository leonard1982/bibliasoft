...
<?php
   ...
   $Ord_Cmp = new grid_presupuestos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_presupuestos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_presupuesto'] = "id_presupuesto";
   $tab_labels["id_presupuesto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestos']['labels']["id_presupuesto"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['labels']["id_presupuesto"] : "Número";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestos']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestos']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['labels']["descripcion"] : "Descripción";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestos']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['labels']["total"] : "Total";
   $tab_ger_campos['activo'] = "on";
   $tab_def_campos['activo'] = "activo";
   $tab_labels["activo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestos']['labels']["activo"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['labels']["activo"] : "Activo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_presupuestos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_presupuestos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> presupuestos</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_presupuestos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_presupuestos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
