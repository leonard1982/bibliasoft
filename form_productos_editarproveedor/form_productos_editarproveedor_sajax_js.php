  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_productos_editarproveedor" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_productos_editarproveedor_form();
	}
...
?>
  ...
  // ---------- Validate codigobar_
  function do_ajax_form_productos_editarproveedor_validate_codigobar_(iNumLinha)
  {
    var nomeCampo_codigobar_ = "codigobar_" + iNumLinha;
    var var_codigobar_ = scAjaxGetFieldHidden(nomeCampo_codigobar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarproveedor_validate_codigobar_(var_codigobar_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarproveedor_validate_codigobar__cb);
  } // do_ajax_form_productos_editarproveedor_validate_codigobar_

  function do_ajax_form_productos_editarproveedor_validate_codigobar__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarproveedor_validate_codigobar__cb

  // ---------- Validate codigoprod_
  function do_ajax_form_productos_editarproveedor_validate_codigoprod_(iNumLinha)
  {
    var nomeCampo_codigoprod_ = "codigoprod_" + iNumLinha;
    var var_codigoprod_ = scAjaxGetFieldHidden(nomeCampo_codigoprod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarproveedor_validate_codigoprod_(var_codigoprod_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarproveedor_validate_codigoprod__cb);
  } // do_ajax_form_productos_editarproveedor_validate_codigoprod_

  function do_ajax_form_productos_editarproveedor_validate_codigoprod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarproveedor_validate_codigoprod__cb

  // ---------- Validate nompro_
  function do_ajax_form_productos_editarproveedor_validate_nompro_(iNumLinha)
  {
    var nomeCampo_nompro_ = "nompro_" + iNumLinha;
    var var_nompro_ = scAjaxGetFieldHidden(nomeCampo_nompro_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarproveedor_validate_nompro_(var_nompro_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarproveedor_validate_nompro__cb);
  } // do_ajax_form_productos_editarproveedor_validate_nompro_

  function do_ajax_form_productos_editarproveedor_validate_nompro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarproveedor_validate_nompro__cb

  // ---------- Validate idpro1_
  function do_ajax_form_productos_editarproveedor_validate_idpro1_(iNumLinha)
  {
    var nomeCampo_idpro1_ = "idpro1_" + iNumLinha;
    var var_idpro1_ = scAjaxGetFieldSelect(nomeCampo_idpro1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarproveedor_validate_idpro1_(var_idpro1_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarproveedor_validate_idpro1__cb);
  } // do_ajax_form_productos_editarproveedor_validate_idpro1_

  function do_ajax_form_productos_editarproveedor_validate_idpro1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idpro1_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idpro1_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idpro1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idpro1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarproveedor_validate_idpro1__cb

  // ---------- Validate idpro2_
  function do_ajax_form_productos_editarproveedor_validate_idpro2_(iNumLinha)
  {
    var nomeCampo_idpro2_ = "idpro2_" + iNumLinha;
    var var_idpro2_ = scAjaxGetFieldText(nomeCampo_idpro2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarproveedor_validate_idpro2_(var_idpro2_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarproveedor_validate_idpro2__cb);
  } // do_ajax_form_productos_editarproveedor_validate_idpro2_

  function do_ajax_form_productos_editarproveedor_validate_idpro2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idpro2_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idpro2_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idpro2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idpro2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarproveedor_validate_idpro2__cb

  // ---------- Validate costomen_
  function do_ajax_form_productos_editarproveedor_validate_costomen_(iNumLinha)
  {
    var nomeCampo_costomen_ = "costomen_" + iNumLinha;
    var var_costomen_ = scAjaxGetFieldText(nomeCampo_costomen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarproveedor_validate_costomen_(var_costomen_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarproveedor_validate_costomen__cb);
  } // do_ajax_form_productos_editarproveedor_validate_costomen_

  function do_ajax_form_productos_editarproveedor_validate_costomen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarproveedor_validate_costomen__cb

  // ---------- Validate unimay_
  function do_ajax_form_productos_editarproveedor_validate_unimay_(iNumLinha)
  {
    var nomeCampo_unimay_ = "unimay_" + iNumLinha;
    var var_unimay_ = scAjaxGetFieldText(nomeCampo_unimay_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarproveedor_validate_unimay_(var_unimay_, iNumLinha, var_script_case_init, do_ajax_form_productos_editarproveedor_validate_unimay__cb);
  } // do_ajax_form_productos_editarproveedor_validate_unimay_

  function do_ajax_form_productos_editarproveedor_validate_unimay__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "unimay_" + iLineNumber;
    }
    else
    {
      sFieldValid = "unimay_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "unimay_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "unimay_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_editarproveedor_validate_unimay__cb

  // ---------- Event onchange idpro1_
  function do_ajax_form_productos_editarproveedor_event_idpro1__onchange(iSeqForm)
  {
    var var_idpro2_ = scAjaxGetFieldText("idpro2_" + iSeqForm);
    var var_idpro1_ = scAjaxGetFieldSelect("idpro1_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_productos_editarproveedor_event_idpro1__onchange(var_idpro2_, var_idpro1_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_productos_editarproveedor_event_idpro1__onchange_cb);
  } // do_ajax_form_productos_editarproveedor_event_idpro1__onchange

  function do_ajax_form_productos_editarproveedor_event_idpro1__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_editarproveedor_event_idpro1__onchange_cb_after_alert);
  } // do_ajax_form_productos_editarproveedor_event_idpro1__onchange_cb
  function do_ajax_form_productos_editarproveedor_event_idpro1__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_editarproveedor_event_idpro1__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_productos_editarproveedor_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_productos_editarproveedor_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_editarproveedor_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_productos_editarproveedor_add_new_line_cb);
  } // do_ajax_form_productos_editarproveedor_add_new_line

  function do_ajax_form_productos_editarproveedor_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_productos_editarproveedor_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_productos_editarproveedor_backup_line(iNumLinha)
  {
    var var_idprod_ = scAjaxGetFieldText("idprod_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_editarproveedor_backup_line(var_idprod_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_productos_editarproveedor_backup_line_cb);
  } // do_ajax_form_productos_editarproveedor_backup_line

  function do_ajax_form_productos_editarproveedor_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_productos_editarproveedor_backup_line_cb

  function do_ajax_form_productos_editarproveedor_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_productos_editarproveedor_cancel_insert

  function do_ajax_form_productos_editarproveedor_cancel_update(iSeqVert)
  {
    do_ajax_form_productos_editarproveedor_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_productos_editarproveedor_cancel_update

  function do_ajax_form_productos_editarproveedor_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_productos_editarproveedor_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_productos_editarproveedor_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_productos_editarproveedor_table_refresh(var_idprod_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_productos_editarproveedor_table_refresh_cb);
  } //  do_ajax_form_productos_editarproveedor_table_refresh

  function do_ajax_form_productos_editarproveedor_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_productos_editarproveedor_table_refresh_cb_after_alert);
  } // do_ajax_form_productos_editarproveedor_table_refresh_cb
  function do_ajax_form_productos_editarproveedor_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_productos_editarproveedor_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_productos_editarproveedor_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_productos_editarproveedor_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_idpro1_ = scAjaxGetFieldSelect("idpro1_" + iNumLinha);
    var var_idpro2_ = scAjaxGetFieldText("idpro2_" + iNumLinha);
    var var_costomen_ = scAjaxGetFieldText("costomen_" + iNumLinha);
    var var_unimay_ = scAjaxGetFieldText("unimay_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_productos_editarproveedor_submit_form(var_codigobar_, var_codigoprod_, var_nompro_, var_idpro1_, var_idpro2_, var_costomen_, var_unimay_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_productos_editarproveedor_submit_form_cb);
  } // do_ajax_form_productos_editarproveedor_submit_form

  function do_ajax_form_productos_editarproveedor_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("idpro1_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idpro2_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("costomen_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("unimay_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_editarproveedor_submit_form_cb_after_alert);
  } // do_ajax_form_productos_editarproveedor_submit_form_cb
  function do_ajax_form_productos_editarproveedor_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_productos_editarproveedor_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_productos_editarproveedor_navigate_form()
  {
    perform_ajax_form_productos_editarproveedor_navigate_form();
  }

  function perform_ajax_form_productos_editarproveedor_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("idpro1_" + iNavForm);
      scAjaxHideErrorDisplay("idpro2_" + iNavForm);
      scAjaxHideErrorDisplay("costomen_" + iNavForm);
      scAjaxHideErrorDisplay("unimay_" + iNavForm);
    }
    var var_idprod_ = document.F2.idprod_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_productos_editarproveedor_navigate_form(var_idprod_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_productos_editarproveedor_navigate_form_cb);
  } // do_ajax_form_productos_editarproveedor_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_editarproveedor']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_productos_editarproveedor_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_productos_editarproveedor_navigate_form_cb_after_alert);
  } // do_ajax_form_productos_editarproveedor_navigate_form_cb
  function do_ajax_form_productos_editarproveedor_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_productos_editarproveedor_navigate_form_cb_after_alert
  function sc_hide_form_productos_editarproveedor_form()
  {
  ...
  function do_ajax_form_productos_editarproveedor_lkpedt_refresh_idpro1_(iSeq)
  {
    var var_idpro1_ = scAjaxGetFieldSelect("idpro1_");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_row = iSeq;
    var nmgp_refresh_fields = "idpro1_";
    x_ajax_form_productos_editarproveedor_lkpedt_refresh_idpro1_(var_idpro1_, nmgp_refresh_row, nmgp_refresh_fields, var_script_case_init, do_ajax_form_productos_editarproveedor_lkpedt_refresh_idpro1__cb);
  } // do_ajax_form_productos_editarproveedor_lkpedt_refresh_idpro1_

  function do_ajax_form_productos_editarproveedor_lkpedt_refresh_idpro1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_productos_editarproveedor_lkpedt_refresh_idpro1__cb
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idpro1_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idpro2_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "costomen_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "unimay_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["codigoprod_" + iNumLinha] = {"label": "Código o Ref<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["idpro1_" + iNumLinha] = {"label": "Proveedor<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idpro2_" + iNumLinha] = {"label": "Proveedor secundario<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["unimay_" + iNumLinha] = {"label": "UND Mayor<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["idpro1_"][iNumLinha] = "idpro1_" + iNumLinha;
    ajax_field_mult["idpro2_"][iNumLinha] = "idpro2_" + iNumLinha;
    ajax_field_mult["costomen_"][iNumLinha] = "costomen_" + iNumLinha;
    ajax_field_mult["unimay_"][iNumLinha] = "unimay_" + iNumLinha;
    ...
    ajax_field_id["idpro1_" + iNumLinha] = new Array("hidden_field_label_idpro1_", "hidden_field_data_idpro1_" + iNumLinha);
    ajax_field_id["costomen_" + iNumLinha] = new Array("hidden_field_label_costomen_", "hidden_field_data_costomen_" + iNumLinha);
    ajax_field_id["unimay_" + iNumLinha] = new Array("hidden_field_label_unimay_", "hidden_field_data_unimay_" + iNumLinha);
    ...
    ajax_error_count["idpro1_" + iNumLinha] = "off";
    ajax_error_count["idpro2_" + iNumLinha] = "off";
    ajax_error_count["costomen_" + iNumLinha] = "off";
    ajax_error_count["unimay_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["idpro1_" + iNumLinha] = "off";
    ajax_read_only["idpro2_" + iNumLinha] = "off";
    ajax_read_only["costomen_" + iNumLinha] = "off";
    ajax_read_only["unimay_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ...
    ajax_read_only["idpro1_" + iNumLinha] = "on";
    ajax_read_only["idpro2_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["idpro1_" + iNumLinha] = null;
    ajax_error_list["idpro2_" + iNumLinha] = null;
    ajax_error_list["costomen_" + iNumLinha] = null;
    ajax_error_list["unimay_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["idpro1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idpro1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idpro1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idpro1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idpro1_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idpro2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idpro2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idpro2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idpro2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idpro2_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["unimay_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["unimay_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["unimay_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["unimay_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["unimay_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idpro1_'])) ? $this->nmgp_cmp_readonly['idpro1_'] : 'off';
?>
    scAjaxFieldRead("idpro1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idpro2_'])) ? $this->nmgp_cmp_readonly['idpro2_'] : 'off';
?>
    scAjaxFieldRead("idpro2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['unimay_'])) ? $this->nmgp_cmp_readonly['unimay_'] : 'on';
?>
    scAjaxFieldRead("unimay_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("idpro1_" + iSeq, "on");
    scAjaxFieldRead("idpro2_" + iSeq, "on");
    scAjaxFieldRead("costomen_" + iSeq, "on");
    scAjaxFieldRead("unimay_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["codigobar_" + iRow] || "on" == ajax_error_count["codigoprod_" + iRow] || "on" == ajax_error_count["nompro_" + iRow] || "on" == ajax_error_count["idpro1_" + iRow] || "on" == ajax_error_count["idpro2_" + iRow] || "on" == ajax_error_count["costomen_" + iRow] || "on" == ajax_error_count["unimay_" + iRow]))
    {
      ...
      $("#hidden_field_data_idpro1_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idpro2_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_costomen_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_unimay_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["codigobar_" + iRow] && "off" == ajax_error_count["codigoprod_" + iRow] && "off" == ajax_error_count["nompro_" + iRow] && "off" == ajax_error_count["idpro1_" + iRow] && "off" == ajax_error_count["idpro2_" + iRow] && "off" == ajax_error_count["costomen_" + iRow] && "off" == ajax_error_count["unimay_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["idpro1_" + iRow] = "off";
        ajax_error_count["idpro2_" + iRow] = "off";
        ajax_error_count["costomen_" + iRow] = "off";
        ajax_error_count["unimay_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idpro1_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idpro2_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_costomen_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_unimay_" + iRow).removeClass("scFormErrorLine");
    }
  }
