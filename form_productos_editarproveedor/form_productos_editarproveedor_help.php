...
@session_start() ;
class form_productos_editarproveedor_help
{
...
<?php echo "<b>Costo</b><br>" . nl2br("SE DEBE MODIFICAR SOLO CUANDO ESTÉ COMPLETAMENTE SEGURO, ESTO AFECTARÁ LOS COSTOS DE INVENTARIO.
SI EL PRODUCTO MANEJA IVA EL COSTO ES EL VALOR DE LA UNIDAD ANTES DE IMPUESTO"); ?>
</body>
</html>
<?php
        }
...
$exec_help = new form_productos_editarproveedor_help();
?>
