  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_kardex" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tipo
  function do_ajax_control_kardex_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldHidden(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_kardex_validate_tipo(var_tipo, var_script_case_init, do_ajax_control_kardex_validate_tipo_cb);
  } // do_ajax_control_kardex_validate_tipo

  function do_ajax_control_kardex_validate_tipo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_kardex_validate_tipo_cb

  // ---------- Validate pj
  function do_ajax_control_kardex_validate_pj()
  {
    var nomeCampo_pj = "pj";
    var var_pj = scAjaxGetFieldHidden(nomeCampo_pj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_kardex_validate_pj(var_pj, var_script_case_init, do_ajax_control_kardex_validate_pj_cb);
  } // do_ajax_control_kardex_validate_pj

  function do_ajax_control_kardex_validate_pj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pj";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_kardex_validate_pj_cb

  // ---------- Validate numero
  function do_ajax_control_kardex_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_kardex_validate_numero(var_numero, var_script_case_init, do_ajax_control_kardex_validate_numero_cb);
  } // do_ajax_control_kardex_validate_numero

  function do_ajax_control_kardex_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_kardex_validate_numero_cb

  // ---------- Validate kardexid
  function do_ajax_control_kardex_validate_kardexid()
  {
    var nomeCampo_kardexid = "kardexid";
    var var_kardexid = scAjaxGetFieldText(nomeCampo_kardexid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_kardex_validate_kardexid(var_kardexid, var_script_case_init, do_ajax_control_kardex_validate_kardexid_cb);
  } // do_ajax_control_kardex_validate_kardexid

  function do_ajax_control_kardex_validate_kardexid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_kardex_validate_kardexid_cb

  // ---------- Validate fecha
  function do_ajax_control_kardex_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_control_kardex_validate_fecha(var_fecha, var_script_case_init, do_ajax_control_kardex_validate_fecha_cb);
    }, 200);
  } // do_ajax_control_kardex_validate_fecha

  function do_ajax_control_kardex_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_kardex_validate_fecha_cb

  // ---------- Validate asentada
  function do_ajax_control_kardex_validate_asentada()
  {
    ...
    setTimeout(function() {
      var var_asentada = scAjaxGetFieldText(nomeCampo_asentada);
      x_ajax_control_kardex_validate_asentada(var_asentada, var_script_case_init, do_ajax_control_kardex_validate_asentada_cb);
    }, 200);
  } // do_ajax_control_kardex_validate_asentada

  function do_ajax_control_kardex_validate_asentada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_kardex_validate_asentada_cb

  // ---------- Validate sn_cufe
  function do_ajax_control_kardex_validate_sn_cufe()
  {
    var nomeCampo_sn_cufe = "sn_cufe";
    var var_sn_cufe = scAjaxGetFieldText(nomeCampo_sn_cufe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_kardex_validate_sn_cufe(var_sn_cufe, var_script_case_init, do_ajax_control_kardex_validate_sn_cufe_cb);
  } // do_ajax_control_kardex_validate_sn_cufe

  function do_ajax_control_kardex_validate_sn_cufe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_cufe";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_kardex_validate_sn_cufe_cb

  // ---------- Validate observaciones
  function do_ajax_control_kardex_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_kardex_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_control_kardex_validate_observaciones_cb);
  } // do_ajax_control_kardex_validate_observaciones

  function do_ajax_control_kardex_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_kardex_validate_observaciones_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_kardex_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_kardex_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_kardex_submit_form(var_tipo, var_pj, var_numero, var_kardexid, var_fecha, var_asentada, var_sn_cufe, var_observaciones, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_kardex_submit_form_cb);
  } // do_ajax_control_kardex_submit_form

  function do_ajax_control_kardex_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_kardex_submit_form_cb_after_alert);
  } // do_ajax_control_kardex_submit_form_cb
  function do_ajax_control_kardex_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_kardex_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_kardex_navigate_form()
  {
    perform_ajax_control_kardex_navigate_form();
  }

  function perform_ajax_control_kardex_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_kardex_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_kardex']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_kardex_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_kardex_navigate_form_cb_after_alert);
  } // do_ajax_control_kardex_navigate_form_cb
  function do_ajax_control_kardex_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_kardex_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_kardex_navigate_form_cb_after_alert
  function sc_hide_control_kardex_form()
  {
