  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_devcom_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idpro
  function do_ajax_form_devcom_mob_validate_idpro()
  {
  } // do_ajax_form_devcom_mob_validate_idpro

  function do_ajax_form_devcom_mob_validate_idpro_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_idpro_cb

  // ---------- Validate colores
  function do_ajax_form_devcom_mob_validate_colores()
  {
    var nomeCampo_colores = "colores";
    var var_colores = scAjaxGetFieldSelect(nomeCampo_colores);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_mob_validate_colores(var_colores, var_script_case_init, do_ajax_form_devcom_mob_validate_colores_cb);
  } // do_ajax_form_devcom_mob_validate_colores

  function do_ajax_form_devcom_mob_validate_colores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "colores";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_colores_cb

  // ---------- Validate tallas
  function do_ajax_form_devcom_mob_validate_tallas()
  {
    var nomeCampo_tallas = "tallas";
    var var_tallas = scAjaxGetFieldSelect(nomeCampo_tallas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_mob_validate_tallas(var_tallas, var_script_case_init, do_ajax_form_devcom_mob_validate_tallas_cb);
  } // do_ajax_form_devcom_mob_validate_tallas

  function do_ajax_form_devcom_mob_validate_tallas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tallas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_tallas_cb

  // ---------- Validate sabor
  function do_ajax_form_devcom_mob_validate_sabor()
  {
    var nomeCampo_sabor = "sabor";
    var var_sabor = scAjaxGetFieldSelect(nomeCampo_sabor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_mob_validate_sabor(var_sabor, var_script_case_init, do_ajax_form_devcom_mob_validate_sabor_cb);
  } // do_ajax_form_devcom_mob_validate_sabor

  function do_ajax_form_devcom_mob_validate_sabor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sabor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_sabor_cb

  // ---------- Validate cantidad
  function do_ajax_form_devcom_mob_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_mob_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_devcom_mob_validate_cantidad_cb);
  } // do_ajax_form_devcom_mob_validate_cantidad

  function do_ajax_form_devcom_mob_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_cantidad_cb

  // ---------- Validate idbod
  function do_ajax_form_devcom_mob_validate_idbod()
  {
  } // do_ajax_form_devcom_mob_validate_idbod

  function do_ajax_form_devcom_mob_validate_idbod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idbod";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_idbod_cb

  // ---------- Validate valorunit
  function do_ajax_form_devcom_mob_validate_valorunit()
  {
    var nomeCampo_valorunit = "valorunit";
    var var_valorunit = scAjaxGetFieldHidden(nomeCampo_valorunit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_mob_validate_valorunit(var_valorunit, var_script_case_init, do_ajax_form_devcom_mob_validate_valorunit_cb);
  } // do_ajax_form_devcom_mob_validate_valorunit

  function do_ajax_form_devcom_mob_validate_valorunit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valorunit";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_valorunit_cb

  // ---------- Validate valorpar
  function do_ajax_form_devcom_mob_validate_valorpar()
  {
    var nomeCampo_valorpar = "valorpar";
    var var_valorpar = scAjaxGetFieldHidden(nomeCampo_valorpar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_mob_validate_valorpar(var_valorpar, var_script_case_init, do_ajax_form_devcom_mob_validate_valorpar_cb);
  } // do_ajax_form_devcom_mob_validate_valorpar

  function do_ajax_form_devcom_mob_validate_valorpar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valorpar";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_valorpar_cb

  // ---------- Validate iva
  function do_ajax_form_devcom_mob_validate_iva()
  {
    var nomeCampo_iva = "iva";
    var var_iva = scAjaxGetFieldText(nomeCampo_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_mob_validate_iva(var_iva, var_script_case_init, do_ajax_form_devcom_mob_validate_iva_cb);
  } // do_ajax_form_devcom_mob_validate_iva

  function do_ajax_form_devcom_mob_validate_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "iva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_iva_cb

  // ---------- Validate descuento
  function do_ajax_form_devcom_mob_validate_descuento()
  {
    var nomeCampo_descuento = "descuento";
    var var_descuento = scAjaxGetFieldText(nomeCampo_descuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_mob_validate_descuento(var_descuento, var_script_case_init, do_ajax_form_devcom_mob_validate_descuento_cb);
  } // do_ajax_form_devcom_mob_validate_descuento

  function do_ajax_form_devcom_mob_validate_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descuento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_descuento_cb

  // ---------- Validate tasaiva
  function do_ajax_form_devcom_mob_validate_tasaiva()
  {
    var nomeCampo_tasaiva = "tasaiva";
    var var_tasaiva = scAjaxGetFieldText(nomeCampo_tasaiva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_mob_validate_tasaiva(var_tasaiva, var_script_case_init, do_ajax_form_devcom_mob_validate_tasaiva_cb);
  } // do_ajax_form_devcom_mob_validate_tasaiva

  function do_ajax_form_devcom_mob_validate_tasaiva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tasaiva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_tasaiva_cb

  // ---------- Validate tasadesc
  function do_ajax_form_devcom_mob_validate_tasadesc()
  {
    var nomeCampo_tasadesc = "tasadesc";
    var var_tasadesc = scAjaxGetFieldText(nomeCampo_tasadesc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_mob_validate_tasadesc(var_tasadesc, var_script_case_init, do_ajax_form_devcom_mob_validate_tasadesc_cb);
  } // do_ajax_form_devcom_mob_validate_tasadesc

  function do_ajax_form_devcom_mob_validate_tasadesc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tasadesc";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_tasadesc_cb

  // ---------- Validate devuelto
  function do_ajax_form_devcom_mob_validate_devuelto()
  {
    var nomeCampo_devuelto = "devuelto";
    var var_devuelto = scAjaxGetFieldText(nomeCampo_devuelto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_mob_validate_devuelto(var_devuelto, var_script_case_init, do_ajax_form_devcom_mob_validate_devuelto_cb);
  } // do_ajax_form_devcom_mob_validate_devuelto

  function do_ajax_form_devcom_mob_validate_devuelto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "devuelto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_devuelto_cb

  // ---------- Validate id
  function do_ajax_form_devcom_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_mob_validate_id(var_id, var_script_case_init, do_ajax_form_devcom_mob_validate_id_cb);
  } // do_ajax_form_devcom_mob_validate_id

  function do_ajax_form_devcom_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_mob_validate_id_cb

  // ---------- Event onblur cantidad
  function do_ajax_form_devcom_mob_event_cantidad_onblur()
  {
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_idpro = scAjaxGetFieldHidden("idpro");
    var var_id = scAjaxGetFieldText("id");
    var var_idbod = scAjaxGetFieldText("idbod");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devcom_mob_event_cantidad_onblur(var_cantidad, var_idpro, var_id, var_idbod, var_script_case_init, do_ajax_form_devcom_mob_event_cantidad_onblur_cb);
  } // do_ajax_form_devcom_mob_event_cantidad_onblur

  function do_ajax_form_devcom_mob_event_cantidad_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cantidad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devcom_mob_event_cantidad_onblur_cb_after_alert);
  } // do_ajax_form_devcom_mob_event_cantidad_onblur_cb
  function do_ajax_form_devcom_mob_event_cantidad_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devcom_mob_event_cantidad_onblur_cb_after_alert

  // ---------- Event onchange cantidad
  function do_ajax_form_devcom_mob_event_cantidad_onchange()
  {
    var var_valorpar = scAjaxGetFieldHidden("valorpar");
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_valorunit = scAjaxGetFieldHidden("valorunit");
    var var_descuento = scAjaxGetFieldText("descuento");
    var var_tasaiva = scAjaxGetFieldText("tasaiva");
    var var_iva = scAjaxGetFieldText("iva");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devcom_mob_event_cantidad_onchange(var_valorpar, var_cantidad, var_valorunit, var_descuento, var_tasaiva, var_iva, var_script_case_init, do_ajax_form_devcom_mob_event_cantidad_onchange_cb);
  } // do_ajax_form_devcom_mob_event_cantidad_onchange

  function do_ajax_form_devcom_mob_event_cantidad_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cantidad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devcom_mob_event_cantidad_onchange_cb_after_alert);
  } // do_ajax_form_devcom_mob_event_cantidad_onchange_cb
  function do_ajax_form_devcom_mob_event_cantidad_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devcom_mob_event_cantidad_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_devcom_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_devcom_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpro = scAjaxGetFieldHidden("idpro");
    ...
    var var_descuento = scAjaxGetFieldText("descuento");
    var var_tasaiva = scAjaxGetFieldText("tasaiva");
    var var_tasadesc = scAjaxGetFieldText("tasadesc");
    var var_devuelto = scAjaxGetFieldText("devuelto");
    var var_id = scAjaxGetFieldText("id");
    var var_iddet = scAjaxGetFieldText("iddet");
    ...
    scAjaxProcOn();
    x_ajax_form_devcom_mob_submit_form(var_idpro, var_colores, var_tallas, var_sabor, var_cantidad, var_idbod, var_valorunit, var_valorpar, var_iva, var_descuento, var_tasaiva, var_tasadesc, var_devuelto, var_id, var_iddet, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_devcom_mob_submit_form_cb);
  } // do_ajax_form_devcom_mob_submit_form

  function do_ajax_form_devcom_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("idbod");
      scAjaxHideErrorDisplay("valorunit");
      scAjaxHideErrorDisplay("valorpar");
      scAjaxHideErrorDisplay("iva");
      scAjaxHideErrorDisplay("descuento");
      scAjaxHideErrorDisplay("tasaiva");
      scAjaxHideErrorDisplay("tasadesc");
      scAjaxHideErrorDisplay("devuelto");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_devcom_mob_submit_form_cb_after_alert);
  } // do_ajax_form_devcom_mob_submit_form_cb
  function do_ajax_form_devcom_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_devcom_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_devcom_mob_navigate_form()
  {
    perform_ajax_form_devcom_mob_navigate_form();
  }

  function perform_ajax_form_devcom_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("devuelto");
    scAjaxHideErrorDisplay("id");
    var var_iddet = document.F2.iddet.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_devcom_mob_navigate_form(var_iddet, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_devcom_mob_navigate_form_cb);
  } // do_ajax_form_devcom_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_devcom_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.iddet.value = scAjaxGetKeyValue("iddet");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_devcom_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_devcom_mob_navigate_form_cb
  function do_ajax_form_devcom_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_devcom_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_devcom_mob_navigate_form_cb_after_alert
  function sc_hide_form_devcom_mob_form()
  {
  ...
  ajax_field_list[0] = "idpro";
  ajax_field_list[1] = "colores";
  ajax_field_list[2] = "tallas";
  ajax_field_list[3] = "sabor";
  ajax_field_list[4] = "cantidad";
  ajax_field_list[5] = "idbod";
  ajax_field_list[6] = "valorunit";
  ajax_field_list[7] = "valorpar";
  ajax_field_list[8] = "iva";
  ajax_field_list[9] = "descuento";
  ajax_field_list[10] = "tasaiva";
  ajax_field_list[11] = "tasadesc";
  ajax_field_list[12] = "devuelto";
  ajax_field_list[13] = "id";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idpro": {"label": "Artículo o Producto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "idbod": {"label": "Ubicación", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "valorunit": {"label": "Valorunit", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "valorpar": {"label": "Valorpar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "iva": {"label": "Iva", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descuento": {"label": "Desc. x Und.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tasaiva": {"label": "Tasaiva", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tasadesc": {"label": "Tasadesc", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "devuelto": {"label": "Devuelto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["idbod"][1] = "idbod";
  ajax_field_mult["valorunit"][1] = "valorunit";
  ajax_field_mult["valorpar"][1] = "valorpar";
  ajax_field_mult["iva"][1] = "iva";
  ajax_field_mult["descuento"][1] = "descuento";
  ajax_field_mult["tasaiva"][1] = "tasaiva";
  ajax_field_mult["tasadesc"][1] = "tasadesc";
  ajax_field_mult["devuelto"][1] = "devuelto";
  ...
  var ajax_field_id = {
    ...
    "idbod": new Array("hidden_field_label_idbod", "hidden_field_data_idbod"),
    "valorunit": new Array("hidden_field_label_valorunit", "hidden_field_data_valorunit"),
    "valorpar": new Array("hidden_field_label_valorpar", "hidden_field_data_valorpar"),
    "iva": new Array("hidden_field_label_iva", "hidden_field_data_iva"),
    "descuento": new Array("hidden_field_label_descuento", "hidden_field_data_descuento")
  };
