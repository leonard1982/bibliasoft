  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_devcom" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idpro
  function do_ajax_form_devcom_validate_idpro()
  {
  } // do_ajax_form_devcom_validate_idpro

  function do_ajax_form_devcom_validate_idpro_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_idpro_cb

  // ---------- Validate colores
  function do_ajax_form_devcom_validate_colores()
  {
    var nomeCampo_colores = "colores";
    var var_colores = scAjaxGetFieldSelect(nomeCampo_colores);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_validate_colores(var_colores, var_script_case_init, do_ajax_form_devcom_validate_colores_cb);
  } // do_ajax_form_devcom_validate_colores

  function do_ajax_form_devcom_validate_colores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "colores";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_colores_cb

  // ---------- Validate tallas
  function do_ajax_form_devcom_validate_tallas()
  {
    var nomeCampo_tallas = "tallas";
    var var_tallas = scAjaxGetFieldSelect(nomeCampo_tallas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_validate_tallas(var_tallas, var_script_case_init, do_ajax_form_devcom_validate_tallas_cb);
  } // do_ajax_form_devcom_validate_tallas

  function do_ajax_form_devcom_validate_tallas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tallas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_tallas_cb

  // ---------- Validate sabor
  function do_ajax_form_devcom_validate_sabor()
  {
    var nomeCampo_sabor = "sabor";
    var var_sabor = scAjaxGetFieldSelect(nomeCampo_sabor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_validate_sabor(var_sabor, var_script_case_init, do_ajax_form_devcom_validate_sabor_cb);
  } // do_ajax_form_devcom_validate_sabor

  function do_ajax_form_devcom_validate_sabor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sabor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_sabor_cb

  // ---------- Validate cantidad
  function do_ajax_form_devcom_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_devcom_validate_cantidad_cb);
  } // do_ajax_form_devcom_validate_cantidad

  function do_ajax_form_devcom_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_cantidad_cb

  // ---------- Validate idbod
  function do_ajax_form_devcom_validate_idbod()
  {
  } // do_ajax_form_devcom_validate_idbod

  function do_ajax_form_devcom_validate_idbod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idbod";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_idbod_cb

  // ---------- Validate valorunit
  function do_ajax_form_devcom_validate_valorunit()
  {
    var nomeCampo_valorunit = "valorunit";
    var var_valorunit = scAjaxGetFieldHidden(nomeCampo_valorunit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_validate_valorunit(var_valorunit, var_script_case_init, do_ajax_form_devcom_validate_valorunit_cb);
  } // do_ajax_form_devcom_validate_valorunit

  function do_ajax_form_devcom_validate_valorunit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_valorunit_cb

  // ---------- Validate valorpar
  function do_ajax_form_devcom_validate_valorpar()
  {
    var nomeCampo_valorpar = "valorpar";
    var var_valorpar = scAjaxGetFieldHidden(nomeCampo_valorpar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_validate_valorpar(var_valorpar, var_script_case_init, do_ajax_form_devcom_validate_valorpar_cb);
  } // do_ajax_form_devcom_validate_valorpar

  function do_ajax_form_devcom_validate_valorpar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_valorpar_cb

  // ---------- Validate iva
  function do_ajax_form_devcom_validate_iva()
  {
    var nomeCampo_iva = "iva";
    var var_iva = scAjaxGetFieldText(nomeCampo_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_validate_iva(var_iva, var_script_case_init, do_ajax_form_devcom_validate_iva_cb);
  } // do_ajax_form_devcom_validate_iva

  function do_ajax_form_devcom_validate_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "iva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_iva_cb

  // ---------- Validate descuento
  function do_ajax_form_devcom_validate_descuento()
  {
    var nomeCampo_descuento = "descuento";
    var var_descuento = scAjaxGetFieldText(nomeCampo_descuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_validate_descuento(var_descuento, var_script_case_init, do_ajax_form_devcom_validate_descuento_cb);
  } // do_ajax_form_devcom_validate_descuento

  function do_ajax_form_devcom_validate_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_descuento_cb

  // ---------- Validate tasaiva
  function do_ajax_form_devcom_validate_tasaiva()
  {
    var nomeCampo_tasaiva = "tasaiva";
    var var_tasaiva = scAjaxGetFieldText(nomeCampo_tasaiva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_validate_tasaiva(var_tasaiva, var_script_case_init, do_ajax_form_devcom_validate_tasaiva_cb);
  } // do_ajax_form_devcom_validate_tasaiva

  function do_ajax_form_devcom_validate_tasaiva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tasaiva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_tasaiva_cb

  // ---------- Validate tasadesc
  function do_ajax_form_devcom_validate_tasadesc()
  {
    var nomeCampo_tasadesc = "tasadesc";
    var var_tasadesc = scAjaxGetFieldText(nomeCampo_tasadesc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_validate_tasadesc(var_tasadesc, var_script_case_init, do_ajax_form_devcom_validate_tasadesc_cb);
  } // do_ajax_form_devcom_validate_tasadesc

  function do_ajax_form_devcom_validate_tasadesc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_tasadesc_cb

  // ---------- Validate devuelto
  function do_ajax_form_devcom_validate_devuelto()
  {
    var nomeCampo_devuelto = "devuelto";
    var var_devuelto = scAjaxGetFieldText(nomeCampo_devuelto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_validate_devuelto(var_devuelto, var_script_case_init, do_ajax_form_devcom_validate_devuelto_cb);
  } // do_ajax_form_devcom_validate_devuelto

  function do_ajax_form_devcom_validate_devuelto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_devuelto_cb

  // ---------- Validate id
  function do_ajax_form_devcom_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devcom_validate_id(var_id, var_script_case_init, do_ajax_form_devcom_validate_id_cb);
  } // do_ajax_form_devcom_validate_id

  function do_ajax_form_devcom_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devcom_validate_id_cb

  // ---------- Event onblur cantidad
  function do_ajax_form_devcom_event_cantidad_onblur()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_devcom_event_cantidad_onblur(var_cantidad, var_idpro, var_id, var_idbod, var_script_case_init, do_ajax_form_devcom_event_cantidad_onblur_cb);
  } // do_ajax_form_devcom_event_cantidad_onblur

  function do_ajax_form_devcom_event_cantidad_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cantidad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devcom_event_cantidad_onblur_cb_after_alert);
  } // do_ajax_form_devcom_event_cantidad_onblur_cb
  function do_ajax_form_devcom_event_cantidad_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devcom_event_cantidad_onblur_cb_after_alert

  // ---------- Event onchange cantidad
  function do_ajax_form_devcom_event_cantidad_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devcom_event_cantidad_onchange(var_valorpar, var_cantidad, var_valorunit, var_descuento, var_tasaiva, var_iva, var_script_case_init, do_ajax_form_devcom_event_cantidad_onchange_cb);
  } // do_ajax_form_devcom_event_cantidad_onchange

  function do_ajax_form_devcom_event_cantidad_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cantidad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devcom_event_cantidad_onchange_cb_after_alert);
  } // do_ajax_form_devcom_event_cantidad_onchange_cb
  function do_ajax_form_devcom_event_cantidad_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devcom_event_cantidad_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_devcom_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_devcom_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpro = scAjaxGetFieldHidden("idpro");
    ...
    scAjaxProcOn();
    x_ajax_form_devcom_submit_form(var_idpro, var_colores, var_tallas, var_sabor, var_cantidad, var_idbod, var_valorunit, var_valorpar, var_iva, var_descuento, var_tasaiva, var_tasadesc, var_devuelto, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_devcom_submit_form_cb);
  } // do_ajax_form_devcom_submit_form

  function do_ajax_form_devcom_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_devcom_submit_form_cb_after_alert);
  } // do_ajax_form_devcom_submit_form_cb
  function do_ajax_form_devcom_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_devcom_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_devcom_navigate_form()
  {
    perform_ajax_form_devcom_navigate_form();
  }

  function perform_ajax_form_devcom_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_devcom_navigate_form(var_iddet, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_devcom_navigate_form_cb);
  } // do_ajax_form_devcom_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_devcom_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_devcom_navigate_form_cb_after_alert);
  } // do_ajax_form_devcom_navigate_form_cb
  function do_ajax_form_devcom_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_devcom_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_devcom_navigate_form_cb_after_alert
  function sc_hide_form_devcom_form()
  {
