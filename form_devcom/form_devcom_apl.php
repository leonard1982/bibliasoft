...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->colo) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['colo'] = $this->colo;
      }
      if (isset($this->tall) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['tall'] = $this->tall;
      }
      if (isset($this->sabo) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['sabo'] = $this->sabo;
      }
      ...
      if (isset($_POST["colo"]) && isset($this->colo)) 
      {
          $_SESSION['colo'] = $this->colo;
      }
      if (isset($_POST["tall"]) && isset($this->tall)) 
      {
          $_SESSION['tall'] = $this->tall;
      }
      if (isset($_POST["sabo"]) && isset($this->sabo)) 
      {
          $_SESSION['sabo'] = $this->sabo;
      }
      ...
      if (isset($_GET["colo"]) && isset($this->colo)) 
      {
          $_SESSION['colo'] = $this->colo;
      }
      if (isset($_GET["tall"]) && isset($this->tall)) 
      {
          $_SESSION['tall'] = $this->tall;
      }
      if (isset($_GET["sabo"]) && isset($this->sabo)) 
      {
          $_SESSION['sabo'] = $this->sabo;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_devcom']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_devcom']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_devcom']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_devcom']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_devcom']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_devcom']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_devcom']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_devcom']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_idinvself)) 
          {
              $_SESSION['par_idinvself'] = $this->par_idinvself;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_devcom']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_devcom']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_devcom']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_devcom']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_devcom']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_devcom']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_devcom']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_devcom']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_devcom']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_devcom_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['initialize'])
          {
              $_SESSION['scriptcase']['form_devcom']['contr_erro'] = 'on';
  $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['start'] = 'new';
$_SESSION['scriptcase']['form_devcom']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['form_devcom']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_devcom']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_devcom'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_devcom']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_devcom']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_devcom') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_devcom']['label'] = "Devolución en entrada o compra";
      ...
      $_SESSION['scriptcase']['error_icon']['form_devcom']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_devcom'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_orig'] = " where iddet=" . $_SESSION['par_idinvself'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_pesq'] = " where iddet=" . $_SESSION['par_idinvself'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_devcom'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_devcom'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dados_form'];
          if (!isset($this->iddet)){$this->iddet = $this->nmgp_dados_form['iddet'];} 
          if (!isset($this->idfaccom)){$this->idfaccom = $this->nmgp_dados_form['idfaccom'];} 
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['idbod'] != "null"){$this->idbod = $this->nmgp_dados_form['idbod'];} 
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_devcom", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_devcom_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_devcom_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_devcom/form_devcom_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_devcom_erro.class.php"); 
      }
      $this->Erro      = new form_devcom_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['opcao']))
         { 
             if ($this->iddet != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_devcom']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_devcom']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_devcom']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dados_select'];
     }
   }
...
//
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_devcom_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_devcom_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          if ('autocomp_idbod' == $this->NM_ajax_opcao)
          {
              if (isset($_GET['term'])) {
                  $this->idbod = ($_SESSION['scriptcase']['charset'] != "UTF-8") ? NM_utf8_decode(sc_convert_encoding($_GET['term'], $_SESSION['scriptcase']['charset'], 'UTF-8')) : $_GET['term'];
              } else {
                  $this->idbod = '';
              }
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   ...
   $nm_comando = "SELECT idbodega, bodega FROM bodegas WHERE bodega LIKE '%" . substr($this->Db->qstr($this->idbod), 1, -1) . "%' ORDER BY bodega";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dados_select']['idbod']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idbod = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dados_select']['idbod'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dados_select']['descuento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->descuento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dados_select']['descuento'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_devcom.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("Devolución en entrada o compra") ?></TITLE>
...
<form name="Fdown" method="get" action="form_devcom_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_devcom"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_devcom']) || !is_array($this->NM_ajax_info['errList']['geral_form_devcom']))
              {
                  $this->NM_ajax_info['errList']['geral_form_devcom'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_devcom'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if (!isset($this->sc_temp_sabo)) {$this->sc_temp_sabo = (isset($_SESSION['sabo'])) ? $_SESSION['sabo'] : "";}
if (!isset($this->sc_temp_tall)) {$this->sc_temp_tall = (isset($_SESSION['tall'])) ? $_SESSION['tall'] : "";}
if (!isset($this->sc_temp_colo)) {$this->sc_temp_colo = (isset($_SESSION['colo'])) ? $_SESSION['colo'] : "";}
   
      $nm_select = "SELECT SUM(cantidad) AS existencia FROM inventario WHERE idpro=$this->idpro  AND iddetalle=$this->id  AND idbod=$this->idbod  and colores=$this->sc_temp_colo and tallas=$this->sc_temp_tall and sabor=$this->sc_temp_sabo"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds = array();
     if ($this->idpro != "" && $this->id != "" && $this->idbod != "")
     { 
...
{$canti=$this->cantidad *-1;

 if($canti>$this->ds[0][0])
	{
		
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "¡Cantidad excede la compra o saldo en bodega!";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_devcom';
  } elseif ('submit_form' == $this->NM_ajax_opcao) {
   $sErrorIndex = 'geral_form_devcom';
  } else {
   $sErrorIndex = substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
  }
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "¡Cantidad excede la compra o saldo en bodega!";
 }
;
	...
	$cant=$this->cantidad *-1;
     ...
     $nm_select ="insert detallecompra set idfaccom=$this->idfaccom , idpro=$this->idpro , idbod=$this->idbod , cantidad=$this->cantidad , valorunit=			$this->valorunit , valorpar=$this->valorpar , iva=$this->iva , descuento=$this->descuento , tasaiva=$this->tasaiva ,  	tasadesc=$this->tasadesc , devuelto=($dev+$cant), colores=$this->sc_temp_colo, tallas=$this->sc_temp_tall, sabor=$this->sc_temp_sabo"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         $rf->Close();
      ;
	$this->actualiza_saldo();
	 }
}
if (isset($this->sc_temp_colo)) { $_SESSION['colo'] = $this->sc_temp_colo;}
if (isset($this->sc_temp_tall)) { $_SESSION['tall'] = $this->sc_temp_tall;}
if (isset($this->sc_temp_sabo)) { $_SESSION['sabo'] = $this->sc_temp_sabo;}
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_tasadesc != $this->tasadesc || (isset($bFlagRead_tasadesc) && $bFlagRead_tasadesc)))
    {
...
$_SESSION['scriptcase']['form_devcom']['contr_erro'] = 'off'; 
    ...
    function ValidateField_idpro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Artículo o Producto " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 10 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_colores(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->colores) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['Lookup_colores']) && !in_array($this->colores, $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['Lookup_colores']))
               {
                   $hasError = true;
    ...
    function ValidateField_tallas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->tallas) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['Lookup_tallas']) && !in_array($this->tallas, $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['Lookup_tallas']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_sabor(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->sabor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['Lookup_sabor']) && !in_array($this->sabor, $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['Lookup_sabor']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cantidad(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->cantidad, 8, 2, 0, 0, "T") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_idbod(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->idbod) > 10) 
          { 
              $hasError = true;
              $Campos_Crit .= "Ubicación " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 10 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['idbod']))
              {
                  $Campos_Erros['idbod'] = array();
              }
              $Campos_Erros['idbod'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 10 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['idbod']) || !is_array($this->NM_ajax_info['errList']['idbod']))
              {
                  $this->NM_ajax_info['errList']['idbod'] = array();
              }
              $this->NM_ajax_info['errList']['idbod'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 10 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_valorpar(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              elseif ('-' == substr($this->valorpar, -1))
              {
                  $iTestSize++;
                  $this->valorpar = '-' . substr($this->valorpar, 0, -1);
              }
              ...
              if ($teste_validade->Valor($this->valorpar, 12, 0, 0, 0, "T") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_iva(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->iva, 11, 0, 0, 0, "T") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Iva; " ; 
                  if (!isset($Campos_Erros['iva']))
    ...
    function ValidateField_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              elseif ('-' == substr($this->id, -1))
              {
                  $iTestSize++;
                  $this->id = '-' . substr($this->id, 0, -1);
              }
              ...
              if ($teste_validade->Valor($this->id, 20, 0, 0, 0, "S") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "ID; " ; 
                  if (!isset($Campos_Erros['id']))
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['iddet']['keyVal'] = form_devcom_pack_protect_string($this->nmgp_dados_form['iddet']);
          }
   } // ajax_return_values
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_devcom_pack_protect_string(NM_charset_to_utf8($this->idpro))]) ? $aLookup[0][form_devcom_pack_protect_string(NM_charset_to_utf8($this->idpro))] : "";
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['colores']['valList'][$i] = form_devcom_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tallas']['valList'][$i] = form_devcom_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['sabor']['valList'][$i] = form_devcom_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_devcom_pack_protect_string(NM_charset_to_utf8($this->idbod))]) ? $aLookup[0][form_devcom_pack_protect_string(NM_charset_to_utf8($this->idbod))] : "";
          $this->NM_ajax_info['fldList']['idbod_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($val_output),
              );
          }
   ...
   function ajax_return_values_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
if($res==0)
	{
	$this->nm_mens_alert[] = "¡COMPRA NO ASENTADA, NO SE PUEDE HACER DEVOLUCIONES!"; $this->nm_params_alert[] = array(); if ($this->NM_ajax_flag) { $this->sc_ajax_alert("¡COMPRA NO ASENTADA, NO SE PUEDE HACER DEVOLUCIONES!"); }}
else
	{
	 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_select = "select * from detallecompra where iddet=$this->sc_temp_par_idinvself"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_select = "select * from detallecompra where iddet=$this->sc_temp_par_idinvself"; 
	...
	if(!empty($this->ds[0][0]))
		{
			...
			$this->id =$this->ds[0][0];
			$this->idfaccom =$this->ds[0][1];
			$this->idpro =$this->ds[0][2];
			$this->idbod =$this->ds[0][3];
			$this->cantidad =$this->ds[0][4]*-1;
			$this->valorunit =$this->ds[0][5];
			$this->valorpar =$this->ds[0][6]*-1;
			$this->iva =$this->ds[0][7]*-1;
			$this->descuento =$this->ds[0][8];
			$this->tasaiva =$this->ds[0][9];
			$this->tasadesc =$this->ds[0][10];
			$this->devuelto =$this->ds[0][11];
			$this->colores =$this->ds[0][12];$this->sc_temp_colo=$this->colores ;
			$this->tallas =$this->ds[0][13];$this->sc_temp_tall=$this->tallas ;
			$this->sabor =$this->ds[0][14];$this->sc_temp_sabo=$this->sabor ;
...
$_SESSION['scriptcase']['form_devcom']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "idpro = $this->idpro, idbod = $this->idbod, cantidad = $this->cantidad, valorunit = $this->valorunit, valorpar = $this->valorpar, iva = $this->iva, descuento = $this->descuento, tasaiva = $this->tasaiva, tasadesc = $this->tasadesc, devuelto = $this->devuelto, colores = $this->colores, tallas = $this->tallas, sabor = $this->sabor"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['idfaccom']) && $NM_val_form['idfaccom'] != $this->nmgp_dados_select['idfaccom']) 
              { 
                  $SC_fields_update[] = "idfaccom = $this->idfaccom"; 
              } 
              $aDoNotUpdate = array();
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('idpro', 'colores', 'tallas', 'sabor', 'cantidad', 'idbod', 'valorunit', 'valorpar', 'iva', 'descuento', 'tasaiva', 'tasadesc', 'devuelto', 'id'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (iddet, idfaccom, idpro, idbod, cantidad, valorunit, valorpar, iva, descuento, tasaiva, tasadesc, devuelto, colores, tallas, sabor) VALUES ($this->iddet, $this->idfaccom, $this->idpro, $this->idbod, $this->cantidad, $this->valorunit, $this->valorpar, $this->iva, $this->descuento, $this->tasaiva, $this->tasadesc, $this->devuelto, $this->colores, $this->tallas, $this->sabor)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "iddet, idfaccom, idpro, idbod, cantidad, valorunit, valorpar, iva, descuento, tasaiva, tasadesc, devuelto, colores, tallas, sabor) VALUES (" . $NM_seq_auto . "$this->iddet, $this->idfaccom, $this->idpro, $this->idbod, $this->cantidad, $this->valorunit, $this->valorpar, $this->iva, $this->descuento, $this->tasaiva, $this->tasadesc, $this->devuelto, $this->colores, $this->tallas, $this->sabor)"; 
              }
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'] = 0; 
              }
...
$a=$this->idfaccom ;
     ...
     $nm_select ="INSERT inventario SET fecha='$fech', cantidad=$this->cantidad , idpro=$this->idpro , costo=$this->valorunit , valorparcial=$this->valorpar , idbod=$this->idbod , tipo=2, detalle='Devolución en Compra', idmov=1,  idfaccom=$a, nufacvta=0, iddetalle=$last_id"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
;
$numfact=substr($this->ds , 8);
$dev=$this->devuelto ;
$cant=$this->cantidad *-1;


     $nm_select ="INSERT devcompra SET fecha='$fech', numfaccom='$numfact', idinven=$last_id, idpro=$this->idpro , cantidad=$cant"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="UPDATE detallecompra set devuelto=($dev+$cant) where iddet=$last_id"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="update facturacom set observaciones='TIENE DEVOLUCION',anulada='DEVUELTA' where idfaccom=$a"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="delete from detallecompraself where iddet=$last_ide"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$_SESSION['scriptcase']['form_devcom']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['parms'] = "iddet?#?$this->iddet?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("iddet=" . $_SESSION['par_idinvself'] . "");
      ...
      { 
          ...
          $qt_geral_reg_form_devcom = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['total'] = $qt_geral_reg_form_devcom;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->iddet))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_devcom = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'] > $qt_geral_reg_form_devcom)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'] = $qt_geral_reg_form_devcom; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_devcom) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
          { 
              $nmgp_select = "SELECT iddet, idfaccom, idpro, idbod, cantidad, valorunit, valorpar, iva, descuento, tasaiva, tasadesc, devuelto, colores, tallas, sabor from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT iddet, idfaccom, idpro, idbod, cantidad, valorunit, valorpar, iva, descuento, tasaiva, tasadesc, devuelto, colores, tallas, sabor from " . $this->Ini->nm_tabela ; 
          ...
          $aWhere = array();
          $aWhere[] = "iddet=" . $_SESSION['par_idinvself'] . "";
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'] < $qt_geral_reg_form_devcom;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['reg_start'] + 1;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$this->valorpar =round(($this->cantidad *($this->valorunit -$this->descuento )), 0);
$tar=$this->tasaiva /100;
$this->iva =round(($this->valorpar *$tar), 0);
...
$cons=$this->consulta();
if(!empty($cons)){$canti=$this->cantidad *-1;
if($canti>$cons)
	{
		echo "<h4>Cantidad Máxima a devolver: -$cons</h4>";
		echo "<br>"; 
...
$this->nm_formatar_campos('cantidad', 'idpro', 'id', 'idbod');
...
$this->nm_formatar_campos('valorpar', 'cantidad', 'valorunit', 'descuento', 'tasaiva', 'iva');
...
$det=$this->id ;
$bod=$this->idbod ;
$co=$this->sc_temp_colo;
$ta=$this->sc_temp_tall;
$sa=$this->sc_temp_sabo;

 
      $nm_select = "SELECT SUM(cantidad) AS existencia FROM detallecompra WHERE idpro=$i AND idbod=$bod and colores=$co and tallas=$ta and sabor=$sa"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->des = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_devcom_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        $searchOk = false;
        if ('SC_all_Cmp' == $this->nmgp_fast_search && in_array($field, array("idinv", "fecha", "cantidad", "idpro", "costo", "valorparcial", "idbod", "tipo", "detalle", "idmov", "idfaccom", "nufacvta", "idinvent"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['csrf_token'];
    }
...
{ 
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter_form'] . " and (iddet=" . $_SESSION['par_idinvself'] . ") and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where iddet=" . $_SESSION['par_idinvself'] . " and (" . $comando . ")";
      }
      $nmgp_select = "SELECT count(*) AS countTest from " . $this->Ini->nm_tabela . $sc_where; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      $rt = $this->Db->Execute($nmgp_select) ; 
      ...
      $qt_geral_reg_form_devcom = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['total'] = $qt_geral_reg_form_devcom;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_devcom_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "iddet";$nm_numeric[] = "idfaccom";$nm_numeric[] = "idpro";$nm_numeric[] = "idbod";$nm_numeric[] = "cantidad";$nm_numeric[] = "valorunit";$nm_numeric[] = "valorpar";$nm_numeric[] = "iva";$nm_numeric[] = "descuento";$nm_numeric[] = "tasaiva";$nm_numeric[] = "tasadesc";$nm_numeric[] = "devuelto";$nm_numeric[] = "colores";$nm_numeric[] = "tallas";$nm_numeric[] = "sabor";$nm_numeric[] = "";
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_devcom_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_devcom_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom']['masterValue']))
{
