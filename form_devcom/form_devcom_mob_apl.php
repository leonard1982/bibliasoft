...
$_SESSION['scriptcase']['form_devcom_mob']['contr_erro'] = 'off';
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom_mob']['insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devcom_mob']['insert'];
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom_mob']['embutida_liga_form_insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom_mob']['embutida_liga_form_insert'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devcom_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_devcom_mob']['insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_devcom_mob']['insert'];
      }
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom_mob']['opcao'] = "inicio";
...
//---------- 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devcom_mob']['dados_select'];
...
<?php
  exit;
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "bcancelar":
                return array("sc_b_sai_t.sc-unique-btn-1", "sc_b_sai_t.sc-unique-btn-16");
                break;
            case "update":
                return array("sc_b_upd_t.sc-unique-btn-2", "sc_b_upd_t.sc-unique-btn-17");
                break;
            case "new":
