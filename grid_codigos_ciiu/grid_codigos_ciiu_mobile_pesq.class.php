...
class grid_codigos_ciiu_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_codigos_ciiu_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_codigos_ciiu_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_codigos_ciiu_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_ciiu')
      {
          $id_ciiu = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_ciiu($id_ciiu);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codigo_ciiu')
      {
          $codigo_ciiu = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codigo_ciiu($codigo_ciiu);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_id_ciiu($id_ciiu)
   {
      $id_ciiu = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $id_ciiu);
      $id_ciiu = substr($this->Db->qstr($id_ciiu), 1, -1);
            $id_ciiu_look = substr($this->Db->qstr($id_ciiu), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_ciiu from " . $this->Ini->nm_tabela . " where   CAST (id_ciiu AS TEXT)  like '%" . $id_ciiu . "%' order by id_ciiu"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct id_ciiu from " . $this->Ini->nm_tabela . " where   CAST (id_ciiu AS VARCHAR)  like '%" . $id_ciiu . "%' order by id_ciiu"; 
      }
      else
      {
          $nm_comando = "select distinct id_ciiu from " . $this->Ini->nm_tabela . " where  id_ciiu like '%" . $id_ciiu . "%' order by id_ciiu"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_codigo_ciiu($codigo_ciiu)
   {
      $codigo_ciiu = substr($this->Db->qstr($codigo_ciiu), 1, -1);
            $codigo_ciiu_look = substr($this->Db->qstr($codigo_ciiu), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct codigo_ciiu from " . $this->Ini->nm_tabela . " where  codigo_ciiu like '%" . $codigo_ciiu . "%' order by codigo_ciiu"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_ciiu";$Nm_numeric[] = "id_ciiu";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>CONSULTA CÓDIGOS CIIU</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_codigos_ciiu/grid_codigos_ciiu_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_codigos_ciiu_ajax_search.js"></script>
 <script type="text/javascript" src="grid_codigos_ciiu_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_codigos_ciiu_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_codigos_ciiu']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_codigos_ciiu']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_ciiu_cond#NMF#' + search_get_sel_txt('SC_id_ciiu_cond') + '@NMF@';
  str_out += 'SC_id_ciiu#NMF#' + search_get_text('SC_id_ciiu') + '@NMF@';
  str_out += 'id_ac_id_ciiu#NMF#' + search_get_title('select2-id_ac_id_ciiu-container') + '@NMF@';
  str_out += 'SC_id_ciiu_input_2#NMF#' + search_get_text('SC_id_ciiu_input_2') + '@NMF@';
  str_out += 'SC_codigo_ciiu_cond#NMF#' + search_get_sel_txt('SC_codigo_ciiu_cond') + '@NMF@';
  str_out += 'SC_codigo_ciiu#NMF#' + search_get_text('SC_codigo_ciiu') + '@NMF@';
  str_out += 'id_ac_codigo_ciiu#NMF#' + search_get_title('select2-id_ac_codigo_ciiu-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-codigo_ciiu").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_codigo_ciiu",
      max_itens: "10",
   ...
   $("#SC_codigo_ciiu").val(e.params.data.id);
  });
  ...
  $(".sc-ui-autocomp-id_ciiu").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_id_ciiu",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_id_ciiu").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>CONSULTA CÓDIGOS CIIU</span></td>
...
<?php
   ...
   {
      global 
             $id_ciiu_cond, $id_ciiu, $id_ciiu_input_2, $id_ciiu_autocomp,
             $codigo_ciiu_cond, $codigo_ciiu, $codigo_ciiu_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_ciiu = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['id_ciiu']; 
          $id_ciiu_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['id_ciiu_input_2']; 
          $id_ciiu_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['id_ciiu_cond']; 
          $codigo_ciiu = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['codigo_ciiu']; 
          $codigo_ciiu_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['codigo_ciiu_cond']; 
          $descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['descripcion']; 
          $descripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['descripcion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_ciiu_cond) || empty($id_ciiu_cond))
      {
         $id_ciiu_cond = "gt";
      }
      if (!isset($codigo_ciiu_cond) || empty($codigo_ciiu_cond))
      {
         $codigo_ciiu_cond = "qp";
      }
      ...
      $str_hide_id_ciiu = (in_array($id_ciiu_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_codigo_ciiu = (in_array($codigo_ciiu_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_descripcion = (in_array($descripcion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_ciiu = ('bw' == $id_ciiu_cond) ? $display_aberto : $display_fechado;
      $str_display_codigo_ciiu = ('bw' == $codigo_ciiu_cond) ? $display_aberto : $display_fechado;
      $str_display_descripcion = ('bw' == $descripcion_cond) ? $display_aberto : $display_fechado;

      if (!isset($id_ciiu) || $id_ciiu == "")
      {
          $id_ciiu = "";
      }
      if (isset($id_ciiu) && !empty($id_ciiu))
      {
         $tmp_pos = strpos($id_ciiu, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_ciiu = substr($id_ciiu, 0, $tmp_pos);
         }
      }
      if (!isset($codigo_ciiu) || $codigo_ciiu == "")
      {
          $codigo_ciiu = "";
      }
      if (isset($codigo_ciiu) && !empty($codigo_ciiu))
      {
         $tmp_pos = strpos($codigo_ciiu, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $codigo_ciiu = substr($codigo_ciiu, 0, $tmp_pos);
         }
      }
...
?>
 ...
 $nmgp_tab_label .= "id_ciiu?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_ciiu_cond" name="id_ciiu_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_ciiu'), this, 'id_ciiu')">
       <OPTION value="gt" <?php if ("gt" == $id_ciiu_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_ciiu_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_ciiu_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_ciiu_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_id_ciiu"  <?php echo $str_hide_id_ciiu?>><?php
      if ($id_ciiu != "")
      {
      $id_ciiu_look = substr($this->Db->qstr($id_ciiu), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_ciiu))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_ciiu from " . $this->Ini->nm_tabela . " where id_ciiu = $id_ciiu_look order by id_ciiu"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct id_ciiu from " . $this->Ini->nm_tabela . " where id_ciiu = $id_ciiu_look order by id_ciiu"; 
      ...
      if (isset($nmgp_def_dados[0][$id_ciiu]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_ciiu];
      }
      else
      {
            nmgp_Form_Num_Val($id_ciiu, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $id_ciiu;
      }
?>
<INPUT  type="text" id="SC_id_ciiu" name="id_ciiu" value="<?php echo NM_encode_input($id_ciiu) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-id_ciiu" id="id_ac_id_ciiu" name="id_ciiu_autocomp"><?php if ('' !=  $id_ciiu) { ?><option value="<?php echo $id_ciiu ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_id_ciiu"  <?php echo $str_display_id_ciiu; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_ciiu_input_2" name="id_ciiu_input_2" value="<?php echo NM_encode_input($id_ciiu_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
 ...
 $nmgp_tab_label .= "codigo_ciiu?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_codigo_ciiu_cond" name="codigo_ciiu_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_ciiu'), this, 'codigo_ciiu')">
       <OPTION value="qp" <?php if ("qp" == $codigo_ciiu_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $codigo_ciiu_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codigo_ciiu_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $codigo_ciiu_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_codigo_ciiu"  <?php echo $str_hide_codigo_ciiu?>><?php
      if ($codigo_ciiu != "")
      {
      $codigo_ciiu_look = substr($this->Db->qstr($codigo_ciiu), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct codigo_ciiu from " . $this->Ini->nm_tabela . " where codigo_ciiu = '$codigo_ciiu_look' order by codigo_ciiu"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$codigo_ciiu]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$codigo_ciiu];
      }
      else
      {
          $sAutocompValue = $codigo_ciiu;
      }
?>
<INPUT  type="text" id="SC_codigo_ciiu" name="codigo_ciiu" value="<?php echo NM_encode_input($codigo_ciiu) ?>"  size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-codigo_ciiu" id="id_ac_codigo_ciiu" name="codigo_ciiu_autocomp"><?php if ('' !=  $codigo_ciiu) { ?><option value="<?php echo $codigo_ciiu ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
?>
<?php
   if (is_file("grid_codigos_ciiu_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_codigos_ciiu']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_codigos_ciiu']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_ciiu_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_ciiu'), document.F1.id_ciiu_cond, 'id_ciiu');
   document.F1.id_ciiu.value = "";
   document.F1.id_ciiu_autocomp.value = "";
   $('#select2-id_ac_id_ciiu-container').html('<?php echo $this->Val_init_id_ciiu['desc'] ?>');;
   document.F1.id_ciiu_input_2.value = "";
   document.F1.codigo_ciiu_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_codigo_ciiu'), document.F1.codigo_ciiu_cond, 'codigo_ciiu');
   document.F1.codigo_ciiu.value = "";
   document.F1.codigo_ciiu_autocomp.value = "";
   $('#select2-id_ac_codigo_ciiu-container').html('<?php echo $this->Val_init_codigo_ciiu['desc'] ?>');;
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_codigos_ciiu";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_ciiu_cond'] = 'cond';
      $tp_fields['SC_id_ciiu'] = 'text_aut';
      $tp_fields['id_ac_id_ciiu'] = 'select2_aut';
      $tp_fields['SC_id_ciiu_input_2'] = 'text';
      $tp_fields['SC_codigo_ciiu_cond'] = 'cond';
      $tp_fields['SC_codigo_ciiu'] = 'text_aut';
      $tp_fields['id_ac_codigo_ciiu'] = 'select2_aut';
   ...
   {
      global $id_ciiu_cond, $id_ciiu, $id_ciiu_input_2, $id_ciiu_autocomp,
             $codigo_ciiu_cond, $codigo_ciiu, $codigo_ciiu_autocomp,
      ...
      if (!empty($id_ciiu_autocomp) && empty($id_ciiu))
      {
          $id_ciiu = $id_ciiu_autocomp;
      }
      if (!empty($codigo_ciiu_autocomp) && empty($codigo_ciiu))
      {
          $codigo_ciiu = $codigo_ciiu_autocomp;
      }
      if (!empty($descripcion_autocomp) && empty($descripcion))
      {
          $descripcion = $descripcion_autocomp;
      }
      $id_ciiu_cond_salva = $id_ciiu_cond; 
      if (!isset($id_ciiu_input_2) || $id_ciiu_input_2 == "")
      {
          $id_ciiu_input_2 = $id_ciiu;
      }
      $codigo_ciiu_cond_salva = $codigo_ciiu_cond; 
      if (!isset($codigo_ciiu_input_2) || $codigo_ciiu_input_2 == "")
      {
          $codigo_ciiu_input_2 = $codigo_ciiu;
      }
      ...
      if ($id_ciiu_cond != "in")
      {
          nm_limpa_numero($id_ciiu, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_ciiu_cond != "in")
      {
          nm_limpa_numero($id_ciiu_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['id_ciiu'] = $id_ciiu; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['id_ciiu_input_2'] = $id_ciiu_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['id_ciiu_cond'] = $id_ciiu_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['codigo_ciiu'] = $codigo_ciiu; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['codigo_ciiu_cond'] = $codigo_ciiu_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['descripcion'] = $descripcion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['descripcion_cond'] = $descripcion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca'] = $Temp_Busca;
      }
      if ($id_ciiu_cond != "in" && $id_ciiu_cond != "bw" && !empty($id_ciiu) && !is_numeric($id_ciiu))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Ciiu";
      }
      if ($id_ciiu_cond == "bw" && ((!empty($id_ciiu) && !is_numeric($id_ciiu)) || (!empty($id_ciiu_input_2) && !is_numeric($id_ciiu_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Ciiu";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_ciiu'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_ciiu'] = $cmp1;
      }
      else
      {
          $cmp1 = $id_ciiu;
      ...
      $Conteudo = $id_ciiu_input_2;
      if (strtoupper($id_ciiu_cond) != "II" && strtoupper($id_ciiu_cond) != "QP" && strtoupper($id_ciiu_cond) != "NP" && strtoupper($id_ciiu_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_ciiu_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($codigo_ciiu != '') {
      $codigo_ciiu_look = substr($this->Db->qstr($codigo_ciiu), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codigo_ciiu'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['codigo_ciiu'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['codigo_ciiu'] = $codigo_ciiu;
      }
      $nmgp_def_dados = array();
    if ($descripcion != '') {
      $descripcion_look = substr($this->Db->qstr($descripcion), 1, -1); 
      ...
      if (isset($id_ciiu) || $id_ciiu_cond == "nu" || $id_ciiu_cond == "nn" || $id_ciiu_cond == "ep" || $id_ciiu_cond == "ne")
      {
         $this->monta_condicao("id_ciiu", $id_ciiu_cond, $id_ciiu, $id_ciiu_input_2, "id_ciiu");
      }

      //----- $codigo_ciiu
      $this->Date_part = false;
      if (isset($codigo_ciiu) || $codigo_ciiu_cond == "nu" || $codigo_ciiu_cond == "nn" || $codigo_ciiu_cond == "ep" || $codigo_ciiu_cond == "ne")
      {
         $this->monta_condicao("codigo_ciiu", $codigo_ciiu_cond, $codigo_ciiu, "", "codigo_ciiu");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigos_ciiu']['cond_pesq'] .= $this->NM_operador;
