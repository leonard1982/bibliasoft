<?php
@session_start() ;
$_SESSION['scriptcase']['grid_codigos_ciiu']['sc_process_barr'] = true;
require_once('../grid_codigos_ciiu/index.php');
unset($_SESSION['scriptcase']['grid_codigos_ciiu']['sc_process_barr']);
$ExportCtrl = new grid_codigos_ciiu_export_control;
$ExportCtrl->Export_barr();

class grid_codigos_ciiu_export_control
{
