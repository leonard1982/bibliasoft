 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_id_ciiu_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_ciiu'])) ? $this->New_label['id_ciiu'] : "Id Ciiu"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_ciiu_cond" name="id_ciiu_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_ciiu'), this, 'id_ciiu')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_ciiu" <?php echo $str_hide_id_ciiu?> valign="top">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-id_ciiu" id="id_ac_id_ciiu" name="id_ciiu_autocomp"><?php if ('' !=  $id_ciiu) { ?><option value="<?php echo $id_ciiu ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_ciiu"  <?php echo $str_display_id_ciiu; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_ciiu_input_2" name="id_ciiu_input_2" value="<?php echo NM_encode_input($id_ciiu_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_codigo_ciiu_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['codigo_ciiu'])) ? $this->New_label['codigo_ciiu'] : "CÓDIGO"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_codigo_ciiu_cond" name="codigo_ciiu_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_ciiu'), this, 'codigo_ciiu')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codigo_ciiu" <?php echo $str_hide_codigo_ciiu?> valign="top">
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-codigo_ciiu" id="id_ac_codigo_ciiu" name="codigo_ciiu_autocomp"><?php if ('' !=  $codigo_ciiu) { ?><option value="<?php echo $codigo_ciiu ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_descripcion_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['descripcion'])) ? $this->New_label['descripcion'] : "DESCRIPCIÓN ACTIVIDAD"; ?></TD>
     <TD class="scFilterFieldOdd"> 
