  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_copiar_facturapos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_copiar_facturapos_form();
	}
...
?>
  ...
  // ---------- Validate mensaje
  function do_ajax_control_copiar_facturapos_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldHidden(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_facturapos_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_control_copiar_facturapos_validate_mensaje_cb);
  } // do_ajax_control_copiar_facturapos_validate_mensaje

  function do_ajax_control_copiar_facturapos_validate_mensaje_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_facturapos_validate_mensaje_cb

  // ---------- Validate prefijo
  function do_ajax_control_copiar_facturapos_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldSelect(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_facturapos_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_control_copiar_facturapos_validate_prefijo_cb);
  } // do_ajax_control_copiar_facturapos_validate_prefijo

  function do_ajax_control_copiar_facturapos_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_facturapos_validate_prefijo_cb

  // ---------- Validate cliente
  function do_ajax_control_copiar_facturapos_validate_cliente()
  {
  } // do_ajax_control_copiar_facturapos_validate_cliente

  function do_ajax_control_copiar_facturapos_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_facturapos_validate_cliente_cb

  // ---------- Validate direccion
  function do_ajax_control_copiar_facturapos_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldSelect(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_facturapos_validate_direccion(var_direccion, var_script_case_init, do_ajax_control_copiar_facturapos_validate_direccion_cb);
  } // do_ajax_control_copiar_facturapos_validate_direccion

  function do_ajax_control_copiar_facturapos_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_facturapos_validate_direccion_cb

  // ---------- Validate observaciones
  function do_ajax_control_copiar_facturapos_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_facturapos_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_control_copiar_facturapos_validate_observaciones_cb);
  } // do_ajax_control_copiar_facturapos_validate_observaciones

  function do_ajax_control_copiar_facturapos_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_facturapos_validate_observaciones_cb

  // ---------- Refresh cliente
  function do_ajax_control_copiar_facturapos_refresh_cliente()
  {
    var var_cliente = scAjaxGetFieldText("cliente");
    var var_nmgp_refresh_fields = "direccion";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_copiar_facturapos_refresh_cliente(var_cliente, var_nmgp_refresh_fields, var_script_case_init, do_ajax_control_copiar_facturapos_refresh_cliente_cb);
  } // do_ajax_control_copiar_facturapos_refresh_cliente

  function do_ajax_control_copiar_facturapos_refresh_cliente_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_facturapos_refresh_cliente_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_copiar_facturapos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_copiar_facturapos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_cliente = scAjaxGetFieldText("cliente");
    var var_direccion = scAjaxGetFieldSelect("direccion");
    ...
    scAjaxProcOn();
    x_ajax_control_copiar_facturapos_submit_form(var_mensaje, var_prefijo, var_cliente, var_direccion, var_observaciones, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_copiar_facturapos_submit_form_cb);
  } // do_ajax_control_copiar_facturapos_submit_form

  function do_ajax_control_copiar_facturapos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_copiar_facturapos_submit_form_cb_after_alert);
  } // do_ajax_control_copiar_facturapos_submit_form_cb
  function do_ajax_control_copiar_facturapos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_copiar_facturapos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_copiar_facturapos_navigate_form()
  {
    perform_ajax_control_copiar_facturapos_navigate_form();
  }

  function perform_ajax_control_copiar_facturapos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_copiar_facturapos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_facturapos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_copiar_facturapos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_copiar_facturapos_navigate_form_cb_after_alert);
  } // do_ajax_control_copiar_facturapos_navigate_form_cb
  function do_ajax_control_copiar_facturapos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_copiar_facturapos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_copiar_facturapos_navigate_form_cb_after_alert
  function sc_hide_control_copiar_facturapos_form()
  {
