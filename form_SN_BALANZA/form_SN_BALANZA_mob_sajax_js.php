  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_SN_BALANZA_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_SN_BALANZA_mob_form();
	}
  ...
  // ---------- Validate sn_puerto_com
  function do_ajax_form_SN_BALANZA_mob_validate_sn_puerto_com()
  {
    var nomeCampo_sn_puerto_com = "sn_puerto_com";
    var var_sn_puerto_com = scAjaxGetFieldSelect(nomeCampo_sn_puerto_com);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_mob_validate_sn_puerto_com(var_sn_puerto_com, var_script_case_init, do_ajax_form_SN_BALANZA_mob_validate_sn_puerto_com_cb);
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_puerto_com

  function do_ajax_form_SN_BALANZA_mob_validate_sn_puerto_com_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_puerto_com";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_puerto_com_cb

  // ---------- Validate sn_baudios
  function do_ajax_form_SN_BALANZA_mob_validate_sn_baudios()
  {
    var nomeCampo_sn_baudios = "sn_baudios";
    var var_sn_baudios = scAjaxGetFieldText(nomeCampo_sn_baudios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_mob_validate_sn_baudios(var_sn_baudios, var_script_case_init, do_ajax_form_SN_BALANZA_mob_validate_sn_baudios_cb);
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_baudios

  function do_ajax_form_SN_BALANZA_mob_validate_sn_baudios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_baudios";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_baudios_cb

  // ---------- Validate sn_paridad
  function do_ajax_form_SN_BALANZA_mob_validate_sn_paridad()
  {
    var nomeCampo_sn_paridad = "sn_paridad";
    var var_sn_paridad = scAjaxGetFieldText(nomeCampo_sn_paridad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_mob_validate_sn_paridad(var_sn_paridad, var_script_case_init, do_ajax_form_SN_BALANZA_mob_validate_sn_paridad_cb);
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_paridad

  function do_ajax_form_SN_BALANZA_mob_validate_sn_paridad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_paridad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_paridad_cb

  // ---------- Validate sn_bits
  function do_ajax_form_SN_BALANZA_mob_validate_sn_bits()
  {
    var nomeCampo_sn_bits = "sn_bits";
    var var_sn_bits = scAjaxGetFieldText(nomeCampo_sn_bits);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_mob_validate_sn_bits(var_sn_bits, var_script_case_init, do_ajax_form_SN_BALANZA_mob_validate_sn_bits_cb);
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_bits

  function do_ajax_form_SN_BALANZA_mob_validate_sn_bits_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_bits";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_bits_cb

  // ---------- Validate sn_copy_inicio
  function do_ajax_form_SN_BALANZA_mob_validate_sn_copy_inicio()
  {
    var nomeCampo_sn_copy_inicio = "sn_copy_inicio";
    var var_sn_copy_inicio = scAjaxGetFieldText(nomeCampo_sn_copy_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_mob_validate_sn_copy_inicio(var_sn_copy_inicio, var_script_case_init, do_ajax_form_SN_BALANZA_mob_validate_sn_copy_inicio_cb);
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_copy_inicio

  function do_ajax_form_SN_BALANZA_mob_validate_sn_copy_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_copy_inicio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_copy_inicio_cb

  // ---------- Validate sn_copy_fin
  function do_ajax_form_SN_BALANZA_mob_validate_sn_copy_fin()
  {
    var nomeCampo_sn_copy_fin = "sn_copy_fin";
    var var_sn_copy_fin = scAjaxGetFieldText(nomeCampo_sn_copy_fin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_mob_validate_sn_copy_fin(var_sn_copy_fin, var_script_case_init, do_ajax_form_SN_BALANZA_mob_validate_sn_copy_fin_cb);
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_copy_fin

  function do_ajax_form_SN_BALANZA_mob_validate_sn_copy_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_copy_fin";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_copy_fin_cb

  // ---------- Validate sn_peso
  function do_ajax_form_SN_BALANZA_mob_validate_sn_peso()
  {
    var nomeCampo_sn_peso = "sn_peso";
    var var_sn_peso = scAjaxGetFieldText(nomeCampo_sn_peso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_mob_validate_sn_peso(var_sn_peso, var_script_case_init, do_ajax_form_SN_BALANZA_mob_validate_sn_peso_cb);
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_peso

  function do_ajax_form_SN_BALANZA_mob_validate_sn_peso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_peso";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_peso_cb

  // ---------- Validate sn_intervalo
  function do_ajax_form_SN_BALANZA_mob_validate_sn_intervalo()
  {
    var nomeCampo_sn_intervalo = "sn_intervalo";
    var var_sn_intervalo = scAjaxGetFieldText(nomeCampo_sn_intervalo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_mob_validate_sn_intervalo(var_sn_intervalo, var_script_case_init, do_ajax_form_SN_BALANZA_mob_validate_sn_intervalo_cb);
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_intervalo

  function do_ajax_form_SN_BALANZA_mob_validate_sn_intervalo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_intervalo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_intervalo_cb

  // ---------- Validate sn_parametro
  function do_ajax_form_SN_BALANZA_mob_validate_sn_parametro()
  {
    var nomeCampo_sn_parametro = "sn_parametro";
    var var_sn_parametro = scAjaxGetFieldText(nomeCampo_sn_parametro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_mob_validate_sn_parametro(var_sn_parametro, var_script_case_init, do_ajax_form_SN_BALANZA_mob_validate_sn_parametro_cb);
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_parametro

  function do_ajax_form_SN_BALANZA_mob_validate_sn_parametro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_parametro";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_parametro_cb

  // ---------- Validate sn_divisor
  function do_ajax_form_SN_BALANZA_mob_validate_sn_divisor()
  {
    var nomeCampo_sn_divisor = "sn_divisor";
    var var_sn_divisor = scAjaxGetFieldText(nomeCampo_sn_divisor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_mob_validate_sn_divisor(var_sn_divisor, var_script_case_init, do_ajax_form_SN_BALANZA_mob_validate_sn_divisor_cb);
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_divisor

  function do_ajax_form_SN_BALANZA_mob_validate_sn_divisor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_divisor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_divisor_cb

  // ---------- Validate sn_modo
  function do_ajax_form_SN_BALANZA_mob_validate_sn_modo()
  {
    var nomeCampo_sn_modo = "sn_modo";
    var var_sn_modo = scAjaxGetFieldSelect(nomeCampo_sn_modo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_mob_validate_sn_modo(var_sn_modo, var_script_case_init, do_ajax_form_SN_BALANZA_mob_validate_sn_modo_cb);
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_modo

  function do_ajax_form_SN_BALANZA_mob_validate_sn_modo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_modo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_mob_validate_sn_modo_cb

  // ---------- Validate id
  function do_ajax_form_SN_BALANZA_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_mob_validate_id(var_id, var_script_case_init, do_ajax_form_SN_BALANZA_mob_validate_id_cb);
  } // do_ajax_form_SN_BALANZA_mob_validate_id

  function do_ajax_form_SN_BALANZA_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_mob_validate_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_SN_BALANZA_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_SN_BALANZA_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_sn_puerto_com = scAjaxGetFieldSelect("sn_puerto_com");
    var var_sn_baudios = scAjaxGetFieldText("sn_baudios");
    var var_sn_paridad = scAjaxGetFieldText("sn_paridad");
    var var_sn_bits = scAjaxGetFieldText("sn_bits");
    var var_sn_copy_inicio = scAjaxGetFieldText("sn_copy_inicio");
    var var_sn_copy_fin = scAjaxGetFieldText("sn_copy_fin");
    var var_sn_peso = scAjaxGetFieldText("sn_peso");
    var var_sn_intervalo = scAjaxGetFieldText("sn_intervalo");
    var var_sn_parametro = scAjaxGetFieldText("sn_parametro");
    var var_sn_divisor = scAjaxGetFieldText("sn_divisor");
    var var_sn_modo = scAjaxGetFieldSelect("sn_modo");
    ...
    scAjaxProcOn();
    x_ajax_form_SN_BALANZA_mob_submit_form(var_sn_puerto_com, var_sn_baudios, var_sn_paridad, var_sn_bits, var_sn_copy_inicio, var_sn_copy_fin, var_sn_peso, var_sn_intervalo, var_sn_parametro, var_sn_divisor, var_sn_modo, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_SN_BALANZA_mob_submit_form_cb);
  } // do_ajax_form_SN_BALANZA_mob_submit_form

  function do_ajax_form_SN_BALANZA_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("sn_puerto_com");
      scAjaxHideErrorDisplay("sn_baudios");
      scAjaxHideErrorDisplay("sn_paridad");
      scAjaxHideErrorDisplay("sn_bits");
      scAjaxHideErrorDisplay("sn_copy_inicio");
      scAjaxHideErrorDisplay("sn_copy_fin");
      scAjaxHideErrorDisplay("sn_peso");
      scAjaxHideErrorDisplay("sn_intervalo");
      scAjaxHideErrorDisplay("sn_parametro");
      scAjaxHideErrorDisplay("sn_divisor");
      scAjaxHideErrorDisplay("sn_modo");
      scAjaxHideErrorDisplay("id");
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_SN_BALANZA_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_SN_BALANZA_mob']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_SN_BALANZA_mob']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_SN_BALANZA_mob_submit_form_cb_after_alert);
  } // do_ajax_form_SN_BALANZA_mob_submit_form_cb
  function do_ajax_form_SN_BALANZA_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_SN_BALANZA_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_SN_BALANZA_mob_navigate_form()
  {
    perform_ajax_form_SN_BALANZA_mob_navigate_form();
  }

  function perform_ajax_form_SN_BALANZA_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_SN_BALANZA_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_SN_BALANZA_mob_navigate_form_cb);
  } // do_ajax_form_SN_BALANZA_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_SN_BALANZA_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_SN_BALANZA_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_SN_BALANZA_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_SN_BALANZA_mob_navigate_form_cb
  function do_ajax_form_SN_BALANZA_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_SN_BALANZA_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_SN_BALANZA_mob_navigate_form_cb_after_alert
  function sc_hide_form_SN_BALANZA_mob_form()
  {
  ...
  ajax_field_list[0] = "sn_puerto_com";
  ajax_field_list[1] = "sn_baudios";
  ajax_field_list[2] = "sn_paridad";
  ajax_field_list[3] = "sn_bits";
  ajax_field_list[4] = "sn_copy_inicio";
  ajax_field_list[5] = "sn_copy_fin";
  ajax_field_list[6] = "sn_peso";
  ajax_field_list[7] = "sn_intervalo";
  ajax_field_list[8] = "sn_parametro";
  ajax_field_list[9] = "sn_divisor";
  ajax_field_list[10] = "sn_modo";
  ...
  var ajax_error_list = {
    "sn_puerto_com": {"label": "PUERTO COM", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sn_baudios": {"label": "BAUDIOS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sn_paridad": {"label": "PARIDAD", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sn_bits": {"label": "BITS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sn_copy_inicio": {"label": "COPY INICIO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sn_copy_fin": {"label": "COPY FIN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sn_peso": {"label": "PESO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sn_intervalo": {"label": "INTERVALO (EN MILISEGUNDOS)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sn_parametro": {"label": "PARAMETRO BALANZA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sn_divisor": {"label": "DIVISOR", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sn_modo": {"label": "MODO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "sn_puerto_com": new Array(),
    "sn_baudios": new Array(),
    "sn_paridad": new Array(),
    "sn_bits": new Array(),
    "sn_copy_inicio": new Array(),
    "sn_copy_fin": new Array(),
    "sn_peso": new Array(),
    "sn_intervalo": new Array(),
    "sn_parametro": new Array(),
    "sn_divisor": new Array(),
    "sn_modo": new Array(),
    "id": new Array()
  };
  ajax_field_mult["sn_puerto_com"][1] = "sn_puerto_com";
  ajax_field_mult["sn_baudios"][1] = "sn_baudios";
  ajax_field_mult["sn_paridad"][1] = "sn_paridad";
  ajax_field_mult["sn_bits"][1] = "sn_bits";
  ajax_field_mult["sn_copy_inicio"][1] = "sn_copy_inicio";
  ajax_field_mult["sn_copy_fin"][1] = "sn_copy_fin";
  ajax_field_mult["sn_peso"][1] = "sn_peso";
  ajax_field_mult["sn_intervalo"][1] = "sn_intervalo";
  ajax_field_mult["sn_parametro"][1] = "sn_parametro";
  ajax_field_mult["sn_divisor"][1] = "sn_divisor";
  ajax_field_mult["sn_modo"][1] = "sn_modo";
  ajax_field_mult["id"][1] = "id";

  var ajax_field_id = {
    "sn_puerto_com": new Array("hidden_field_label_sn_puerto_com", "hidden_field_data_sn_puerto_com"),
    "sn_baudios": new Array("hidden_field_label_sn_baudios", "hidden_field_data_sn_baudios"),
    "sn_paridad": new Array("hidden_field_label_sn_paridad", "hidden_field_data_sn_paridad"),
    "sn_bits": new Array("hidden_field_label_sn_bits", "hidden_field_data_sn_bits"),
    "sn_copy_inicio": new Array("hidden_field_label_sn_copy_inicio", "hidden_field_data_sn_copy_inicio"),
    "sn_copy_fin": new Array("hidden_field_label_sn_copy_fin", "hidden_field_data_sn_copy_fin"),
    "sn_peso": new Array("hidden_field_label_sn_peso", "hidden_field_data_sn_peso"),
    "sn_intervalo": new Array("hidden_field_label_sn_intervalo", "hidden_field_data_sn_intervalo"),
    "sn_parametro": new Array("hidden_field_label_sn_parametro", "hidden_field_data_sn_parametro"),
    "sn_divisor": new Array("hidden_field_label_sn_divisor", "hidden_field_data_sn_divisor"),
    "sn_modo": new Array("hidden_field_label_sn_modo", "hidden_field_data_sn_modo")
  };
