  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_SN_BALANZA" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_SN_BALANZA_validate_sn_puerto_com()
  {
    var nomeCampo_sn_puerto_com = "sn_puerto_com";
    var var_sn_puerto_com = scAjaxGetFieldSelect(nomeCampo_sn_puerto_com);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_validate_sn_puerto_com(var_sn_puerto_com, var_script_case_init, do_ajax_form_SN_BALANZA_validate_sn_puerto_com_cb);
  } // do_ajax_form_SN_BALANZA_validate_sn_puerto_com

  function do_ajax_form_SN_BALANZA_validate_sn_puerto_com_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_validate_sn_puerto_com_cb

  // ---------- Validate sn_baudios
  function do_ajax_form_SN_BALANZA_validate_sn_baudios()
  {
    var nomeCampo_sn_baudios = "sn_baudios";
    var var_sn_baudios = scAjaxGetFieldText(nomeCampo_sn_baudios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_validate_sn_baudios(var_sn_baudios, var_script_case_init, do_ajax_form_SN_BALANZA_validate_sn_baudios_cb);
  } // do_ajax_form_SN_BALANZA_validate_sn_baudios

  function do_ajax_form_SN_BALANZA_validate_sn_baudios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_validate_sn_baudios_cb

  // ---------- Validate sn_paridad
  function do_ajax_form_SN_BALANZA_validate_sn_paridad()
  {
    var nomeCampo_sn_paridad = "sn_paridad";
    var var_sn_paridad = scAjaxGetFieldText(nomeCampo_sn_paridad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_validate_sn_paridad(var_sn_paridad, var_script_case_init, do_ajax_form_SN_BALANZA_validate_sn_paridad_cb);
  } // do_ajax_form_SN_BALANZA_validate_sn_paridad

  function do_ajax_form_SN_BALANZA_validate_sn_paridad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_validate_sn_paridad_cb

  // ---------- Validate sn_bits
  function do_ajax_form_SN_BALANZA_validate_sn_bits()
  {
    var nomeCampo_sn_bits = "sn_bits";
    var var_sn_bits = scAjaxGetFieldText(nomeCampo_sn_bits);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_validate_sn_bits(var_sn_bits, var_script_case_init, do_ajax_form_SN_BALANZA_validate_sn_bits_cb);
  } // do_ajax_form_SN_BALANZA_validate_sn_bits

  function do_ajax_form_SN_BALANZA_validate_sn_bits_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_bits";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_validate_sn_bits_cb

  // ---------- Validate sn_copy_inicio
  function do_ajax_form_SN_BALANZA_validate_sn_copy_inicio()
  {
    var nomeCampo_sn_copy_inicio = "sn_copy_inicio";
    var var_sn_copy_inicio = scAjaxGetFieldText(nomeCampo_sn_copy_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_validate_sn_copy_inicio(var_sn_copy_inicio, var_script_case_init, do_ajax_form_SN_BALANZA_validate_sn_copy_inicio_cb);
  } // do_ajax_form_SN_BALANZA_validate_sn_copy_inicio

  function do_ajax_form_SN_BALANZA_validate_sn_copy_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_validate_sn_copy_inicio_cb

  // ---------- Validate sn_copy_fin
  function do_ajax_form_SN_BALANZA_validate_sn_copy_fin()
  {
    var nomeCampo_sn_copy_fin = "sn_copy_fin";
    var var_sn_copy_fin = scAjaxGetFieldText(nomeCampo_sn_copy_fin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_validate_sn_copy_fin(var_sn_copy_fin, var_script_case_init, do_ajax_form_SN_BALANZA_validate_sn_copy_fin_cb);
  } // do_ajax_form_SN_BALANZA_validate_sn_copy_fin

  function do_ajax_form_SN_BALANZA_validate_sn_copy_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_validate_sn_copy_fin_cb

  // ---------- Validate sn_peso
  function do_ajax_form_SN_BALANZA_validate_sn_peso()
  {
    var nomeCampo_sn_peso = "sn_peso";
    var var_sn_peso = scAjaxGetFieldText(nomeCampo_sn_peso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_validate_sn_peso(var_sn_peso, var_script_case_init, do_ajax_form_SN_BALANZA_validate_sn_peso_cb);
  } // do_ajax_form_SN_BALANZA_validate_sn_peso

  function do_ajax_form_SN_BALANZA_validate_sn_peso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_peso";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_validate_sn_peso_cb

  // ---------- Validate sn_intervalo
  function do_ajax_form_SN_BALANZA_validate_sn_intervalo()
  {
    var nomeCampo_sn_intervalo = "sn_intervalo";
    var var_sn_intervalo = scAjaxGetFieldText(nomeCampo_sn_intervalo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_validate_sn_intervalo(var_sn_intervalo, var_script_case_init, do_ajax_form_SN_BALANZA_validate_sn_intervalo_cb);
  } // do_ajax_form_SN_BALANZA_validate_sn_intervalo

  function do_ajax_form_SN_BALANZA_validate_sn_intervalo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_validate_sn_intervalo_cb

  // ---------- Validate sn_parametro
  function do_ajax_form_SN_BALANZA_validate_sn_parametro()
  {
    var nomeCampo_sn_parametro = "sn_parametro";
    var var_sn_parametro = scAjaxGetFieldText(nomeCampo_sn_parametro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_validate_sn_parametro(var_sn_parametro, var_script_case_init, do_ajax_form_SN_BALANZA_validate_sn_parametro_cb);
  } // do_ajax_form_SN_BALANZA_validate_sn_parametro

  function do_ajax_form_SN_BALANZA_validate_sn_parametro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_validate_sn_parametro_cb

  // ---------- Validate sn_divisor
  function do_ajax_form_SN_BALANZA_validate_sn_divisor()
  {
    var nomeCampo_sn_divisor = "sn_divisor";
    var var_sn_divisor = scAjaxGetFieldText(nomeCampo_sn_divisor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_validate_sn_divisor(var_sn_divisor, var_script_case_init, do_ajax_form_SN_BALANZA_validate_sn_divisor_cb);
  } // do_ajax_form_SN_BALANZA_validate_sn_divisor

  function do_ajax_form_SN_BALANZA_validate_sn_divisor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_validate_sn_divisor_cb

  // ---------- Validate sn_modo
  function do_ajax_form_SN_BALANZA_validate_sn_modo()
  {
    var nomeCampo_sn_modo = "sn_modo";
    var var_sn_modo = scAjaxGetFieldSelect(nomeCampo_sn_modo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_validate_sn_modo(var_sn_modo, var_script_case_init, do_ajax_form_SN_BALANZA_validate_sn_modo_cb);
  } // do_ajax_form_SN_BALANZA_validate_sn_modo

  function do_ajax_form_SN_BALANZA_validate_sn_modo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_modo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_validate_sn_modo_cb

  // ---------- Validate id
  function do_ajax_form_SN_BALANZA_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_SN_BALANZA_validate_id(var_id, var_script_case_init, do_ajax_form_SN_BALANZA_validate_id_cb);
  } // do_ajax_form_SN_BALANZA_validate_id

  function do_ajax_form_SN_BALANZA_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_SN_BALANZA_validate_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_SN_BALANZA_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_SN_BALANZA_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_SN_BALANZA_submit_form(var_sn_puerto_com, var_sn_baudios, var_sn_paridad, var_sn_bits, var_sn_copy_inicio, var_sn_copy_fin, var_sn_peso, var_sn_intervalo, var_sn_parametro, var_sn_divisor, var_sn_modo, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_SN_BALANZA_submit_form_cb);
  } // do_ajax_form_SN_BALANZA_submit_form

  function do_ajax_form_SN_BALANZA_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_SN_BALANZA_submit_form_cb_after_alert);
  } // do_ajax_form_SN_BALANZA_submit_form_cb
  function do_ajax_form_SN_BALANZA_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_SN_BALANZA_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_SN_BALANZA_navigate_form()
  {
    perform_ajax_form_SN_BALANZA_navigate_form();
  }

  function perform_ajax_form_SN_BALANZA_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_SN_BALANZA_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_SN_BALANZA_navigate_form_cb);
  } // do_ajax_form_SN_BALANZA_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_SN_BALANZA']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_SN_BALANZA_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_SN_BALANZA_navigate_form_cb_after_alert);
  } // do_ajax_form_SN_BALANZA_navigate_form_cb
  function do_ajax_form_SN_BALANZA_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_SN_BALANZA_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_SN_BALANZA_navigate_form_cb_after_alert
  function sc_hide_form_SN_BALANZA_form()
  {
