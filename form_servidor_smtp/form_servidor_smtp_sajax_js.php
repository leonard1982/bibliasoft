  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_servidor_smtp" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_servidor_smtp_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_servidor_smtp_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servidor_smtp_validate_id(var_id, var_script_case_init, do_ajax_form_servidor_smtp_validate_id_cb);
  } // do_ajax_form_servidor_smtp_validate_id

  function do_ajax_form_servidor_smtp_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servidor_smtp_validate_id_cb

  // ---------- Validate servidor
  function do_ajax_form_servidor_smtp_validate_servidor()
  {
    var nomeCampo_servidor = "servidor";
    var var_servidor = scAjaxGetFieldText(nomeCampo_servidor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servidor_smtp_validate_servidor(var_servidor, var_script_case_init, do_ajax_form_servidor_smtp_validate_servidor_cb);
  } // do_ajax_form_servidor_smtp_validate_servidor

  function do_ajax_form_servidor_smtp_validate_servidor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servidor_smtp_validate_servidor_cb

  // ---------- Validate puerto
  function do_ajax_form_servidor_smtp_validate_puerto()
  {
    var nomeCampo_puerto = "puerto";
    var var_puerto = scAjaxGetFieldText(nomeCampo_puerto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servidor_smtp_validate_puerto(var_puerto, var_script_case_init, do_ajax_form_servidor_smtp_validate_puerto_cb);
  } // do_ajax_form_servidor_smtp_validate_puerto

  function do_ajax_form_servidor_smtp_validate_puerto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puerto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servidor_smtp_validate_puerto_cb

  // ---------- Validate usuario
  function do_ajax_form_servidor_smtp_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servidor_smtp_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_servidor_smtp_validate_usuario_cb);
  } // do_ajax_form_servidor_smtp_validate_usuario

  function do_ajax_form_servidor_smtp_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servidor_smtp_validate_usuario_cb

  // ---------- Validate password
  function do_ajax_form_servidor_smtp_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servidor_smtp_validate_password(var_password, var_script_case_init, do_ajax_form_servidor_smtp_validate_password_cb);
  } // do_ajax_form_servidor_smtp_validate_password

  function do_ajax_form_servidor_smtp_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servidor_smtp_validate_password_cb

  // ---------- Validate correo_remitente
  function do_ajax_form_servidor_smtp_validate_correo_remitente()
  {
    var nomeCampo_correo_remitente = "correo_remitente";
    var var_correo_remitente = scAjaxGetFieldText(nomeCampo_correo_remitente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servidor_smtp_validate_correo_remitente(var_correo_remitente, var_script_case_init, do_ajax_form_servidor_smtp_validate_correo_remitente_cb);
  } // do_ajax_form_servidor_smtp_validate_correo_remitente

  function do_ajax_form_servidor_smtp_validate_correo_remitente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servidor_smtp_validate_correo_remitente_cb

  // ---------- Validate tls_ssl
  function do_ajax_form_servidor_smtp_validate_tls_ssl()
  {
    var nomeCampo_tls_ssl = "tls_ssl";
    var var_tls_ssl = scAjaxGetFieldSelect(nomeCampo_tls_ssl);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servidor_smtp_validate_tls_ssl(var_tls_ssl, var_script_case_init, do_ajax_form_servidor_smtp_validate_tls_ssl_cb);
  } // do_ajax_form_servidor_smtp_validate_tls_ssl

  function do_ajax_form_servidor_smtp_validate_tls_ssl_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tls_ssl";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servidor_smtp_validate_tls_ssl_cb

  // ---------- Validate activo
  function do_ajax_form_servidor_smtp_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldCheckbox(nomeCampo_activo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servidor_smtp_validate_activo(var_activo, var_script_case_init, do_ajax_form_servidor_smtp_validate_activo_cb);
  } // do_ajax_form_servidor_smtp_validate_activo

  function do_ajax_form_servidor_smtp_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servidor_smtp_validate_activo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_servidor_smtp_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_servidor_smtp_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_servidor_smtp_submit_form(var_id, var_servidor, var_puerto, var_usuario, var_password, var_correo_remitente, var_tls_ssl, var_activo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_servidor_smtp_submit_form_cb);
  } // do_ajax_form_servidor_smtp_submit_form

  function do_ajax_form_servidor_smtp_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_smtp']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_smtp']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_smtp']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_servidor_smtp_submit_form_cb_after_alert);
  } // do_ajax_form_servidor_smtp_submit_form_cb
  function do_ajax_form_servidor_smtp_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_servidor_smtp_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_servidor_smtp_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_servidor_smtp_navigate_form, function() {});
    } else {
      perform_ajax_form_servidor_smtp_navigate_form();
    }
  }

  function perform_ajax_form_servidor_smtp_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_servidor_smtp_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_servidor_smtp_navigate_form_cb);
  } // do_ajax_form_servidor_smtp_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_smtp']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_servidor_smtp_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_servidor_smtp_navigate_form_cb_after_alert);
  } // do_ajax_form_servidor_smtp_navigate_form_cb
  function do_ajax_form_servidor_smtp_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_servidor_smtp_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_servidor_smtp_navigate_form_cb_after_alert
  function sc_hide_form_servidor_smtp_form()
  {
