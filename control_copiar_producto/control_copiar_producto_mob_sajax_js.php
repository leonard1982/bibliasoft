  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_copiar_producto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_copiar_producto_mob_form();
	}
...
?>
  ...
  // ---------- Validate referencia
  function do_ajax_control_copiar_producto_mob_validate_referencia()
  {
  } // do_ajax_control_copiar_producto_mob_validate_referencia

  function do_ajax_control_copiar_producto_mob_validate_referencia_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_producto_mob_validate_referencia_cb

  // ---------- Validate nuevocodigo
  function do_ajax_control_copiar_producto_mob_validate_nuevocodigo()
  {
    var nomeCampo_nuevocodigo = "nuevocodigo";
    var var_nuevocodigo = scAjaxGetFieldText(nomeCampo_nuevocodigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_producto_mob_validate_nuevocodigo(var_nuevocodigo, var_script_case_init, do_ajax_control_copiar_producto_mob_validate_nuevocodigo_cb);
  } // do_ajax_control_copiar_producto_mob_validate_nuevocodigo

  function do_ajax_control_copiar_producto_mob_validate_nuevocodigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nuevocodigo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_producto_mob_validate_nuevocodigo_cb

  // ---------- Validate nuevadescripcion
  function do_ajax_control_copiar_producto_mob_validate_nuevadescripcion()
  {
    var nomeCampo_nuevadescripcion = "nuevadescripcion";
    var var_nuevadescripcion = scAjaxGetFieldText(nomeCampo_nuevadescripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_producto_mob_validate_nuevadescripcion(var_nuevadescripcion, var_script_case_init, do_ajax_control_copiar_producto_mob_validate_nuevadescripcion_cb);
  } // do_ajax_control_copiar_producto_mob_validate_nuevadescripcion

  function do_ajax_control_copiar_producto_mob_validate_nuevadescripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nuevadescripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_producto_mob_validate_nuevadescripcion_cb

  // ---------- Validate precio
  function do_ajax_control_copiar_producto_mob_validate_precio()
  {
    var nomeCampo_precio = "precio";
    var var_precio = scAjaxGetFieldText(nomeCampo_precio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_producto_mob_validate_precio(var_precio, var_script_case_init, do_ajax_control_copiar_producto_mob_validate_precio_cb);
  } // do_ajax_control_copiar_producto_mob_validate_precio

  function do_ajax_control_copiar_producto_mob_validate_precio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "precio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_producto_mob_validate_precio_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_copiar_producto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_copiar_producto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_referencia = scAjaxGetFieldText("referencia");
    var var_nuevocodigo = scAjaxGetFieldText("nuevocodigo");
    var var_nuevadescripcion = scAjaxGetFieldText("nuevadescripcion");
    ...
    scAjaxProcOn();
    x_ajax_control_copiar_producto_mob_submit_form(var_referencia, var_nuevocodigo, var_nuevadescripcion, var_precio, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_copiar_producto_mob_submit_form_cb);
  } // do_ajax_control_copiar_producto_mob_submit_form

  function do_ajax_control_copiar_producto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_producto_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_producto_mob']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_producto_mob']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_copiar_producto_mob_submit_form_cb_after_alert);
  } // do_ajax_control_copiar_producto_mob_submit_form_cb
  function do_ajax_control_copiar_producto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_copiar_producto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_copiar_producto_mob_navigate_form()
  {
    perform_ajax_control_copiar_producto_mob_navigate_form();
  }

  function perform_ajax_control_copiar_producto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_copiar_producto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_producto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_copiar_producto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_copiar_producto_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_copiar_producto_mob_navigate_form_cb
  function do_ajax_control_copiar_producto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('referencia');
...
{
?>
    do_ajax_control_copiar_producto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_copiar_producto_mob_navigate_form_cb_after_alert
  function sc_hide_control_copiar_producto_mob_form()
  {
  ...
  ajax_field_list[0] = "referencia";
  ajax_field_list[1] = "nuevocodigo";
  ajax_field_list[2] = "nuevadescripcion";
  ajax_field_list[3] = "precio";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "referencia": {"label": "Producto a copiar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nuevocodigo": {"label": "Nuevo código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nuevadescripcion": {"label": "Nueva Descripción", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "nuevocodigo": new Array(),
    "nuevadescripcion": new Array(),
    "precio": new Array()
  };
  ajax_field_mult["referencia"][1] = "referencia";
  ajax_field_mult["nuevocodigo"][1] = "nuevocodigo";
  ajax_field_mult["nuevadescripcion"][1] = "nuevadescripcion";
  ajax_field_mult["precio"][1] = "precio";

  var ajax_field_id = {
    "referencia": new Array("hidden_field_label_referencia", "hidden_field_data_referencia"),
    "nuevocodigo": new Array("hidden_field_label_nuevocodigo", "hidden_field_data_nuevocodigo"),
    "nuevadescripcion": new Array("hidden_field_label_nuevadescripcion", "hidden_field_data_nuevadescripcion"),
