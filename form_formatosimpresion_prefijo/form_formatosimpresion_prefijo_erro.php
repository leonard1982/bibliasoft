...
$old_error_handler = set_error_handler("form_formatosimpresion_prefijo_scriptcase_error_handler");

function form_formatosimpresion_prefijo_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_formatosimpresion_prefijo']['contr_erro']) && $_SESSION['scriptcase']['form_formatosimpresion_prefijo']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            global $inicial_form_formatosimpresion_prefijo;
            $inicial_form_formatosimpresion_prefijo->contr_form_formatosimpresion_prefijo->Apl_com_erro = true;
            if ($inicial_form_formatosimpresion_prefijo->contr_form_formatosimpresion_prefijo->NM_ajax_flag)
            {
                $inicial_form_formatosimpresion_prefijo->contr_form_formatosimpresion_prefijo->NM_ajax_info['errList']['geral_form_formatosimpresion_prefijo'][] = $msg;
                return;
            }
            form_formatosimpresion_prefijo_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_formatosimpresion_prefijo_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_formatosimpresion_prefijo'])  && '' != $_SESSION['scriptcase']['error_icon']['form_formatosimpresion_prefijo'])  ? $_SESSION['scriptcase']['error_icon']['form_formatosimpresion_prefijo']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_formatosimpresion_prefijo']) && '' != $_SESSION['scriptcase']['error_span_title']['form_formatosimpresion_prefijo']) ? $_SESSION['scriptcase']['error_span_title']['form_formatosimpresion_prefijo'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_formatosimpresion_prefijo']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_formatosimpresion_prefijo']) ? $_SESSION['scriptcase']['error_icon_title']['form_formatosimpresion_prefijo'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_formatosimpresion_prefijo']['error_buffer'] .= ob_get_flush();
}
