  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_formatosimpresion_prefijo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_formatosimpresion_prefijo_form();
	}
...
?>
  ...
  // ---------- Validate prefijo_
  function do_ajax_form_formatosimpresion_prefijo_validate_prefijo_(iNumLinha)
  {
    var nomeCampo_prefijo_ = "prefijo_" + iNumLinha;
    var var_prefijo_ = scAjaxGetFieldSelect(nomeCampo_prefijo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formatosimpresion_prefijo_validate_prefijo_(var_prefijo_, iNumLinha, var_script_case_init, do_ajax_form_formatosimpresion_prefijo_validate_prefijo__cb);
  } // do_ajax_form_formatosimpresion_prefijo_validate_prefijo_

  function do_ajax_form_formatosimpresion_prefijo_validate_prefijo__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formatosimpresion_prefijo_validate_prefijo__cb

  // ---------- Validate tipodocumento_
  function do_ajax_form_formatosimpresion_prefijo_validate_tipodocumento_(iNumLinha)
  {
    var nomeCampo_tipodocumento_ = "tipodocumento_" + iNumLinha;
    var var_tipodocumento_ = scAjaxGetFieldSelect(nomeCampo_tipodocumento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formatosimpresion_prefijo_validate_tipodocumento_(var_tipodocumento_, iNumLinha, var_script_case_init, do_ajax_form_formatosimpresion_prefijo_validate_tipodocumento__cb);
  } // do_ajax_form_formatosimpresion_prefijo_validate_tipodocumento_

  function do_ajax_form_formatosimpresion_prefijo_validate_tipodocumento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tipodocumento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipodocumento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tipodocumento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tipodocumento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formatosimpresion_prefijo_validate_tipodocumento__cb

  // ---------- Validate idformato_
  function do_ajax_form_formatosimpresion_prefijo_validate_idformato_(iNumLinha)
  {
    var nomeCampo_idformato_ = "idformato_" + iNumLinha;
    var var_idformato_ = scAjaxGetFieldSelect(nomeCampo_idformato_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formatosimpresion_prefijo_validate_idformato_(var_idformato_, iNumLinha, var_script_case_init, do_ajax_form_formatosimpresion_prefijo_validate_idformato__cb);
  } // do_ajax_form_formatosimpresion_prefijo_validate_idformato_

  function do_ajax_form_formatosimpresion_prefijo_validate_idformato__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formatosimpresion_prefijo_validate_idformato__cb

  // ---------- Validate encabezado_pos_
  function do_ajax_form_formatosimpresion_prefijo_validate_encabezado_pos_(iNumLinha)
  {
    var nomeCampo_encabezado_pos_ = "encabezado_pos_" + iNumLinha;
    var var_encabezado_pos_ = scAjaxGetFieldText(nomeCampo_encabezado_pos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formatosimpresion_prefijo_validate_encabezado_pos_(var_encabezado_pos_, iNumLinha, var_script_case_init, do_ajax_form_formatosimpresion_prefijo_validate_encabezado_pos__cb);
  } // do_ajax_form_formatosimpresion_prefijo_validate_encabezado_pos_

  function do_ajax_form_formatosimpresion_prefijo_validate_encabezado_pos__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "encabezado_pos_" + iLineNumber;
    }
    else
    {
      sFieldValid = "encabezado_pos_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "encabezado_pos_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "encabezado_pos_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formatosimpresion_prefijo_validate_encabezado_pos__cb

  // ---------- Validate pie_pos_
  function do_ajax_form_formatosimpresion_prefijo_validate_pie_pos_(iNumLinha)
  {
    var nomeCampo_pie_pos_ = "pie_pos_" + iNumLinha;
    var var_pie_pos_ = scAjaxGetFieldText(nomeCampo_pie_pos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formatosimpresion_prefijo_validate_pie_pos_(var_pie_pos_, iNumLinha, var_script_case_init, do_ajax_form_formatosimpresion_prefijo_validate_pie_pos__cb);
  } // do_ajax_form_formatosimpresion_prefijo_validate_pie_pos_

  function do_ajax_form_formatosimpresion_prefijo_validate_pie_pos__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pie_pos_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pie_pos_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pie_pos_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pie_pos_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formatosimpresion_prefijo_validate_pie_pos__cb

  // ---------- Refresh tipodocumento_
  function do_ajax_form_formatosimpresion_prefijo_refresh_tipodocumento_(iSeqForm)
  {
    var var_tipodocumento_ = scAjaxGetFieldSelect("tipodocumento_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "idformato_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_formatosimpresion_prefijo_refresh_tipodocumento_(var_tipodocumento_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_formatosimpresion_prefijo_refresh_tipodocumento__cb);
  } // do_ajax_form_formatosimpresion_prefijo_refresh_tipodocumento_

  function do_ajax_form_formatosimpresion_prefijo_refresh_tipodocumento__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formatosimpresion_prefijo_refresh_tipodocumento__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_formatosimpresion_prefijo_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_formatosimpresion_prefijo_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_formatosimpresion_prefijo_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_formatosimpresion_prefijo_add_new_line_cb);
  } // do_ajax_form_formatosimpresion_prefijo_add_new_line

  function do_ajax_form_formatosimpresion_prefijo_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_formatosimpresion_prefijo_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_formatosimpresion_prefijo_backup_line(iNumLinha)
  {
    var var_idformatoimpresion_prefijo_ = scAjaxGetFieldText("idformatoimpresion_prefijo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formatosimpresion_prefijo_backup_line(var_idformatoimpresion_prefijo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_formatosimpresion_prefijo_backup_line_cb);
  } // do_ajax_form_formatosimpresion_prefijo_backup_line

  function do_ajax_form_formatosimpresion_prefijo_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_formatosimpresion_prefijo_backup_line_cb

  function do_ajax_form_formatosimpresion_prefijo_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_formatosimpresion_prefijo_cancel_insert

  function do_ajax_form_formatosimpresion_prefijo_cancel_update(iSeqVert)
  {
    do_ajax_form_formatosimpresion_prefijo_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_formatosimpresion_prefijo_cancel_update

  function do_ajax_form_formatosimpresion_prefijo_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_formatosimpresion_prefijo_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_formatosimpresion_prefijo_table_refresh()
  {
    var var_idformatoimpresion_prefijo_ = document.F2.idformatoimpresion_prefijo_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_formatosimpresion_prefijo_table_refresh(var_idformatoimpresion_prefijo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_formatosimpresion_prefijo_table_refresh_cb);
  } //  do_ajax_form_formatosimpresion_prefijo_table_refresh

  function do_ajax_form_formatosimpresion_prefijo_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idformatoimpresion_prefijo_.value = scAjaxGetKeyValue("idformatoimpresion_prefijo_");
    ...
    scAjaxAlert(do_ajax_form_formatosimpresion_prefijo_table_refresh_cb_after_alert);
  } // do_ajax_form_formatosimpresion_prefijo_table_refresh_cb
  function do_ajax_form_formatosimpresion_prefijo_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_formatosimpresion_prefijo_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_formatosimpresion_prefijo_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_formatosimpresion_prefijo_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_prefijo_ = scAjaxGetFieldSelect("prefijo_" + iNumLinha);
    var var_tipodocumento_ = scAjaxGetFieldSelect("tipodocumento_" + iNumLinha);
    var var_idformato_ = scAjaxGetFieldSelect("idformato_" + iNumLinha);
    var var_encabezado_pos_ = scAjaxGetFieldText("encabezado_pos_" + iNumLinha);
    var var_pie_pos_ = scAjaxGetFieldText("pie_pos_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_formatosimpresion_prefijo_submit_form(var_prefijo_, var_tipodocumento_, var_idformato_, var_encabezado_pos_, var_pie_pos_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_formatosimpresion_prefijo_submit_form_cb);
  } // do_ajax_form_formatosimpresion_prefijo_submit_form

  function do_ajax_form_formatosimpresion_prefijo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("tipodocumento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idformato_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("encabezado_pos_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pie_pos_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_formatosimpresion_prefijo_submit_form_cb_after_alert);
  } // do_ajax_form_formatosimpresion_prefijo_submit_form_cb
  function do_ajax_form_formatosimpresion_prefijo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_formatosimpresion_prefijo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_formatosimpresion_prefijo_navigate_form()
  {
    perform_ajax_form_formatosimpresion_prefijo_navigate_form();
  }

  function perform_ajax_form_formatosimpresion_prefijo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_formatosimpresion_prefijo_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("tipodocumento_" + iNavForm);
      scAjaxHideErrorDisplay("idformato_" + iNavForm);
      scAjaxHideErrorDisplay("encabezado_pos_" + iNavForm);
      scAjaxHideErrorDisplay("pie_pos_" + iNavForm);
    }
    var var_idformatoimpresion_prefijo_ = document.F2.idformatoimpresion_prefijo_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_formatosimpresion_prefijo_navigate_form(var_idformatoimpresion_prefijo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_formatosimpresion_prefijo_navigate_form_cb);
  } // do_ajax_form_formatosimpresion_prefijo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_formatosimpresion_prefijo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_formatosimpresion_prefijo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idformatoimpresion_prefijo_.value = scAjaxGetKeyValue("idformatoimpresion_prefijo_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_formatosimpresion_prefijo_navigate_form_cb_after_alert);
  } // do_ajax_form_formatosimpresion_prefijo_navigate_form_cb
  function do_ajax_form_formatosimpresion_prefijo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_formatosimpresion_prefijo_navigate_form_cb_after_alert
  function sc_hide_form_formatosimpresion_prefijo_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tipodocumento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idformato_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "encabezado_pos_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pie_pos_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["tipodocumento_" + iNumLinha] = {"label": "Tipo Documento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idformato_" + iNumLinha] = {"label": "Formato<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["encabezado_pos_" + iNumLinha] = {"label": "Encabezado Pos<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pie_pos_" + iNumLinha] = {"label": "Pie Pos<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["prefijo_"][iNumLinha] = "prefijo_" + iNumLinha;
    ajax_field_mult["tipodocumento_"][iNumLinha] = "tipodocumento_" + iNumLinha;
    ajax_field_mult["idformato_"][iNumLinha] = "idformato_" + iNumLinha;
    ajax_field_mult["encabezado_pos_"][iNumLinha] = "encabezado_pos_" + iNumLinha;
    ajax_field_mult["pie_pos_"][iNumLinha] = "pie_pos_" + iNumLinha;
    ajax_field_id["prefijo_" + iNumLinha] = new Array("hidden_field_label_prefijo_", "hidden_field_data_prefijo_" + iNumLinha);
    ajax_field_id["tipodocumento_" + iNumLinha] = new Array("hidden_field_label_tipodocumento_", "hidden_field_data_tipodocumento_" + iNumLinha);
    ajax_field_id["idformato_" + iNumLinha] = new Array("hidden_field_label_idformato_", "hidden_field_data_idformato_" + iNumLinha);
    ajax_field_id["encabezado_pos_" + iNumLinha] = new Array("hidden_field_label_encabezado_pos_", "hidden_field_data_encabezado_pos_" + iNumLinha);
    ajax_field_id["pie_pos_" + iNumLinha] = new Array("hidden_field_label_pie_pos_", "hidden_field_data_pie_pos_" + iNumLinha);
    ajax_error_count["prefijo_" + iNumLinha] = "off";
    ajax_error_count["tipodocumento_" + iNumLinha] = "off";
    ajax_error_count["idformato_" + iNumLinha] = "off";
    ajax_error_count["encabezado_pos_" + iNumLinha] = "off";
    ajax_error_count["pie_pos_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["prefijo_" + iNumLinha] = "off";
    ajax_read_only["tipodocumento_" + iNumLinha] = "off";
    ajax_read_only["idformato_" + iNumLinha] = "off";
    ajax_read_only["encabezado_pos_" + iNumLinha] = "off";
    ajax_read_only["pie_pos_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["tipodocumento_" + iNumLinha] = "on";
    ajax_read_only["idformato_" + iNumLinha] = "on";
    ajax_read_only["encabezado_pos_" + iNumLinha] = "on";
    ajax_read_only["pie_pos_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["tipodocumento_" + iNumLinha] = null;
    ajax_error_list["idformato_" + iNumLinha] = null;
    ajax_error_list["encabezado_pos_" + iNumLinha] = null;
    ajax_error_list["pie_pos_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "prefijo_": new Array(),
    "tipodocumento_": new Array(),
    "idformato_": new Array(),
    "encabezado_pos_": new Array(),
    "pie_pos_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["tipodocumento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipodocumento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipodocumento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipodocumento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipodocumento_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["encabezado_pos_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["encabezado_pos_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["encabezado_pos_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["encabezado_pos_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["encabezado_pos_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pie_pos_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pie_pos_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pie_pos_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pie_pos_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pie_pos_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipodocumento_'])) ? $this->nmgp_cmp_readonly['tipodocumento_'] : 'off';
?>
    scAjaxFieldRead("tipodocumento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idformato_'])) ? $this->nmgp_cmp_readonly['idformato_'] : 'off';
?>
    scAjaxFieldRead("idformato_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['encabezado_pos_'])) ? $this->nmgp_cmp_readonly['encabezado_pos_'] : 'off';
?>
    scAjaxFieldRead("encabezado_pos_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pie_pos_'])) ? $this->nmgp_cmp_readonly['pie_pos_'] : 'off';
?>
    scAjaxFieldRead("pie_pos_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("prefijo_" + iSeq, "on");
    scAjaxFieldRead("tipodocumento_" + iSeq, "on");
    scAjaxFieldRead("idformato_" + iSeq, "on");
    scAjaxFieldRead("encabezado_pos_" + iSeq, "on");
    scAjaxFieldRead("pie_pos_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["prefijo_" + iRow] || "on" == ajax_error_count["tipodocumento_" + iRow] || "on" == ajax_error_count["idformato_" + iRow] || "on" == ajax_error_count["encabezado_pos_" + iRow] || "on" == ajax_error_count["pie_pos_" + iRow]))
    {
      ...
      $("#hidden_field_data_tipodocumento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idformato_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_encabezado_pos_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pie_pos_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["prefijo_" + iRow] && "off" == ajax_error_count["tipodocumento_" + iRow] && "off" == ajax_error_count["idformato_" + iRow] && "off" == ajax_error_count["encabezado_pos_" + iRow] && "off" == ajax_error_count["pie_pos_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["prefijo_" + iRow] = "off";
        ajax_error_count["tipodocumento_" + iRow] = "off";
        ajax_error_count["idformato_" + iRow] = "off";
        ajax_error_count["encabezado_pos_" + iRow] = "off";
        ajax_error_count["pie_pos_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_tipodocumento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idformato_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_encabezado_pos_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pie_pos_" + iRow).removeClass("scFormErrorLine");
    }
  }
