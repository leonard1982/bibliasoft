...
{
    tb_show('', 'calendar_calendar.php?nmgp_opcao=igual_calendar&id=' + sEventId + '&__orig_id=' + sEventId + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
}
<?php
