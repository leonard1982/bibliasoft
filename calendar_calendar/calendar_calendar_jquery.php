...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('change', function() { sc_calendar_calendar_id_onchange(this, iSeqRow) });
  $('#id_sc_field_title' + iSeqRow).bind('blur', function() { sc_calendar_calendar_title_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_calendar_calendar_title_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_description' + iSeqRow).bind('blur', function() { sc_calendar_calendar_description_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_calendar_calendar_description_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_start_date' + iSeqRow).bind('blur', function() { sc_calendar_calendar_start_date_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_calendar_calendar_start_date_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_start_time' + iSeqRow).bind('blur', function() { sc_calendar_calendar_start_time_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_calendar_calendar_start_time_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_end_date' + iSeqRow).bind('blur', function() { sc_calendar_calendar_end_date_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_calendar_calendar_end_date_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_end_time' + iSeqRow).bind('blur', function() { sc_calendar_calendar_end_time_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_calendar_calendar_end_time_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_period' + iSeqRow).bind('blur', function() { sc_calendar_calendar_period_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_calendar_calendar_period_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_category' + iSeqRow).bind('blur', function() { sc_calendar_calendar_category_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_calendar_calendar_category_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_id_api' + iSeqRow).bind('blur', function() { sc_calendar_calendar_id_api_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_calendar_calendar_id_api_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_calendar_calendar_id_api_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_event_google' + iSeqRow).bind('change', function() { sc_calendar_calendar_id_event_google_onchange(this, iSeqRow) });
  $('#id_sc_field_recur_info' + iSeqRow).bind('blur', function() { sc_calendar_calendar_recur_info_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_calendar_calendar_recur_info_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_event_color' + iSeqRow).bind('blur', function() { sc_calendar_calendar_event_color_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_calendar_calendar_event_color_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_calendar_calendar_event_color_onfocus(this, iSeqRow) });
  $('#id_sc_field_creator' + iSeqRow).bind('change', function() { sc_calendar_calendar_creator_onchange(this, iSeqRow) });
  $('#id_sc_field_reminder' + iSeqRow).bind('change', function() { sc_calendar_calendar_reminder_onchange(this, iSeqRow) });
  $('#id_sc_field___calend_all_day__' + iSeqRow).bind('blur', function() { sc_calendar_calendar___calend_all_day___onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_calendar_calendar___calend_all_day___onchange(this, iSeqRow) })
...
function sc_calendar_calendar_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar_title_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar_description_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar_start_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar_start_time_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar_end_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar_end_time_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar_period_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar_category_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar_id_api_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar_id_event_google_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar_recur_info_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar_event_color_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar_creator_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_calendar_calendar_reminder_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_calendar___calend_all_day___onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_calendar_calendar_form" + pageNo).hide();
}
...
function scEventControl_onCalculator_recur_info() {
  if (!_scCalculatorControl["id_sc_field_recur_info"]) {
    ...
    do_ajax_calendar_calendar_event_recur_info_onblur();
  }
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_start_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      setTimeout(function() { do_ajax_calendar_calendar_validate_start_date(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_end_date" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_calendar_calendar_validate_end_date(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'calendar_calendar')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
