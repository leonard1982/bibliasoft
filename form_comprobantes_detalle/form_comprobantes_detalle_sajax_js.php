  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_comprobantes_detalle" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_comprobantes_detalle_form();
	}
  ...
  function do_ajax_form_comprobantes_detalle_validate_comprobante()
  {
    var nomeCampo_comprobante = "comprobante";
    var var_comprobante = scAjaxGetFieldText(nomeCampo_comprobante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_detalle_validate_comprobante(var_comprobante, var_script_case_init, do_ajax_form_comprobantes_detalle_validate_comprobante_cb);
  } // do_ajax_form_comprobantes_detalle_validate_comprobante

  function do_ajax_form_comprobantes_detalle_validate_comprobante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "comprobante";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_detalle_validate_comprobante_cb

  // ---------- Validate plan_cuenta
  function do_ajax_form_comprobantes_detalle_validate_plan_cuenta()
  {
  } // do_ajax_form_comprobantes_detalle_validate_plan_cuenta

  function do_ajax_form_comprobantes_detalle_validate_plan_cuenta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "plan_cuenta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_detalle_validate_plan_cuenta_cb

  // ---------- Validate valor
  function do_ajax_form_comprobantes_detalle_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_detalle_validate_valor(var_valor, var_script_case_init, do_ajax_form_comprobantes_detalle_validate_valor_cb);
  } // do_ajax_form_comprobantes_detalle_validate_valor

  function do_ajax_form_comprobantes_detalle_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_detalle_validate_valor_cb

  // ---------- Validate tipo
  function do_ajax_form_comprobantes_detalle_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_detalle_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_comprobantes_detalle_validate_tipo_cb);
  } // do_ajax_form_comprobantes_detalle_validate_tipo

  function do_ajax_form_comprobantes_detalle_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_detalle_validate_tipo_cb

  // ---------- Validate tercero
  function do_ajax_form_comprobantes_detalle_validate_tercero()
  {
  } // do_ajax_form_comprobantes_detalle_validate_tercero

  function do_ajax_form_comprobantes_detalle_validate_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tercero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_detalle_validate_tercero_cb

  // ---------- Validate observacion
  function do_ajax_form_comprobantes_detalle_validate_observacion()
  {
    var nomeCampo_observacion = "observacion";
    var var_observacion = scAjaxGetFieldText(nomeCampo_observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_detalle_validate_observacion(var_observacion, var_script_case_init, do_ajax_form_comprobantes_detalle_validate_observacion_cb);
  } // do_ajax_form_comprobantes_detalle_validate_observacion

  function do_ajax_form_comprobantes_detalle_validate_observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_detalle_validate_observacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_comprobantes_detalle_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_comprobantes_detalle_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_comprobante = scAjaxGetFieldText("comprobante");
    var var_plan_cuenta = scAjaxGetFieldText("plan_cuenta");
    ...
    scAjaxProcOn();
    x_ajax_form_comprobantes_detalle_submit_form(var_comprobante, var_plan_cuenta, var_valor, var_tipo, var_tercero, var_observacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_comprobantes_detalle_submit_form_cb);
  } // do_ajax_form_comprobantes_detalle_submit_form

  function do_ajax_form_comprobantes_detalle_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("comprobante");
      scAjaxHideErrorDisplay("plan_cuenta");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_comprobantes_detalle_submit_form_cb_after_alert);
  } // do_ajax_form_comprobantes_detalle_submit_form_cb
  function do_ajax_form_comprobantes_detalle_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_comprobantes_detalle_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_comprobantes_detalle_navigate_form()
  {
    perform_ajax_form_comprobantes_detalle_navigate_form();
  }

  function perform_ajax_form_comprobantes_detalle_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tercero");
    scAjaxHideErrorDisplay("observacion");
    var var_iddetalle_comprobante = document.F2.iddetalle_comprobante.value;
    ...
    scAjaxProcOn();
    x_ajax_form_comprobantes_detalle_navigate_form(var_iddetalle_comprobante, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_comprobantes_detalle_navigate_form_cb);
  } // do_ajax_form_comprobantes_detalle_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes_detalle']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_comprobantes_detalle_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.iddetalle_comprobante.value = scAjaxGetKeyValue("iddetalle_comprobante");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_comprobantes_detalle_navigate_form_cb_after_alert);
  } // do_ajax_form_comprobantes_detalle_navigate_form_cb
  function do_ajax_form_comprobantes_detalle_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_comprobantes_detalle_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_comprobantes_detalle_navigate_form_cb_after_alert
  function sc_hide_form_comprobantes_detalle_form()
  {
  ...
  ajax_field_list[0] = "comprobante";
  ajax_field_list[1] = "plan_cuenta";
  ajax_field_list[2] = "valor";
  ajax_field_list[3] = "tipo";
  ajax_field_list[4] = "tercero";
  ajax_field_list[5] = "observacion";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "comprobante": {"label": "Comprobante", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "plan_cuenta": {"label": "Plan Cuenta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "observacion": {"label": "Observacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "comprobante": new Array(),
    "plan_cuenta": new Array(),
    "valor": new Array(),
    "tipo": new Array(),
    "tercero": new Array(),
    "observacion": new Array()
  };
  ajax_field_mult["comprobante"][1] = "comprobante";
  ajax_field_mult["plan_cuenta"][1] = "plan_cuenta";
  ...
  var ajax_field_id = {
    "plan_cuenta": new Array("hidden_field_label_plan_cuenta", "hidden_field_data_plan_cuenta"),
