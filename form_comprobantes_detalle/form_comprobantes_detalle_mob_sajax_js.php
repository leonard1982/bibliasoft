  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_comprobantes_detalle_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_comprobantes_detalle_mob_form();
	}
...
?>
  ...
  function do_ajax_form_comprobantes_detalle_mob_validate_comprobante()
  {
    var nomeCampo_comprobante = "comprobante";
    var var_comprobante = scAjaxGetFieldText(nomeCampo_comprobante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_detalle_mob_validate_comprobante(var_comprobante, var_script_case_init, do_ajax_form_comprobantes_detalle_mob_validate_comprobante_cb);
  } // do_ajax_form_comprobantes_detalle_mob_validate_comprobante

  function do_ajax_form_comprobantes_detalle_mob_validate_comprobante_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_detalle_mob_validate_comprobante_cb

  // ---------- Validate plan_cuenta
  function do_ajax_form_comprobantes_detalle_mob_validate_plan_cuenta()
  {
  } // do_ajax_form_comprobantes_detalle_mob_validate_plan_cuenta

  function do_ajax_form_comprobantes_detalle_mob_validate_plan_cuenta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_detalle_mob_validate_plan_cuenta_cb

  // ---------- Validate valor
  function do_ajax_form_comprobantes_detalle_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_detalle_mob_validate_valor(var_valor, var_script_case_init, do_ajax_form_comprobantes_detalle_mob_validate_valor_cb);
  } // do_ajax_form_comprobantes_detalle_mob_validate_valor

  function do_ajax_form_comprobantes_detalle_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_detalle_mob_validate_valor_cb

  // ---------- Validate tipo
  function do_ajax_form_comprobantes_detalle_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_detalle_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_comprobantes_detalle_mob_validate_tipo_cb);
  } // do_ajax_form_comprobantes_detalle_mob_validate_tipo

  function do_ajax_form_comprobantes_detalle_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_detalle_mob_validate_tipo_cb

  // ---------- Validate tercero
  function do_ajax_form_comprobantes_detalle_mob_validate_tercero()
  {
  } // do_ajax_form_comprobantes_detalle_mob_validate_tercero

  function do_ajax_form_comprobantes_detalle_mob_validate_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tercero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_detalle_mob_validate_tercero_cb

  // ---------- Validate observacion
  function do_ajax_form_comprobantes_detalle_mob_validate_observacion()
  {
    var nomeCampo_observacion = "observacion";
    var var_observacion = scAjaxGetFieldText(nomeCampo_observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_detalle_mob_validate_observacion(var_observacion, var_script_case_init, do_ajax_form_comprobantes_detalle_mob_validate_observacion_cb);
  } // do_ajax_form_comprobantes_detalle_mob_validate_observacion

  function do_ajax_form_comprobantes_detalle_mob_validate_observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_detalle_mob_validate_observacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_comprobantes_detalle_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_comprobantes_detalle_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_iddetalle_comprobante = scAjaxGetFieldText("iddetalle_comprobante");
    ...
    scAjaxProcOn();
    x_ajax_form_comprobantes_detalle_mob_submit_form(var_comprobante, var_plan_cuenta, var_valor, var_tipo, var_tercero, var_observacion, var_iddetalle_comprobante, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_comprobantes_detalle_mob_submit_form_cb);
  } // do_ajax_form_comprobantes_detalle_mob_submit_form

  function do_ajax_form_comprobantes_detalle_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_comprobantes_detalle_mob_submit_form_cb_after_alert);
  } // do_ajax_form_comprobantes_detalle_mob_submit_form_cb
  function do_ajax_form_comprobantes_detalle_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_comprobantes_detalle_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_comprobantes_detalle_mob_navigate_form()
  {
    perform_ajax_form_comprobantes_detalle_mob_navigate_form();
  }

  function perform_ajax_form_comprobantes_detalle_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_comprobantes_detalle_mob_navigate_form(var_iddetalle_comprobante, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_comprobantes_detalle_mob_navigate_form_cb);
  } // do_ajax_form_comprobantes_detalle_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes_detalle_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_comprobantes_detalle_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_comprobantes_detalle_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_comprobantes_detalle_mob_navigate_form_cb
  function do_ajax_form_comprobantes_detalle_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_comprobantes_detalle_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_comprobantes_detalle_mob_navigate_form_cb_after_alert
  function sc_hide_form_comprobantes_detalle_mob_form()
  {
