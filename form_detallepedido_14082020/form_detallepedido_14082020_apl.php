<?php
//
class form_detallepedido_14082020_apl
{
   ...
   var $sabor__1;
   var $estado_comanda_;
   var $usuario_comanda_;
   var $tercero_comanda_;
   var $hora_inicio_;
   var $hora_inicio__hora;
   var $hora_final_;
   var $hora_final__hora;
   var $observ_;
   var $cerrado_;
   var $obs_;
   var $descr_;
   ...
   var $form_vert_form_detallepedido_14082020 = array();
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['autorizarborrado_']))
          {
              $this->autorizarborrado_ = $this->NM_ajax_info['param']['autorizarborrado_'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['descrip_']))
          {
              $this->descrip_ = $this->NM_ajax_info['param']['descrip_'];
          }
          if (isset($this->NM_ajax_info['param']['descuento_']))
          {
              $this->descuento_ = $this->NM_ajax_info['param']['descuento_'];
          }
          if (isset($this->NM_ajax_info['param']['estado_comanda_']))
          {
              $this->estado_comanda_ = $this->NM_ajax_info['param']['estado_comanda_'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['idpedid_']))
          {
              $this->idpedid_ = $this->NM_ajax_info['param']['idpedid_'];
          }
      ...
      $this->sc_conv_var['idpedid'] = "idpedid_";
      ...
      $this->sc_conv_var['estado_comanda'] = "estado_comanda_";
      $this->sc_conv_var['usuario_comanda'] = "usuario_comanda_";
      $this->sc_conv_var['tercero_comanda'] = "tercero_comanda_";
      $this->sc_conv_var['hora_inicio'] = "hora_inicio_";
      $this->sc_conv_var['hora_final'] = "hora_final_";
      $this->sc_conv_var['observ'] = "observ_";
      $this->sc_conv_var['cerrado'] = "cerrado_";
      $this->sc_conv_var['obs'] = "obs_";
      $this->sc_conv_var['descr'] = "descr_";
      $this->sc_conv_var['codbarra'] = "codbarra_";
      $this->sc_conv_var['stockubica'] = "stockubica_";
      $this->sc_conv_var['unidad'] = "unidad_";
      $this->sc_conv_var['descrip'] = "descrip_";
      $this->sc_conv_var['autorizarborrado'] = "autorizarborrado_";
      if (!empty($_FILES))
      {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_detallepedido_14082020($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_numero)) 
          {
              $_SESSION['par_numero'] = $this->par_numero;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_detallepedido_14082020_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_detallepedido_14082020']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_detallepedido_14082020']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_detallepedido_14082020'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detallepedido_14082020']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detallepedido_14082020']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_detallepedido_14082020') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detallepedido_14082020']['label'] = "Detalle venta";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_detallepedido_14082020")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_detallepedido_14082020']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_detallepedido_14082020'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_orig'] = " where idpedid=" . $_SESSION['par_numero'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_pesq'] = " where idpedid=" . $_SESSION['par_numero'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detallepedido_14082020']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_detallepedido_14082020'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_detallepedido_14082020'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['exit'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_detallepedido_14082020", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_detallepedido_14082020_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_detallepedido_14082020_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_detallepedido_14082020/form_detallepedido_14082020_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_detallepedido_14082020_erro.class.php"); 
      }
      $this->Erro      = new form_detallepedido_14082020_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_max_reg']) == "all")
      {
      ...
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opcao']))
         { 
             if ($this->iddet_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['autorizar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['botoes']['autorizar'];
          $this->nmgp_botoes['refrescar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['botoes']['refrescar'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['final'];
      }
      else
      {
      }
...
//
      ...
      {
      $_SESSION['scriptcase']['form_detallepedido_14082020']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_detallepedido_14082020']['contr_erro'] = 'off'; 
      }
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_detallepedido_14082020']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_detallepedido_14082020']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
   ...
   function loadFieldConfig()
   {
      ...
      //-- idpedid_
      $this->field_config['idpedid_']               = array();
      $this->field_config['idpedid_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['idpedid_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['idpedid_']['symbol_dec'] = '';
      $this->field_config['idpedid_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['idpedid_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- numfac_
      ...
      //-- tercero_comanda_
      $this->field_config['tercero_comanda_']               = array();
      $this->field_config['tercero_comanda_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['tercero_comanda_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['tercero_comanda_']['symbol_dec'] = '';
      $this->field_config['tercero_comanda_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['tercero_comanda_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- hora_inicio_
      $this->field_config['hora_inicio_']                 = array();
      $this->field_config['hora_inicio_']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'] . ';' . $_SESSION['scriptcase']['reg_conf']['time_format'];
      $this->field_config['hora_inicio_']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['hora_inicio_']['time_sep']     = $_SESSION['scriptcase']['reg_conf']['time_sep'];
      $this->field_config['hora_inicio_']['date_display'] = "ddmmaaaa;hhiiss";
      $this->new_date_format('DH', 'hora_inicio_');
      //-- hora_final_
      $this->field_config['hora_final_']                 = array();
      $this->field_config['hora_final_']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'] . ';' . $_SESSION['scriptcase']['reg_conf']['time_format'];
      $this->field_config['hora_final_']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['hora_final_']['time_sep']     = $_SESSION['scriptcase']['reg_conf']['time_sep'];
      $this->field_config['hora_final_']['date_display'] = "ddmmaaaa;hhiiss";
      $this->new_date_format('DH', 'hora_final_');
      //-- codbarra_
      $this->field_config['codbarra_']               = array();
      $this->field_config['codbarra_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['codbarra_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['codbarra_']['symbol_dec'] = '';
      $this->field_config['codbarra_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['codbarra_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
   }
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'add_new_line' == $this->NM_ajax_opcao)
      {
         ...
         $this->NM_close_db();
         form_detallepedido_14082020_pack_ajax_response();
         exit;
      }
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($this->idpedid_)) { $this->nm_limpa_alfa($this->idpedid_); }
         ...
         if (isset($this->estado_comanda_)) { $this->nm_limpa_alfa($this->estado_comanda_); }
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_form'][$sc_seq_vert];
             ...
             $this->usuario_comanda_ = $this->nmgp_dados_form['usuario_comanda_']; 
             $this->tercero_comanda_ = $this->nmgp_dados_form['tercero_comanda_']; 
             $this->hora_inicio_ = $this->nmgp_dados_form['hora_inicio_']; 
             $this->hora_final_ = $this->nmgp_dados_form['hora_final_']; 
             $this->observ_ = $this->nmgp_dados_form['observ_']; 
             $this->cerrado_ = $this->nmgp_dados_form['cerrado_']; 
             $this->descr_ = $this->nmgp_dados_form['descr_']; 
             $this->codbarra_ = $this->nmgp_dados_form['codbarra_']; 
         }
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_detallepedido_14082020']) || !is_array($this->NM_ajax_info['errList']['geral_form_detallepedido_14082020']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_detallepedido_14082020'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_detallepedido_14082020'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_detallepedido_14082020'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_detallepedido_14082020'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_redir_atualiz'] == "ok")
          {
      ...
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
         ...
         $Campos_Erros = array();
          ...
          if ('validate_descrip_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'descrip_');
          }
          ...
          if ('validate_autorizarborrado_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'autorizarborrado_');
          }
          if ('validate_estado_comanda_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'estado_comanda_');
          }
          if ('validate_idpedid_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'idpedid_');
          }
          form_detallepedido_14082020_pack_ajax_response();
          exit;
      }
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_idpro_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_idpro_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_idpro_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_idpro_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_detallepedido_14082020_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_detallepedido_14082020_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_idpro_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      { 
         ...
         { 
             $GLOBALS["idpro_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['idpro_'];
         } 
         $this->iddet_ = $GLOBALS["iddet_" . $sc_seq_vert]; 
         $this->idpro_ = $GLOBALS["idpro_" . $sc_seq_vert]; 
         $this->descrip_ = $GLOBALS["descrip_" . $sc_seq_vert]; 
         ...
         $this->autorizarborrado_ = $GLOBALS["autorizarborrado_" . $sc_seq_vert]; 
         $this->estado_comanda_ = $GLOBALS["estado_comanda_" . $sc_seq_vert]; 
         $this->idpedid_ = $GLOBALS["idpedid_" . $sc_seq_vert]; 
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_form'][$sc_seq_vert];
             $this->numfac_ = $this->nmgp_dados_form['numfac_']; 
         ...
         if (isset($this->estado_comanda_)) { $this->nm_limpa_alfa($this->estado_comanda_); }
         if (isset($this->obs_)) { $this->nm_limpa_alfa($this->obs_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert];
         }
         if ($this->nmgp_opcao != "recarga" && (!in_array($sc_seq_vert, $sc_check_excl) && !in_array($sc_seq_vert, $sc_check_incl) ))
         { }
         else
         {
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['idpro_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_disabled'][$sc_seq_vert]['idpro_']))
             { 
                 $this->idpro_ = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['idpro_'];
             } 
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['iddet_'] =  $this->iddet_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['descrip_'] =  $this->descrip_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['obs_'] =  $this->obs_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['colores_'] =  $this->colores_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['tallas_'] =  $this->tallas_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['sabor_'] =  $this->sabor_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['idbod_'] =  $this->idbod_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['unidadmayor_'] =  $this->unidadmayor_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['stockubica_'] =  $this->stockubica_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['unidad_'] =  $this->unidad_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['cantidad_'] =  $this->cantidad_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['valorunit_'] =  $this->valorunit_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['valorpar_'] =  $this->valorpar_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['descuento_'] =  $this->descuento_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['adicional_'] =  $this->adicional_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['adicional1_'] =  $this->adicional1_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['factor_'] =  $this->factor_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['iva_'] =  $this->iva_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['costop_'] =  $this->costop_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['autorizarborrado_'] =  $this->autorizarborrado_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['estado_comanda_'] =  $this->estado_comanda_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['idpedid_'] =  $this->idpedid_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['numfac_'] =  $this->numfac_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['remision_'] =  $this->remision_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['devuelto_'] =  $this->devuelto_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['usuario_comanda_'] =  $this->usuario_comanda_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['tercero_comanda_'] =  $this->tercero_comanda_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['hora_inicio_'] =  $this->hora_inicio_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['hora_inicio__hora'] =  $this->hora_inicio__hora; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['hora_final_'] =  $this->hora_final_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['hora_final__hora'] =  $this->hora_final__hora; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['observ_'] =  $this->observ_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['cerrado_'] =  $this->cerrado_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['descr_'] =  $this->descr_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['codbarra_'] =  $this->codbarra_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_detallepedido_14082020);
      ...
      {
          $this->nm_tira_formatacao();
          if ('event_autorizarborrado__onclick' == $this->NM_ajax_opcao)
          {
              $this->autorizarborrado__onClick();
          }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_detallepedido_14082020.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_detallepedido_14082020_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_detallepedido_14082020"> 
...
<?php
include_once("form_detallepedido_14082020_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opc_ant'] == "incluir")
      {
      ...
      nm_limpa_numero($this->idpedid_, $this->field_config['idpedid_']['symbol_grp']) ; 
      $_SESSION['scriptcase']['form_detallepedido_14082020']['contr_erro'] = 'on';
if (!isset($this->sc_temp_gIdDeta)) {$this->sc_temp_gIdDeta = (isset($_SESSION['gIdDeta'])) ? $_SESSION['gIdDeta'] : "";}
if (!isset($this->sc_temp_gProducto)) {$this->sc_temp_gProducto = (isset($_SESSION['gProducto'])) ? $_SESSION['gProducto'] : "";}
  if($this->iddet_ >0 and $this->estado_comanda_ ==2)
	{
	$this->sc_temp_gProducto=$this->idpro_ ;
	$this->sc_temp_gIdDeta=$this->iddet_ ;
	 if (isset($this->sc_temp_gProducto)) { $_SESSION['gProducto'] = $this->sc_temp_gProducto;}
 if (isset($this->sc_temp_gIdDeta)) { $_SESSION['gIdDeta'] = $this->sc_temp_gIdDeta;}
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'costop_':
               return "Costop";
               break;
           case 'autorizarborrado_':
               return "Borrar";
               break;
           case 'estado_comanda_':
               return "Estado";
               break;
           case 'idpedid_':
               return "Idpedid";
           ...
           case 'devuelto_':
               return "Devuelto";
               break;
           case 'usuario_comanda_':
               return "Usuario Comanda";
               break;
           case 'tercero_comanda_':
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_detallepedido_14082020'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'descrip_' == $filtro)) || (is_array($filtro) && in_array('descrip_', $filtro)))
        $this->ValidateField_descrip_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'autorizarborrado_' == $filtro)) || (is_array($filtro) && in_array('autorizarborrado_', $filtro)))
        $this->ValidateField_autorizarborrado_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'estado_comanda_' == $filtro)) || (is_array($filtro) && in_array('estado_comanda_', $filtro)))
        $this->ValidateField_estado_comanda_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'idpedid_' == $filtro)) || (is_array($filtro) && in_array('idpedid_', $filtro)))
        $this->ValidateField_idpedid_($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_estado_comanda_ = $this->estado_comanda_;
    $original_valorpar_ = $this->valorpar_;
}
  if ($this->sc_evento == "excluir" || $this->sc_evento == "delete")
	{
	if($this->estado_comanda_ <2)
		{
		goto a;
		}
	elseif($this->estado_comanda_ ==2)
		{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_detallepedido_14082020';
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_estado_comanda_ != $this->estado_comanda_ || (isset($bFlagRead_estado_comanda_) && $bFlagRead_estado_comanda_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['estado_comanda_' . $this->nmgp_refresh_row]['type']    = 'label';
        $this->NM_ajax_info['fldList']['estado_comanda_' . $this->nmgp_refresh_row]['valList'] = array($this->estado_comanda_);
        $this->NM_ajax_changed['estado_comanda_'] = true;
    }
...
$_SESSION['scriptcase']['form_detallepedido_14082020']['contr_erro'] = 'off'; 
    ...
    function ValidateField_descrip_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (trim($this->descrip_) != "")  
          { 
          } 
      } 
        if ($hasError) {
    ...
    function ValidateField_colores_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->colores_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_colores_']) && !in_array($this->colores_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_colores_']))
               {
                   $hasError = true;
    ...
    function ValidateField_tallas_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->tallas_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_tallas_']) && !in_array($this->tallas_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_tallas_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_sabor_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->sabor_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_sabor_']) && !in_array($this->sabor_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_sabor_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idbod_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idbod_ == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['php_cmp_required']['idbod_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['php_cmp_required']['idbod_'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idbod_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_idbod_']) && !in_array($this->idbod_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_idbod_']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idbod_']))
    ...
    function ValidateField_autorizarborrado_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->autorizarborrado_ == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
      if ($this->autorizarborrado_ != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_autorizarborrado_']) && !in_array($this->autorizarborrado_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_autorizarborrado_']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['autorizarborrado_']))
              {
                  $Campos_Erros['autorizarborrado_'] = array();
              }
              $Campos_Erros['autorizarborrado_'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($this->NM_ajax_info['errList']['autorizarborrado_']) || !is_array($this->NM_ajax_info['errList']['autorizarborrado_']))
              {
                  $this->NM_ajax_info['errList']['autorizarborrado_'] = array();
              }
              $this->NM_ajax_info['errList']['autorizarborrado_'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
          }
      }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'autorizarborrado_';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_autorizarborrado_

    function ValidateField_estado_comanda_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->estado_comanda_) > 255) 
          { 
              $hasError = true;
              $Campos_Crit .= "Estado " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['estado_comanda_']))
              {
                  $Campos_Erros['estado_comanda_'] = array();
              }
              $Campos_Erros['estado_comanda_'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['estado_comanda_']) || !is_array($this->NM_ajax_info['errList']['estado_comanda_']))
              {
                  $this->NM_ajax_info['errList']['estado_comanda_'] = array();
              }
              $this->NM_ajax_info['errList']['estado_comanda_'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'estado_comanda_';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_estado_comanda_

    function ValidateField_idpedid_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idpedid_ === "" || is_null($this->idpedid_))  
      { 
          $this->idpedid_ = 0;
          $this->sc_force_zero[] = 'idpedid_';
      } 
      nm_limpa_numero($this->idpedid_, $this->field_config['idpedid_']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 20;
              if (strlen($this->idpedid_) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Idpedid: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['idpedid_']))
                  {
                      $Campos_Erros['idpedid_'] = array();
                  }
                  $Campos_Erros['idpedid_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['idpedid_']) || !is_array($this->NM_ajax_info['errList']['idpedid_']))
                  {
                      $this->NM_ajax_info['errList']['idpedid_'] = array();
                  }
                  $this->NM_ajax_info['errList']['idpedid_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->idpedid_, 20, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Idpedid; " ; 
                  if (!isset($Campos_Erros['idpedid_']))
                  ...
                  $Campos_Erros['idpedid_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['idpedid_']) || !is_array($this->NM_ajax_info['errList']['idpedid_']))
                  {
                      $this->NM_ajax_info['errList']['idpedid_'] = array();
                  }
                  $this->NM_ajax_info['errList']['idpedid_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['descrip_'] = $this->descrip_;
    ...
    $this->nmgp_dados_form['autorizarborrado_'] = $this->autorizarborrado_;
    $this->nmgp_dados_form['estado_comanda_'] = $this->estado_comanda_;
    $this->nmgp_dados_form['idpedid_'] = $this->idpedid_;
    ...
    $this->nmgp_dados_form['usuario_comanda_'] = $this->usuario_comanda_;
    $this->nmgp_dados_form['tercero_comanda_'] = $this->tercero_comanda_;
    $this->nmgp_dados_form['hora_inicio_'] = $this->hora_inicio_;
    $this->nmgp_dados_form['hora_final_'] = $this->hora_final_;
    $this->nmgp_dados_form['observ_'] = $this->observ_;
    $this->nmgp_dados_form['cerrado_'] = $this->cerrado_;
    $this->nmgp_dados_form['descr_'] = $this->descr_;
    $this->nmgp_dados_form['codbarra_'] = $this->codbarra_;
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['idpedid_'] = $this->idpedid_;
      nm_limpa_numero($this->idpedid_, $this->field_config['idpedid_']['symbol_grp']) ; 
      ...
      $this->Before_unformat['tercero_comanda_'] = $this->tercero_comanda_;
      nm_limpa_numero($this->tercero_comanda_, $this->field_config['tercero_comanda_']['symbol_grp']) ; 
      $this->Before_unformat['hora_inicio_'] = $this->hora_inicio_;
      $this->Before_unformat['hora_inicio__hora'] = $this->hora_inicio__hora;
      nm_limpa_data($this->hora_inicio_, $this->field_config['hora_inicio_']['date_sep']) ; 
      nm_limpa_hora($this->hora_inicio__hora, $this->field_config['hora_inicio_']['time_sep']) ; 
      $this->Before_unformat['hora_final_'] = $this->hora_final_;
      $this->Before_unformat['hora_final__hora'] = $this->hora_final__hora;
      nm_limpa_data($this->hora_final_, $this->field_config['hora_final_']['date_sep']) ; 
      nm_limpa_hora($this->hora_final__hora, $this->field_config['hora_final_']['time_sep']) ; 
      $this->Before_unformat['codbarra_'] = $this->codbarra_;
      nm_limpa_numero($this->codbarra_, $this->field_config['codbarra_']['symbol_grp']) ; 
   }
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "tercero_comanda_")
      {
          nm_limpa_numero($this->tercero_comanda_, $this->field_config['tercero_comanda_']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "codbarra_")
      {
          nm_limpa_numero($this->codbarra_, $this->field_config['codbarra_']['symbol_grp']) ; 
      }
   }
   function nm_formatar_campos($format_fields = array())
   {
      ...
      if ('' !== $this->idpedid_ || (!empty($format_fields) && isset($format_fields['idpedid_'])))
      {
          nmgp_Form_Num_Val($this->idpedid_, $this->field_config['idpedid_']['symbol_grp'], $this->field_config['idpedid_']['symbol_dec'], "0", "S", $this->field_config['idpedid_']['format_neg'], "", "", "-", $this->field_config['idpedid_']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['iddet_']['keyVal'] = form_detallepedido_14082020_pack_protect_string($this->nmgp_dados_form['iddet_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['iddet_'] = $this->iddet_;
                  }
                  if (isset($this->NM_ajax_changed['idpro_']) && $this->NM_ajax_changed['idpro_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['idpro_'] = $this->idpro_;
                  }
                  if (isset($this->NM_ajax_changed['descrip_']) && $this->NM_ajax_changed['descrip_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['descrip_'] = $this->descrip_;
                  }
                  if (isset($this->NM_ajax_changed['obs_']) && $this->NM_ajax_changed['obs_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['obs_'] = $this->obs_;
                  }
                  if (isset($this->NM_ajax_changed['colores_']) && $this->NM_ajax_changed['colores_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['colores_'] = $this->colores_;
                  }
                  if (isset($this->NM_ajax_changed['tallas_']) && $this->NM_ajax_changed['tallas_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['tallas_'] = $this->tallas_;
                  }
                  if (isset($this->NM_ajax_changed['sabor_']) && $this->NM_ajax_changed['sabor_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['sabor_'] = $this->sabor_;
                  }
                  if (isset($this->NM_ajax_changed['idbod_']) && $this->NM_ajax_changed['idbod_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['idbod_'] = $this->idbod_;
                  }
                  if (isset($this->NM_ajax_changed['unidadmayor_']) && $this->NM_ajax_changed['unidadmayor_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['unidadmayor_'] = $this->unidadmayor_;
                  }
                  if (isset($this->NM_ajax_changed['stockubica_']) && $this->NM_ajax_changed['stockubica_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['stockubica_'] = $this->stockubica_;
                  }
                  if (isset($this->NM_ajax_changed['unidad_']) && $this->NM_ajax_changed['unidad_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['unidad_'] = $this->unidad_;
                  }
                  if (isset($this->NM_ajax_changed['cantidad_']) && $this->NM_ajax_changed['cantidad_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['cantidad_'] = $this->cantidad_;
                  }
                  if (isset($this->NM_ajax_changed['valorunit_']) && $this->NM_ajax_changed['valorunit_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['valorunit_'] = $this->valorunit_;
                  }
                  if (isset($this->NM_ajax_changed['valorpar_']) && $this->NM_ajax_changed['valorpar_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['valorpar_'] = $this->valorpar_;
                  }
                  if (isset($this->NM_ajax_changed['descuento_']) && $this->NM_ajax_changed['descuento_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['descuento_'] = $this->descuento_;
                  }
                  if (isset($this->NM_ajax_changed['adicional_']) && $this->NM_ajax_changed['adicional_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['adicional_'] = $this->adicional_;
                  }
                  if (isset($this->NM_ajax_changed['adicional1_']) && $this->NM_ajax_changed['adicional1_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['adicional1_'] = $this->adicional1_;
                  }
                  if (isset($this->NM_ajax_changed['factor_']) && $this->NM_ajax_changed['factor_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['factor_'] = $this->factor_;
                  }
                  if (isset($this->NM_ajax_changed['iva_']) && $this->NM_ajax_changed['iva_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['iva_'] = $this->iva_;
                  }
                  if (isset($this->NM_ajax_changed['costop_']) && $this->NM_ajax_changed['costop_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['costop_'] = $this->costop_;
                  }
                  if (isset($this->NM_ajax_changed['autorizarborrado_']) && $this->NM_ajax_changed['autorizarborrado_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['autorizarborrado_'] = $this->autorizarborrado_;
                  }
                  if (isset($this->NM_ajax_changed['estado_comanda_']) && $this->NM_ajax_changed['estado_comanda_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['estado_comanda_'] = $this->estado_comanda_;
                  }
                  if (isset($this->NM_ajax_changed['idpedid_']) && $this->NM_ajax_changed['idpedid_'])
                  {
                      $this->form_vert_form_detallepedido_14082020[$this->nmgp_refresh_row]['idpedid_'] = $this->idpedid_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_detallepedido_14082020 as $sc_seq_vert => $aRecData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['idpro_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][form_detallepedido_14082020_pack_protect_string($aRecData['idpro_'])]),
              );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("descrip_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['descrip_']);
                  $aLookup = array();
          ...
          { 
              $descrip_ = "<span class=\"scFormErrorMessage\">" . $this->Ini->Nm_lang['lang_errm_gd'] . "</span>"; 
          } 
          else 
          { 
          ...
          $sTmpImgHtml = "<a href=\"javascript:nm_gp_submit('" . $this->Ini->link_form_detallepedido_obs_edit . "', '$this->nm_location', 'iddet*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_form'][$sc_seq_vert]['iddet_'] . "*scoutpar_numero*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_form'][$sc_seq_vert]['idpedid_'] . "*scoutid_detalle*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_form'][$sc_seq_vert]['iddet_'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout', '', '_self', '0', '0', 'form_detallepedido_obs')\"><font color=\"" . $this->Ini->cor_link_dados . "\">" . $descrip_ . "</font></a>";
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['descrip_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'imagehtml',
                       'valList' => array($sTmpValue),
               'imgHtml' => $sTmpImgHtml,
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_colores_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_colores_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_colores_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_colores_'] = array(); 
}
if ('autocomp_' != substr($this->NM_ajax_opcao, 0, 9))
{
   $this->idpro_ = $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['idpro_'];
}
$aLookup[] = array(form_detallepedido_14082020_pack_protect_string('0') => str_replace('<', '&lt;',form_detallepedido_14082020_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_colores_'][] = '0';
if ($this->idpro_ != "")
{ 
   $this->nm_clear_val("idpro_");
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_colores_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['colores_' . $sc_seq_vert]['valList'][$i] = form_detallepedido_14082020_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_tallas_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_tallas_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_tallas_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_tallas_'] = array(); 
}
if ('autocomp_' != substr($this->NM_ajax_opcao, 0, 9))
{
   $this->idpro_ = $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['idpro_'];
...
$aLookup[] = array(form_detallepedido_14082020_pack_protect_string('0') => str_replace('<', '&lt;',form_detallepedido_14082020_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_tallas_'][] = '0';
if ($this->idpro_ != "")
{ 
   $this->nm_clear_val("idpro_");
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_tallas_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tallas_' . $sc_seq_vert]['valList'][$i] = form_detallepedido_14082020_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_sabor_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_sabor_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_sabor_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_sabor_'] = array(); 
}
if ('autocomp_' != substr($this->NM_ajax_opcao, 0, 9))
{
   $this->idpro_ = $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['idpro_'];
...
$aLookup[] = array(form_detallepedido_14082020_pack_protect_string('0') => str_replace('<', '&lt;',form_detallepedido_14082020_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_sabor_'][] = '0';
if ($this->idpro_ != "")
{ 
   $this->nm_clear_val("idpro_");
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_sabor_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['sabor_' . $sc_seq_vert]['valList'][$i] = form_detallepedido_14082020_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_idbod_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_idbod_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_idbod_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_idbod_'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_idbod_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idbod_' . $sc_seq_vert]['valList'][$i] = form_detallepedido_14082020_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          $this->NM_ajax_info['fldList']['idbod_' . $sc_seq_vert]['labList'] = $aLabel;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("unidadmayor_", $this->nmgp_refresh_fields)))
              {
                  ...
                  $aLookup = array();
$aLookup[] = array(form_detallepedido_14082020_pack_protect_string('NO') => str_replace('<', '&lt;',form_detallepedido_14082020_pack_protect_string("NO")));
$aLookup[] = array(form_detallepedido_14082020_pack_protect_string('SI') => str_replace('<', '&lt;',form_detallepedido_14082020_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_unidadmayor_'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_unidadmayor_'][] = 'SI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['unidadmayor_' . $sc_seq_vert]['valList'][$i] = form_detallepedido_14082020_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          $aLookupOrig = $aLookup;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("autorizarborrado_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['autorizarborrado_']);
                  $aLookup = array();
$aLookup[] = array(form_detallepedido_14082020_pack_protect_string('s') => str_replace('<', '&lt;',form_detallepedido_14082020_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_autorizarborrado_'][] = 's';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['autorizarborrado_']) && !empty($this->NM_ajax_info['select_html']['autorizarborrado_']))
          {
              eval("\$sOptComp = \"" . str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['autorizarborrado_']) . "\";");
          }
                  $this->NM_ajax_info['fldList']['autorizarborrado_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'radio',
                       'switch'  => false,
                       'valList' => array($sTmpValue),
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['autorizarborrado_' . $sc_seq_vert]['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['autorizarborrado_' . $sc_seq_vert]['valList'][$i] = form_detallepedido_14082020_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['autorizarborrado_' . $sc_seq_vert]['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['autorizarborrado_' . $sc_seq_vert]['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['autorizarborrado_' . $sc_seq_vert]['labList'] = $aLabel;
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("estado_comanda_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['estado_comanda_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['estado_comanda_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'label',
                       'valList' => array($sTmpValue),
                       );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("idpedid_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['idpedid_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['idpedid_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opc_ant'] == "novo"))
      {
          if (!isset($this->nmgp_cmp_hidden["autorizarborrado_"]))
          {
              $this->nmgp_cmp_hidden["autorizarborrado_"] = "off"; $this->NM_ajax_info['fieldDisplay']['autorizarborrado_'] = 'off';
          }
      }
      else
      {
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_descrip_ = $this->descrip_;
    $original_estado_comanda_ = $this->estado_comanda_;
...
if ($this->sc_evento == "novo")
	{
	$this->nmgp_cmp_hidden["descrip_"] = "off"; $this->NM_ajax_info['fieldDisplay']['descrip_'] = 'off';
	}


switch($this->estado_comanda_ )
{
	case 1:
		$this->estado_comanda_  = "PENDIENTE";
	break;
							
	case 2:
		$this->estado_comanda_  = "PROCESO";
	break;
							
	case 3:
		$this->estado_comanda_  = "CERRADA";
	break;
}
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_descrip_ != $this->descrip_ || (isset($bFlagRead_descrip_) && $bFlagRead_descrip_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['descrip_' . $this->nmgp_refresh_row]['type']    = 'imagehtml';
        $this->NM_ajax_info['fldList']['descrip_' . $this->nmgp_refresh_row]['valList'] = array($this->descrip_);
        $this->NM_ajax_changed['descrip_'] = true;
    }
    if (($original_estado_comanda_ != $this->estado_comanda_ || (isset($bFlagRead_estado_comanda_) && $bFlagRead_estado_comanda_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['estado_comanda_' . $this->nmgp_refresh_row]['type']    = 'label';
...
$_SESSION['scriptcase']['form_detallepedido_14082020']['contr_erro'] = 'off'; 
      ...
      if (empty($this->hora_inicio_))
      {
          $this->hora_inicio__hora = $this->hora_inicio_;
      }
      if (empty($this->hora_final_))
      {
          $this->hora_final__hora = $this->hora_final_;
      }
      $this->nm_guardar_campos();
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->iddet_)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_idpedid_ = $this->idpedid_;
}
...
{
	$this->fGestionaStock($this->iddet_ ,1,"pedido");

	if(!empty($this->iddet_ ))
	{
		$this->update_master();
	}
}
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_idpedid_ != $this->idpedid_ || (isset($bFlagRead_idpedid_) && $bFlagRead_idpedid_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['idpedid_' . $this->nmgp_refresh_row]['type']    = 'text';
        $this->NM_ajax_info['fldList']['idpedid_' . $this->nmgp_refresh_row]['valList'] = array($this->idpedid_);
        $this->NM_ajax_changed['idpedid_'] = true;
    }
}
$_SESSION['scriptcase']['form_detallepedido_14082020']['contr_erro'] = 'off'; 
    }
      ...
      {
          $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert];
          if ($this->nmgp_dados_select['iddet_'] == $this->iddet_ &&
              ...
              $this->nmgp_dados_select['estado_comanda_'] == $this->estado_comanda_ &&
              $this->nmgp_dados_select['idpedid_'] == $this->idpedid_)
          { }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['iddet_'] = $this->iddet_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['idpro_'] = $this->idpro_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['obs_'] = $this->obs_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['colores_'] = $this->colores_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['tallas_'] = $this->tallas_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['sabor_'] = $this->sabor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['idbod_'] = $this->idbod_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['unidadmayor_'] = $this->unidadmayor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['cantidad_'] = $this->cantidad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['valorunit_'] = $this->valorunit_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['valorpar_'] = $this->valorpar_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['descuento_'] = $this->descuento_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['adicional_'] = $this->adicional_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['adicional1_'] = $this->adicional1_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['factor_'] = $this->factor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['iva_'] = $this->iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['costop_'] = $this->costop_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['estado_comanda_'] = $this->estado_comanda_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert]['idpedid_'] = $this->idpedid_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ('incluir' == $this->nmgp_opcao && $this->idpedid_ == ""){$this->idpedid_ = "null"; $NM_val_null[] = "idpedid_";}  
      if (('alterar' == $this->nmgp_opcao || 'igual' == $this->nmgp_opcao) && $this->idpedid_ == ""){$this->idpedid_ = "null"; $NM_val_null[] = "idpedid_";}  
      $NM_val_form['iddet_'] = $this->iddet_;
      $NM_val_form['idpro_'] = $this->idpro_;
      $NM_val_form['descrip_'] = $this->descrip_;
      ...
      $NM_val_form['autorizarborrado_'] = $this->autorizarborrado_;
      $NM_val_form['estado_comanda_'] = $this->estado_comanda_;
      $NM_val_form['idpedid_'] = $this->idpedid_;
      $NM_val_form['numfac_'] = $this->numfac_;
      $NM_val_form['remision_'] = $this->remision_;
      $NM_val_form['devuelto_'] = $this->devuelto_;
      $NM_val_form['usuario_comanda_'] = $this->usuario_comanda_;
      $NM_val_form['tercero_comanda_'] = $this->tercero_comanda_;
      $NM_val_form['hora_inicio_'] = $this->hora_inicio_;
      $NM_val_form['hora_final_'] = $this->hora_final_;
      $NM_val_form['observ_'] = $this->observ_;
      $NM_val_form['cerrado_'] = $this->cerrado_;
      $NM_val_form['descr_'] = $this->descr_;
      $NM_val_form['codbarra_'] = $this->codbarra_;
      if ($this->iddet_ === "" || is_null($this->iddet_))  
      { 
          $this->iddet_ = 0;
      } 
      ...
      if ($this->tercero_comanda_ === "" || is_null($this->tercero_comanda_))  
      { 
          $this->tercero_comanda_ = 0;
          $this->sc_force_zero[] = 'tercero_comanda_';
      } 
      $nm_bases_lob_geral = array_merge($this->Ini->nm_bases_oracle, $this->Ini->nm_bases_ibase, $this->Ini->nm_bases_informix, $this->Ini->nm_bases_mysql, $this->Ini->nm_bases_access, $this->Ini->nm_bases_sqlite, array('pdo_ibm'), array('pdo_sqlsrv'));
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          $this->estado_comanda__before_qstr = $this->estado_comanda_;
          $this->estado_comanda_ = substr($this->Db->qstr($this->estado_comanda_), 1, -1); 
          if ($this->estado_comanda_ == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->estado_comanda_ = "null"; 
              $NM_val_null[] = "estado_comanda_";
          } 
          $this->usuario_comanda__before_qstr = $this->usuario_comanda_;
          $this->usuario_comanda_ = substr($this->Db->qstr($this->usuario_comanda_), 1, -1); 
          if ($this->usuario_comanda_ == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->usuario_comanda_ = "null"; 
              $NM_val_null[] = "usuario_comanda_";
          } 
          if ($this->hora_inicio_ == "")  
          { 
              $this->hora_inicio_ = "null"; 
              $NM_val_null[] = "hora_inicio_";
          } 
          if ($this->hora_final_ == "")  
          { 
              $this->hora_final_ = "null"; 
              $NM_val_null[] = "hora_final_";
          } 
          $this->observ__before_qstr = $this->observ_;
          $this->observ_ = substr($this->Db->qstr($this->observ_), 1, -1); 
          if ($this->observ_ == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->observ_ = "null"; 
              $NM_val_null[] = "observ_";
          } 
          $this->cerrado__before_qstr = $this->cerrado_;
          $this->cerrado_ = substr($this->Db->qstr($this->cerrado_), 1, -1); 
          if ($this->cerrado_ == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->cerrado_ = "null"; 
              $NM_val_null[] = "cerrado_";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "idpedid = $this->idpedid_, idpro = $this->idpro_, unidadmayor = '$this->unidadmayor_', factor = $this->factor_, idbod = $this->idbod_, costop = $this->costop_, cantidad = $this->cantidad_, valorunit = $this->valorunit_, valorpar = $this->valorpar_, iva = $this->iva_, descuento = $this->descuento_, adicional = $this->adicional_, adicional1 = $this->adicional1_, colores = $this->colores_, tallas = $this->tallas_, sabor = $this->sabor_, estado_comanda = '$this->estado_comanda_', obs = '$this->obs_'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['usuario_comanda_']) && $NM_val_form['usuario_comanda_'] != $this->nmgp_dados_select['usuario_comanda_']) 
              { 
                  $SC_fields_update[] = "usuario_comanda = '$this->usuario_comanda_'"; 
              } 
              if (isset($NM_val_form['tercero_comanda_']) && $NM_val_form['tercero_comanda_'] != $this->nmgp_dados_select['tercero_comanda_']) 
              { 
                  $SC_fields_update[] = "tercero_comanda = $this->tercero_comanda_"; 
              } 
              if (isset($NM_val_form['hora_inicio_']) && $NM_val_form['hora_inicio_'] != $this->nmgp_dados_select['hora_inicio_']) 
              { 
                   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
                  { 
                      $SC_fields_update[] = "hora_inicio = TO_DATE('$this->hora_inicio_', 'yyyy-mm-dd hh24:mi:ss')"; 
                  } 
                  else
                  { 
                      $SC_fields_update[] = "hora_inicio = '$this->hora_inicio_'"; 
                  } 
              } 
              if (isset($NM_val_form['hora_final_']) && $NM_val_form['hora_final_'] != $this->nmgp_dados_select['hora_final_']) 
              { 
                   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
                  { 
                      $SC_fields_update[] = "hora_final = TO_DATE('$this->hora_final_', 'yyyy-mm-dd hh24:mi:ss')"; 
                  } 
                  else
                  { 
                      $SC_fields_update[] = "hora_final = '$this->hora_final_'"; 
                  } 
              } 
              if (isset($NM_val_form['observ_']) && $NM_val_form['observ_'] != $this->nmgp_dados_select['observ_']) 
              { 
                  $SC_fields_update[] = "observ = '$this->observ_'"; 
              } 
              if (isset($NM_val_form['cerrado_']) && $NM_val_form['cerrado_'] != $this->nmgp_dados_select['cerrado_']) 
              { 
                  $SC_fields_update[] = "cerrado = '$this->cerrado_'"; 
              } 
              ...
              $this->estado_comanda_ = $this->estado_comanda__before_qstr;
              $this->usuario_comanda_ = $this->usuario_comanda__before_qstr;
              $this->observ_ = $this->observ__before_qstr;
              $this->cerrado_ = $this->cerrado__before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['idpedid_'])) { $this->idpedid_ = $NM_val_form['idpedid_']; }
              elseif (isset($this->idpedid_)) { $this->nm_limpa_alfa($this->idpedid_); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['estado_comanda_'])) { $this->estado_comanda_ = $NM_val_form['estado_comanda_']; }
              elseif (isset($this->estado_comanda_)) { $this->nm_limpa_alfa($this->estado_comanda_); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('iddet_', 'idpro_', 'descrip_', 'obs_', 'colores_', 'tallas_', 'sabor_', 'idbod_', 'unidadmayor_', 'stockubica_', 'unidad_', 'cantidad_', 'valorunit_', 'valorpar_', 'descuento_', 'adicional_', 'adicional1_', 'factor_', 'iva_', 'costop_', 'autorizarborrado_', 'estado_comanda_', 'idpedid_'), $aDoNotUpdate);
              ...
              if (isset($this->Embutida_ronly) && $this->Embutida_ronly)
              {
                  ...
                  $this->NM_ajax_info['readOnly']['descrip_' . $this->nmgp_refresh_row] = 'on';
                  ...
                  $this->NM_ajax_info['readOnly']['autorizarborrado_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['estado_comanda_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['idpedid_' . $this->nmgp_refresh_row] = 'on';
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (idpedid, numfac, remision, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto, colores, tallas, sabor, estado_comanda, usuario_comanda, tercero_comanda, hora_inicio, hora_final, observ, cerrado, obs, descr) VALUES ($this->idpedid_, $this->numfac_, $this->remision_, $this->idpro_, '$this->unidadmayor_', $this->factor_, $this->idbod_, $this->costop_, $this->cantidad_, $this->valorunit_, $this->valorpar_, $this->iva_, $this->descuento_, $this->adicional_, $this->adicional1_, $this->devuelto_, $this->colores_, $this->tallas_, $this->sabor_, '$this->estado_comanda_', '$this->usuario_comanda_', $this->tercero_comanda_, '$this->hora_inicio_', '$this->hora_final_', '$this->observ_', '$this->cerrado_', '$this->obs_', '$this->descr_')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "idpedid, numfac, remision, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto, colores, tallas, sabor, estado_comanda, usuario_comanda, tercero_comanda, hora_inicio, hora_final, observ, cerrado, obs, descr) VALUES (" . $NM_seq_auto . "$this->idpedid_, $this->numfac_, $this->remision_, $this->idpro_, '$this->unidadmayor_', $this->factor_, $this->idbod_, $this->costop_, $this->cantidad_, $this->valorunit_, $this->valorpar_, $this->iva_, $this->descuento_, $this->adicional_, $this->adicional1_, $this->devuelto_, $this->colores_, $this->tallas_, $this->sabor_, '$this->estado_comanda_', '$this->usuario_comanda_', $this->tercero_comanda_, '$this->hora_inicio_', '$this->hora_final_', '$this->observ_', '$this->cerrado_', '$this->obs_', '$this->descr_')"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "idpedid, numfac, remision, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto, colores, tallas, sabor, estado_comanda, usuario_comanda, tercero_comanda, hora_inicio, hora_final, observ, cerrado, obs, descr) VALUES (" . $NM_seq_auto . "$this->idpedid_, $this->numfac_, $this->remision_, $this->idpro_, '$this->unidadmayor_', $this->factor_, $this->idbod_, $this->costop_, $this->cantidad_, $this->valorunit_, $this->valorpar_, $this->iva_, $this->descuento_, $this->adicional_, $this->adicional1_, $this->devuelto_, $this->colores_, $this->tallas_, $this->sabor_, '$this->estado_comanda_', '$this->usuario_comanda_', $this->tercero_comanda_, TO_DATE('$this->hora_inicio_', 'yyyy-mm-dd hh24:mi:ss'), TO_DATE('$this->hora_final_', 'yyyy-mm-dd hh24:mi:ss'), '$this->observ_', '$this->cerrado_', '$this->obs_', '$this->descr_')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "idpedid, numfac, remision, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto, colores, tallas, sabor, estado_comanda, usuario_comanda, tercero_comanda, hora_inicio, hora_final, observ, cerrado, obs, descr) VALUES (" . $NM_seq_auto . "$this->idpedid_, $this->numfac_, $this->remision_, $this->idpro_, '$this->unidadmayor_', $this->factor_, $this->idbod_, $this->costop_, $this->cantidad_, $this->valorunit_, $this->valorpar_, $this->iva_, $this->descuento_, $this->adicional_, $this->adicional1_, $this->devuelto_, $this->colores_, $this->tallas_, $this->sabor_, '$this->estado_comanda_', '$this->usuario_comanda_', $this->tercero_comanda_, '$this->hora_inicio_', '$this->hora_final_', '$this->observ_', '$this->cerrado_', '$this->obs_', '$this->descr_')"; 
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $sTmpImgHtml = "<a href=\"javascript:nm_gp_submit('" . $this->Ini->link_form_detallepedido_obs_edit . "', '$this->nm_location', 'iddet*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_form'][$sc_seq_vert]['iddet_'] . "*scoutpar_numero*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_form'][$sc_seq_vert]['idpedid_'] . "*scoutid_detalle*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_form'][$sc_seq_vert]['iddet_'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout', '', '_self', '0', '0', 'form_detallepedido_obs')\"><font color=\"" . $this->Ini->cor_link_dados . "\">" . $descrip_ . "</font></a>";
                  $this->NM_ajax_info['fldList']['descrip_' . $this->nmgp_refresh_row]['type']    = 'imagehtml';
                  $this->NM_ajax_info['fldList']['descrip_' . $this->nmgp_refresh_row]['imgHtml'] = $sTmpImgHtml;
                  $this->NM_ajax_info['fldList']['descrip_' . $this->nmgp_refresh_row]['valList'] = array();
                  $this->NM_ajax_info['fldList']['descrip_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_descrip_));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['descrip_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['descrip_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == form_detallepedido_14082020_pack_protect_string(NM_charset_to_utf8($this->colores_)))
              {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detallepedido_14082020_pack_protect_string(NM_charset_to_utf8($this->tallas_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detallepedido_14082020_pack_protect_string(NM_charset_to_utf8($this->sabor_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detallepedido_14082020_pack_protect_string(NM_charset_to_utf8($this->idbod_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_unidadmayor_'][] = 'SI';
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detallepedido_14082020_pack_protect_string(NM_charset_to_utf8($this->unidadmayor_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['Lookup_autorizarborrado_'][] = 's';
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detallepedido_14082020_pack_protect_string(NM_charset_to_utf8($this->autorizarborrado_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
          $tmpLabel_autorizarborrado_ = $sLabelTemp;
                  $this->NM_ajax_info['fldList']['autorizarborrado_' . $this->nmgp_refresh_row]['type']    = 'radio';
                  $this->NM_ajax_info['fldList']['autorizarborrado_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->autorizarborrado_)));
                  $this->NM_ajax_info['fldList']['autorizarborrado_' . $this->nmgp_refresh_row]['labList'] = array($tmpLabel_autorizarborrado_);

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['autorizarborrado_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['autorizarborrado_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $tmpLabel_estado_comanda_ = $this->estado_comanda_;
                  $this->NM_ajax_info['fldList']['estado_comanda_' . $this->nmgp_refresh_row]['type']    = 'label';
                  $this->NM_ajax_info['fldList']['estado_comanda_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->estado_comanda_)));
                  $this->NM_ajax_info['fldList']['estado_comanda_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_estado_comanda_)));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['estado_comanda_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['estado_comanda_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->NM_ajax_info['fldList']['idpedid_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['idpedid_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->idpedid_)));
                  $this->NM_ajax_info['fldList']['idpedid_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_idpedid_)));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['idpedid_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['idpedid_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] = 0; 
              }
...
if (!isset($this->sc_temp_gModificarInventario)) {$this->sc_temp_gModificarInventario = (isset($_SESSION['gModificarInventario'])) ? $_SESSION['gModificarInventario'] : "";}
      ...
      $nm_select = "select idgrup from productos where idprod=$this->idpro_ "; 
...
if($this->sc_temp_gModificarInventario=="SI" and $vGrupo==0)
	{
      ...
      $nm_select = "select prefijo_ped from pedidos where idpedido=$this->idpedid_ "; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->d_ped = array();
     if ($this->idpedid_ != "")
...
;
		if(isset($this->pre[0][0]))
			...
			if($existe !== false)
				{
				$this->fGestionaStock($this->iddet_ ,2,"pedido");
				}
			}
		}
	}
...
if (!isset($this->sc_temp_gModificarInventario)) {$this->sc_temp_gModificarInventario = (isset($_SESSION['gModificarInventario'])) ? $_SESSION['gModificarInventario'] : "";}
  if($this->sc_temp_gModificarInventario=="SI")
{
	$this->fGestionaStock($this->iddet_ ,3,"pedido");
}
...
$_SESSION['scriptcase']['form_detallepedido_14082020']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['parms'] = "iddet_?#?$this->iddet_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_detallepedido_14082020']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_detallepedido_14082020 = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter'] . ")";
          }
      }
      $sc_where = trim("idpedid=" . $_SESSION['par_numero'] . "");
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['total']))
          {
              ...
              $qt_geral_reg_form_detallepedido_14082020 = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['total'] = $qt_geral_reg_form_detallepedido_14082020;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['total']) || $this->sc_teve_excl || $this->sc_teve_incl)
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->iddet_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_detallepedido_14082020 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_detallepedido_14082020) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] += $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] > $qt_geral_reg_form_detallepedido_14082020)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] = $qt_geral_reg_form_detallepedido_14082020 - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] = ($qt_geral_reg_form_detallepedido_14082020 + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['ordem_ord']; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nmgp_select = "SELECT iddet, idpedid, numfac, remision, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto, colores, tallas, sabor, estado_comanda, usuario_comanda, tercero_comanda, hora_inicio, hora_final, observ, cerrado, obs, descr from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nmgp_select = "SELECT iddet, idpedid, numfac, remision, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto, colores, tallas, sabor, estado_comanda, usuario_comanda, tercero_comanda, hora_inicio, hora_final, observ, cerrado, obs, descr from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      ...
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
      { 
          $nmgp_select = "SELECT iddet, idpedid, numfac, remision, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto, colores, tallas, sabor, estado_comanda, usuario_comanda, tercero_comanda, TO_DATE(TO_CHAR(hora_inicio, 'yyyy-mm-dd hh24:mi:ss'), 'yyyy-mm-dd hh24:mi:ss'), TO_DATE(TO_CHAR(hora_final, 'yyyy-mm-dd hh24:mi:ss'), 'yyyy-mm-dd hh24:mi:ss'), observ, cerrado, obs, descr from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
      { 
          $nmgp_select = "SELECT iddet, idpedid, numfac, remision, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto, colores, tallas, sabor, estado_comanda, usuario_comanda, tercero_comanda, hora_inicio, hora_final, observ, cerrado, obs, descr from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      ...
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['run_iframe'] == "R")
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              $rs = $this->Db->Execute($nmgp_select) ; 
          } 
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          {
              $sc_seq_vert = 0; 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['empty_filter'] = true;
              }
          }
          else
          {
          ...
          { 
              ...
              $this->idpedid_ = $rs->fields[1] ; 
              $this->nmgp_dados_select['idpedid_'] = $this->idpedid_;
              $this->numfac_ = $rs->fields[2] ; 
              $this->nmgp_dados_select['numfac_'] = $this->numfac_;
              $this->remision_ = $rs->fields[3] ; 
              $this->nmgp_dados_select['remision_'] = $this->remision_;
              $this->idpro_ = $rs->fields[4] ; 
              $this->nmgp_dados_select['idpro_'] = $this->idpro_;
              $this->unidadmayor_ = $rs->fields[5] ; 
              $this->nmgp_dados_select['unidadmayor_'] = $this->unidadmayor_;
              $this->factor_ = trim($rs->fields[6]) ; 
              $this->nmgp_dados_select['factor_'] = $this->factor_;
              $this->idbod_ = $rs->fields[7] ; 
              $this->nmgp_dados_select['idbod_'] = $this->idbod_;
              $this->costop_ = trim($rs->fields[8]) ; 
              $this->nmgp_dados_select['costop_'] = $this->costop_;
              $this->cantidad_ = trim($rs->fields[9]) ; 
              $this->nmgp_dados_select['cantidad_'] = $this->cantidad_;
              $this->valorunit_ = trim($rs->fields[10]) ; 
              $this->nmgp_dados_select['valorunit_'] = $this->valorunit_;
              $this->valorpar_ = trim($rs->fields[11]) ; 
              $this->nmgp_dados_select['valorpar_'] = $this->valorpar_;
              $this->iva_ = trim($rs->fields[12]) ; 
              $this->nmgp_dados_select['iva_'] = $this->iva_;
              $this->descuento_ = trim($rs->fields[13]) ; 
              $this->nmgp_dados_select['descuento_'] = $this->descuento_;
              $this->adicional_ = $rs->fields[14] ; 
              $this->nmgp_dados_select['adicional_'] = $this->adicional_;
              $this->adicional1_ = $rs->fields[15] ; 
              $this->nmgp_dados_select['adicional1_'] = $this->adicional1_;
              $this->devuelto_ = $rs->fields[16] ; 
              $this->nmgp_dados_select['devuelto_'] = $this->devuelto_;
              $this->colores_ = $rs->fields[17] ; 
              $this->nmgp_dados_select['colores_'] = $this->colores_;
              $this->tallas_ = $rs->fields[18] ; 
              $this->nmgp_dados_select['tallas_'] = $this->tallas_;
              $this->sabor_ = $rs->fields[19] ; 
              $this->nmgp_dados_select['sabor_'] = $this->sabor_;
              $this->estado_comanda_ = $rs->fields[20] ; 
              $this->nmgp_dados_select['estado_comanda_'] = $this->estado_comanda_;
              $this->usuario_comanda_ = $rs->fields[21] ; 
              $this->nmgp_dados_select['usuario_comanda_'] = $this->usuario_comanda_;
              $this->tercero_comanda_ = $rs->fields[22] ; 
              $this->nmgp_dados_select['tercero_comanda_'] = $this->tercero_comanda_;
              $this->hora_inicio_ = $rs->fields[23] ; 
              if (substr($this->hora_inicio_, 10, 1) == "-") 
              { 
                 $this->hora_inicio_ = substr($this->hora_inicio_, 0, 10) . " " . substr($this->hora_inicio_, 11);
              } 
              if (substr($this->hora_inicio_, 13, 1) == ".") 
              { 
                 $this->hora_inicio_ = substr($this->hora_inicio_, 0, 13) . ":" . substr($this->hora_inicio_, 14, 2) . ":" . substr($this->hora_inicio_, 17);
              } 
              $this->nmgp_dados_select['hora_inicio_'] = $this->hora_inicio_;
              $this->hora_final_ = $rs->fields[24] ; 
              if (substr($this->hora_final_, 10, 1) == "-") 
              { 
                 $this->hora_final_ = substr($this->hora_final_, 0, 10) . " " . substr($this->hora_final_, 11);
              } 
              if (substr($this->hora_final_, 13, 1) == ".") 
              { 
                 $this->hora_final_ = substr($this->hora_final_, 0, 13) . ":" . substr($this->hora_final_, 14, 2) . ":" . substr($this->hora_final_, 17);
              } 
              $this->nmgp_dados_select['hora_final_'] = $this->hora_final_;
              $this->observ_ = $rs->fields[25] ; 
              $this->nmgp_dados_select['observ_'] = $this->observ_;
              $this->cerrado_ = $rs->fields[26] ; 
              $this->nmgp_dados_select['cerrado_'] = $this->cerrado_;
              $this->obs_ = $rs->fields[27] ; 
              $this->nmgp_dados_select['obs_'] = $this->obs_;
              $this->descr_ = $rs->fields[28] ; 
              $this->nmgp_dados_select['descr_'] = $this->descr_;
              $this->codbarra_ = isset($GLOBALS['codbarra_' . $sc_seq_vert]) ? $GLOBALS['codbarra_' . $sc_seq_vert] : '';
              ...
              $this->descrip_ = isset($GLOBALS['descrip_' . $sc_seq_vert]) ? $GLOBALS['descrip_' . $sc_seq_vert] : '';
              $this->autorizarborrado_ = isset($GLOBALS['autorizarborrado_' . $sc_seq_vert]) ? $GLOBALS['autorizarborrado_' . $sc_seq_vert] : '';
              $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->nm_troca_decimal(",", ".");
              $this->iddet_ = (string)$this->iddet_; 
              $this->idpedid_ = (string)$this->idpedid_; 
              ...
              $this->tercero_comanda_ = (string)$this->tercero_comanda_; 
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['parms'] = "iddet_?#?$this->iddet_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['iddet_'] =  $this->iddet_; 
             $this->form_vert_form_detallepedido_14082020[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
          ...
          ksort ($this->form_vert_form_detallepedido_14082020); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          {
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['total'] + 1; 
          }
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] < (($qt_geral_reg_form_detallepedido_14082020 + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['embutida_multi']) 
          { 
          } 
          ...
          { 
              ...
              $this->tallas_ = "";  
              $this->sabor_ = "";  
              $this->estado_comanda_ = "";  
              $this->obs_ = "";  
              $this->stockubica_ = "0";  
              $this->unidad_ = "";  
              $this->descrip_ = "";  
              $this->autorizarborrado_ = "";  
              $this->nm_proc_onload_record($sc_seq_vert);
              if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['foreign_key']))
              {
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['foreign_key'] as $sFKName => $sFKValue)
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['reg_start'] + $this->sc_max_reg;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
function autorizarborrado__onClick()
{
$_SESSION['scriptcase']['form_detallepedido_14082020']['contr_erro'] = 'on';
if (!isset($this->sc_temp_gIdDeta)) {$this->sc_temp_gIdDeta = (isset($_SESSION['gIdDeta'])) ? $_SESSION['gIdDeta'] : "";}
if (!isset($this->sc_temp_gProducto)) {$this->sc_temp_gProducto = (isset($_SESSION['gProducto'])) ? $_SESSION['gProducto'] : "";}
...
$original_iddet_ = $this->iddet_;
      ...
      $nm_select = "select estado_comanda,(select p.nompro from productos p where p.idprod=$this->idpro_ ) from detallepedido where iddet='".$this->iddet_ ."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vdet = array();
     if ($this->idpro_ != "" && $this->iddet_ != "")
     { 
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
...
{
	$this->estado_comanda_  =$this->vdet[0][0];
...
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('autoriza_borrado') . "/", $this->nm_location, "_self?#?" . NM_encode_input("") . "?@?", "_self", "ret_self", 440, 630);
		...
		{
			if($this->estado_comanda_ ==1)
			{
			
				 
      $nm_select = "select numpedido from pedidos where idpedido='".$this->idpedid_ ."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
;
     ...
     $nm_select ="delete from detallepedido where iddet=$this->iddet_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('form_detallepedido') . "/", $this->nm_location, "idpedid?#?" . NM_encode_input($this->idpedid_ ) . "?@?", "_self", "ret_self", 440, 630);
 };
				}
			}	
			else
...
$modificado_estado_comanda_ = $this->estado_comanda_;
$modificado_idpedid_ = $this->idpedid_;
$modificado_iddet_ = $this->iddet_;
$this->nm_formatar_campos('idpro_', 'iddet_', 'estado_comanda_', 'idpedid_');
...
if ($original_estado_comanda_ !== $modificado_estado_comanda_ || isset($this->nmgp_cmp_readonly['estado_comanda_']) || (isset($bFlagRead_estado_comanda_) && $bFlagRead_estado_comanda_))
{
    $this->nmgp_refresh_fields[] = 'estado_comanda_';
    $this->NM_ajax_changed['estado_comanda_'] = true;
    $this->NM_ajax_force_values = true;
}
if ($original_idpedid_ !== $modificado_idpedid_ || isset($this->nmgp_cmp_readonly['idpedid_']) || (isset($bFlagRead_idpedid_) && $bFlagRead_idpedid_))
{
    $this->nmgp_refresh_fields[] = 'idpedid_';
    $this->NM_ajax_changed['idpedid_'] = true;
    $this->NM_ajax_force_values = true;
}
if ($original_iddet_ !== $modificado_iddet_ || isset($this->nmgp_cmp_readonly['iddet_']) || (isset($bFlagRead_iddet_) && $bFlagRead_iddet_))
...
$this->nm_formatar_campos('idpro_', 'valorunit_', 'cantidad_', 'stockubica_', 'adicional1_', 'descuento_', 'valorpar_', 'adicional_', 'iva_', 'idbod_', 'unidadmayor_', 'factor_', 'unidad_');
$this->nmgp_refresh_fields = array();
if ($original_idpro_ !== $modificado_idpro_ || isset($this->nmgp_cmp_readonly['idpro_']) || (isset($bFlagRead_idpro_) && $bFlagRead_idpro_))
{
    $this->nmgp_refresh_fields[] = 'idpro_';
...
$modificado_cantidad_ = $this->cantidad_;
$modificado_stockubica_ = $this->stockubica_;
$this->nm_formatar_campos('cantidad_', 'stockubica_');
$this->nmgp_refresh_fields = array();
if ($original_cantidad_ !== $modificado_cantidad_ || isset($this->nmgp_cmp_readonly['cantidad_']) || (isset($bFlagRead_cantidad_) && $bFlagRead_cantidad_))
{
    $this->nmgp_refresh_fields[] = 'cantidad_';
...
$modificado_stockubica_ = $this->stockubica_;
$modificado_unidad_ = $this->unidad_;
$this->nm_formatar_campos('colores_', 'idpro_', 'idbod_', 'unidadmayor_', 'factor_', 'stockubica_', 'unidad_');
$this->nmgp_refresh_fields = array();
...
$modificado_stockubica_ = $this->stockubica_;
$modificado_unidad_ = $this->unidad_;
$this->nm_formatar_campos('idpro_', 'idbod_', 'unidadmayor_', 'factor_', 'stockubica_', 'unidad_');
$this->nmgp_refresh_fields = array();
if ($original_idpro_ !== $modificado_idpro_ || isset($this->nmgp_cmp_readonly['idpro_']) || (isset($bFlagRead_idpro_) && $bFlagRead_idpro_))
{
    $this->nmgp_refresh_fields[] = 'idpro_';
...
switch ($lis)
	{
	case 1:
	$sql="select unidmaymen, costomen, recmayamen, preciomen, preciofull,precio_editable,idgrup from productos where idprod=$this->idpro_ ";
...
;
	...
	case 2:
	$sql="select unidmaymen, costomen, recmayamen, preciomen2, precio2,precio_editable,idgrup from productos where idprod=$this->idpro_ ";
...
;
	...
	case 3:
	$sql="select unidmaymen, costomen, recmayamen, preciomen3, preciomay,precio_editable,idgrup from productos where idprod=$this->idpro_ ";
...
$this->nm_formatar_campos('cantidad_', 'idpro_', 'valorunit_', 'unidadmayor_', 'costop_', 'factor_', 'idbod_', 'adicional1_', 'descuento_', 'valorpar_', 'adicional_', 'iva_', 'colores_', 'tallas_', 'sabor_');
$this->nmgp_refresh_fields = array();
if ($original_cantidad_ !== $modificado_cantidad_ || isset($this->nmgp_cmp_readonly['cantidad_']) || (isset($bFlagRead_cantidad_) && $bFlagRead_cantidad_))
{
    $this->nmgp_refresh_fields[] = 'cantidad_';
...
$modificado_stockubica_ = $this->stockubica_;
$modificado_unidad_ = $this->unidad_;
$this->nm_formatar_campos('sabor_', 'idpro_', 'idbod_', 'unidadmayor_', 'factor_', 'stockubica_', 'unidad_');
$this->nmgp_refresh_fields = array();
if ($original_sabor_ !== $modificado_sabor_ || isset($this->nmgp_cmp_readonly['sabor_']) || (isset($bFlagRead_sabor_) && $bFlagRead_sabor_))
{
    $this->nmgp_refresh_fields[] = 'sabor_';
...
$modificado_stockubica_ = $this->stockubica_;
$modificado_unidad_ = $this->unidad_;
$this->nm_formatar_campos('tallas_', 'idpro_', 'idbod_', 'unidadmayor_', 'factor_', 'stockubica_', 'unidad_');
$this->nmgp_refresh_fields = array();
if ($original_tallas_ !== $modificado_tallas_ || isset($this->nmgp_cmp_readonly['tallas_']) || (isset($bFlagRead_tallas_) && $bFlagRead_tallas_))
{
    $this->nmgp_refresh_fields[] = 'tallas_';
...
$modificado_stockubica_ = $this->stockubica_;
$modificado_unidad_ = $this->unidad_;
$this->nm_formatar_campos('unidadmayor_', 'idpro_', 'valorunit_', 'adicional1_', 'descuento_', 'valorpar_', 'adicional_', 'iva_', 'cantidad_', 'idbod_', 'factor_', 'stockubica_', 'unidad_');
$this->nmgp_refresh_fields = array();
if ($original_unidadmayor_ !== $modificado_unidadmayor_ || isset($this->nmgp_cmp_readonly['unidadmayor_']) || (isset($bFlagRead_unidadmayor_) && $bFlagRead_unidadmayor_))
{
    $this->nmgp_refresh_fields[] = 'unidadmayor_';
...
$sql="SELECT sum(valorpar), sum(iva), sum(descuento) FROM detallepedido WHERE idpedid=$this->idpedid_ ";
...
if(!empty($this->ds[0][0]))
{
     ...
     $nm_select ="UPDATE pedidos SET total=$total, saldo=$total, subtotal=$sub, valoriva=$iva, adicional=$desc WHERE idpedido=$this->idpedid_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
else
	{
     ...
     $nm_select ="UPDATE pedidos SET total=0, saldo=0, subtotal=0, valoriva=0, adicional=0 WHERE idpedido=$this->idpedid_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
if($this->valorunit_ <$this->costop_ )
	{
...
$modificado_stockubica_ = $this->stockubica_;
$modificado_unidad_ = $this->unidad_;
$this->nm_formatar_campos('valorunit_', 'costop_', 'idpro_', 'adicional1_', 'descuento_', 'valorpar_', 'adicional_', 'iva_', 'cantidad_', 'idbod_', 'unidadmayor_', 'factor_', 'stockubica_', 'unidad_');
$this->nmgp_refresh_fields = array();
if ($original_valorunit_ !== $modificado_valorunit_ || isset($this->nmgp_cmp_readonly['valorunit_']) || (isset($bFlagRead_valorunit_) && $bFlagRead_valorunit_))
{
    $this->nmgp_refresh_fields[] = 'valorunit_';
...
WHERE idpro = $this->idpro_  AND idbod=$this->idbod_  and colores=$this->sc_temp_color_pedido and tallas=$this->sc_temp_talla_pedido and sabor=$this->sc_temp_sabor_pedido";
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        $searchOk = false;
        if ('SC_all_Cmp' == $this->nmgp_fast_search && in_array($field, array("iddet_", "numfac_", "idpro_", "idbod_", "cantidad_", "valorunit_", "valorpar_", "iva_", "descuento_", "adicional_", "adicional1_", "adicional2"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_autorizarborrado_()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "?#?s?#?N?@?";
       $todo = explode("?@?", $nmgp_def_dados);
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter_form'] . " and (idpedid=" . $_SESSION['par_numero'] . ") and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where idpedid=" . $_SESSION['par_numero'] . " and (" . $comando . ")";
      }
      $nmgp_select = "SELECT count(*) AS countTest from " . $this->Ini->nm_tabela . $sc_where; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      $rt = $this->Db->Execute($nmgp_select) ; 
      ...
      $qt_geral_reg_form_detallepedido_14082020 = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['total'] = $qt_geral_reg_form_detallepedido_14082020;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_detallepedido_14082020_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_detallepedido_14082020_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_detallepedido_14082020_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['retorno_edit'] = "";
   }
   ...
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function sc_set_focus($sFieldName)
    {
        ...
        $aFocus = array(
                        ...
                        'iva' => 'iva_',
                        'costop' => 'costop_',
                        'autorizarborrado_' => 'autorizarborrado_',
                        'estado_comanda' => 'estado_comanda_',
                        'idpedid' => 'idpedid_',
                       );
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_14082020']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
    ...
    function sc_field_readonly($sField, $sStatus, $iSeq = '')
    {
        ...
        $sFieldDateTime = '';
        if ('hora_inicio_' == $sField)
        {
            $sFieldDateTime = $sField . '_hora';
        }
        if ('hora_final_' == $sField)
        {
            $sFieldDateTime = $sField . '_hora';
        }
