<?php
   ...
   $_SESSION['scriptcase']['consulta']['glo_nm_path_conf']       = "";
   ...
   $_SESSION['scriptcase']['consulta']['glo_nm_path_doc']        = "";
    ...
    {
            /*check tmp*/$_SESSION['scriptcase']['consulta']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
...
// 
      ...
      $this->path_conf       = $_SESSION['scriptcase']['consulta']['glo_nm_path_conf'];
      ...
      if (!isset($_SESSION['scriptcase']['consulta']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['consulta']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['consulta']['save_session']['data'] = '';
      } 
      ...
      $_SESSION['sc_session'][$this->sc_page]['consulta']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      {
          include_once("consulta_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['consulta']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['consulta']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['consulta']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['consulta']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['consulta']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['consulta']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['consulta']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['consulta']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['consulta']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['consulta']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "consulta_erro.class.php"); 
...
// 
      ...
      $_SESSION['sc_session'][$this->sc_page]['consulta']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['consulta']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
/*NM*/            $_SESSION['scriptcase']['consulta']['glo_nm_perfil'] = $NM_con_dest;
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['consulta']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['consulta']['embutida_init']) 
      {
          if (!isset($_SESSION['gModificarInventario'])) 
          {
              $this->nm_falta_var .= "gModificarInventario; ";
          }
          if (!isset($_SESSION['gbanco_movil'])) 
          {
              $this->nm_falta_var .= "gbanco_movil; ";
          }
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['consulta']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['consulta']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['consulta']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['consulta']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['consulta']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['consulta']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['consulta']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['consulta']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "consulta_erro.class.php"); 
      $this->Erro      = new consulta_erro();
...
if (!isset($_SESSION['gbanco_movil'])) {$_SESSION['gbanco_movil'] = "";}
if (!isset($this->sc_temp_gbanco_movil)) {$this->sc_temp_gbanco_movil = (isset($_SESSION['gbanco_movil'])) ? $_SESSION['gbanco_movil'] : "";}
...
if (!isset($_SESSION['gidvendedor'])) {$_SESSION['gidvendedor'] = "";}
if (!isset($this->sc_temp_gidvendedor)) {$this->sc_temp_gidvendedor = (isset($_SESSION['gidvendedor'])) ? $_SESSION['gidvendedor'] : "";}
  if(!empty($_POST))
{
	if (strpos(strtolower($this->Ini->nm_tpbanco), "access") === false && !$this->Ini->sc_tem_trans_banco)
{
	...
	$cantidad   = 0;
      ...
      $this->vModificaInventario = array();
      $this->vmodificainventario = array();
      ...
      { 
          ...
          { 
                 ...
                 { 
                        $this->vModificaInventario[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vmodificainventario[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vModificaInventario = false;
          $this->vModificaInventario_erro = $this->Db->ErrorMsg();
          $this->vmodificainventario = false;
          $this->vmodificainventario_erro = $this->Db->ErrorMsg();
      } 
;
	if(isset($this->vmodificainventario[0][0]))
	{
		$this->sc_temp_gModificarInventario = $this->vmodificainventario[0][0];
	}
	
	if(isset($_POST["accion"]) and $this->sc_temp_gModificarInventario=="SI")
	{
		$vaccion = $_POST["accion"];
		$viddet  = $_POST["iddet"];
		
		 
      $nm_select = "select idpedid,idpro,cantidad from detallepedido where iddet='".$viddet."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
;
		...
		{			
			...
			$vidpedid = $this->vdatospedido[0][0];
			$vidpro   = $this->vdatospedido[0][1];
			$vcantidad= $this->vdatospedido[0][2];
			$retorno  = $viddet;
			
			if($vaccion=="borrar")
			{
				$this->fGestionaStock($viddet,1);
			}

			if($vaccion=="mas")
			{
				$this->fGestionaStock($viddet,4);
			}

			if($vaccion=="menos")
			{
				$this->fGestionaStock($viddet,3);
			}
		}
	}
	
	if(isset($_POST["sqlretorno"]))
	{
		$sqlretorno = $_POST["sqlretorno"];
	}
	...
	if(!empty($sqlretorno))
	{
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vretorno[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->vretorno = false;
          $this->vretorno_erro = $this->Db->ErrorMsg();
      } 
;	

		if(isset($this->vretorno[0][0]))
		{

			$retorno = $this->vretorno[0][0];
				
			if(isset($_POST["pedidorestarexistencia"]))
			{
				if($this->sc_temp_gModificarInventario=="SI")
				{
					$this->fGestionaStock($retorno,2);
				}
			}
		}
	}
	...
	if(isset($_POST["caja"]))
	{
      ...
      { 
          $nm_select = "select total,prefijo_ped,numpedido,str_replace (convert(char(10),fechaven,102), '.', '-') + ' ' + convert(char(8),fechaven,20) from pedidos where idpedido='".$vidped."'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_select = "select total,prefijo_ped,numpedido,convert(char(23),fechaven,121) from pedidos where idpedido='".$vidped."'"; 
      }
      else
      { 
          $nm_select = "select total,prefijo_ped,numpedido,fechaven from pedidos where idpedido='".$vidped."'"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vDatosPedido = array();
...
;
			...
			if(isset($this->vdatospedido[0][0]))
			{
				...
				$vfechaven    = $this->vdatospedido[0][3];
				...
				$vsql3 = "insert into caja 
							  ...
							  idpedido='".$vidped."',
							  hora='".date("H:i:s")."',
							  banco='".$this->sc_temp_gbanco_movil."'
							  ";
     ...
     $nm_select = "insert into log set usuario='".$this->sc_temp_gidvendedor."',accion='COBRAR', observaciones='EL USUARIO COBRÓ: $".$vtotalpedido." DEL PEDIDO N:".number_format($vnumpedido)."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	echo json_encode(array("retorno" => $retorno,"cantidad"=>$cantidad));
...
if (isset($this->sc_temp_gidvendedor)) {$_SESSION['gidvendedor'] = $this->sc_temp_gidvendedor;}
if (isset($this->sc_temp_gModificarInventario)) {$_SESSION['gModificarInventario'] = $this->sc_temp_gModificarInventario;}
if (isset($this->sc_temp_gbanco_movil)) {$_SESSION['gbanco_movil'] = $this->sc_temp_gbanco_movil;}
...
function fGestionaStock($iddet, $tipo)
{
$_SESSION['scriptcase']['consulta']['contr_erro'] = 'on';
...
{	
	$vsqldetalle = "select 
					...
					d.idbod,
					d.idpedid,
					(select p.fechaven from pedidos p where p.idpedido=d.idpedid) as fechaven
					from 
					detallepedido d
					where 
					d.iddet='".$iddet."'
...
;
	...
	if(isset($vdatosdetalle[0][0]))
	{
		...
		$vidpedid  = $vdatosdetalle[0][5];
		$vtipo     = $tipo;
		$vdetalle  = "Venta Restaurante";
		$vidmov    = 1;
		$vfecha    = $vdatosdetalle[0][6];
	}
	...
	switch($tipo)
	{
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $siEsCombo[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $siescombo[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $siEsCombo = false;
          $siEsCombo_erro = $this->Db->ErrorMsg();
          $siescombo = false;
          $siescombo_erro = $this->Db->ErrorMsg();
      } 
;

			if(isset($siescombo[0][0]))
			{
				if($siescombo[0][0]=="SI")
				{
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $listaCombo[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $listacombo[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $listaCombo = false;
          $listaCombo_erro = $this->Db->ErrorMsg();
          $listacombo = false;
          $listacombo_erro = $this->Db->ErrorMsg();
      } 
;

					if(isset($listacombo[0][0]))
					{
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $vCantidadPro[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $vcantidadpro[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $vCantidadPro = false;
          $vCantidadPro_erro = $this->Db->ErrorMsg();
          $vcantidadpro = false;
          $vcantidadpro_erro = $this->Db->ErrorMsg();
      } 
;

							if(isset($vcantidadpro[0][0]))
							{
								$vsqlstock2="UPDATE 
										   productos 
										   SET 
										   stockmen = (stockmen+".$vcantidadpro[0][0].")
										   WHERE 
										   idprod='".$listacombo[$i][1]."'
										   ";
     ...
     $nm_select = "delete  										from  										inventario  										where  											idpro='".$listacombo[$i][1] ."'  										and idped='".$vidpedid."'  										and iddetalle='".$iddet."'  										and idcombo='".$vidpro."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
					...
					if(isset($listacombo[0][0]))
					{
						for($i=0;$i<count($listacombo );$i++)
						{
							...
							$vsqlinv2 = "INSERT 
								  ...
								  SET 
								  fecha		   ='".$vfecha."', 
								  cantidad	   =(".$listacombo[$i][2]."*-1), 
								  idpro		   ='".$listacombo[$i][1]."', 
								  costo		   ='".$siescombo[0][1]."',
								  valorparcial ='".($listacombo[$i][3])."', 
								  idbod        ='".$vidbod."', 
								  tipo		   ='".$vtipo."', 
								  detalle	   ='".$vdetalle."', 
								  idmov		   ='".$vidmov."',
     ...
     $nm_select = $vsqlinv2; 
      ...
      ;
							...
							$vsqlstock2="UPDATE 
								   productos 
								   SET 
								   stockmen = stockmen-".$listacombo[$i][2]."
								   WHERE 
								   idprod='".$listacombo[$i][1]."'
								   ";
		...
		case 3:
			...
			if($vcantidad > 1)
			{
				$vsqlinv = "UPDATE
						  ...
						  SET 
						  cantidad = (cantidad+1),
						  valorparcial = ((cantidad*(select d.valorunit from detallepedido d where d.iddet='".$iddet."'))*-1)
						  where 
							  iddetalle='".$iddet."'
						  and idped='".$vidpedid."' 
						  and idpro='".$vidpro."'
						...
						if(isset($listacombo[0][0]))
						{
							...
							for($i=0;$i<count($listacombo );$i++)
							{
								$vsqlinv2 = "UPDATE
										  inventario 
										  SET 
										  cantidad = (cantidad+".$listacombo[$i][2]."),
									      valorparcial = (valorparcial-".$listacombo[$i][3].")
										  where 
											  iddetalle='".$iddet."'
										  and idped='".$vidpedid."'
										  and idpro='".$listacombo[$i][1]."'
										  and idcombo='".$vidpro."'
										  ";
     ...
     $nm_select = $vsqlinv2; 
      ...
      ;
								...
								$vsqlstock2="UPDATE 
										   productos 
										   SET 
										   stockmen = stockmen = (stockmen+".$listacombo[$i][2].")
										   WHERE 
										   idprod='".$listacombo[$i][1]."'
										   ";
     ...
     $nm_select = $vsqlinv2; 
      ...
      ;
							...
							$vsqlstock2="UPDATE 
									   productos p
									   SET 
									   p.stockmen = (p.stockmen-".$listacombo[$i][2].")
									   WHERE 
									   p.idprod='".$listacombo[$i][1]."'
									   ";
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['consulta']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['consulta']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
               $_SESSION['scriptcase']['consulta']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
           }
       }
   }
   ...
   if (isset($_POST["gModificarInventario"])) 
   {
       ...
       nm_limpa_str_consulta($_SESSION["gModificarInventario"]);
   }
   ...
   if (isset($_POST["gbanco_movil"])) 
   {
       $_SESSION["gbanco_movil"] = $_POST["gbanco_movil"];
       nm_limpa_str_consulta($_SESSION["gbanco_movil"]);
   }
   if (isset($_GET["gbanco_movil"])) 
   {
       $_SESSION["gbanco_movil"] = $_GET["gbanco_movil"];
       nm_limpa_str_consulta($_SESSION["gbanco_movil"]);
   }
   if (!isset($_SESSION["gbanco_movil"])) 
   {
       $_SESSION["gbanco_movil"] = "";
   }
   if (!empty($glo_perfil))  
   { 
   ...
   else
   {
       ...
       if ('consulta' == $sReferer || 'consulta_' == substr($sReferer, 0, 9))
       {
           $_SESSION['sc_session'][$script_case_init]['consulta']['initialize'] = false;
       }
       else
   ...
   { 
       ...
       if (isset($gbanco_movil)) 
       {
           $_SESSION['gbanco_movil'] = $gbanco_movil;
           nm_limpa_str_consulta($_SESSION["gbanco_movil"]);
       }
   } 
   $GLOBALS["NM_ERRO_IBASE"] = 0;  
   $contr_consulta = new consulta_apl();
   $contr_consulta->controle();
//
