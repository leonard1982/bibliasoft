...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_new_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="fac_compras_new_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_Eliminar_ok()
{
    ...
    document.F1.action = "fac_compras_new_mob.php";
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_new_mob']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_new_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_new_mob']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_new_mob']['where_detal']))
  {
?>  
...
{
    document.getElementById('fac_compras_new_mob_form0').style.width='1px';
    document.getElementById('fac_compras_new_mob_form0').style.height='0px';
    document.getElementById('fac_compras_new_mob_form0').style.display='none';
    document.getElementById('fac_compras_new_mob_form0').style.overflow='scroll';
    document.getElementById('fac_compras_new_mob_form1').style.width='1px';
    document.getElementById('fac_compras_new_mob_form1').style.height='0px';
    document.getElementById('fac_compras_new_mob_form1').style.display='none';
    document.getElementById('fac_compras_new_mob_form1').style.overflow='scroll';
    document.getElementById('fac_compras_new_mob_form2').style.width='1px';
    document.getElementById('fac_compras_new_mob_form2').style.height='0px';
    document.getElementById('fac_compras_new_mob_form2').style.display='none';
    document.getElementById('fac_compras_new_mob_form2').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_new_mob']['pdf_view']) {
?>
...
?>
   ...
   if ("fac_compras_new_mob_form1" == N_pagina) {
     scAjaxDetailHeight("detallecompra_new", "600");
    }
   if ("fac_compras_new_mob_form2" == N_pagina) {
