...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'creado':
      case 'editado':
        sc_exib_ocult_pag('fac_compras_new_mob_form0');
        break;
      case 'detalle':
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_creado_hora' + iSeqRow).bind('blur', function() { sc_fac_compras_new_creado_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_fac_compras_new_creado_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_editado_hora' + iSeqRow).bind('blur', function() { sc_fac_compras_new_editado_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_fac_compras_new_editado_onfocus(this, iSeqRow) });
...
function sc_fac_compras_new_idfaccom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_idfaccom();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_numfacom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_numfacom();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_formapago_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_formapago();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_fechacom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_fechacom();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_fechavenc_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_fechavenc();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_idprov_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_idprov();
  scCssBlur(oThis);
}

function sc_fac_compras_new_idprov_onchange(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_event_idprov_onchange();
}
...
function sc_fac_compras_new_subtotal_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_subtotal();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_valoriva_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_valoriva();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_total_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_total();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_pagada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_pagada();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_asentada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_asentada();
  scCssBlur(oThis);
}

function sc_fac_compras_new_asentada_onchange(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_event_asentada_onchange();
}
...
function sc_fac_compras_new_control_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_control();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_observaciones();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_saldo_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_saldo();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_anulada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_anulada();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_es_remision_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_es_remision();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_id_pedidocom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_id_pedidocom();
  scCssBlur(oThis);
}

function sc_fac_compras_new_id_pedidocom_onchange(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_event_id_pedidocom_onchange();
}
...
function sc_fac_compras_new_retencion_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_retencion();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_reteica_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_reteica();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_reteiva_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_reteiva();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_usuario_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_usuario();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_banco_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_banco();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_creado_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_creado();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_editado_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_editado();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_cod_cuenta_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_cod_cuenta();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_prefijo_com_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_prefijo_com();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_numero_com_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_numero_com();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_tipo_com_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_tipo_com();
  scCssBlur(oThis);
}

function sc_fac_compras_new_tipo_com_onchange(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_event_tipo_com_onchange();
}
...
function sc_fac_compras_new_detalle_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_detalle();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_prefijo_delpedido_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_mob_validate_prefijo_delpedido();
  scCssBlur(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_fac_compras_new_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechacom" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_new_mob_validate_fechacom(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_new_mob_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_new_mob_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_editado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_new_mob_validate_editado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecha_validacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_new_mob_validate_fecha_validacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'fac_compras_new_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
