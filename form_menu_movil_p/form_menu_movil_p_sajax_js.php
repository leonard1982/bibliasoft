  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_menu_movil_p" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_menu_movil_p_form();
	}
  ...
  // ---------- Validate titulo
  function do_ajax_form_menu_movil_p_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_menu_movil_p_validate_titulo_cb);
  } // do_ajax_form_menu_movil_p_validate_titulo

  function do_ajax_form_menu_movil_p_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_validate_titulo_cb

  // ---------- Validate aplicacion
  function do_ajax_form_menu_movil_p_validate_aplicacion()
  {
    var nomeCampo_aplicacion = "aplicacion";
    var var_aplicacion = scAjaxGetFieldText(nomeCampo_aplicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_validate_aplicacion(var_aplicacion, var_script_case_init, do_ajax_form_menu_movil_p_validate_aplicacion_cb);
  } // do_ajax_form_menu_movil_p_validate_aplicacion

  function do_ajax_form_menu_movil_p_validate_aplicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_validate_aplicacion_cb

  // ---------- Validate pie
  function do_ajax_form_menu_movil_p_validate_pie()
  {
    var nomeCampo_pie = "pie";
    var var_pie = scAjaxGetFieldText(nomeCampo_pie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_validate_pie(var_pie, var_script_case_init, do_ajax_form_menu_movil_p_validate_pie_cb);
  } // do_ajax_form_menu_movil_p_validate_pie

  function do_ajax_form_menu_movil_p_validate_pie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pie";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_validate_pie_cb

  // ---------- Validate logo
  function do_ajax_form_menu_movil_p_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_validate_logo(var_logo, var_script_case_init, do_ajax_form_menu_movil_p_validate_logo_cb);
  } // do_ajax_form_menu_movil_p_validate_logo

  function do_ajax_form_menu_movil_p_validate_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "logo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_validate_logo_cb

  // ---------- Validate tema_titulo
  function do_ajax_form_menu_movil_p_validate_tema_titulo()
  {
    var nomeCampo_tema_titulo = "tema_titulo";
    var var_tema_titulo = scAjaxGetFieldSelect(nomeCampo_tema_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_validate_tema_titulo(var_tema_titulo, var_script_case_init, do_ajax_form_menu_movil_p_validate_tema_titulo_cb);
  } // do_ajax_form_menu_movil_p_validate_tema_titulo

  function do_ajax_form_menu_movil_p_validate_tema_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_validate_tema_titulo_cb

  // ---------- Validate tema_pie
  function do_ajax_form_menu_movil_p_validate_tema_pie()
  {
    var nomeCampo_tema_pie = "tema_pie";
    var var_tema_pie = scAjaxGetFieldSelect(nomeCampo_tema_pie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_validate_tema_pie(var_tema_pie, var_script_case_init, do_ajax_form_menu_movil_p_validate_tema_pie_cb);
  } // do_ajax_form_menu_movil_p_validate_tema_pie

  function do_ajax_form_menu_movil_p_validate_tema_pie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_validate_tema_pie_cb

  // ---------- Validate idpagina
  function do_ajax_form_menu_movil_p_validate_idpagina()
  {
    var nomeCampo_idpagina = "idpagina";
    var var_idpagina = scAjaxGetFieldHidden(nomeCampo_idpagina);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_validate_idpagina(var_idpagina, var_script_case_init, do_ajax_form_menu_movil_p_validate_idpagina_cb);
  } // do_ajax_form_menu_movil_p_validate_idpagina

  function do_ajax_form_menu_movil_p_validate_idpagina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_validate_idpagina_cb

  // ---------- Validate id
  function do_ajax_form_menu_movil_p_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_validate_id(var_id, var_script_case_init, do_ajax_form_menu_movil_p_validate_id_cb);
  } // do_ajax_form_menu_movil_p_validate_id

  function do_ajax_form_menu_movil_p_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_validate_id_cb

  // ---------- Validate ancho_imagen
  function do_ajax_form_menu_movil_p_validate_ancho_imagen()
  {
    var nomeCampo_ancho_imagen = "ancho_imagen";
    var var_ancho_imagen = scAjaxGetFieldText(nomeCampo_ancho_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_validate_ancho_imagen(var_ancho_imagen, var_script_case_init, do_ajax_form_menu_movil_p_validate_ancho_imagen_cb);
  } // do_ajax_form_menu_movil_p_validate_ancho_imagen

  function do_ajax_form_menu_movil_p_validate_ancho_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_validate_ancho_imagen_cb

  // ---------- Validate alto_imagen
  function do_ajax_form_menu_movil_p_validate_alto_imagen()
  {
    var nomeCampo_alto_imagen = "alto_imagen";
    var var_alto_imagen = scAjaxGetFieldText(nomeCampo_alto_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_validate_alto_imagen(var_alto_imagen, var_script_case_init, do_ajax_form_menu_movil_p_validate_alto_imagen_cb);
  } // do_ajax_form_menu_movil_p_validate_alto_imagen

  function do_ajax_form_menu_movil_p_validate_alto_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_validate_alto_imagen_cb

  // ---------- Validate tipo1
  function do_ajax_form_menu_movil_p_validate_tipo1()
  {
    var nomeCampo_tipo1 = "tipo1";
    var var_tipo1 = scAjaxGetFieldSelect(nomeCampo_tipo1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_validate_tipo1(var_tipo1, var_script_case_init, do_ajax_form_menu_movil_p_validate_tipo1_cb);
  } // do_ajax_form_menu_movil_p_validate_tipo1

  function do_ajax_form_menu_movil_p_validate_tipo1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_validate_tipo1_cb

  // ---------- Validate detalle
  function do_ajax_form_menu_movil_p_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_menu_movil_p_validate_detalle_cb);
  } // do_ajax_form_menu_movil_p_validate_detalle

  function do_ajax_form_menu_movil_p_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_validate_detalle_cb

  // ---------- Event onchange id
  function do_ajax_form_menu_movil_p_event_id_onchange()
  {
    var var_id = scAjaxGetFieldText("id");
    var var_idpagina = scAjaxGetFieldHidden("idpagina");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_menu_movil_p_event_id_onchange(var_id, var_idpagina, var_script_case_init, do_ajax_form_menu_movil_p_event_id_onchange_cb);
  } // do_ajax_form_menu_movil_p_event_id_onchange

  function do_ajax_form_menu_movil_p_event_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_menu_movil_p_event_id_onchange_cb_after_alert);
  } // do_ajax_form_menu_movil_p_event_id_onchange_cb
  function do_ajax_form_menu_movil_p_event_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_menu_movil_p_event_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_menu_movil_p_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_menu_movil_p_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_menu_movil_p_submit_form(var_titulo, var_aplicacion, var_pie, var_logo, var_tema_titulo, var_tema_pie, var_idpagina, var_id, var_ancho_imagen, var_alto_imagen, var_tipo1, var_logo_ul_name, var_logo_ul_type, var_logo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_menu_movil_p_submit_form_cb);
  } // do_ajax_form_menu_movil_p_submit_form

  function do_ajax_form_menu_movil_p_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_menu_movil_p_submit_form_cb_after_alert);
  } // do_ajax_form_menu_movil_p_submit_form_cb
  function do_ajax_form_menu_movil_p_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_menu_movil_p_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_menu_movil"] = "off";

  function do_ajax_form_menu_movil_p_navigate_form()
  {
    perform_ajax_form_menu_movil_p_navigate_form();
  }

  function perform_ajax_form_menu_movil_p_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_menu_movil"] = "on";
    x_ajax_form_menu_movil_p_navigate_form(var_idpagina, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_menu_movil_p_navigate_form_cb);
  } // do_ajax_form_menu_movil_p_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_menu_movil_p']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_menu_movil_p_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_menu_movil"] && "nmsc_iframe_liga_form_menu_movil" != scMasterDetailIframe["nmsc_iframe_liga_form_menu_movil"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_menu_movil"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_menu_movil').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_menu_movil').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_menu_movil').style.display = "none";
    }
    document.F1.logo_ul_name.value = '';
    document.F1.logo_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_menu_movil_p_navigate_form_cb_after_alert);
  } // do_ajax_form_menu_movil_p_navigate_form_cb
  function do_ajax_form_menu_movil_p_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_menu_movil_p_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_menu_movil_p_navigate_form_cb_after_alert
  function sc_hide_form_menu_movil_p_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_menu_movil"])
    {
      return true;
    }
    return false;
