  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_menu_movil_p_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_menu_movil_p_mob_form();
	}
  ...
  // ---------- Validate titulo
  function do_ajax_form_menu_movil_p_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_menu_movil_p_mob_validate_titulo_cb);
  } // do_ajax_form_menu_movil_p_mob_validate_titulo

  function do_ajax_form_menu_movil_p_mob_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_mob_validate_titulo_cb

  // ---------- Validate aplicacion
  function do_ajax_form_menu_movil_p_mob_validate_aplicacion()
  {
    var nomeCampo_aplicacion = "aplicacion";
    var var_aplicacion = scAjaxGetFieldText(nomeCampo_aplicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_mob_validate_aplicacion(var_aplicacion, var_script_case_init, do_ajax_form_menu_movil_p_mob_validate_aplicacion_cb);
  } // do_ajax_form_menu_movil_p_mob_validate_aplicacion

  function do_ajax_form_menu_movil_p_mob_validate_aplicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aplicacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_mob_validate_aplicacion_cb

  // ---------- Validate pie
  function do_ajax_form_menu_movil_p_mob_validate_pie()
  {
    var nomeCampo_pie = "pie";
    var var_pie = scAjaxGetFieldText(nomeCampo_pie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_mob_validate_pie(var_pie, var_script_case_init, do_ajax_form_menu_movil_p_mob_validate_pie_cb);
  } // do_ajax_form_menu_movil_p_mob_validate_pie

  function do_ajax_form_menu_movil_p_mob_validate_pie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pie";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_mob_validate_pie_cb

  // ---------- Validate logo
  function do_ajax_form_menu_movil_p_mob_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_mob_validate_logo(var_logo, var_script_case_init, do_ajax_form_menu_movil_p_mob_validate_logo_cb);
  } // do_ajax_form_menu_movil_p_mob_validate_logo

  function do_ajax_form_menu_movil_p_mob_validate_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "logo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_mob_validate_logo_cb

  // ---------- Validate tema_titulo
  function do_ajax_form_menu_movil_p_mob_validate_tema_titulo()
  {
    var nomeCampo_tema_titulo = "tema_titulo";
    var var_tema_titulo = scAjaxGetFieldSelect(nomeCampo_tema_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_mob_validate_tema_titulo(var_tema_titulo, var_script_case_init, do_ajax_form_menu_movil_p_mob_validate_tema_titulo_cb);
  } // do_ajax_form_menu_movil_p_mob_validate_tema_titulo

  function do_ajax_form_menu_movil_p_mob_validate_tema_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tema_titulo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_mob_validate_tema_titulo_cb

  // ---------- Validate tema_pie
  function do_ajax_form_menu_movil_p_mob_validate_tema_pie()
  {
    var nomeCampo_tema_pie = "tema_pie";
    var var_tema_pie = scAjaxGetFieldSelect(nomeCampo_tema_pie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_mob_validate_tema_pie(var_tema_pie, var_script_case_init, do_ajax_form_menu_movil_p_mob_validate_tema_pie_cb);
  } // do_ajax_form_menu_movil_p_mob_validate_tema_pie

  function do_ajax_form_menu_movil_p_mob_validate_tema_pie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tema_pie";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_mob_validate_tema_pie_cb

  // ---------- Validate idpagina
  function do_ajax_form_menu_movil_p_mob_validate_idpagina()
  {
    var nomeCampo_idpagina = "idpagina";
    var var_idpagina = scAjaxGetFieldHidden(nomeCampo_idpagina);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_mob_validate_idpagina(var_idpagina, var_script_case_init, do_ajax_form_menu_movil_p_mob_validate_idpagina_cb);
  } // do_ajax_form_menu_movil_p_mob_validate_idpagina

  function do_ajax_form_menu_movil_p_mob_validate_idpagina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpagina";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_mob_validate_idpagina_cb

  // ---------- Validate id
  function do_ajax_form_menu_movil_p_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_mob_validate_id(var_id, var_script_case_init, do_ajax_form_menu_movil_p_mob_validate_id_cb);
  } // do_ajax_form_menu_movil_p_mob_validate_id

  function do_ajax_form_menu_movil_p_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_mob_validate_id_cb

  // ---------- Validate ancho_imagen
  function do_ajax_form_menu_movil_p_mob_validate_ancho_imagen()
  {
    var nomeCampo_ancho_imagen = "ancho_imagen";
    var var_ancho_imagen = scAjaxGetFieldText(nomeCampo_ancho_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_mob_validate_ancho_imagen(var_ancho_imagen, var_script_case_init, do_ajax_form_menu_movil_p_mob_validate_ancho_imagen_cb);
  } // do_ajax_form_menu_movil_p_mob_validate_ancho_imagen

  function do_ajax_form_menu_movil_p_mob_validate_ancho_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ancho_imagen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_mob_validate_ancho_imagen_cb

  // ---------- Validate alto_imagen
  function do_ajax_form_menu_movil_p_mob_validate_alto_imagen()
  {
    var nomeCampo_alto_imagen = "alto_imagen";
    var var_alto_imagen = scAjaxGetFieldText(nomeCampo_alto_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_mob_validate_alto_imagen(var_alto_imagen, var_script_case_init, do_ajax_form_menu_movil_p_mob_validate_alto_imagen_cb);
  } // do_ajax_form_menu_movil_p_mob_validate_alto_imagen

  function do_ajax_form_menu_movil_p_mob_validate_alto_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "alto_imagen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_mob_validate_alto_imagen_cb

  // ---------- Validate tipo1
  function do_ajax_form_menu_movil_p_mob_validate_tipo1()
  {
    var nomeCampo_tipo1 = "tipo1";
    var var_tipo1 = scAjaxGetFieldSelect(nomeCampo_tipo1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_mob_validate_tipo1(var_tipo1, var_script_case_init, do_ajax_form_menu_movil_p_mob_validate_tipo1_cb);
  } // do_ajax_form_menu_movil_p_mob_validate_tipo1

  function do_ajax_form_menu_movil_p_mob_validate_tipo1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_mob_validate_tipo1_cb

  // ---------- Validate detalle
  function do_ajax_form_menu_movil_p_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_movil_p_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_menu_movil_p_mob_validate_detalle_cb);
  } // do_ajax_form_menu_movil_p_mob_validate_detalle

  function do_ajax_form_menu_movil_p_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_movil_p_mob_validate_detalle_cb

  // ---------- Event onchange id
  function do_ajax_form_menu_movil_p_mob_event_id_onchange()
  {
    var var_id = scAjaxGetFieldText("id");
    var var_idpagina = scAjaxGetFieldHidden("idpagina");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_menu_movil_p_mob_event_id_onchange(var_id, var_idpagina, var_script_case_init, do_ajax_form_menu_movil_p_mob_event_id_onchange_cb);
  } // do_ajax_form_menu_movil_p_mob_event_id_onchange

  function do_ajax_form_menu_movil_p_mob_event_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_menu_movil_p_mob_event_id_onchange_cb_after_alert);
  } // do_ajax_form_menu_movil_p_mob_event_id_onchange_cb
  function do_ajax_form_menu_movil_p_mob_event_id_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_menu_movil_p_mob_event_id_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_menu_movil_p_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_menu_movil_p_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_titulo = scAjaxGetFieldText("titulo");
    var var_aplicacion = scAjaxGetFieldText("aplicacion");
    var var_pie = scAjaxGetFieldText("pie");
    var var_logo = scAjaxGetFieldText("logo");
    var var_tema_titulo = scAjaxGetFieldSelect("tema_titulo");
    var var_tema_pie = scAjaxGetFieldSelect("tema_pie");
    var var_idpagina = scAjaxGetFieldHidden("idpagina");
    var var_id = scAjaxGetFieldText("id");
    var var_ancho_imagen = scAjaxGetFieldText("ancho_imagen");
    var var_alto_imagen = scAjaxGetFieldText("alto_imagen");
    var var_tipo1 = scAjaxGetFieldSelect("tipo1");
    ...
    scAjaxProcOn();
    x_ajax_form_menu_movil_p_mob_submit_form(var_titulo, var_aplicacion, var_pie, var_logo, var_tema_titulo, var_tema_pie, var_idpagina, var_id, var_ancho_imagen, var_alto_imagen, var_tipo1, var_logo_ul_name, var_logo_ul_type, var_logo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_menu_movil_p_mob_submit_form_cb);
  } // do_ajax_form_menu_movil_p_mob_submit_form

  function do_ajax_form_menu_movil_p_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("aplicacion");
      scAjaxHideErrorDisplay("pie");
      scAjaxHideErrorDisplay("logo");
      scAjaxHideErrorDisplay("tema_titulo");
      scAjaxHideErrorDisplay("tema_pie");
      scAjaxHideErrorDisplay("idpagina");
      scAjaxHideErrorDisplay("id");
      scAjaxHideErrorDisplay("ancho_imagen");
      scAjaxHideErrorDisplay("alto_imagen");
      scAjaxHideErrorDisplay("tipo1");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_menu_movil_p_mob_submit_form_cb_after_alert);
  } // do_ajax_form_menu_movil_p_mob_submit_form_cb
  function do_ajax_form_menu_movil_p_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_menu_movil_p_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_menu_movil_mob"] = "off";

  function do_ajax_form_menu_movil_p_mob_navigate_form()
  {
    perform_ajax_form_menu_movil_p_mob_navigate_form();
  }

  function perform_ajax_form_menu_movil_p_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tipo1");
    scAjaxHideErrorDisplay("detalle");
    var var_idpagina = document.F2.idpagina.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_menu_movil_mob"] = "on";
    x_ajax_form_menu_movil_p_mob_navigate_form(var_idpagina, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_menu_movil_p_mob_navigate_form_cb);
  } // do_ajax_form_menu_movil_p_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_menu_movil_p_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_menu_movil_p_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idpagina.value = scAjaxGetKeyValue("idpagina");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_menu_movil_mob"] && "nmsc_iframe_liga_form_menu_movil_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_menu_movil_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_menu_movil_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_menu_movil_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_menu_movil_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_menu_movil_mob').style.display = "none";
    }
    document.F1.logo_ul_name.value = '';
    document.F1.logo_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_menu_movil_p_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_menu_movil_p_mob_navigate_form_cb
  function do_ajax_form_menu_movil_p_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_menu_movil_p_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_menu_movil_p_mob_navigate_form_cb_after_alert
  function sc_hide_form_menu_movil_p_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_menu_movil_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "aplicacion";
  ajax_field_list[2] = "pie";
  ajax_field_list[3] = "logo";
  ajax_field_list[4] = "tema_titulo";
  ajax_field_list[5] = "tema_pie";
  ajax_field_list[6] = "idpagina";
  ajax_field_list[7] = "id";
  ajax_field_list[8] = "ancho_imagen";
  ajax_field_list[9] = "alto_imagen";
  ajax_field_list[10] = "tipo1";
  ...
  var ajax_error_list = {
    ...
    "aplicacion": {"label": "Aplicacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pie": {"label": "Texto del pie de página", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "logo": {"label": "Logo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tema_titulo": {"label": "Tema Titulo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tema_pie": {"label": "Tema Pie", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idpagina": {"label": "Idpagina", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id": {"label": "Id objeto html", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ancho_imagen": {"label": "Ancho Imagen", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "alto_imagen": {"label": "Alto Imagen", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo1": {"label": "Tipo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "titulo": new Array(),
    "aplicacion": new Array(),
    "pie": new Array(),
    "logo": new Array(),
    "tema_titulo": new Array(),
    "tema_pie": new Array(),
    "idpagina": new Array(),
    "id": new Array(),
    "ancho_imagen": new Array(),
    "alto_imagen": new Array(),
    "tipo1": new Array(),
    "detalle": new Array()
  };
  ajax_field_mult["titulo"][1] = "titulo";
  ajax_field_mult["aplicacion"][1] = "aplicacion";
  ajax_field_mult["pie"][1] = "pie";
  ajax_field_mult["logo"][1] = "logo";
  ajax_field_mult["tema_titulo"][1] = "tema_titulo";
  ajax_field_mult["tema_pie"][1] = "tema_pie";
  ajax_field_mult["idpagina"][1] = "idpagina";
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["ancho_imagen"][1] = "ancho_imagen";
  ajax_field_mult["alto_imagen"][1] = "alto_imagen";
  ajax_field_mult["tipo1"][1] = "tipo1";
  ajax_field_mult["detalle"][1] = "detalle";

  var ajax_field_id = {
    "titulo": new Array("hidden_field_label_titulo", "hidden_field_data_titulo"),
    "aplicacion": new Array("hidden_field_label_aplicacion", "hidden_field_data_aplicacion"),
    "pie": new Array("hidden_field_label_pie", "hidden_field_data_pie"),
    "logo": new Array("hidden_field_label_logo", "hidden_field_data_logo"),
    "tema_titulo": new Array("hidden_field_label_tema_titulo", "hidden_field_data_tema_titulo"),
    "tema_pie": new Array("hidden_field_label_tema_pie", "hidden_field_data_tema_pie"),
    "id": new Array("hidden_field_label_id", "hidden_field_data_id"),
    "ancho_imagen": new Array("hidden_field_label_ancho_imagen", "hidden_field_data_ancho_imagen"),
    "alto_imagen": new Array("hidden_field_label_alto_imagen", "hidden_field_data_alto_imagen"),
    "tipo1": new Array("hidden_field_label_tipo1", "hidden_field_data_tipo1"),
