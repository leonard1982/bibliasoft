function grid_pedidos_111121_numero2_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_numero2" + seqRow).html();
}

function grid_pedidos_111121_numero2_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_numero2" + seqRow).html(newValue);
}

function grid_pedidos_111121_asentada_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_Hidden_asentada" + seqRow).html();
}

function grid_pedidos_111121_asentada_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_asentada" + seqRow).html(newValue);
}
function grid_pedidos_111121_asentada_Hidden_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_Hidden_asentada" + seqRow).html(newValue);
}

function grid_pedidos_111121_facturado_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_facturado" + seqRow).html();
}

function grid_pedidos_111121_facturado_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_facturado" + seqRow).html(newValue);
}

function grid_pedidos_111121_idcli_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_idcli" + seqRow).html();
}

function grid_pedidos_111121_idcli_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_idcli" + seqRow).html(newValue);
}

function grid_pedidos_111121_cambiar_cliente_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_cambiar_cliente" + seqRow).find("i").attr("src");
}

function grid_pedidos_111121_cambiar_cliente_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_cambiar_cliente" + seqRow).find("img").attr("src", newValue);
}

function grid_pedidos_111121_fechaven_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_fechaven" + seqRow).html();
}

function grid_pedidos_111121_fechaven_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_fechaven" + seqRow).html(newValue);
}

function grid_pedidos_111121_total_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_total" + seqRow).html();
}

function grid_pedidos_111121_total_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_total" + seqRow).html(newValue);
}

function grid_pedidos_111121_vendedor_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_vendedor" + seqRow).html();
}

function grid_pedidos_111121_vendedor_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_vendedor" + seqRow).html(newValue);
}

function grid_pedidos_111121_imprimir_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_imprimir" + seqRow).find("i").attr("src");
}

function grid_pedidos_111121_imprimir_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_imprimir" + seqRow).find("img").attr("src", newValue);
}

function grid_pedidos_111121_pos_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_pos" + seqRow).html();
}

function grid_pedidos_111121_pos_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_pos" + seqRow).html(newValue);
}

function grid_pedidos_111121_cobrar_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_cobrar" + seqRow).find("i").attr("src");
}

function grid_pedidos_111121_cobrar_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_cobrar" + seqRow).find("img").attr("src", newValue);
}

function grid_pedidos_111121_creado_en_movil_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_creado_en_movil" + seqRow).html();
}

function grid_pedidos_111121_creado_en_movil_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_creado_en_movil" + seqRow).html(newValue);
}

function grid_pedidos_111121_disponible_en_movil_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_disponible_en_movil" + seqRow).html();
}

function grid_pedidos_111121_disponible_en_movil_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_disponible_en_movil" + seqRow).html(newValue);
}

function grid_pedidos_111121_idpedido_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_Hidden_idpedido" + seqRow).html();
}

function grid_pedidos_111121_idpedido_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_idpedido" + seqRow).html(newValue);
}
function grid_pedidos_111121_idpedido_Hidden_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_Hidden_idpedido" + seqRow).html(newValue);
}

function grid_pedidos_111121_numfacven_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_numfacven" + seqRow).html();
}

function grid_pedidos_111121_numfacven_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_numfacven" + seqRow).html(newValue);
}

function grid_pedidos_111121_nremision_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_nremision" + seqRow).html();
}

function grid_pedidos_111121_nremision_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_nremision" + seqRow).html(newValue);
}

function grid_pedidos_111121_credito_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_credito" + seqRow).html();
}

function grid_pedidos_111121_credito_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_credito" + seqRow).html(newValue);
}

function grid_pedidos_111121_fechavenc_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_fechavenc" + seqRow).html();
}

function grid_pedidos_111121_fechavenc_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_fechavenc" + seqRow).html(newValue);
}

function grid_pedidos_111121_observaciones_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_observaciones" + seqRow).html();
}

function grid_pedidos_111121_observaciones_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_observaciones" + seqRow).html(newValue);
}

function grid_pedidos_111121_prefijo_ped_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_prefijo_ped" + seqRow).html();
}

function grid_pedidos_111121_prefijo_ped_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_prefijo_ped" + seqRow).html(newValue);
}

function grid_pedidos_111121_getValue(field, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  var SC_tmp = "";
  if ("numero2" == field) {
    SC_tmp = grid_pedidos_111121_numero2_getValue(seqRow);
  }
  if ("asentada" == field) {
    SC_tmp = grid_pedidos_111121_asentada_getValue(seqRow);
  }
  if ("facturado" == field) {
    SC_tmp = grid_pedidos_111121_facturado_getValue(seqRow);
  }
  if ("idcli" == field) {
    SC_tmp = grid_pedidos_111121_idcli_getValue(seqRow);
  }
  if ("cambiar_cliente" == field) {
    SC_tmp = grid_pedidos_111121_cambiar_cliente_getValue(seqRow);
  }
  if ("fechaven" == field) {
    SC_tmp = grid_pedidos_111121_fechaven_getValue(seqRow);
  }
  if ("total" == field) {
    SC_tmp = grid_pedidos_111121_total_getValue(seqRow);
  }
  if ("vendedor" == field) {
    SC_tmp = grid_pedidos_111121_vendedor_getValue(seqRow);
  }
  if ("imprimir" == field) {
    SC_tmp = grid_pedidos_111121_imprimir_getValue(seqRow);
  }
  if ("pos" == field) {
    SC_tmp = grid_pedidos_111121_pos_getValue(seqRow);
  }
  if ("cobrar" == field) {
    SC_tmp = grid_pedidos_111121_cobrar_getValue(seqRow);
  }
  if ("creado_en_movil" == field) {
    SC_tmp = grid_pedidos_111121_creado_en_movil_getValue(seqRow);
  }
  if ("disponible_en_movil" == field) {
    SC_tmp = grid_pedidos_111121_disponible_en_movil_getValue(seqRow);
  }
  if ("idpedido" == field) {
    SC_tmp = grid_pedidos_111121_idpedido_getValue(seqRow);
  }
  if ("numfacven" == field) {
    SC_tmp = grid_pedidos_111121_numfacven_getValue(seqRow);
  }
  if ("nremision" == field) {
    SC_tmp = grid_pedidos_111121_nremision_getValue(seqRow);
  }
  if ("credito" == field) {
    SC_tmp = grid_pedidos_111121_credito_getValue(seqRow);
  }
  if ("fechavenc" == field) {
    SC_tmp = grid_pedidos_111121_fechavenc_getValue(seqRow);
  }
  if ("observaciones" == field) {
    SC_tmp = grid_pedidos_111121_observaciones_getValue(seqRow);
  }
  if ("prefijo_ped" == field) {
    SC_tmp = grid_pedidos_111121_prefijo_ped_getValue(seqRow);
  }
...
function grid_pedidos_111121_setValue(field, newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  if ("numero2" == field) {
    grid_pedidos_111121_numero2_setValue(newValue, seqRow);
  }
  if ("asentada" == field) {
    grid_pedidos_111121_asentada_setValue(newValue, seqRow);
  }
  if ("facturado" == field) {
    grid_pedidos_111121_facturado_setValue(newValue, seqRow);
  }
  if ("idcli" == field) {
    grid_pedidos_111121_idcli_setValue(newValue, seqRow);
  }
  if ("cambiar_cliente" == field) {
    grid_pedidos_111121_cambiar_cliente_setValue(newValue, seqRow);
  }
  if ("fechaven" == field) {
    grid_pedidos_111121_fechaven_setValue(newValue, seqRow);
  }
  if ("total" == field) {
    grid_pedidos_111121_total_setValue(newValue, seqRow);
  }
  if ("vendedor" == field) {
    grid_pedidos_111121_vendedor_setValue(newValue, seqRow);
  }
  if ("imprimir" == field) {
    grid_pedidos_111121_imprimir_setValue(newValue, seqRow);
  }
  if ("pos" == field) {
    grid_pedidos_111121_pos_setValue(newValue, seqRow);
  }
  if ("cobrar" == field) {
    grid_pedidos_111121_cobrar_setValue(newValue, seqRow);
  }
  if ("creado_en_movil" == field) {
    grid_pedidos_111121_creado_en_movil_setValue(newValue, seqRow);
  }
  if ("disponible_en_movil" == field) {
    grid_pedidos_111121_disponible_en_movil_setValue(newValue, seqRow);
  }
  if ("idpedido" == field) {
    grid_pedidos_111121_idpedido_setValue(newValue, seqRow);
  }
  if ("numfacven" == field) {
    grid_pedidos_111121_numfacven_setValue(newValue, seqRow);
  }
  if ("nremision" == field) {
    grid_pedidos_111121_nremision_setValue(newValue, seqRow);
  }
  if ("credito" == field) {
    grid_pedidos_111121_credito_setValue(newValue, seqRow);
  }
  if ("fechavenc" == field) {
    grid_pedidos_111121_fechavenc_setValue(newValue, seqRow);
  }
  if ("observaciones" == field) {
    grid_pedidos_111121_observaciones_setValue(newValue, seqRow);
  }
  if ("prefijo_ped" == field) {
    grid_pedidos_111121_prefijo_ped_setValue(newValue, seqRow);
  }
  if ("asentada_Hidden" == field) {
    grid_pedidos_111121_asentada_Hidden_setValue(newValue, seqRow);
  }
  if ("idpedido_Hidden" == field) {
    grid_pedidos_111121_idpedido_Hidden_setValue(newValue, seqRow);
  }
}
...
function scJQAddEvents(seqRow) {
  ...
  $("#id_sc_field_idpedido" + seqRow).click(function () {
    $.ajax({
      type: "POST",
      url: "index.php",
      data: "nmgp_opcao=ajax_event&nmgp_event=idpedido_onClick&script_case_init=" + document.F3.script_case_init.value + "&idpedido=" + grid_pedidos_111121_getValue("idpedido", seqRow) + "&asentada=" + grid_pedidos_111121_getValue("asentada", seqRow) + ""
     })
     .done(function(jsonReturn) {
        ...
        if (oResp["setValue"]) {
          for (i = 0; i < oResp["setValue"].length; i++) {
            grid_pedidos_111121_setValue(oResp["setValue"][i]["field"], oResp["setValue"][i]["value"], seqRow);
          }
        }
...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_grid_pedidos_111121').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_grid_pedidos_111121').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_grid_pedidos_111121').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_grid_pedidos_111121').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_grid_pedidos_111121').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_pedidos_111121').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_pedidos_111121').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_pedidos_111121').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_grid_pedidos_111121').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_pedidos_111121').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_pedidos_111121').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_pedidos_111121').style.width  = '0px';
        if (oResp["setValue"]) {
          for (i = 0; i < oResp["setValue"].length; i++) {
