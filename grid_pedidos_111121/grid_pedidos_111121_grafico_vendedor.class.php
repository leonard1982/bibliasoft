...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_111121']['contr_label_graf']['vendedor']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_111121']['contr_label_graf']['vendedor']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_111121']['contr_label_graf']['vendedor'];
      }
   }
