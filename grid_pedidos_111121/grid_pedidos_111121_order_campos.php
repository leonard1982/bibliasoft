...
<?php
   ...
   $Ord_Cmp = new grid_pedidos_111121_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_pedidos_111121_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["numero2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["numero2"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["numero2"] : "Número";
   $tab_ger_campos['asentada'] = "on";
   $tab_def_campos['asentada'] = "asentada";
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["asentada"] : "Asentado";
...
ORDER BY fac.numfacven, fac.resolucion";
   ...
   $tab_labels["facturado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["facturado"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["facturado"] : "Facturado";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["idcli"] : "Cliente";
   ...
   $tab_labels["cambiar_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["cambiar_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["cambiar_cliente"] : "";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["fechaven"] : "Fecha";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["total"] : "Total";
   $tab_ger_campos['vendedor'] = "on";
   $tab_def_campos['vendedor'] = "vendedor";
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["vendedor"] : "Vendedor";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["imprimir"] : "Imprimir";
   ...
   $tab_labels["pos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["pos"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["pos"] : "POS";
   ...
   $tab_labels["cobrar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["cobrar"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["cobrar"] : "Cobrar";
   $tab_ger_campos['creado_en_movil'] = "on";
   $tab_def_campos['creado_en_movil'] = "creado_en_movil";
   $tab_labels["creado_en_movil"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["creado_en_movil"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["creado_en_movil"] : "Movil";
   $tab_ger_campos['disponible_en_movil'] = "on";
   $tab_def_campos['disponible_en_movil'] = "disponible_en_movil";
   $tab_labels["disponible_en_movil"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["disponible_en_movil"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['labels']["disponible_en_movil"] : "Disponible/Móvil";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_pedidos_111121_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_pedidos_111121']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
