<div id="form_webservicefe_150822_mob_form2" style='<?php echo ($this->tabCssClass["form_webservicefe_150822_mob_form2"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['Lookup_proveedor_anterior'][] = 'FACILWEB'; ?>
 <option  value="DATAICO" <?php  if ($this->proveedor_anterior == "DATAICO") { echo " selected" ;} ?>>DATAICO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['Lookup_proveedor_anterior'][] = 'DATAICO'; ?>
 <option  value="CADENA S. A." <?php  if ($this->proveedor_anterior == "CADENA S. A.") { echo " selected" ;} ?>>CADENA S. A.</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['Lookup_proveedor_anterior'][] = 'CADENA S. A.'; ?>
 <option  value="THE FACTORY HKA" <?php  if ($this->proveedor_anterior == "THE FACTORY HKA") { echo " selected" ;} ?>>THE FACTORY HKA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['Lookup_proveedor_anterior'][] = 'THE FACTORY HKA'; ?>
 </select></span>
</span><?php  }?>
