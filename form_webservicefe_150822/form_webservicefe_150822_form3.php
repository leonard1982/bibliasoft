<div id="form_webservicefe_150822_form3" style='<?php echo ($this->tabCssClass["form_webservicefe_150822_form3"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['Lookup_envio_credenciales'][] = 'SI'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['Lookup_plantillas_correo'][] = 'SI'; ?>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['Lookup_plantilla_pordefecto']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['Lookup_plantilla_pordefecto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['Lookup_plantilla_pordefecto']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['Lookup_plantilla_pordefecto'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['Lookup_plantilla_pordefecto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['Lookup_plantilla_pordefecto'][] = ''; 
...
<script> 
<?php
 $NM_pag_atual = "form_webservicefe_150822_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "form_webservicefe_150822_form" . $this->nmgp_ancora;
 }
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['masterValue']))
{
...
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['masterValue'] as $cmp_master => $val_master)
        {
?>
    dbParentFrame[0].contentWindow.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
        }
        unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['masterValue']);
?>
}
<?php
    }
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_webservicefe_150822");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_webservicefe_150822");
 parent.scAjaxDetailHeight("form_webservicefe_150822", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['sc_modal'])
{
?>
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
