<div id="form_webservicefe_150822_mob_form1" style='<?php echo ($this->tabCssClass["form_webservicefe_150822_mob_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['Lookup_enviar_dian'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['Lookup_enviar_cliente'][] = '1'; ?>
