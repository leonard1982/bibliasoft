...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_webservicefe_150822_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_webservicefe_150822_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
<body class="scFormPage sc-app-form" style="<?php echo $remove_margin . $str_iframe_body . $vertical_center; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_webservicefe_150822']['error_buffer']) && '' != $_SESSION['scriptcase']['form_webservicefe_150822']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_webservicefe_150822']['error_buffer'];
}
...
<?php
 include_once("form_webservicefe_150822_mob_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_webservicefe_150822_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_webservicefe_150822_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-6';
        $buttonMacroLabel = "";
        
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['empty_filter'] = true;
       }
  }
?>
<script type="text/javascript">
var pag_ativa = "form_webservicefe_150822_mob_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_webservicefe_150822_mob_form0' => array(
            'title' => "Producción",
            'class' => $nmgp_num_form == "form_webservicefe_150822_mob_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_webservicefe_150822_mob_form1' => array(
            'title' => "Pruebas",
            'class' => $nmgp_num_form == "form_webservicefe_150822_mob_form1" ? "scTabActive" : "scTabInactive",
        ),
        'form_webservicefe_150822_mob_form2' => array(
            'title' => "Proveedor Anterior",
            'class' => $nmgp_num_form == "form_webservicefe_150822_mob_form2" ? "scTabActive" : "scTabInactive",
        ),
        'form_webservicefe_150822_mob_form3' => array(
            'title' => "Adicionales",
            'class' => $nmgp_num_form == "form_webservicefe_150822_mob_form3" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('Producción' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_webservicefe_150822_mob_form0']['class'] = 'scTabInactive';
                        }
                        if ('Pruebas' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_webservicefe_150822_mob_form1']['class'] = 'scTabInactive';
                        }
                        if ('Proveedor Anterior' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_webservicefe_150822_mob_form2']['class'] = 'scTabInactive';
                        }
                        if ('Adicionales' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_webservicefe_150822_mob_form3']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_webservicefe_150822_mob_form0"]['class'];
?>
   <li id="id_form_webservicefe_150822_mob_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_webservicefe_150822_mob_form0')">
     Producción
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_webservicefe_150822_mob_form1"]['class'];
?>
   <li id="id_form_webservicefe_150822_mob_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_webservicefe_150822_mob_form1')">
     Pruebas
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_webservicefe_150822_mob_form2"]['class'];
?>
   <li id="id_form_webservicefe_150822_mob_form2" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_webservicefe_150822_mob_form2')">
     Proveedor Anterior
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_webservicefe_150822_mob_form3"]['class'];
?>
   <li id="id_form_webservicefe_150822_mob_form3" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_webservicefe_150822_mob_form3')">
     Adicionales
    </a>
   </li>
</ul>
...
<div id="form_webservicefe_150822_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['Lookup_proveedor'][] = ''; ?>
 <option value=""></option>
 <option  value="FACILWEB" <?php  if ($this->proveedor == "FACILWEB") { echo " selected" ;} ?>>FACILWEB</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['Lookup_proveedor'][] = 'FACILWEB'; ?>
 <option  value="DATAICO" <?php  if ($this->proveedor == "DATAICO") { echo " selected" ;} ?>>DATAICO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['Lookup_proveedor'][] = 'DATAICO'; ?>
 <option  value="CADENA S. A." <?php  if ($this->proveedor == "CADENA S. A.") { echo " selected" ;} ?>>CADENA S. A.</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['Lookup_proveedor'][] = 'CADENA S. A.'; ?>
 <option  value="THE FACTORY HKA" <?php  if ($this->proveedor == "THE FACTORY HKA") { echo " selected" ;} ?>>THE FACTORY HKA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['Lookup_proveedor'][] = 'THE FACTORY HKA'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['Lookup_modo'][] = 'PRUEBAS'; ?>
 <option  value="PRODUCCION" <?php  if ($this->modo == "PRODUCCION") { echo " selected" ;} ?>>PRODUCCIÓN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_150822_mob']['Lookup_modo'][] = 'PRODUCCION'; ?>
 </select></span>
</span><?php  }?>
