  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'url_api_sendmail':
        sc_exib_ocult_pag('form_webservicefe_150822_mob_form0');
        break;
      ...
      case 'enviar_dian':
      case 'enviar_cliente':
        sc_exib_ocult_pag('form_webservicefe_150822_mob_form1');
        break;
      ...
      case 'password_anterior':
        sc_exib_ocult_pag('form_webservicefe_150822_mob_form2');
        break;
      case 'envio_credenciales':
      case 'copia_factura_a':
      case 'plantillas_correo':
      case 'plantilla_pordefecto':
        sc_exib_ocult_pag('form_webservicefe_150822_mob_form3');
        break;
    }
  }
...
function scHidePage(pageNo) {
	$("#id_form_webservicefe_150822_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_webservicefe_150822_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
