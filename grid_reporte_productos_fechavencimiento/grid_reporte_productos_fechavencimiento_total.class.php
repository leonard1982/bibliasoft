...
class grid_reporte_productos_fechavencimiento_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_reporte_productos_fechavencimiento']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_reporte_productos_fechavencimiento']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $nm_comando = "select distinct g.nomgrupo as grupo, p.codigobar as codigo, p.nompro as descripcion, if(p.unidmaymen='SI',p.unimay,p.unimen) as unidad, p.stockmen as existencia, iv.fechavenc as vence, iv.lote as lote from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['where_pesq']; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['tot_geral'] = array() ;  
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['contr_total_geral'] = "OK";
   } 
   ...
   //-----  lote
   function quebra_lote_sc_free_group_by($lote, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb;
      $tot_lote = array() ;  
   ...
   function Calc_resumo_grupo($destino_resumo)
   {
      global $nm_lang;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['SC_Ind_Groupby'];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_grupo($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('existencia' => 'N');
      $nm_comando = "select distinct g.nomgrupo as grupo, p.codigobar as codigo, p.nompro as descripcion, if(p.unidmaymen='SI',p.unimay,p.unimen) as unidad, p.stockmen as existencia, iv.fechavenc as vence, iv.lote as lote from " . $this->Ini->nm_tabela . " " . $this->sc_where_atual; 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('grupo' => "grupo",'codigo' => "codigo",'descripcion' => "descripcion",'unidad' => "unidad",'existencia' => "existencia",'vence' => "vence",'lote' => "lote");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $format_dimensions['lote']['reg'] = "S";
      $format_dimensions['lote']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
