...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "Grupo";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['contr_label_graf']['grupo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['contr_label_graf']['grupo']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['contr_label_graf']['grupo'];
      }
   }
