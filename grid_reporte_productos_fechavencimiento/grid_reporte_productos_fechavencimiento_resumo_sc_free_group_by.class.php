...
class grid_reporte_productos_fechavencimiento_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['arr_total']['codigo'] = $this->array_total_codigo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['arr_total']['descripcion'] = $this->array_total_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['arr_total']['unidad'] = $this->array_total_unidad;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['arr_total']['existencia'] = $this->array_total_existencia;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['arr_total']['vence'] = $this->array_total_vence;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['arr_total']['lote'] = $this->array_total_lote;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['labels']['codigo'] = $Lab_codigo; 
       $prep_field['descripcion'] = $Lab_descripcion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['labels']['descripcion'] = $Lab_descripcion; 
       $prep_field['unidad'] = $Lab_unidad;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['labels']['unidad'] = $Lab_unidad; 
       $prep_field['existencia'] = $Lab_existencia;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['labels']['existencia'] = $Lab_existencia; 
       $prep_field['vence'] = $Lab_vence;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['labels']['vence'] = $Lab_vence; 
       $prep_field['lote'] = $Lab_lote;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['labels']['lote'] = $Lab_lote; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['lote']['fill'] = "true";
       $Arr_parms['lote']['order'] = "label";
       $Arr_parms['lote']['order_start'] = 'asc';
       $Arr_parms['lote']['order_invert'] = 'false';
       $Arr_parms['lote']['order_enabled'] = 'false';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['lote'] = array(0 => 'lote', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['pivot_order_level'] = 0;
       }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'field_x'  => 'lote',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_lote)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
{ 
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_reporte_productos_fechavencimiento/grid_reporte_productos_fechavencimiento_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_grupo, $quebra_codigo, $quebra_descripcion, $quebra_unidad, $quebra_existencia, $quebra_vence, $quebra_lote, $quebra_grupo_orig, $quebra_codigo_orig, $quebra_descripcion_orig, $quebra_unidad_orig, $quebra_existencia_orig, $quebra_vence_orig, $quebra_lote_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_fechavencimiento']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->grupo, $this->codigo, $this->descripcion, $this->unidad, $this->existencia, $this->vence, $this->lote, $this->grupo_orig,  $this->codigo_orig,  $this->descripcion_orig,  $this->unidad_orig,  $this->existencia_orig,  $this->vence_orig,  $this->lote_orig);
            }
   }
//
