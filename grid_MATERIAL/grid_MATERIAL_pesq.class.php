...
class grid_MATERIAL_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_MATERIAL_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_MATERIAL_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_MATERIAL_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codbarra')
      {
          $codbarra = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codbarra($codbarra);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_descrip')
      {
          $descrip = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_descrip($descrip);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_codbarra($codbarra)
   {
      $codbarra = substr($this->Db->qstr($codbarra), 1, -1);
            $codbarra_look = substr($this->Db->qstr($codbarra), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct CODBARRA from " . $this->Ini->nm_tabela . " where  CODBARRA like '%" . $codbarra . "%' order by CODBARRA"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
   ...
   function lookup_ajax_descrip($descrip)
   {
      $descrip = substr($this->Db->qstr($descrip), 1, -1);
            $descrip_look = substr($this->Db->qstr($descrip), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct DESCRIP from " . $this->Ini->nm_tabela . " where  DESCRIP like '%" . $descrip . "%' order by DESCRIP"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "matid";$Nm_numeric[] = "grupmatid";$Nm_numeric[] = "peso";$Nm_numeric[] = "gcmatid";$Nm_numeric[] = "tipoivaid";$Nm_numeric[] = "factor";$Nm_numeric[] = "factorglb";$Nm_numeric[] = "comision";$Nm_numeric[] = "lineamatid";$Nm_numeric[] = "horasserv";$Nm_numeric[] = "porutil";$Nm_numeric[] = "porcomision";$Nm_numeric[] = "deptoartid";$Nm_numeric[] = "mesgaran";$Nm_numeric[] = "marcaartid";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$campo_join]);
              return;
          }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> MATERIAL</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_MATERIAL/grid_MATERIAL_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_MATERIAL_ajax_search.js"></script>
 <script type="text/javascript" src="grid_MATERIAL_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_MATERIAL_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_MATERIAL']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_MATERIAL']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['ajax_nav'])
           { 
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_matid_cond#NMF#' + search_get_sel_txt('SC_matid_cond') + '@NMF@';
  str_out += 'SC_matid#NMF#' + search_get_text('SC_matid') + '@NMF@';
  ...
  str_out += 'SC_codbarra_cond#NMF#' + search_get_sel_txt('SC_codbarra_cond') + '@NMF@';
  str_out += 'SC_codbarra#NMF#' + search_get_text('SC_codbarra') + '@NMF@';
  str_out += 'id_ac_codbarra#NMF#' + search_get_text('id_ac_codbarra') + '@NMF@';
  str_out += 'SC_descrip_cond#NMF#' + search_get_sel_txt('SC_descrip_cond') + '@NMF@';
  str_out += 'SC_descrip#NMF#' + search_get_text('SC_descrip') + '@NMF@';
  str_out += 'id_ac_descrip#NMF#' + search_get_text('id_ac_descrip') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   scClass = $("#id_ac_codbarra").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_codbarra").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_codbarra",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_codbarra").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_descrip").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_descrip").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_descrip",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> MATERIAL</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $codbarra_cond, $codbarra, $codbarra_autocomp,
             $descrip_cond, $descrip, $descrip_autocomp,
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_MATERIAL", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $matid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['matid']; 
          $matid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['matid_cond']; 
          $codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['codigo']; 
          $codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['codigo_cond']; 
          $codbarra = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['codbarra']; 
          $codbarra_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['codbarra_cond']; 
          $descrip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['descrip']; 
          $descrip_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['descrip_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['NM_operador']; 
          if (strtoupper($matid_cond) != "II" && strtoupper($matid_cond) != "QP" && strtoupper($matid_cond) != "NP" && strtoupper($matid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($matid, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($matid_cond) || empty($matid_cond))
      {
         $matid_cond = "gt";
      }
      ...
      if (!isset($codbarra_cond) || empty($codbarra_cond))
      {
         $codbarra_cond = "qp";
      }
      if (!isset($descrip_cond) || empty($descrip_cond))
      {
         $descrip_cond = "qp";
      }
      ...
      $str_hide_matid = (in_array($matid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_codigo = (in_array($codigo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_codbarra = (in_array($codbarra_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_descrip = (in_array($descrip_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($matid) || $matid == "")
      {
          $matid = "";
      }
      if (isset($matid) && !empty($matid))
      {
         $tmp_pos = strpos($matid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $matid = substr($matid, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($codbarra) || $codbarra == "")
      {
          $codbarra = "";
      }
      if (isset($codbarra) && !empty($codbarra))
      {
         $tmp_pos = strpos($codbarra, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $codbarra = substr($codbarra, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($descrip, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $descrip = substr($descrip, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_matid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['matid'])) ? $this->New_label['matid'] : "MATID"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_matid_cond" name="matid_cond" onChange="nm_campos_between(document.getElementById('id_vis_matid'), this, 'matid')">
       <OPTION value="gt" <?php if ("gt" == $matid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $matid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $matid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_matid" <?php echo $str_hide_matid?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['matid'])) ? $this->New_label['matid'] : "MATID";
 $nmgp_tab_label .= "matid?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_matid" name="matid" value="<?php echo NM_encode_input($matid) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
<INPUT  type="text" id="SC_codigo" name="codigo" value="<?php echo NM_encode_input($codigo) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_codigo" name="codigo_autocomp" size="25"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_codbarra_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['codbarra'])) ? $this->New_label['codbarra'] : "CODBARRA"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_codbarra_cond" name="codbarra_cond" onChange="nm_campos_between(document.getElementById('id_vis_codbarra'), this, 'codbarra')">
       <OPTION value="qp" <?php if ("qp" == $codbarra_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $codbarra_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codbarra_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $codbarra_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codbarra" <?php echo $str_hide_codbarra?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['codbarra'])) ? $this->New_label['codbarra'] : "CODBARRA";
 $nmgp_tab_label .= "codbarra?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $codbarra_look = substr($this->Db->qstr($codbarra), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct CODBARRA from " . $this->Ini->nm_tabela . " where CODBARRA = '$codbarra_look' order by CODBARRA"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
      ...
      if (isset($nmgp_def_dados[0][$codbarra]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$codbarra];
      }
      else
      {
          $sAutocompValue = $codbarra;
      }
?>
<INPUT  type="text" id="SC_codbarra" name="codbarra" value="<?php echo NM_encode_input($codbarra) ?>"  size=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_codbarra" name="codbarra_autocomp" size="40"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_descrip_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['descrip'])) ? $this->New_label['descrip'] : "DESCRIP"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_descrip_cond" name="descrip_cond" onChange="nm_campos_between(document.getElementById('id_vis_descrip'), this, 'descrip')">
       <OPTION value="qp" <?php if ("qp" == $descrip_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $descrip_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $descrip_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $descrip_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_descrip" <?php echo $str_hide_descrip?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['descrip'])) ? $this->New_label['descrip'] : "DESCRIP";
 $nmgp_tab_label .= "descrip?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $descrip_look = substr($this->Db->qstr($descrip), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct DESCRIP from " . $this->Ini->nm_tabela . " where DESCRIP = '$descrip_look' order by DESCRIP"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
      ...
      if (isset($nmgp_def_dados[0][$descrip]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$descrip];
      }
      else
      {
          $sAutocompValue = $descrip;
      }
?>
<INPUT  type="text" id="SC_descrip" name="descrip" value="<?php echo NM_encode_input($descrip) ?>"  size=50 alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_descrip" name="descrip_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_MATERIAL_help.txt"))
   {
      $Arq_WebHelp = file("grid_MATERIAL_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_MATERIAL']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_MATERIAL']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_MATERIAL']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_MATERIAL']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.matid_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_matid'), document.F1.matid_cond, 'matid');
   document.F1.matid.value = "";
   ...
   document.F1.codbarra_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_codbarra'), document.F1.codbarra_cond, 'codbarra');
   document.F1.codbarra.value = "";
   document.F1.codbarra_autocomp.value = "";
   document.F1.descrip_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_descrip'), document.F1.descrip_cond, 'descrip');
   document.F1.descrip.value = "";
   document.F1.descrip_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEB_FE_73/grid_MATERIAL";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] = "";
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['pesq_tab_label'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_matid_cond'] = 'cond';
      $tp_fields['SC_matid'] = 'text';
      $tp_fields['SC_codigo_cond'] = 'cond';
      $tp_fields['SC_codigo'] = 'text_aut';
      $tp_fields['id_ac_codigo'] = 'text_aut';
      $tp_fields['SC_codbarra_cond'] = 'cond';
      $tp_fields['SC_codbarra'] = 'text_aut';
      $tp_fields['id_ac_codbarra'] = 'text_aut';
      $tp_fields['SC_descrip_cond'] = 'cond';
      $tp_fields['SC_descrip'] = 'text_aut';
      $tp_fields['id_ac_descrip'] = 'text_aut';
   ...
   {
      global $matid_cond, $matid,
             $codigo_cond, $codigo, $codigo_autocomp,
             $codbarra_cond, $codbarra, $codbarra_autocomp,
             $descrip_cond, $descrip, $descrip_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq'] = array();
      if (!empty($codigo_autocomp) && empty($codigo))
      {
          $codigo = $codigo_autocomp;
      }
      if (!empty($codbarra_autocomp) && empty($codbarra))
      {
          $codbarra = $codbarra_autocomp;
      }
      if (!empty($descrip_autocomp) && empty($descrip))
      {
          $descrip = $descrip_autocomp;
      }
      $matid_cond_salva = $matid_cond; 
      if (!isset($matid_input_2) || $matid_input_2 == "")
      {
          $matid_input_2 = $matid;
      }
      ...
      $codbarra_cond_salva = $codbarra_cond; 
      if (!isset($codbarra_input_2) || $codbarra_input_2 == "")
      {
          $codbarra_input_2 = $codbarra;
      }
      $descrip_cond_salva = $descrip_cond; 
      if (!isset($descrip_input_2) || $descrip_input_2 == "")
      {
          $descrip_input_2 = $descrip;
      }
      if ($matid_cond != "in")
      {
          nm_limpa_numero($matid, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['matid'] = $matid; 
      if (is_array($matid) && !empty($matid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['val'][0] = $matid;
      }
      elseif ($matid_cond_salva == "nu" || $matid_cond_salva == "nn" || $matid_cond_salva == "ep" || $matid_cond_salva == "ne" || !empty($matid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['val'][0][0] = $matid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['matid_cond'] = $matid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['cmp'] = "matid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['opc'] = $matid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq']['matid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['codigo'] = $codigo; 
      if (is_array($codigo) && !empty($codigo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['val'][0] = $codigo;
      }
      elseif ($codigo_cond_salva == "nu" || $codigo_cond_salva == "nn" || $codigo_cond_salva == "ep" || $codigo_cond_salva == "ne" || !empty($codigo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['val'][0][0] = $codigo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['codigo_cond'] = $codigo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['cmp'] = "codigo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['opc'] = $codigo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq']['codigo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['codbarra'] = $codbarra; 
      if (is_array($codbarra) && !empty($codbarra))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['val'][0] = $codbarra;
      }
      elseif ($codbarra_cond_salva == "nu" || $codbarra_cond_salva == "nn" || $codbarra_cond_salva == "ep" || $codbarra_cond_salva == "ne" || !empty($codbarra))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['val'][0][0] = $codbarra;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['codbarra_cond'] = $codbarra_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['cmp'] = "codbarra"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['opc'] = $codbarra_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq']['codbarra'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['descrip'] = $descrip; 
      if (is_array($descrip) && !empty($descrip))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['val'][0] = $descrip;
      }
      elseif ($descrip_cond_salva == "nu" || $descrip_cond_salva == "nn" || $descrip_cond_salva == "ep" || $descrip_cond_salva == "ne" || !empty($descrip))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['val'][0][0] = $descrip;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['descrip_cond'] = $descrip_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['cmp'] = "descrip"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid]['opc'] = $descrip_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['grid_pesq']['descrip'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['matid'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($codigo != '') {
      $codigo_look = substr($this->Db->qstr($codigo), 1, -1); 
      $nmgp_def_dados = array(); 
    ...
    if ($codbarra != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codbarra'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['codbarra'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['codbarra'] = $codbarra;
      }
      $nmgp_def_dados = array();
    if ($descrip != '') {
      $descrip_look = substr($this->Db->qstr($descrip), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['descrip'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['descrip'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['descrip'] = $descrip;
      }

      //----- $matid
      $this->Date_part = false;
      if (isset($matid) || $matid_cond == "nu" || $matid_cond == "nn" || $matid_cond == "ep" || $matid_cond == "ne")
      {
         $this->monta_condicao("MATID", $matid_cond, $matid, "", "matid");
      }
      ...
      //----- $codbarra
      $this->Date_part = false;
      if (isset($codbarra) || $codbarra_cond == "nu" || $codbarra_cond == "nn" || $codbarra_cond == "ep" || $codbarra_cond == "ne")
      {
         $this->monta_condicao("CODBARRA", $codbarra_cond, $codbarra, "", "codbarra");
      }

      //----- $descrip
      $this->Date_part = false;
      if (isset($descrip) || $descrip_cond == "nu" || $descrip_cond == "nn" || $descrip_cond == "ep" || $descrip_cond == "ne")
      {
         $this->monta_condicao("DESCRIP", $descrip_cond, $descrip, "", "descrip");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq_grid'] = $this->comando;
       if (empty($this->comando)) 
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq_filtro'] = "";
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_orig'];
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_dyn_search'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq_filtro'] = "";
      }
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_MATERIAL']['where_pesq'];
