...
<?php
   ...
   $Ord_Cmp = new grid_MATERIAL_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_MATERIAL_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_MATERIAL_json.php");
   }
   ...
   $tab_labels["matid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['labels']["matid"])) ? $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['labels']["matid"] : "MATID";
   $tab_ger_campos['codigo'] = "on";
   $tab_def_campos['codigo'] = "CODIGO";
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['labels']["codigo"] : "CODIGO";
   $tab_ger_campos['codbarra'] = "on";
   $tab_def_campos['codbarra'] = "CODBARRA";
   $tab_labels["codbarra"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['labels']["codbarra"])) ? $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['labels']["codbarra"] : "CODBARRA";
   $tab_ger_campos['descrip'] = "on";
   $tab_def_campos['descrip'] = "DESCRIP";
   $tab_labels["descrip"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['labels']["descrip"])) ? $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['labels']["descrip"] : "DESCRIP";
   $tab_ger_campos['grupmatid'] = "on";
   $tab_def_campos['grupmatid'] = "GRUPMATID";
   $tab_labels["grupmatid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['labels']["grupmatid"])) ? $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['labels']["grupmatid"] : "GRUPMATID";
   $tab_ger_campos['referencia'] = "on";
   $tab_def_campos['referencia'] = "REFERENCIA";
   $tab_labels["referencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['labels']["referencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['labels']["referencia"] : "REFERENCIA";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> MATERIAL</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_MATERIAL_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_MATERIAL']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
