...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_matid_cond" name="matid_cond" onChange="nm_campos_between(document.getElementById('id_vis_matid'), this, 'matid')">
      ...
      <br><span id="id_hide_matid"  <?php echo $str_hide_matid?>><INPUT  type="text" id="SC_matid" name="matid" value="<?php echo NM_encode_input($matid) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_codbarra_cond" name="codbarra_cond" onChange="nm_campos_between(document.getElementById('id_vis_codbarra'), this, 'codbarra')">
      ...
      <br><span id="id_hide_codbarra"  <?php echo $str_hide_codbarra?>><?php
      if ($codbarra != "")
      {
      $codbarra_look = substr($this->Db->qstr($codbarra), 1, -1); 
      $nmgp_def_dados = array(); 
