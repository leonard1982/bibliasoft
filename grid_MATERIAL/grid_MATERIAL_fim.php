...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_MATERIAL"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_MATERIAL"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_MATERIAL']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_MATERIAL']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_MATERIAL']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_MATERIAL']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_MATERIAL']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_MATERIAL']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_MATERIAL']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_MATERIAL']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_MATERIAL']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_MATERIAL' || $achou)
          {
