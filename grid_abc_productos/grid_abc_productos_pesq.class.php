 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_nomgrupo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nomgrupo'])) ? $this->New_label['nomgrupo'] : "Grupo/Familia"; ?></TD>
      
      <INPUT type="hidden" id="SC_nomgrupo_cond" name="nomgrupo_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nomgrupo" <?php echo $str_hide_nomgrupo?> valign="top">
...
$style_cond_in = ($porcentaje_cond != "in") ? " style=\"display: none;\"" : ""; 
?>
<INPUT  type="text" id="SC_porcentaje_IN" name="porcentaje_IN" value="<?php echo NM_encode_input($porcentaje_IN) ?>" size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '0123456789,-', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd"<?php echo $style_cond_in ?>>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_porcentaje"  <?php echo $str_display_porcentaje; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_porcentaje_input_2" name="porcentaje_input_2" value="<?php echo NM_encode_input($porcentaje_input_2) ?>"  size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: ',', allowNegative: true, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
