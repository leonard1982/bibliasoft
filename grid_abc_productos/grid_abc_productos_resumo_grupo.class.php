...
$_SESSION['scriptcase']['grid_abc_productos']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_nomgrupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['arr_total']['nomgrupo'];
      }
      else
      {
          $this->array_total_nomgrupo = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['summarizing_fields_order']['grupo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['summarizing_fields_order']['grupo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['summarizing_fields_order']['grupo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['summarizing_fields_display']['grupo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['summarizing_fields_display']['grupo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['summarizing_fields_display']['grupo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['summarizing_fields_display']['grupo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['summarizing_fields_display']['grupo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['summarizing_fields_display']['grupo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['summarizing_fields_display']['grupo'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_nomgrupo as $i_nomgrupo => $d_nomgrupo) {
           if (!in_array($i_nomgrupo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_nomgrupo[5] ] = $d_nomgrupo[4];
               $this->comp_label[0][ $d_nomgrupo[5] ] = $d_nomgrupo[4];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'nomgrupo', 'prot' => '@aspass@'),
       );
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['pivot_order_sort'] = '';
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_nomgrupo => $l_nomgrupo) {
           if (isset($this->array_total_nomgrupo[$i_nomgrupo])) {
               $this->comp_group[$i_nomgrupo] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_nomgrupo;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      ksort($this->array_total_nomgrupo);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   {
      //----- Grupo/Familia
      if (!isset($this->array_total_nomgrupo[$quebra_nomgrupo_orig]))
      {
         $this->array_total_nomgrupo[$quebra_nomgrupo_orig][0] = 1;
         $this->array_total_nomgrupo[$quebra_nomgrupo_orig][1] = $sum_vendido;
         $this->array_total_nomgrupo[$quebra_nomgrupo_orig][2] = $sum_porcentaje;
         $this->array_total_nomgrupo[$quebra_nomgrupo_orig][3] = 1;
         $this->array_total_nomgrupo[$quebra_nomgrupo_orig][4] = $quebra_nomgrupo;
         $this->array_total_nomgrupo[$quebra_nomgrupo_orig][5] = $quebra_nomgrupo_orig;
      }
      else
      {
         $this->array_total_nomgrupo[$quebra_nomgrupo_orig][0]++;
         $this->array_total_nomgrupo[$quebra_nomgrupo_orig][1] += $sum_vendido;
         $this->array_total_nomgrupo[$quebra_nomgrupo_orig][2] += $sum_porcentaje;
         $this->array_total_nomgrupo[$quebra_nomgrupo_orig][3]++;
      }
   }
   ...
   function finaliza_arrays()
   {
      ...
      if (isset($this->array_total_nomgrupo))
      {
         foreach ($this->array_total_nomgrupo as $campo_nomgrupo => $dados_nomgrupo)
         {
           $this->nomgrupo = $dados_nomgrupo[4];
           $this->count_nomgrupo = $dados_nomgrupo[0];
           $this->sum_nomgrupo_vendido = $dados_nomgrupo[1];
           $this->sum_nomgrupo_porcentaje = $dados_nomgrupo[2];
           ...
           if ($this->sc_proc_quebra_nomgrupo)
           {
           $_SESSION['scriptcase']['grid_abc_productos']['contr_erro'] = 'on';
if (!isset($_SESSION['gtotalporcentaje'])) {$_SESSION['gtotalporcentaje'] = "";}
if (!isset($this->sc_temp_gtotalporcentaje)) {$this->sc_temp_gtotalporcentaje = (isset($_SESSION['gtotalporcentaje'])) ? $_SESSION['gtotalporcentaje'] : "";}
...
$_SESSION['scriptcase']['grid_abc_productos']['contr_erro'] = 'off'; 
           ...
           $this->array_total_nomgrupo[$campo_nomgrupo][1] = $this->sum_nomgrupo_vendido;
           $this->array_total_nomgrupo[$campo_nomgrupo][2] = $this->sum_nomgrupo_porcentaje;
         } 
      } 
...
$_SESSION['scriptcase']['grid_abc_productos']['contr_erro'] = 'off'; 
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'nomgrupo');
     $campos_order = $this->Ini->Get_date_order_groupby("nomgrupo", 'asc', $format, $campos_order);
