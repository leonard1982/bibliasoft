...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_abc_productos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_abc_productos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_abc_productos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_abc_productos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_abc_productos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_abc_productos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_abc_productos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_abc_productos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_abc_productos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_abc_productos']['embutida_filho'] as $ind => $sc_init)
          {
