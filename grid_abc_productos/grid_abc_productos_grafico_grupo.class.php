...
<?php
   ...
   function inicializa_vars()
   {
      ...
      //---- Label
      $this->label    = array();
      $this->label[0] = "Grupo/Familia";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['contr_label_graf']['nomgrupo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['contr_label_graf']['nomgrupo']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_abc_productos']['contr_label_graf']['nomgrupo'];
      }
   }
