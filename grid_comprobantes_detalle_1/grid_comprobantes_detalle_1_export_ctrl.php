<?php
@session_start() ;
$_SESSION['scriptcase']['grid_comprobantes_detalle_1']['sc_process_barr'] = true;
require_once('../grid_comprobantes_detalle_1/index.php');
unset($_SESSION['scriptcase']['grid_comprobantes_detalle_1']['sc_process_barr']);
$ExportCtrl = new grid_comprobantes_detalle_1_export_control;
$ExportCtrl->Export_barr();

class grid_comprobantes_detalle_1_export_control
{
