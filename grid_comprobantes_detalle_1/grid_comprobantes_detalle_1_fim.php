...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_comprobantes_detalle_1"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_comprobantes_detalle_1"]);
   }
