<?php
@session_start() ;
$_SESSION['scriptcase']['grid_semanas_venta']['sc_process_barr'] = true;
require_once('../grid_semanas_venta/index.php');
unset($_SESSION['scriptcase']['grid_semanas_venta']['sc_process_barr']);
$ExportCtrl = new grid_semanas_venta_export_control;
$ExportCtrl->Export_barr();

class grid_semanas_venta_export_control
{
