...
?>
<INPUT  type="text" id="SC_existencia" name="existencia" value="<?php echo NM_encode_input($existencia) ?>" size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 2, decimalSep: ',', thousandsSep: '.', allowNegative: true, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_existencia"  <?php echo $str_display_existencia; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_existencia_input_2" name="existencia_input_2" value="<?php echo NM_encode_input($existencia_input_2) ?>"  size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 2, decimalSep: ',', thousandsSep: '.', allowNegative: true, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_demanda_semanal_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['demanda_semanal'])) ? $this->New_label['demanda_semanal'] : "Demanda Semanal"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_demanda_semanal_cond" name="demanda_semanal_cond" onChange="nm_campos_between(document.getElementById('id_vis_demanda_semanal'), this, 'demanda_semanal')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_demanda_semanal" <?php echo $str_hide_demanda_semanal?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
?>
<INPUT  type="text" id="SC_demanda_semanal" name="demanda_semanal" value="<?php echo NM_encode_input($demanda_semanal) ?>" size=40 alt="{datatype: 'decimal', maxLength: 40, precision: 2, decimalSep: ',', thousandsSep: '.', allowNegative: true, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_demanda_semanal"  <?php echo $str_display_demanda_semanal; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
      ...
      <TD id='SC_semanas_venta_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['semanas_venta'])) ? $this->New_label['semanas_venta'] : "Semanas Venta"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_semanas_venta_cond" name="semanas_venta_cond" onChange="nm_campos_between(document.getElementById('id_vis_semanas_venta'), this, 'semanas_venta')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_semanas_venta" <?php echo $str_hide_semanas_venta?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
?>
<INPUT  type="text" id="SC_semanas_venta" name="semanas_venta" value="<?php echo NM_encode_input($semanas_venta) ?>" size=22 alt="{datatype: 'decimal', maxLength: 22, precision: 2, decimalSep: ',', thousandsSep: '.', allowNegative: true, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_semanas_venta"  <?php echo $str_display_semanas_venta; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
