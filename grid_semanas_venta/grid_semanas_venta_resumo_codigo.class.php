...
class grid_semanas_venta_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_total']['codigo'];
      }
      else
      {
          $this->array_total_codigo = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_order']['codigo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_order']['codigo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_order']['codigo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['codigo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['codigo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['codigo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['codigo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['codigo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['codigo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['codigo'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_codigo as $i_codigo => $d_codigo) {
           if (!in_array($i_codigo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_codigo[3] ] = $d_codigo[2];
               $this->comp_label[0][ $d_codigo[3] ] = $d_codigo[2];
           }
       }
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_level'] = -1;
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_codigo => $l_codigo) {
           if (isset($this->array_total_codigo[$i_codigo])) {
               $this->comp_group[$i_codigo] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_codigo;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_codigo("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_codigo, $quebra_codigo_orig)
   {
      //----- Codigo
      if (!isset($this->array_total_codigo[$quebra_codigo_orig]))
      {
         $this->array_total_codigo[$quebra_codigo_orig][0] = 1;
         $this->array_total_codigo[$quebra_codigo_orig][1] = 1;
         $this->array_total_codigo[$quebra_codigo_orig][2] = $quebra_codigo;
         $this->array_total_codigo[$quebra_codigo_orig][3] = $quebra_codigo_orig;
      }
      else
      {
         $this->array_total_codigo[$quebra_codigo_orig][0]++;
         $this->array_total_codigo[$quebra_codigo_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'codigo');
     $campos_order = $this->Ini->Get_date_order_groupby("codigo", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->idgrup = $this->look_idgrup ;
            nmgp_Form_Num_Val($this->existencia, "", "", "", "", "", "", "V::", "") ; 
            nmgp_Form_Num_Val($this->demanda_semanal, "", "", "", "", "", "", "N:", "") ; 
            nmgp_Form_Num_Val($this->semanas_venta, "", "", "", "", "", "", "N:", "") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->codigo, $this->codigo_orig);
            }
   }
//
