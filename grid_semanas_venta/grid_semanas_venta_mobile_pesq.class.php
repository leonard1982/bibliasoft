...
class grid_semanas_venta_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_semanas_venta_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_semanas_venta_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_semanas_venta_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_descripcion($descripcion)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct descripcion from (select  p.codigobar as codigo, p.nompro as descripcion, coalesce(p.stockmen,0) as existencia, coalesce(( select (SUM(d.cantidad)/(EXTRACT(WEEK FROM CURRENT_TIMESTAMP)))   from detalleventa d    inner join facturaven f ON d.numfac=f.idfacven   where   f.asentada=1 and   d.idpro=p.idprod ),0) as demanda_semanal, coalesce(( p.stockmen/(select (SUM(d.cantidad)/(EXTRACT(WEEK FROM CURRENT_TIMESTAMP)))   from detalleventa d    inner join facturaven f ON d.numfac=f.idfacven   where   f.asentada=1 and   d.idpro=p.idprod) ),0) as semanas_venta, (if(p.unidmaymen='SI',p.unimay,p.unimen)) as unidad, p.idgrup FROM productos p where  p.idgrup <> 1 and p.escombo='NO') nm_sel_esp where  descripcion like '%" . $descripcion . "%'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "existencia";$Nm_numeric[] = "demanda_semanal";$Nm_numeric[] = "semanas_venta";$Nm_numeric[] = "idgrup";$Nm_numeric[] = "existencia";$Nm_numeric[] = "demanda_semanal";$Nm_numeric[] = "semanas_venta";$Nm_numeric[] = "idgrup";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_semanas_venta/grid_semanas_venta_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_semanas_venta_ajax_search.js"></script>
 <script type="text/javascript" src="grid_semanas_venta_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_semanas_venta_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_semanas_venta']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_semanas_venta']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'id_ac_codigo#NMF#' + search_get_title('select2-id_ac_codigo-container') + '@NMF@';
  ...
  str_out += 'id_ac_descripcion#NMF#' + search_get_title('select2-id_ac_descripcion-container') + '@NMF@';
  ...
  str_out += 'SC_demanda_semanal_cond#NMF#' + search_get_sel_txt('SC_demanda_semanal_cond') + '@NMF@';
  str_out += 'SC_demanda_semanal#NMF#' + search_get_text('SC_demanda_semanal') + '@NMF@';
  str_out += 'SC_demanda_semanal_input_2#NMF#' + search_get_text('SC_demanda_semanal_input_2') + '@NMF@';
  str_out += 'SC_semanas_venta_cond#NMF#' + search_get_sel_txt('SC_semanas_venta_cond') + '@NMF@';
  str_out += 'SC_semanas_venta#NMF#' + search_get_text('SC_semanas_venta') + '@NMF@';
  str_out += 'SC_semanas_venta_input_2#NMF#' + search_get_text('SC_semanas_venta_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  ...
  $(".sc-ui-autocomp-codigo").on("focus", function() {
  }).on("blur", function() {
   ...
   $("#SC_codigo").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-descripcion").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   $("#SC_descripcion").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Semanas Venta</span></td>
            <td id="lin1_col2" class="scFilterHeaderFont"><span><IMG src="<?php echo $this->Ini->path_imag_cab; ?>/scriptcase__NM__ico__NM__calendar_5_32.png" border="0"></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $existencia_cond, $existencia, $existencia_input_2,
             $demanda_semanal_cond, $demanda_semanal, $demanda_semanal_input_2,
             $semanas_venta_cond, $semanas_venta, $semanas_venta_input_2,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idgrup = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['idgrup']; 
          $idgrup_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['idgrup_cond']; 
          $codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['codigo']; 
          $codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['codigo_cond']; 
          $descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['descripcion']; 
          $descripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['descripcion_cond']; 
          $existencia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['existencia']; 
          $existencia_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['existencia_input_2']; 
          $existencia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['existencia_cond']; 
          $demanda_semanal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['demanda_semanal']; 
          $demanda_semanal_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['demanda_semanal_input_2']; 
          $demanda_semanal_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['demanda_semanal_cond']; 
          $semanas_venta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['semanas_venta']; 
          $semanas_venta_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['semanas_venta_input_2']; 
          $semanas_venta_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['semanas_venta_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['NM_operador']; 
          ...
          { 
              nmgp_Form_Num_Val($existencia, ".", ",", "2", "S", "1", "", "N:2", "-") ; 
          } 
          if (strtoupper($existencia_cond) != "II" && strtoupper($existencia_cond) != "QP" && strtoupper($existencia_cond) != "NP" && strtoupper($existencia_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($existencia_input_2, ".", ",", "2", "S", "1", "", "N:2", "-") ; 
          } 
          if (strtoupper($demanda_semanal_cond) != "II" && strtoupper($demanda_semanal_cond) != "QP" && strtoupper($demanda_semanal_cond) != "NP" && strtoupper($demanda_semanal_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($demanda_semanal, ".", ",", "2", "S", "1", "", "N:2", "-") ; 
          } 
          if (strtoupper($demanda_semanal_cond) != "II" && strtoupper($demanda_semanal_cond) != "QP" && strtoupper($demanda_semanal_cond) != "NP" && strtoupper($demanda_semanal_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($demanda_semanal_input_2, ".", ",", "2", "S", "1", "", "N:2", "-") ; 
          } 
          if (strtoupper($semanas_venta_cond) != "II" && strtoupper($semanas_venta_cond) != "QP" && strtoupper($semanas_venta_cond) != "NP" && strtoupper($semanas_venta_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($semanas_venta, ".", ",", "2", "S", "1", "", "N:2", "-") ; 
          } 
          if (strtoupper($semanas_venta_cond) != "II" && strtoupper($semanas_venta_cond) != "QP" && strtoupper($semanas_venta_cond) != "NP" && strtoupper($semanas_venta_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($semanas_venta_input_2, ".", ",", "2", "S", "1", "", "N:2", "-") ; 
          } 
      } 
      ...
      if (!isset($demanda_semanal_cond) || empty($demanda_semanal_cond))
      {
         $demanda_semanal_cond = "ge";
      }
      if (!isset($semanas_venta_cond) || empty($semanas_venta_cond))
      {
         $semanas_venta_cond = "le";
      }
      ...
      $str_hide_demanda_semanal = (in_array($demanda_semanal_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_semanas_venta = (in_array($semanas_venta_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_demanda_semanal = ('bw' == $demanda_semanal_cond) ? $display_aberto : $display_fechado;
      $str_display_semanas_venta = ('bw' == $semanas_venta_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($demanda_semanal) || $demanda_semanal == "")
      {
          $demanda_semanal = "";
      }
      if (isset($demanda_semanal) && !empty($demanda_semanal))
      {
         $tmp_pos = strpos($demanda_semanal, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $demanda_semanal = substr($demanda_semanal, 0, $tmp_pos);
         }
      }
      if (!isset($semanas_venta) || $semanas_venta == "")
      {
          $semanas_venta = "";
      }
      if (isset($semanas_venta) && !empty($semanas_venta))
      {
         $tmp_pos = strpos($semanas_venta, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $semanas_venta = substr($semanas_venta, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idgrup" name="idgrup_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <INPUT type="hidden" id="SC_codigo_cond" name="codigo_cond" value="qp">
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_codigo"  <?php echo $str_hide_codigo?>><?php
      ...
      $codigo_look = substr($this->Db->qstr($codigo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct codigo from (select  p.codigobar as codigo, p.nompro as descripcion, coalesce(p.stockmen,0) as existencia, coalesce(( select (SUM(d.cantidad)/(EXTRACT(WEEK FROM CURRENT_TIMESTAMP)))   from detalleventa d    inner join facturaven f ON d.numfac=f.idfacven   where   f.asentada=1 and   d.idpro=p.idprod ),0) as demanda_semanal, coalesce(( p.stockmen/(select (SUM(d.cantidad)/(EXTRACT(WEEK FROM CURRENT_TIMESTAMP)))   from detalleventa d    inner join facturaven f ON d.numfac=f.idfacven   where   f.asentada=1 and   d.idpro=p.idprod) ),0) as semanas_venta, (if(p.unidmaymen='SI',p.unimay,p.unimen)) as unidad, p.idgrup FROM productos p where  p.idgrup <> 1 and p.escombo='NO') nm_sel_esp where codigo = '$codigo_look'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_codigo" name="codigo" value="<?php echo NM_encode_input($codigo) ?>"  size=43 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-codigo" id="id_ac_codigo" name="codigo_autocomp"><?php if ('' !=  $codigo) { ?><option value="<?php echo $codigo ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_descripcion"  <?php echo $str_hide_descripcion?>><?php
      if ($descripcion != "")
      {
      $descripcion_look = substr($this->Db->qstr($descripcion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct descripcion from (select  p.codigobar as codigo, p.nompro as descripcion, coalesce(p.stockmen,0) as existencia, coalesce(( select (SUM(d.cantidad)/(EXTRACT(WEEK FROM CURRENT_TIMESTAMP)))   from detalleventa d    inner join facturaven f ON d.numfac=f.idfacven   where   f.asentada=1 and   d.idpro=p.idprod ),0) as demanda_semanal, coalesce(( p.stockmen/(select (SUM(d.cantidad)/(EXTRACT(WEEK FROM CURRENT_TIMESTAMP)))   from detalleventa d    inner join facturaven f ON d.numfac=f.idfacven   where   f.asentada=1 and   d.idpro=p.idprod) ),0) as semanas_venta, (if(p.unidmaymen='SI',p.unimay,p.unimen)) as unidad, p.idgrup FROM productos p where  p.idgrup <> 1 and p.escombo='NO') nm_sel_esp where descripcion = '$descripcion_look'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_descripcion" name="descripcion" value="<?php echo NM_encode_input($descripcion) ?>"  size=50 alt="{datatype: 'text', maxLength: 600, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-descripcion" id="id_ac_descripcion" name="descripcion_autocomp"><?php if ('' !=  $descripcion) { ?><option value="<?php echo $descripcion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_existencia_cond" name="existencia_cond" onChange="nm_campos_between(document.getElementById('id_vis_existencia'), this, 'existencia')">
      ...
      <br><span id="id_hide_existencia"  <?php echo $str_hide_existencia?>><INPUT  type="text" id="SC_existencia" name="existencia" value="<?php echo NM_encode_input($existencia) ?>" size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 2, decimalSep: ',', thousandsSep: '.', allowNegative: true, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">         <BR>
        <SPAN id="id_vis_existencia"  <?php echo $str_display_existencia; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_existencia_input_2" name="existencia_input_2" value="<?php echo NM_encode_input($existencia_input_2) ?>"  size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 2, decimalSep: ',', thousandsSep: '.', allowNegative: true, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
 ...
 $nmgp_tab_label .= "demanda_semanal?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_demanda_semanal_cond" name="demanda_semanal_cond" onChange="nm_campos_between(document.getElementById('id_vis_demanda_semanal'), this, 'demanda_semanal')">
       <OPTION value="ge" <?php if ("ge" == $demanda_semanal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr_equl'] ?></OPTION>
       <OPTION value="le" <?php if ("le" == $demanda_semanal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less_equl'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $demanda_semanal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $demanda_semanal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $demanda_semanal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $demanda_semanal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_demanda_semanal"  <?php echo $str_hide_demanda_semanal?>><INPUT  type="text" id="SC_demanda_semanal" name="demanda_semanal" value="<?php echo NM_encode_input($demanda_semanal) ?>" size=40 alt="{datatype: 'decimal', maxLength: 40, precision: 2, decimalSep: ',', thousandsSep: '.', allowNegative: true, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">         <BR>
        <SPAN id="id_vis_demanda_semanal"  <?php echo $str_display_demanda_semanal; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_demanda_semanal_input_2" name="demanda_semanal_input_2" value="<?php echo NM_encode_input($demanda_semanal_input_2) ?>"  size=40 alt="{datatype: 'decimal', maxLength: 40, precision: 2, decimalSep: ',', thousandsSep: '.', allowNegative: true, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
 ...
 $nmgp_tab_label .= "semanas_venta?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_semanas_venta_cond" name="semanas_venta_cond" onChange="nm_campos_between(document.getElementById('id_vis_semanas_venta'), this, 'semanas_venta')">
       <OPTION value="le" <?php if ("le" == $semanas_venta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less_equl'] ?></OPTION>
       <OPTION value="ge" <?php if ("ge" == $semanas_venta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr_equl'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $semanas_venta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $semanas_venta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $semanas_venta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $semanas_venta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_semanas_venta"  <?php echo $str_hide_semanas_venta?>><INPUT  type="text" id="SC_semanas_venta" name="semanas_venta" value="<?php echo NM_encode_input($semanas_venta) ?>" size=22 alt="{datatype: 'decimal', maxLength: 22, precision: 2, decimalSep: ',', thousandsSep: '.', allowNegative: true, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">         <BR>
        <SPAN id="id_vis_semanas_venta"  <?php echo $str_display_semanas_venta; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_semanas_venta_input_2" name="semanas_venta_input_2" value="<?php echo NM_encode_input($semanas_venta_input_2) ?>"  size=22 alt="{datatype: 'decimal', maxLength: 22, precision: 2, decimalSep: ',', thousandsSep: '.', allowNegative: true, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
<?php
   if (is_file("grid_semanas_venta_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opc_psq'])
   {
...
<?php
   ...
   {
?>
          <?php echo nmButtonOutput($this->arr_buttons, "blimpar", "limpa_form();", "limpa_form();", "limpa_frm_bot", "", "Limpiar Filtro", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
<?php
   }
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   $('#select2-id_ac_codigo-container').html('<?php echo $this->Val_init_codigo['desc'] ?>');;
   ...
   $('#select2-id_ac_descripcion-container').html('<?php echo $this->Val_init_descripcion['desc'] ?>');;
   document.F1.existencia_cond.value = 'ge';
   ...
   document.F1.demanda_semanal_cond.value = 'ge';
   nm_campos_between(document.getElementById('id_vis_demanda_semanal'), document.F1.demanda_semanal_cond, 'demanda_semanal');
   document.F1.demanda_semanal.value = "";
   document.F1.demanda_semanal_input_2.value = "";
   document.F1.semanas_venta_cond.value = 'le';
   nm_campos_between(document.getElementById('id_vis_semanas_venta'), document.F1.semanas_venta_cond, 'semanas_venta');
   document.F1.semanas_venta.value = "";
   document.F1.semanas_venta_input_2.value = "";
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['id_ac_codigo'] = 'select2_aut';
      $tp_fields['SC_descripcion_cond'] = 'cond';
      $tp_fields['SC_descripcion'] = 'text_aut';
      $tp_fields['id_ac_descripcion'] = 'select2_aut';
      $tp_fields['SC_existencia_cond'] = 'cond';
      $tp_fields['SC_existencia'] = 'text';
      $tp_fields['SC_existencia_input_2'] = 'text';
      $tp_fields['SC_demanda_semanal_cond'] = 'cond';
      $tp_fields['SC_demanda_semanal'] = 'text';
      $tp_fields['SC_demanda_semanal_input_2'] = 'text';
      $tp_fields['SC_semanas_venta_cond'] = 'cond';
      $tp_fields['SC_semanas_venta'] = 'text';
      $tp_fields['SC_semanas_venta_input_2'] = 'text';
   ...
   {
      global $idgrup_cond, $idgrup, $idgrup_autocomp,
             $codigo_cond, $codigo, $codigo_autocomp,
             $descripcion_cond, $descripcion, $descripcion_autocomp,
             $existencia_cond, $existencia, $existencia_input_2,
             $demanda_semanal_cond, $demanda_semanal, $demanda_semanal_input_2,
             $semanas_venta_cond, $semanas_venta, $semanas_venta_input_2, $nmgp_tab_label;
      ...
      $demanda_semanal_cond_salva = $demanda_semanal_cond; 
      if (!isset($demanda_semanal_input_2) || $demanda_semanal_input_2 == "")
      {
          $demanda_semanal_input_2 = $demanda_semanal;
      }
      $semanas_venta_cond_salva = $semanas_venta_cond; 
      if (!isset($semanas_venta_input_2) || $semanas_venta_input_2 == "")
      {
          $semanas_venta_input_2 = $semanas_venta;
      }
      if ($existencia_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($existencia, ",", ".") ; 
          }
      }
      if ($existencia_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($existencia_input_2, ",", ".") ; 
          }
      }
      if ($demanda_semanal_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($demanda_semanal, ",", ".") ; 
          }
      }
      if ($demanda_semanal_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($demanda_semanal_input_2, ",", ".") ; 
          }
      }
      if ($semanas_venta_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($semanas_venta, ",", ".") ; 
          }
      }
      if ($semanas_venta_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($semanas_venta_input_2, ",", ".") ; 
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['idgrup'] = $idgrup; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['idgrup_cond'] = $idgrup_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['codigo'] = $codigo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['codigo_cond'] = $codigo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['descripcion'] = $descripcion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['descripcion_cond'] = $descripcion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['existencia'] = $existencia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['existencia_input_2'] = $existencia_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['existencia_cond'] = $existencia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['demanda_semanal'] = $demanda_semanal; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['demanda_semanal_input_2'] = $demanda_semanal_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['demanda_semanal_cond'] = $demanda_semanal_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['semanas_venta'] = $semanas_venta; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['semanas_venta_input_2'] = $semanas_venta_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['semanas_venta_cond'] = $semanas_venta_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca'] = $Temp_Busca;
      }
      ...
      if ($demanda_semanal_cond != "in" && $demanda_semanal_cond != "bw" && !empty($demanda_semanal) && !is_numeric($demanda_semanal))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Demanda Semanal";
      }
      if ($demanda_semanal_cond == "bw" && ((!empty($demanda_semanal) && !is_numeric($demanda_semanal)) || (!empty($demanda_semanal_input_2) && !is_numeric($demanda_semanal_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Demanda Semanal";
      }
      if ($semanas_venta_cond != "in" && $semanas_venta_cond != "bw" && !empty($semanas_venta) && !is_numeric($semanas_venta))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Semanas Venta";
      }
      if ($semanas_venta_cond == "bw" && ((!empty($semanas_venta) && !is_numeric($semanas_venta)) || (!empty($semanas_venta_input_2) && !is_numeric($semanas_venta_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Semanas Venta";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
    ...
    if ($descripcion != '') {
      ...
      if (strtoupper($existencia_cond) != "II" && strtoupper($existencia_cond) != "QP" && strtoupper($existencia_cond) != "NP" && strtoupper($existencia_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "2", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['existencia'] = $Conteudo;
      ...
      $Conteudo = $demanda_semanal;
      if (strtoupper($demanda_semanal_cond) != "II" && strtoupper($demanda_semanal_cond) != "QP" && strtoupper($demanda_semanal_cond) != "NP" && strtoupper($demanda_semanal_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "2", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['demanda_semanal'] = $Conteudo;
      $Conteudo = $demanda_semanal_input_2;
      if (strtoupper($demanda_semanal_cond) != "II" && strtoupper($demanda_semanal_cond) != "QP" && strtoupper($demanda_semanal_cond) != "NP" && strtoupper($demanda_semanal_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "2", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['demanda_semanal_input_2'] = $Conteudo;
      $Conteudo = $semanas_venta;
      if (strtoupper($semanas_venta_cond) != "II" && strtoupper($semanas_venta_cond) != "QP" && strtoupper($semanas_venta_cond) != "NP" && strtoupper($semanas_venta_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "2", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['semanas_venta'] = $Conteudo;
      $Conteudo = $semanas_venta_input_2;
      if (strtoupper($semanas_venta_cond) != "II" && strtoupper($semanas_venta_cond) != "QP" && strtoupper($semanas_venta_cond) != "NP" && strtoupper($semanas_venta_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, ".", ",", "2", "S", "1", "", "N:2", "-") ; 
      } 
      $this->cmp_formatado['semanas_venta_input_2'] = $Conteudo;
      ...
      {
         $this->monta_condicao("existencia", $existencia_cond, $existencia, $existencia_input_2, "existencia");
      }

      //----- $demanda_semanal
      $this->Date_part = false;
      if (isset($demanda_semanal) || $demanda_semanal_cond == "nu" || $demanda_semanal_cond == "nn" || $demanda_semanal_cond == "ep" || $demanda_semanal_cond == "ne")
      {
         $this->monta_condicao("demanda_semanal", $demanda_semanal_cond, $demanda_semanal, $demanda_semanal_input_2, "demanda_semanal");
      }

      //----- $semanas_venta
      $this->Date_part = false;
      if (isset($semanas_venta) || $semanas_venta_cond == "nu" || $semanas_venta_cond == "nn" || $semanas_venta_cond == "ep" || $semanas_venta_cond == "ne")
      {
         $this->monta_condicao("semanas_venta", $semanas_venta_cond, $semanas_venta, $semanas_venta_input_2, "semanas_venta");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['cond_pesq'] .= $this->NM_operador;
