...
class grid_semanas_venta_json
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_semanas_venta/grid_semanas_venta_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['json_format'];
      }
   ...
   function grava_arquivo()
   {
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "grid_semanas_venta_res_json.class.php");
              $this->Res = new grid_semanas_venta_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['json_res_grid']);
          } 
      }
   ...
   function NM_export_demanda_semanal()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->demanda_semanal;
   }
   //----- semanas_venta
   function NM_export_semanas_venta()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->semanas_venta;
   }
   //----- unidad
