...
class grid_semanas_venta_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_total']['descripcion'];
      }
      else
      {
          $this->array_total_descripcion = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_order']['producto']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_order']['producto'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_order']['producto'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['producto'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['producto'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['producto'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['producto'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['producto'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['producto'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['producto'] as $i_sum => $d_sum)
           {
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = $this->Ini->Get_date_order_groupby("descripcion", 'asc', $format, $campos_order);
