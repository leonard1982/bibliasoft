...
class grid_semanas_venta_rtf
{
   ...
   function NM_export_demanda_semanal()
   {
         ...
         $this->demanda_semanal = str_replace('<', '&lt;', $this->demanda_semanal);
         $this->demanda_semanal = str_replace('>', '&gt;', $this->demanda_semanal);
         $this->Texto_tag .= "<td>" . $this->demanda_semanal . "</td>\r\n";
   }
   //----- semanas_venta
   function NM_export_semanas_venta()
   {
         ...
         $this->semanas_venta = str_replace('<', '&lt;', $this->semanas_venta);
         $this->semanas_venta = str_replace('>', '&gt;', $this->semanas_venta);
         $this->Texto_tag .= "<td>" . $this->semanas_venta . "</td>\r\n";
   }
   //----- unidad
