...
<?php
   ...
   $Ord_Cmp = new grid_semanas_venta_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_semanas_venta_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idgrup"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["idgrup"])) ? $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["idgrup"] : "Grupo/Familia";
   $tab_ger_campos['codigo'] = "on";
   $tab_def_campos['codigo'] = "codigo";
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["descripcion"] : "Descripcion";
   $tab_ger_campos['existencia'] = "on";
   $tab_def_campos['existencia'] = "existencia";
   $tab_labels["existencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["existencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["existencia"] : "Existencia";
   $tab_ger_campos['demanda_semanal'] = "on";
   $tab_def_campos['demanda_semanal'] = "demanda_semanal";
   $tab_labels["demanda_semanal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["demanda_semanal"])) ? $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["demanda_semanal"] : "Demanda Semanal";
   $tab_ger_campos['semanas_venta'] = "on";
   $tab_def_campos['semanas_venta'] = "semanas_venta";
   $tab_labels["semanas_venta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["semanas_venta"])) ? $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["semanas_venta"] : "Semanas Venta";
   $tab_ger_campos['unidad'] = "on";
   $tab_def_campos['unidad'] = "unidad";
   $tab_labels["unidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["unidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['labels']["unidad"] : "Unidad";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_semanas_venta_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_semanas_venta']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
