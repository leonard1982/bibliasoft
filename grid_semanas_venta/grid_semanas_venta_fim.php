...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_semanas_venta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_semanas_venta"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_semanas_venta']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_semanas_venta']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_semanas_venta']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_semanas_venta']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_semanas_venta']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_semanas_venta</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_semanas_venta']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_semanas_venta']['embutida_filho'] as $ind => $sc_init)
          {
