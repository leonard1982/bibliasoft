...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "Codigo";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['contr_label_graf']['codigo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['contr_label_graf']['codigo']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['contr_label_graf']['codigo'];
      }
   }
