...
class grid_semanas_venta_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_demanda_semanal;
   var $array_total_semanas_venta;
   var $array_total_unidad;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_demanda_semanal = array();
      $this->array_total_semanas_venta   = array();
      $this->array_total_unidad          = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_semanas_venta']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_semanas_venta']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_total']['codigo'] = $this->array_total_codigo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_total']['descripcion'] = $this->array_total_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_total']['existencia'] = $this->array_total_existencia;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_total']['demanda_semanal'] = $this->array_total_demanda_semanal;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_total']['semanas_venta'] = $this->array_total_semanas_venta;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_total']['unidad'] = $this->array_total_unidad;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_total']['idgrup'] = $this->array_total_idgrup;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['json_use_label'])
       {
          $Lab_codigo = "codigo";
          $Lab_descripcion = "descripcion";
          $Lab_existencia = "existencia";
          $Lab_demanda_semanal = "demanda_semanal";
          $Lab_semanas_venta = "semanas_venta";
          $Lab_unidad = "unidad";
          $Lab_idgrup = "idgrup";
       }
       else
       ...
       $Lab_descripcion = "Descripcion";
       $Lab_existencia = "Existencia";
       $Lab_demanda_semanal = "Demanda Semanal";
       $Lab_semanas_venta = "Semanas Venta";
       $Lab_unidad = "Unidad";
       $Lab_idgrup = "Grupo/Familia";
       }
       $prep_field = array();
       $prep_field['codigo'] = $Lab_codigo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['codigo'] = $Lab_codigo; 
       $prep_field['descripcion'] = $Lab_descripcion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['descripcion'] = $Lab_descripcion; 
       $prep_field['existencia'] = $Lab_existencia;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['existencia'] = $Lab_existencia; 
       $prep_field['demanda_semanal'] = $Lab_demanda_semanal;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['demanda_semanal'] = $Lab_demanda_semanal; 
       $prep_field['semanas_venta'] = $Lab_semanas_venta;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['semanas_venta'] = $Lab_semanas_venta; 
       $prep_field['unidad'] = $Lab_unidad;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['unidad'] = $Lab_unidad; 
       $prep_field['idgrup'] = $Lab_idgrup;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['idgrup'] = $Lab_idgrup; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['idgrup']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['idgrup'] = "Grupo/Familia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['codigo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['codigo'] = "Codigo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['descripcion'] = "Descripcion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['existencia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['existencia'] = "Existencia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['demanda_semanal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['demanda_semanal'] = "Demanda Semanal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['semanas_venta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['semanas_venta'] = "Semanas Venta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['unidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['labels']['unidad'] = "Unidad"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['demanda_semanal']['alin'] = "''";
       $Arr_parms['demanda_semanal']['link'] = "S";
       $Arr_parms['semanas_venta']['alin'] = "''";
       $Arr_parms['semanas_venta']['link'] = "S";
       $Arr_parms['unidad']['alin'] = "''";
       $Arr_parms['unidad']['link'] = "S";
       ...
       $Arr_parms['descripcion']['fill'] = "true";
       $Arr_parms['descripcion']['order'] = "label";
       $Arr_parms['descripcion']['order_start'] = 'asc';
       $Arr_parms['descripcion']['order_invert'] = 'false';
       $Arr_parms['descripcion']['order_enabled'] = 'false';
       ...
       $Arr_parms['demanda_semanal']['fill'] = "true";
       $Arr_parms['demanda_semanal']['order'] = "label";
       $Arr_parms['demanda_semanal']['order_start'] = 'asc';
       $Arr_parms['demanda_semanal']['order_invert'] = 'false';
       $Arr_parms['demanda_semanal']['order_enabled'] = 'false';
       $Arr_parms['semanas_venta']['fill'] = "true";
       $Arr_parms['semanas_venta']['order'] = "label";
       $Arr_parms['semanas_venta']['order_start'] = 'asc';
       $Arr_parms['semanas_venta']['order_invert'] = 'false';
       $Arr_parms['semanas_venta']['order_enabled'] = 'false';
       $Arr_parms['unidad']['fill'] = "true";
       $Arr_parms['unidad']['order'] = "label";
       $Arr_parms['unidad']['order_start'] = 'asc';
       $Arr_parms['unidad']['order_invert'] = 'false';
       $Arr_parms['unidad']['order_enabled'] = 'false';
       ...
       $prep_links_fl['demanda_semanal'] = array(0 => 'demanda_semanal', 1 => '');
       $prep_links_fl['semanas_venta'] = array(0 => 'semanas_venta', 1 => '');
       $prep_links_fl['unidad'] = array(0 => 'unidad', 1 => '@aspass@');
       $prep_links_fl['idgrup'] = array(0 => 'idgrup', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_semanas_venta@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'field_x'  => 'descripcion',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_descripcion)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           'demanda_semanal' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'demanda_semanal',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_demanda_semanal)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'semanas_venta',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_semanas_venta)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'field_x'  => 'unidad',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_unidad)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_semanas_venta_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_semanas_venta_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_semanas_venta_total.class.php"); 
      }
      ...
      $this->Total   = new grid_semanas_venta_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_semanas_venta/grid_semanas_venta_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_semanas_venta_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_semanas_venta_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_semanas_venta_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_semanas_venta/grid_semanas_venta_config_graf_flash.php?nome_apl=grid_semanas_venta&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_semanas_venta_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_semanas_venta']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_semanas_venta']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_semanas_venta_config_pivot.php?nome_apl=grid_semanas_venta&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_semanas_venta/grid_semanas_venta_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_semanas_venta_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_semanas_venta/grid_semanas_venta_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          if ($tmp_pos !== false && !is_array($codigo))
          {
          ...
          $existencia_2 = $Busca_temp['existencia_input_2']; 
          $demanda_semanal = $Busca_temp['demanda_semanal']; 
          $tmp_pos = strpos($demanda_semanal, "##@@");
          if ($tmp_pos !== false && !is_array($demanda_semanal))
          {
              $demanda_semanal = substr($demanda_semanal, 0, $tmp_pos);
          }
          $demanda_semanal_2 = $Busca_temp['demanda_semanal_input_2']; 
          $semanas_venta = $Busca_temp['semanas_venta']; 
          $tmp_pos = strpos($semanas_venta, "##@@");
          if ($tmp_pos !== false && !is_array($semanas_venta))
          {
   ...
   //---- 
   function adiciona_registro($quebra_codigo, $quebra_descripcion, $quebra_existencia, $quebra_demanda_semanal, $quebra_semanas_venta, $quebra_unidad, $quebra_idgrup, $quebra_codigo_orig, $quebra_descripcion_orig, $quebra_existencia_orig, $quebra_demanda_semanal_orig, $quebra_semanas_venta_orig, $quebra_unidad_orig, $quebra_idgrup_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_semanas_venta']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->codigo = $rs_res->fields[1] ;  
            $this->descripcion = $rs_res->fields[2] ;  
            $this->existencia = $rs_res->fields[3] ;  
            $this->existencia =  str_replace(",", ".", $this->existencia);
            $this->demanda_semanal = $rs_res->fields[4] ;  
            $this->semanas_venta = $rs_res->fields[5] ;  
            $this->unidad = $rs_res->fields[6] ;  
            $this->codigo_orig = $this->codigo;
            $this->descripcion_orig = $this->descripcion;
            $this->existencia_orig = $this->existencia;
            $this->demanda_semanal_orig = $this->demanda_semanal;
            $this->semanas_venta_orig = $this->semanas_venta;
            $this->unidad_orig = $this->unidad;
            $this->idgrup_orig = $this->idgrup;
            nmgp_Form_Num_Val($this->existencia, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "0", "S", "2", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
            nmgp_Form_Num_Val($this->demanda_semanal, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            nmgp_Form_Num_Val($this->semanas_venta, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->codigo, $this->descripcion, $this->existencia, $this->demanda_semanal, $this->semanas_venta, $this->unidad, $this->idgrup, $this->codigo_orig,  $this->descripcion_orig,  $this->existencia_orig,  $this->demanda_semanal_orig,  $this->semanas_venta_orig,  $this->unidad_orig,  $this->idgrup_orig);
            }
   }
//
