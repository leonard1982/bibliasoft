<?php
class pdfreport_caja_1_280819_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_caja_1_280819']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_caja_1_280819", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_pesq_filtro'];
   $_SESSION['scriptcase']['pdfreport_caja_1_280819']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['pdfreport_caja_1_280819']['contr_erro'] = 'off'; 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_caja_1_280819']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_caja_1_280819']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_caja_1_280819']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_caja_1_280819']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_pesq'];  
//----- 
   ...
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['fecha'] = "Fecha";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['cantidad'] = "Cantidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['cheques'] = "cheques";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['efectivo'] = "efectivo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['facturado'] = "facturado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['rango'] = "rango";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['tarjeta'] = "tarjeta";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['prueba'] = "prueba";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['nfac'] = "nfac";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['totventa'] = "totventa";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['credito'] = "credito";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['retefuente'] = "retefuente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['reteica'] = "reteica";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['reteiva'] = "reteiva";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['cree'] = "cree";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['tot_rete'] = "tot_rete";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['ajuste'] = "ajuste";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['iva_19'] = "iva_19";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['iva_5'] = "iva_5";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['iva_0'] = "iva_0";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['tot_iva'] = "tot_iva";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['tot_base'] = "tot_base";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['base19'] = "base19";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['base5'] = "base5";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['base0'] = "base0";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['imp_consumo'] = "imp_consumo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['tot_impoconsumo'] = "tot_impoconsumo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['imp_bolsa'] = "imp_bolsa";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['labels']['descuentos'] = "descuentos";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_caja_1_280819']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_caja_1_280819']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_caja_1_280819']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf->AddPage();
      $this->Pdf_init();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_caja_1_280819']['qt_col_grid']) 
      {  
...
$this->facturado[$this->nm_grid_colunas] =$this->ds_fv[$this->nm_grid_colunas][0][0];
      ...
      $nm_select = "SELECT COUNT(*) from facturaven where banco=$this->sc_temp_elbanco and fechaven='$this->sc_temp_lafecha' ORDER BY idfacven "; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
$_SESSION['scriptcase']['pdfreport_caja_1_280819']['contr_erro'] = 'off';
          ...
          $this->descuentos[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->descuentos[$this->nm_grid_colunas]);
            $cell_22 = array('posx' => 80, 'posy' => 20, 'data' => $this->fecha[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_facturado = array('posx' => 80, 'posy' => 50, 'data' => $this->facturado[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_rango = array('posx' => 10, 'posy' => 30, 'data' => $this->rango[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_efectivo = array('posx' => 80, 'posy' => 70, 'data' => $this->efectivo[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_tarjeta = array('posx' => 80, 'posy' => 80, 'data' => $this->tarjeta[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_cheques = array('posx' => 80, 'posy' => 90, 'data' => $this->cheques[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_et_fac = array('posx' => 10, 'posy' => 50, 'data' => $this->SC_conv_utf8('VALOR FACTURADO: '), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_for_pag = array('posx' => 10, 'posy' => 60, 'data' => $this->SC_conv_utf8('--DETALLE FORMAS DE PAGO--'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_efec = array('posx' => 10, 'posy' => 70, 'data' => $this->SC_conv_utf8('EN EFECTIVO:'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_tarj = array('posx' => 10, 'posy' => 80, 'data' => $this->SC_conv_utf8('CON TARJETA D ó C:'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_che = array('posx' => 10, 'posy' => 90, 'data' => $this->SC_conv_utf8('CHEQUE U OTRAS:'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_et_tot_fp = array('posx' => 10, 'posy' => 110, 'data' => $this->SC_conv_utf8('TOTAL FORMAS DE PAGO:'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_tot_fp = array('posx' => 80, 'posy' => 110, 'data' => $this->totventa[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_et_fech = array('posx' => 10, 'posy' => 20, 'data' => $this->SC_conv_utf8('FECHA DEL COMPROBANTE:'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_38 = array('posx' => 10, 'posy' => 10, 'data' => $this->SC_conv_utf8('COMPROBANTE INFORME DIARIO'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_39 = array('posx' => 10, 'posy' => 40, 'data' => $this->SC_conv_utf8('NÚMERO DE FACTURAS:'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_40 = array('posx' => 65, 'posy' => 105, 'data' => $this->SC_conv_utf8('----------------------'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_nfac = array('posx' => 80, 'posy' => 40, 'data' => $this->nfac[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_credito = array('posx' => 80, 'posy' => 100, 'data' => $this->credito[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_45 = array('posx' => 10, 'posy' => 100, 'data' => $this->SC_conv_utf8('A CREDITO:'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_retefuente = array('posx' => 80, 'posy' => 130, 'data' => $this->retefuente[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_reteica = array('posx' => 80, 'posy' => 140, 'data' => $this->reteica[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_48 = array('posx' => 10, 'posy' => 120, 'data' => $this->SC_conv_utf8('--RETENCIONES--'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_49 = array('posx' => 10, 'posy' => 130, 'data' => $this->SC_conv_utf8('RETENCIÓN EN LA FUENTE:'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_50 = array('posx' => '0', 'posy' => 140, 'data' => $this->SC_conv_utf8('RETENCIÓN ICA:'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_51 = array('posx' => 80, 'posy' => 150, 'data' => $this->reteiva[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_52 = array('posx' => 80, 'posy' => 180, 'data' => $this->cree[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_reteiva = array('posx' => 10, 'posy' => 150, 'data' => $this->SC_conv_utf8('RETE IVA:'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_cree = array('posx' => 10, 'posy' => 180, 'data' => $this->SC_conv_utf8('AUTO RETENCIÓN:'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_tot_rete = array('posx' => 80, 'posy' => 170, 'data' => $this->tot_rete[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_ajuste = array('posx' => 80, 'posy' => 160, 'data' => $this->ajuste[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_57 = array('posx' => 65, 'posy' => 165, 'data' => $this->SC_conv_utf8('----------------------'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_58 = array('posx' => 10, 'posy' => 160, 'data' => $this->SC_conv_utf8('AJUSTE:'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_59 = array('posx' => 10, 'posy' => 170, 'data' => $this->SC_conv_utf8('TOTAL RETENCIONES:'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_96 = array('posx' => 80, 'posy' => 85, 'data' => date('d/m/Y'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_97 = array('posx' => 10, 'posy' => 100, 'data' => $this->SC_conv_utf8('FACILWEB - www.solucionesnavarro.com'), 'width'      => 0, 'align'      => 'C', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $this->Pdf->SetFont($cell_retefuente['font_type'], $cell_retefuente['font_style'], $cell_retefuente['font_size']);
            $this->pdf_text_color($cell_retefuente['data'], $cell_retefuente['color_r'], $cell_retefuente['color_g'], $cell_retefuente['color_b']);
            if (!empty($cell_retefuente['posx']) && !empty($cell_retefuente['posy']))
            {
                $this->Pdf->SetXY($cell_retefuente['posx'], $cell_retefuente['posy']);
            }
            elseif (!empty($cell_retefuente['posx']))
            {
                $this->Pdf->SetX($cell_retefuente['posx']);
            }
            elseif (!empty($cell_retefuente['posy']))
            {
                $this->Pdf->SetY($cell_retefuente['posy']);
            }
            $this->Pdf->Cell($cell_retefuente['width'], 0, $cell_retefuente['data'], 0, 0, $cell_retefuente['align']);

            $this->Pdf->SetFont($cell_reteica['font_type'], $cell_reteica['font_style'], $cell_reteica['font_size']);
            $this->pdf_text_color($cell_reteica['data'], $cell_reteica['color_r'], $cell_reteica['color_g'], $cell_reteica['color_b']);
            if (!empty($cell_reteica['posx']) && !empty($cell_reteica['posy']))
            {
                $this->Pdf->SetXY($cell_reteica['posx'], $cell_reteica['posy']);
            }
            elseif (!empty($cell_reteica['posx']))
            {
                $this->Pdf->SetX($cell_reteica['posx']);
            }
            elseif (!empty($cell_reteica['posy']))
            {
                $this->Pdf->SetY($cell_reteica['posy']);
            }
            $this->Pdf->Cell($cell_reteica['width'], 0, $cell_reteica['data'], 0, 0, $cell_reteica['align']);
            ...
            $this->Pdf->SetFont($cell_cree['font_type'], $cell_cree['font_style'], $cell_cree['font_size']);
            $this->pdf_text_color($cell_cree['data'], $cell_cree['color_r'], $cell_cree['color_g'], $cell_cree['color_b']);
            if (!empty($cell_cree['posx']) && !empty($cell_cree['posy']))
            {
                $this->Pdf->SetXY($cell_cree['posx'], $cell_cree['posy']);
            }
            elseif (!empty($cell_cree['posx']))
            {
                $this->Pdf->SetX($cell_cree['posx']);
            }
            elseif (!empty($cell_cree['posy']))
            {
                $this->Pdf->SetY($cell_cree['posy']);
            }
            $this->Pdf->Cell($cell_cree['width'], 0, $cell_cree['data'], 0, 0, $cell_cree['align']);

            $this->Pdf->SetFont($cell_tot_rete['font_type'], $cell_tot_rete['font_style'], $cell_tot_rete['font_size']);
            $this->pdf_text_color($cell_tot_rete['data'], $cell_tot_rete['color_r'], $cell_tot_rete['color_g'], $cell_tot_rete['color_b']);
            if (!empty($cell_tot_rete['posx']) && !empty($cell_tot_rete['posy']))
            {
                $this->Pdf->SetXY($cell_tot_rete['posx'], $cell_tot_rete['posy']);
            }
            elseif (!empty($cell_tot_rete['posx']))
            {
                $this->Pdf->SetX($cell_tot_rete['posx']);
            }
            elseif (!empty($cell_tot_rete['posy']))
            {
                $this->Pdf->SetY($cell_tot_rete['posy']);
            }
            $this->Pdf->Cell($cell_tot_rete['width'], 0, $cell_tot_rete['data'], 0, 0, $cell_tot_rete['align']);

            $this->Pdf->SetFont($cell_ajuste['font_type'], $cell_ajuste['font_style'], $cell_ajuste['font_size']);
            $this->pdf_text_color($cell_ajuste['data'], $cell_ajuste['color_r'], $cell_ajuste['color_g'], $cell_ajuste['color_b']);
            if (!empty($cell_ajuste['posx']) && !empty($cell_ajuste['posy']))
            {
                $this->Pdf->SetXY($cell_ajuste['posx'], $cell_ajuste['posy']);
            }
            elseif (!empty($cell_ajuste['posx']))
            {
                $this->Pdf->SetX($cell_ajuste['posx']);
            }
            elseif (!empty($cell_ajuste['posy']))
            {
                $this->Pdf->SetY($cell_ajuste['posy']);
            }
            $this->Pdf->Cell($cell_ajuste['width'], 0, $cell_ajuste['data'], 0, 0, $cell_ajuste['align']);
