<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_caja_1_280819']['sc_process_barr'] = true;
require_once('../pdfreport_caja_1_280819/index.php');
unset($_SESSION['scriptcase']['pdfreport_caja_1_280819']['sc_process_barr']);
$ExportCtrl = new pdfreport_caja_1_280819_export_control;
$ExportCtrl->Export_barr();

class pdfreport_caja_1_280819_export_control
{
