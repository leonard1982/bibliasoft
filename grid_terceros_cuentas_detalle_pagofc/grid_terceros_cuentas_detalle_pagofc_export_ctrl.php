<?php
@session_start() ;
$_SESSION['scriptcase']['grid_terceros_cuentas_detalle_pagofc']['sc_process_barr'] = true;
require_once('../grid_terceros_cuentas_detalle_pagofc/index.php');
unset($_SESSION['scriptcase']['grid_terceros_cuentas_detalle_pagofc']['sc_process_barr']);
$ExportCtrl = new grid_terceros_cuentas_detalle_pagofc_export_control;
$ExportCtrl->Export_barr();

class grid_terceros_cuentas_detalle_pagofc_export_control
{
