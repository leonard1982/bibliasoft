...
//
   ...
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['mostra_edit'] = "N";
   }
        ...
        if($filter_type == 'advanced_search')
        {
            ...
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    ...
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['campos_busca'][ $field ], '/');
        ...
        elseif($filter_type == 'quicksearch')
        {
            ...
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['fast_search'][1] == 'qp')
                {
                    ...
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
