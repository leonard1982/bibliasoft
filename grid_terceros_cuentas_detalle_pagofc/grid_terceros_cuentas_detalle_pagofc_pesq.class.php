...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tercero" name="tercero_autocomp" size="60" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tipo'])) ? $this->New_label['tipo'] : "Tipo"; ?></TD>
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['concepto'])) ? $this->New_label['concepto'] : "Concepto"; ?></TD>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_usuario" name="usuario_autocomp" size="60" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['pagada'])) ? $this->New_label['pagada'] : "Pagada"; ?></TD>
...
<?php
 ...
 <OPTION value="SI##@@SI"<?php if ($pagada == "SI") { echo " selected" ;} ?>>SI</option>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['asentada'])) ? $this->New_label['asentada'] : "Asentada"; ?></TD>
   ...
   function trata_campos()
   {
      ...
      if (is_array($tipo)) {
          foreach ($tipo as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['psq_check_ret']['tipo'])) {
      ...
      if (is_array($concepto)) {
          foreach ($concepto as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['psq_check_ret']['concepto'])) {
