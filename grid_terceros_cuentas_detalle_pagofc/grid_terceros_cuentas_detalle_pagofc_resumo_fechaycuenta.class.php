...
class grid_terceros_cuentas_detalle_pagofc_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['arr_total']['fecha'];
          $this->array_total_cod_cuenta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['arr_total']['cod_cuenta'];
      }
      else
      {
          $this->array_total_fecha = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['summarizing_fields_order']['fechaycuenta']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['summarizing_fields_order']['fechaycuenta'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['summarizing_fields_order']['fechaycuenta'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['summarizing_fields_display']['fechaycuenta'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['summarizing_fields_display']['fechaycuenta'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['summarizing_fields_display']['fechaycuenta'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['summarizing_fields_display']['fechaycuenta'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['summarizing_fields_display']['fechaycuenta'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['summarizing_fields_display']['fechaycuenta'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['summarizing_fields_display']['fechaycuenta'] as $i_sum => $d_sum)
           {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_detalle_pagofc']['pivot_order_level'] = -1;
       }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $_SESSION['scriptcase']['grid_terceros_cuentas_detalle_pagofc']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['grid_terceros_cuentas_detalle_pagofc']['contr_erro'] = 'off'; 
