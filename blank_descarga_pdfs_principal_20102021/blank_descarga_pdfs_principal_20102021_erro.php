...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['blank_descarga_pdfs_principal_20102021']['contr_erro']) && $_SESSION['scriptcase']['blank_descarga_pdfs_principal_20102021']['contr_erro'] == 'on')
    {
