<?php
//
class form_productos_060522_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_productos_060522']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_productos_060522']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->gnit)) 
          {
              $_SESSION['gnit'] = $this->gnit;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_productos_060522']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_productos_060522']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_productos_060522_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['initialize'])
          {
              $_SESSION['scriptcase']['form_productos_060522']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_productos_060522']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['upload_field_info']['imagen'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_productos_060522',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_productos_060522']['upload_field_info']['imagenprod'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_productos_060522',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['sc_modal']))
      {
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_productos_060522']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_productos_060522'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_productos_060522']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_productos_060522']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_productos_060522') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_productos_060522']['label'] = "Editar producto";
      ...
      $_SESSION['scriptcase']['error_icon']['form_productos_060522']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_productos_060522'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['upload_field_ul_name'][$this->imagen_ul_name]))
          {
              $this->NM_ajax_info['param']['imagen_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['upload_field_ul_name'][$this->imagen_ul_name];
          }
      ...
      elseif (isset($this->imagen_ul_name) && '' != $this->imagen_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['upload_field_ul_name'][$this->imagen_ul_name]))
          {
              $this->imagen_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['upload_field_ul_name'][$this->imagen_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_060522']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_productos_060522'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_productos_060522'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_productos_060522", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_productos_060522_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_productos_060522_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_productos_060522/form_productos_060522_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_productos_060522_erro.class.php"); 
      }
      $this->Erro      = new form_productos_060522_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opcao']))
         { 
             if ($this->idprod != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_060522']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['botoes']['sc_btn_0'];
          $this->nmgp_botoes['sc_btn_1'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['botoes']['sc_btn_1'];
          $this->nmgp_botoes['sc_btn_2'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['botoes']['sc_btn_2'];
          $this->nmgp_botoes['escalas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['botoes']['escalas'];
          $this->nmgp_botoes['recalcular'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['botoes']['recalcular'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['final'];
      }
      else
      {
      }
...
$_SESSION['scriptcase']['form_productos_060522']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_productos_060522']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_productos_060522']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select'];
     }
   }
...
//
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idpro1']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idpro1'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idpro1']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idpro1'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_productos_060522_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_productos_060522_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idpro1'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idpro2']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idpro2'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idpro2']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idpro2'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idpro2'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidad_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidad_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidad_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidad_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidad_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidad_ma']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidad_ma'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidad_ma']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidad_ma'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidad_ma'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['unimay']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->unimay = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['unimay'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['costomay']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->costomay = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['costomay'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['recmayamen']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->recmayamen = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['recmayamen'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['preciofull']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->preciofull = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['preciofull'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['precio2']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->precio2 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['precio2'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['preciomay']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->preciomay = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['preciomay'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['stockmen']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->stockmen = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']['stockmen'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_productos_060522.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_productos_060522_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_productos_060522"> 
...
<?php
include_once("form_productos_060522_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->idprod) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['idprod']))
          {
              $varloc_btn_php['idprod'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['idprod'];
          }
          if (!isset($this->unidmaymen) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['unidmaymen']))
          {
              $varloc_btn_php['unidmaymen'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['unidmaymen'];
          }
          if (!isset($this->recmayamen) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['recmayamen']))
          {
              $varloc_btn_php['recmayamen'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['recmayamen'];
          }
          if (!isset($this->multiple_escala) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['multiple_escala']))
          {
              $varloc_btn_php['multiple_escala'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['multiple_escala'];
          }
          if (!isset($this->idprod) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['idprod']))
          {
              $varloc_btn_php['idprod'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['idprod'];
          ...
          if (!isset($this->existencia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['existencia']))
          {
              $varloc_btn_php['existencia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['existencia'];
          }
          if (!isset($this->existencia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['existencia']))
          {
              $varloc_btn_php['existencia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form']['existencia'];
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_productos_060522']) || !is_array($this->NM_ajax_info['errList']['geral_form_productos_060522']))
              {
                  $this->NM_ajax_info['errList']['geral_form_productos_060522'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_productos_060522'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if(isset($this->dat_conf[0][0]))
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_productos_060522';
...
$_SESSION['scriptcase']['form_productos_060522']['contr_erro'] = 'off'; 
    ...
    function ValidateField_codigoprod(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['codigoprod']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['codigoprod'] == "on")) 
      { 
          if ($this->codigoprod == "")  
          { 
              $hasError = true;
...
;
    ...
    function ValidateField_codigobar(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['codigobar']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['codigobar'] == "on")) 
      { 
          if ($this->codigobar == "")  
          { 
              $hasError = true;
...
;
    ...
    function ValidateField_nompro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['nompro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['nompro'] == "on")) 
      { 
          if ($this->nompro == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_idgrup(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idgrup == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['idgrup']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['idgrup'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idgrup) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idgrup']) && !in_array($this->idgrup, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idgrup']))
          {
              $hasError = true;
    ...
    function ValidateField_idpro1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['idpro1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['idpro1'] == "on")) 
      { 
          if ($this->idpro1 == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_tipo_producto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->tipo_producto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_tipo_producto']) && !in_array($this->tipo_producto, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_tipo_producto']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_precio_editable(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['precio_editable']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['precio_editable'] == "on")
        { 
          $hasError = true;
    ...
    function ValidateField_maneja_tcs_lfs(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_maneja_tcs_lfs']) && !in_array($this->maneja_tcs_lfs, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_maneja_tcs_lfs']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_unidmaymen(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->unidmaymen != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidmaymen']) && !in_array($this->unidmaymen, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidmaymen']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_unimen(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['unimen']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['unimen'] == "on")) 
      { 
          if ($this->unimen == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_multiple_escala(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_multiple_escala']) && !in_array($this->multiple_escala, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_multiple_escala']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_en_base_a(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->en_base_a != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_en_base_a']) && !in_array($this->en_base_a, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_en_base_a']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idiva(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idiva) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idiva']) && !in_array($this->idiva, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idiva']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_activo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->activo != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_activo']) && !in_array($this->activo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_activo']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_control_costo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_control_costo']) && !in_array($this->control_costo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_control_costo']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cod_cuenta(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cod_cuenta) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_cod_cuenta']) && !in_array($this->cod_cuenta, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_cod_cuenta']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_marca(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_marca) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_id_marca']) && !in_array($this->id_marca, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_id_marca']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_linea(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_linea) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_id_linea']) && !in_array($this->id_linea, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_id_linea']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_productos_060522_doc_name.php';
              }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idprod']['keyVal'] = form_productos_060522_pack_protect_string($this->nmgp_dados_form['idprod']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idgrup']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idgrup'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idgrup']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idgrup'] = array(); 
}
$aLookup[] = array(form_productos_060522_pack_protect_string('') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string('Seleccione familia o grupo')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idgrup'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idgrup'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idgrup']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_productos_060522_pack_protect_string(NM_charset_to_utf8($this->idpro1))]) ? $aLookup[0][form_productos_060522_pack_protect_string(NM_charset_to_utf8($this->idpro1))] : "";
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_tipo_producto']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_tipo_producto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_tipo_producto']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_tipo_producto'] = array(); 
}
$aLookup[] = array(form_productos_060522_pack_protect_string('') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_tipo_producto'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_tipo_producto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_producto']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_productos_060522_pack_protect_string(NM_charset_to_utf8($this->idpro2))]) ? $aLookup[0][form_productos_060522_pack_protect_string(NM_charset_to_utf8($this->idpro2))] : "";
...
$aLookup[] = array(form_productos_060522_pack_protect_string('0') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("No")));
$aLookup[] = array(form_productos_060522_pack_protect_string('1') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("Sí")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_otro'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_otro'][] = '1';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"otro\"";
          ...
          {
              $this->NM_ajax_info['fldList']['otro']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('NO') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("NO")));
$aLookup[] = array(form_productos_060522_pack_protect_string('SI') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_precio_editable'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_precio_editable'][] = 'SI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['precio_editable']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('NA') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("No Aplica")));
$aLookup[] = array(form_productos_060522_pack_protect_string('CTS') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("Color, Talla y Sabor")));
$aLookup[] = array(form_productos_060522_pack_protect_string('LFS') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("Lote, F. Vencimiento, Serial")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_maneja_tcs_lfs'][] = 'NA';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_maneja_tcs_lfs'][] = 'CTS';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_maneja_tcs_lfs'][] = 'LFS';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['maneja_tcs_lfs']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('NO') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("NO")));
$aLookup[] = array(form_productos_060522_pack_protect_string('SI') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidmaymen'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidmaymen'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['unidmaymen']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_productos_060522_pack_protect_string(NM_charset_to_utf8($this->unidad_ma))]) ? $aLookup[0][form_productos_060522_pack_protect_string(NM_charset_to_utf8($this->unidad_ma))] : "";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_productos_060522_pack_protect_string(NM_charset_to_utf8($this->unidad_))]) ? $aLookup[0][form_productos_060522_pack_protect_string(NM_charset_to_utf8($this->unidad_))] : "";
...
$aLookup[] = array(form_productos_060522_pack_protect_string('NO') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("NO")));
$aLookup[] = array(form_productos_060522_pack_protect_string('SI') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_multiple_escala'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_multiple_escala'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['multiple_escala']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('UMAY') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("UNIDAD MAYOR")));
$aLookup[] = array(form_productos_060522_pack_protect_string('UMEN') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("UNIDAD")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_en_base_a'][] = 'UMAY';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_en_base_a'][] = 'UMEN';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['en_base_a']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idiva']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idiva'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idiva']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idiva'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_idiva'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idiva']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('SI') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("SI")));
$aLookup[] = array(form_productos_060522_pack_protect_string('NO') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_activo'][] = 'SI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_activo'][] = 'NO';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['activo']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('NO') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("NO")));
$aLookup[] = array(form_productos_060522_pack_protect_string('SI') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_colores'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_colores'][] = 'SI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['colores']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('NO') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("NO")));
$aLookup[] = array(form_productos_060522_pack_protect_string('SI') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_tallas'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_tallas'][] = 'SI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tallas']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('NO') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("NO")));
$aLookup[] = array(form_productos_060522_pack_protect_string('SI') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_sabores'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_sabores'][] = 'SI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['sabores']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('NO') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("NO")));
$aLookup[] = array(form_productos_060522_pack_protect_string('SI') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_fecha_vencimiento'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_fecha_vencimiento'][] = 'SI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['fecha_vencimiento']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('NO') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("NO")));
$aLookup[] = array(form_productos_060522_pack_protect_string('SI') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_lote'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_lote'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"lote\"";
          ...
          {
              $this->NM_ajax_info['fldList']['lote']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('NO') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("NO")));
$aLookup[] = array(form_productos_060522_pack_protect_string('SI') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_serial_codbarras'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_serial_codbarras'][] = 'SI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['serial_codbarras']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('NA') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("No Aplica")));
$aLookup[] = array(form_productos_060522_pack_protect_string('UC') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("Último Costo")));
$aLookup[] = array(form_productos_060522_pack_protect_string('CP') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("Costo Promedio")));
$aLookup[] = array(form_productos_060522_pack_protect_string('PC') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("Porcentaje utilidad %")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_control_costo'][] = 'NA';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_control_costo'][] = 'UC';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_control_costo'][] = 'CP';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_control_costo'][] = 'PC';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['control_costo']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string('SELECCIONE')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_cod_cuenta'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cod_cuenta']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_id_marca'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_marca']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_id_linea'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_linea']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_productos_060522_pack_protect_string('SI') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("SI")));
$aLookup[] = array(form_productos_060522_pack_protect_string('NO') => str_replace('<', '&lt;',form_productos_060522_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_para_registro_fe'][] = 'SI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_para_registro_fe'][] = 'NO';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['para_registro_fe']['valList'][$i] = form_productos_060522_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->idprod)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
$_SESSION['scriptcase']['form_productos_060522']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['imagen_salva'] = array(
                      'row'     => '',
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_productos_060522']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['parms'] = "idprod?#?$this->idprod?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter'] . ")";
          }
      }
//------------ 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_productos_060522 = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['total'] = $qt_geral_reg_form_productos_060522;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idprod))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_productos_060522 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] > $qt_geral_reg_form_productos_060522)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] = $qt_geral_reg_form_productos_060522; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_productos_060522) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['escalas'] = $this->nmgp_botoes['escalas'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['recalcular'] = $this->nmgp_botoes['recalcular'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['parms'] = "idprod?#?$this->idprod?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['sub_dir'][0]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['sub_dir'][1]  = "/" . $_SESSION['gnit'] . "/";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] < $qt_geral_reg_form_productos_060522;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_clone']['imagenprod']);  
              }
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_select'];
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dados_clone']['imagenprod'] = $this->nmgp_dados_select['imagenprod'];  
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out1_imagen))
       {
        ...
        $this->initFormPages();
        include_once("form_productos_060522_form0.php");
        include_once("form_productos_060522_form1.php");
        $this->hideFormPages();
 }
...
<?php
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_productos_060522 = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['total'] = $qt_geral_reg_form_productos_060522;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_productos_060522_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_productos_060522_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_productos_060522_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['masterValue']))
{
