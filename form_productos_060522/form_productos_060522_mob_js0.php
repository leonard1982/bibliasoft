...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_productos_060522_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_recalcular_ok()
{
    ...
    document.F1.action = "form_productos_060522_mob.php";
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522_mob']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522_mob']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522_mob']['where_detal']))
  {
?>  
...
{
    NovaJanela = window.open ("form_productos_060522_mob_help.php?nm_cod_campo=" + campo + "&language=<?php echo $this->Ini->path_lang . $this->Ini->str_lang?>&help_css=<?php echo '../_lib/css/' . $this->Ini->str_schema_all . '_form.css'; ?>", "ScriptCase", "height=100, width=300, resizable, scrollbars");
}
...
{
    document.getElementById('form_productos_060522_mob_form0').style.width='1px';
    document.getElementById('form_productos_060522_mob_form0').style.height='0px';
    document.getElementById('form_productos_060522_mob_form0').style.display='none';
    document.getElementById('form_productos_060522_mob_form0').style.overflow='scroll';
    document.getElementById('form_productos_060522_mob_form1').style.width='1px';
    document.getElementById('form_productos_060522_mob_form1').style.height='0px';
    document.getElementById('form_productos_060522_mob_form1').style.display='none';
    document.getElementById('form_productos_060522_mob_form1').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522_mob']['pdf_view']) {
?>
...
?>
    ...
    displayChange_page(pag_ativa.substr(30), 'off');
    pag_ativa = N_pagina;
    sc_tab_pag(pag_ativa, 'scTabActive');
    displayChange_page(pag_ativa.substr(30), 'on');
}
