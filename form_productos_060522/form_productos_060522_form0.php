...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_productos_060522/form_productos_060522_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_productos_060522_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-idpro1", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "idpro1" != sId ? sId.substr(6) : "";
   sc_form_productos_060522_idpro1_onfocus("id_sc_field_" + sId, sRow);
  ...
  $(".sc-ui-autocomp-idpro2", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "idpro2" != sId ? sId.substr(6) : "";
   sc_form_productos_060522_idpro2_onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
  ...
  $(".sc-ui-autocomp-unidad_", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "unidad_" != sId ? sId.substr(7) : "";
   sc_form_productos_060522_unidad__onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
  ...
  $(".sc-ui-autocomp-unidad_ma", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "unidad_ma" != sId ? sId.substr(9) : "";
   sc_form_productos_060522_unidad_ma_onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_productos_060522_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_productos_060522'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_productos_060522'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['sc_btn_0']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['sc_btn_0']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['sc_btn_0']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['sc_btn_0']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['sc_btn_0'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['sc_btn_1']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['sc_btn_1']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['sc_btn_1']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['sc_btn_1']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['sc_btn_1'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['sc_btn_2']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['sc_btn_2']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['sc_btn_2']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['sc_btn_2']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['sc_btn_2'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['escalas']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['escalas']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['escalas']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['escalas']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['escalas'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['recalcular']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['recalcular']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['recalcular']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['recalcular']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['recalcular'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['copy']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['copy']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['copy']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['copy']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['copy'];
        }
?>
...
<?php 
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
?>
<script type="text/javascript">
var pag_ativa = "form_productos_060522_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_productos_060522_form0' => array(
            'title' => "General",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_productos_060522_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_productos_060522_form1' => array(
            'title' => "Contabilidad y Otros",
            'class' => $nmgp_num_form == "form_productos_060522_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('General' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_productos_060522_form0']['class'] = 'scTabInactive';
                        }
                        if ('Contabilidad y Otros' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_productos_060522_form1']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_productos_060522_form0"]['class'];
?>
   <li id="id_form_productos_060522_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_productos_060522_form0')">
     <img src="<?php echo $this->Ini->path_icones ?>/scriptcase__NM__ico__NM__about_32.png" align="absmiddle">
     General
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_productos_060522_form1"]['class'];
?>
   <li id="id_form_productos_060522_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_productos_060522_form1')">
...
<div id="form_productos_060522_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codigoprod_label" id="hidden_field_label_codigoprod" style="<?php echo $sStyleHidden_codigoprod; ?>"><span id="id_label_codigoprod"><?php echo $this->nm_new_label['codigoprod']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['codigoprod']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['codigoprod'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codigobar_label" id="hidden_field_label_codigobar" style="<?php echo $sStyleHidden_codigobar; ?>"><span id="id_label_codigobar"><?php echo $this->nm_new_label['codigobar']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['codigobar']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['codigobar'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nompro_label" id="hidden_field_label_nompro" style="<?php echo $sStyleHidden_nompro; ?>"><span id="id_label_nompro"><?php echo $this->nm_new_label['nompro']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['nompro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['nompro'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idgrup_label" id="hidden_field_label_idgrup" style="<?php echo $sStyleHidden_idgrup; ?>"><span id="id_label_idgrup"><?php echo $this->nm_new_label['idgrup']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['idgrup']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['idgrup'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php
   ...
   if (isset($this->Ini->sc_lig_md5["form_grupo"]) && $this->Ini->sc_lig_md5["form_grupo"] == "S") {
       $Parms_Lig  = "nm_evt_ret_edit*scindo_ajax_form_productos_060522_lkpedt_refresh_idgrup*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
       ...
       $Md5_Lig  = "nm_evt_ret_edit*scindo_ajax_form_productos_060522_lkpedt_refresh_idgrup*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
   }
 ?><?php echo nmButtonOutput($this->arr_buttons, "bform_lookuplink", "", "", "fldedt_idgrup", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->link_form_grupo_edit . "?script_case_init=" . $this->Ini->sc_page . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=form_productos_060522&KeepThis=true&TB_iframe=true&height=400&width=800&modal=true", "");?>
<?php    echo "</span>";
?> 
<?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idpro1_label" id="hidden_field_label_idpro1" style="<?php echo $sStyleHidden_idpro1; ?>"><span id="id_label_idpro1"><?php echo $this->nm_new_label['idpro1']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['idpro1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['idpro1'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php
   if (isset($this->Ini->sc_lig_md5["terceros"]) && $this->Ini->sc_lig_md5["terceros"] == "S") {
       $Parms_Lig  = "nm_evt_ret_edit*scindo_ajax_form_productos_060522_lkpedt_refresh_idpro1*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_productos_060522@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nm_evt_ret_edit*scindo_ajax_form_productos_060522_lkpedt_refresh_idpro1*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
   }
?>
<?php if (!$this->Ini->Export_img_zip) { ?><?php echo nmButtonOutput($this->arr_buttons, "bform_lookuplink", "", "", "fldedt_idpro1", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->link_terceros_edit . "?script_case_init=" . $this->Ini->sc_page . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=form_productos_060522&KeepThis=true&TB_iframe=true&height=400&width=1200&modal=true", "");?>
<?php } ?></span><?php } ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_otro'][] = '0'; ?>
 <option  value="1" <?php  if ($this->otro == "1") { echo " selected" ;} ?>>Sí</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_otro'][] = '1'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_precio_editable_label" id="hidden_field_label_precio_editable" style="<?php echo $sStyleHidden_precio_editable; ?>"><span id="id_label_precio_editable"><?php echo $this->nm_new_label['precio_editable']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['precio_editable']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['precio_editable'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_precio_editable'][] = 'NO'; ?>
 <option  value="SI" <?php  if ($this->precio_editable == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_precio_editable'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_maneja_tcs_lfs'][] = 'NA'; ?>
<?php  if ("NA" == $this->maneja_tcs_lfs)  { echo " checked" ;} ?><?php  if (empty($this->maneja_tcs_lfs)) { echo " checked" ;} ?>  onClick="do_ajax_form_productos_060522_event_maneja_tcs_lfs_onclick();" ><label for="<?php echo $tempOptionId ?>">No Aplica</label></TD>
</TR>
<TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_maneja_tcs_lfs'][] = 'CTS'; ?>
<?php  if ("CTS" == $this->maneja_tcs_lfs)  { echo " checked" ;} ?>  onClick="do_ajax_form_productos_060522_event_maneja_tcs_lfs_onclick();" ><label for="<?php echo $tempOptionId ?>">Color, Talla y Sabor</label></TD>
</TR>
<TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_maneja_tcs_lfs'][] = 'LFS'; ?>
<?php  if ("LFS" == $this->maneja_tcs_lfs)  { echo " checked" ;} ?>  onClick="do_ajax_form_productos_060522_event_maneja_tcs_lfs_onclick();" ><label for="<?php echo $tempOptionId ?>">Lote, F. Vencimiento, Serial</label></TD>
</TR></TABLE>
</div>
</span><?php  }?>
...
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidmaymen'][] = 'NO'; ?>
<?php  if ("NO" == $this->unidmaymen)  { echo " checked" ;} ?><?php  if (empty($this->unidmaymen)) { echo " checked" ;} ?>  onClick="do_ajax_form_productos_060522_event_unidmaymen_onclick();" ><label for="<?php echo $tempOptionId ?>">NO</label></TD>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_unidmaymen'][] = 'SI'; ?>
<?php  if ("SI" == $this->unidmaymen)  { echo " checked" ;} ?>  onClick="do_ajax_form_productos_060522_event_unidmaymen_onclick();" ><label for="<?php echo $tempOptionId ?>">SI</label></TD>
</TR></TABLE>
</div>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_unimen_label" id="hidden_field_label_unimen" style="<?php echo $sStyleHidden_unimen; ?>"><span id="id_label_unimen"><?php echo $this->nm_new_label['unimen']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['unimen']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['php_cmp_required']['unimen'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_multiple_escala'][] = 'NO'; ?>
<?php  if ("NO" == $this->multiple_escala)  { echo " checked" ;} ?><?php  if (empty($this->multiple_escala)) { echo " checked" ;} ?>  onClick="do_ajax_form_productos_060522_event_multiple_escala_onclick();" ><label for="<?php echo $tempOptionId ?>">NO</label></TD>
</TR>
<TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_multiple_escala'][] = 'SI'; ?>
<?php  if ("SI" == $this->multiple_escala)  { echo " checked" ;} ?>  onClick="do_ajax_form_productos_060522_event_multiple_escala_onclick();" ><label for="<?php echo $tempOptionId ?>">SI</label></TD>
</TR></TABLE>
</div>
</span><?php  }?>
...
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_en_base_a'][] = 'UMAY'; ?>
<?php  if ("UMAY" == $this->en_base_a)  { echo " checked" ;} ?><?php  if (empty($this->en_base_a)) { echo " checked" ;} ?>  onClick="do_ajax_form_productos_060522_event_en_base_a_onclick();" ><label for="<?php echo $tempOptionId ?>">UNIDAD MAYOR</label></TD>
</TR>
<TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_en_base_a'][] = 'UMEN'; ?>
<?php  if ("UMEN" == $this->en_base_a)  { echo " checked" ;} ?>  onClick="do_ajax_form_productos_060522_event_en_base_a_onclick();" ><label for="<?php echo $tempOptionId ?>">UNIDAD</label></TD>
</TR></TABLE>
</div>
</span><?php  }?>
...
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_activo'][] = 'SI'; ?>
<?php  if ("SI" == $this->activo)  { echo " checked" ;} ?><?php  if (empty($this->activo)) { echo " checked" ;} ?>  onClick="" ><label for="<?php echo $tempOptionId ?>">SI</label></TD>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_activo'][] = 'NO'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_colores'][] = 'NULL'; ?>
 <option value="NULL"></option>
 <option  value="NO" <?php  if ($this->colores == "NO") { echo " selected" ;} ?><?php  if (empty($this->colores)) { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_colores'][] = 'NO'; ?>
 <option  value="SI" <?php  if ($this->colores == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_colores'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_tallas'][] = 'NULL'; ?>
 <option value="NULL"></option>
 <option  value="NO" <?php  if ($this->tallas == "NO") { echo " selected" ;} ?><?php  if (empty($this->tallas)) { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_tallas'][] = 'NO'; ?>
 <option  value="SI" <?php  if ($this->tallas == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_tallas'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_sabores'][] = 'NULL'; ?>
 <option value="NULL"></option>
 <option  value="NO" <?php  if ($this->sabores == "NO") { echo " selected" ;} ?><?php  if (empty($this->sabores)) { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_sabores'][] = 'NO'; ?>
 <option  value="SI" <?php  if ($this->sabores == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_sabores'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_fecha_vencimiento'][] = 'NO'; ?>
 <option  value="SI" <?php  if ($this->fecha_vencimiento == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_fecha_vencimiento'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_lote'][] = 'NO'; ?>
 <option  value="SI" <?php  if ($this->lote == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_lote'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_serial_codbarras'][] = 'NO'; ?>
 <option  value="SI" <?php  if ($this->serial_codbarras == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_serial_codbarras'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_control_costo'][] = 'NA'; ?>
<?php  if ("NA" == $this->control_costo)  { echo " checked" ;} ?><?php  if (empty($this->control_costo)) { echo " checked" ;} ?>  onClick="do_ajax_form_productos_060522_event_control_costo_onclick();" ><label for="<?php echo $tempOptionId ?>">No Aplica</label></TD>
</TR>
<TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_control_costo'][] = 'UC'; ?>
<?php  if ("UC" == $this->control_costo)  { echo " checked" ;} ?>  onClick="do_ajax_form_productos_060522_event_control_costo_onclick();" ><label for="<?php echo $tempOptionId ?>">Último Costo</label></TD>
</TR>
<TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_control_costo'][] = 'CP'; ?>
<?php  if ("CP" == $this->control_costo)  { echo " checked" ;} ?>  onClick="do_ajax_form_productos_060522_event_control_costo_onclick();" ><label for="<?php echo $tempOptionId ?>">Costo Promedio</label></TD>
</TR>
<TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_060522']['Lookup_control_costo'][] = 'PC'; ?>
<?php  if ("PC" == $this->control_costo)  { echo " checked" ;} ?>  onClick="do_ajax_form_productos_060522_event_control_costo_onclick();" ><label for="<?php echo $tempOptionId ?>">Porcentaje utilidad %</label></TD>
</TR></TABLE>
</div>
</span><?php  }?>
