...
function sc_form_pagar_pedido_idpedido_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_idpedido();
  scCssBlur(oThis);
}
...
function sc_form_pagar_pedido_fechaven_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_fechaven();
  scCssBlur(oThis);
}
...
function sc_form_pagar_pedido_idcli_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_idcli();
  scCssBlur(oThis);
}
...
function sc_form_pagar_pedido_total_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_total();
  scCssBlur(oThis);
}
...
function sc_form_pagar_pedido_asentada_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_asentada();
  scCssBlur(oThis);
}
...
function sc_form_pagar_pedido_adicional_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_adicional();
  scCssBlur(oThis);
}
...
function sc_form_pagar_pedido_formapago_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_formapago();
  scCssBlur(oThis);
}
...
function sc_form_pagar_pedido_adicional2_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_adicional2();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_adicional2_onchange(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_event_adicional2_onchange();
}
...
function sc_form_pagar_pedido_adicional3_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_adicional3();
  scCssBlur(oThis);
}
...
function sc_form_pagar_pedido_obspago_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_obspago();
  scCssBlur(oThis);
}
...
function sc_form_pagar_pedido_numpedido_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_numpedido();
  scCssBlur(oThis);
}
...
function sc_form_pagar_pedido_prefijo_ped_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_prefijo_ped();
  scCssBlur(oThis);
}
...
function sc_form_pagar_pedido_creado_en_movil_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_creado_en_movil();
  scCssBlur(oThis);
}
...
function sc_form_pagar_pedido_disponible_en_movil_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_mob_validate_disponible_en_movil();
  scCssBlur(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_pagar_pedido_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pagar_pedido_mob_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechadocu" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pagar_pedido_mob_validate_fechadocu(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_pagar_pedido_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
