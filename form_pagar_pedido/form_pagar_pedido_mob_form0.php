...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_mob']['btn_disabled']['volver']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_mob']['btn_disabled']['volver']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_mob']['btn_label']['volver']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_mob']['btn_label']['volver']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_mob']['btn_label']['volver'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_mob']['btn_disabled']['pagarjs']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_mob']['btn_disabled']['pagarjs']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_mob']['btn_label']['pagarjs']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_mob']['btn_label']['pagarjs']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_mob']['btn_label']['pagarjs'];
        }
?>
