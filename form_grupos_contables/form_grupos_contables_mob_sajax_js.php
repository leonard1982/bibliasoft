  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_grupos_contables_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_grupos_contables_mob_form();
	}
  ...
  // ---------- Validate codigo
  function do_ajax_form_grupos_contables_mob_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupos_contables_mob_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_grupos_contables_mob_validate_codigo_cb);
  } // do_ajax_form_grupos_contables_mob_validate_codigo

  function do_ajax_form_grupos_contables_mob_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupos_contables_mob_validate_codigo_cb

  // ---------- Validate descripcion
  function do_ajax_form_grupos_contables_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupos_contables_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_grupos_contables_mob_validate_descripcion_cb);
  } // do_ajax_form_grupos_contables_mob_validate_descripcion

  function do_ajax_form_grupos_contables_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupos_contables_mob_validate_descripcion_cb

  // ---------- Validate puc_inventario
  function do_ajax_form_grupos_contables_mob_validate_puc_inventario()
  {
  } // do_ajax_form_grupos_contables_mob_validate_puc_inventario

  function do_ajax_form_grupos_contables_mob_validate_puc_inventario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puc_inventario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupos_contables_mob_validate_puc_inventario_cb

  // ---------- Validate puc_devolucion_compra
  function do_ajax_form_grupos_contables_mob_validate_puc_devolucion_compra()
  {
  } // do_ajax_form_grupos_contables_mob_validate_puc_devolucion_compra

  function do_ajax_form_grupos_contables_mob_validate_puc_devolucion_compra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puc_devolucion_compra";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupos_contables_mob_validate_puc_devolucion_compra_cb

  // ---------- Validate puc_ingresos
  function do_ajax_form_grupos_contables_mob_validate_puc_ingresos()
  {
  } // do_ajax_form_grupos_contables_mob_validate_puc_ingresos

  function do_ajax_form_grupos_contables_mob_validate_puc_ingresos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puc_ingresos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupos_contables_mob_validate_puc_ingresos_cb

  // ---------- Validate puc_devolucion_ventas
  function do_ajax_form_grupos_contables_mob_validate_puc_devolucion_ventas()
  {
  } // do_ajax_form_grupos_contables_mob_validate_puc_devolucion_ventas

  function do_ajax_form_grupos_contables_mob_validate_puc_devolucion_ventas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puc_devolucion_ventas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupos_contables_mob_validate_puc_devolucion_ventas_cb

  // ---------- Validate puc_costo_ventas
  function do_ajax_form_grupos_contables_mob_validate_puc_costo_ventas()
  {
  } // do_ajax_form_grupos_contables_mob_validate_puc_costo_ventas

  function do_ajax_form_grupos_contables_mob_validate_puc_costo_ventas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puc_costo_ventas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_grupos_contables_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_grupos_contables_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_codigo = scAjaxGetFieldText("codigo");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_puc_inventario = scAjaxGetFieldText("puc_inventario");
    var var_puc_devolucion_compra = scAjaxGetFieldText("puc_devolucion_compra");
  ...
  function do_ajax_form_grupos_contables_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("puc_inventario");
      scAjaxHideErrorDisplay("puc_devolucion_compra");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_grupos_contables_mob_submit_form_cb_after_alert);
  } // do_ajax_form_grupos_contables_mob_submit_form_cb
  function do_ajax_form_grupos_contables_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_grupos_contables_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_grupos_contables_mob_navigate_form()
  {
    perform_ajax_form_grupos_contables_mob_navigate_form();
  }

  function perform_ajax_form_grupos_contables_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_grupos_contables_mob_navigate_form(var_id_grupo_contable, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_grupos_contables_mob_navigate_form_cb);
  } // do_ajax_form_grupos_contables_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_grupos_contables_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_grupos_contables_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_grupo_contable.value = scAjaxGetKeyValue("id_grupo_contable");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_grupos_contables_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_grupos_contables_mob_navigate_form_cb
  function do_ajax_form_grupos_contables_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_grupos_contables_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_grupos_contables_mob_navigate_form_cb_after_alert
  function sc_hide_form_grupos_contables_mob_form()
  {
  ...
  ajax_field_list[2] = "puc_inventario";
  ajax_field_list[3] = "puc_devolucion_compra";
  ...
  var ajax_error_list = {
    ...
    "puc_inventario": {"label": "Puc Inventario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["puc_inventario"][1] = "puc_inventario";
  ajax_field_mult["puc_devolucion_compra"][1] = "puc_devolucion_compra";
  ...
  var ajax_field_id = {
    ...
    "puc_inventario": new Array("hidden_field_label_puc_inventario", "hidden_field_data_puc_inventario"),
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("puc_devolucion_compra" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("puc_devolucion_ventas" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
