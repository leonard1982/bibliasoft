...
class form_detalleventa_apl
{
   ...
   var $form_vert_form_detalleventa = array();
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_detalleventa']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_detalleventa']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_numfacventa)) 
          {
              $_SESSION['par_numfacventa'] = $this->par_numfacventa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_detalleventa']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_detalleventa']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_detalleventa_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_detalleventa']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_detalleventa']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_detalleventa'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalleventa']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalleventa']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_detalleventa') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalleventa']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - detalleventa";
      ...
      $_SESSION['scriptcase']['error_icon']['form_detalleventa']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_detalleventa'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_orig'] = " where numfac=" . $_SESSION['par_numfacventa'] . " and cantidad>0";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_pesq'] = " where numfac=" . $_SESSION['par_numfacventa'] . " and cantidad>0";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventa']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_detalleventa'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_detalleventa'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['exit'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_detalleventa", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_detalleventa_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_detalleventa_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_detalleventa/form_detalleventa_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_detalleventa_erro.class.php"); 
      }
      $this->Erro      = new form_detalleventa_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_max_reg']) == "all")
      {
      ...
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['opcao']))
         { 
             if ($this->iddet_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_detalleventa']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_detalleventa']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_form'][$sc_seq_vert];
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_detalleventa']) || !is_array($this->NM_ajax_info['errList']['geral_form_detalleventa']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalleventa'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalleventa'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalleventa'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalleventa'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_redir_atualiz'] == "ok")
          {
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_detalleventa_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_detalleventa_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      { 
         ...
         { 
             $GLOBALS["idpro_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['idpro_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["elcolor_" . $sc_seq_vert]))
         { 
             $GLOBALS["elcolor_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['elcolor_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["latalla_" . $sc_seq_vert]))
         { 
             $GLOBALS["latalla_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['latalla_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["elsabor_" . $sc_seq_vert]))
         { 
             $GLOBALS["elsabor_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['elsabor_'];
         } 
         ...
         if (isset($this->sabor_)) { $this->nm_limpa_alfa($this->sabor_); }
         if (isset($this->obs_)) { $this->nm_limpa_alfa($this->obs_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert];
         }
         if ($this->nmgp_opcao != "recarga" && (!in_array($sc_seq_vert, $sc_check_excl) && !in_array($sc_seq_vert, $sc_check_incl) ))
         { }
         else
         {
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['idpro_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_disabled'][$sc_seq_vert]['idpro_']))
             { 
                 $this->idpro_ = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['idpro_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['elcolor_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_disabled'][$sc_seq_vert]['elcolor_']))
             { 
                 $this->elcolor_ = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['elcolor_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['latalla_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_disabled'][$sc_seq_vert]['latalla_']))
             { 
                 $this->latalla_ = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['latalla_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['elsabor_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_disabled'][$sc_seq_vert]['elsabor_']))
             { 
                 $this->elsabor_ = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['elsabor_'];
             } 
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_detalleventa[$sc_seq_vert]['numfac_'] =  $this->numfac_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['desc_'] =  $this->desc_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['obs_'] =  $this->obs_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['colores_'] =  $this->colores_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['elcolor_'] =  $this->elcolor_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['tallas_'] =  $this->tallas_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['latalla_'] =  $this->latalla_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['sabor_'] =  $this->sabor_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['elsabor_'] =  $this->elsabor_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['idbod_'] =  $this->idbod_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['unidadmayor_'] =  $this->unidadmayor_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['stockubica_'] =  $this->stockubica_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['unidad_'] =  $this->unidad_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['cantidad_'] =  $this->cantidad_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['valorunit_'] =  $this->valorunit_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['valorpar_'] =  $this->valorpar_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['descuento_'] =  $this->descuento_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['adicional_'] =  $this->adicional_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['adicional1_'] =  $this->adicional1_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['factor_'] =  $this->factor_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['iva_'] =  $this->iva_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['costop_'] =  $this->costop_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['iddet_'] =  $this->iddet_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['remision_'] =  $this->remision_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['devuelto_'] =  $this->devuelto_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['numdevo_'] =  $this->numdevo_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['iddeta_'] =  $this->iddeta_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['existencia_'] =  $this->existencia_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_detalleventa);
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_detalleventa.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_detalleventa_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_detalleventa"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_detalleventa'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      {
      $_SESSION['scriptcase']['form_detalleventa']['contr_erro'] = 'on';
...
if($vMerror=='NO')
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_detalleventa';
...
$_SESSION['scriptcase']['form_detalleventa']['contr_erro'] = 'off'; 
    ...
    function ValidateField_idpro_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['php_cmp_required']['idpro_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['php_cmp_required']['idpro_'] == "on")) 
      { 
          if ($this->idpro_ == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_colores_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->colores_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_colores_']) && !in_array($this->colores_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_colores_']))
               {
                   $hasError = true;
    ...
    function ValidateField_elcolor_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->elcolor_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_elcolor_']) && !in_array($this->elcolor_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_elcolor_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_tallas_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->tallas_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_tallas_']) && !in_array($this->tallas_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_tallas_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_latalla_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->latalla_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_latalla_']) && !in_array($this->latalla_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_latalla_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_sabor_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->sabor_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_sabor_']) && !in_array($this->sabor_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_sabor_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_elsabor_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->elsabor_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_elsabor_']) && !in_array($this->elsabor_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_elsabor_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idbod_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idbod_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_idbod_']) && !in_array($this->idbod_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_idbod_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_unidadmayor_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['php_cmp_required']['unidadmayor_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['php_cmp_required']['unidadmayor_'] == "on")
        { 
          $hasError = true;
    ...
    function ValidateField_cantidad_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['php_cmp_required']['cantidad_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['php_cmp_required']['cantidad_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_valorunit_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['php_cmp_required']['valorunit_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['php_cmp_required']['valorunit_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_factor_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['php_cmp_required']['factor_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['php_cmp_required']['factor_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Factor" ; 
              if (!isset($Campos_Erros['factor_']))
    ...
    function ValidateField_costop_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['php_cmp_required']['costop_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['php_cmp_required']['costop_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Costop" ; 
              if (!isset($Campos_Erros['costop_']))
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['iddet_']['keyVal'] = form_detalleventa_pack_protect_string($this->nmgp_dados_form['iddet_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_detalleventa[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['numfac_'] = $this->numfac_;
                  }
                  if (isset($this->NM_ajax_changed['idpro_']) && $this->NM_ajax_changed['idpro_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['idpro_'] = $this->idpro_;
                  }
                  if (isset($this->NM_ajax_changed['desc_']) && $this->NM_ajax_changed['desc_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['desc_'] = $this->desc_;
                  }
                  if (isset($this->NM_ajax_changed['obs_']) && $this->NM_ajax_changed['obs_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['obs_'] = $this->obs_;
                  }
                  if (isset($this->NM_ajax_changed['colores_']) && $this->NM_ajax_changed['colores_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['colores_'] = $this->colores_;
                  }
                  if (isset($this->NM_ajax_changed['elcolor_']) && $this->NM_ajax_changed['elcolor_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['elcolor_'] = $this->elcolor_;
                  }
                  if (isset($this->NM_ajax_changed['tallas_']) && $this->NM_ajax_changed['tallas_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['tallas_'] = $this->tallas_;
                  }
                  if (isset($this->NM_ajax_changed['latalla_']) && $this->NM_ajax_changed['latalla_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['latalla_'] = $this->latalla_;
                  }
                  if (isset($this->NM_ajax_changed['sabor_']) && $this->NM_ajax_changed['sabor_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['sabor_'] = $this->sabor_;
                  }
                  if (isset($this->NM_ajax_changed['elsabor_']) && $this->NM_ajax_changed['elsabor_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['elsabor_'] = $this->elsabor_;
                  }
                  if (isset($this->NM_ajax_changed['idbod_']) && $this->NM_ajax_changed['idbod_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['idbod_'] = $this->idbod_;
                  }
                  if (isset($this->NM_ajax_changed['unidadmayor_']) && $this->NM_ajax_changed['unidadmayor_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['unidadmayor_'] = $this->unidadmayor_;
                  }
                  if (isset($this->NM_ajax_changed['stockubica_']) && $this->NM_ajax_changed['stockubica_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['stockubica_'] = $this->stockubica_;
                  }
                  if (isset($this->NM_ajax_changed['unidad_']) && $this->NM_ajax_changed['unidad_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['unidad_'] = $this->unidad_;
                  }
                  if (isset($this->NM_ajax_changed['cantidad_']) && $this->NM_ajax_changed['cantidad_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['cantidad_'] = $this->cantidad_;
                  }
                  if (isset($this->NM_ajax_changed['valorunit_']) && $this->NM_ajax_changed['valorunit_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['valorunit_'] = $this->valorunit_;
                  }
                  if (isset($this->NM_ajax_changed['valorpar_']) && $this->NM_ajax_changed['valorpar_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['valorpar_'] = $this->valorpar_;
                  }
                  if (isset($this->NM_ajax_changed['descuento_']) && $this->NM_ajax_changed['descuento_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['descuento_'] = $this->descuento_;
                  }
                  if (isset($this->NM_ajax_changed['adicional_']) && $this->NM_ajax_changed['adicional_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['adicional_'] = $this->adicional_;
                  }
                  if (isset($this->NM_ajax_changed['adicional1_']) && $this->NM_ajax_changed['adicional1_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['adicional1_'] = $this->adicional1_;
                  }
                  if (isset($this->NM_ajax_changed['factor_']) && $this->NM_ajax_changed['factor_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['factor_'] = $this->factor_;
                  }
                  if (isset($this->NM_ajax_changed['iva_']) && $this->NM_ajax_changed['iva_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['iva_'] = $this->iva_;
                  }
                  if (isset($this->NM_ajax_changed['costop_']) && $this->NM_ajax_changed['costop_'])
                  {
                      $this->form_vert_form_detalleventa[$this->nmgp_refresh_row]['costop_'] = $this->costop_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_detalleventa as $sc_seq_vert => $aRecData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['idpro_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][form_detalleventa_pack_protect_string($aRecData['idpro_'])]),
              );
              }
          ...
          $sTmpImgHtml = "<a href=\"javascript:nm_gp_submit('" . $this->Ini->link_form_detalleventa_observ_edit . "', '$this->nm_location', 'SC_glo_par_par_numfacventa*scinpar_numfacventa*scoutdetalle*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_form'][$sc_seq_vert]['iddet_'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout', '', '_self', '0', '0', 'form_detalleventa_observ')\"><font color=\"" . $this->Ini->cor_link_dados . "\">" . $desc_ . "</font></a>";
          $aLookupOrig = $aLookup;
...
$aLookup[] = array(form_detalleventa_pack_protect_string('0') => str_replace('<', '&lt;',form_detalleventa_pack_protect_string(' ')));
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['colores_' . $sc_seq_vert]['valList'][$i] = form_detalleventa_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
if ('autocomp_' != substr($this->NM_ajax_opcao, 0, 9))
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_detalleventa_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_detalleventa_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['elcolor_' . $sc_seq_vert]['valList'][$i] = form_detalleventa_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tallas_' . $sc_seq_vert]['valList'][$i] = form_detalleventa_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
if ('autocomp_' != substr($this->NM_ajax_opcao, 0, 9))
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['latalla_' . $sc_seq_vert]['valList'][$i] = form_detalleventa_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['sabor_' . $sc_seq_vert]['valList'][$i] = form_detalleventa_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
if ('autocomp_' != substr($this->NM_ajax_opcao, 0, 9))
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['elsabor_' . $sc_seq_vert]['valList'][$i] = form_detalleventa_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idbod_' . $sc_seq_vert]['valList'][$i] = form_detalleventa_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          $this->NM_ajax_info['fldList']['idbod_' . $sc_seq_vert]['labList'] = $aLabel;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("unidadmayor_", $this->nmgp_refresh_fields)))
              {
                  ...
                  $aLookup = array();
$aLookup[] = array(form_detalleventa_pack_protect_string('NO') => str_replace('<', '&lt;',form_detalleventa_pack_protect_string("NO")));
$aLookup[] = array(form_detalleventa_pack_protect_string('SI') => str_replace('<', '&lt;',form_detalleventa_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_unidadmayor_'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_unidadmayor_'][] = 'SI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['unidadmayor_' . $sc_seq_vert]['valList'][$i] = form_detalleventa_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->iddet_)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
$_SESSION['scriptcase']['form_detalleventa']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['numfac_'] = $this->numfac_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['idpro_'] = $this->idpro_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['obs_'] = $this->obs_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['colores_'] = $this->colores_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['tallas_'] = $this->tallas_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['sabor_'] = $this->sabor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['idbod_'] = $this->idbod_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['unidadmayor_'] = $this->unidadmayor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['cantidad_'] = $this->cantidad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['valorunit_'] = $this->valorunit_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['valorpar_'] = $this->valorpar_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['descuento_'] = $this->descuento_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['adicional_'] = $this->adicional_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['adicional1_'] = $this->adicional1_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['factor_'] = $this->factor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['iva_'] = $this->iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert]['costop_'] = $this->costop_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('numfac_', 'idpro_', 'desc_', 'obs_', 'colores_', 'elcolor_', 'tallas_', 'latalla_', 'sabor_', 'elsabor_', 'idbod_', 'unidadmayor_', 'stockubica_', 'unidad_', 'cantidad_', 'valorunit_', 'valorpar_', 'descuento_', 'adicional_', 'adicional1_', 'factor_', 'iva_', 'costop_'), $aDoNotUpdate);
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == form_detalleventa_pack_protect_string(NM_charset_to_utf8($this->colores_)))
              {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detalleventa_pack_protect_string(NM_charset_to_utf8($this->elcolor_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detalleventa_pack_protect_string(NM_charset_to_utf8($this->tallas_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detalleventa_pack_protect_string(NM_charset_to_utf8($this->latalla_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detalleventa_pack_protect_string(NM_charset_to_utf8($this->sabor_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detalleventa_pack_protect_string(NM_charset_to_utf8($this->elsabor_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detalleventa_pack_protect_string(NM_charset_to_utf8($this->idbod_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['Lookup_unidadmayor_'][] = 'SI';
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detalleventa_pack_protect_string(NM_charset_to_utf8($this->unidadmayor_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
          $tmpLabel_unidadmayor_ = $sLabelTemp;
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_detalleventa']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['parms'] = "iddet_?#?$this->iddet_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventa']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_detalleventa = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter'] . ")";
          }
      }
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['total']))
          {
              ...
              $qt_geral_reg_form_detalleventa = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['total'] = $qt_geral_reg_form_detalleventa;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['total']) || $this->sc_teve_excl || $this->sc_teve_incl)
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->iddet_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_detalleventa = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_detalleventa) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] += $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] > $qt_geral_reg_form_detalleventa)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] = $qt_geral_reg_form_detalleventa - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] = ($qt_geral_reg_form_detalleventa + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['ordem_ord']; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
      ...
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['run_iframe'] == "R")
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              $rs = $this->Db->Execute($nmgp_select) ; 
          } 
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['parms'] = "iddet_?#?$this->iddet_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_detalleventa[$sc_seq_vert]['numfac_'] =  $this->numfac_; 
             $this->form_vert_form_detalleventa[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
          ...
          ksort ($this->form_vert_form_detalleventa); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          {
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['total'] + 1; 
          }
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] < (($qt_geral_reg_form_detalleventa + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['embutida_multi']) 
          { 
          } 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['reg_start'] + $this->sc_max_reg;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$this->nm_formatar_campos('idpro_', 'adicional1_', 'descuento_', 'valorpar_', 'adicional_', 'iva_', 'cantidad_', 'valorunit_');
...
$modificado_tallas_ = $this->tallas_;
$modificado_sabor_ = $this->sabor_;
$this->nm_formatar_campos('idpro_', 'numfac_', 'valorunit_', 'unidadmayor_', 'costop_', 'factor_', 'adicional_', 'cantidad_', 'adicional1_', 'descuento_', 'valorpar_', 'iva_', 'colores_', 'tallas_', 'sabor_');
$this->nmgp_refresh_fields = array();
if ($original_idpro_ !== $modificado_idpro_ || isset($this->nmgp_cmp_readonly['idpro_']) || (isset($bFlagRead_idpro_) && $bFlagRead_idpro_))
{
    $this->nmgp_refresh_fields[] = 'idpro_';
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter_form'] . " and (numfac=" . $_SESSION['par_numfacventa'] . " and cantidad>0) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_detalleventa = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['total'] = $qt_geral_reg_form_detalleventa;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_detalleventa_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_detalleventa_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_detalleventa_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['masterValue']))
{
...
<?php
  exit;
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventa']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
