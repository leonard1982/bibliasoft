<?php
@session_start() ;
$_SESSION['scriptcase']['grid_inventariofisico']['sc_process_barr'] = true;
require_once('../grid_inventariofisico/index.php');
unset($_SESSION['scriptcase']['grid_inventariofisico']['sc_process_barr']);
$ExportCtrl = new grid_inventariofisico_export_control;
$ExportCtrl->Export_barr();

class grid_inventariofisico_export_control
{
