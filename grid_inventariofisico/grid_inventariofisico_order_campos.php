...
<?php
   ...
   $Ord_Cmp = new grid_inventariofisico_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_inventariofisico_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["titulo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["titulo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["titulo"] : "titulo";
   ...
   $tab_labels["prefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["prefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["prefijo"] : "prefijo";
   ...
   {
       $tab_def_campos['numero'] = "";
   }
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["numero"] : "Nota #:";
   $tab_ger_campos['fecha_nota'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fecha_nota'] = "fecha_nota";
   }
   else
   {
       $tab_def_campos['fecha_nota'] = "";
   }
   $tab_labels["fecha_nota"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["fecha_nota"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["fecha_nota"] : "fecha_nota";
   $tab_ger_campos['t_conc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_conc'] = "t_conc";
   }
   else
   {
       $tab_def_campos['t_conc'] = "";
   }
   $tab_labels["t_conc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["t_conc"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["t_conc"] : "t_conc";
   ...
   {
       $tab_def_campos['concepto'] = "";
   }
   $tab_labels["concepto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["concepto"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["concepto"] : "concepto";
   $tab_ger_campos['r1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['r1'] = "r1";
   }
   else
   {
       $tab_def_campos['r1'] = "";
   }
   $tab_labels["r1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["r1"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["r1"] : "r1";
   $tab_ger_campos['r2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['r2'] = "r2";
   }
   else
   {
       $tab_def_campos['r2'] = "";
   }
   $tab_labels["r2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["r2"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["r2"] : "r2";
   $tab_ger_campos['t_obs'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_obs'] = "t_obs";
   }
   else
   {
       $tab_def_campos['t_obs'] = "";
   }
   $tab_labels["t_obs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["t_obs"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["t_obs"] : "t_obs";
   ...
   $tab_labels["obs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["obs"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["obs"] : "obs";
   $tab_ger_campos['r3'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['r3'] = "r3";
   }
   else
   {
       $tab_def_campos['r3'] = "";
   }
   $tab_labels["r3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["r3"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["r3"] : "r3";
   $tab_ger_campos['r4'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['r4'] = "r4";
   }
   else
   {
       $tab_def_campos['r4'] = "";
   }
   $tab_labels["r4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["r4"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["r4"] : "r4";
   $tab_ger_campos['t_ubi'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_ubi'] = "t_ubi";
   }
   else
   {
       $tab_def_campos['t_ubi'] = "";
   }
   $tab_labels["t_ubi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["t_ubi"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["t_ubi"] : "t_ubi";
   ...
   $tab_labels["ubicacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["ubicacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["ubicacion"] : "ubicacion";
   $tab_ger_campos['r5'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['r5'] = "r5";
   }
   else
   {
       $tab_def_campos['r5'] = "";
   }
   $tab_labels["r5"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["r5"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["r5"] : "r5";
   $tab_ger_campos['r6'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['r6'] = "r6";
   }
   else
   {
       $tab_def_campos['r6'] = "";
   }
   $tab_labels["r6"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["r6"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["r6"] : "r6";
   $tab_ger_campos['detalle_nota'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['detalle_nota'] = "detalle_nota";
   }
   else
   {
       $tab_def_campos['detalle_nota'] = "";
   }
   $tab_labels["detalle_nota"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["detalle_nota"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['labels']["detalle_nota"] : "detalle_nota";
   $tab_ger_campos['titulo'] = "none";
   $tab_ger_campos['prefijo'] = "none";
   $tab_ger_campos['numero'] = "none";
   $tab_ger_campos['fecha_nota'] = "none";
   $tab_ger_campos['t_conc'] = "none";
   $tab_ger_campos['concepto'] = "none";
   $tab_ger_campos['r1'] = "none";
   $tab_ger_campos['r2'] = "none";
   $tab_ger_campos['t_obs'] = "none";
   $tab_ger_campos['obs'] = "none";
   $tab_ger_campos['r3'] = "none";
   $tab_ger_campos['r4'] = "none";
   $tab_ger_campos['t_ubi'] = "none";
   $tab_ger_campos['ubicacion'] = "none";
   $tab_ger_campos['r5'] = "none";
   $tab_ger_campos['r6'] = "none";
   $tab_ger_campos['detalle_nota'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_inventariofisico']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_inventariofisico']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_inventariofisico']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE>Nota de Inventario</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_inventariofisico_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_inventariofisico']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
