...
class grid_inventariofisico_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_inventariofisico/grid_inventariofisico_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_inventariofisico_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_inventariofisico.zip";
          $this->Arquivo   .= "_grid_inventariofisico" . $this->Xls_tp;
          $this->Tit_doc    = "grid_inventariofisico" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_inventariofisico']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "detalle_nota" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->arr_span['detalle_nota'] = $this->count_span;
              $this->Emb_label_cols_detalle_nota = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalle_notainv']['embutida'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalle_notainv']['embutida_label'] = true;
                  ...
                  if (isset($_SESSION['scriptcase']['export_return']))
                  {
                     foreach ($_SESSION['scriptcase']['export_return']['label'] as $col => $dados)
                     {
                         if (isset($dados['col_span_i'])) {
                             $this->Emb_label_cols_detalle_nota += $dados['col_span_i'];
                         }
                         elseif (isset($dados['col_span_f'])) {
                             $this->Emb_label_cols_detalle_nota += $dados['col_span_f'];
                         }
                         else {
                             $this->Emb_label_cols_detalle_nota++;
                         }
                     }
                  }
                  $this->count_span += $this->Emb_label_cols_detalle_nota;
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalle_notainv']['embutida'] = false;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalle_notainv']['embutida_label'] = false;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['embutida'])
              { 
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['embutida'])
              { 
                  $this->arr_export['label'][$this->Xls_col]['col_span_f'] = $this->Emb_label_cols_detalle_nota;
                  $this->Xls_col++;
              }
              else
              { 
                  $this->Xls_col += $this->Emb_label_cols_detalle_nota;
              } 
          }
      } 
      $this->Xls_col = 0;
   ...
   function NM_export_fecha_nota()
   {
      ...
      if (!empty($this->fecha_nota))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_nota, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_nota, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- t_conc
   function NM_export_t_conc()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->t_conc, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->t_conc, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- concepto
   ...
   function NM_export_r1()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->r1, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->r1, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- r2
   function NM_export_r2()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->r2, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->r2, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- t_obs
   function NM_export_t_obs()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->t_obs, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->t_obs, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- obs
   ...
   function NM_export_r3()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->r3, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->r3, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- r4
   function NM_export_r4()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->r4, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->r4, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- t_ubi
   function NM_export_t_ubi()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->t_ubi, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->t_ubi, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ubicacion
   ...
   function NM_export_r5()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->r5, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->r5, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- r6
   function NM_export_r6()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->r6, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->r6, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- titulo
   ...
   //----- fecha_nota
   function NM_sub_cons_fecha_nota()
   {
      if (!empty($this->fecha_nota))
      {
         $conteudo_x =  $this->fecha_nota;
         ...
         $this->fecha_nota = NM_charset_to_utf8($this->fecha_nota);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fecha_nota;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- t_conc
   function NM_sub_cons_t_conc()
   {
         $this->t_conc = html_entity_decode($this->t_conc, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->t_conc = strip_tags($this->t_conc);
         $this->t_conc = NM_charset_to_utf8($this->t_conc);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->t_conc;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- r1
   function NM_sub_cons_r1()
   {
         $this->r1 = html_entity_decode($this->r1, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->r1 = strip_tags($this->r1);
         $this->r1 = NM_charset_to_utf8($this->r1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->r1;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- r2
   function NM_sub_cons_r2()
   {
         $this->r2 = html_entity_decode($this->r2, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->r2 = strip_tags($this->r2);
         $this->r2 = NM_charset_to_utf8($this->r2);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->r2;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- t_obs
   function NM_sub_cons_t_obs()
   {
         $this->t_obs = html_entity_decode($this->t_obs, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->t_obs = strip_tags($this->t_obs);
         $this->t_obs = NM_charset_to_utf8($this->t_obs);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->t_obs;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- r3
   function NM_sub_cons_r3()
   {
         $this->r3 = html_entity_decode($this->r3, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->r3 = strip_tags($this->r3);
         $this->r3 = NM_charset_to_utf8($this->r3);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->r3;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- r4
   function NM_sub_cons_r4()
   {
         $this->r4 = html_entity_decode($this->r4, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->r4 = strip_tags($this->r4);
         $this->r4 = NM_charset_to_utf8($this->r4);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->r4;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- t_ubi
   function NM_sub_cons_t_ubi()
   {
         $this->t_ubi = html_entity_decode($this->t_ubi, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->t_ubi = strip_tags($this->t_ubi);
         $this->t_ubi = NM_charset_to_utf8($this->t_ubi);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->t_ubi;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- r5
   function NM_sub_cons_r5()
   {
         $this->r5 = html_entity_decode($this->r5, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->r5 = strip_tags($this->r5);
         $this->r5 = NM_charset_to_utf8($this->r5);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->r5;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- r6
   function NM_sub_cons_r6()
   {
         $this->r6 = html_entity_decode($this->r6, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->r6 = strip_tags($this->r6);
         $this->r6 = NM_charset_to_utf8($this->r6);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->r6;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detalle_nota
   function NM_sub_cons_detalle_nota()
   {
         $this->Rows_sub_detalle_nota = array();
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?SC_glo_par_par_idmov?#?par_idmov?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalle_notainv']['embutida'] = true;
         if (method_exists($this->grid_detalle_notainv, "controle"))
         {
             $this->grid_detalle_notainv->controle();
             ...
             if (isset($_SESSION['scriptcase']['export_return']))
             {
                 ...
                 if (isset($_SESSION['scriptcase']['export_return']['lines']))
                 {
                     ...
                     foreach ($_SESSION['scriptcase']['export_return']['lines'] as $line => $cols)
                     {
                         ...
                         foreach ($cols as $icol => $dados)
                         {
                             $this->Rows_sub_detalle_nota[$this->row_sub][$icol] = $dados;
                             if ($prim_col && $this->row_sub > 1)
                             {
                                 if (isset($this->Rows_sub_detalle_nota[$this->row_sub][$icol]['col_span_i']))
                                 {
                                    $this->Rows_sub_detalle_nota[$this->row_sub][$icol]['col_span_i'] += $this->arr_span['detalle_nota'];
                                 }
                                 else
                                 {
                                    $this->Rows_sub_detalle_nota[$this->row_sub][$icol]['col_span_i'] = $this->arr_span['detalle_nota'];
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>Nota de Inventario :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventariofisico']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
