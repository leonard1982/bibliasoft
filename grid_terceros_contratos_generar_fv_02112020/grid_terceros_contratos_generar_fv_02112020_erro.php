...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_02112020']['contr_erro']) && $_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_02112020']['contr_erro'] == 'on')
    {
