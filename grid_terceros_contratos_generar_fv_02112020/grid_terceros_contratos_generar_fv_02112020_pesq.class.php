...
class grid_terceros_contratos_generar_fv_02112020_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
    ...
    if (!$this->NM_ajax_flag && (!isset($bprocessa) || $bprocessa != "pesq"))
    {
      global $zona_cond, $zona,
             $anio_liquidar_cond, $anio_liquidar,
             $periodo_liquidar_cond, $periodo_liquidar,
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_terceros_contratos_generar_fv_02112020_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_terceros_contratos_generar_fv_02112020_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_terceros_contratos_generar_fv_02112020_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_terceros_contratos_generar_fv_02112020/grid_terceros_contratos_generar_fv_02112020_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_terceros_contratos_generar_fv_02112020_ajax_search.js"></script>
 <script type="text/javascript" src="grid_terceros_contratos_generar_fv_02112020_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_terceros_contratos_generar_fv_02112020_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_02112020']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_02112020']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_anio_liquidar_cond#NMF#' + search_get_sel_txt('SC_anio_liquidar_cond') + '@NMF@';
  str_out += 'SC_anio_liquidar#NMF#' + search_get_select('SC_anio_liquidar') + '@NMF@';
  str_out += 'SC_periodo_liquidar_cond#NMF#' + search_get_sel_txt('SC_periodo_liquidar_cond') + '@NMF@';
  str_out += 'SC_periodo_liquidar#NMF#' + search_get_select('SC_periodo_liquidar') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $zona = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['zona']; 
          $zona_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['zona_cond']; 
          $anio_liquidar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['anio_liquidar']; 
          $anio_liquidar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['anio_liquidar_cond']; 
          $periodo_liquidar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['periodo_liquidar']; 
          $periodo_liquidar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['periodo_liquidar_cond']; 
          $fecha_inicio_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_dia']; 
          $fecha_inicio_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_mes']; 
          $fecha_inicio_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_ano']; 
          $fecha_inicio_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_input_2_dia']; 
          $fecha_inicio_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_input_2_mes']; 
          $fecha_inicio_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_input_2_ano']; 
          $fecha_inicio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_cond']; 
          $numero_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['numero_contrato']; 
          $numero_contrato_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['numero_contrato_cond']; 
          $cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['cliente']; 
          $cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['cliente_cond']; 
          $estado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['estado']; 
          $estado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['estado_cond']; 
          $resolucion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['resolucion']; 
          $resolucion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['resolucion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['NM_operador']; 
      } 
      if (!isset($zona_cond) || empty($zona_cond))
      {
         $zona_cond = "eq";
      }
      if (!isset($anio_liquidar_cond) || empty($anio_liquidar_cond))
      {
         $anio_liquidar_cond = "eq";
      }
      if (!isset($periodo_liquidar_cond) || empty($periodo_liquidar_cond))
      {
         $periodo_liquidar_cond = "eq";
      }
      ...
      $str_hide_anio_liquidar = (in_array($anio_liquidar_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_periodo_liquidar = (in_array($periodo_liquidar_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_anio_liquidar = ('bw' == $anio_liquidar_cond) ? $display_aberto : $display_fechado;
      $str_display_periodo_liquidar = ('bw' == $periodo_liquidar_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($anio_liquidar) || $anio_liquidar == "")
      {
          $anio_liquidar = "";
      }
      if (isset($anio_liquidar) && !empty($anio_liquidar))
      {
         $tmp_pos = strpos($anio_liquidar, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $anio_liquidar = substr($anio_liquidar, 0, $tmp_pos);
         }
      }
      if (!isset($periodo_liquidar) || $periodo_liquidar == "")
      {
          $periodo_liquidar = "";
      }
      if (isset($periodo_liquidar) && !empty($periodo_liquidar))
      {
         $tmp_pos = strpos($periodo_liquidar, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $periodo_liquidar = substr($periodo_liquidar, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_zona_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['zona'])) ? $this->New_label['zona'] : "Zona"; ?></TD>
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['zona'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['zona'][] = trim($rs->fields[0]);
...
?>
      ...
      <TD id='SC_anio_liquidar_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['anio_liquidar'])) ? $this->New_label['anio_liquidar'] : " Año a liquidar"; ?></TD>
      
      <INPUT type="hidden" id="SC_anio_liquidar_cond" name="anio_liquidar_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_anio_liquidar" <?php echo $str_hide_anio_liquidar?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['anio_liquidar'])) ? $this->New_label['anio_liquidar'] : " Año a liquidar";
 $nmgp_tab_label .= "anio_liquidar?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['anio_liquidar'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['anio_liquidar'][] = "2020";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['anio_liquidar'][] = "2021";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['anio_liquidar'][] = "2022";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['anio_liquidar'][] = "2023";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['anio_liquidar'][] = "2024";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['anio_liquidar'][] = "2025";
 ?>

 <SELECT class="scFilterObjectEven" id="SC_anio_liquidar"  name="anio_liquidar"  size="1">
 <OPTION value="2020##@@2020"<?php if ($anio_liquidar == "2020") { echo " selected" ;} ?>>2020</option>
 <OPTION value="2021##@@2021"<?php if ($anio_liquidar == "2021") { echo " selected" ;} ?>>2021</option>
 <OPTION value="2022##@@2022"<?php if ($anio_liquidar == "2022") { echo " selected" ;} ?>>2022</option>
 <OPTION value="2023##@@2023"<?php if ($anio_liquidar == "2023") { echo " selected" ;} ?>>2023</option>
 <OPTION value="2024##@@2024"<?php if ($anio_liquidar == "2024") { echo " selected" ;} ?>>2024</option>
 <OPTION value="2025##@@2025"<?php if ($anio_liquidar == "2025") { echo " selected" ;} ?>>2025</option>
 </SELECT>
      ...
      <TD id='SC_periodo_liquidar_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['periodo_liquidar'])) ? $this->New_label['periodo_liquidar'] : "Periodo a liquidar"; ?></TD>
      
      <INPUT type="hidden" id="SC_periodo_liquidar_cond" name="periodo_liquidar_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_periodo_liquidar" <?php echo $str_hide_periodo_liquidar?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['periodo_liquidar'])) ? $this->New_label['periodo_liquidar'] : "Periodo a liquidar";
 $nmgp_tab_label .= "periodo_liquidar?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'][] = "01";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'][] = "02";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'][] = "03";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'][] = "04";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'][] = "05";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'][] = "06";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'][] = "07";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'][] = "08";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'][] = "09";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'][] = "10";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'][] = "11";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'][] = "12";
 ?>

 <SELECT class="scFilterObjectOdd" id="SC_periodo_liquidar"  name="periodo_liquidar"  size="1">
 <OPTION value="01##@@ENERO"<?php if ($periodo_liquidar == "01") { echo " selected" ;} ?>>ENERO</option>
 <OPTION value="02##@@FEBRERO"<?php if ($periodo_liquidar == "02") { echo " selected" ;} ?>>FEBRERO</option>
 <OPTION value="03##@@MARZO"<?php if ($periodo_liquidar == "03") { echo " selected" ;} ?>>MARZO</option>
 <OPTION value="04##@@ABRIL"<?php if ($periodo_liquidar == "04") { echo " selected" ;} ?>>ABRIL</option>
 <OPTION value="05##@@MAYO"<?php if ($periodo_liquidar == "05") { echo " selected" ;} ?>>MAYO</option>
 <OPTION value="06##@@JUNIO"<?php if ($periodo_liquidar == "06") { echo " selected" ;} ?>>JUNIO</option>
 <OPTION value="07##@@JULIO"<?php if ($periodo_liquidar == "07") { echo " selected" ;} ?>>JULIO</option>
 <OPTION value="08##@@AGOSTO"<?php if ($periodo_liquidar == "08") { echo " selected" ;} ?>>AGOSTO</option>
 <OPTION value="09##@@SEPTIEMBRE"<?php if ($periodo_liquidar == "09") { echo " selected" ;} ?>>SEPTIEMBRE</option>
 <OPTION value="10##@@OCTUBRE"<?php if ($periodo_liquidar == "10") { echo " selected" ;} ?>>OCTUBRE</option>
 <OPTION value="11##@@NOVIEMBRE"<?php if ($periodo_liquidar == "11") { echo " selected" ;} ?>>NOVIEMBRE</option>
 <OPTION value="12##@@DICIEMBRE"<?php if ($periodo_liquidar == "12") { echo " selected" ;} ?>>DICIEMBRE</option>
 </SELECT>
...
?>
      ...
      <TD id='SC_numero_contrato_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['numero_contrato'])) ? $this->New_label['numero_contrato'] : "Contrato"; ?></TD>
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numero_contrato" id="id_ac_numero_contrato" name="numero_contrato_autocomp"><?php if ('' !=  $numero_contrato) { ?><option value="<?php echo $numero_contrato ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cliente" name="cliente_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: true}">
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['estado'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['estado'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_estado">
      <SELECT class="scFilterObjectOdd" id="SC_estado" name="estado"  size="1">
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT Idres,prefijo  FROM resdian  WHERE activa='SI' and resolucion>0 ORDER BY prefijo"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['resolucion'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['resolucion'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
<?php
   if (is_file("grid_terceros_contratos_generar_fv_02112020_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.anio_liquidar_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_anio_liquidar'), document.F1.anio_liquidar_cond, 'anio_liquidar');
   document.F1.anio_liquidar.value = "";
   document.F1.periodo_liquidar_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_periodo_liquidar'), document.F1.periodo_liquidar_cond, 'periodo_liquidar');
   document.F1.periodo_liquidar.value = "";
 ...
 function Sc_carga_select2(Field)
 {
    ...
    if (Field == 'all' || Field == 'anio_liquidar') {
       Sc_carga_select2_anio_liquidar();
    }
    if (Field == 'all' || Field == 'periodo_liquidar') {
       Sc_carga_select2_periodo_liquidar();
    }
 ...
 function Sc_carga_select2_anio_liquidar()
 {
  $("#SC_anio_liquidar").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
 ...
 function Sc_carga_select2_periodo_liquidar()
 {
  $("#SC_periodo_liquidar").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
 ...
 {
    $('#SC_fecha_inicio_dia').bind('change', function() {sc_grid_terceros_contratos_generar_fv_02112020_valida_dia(this)});
    $('#SC_fecha_inicio_input_2_dia').bind('change', function() {sc_grid_terceros_contratos_generar_fv_02112020_valida_dia(this)});
    $('#SC_fecha_inicio_input_2_mes').bind('change', function() {sc_grid_terceros_contratos_generar_fv_02112020_valida_mes(this)});
    $('#SC_fecha_inicio_mes').bind('change', function() {sc_grid_terceros_contratos_generar_fv_02112020_valida_mes(this)});
 }
 function sc_grid_terceros_contratos_generar_fv_02112020_valida_dia(obj)
 {
 ...
 function sc_grid_terceros_contratos_generar_fv_02112020_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_terceros_contratos_generar_fv_02112020";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_terceros_contratos_generar_fv_02112020/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_anio_liquidar_cond'] = 'cond';
      $tp_fields['SC_anio_liquidar'] = 'select';
      $tp_fields['SC_periodo_liquidar_cond'] = 'cond';
      $tp_fields['SC_periodo_liquidar'] = 'select';
   ...
   function trata_campos()
   {
      ...
      $anio_liquidar_cond_salva = $anio_liquidar_cond; 
      if (!isset($anio_liquidar_input_2) || $anio_liquidar_input_2 == "")
      {
          $anio_liquidar_input_2 = $anio_liquidar;
      }
      $periodo_liquidar_cond_salva = $periodo_liquidar_cond; 
      if (!isset($periodo_liquidar_input_2) || $periodo_liquidar_input_2 == "")
      {
          $periodo_liquidar_input_2 = $periodo_liquidar;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca'];
      }
      $tmp_pos = strpos($zona, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $zona;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['zona'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Zona : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($anio_liquidar, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $anio_liquidar;
      }
      else {
          $L_lookup = substr($anio_liquidar, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['anio_liquidar'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= " Año a liquidar : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($periodo_liquidar, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $periodo_liquidar;
      }
      else {
          $L_lookup = substr($periodo_liquidar, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['periodo_liquidar'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Periodo a liquidar : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['estado'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['psq_check_ret']['resolucion'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['zona'] = $zona; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['zona_cond'] = $zona_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['anio_liquidar'] = $anio_liquidar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['anio_liquidar_cond'] = $anio_liquidar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['periodo_liquidar'] = $periodo_liquidar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['periodo_liquidar_cond'] = $periodo_liquidar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_dia'] = $fecha_inicio_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_mes'] = $fecha_inicio_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_ano'] = $fecha_inicio_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_input_2_dia'] = $fecha_inicio_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_input_2_mes'] = $fecha_inicio_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_input_2_ano'] = $fecha_inicio_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_cond'] = $fecha_inicio_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['numero_contrato'] = $numero_contrato; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['numero_contrato_cond'] = $numero_contrato_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['cliente'] = $cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['cliente_cond'] = $cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['estado'] = $estado; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['estado_cond'] = $estado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['resolucion'] = $resolucion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['resolucion_cond'] = $resolucion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca'] = $Temp_Busca;
      }
      ...
      $anio_liquidar_LKP = $anio_liquidar;
      $Tmp_pos = strpos($anio_liquidar, "##@@");
      if ($Tmp_pos !== false)
      {
          $anio_liquidar = substr($anio_liquidar, 0, $Tmp_pos);
      ...
      $periodo_liquidar_LKP = $periodo_liquidar;
      $Tmp_pos = strpos($periodo_liquidar, "##@@");
      if ($Tmp_pos !== false)
      {
          $periodo_liquidar = substr($periodo_liquidar, 0, $Tmp_pos);
...
if (!isset($this->sc_temp_ganio)) {$this->sc_temp_ganio = (isset($_SESSION['ganio'])) ? $_SESSION['ganio'] : "";}
 $this->sc_temp_ganio       = $anio_liquidar ;
$this->sc_temp_gperiodo    = $periodo_liquidar ;
$this->sc_temp_gresolucion = $resolucion ;
$vsql = "select prefijo from resdian where Idres='".$resolucion ."'";
...
$_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_02112020']['contr_erro'] = 'off'; 
      ...
      if ($anio_liquidar_LKP == $anio_liquidar)
      {
          $anio_liquidar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['anio_liquidar'];
      }
      if ($periodo_liquidar_LKP == $periodo_liquidar)
      {
          $periodo_liquidar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['periodo_liquidar'];
      }
      ...
      $Conteudo = $anio_liquidar;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['anio_liquidar'] = $Conteudo;
      $Conteudo = $periodo_liquidar;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['periodo_liquidar'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($numero_contrato != '') {
      $numero_contrato_look = substr($this->Db->qstr($numero_contrato), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
    ...
    if ($cliente != '') {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca_ant']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca'];
      }
      ...
      if ($fecha_inicio_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio'] = $val[0];
          ...
          if ($fecha_inicio_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']['fecha_inicio_input_2'] = $val[1];
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_pesq_ant'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca_ant'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['campos_busca'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_pesq'];
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "estado" : return ('class="scFilterObjectOdd"'); break;
