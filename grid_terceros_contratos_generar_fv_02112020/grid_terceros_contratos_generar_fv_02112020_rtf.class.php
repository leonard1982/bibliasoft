...
class grid_terceros_contratos_generar_fv_02112020_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          foreach ($todo as $param)
          {
               ...
               if (1 < sizeof($cadapar))
               {
                   ...
                   nm_limpa_str_grid_terceros_contratos_generar_fv_02112020($cadapar[1]);
                   nm_protect_num_grid_terceros_contratos_generar_fv_02112020($cadapar[0], $cadapar[1]);
                   if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                   $Tmp_par   = $cadapar[0];
                   $$Tmp_par = $cadapar[1];
                   if ($Tmp_par == "nmgp_opcao")
                   {
                       $_SESSION['sc_session'][$script_case_init]['grid_terceros_contratos_generar_fv_02112020']['opcao'] = $cadapar[1];
                   }
               }
          }
      }
      if (isset($ganio)) 
      {
          ...
          nm_limpa_str_grid_terceros_contratos_generar_fv_02112020($_SESSION["ganio"]);
      }
      if (isset($gperiodo)) 
      {
          $_SESSION['gperiodo'] = $gperiodo;
          nm_limpa_str_grid_terceros_contratos_generar_fv_02112020($_SESSION["gperiodo"]);
      }
      if (isset($gprefijo)) 
      {
          $_SESSION['gprefijo'] = $gprefijo;
          nm_limpa_str_grid_terceros_contratos_generar_fv_02112020($_SESSION["gprefijo"]);
      }
      if (isset($gresolucion)) 
      {
          $_SESSION['gresolucion'] = $gresolucion;
          nm_limpa_str_grid_terceros_contratos_generar_fv_02112020($_SESSION["gresolucion"]);
      }
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      require_once($this->Ini->path_aplicacao . "grid_terceros_contratos_generar_fv_02112020_total.class.php"); 
      ...
      if (method_exists($this->Tot,$Gb_geral))
      {
          ...
          {
              $this->sum_mensualidad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['tot_geral'][2];
          }
      }
      if (!$this->Ini->sc_export_ajax) {
      ...
      $this->Arquivo   .= "_grid_terceros_contratos_generar_fv_02112020";
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_terceros_contratos_generar_fv_02112020.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['rtf_name']);
      }
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['order_grid'];
...
$_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_02112020']['contr_erro'] = 'off'; 
      ...
      $this->Texto_tag .= "</table>\r\n";
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   //----- numero_contrato
   ...
   function NM_export_zona()
   {
         ...
         $this->look_zona = str_replace('<', '&lt;', $this->look_zona);
         $this->look_zona = str_replace('>', '&gt;', $this->look_zona);
         $this->Texto_tag .= "<td>" . $this->look_zona . "</td>\r\n";
   }
   //----- estado
   ...
   function NM_export_novedades()
   {
         ...
         $this->novedades = str_replace('<', '&lt;', $this->novedades);
         $this->novedades = str_replace('>', '&gt;', $this->novedades);
         $this->Texto_tag .= "<td>" . $this->novedades . "</td>\r\n";
   }
   //----- fecha_factura
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos_generar_fv_02112020'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>Generar Factura a Contratos :: RTF</TITLE>
...
<form name="Fdown" method="get" action="grid_terceros_contratos_generar_fv_02112020_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="grid_terceros_contratos_generar_fv_02112020"> 
