<?php
@session_start() ;
$_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_02112020']['sc_process_barr'] = true;
require_once('../grid_terceros_contratos_generar_fv_02112020/index.php');
unset($_SESSION['scriptcase']['grid_terceros_contratos_generar_fv_02112020']['sc_process_barr']);
$ExportCtrl = new grid_terceros_contratos_generar_fv_02112020_export_control;
$ExportCtrl->Export_barr();

class grid_terceros_contratos_generar_fv_02112020_export_control
{
