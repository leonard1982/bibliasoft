...
if(!empty($vperiodo) and !empty($vanio) and !empty($vzona) and !empty($vidres))
{
	...
	file_put_contents($vruta_archivo, fopen($vurl, 'r'));
	
	echo "<div>";
	echo "Descarga aquí el archivo en PDF <a href='".$vruta_archivo."'>".$vanio."_".$vperiodo.".pdf"."</a>";
	echo "</div><br>";
}
else
{
