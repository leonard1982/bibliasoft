...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_terceros_cuentas_100219_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_terceros_cuentas_100219_mob']['insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_terceros_cuentas_100219_mob']['insert'];
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_cuentas_100219_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_cuentas_100219_mob']['embutida_liga_form_insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_cuentas_100219_mob']['embutida_liga_form_insert'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_terceros_cuentas_100219_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_terceros_cuentas_100219_mob']['insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_terceros_cuentas_100219_mob']['insert'];
      }
...
//---------- 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_cuentas_100219_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_cuentas_100219_mob']['dados_select'];
