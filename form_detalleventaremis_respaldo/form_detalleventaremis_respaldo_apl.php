<?php
//
class form_detalleventaremis_respaldo_apl
{
   ...
   var $form_vert_form_detalleventaremis_respaldo = array();
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_numfacventa)) 
          {
              $_SESSION['par_numfacventa'] = $this->par_numfacventa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_detalleventaremis_respaldo_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_detalleventaremis_respaldo']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_detalleventaremis_respaldo']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_detalleventaremis_respaldo'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalleventaremis_respaldo']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalleventaremis_respaldo']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_detalleventaremis_respaldo') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalleventaremis_respaldo']['label'] = "Detalle venta";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_detalleventaremis_respaldo")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_detalleventaremis_respaldo']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_detalleventaremis_respaldo'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_orig'] = " where remision=" . $_SESSION['par_numfacventa'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_pesq'] = " where remision=" . $_SESSION['par_numfacventa'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleventaremis_respaldo']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_detalleventaremis_respaldo'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_detalleventaremis_respaldo'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['exit'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_detalleventaremis_respaldo", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_detalleventaremis_respaldo_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_detalleventaremis_respaldo_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_detalleventaremis_respaldo/form_detalleventaremis_respaldo_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_detalleventaremis_respaldo_erro.class.php"); 
      }
      $this->Erro      = new form_detalleventaremis_respaldo_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_max_reg']) == "all")
      {
      ...
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['opcao']))
         { 
             if ($this->iddet_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_detalleventaremis_respaldo']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_detalleventaremis_respaldo']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_form'][$sc_seq_vert];
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_detalleventaremis_respaldo']) || !is_array($this->NM_ajax_info['errList']['geral_form_detalleventaremis_respaldo']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalleventaremis_respaldo'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalleventaremis_respaldo'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalleventaremis_respaldo'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalleventaremis_respaldo'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_redir_atualiz'] == "ok")
          {
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_detalleventaremis_respaldo_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_detalleventaremis_respaldo_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      { 
         ...
         { 
             $GLOBALS["idpro_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['idpro_'];
         } 
         ...
         if (isset($this->adicional_)) { $this->nm_limpa_alfa($this->adicional_); }
         if (isset($this->adicional1_)) { $this->nm_limpa_alfa($this->adicional1_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert];
         }
         if ($this->nmgp_opcao != "recarga" && (!in_array($sc_seq_vert, $sc_check_excl) && !in_array($sc_seq_vert, $sc_check_incl) ))
         { }
         else
         {
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['idpro_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_disabled'][$sc_seq_vert]['idpro_']))
             { 
                 $this->idpro_ = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['idpro_'];
             } 
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['idbod_'] =  $this->idbod_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['unidadmayor_'] =  $this->unidadmayor_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['stockubica_'] =  $this->stockubica_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['unidad_'] =  $this->unidad_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['cantidad_'] =  $this->cantidad_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['valorunit_'] =  $this->valorunit_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['valorpar_'] =  $this->valorpar_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['descuento_'] =  $this->descuento_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['adicional_'] =  $this->adicional_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['adicional1_'] =  $this->adicional1_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['factor_'] =  $this->factor_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['iva_'] =  $this->iva_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['costop_'] =  $this->costop_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['iddet_'] =  $this->iddet_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['numfac_'] =  $this->numfac_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['remision_'] =  $this->remision_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['devuelto_'] =  $this->devuelto_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_detalleventaremis_respaldo);
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_detalleventaremis_respaldo.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_detalleventaremis_respaldo_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_detalleventaremis_respaldo"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_detalleventaremis_respaldo'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      {
      $_SESSION['scriptcase']['form_detalleventaremis_respaldo']['contr_erro'] = 'on';
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
  ...
  if ($this->sc_evento == "excluir" || $this->sc_evento == "delete")
	{goto a;}
if($this->cantidad_ >$this->stockubica_ )
	{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_detalleventaremis_respaldo';
...
$_SESSION['scriptcase']['form_detalleventaremis_respaldo']['contr_erro'] = 'off'; 
    ...
    function ValidateField_idbod_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idbod_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['Lookup_idbod_']) && !in_array($this->idbod_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['Lookup_idbod_']))
               {
                   $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['iddet_']['keyVal'] = form_detalleventaremis_respaldo_pack_protect_string($this->nmgp_dados_form['iddet_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['idpro_'] = $this->idpro_;
                  }
                  if (isset($this->NM_ajax_changed['idbod_']) && $this->NM_ajax_changed['idbod_'])
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['idbod_'] = $this->idbod_;
                  }
                  if (isset($this->NM_ajax_changed['unidadmayor_']) && $this->NM_ajax_changed['unidadmayor_'])
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['unidadmayor_'] = $this->unidadmayor_;
                  }
                  if (isset($this->NM_ajax_changed['stockubica_']) && $this->NM_ajax_changed['stockubica_'])
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['stockubica_'] = $this->stockubica_;
                  }
                  if (isset($this->NM_ajax_changed['unidad_']) && $this->NM_ajax_changed['unidad_'])
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['unidad_'] = $this->unidad_;
                  }
                  if (isset($this->NM_ajax_changed['cantidad_']) && $this->NM_ajax_changed['cantidad_'])
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['cantidad_'] = $this->cantidad_;
                  }
                  if (isset($this->NM_ajax_changed['valorunit_']) && $this->NM_ajax_changed['valorunit_'])
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['valorunit_'] = $this->valorunit_;
                  }
                  if (isset($this->NM_ajax_changed['valorpar_']) && $this->NM_ajax_changed['valorpar_'])
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['valorpar_'] = $this->valorpar_;
                  }
                  if (isset($this->NM_ajax_changed['descuento_']) && $this->NM_ajax_changed['descuento_'])
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['descuento_'] = $this->descuento_;
                  }
                  if (isset($this->NM_ajax_changed['adicional_']) && $this->NM_ajax_changed['adicional_'])
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['adicional_'] = $this->adicional_;
                  }
                  if (isset($this->NM_ajax_changed['adicional1_']) && $this->NM_ajax_changed['adicional1_'])
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['adicional1_'] = $this->adicional1_;
                  }
                  if (isset($this->NM_ajax_changed['factor_']) && $this->NM_ajax_changed['factor_'])
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['factor_'] = $this->factor_;
                  }
                  if (isset($this->NM_ajax_changed['iva_']) && $this->NM_ajax_changed['iva_'])
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['iva_'] = $this->iva_;
                  }
                  if (isset($this->NM_ajax_changed['costop_']) && $this->NM_ajax_changed['costop_'])
                  {
                      $this->form_vert_form_detalleventaremis_respaldo[$this->nmgp_refresh_row]['costop_'] = $this->costop_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_detalleventaremis_respaldo as $sc_seq_vert => $aRecData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['idpro_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][form_detalleventaremis_respaldo_pack_protect_string($aRecData['idpro_'])]),
              );
              }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idbod_' . $sc_seq_vert]['valList'][$i] = form_detalleventaremis_respaldo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          $this->NM_ajax_info['fldList']['idbod_' . $sc_seq_vert]['labList'] = $aLabel;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("unidadmayor_", $this->nmgp_refresh_fields)))
              {
                  ...
                  $aLookup = array();
$aLookup[] = array(form_detalleventaremis_respaldo_pack_protect_string('NO') => str_replace('<', '&lt;',form_detalleventaremis_respaldo_pack_protect_string("NO")));
$aLookup[] = array(form_detalleventaremis_respaldo_pack_protect_string('SI') => str_replace('<', '&lt;',form_detalleventaremis_respaldo_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['Lookup_unidadmayor_'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['Lookup_unidadmayor_'][] = 'SI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['unidadmayor_' . $sc_seq_vert]['valList'][$i] = form_detalleventaremis_respaldo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->iddet_)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
$sql="select idinv from inventario where idpro=$this->idpro_  and remision=$this->remision_ ";
...
$_SESSION['scriptcase']['form_detalleventaremis_respaldo']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['idpro_'] = $this->idpro_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['idbod_'] = $this->idbod_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['unidadmayor_'] = $this->unidadmayor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['cantidad_'] = $this->cantidad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['valorunit_'] = $this->valorunit_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['valorpar_'] = $this->valorpar_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['descuento_'] = $this->descuento_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['adicional_'] = $this->adicional_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['adicional1_'] = $this->adicional1_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['factor_'] = $this->factor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['iva_'] = $this->iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert]['costop_'] = $this->costop_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "idpro = $this->idpro_, unidadmayor = '$this->unidadmayor_', factor = $this->factor_, idbod = $this->idbod_, costop = $this->costop_, cantidad = $this->cantidad_, valorunit = $this->valorunit_, valorpar = $this->valorpar_, iva = $this->iva_, descuento = $this->descuento_, adicional = $this->adicional_, adicional1 = $this->adicional1_"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('idpro_', 'idbod_', 'unidadmayor_', 'stockubica_', 'unidad_', 'cantidad_', 'valorunit_', 'valorpar_', 'descuento_', 'adicional_', 'adicional1_', 'factor_', 'iva_', 'costop_'), $aDoNotUpdate);
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (numfac, remision, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto) VALUES ($this->numfac_, $this->remision_, $this->idpro_, '$this->unidadmayor_', $this->factor_, $this->idbod_, $this->costop_, $this->cantidad_, $this->valorunit_, $this->valorpar_, $this->iva_, $this->descuento_, $this->adicional_, $this->adicional1_, $this->devuelto_)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "numfac, remision, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto) VALUES (" . $NM_seq_auto . "$this->numfac_, $this->remision_, $this->idpro_, '$this->unidadmayor_', $this->factor_, $this->idbod_, $this->costop_, $this->cantidad_, $this->valorunit_, $this->valorpar_, $this->iva_, $this->descuento_, $this->adicional_, $this->adicional1_, $this->devuelto_)"; 
              }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == form_detalleventaremis_respaldo_pack_protect_string(NM_charset_to_utf8($this->idbod_)))
              {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['Lookup_unidadmayor_'][] = 'SI';
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detalleventaremis_respaldo_pack_protect_string(NM_charset_to_utf8($this->unidadmayor_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
          $tmpLabel_unidadmayor_ = $sLabelTemp;
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] = 0; 
              }
...
if($this->unidadmayor_ =='NO' and $this->factor_ >0)
	...
	$cant=round($aux, 3);
     ...
     $nm_select ="INSERT inventario SET fecha='$this->ds', cantidad=($cant*-1), idpro=$this->idpro_ , costo=$this->costop_ , 	valorparcial=($this->valorpar_ -$this->descuento_ ), idbod=$this->idbod_ , tipo=2, detalle='Venta Remisión', idmov=1,  	remision=$this->sc_temp_par_numfacventa, iddetalle=$last_id"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
else
	{
     ...
     $nm_select ="INSERT inventario SET fecha='$this->ds', cantidad=($this->cantidad_ *-1), idpro=$this->idpro_ , costo=$this->costop_ , 	valorparcial=($this->valorpar_ -$this->descuento_ ), idbod=$this->idbod_ , tipo=2, detalle='Venta Remisión', idmov=1,  	remision=$this->sc_temp_par_numfacventa, iddetalle=$last_id"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$_SESSION['scriptcase']['form_detalleventaremis_respaldo']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['parms'] = "iddet_?#?$this->iddet_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleventaremis_respaldo']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_detalleventaremis_respaldo = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter'] . ")";
          }
      }
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['total']))
          {
              ...
              $qt_geral_reg_form_detalleventaremis_respaldo = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['total'] = $qt_geral_reg_form_detalleventaremis_respaldo;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['total']) || $this->sc_teve_excl || $this->sc_teve_incl)
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->iddet_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_detalleventaremis_respaldo = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_detalleventaremis_respaldo) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] += $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] > $qt_geral_reg_form_detalleventaremis_respaldo)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] = $qt_geral_reg_form_detalleventaremis_respaldo - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] = ($qt_geral_reg_form_detalleventaremis_respaldo + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['ordem_ord']; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nmgp_select = "SELECT iddet, numfac, remision, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nmgp_select = "SELECT iddet, numfac, remision, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      ...
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['run_iframe'] == "R")
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              $rs = $this->Db->Execute($nmgp_select) ; 
          } 
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['parms'] = "iddet_?#?$this->iddet_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
             $this->form_vert_form_detalleventaremis_respaldo[$sc_seq_vert]['idbod_'] =  $this->idbod_; 
          ...
          ksort ($this->form_vert_form_detalleventaremis_respaldo); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          {
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['total'] + 1; 
          }
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] < (($qt_geral_reg_form_detalleventaremis_respaldo + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['embutida_multi']) 
          { 
          } 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['reg_start'] + $this->sc_max_reg;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$this->nm_formatar_campos('cantidad_', 'stockubica_', 'idpro_', 'adicional1_', 'descuento_', 'valorpar_', 'adicional_', 'iva_', 'valorunit_', 'idbod_', 'unidadmayor_', 'factor_', 'unidad_');
...
$modificado_stockubica_ = $this->stockubica_;
$modificado_unidad_ = $this->unidad_;
$this->nm_formatar_campos('idpro_', 'valorunit_', 'unidadmayor_', 'costop_', 'factor_', 'adicional1_', 'descuento_', 'valorpar_', 'adicional_', 'iva_', 'cantidad_', 'idbod_', 'stockubica_', 'unidad_');
$this->nmgp_refresh_fields = array();
if ($original_idpro_ !== $modificado_idpro_ || isset($this->nmgp_cmp_readonly['idpro_']) || (isset($bFlagRead_idpro_) && $bFlagRead_idpro_))
{
    $this->nmgp_refresh_fields[] = 'idpro_';
...
$modificado_stockubica_ = $this->stockubica_;
$modificado_unidad_ = $this->unidad_;
$this->nm_formatar_campos('unidadmayor_', 'factor_', 'valorunit_', 'idpro_', 'adicional1_', 'descuento_', 'valorpar_', 'adicional_', 'iva_', 'cantidad_', 'idbod_', 'stockubica_', 'unidad_');
$this->nmgp_refresh_fields = array();
if ($original_unidadmayor_ !== $modificado_unidadmayor_ || isset($this->nmgp_cmp_readonly['unidadmayor_']) || (isset($bFlagRead_unidadmayor_) && $bFlagRead_unidadmayor_))
{
    $this->nmgp_refresh_fields[] = 'unidadmayor_';
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter_form'] . " and (remision=" . $_SESSION['par_numfacventa'] . ") and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_detalleventaremis_respaldo = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['total'] = $qt_geral_reg_form_detalleventaremis_respaldo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_detalleventaremis_respaldo_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "iddet";$nm_numeric[] = "numfac";$nm_numeric[] = "remision";$nm_numeric[] = "idpro";$nm_numeric[] = "factor";$nm_numeric[] = "idbod";$nm_numeric[] = "costop";$nm_numeric[] = "cantidad";$nm_numeric[] = "valorunit";$nm_numeric[] = "valorpar";$nm_numeric[] = "iva";$nm_numeric[] = "descuento";$nm_numeric[] = "adicional";$nm_numeric[] = "adicional1";$nm_numeric[] = "devuelto";$nm_numeric[] = "";
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_detalleventaremis_respaldo_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_detalleventaremis_respaldo_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['masterValue']))
{
...
<?php
  exit;
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleventaremis_respaldo']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
