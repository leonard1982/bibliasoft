<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_caja_1']['sc_process_barr'] = true;
require_once('../pdfreport_caja_1/index.php');
unset($_SESSION['scriptcase']['pdfreport_caja_1']['sc_process_barr']);
$ExportCtrl = new pdfreport_caja_1_export_control;
$ExportCtrl->Export_barr();

class pdfreport_caja_1_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_titl'] ?> - caja</TITLE>
