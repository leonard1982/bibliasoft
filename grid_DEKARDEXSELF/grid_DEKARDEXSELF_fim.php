...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_DEKARDEXSELF"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_DEKARDEXSELF"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_DEKARDEXSELF']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_DEKARDEXSELF']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_DEKARDEXSELF']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_DEKARDEXSELF']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_DEKARDEXSELF']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_DEKARDEXSELF']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_DEKARDEXSELF']['embutida_filho'] as $ind => $sc_init)
          {
