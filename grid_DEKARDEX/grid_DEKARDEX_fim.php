...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_DEKARDEX"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_DEKARDEX"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_DEKARDEX']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_DEKARDEX']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_DEKARDEX']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_DEKARDEX']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_DEKARDEX']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_DEKARDEX']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_DEKARDEX']['embutida_filho'] as $ind => $sc_init)
          {
