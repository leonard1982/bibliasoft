...
class grid_DEKARDEX_resumo
{
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_DEKARDEX']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_DEKARDEX']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['arr_total']['porciva'] = $this->array_total_porciva;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['json_use_label'])
       {
          $Lab_porciva = "PORCIVA";
       }
       else
       ...
       $prep_field = array();
       $prep_field['porciva'] = $Lab_porciva;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['porciva'] = $Lab_porciva; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['matid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['matid'] = "PRODUCTO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['bodid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['bodid'] = "BD"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['tipund']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['tipund'] = "UND"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['porciva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['porciva'] = "IVA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['descuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['descuento'] = "DESC."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['canlista']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['canlista'] = "CANT."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['precioneto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['precioneto'] = "VALOR/U"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['base_linea']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['base_linea'] = "BASE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['iva_linea']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['iva_linea'] = "IVA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['parcvta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['parcvta'] = "T/LINEA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['seriales']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['seriales'] = "SERIALES"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['preciovta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['preciovta'] = "PRECIOVTA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['preciobase']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['preciobase'] = "BASE/U"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['precioiva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['precioiva'] = "IVA/U"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['dekardexid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['dekardexid'] = "DEKARDEXID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['kardexid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['kardexid'] = "KARDEXID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['prioridad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['prioridad'] = "PRIORIDAD"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['remtotfac']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['remtotfac'] = "REMTOTFAC"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['canmat']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['canmat'] = "CANMAT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['preciolista']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['preciolista'] = "PRECIOLISTA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['precioexcento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['precioexcento'] = "PRECIOEXCENTO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['precioiconsumo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['precioiconsumo'] = "PRECIOICONSUMO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['parcosto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['parcosto'] = "PARCOSTO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['salcan']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['salcan'] = "SALCAN"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['salcost']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['salcost'] = "SALCOST"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['dctoadic']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['dctoadic'] = "DCTOADIC"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['impreso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['impreso'] = "IMPRESO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['descuento3']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['descuento3'] = "DESCUENTO3"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['sobrante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['sobrante'] = "SOBRANTE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['faltante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['faltante'] = "FALTANTE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['cambio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['cambio'] = "CAMBIO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['calidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['calidad'] = "CALIDAD"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['descuento4']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['descuento4'] = "DESCUENTO4"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['tallacolor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['tallacolor'] = "TALLACOLOR"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['conrem']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['conrem'] = "CONREM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['tipovta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['tipovta'] = "TIPOVTA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['dajustebase']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['dajustebase'] = "DAJUSTEBASE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['cenid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['cenid'] = "CENID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['excluido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['excluido'] = "EXCLUIDO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['realid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['realid'] = "REALID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['impresop']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['impresop'] = "IMPRESOP"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['preciotasa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['preciotasa'] = "PRECIOTASA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['parctasa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['parctasa'] = "PARCTASA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['contratoinmid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['contratoinmid'] = "CONTRATOINMID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['fecmaxdevre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['fecmaxdevre'] = "FECMAXDEVRE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['sn_vunitario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['sn_vunitario'] = "SN VUNITARIO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['sn_observ_edit']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['labels']['sn_observ_edit'] = "SN OBSERV EDIT"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['porciva']['alin'] = "''";
       $Arr_parms['porciva']['link'] = "S";
       $Arr_parms['porciva']['fill'] = "true";
       $Arr_parms['porciva']['order'] = "label";
       $Arr_parms['porciva']['order_start'] = 'asc';
       $Arr_parms['porciva']['order_invert'] = 'false';
       $Arr_parms['porciva']['order_enabled'] = 'true';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['porciva'] = array(0 => 'porciva', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_DEKARDEX@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_DEKARDEX_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_DEKARDEX/grid_DEKARDEX_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_DEKARDEX_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_DEKARDEX_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_DEKARDEX_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_DEKARDEX/grid_DEKARDEX_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_DEKARDEX/grid_DEKARDEX_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_DEKARDEX&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_DEKARDEX/grid_DEKARDEX_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_DEKARDEX/grid_DEKARDEX_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_DEKARDEX/grid_DEKARDEX_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_DEKARDEX_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_DEKARDEX']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_DEKARDEX']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_DEKARDEX_config_pivot.php?nome_apl=grid_DEKARDEX&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_DEKARDEX_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_DEKARDEX/grid_DEKARDEX_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $dekardexid = $Busca_temp['dekardexid']; 
          $tmp_pos = strpos($dekardexid, "##@@");
          if ($tmp_pos !== false && !is_array($dekardexid))
          {
              $dekardexid = substr($dekardexid, 0, $tmp_pos);
          }
          $kardexid = $Busca_temp['kardexid']; 
          $tmp_pos = strpos($kardexid, "##@@");
          if ($tmp_pos !== false && !is_array($kardexid))
          {
              $kardexid = substr($kardexid, 0, $tmp_pos);
          }
          $matid = $Busca_temp['matid']; 
          $tmp_pos = strpos($matid, "##@@");
          if ($tmp_pos !== false && !is_array($matid))
          {
              $matid = substr($matid, 0, $tmp_pos);
          }
          $bodid = $Busca_temp['bodid']; 
          $tmp_pos = strpos($bodid, "##@@");
          if ($tmp_pos !== false && !is_array($bodid))
          {
              $bodid = substr($bodid, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($sum_base_linea, $sum_iva_linea, $sum_parcvta, $quebra_porciva, $quebra_porciva_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_base_linea)) {$sum_base_linea = '0';}
          if (empty($sum_iva_linea)) {$sum_iva_linea = '0';}
          if (empty($sum_parcvta)) {$sum_parcvta = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_base_linea . ';
              $this->' . $arr_name . '[2] = ' . $sum_iva_linea . ';
              $this->' . $arr_name . '[3] = ' . $sum_parcvta . ';
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->matid = $rs_res->fields[0] ;  
            $this->bodid = $rs_res->fields[1] ;  
            $this->tipund = $rs_res->fields[2] ;  
            $this->porciva = $rs_res->fields[3] ;  
            $this->porciva =  str_replace(",", ".", $this->porciva);
            $this->descuento = $rs_res->fields[4] ;  
            $this->descuento =  str_replace(",", ".", $this->descuento);
            $this->canlista = $rs_res->fields[5] ;  
            $this->canlista =  str_replace(",", ".", $this->canlista);
            $this->precioneto = $rs_res->fields[6] ;  
            $this->precioneto =  str_replace(",", ".", $this->precioneto);
            $this->base_linea = $rs_res->fields[7] ;  
            $this->base_linea =  str_replace(",", ".", $this->base_linea);
            $this->iva_linea = $rs_res->fields[8] ;  
            $this->iva_linea =  str_replace(",", ".", $this->iva_linea);
            $this->parcvta = $rs_res->fields[9] ;  
            $this->parcvta =  str_replace(",", ".", $this->parcvta);
            $this->preciovta = $rs_res->fields[10] ;  
            $this->preciovta =  str_replace(",", ".", $this->preciovta);
            $this->preciobase = $rs_res->fields[11] ;  
            $this->preciobase =  str_replace(",", ".", $this->preciobase);
            $this->precioiva = $rs_res->fields[12] ;  
            $this->precioiva =  str_replace(",", ".", $this->precioiva);
            $this->dekardexid = $rs_res->fields[13] ;  
            $this->porciva_orig = $this->porciva;
            nmgp_Form_Num_Val($this->porciva, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "0", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->base_linea, $this->iva_linea, $this->parcvta, $this->porciva, $this->porciva_orig);
            }
   }
//
