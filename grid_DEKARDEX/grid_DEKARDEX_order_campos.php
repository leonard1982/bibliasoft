<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_DEKARDEX']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_DEKARDEX_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_DEKARDEX_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['matid'] = "on";
   $tab_def_campos['matid'] = "MATID";
   $tab_labels["matid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["matid"])) ? $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["matid"] : "PRODUCTO";
   $tab_ger_campos['bodid'] = "on";
   $tab_def_campos['bodid'] = "BODID";
   $tab_labels["bodid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["bodid"])) ? $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["bodid"] : "BD";
   $tab_ger_campos['tipund'] = "on";
   $tab_def_campos['tipund'] = "TIPUND";
   $tab_labels["tipund"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["tipund"])) ? $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["tipund"] : "UND";
   $tab_ger_campos['porciva'] = "on";
   $tab_def_campos['porciva'] = "PORCIVA";
   $tab_labels["porciva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["porciva"])) ? $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["porciva"] : "IVA";
   $tab_ger_campos['descuento'] = "on";
   $tab_def_campos['descuento'] = "DESCUENTO";
   $tab_labels["descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["descuento"] : "DESC.";
   $tab_ger_campos['canlista'] = "on";
   $tab_def_campos['canlista'] = "CANLISTA";
   $tab_labels["canlista"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["canlista"])) ? $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["canlista"] : "CANT.";
   $tab_ger_campos['precioneto'] = "on";
   $tab_def_campos['precioneto'] = "PRECIONETO";
   $tab_labels["precioneto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["precioneto"])) ? $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["precioneto"] : "VALOR/U";
   $tab_ger_campos['base_linea'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['base_linea'] = "base_linea";
   }
   else
   {
       $tab_def_campos['base_linea'] = "(PARCVTA/((PORCIVA/100)+1))";
   }
   $tab_labels["base_linea"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["base_linea"])) ? $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["base_linea"] : "BASE";
   $tab_ger_campos['iva_linea'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['iva_linea'] = "iva_linea";
   }
   else
   {
       $tab_def_campos['iva_linea'] = "(PARCVTA-(PARCVTA/((PORCIVA/100)+1)))";
   }
   $tab_labels["iva_linea"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["iva_linea"])) ? $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["iva_linea"] : "IVA";
   $tab_ger_campos['parcvta'] = "on";
   $tab_def_campos['parcvta'] = "PARCVTA";
   $tab_labels["parcvta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["parcvta"])) ? $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["parcvta"] : "T/LINEA";
   $tab_ger_campos['seriales'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['seriales'] = "SERIALES";
   }
   else
   {
       $tab_def_campos['seriales'] = "";
   }
   $tab_labels["seriales"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["seriales"])) ? $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['labels']["seriales"] : "SERIALES";
   $tab_ger_campos['seriales'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_DEKARDEX_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_DEKARDEX']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
