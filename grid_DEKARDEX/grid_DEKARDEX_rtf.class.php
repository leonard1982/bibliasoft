...
class grid_DEKARDEX_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_DEKARDEX.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_DEKARDEX']['contr_erro'] = 'off'; 
   ...
   function NM_export_matid()
   {
         ...
         $this->look_matid = str_replace('<', '&lt;', $this->look_matid);
         $this->look_matid = str_replace('>', '&gt;', $this->look_matid);
         $this->Texto_tag .= "<td>" . $this->look_matid . "</td>\r\n";
   }
   //----- bodid
   function NM_export_bodid()
   {
         ...
         $this->look_bodid = str_replace('<', '&lt;', $this->look_bodid);
         $this->look_bodid = str_replace('>', '&gt;', $this->look_bodid);
         $this->Texto_tag .= "<td>" . $this->look_bodid . "</td>\r\n";
   }
   //----- tipund
   function NM_export_tipund()
   {
         ...
         $this->look_tipund = str_replace('<', '&lt;', $this->look_tipund);
         $this->look_tipund = str_replace('>', '&gt;', $this->look_tipund);
         $this->Texto_tag .= "<td>" . $this->look_tipund . "</td>\r\n";
   }
   //----- porciva
   function NM_export_porciva()
   {
         ...
         $this->porciva = str_replace('<', '&lt;', $this->porciva);
         $this->porciva = str_replace('>', '&gt;', $this->porciva);
         $this->Texto_tag .= "<td>" . $this->porciva . "</td>\r\n";
   }
   //----- descuento
   ...
   function NM_export_canlista()
   {
         ...
         $this->canlista = str_replace('<', '&lt;', $this->canlista);
         $this->canlista = str_replace('>', '&gt;', $this->canlista);
         $this->Texto_tag .= "<td>" . $this->canlista . "</td>\r\n";
   }
   //----- precioneto
   function NM_export_precioneto()
   {
         ...
         $this->precioneto = str_replace('<', '&lt;', $this->precioneto);
         $this->precioneto = str_replace('>', '&gt;', $this->precioneto);
         $this->Texto_tag .= "<td>" . $this->precioneto . "</td>\r\n";
   }
   //----- base_linea
   function NM_export_base_linea()
   {
         ...
         $this->base_linea = str_replace('<', '&lt;', $this->base_linea);
         $this->base_linea = str_replace('>', '&gt;', $this->base_linea);
         $this->Texto_tag .= "<td>" . $this->base_linea . "</td>\r\n";
   }
   //----- iva_linea
   function NM_export_iva_linea()
   {
         ...
         $this->iva_linea = str_replace('<', '&lt;', $this->iva_linea);
         $this->iva_linea = str_replace('>', '&gt;', $this->iva_linea);
         $this->Texto_tag .= "<td>" . $this->iva_linea . "</td>\r\n";
   }
   //----- parcvta
   function NM_export_parcvta()
   {
         ...
         $this->parcvta = str_replace('<', '&lt;', $this->parcvta);
         $this->parcvta = str_replace('>', '&gt;', $this->parcvta);
         $this->Texto_tag .= "<td>" . $this->parcvta . "</td>\r\n";
   }
   //----- seriales
   function NM_export_seriales()
   {
         ...
         $this->seriales = str_replace('<', '&lt;', $this->seriales);
         $this->seriales = str_replace('>', '&gt;', $this->seriales);
         $this->Texto_tag .= "<td>" . $this->seriales . "</td>\r\n";
   }
   //----- preciovta
   function NM_export_preciovta()
   {
         ...
         $this->preciovta = str_replace('<', '&lt;', $this->preciovta);
         $this->preciovta = str_replace('>', '&gt;', $this->preciovta);
         $this->Texto_tag .= "<td>" . $this->preciovta . "</td>\r\n";
   }
   //----- preciobase
   function NM_export_preciobase()
   {
         ...
         $this->preciobase = str_replace('<', '&lt;', $this->preciobase);
         $this->preciobase = str_replace('>', '&gt;', $this->preciobase);
         $this->Texto_tag .= "<td>" . $this->preciobase . "</td>\r\n";
   }
   //----- precioiva
   function NM_export_precioiva()
   {
         ...
         $this->precioiva = str_replace('<', '&lt;', $this->precioiva);
         $this->precioiva = str_replace('>', '&gt;', $this->precioiva);
         $this->Texto_tag .= "<td>" . $this->precioiva . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_DEKARDEX']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
