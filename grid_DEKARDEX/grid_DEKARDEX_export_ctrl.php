<?php
@session_start() ;
$_SESSION['scriptcase']['grid_DEKARDEX']['sc_process_barr'] = true;
require_once('../grid_DEKARDEX/index.php');
unset($_SESSION['scriptcase']['grid_DEKARDEX']['sc_process_barr']);
$ExportCtrl = new grid_DEKARDEX_export_control;
$ExportCtrl->Export_barr();

class grid_DEKARDEX_export_control
{
