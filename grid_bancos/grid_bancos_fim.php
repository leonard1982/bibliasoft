...
//----- 
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_bancos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_bancos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_bancos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_bancos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_bancos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_bancos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_bancos']['embutida_filho'] as $ind => $sc_init)
          {
