<?php
@session_start() ;
$_SESSION['scriptcase']['ventas_periodo']['sc_process_barr'] = true;
require_once('../ventas_periodo/index.php');
unset($_SESSION['scriptcase']['ventas_periodo']['sc_process_barr']);
$ExportCtrl = new ventas_periodo_export_control;
$ExportCtrl->Export_barr();

class ventas_periodo_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> facturaven</TITLE>
