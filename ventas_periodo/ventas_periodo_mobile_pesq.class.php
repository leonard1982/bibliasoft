...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "month(fechaven)";$Nm_numeric[] = "total";$Nm_numeric[] = "year(fechaven)";$Nm_numeric[] = "month(fechaven)";$Nm_numeric[] = "total";$Nm_numeric[] = "year(fechaven)";
