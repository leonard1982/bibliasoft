<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detallecompra_new_nc']['sc_process_barr'] = true;
require_once('../grid_detallecompra_new_nc/index.php');
unset($_SESSION['scriptcase']['grid_detallecompra_new_nc']['sc_process_barr']);
$ExportCtrl = new grid_detallecompra_new_nc_export_control;
$ExportCtrl->Export_barr();

class grid_detallecompra_new_nc_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_detallecompra_new_nc']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_detallecompra_new_nc']['glo_nm_path_imag_temp'];
