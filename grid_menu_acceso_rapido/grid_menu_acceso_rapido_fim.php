...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_menu_acceso_rapido"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_menu_acceso_rapido"]);
   }
