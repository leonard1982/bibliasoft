...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_menu_acceso_rapido"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_menu_acceso_rapido"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_menu_acceso_rapido']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_menu_acceso_rapido']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_menu_acceso_rapido']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_menu_acceso_rapido']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_menu_acceso_rapido']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_menu_acceso_rapido']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_menu_acceso_rapido']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_menu_acceso_rapido</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_menu_acceso_rapido']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_menu_acceso_rapido']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_menu_acceso_rapido' || $achou)
          {
