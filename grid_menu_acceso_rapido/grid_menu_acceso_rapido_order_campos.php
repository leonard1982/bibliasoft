<?php
   include_once('grid_menu_acceso_rapido_session.php');
   session_start();
   if (!function_exists("NM_is_utf8"))
   {
       include_once("../_lib/lib/php/nm_utf8.php");
   }
    $Ord_Cmp = new grid_menu_acceso_rapido_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_menu_acceso_rapido_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['terceros'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['terceros'] = "terceros";
       $tab_converte["terceros"]   = "terceros";
   }
   else
   {
       $tab_def_campos['terceros'] = "";
       $tab_converte[""]   = "terceros";
   }
   $tab_labels["terceros"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["terceros"])) ? $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["terceros"] : "";
   $tab_ger_campos['productos'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['productos'] = "productos";
       $tab_converte["productos"]   = "productos";
   }
   else
   {
       $tab_def_campos['productos'] = "";
       $tab_converte[""]   = "productos";
   }
   $tab_labels["productos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["productos"])) ? $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["productos"] : "";
   $tab_ger_campos['compras'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['compras'] = "compras";
       $tab_converte["compras"]   = "compras";
   }
   else
   {
       $tab_def_campos['compras'] = "";
       $tab_converte[""]   = "compras";
   }
   $tab_labels["compras"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["compras"])) ? $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["compras"] : "";
   $tab_ger_campos['ventas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ventas'] = "ventas";
       $tab_converte["ventas"]   = "ventas";
   }
   else
   {
       $tab_def_campos['ventas'] = "";
       $tab_converte[""]   = "ventas";
   }
   $tab_labels["ventas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["ventas"])) ? $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["ventas"] : "";
   $tab_ger_campos['empresa'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['empresa'] = "empresa";
       $tab_converte["empresa"]   = "empresa";
   }
   else
   {
       $tab_def_campos['empresa'] = "";
       $tab_converte[""]   = "empresa";
   }
   $tab_labels["empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["empresa"] : "";
   $tab_ger_campos['cartera'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cartera'] = "cartera";
       $tab_converte["cartera"]   = "cartera";
   }
   else
   {
       $tab_def_campos['cartera'] = "";
       $tab_converte[""]   = "cartera";
   }
   $tab_labels["cartera"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["cartera"])) ? $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["cartera"] : "";
   $tab_ger_campos['tesoreria'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tesoreria'] = "tesoreria";
       $tab_converte["tesoreria"]   = "tesoreria";
   }
   else
   {
       $tab_def_campos['tesoreria'] = "";
       $tab_converte[""]   = "tesoreria";
   }
   $tab_labels["tesoreria"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["tesoreria"])) ? $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["tesoreria"] : "";
   $tab_ger_campos['copia'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['copia'] = "copia";
       $tab_converte["copia"]   = "copia";
   }
   else
   {
       $tab_def_campos['copia'] = "";
       $tab_converte[""]   = "copia";
   }
   $tab_labels["copia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["copia"])) ? $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["copia"] : "";
   $tab_ger_campos['soporte'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['soporte'] = "soporte";
       $tab_converte["soporte"]   = "soporte";
   }
   else
   {
       $tab_def_campos['soporte'] = "";
       $tab_converte[""]   = "soporte";
   }
   $tab_labels["soporte"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["soporte"])) ? $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["soporte"] : "";
   $tab_ger_campos['tutoriales'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tutoriales'] = "tutoriales";
       $tab_converte["tutoriales"]   = "tutoriales";
   }
   else
   {
       $tab_def_campos['tutoriales'] = "";
       $tab_converte[""]   = "tutoriales";
   }
   $tab_labels["tutoriales"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["tutoriales"])) ? $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["tutoriales"] : "";
   $tab_ger_campos['correo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['correo'] = "correo";
       $tab_converte["correo"]   = "correo";
   }
   else
   {
   ...
   $tab_labels["correo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["correo"])) ? $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["correo"] : "";
   $tab_ger_campos['gestor_archivos'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gestor_archivos'] = "gestor_archivos";
       $tab_converte["gestor_archivos"]   = "gestor_archivos";
   }
   else
   {
       $tab_def_campos['gestor_archivos'] = "";
       $tab_converte[""]   = "gestor_archivos";
   }
   $tab_labels["gestor_archivos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["gestor_archivos"])) ? $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["gestor_archivos"] : "";
   $tab_ger_campos['tareas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tareas'] = "tareas";
       $tab_converte["tareas"]   = "tareas";
   }
   else
   {
       $tab_def_campos['tareas'] = "";
       $tab_converte[""]   = "tareas";
   }
   $tab_labels["tareas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["tareas"])) ? $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['labels']["tareas"] : "";
   $tab_ger_campos['terceros'] = "none";
   $tab_ger_campos['productos'] = "none";
   $tab_ger_campos['compras'] = "none";
   $tab_ger_campos['ventas'] = "none";
   $tab_ger_campos['empresa'] = "none";
   $tab_ger_campos['cartera'] = "none";
   $tab_ger_campos['tesoreria'] = "none";
   $tab_ger_campos['copia'] = "none";
   $tab_ger_campos['soporte'] = "none";
   $tab_ger_campos['tutoriales'] = "none";
   $tab_ger_campos['correo'] = "none";
   $tab_ger_campos['gestor_archivos'] = "none";
   $tab_ger_campos['tareas'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
function Sel_processa_form()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos;
   ...
   $str_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "grid_fondo/grid_fondo";
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_menu_acceso_rapido_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_menu_acceso_rapido']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
