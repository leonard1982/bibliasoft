...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_kardex_nc_tns_01062020B"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_kardex_nc_tns_01062020B"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_01062020B']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_01062020B']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_01062020B']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_01062020B']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_01062020B']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_kardex_nc_tns_01062020B</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_01062020B']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_01062020B']['embutida_filho'] as $ind => $sc_init)
          {
