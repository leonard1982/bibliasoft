...
<?php
   ...
   $Ord_Cmp = new grid_kardex_nc_tns_01062020B_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_kardex_nc_tns_01062020B_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['enviar'] = "enviar";
   }
   else
   {
       $tab_def_campos['enviar'] = "";
   }
   $tab_labels["enviar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["enviar"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["enviar"] : "ENVIAR";
   $tab_ger_campos['codcomp'] = "on";
   $tab_def_campos['codcomp'] = "CODCOMP";
   $tab_labels["codcomp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["codcomp"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["codcomp"] : "TIPO";
   $tab_ger_campos['codprefijo'] = "on";
   $tab_def_campos['codprefijo'] = "CODPREFIJO";
   $tab_labels["codprefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["codprefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["codprefijo"] : "PJ/TNS";
   $tab_ger_campos['pj_fe'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pj_fe'] = "PJ_FE";
   }
   else
   {
       $tab_def_campos['pj_fe'] = "";
   }
   $tab_labels["pj_fe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["pj_fe"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["pj_fe"] : "PJ/FE";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "NUMERO";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["numero"] : "#";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "FECHA";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["fecha"] : "FECHA";
   $tab_ger_campos['nit_tercero'] = "on";
   $tab_def_campos['nit_tercero'] = "NIT_TERCERO";
   $tab_labels["nit_tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["nit_tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["nit_tercero"] : "ID";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "NOMBRE";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["nombre"] : "NOMBRE";
   ...
   {
       $tab_def_campos['email'] = "";
   }
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["email"] : "EMAIL";
   $tab_ger_campos['ico_cliente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['ico_cliente'] = "ico_cliente";
   }
   else
   {
       $tab_def_campos['ico_cliente'] = "";
   }
   $tab_labels["ico_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["ico_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["ico_cliente"] : "ASOCIAR/FV";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "TOTAL";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["total"] : "TOTAL";
   $tab_ger_campos['detalle'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['detalle'] = "detalle";
   }
   else
   {
       $tab_def_campos['detalle'] = "";
   }
   $tab_labels["detalle"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["detalle"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["detalle"] : "DETALLE";
   $tab_ger_campos['pdf'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pdf'] = "pdf";
   }
   else
   {
       $tab_def_campos['pdf'] = "";
   }
   $tab_labels["pdf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["pdf"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["pdf"] : "PDF";
   $tab_ger_campos['avisos'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['avisos'] = "avisos";
   }
   else
   {
       $tab_def_campos['avisos'] = "";
   }
   $tab_labels["avisos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["avisos"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["avisos"] : "XML";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["sc_field_0"] : "RE-ENVIAR";
   $tab_ger_campos['kardexid'] = "on";
   $tab_def_campos['kardexid'] = "KARDEXID";
   $tab_labels["kardexid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["kardexid"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['labels']["kardexid"] : "";
   $tab_ger_campos['enviar'] = "none";
   $tab_ger_campos['pj_fe'] = "none";
   $tab_ger_campos['email'] = "none";
   $tab_ger_campos['ico_cliente'] = "none";
   $tab_ger_campos['detalle'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_kardex_nc_tns_01062020B_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_01062020B']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
