<?php
@session_start() ;
$_SESSION['scriptcase']['grid_kardex_nc_tns_01062020B']['sc_process_barr'] = true;
require_once('../grid_kardex_nc_tns_01062020B/index.php');
unset($_SESSION['scriptcase']['grid_kardex_nc_tns_01062020B']['sc_process_barr']);
$ExportCtrl = new grid_kardex_nc_tns_01062020B_export_control;
$ExportCtrl->Export_barr();

class grid_kardex_nc_tns_01062020B_export_control
{
