<?php
@session_start() ;
$_SESSION['scriptcase']['grid_facturacom_genera_comprobantes']['sc_process_barr'] = true;
require_once('../grid_facturacom_genera_comprobantes/index.php');
unset($_SESSION['scriptcase']['grid_facturacom_genera_comprobantes']['sc_process_barr']);
$ExportCtrl = new grid_facturacom_genera_comprobantes_export_control;
$ExportCtrl->Export_barr();

class grid_facturacom_genera_comprobantes_export_control
{
