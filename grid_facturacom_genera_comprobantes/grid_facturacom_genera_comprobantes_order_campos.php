...
<?php
   ...
   $Ord_Cmp = new grid_facturacom_genera_comprobantes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_facturacom_genera_comprobantes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['fechaven'] = "fechacom";
   }
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["fechaven"] : "Fecha";
   ...
   {
       $tab_def_campos['credito'] = "formapago";
   }
   $tab_labels["credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["credito"] : "Credito";
   ...
   {
       $tab_def_campos['resolucion'] = "'1'";
   }
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["resolucion"] : "PJ";
   ...
   {
       $tab_def_campos['numfacven'] = "numfacom";
   }
   $tab_labels["numfacven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["numfacven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["numfacven"] : "N°";
   $tab_ger_campos['fechavenc'] = "on";
   $tab_def_campos['fechavenc'] = "fechavenc";
   $tab_labels["fechavenc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["fechavenc"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["fechavenc"] : "Vence";
   ...
   {
       $tab_def_campos['idcli'] = "idprov";
   }
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["idcli"] : "Proveedor";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["total"] : "Total";
   $tab_ger_campos['banco'] = "on";
   $tab_def_campos['banco'] = "banco";
   $tab_labels["banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["banco"] : "Caja";
   ...
   $tab_labels["sicomprobante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["sicomprobante"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['labels']["sicomprobante"] : "¿CC?";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_facturacom_genera_comprobantes_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_facturacom_genera_comprobantes']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
