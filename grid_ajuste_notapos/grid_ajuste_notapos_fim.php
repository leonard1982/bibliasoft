...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_ajuste_notapos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_ajuste_notapos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_notainv_ajuste'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_ajuste_notapos']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_ajuste_notapos']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ajuste_notapos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ajuste_notapos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ajuste_notapos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ajuste_notapos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ajuste_notapos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ajuste_notapos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ajuste_notapos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ajuste_notapos']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_ajuste_notapos' || $achou)
          {
