...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detallepedido_nube"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detallepedido_nube"]);
   }
