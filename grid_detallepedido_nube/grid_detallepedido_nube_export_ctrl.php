<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detallepedido_nube']['sc_process_barr'] = true;
require_once('../grid_detallepedido_nube/index.php');
unset($_SESSION['scriptcase']['grid_detallepedido_nube']['sc_process_barr']);
$ExportCtrl = new grid_detallepedido_nube_export_control;
$ExportCtrl->Export_barr();

class grid_detallepedido_nube_export_control
{
