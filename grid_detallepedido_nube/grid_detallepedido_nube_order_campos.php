<?php
   include_once('grid_detallepedido_nube_session.php');
   session_start();
   $_SESSION['scriptcase']['grid_detallepedido_nube']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['grid_detallepedido_nube']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['grid_detallepedido_nube']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_detallepedido_nube']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_detallepedido_nube_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detallepedido_nube_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_detallepedido_nube_json.php");
   }
   ...
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["idpro"] : "Producto";
   $tab_ger_campos['colores'] = "on";
   $tab_def_campos['colores'] = "colores";
   $tab_labels["colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["colores"] : "Color";
   $tab_ger_campos['tallas'] = "on";
   $tab_def_campos['tallas'] = "tallas";
   $tab_labels["tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["tallas"] : "Talla";
   $tab_ger_campos['sabor'] = "on";
   $tab_def_campos['sabor'] = "sabor";
   $tab_labels["sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["sabor"] : "Sabor";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['valorunit'] = "on";
   $tab_def_campos['valorunit'] = "valorunit";
   $tab_labels["valorunit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["valorunit"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["valorunit"] : "Valor. unit.";
   $tab_ger_campos['descuento'] = "on";
   $tab_def_campos['descuento'] = "descuento";
   $tab_labels["descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["descuento"] : "Desc. x U.";
   $tab_ger_campos['valorpar'] = "on";
   $tab_def_campos['valorpar'] = "valorpar";
   $tab_labels["valorpar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["valorpar"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["valorpar"] : "Valor par.";
   $tab_ger_campos['iva'] = "on";
   $tab_def_campos['iva'] = "iva";
   $tab_labels["iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["iva"] : "Impuesto";
   ...
   {
       $tab_def_campos['unidad'] = "";
   }
   $tab_labels["unidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["unidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['labels']["unidad"] : "Unidad";
   $tab_ger_campos['unidad'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detallepedido_nube_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nube']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
