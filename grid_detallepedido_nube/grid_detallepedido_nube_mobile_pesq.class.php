...
class grid_detallepedido_nube_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_detallepedido_nube_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_detallepedido_nube_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_detallepedido_nube_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_iddet($iddet)
   {
      ...
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and   CAST (iddet AS TEXT)  like '%" . $iddet . "%' order by iddet"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and   CAST (iddet AS VARCHAR)  like '%" . $iddet . "%' order by iddet"; 
      }
      else
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and  iddet like '%" . $iddet . "%' order by iddet"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_idpedid($idpedid)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idpedid from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and   CAST (idpedid AS TEXT)  like '%" . $idpedid . "%' order by idpedid"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idpedid from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and   CAST (idpedid AS VARCHAR)  like '%" . $idpedid . "%' order by idpedid"; 
      }
      else
      {
          $nm_comando = "select distinct idpedid from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and  idpedid like '%" . $idpedid . "%' order by idpedid"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_numfac($numfac)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numfac from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and   CAST (numfac AS TEXT)  like '%" . $numfac . "%' order by numfac"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfac from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and   CAST (numfac AS VARCHAR)  like '%" . $numfac . "%' order by numfac"; 
      }
      else
      {
          $nm_comando = "select distinct numfac from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and  numfac like '%" . $numfac . "%' order by numfac"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_remision($remision)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct remision from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and   CAST (remision AS TEXT)  like '%" . $remision . "%' order by remision"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct remision from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and   CAST (remision AS VARCHAR)  like '%" . $remision . "%' order by remision"; 
      }
      else
      {
          $nm_comando = "select distinct remision from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and  remision like '%" . $remision . "%' order by remision"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_detallepedido_nube/grid_detallepedido_nube_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_detallepedido_nube_ajax_search.js"></script>
 <script type="text/javascript" src="grid_detallepedido_nube_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_detallepedido_nube_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detallepedido_nube']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detallepedido_nube']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $iddet = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['iddet']; 
          $iddet_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['iddet_input_2']; 
          $iddet_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['iddet_cond']; 
          $idpedid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['idpedid']; 
          $idpedid_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['idpedid_input_2']; 
          $idpedid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['idpedid_cond']; 
          $numfac = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['numfac']; 
          $numfac_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['numfac_input_2']; 
          $numfac_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['numfac_cond']; 
          $remision = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['remision']; 
          $remision_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['remision_input_2']; 
          $remision_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['remision_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['NM_operador']; 
      } 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and iddet = $iddet_look order by iddet"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and iddet = $iddet_look order by iddet"; 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idpedid from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and idpedid = $idpedid_look order by idpedid"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idpedid from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and idpedid = $idpedid_look order by idpedid"; 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numfac from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and numfac = $numfac_look order by numfac"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfac from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and numfac = $numfac_look order by numfac"; 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct remision from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and remision = $remision_look order by remision"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct remision from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['gidpedido_nube'] . " and remision = $remision_look order by remision"; 
...
?>
<?php
   if (is_file("grid_detallepedido_nube_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepedido_nube']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_detallepedido_nube']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_detallepedido_nube";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_detallepedido_nube/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['iddet'] = $iddet; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['iddet_input_2'] = $iddet_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['iddet_cond'] = $iddet_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['idpedid'] = $idpedid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['idpedid_input_2'] = $idpedid_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['idpedid_cond'] = $idpedid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['numfac'] = $numfac; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['numfac_input_2'] = $numfac_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['numfac_cond'] = $numfac_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['remision'] = $remision; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['remision_input_2'] = $remision_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['remision_cond'] = $remision_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca'] = $Temp_Busca;
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_nube']['cond_pesq'] .= $this->NM_operador;
