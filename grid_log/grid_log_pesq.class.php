...
class grid_log_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_log_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_log_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_log_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_log/grid_log_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_log_ajax_search.js"></script>
 <script type="text/javascript" src="grid_log_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_log_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_log']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_log']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $fechayhora_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_input_2_dia']; 
          $fechayhora_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_input_2_mes']; 
          $fechayhora_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_input_2_ano']; 
          $fechayhora_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_hor']; 
          $fechayhora_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_min']; 
          $fechayhora_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_seg']; 
          $fechayhora_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_input_2_hor']; 
          $fechayhora_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_input_2_min']; 
          $fechayhora_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_input_2_seg']; 
          $fechayhora_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_cond']; 
          $usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['usuario']; 
          $usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['usuario_cond']; 
          $accion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['accion']; 
          $accion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['accion_cond']; 
          $observaciones = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['observaciones']; 
...
<?php
 ...
 <OPTION value="12##@@DICIEMBRE"<?php if ($periodo == "12") { echo " selected" ;} ?>>DICIEMBRE</option>
      ...
      <TD id='SC_fechayhora_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fechayhora'])) ? $this->New_label['fechayhora'] : "Fechayhora"; ?></TD>
      
      <INPUT type="hidden" id="SC_fechayhora_cond" name="fechayhora_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fechayhora" <?php echo $str_hide_fechayhora?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_fechayhora"  <?php echo $str_display_fechayhora; ?> class="scFilterFieldFontOdd">
...
?>
      ...
      <TD id='SC_usuario_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['usuario'])) ? $this->New_label['usuario'] : "Usuario Tercero"; ?></TD>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_usuario" name="usuario_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_accion_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['accion'])) ? $this->New_label['accion'] : "Accion"; ?></TD>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['psq_check_ret']['accion'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['psq_check_ret']['accion'][] = "AGREGAR";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['psq_check_ret']['accion'][] = "EDITAR";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['psq_check_ret']['accion'][] = "ELIMINAR";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['psq_check_ret']['accion'][] = "CONSULTAR";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['psq_check_ret']['accion'][] = "OTRO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['psq_check_ret']['accion'][] = "ABRIR";
 ?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_accion_orig" name="accion_orig" size=7 multiple onDblClick="nm_add_sel('accion_orig', 'accion_dest', 'N', '')">
<?php
    if (is_array($accion) && !empty($accion))
    {
        $accion_sel = (in_array("AGREGAR", $accion)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="AGREGAR##@@AGREGAR" <?php echo $accion_sel; ?>>AGREGAR</option>
<?php
    if (is_array($accion) && !empty($accion))
    {
        $accion_sel = (in_array("EDITAR", $accion)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="EDITAR##@@EDITAR" <?php echo $accion_sel; ?>>EDITAR</option>
<?php
    if (is_array($accion) && !empty($accion))
    {
        $accion_sel = (in_array("ELIMINAR", $accion)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="ELIMINAR##@@ELIMINAR" <?php echo $accion_sel; ?>>ELIMINAR</option>
<?php
    if (is_array($accion) && !empty($accion))
    {
        $accion_sel = (in_array("CONSULTAR", $accion)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="CONSULTAR##@@CONSULTAR" <?php echo $accion_sel; ?>>CONSULTAR</option>
<?php
    if (is_array($accion) && !empty($accion))
    {
        $accion_sel = (in_array("OTRO", $accion)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="OTRO##@@OTRO" <?php echo $accion_sel; ?>>OTRO</option>
<?php
    if (is_array($accion) && !empty($accion))
    {
        $accion_sel = (in_array("ABRIR", $accion)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="ABRIR##@@ABRIR" <?php echo $accion_sel; ?>>ABRIR</option>
 </SELECT>
   </td>
   <td align="center">
<?php
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('accion_orig', 'accion_dest', 'N', '');", "nm_add_all('accion_orig', 'accion_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('accion_orig', 'accion_dest', 'N', '');", "nm_add_sel('accion_orig', 'accion_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('accion_dest', 'accion_orig', 'N', '');", "nm_del_sel('accion_dest', 'accion_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('accion_dest', 'accion_orig', 'N', '');", "nm_del_all('accion_dest', 'accion_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_accion_dest" name="accion_dest" size=7 multiple onDblClick="nm_del_sel('accion_dest', 'accion_orig', 'N', '')">"
<?php if (in_array("AGREGAR", $accion)) { ?> <OPTION value="AGREGAR##@@AGREGAR" >AGREGAR</option>
<?php
      }
?>
<?php if (in_array("EDITAR", $accion)) { ?> <OPTION value="EDITAR##@@EDITAR" >EDITAR</option>
<?php
      }
?>
<?php if (in_array("ELIMINAR", $accion)) { ?> <OPTION value="ELIMINAR##@@ELIMINAR" >ELIMINAR</option>
<?php
      }
?>
<?php if (in_array("CONSULTAR", $accion)) { ?> <OPTION value="CONSULTAR##@@CONSULTAR" >CONSULTAR</option>
<?php
      }
?>
<?php if (in_array("OTRO", $accion)) { ?> <OPTION value="OTRO##@@OTRO" >OTRO</option>
<?php
      }
?>
<?php if (in_array("ABRIR", $accion)) { ?> <OPTION value="ABRIR##@@ABRIR" >ABRIR</option>
<?php
      }
?>
    </select>
    <input type="hidden" id="SC_accion" name="accion" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.accion_dest.selectedIndex = -1;</script>
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_log']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_log']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_del_all('accion_dest', 'accion_orig', 'N', '');
 ...
 {
    $('#SC_fechayhora_dia').bind('change', function() {sc_grid_log_valida_dia(this)});
    $('#SC_fechayhora_hor').bind('change', function() {sc_grid_log_valida_hora(this)});
    $('#SC_fechayhora_input_2_dia').bind('change', function() {sc_grid_log_valida_dia(this)});
    $('#SC_fechayhora_input_2_hor').bind('change', function() {sc_grid_log_valida_hora(this)});
    $('#SC_fechayhora_input_2_mes').bind('change', function() {sc_grid_log_valida_mes(this)});
    $('#SC_fechayhora_input_2_min').bind('change', function() {sc_grid_log_valida_min(this)});
    $('#SC_fechayhora_input_2_seg').bind('change', function() {sc_grid_log_valida_seg(this)});
    $('#SC_fechayhora_mes').bind('change', function() {sc_grid_log_valida_mes(this)});
    $('#SC_fechayhora_min').bind('change', function() {sc_grid_log_valida_min(this)});
    $('#SC_fechayhora_seg').bind('change', function() {sc_grid_log_valida_seg(this)});
 }
 function sc_grid_log_valida_dia(obj)
 {
 ...
 function sc_grid_log_valida_mes(obj)
 {
 ...
 function sc_grid_log_valida_hora(obj)
 {
 ...
 function sc_grid_log_valida_min(obj)
 {
 ...
 function sc_grid_log_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if (is_array($accion)) {
          foreach ($accion as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['psq_check_ret']['accion'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_input_2_dia'] = $fechayhora_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_input_2_mes'] = $fechayhora_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_input_2_ano'] = $fechayhora_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_hor'] = $fechayhora_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_min'] = $fechayhora_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_seg'] = $fechayhora_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_input_2_hor'] = $fechayhora_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_input_2_min'] = $fechayhora_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_input_2_seg'] = $fechayhora_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_cond'] = $fechayhora_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['usuario'] = $usuario; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['usuario_cond'] = $usuario_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['accion'] = $accion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['accion_cond'] = $accion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['observaciones'] = $observaciones; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['observaciones_cond'] = $observaciones_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
    ...
    if ($observaciones != '') {
      ...
      if ($fechayhora_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora'] = $val[0];
          ...
          if ($fechayhora_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']['fechayhora_input_2'] = $val[1];
      ...
      if (is_array($accion) && count($accion) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $nmgp_tab_label['accion'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log']['cond_pesq'] .= $this->NM_operador;
