...
class grid_log_total
{
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo)
   {
      ...
      $cmp_sql_def   = array('fechayhora' => "fechayhora",'usuario' => "usuario",'accion' => "accion",'observaciones' => "observaciones",'periodo' => "periodo",'anio' => "anio");
