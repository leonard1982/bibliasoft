<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalleventa']['sc_process_barr'] = true;
require_once('../grid_detalleventa/index.php');
unset($_SESSION['scriptcase']['grid_detalleventa']['sc_process_barr']);
$ExportCtrl = new grid_detalleventa_export_control;
$ExportCtrl->Export_barr();

class grid_detalleventa_export_control
{
