<?php
   include_once('grid_detalleventa_session.php');
   session_start();
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detalleventa"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detalleventa"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleventa']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleventa']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleventa']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalleventa']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_detalleventa' || $achou)
          {
