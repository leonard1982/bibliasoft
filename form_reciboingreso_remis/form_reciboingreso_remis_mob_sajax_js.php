  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_reciboingreso_remis_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_reciboingreso_remis_mob_form();
	}
  ...
  // ---------- Validate nurecibo
  function do_ajax_form_reciboingreso_remis_mob_validate_nurecibo()
  {
    var nomeCampo_nurecibo = "nurecibo";
    var var_nurecibo = scAjaxGetFieldHidden(nomeCampo_nurecibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_nurecibo(var_nurecibo, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_nurecibo_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_nurecibo

  function do_ajax_form_reciboingreso_remis_mob_validate_nurecibo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_nurecibo_cb

  // ---------- Validate cliente
  function do_ajax_form_reciboingreso_remis_mob_validate_cliente()
  {
  } // do_ajax_form_reciboingreso_remis_mob_validate_cliente

  function do_ajax_form_reciboingreso_remis_mob_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_cliente_cb

  // ---------- Validate resolucion
  function do_ajax_form_reciboingreso_remis_mob_validate_resolucion()
  {
    var nomeCampo_resolucion = "resolucion";
    var var_resolucion = scAjaxGetFieldSelect(nomeCampo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_resolucion(var_resolucion, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_resolucion_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_resolucion

  function do_ajax_form_reciboingreso_remis_mob_validate_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_resolucion_cb

  // ---------- Validate nufac
  function do_ajax_form_reciboingreso_remis_mob_validate_nufac()
  {
    var nomeCampo_nufac = "nufac";
    var var_nufac = scAjaxGetFieldSelect(nomeCampo_nufac);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_nufac(var_nufac, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_nufac_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_nufac

  function do_ajax_form_reciboingreso_remis_mob_validate_nufac_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nufac";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_nufac_cb

  // ---------- Validate concepto
  function do_ajax_form_reciboingreso_remis_mob_validate_concepto()
  {
    var nomeCampo_concepto = "concepto";
    var var_concepto = scAjaxGetFieldText(nomeCampo_concepto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_concepto(var_concepto, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_concepto_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_concepto

  function do_ajax_form_reciboingreso_remis_mob_validate_concepto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_concepto_cb

  // ---------- Validate fecharecibo
  function do_ajax_form_reciboingreso_remis_mob_validate_fecharecibo()
  {
    var nomeCampo_fecharecibo = "fecharecibo";
    var var_fecharecibo = scAjaxGetFieldText(nomeCampo_fecharecibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_fecharecibo(var_fecharecibo, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_fecharecibo_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_fecharecibo

  function do_ajax_form_reciboingreso_remis_mob_validate_fecharecibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_fecharecibo_cb

  // ---------- Validate monto
  function do_ajax_form_reciboingreso_remis_mob_validate_monto()
  {
    var nomeCampo_monto = "monto";
    var var_monto = scAjaxGetFieldText(nomeCampo_monto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_monto(var_monto, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_monto_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_monto

  function do_ajax_form_reciboingreso_remis_mob_validate_monto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "monto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_monto_cb

  // ---------- Validate son
  function do_ajax_form_reciboingreso_remis_mob_validate_son()
  {
    var nomeCampo_son = "son";
    var var_son = scAjaxGetFieldText(nomeCampo_son);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_son(var_son, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_son_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_son

  function do_ajax_form_reciboingreso_remis_mob_validate_son_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "son";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_son_cb

  // ---------- Validate saldofac
  function do_ajax_form_reciboingreso_remis_mob_validate_saldofac()
  {
    var nomeCampo_saldofac = "saldofac";
    var var_saldofac = scAjaxGetFieldHidden(nomeCampo_saldofac);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_saldofac(var_saldofac, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_saldofac_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_saldofac

  function do_ajax_form_reciboingreso_remis_mob_validate_saldofac_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_saldofac_cb

  // ---------- Validate formapago
  function do_ajax_form_reciboingreso_remis_mob_validate_formapago()
  {
    var nomeCampo_formapago = "formapago";
    var var_formapago = scAjaxGetFieldSelect(nomeCampo_formapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_formapago(var_formapago, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_formapago_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_formapago

  function do_ajax_form_reciboingreso_remis_mob_validate_formapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_formapago_cb

  // ---------- Validate numcheque
  function do_ajax_form_reciboingreso_remis_mob_validate_numcheque()
  {
    var nomeCampo_numcheque = "numcheque";
    var var_numcheque = scAjaxGetFieldText(nomeCampo_numcheque);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_numcheque(var_numcheque, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_numcheque_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_numcheque

  function do_ajax_form_reciboingreso_remis_mob_validate_numcheque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_numcheque_cb

  // ---------- Validate banco
  function do_ajax_form_reciboingreso_remis_mob_validate_banco()
  {
    var nomeCampo_banco = "banco";
    var var_banco = scAjaxGetFieldText(nomeCampo_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_banco(var_banco, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_banco_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_banco

  function do_ajax_form_reciboingreso_remis_mob_validate_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "banco";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_banco_cb

  // ---------- Validate numtarjeta
  function do_ajax_form_reciboingreso_remis_mob_validate_numtarjeta()
  {
    var nomeCampo_numtarjeta = "numtarjeta";
    var var_numtarjeta = scAjaxGetFieldText(nomeCampo_numtarjeta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_numtarjeta(var_numtarjeta, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_numtarjeta_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_numtarjeta

  function do_ajax_form_reciboingreso_remis_mob_validate_numtarjeta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_numtarjeta_cb

  // ---------- Validate nombreobanco
  function do_ajax_form_reciboingreso_remis_mob_validate_nombreobanco()
  {
    var nomeCampo_nombreobanco = "nombreobanco";
    var var_nombreobanco = scAjaxGetFieldText(nomeCampo_nombreobanco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_nombreobanco(var_nombreobanco, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_nombreobanco_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_nombreobanco

  function do_ajax_form_reciboingreso_remis_mob_validate_nombreobanco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_nombreobanco_cb

  // ---------- Validate obser
  function do_ajax_form_reciboingreso_remis_mob_validate_obser()
  {
    var nomeCampo_obser = "obser";
    var var_obser = scAjaxGetFieldText(nomeCampo_obser);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_mob_validate_obser(var_obser, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_validate_obser_cb);
  } // do_ajax_form_reciboingreso_remis_mob_validate_obser

  function do_ajax_form_reciboingreso_remis_mob_validate_obser_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "obser";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_validate_obser_cb

  // ---------- Refresh cliente
  function do_ajax_form_reciboingreso_remis_mob_refresh_cliente()
  {
    var var_cliente = scAjaxGetFieldText("cliente");
    var var_nmgp_refresh_fields = "resolucion";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_mob_refresh_cliente(var_cliente, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_refresh_cliente_cb);
  } // do_ajax_form_reciboingreso_remis_mob_refresh_cliente

  function do_ajax_form_reciboingreso_remis_mob_refresh_cliente_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_reciboingreso_remis_mob_refresh_resolucion();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_refresh_cliente_cb

  // ---------- Refresh resolucion
  function do_ajax_form_reciboingreso_remis_mob_refresh_resolucion()
  {
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_nmgp_refresh_fields = "nufac";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_mob_refresh_resolucion(var_resolucion, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_refresh_resolucion_cb);
  } // do_ajax_form_reciboingreso_remis_mob_refresh_resolucion

  function do_ajax_form_reciboingreso_remis_mob_refresh_resolucion_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_mob_refresh_resolucion_cb

  // ---------- Event onchange cliente
  function do_ajax_form_reciboingreso_remis_mob_event_cliente_onchange()
  {
    var var_cliente = scAjaxGetFieldText("id_ac_cliente");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_mob_event_cliente_onchange(var_cliente, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_event_cliente_onchange_cb);
  } // do_ajax_form_reciboingreso_remis_mob_event_cliente_onchange

  function do_ajax_form_reciboingreso_remis_mob_event_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_mob_event_cliente_onchange_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_mob_event_cliente_onchange_cb
  function do_ajax_form_reciboingreso_remis_mob_event_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_reciboingreso_remis_mob_refresh_cliente();
    scAjaxRedir();
  } // do_ajax_form_reciboingreso_remis_mob_event_cliente_onchange_cb_after_alert

  // ---------- Event onchange formapago
  function do_ajax_form_reciboingreso_remis_mob_event_formapago_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_mob_event_formapago_onchange(var_formapago, var_numcheque, var_banco, var_numtarjeta, var_nombreobanco, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_event_formapago_onchange_cb);
  } // do_ajax_form_reciboingreso_remis_mob_event_formapago_onchange

  function do_ajax_form_reciboingreso_remis_mob_event_formapago_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "formapago";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_mob_event_formapago_onchange_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_mob_event_formapago_onchange_cb
  function do_ajax_form_reciboingreso_remis_mob_event_formapago_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_reciboingreso_remis_mob_event_formapago_onchange_cb_after_alert

  // ---------- Event onblur monto
  function do_ajax_form_reciboingreso_remis_mob_event_monto_onblur()
  {
    var var_saldofac = scAjaxGetFieldHidden("saldofac");
    var var_monto = scAjaxGetFieldText("monto");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_mob_event_monto_onblur(var_saldofac, var_monto, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_event_monto_onblur_cb);
  } // do_ajax_form_reciboingreso_remis_mob_event_monto_onblur

  function do_ajax_form_reciboingreso_remis_mob_event_monto_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "monto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_mob_event_monto_onblur_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_mob_event_monto_onblur_cb
  function do_ajax_form_reciboingreso_remis_mob_event_monto_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_reciboingreso_remis_mob_event_monto_onblur_cb_after_alert

  // ---------- Event onchange monto
  function do_ajax_form_reciboingreso_remis_mob_event_monto_onchange()
  {
    var var_saldofac = scAjaxGetFieldHidden("saldofac");
    var var_monto = scAjaxGetFieldText("monto");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_mob_event_monto_onchange(var_saldofac, var_monto, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_event_monto_onchange_cb);
  } // do_ajax_form_reciboingreso_remis_mob_event_monto_onchange

  function do_ajax_form_reciboingreso_remis_mob_event_monto_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "monto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_mob_event_monto_onchange_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_mob_event_monto_onchange_cb
  function do_ajax_form_reciboingreso_remis_mob_event_monto_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_reciboingreso_remis_mob_event_monto_onchange_cb_after_alert

  // ---------- Event onchange nufac
  function do_ajax_form_reciboingreso_remis_mob_event_nufac_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_mob_event_nufac_onchange(var_nufac, var_monto, var_saldofac, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_event_nufac_onchange_cb);
  } // do_ajax_form_reciboingreso_remis_mob_event_nufac_onchange

  function do_ajax_form_reciboingreso_remis_mob_event_nufac_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nufac";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_mob_event_nufac_onchange_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_mob_event_nufac_onchange_cb
  function do_ajax_form_reciboingreso_remis_mob_event_nufac_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_reciboingreso_remis_mob_refresh_nufac();
    scAjaxRedir();
  } // do_ajax_form_reciboingreso_remis_mob_event_nufac_onchange_cb_after_alert

  // ---------- Event onchange resolucion
  function do_ajax_form_reciboingreso_remis_mob_event_resolucion_onchange()
  {
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_mob_event_resolucion_onchange(var_resolucion, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_event_resolucion_onchange_cb);
  } // do_ajax_form_reciboingreso_remis_mob_event_resolucion_onchange

  function do_ajax_form_reciboingreso_remis_mob_event_resolucion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "resolucion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_mob_event_resolucion_onchange_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_mob_event_resolucion_onchange_cb
  function do_ajax_form_reciboingreso_remis_mob_event_resolucion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_reciboingreso_remis_mob_refresh_resolucion();
    scAjaxRedir();
  } // do_ajax_form_reciboingreso_remis_mob_event_resolucion_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_reciboingreso_remis_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_reciboingreso_remis_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_idrecibo = scAjaxGetFieldText("idrecibo");
    ...
    scAjaxProcOn();
    x_ajax_form_reciboingreso_remis_mob_submit_form(var_nurecibo, var_cliente, var_resolucion, var_nufac, var_concepto, var_fecharecibo, var_monto, var_son, var_saldofac, var_formapago, var_numcheque, var_banco, var_numtarjeta, var_nombreobanco, var_obser, var_idrecibo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_reciboingreso_remis_mob_submit_form_cb);
  } // do_ajax_form_reciboingreso_remis_mob_submit_form

  function do_ajax_form_reciboingreso_remis_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_mob_submit_form_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_mob_submit_form_cb
  function do_ajax_form_reciboingreso_remis_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_reciboingreso_remis_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_reciboingreso_remis_mob_navigate_form()
  {
    perform_ajax_form_reciboingreso_remis_mob_navigate_form();
  }

  function perform_ajax_form_reciboingreso_remis_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_reciboingreso_remis_mob_navigate_form(var_idrecibo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_reciboingreso_remis_mob_navigate_form_cb);
  } // do_ajax_form_reciboingreso_remis_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_remis_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_reciboingreso_remis_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_reciboingreso_remis_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_mob_navigate_form_cb
  function do_ajax_form_reciboingreso_remis_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_reciboingreso_remis_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_reciboingreso_remis_mob_navigate_form_cb_after_alert
  function sc_hide_form_reciboingreso_remis_mob_form()
  {
