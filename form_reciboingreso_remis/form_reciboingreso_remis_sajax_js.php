  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_reciboingreso_remis" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_reciboingreso_remis_form();
	}
  ...
  // ---------- Validate nurecibo
  function do_ajax_form_reciboingreso_remis_validate_nurecibo()
  {
    var nomeCampo_nurecibo = "nurecibo";
    var var_nurecibo = scAjaxGetFieldHidden(nomeCampo_nurecibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_nurecibo(var_nurecibo, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_nurecibo_cb);
  } // do_ajax_form_reciboingreso_remis_validate_nurecibo

  function do_ajax_form_reciboingreso_remis_validate_nurecibo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_nurecibo_cb

  // ---------- Validate cliente
  function do_ajax_form_reciboingreso_remis_validate_cliente()
  {
  } // do_ajax_form_reciboingreso_remis_validate_cliente

  function do_ajax_form_reciboingreso_remis_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_cliente_cb

  // ---------- Validate resolucion
  function do_ajax_form_reciboingreso_remis_validate_resolucion()
  {
    var nomeCampo_resolucion = "resolucion";
    var var_resolucion = scAjaxGetFieldSelect(nomeCampo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_resolucion(var_resolucion, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_resolucion_cb);
  } // do_ajax_form_reciboingreso_remis_validate_resolucion

  function do_ajax_form_reciboingreso_remis_validate_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_resolucion_cb

  // ---------- Validate nufac
  function do_ajax_form_reciboingreso_remis_validate_nufac()
  {
    var nomeCampo_nufac = "nufac";
    var var_nufac = scAjaxGetFieldSelect(nomeCampo_nufac);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_nufac(var_nufac, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_nufac_cb);
  } // do_ajax_form_reciboingreso_remis_validate_nufac

  function do_ajax_form_reciboingreso_remis_validate_nufac_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nufac";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_nufac_cb

  // ---------- Validate concepto
  function do_ajax_form_reciboingreso_remis_validate_concepto()
  {
    var nomeCampo_concepto = "concepto";
    var var_concepto = scAjaxGetFieldText(nomeCampo_concepto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_concepto(var_concepto, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_concepto_cb);
  } // do_ajax_form_reciboingreso_remis_validate_concepto

  function do_ajax_form_reciboingreso_remis_validate_concepto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_concepto_cb

  // ---------- Validate fecharecibo
  function do_ajax_form_reciboingreso_remis_validate_fecharecibo()
  {
    var nomeCampo_fecharecibo = "fecharecibo";
    var var_fecharecibo = scAjaxGetFieldText(nomeCampo_fecharecibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_fecharecibo(var_fecharecibo, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_fecharecibo_cb);
  } // do_ajax_form_reciboingreso_remis_validate_fecharecibo

  function do_ajax_form_reciboingreso_remis_validate_fecharecibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_fecharecibo_cb

  // ---------- Validate monto
  function do_ajax_form_reciboingreso_remis_validate_monto()
  {
    var nomeCampo_monto = "monto";
    var var_monto = scAjaxGetFieldText(nomeCampo_monto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_monto(var_monto, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_monto_cb);
  } // do_ajax_form_reciboingreso_remis_validate_monto

  function do_ajax_form_reciboingreso_remis_validate_monto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "monto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_monto_cb

  // ---------- Validate son
  function do_ajax_form_reciboingreso_remis_validate_son()
  {
    var nomeCampo_son = "son";
    var var_son = scAjaxGetFieldText(nomeCampo_son);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_son(var_son, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_son_cb);
  } // do_ajax_form_reciboingreso_remis_validate_son

  function do_ajax_form_reciboingreso_remis_validate_son_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "son";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_son_cb

  // ---------- Validate saldofac
  function do_ajax_form_reciboingreso_remis_validate_saldofac()
  {
    var nomeCampo_saldofac = "saldofac";
    var var_saldofac = scAjaxGetFieldHidden(nomeCampo_saldofac);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_saldofac(var_saldofac, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_saldofac_cb);
  } // do_ajax_form_reciboingreso_remis_validate_saldofac

  function do_ajax_form_reciboingreso_remis_validate_saldofac_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_saldofac_cb

  // ---------- Validate formapago
  function do_ajax_form_reciboingreso_remis_validate_formapago()
  {
    var nomeCampo_formapago = "formapago";
    var var_formapago = scAjaxGetFieldSelect(nomeCampo_formapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_formapago(var_formapago, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_formapago_cb);
  } // do_ajax_form_reciboingreso_remis_validate_formapago

  function do_ajax_form_reciboingreso_remis_validate_formapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_formapago_cb

  // ---------- Validate numcheque
  function do_ajax_form_reciboingreso_remis_validate_numcheque()
  {
    var nomeCampo_numcheque = "numcheque";
    var var_numcheque = scAjaxGetFieldText(nomeCampo_numcheque);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_numcheque(var_numcheque, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_numcheque_cb);
  } // do_ajax_form_reciboingreso_remis_validate_numcheque

  function do_ajax_form_reciboingreso_remis_validate_numcheque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numcheque";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_numcheque_cb

  // ---------- Validate banco
  function do_ajax_form_reciboingreso_remis_validate_banco()
  {
    var nomeCampo_banco = "banco";
    var var_banco = scAjaxGetFieldText(nomeCampo_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_banco(var_banco, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_banco_cb);
  } // do_ajax_form_reciboingreso_remis_validate_banco

  function do_ajax_form_reciboingreso_remis_validate_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "banco";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_banco_cb

  // ---------- Validate numtarjeta
  function do_ajax_form_reciboingreso_remis_validate_numtarjeta()
  {
    var nomeCampo_numtarjeta = "numtarjeta";
    var var_numtarjeta = scAjaxGetFieldText(nomeCampo_numtarjeta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_numtarjeta(var_numtarjeta, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_numtarjeta_cb);
  } // do_ajax_form_reciboingreso_remis_validate_numtarjeta

  function do_ajax_form_reciboingreso_remis_validate_numtarjeta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numtarjeta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_numtarjeta_cb

  // ---------- Validate nombreobanco
  function do_ajax_form_reciboingreso_remis_validate_nombreobanco()
  {
    var nomeCampo_nombreobanco = "nombreobanco";
    var var_nombreobanco = scAjaxGetFieldText(nomeCampo_nombreobanco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_nombreobanco(var_nombreobanco, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_nombreobanco_cb);
  } // do_ajax_form_reciboingreso_remis_validate_nombreobanco

  function do_ajax_form_reciboingreso_remis_validate_nombreobanco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombreobanco";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_nombreobanco_cb

  // ---------- Validate obser
  function do_ajax_form_reciboingreso_remis_validate_obser()
  {
    var nomeCampo_obser = "obser";
    var var_obser = scAjaxGetFieldText(nomeCampo_obser);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reciboingreso_remis_validate_obser(var_obser, var_script_case_init, do_ajax_form_reciboingreso_remis_validate_obser_cb);
  } // do_ajax_form_reciboingreso_remis_validate_obser

  function do_ajax_form_reciboingreso_remis_validate_obser_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "obser";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_validate_obser_cb

  // ---------- Refresh cliente
  function do_ajax_form_reciboingreso_remis_refresh_cliente()
  {
    var var_cliente = scAjaxGetFieldText("cliente");
    var var_nmgp_refresh_fields = "resolucion";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_refresh_cliente(var_cliente, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_reciboingreso_remis_refresh_cliente_cb);
  } // do_ajax_form_reciboingreso_remis_refresh_cliente

  function do_ajax_form_reciboingreso_remis_refresh_cliente_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_reciboingreso_remis_refresh_resolucion();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_refresh_cliente_cb

  // ---------- Refresh resolucion
  function do_ajax_form_reciboingreso_remis_refresh_resolucion()
  {
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_nmgp_refresh_fields = "nufac";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_refresh_resolucion(var_resolucion, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_reciboingreso_remis_refresh_resolucion_cb);
  } // do_ajax_form_reciboingreso_remis_refresh_resolucion

  function do_ajax_form_reciboingreso_remis_refresh_resolucion_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reciboingreso_remis_refresh_resolucion_cb

  // ---------- Event onchange cliente
  function do_ajax_form_reciboingreso_remis_event_cliente_onchange()
  {
    var var_cliente = scAjaxGetFieldText("id_ac_cliente");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_event_cliente_onchange(var_cliente, var_script_case_init, do_ajax_form_reciboingreso_remis_event_cliente_onchange_cb);
  } // do_ajax_form_reciboingreso_remis_event_cliente_onchange

  function do_ajax_form_reciboingreso_remis_event_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_event_cliente_onchange_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_event_cliente_onchange_cb
  function do_ajax_form_reciboingreso_remis_event_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_reciboingreso_remis_refresh_cliente();
    scAjaxRedir();
  } // do_ajax_form_reciboingreso_remis_event_cliente_onchange_cb_after_alert

  // ---------- Event onchange formapago
  function do_ajax_form_reciboingreso_remis_event_formapago_onchange()
  {
    var var_formapago = scAjaxGetFieldSelect("formapago");
    var var_numcheque = scAjaxGetFieldText("numcheque");
    var var_banco = scAjaxGetFieldText("banco");
    var var_numtarjeta = scAjaxGetFieldText("numtarjeta");
    var var_nombreobanco = scAjaxGetFieldText("nombreobanco");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_event_formapago_onchange(var_formapago, var_numcheque, var_banco, var_numtarjeta, var_nombreobanco, var_script_case_init, do_ajax_form_reciboingreso_remis_event_formapago_onchange_cb);
  } // do_ajax_form_reciboingreso_remis_event_formapago_onchange

  function do_ajax_form_reciboingreso_remis_event_formapago_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "formapago";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_event_formapago_onchange_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_event_formapago_onchange_cb
  function do_ajax_form_reciboingreso_remis_event_formapago_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_reciboingreso_remis_event_formapago_onchange_cb_after_alert

  // ---------- Event onblur monto
  function do_ajax_form_reciboingreso_remis_event_monto_onblur()
  {
    var var_saldofac = scAjaxGetFieldHidden("saldofac");
    var var_monto = scAjaxGetFieldText("monto");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_event_monto_onblur(var_saldofac, var_monto, var_script_case_init, do_ajax_form_reciboingreso_remis_event_monto_onblur_cb);
  } // do_ajax_form_reciboingreso_remis_event_monto_onblur

  function do_ajax_form_reciboingreso_remis_event_monto_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "monto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_event_monto_onblur_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_event_monto_onblur_cb
  function do_ajax_form_reciboingreso_remis_event_monto_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_reciboingreso_remis_event_monto_onblur_cb_after_alert

  // ---------- Event onchange monto
  function do_ajax_form_reciboingreso_remis_event_monto_onchange()
  {
    var var_saldofac = scAjaxGetFieldHidden("saldofac");
    var var_monto = scAjaxGetFieldText("monto");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_event_monto_onchange(var_saldofac, var_monto, var_script_case_init, do_ajax_form_reciboingreso_remis_event_monto_onchange_cb);
  } // do_ajax_form_reciboingreso_remis_event_monto_onchange

  function do_ajax_form_reciboingreso_remis_event_monto_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "monto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_event_monto_onchange_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_event_monto_onchange_cb
  function do_ajax_form_reciboingreso_remis_event_monto_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_reciboingreso_remis_event_monto_onchange_cb_after_alert

  // ---------- Event onchange nufac
  function do_ajax_form_reciboingreso_remis_event_nufac_onchange()
  {
    var var_nufac = scAjaxGetFieldSelect("nufac");
    var var_monto = scAjaxGetFieldText("monto");
    var var_saldofac = scAjaxGetFieldHidden("saldofac");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_event_nufac_onchange(var_nufac, var_monto, var_saldofac, var_script_case_init, do_ajax_form_reciboingreso_remis_event_nufac_onchange_cb);
  } // do_ajax_form_reciboingreso_remis_event_nufac_onchange

  function do_ajax_form_reciboingreso_remis_event_nufac_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nufac";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_event_nufac_onchange_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_event_nufac_onchange_cb
  function do_ajax_form_reciboingreso_remis_event_nufac_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_reciboingreso_remis_refresh_nufac();
    scAjaxRedir();
  } // do_ajax_form_reciboingreso_remis_event_nufac_onchange_cb_after_alert

  // ---------- Event onchange resolucion
  function do_ajax_form_reciboingreso_remis_event_resolucion_onchange()
  {
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reciboingreso_remis_event_resolucion_onchange(var_resolucion, var_script_case_init, do_ajax_form_reciboingreso_remis_event_resolucion_onchange_cb);
  } // do_ajax_form_reciboingreso_remis_event_resolucion_onchange

  function do_ajax_form_reciboingreso_remis_event_resolucion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "resolucion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_event_resolucion_onchange_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_event_resolucion_onchange_cb
  function do_ajax_form_reciboingreso_remis_event_resolucion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_reciboingreso_remis_refresh_resolucion();
    scAjaxRedir();
  } // do_ajax_form_reciboingreso_remis_event_resolucion_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_reciboingreso_remis_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_reciboingreso_remis_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_monto = scAjaxGetFieldText("monto");
    var var_son = scAjaxGetFieldText("son");
    var var_saldofac = scAjaxGetFieldHidden("saldofac");
    var var_formapago = scAjaxGetFieldSelect("formapago");
    var var_numcheque = scAjaxGetFieldText("numcheque");
    var var_banco = scAjaxGetFieldText("banco");
    ...
    scAjaxProcOn();
    x_ajax_form_reciboingreso_remis_submit_form(var_nurecibo, var_cliente, var_resolucion, var_nufac, var_concepto, var_fecharecibo, var_monto, var_son, var_saldofac, var_formapago, var_numcheque, var_banco, var_numtarjeta, var_nombreobanco, var_obser, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_reciboingreso_remis_submit_form_cb);
  } // do_ajax_form_reciboingreso_remis_submit_form

  function do_ajax_form_reciboingreso_remis_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("son");
      scAjaxHideErrorDisplay("saldofac");
      scAjaxHideErrorDisplay("formapago");
      scAjaxHideErrorDisplay("numcheque");
      scAjaxHideErrorDisplay("banco");
      scAjaxHideErrorDisplay("numtarjeta");
      scAjaxHideErrorDisplay("nombreobanco");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_reciboingreso_remis_submit_form_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_submit_form_cb
  function do_ajax_form_reciboingreso_remis_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_reciboingreso_remis_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_reciboingreso_remis_navigate_form()
  {
    perform_ajax_form_reciboingreso_remis_navigate_form();
  }

  function perform_ajax_form_reciboingreso_remis_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_reciboingreso_remis_navigate_form(var_idrecibo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_reciboingreso_remis_navigate_form_cb);
  } // do_ajax_form_reciboingreso_remis_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_remis']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_reciboingreso_remis_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_reciboingreso_remis_navigate_form_cb_after_alert);
  } // do_ajax_form_reciboingreso_remis_navigate_form_cb
  function do_ajax_form_reciboingreso_remis_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_reciboingreso_remis_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_reciboingreso_remis_navigate_form_cb_after_alert
  function sc_hide_form_reciboingreso_remis_form()
  {
  ...
  ajax_field_list[1] = "cliente";
  ajax_field_list[2] = "resolucion";
  ajax_field_list[3] = "nufac";
  ajax_field_list[4] = "concepto";
  ajax_field_list[5] = "fecharecibo";
  ajax_field_list[6] = "monto";
  ajax_field_list[7] = "son";
  ajax_field_list[8] = "saldofac";
  ajax_field_list[9] = "formapago";
  ajax_field_list[10] = "numcheque";
  ajax_field_list[11] = "banco";
  ajax_field_list[12] = "numtarjeta";
  ajax_field_list[13] = "nombreobanco";
  ajax_field_list[14] = "obser";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "nurecibo": {"label": "Número del recibo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "nufac": {"label": "Remisión a pagar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "fecharecibo": {"label": "Fecha del recibo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "monto": {"label": "Monto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "son": {"label": "Valor en letras", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "saldofac": {"label": "Saldo de la Remisión", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "numcheque": {"label": "Número cheque", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "banco": {"label": "Banco", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "numtarjeta": {"label": "Número tarjeta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombreobanco": {"label": "Nombre Tarjeta o banco", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "numcheque": new Array(),
    "banco": new Array(),
    "numtarjeta": new Array(),
    "nombreobanco": new Array(),
    "obser": new Array()
  };
  ...
  ajax_field_mult["son"][1] = "son";
  ajax_field_mult["saldofac"][1] = "saldofac";
  ajax_field_mult["formapago"][1] = "formapago";
  ajax_field_mult["numcheque"][1] = "numcheque";
  ajax_field_mult["banco"][1] = "banco";
  ajax_field_mult["numtarjeta"][1] = "numtarjeta";
  ajax_field_mult["nombreobanco"][1] = "nombreobanco";
  ...
  var ajax_field_id = {
    ...
    "nufac": new Array("hidden_field_label_nufac", "hidden_field_data_nufac"),
    "concepto": new Array("hidden_field_label_concepto", "hidden_field_data_concepto"),
    ...
    "son": new Array("hidden_field_label_son", "hidden_field_data_son"),
    ...
    "numcheque": new Array("hidden_field_label_numcheque", "hidden_field_data_numcheque"),
    "banco": new Array("hidden_field_label_banco", "hidden_field_data_banco"),
    "numtarjeta": new Array("hidden_field_label_numtarjeta", "hidden_field_data_numtarjeta"),
    "nombreobanco": new Array("hidden_field_label_nombreobanco", "hidden_field_data_nombreobanco"),
