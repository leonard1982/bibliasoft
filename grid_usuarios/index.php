<?php
   ...
   $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_cache']      = "";
...
<?php
      ...
      $this->sc_lig_target["A_@scinf__@scinf_form_usuarios"] = '_self';
      ...
      $this->sc_lig_target["B_@scinf_permisos"] = '_self';
      $this->sc_lig_target["B_@scinf_permisos_@scinf_form_aplicaciones_permisos"] = '_self';
...
// 
      ...
      $this->arr_buttons_usr['permisos']['hint']             = "Permisos de usuario";
      $this->arr_buttons_usr['permisos']['type']             = "button";
      $this->arr_buttons_usr['permisos']['value']            = "Permisos";
      $this->arr_buttons_usr['permisos']['display']          = "only_text";
      $this->arr_buttons_usr['permisos']['display_position'] = "text_right";
      $this->arr_buttons_usr['permisos']['style']            = "default";
      $this->arr_buttons_usr['permisos']['image']            = "scriptcase__NM__ico__NM__key_ok_32.png";
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_usuarios']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle($linhas = 0)
   {
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_usuarios']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_usuarios']['label'] = "Usuarios";
...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']      = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq']         = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search']       = "";
...
//----------------------------------->
      ...
      { 
          ...
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dashboard_refresh_after_chart'])) {
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "idusuarios";$nm_numeric[] = "tercero";$nm_numeric[] = "resolucion";$nm_numeric[] = "grupo";$nm_numeric[] = "grupocomanda";
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
               $_SESSION['scriptcase']['grid_usuarios']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
           }
       }
   }
