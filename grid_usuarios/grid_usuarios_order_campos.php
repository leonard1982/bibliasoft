<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idusuarios'] = "idusuarios";
   $tab_labels["idusuarios"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["idusuarios"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["idusuarios"] : "Id";
   ...
   $tab_labels["grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["grupo"] : "Grupo";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
