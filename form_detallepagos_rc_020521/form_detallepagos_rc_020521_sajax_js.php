  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detallepagos_rc_020521" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detallepagos_rc_020521_form();
	}
...
?>
  ...
  // ---------- Validate idrc_
  function do_ajax_form_detallepagos_rc_020521_validate_idrc_(iNumLinha)
  {
    var nomeCampo_idrc_ = "idrc_" + iNumLinha;
    var var_idrc_ = scAjaxGetFieldText(nomeCampo_idrc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_020521_validate_idrc_(var_idrc_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_020521_validate_idrc__cb);
  } // do_ajax_form_detallepagos_rc_020521_validate_idrc_

  function do_ajax_form_detallepagos_rc_020521_validate_idrc__cb(sResp)
  {
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idrc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idrc_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_020521_validate_idrc__cb

  // ---------- Validate idfact_
  function do_ajax_form_detallepagos_rc_020521_validate_idfact_(iNumLinha)
  {
    var nomeCampo_idfact_ = "idfact_" + iNumLinha;
    var var_idfact_ = scAjaxGetFieldText(nomeCampo_idfact_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_020521_validate_idfact_(var_idfact_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_020521_validate_idfact__cb);
  } // do_ajax_form_detallepagos_rc_020521_validate_idfact_

  function do_ajax_form_detallepagos_rc_020521_validate_idfact__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idfact_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idfact_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idfact_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idfact_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_020521_validate_idfact__cb

  // ---------- Validate idbanco_caja_
  function do_ajax_form_detallepagos_rc_020521_validate_idbanco_caja_(iNumLinha)
  {
    var nomeCampo_idbanco_caja_ = "idbanco_caja_" + iNumLinha;
    var var_idbanco_caja_ = scAjaxGetFieldSelect(nomeCampo_idbanco_caja_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_020521_validate_idbanco_caja_(var_idbanco_caja_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_020521_validate_idbanco_caja__cb);
  } // do_ajax_form_detallepagos_rc_020521_validate_idbanco_caja_

  function do_ajax_form_detallepagos_rc_020521_validate_idbanco_caja__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idbanco_caja_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idbanco_caja_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idbanco_caja_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idbanco_caja_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_020521_validate_idbanco_caja__cb

  // ---------- Validate idfp_
  function do_ajax_form_detallepagos_rc_020521_validate_idfp_(iNumLinha)
  {
    var nomeCampo_idfp_ = "idfp_" + iNumLinha;
    var var_idfp_ = scAjaxGetFieldSelect(nomeCampo_idfp_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_020521_validate_idfp_(var_idfp_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_020521_validate_idfp__cb);
  } // do_ajax_form_detallepagos_rc_020521_validate_idfp_

  function do_ajax_form_detallepagos_rc_020521_validate_idfp__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idfp_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idfp_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_020521_validate_idfp__cb

  // ---------- Validate monto_
  function do_ajax_form_detallepagos_rc_020521_validate_monto_(iNumLinha)
  {
    var nomeCampo_monto_ = "monto_" + iNumLinha;
    var var_monto_ = scAjaxGetFieldText(nomeCampo_monto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_020521_validate_monto_(var_monto_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_020521_validate_monto__cb);
  } // do_ajax_form_detallepagos_rc_020521_validate_monto_

  function do_ajax_form_detallepagos_rc_020521_validate_monto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "monto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "monto_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "monto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "monto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_020521_validate_monto__cb

  // ---------- Validate banco_
  function do_ajax_form_detallepagos_rc_020521_validate_banco_(iNumLinha)
  {
    var nomeCampo_banco_ = "banco_" + iNumLinha;
    var var_banco_ = scAjaxGetFieldText(nomeCampo_banco_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_020521_validate_banco_(var_banco_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_020521_validate_banco__cb);
  } // do_ajax_form_detallepagos_rc_020521_validate_banco_

  function do_ajax_form_detallepagos_rc_020521_validate_banco__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_020521_validate_banco__cb

  // ---------- Validate numcheque_
  function do_ajax_form_detallepagos_rc_020521_validate_numcheque_(iNumLinha)
  {
    var nomeCampo_numcheque_ = "numcheque_" + iNumLinha;
    var var_numcheque_ = scAjaxGetFieldText(nomeCampo_numcheque_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_020521_validate_numcheque_(var_numcheque_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_020521_validate_numcheque__cb);
  } // do_ajax_form_detallepagos_rc_020521_validate_numcheque_

  function do_ajax_form_detallepagos_rc_020521_validate_numcheque__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "numcheque_" + iLineNumber;
    }
    else
    {
      sFieldValid = "numcheque_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "numcheque_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "numcheque_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_020521_validate_numcheque__cb

  // ---------- Validate fechacob_
  function do_ajax_form_detallepagos_rc_020521_validate_fechacob_(iNumLinha)
  {
    var nomeCampo_fechacob_ = "fechacob_" + iNumLinha;
    var var_fechacob_ = scAjaxGetFieldText(nomeCampo_fechacob_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_020521_validate_fechacob_(var_fechacob_, iNumLinha, var_script_case_init, do_ajax_form_detallepagos_rc_020521_validate_fechacob__cb);
  } // do_ajax_form_detallepagos_rc_020521_validate_fechacob_

  function do_ajax_form_detallepagos_rc_020521_validate_fechacob__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fechacob_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fechacob_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fechacob_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fechacob_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepagos_rc_020521_validate_fechacob__cb

  // ---------- Event onchange idfp_
  function do_ajax_form_detallepagos_rc_020521_event_idfp__onchange(iSeqForm)
  {
    var var_idfp_ = scAjaxGetFieldSelect("idfp_" + iSeqForm);
    var var_banco_ = scAjaxGetFieldText("banco_" + iSeqForm);
    var var_numcheque_ = scAjaxGetFieldText("numcheque_" + iSeqForm);
    var var_fechacob_ = scAjaxGetFieldText("fechacob_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepagos_rc_020521_event_idfp__onchange(var_idfp_, var_banco_, var_numcheque_, var_fechacob_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepagos_rc_020521_event_idfp__onchange_cb);
  } // do_ajax_form_detallepagos_rc_020521_event_idfp__onchange

  function do_ajax_form_detallepagos_rc_020521_event_idfp__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepagos_rc_020521_event_idfp__onchange_cb_after_alert);
  } // do_ajax_form_detallepagos_rc_020521_event_idfp__onchange_cb
  function do_ajax_form_detallepagos_rc_020521_event_idfp__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepagos_rc_020521_event_idfp__onchange_cb_after_alert

  // ---------- Event onchange monto_
  function do_ajax_form_detallepagos_rc_020521_event_monto__onchange(iSeqForm)
  {
    var var_monto_ = scAjaxGetFieldText("monto_" + iSeqForm);
    var var_idfact_ = scAjaxGetFieldText("idfact_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepagos_rc_020521_event_monto__onchange(var_monto_, var_idfact_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepagos_rc_020521_event_monto__onchange_cb);
  } // do_ajax_form_detallepagos_rc_020521_event_monto__onchange

  function do_ajax_form_detallepagos_rc_020521_event_monto__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepagos_rc_020521_event_monto__onchange_cb_after_alert);
  } // do_ajax_form_detallepagos_rc_020521_event_monto__onchange_cb
  function do_ajax_form_detallepagos_rc_020521_event_monto__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepagos_rc_020521_event_monto__onchange_cb_after_alert

  // ---------- Event onfocus monto_
  function do_ajax_form_detallepagos_rc_020521_event_monto__onfocus(iSeqForm)
  {
    var var_monto_ = scAjaxGetFieldText("monto_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn();
    x_ajax_form_detallepagos_rc_020521_event_monto__onfocus(var_monto_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepagos_rc_020521_event_monto__onfocus_cb);
  } // do_ajax_form_detallepagos_rc_020521_event_monto__onfocus

  function do_ajax_form_detallepagos_rc_020521_event_monto__onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepagos_rc_020521_event_monto__onfocus_cb_after_alert);
  } // do_ajax_form_detallepagos_rc_020521_event_monto__onfocus_cb
  function do_ajax_form_detallepagos_rc_020521_event_monto__onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepagos_rc_020521_event_monto__onfocus_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detallepagos_rc_020521_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detallepagos_rc_020521_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detallepagos_rc_020521_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detallepagos_rc_020521_add_new_line_cb);
  } // do_ajax_form_detallepagos_rc_020521_add_new_line

  function do_ajax_form_detallepagos_rc_020521_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_detallepagos_rc_020521_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detallepagos_rc_020521_backup_line(iNumLinha)
  {
    var var_iddetall_ = scAjaxGetFieldText("iddetall_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepagos_rc_020521_backup_line(var_iddetall_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detallepagos_rc_020521_backup_line_cb);
  } // do_ajax_form_detallepagos_rc_020521_backup_line

  function do_ajax_form_detallepagos_rc_020521_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detallepagos_rc_020521_backup_line_cb

  function do_ajax_form_detallepagos_rc_020521_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detallepagos_rc_020521_cancel_insert

  function do_ajax_form_detallepagos_rc_020521_cancel_update(iSeqVert)
  {
    do_ajax_form_detallepagos_rc_020521_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detallepagos_rc_020521_cancel_update

  function do_ajax_form_detallepagos_rc_020521_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detallepagos_rc_020521_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detallepagos_rc_020521_table_refresh()
  {
    var var_iddetall_ = document.F2.iddetall_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallepagos_rc_020521_table_refresh(var_iddetall_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallepagos_rc_020521_table_refresh_cb);
  } //  do_ajax_form_detallepagos_rc_020521_table_refresh

  function do_ajax_form_detallepagos_rc_020521_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.iddetall_.value = scAjaxGetKeyValue("iddetall_");
    ...
    scAjaxAlert(do_ajax_form_detallepagos_rc_020521_table_refresh_cb_after_alert);
  } // do_ajax_form_detallepagos_rc_020521_table_refresh_cb
  function do_ajax_form_detallepagos_rc_020521_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_detallepagos_rc_020521_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detallepagos_rc_020521_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detallepagos_rc_020521_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_idrc_ = scAjaxGetFieldText("idrc_" + iNumLinha);
    var var_idfact_ = scAjaxGetFieldText("idfact_" + iNumLinha);
    var var_idbanco_caja_ = scAjaxGetFieldSelect("idbanco_caja_" + iNumLinha);
    var var_idfp_ = scAjaxGetFieldSelect("idfp_" + iNumLinha);
    var var_monto_ = scAjaxGetFieldText("monto_" + iNumLinha);
    var var_banco_ = scAjaxGetFieldText("banco_" + iNumLinha);
    var var_numcheque_ = scAjaxGetFieldText("numcheque_" + iNumLinha);
    var var_fechacob_ = scAjaxGetFieldText("fechacob_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_detallepagos_rc_020521_submit_form(var_idrc_, var_idfact_, var_idbanco_caja_, var_idfp_, var_monto_, var_banco_, var_numcheque_, var_fechacob_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detallepagos_rc_020521_submit_form_cb);
  } // do_ajax_form_detallepagos_rc_020521_submit_form

  function do_ajax_form_detallepagos_rc_020521_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idrc_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idfact_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idbanco_caja_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idfp_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("monto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("banco_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("numcheque_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fechacob_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepagos_rc_020521_submit_form_cb_after_alert);
  } // do_ajax_form_detallepagos_rc_020521_submit_form_cb
  function do_ajax_form_detallepagos_rc_020521_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detallepagos_rc_020521_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detallepagos_rc_020521_navigate_form()
  {
    perform_ajax_form_detallepagos_rc_020521_navigate_form();
  }

  function perform_ajax_form_detallepagos_rc_020521_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("idrc_" + iNavForm);
      scAjaxHideErrorDisplay("idfact_" + iNavForm);
      scAjaxHideErrorDisplay("idbanco_caja_" + iNavForm);
      scAjaxHideErrorDisplay("idfp_" + iNavForm);
      scAjaxHideErrorDisplay("monto_" + iNavForm);
      scAjaxHideErrorDisplay("banco_" + iNavForm);
      scAjaxHideErrorDisplay("numcheque_" + iNavForm);
      scAjaxHideErrorDisplay("fechacob_" + iNavForm);
    }
    var var_iddetall_ = document.F2.iddetall_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallepagos_rc_020521_navigate_form(var_iddetall_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallepagos_rc_020521_navigate_form_cb);
  } // do_ajax_form_detallepagos_rc_020521_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepagos_rc_020521']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detallepagos_rc_020521_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.iddetall_.value = scAjaxGetKeyValue("iddetall_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detallepagos_rc_020521_navigate_form_cb_after_alert);
  } // do_ajax_form_detallepagos_rc_020521_navigate_form_cb
  function do_ajax_form_detallepagos_rc_020521_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('idfp_1');
...
?>
  ...
  } // do_ajax_form_detallepagos_rc_020521_navigate_form_cb_after_alert
  function sc_hide_form_detallepagos_rc_020521_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idrc_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idfact_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idbanco_caja_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idfp_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "monto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "banco_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "numcheque_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fechacob_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idrc_" + iNumLinha] = {"label": "Idrc<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idfact_" + iNumLinha] = {"label": "Idfact<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idbanco_caja_" + iNumLinha] = {"label": "Banco<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idfp_" + iNumLinha] = {"label": "Forma de pago<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["monto_" + iNumLinha] = {"label": "Monto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["numcheque_" + iNumLinha] = {"label": "Número cheque<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fechacob_" + iNumLinha] = {"label": "Fecha del cheque<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idrc_"][iNumLinha] = "idrc_" + iNumLinha;
    ajax_field_mult["idfact_"][iNumLinha] = "idfact_" + iNumLinha;
    ajax_field_mult["idbanco_caja_"][iNumLinha] = "idbanco_caja_" + iNumLinha;
    ajax_field_mult["idfp_"][iNumLinha] = "idfp_" + iNumLinha;
    ajax_field_mult["monto_"][iNumLinha] = "monto_" + iNumLinha;
    ajax_field_mult["banco_"][iNumLinha] = "banco_" + iNumLinha;
    ajax_field_mult["numcheque_"][iNumLinha] = "numcheque_" + iNumLinha;
    ajax_field_mult["fechacob_"][iNumLinha] = "fechacob_" + iNumLinha;
    ajax_field_id["idbanco_caja_" + iNumLinha] = new Array("hidden_field_label_idbanco_caja_", "hidden_field_data_idbanco_caja_" + iNumLinha);
    ajax_field_id["idfp_" + iNumLinha] = new Array("hidden_field_label_idfp_", "hidden_field_data_idfp_" + iNumLinha);
    ajax_field_id["monto_" + iNumLinha] = new Array("hidden_field_label_monto_", "hidden_field_data_monto_" + iNumLinha);
    ajax_field_id["banco_" + iNumLinha] = new Array("hidden_field_label_banco_", "hidden_field_data_banco_" + iNumLinha);
    ajax_field_id["numcheque_" + iNumLinha] = new Array("hidden_field_label_numcheque_", "hidden_field_data_numcheque_" + iNumLinha);
    ajax_field_id["fechacob_" + iNumLinha] = new Array("hidden_field_label_fechacob_", "hidden_field_data_fechacob_" + iNumLinha);
    ajax_error_count["idrc_" + iNumLinha] = "off";
    ajax_error_count["idfact_" + iNumLinha] = "off";
    ajax_error_count["idbanco_caja_" + iNumLinha] = "off";
    ajax_error_count["idfp_" + iNumLinha] = "off";
    ajax_error_count["monto_" + iNumLinha] = "off";
    ajax_error_count["banco_" + iNumLinha] = "off";
    ajax_error_count["numcheque_" + iNumLinha] = "off";
    ajax_error_count["fechacob_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idrc_" + iNumLinha] = "off";
    ajax_read_only["idfact_" + iNumLinha] = "off";
    ajax_read_only["idbanco_caja_" + iNumLinha] = "off";
    ajax_read_only["idfp_" + iNumLinha] = "off";
    ajax_read_only["monto_" + iNumLinha] = "off";
    ajax_read_only["banco_" + iNumLinha] = "off";
    ajax_read_only["numcheque_" + iNumLinha] = "off";
    ajax_read_only["fechacob_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idrc_" + iNumLinha] = "on";
    ajax_read_only["idfact_" + iNumLinha] = "on";
    ajax_read_only["idbanco_caja_" + iNumLinha] = "on";
    ajax_read_only["idfp_" + iNumLinha] = "on";
    ajax_read_only["monto_" + iNumLinha] = "on";
    ajax_read_only["banco_" + iNumLinha] = "on";
    ajax_read_only["numcheque_" + iNumLinha] = "on";
    ajax_read_only["fechacob_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idrc_" + iNumLinha] = null;
    ajax_error_list["idfact_" + iNumLinha] = null;
    ajax_error_list["idbanco_caja_" + iNumLinha] = null;
    ajax_error_list["idfp_" + iNumLinha] = null;
    ajax_error_list["monto_" + iNumLinha] = null;
    ajax_error_list["banco_" + iNumLinha] = null;
    ajax_error_list["numcheque_" + iNumLinha] = null;
    ajax_error_list["fechacob_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idrc_": new Array(),
    "idfact_": new Array(),
    "idbanco_caja_": new Array(),
    "idfp_": new Array(),
    "monto_": new Array(),
    "banco_": new Array(),
    "numcheque_": new Array(),
    "fechacob_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idrc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idrc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idrc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idrc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idrc_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idfact_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idfact_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idfact_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idfact_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idfact_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idbanco_caja_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idbanco_caja_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idbanco_caja_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idbanco_caja_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idbanco_caja_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idfp_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idfp_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idfp_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idfp_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idfp_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["monto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["monto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["monto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["monto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["monto_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["numcheque_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["numcheque_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["numcheque_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["numcheque_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["numcheque_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fechacob_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fechacob_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fechacob_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fechacob_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fechacob_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idrc_'])) ? $this->nmgp_cmp_readonly['idrc_'] : 'off';
?>
    scAjaxFieldRead("idrc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idfact_'])) ? $this->nmgp_cmp_readonly['idfact_'] : 'off';
?>
    scAjaxFieldRead("idfact_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idbanco_caja_'])) ? $this->nmgp_cmp_readonly['idbanco_caja_'] : 'off';
?>
    scAjaxFieldRead("idbanco_caja_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idfp_'])) ? $this->nmgp_cmp_readonly['idfp_'] : 'off';
?>
    scAjaxFieldRead("idfp_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['monto_'])) ? $this->nmgp_cmp_readonly['monto_'] : 'off';
?>
    scAjaxFieldRead("monto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['numcheque_'])) ? $this->nmgp_cmp_readonly['numcheque_'] : 'off';
?>
    scAjaxFieldRead("numcheque_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fechacob_'])) ? $this->nmgp_cmp_readonly['fechacob_'] : 'off';
?>
    scAjaxFieldRead("fechacob_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idrc_" + iSeq, "on");
    scAjaxFieldRead("idfact_" + iSeq, "on");
    scAjaxFieldRead("idbanco_caja_" + iSeq, "on");
    scAjaxFieldRead("idfp_" + iSeq, "on");
    scAjaxFieldRead("monto_" + iSeq, "on");
    scAjaxFieldRead("banco_" + iSeq, "on");
    scAjaxFieldRead("numcheque_" + iSeq, "on");
    scAjaxFieldRead("fechacob_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idrc_" + iRow] || "on" == ajax_error_count["idfact_" + iRow] || "on" == ajax_error_count["idbanco_caja_" + iRow] || "on" == ajax_error_count["idfp_" + iRow] || "on" == ajax_error_count["monto_" + iRow] || "on" == ajax_error_count["banco_" + iRow] || "on" == ajax_error_count["numcheque_" + iRow] || "on" == ajax_error_count["fechacob_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idrc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idfact_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idbanco_caja_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idfp_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_monto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_banco_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_numcheque_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fechacob_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idrc_" + iRow] && "off" == ajax_error_count["idfact_" + iRow] && "off" == ajax_error_count["idbanco_caja_" + iRow] && "off" == ajax_error_count["idfp_" + iRow] && "off" == ajax_error_count["monto_" + iRow] && "off" == ajax_error_count["banco_" + iRow] && "off" == ajax_error_count["numcheque_" + iRow] && "off" == ajax_error_count["fechacob_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idrc_" + iRow] = "off";
        ajax_error_count["idfact_" + iRow] = "off";
        ajax_error_count["idbanco_caja_" + iRow] = "off";
        ajax_error_count["idfp_" + iRow] = "off";
        ajax_error_count["monto_" + iRow] = "off";
        ajax_error_count["banco_" + iRow] = "off";
        ajax_error_count["numcheque_" + iRow] = "off";
        ajax_error_count["fechacob_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idrc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idfact_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idbanco_caja_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idfp_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_monto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_banco_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_numcheque_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fechacob_" + iRow).removeClass("scFormErrorLine");
    }
  }
