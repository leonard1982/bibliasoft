...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["ruta_imagen" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["ruta_imagen" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["ruta_imagen" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_form_mensajes_masivos_id_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_form_mensajes_masivos_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_creado' + iSeqRow).bind('blur', function() { sc_form_mensajes_masivos_creado_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_mensajes_masivos_creado_onfocus(this, iSeqRow) });
  $('#id_sc_field_creado_hora' + iSeqRow).bind('blur', function() { sc_form_mensajes_masivos_creado_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_mensajes_masivos_creado_onfocus(this, iSeqRow) });
  $('#id_sc_field_inicio' + iSeqRow).bind('blur', function() { sc_form_mensajes_masivos_inicio_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_mensajes_masivos_inicio_onfocus(this, iSeqRow) });
  $('#id_sc_field_fin' + iSeqRow).bind('blur', function() { sc_form_mensajes_masivos_fin_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_mensajes_masivos_fin_onfocus(this, iSeqRow) });
  $('#id_sc_field_mensaje' + iSeqRow).bind('blur', function() { sc_form_mensajes_masivos_mensaje_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_mensajes_masivos_mensaje_onfocus(this, iSeqRow) });
  $('#id_sc_field_activo' + iSeqRow).bind('blur', function() { sc_form_mensajes_masivos_activo_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_mensajes_masivos_activo_onfocus(this, iSeqRow) });
  $('#id_sc_field_descripcion' + iSeqRow).bind('blur', function() { sc_form_mensajes_masivos_descripcion_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_mensajes_masivos_descripcion_onfocus(this, iSeqRow) });
  $('#id_sc_field_asunto' + iSeqRow).bind('blur', function() { sc_form_mensajes_masivos_asunto_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_mensajes_masivos_asunto_onfocus(this, iSeqRow) });
  $('#id_sc_field_imagen' + iSeqRow).bind('blur', function() { sc_form_mensajes_masivos_imagen_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_mensajes_masivos_imagen_onfocus(this, iSeqRow) });
  $('#id_sc_field_ruta_imagen' + iSeqRow).bind('blur', function() { sc_form_mensajes_masivos_ruta_imagen_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_mensajes_masivos_ruta_imagen_onfocus(this, iSeqRow) });
  $('.sc-ui-radio-activo' + iSeqRow).on('click', function() { scMarkFormAsChanged(); });
} // scJQEventsAdd

function sc_form_mensajes_masivos_id_onblur(oThis, iSeqRow) {
  do_ajax_form_mensajes_masivos_mob_validate_id();
  scCssBlur(oThis);
}

function sc_form_mensajes_masivos_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mensajes_masivos_creado_onblur(oThis, iSeqRow) {
  do_ajax_form_mensajes_masivos_mob_validate_creado();
  scCssBlur(oThis);
}
...
function sc_form_mensajes_masivos_creado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_mensajes_masivos_inicio_onblur(oThis, iSeqRow) {
  do_ajax_form_mensajes_masivos_mob_validate_inicio();
  scCssBlur(oThis);
}

function sc_form_mensajes_masivos_inicio_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mensajes_masivos_fin_onblur(oThis, iSeqRow) {
  do_ajax_form_mensajes_masivos_mob_validate_fin();
  scCssBlur(oThis);
}

function sc_form_mensajes_masivos_fin_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mensajes_masivos_mensaje_onblur(oThis, iSeqRow) {
  do_ajax_form_mensajes_masivos_mob_validate_mensaje();
  scCssBlur(oThis);
}

function sc_form_mensajes_masivos_mensaje_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mensajes_masivos_activo_onblur(oThis, iSeqRow) {
  do_ajax_form_mensajes_masivos_mob_validate_activo();
  scCssBlur(oThis);
}

function sc_form_mensajes_masivos_activo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mensajes_masivos_descripcion_onblur(oThis, iSeqRow) {
  do_ajax_form_mensajes_masivos_mob_validate_descripcion();
  scCssBlur(oThis);
}

function sc_form_mensajes_masivos_descripcion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mensajes_masivos_asunto_onblur(oThis, iSeqRow) {
  do_ajax_form_mensajes_masivos_mob_validate_asunto();
  scCssBlur(oThis);
}

function sc_form_mensajes_masivos_asunto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mensajes_masivos_imagen_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_form_mensajes_masivos_imagen_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_mensajes_masivos_ruta_imagen_onblur(oThis, iSeqRow) {
  do_ajax_form_mensajes_masivos_mob_validate_ruta_imagen();
  scCssBlur(oThis);
}

function sc_form_mensajes_masivos_ruta_imagen_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("ruta_imagen", "", status);
...
function displayChange_row(row, status) {
	...
	displayChange_field_ruta_imagen(row, status);
...
function displayChange_field_ruta_imagen(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_mensajes_masivos_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_inicio" + iSeqRow).datepicker({
    beforeShow: function(input, inst) {
      var $oField = $(this),
          aParts  = $oField.val().split(" "),
          sTime   = "";
      sc_jq_calendar_value["#id_sc_field_inicio" + iSeqRow] = $oField.val();
    },
    onClose: function(dateText, inst) {
      do_ajax_form_mensajes_masivos_mob_validate_inicio(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
    ...
    dateFormat: "<?php echo $this->jqueryCalendarDtFormat("" . str_replace(array('/', 'aaaa', $_SESSION['scriptcase']['reg_conf']['date_sep']), array('', 'yyyy', ''), $this->field_config['inicio']['date_format']) . "", "" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . ""); ?>",
...
?>
  ...
  $("#id_sc_field_fin" + iSeqRow).datepicker({
    beforeShow: function(input, inst) {
      var $oField = $(this),
          aParts  = $oField.val().split(" "),
          sTime   = "";
      sc_jq_calendar_value["#id_sc_field_fin" + iSeqRow] = $oField.val();
    },
    onClose: function(dateText, inst) {
      do_ajax_form_mensajes_masivos_mob_validate_fin(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
    ...
    weekHeader: "<?php echo html_entity_decode($this->Ini->Nm_lang['lang_shrt_days_sem'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>",
    firstDay: <?php echo $this->jqueryCalendarWeekInit("" . $_SESSION['scriptcase']['reg_conf']['date_week_ini'] . ""); ?>,
    dateFormat: "<?php echo $this->jqueryCalendarDtFormat("" . str_replace(array('/', 'aaaa', $_SESSION['scriptcase']['reg_conf']['date_sep']), array('', 'yyyy', ''), $this->field_config['fin']['date_format']) . "", "" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . ""); ?>",
    showOtherMonths: true,
    showOn: "button",
<?php
$miniCalendarIcon   = $this->jqueryIconFile('calendar');
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_imagen" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_mensajes_masivos_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_mensajes_masivos_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
