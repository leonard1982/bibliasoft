  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mensajes_masivos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_mensajes_masivos_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_mensajes_masivos_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensajes_masivos_validate_id(var_id, var_script_case_init, do_ajax_form_mensajes_masivos_validate_id_cb);
  } // do_ajax_form_mensajes_masivos_validate_id

  function do_ajax_form_mensajes_masivos_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensajes_masivos_validate_id_cb

  // ---------- Validate creado
  function do_ajax_form_mensajes_masivos_validate_creado()
  {
    var nomeCampo_creado = "creado";
    var var_creado = scAjaxGetFieldHidden(nomeCampo_creado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensajes_masivos_validate_creado(var_creado, var_script_case_init, do_ajax_form_mensajes_masivos_validate_creado_cb);
  } // do_ajax_form_mensajes_masivos_validate_creado

  function do_ajax_form_mensajes_masivos_validate_creado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "creado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensajes_masivos_validate_creado_cb

  // ---------- Validate inicio
  function do_ajax_form_mensajes_masivos_validate_inicio()
  {
    var nomeCampo_inicio = "inicio";
    var var_inicio = scAjaxGetFieldText(nomeCampo_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensajes_masivos_validate_inicio(var_inicio, var_script_case_init, do_ajax_form_mensajes_masivos_validate_inicio_cb);
  } // do_ajax_form_mensajes_masivos_validate_inicio

  function do_ajax_form_mensajes_masivos_validate_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "inicio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensajes_masivos_validate_inicio_cb

  // ---------- Validate fin
  function do_ajax_form_mensajes_masivos_validate_fin()
  {
    var nomeCampo_fin = "fin";
    var var_fin = scAjaxGetFieldText(nomeCampo_fin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensajes_masivos_validate_fin(var_fin, var_script_case_init, do_ajax_form_mensajes_masivos_validate_fin_cb);
  } // do_ajax_form_mensajes_masivos_validate_fin

  function do_ajax_form_mensajes_masivos_validate_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fin";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensajes_masivos_validate_fin_cb

  // ---------- Validate descripcion
  function do_ajax_form_mensajes_masivos_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensajes_masivos_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_mensajes_masivos_validate_descripcion_cb);
  } // do_ajax_form_mensajes_masivos_validate_descripcion

  function do_ajax_form_mensajes_masivos_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensajes_masivos_validate_descripcion_cb

  // ---------- Validate imagen
  function do_ajax_form_mensajes_masivos_validate_imagen()
  {
    var nomeCampo_imagen = "imagen";
    var var_imagen = scAjaxGetFieldText(nomeCampo_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensajes_masivos_validate_imagen(var_imagen, var_script_case_init, do_ajax_form_mensajes_masivos_validate_imagen_cb);
  } // do_ajax_form_mensajes_masivos_validate_imagen

  function do_ajax_form_mensajes_masivos_validate_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imagen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensajes_masivos_validate_imagen_cb

  // ---------- Validate ruta_imagen
  function do_ajax_form_mensajes_masivos_validate_ruta_imagen()
  {
    var nomeCampo_ruta_imagen = "ruta_imagen";
    var var_ruta_imagen = scAjaxGetFieldHidden(nomeCampo_ruta_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensajes_masivos_validate_ruta_imagen(var_ruta_imagen, var_script_case_init, do_ajax_form_mensajes_masivos_validate_ruta_imagen_cb);
  } // do_ajax_form_mensajes_masivos_validate_ruta_imagen

  function do_ajax_form_mensajes_masivos_validate_ruta_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ruta_imagen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensajes_masivos_validate_ruta_imagen_cb

  // ---------- Validate asunto
  function do_ajax_form_mensajes_masivos_validate_asunto()
  {
    var nomeCampo_asunto = "asunto";
    var var_asunto = scAjaxGetFieldText(nomeCampo_asunto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensajes_masivos_validate_asunto(var_asunto, var_script_case_init, do_ajax_form_mensajes_masivos_validate_asunto_cb);
  } // do_ajax_form_mensajes_masivos_validate_asunto

  function do_ajax_form_mensajes_masivos_validate_asunto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asunto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensajes_masivos_validate_asunto_cb

  // ---------- Validate mensaje
  function do_ajax_form_mensajes_masivos_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldEditorHtml(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensajes_masivos_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_form_mensajes_masivos_validate_mensaje_cb);
  } // do_ajax_form_mensajes_masivos_validate_mensaje

  function do_ajax_form_mensajes_masivos_validate_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensajes_masivos_validate_mensaje_cb

  // ---------- Validate activo
  function do_ajax_form_mensajes_masivos_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldRadio(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensajes_masivos_validate_activo(var_activo, var_script_case_init, do_ajax_form_mensajes_masivos_validate_activo_cb);
  } // do_ajax_form_mensajes_masivos_validate_activo

  function do_ajax_form_mensajes_masivos_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensajes_masivos_validate_activo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mensajes_masivos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mensajes_masivos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_creado = scAjaxGetFieldHidden("creado");
    ...
    var var_ruta_imagen = scAjaxGetFieldHidden("ruta_imagen");
    ...
    scAjaxProcOn();
    x_ajax_form_mensajes_masivos_submit_form(var_id, var_creado, var_inicio, var_fin, var_descripcion, var_imagen, var_ruta_imagen, var_asunto, var_mensaje, var_activo, var_imagen_ul_name, var_imagen_ul_type, var_imagen_salva, var_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mensajes_masivos_submit_form_cb);
  } // do_ajax_form_mensajes_masivos_submit_form

  function do_ajax_form_mensajes_masivos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("ruta_imagen");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mensajes_masivos_submit_form_cb_after_alert);
  } // do_ajax_form_mensajes_masivos_submit_form_cb
  function do_ajax_form_mensajes_masivos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mensajes_masivos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mensajes_masivos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_mensajes_masivos_navigate_form, function() {});
    } else {
      perform_ajax_form_mensajes_masivos_navigate_form();
    }
  }

  function perform_ajax_form_mensajes_masivos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_mensajes_masivos_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mensajes_masivos_navigate_form_cb);
  } // do_ajax_form_mensajes_masivos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mensajes_masivos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mensajes_masivos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mensajes_masivos_navigate_form_cb_after_alert);
  } // do_ajax_form_mensajes_masivos_navigate_form_cb
  function do_ajax_form_mensajes_masivos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_mensajes_masivos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_mensajes_masivos_navigate_form_cb_after_alert
  function sc_hide_form_mensajes_masivos_form()
  {
  ...
  ajax_field_list[1] = "creado";
  ajax_field_list[2] = "inicio";
  ajax_field_list[3] = "fin";
  ajax_field_list[4] = "descripcion";
  ajax_field_list[5] = "imagen";
  ajax_field_list[6] = "ruta_imagen";
  ajax_field_list[7] = "asunto";
  ajax_field_list[8] = "mensaje";
  ...
  var ajax_error_list = {
    ...
    "ruta_imagen": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["ruta_imagen"][1] = "ruta_imagen";
  ...
  var ajax_field_id = {
    ...
    "ruta_imagen": new Array("hidden_field_label_ruta_imagen", "hidden_field_data_ruta_imagen"),
