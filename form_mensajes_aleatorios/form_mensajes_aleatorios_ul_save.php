 ...
 */
   ...
   // scriptcase
   include_once('form_mensajes_aleatorios_session.php');
   @session_start();
   // ----------
...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['form_mensajes_aleatorios']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['form_mensajes_aleatorios']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['form_mensajes_aleatorios']['upload_field_info'][ $_POST['param_field'] ];
