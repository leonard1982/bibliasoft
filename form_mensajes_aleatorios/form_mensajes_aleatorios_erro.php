...
$old_error_handler = set_error_handler("form_mensajes_aleatorios_scriptcase_error_handler");

function form_mensajes_aleatorios_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_mensajes_aleatorios']['contr_erro']) && $_SESSION['scriptcase']['form_mensajes_aleatorios']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            global $inicial_form_mensajes_aleatorios;
            $inicial_form_mensajes_aleatorios->contr_form_mensajes_aleatorios->Apl_com_erro = true;
            if ($inicial_form_mensajes_aleatorios->contr_form_mensajes_aleatorios->NM_ajax_flag)
            {
                $inicial_form_mensajes_aleatorios->contr_form_mensajes_aleatorios->NM_ajax_info['errList']['geral_form_mensajes_aleatorios'][] = $msg;
                return;
            }
            form_mensajes_aleatorios_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_mensajes_aleatorios_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_mensajes_aleatorios'])  && '' != $_SESSION['scriptcase']['error_icon']['form_mensajes_aleatorios'])  ? $_SESSION['scriptcase']['error_icon']['form_mensajes_aleatorios']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_mensajes_aleatorios']) && '' != $_SESSION['scriptcase']['error_span_title']['form_mensajes_aleatorios']) ? $_SESSION['scriptcase']['error_span_title']['form_mensajes_aleatorios'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_mensajes_aleatorios']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_mensajes_aleatorios']) ? $_SESSION['scriptcase']['error_icon_title']['form_mensajes_aleatorios'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_mensajes_aleatorios']['error_buffer'] .= ob_get_flush();
}
