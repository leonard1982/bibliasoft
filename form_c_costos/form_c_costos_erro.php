...
$old_error_handler = set_error_handler("form_c_costos_scriptcase_error_handler");

function form_c_costos_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_c_costos']['contr_erro']) && $_SESSION['scriptcase']['form_c_costos']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_c_costos->contr_form_c_costos->Apl_com_erro = true;
            if ($inicial_form_c_costos->contr_form_c_costos->NM_ajax_flag)
            {
                $inicial_form_c_costos->contr_form_c_costos->NM_ajax_info['errList']['geral_form_c_costos'][] = $msg;
                return;
            }
            form_c_costos_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_c_costos_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_c_costos'])  && '' != $_SESSION['scriptcase']['error_icon']['form_c_costos'])  ? $_SESSION['scriptcase']['error_icon']['form_c_costos']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_c_costos']) && '' != $_SESSION['scriptcase']['error_close']['form_c_costos']) ? $_SESSION['scriptcase']['error_close']['form_c_costos'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_c_costos']) && '' != $_SESSION['scriptcase']['error_span_title']['form_c_costos']) ? $_SESSION['scriptcase']['error_span_title']['form_c_costos'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_c_costos']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_c_costos']) ? $_SESSION['scriptcase']['error_icon_title']['form_c_costos'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_c_costos']['error_buffer'] .= ob_get_flush();
}
