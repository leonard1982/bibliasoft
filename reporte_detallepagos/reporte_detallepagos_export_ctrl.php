<?php
@session_start() ;
$_SESSION['scriptcase']['reporte_detallepagos']['sc_process_barr'] = true;
require_once('../reporte_detallepagos/index.php');
unset($_SESSION['scriptcase']['reporte_detallepagos']['sc_process_barr']);
$ExportCtrl = new reporte_detallepagos_export_control;
$ExportCtrl->Export_barr();

class reporte_detallepagos_export_control
{
