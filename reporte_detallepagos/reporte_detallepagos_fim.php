...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____reporte_detallepagos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____reporte_detallepagos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_detallepagos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['reporte_detallepagos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_detallepagos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['reporte_detallepagos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['reporte_detallepagos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>reporte_detallepagos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['reporte_detallepagos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['reporte_detallepagos']['embutida_filho'] as $ind => $sc_init)
          {
