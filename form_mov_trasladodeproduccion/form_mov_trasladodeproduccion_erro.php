...
$old_error_handler = set_error_handler("form_mov_trasladodeproduccion_scriptcase_error_handler");

function form_mov_trasladodeproduccion_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_mov_trasladodeproduccion']['contr_erro']) && $_SESSION['scriptcase']['form_mov_trasladodeproduccion']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_mov_trasladodeproduccion->contr_form_mov_trasladodeproduccion->Apl_com_erro = true;
            if ($inicial_form_mov_trasladodeproduccion->contr_form_mov_trasladodeproduccion->NM_ajax_flag)
            {
                $inicial_form_mov_trasladodeproduccion->contr_form_mov_trasladodeproduccion->NM_ajax_info['errList']['geral_form_mov_trasladodeproduccion'][] = $msg;
                return;
            }
            form_mov_trasladodeproduccion_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_mov_trasladodeproduccion_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_mov_trasladodeproduccion'])  && '' != $_SESSION['scriptcase']['error_icon']['form_mov_trasladodeproduccion'])  ? $_SESSION['scriptcase']['error_icon']['form_mov_trasladodeproduccion']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_mov_trasladodeproduccion']) && '' != $_SESSION['scriptcase']['error_span_title']['form_mov_trasladodeproduccion']) ? $_SESSION['scriptcase']['error_span_title']['form_mov_trasladodeproduccion'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_mov_trasladodeproduccion']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_mov_trasladodeproduccion']) ? $_SESSION['scriptcase']['error_icon_title']['form_mov_trasladodeproduccion'] : '';
?>
