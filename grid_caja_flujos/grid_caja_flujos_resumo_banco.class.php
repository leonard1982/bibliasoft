...
class grid_caja_flujos_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_banco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['arr_total']['banco'];
      }
      else
      {
          $this->array_total_banco = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['arr_total']['banco'] = $this->array_total_banco;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['labels']['banco'] = $Lab_banco; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_order']['banco']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_order']['banco'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_order']['banco'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['banco'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['banco'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['banco'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['banco'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['banco'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['banco'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['banco'] as $i_sum => $d_sum)
           {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_banco("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor, $quebra_banco, $quebra_banco_orig)
   {
      //----- Banco
      if (!isset($this->array_total_banco[$quebra_banco_orig]))
      {
         $this->array_total_banco[$quebra_banco_orig][0] = 1;
         $this->array_total_banco[$quebra_banco_orig][1] = $sum_valor;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor, $this->banco, $this->banco_orig);
            }
   }
//
