...
class grid_caja_flujos_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['arr_total']['tipo'];
      }
      else
      {
          $this->array_total_tipo = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['arr_total']['tipo'] = $this->array_total_tipo;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['labels']['tipo'] = $Lab_tipo; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_order']['tipo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_order']['tipo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_order']['tipo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['tipo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['tipo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['tipo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['tipo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['tipo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['tipo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['tipo'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_tipo as $i_tipo => $d_tipo) {
           if (!in_array($i_tipo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tipo[4] ] = $d_tipo[3];
               $this->comp_label[0][ $d_tipo[4] ] = $d_tipo[3];
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor, $quebra_tipo, $quebra_tipo_orig)
   {
      //----- Tipo
      if (!isset($this->array_total_tipo[$quebra_tipo_orig]))
      {
         $this->array_total_tipo[$quebra_tipo_orig][0] = 1;
         $this->array_total_tipo[$quebra_tipo_orig][1] = $sum_valor;
         $this->array_total_tipo[$quebra_tipo_orig][2] = 1;
         $this->array_total_tipo[$quebra_tipo_orig][3] = $quebra_tipo;
         $this->array_total_tipo[$quebra_tipo_orig][4] = $quebra_tipo_orig;
      }
      else
      {
         $this->array_total_tipo[$quebra_tipo_orig][0]++;
         $this->array_total_tipo[$quebra_tipo_orig][1] += $sum_valor;
         $this->array_total_tipo[$quebra_tipo_orig][2]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor, $this->tipo, $this->tipo_orig);
            }
   }
//
