...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "IE";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['contr_label_graf']['ie']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['contr_label_graf']['ie']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['contr_label_graf']['ie'];
      }
   }
