...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['contr_label_graf']['tercero']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['contr_label_graf']['tercero']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['contr_label_graf']['tercero'];
      }
   }
