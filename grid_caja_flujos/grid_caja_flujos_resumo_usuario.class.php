...
class grid_caja_flujos_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['arr_total']['usuario'];
      }
      else
      {
          $this->array_total_usuario = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['arr_total']['usuario'] = $this->array_total_usuario;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['labels']['usuario'] = $Lab_usuario; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_order']['usuario']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_order']['usuario'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_order']['usuario'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['usuario'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['usuario'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['usuario'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['usuario'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['usuario'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['usuario'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['usuario'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_usuario as $i_usuario => $d_usuario) {
           if (!in_array($i_usuario, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_usuario[4] ] = $d_usuario[3];
               $this->comp_label[0][ $d_usuario[4] ] = $d_usuario[3];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'usuario', 'prot' => '@aspass@'),
       );
       ...
       //-----
       foreach ($this->comp_label[0] as $i_usuario => $l_usuario) {
           if (isset($this->array_total_usuario[$i_usuario])) {
               $this->comp_group[$i_usuario] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_usuario;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      ksort($this->array_total_usuario);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor, $quebra_usuario, $quebra_usuario_orig)
   {
      //----- Usuario
      if (!isset($this->array_total_usuario[$quebra_usuario_orig]))
      {
         $this->array_total_usuario[$quebra_usuario_orig][0] = 1;
         $this->array_total_usuario[$quebra_usuario_orig][1] = $sum_valor;
         $this->array_total_usuario[$quebra_usuario_orig][2] = 1;
         $this->array_total_usuario[$quebra_usuario_orig][3] = $quebra_usuario;
         $this->array_total_usuario[$quebra_usuario_orig][4] = $quebra_usuario_orig;
      }
      else
      {
         $this->array_total_usuario[$quebra_usuario_orig][0]++;
         $this->array_total_usuario[$quebra_usuario_orig][1] += $sum_valor;
         $this->array_total_usuario[$quebra_usuario_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'usuario');
     $campos_order = $this->Ini->Get_date_order_groupby("usuario", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor, $this->usuario, $this->usuario_orig);
            }
   }
//
