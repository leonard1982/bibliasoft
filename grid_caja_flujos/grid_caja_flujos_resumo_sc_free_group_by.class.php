...
class grid_caja_flujos_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['arr_total']['documento'] = $this->array_total_documento;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['arr_total']['valor'] = $this->array_total_valor;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['arr_total']['ie'] = $this->array_total_ie;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['labels']['documento'] = $Lab_documento; 
       $prep_field['valor'] = $Lab_valor;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['labels']['valor'] = $Lab_valor; 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['labels']['ie'] = $Lab_ie; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['valor']['alin'] = "''";
       $Arr_parms['valor']['link'] = "S";
       ...
       $Arr_parms['valor']['fill'] = "true";
       $Arr_parms['valor']['order'] = "label";
       $Arr_parms['valor']['order_start'] = 'asc';
       $Arr_parms['valor']['order_invert'] = 'false';
       $Arr_parms['valor']['order_enabled'] = 'false';
       ...
       $prep_links_fl['valor'] = array(0 => 'valor', 1 => '');
       $prep_links_fl['banco'] = array(0 => 'banco', 1 => '@aspass@');
       $prep_links_fl['tercero'] = array(0 => 'tercero', 1 => '@aspass@');
       $prep_links_fl['usuario'] = array(0 => 'usuario', 1 => '@aspass@');
       $prep_links_fl['ie'] = array(0 => 'ie', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['pivot_order_level'] = 0;
       }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'field_x'  => 'valor',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_valor)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
{ 
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_caja_flujos/grid_caja_flujos_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor, $quebra_fecha, $quebra_tipo, $quebra_documento, $quebra_valor, $quebra_banco, $quebra_tercero, $quebra_usuario, $quebra_ie, $quebra_fecha_orig, $quebra_tipo_orig, $quebra_documento_orig, $quebra_valor_orig, $quebra_banco_orig, $quebra_tercero_orig, $quebra_usuario_orig, $quebra_ie_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_flujos']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor, $this->fecha, $this->tipo, $this->documento, $this->valor, $this->banco, $this->tercero, $this->usuario, $this->ie, $this->fecha_orig,  $this->tipo_orig,  $this->documento_orig,  $this->valor_orig,  $this->banco_orig,  $this->tercero_orig,  $this->usuario_orig,  $this->ie_orig);
            }
   }
//
