...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idtercero' + iSeqRow).bind('change', function() { sc_terceros_cliente_idtercero_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_nombres' + iSeqRow).bind('blur', function() { sc_terceros_cliente_nombres_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_cliente_nombres_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_direccion' + iSeqRow).bind('blur', function() { sc_terceros_cliente_direccion_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_cliente_direccion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tel_cel' + iSeqRow).bind('blur', function() { sc_terceros_cliente_tel_cel_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_cliente_tel_cel_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros_cliente_tel_cel_onfocus(this, iSeqRow) });
  $('#id_sc_field_nacimiento' + iSeqRow).bind('change', function() { sc_terceros_cliente_nacimiento_onchange(this, iSeqRow) });
  $('#id_sc_field_sexo' + iSeqRow).bind('blur', function() { sc_terceros_cliente_sexo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_terceros_cliente_sexo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_urlmail' + iSeqRow).bind('blur', function() { sc_terceros_cliente_urlmail_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_cliente_urlmail_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros_cliente_urlmail_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechault' + iSeqRow).bind('change', function() { sc_terceros_cliente_fechault_onchange(this, iSeqRow) });
  $('#id_sc_field_saldo' + iSeqRow).bind('change', function() { sc_terceros_cliente_saldo_onchange(this, iSeqRow) });
  $('#id_sc_field_afiliacion' + iSeqRow).bind('change', function() { sc_terceros_cliente_afiliacion_onchange(this, iSeqRow) });
  $('#id_sc_field_idmuni' + iSeqRow).bind('blur', function() { sc_terceros_cliente_idmuni_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_terceros_cliente_idmuni_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_terceros_cliente_observaciones_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_terceros_cliente_observaciones_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_listaprecios' + iSeqRow).bind('change', function() { sc_terceros_cliente_listaprecios_onchange(this, iSeqRow) });
  $('#id_sc_field_loatiende' + iSeqRow).bind('blur', function() { sc_terceros_cliente_loatiende_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_cliente_loatiende_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros_cliente_loatiende_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_actual' + iSeqRow).bind('change', function() { sc_terceros_cliente_con_actual_onchange(this, iSeqRow) });
  $('#id_sc_field_con_actual_hora' + iSeqRow).bind('change', function() { sc_terceros_cliente_con_actual_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_efec_retencion' + iSeqRow).bind('change', function() { sc_terceros_cliente_efec_retencion_onchange(this, iSeqRow) });
  $('#id_sc_field_regimen' + iSeqRow).bind('blur', function() { sc_terceros_cliente_regimen_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_cliente_regimen_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_empleado' + iSeqRow).bind('change', function() { sc_terceros_cliente_empleado_onchange(this, iSeqRow) });
  $('#id_sc_field_proveedor' + iSeqRow).bind('change', function() { sc_terceros_cliente_proveedor_onchange(this, iSeqRow) });
  $('#id_sc_field_contacto' + iSeqRow).bind('change', function() { sc_terceros_cliente_contacto_onchange(this, iSeqRow) });
  $('#id_sc_field_telefonos_prov' + iSeqRow).bind('change', function() { sc_terceros_cliente_telefonos_prov_onchange(this, iSeqRow) });
  $('#id_sc_field_email' + iSeqRow).bind('change', function() { sc_terceros_cliente_email_onchange(this, iSeqRow) });
  $('#id_sc_field_url' + iSeqRow).bind('change', function() { sc_terceros_cliente_url_onchange(this, iSeqRow) });
  $('#id_sc_field_creditoprov' + iSeqRow).bind('change', function() { sc_terceros_cliente_creditoprov_onchange(this, iSeqRow) });
  $('#id_sc_field_dias' + iSeqRow).bind('change', function() { sc_terceros_cliente_dias_onchange(this, iSeqRow) });
  $('#id_sc_field_fechultcomp' + iSeqRow).bind('change', function() { sc_terceros_cliente_fechultcomp_onchange(this, iSeqRow) });
  $('#id_sc_field_saldoapagar' + iSeqRow).bind('change', function() { sc_terceros_cliente_saldoapagar_onchange(this, iSeqRow) });
  $('#id_sc_field_autoretenedor' + iSeqRow).bind('change', function() { sc_terceros_cliente_autoretenedor_onchange(this, iSeqRow) });
  $('#id_sc_field_tipo_documento' + iSeqRow).bind('blur', function() { sc_terceros_cliente_tipo_documento_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_terceros_cliente_tipo_documento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dv' + iSeqRow).bind('blur', function() { sc_terceros_cliente_dv_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_terceros_cliente_dv_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_sucur_cliente' + iSeqRow).bind('change', function() { sc_terceros_cliente_sucur_cliente_onchange(this, iSeqRow) });
  $('#id_sc_field_representante' + iSeqRow).bind('blur', function() { sc_terceros_cliente_representante_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_terceros_cliente_representante_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_imagenter' + iSeqRow).bind('blur', function() { sc_terceros_cliente_imagenter_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_cliente_imagenter_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_es_restaurante' + iSeqRow).bind('blur', function() { sc_terceros_cliente_es_restaurante_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_terceros_cliente_es_restaurante_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_terceros_cliente_es_restaurante_onfocus(this, iSeqRow) });
  $('#id_sc_field_cupodis' + iSeqRow).bind('change', function() { sc_terceros_cliente_cupodis_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_relleno2' + iSeqRow).bind('change', function() { sc_terceros_cliente_relleno2_onchange(this, iSeqRow) });
  $('#id_sc_field_sucursales' + iSeqRow).bind('change', function() { sc_terceros_cliente_sucursales_onchange(this, iSeqRow) });
  $('.sc-ui-radio-es_restaurante' + iSeqRow).on('click', function() { scMarkFormAsChanged(); });
} // scJQEventsAdd

function sc_terceros_cliente_idtercero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_documento_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_documento();
  scCssBlur(oThis);
}

function sc_terceros_cliente_documento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_cliente_event_documento_onchange();
}
...
function sc_terceros_cliente_nombres_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_nombres();
  scCssBlur(oThis);
}

function sc_terceros_cliente_nombres_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_nombres_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
  do_ajax_terceros_cliente_event_nombres_onfocus();
}

function sc_terceros_cliente_direccion_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_direccion();
  scCssBlur(oThis);
}

function sc_terceros_cliente_direccion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_tel_cel_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_tel_cel();
  scCssBlur(oThis);
}

function sc_terceros_cliente_tel_cel_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_nacimiento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_sexo_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_sexo();
  scCssBlur(oThis);
}

function sc_terceros_cliente_sexo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_urlmail_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_urlmail();
  scCssBlur(oThis);
}

function sc_terceros_cliente_urlmail_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_fechault_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_saldo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_afiliacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_idmuni_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_idmuni();
  scCssBlur(oThis);
}

function sc_terceros_cliente_idmuni_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_observaciones();
  scCssBlur(oThis);
}

function sc_terceros_cliente_observaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_credito_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_credito();
  scCssBlur(oThis);
}

function sc_terceros_cliente_credito_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_cliente_event_credito_onchange();
}
...
function sc_terceros_cliente_cupo_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_cupo();
  scCssBlur(oThis);
}

function sc_terceros_cliente_cupo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_cliente_event_cupo_onchange();
}
...
function sc_terceros_cliente_listaprecios_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_loatiende_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_loatiende();
  scCssBlur(oThis);
}

function sc_terceros_cliente_loatiende_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_con_actual_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_con_actual_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_efec_retencion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_regimen_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_regimen();
  scCssBlur(oThis);
}

function sc_terceros_cliente_regimen_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_tipo_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_tipo();
  scCssBlur(oThis);
}

function sc_terceros_cliente_tipo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_cliente_event_tipo_onchange();
}
...
function sc_terceros_cliente_cliente_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_cliente();
  scCssBlur(oThis);
}

function sc_terceros_cliente_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_cliente_event_cliente_onchange();
}
...
function sc_terceros_cliente_empleado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_proveedor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_contacto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_telefonos_prov_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_url_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_creditoprov_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_dias_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_fechultcomp_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_saldoapagar_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_autoretenedor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_tipo_documento_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_tipo_documento();
  scCssBlur(oThis);
}

function sc_terceros_cliente_tipo_documento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_dv_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_dv();
  scCssBlur(oThis);
}

function sc_terceros_cliente_dv_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_nombre1_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_nombre1();
  scCssBlur(oThis);
}

function sc_terceros_cliente_nombre1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_cliente_event_nombre1_onchange();
}
...
function sc_terceros_cliente_nombre2_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_nombre2();
  scCssBlur(oThis);
}

function sc_terceros_cliente_nombre2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_cliente_event_nombre2_onchange();
}
...
function sc_terceros_cliente_apellido1_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_apellido1();
  scCssBlur(oThis);
}

function sc_terceros_cliente_apellido1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_cliente_event_apellido1_onchange();
}
...
function sc_terceros_cliente_apellido2_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_apellido2();
  scCssBlur(oThis);
}

function sc_terceros_cliente_apellido2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_cliente_event_apellido2_onchange();
}
...
function sc_terceros_cliente_sucur_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_representante_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_representante();
  scCssBlur(oThis);
}

function sc_terceros_cliente_representante_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_imagenter_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_es_restaurante_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_es_restaurante();
  scCssBlur(oThis);
}

function sc_terceros_cliente_es_restaurante_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_cliente_cupodis_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_departamento_onblur(oThis, iSeqRow) {
  do_ajax_terceros_cliente_validate_departamento();
  scCssBlur(oThis);
}

function sc_terceros_cliente_departamento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_cliente_refresh_departamento();
}
...
function sc_terceros_cliente_relleno2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_cliente_sucursales_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_terceros_cliente_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_nacimiento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros_cliente_validate_nacimiento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechault" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros_cliente_validate_fechault(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_afiliacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros_cliente_validate_afiliacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_con_actual" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_terceros_cliente_validate_con_actual(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_imagenter" + iSeqRow).fileupload({
    datatype: "json",
    url: "terceros_cliente_ul_save.php",
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'terceros_cliente')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
