 ...
 */
   ...
   // scriptcase
   include_once('terceros_cliente_session.php');
   @session_start();
   // ----------
...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['terceros_cliente']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['terceros_cliente']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['terceros_cliente']['upload_field_info'][ $_POST['param_field'] ];
