  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_terceros_cliente_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_terceros_cliente_mob_form();
	}
...
?>
  ...
  function do_ajax_terceros_cliente_mob_validate_tipo_documento()
  {
    ...
    x_ajax_terceros_cliente_mob_validate_tipo_documento(var_tipo_documento, var_script_case_init, do_ajax_terceros_cliente_mob_validate_tipo_documento_cb);
  } // do_ajax_terceros_cliente_mob_validate_tipo_documento

  function do_ajax_terceros_cliente_mob_validate_tipo_documento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_tipo_documento_cb

  // ---------- Validate documento
  function do_ajax_terceros_cliente_mob_validate_documento()
  {
    var nomeCampo_documento = "documento";
    var var_documento = scAjaxGetFieldText(nomeCampo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_documento(var_documento, var_script_case_init, do_ajax_terceros_cliente_mob_validate_documento_cb);
  } // do_ajax_terceros_cliente_mob_validate_documento

  function do_ajax_terceros_cliente_mob_validate_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_documento_cb

  // ---------- Validate dv
  function do_ajax_terceros_cliente_mob_validate_dv()
  {
    var nomeCampo_dv = "dv";
    var var_dv = scAjaxGetFieldText(nomeCampo_dv);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_dv(var_dv, var_script_case_init, do_ajax_terceros_cliente_mob_validate_dv_cb);
  } // do_ajax_terceros_cliente_mob_validate_dv

  function do_ajax_terceros_cliente_mob_validate_dv_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dv";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_dv_cb

  // ---------- Validate imagenter
  function do_ajax_terceros_cliente_mob_validate_imagenter()
  {
    var nomeCampo_imagenter = "imagenter";
    var var_imagenter = scAjaxGetFieldText(nomeCampo_imagenter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_imagenter(var_imagenter, var_script_case_init, do_ajax_terceros_cliente_mob_validate_imagenter_cb);
  } // do_ajax_terceros_cliente_mob_validate_imagenter

  function do_ajax_terceros_cliente_mob_validate_imagenter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_imagenter_cb

  // ---------- Validate nombre1
  function do_ajax_terceros_cliente_mob_validate_nombre1()
  {
    var nomeCampo_nombre1 = "nombre1";
    var var_nombre1 = scAjaxGetFieldText(nomeCampo_nombre1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_nombre1(var_nombre1, var_script_case_init, do_ajax_terceros_cliente_mob_validate_nombre1_cb);
  } // do_ajax_terceros_cliente_mob_validate_nombre1

  function do_ajax_terceros_cliente_mob_validate_nombre1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_nombre1_cb

  // ---------- Validate nombre2
  function do_ajax_terceros_cliente_mob_validate_nombre2()
  {
    var nomeCampo_nombre2 = "nombre2";
    var var_nombre2 = scAjaxGetFieldText(nomeCampo_nombre2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_nombre2(var_nombre2, var_script_case_init, do_ajax_terceros_cliente_mob_validate_nombre2_cb);
  } // do_ajax_terceros_cliente_mob_validate_nombre2

  function do_ajax_terceros_cliente_mob_validate_nombre2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_nombre2_cb

  // ---------- Validate apellido1
  function do_ajax_terceros_cliente_mob_validate_apellido1()
  {
    var nomeCampo_apellido1 = "apellido1";
    var var_apellido1 = scAjaxGetFieldText(nomeCampo_apellido1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_apellido1(var_apellido1, var_script_case_init, do_ajax_terceros_cliente_mob_validate_apellido1_cb);
  } // do_ajax_terceros_cliente_mob_validate_apellido1

  function do_ajax_terceros_cliente_mob_validate_apellido1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_apellido1_cb

  // ---------- Validate apellido2
  function do_ajax_terceros_cliente_mob_validate_apellido2()
  {
    var nomeCampo_apellido2 = "apellido2";
    var var_apellido2 = scAjaxGetFieldText(nomeCampo_apellido2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_apellido2(var_apellido2, var_script_case_init, do_ajax_terceros_cliente_mob_validate_apellido2_cb);
  } // do_ajax_terceros_cliente_mob_validate_apellido2

  function do_ajax_terceros_cliente_mob_validate_apellido2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_apellido2_cb

  // ---------- Validate tel_cel
  function do_ajax_terceros_cliente_mob_validate_tel_cel()
  {
    var nomeCampo_tel_cel = "tel_cel";
    var var_tel_cel = scAjaxGetFieldText(nomeCampo_tel_cel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_tel_cel(var_tel_cel, var_script_case_init, do_ajax_terceros_cliente_mob_validate_tel_cel_cb);
  } // do_ajax_terceros_cliente_mob_validate_tel_cel

  function do_ajax_terceros_cliente_mob_validate_tel_cel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tel_cel";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_tel_cel_cb

  // ---------- Validate urlmail
  function do_ajax_terceros_cliente_mob_validate_urlmail()
  {
    var nomeCampo_urlmail = "urlmail";
    var var_urlmail = scAjaxGetFieldText(nomeCampo_urlmail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_urlmail(var_urlmail, var_script_case_init, do_ajax_terceros_cliente_mob_validate_urlmail_cb);
  } // do_ajax_terceros_cliente_mob_validate_urlmail

  function do_ajax_terceros_cliente_mob_validate_urlmail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "urlmail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_urlmail_cb

  // ---------- Validate nombres
  function do_ajax_terceros_cliente_mob_validate_nombres()
  {
    var nomeCampo_nombres = "nombres";
    var var_nombres = scAjaxGetFieldText(nomeCampo_nombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_nombres(var_nombres, var_script_case_init, do_ajax_terceros_cliente_mob_validate_nombres_cb);
  } // do_ajax_terceros_cliente_mob_validate_nombres

  function do_ajax_terceros_cliente_mob_validate_nombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombres";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_nombres_cb

  // ---------- Validate representante
  function do_ajax_terceros_cliente_mob_validate_representante()
  {
    var nomeCampo_representante = "representante";
    var var_representante = scAjaxGetFieldText(nomeCampo_representante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_representante(var_representante, var_script_case_init, do_ajax_terceros_cliente_mob_validate_representante_cb);
  } // do_ajax_terceros_cliente_mob_validate_representante

  function do_ajax_terceros_cliente_mob_validate_representante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_representante_cb

  // ---------- Validate sexo
  function do_ajax_terceros_cliente_mob_validate_sexo()
  {
    var nomeCampo_sexo = "sexo";
    var var_sexo = scAjaxGetFieldSelect(nomeCampo_sexo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_sexo(var_sexo, var_script_case_init, do_ajax_terceros_cliente_mob_validate_sexo_cb);
  } // do_ajax_terceros_cliente_mob_validate_sexo

  function do_ajax_terceros_cliente_mob_validate_sexo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sexo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_sexo_cb

  // ---------- Validate tipo
  function do_ajax_terceros_cliente_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_terceros_cliente_mob_validate_tipo_cb);
  } // do_ajax_terceros_cliente_mob_validate_tipo

  function do_ajax_terceros_cliente_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_tipo_cb

  // ---------- Validate regimen
  function do_ajax_terceros_cliente_mob_validate_regimen()
  {
    var nomeCampo_regimen = "regimen";
    var var_regimen = scAjaxGetFieldSelect(nomeCampo_regimen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_regimen(var_regimen, var_script_case_init, do_ajax_terceros_cliente_mob_validate_regimen_cb);
  } // do_ajax_terceros_cliente_mob_validate_regimen

  function do_ajax_terceros_cliente_mob_validate_regimen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "regimen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_regimen_cb

  // ---------- Validate direccion
  function do_ajax_terceros_cliente_mob_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_direccion(var_direccion, var_script_case_init, do_ajax_terceros_cliente_mob_validate_direccion_cb);
  } // do_ajax_terceros_cliente_mob_validate_direccion

  function do_ajax_terceros_cliente_mob_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_direccion_cb

  // ---------- Validate departamento
  function do_ajax_terceros_cliente_mob_validate_departamento()
  {
    var nomeCampo_departamento = "departamento";
    var var_departamento = scAjaxGetFieldSelect(nomeCampo_departamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_departamento(var_departamento, var_script_case_init, do_ajax_terceros_cliente_mob_validate_departamento_cb);
  } // do_ajax_terceros_cliente_mob_validate_departamento

  function do_ajax_terceros_cliente_mob_validate_departamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_departamento_cb

  // ---------- Validate idmuni
  function do_ajax_terceros_cliente_mob_validate_idmuni()
  {
    var nomeCampo_idmuni = "idmuni";
    var var_idmuni = scAjaxGetFieldSelect(nomeCampo_idmuni);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_idmuni(var_idmuni, var_script_case_init, do_ajax_terceros_cliente_mob_validate_idmuni_cb);
  } // do_ajax_terceros_cliente_mob_validate_idmuni

  function do_ajax_terceros_cliente_mob_validate_idmuni_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idmuni";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_idmuni_cb

  // ---------- Validate observaciones
  function do_ajax_terceros_cliente_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_terceros_cliente_mob_validate_observaciones_cb);
  } // do_ajax_terceros_cliente_mob_validate_observaciones

  function do_ajax_terceros_cliente_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_observaciones_cb

  // ---------- Validate cliente
  function do_ajax_terceros_cliente_mob_validate_cliente()
  {
    var nomeCampo_cliente = "cliente";
    var var_cliente = scAjaxGetFieldSelect(nomeCampo_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_cliente(var_cliente, var_script_case_init, do_ajax_terceros_cliente_mob_validate_cliente_cb);
  } // do_ajax_terceros_cliente_mob_validate_cliente

  function do_ajax_terceros_cliente_mob_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_cliente_cb

  // ---------- Validate es_restaurante
  function do_ajax_terceros_cliente_mob_validate_es_restaurante()
  {
    var nomeCampo_es_restaurante = "es_restaurante";
    var var_es_restaurante = scAjaxGetFieldRadio(nomeCampo_es_restaurante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_es_restaurante(var_es_restaurante, var_script_case_init, do_ajax_terceros_cliente_mob_validate_es_restaurante_cb);
  } // do_ajax_terceros_cliente_mob_validate_es_restaurante

  function do_ajax_terceros_cliente_mob_validate_es_restaurante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_es_restaurante_cb

  // ---------- Validate credito
  function do_ajax_terceros_cliente_mob_validate_credito()
  {
    var nomeCampo_credito = "credito";
    var var_credito = scAjaxGetFieldSelect(nomeCampo_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_credito(var_credito, var_script_case_init, do_ajax_terceros_cliente_mob_validate_credito_cb);
  } // do_ajax_terceros_cliente_mob_validate_credito

  function do_ajax_terceros_cliente_mob_validate_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "credito";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_credito_cb

  // ---------- Validate cupo
  function do_ajax_terceros_cliente_mob_validate_cupo()
  {
    var nomeCampo_cupo = "cupo";
    var var_cupo = scAjaxGetFieldText(nomeCampo_cupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_cupo(var_cupo, var_script_case_init, do_ajax_terceros_cliente_mob_validate_cupo_cb);
  } // do_ajax_terceros_cliente_mob_validate_cupo

  function do_ajax_terceros_cliente_mob_validate_cupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cupo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_cupo_cb

  // ---------- Validate loatiende
  function do_ajax_terceros_cliente_mob_validate_loatiende()
  {
    var nomeCampo_loatiende = "loatiende";
    var var_loatiende = scAjaxGetFieldSelect(nomeCampo_loatiende);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_cliente_mob_validate_loatiende(var_loatiende, var_script_case_init, do_ajax_terceros_cliente_mob_validate_loatiende_cb);
  } // do_ajax_terceros_cliente_mob_validate_loatiende

  function do_ajax_terceros_cliente_mob_validate_loatiende_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_validate_loatiende_cb

  // ---------- Refresh departamento
  function do_ajax_terceros_cliente_mob_refresh_departamento()
  {
    var var_departamento = scAjaxGetFieldSelect("departamento");
    var var_nmgp_refresh_fields = "idmuni";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_cliente_mob_refresh_departamento(var_departamento, var_nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_cliente_mob_refresh_departamento_cb);
  } // do_ajax_terceros_cliente_mob_refresh_departamento

  function do_ajax_terceros_cliente_mob_refresh_departamento_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_cliente_mob_refresh_departamento_cb

  // ---------- Event onchange apellido1
  function do_ajax_terceros_cliente_mob_event_apellido1_onchange()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    var var_apellido1 = scAjaxGetFieldText("apellido1");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_cliente_mob_event_apellido1_onchange(var_nombre1, var_apellido1, var_script_case_init, do_ajax_terceros_cliente_mob_event_apellido1_onchange_cb);
  } // do_ajax_terceros_cliente_mob_event_apellido1_onchange

  function do_ajax_terceros_cliente_mob_event_apellido1_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "apellido1";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_cliente_mob_event_apellido1_onchange_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_event_apellido1_onchange_cb
  function do_ajax_terceros_cliente_mob_event_apellido1_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_cliente_mob_event_apellido1_onchange_cb_after_alert

  // ---------- Event onchange apellido2
  function do_ajax_terceros_cliente_mob_event_apellido2_onchange()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    var var_apellido2 = scAjaxGetFieldText("apellido2");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_cliente_mob_event_apellido2_onchange(var_nombre1, var_apellido2, var_script_case_init, do_ajax_terceros_cliente_mob_event_apellido2_onchange_cb);
  } // do_ajax_terceros_cliente_mob_event_apellido2_onchange

  function do_ajax_terceros_cliente_mob_event_apellido2_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "apellido2";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_cliente_mob_event_apellido2_onchange_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_event_apellido2_onchange_cb
  function do_ajax_terceros_cliente_mob_event_apellido2_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_cliente_mob_event_apellido2_onchange_cb_after_alert

  // ---------- Event onchange cliente
  function do_ajax_terceros_cliente_mob_event_cliente_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_cliente_mob_event_cliente_onchange(var_cliente, var_credito, var_cupo, var_loatiende, var_script_case_init, do_ajax_terceros_cliente_mob_event_cliente_onchange_cb);
  } // do_ajax_terceros_cliente_mob_event_cliente_onchange

  function do_ajax_terceros_cliente_mob_event_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_cliente_mob_event_cliente_onchange_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_event_cliente_onchange_cb
  function do_ajax_terceros_cliente_mob_event_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_cliente_mob_event_cliente_onchange_cb_after_alert

  // ---------- Event onchange credito
  function do_ajax_terceros_cliente_mob_event_credito_onchange()
  {
    var var_credito = scAjaxGetFieldSelect("credito");
    var var_cupo = scAjaxGetFieldText("cupo");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_cliente_mob_event_credito_onchange(var_credito, var_cupo, var_script_case_init, do_ajax_terceros_cliente_mob_event_credito_onchange_cb);
  } // do_ajax_terceros_cliente_mob_event_credito_onchange

  function do_ajax_terceros_cliente_mob_event_credito_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "credito";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_cliente_mob_event_credito_onchange_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_event_credito_onchange_cb
  function do_ajax_terceros_cliente_mob_event_credito_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_cliente_mob_event_credito_onchange_cb_after_alert

  // ---------- Event onchange creditoprov
  function do_ajax_terceros_cliente_mob_event_creditoprov_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_cliente_mob_event_creditoprov_onchange(var_script_case_init, do_ajax_terceros_cliente_mob_event_creditoprov_onchange_cb);
  } // do_ajax_terceros_cliente_mob_event_creditoprov_onchange

  function do_ajax_terceros_cliente_mob_event_creditoprov_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_cliente_mob_event_creditoprov_onchange_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_event_creditoprov_onchange_cb
  function do_ajax_terceros_cliente_mob_event_creditoprov_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_cliente_mob_event_creditoprov_onchange_cb_after_alert

  // ---------- Event onchange cupo
  function do_ajax_terceros_cliente_mob_event_cupo_onchange()
  {
    var var_cupo = scAjaxGetFieldText("cupo");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_cliente_mob_event_cupo_onchange(var_cupo, var_script_case_init, do_ajax_terceros_cliente_mob_event_cupo_onchange_cb);
  } // do_ajax_terceros_cliente_mob_event_cupo_onchange

  function do_ajax_terceros_cliente_mob_event_cupo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cupo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_cliente_mob_event_cupo_onchange_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_event_cupo_onchange_cb
  function do_ajax_terceros_cliente_mob_event_cupo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_cliente_mob_event_cupo_onchange_cb_after_alert

  // ---------- Event onchange documento
  function do_ajax_terceros_cliente_mob_event_documento_onchange()
  {
    var var_documento = scAjaxGetFieldText("documento");
    var var_dv = scAjaxGetFieldText("dv");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_cliente_mob_event_documento_onchange(var_documento, var_dv, var_script_case_init, do_ajax_terceros_cliente_mob_event_documento_onchange_cb);
  } // do_ajax_terceros_cliente_mob_event_documento_onchange

  function do_ajax_terceros_cliente_mob_event_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_cliente_mob_event_documento_onchange_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_event_documento_onchange_cb
  function do_ajax_terceros_cliente_mob_event_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_cliente_mob_event_documento_onchange_cb_after_alert

  // ---------- Event onchange nombre1
  function do_ajax_terceros_cliente_mob_event_nombre1_onchange()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_cliente_mob_event_nombre1_onchange(var_nombre1, var_script_case_init, do_ajax_terceros_cliente_mob_event_nombre1_onchange_cb);
  } // do_ajax_terceros_cliente_mob_event_nombre1_onchange

  function do_ajax_terceros_cliente_mob_event_nombre1_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre1";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_cliente_mob_event_nombre1_onchange_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_event_nombre1_onchange_cb
  function do_ajax_terceros_cliente_mob_event_nombre1_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_cliente_mob_event_nombre1_onchange_cb_after_alert

  // ---------- Event onchange nombre2
  function do_ajax_terceros_cliente_mob_event_nombre2_onchange()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    var var_nombre2 = scAjaxGetFieldText("nombre2");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_cliente_mob_event_nombre2_onchange(var_nombre1, var_nombre2, var_script_case_init, do_ajax_terceros_cliente_mob_event_nombre2_onchange_cb);
  } // do_ajax_terceros_cliente_mob_event_nombre2_onchange

  function do_ajax_terceros_cliente_mob_event_nombre2_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre2";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_cliente_mob_event_nombre2_onchange_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_event_nombre2_onchange_cb
  function do_ajax_terceros_cliente_mob_event_nombre2_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_cliente_mob_event_nombre2_onchange_cb_after_alert

  // ---------- Event onfocus nombres
  function do_ajax_terceros_cliente_mob_event_nombres_onfocus()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_terceros_cliente_mob_event_nombres_onfocus(var_nombre1, var_nombres, var_nombre2, var_apellido1, var_apellido2, var_script_case_init, do_ajax_terceros_cliente_mob_event_nombres_onfocus_cb);
  } // do_ajax_terceros_cliente_mob_event_nombres_onfocus

  function do_ajax_terceros_cliente_mob_event_nombres_onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombres";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_cliente_mob_event_nombres_onfocus_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_event_nombres_onfocus_cb
  function do_ajax_terceros_cliente_mob_event_nombres_onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_cliente_mob_event_nombres_onfocus_cb_after_alert

  // ---------- Event onchange proveedor
  function do_ajax_terceros_cliente_mob_event_proveedor_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_cliente_mob_event_proveedor_onchange(var_script_case_init, do_ajax_terceros_cliente_mob_event_proveedor_onchange_cb);
  } // do_ajax_terceros_cliente_mob_event_proveedor_onchange

  function do_ajax_terceros_cliente_mob_event_proveedor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_cliente_mob_event_proveedor_onchange_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_event_proveedor_onchange_cb
  function do_ajax_terceros_cliente_mob_event_proveedor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_cliente_mob_event_proveedor_onchange_cb_after_alert

  // ---------- Event onchange sucur_cliente
  function do_ajax_terceros_cliente_mob_event_sucur_cliente_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_cliente_mob_event_sucur_cliente_onchange(var_idmuni, var_direccion, var_tel_cel, var_script_case_init, do_ajax_terceros_cliente_mob_event_sucur_cliente_onchange_cb);
  } // do_ajax_terceros_cliente_mob_event_sucur_cliente_onchange

  function do_ajax_terceros_cliente_mob_event_sucur_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_cliente_mob_event_sucur_cliente_onchange_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_event_sucur_cliente_onchange_cb
  function do_ajax_terceros_cliente_mob_event_sucur_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_cliente_mob_event_sucur_cliente_onchange_cb_after_alert

  // ---------- Event onchange tipo
  function do_ajax_terceros_cliente_mob_event_tipo_onchange()
  {
    var var_tipo = scAjaxGetFieldSelect("tipo");
    var var_regimen = scAjaxGetFieldSelect("regimen");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_cliente_mob_event_tipo_onchange(var_tipo, var_regimen, var_script_case_init, do_ajax_terceros_cliente_mob_event_tipo_onchange_cb);
  } // do_ajax_terceros_cliente_mob_event_tipo_onchange

  function do_ajax_terceros_cliente_mob_event_tipo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_cliente_mob_event_tipo_onchange_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_event_tipo_onchange_cb
  function do_ajax_terceros_cliente_mob_event_tipo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_cliente_mob_event_tipo_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_terceros_cliente_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_terceros_cliente_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_cupo = scAjaxGetFieldText("cupo");
    var var_loatiende = scAjaxGetFieldSelect("loatiende");
    var var_idtercero = scAjaxGetFieldText("idtercero");
    ...
    scAjaxProcOn();
    x_ajax_terceros_cliente_mob_submit_form(var_tipo_documento, var_documento, var_dv, var_imagenter, var_nombre1, var_nombre2, var_apellido1, var_apellido2, var_tel_cel, var_urlmail, var_nombres, var_representante, var_sexo, var_tipo, var_regimen, var_direccion, var_departamento, var_idmuni, var_observaciones, var_cliente, var_es_restaurante, var_credito, var_cupo, var_loatiende, var_idtercero, var_imagenter_ul_name, var_imagenter_ul_type, var_imagenter_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_terceros_cliente_mob_submit_form_cb);
  } // do_ajax_terceros_cliente_mob_submit_form

  function do_ajax_terceros_cliente_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_terceros_cliente_mob_submit_form_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_submit_form_cb
  function do_ajax_terceros_cliente_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_terceros_cliente_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_terceros_cliente_mob_navigate_form()
  {
    perform_ajax_terceros_cliente_mob_navigate_form();
  }

  function perform_ajax_terceros_cliente_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_terceros_cliente_mob_navigate_form(var_idtercero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_terceros_cliente_mob_navigate_form_cb);
  } // do_ajax_terceros_cliente_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_terceros_cliente_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_terceros_cliente_mob_navigate_form_cb_after_alert);
  } // do_ajax_terceros_cliente_mob_navigate_form_cb
  function do_ajax_terceros_cliente_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_terceros_cliente_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  ajax_field_list[0] = "tipo_documento";
  ajax_field_list[1] = "documento";
  ajax_field_list[2] = "dv";
  ajax_field_list[3] = "imagenter";
  ajax_field_list[4] = "nombre1";
  ajax_field_list[5] = "nombre2";
  ajax_field_list[6] = "apellido1";
  ajax_field_list[7] = "apellido2";
  ajax_field_list[8] = "tel_cel";
  ajax_field_list[9] = "urlmail";
  ajax_field_list[10] = "nombres";
  ajax_field_list[11] = "representante";
  ajax_field_list[12] = "sexo";
  ajax_field_list[13] = "tipo";
  ajax_field_list[14] = "regimen";
  ajax_field_list[15] = "direccion";
  ajax_field_list[16] = "departamento";
  ajax_field_list[17] = "idmuni";
  ajax_field_list[18] = "observaciones";
  ajax_field_list[19] = "cliente";
  ajax_field_list[20] = "es_restaurante";
  ajax_field_list[21] = "credito";
  ajax_field_list[22] = "cupo";
  ajax_field_list[23] = "loatiende";
  ...
  var ajax_error_list = {
    ...
    "documento": {"label": "Documento de Identidad/Nit", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "idmuni": {"label": "Ciudad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "loatiende": {"label": "Lo Atiende", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
