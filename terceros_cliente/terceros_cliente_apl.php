...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['terceros_cliente']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['terceros_cliente']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_terceros_cliente($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['terceros_cliente']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->pa)) 
          {
              $_SESSION['pa'] = $this->pa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['terceros_cliente']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['terceros_cliente']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new terceros_cliente_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['initialize'])
          {
              $_SESSION['scriptcase']['terceros_cliente']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['terceros_cliente']['contr_erro'] = 'off';
          }
          $this->Ini->init2();
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['terceros_cliente']['upload_field_info']['imagenter'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'terceros_cliente',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['terceros_cliente']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['terceros_cliente'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['terceros_cliente']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['terceros_cliente']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('terceros_cliente') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['terceros_cliente']['label'] = "Actualización datos del cliente";
      ...
      $_SESSION['scriptcase']['error_icon']['terceros_cliente']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['terceros_cliente'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['upload_field_ul_name'][$this->imagenter_ul_name]))
          {
              $this->NM_ajax_info['param']['imagenter_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['upload_field_ul_name'][$this->imagenter_ul_name];
          }
      ...
      elseif (isset($this->imagenter_ul_name) && '' != $this->imagenter_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['upload_field_ul_name'][$this->imagenter_ul_name]))
          {
              $this->imagenter_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['upload_field_ul_name'][$this->imagenter_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_orig'] = " where cliente='SI'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_pesq'] = " where cliente='SI'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['terceros_cliente']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['terceros_cliente'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['terceros_cliente'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("terceros_cliente", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'terceros_cliente_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'terceros_cliente_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'terceros_cliente/terceros_cliente_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "terceros_cliente_erro.class.php"); 
      }
      $this->Erro      = new terceros_cliente_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opcao']))
         { 
             if ($this->idtercero != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['terceros_cliente']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['final'];
      }
      else
      {
      }
...
$_SESSION['scriptcase']['terceros_cliente']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['terceros_cliente']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['terceros_cliente']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          terceros_cliente_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['cupo']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cupo = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['cupo'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['cliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['cliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['dias']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->dias = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['dias'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['documento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->documento = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['documento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['tipo_documento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tipo_documento = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['tipo_documento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['nombres']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nombres = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['nombres'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['credito']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->credito = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['credito'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['cupodis']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cupodis = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['cupodis'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['regimen']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->regimen = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select']['regimen'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['sc_redir_atualiz'] == "ok")
          {
          ...
          if ($this->sc_evento == "insert" || ($this->nmgp_opc_ant == "novo" && $this->nmgp_opcao == "novo" && $this->sc_evento == "novo"))
          {
              $this->NM_close_db(); 
              $this->nm_tira_formatacao(); 
              $this->nm_gera_mensagem($this->nm_mens_form_ins, "terceros_cliente.php", "", "idtercero?#?$this->idtercero?@?"); 
          }
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "terceros_cliente.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="terceros_cliente_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="terceros_cliente"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_terceros_cliente']) || !is_array($this->NM_ajax_info['errList']['geral_terceros_cliente']))
              {
                  $this->NM_ajax_info['errList']['geral_terceros_cliente'] = array();
              }
              $this->NM_ajax_info['errList']['geral_terceros_cliente'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_documento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['php_cmp_required']['documento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['php_cmp_required']['documento'] == "on")) 
      { 
          if ($this->documento == "")  
          { 
              $hasError = true;
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if (!$hasError && "" != $this->imagenter && "S" != $this->imagenter_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'terceros_cliente_doc_name.php';
                }
...
;
    ...
    function ValidateField_nombres(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['php_cmp_required']['nombres']) || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['php_cmp_required']['nombres'] == "on")) 
      { 
          if ($this->nombres == "")  
          { 
              $hasError = true;
...
;
    ...
    function ValidateField_departamento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->departamento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_departamento']) && !in_array($this->departamento, $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_departamento']))
               {
                   $hasError = true;
    ...
    function ValidateField_idmuni(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idmuni) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_idmuni']) && !in_array($this->idmuni, $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_idmuni']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_es_restaurante(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_es_restaurante']) && !in_array($this->es_restaurante, $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_es_restaurante']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cupo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->cupo, 12, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Cupo; " ; 
                  if (!isset($Campos_Erros['cupo']))
    ...
    function ValidateField_loatiende(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->loatiende) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_loatiende']) && !in_array($this->loatiende, $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_loatiende']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
//--------------------------------------------------------------------------------------
   function upload_img_doc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros) 
   {
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_form']['imagenter']) && $this->imagenter_limpa != "S")
          {
              $this->imagenter = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_form']['imagenter'];
          }
      } 
   }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idtercero']['keyVal'] = terceros_cliente_pack_protect_string($this->nmgp_dados_form['idtercero']);
          }
   } // ajax_return_values
...
$aLookup[] = array(terceros_cliente_pack_protect_string('11') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("Registtro civil de nacimiento")));
$aLookup[] = array(terceros_cliente_pack_protect_string('12') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("Tarjeta de identidad")));
$aLookup[] = array(terceros_cliente_pack_protect_string('13') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("Cédula de ciudadanía")));
$aLookup[] = array(terceros_cliente_pack_protect_string('21') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("Tarjeta de Extranjería")));
$aLookup[] = array(terceros_cliente_pack_protect_string('22') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("Cédula de extranjería")));
$aLookup[] = array(terceros_cliente_pack_protect_string('31') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("Nit")));
$aLookup[] = array(terceros_cliente_pack_protect_string('41') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("Pasaporte")));
$aLookup[] = array(terceros_cliente_pack_protect_string('42') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("Tipo de documento extranjero")));
$aLookup[] = array(terceros_cliente_pack_protect_string('43') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("Definido por la DIAN")));
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_tipo_documento'][] = '11';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_tipo_documento'][] = '12';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_tipo_documento'][] = '13';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_tipo_documento'][] = '21';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_tipo_documento'][] = '22';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_tipo_documento'][] = '31';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_tipo_documento'][] = '41';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_tipo_documento'][] = '42';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_tipo_documento'][] = '43';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_documento']['valList'][$i] = terceros_cliente_pack_protect_string($v);
          }
...
$aLookup[] = array(terceros_cliente_pack_protect_string('M') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("Masculino")));
$aLookup[] = array(terceros_cliente_pack_protect_string('F') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("Femenino")));
$aLookup[] = array(terceros_cliente_pack_protect_string('O') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("Otro")));
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_sexo'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_sexo'][] = 'F';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_sexo'][] = 'O';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"sexo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['sexo']['valList'][$i] = terceros_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(terceros_cliente_pack_protect_string('NAT') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("NATURAL")));
$aLookup[] = array(terceros_cliente_pack_protect_string('JUR') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("JURÍDICA")));
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_tipo'][] = 'NAT';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_tipo'][] = 'JUR';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"tipo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['tipo']['valList'][$i] = terceros_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(terceros_cliente_pack_protect_string('SIM') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("SIMPLIFICADO")));
$aLookup[] = array(terceros_cliente_pack_protect_string('COMUN') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("COMÚN")));
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_regimen'][] = 'SIM';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_regimen'][] = 'COMUN';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['regimen']['valList'][$i] = terceros_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_departamento']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_departamento'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_departamento']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_departamento'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(terceros_cliente_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', terceros_cliente_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_departamento'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['departamento']['valList'][$i] = terceros_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_idmuni']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_idmuni'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_idmuni']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_idmuni'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_idmuni'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idmuni']['valList'][$i] = terceros_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(terceros_cliente_pack_protect_string('SI') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_cliente'][] = 'SI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['cliente']['valList'][$i] = terceros_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(terceros_cliente_pack_protect_string('NO') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("NO")));
$aLookup[] = array(terceros_cliente_pack_protect_string('SI') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_es_restaurante'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_es_restaurante'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['es_restaurante']['valList'][$i] = terceros_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(terceros_cliente_pack_protect_string('NO') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("NO")));
$aLookup[] = array(terceros_cliente_pack_protect_string('SI') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_credito'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_credito'][] = 'SI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['credito']['valList'][$i] = terceros_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_loatiende']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_loatiende'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_loatiende']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_loatiende'] = array(); 
}
$aLookup[] = array(terceros_cliente_pack_protect_string('') => str_replace('<', '&lt;',terceros_cliente_pack_protect_string('Vendedor')));
$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_loatiende'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['Lookup_loatiende'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['loatiende']['valList'][$i] = terceros_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
if(isset($this->ds_ter[0][0]) or isset($this->ds_ter[0][1]) or isset($this->ds_ter[0][2]))
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_terceros_cliente' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['terceros_cliente']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['imagenter_salva'] = array(
                      'row'     => '',
              ...
              $this->nmgp_refresh_fields = array_diff(array('tipo_documento', 'documento', 'dv', 'nombre1', 'nombre2', 'apellido1', 'apellido2', 'tel_cel', 'urlmail', 'nombres', 'representante', 'sexo', 'tipo', 'regimen', 'direccion', 'departamento', 'idmuni', 'observaciones', 'cliente', 'es_restaurante', 'credito', 'cupo', 'loatiende'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['terceros_cliente']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['parms'] = "idtercero?#?$this->idtercero?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_terceros_cliente = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['total'] = $qt_geral_reg_terceros_cliente;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idtercero))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_terceros_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'] > $qt_geral_reg_terceros_cliente)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'] = $qt_geral_reg_terceros_cliente; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_terceros_cliente) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['parms'] = "idtercero?#?$this->idtercero?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['sub_dir'][0]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'] < $qt_geral_reg_terceros_cliente;
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          if ($this->sc_evento == "insert")
          {
              $this->nm_gera_mensagem("Cliente creado Satisfactoriamente", $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['retorno_edit'], "parent"); 
          }
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out_imagenter))
       {
        ...
        $this->initFormPages();
    include_once("terceros_cliente_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter_form'] . " and (cliente='SI') and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_terceros_cliente = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['total'] = $qt_geral_reg_terceros_cliente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          terceros_cliente_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "terceros_cliente_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['nm_run_menu'] = 2;
       $nmgp_saida_form = "terceros_cliente_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
 ...
 function nm_gera_mensagem($nm_mensagem, $nm_apl_dest, $nm_apl_retorno="", $nm_apl_parms="")
 {
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['opc_ant'] = "";
    }
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['sc_outra_jan'] && $nm_apl_retorno == 'sc_sai')
    {
        $nm_tp_saida    = "close";
    }
...
<?php
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['run_iframe_ajax']))
        {
            echo "parent.ajax_navigate('edit', '" . $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['retorno_edit'][1] . "');";
        }
        else
        {
            echo "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_cliente']['retorno_edit'] . "';"; 
        }
?>
   } 
   if (tp_saida == "post") 
...
<?php
    if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
    {
        $this->NM_ajax_info['redir']['action'] = terceros_cliente_pack_protect_string(ob_get_contents());
        ob_end_clean();
        ob_start();
        terceros_cliente_pack_ajax_response();
    }
