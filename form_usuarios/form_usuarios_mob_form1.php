<div id="form_usuarios_mob_form1" style='<?php echo ($this->tabCssClass["form_usuarios_mob_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_acceso_inventario'][] = 'SI'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_acceso_gerencial'][] = 'SI'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_acceso_restaurante'][] = 'SI'; ?>
