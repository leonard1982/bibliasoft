...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_usuarios_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_usuarios_mob']['opc_ant'] = "inicio";
      }
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_usuarios_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_usuarios_mob']['label'] = "Usuario";
      ...
      $_SESSION['scriptcase']['error_icon']['form_usuarios_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      {
          $this->nmgp_botoes['permisos'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['botoes']['permisos'];
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_usuarios_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_usuarios_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
...
//
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dados_select']['grupo']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dados_select']['grupo'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dados_select']['usuario']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dados_select']['usuario'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dados_select']['activo']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->activo = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dados_select']['activo'];
          } 
...
//---------------------------------------------------------
    ...
    function ValidateField_password(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['password']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['password'] == "on")) 
      { 
          if ($this->password == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_nombre(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['nombre'] == "on")) 
      { 
          if ($this->nombre == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_correo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['correo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['correo'] == "on")) 
      { 
          if ($this->correo == "")  
          { 
              $hasError = true;
...
;
    ...
    function ValidateField_tercero(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->tercero == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['tercero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['tercero'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->tercero) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_tercero']) && !in_array($this->tercero, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_tercero']))
          {
              $hasError = true;
    ...
    function ValidateField_resolucion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->resolucion == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['resolucion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['resolucion'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->resolucion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_resolucion']) && !in_array($this->resolucion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_resolucion']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['resolucion']))
    ...
    function ValidateField_grupo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->grupo == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['grupo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['grupo'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "Grupo" ; 
          ...
          if (!empty($this->grupo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_grupo']) && !in_array($this->grupo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_grupo']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['grupo']))
    ...
    function ValidateField_grupocomanda(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->grupocomanda) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_grupocomanda']) && !in_array($this->grupocomanda, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_grupocomanda']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_banco_movil(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->banco_movil) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_banco_movil']) && !in_array($this->banco_movil, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_banco_movil']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idbod(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idbod) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_idbod']) && !in_array($this->idbod, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_idbod']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_ocultar_bod(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->ocultar_bod != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_ocultar_bod']) && !in_array($this->ocultar_bod, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_ocultar_bod']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idusuarios']['keyVal'] = form_usuarios_mob_pack_protect_string($this->nmgp_dados_form['idusuarios']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_usuarios_mob_pack_protect_string('') => str_replace('<', '&lt;',form_usuarios_mob_pack_protect_string('SELECCIONE')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_tercero'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_usuarios_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_usuarios_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tercero']['valList'][$i] = form_usuarios_mob_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['resolucion']['valList'][$i] = form_usuarios_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_grupo'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['grupo']['valList'][$i] = form_usuarios_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_usuarios_mob_pack_protect_string('S') => str_replace('<', '&lt;',form_usuarios_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_activo'][] = 'S';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_grupocomanda'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['grupocomanda']['valList'][$i] = form_usuarios_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['banco_movil']['valList'][$i] = form_usuarios_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_usuarios_mob_pack_protect_string('0') => str_replace('<', '&lt;',form_usuarios_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_idbod'][] = '0';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idbod']['valList'][$i] = form_usuarios_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_usuarios_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_usuarios_mob_pack_protect_string("MOSTRAR")));
$aLookup[] = array(form_usuarios_mob_pack_protect_string('NO') => str_replace('<', '&lt;',form_usuarios_mob_pack_protect_string("NO MOSTRAR")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_ocultar_bod'][] = 'SI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_ocultar_bod'][] = 'NO';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['ocultar_bod']['valList'][$i] = form_usuarios_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_usuarios_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_usuarios_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_acceso_inventario'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['acceso_inventario']['valList'][$i] = form_usuarios_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_usuarios_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_usuarios_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_acceso_gerencial'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['acceso_gerencial']['valList'][$i] = form_usuarios_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_usuarios_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_usuarios_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_acceso_restaurante'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['acceso_restaurante']['valList'][$i] = form_usuarios_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->idusuarios)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
if(isset($this->vsiexiste[0][0]))
{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_usuarios_mob';
...
$_SESSION['scriptcase']['form_usuarios_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['parms'] = "idusuarios?#?$this->idusuarios?@?"; 
      }
      $this->NM_commit_db(); 
...
//------------ 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_usuarios_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['reg_start'] + 1;
...
<?php
        ...
        include_once("form_usuarios_mob_form1.php");
        include_once("form_usuarios_mob_form2.php");
        include_once("form_usuarios_mob_form3.php");
        $this->hideFormPages();
 }
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            ...
            case "permisos":
                ...
                break;
            case "copy":
                return array("sc_b_clone_t.sc-unique-btn-6", "sc_b_clone_t.sc-unique-btn-21");
                break;
            case "help":
