...
{
    NovaJanela = window.open ("form_usuarios_help.php?nm_cod_campo=" + campo + "&language=<?php echo $this->Ini->path_lang . $this->Ini->str_lang?>&help_css=<?php echo '../_lib/css/' . $this->Ini->str_schema_all . '_form.css'; ?>", "ScriptCase", "height=100, width=300, resizable, scrollbars");
}
...
{
    document.getElementById('form_usuarios_form0').style.width='1px';
    document.getElementById('form_usuarios_form0').style.height='0px';
    document.getElementById('form_usuarios_form0').style.display='none';
    document.getElementById('form_usuarios_form0').style.overflow='scroll';
    document.getElementById('form_usuarios_form1').style.width='1px';
    document.getElementById('form_usuarios_form1').style.height='0px';
    document.getElementById('form_usuarios_form1').style.display='none';
    document.getElementById('form_usuarios_form1').style.overflow='scroll';
    document.getElementById('form_usuarios_form2').style.width='1px';
    document.getElementById('form_usuarios_form2').style.height='0px';
    document.getElementById('form_usuarios_form2').style.display='none';
    document.getElementById('form_usuarios_form2').style.overflow='scroll';
    document.getElementById('form_usuarios_form3').style.width='1px';
    document.getElementById('form_usuarios_form3').style.height='0px';
    document.getElementById('form_usuarios_form3').style.display='none';
    document.getElementById('form_usuarios_form3').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['pdf_view']) {
?>
...
?>
    ...
    displayChange_page(pag_ativa.substr(18), 'off');
    pag_ativa = N_pagina;
    sc_tab_pag(pag_ativa, 'scTabActive');
    displayChange_page(pag_ativa.substr(18), 'on');
}
