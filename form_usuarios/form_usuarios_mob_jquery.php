...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'idbod':
      case 'ocultar_bod':
        sc_exib_ocult_pag('form_usuarios_mob_form0');
        break;
      case 'acceso_inventario':
      case 'acceso_gerencial':
      case 'acceso_restaurante':
        sc_exib_ocult_pag('form_usuarios_mob_form1');
        break;
      case 'nombre_pc':
      case 'nombre_impre':
        sc_exib_ocult_pag('form_usuarios_mob_form2');
        break;
      case 'ubicacion':
      case 'n_equipo':
      case 'serial':
        sc_exib_ocult_pag('form_usuarios_mob_form3');
        break;
    }
  }
...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["ocultar_bod" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["ocultar_bod" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["ocultar_bod" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idusuarios' + iSeqRow).bind('blur', function() { sc_form_usuarios_idusuarios_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_usuarios_idusuarios_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_password' + iSeqRow).bind('blur', function() { sc_form_usuarios_password_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_usuarios_password_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre' + iSeqRow).bind('blur', function() { sc_form_usuarios_nombre_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_usuarios_nombre_onfocus(this, iSeqRow) });
  $('#id_sc_field_correo' + iSeqRow).bind('blur', function() { sc_form_usuarios_correo_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_usuarios_correo_onfocus(this, iSeqRow) });
  $('#id_sc_field_telefono' + iSeqRow).bind('blur', function() { sc_form_usuarios_telefono_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_usuarios_telefono_onfocus(this, iSeqRow) });
  $('#id_sc_field_tercero' + iSeqRow).bind('blur', function() { sc_form_usuarios_tercero_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_usuarios_tercero_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_usuarios_tercero_onfocus(this, iSeqRow) });
  $('#id_sc_field_resolucion' + iSeqRow).bind('blur', function() { sc_form_usuarios_resolucion_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_usuarios_resolucion_onfocus(this, iSeqRow) });
  $('#id_sc_field_grupo' + iSeqRow).bind('blur', function() { sc_form_usuarios_grupo_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_usuarios_grupo_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_usuarios_grupo_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_grupocomanda' + iSeqRow).bind('blur', function() { sc_form_usuarios_grupocomanda_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_usuarios_grupocomanda_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_pc' + iSeqRow).bind('blur', function() { sc_form_usuarios_nombre_pc_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_usuarios_nombre_pc_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_impre' + iSeqRow).bind('blur', function() { sc_form_usuarios_nombre_impre_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_usuarios_nombre_impre_onfocus(this, iSeqRow) });
  $('#id_sc_field_acceso_inventario' + iSeqRow).bind('blur', function() { sc_form_usuarios_acceso_inventario_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_usuarios_acceso_inventario_onfocus(this, iSeqRow) });
  $('#id_sc_field_acceso_gerencial' + iSeqRow).bind('blur', function() { sc_form_usuarios_acceso_gerencial_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_usuarios_acceso_gerencial_onfocus(this, iSeqRow) });
  $('#id_sc_field_acceso_restaurante' + iSeqRow).bind('blur', function() { sc_form_usuarios_acceso_restaurante_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_usuarios_acceso_restaurante_onfocus(this, iSeqRow) });
  $('#id_sc_field_banco_movil' + iSeqRow).bind('blur', function() { sc_form_usuarios_banco_movil_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_usuarios_banco_movil_onfocus(this, iSeqRow) });
  $('#id_sc_field_ubicacion' + iSeqRow).bind('blur', function() { sc_form_usuarios_ubicacion_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_usuarios_ubicacion_onfocus(this, iSeqRow) });
  $('#id_sc_field_n_equipo' + iSeqRow).bind('blur', function() { sc_form_usuarios_n_equipo_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_usuarios_n_equipo_onfocus(this, iSeqRow) });
  $('#id_sc_field_serial' + iSeqRow).bind('blur', function() { sc_form_usuarios_serial_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_usuarios_serial_onfocus(this, iSeqRow) });
  $('#id_sc_field_idbod' + iSeqRow).bind('blur', function() { sc_form_usuarios_idbod_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_usuarios_idbod_onfocus(this, iSeqRow) });
  $('#id_sc_field_ocultar_bod' + iSeqRow).bind('blur', function() { sc_form_usuarios_ocultar_bod_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_usuarios_ocultar_bod_onfocus(this, iSeqRow) });
  $('.sc-ui-checkbox-activo' + iSeqRow).on('click', function() { scMarkFormAsChanged(); });
  $('.sc-ui-radio-ocultar_bod' + iSeqRow).on('click', function() { scMarkFormAsChanged(); });
...
function sc_form_usuarios_idusuarios_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_idusuarios();
  scCssBlur(oThis);
}

function sc_form_usuarios_idusuarios_onfocus(oThis, iSeqRow) {
...
function sc_form_usuarios_password_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_password();
  scCssBlur(oThis);
}

function sc_form_usuarios_password_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_nombre_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_nombre();
  scCssBlur(oThis);
}

function sc_form_usuarios_nombre_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_correo_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_correo();
  scCssBlur(oThis);
}

function sc_form_usuarios_correo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_telefono_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_telefono();
  scCssBlur(oThis);
}

function sc_form_usuarios_telefono_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_tercero_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_tercero();
  scCssBlur(oThis);
}

function sc_form_usuarios_tercero_onchange(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_event_tercero_onchange();
}

function sc_form_usuarios_tercero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_resolucion_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_resolucion();
  scCssBlur(oThis);
}

function sc_form_usuarios_resolucion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_grupo_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_grupo();
  scCssBlur(oThis);
}

function sc_form_usuarios_grupo_onchange(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_event_grupo_onchange();
}

function sc_form_usuarios_grupo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_usuarios_grupocomanda_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_grupocomanda();
  scCssBlur(oThis);
}

function sc_form_usuarios_grupocomanda_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_nombre_pc_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_nombre_pc();
  scCssBlur(oThis);
}

function sc_form_usuarios_nombre_pc_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_nombre_impre_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_nombre_impre();
  scCssBlur(oThis);
}

function sc_form_usuarios_nombre_impre_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_acceso_inventario_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_acceso_inventario();
  scCssBlur(oThis);
}

function sc_form_usuarios_acceso_inventario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_acceso_gerencial_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_acceso_gerencial();
  scCssBlur(oThis);
}

function sc_form_usuarios_acceso_gerencial_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_acceso_restaurante_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_acceso_restaurante();
  scCssBlur(oThis);
}

function sc_form_usuarios_acceso_restaurante_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_banco_movil_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_banco_movil();
  scCssBlur(oThis);
}

function sc_form_usuarios_banco_movil_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_ubicacion_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_ubicacion();
  scCssBlur(oThis);
}

function sc_form_usuarios_ubicacion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_n_equipo_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_n_equipo();
  scCssBlur(oThis);
}

function sc_form_usuarios_n_equipo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_serial_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_serial();
  scCssBlur(oThis);
}

function sc_form_usuarios_serial_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_idbod_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_idbod();
  scCssBlur(oThis);
}

function sc_form_usuarios_idbod_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_usuarios_ocultar_bod_onblur(oThis, iSeqRow) {
  do_ajax_form_usuarios_mob_validate_ocultar_bod();
  scCssBlur(oThis);
}

function sc_form_usuarios_ocultar_bod_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("ocultar_bod", "", status);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_ocultar_bod(row, status);
...
function displayChange_field_ocultar_bod(row, status) {
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_creacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_usuarios_mob_validate_creacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_ultima_actualizacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_usuarios_mob_validate_ultima_actualizacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_usuarios_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
