<div id="form_usuarios_form3" style='<?php echo ($this->tabCssClass["form_usuarios_form3"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<script> 
<?php
 $NM_pag_atual = "form_usuarios_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "form_usuarios_form" . $this->nmgp_ancora;
 }
?>
<?php
