...
?>
  ...
  // ---------- Validate idusuarios
  function do_ajax_form_usuarios_validate_idusuarios()
  {
    var nomeCampo_idusuarios = "idusuarios";
    var var_idusuarios = scAjaxGetFieldHidden(nomeCampo_idusuarios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_idusuarios(var_idusuarios, var_script_case_init, do_ajax_form_usuarios_validate_idusuarios_cb);
  } // do_ajax_form_usuarios_validate_idusuarios

  function do_ajax_form_usuarios_validate_idusuarios_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_idusuarios_cb
  ...
  // ---------- Validate password
  function do_ajax_form_usuarios_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_password(var_password, var_script_case_init, do_ajax_form_usuarios_validate_password_cb);
  } // do_ajax_form_usuarios_validate_password

  function do_ajax_form_usuarios_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_password_cb
  ...
  // ---------- Validate correo
  function do_ajax_form_usuarios_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_correo(var_correo, var_script_case_init, do_ajax_form_usuarios_validate_correo_cb);
  } // do_ajax_form_usuarios_validate_correo

  function do_ajax_form_usuarios_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_correo_cb

  // ---------- Validate telefono
  function do_ajax_form_usuarios_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_usuarios_validate_telefono_cb);
  } // do_ajax_form_usuarios_validate_telefono

  function do_ajax_form_usuarios_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_telefono_cb

  // ---------- Validate tercero
  function do_ajax_form_usuarios_validate_tercero()
  {
    var nomeCampo_tercero = "tercero";
    var var_tercero = scAjaxGetFieldSelect(nomeCampo_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_tercero(var_tercero, var_script_case_init, do_ajax_form_usuarios_validate_tercero_cb);
  } // do_ajax_form_usuarios_validate_tercero

  function do_ajax_form_usuarios_validate_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tercero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_tercero_cb

  // ---------- Validate resolucion
  function do_ajax_form_usuarios_validate_resolucion()
  {
    var nomeCampo_resolucion = "resolucion";
    var var_resolucion = scAjaxGetFieldSelect(nomeCampo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_resolucion(var_resolucion, var_script_case_init, do_ajax_form_usuarios_validate_resolucion_cb);
  } // do_ajax_form_usuarios_validate_resolucion

  function do_ajax_form_usuarios_validate_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_resolucion_cb

  // ---------- Validate grupo
  function do_ajax_form_usuarios_validate_grupo()
  {
    var nomeCampo_grupo = "grupo";
    var var_grupo = scAjaxGetFieldSelect(nomeCampo_grupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_grupo(var_grupo, var_script_case_init, do_ajax_form_usuarios_validate_grupo_cb);
  } // do_ajax_form_usuarios_validate_grupo

  function do_ajax_form_usuarios_validate_grupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "grupo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_grupo_cb
  ...
  function do_ajax_form_usuarios_validate_grupocomanda()
  {
    var nomeCampo_grupocomanda = "grupocomanda";
    var var_grupocomanda = scAjaxGetFieldSelect(nomeCampo_grupocomanda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_grupocomanda(var_grupocomanda, var_script_case_init, do_ajax_form_usuarios_validate_grupocomanda_cb);
  } // do_ajax_form_usuarios_validate_grupocomanda

  function do_ajax_form_usuarios_validate_grupocomanda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_grupocomanda_cb

  // ---------- Validate banco_movil
  function do_ajax_form_usuarios_validate_banco_movil()
  {
    var nomeCampo_banco_movil = "banco_movil";
    var var_banco_movil = scAjaxGetFieldSelect(nomeCampo_banco_movil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_banco_movil(var_banco_movil, var_script_case_init, do_ajax_form_usuarios_validate_banco_movil_cb);
  } // do_ajax_form_usuarios_validate_banco_movil

  function do_ajax_form_usuarios_validate_banco_movil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_banco_movil_cb

  // ---------- Validate idbod
  function do_ajax_form_usuarios_validate_idbod()
  {
    var nomeCampo_idbod = "idbod";
    var var_idbod = scAjaxGetFieldSelect(nomeCampo_idbod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_idbod(var_idbod, var_script_case_init, do_ajax_form_usuarios_validate_idbod_cb);
  } // do_ajax_form_usuarios_validate_idbod

  function do_ajax_form_usuarios_validate_idbod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idbod";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_idbod_cb

  // ---------- Validate ocultar_bod
  function do_ajax_form_usuarios_validate_ocultar_bod()
  {
    var nomeCampo_ocultar_bod = "ocultar_bod";
    var var_ocultar_bod = scAjaxGetFieldRadio(nomeCampo_ocultar_bod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_ocultar_bod(var_ocultar_bod, var_script_case_init, do_ajax_form_usuarios_validate_ocultar_bod_cb);
  } // do_ajax_form_usuarios_validate_ocultar_bod

  function do_ajax_form_usuarios_validate_ocultar_bod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ocultar_bod";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_ocultar_bod_cb

  // ---------- Validate acceso_inventario
  function do_ajax_form_usuarios_validate_acceso_inventario()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_acceso_inventario(var_acceso_inventario, var_script_case_init, do_ajax_form_usuarios_validate_acceso_inventario_cb);
  } // do_ajax_form_usuarios_validate_acceso_inventario

  function do_ajax_form_usuarios_validate_acceso_inventario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_acceso_inventario_cb

  // ---------- Validate acceso_gerencial
  function do_ajax_form_usuarios_validate_acceso_gerencial()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_acceso_gerencial(var_acceso_gerencial, var_script_case_init, do_ajax_form_usuarios_validate_acceso_gerencial_cb);
  } // do_ajax_form_usuarios_validate_acceso_gerencial

  function do_ajax_form_usuarios_validate_acceso_gerencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_acceso_gerencial_cb

  // ---------- Validate acceso_restaurante
  function do_ajax_form_usuarios_validate_acceso_restaurante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_acceso_restaurante(var_acceso_restaurante, var_script_case_init, do_ajax_form_usuarios_validate_acceso_restaurante_cb);
  } // do_ajax_form_usuarios_validate_acceso_restaurante

  function do_ajax_form_usuarios_validate_acceso_restaurante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_acceso_restaurante_cb

  // ---------- Validate nombre_pc
  function do_ajax_form_usuarios_validate_nombre_pc()
  {
    var nomeCampo_nombre_pc = "nombre_pc";
    var var_nombre_pc = scAjaxGetFieldText(nomeCampo_nombre_pc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_nombre_pc(var_nombre_pc, var_script_case_init, do_ajax_form_usuarios_validate_nombre_pc_cb);
  } // do_ajax_form_usuarios_validate_nombre_pc

  function do_ajax_form_usuarios_validate_nombre_pc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_nombre_pc_cb

  // ---------- Validate nombre_impre
  function do_ajax_form_usuarios_validate_nombre_impre()
  {
    var nomeCampo_nombre_impre = "nombre_impre";
    var var_nombre_impre = scAjaxGetFieldText(nomeCampo_nombre_impre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_nombre_impre(var_nombre_impre, var_script_case_init, do_ajax_form_usuarios_validate_nombre_impre_cb);
  } // do_ajax_form_usuarios_validate_nombre_impre

  function do_ajax_form_usuarios_validate_nombre_impre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_nombre_impre_cb

  // ---------- Validate ubicacion
  function do_ajax_form_usuarios_validate_ubicacion()
  {
    var nomeCampo_ubicacion = "ubicacion";
    var var_ubicacion = scAjaxGetFieldText(nomeCampo_ubicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_ubicacion(var_ubicacion, var_script_case_init, do_ajax_form_usuarios_validate_ubicacion_cb);
  } // do_ajax_form_usuarios_validate_ubicacion

  function do_ajax_form_usuarios_validate_ubicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_ubicacion_cb

  // ---------- Validate n_equipo
  function do_ajax_form_usuarios_validate_n_equipo()
  {
    var nomeCampo_n_equipo = "n_equipo";
    var var_n_equipo = scAjaxGetFieldText(nomeCampo_n_equipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_n_equipo(var_n_equipo, var_script_case_init, do_ajax_form_usuarios_validate_n_equipo_cb);
  } // do_ajax_form_usuarios_validate_n_equipo

  function do_ajax_form_usuarios_validate_n_equipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_n_equipo_cb

  // ---------- Validate serial
  function do_ajax_form_usuarios_validate_serial()
  {
    var nomeCampo_serial = "serial";
    var var_serial = scAjaxGetFieldText(nomeCampo_serial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_serial(var_serial, var_script_case_init, do_ajax_form_usuarios_validate_serial_cb);
  } // do_ajax_form_usuarios_validate_serial

  function do_ajax_form_usuarios_validate_serial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "serial";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_serial_cb

  // ---------- Event onchange grupo
  function do_ajax_form_usuarios_event_grupo_onchange()
  {
    var var_grupo = scAjaxGetFieldSelect("grupo");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_usuarios_event_grupo_onchange(var_grupo, var_script_case_init, do_ajax_form_usuarios_event_grupo_onchange_cb);
  } // do_ajax_form_usuarios_event_grupo_onchange

  function do_ajax_form_usuarios_event_grupo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "grupo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_usuarios_event_grupo_onchange_cb_after_alert);
  } // do_ajax_form_usuarios_event_grupo_onchange_cb
  function do_ajax_form_usuarios_event_grupo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_usuarios_event_grupo_onchange_cb_after_alert

  // ---------- Event onchange tercero
  function do_ajax_form_usuarios_event_tercero_onchange()
  {
    var var_idusuarios = scAjaxGetFieldHidden("idusuarios");
    var var_tercero = scAjaxGetFieldSelect("tercero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_usuarios_event_tercero_onchange(var_idusuarios, var_tercero, var_script_case_init, do_ajax_form_usuarios_event_tercero_onchange_cb);
  } // do_ajax_form_usuarios_event_tercero_onchange

  function do_ajax_form_usuarios_event_tercero_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tercero";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_usuarios_event_tercero_onchange_cb_after_alert);
  } // do_ajax_form_usuarios_event_tercero_onchange_cb
  function do_ajax_form_usuarios_event_tercero_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_usuarios_event_tercero_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_usuarios_submit_form()
  {
    ...
    var var_ocultar_bod = scAjaxGetFieldRadio("ocultar_bod");
    ...
    scAjaxProcOn();
    x_ajax_form_usuarios_submit_form(var_idusuarios, var_usuario, var_password, var_nombre, var_correo, var_telefono, var_tercero, var_resolucion, var_grupo, var_activo, var_grupocomanda, var_banco_movil, var_idbod, var_ocultar_bod, var_acceso_inventario, var_acceso_gerencial, var_acceso_restaurante, var_nombre_pc, var_nombre_impre, var_ubicacion, var_n_equipo, var_serial, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_usuarios_submit_form_cb);
  ...
  function do_ajax_form_usuarios_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("ocultar_bod");
...
?>
  ...
  function perform_ajax_form_usuarios_navigate_form()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_usuarios_navigate_form(var_idusuarios, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_usuarios_navigate_form_cb);
...
?>
  ...
  function do_ajax_form_usuarios_lkpedt_refresh_tercero()
  {
    var var_tercero = scAjaxGetFieldSelect("tercero");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "tercero";
    x_ajax_form_usuarios_lkpedt_refresh_tercero(var_tercero, nmgp_refresh_fields, var_script_case_init, do_ajax_form_usuarios_lkpedt_refresh_tercero_cb);
  } // do_ajax_form_usuarios_lkpedt_refresh_tercero

  function do_ajax_form_usuarios_lkpedt_refresh_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_usuarios_lkpedt_refresh_tercero_cb

  function do_ajax_form_usuarios_lkpedt_refresh_resolucion()
  {
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "resolucion";
    x_ajax_form_usuarios_lkpedt_refresh_resolucion(var_resolucion, nmgp_refresh_fields, var_script_case_init, do_ajax_form_usuarios_lkpedt_refresh_resolucion_cb);
  } // do_ajax_form_usuarios_lkpedt_refresh_resolucion

  function do_ajax_form_usuarios_lkpedt_refresh_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_usuarios_lkpedt_refresh_resolucion_cb

  function do_ajax_form_usuarios_lkpedt_refresh_grupo()
  {
    var var_grupo = scAjaxGetFieldSelect("grupo");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "grupo";
    x_ajax_form_usuarios_lkpedt_refresh_grupo(var_grupo, nmgp_refresh_fields, var_script_case_init, do_ajax_form_usuarios_lkpedt_refresh_grupo_cb);
  } // do_ajax_form_usuarios_lkpedt_refresh_grupo

  function do_ajax_form_usuarios_lkpedt_refresh_grupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_usuarios_lkpedt_refresh_grupo_cb

  function do_ajax_form_usuarios_lkpedt_refresh_banco_movil()
  {
    var var_banco_movil = scAjaxGetFieldSelect("banco_movil");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "banco_movil";
    x_ajax_form_usuarios_lkpedt_refresh_banco_movil(var_banco_movil, nmgp_refresh_fields, var_script_case_init, do_ajax_form_usuarios_lkpedt_refresh_banco_movil_cb);
  } // do_ajax_form_usuarios_lkpedt_refresh_banco_movil

  function do_ajax_form_usuarios_lkpedt_refresh_banco_movil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_usuarios_lkpedt_refresh_banco_movil_cb
  ...
  ajax_field_list[12] = "idbod";
  ajax_field_list[13] = "ocultar_bod";
  ajax_field_list[14] = "acceso_inventario";
  ajax_field_list[15] = "acceso_gerencial";
  ajax_field_list[16] = "acceso_restaurante";
  ajax_field_list[17] = "nombre_pc";
  ajax_field_list[18] = "nombre_impre";
  ajax_field_list[19] = "ubicacion";
  ajax_field_list[20] = "n_equipo";
  ajax_field_list[21] = "serial";
  ...
  var ajax_error_list = {
    ...
    "ocultar_bod": {"label": "Ver Bodegas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["ocultar_bod"][1] = "ocultar_bod";
  ...
  var ajax_field_id = {
    ...
    "ocultar_bod": new Array("hidden_field_label_ocultar_bod", "hidden_field_data_ocultar_bod"),
