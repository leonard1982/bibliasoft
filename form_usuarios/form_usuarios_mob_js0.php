...
{
  nm_gp_submit('<?php echo $this->Ini->link_grid_aplicaciones_menu_asignarpermisos_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "NMSC_inicial*scinbusca*scoutNMSC_paginacao*scinFULL*scout"; ?>', 'inicio', '_self', '0', '0', 'grid_aplicaciones_menu_asignarpermisos');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['where_detal']))
  {
?>  
...
{
    NovaJanela = window.open ("form_usuarios_mob_help.php?nm_cod_campo=" + campo + "&language=<?php echo $this->Ini->path_lang . $this->Ini->str_lang?>&help_css=<?php echo '../_lib/css/' . $this->Ini->str_schema_all . '_form.css'; ?>", "ScriptCase", "height=100, width=300, resizable, scrollbars");
}
...
{
    document.getElementById('form_usuarios_mob_form0').style.width='1px';
    document.getElementById('form_usuarios_mob_form0').style.height='0px';
    document.getElementById('form_usuarios_mob_form0').style.display='none';
    document.getElementById('form_usuarios_mob_form0').style.overflow='scroll';
    document.getElementById('form_usuarios_mob_form1').style.width='1px';
    document.getElementById('form_usuarios_mob_form1').style.height='0px';
    document.getElementById('form_usuarios_mob_form1').style.display='none';
    document.getElementById('form_usuarios_mob_form1').style.overflow='scroll';
    document.getElementById('form_usuarios_mob_form2').style.width='1px';
    document.getElementById('form_usuarios_mob_form2').style.height='0px';
    document.getElementById('form_usuarios_mob_form2').style.display='none';
    document.getElementById('form_usuarios_mob_form2').style.overflow='scroll';
    document.getElementById('form_usuarios_mob_form3').style.width='1px';
    document.getElementById('form_usuarios_mob_form3').style.height='0px';
    document.getElementById('form_usuarios_mob_form3').style.display='none';
    document.getElementById('form_usuarios_mob_form3').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['pdf_view']) {
?>
