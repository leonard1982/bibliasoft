<?php
@session_start() ;
$_SESSION['scriptcase']['grid_kardex_fv_tns_26052020']['sc_process_barr'] = true;
require_once('../grid_kardex_fv_tns_26052020/index.php');
unset($_SESSION['scriptcase']['grid_kardex_fv_tns_26052020']['sc_process_barr']);
$ExportCtrl = new grid_kardex_fv_tns_26052020_export_control;
$ExportCtrl->Export_barr();

class grid_kardex_fv_tns_26052020_export_control
{
