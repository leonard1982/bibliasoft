<?php
   ...
   include_once 'form_gestor_archivos_tercero_mob_doc_name.php';
   ...
   if ($nm_cod_doc == "documento_db")
   {
       ...
       $trab_doc = $root . $_SESSION['scriptcase']['form_gestor_archivos_tercero_mob']['glo_nm_path_imag_temp'] . "/" . $index_file;
