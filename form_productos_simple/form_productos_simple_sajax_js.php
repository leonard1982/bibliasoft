  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_productos_simple" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_productos_simple_form();
	}
  ...
  // ---------- Validate codigobar_
  function do_ajax_form_productos_simple_validate_codigobar_(iNumLinha)
  {
    var nomeCampo_codigobar_ = "codigobar_" + iNumLinha;
    var var_codigobar_ = scAjaxGetFieldText(nomeCampo_codigobar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_simple_validate_codigobar_(var_codigobar_, iNumLinha, var_script_case_init, do_ajax_form_productos_simple_validate_codigobar__cb);
  } // do_ajax_form_productos_simple_validate_codigobar_

  function do_ajax_form_productos_simple_validate_codigobar__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "codigobar_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigobar_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "codigobar_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigobar_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_simple_validate_codigobar__cb

  // ---------- Validate nompro_
  function do_ajax_form_productos_simple_validate_nompro_(iNumLinha)
  {
    var nomeCampo_nompro_ = "nompro_" + iNumLinha;
    var var_nompro_ = scAjaxGetFieldText(nomeCampo_nompro_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_simple_validate_nompro_(var_nompro_, iNumLinha, var_script_case_init, do_ajax_form_productos_simple_validate_nompro__cb);
  } // do_ajax_form_productos_simple_validate_nompro_

  function do_ajax_form_productos_simple_validate_nompro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nompro_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nompro_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nompro_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nompro_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_simple_validate_nompro__cb

  // ---------- Validate unimen_
  function do_ajax_form_productos_simple_validate_unimen_(iNumLinha)
  {
    var nomeCampo_unimen_ = "unimen_" + iNumLinha;
    var var_unimen_ = scAjaxGetFieldText(nomeCampo_unimen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_simple_validate_unimen_(var_unimen_, iNumLinha, var_script_case_init, do_ajax_form_productos_simple_validate_unimen__cb);
  } // do_ajax_form_productos_simple_validate_unimen_

  function do_ajax_form_productos_simple_validate_unimen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "unimen_" + iLineNumber;
    }
    else
    {
      sFieldValid = "unimen_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "unimen_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "unimen_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_simple_validate_unimen__cb

  // ---------- Validate unidad__
  function do_ajax_form_productos_simple_validate_unidad__(iNumLinha)
  {
    var nomeCampo_unidad__ = "unidad__" + iNumLinha;
    var var_unidad__ = scAjaxGetFieldSelect(nomeCampo_unidad__);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_simple_validate_unidad__(var_unidad__, iNumLinha, var_script_case_init, do_ajax_form_productos_simple_validate_unidad___cb);
  } // do_ajax_form_productos_simple_validate_unidad__

  function do_ajax_form_productos_simple_validate_unidad___cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "unidad__" + iLineNumber;
    }
    else
    {
      sFieldValid = "unidad__";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "unidad__");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "unidad__");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_simple_validate_unidad___cb

  // ---------- Validate costomen_
  function do_ajax_form_productos_simple_validate_costomen_(iNumLinha)
  {
    var nomeCampo_costomen_ = "costomen_" + iNumLinha;
    var var_costomen_ = scAjaxGetFieldText(nomeCampo_costomen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_simple_validate_costomen_(var_costomen_, iNumLinha, var_script_case_init, do_ajax_form_productos_simple_validate_costomen__cb);
  } // do_ajax_form_productos_simple_validate_costomen_

  function do_ajax_form_productos_simple_validate_costomen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "costomen_" + iLineNumber;
    }
    else
    {
      sFieldValid = "costomen_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "costomen_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "costomen_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_simple_validate_costomen__cb

  // ---------- Validate preciomen_
  function do_ajax_form_productos_simple_validate_preciomen_(iNumLinha)
  {
    var nomeCampo_preciomen_ = "preciomen_" + iNumLinha;
    var var_preciomen_ = scAjaxGetFieldText(nomeCampo_preciomen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_simple_validate_preciomen_(var_preciomen_, iNumLinha, var_script_case_init, do_ajax_form_productos_simple_validate_preciomen__cb);
  } // do_ajax_form_productos_simple_validate_preciomen_

  function do_ajax_form_productos_simple_validate_preciomen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "preciomen_" + iLineNumber;
    }
    else
    {
      sFieldValid = "preciomen_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "preciomen_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "preciomen_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_simple_validate_preciomen__cb

  // ---------- Validate idgrup_
  function do_ajax_form_productos_simple_validate_idgrup_(iNumLinha)
  {
    var nomeCampo_idgrup_ = "idgrup_" + iNumLinha;
    var var_idgrup_ = scAjaxGetFieldSelect(nomeCampo_idgrup_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_simple_validate_idgrup_(var_idgrup_, iNumLinha, var_script_case_init, do_ajax_form_productos_simple_validate_idgrup__cb);
  } // do_ajax_form_productos_simple_validate_idgrup_

  function do_ajax_form_productos_simple_validate_idgrup__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idgrup_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idgrup_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idgrup_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idgrup_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_simple_validate_idgrup__cb

  // ---------- Validate idiva_
  function do_ajax_form_productos_simple_validate_idiva_(iNumLinha)
  {
    var nomeCampo_idiva_ = "idiva_" + iNumLinha;
    var var_idiva_ = scAjaxGetFieldSelect(nomeCampo_idiva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_simple_validate_idiva_(var_idiva_, iNumLinha, var_script_case_init, do_ajax_form_productos_simple_validate_idiva__cb);
  } // do_ajax_form_productos_simple_validate_idiva_

  function do_ajax_form_productos_simple_validate_idiva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idiva_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idiva_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idiva_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idiva_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_simple_validate_idiva__cb

  // ---------- Validate imagenprod_
  function do_ajax_form_productos_simple_validate_imagenprod_(iNumLinha)
  {
    var nomeCampo_imagenprod_ = "imagenprod_" + iNumLinha;
    var var_imagenprod_ = scAjaxGetFieldText(nomeCampo_imagenprod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_simple_validate_imagenprod_(var_imagenprod_, iNumLinha, var_script_case_init, do_ajax_form_productos_simple_validate_imagenprod__cb);
  } // do_ajax_form_productos_simple_validate_imagenprod_

  function do_ajax_form_productos_simple_validate_imagenprod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "imagenprod_" + iLineNumber;
    }
    else
    {
      sFieldValid = "imagenprod_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "imagenprod_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "imagenprod_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_simple_validate_imagenprod__cb

  // ---------- Event onchange codigobar_
  function do_ajax_form_productos_simple_event_codigobar__onchange(iSeqForm)
  {
    var var_unidad__ = scAjaxGetFieldSelect("unidad__" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_productos_simple_event_codigobar__onchange(var_unidad__, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_productos_simple_event_codigobar__onchange_cb);
  } // do_ajax_form_productos_simple_event_codigobar__onchange

  function do_ajax_form_productos_simple_event_codigobar__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_simple_event_codigobar__onchange_cb_after_alert);
  } // do_ajax_form_productos_simple_event_codigobar__onchange_cb
  function do_ajax_form_productos_simple_event_codigobar__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_simple_event_codigobar__onchange_cb_after_alert

  // ---------- Event onchange unidad__
  function do_ajax_form_productos_simple_event_unidad___onchange(iSeqForm)
  {
    var var_unimen_ = scAjaxGetFieldText("unimen_" + iSeqForm);
    var var_unidad__ = scAjaxGetFieldSelect("unidad__" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_productos_simple_event_unidad___onchange(var_unimen_, var_unidad__, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_productos_simple_event_unidad___onchange_cb);
  } // do_ajax_form_productos_simple_event_unidad___onchange

  function do_ajax_form_productos_simple_event_unidad___onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_simple_event_unidad___onchange_cb_after_alert);
  } // do_ajax_form_productos_simple_event_unidad___onchange_cb
  function do_ajax_form_productos_simple_event_unidad___onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_simple_event_unidad___onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_productos_simple_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_productos_simple_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_simple_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_productos_simple_add_new_line_cb);
  } // do_ajax_form_productos_simple_add_new_line

  function do_ajax_form_productos_simple_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    eval("var_ajax_img_imagenprod_" + iAjaxNewLine + " = '';");
    scFocusField('' + iAjaxNewLine);

  } // do_ajax_form_productos_simple_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_productos_simple_backup_line(iNumLinha)
  {
    var var_idprod_ = scAjaxGetFieldText("idprod_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_simple_backup_line(var_idprod_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_productos_simple_backup_line_cb);
  } // do_ajax_form_productos_simple_backup_line

  function do_ajax_form_productos_simple_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_productos_simple_backup_line_cb

  function do_ajax_form_productos_simple_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_productos_simple_cancel_insert

  function do_ajax_form_productos_simple_cancel_update(iSeqVert)
  {
    do_ajax_form_productos_simple_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_productos_simple_cancel_update

  function do_ajax_form_productos_simple_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_productos_simple_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_productos_simple_table_refresh()
  {
    var var_idprod_ = document.F2.idprod_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_productos_simple_table_refresh(var_idprod_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_productos_simple_table_refresh_cb);
  } //  do_ajax_form_productos_simple_table_refresh

  function do_ajax_form_productos_simple_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idprod_.value = scAjaxGetKeyValue("idprod_");
    ...
    scAjaxAlert(do_ajax_form_productos_simple_table_refresh_cb_after_alert);
  } // do_ajax_form_productos_simple_table_refresh_cb
  function do_ajax_form_productos_simple_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_productos_simple_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_productos_simple_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_productos_simple_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_codigobar_ = scAjaxGetFieldText("codigobar_" + iNumLinha);
    var var_nompro_ = scAjaxGetFieldText("nompro_" + iNumLinha);
    var var_unimen_ = scAjaxGetFieldText("unimen_" + iNumLinha);
    var var_unidad__ = scAjaxGetFieldSelect("unidad__" + iNumLinha);
    var var_costomen_ = scAjaxGetFieldText("costomen_" + iNumLinha);
    var var_preciomen_ = scAjaxGetFieldText("preciomen_" + iNumLinha);
    var var_idgrup_ = scAjaxGetFieldSelect("idgrup_" + iNumLinha);
    var var_idiva_ = scAjaxGetFieldSelect("idiva_" + iNumLinha);
    var var_imagenprod_ = scAjaxGetFieldText("imagenprod_" + iNumLinha);
    var var_imagenprod__ul_name = scAjaxSpecCharProtect(eval('document.F1.imagenprod__ul_name' + iNumLinha + '.value'));
    var var_imagenprod__ul_type = eval('document.F1.imagenprod__ul_type' + iNumLinha + '.value');
    var var_imagenprod__limpa = eval('document.F1.imagenprod__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_productos_simple_submit_form(var_codigobar_, var_nompro_, var_unimen_, var_unidad__, var_costomen_, var_preciomen_, var_idgrup_, var_idiva_, var_imagenprod_, var_imagenprod__ul_name, var_imagenprod__ul_type, var_imagenprod__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_productos_simple_submit_form_cb);
  } // do_ajax_form_productos_simple_submit_form

  function do_ajax_form_productos_simple_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("codigobar_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nompro_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("unimen_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("unidad__" + sc_num_ult_line);
      scAjaxHideErrorDisplay("costomen_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("preciomen_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idgrup_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idiva_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("imagenprod_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
<?php
        ...
        {
?>
          if (document.F1.elements["imagenprod__limpa" + sc_num_ult_line] && document.F1.elements["imagenprod__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldImage("imagenprod_" + sc_num_ult_line, oImgTemp, "", "", "", "N");
            document.F1.elements["imagenprod__limpa" + sc_num_ult_line].checked = false;
          }
<?php
        }
?>
      }
      eval("if (document.F1.imagenprod__ul_name" + sc_num_ult_line + ") document.F1.imagenprod__ul_name" + sc_num_ult_line + ".value = ''");
      eval("if (document.F1.imagenprod__ul_type" + sc_num_ult_line + ") document.F1.imagenprod__ul_type" + sc_num_ult_line + ".value = ''");
    }
    scAjaxSetNavpage();
    scAjaxShowDebug();
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_simple_submit_form_cb_after_alert);
  } // do_ajax_form_productos_simple_submit_form_cb
  function do_ajax_form_productos_simple_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_productos_simple_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_productos_simple_navigate_form()
  {
    perform_ajax_form_productos_simple_navigate_form();
  }

  function perform_ajax_form_productos_simple_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("codigobar_" + iNavForm);
      scAjaxHideErrorDisplay("nompro_" + iNavForm);
      scAjaxHideErrorDisplay("unimen_" + iNavForm);
      scAjaxHideErrorDisplay("unidad__" + iNavForm);
      scAjaxHideErrorDisplay("costomen_" + iNavForm);
      scAjaxHideErrorDisplay("preciomen_" + iNavForm);
      scAjaxHideErrorDisplay("idgrup_" + iNavForm);
      scAjaxHideErrorDisplay("idiva_" + iNavForm);
      scAjaxHideErrorDisplay("imagenprod_" + iNavForm);
    }
    var var_idprod_ = document.F2.idprod_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_productos_simple_navigate_form(var_idprod_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_productos_simple_navigate_form_cb);
  } // do_ajax_form_productos_simple_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_simple']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_productos_simple_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idprod_.value = scAjaxGetKeyValue("idprod_" + var_last_index);
    ...
    {
      eval("if (document.F1.imagenprod__ul_name" + iImg + ") document.F1.imagenprod__ul_name" + iImg + ".value = ''");
      eval("if (document.F1.imagenprod__ul_type" + iImg + ") document.F1.imagenprod__ul_type" + iImg + ".value = ''");
    }
    scAjaxSetBtnVars();
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_productos_simple_navigate_form_cb_after_alert);
  } // do_ajax_form_productos_simple_navigate_form_cb
  function do_ajax_form_productos_simple_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_productos_simple_navigate_form_cb_after_alert
  function sc_hide_form_productos_simple_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "codigobar_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nompro_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "unimen_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "unidad__" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "costomen_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "preciomen_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idgrup_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idiva_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "imagenprod_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["codigobar_" + iNumLinha] = {"label": "Código de barras<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nompro_" + iNumLinha] = {"label": "Descripción<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["unimen_" + iNumLinha] = {"label": "Unidad<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["unidad__" + iNumLinha] = {"label": "Unidad Pr.<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["costomen_" + iNumLinha] = {"label": "Costo compra<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["preciomen_" + iNumLinha] = {"label": "Precio venta menudeo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idgrup_" + iNumLinha] = {"label": "Familia o grupo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idiva_" + iNumLinha] = {"label": "IVA<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["imagenprod_" + iNumLinha] = {"label": "Imágen<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["codigobar_"][iNumLinha] = "codigobar_" + iNumLinha;
    ajax_field_mult["nompro_"][iNumLinha] = "nompro_" + iNumLinha;
    ajax_field_mult["unimen_"][iNumLinha] = "unimen_" + iNumLinha;
    ajax_field_mult["unidad__"][iNumLinha] = "unidad__" + iNumLinha;
    ajax_field_mult["costomen_"][iNumLinha] = "costomen_" + iNumLinha;
    ajax_field_mult["preciomen_"][iNumLinha] = "preciomen_" + iNumLinha;
    ajax_field_mult["idgrup_"][iNumLinha] = "idgrup_" + iNumLinha;
    ajax_field_mult["idiva_"][iNumLinha] = "idiva_" + iNumLinha;
    ajax_field_mult["imagenprod_"][iNumLinha] = "imagenprod_" + iNumLinha;
    ajax_field_id["codigobar_" + iNumLinha] = new Array("hidden_field_label_codigobar_", "hidden_field_data_codigobar_" + iNumLinha);
    ajax_field_id["nompro_" + iNumLinha] = new Array("hidden_field_label_nompro_", "hidden_field_data_nompro_" + iNumLinha);
    ajax_field_id["unidad__" + iNumLinha] = new Array("hidden_field_label_unidad__", "hidden_field_data_unidad__" + iNumLinha);
    ajax_field_id["costomen_" + iNumLinha] = new Array("hidden_field_label_costomen_", "hidden_field_data_costomen_" + iNumLinha);
    ajax_field_id["preciomen_" + iNumLinha] = new Array("hidden_field_label_preciomen_", "hidden_field_data_preciomen_" + iNumLinha);
    ajax_field_id["idgrup_" + iNumLinha] = new Array("hidden_field_label_idgrup_", "hidden_field_data_idgrup_" + iNumLinha);
    ajax_field_id["idiva_" + iNumLinha] = new Array("hidden_field_label_idiva_", "hidden_field_data_idiva_" + iNumLinha);
    ajax_field_id["imagenprod_" + iNumLinha] = new Array("hidden_field_label_imagenprod_", "hidden_field_data_imagenprod_" + iNumLinha);
    ajax_error_count["codigobar_" + iNumLinha] = "off";
    ajax_error_count["nompro_" + iNumLinha] = "off";
    ajax_error_count["unimen_" + iNumLinha] = "off";
    ajax_error_count["unidad__" + iNumLinha] = "off";
    ajax_error_count["costomen_" + iNumLinha] = "off";
    ajax_error_count["preciomen_" + iNumLinha] = "off";
    ajax_error_count["idgrup_" + iNumLinha] = "off";
    ajax_error_count["idiva_" + iNumLinha] = "off";
    ajax_error_count["imagenprod_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["codigobar_" + iNumLinha] = "off";
    ajax_read_only["nompro_" + iNumLinha] = "off";
    ajax_read_only["unimen_" + iNumLinha] = "off";
    ajax_read_only["unidad__" + iNumLinha] = "off";
    ajax_read_only["costomen_" + iNumLinha] = "off";
    ajax_read_only["preciomen_" + iNumLinha] = "off";
    ajax_read_only["idgrup_" + iNumLinha] = "off";
    ajax_read_only["idiva_" + iNumLinha] = "off";
    ajax_read_only["imagenprod_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["codigobar_" + iNumLinha] = "on";
    ajax_read_only["nompro_" + iNumLinha] = "on";
    ajax_read_only["unimen_" + iNumLinha] = "on";
    ajax_read_only["unidad__" + iNumLinha] = "on";
    ajax_read_only["costomen_" + iNumLinha] = "on";
    ajax_read_only["preciomen_" + iNumLinha] = "on";
    ajax_read_only["idgrup_" + iNumLinha] = "on";
    ajax_read_only["idiva_" + iNumLinha] = "on";
    ajax_read_only["imagenprod_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["codigobar_" + iNumLinha] = null;
    ajax_error_list["nompro_" + iNumLinha] = null;
    ajax_error_list["unimen_" + iNumLinha] = null;
    ajax_error_list["unidad__" + iNumLinha] = null;
    ajax_error_list["costomen_" + iNumLinha] = null;
    ajax_error_list["preciomen_" + iNumLinha] = null;
    ajax_error_list["idgrup_" + iNumLinha] = null;
    ajax_error_list["idiva_" + iNumLinha] = null;
    ajax_error_list["imagenprod_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "codigobar_": new Array(),
    "nompro_": new Array(),
    "unimen_": new Array(),
    "unidad__": new Array(),
    "costomen_": new Array(),
    "preciomen_": new Array(),
    "idgrup_": new Array(),
    "idiva_": new Array(),
    "imagenprod_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["codigobar_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigobar_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigobar_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigobar_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigobar_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nompro_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nompro_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nompro_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nompro_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nompro_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["unimen_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["unimen_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["unimen_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["unimen_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["unimen_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["unidad__" + iNumLinha]["valid"] = new Array();
      ajax_error_list["unidad__" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["unidad__" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["unidad__" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["unidad__" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["costomen_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["costomen_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["costomen_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["costomen_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["costomen_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["preciomen_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["preciomen_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["preciomen_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["preciomen_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["preciomen_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idgrup_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idgrup_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idgrup_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idgrup_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idgrup_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idiva_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idiva_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idiva_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idiva_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idiva_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["imagenprod_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["imagenprod_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["imagenprod_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["imagenprod_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["imagenprod_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigobar_'])) ? $this->nmgp_cmp_readonly['codigobar_'] : 'off';
?>
    scAjaxFieldRead("codigobar_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nompro_'])) ? $this->nmgp_cmp_readonly['nompro_'] : 'off';
?>
    scAjaxFieldRead("nompro_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['unimen_'])) ? $this->nmgp_cmp_readonly['unimen_'] : 'off';
?>
    scAjaxFieldRead("unimen_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['unidad__'])) ? $this->nmgp_cmp_readonly['unidad__'] : 'off';
?>
    scAjaxFieldRead("unidad__" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['costomen_'])) ? $this->nmgp_cmp_readonly['costomen_'] : 'off';
?>
    scAjaxFieldRead("costomen_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['preciomen_'])) ? $this->nmgp_cmp_readonly['preciomen_'] : 'off';
?>
    scAjaxFieldRead("preciomen_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idgrup_'])) ? $this->nmgp_cmp_readonly['idgrup_'] : 'off';
?>
    scAjaxFieldRead("idgrup_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idiva_'])) ? $this->nmgp_cmp_readonly['idiva_'] : 'off';
?>
    scAjaxFieldRead("idiva_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['imagenprod_'])) ? $this->nmgp_cmp_readonly['imagenprod_'] : 'off';
?>
    scAjaxFieldRead("imagenprod_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("codigobar_" + iSeq, "on");
    scAjaxFieldRead("nompro_" + iSeq, "on");
    scAjaxFieldRead("unimen_" + iSeq, "on");
    scAjaxFieldRead("unidad__" + iSeq, "on");
    scAjaxFieldRead("costomen_" + iSeq, "on");
    scAjaxFieldRead("preciomen_" + iSeq, "on");
    scAjaxFieldRead("idgrup_" + iSeq, "on");
    scAjaxFieldRead("idiva_" + iSeq, "on");
    scAjaxFieldRead("imagenprod_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["codigobar_" + iRow] || "on" == ajax_error_count["nompro_" + iRow] || "on" == ajax_error_count["unimen_" + iRow] || "on" == ajax_error_count["unidad__" + iRow] || "on" == ajax_error_count["costomen_" + iRow] || "on" == ajax_error_count["preciomen_" + iRow] || "on" == ajax_error_count["idgrup_" + iRow] || "on" == ajax_error_count["idiva_" + iRow] || "on" == ajax_error_count["imagenprod_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigobar_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nompro_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_unimen_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_unidad__" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_costomen_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_preciomen_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idgrup_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idiva_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_imagenprod_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["codigobar_" + iRow] && "off" == ajax_error_count["nompro_" + iRow] && "off" == ajax_error_count["unimen_" + iRow] && "off" == ajax_error_count["unidad__" + iRow] && "off" == ajax_error_count["costomen_" + iRow] && "off" == ajax_error_count["preciomen_" + iRow] && "off" == ajax_error_count["idgrup_" + iRow] && "off" == ajax_error_count["idiva_" + iRow] && "off" == ajax_error_count["imagenprod_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["codigobar_" + iRow] = "off";
        ajax_error_count["nompro_" + iRow] = "off";
        ajax_error_count["unimen_" + iRow] = "off";
        ajax_error_count["unidad__" + iRow] = "off";
        ajax_error_count["costomen_" + iRow] = "off";
        ajax_error_count["preciomen_" + iRow] = "off";
        ajax_error_count["idgrup_" + iRow] = "off";
        ajax_error_count["idiva_" + iRow] = "off";
        ajax_error_count["imagenprod_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_codigobar_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nompro_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_unimen_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_unidad__" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_costomen_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_preciomen_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idgrup_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idiva_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_imagenprod_" + iRow).removeClass("scFormErrorLine");
    }
  }
