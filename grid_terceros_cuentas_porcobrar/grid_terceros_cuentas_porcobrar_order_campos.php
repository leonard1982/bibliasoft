<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_terceros_cuentas_porcobrar']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_terceros_cuentas_porcobrar_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_terceros_cuentas_porcobrar_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["num"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["num"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["num"] : "Número";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['tercero'] = "on";
   $tab_def_campos['tercero'] = "tercero";
   $tab_labels["tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["tercero"] : "Tercero";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['numero_documento'] = "on";
   $tab_def_campos['numero_documento'] = "numero_documento";
   $tab_labels["numero_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["numero_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["numero_documento"] : "Documento";
   $tab_ger_campos['valor_total'] = "on";
   $tab_def_campos['valor_total'] = "valor_total";
   $tab_labels["valor_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["valor_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["valor_total"] : "Valor";
   $tab_ger_campos['saldo'] = "on";
   $tab_def_campos['saldo'] = "saldo";
   $tab_labels["saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["saldo"] : "Saldo";
   $tab_ger_campos['usuario'] = "on";
   $tab_def_campos['usuario'] = "usuario";
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['cod_cuenta'] = "on";
   $tab_def_campos['cod_cuenta'] = "cod_cuenta";
   $tab_labels["cod_cuenta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["cod_cuenta"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["cod_cuenta"] : "Cuenta";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["pagada"] : "Pago";
   $tab_ger_campos['asentada'] = "on";
   $tab_def_campos['asentada'] = "asentada";
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['labels']["asentada"] : "Asentada";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_terceros_cuentas_porcobrar_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_porcobrar']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
