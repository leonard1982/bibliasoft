  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_plantillas_correo_propio_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_plantillas_correo_propio_mob_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_plantillas_correo_propio_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plantillas_correo_propio_mob_validate_id(var_id, var_script_case_init, do_ajax_form_plantillas_correo_propio_mob_validate_id_cb);
  } // do_ajax_form_plantillas_correo_propio_mob_validate_id

  function do_ajax_form_plantillas_correo_propio_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plantillas_correo_propio_mob_validate_id_cb

  // ---------- Validate descripcion
  function do_ajax_form_plantillas_correo_propio_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plantillas_correo_propio_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_plantillas_correo_propio_mob_validate_descripcion_cb);
  } // do_ajax_form_plantillas_correo_propio_mob_validate_descripcion

  function do_ajax_form_plantillas_correo_propio_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plantillas_correo_propio_mob_validate_descripcion_cb

  // ---------- Validate html_header
  function do_ajax_form_plantillas_correo_propio_mob_validate_html_header()
  {
    var nomeCampo_html_header = "html_header";
    var var_html_header = scAjaxGetFieldEditorHtml(nomeCampo_html_header);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plantillas_correo_propio_mob_validate_html_header(var_html_header, var_script_case_init, do_ajax_form_plantillas_correo_propio_mob_validate_html_header_cb);
  } // do_ajax_form_plantillas_correo_propio_mob_validate_html_header

  function do_ajax_form_plantillas_correo_propio_mob_validate_html_header_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "html_header";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plantillas_correo_propio_mob_validate_html_header_cb

  // ---------- Validate html_body
  function do_ajax_form_plantillas_correo_propio_mob_validate_html_body()
  {
    var nomeCampo_html_body = "html_body";
    var var_html_body = scAjaxGetFieldEditorHtml(nomeCampo_html_body);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plantillas_correo_propio_mob_validate_html_body(var_html_body, var_script_case_init, do_ajax_form_plantillas_correo_propio_mob_validate_html_body_cb);
  } // do_ajax_form_plantillas_correo_propio_mob_validate_html_body

  function do_ajax_form_plantillas_correo_propio_mob_validate_html_body_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "html_body";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plantillas_correo_propio_mob_validate_html_body_cb

  // ---------- Validate html_buttons
  function do_ajax_form_plantillas_correo_propio_mob_validate_html_buttons()
  {
    var nomeCampo_html_buttons = "html_buttons";
    var var_html_buttons = scAjaxGetFieldEditorHtml(nomeCampo_html_buttons);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plantillas_correo_propio_mob_validate_html_buttons(var_html_buttons, var_script_case_init, do_ajax_form_plantillas_correo_propio_mob_validate_html_buttons_cb);
  } // do_ajax_form_plantillas_correo_propio_mob_validate_html_buttons

  function do_ajax_form_plantillas_correo_propio_mob_validate_html_buttons_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "html_buttons";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plantillas_correo_propio_mob_validate_html_buttons_cb

  // ---------- Validate html_footer
  function do_ajax_form_plantillas_correo_propio_mob_validate_html_footer()
  {
    var nomeCampo_html_footer = "html_footer";
    var var_html_footer = scAjaxGetFieldEditorHtml(nomeCampo_html_footer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plantillas_correo_propio_mob_validate_html_footer(var_html_footer, var_script_case_init, do_ajax_form_plantillas_correo_propio_mob_validate_html_footer_cb);
  } // do_ajax_form_plantillas_correo_propio_mob_validate_html_footer

  function do_ajax_form_plantillas_correo_propio_mob_validate_html_footer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "html_footer";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plantillas_correo_propio_mob_validate_html_footer_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_plantillas_correo_propio_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_plantillas_correo_propio_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_html_header = scAjaxGetFieldEditorHtml("html_header");
    var var_html_body = scAjaxGetFieldEditorHtml("html_body");
    var var_html_buttons = scAjaxGetFieldEditorHtml("html_buttons");
    var var_html_footer = scAjaxGetFieldEditorHtml("html_footer");
    ...
    scAjaxProcOn();
    x_ajax_form_plantillas_correo_propio_mob_submit_form(var_id, var_descripcion, var_html_header, var_html_body, var_html_buttons, var_html_footer, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_plantillas_correo_propio_mob_submit_form_cb);
  } // do_ajax_form_plantillas_correo_propio_mob_submit_form

  function do_ajax_form_plantillas_correo_propio_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("html_header");
      scAjaxHideErrorDisplay("html_body");
      scAjaxHideErrorDisplay("html_buttons");
      scAjaxHideErrorDisplay("html_footer");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_plantillas_correo_propio_mob_submit_form_cb_after_alert);
  } // do_ajax_form_plantillas_correo_propio_mob_submit_form_cb
  function do_ajax_form_plantillas_correo_propio_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_plantillas_correo_propio_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_plantillas_correo_propio_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_plantillas_correo_propio_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_plantillas_correo_propio_mob_navigate_form();
    }
  }

  function perform_ajax_form_plantillas_correo_propio_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_plantillas_correo_propio_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_plantillas_correo_propio_mob_navigate_form_cb);
  } // do_ajax_form_plantillas_correo_propio_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_plantillas_correo_propio_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_plantillas_correo_propio_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_plantillas_correo_propio_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_plantillas_correo_propio_mob_navigate_form_cb
  function do_ajax_form_plantillas_correo_propio_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_plantillas_correo_propio_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_plantillas_correo_propio_mob_navigate_form_cb_after_alert
  function sc_hide_form_plantillas_correo_propio_mob_form()
  {
  ...
  ajax_field_list[2] = "html_header";
  ajax_field_list[3] = "html_body";
  ajax_field_list[4] = "html_buttons";
  ajax_field_list[5] = "html_footer";
  ...
  var ajax_error_list = {
    ...
    "html_header": {"label": "Cabecera", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "html_body": {"label": "Cuerpo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "html_buttons": {"label": "Botones", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "html_footer": {"label": "Pie", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "html_header": new Array(),
    "html_body": new Array(),
    "html_buttons": new Array(),
    "html_footer": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["descripcion"][1] = "descripcion";
  ajax_field_mult["html_header"][1] = "html_header";
  ajax_field_mult["html_body"][1] = "html_body";
  ajax_field_mult["html_buttons"][1] = "html_buttons";
  ajax_field_mult["html_footer"][1] = "html_footer";

  var ajax_field_id = {
    "descripcion": new Array("hidden_field_label_descripcion", "hidden_field_data_descripcion"),
    "html_header": new Array("hidden_field_label_html_header", "hidden_field_data_html_header"),
    "html_body": new Array("hidden_field_label_html_body", "hidden_field_data_html_body"),
    "html_buttons": new Array("hidden_field_label_html_buttons", "hidden_field_data_html_buttons"),
    "html_footer": new Array("hidden_field_label_html_footer", "hidden_field_data_html_footer")
  };
