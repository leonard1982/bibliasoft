  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_plantillas_correo_propio" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_plantillas_correo_propio_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_plantillas_correo_propio_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plantillas_correo_propio_validate_id(var_id, var_script_case_init, do_ajax_form_plantillas_correo_propio_validate_id_cb);
  } // do_ajax_form_plantillas_correo_propio_validate_id

  function do_ajax_form_plantillas_correo_propio_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plantillas_correo_propio_validate_id_cb

  // ---------- Validate descripcion
  function do_ajax_form_plantillas_correo_propio_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plantillas_correo_propio_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_plantillas_correo_propio_validate_descripcion_cb);
  } // do_ajax_form_plantillas_correo_propio_validate_descripcion

  function do_ajax_form_plantillas_correo_propio_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plantillas_correo_propio_validate_descripcion_cb

  // ---------- Validate html_header
  function do_ajax_form_plantillas_correo_propio_validate_html_header()
  {
    var nomeCampo_html_header = "html_header";
    var var_html_header = scAjaxGetFieldEditorHtml(nomeCampo_html_header);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plantillas_correo_propio_validate_html_header(var_html_header, var_script_case_init, do_ajax_form_plantillas_correo_propio_validate_html_header_cb);
  } // do_ajax_form_plantillas_correo_propio_validate_html_header

  function do_ajax_form_plantillas_correo_propio_validate_html_header_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plantillas_correo_propio_validate_html_header_cb

  // ---------- Validate html_body
  function do_ajax_form_plantillas_correo_propio_validate_html_body()
  {
    var nomeCampo_html_body = "html_body";
    var var_html_body = scAjaxGetFieldEditorHtml(nomeCampo_html_body);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plantillas_correo_propio_validate_html_body(var_html_body, var_script_case_init, do_ajax_form_plantillas_correo_propio_validate_html_body_cb);
  } // do_ajax_form_plantillas_correo_propio_validate_html_body

  function do_ajax_form_plantillas_correo_propio_validate_html_body_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plantillas_correo_propio_validate_html_body_cb

  // ---------- Validate html_buttons
  function do_ajax_form_plantillas_correo_propio_validate_html_buttons()
  {
    var nomeCampo_html_buttons = "html_buttons";
    var var_html_buttons = scAjaxGetFieldEditorHtml(nomeCampo_html_buttons);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plantillas_correo_propio_validate_html_buttons(var_html_buttons, var_script_case_init, do_ajax_form_plantillas_correo_propio_validate_html_buttons_cb);
  } // do_ajax_form_plantillas_correo_propio_validate_html_buttons

  function do_ajax_form_plantillas_correo_propio_validate_html_buttons_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plantillas_correo_propio_validate_html_buttons_cb

  // ---------- Validate html_footer
  function do_ajax_form_plantillas_correo_propio_validate_html_footer()
  {
    var nomeCampo_html_footer = "html_footer";
    var var_html_footer = scAjaxGetFieldEditorHtml(nomeCampo_html_footer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_plantillas_correo_propio_validate_html_footer(var_html_footer, var_script_case_init, do_ajax_form_plantillas_correo_propio_validate_html_footer_cb);
  } // do_ajax_form_plantillas_correo_propio_validate_html_footer

  function do_ajax_form_plantillas_correo_propio_validate_html_footer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_plantillas_correo_propio_validate_html_footer_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_plantillas_correo_propio_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_plantillas_correo_propio_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_plantillas_correo_propio_submit_form(var_id, var_descripcion, var_html_header, var_html_body, var_html_buttons, var_html_footer, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_plantillas_correo_propio_submit_form_cb);
  } // do_ajax_form_plantillas_correo_propio_submit_form

  function do_ajax_form_plantillas_correo_propio_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_plantillas_correo_propio_submit_form_cb_after_alert);
  } // do_ajax_form_plantillas_correo_propio_submit_form_cb
  function do_ajax_form_plantillas_correo_propio_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_plantillas_correo_propio_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_plantillas_correo_propio_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_plantillas_correo_propio_navigate_form, function() {});
    } else {
      perform_ajax_form_plantillas_correo_propio_navigate_form();
    }
  }

  function perform_ajax_form_plantillas_correo_propio_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_plantillas_correo_propio_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_plantillas_correo_propio_navigate_form_cb);
  } // do_ajax_form_plantillas_correo_propio_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_plantillas_correo_propio']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_plantillas_correo_propio_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_plantillas_correo_propio_navigate_form_cb_after_alert);
  } // do_ajax_form_plantillas_correo_propio_navigate_form_cb
  function do_ajax_form_plantillas_correo_propio_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_plantillas_correo_propio_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_plantillas_correo_propio_navigate_form_cb_after_alert
  function sc_hide_form_plantillas_correo_propio_form()
  {
