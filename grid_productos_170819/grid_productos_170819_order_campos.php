...
<?php
   ...
   $Ord_Cmp = new grid_productos_170819_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_productos_170819_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigobar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["codigobar"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["codigobar"] : "Código bar.";
   $tab_ger_campos['nompro'] = "on";
   $tab_def_campos['nompro'] = "nompro";
   $tab_labels["nompro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["nompro"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["nompro"] : "Producto";
   $tab_ger_campos['imagenprod'] = "on";
   $tab_def_campos['imagenprod'] = "imagenprod";
   $tab_labels["imagenprod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["imagenprod"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["imagenprod"] : "Imágen";
   $tab_ger_campos['stockmen'] = "on";
   $tab_def_campos['stockmen'] = "stockmen";
   $tab_labels["stockmen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["stockmen"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["stockmen"] : "Existencia Mayor";
   $tab_ger_campos['unimay'] = "on";
   $tab_def_campos['unimay'] = "unimay";
   $tab_labels["unimay"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["unimay"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["unimay"] : "Und. Mayor";
   $tab_ger_campos['preciofull'] = "on";
   $tab_def_campos['preciofull'] = "preciofull";
   $tab_labels["preciofull"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["preciofull"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["preciofull"] : "Valor U Mayor";
   $tab_ger_campos['existencia_menor'] = "on";
   $tab_def_campos['existencia_menor'] = "existencia_menor";
   $tab_labels["existencia_menor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["existencia_menor"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["existencia_menor"] : "Existencia Menor";
   $tab_ger_campos['unimen'] = "on";
   $tab_def_campos['unimen'] = "unimen";
   $tab_labels["unimen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["unimen"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["unimen"] : "Unidad";
   $tab_ger_campos['preciomen'] = "on";
   $tab_def_campos['preciomen'] = "preciomen";
   $tab_labels["preciomen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["preciomen"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["preciomen"] : "Valor unit.";
   $tab_ger_campos['otro'] = "on";
   $tab_def_campos['otro'] = "otro";
   $tab_labels["otro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["otro"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["otro"] : "Descuento";
   $tab_ger_campos['otro2'] = "on";
   $tab_def_campos['otro2'] = "otro2";
   $tab_labels["otro2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["otro2"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["otro2"] : "%  Desc.";
   ...
   $tab_labels["btn_stock"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["btn_stock"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["btn_stock"] : "Stock";
   $tab_ger_campos['stock_fv_lot'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['stock_fv_lot'] = "stock_fv_lot";
   }
   else
   {
       $tab_def_campos['stock_fv_lot'] = "";
   }
   $tab_labels["stock_fv_lot"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["stock_fv_lot"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["stock_fv_lot"] : "Stock x Fv y/o Lote";
   $tab_ger_campos['escombo'] = "on";
   $tab_def_campos['escombo'] = "escombo";
   $tab_labels["escombo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["escombo"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["escombo"] : "Combo";
   ...
   $tab_labels["agregarnotainv"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["agregarnotainv"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['labels']["agregarnotainv"] : "Agregar Inv.";
   $tab_ger_campos['imagenprod'] = "none";
   $tab_ger_campos['btn_stock'] = "none";
   $tab_ger_campos['stock_fv_lot'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_productos_170819_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_productos_170819']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
