	...
	module.exports = function (oAppData) {
		...
		if (App.getUserRole() === Enums.UserRole.SuperAdmin)
		{
			var
				...
				Settings = __webpack_require__(/*! modules/LogsViewerWebclient/js/Settings.js */ 295)
			;

			Settings.init(oAppData);

			__webpack_require__(/*! modules/LogsViewerWebclient/js/enums.js */ 296);
					...
					ModulesManager.run('AdminPanelWebclient', 'registerAdminPanelTab', [
						function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/LogsViewerWebclient/js/views/AdminSettingsView.js */ 297));
								});
						},
