...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (oAppData) {
		var
			...
			Settings = __webpack_require__(/*! modules/Facebook/js/Settings.js */ 287),
					...
					ModulesManager.run('AdminPanelWebclient', 'registerAdminPanelTab', [
						function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/Facebook/js/views/AdminSettingsView.js */ 289));
								});
						},
			...
			return {
				start: function (ModulesManager) {
					ModulesManager.run('SettingsWebclient', 'registerSettingsTab', [
						function () { return __webpack_require__(/*! modules/Facebook/js/views/FacebookSettingsFormView.js */ 288); },
						Settings.HashModuleName,
						TextUtils.i18n('FACEBOOK/LABEL_SETTINGS_TAB')
					]);
				}
