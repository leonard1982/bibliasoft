...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (oAppData) {
		__webpack_require__(/*! modules/StandardLoginFormWebclient/js/enums.js */ 405);
		__webpack_require__(/*! modules/CoreWebclient/js/vendors/jquery.cookie.js */ 211);
		...
		var
			...
			Settings = __webpack_require__(/*! modules/StandardLoginFormWebclient/js/Settings.js */ 406),
		...
		if (!App.isPublic() && bAnonimUser)
		{
			if (App.isMobile())
			{
				return {
					...
					getLoginScreenView: function () {
						return __webpack_require__(/*! modules/StandardLoginFormWebclient/js/views/LoginView.js */ 407);
					},
			...
			else
			{
				var GetLoginView = function() {
					if (LoginView === null)
					{
						LoginView = __webpack_require__(/*! modules/StandardLoginFormWebclient/js/views/LoginView.js */ 407);
					}
					return LoginView;
				};
