...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (oAppData) {
		var App = __webpack_require__(/*! modules/CoreWebclient/js/App.js */ 180);
		
		if (App.getUserRole() === Enums.UserRole.NormalUser)
		{
			var Settings = __webpack_require__(/*! modules/ChangePasswordWebclient/js/Settings.js */ 250);
			...
			return {
				start: function (ModulesManager) {
					if (Settings.ShowSingleMailChangePasswordInCommonSettings)
					{
						ModulesManager.run(
							...
							[
								function () { return __webpack_require__(/*! modules/ChangePasswordWebclient/js/views/ChangeSingleMailAccountPasswordView.js */ 251); },
								'common',
								'common'
							]
						);
				...
				getChangePasswordPopup: function () {
					return __webpack_require__(/*! modules/ChangePasswordWebclient/js/popups/ChangePasswordPopup.js */ 252);
				},
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var
		...
		Settings = __webpack_require__(/*! modules/ChangePasswordWebclient/js/Settings.js */ 250)
	;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var
		...
		UrlUtils = __webpack_require__(/*! modules/CoreWebclient/js/utils/Url.js */ 178),
		ValidationUtils = __webpack_require__(/*! modules/CoreWebclient/js/utils/Validation.js */ 253),
