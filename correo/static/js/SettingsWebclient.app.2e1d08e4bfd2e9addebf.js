...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (oAppData) {
		...
		{
			var Settings = __webpack_require__(/*! modules/SettingsWebclient/js/Settings.js */ 401);
			...
			if (bAdminUser)
			{
				return {
					getAbstractSettingsFormViewClass: function () {
						return __webpack_require__(/*! modules/SettingsWebclient/js/views/CAbstractSettingsFormView.js */ 402);
					}
				};
			}
				...
				return {
					getScreens: function () {
						...
						oScreens[Settings.HashModuleName] = function () {
							return __webpack_require__(/*! modules/SettingsWebclient/js/views/SettingsView.js */ 403);
						};
						return oScreens;
					},
					...
					registerSettingsTab: function (fGetTabView, sTabName, sTabTitle) {
						var SettingsView = __webpack_require__(/*! modules/SettingsWebclient/js/views/SettingsView.js */ 403);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var
		...
		Settings = __webpack_require__(/*! modules/SettingsWebclient/js/Settings.js */ 401),
