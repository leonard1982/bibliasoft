...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (oAppData) {
		var
			...
			Settings = __webpack_require__(/*! modules/Dropbox/js/Settings.js */ 283),
					...
					ModulesManager.run('AdminPanelWebclient', 'registerAdminPanelTab', [
						function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/Dropbox/js/views/AdminSettingsView.js */ 285));
								});
						},
			...
			return {
				start: function (ModulesManager) {
					ModulesManager.run('SettingsWebclient', 'registerSettingsTab', [
						function () { return __webpack_require__(/*! modules/Dropbox/js/views/DropboxSettingsFormView.js */ 284); },
						Settings.HashModuleName,
						TextUtils.i18n('DROPBOX/LABEL_SETTINGS_TAB')
					]);
				}
