	...
	module.exports = function (oAppData) {
		...
		if (App.getUserRole() === Enums.UserRole.SuperAdmin)
		{
			var
				...
				Cache = __webpack_require__(/*! modules/AdminPanelWebclient/js/Cache.js */ 234),
				Settings = __webpack_require__(/*! modules/AdminPanelWebclient/js/Settings.js */ 235),
			...
			return {
				start: function () {
					aAdminPanelTabsParams.push({
						GetTabView: function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/AdminPanelWebclient/js/views/DbAdminSettingsView.js */ 244));
								});
						},
					...
					aAdminPanelTabsParams.push({
						GetTabView: function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/AdminPanelWebclient/js/views/SecurityAdminSettingsView.js */ 246));
								});
						},
					...
					aAdminPanelTabsParams.push({
						GetTabView: function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/AdminPanelWebclient/js/views/CommonSettingsPaneView.js */ 247));
								});
						},
						TabName: 'common',
					...
					aAdminPanelTabsParams.push({
						GetTabView: function(resolve) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function() {
									resolve(__webpack_require__(/*! modules/AdminPanelWebclient/js/views/AboutAdminSettingsView.js */ 248));
								});
						},
						TabName: 'about',
					...
					oScreens[Settings.HashModuleName] = function () {
						...
						return new Promise(function(resolve, reject) {
							__webpack_require__.e/* nsure */(1/*! admin-bundle */, function(require) {
									var
										oSettingsView = __webpack_require__(/*! modules/AdminPanelWebclient/js/views/SettingsView.js */ 241),
										aPromises = []
									;
				...
				getAbstractSettingsFormViewClass: function () {
					return __webpack_require__(/*! modules/AdminPanelWebclient/js/views/CAbstractSettingsFormView.js */ 236);
				},
				...
				showEntities: function (sCurrentEntityType, oEntitiesId) {
					var
						...
						Links = __webpack_require__(/*! modules/AdminPanelWebclient/js/utils/Links.js */ 237)
					;
					Routing.setHash(Links.get(sCurrentEntityType, oEntitiesId, ''));
				},
				setAddHash: function (aAddHash) {
					var SettingsView = __webpack_require__(/*! modules/AdminPanelWebclient/js/views/SettingsView.js */ 241);
				...
				registerAdminPanelEntityType: function (oEntityData) {
					...
					var EntitiesTabs = __webpack_require__(/*! modules/AdminPanelWebclient/js/EntitiesTabs.js */ 238);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var
		...
		Api = __webpack_require__(/*! modules/CoreWebclient/js/Api.js */ 182),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var
		...
		EntitiesTabs = __webpack_require__(/*! modules/AdminPanelWebclient/js/EntitiesTabs.js */ 238),
		Settings = __webpack_require__(/*! modules/AdminPanelWebclient/js/Settings.js */ 235),
			...
			this.aData.push(
				{
					...
					EditView: __webpack_require__(/*! modules/AdminPanelWebclient/js/views/EditTenantView.js */ 239),
		...
		this.aData.push(
			{
				...
				EditView: __webpack_require__(/*! modules/AdminPanelWebclient/js/views/EditUserView.js */ 240),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var
		...
		EntitiesTabs = __webpack_require__(/*! modules/AdminPanelWebclient/js/EntitiesTabs.js */ 238),
		Settings = __webpack_require__(/*! modules/AdminPanelWebclient/js/Settings.js */ 235),
		CEntitiesView = __webpack_require__(/*! modules/AdminPanelWebclient/js/views/CEntitiesView.js */ 242)
	;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var
		...
		CPageSwitcherView = __webpack_require__(/*! modules/CoreWebclient/js/views/CPageSwitcherView.js */ 243),
