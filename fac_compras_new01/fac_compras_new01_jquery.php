...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idfaccom' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_idfaccom_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_new01_idfaccom_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new01_idfaccom_onfocus(this, iSeqRow) });
  $('#id_sc_field_numfacom' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_numfacom_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_new01_numfacom_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new01_numfacom_onfocus(this, iSeqRow) });
  $('#id_sc_field_formapago' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_formapago_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_fac_compras_new01_formapago_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_fac_compras_new01_formapago_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechacom' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_fechacom_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_new01_fechacom_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new01_fechacom_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechavenc' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_fechavenc_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_fac_compras_new01_fechavenc_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_fac_compras_new01_fechavenc_onfocus(this, iSeqRow) });
  $('#id_sc_field_idprov' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_idprov_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_fac_compras_new01_idprov_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_fac_compras_new01_idprov_onfocus(this, iSeqRow) });
  $('#id_sc_field_subtotal' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_subtotal_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_new01_subtotal_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new01_subtotal_onfocus(this, iSeqRow) });
  $('#id_sc_field_valoriva' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_valoriva_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_new01_valoriva_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new01_valoriva_onfocus(this, iSeqRow) });
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_total_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_fac_compras_new01_total_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_fac_compras_new01_total_onfocus(this, iSeqRow) });
  $('#id_sc_field_pagada' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_pagada_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_fac_compras_new01_pagada_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_fac_compras_new01_pagada_onfocus(this, iSeqRow) });
  $('#id_sc_field_asentada' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_asentada_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_new01_asentada_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new01_asentada_onfocus(this, iSeqRow) });
  $('#id_sc_field_control' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_control_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_new01_control_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new01_control_onfocus(this, iSeqRow) });
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_observaciones_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_fac_compras_new01_observaciones_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_fac_compras_new01_observaciones_onfocus(this, iSeqRow) });
  $('#id_sc_field_saldo' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_saldo_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_fac_compras_new01_saldo_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_fac_compras_new01_saldo_onfocus(this, iSeqRow) });
  $('#id_sc_field_anulada' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_anulada_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_new01_anulada_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new01_anulada_onfocus(this, iSeqRow) });
  $('#id_sc_field_es_remision' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_es_remision_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_fac_compras_new01_es_remision_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_fac_compras_new01_es_remision_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_pedidocom' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_id_pedidocom_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_fac_compras_new01_id_pedidocom_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_fac_compras_new01_id_pedidocom_onfocus(this, iSeqRow) });
  $('#id_sc_field_retencion' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_retencion_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_fac_compras_new01_retencion_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_fac_compras_new01_retencion_onfocus(this, iSeqRow) });
  $('#id_sc_field_reteica' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_reteica_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_new01_reteica_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new01_reteica_onfocus(this, iSeqRow) });
  $('#id_sc_field_reteiva' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_reteiva_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_new01_reteiva_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new01_reteiva_onfocus(this, iSeqRow) });
  $('#id_sc_field_usuario' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_usuario_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_new01_usuario_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new01_usuario_onfocus(this, iSeqRow) });
  $('#id_sc_field_banco' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_banco_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_fac_compras_new01_banco_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_fac_compras_new01_banco_onfocus(this, iSeqRow) });
  $('#id_sc_field_num_ndevolucion' + iSeqRow).bind('change', function() { sc_fac_compras_new01_num_ndevolucion_onchange(this, iSeqRow) });
  $('#id_sc_field_creado' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_creado_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_fac_compras_new01_creado_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_fac_compras_new01_creado_onfocus(this, iSeqRow) });
  $('#id_sc_field_creado_hora' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_creado_hora_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_fac_compras_new01_creado_hora_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_fac_compras_new01_creado_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_editado' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_editado_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_new01_editado_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new01_editado_onfocus(this, iSeqRow) });
  $('#id_sc_field_editado_hora' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_editado_hora_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_fac_compras_new01_editado_hora_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_fac_compras_new01_editado_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_cod_cuenta' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_cod_cuenta_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_fac_compras_new01_cod_cuenta_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_fac_compras_new01_cod_cuenta_onfocus(this, iSeqRow) });
  $('#id_sc_field_prefijo_com' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_prefijo_com_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_fac_compras_new01_prefijo_com_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_fac_compras_new01_prefijo_com_onfocus(this, iSeqRow) });
  $('#id_sc_field_numero_com' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_numero_com_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_fac_compras_new01_numero_com_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_fac_compras_new01_numero_com_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_com' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_tipo_com_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_new01_tipo_com_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new01_tipo_com_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_comafec' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_id_comafec_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_fac_compras_new01_id_comafec_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_fac_compras_new01_id_comafec_onfocus(this, iSeqRow) });
  $('#id_sc_field_detalle' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_detalle_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_new01_detalle_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new01_detalle_onfocus(this, iSeqRow) });
  $('#id_sc_field_hdetalle' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_hdetalle_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_new01_hdetalle_onchange(this, iSeqRow) })
                                      .bind('click', function() { sc_fac_compras_new01_hdetalle_onclick(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new01_hdetalle_onfocus(this, iSeqRow) });
  $('#id_sc_field_prefijo_delpedido' + iSeqRow).bind('blur', function() { sc_fac_compras_new01_prefijo_delpedido_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_fac_compras_new01_prefijo_delpedido_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_fac_compras_new01_prefijo_delpedido_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_fac_compras_new01_idfaccom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_idfaccom();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_idfaccom_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_idfaccom_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_numfacom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_numfacom();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_numfacom_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_numfacom_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_formapago_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_formapago();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_formapago_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_formapago_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_fechacom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_fechacom();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_fechacom_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_fechacom_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_fechavenc_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_fechavenc();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_fechavenc_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_fechavenc_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_idprov_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_idprov();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_idprov_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_fac_compras_new01_event_idprov_onchange();
}

function sc_fac_compras_new01_idprov_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_fac_compras_new01_subtotal_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_subtotal();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_subtotal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_subtotal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_valoriva_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_valoriva();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_valoriva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_valoriva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_total_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_total();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_total_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_pagada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_pagada();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_pagada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_pagada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_asentada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_asentada();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_asentada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_fac_compras_new01_event_asentada_onchange();
}

function sc_fac_compras_new01_asentada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_control_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_control();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_control_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_control_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_observaciones();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_observaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_observaciones_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_saldo_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_saldo();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_saldo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_saldo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_anulada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_anulada();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_anulada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_anulada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_es_remision_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_es_remision();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_es_remision_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_es_remision_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_id_pedidocom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_id_pedidocom();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_id_pedidocom_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_fac_compras_new01_event_id_pedidocom_onchange();
}

function sc_fac_compras_new01_id_pedidocom_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_retencion_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_retencion();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_retencion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_retencion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_reteica_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_reteica();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_reteica_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_reteica_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_reteiva_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_reteiva();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_reteiva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_reteiva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_usuario_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_usuario();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_usuario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_usuario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_banco_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_banco();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_banco_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_banco_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_num_ndevolucion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_creado_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_creado();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_creado_hora_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_creado();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_creado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_creado_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_creado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_creado_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_editado_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_editado();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_editado_hora_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_editado();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_editado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_editado_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_editado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_editado_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_cod_cuenta_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_cod_cuenta();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_cod_cuenta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_cod_cuenta_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_prefijo_com_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_prefijo_com();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_prefijo_com_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_prefijo_com_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_numero_com_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_numero_com();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_numero_com_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_numero_com_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_tipo_com_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_tipo_com();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_tipo_com_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_fac_compras_new01_event_tipo_com_onchange();
}

function sc_fac_compras_new01_tipo_com_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_id_comafec_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_id_comafec();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_id_comafec_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_id_comafec_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_detalle_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_detalle();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_detalle_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_detalle_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new01_hdetalle_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_hdetalle();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_hdetalle_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_hdetalle_onclick(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_event_hdetalle_onclick();
}

function sc_fac_compras_new01_hdetalle_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
  do_ajax_fac_compras_new01_event_hdetalle_onfocus();
}

function sc_fac_compras_new01_prefijo_delpedido_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new01_validate_prefijo_delpedido();
  scCssBlur(oThis);
}

function sc_fac_compras_new01_prefijo_delpedido_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_new01_prefijo_delpedido_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_fac_compras_new01_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechacom" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_new01_validate_fechacom(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_new01_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_new01_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_editado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_new01_validate_editado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'fac_compras_new01')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
