...
?>
  ...
  function do_ajax_terceros_validate_direcciones()
  {
    var nomeCampo_direcciones = "direcciones";
    var var_direcciones = scAjaxGetFieldText(nomeCampo_direcciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_validate_direcciones(var_direcciones, var_script_case_init, do_ajax_terceros_validate_direcciones_cb);
  } // do_ajax_terceros_validate_direcciones

  function do_ajax_terceros_validate_direcciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_validate_direcciones_cb
