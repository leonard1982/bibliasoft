...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>terceros/terceros_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("terceros_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['last'] : 'off'); ?>";
...
function navpage_atualiza(str_navpage)
{
 ...
 function nm_field_disabled(Fields, Opt) {
  ...
  for (i=0; i < Field.length; i++)
  {
     ...
     if (F_name == "cliente")
     {
        $('input[name="cliente[]"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="cliente[]"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="cliente[]"]').removeClass("scFormInputDisabled");
        }
     }
     if (F_name == "dias")
     {
...
include_once('terceros_mob_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-puc_auxiliar_deudores", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "puc_auxiliar_deudores" != sId ? sId.substr(21) : "";
   sc_terceros_mob_puc_auxiliar_deudores_onfocus("id_sc_field_" + sId, sRow);
  ...
  $(".sc-ui-autocomp-puc_retefuente_ventas", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "puc_retefuente_ventas" != sId ? sId.substr(21) : "";
   sc_terceros_mob_puc_retefuente_ventas_onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
  ...
  $(".sc-ui-autocomp-puc_retefuente_servicios_clie", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "puc_retefuente_servicios_clie" != sId ? sId.substr(29) : "";
   sc_terceros_mob_puc_retefuente_servicios_clie_onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
  ...
  $(".sc-ui-autocomp-puc_auxiliar_proveedores", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "puc_auxiliar_proveedores" != sId ? sId.substr(24) : "";
   sc_terceros_mob_puc_auxiliar_proveedores_onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
  ...
  $(".sc-ui-autocomp-puc_retefuente_compras", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "puc_retefuente_compras" != sId ? sId.substr(22) : "";
   sc_terceros_mob_puc_retefuente_compras_onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
  ...
  $(".sc-ui-autocomp-puc_retefuente_servicios_prov", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "puc_retefuente_servicios_prov" != sId ? sId.substr(29) : "";
   sc_terceros_mob_puc_retefuente_servicios_prov_onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
...
{
    echo $_SESSION['scriptcase']['terceros']['error_buffer'];
}
...
<?php
 include_once("terceros_mob_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['insert_validation']; ?>">
<?php
}
?>
...
$_SESSION['scriptcase']['error_icon_title']['terceros_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['copy']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['copy']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['copy']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['copy']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['copy'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['empty_filter'] = true;
       }
  }
?>
<script type="text/javascript">
var pag_ativa = "terceros_mob_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'terceros_mob_form0' => array(
            'title' => "Datos Generales",
            'class' => $nmgp_num_form == "terceros_mob_form0" ? "scTabActive" : "scTabInactive",
        ),
        'terceros_mob_form1' => array(
            'title' => "Clientes",
            'class' => $nmgp_num_form == "terceros_mob_form1" ? "scTabActive" : "scTabInactive",
        ),
        'terceros_mob_form2' => array(
            'title' => "Empleados",
            'class' => $nmgp_num_form == "terceros_mob_form2" ? "scTabActive" : "scTabInactive",
        ),
        'terceros_mob_form3' => array(
            'title' => "Proveedores",
            'class' => $nmgp_num_form == "terceros_mob_form3" ? "scTabActive" : "scTabInactive",
        ),
        'terceros_mob_form4' => array(
            'title' => "Otros",
            'class' => $nmgp_num_form == "terceros_mob_form4" ? "scTabActive" : "scTabInactive",
        ),
        'terceros_mob_form5' => array(
            'title' => "Archivos",
            'class' => $nmgp_num_form == "terceros_mob_form5" ? "scTabActive" : "scTabInactive",
        ),
        'terceros_mob_form6' => array(
            'title' => "Restaurante",
            'class' => $nmgp_num_form == "terceros_mob_form6" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('Datos Generales' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['terceros_mob_form0']['class'] = 'scTabInactive';
                        }
                        if ('Clientes' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['terceros_mob_form1']['class'] = 'scTabInactive';
                        }
                        if ('Empleados' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['terceros_mob_form2']['class'] = 'scTabInactive';
                        }
                        if ('Proveedores' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['terceros_mob_form3']['class'] = 'scTabInactive';
                        }
                        if ('Otros' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['terceros_mob_form4']['class'] = 'scTabInactive';
                        }
                        if ('Archivos' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['terceros_mob_form5']['class'] = 'scTabInactive';
                        }
                        if ('Restaurante' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['terceros_mob_form6']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["terceros_mob_form0"]['class'];
?>
   <li id="id_terceros_mob_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('terceros_mob_form0')">
     <img src="<?php echo $this->Ini->path_icones ?>/usr__NM__bg__NM__contactlist_theuser_802.png" align="absmiddle">
     Datos Generales
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["terceros_mob_form1"]['class'];
?>
   <li id="id_terceros_mob_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('terceros_mob_form1')">
     <img src="<?php echo $this->Ini->path_icones ?>/usr__NM__ico__NM__person_pauseforcoffee_coffee_man_people_1613.png" align="absmiddle">
     Clientes
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["terceros_mob_form2"]['class'];
?>
   <li id="id_terceros_mob_form2" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('terceros_mob_form2')">
...
<?php
    $css_celula = $this->tabCssClass["terceros_mob_form3"]['class'];
?>
   <li id="id_terceros_mob_form3" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('terceros_mob_form3')">
     <img src="<?php echo $this->Ini->path_icones ?>/usr__NM__ico__NM__1488492687-people01_81720.png" align="absmiddle">
     Proveedores
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["terceros_mob_form4"]['class'];
?>
   <li id="id_terceros_mob_form4" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('terceros_mob_form4')">
     <img src="<?php echo $this->Ini->path_icones ?>/scriptcase__NM__ico__NM__about_32.png" align="absmiddle">
     Otros
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["terceros_mob_form5"]['class'];
?>
   <li id="id_terceros_mob_form5" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('terceros_mob_form5')">
     <img src="<?php echo $this->Ini->path_icones ?>/scriptcase__NM__ico__NM__document_attachment_32.png" align="absmiddle">
     Archivos
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["terceros_mob_form6"]['class'];
?>
   <li id="id_terceros_mob_form6" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('terceros_mob_form6')">
...
<div id="terceros_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_tipo'][] = ''; ?>
 <option value=""></option>
 <option  value="NAT" <?php  if ($this->tipo == "NAT") { echo " selected" ;} ?>>NATURAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_tipo'][] = 'NAT'; ?>
 <option  value="JUR" <?php  if ($this->tipo == "JUR") { echo " selected" ;} ?>>JURÍDICA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_tipo'][] = 'JUR'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_regimen'][] = ''; ?>
 <option value="">SELECCIONE</option>
 <option  value="SIM" <?php  if ($this->regimen == "SIM") { echo " selected" ;} ?>>NO RESPONSABLE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_regimen'][] = 'SIM'; ?>
 <option  value="COMUN" <?php  if ($this->regimen == "COMUN") { echo " selected" ;} ?>>RESPONSABLE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_regimen'][] = 'COMUN'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_tipo_documento'][] = '11'; ?>
 <option  value="12" <?php  if ($this->tipo_documento == "12") { echo " selected" ;} ?>>Tarjeta de identidad</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_tipo_documento'][] = '12'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_tipo_documento'][] = '13'; ?>
 <option  value="21" <?php  if ($this->tipo_documento == "21") { echo " selected" ;} ?>>Tarjeta de Extranjería</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_tipo_documento'][] = '21'; ?>
 <option  value="22" <?php  if ($this->tipo_documento == "22") { echo " selected" ;} ?>>Cédula de extranjería</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_tipo_documento'][] = '22'; ?>
 <option  value="31" <?php  if ($this->tipo_documento == "31") { echo " selected" ;} ?>>Nit</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_tipo_documento'][] = '31'; ?>
 <option  value="41" <?php  if ($this->tipo_documento == "41") { echo " selected" ;} ?>>Pasaporte</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_tipo_documento'][] = '41'; ?>
 <option  value="42" <?php  if ($this->tipo_documento == "42") { echo " selected" ;} ?>>Tipo de documento extranjero</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_tipo_documento'][] = '42'; ?>
 <option  value="43" <?php  if ($this->tipo_documento == "43") { echo " selected" ;} ?>>Definido por la DIAN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_tipo_documento'][] = '43'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_sexo'][] = ''; ?>
 <option value=""></option>
 <option  value="M" <?php  if ($this->sexo == "M") { echo " selected" ;} ?>>Masculino</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_sexo'][] = 'M'; ?>
 <option  value="F" <?php  if ($this->sexo == "F") { echo " selected" ;} ?>>Femenino</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_sexo'][] = 'F'; ?>
 <option  value="O" <?php  if ($this->sexo == "O") { echo " selected" ;} ?>>Otro</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_sexo'][] = 'O'; ?>
 </select></span>
</span><?php  }?>
...
<?php 
  ...
  {
      $this->notificar_1 = explode(";", trim($this->notificar));
  } 
  else
  {
      if (empty($this->notificar))
      {
          $this->notificar_1= array(); 
          $this->notificar= "NO";
      } 
      else
      {
          $this->notificar_1= $this->notificar; 
          $this->notificar= ""; 
          foreach ($this->notificar_1 as $cada_notificar)
          {
             if (!empty($notificar))
             {
                 $this->notificar.= ";"; 
             } 
             $this->notificar.= $cada_notificar; 
          } 
      } 
  } 
?> 
...
$notificar_look = "";
 ...
 if (empty($notificar_look)) { $notificar_look = $this->notificar; }
?>
<span id="id_read_on_notificar" class="css_notificar_line" style="<?php echo $sStyleReadLab_notificar; ?>"><?php echo $this->form_format_readonly("notificar", $this->form_encode_input($notificar_look)); ?></span><span id="id_read_off_notificar" class="css_read_off_notificar css_notificar_line" style="<?php echo $sStyleReadInp_notificar; ?>"><?php echo "<div id=\"idAjaxCheckbox_notificar\" style=\"display: inline-block\" class=\"css_notificar_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_notificar_line"><?php $tempOptionId = "id-opt-notificar" . $sc_seq_vert . "-1"; ?>
 <div class="sc switch">
 <input type=checkbox id="<?php echo $tempOptionId ?>" class="sc-ui-checkbox-notificar sc-ui-checkbox-notificar sc-js-input" name="notificar[]" value="SI"
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_notificar'][] = 'SI'; ?>
<?php  if (in_array("SI", $this->notificar_1))  { echo " checked" ;} ?><?php  if (empty($this->notificar)) { echo " checked" ;} ?> onClick="" ><span></span>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_idtercero_line" id="hidden_field_data_idtercero" style="<?php echo $sStyleHidden_idtercero; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idtercero_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idtercero_label" style=""><span id="id_label_idtercero"><?php echo $this->nm_new_label['idtercero']; ?></span></span><br><span id="id_read_on_idtercero" class="css_idtercero_line" style="<?php echo $sStyleReadLab_idtercero; ?>"><?php echo $this->form_format_readonly("idtercero", $this->form_encode_input($this->idtercero)); ?></span><span id="id_read_off_idtercero" class="css_read_off_idtercero" style="<?php echo $sStyleReadInp_idtercero; ?>"><input type="hidden" name="idtercero" value="<?php echo $this->form_encode_input($idtercero) . "\">"?><span id="id_ajax_label_idtercero"><?php echo nl2br($idtercero); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_idtercero_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_idtercero_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }
      else
      {
         $sc_hidden_no--;
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_departamento']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_departamento'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_departamento']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_departamento'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_departamento'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_idmuni']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_idmuni'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_idmuni']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_idmuni'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_idmuni'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_ciudad']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_ciudad'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_ciudad']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_ciudad'] = array(); 
}
if ($this->idmuni != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_ciudad'][] = $rs->fields[0];
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_codigo_postal']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_codigo_postal'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_codigo_postal']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_codigo_postal'] = array(); 
}
if ($this->idmuni != "")
{ 
   $this->nm_clear_val("idmuni");
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_codigo_postal'][] = $rs->fields[0];
              $nmgp_def_dados .= $rs->fields[0] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $rs->MoveNext() ; 
       } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_lenguaje']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_lenguaje'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_lenguaje']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_lenguaje'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_lenguaje'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_lenguaje'][] = ''; 
...
<TABLE align="center" id="hidden_bloco_5" class="scFormTable<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont">DATOS DE NOTIFICACIÓN</TD>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['correo_notificafe']))
    {
        $this->nm_new_label['correo_notificafe'] = "Correo Notificación";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $correo_notificafe = $this->correo_notificafe;
   $sStyleHidden_correo_notificafe = '';
   if (isset($this->nmgp_cmp_hidden['correo_notificafe']) && $this->nmgp_cmp_hidden['correo_notificafe'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['correo_notificafe']);
       $sStyleHidden_correo_notificafe = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_correo_notificafe = 'display: none;';
   $sStyleReadInp_correo_notificafe = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['correo_notificafe']) && $this->nmgp_cmp_readonly['correo_notificafe'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['correo_notificafe']);
       $sStyleReadLab_correo_notificafe = '';
       $sStyleReadInp_correo_notificafe = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['correo_notificafe']) && $this->nmgp_cmp_hidden['correo_notificafe'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="correo_notificafe" value="<?php echo $this->form_encode_input($correo_notificafe) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_correo_notificafe_line" id="hidden_field_data_correo_notificafe" style="<?php echo $sStyleHidden_correo_notificafe; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_correo_notificafe_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_correo_notificafe_label" style=""><span id="id_label_correo_notificafe"><?php echo $this->nm_new_label['correo_notificafe']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["correo_notificafe"]) &&  $this->nmgp_cmp_readonly["correo_notificafe"] == "on") { 

 ?>
<input type="hidden" name="correo_notificafe" value="<?php echo $this->form_encode_input($correo_notificafe) . "\">" . $correo_notificafe . ""; ?>
<?php } else { ?>
<span id="id_read_on_correo_notificafe" class="sc-ui-readonly-correo_notificafe css_correo_notificafe_line" style="<?php echo $sStyleReadLab_correo_notificafe; ?>"><?php echo $this->form_format_readonly("correo_notificafe", $this->form_encode_input($this->correo_notificafe)); ?></span><span id="id_read_off_correo_notificafe" class="css_read_off_correo_notificafe<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_correo_notificafe; ?>">
 <input class="sc-js-input scFormObjectOdd css_correo_notificafe_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_correo_notificafe" type=text name="correo_notificafe" value="<?php echo $this->form_encode_input($correo_notificafe) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=50"; } ?> maxlength=120 alt="{enterTab: true, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" >&nbsp;<?php if ($this->nmgp_opcao != "novo"){ ?><?php echo nmButtonOutput($this->arr_buttons, "bemail", "if (document.F1.correo_notificafe.value != '') {window.open('mailto:' + document.F1.correo_notificafe.value); }", "if (document.F1.correo_notificafe.value != '') {window.open('mailto:' + document.F1.correo_notificafe.value); }", "correo_notificafe_mail", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php } ?>
</span><?php } ?>
<span style="display: inline-block"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "nm_mostra_mens('correo_notificafe')", "nm_mostra_mens('correo_notificafe')", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_correo_notificafe_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_correo_notificafe_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['celular_notificafe']))
    {
        $this->nm_new_label['celular_notificafe'] = "Celular Notificación";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $celular_notificafe = $this->celular_notificafe;
   $sStyleHidden_celular_notificafe = '';
   if (isset($this->nmgp_cmp_hidden['celular_notificafe']) && $this->nmgp_cmp_hidden['celular_notificafe'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['celular_notificafe']);
       $sStyleHidden_celular_notificafe = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_celular_notificafe = 'display: none;';
   $sStyleReadInp_celular_notificafe = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['celular_notificafe']) && $this->nmgp_cmp_readonly['celular_notificafe'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['celular_notificafe']);
       $sStyleReadLab_celular_notificafe = '';
       $sStyleReadInp_celular_notificafe = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['celular_notificafe']) && $this->nmgp_cmp_hidden['celular_notificafe'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="celular_notificafe" value="<?php echo $this->form_encode_input($celular_notificafe) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_celular_notificafe_line" id="hidden_field_data_celular_notificafe" style="<?php echo $sStyleHidden_celular_notificafe; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_celular_notificafe_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_celular_notificafe_label" style=""><span id="id_label_celular_notificafe"><?php echo $this->nm_new_label['celular_notificafe']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["celular_notificafe"]) &&  $this->nmgp_cmp_readonly["celular_notificafe"] == "on") { 

 ?>
<input type="hidden" name="celular_notificafe" value="<?php echo $this->form_encode_input($celular_notificafe) . "\">" . $celular_notificafe . ""; ?>
<?php } else { ?>
<span id="id_read_on_celular_notificafe" class="sc-ui-readonly-celular_notificafe css_celular_notificafe_line" style="<?php echo $sStyleReadLab_celular_notificafe; ?>"><?php echo $this->form_format_readonly("celular_notificafe", $this->form_encode_input($this->celular_notificafe)); ?></span><span id="id_read_off_celular_notificafe" class="css_read_off_celular_notificafe<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_celular_notificafe; ?>">
 <input class="sc-js-input scFormObjectOdd css_celular_notificafe_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_celular_notificafe" type=text name="celular_notificafe" value="<?php echo $this->form_encode_input($celular_notificafe) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=12"; } ?> maxlength=21 alt="{datatype: 'mask', maxLength: 10, allowedChars: '<?php echo $this->allowedCharsCharset("0123456789-") ?>', lettersCase: '', maskList: '999-9999999', enterTab: true, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
<span style="display: inline-block"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "nm_mostra_mens('celular_notificafe')", "nm_mostra_mens('celular_notificafe')", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_celular_notificafe_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_celular_notificafe_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $sStyleHidden_celular_notificafe_dumb = ('' == $sStyleHidden_celular_notificafe) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_celular_notificafe_dumb" style="<?php echo $sStyleHidden_celular_notificafe_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php 
  if ($this->nmgp_opcao != "recarga") 
  {
      $this->cliente_1 = explode(";", trim($this->cliente));
  } 
  else
  {
      if (empty($this->cliente))
      {
          $this->cliente_1= array(); 
          $this->cliente= "NO";
      } 
      else
      {
          $this->cliente_1= $this->cliente; 
          $this->cliente= ""; 
          foreach ($this->cliente_1 as $cada_cliente)
          {
             if (!empty($cliente))
             {
                 $this->cliente.= ";"; 
             } 
             $this->cliente.= $cada_cliente; 
          } 
      } 
  } 
?> 
...
$cliente_look = "";
 ...
 if (empty($cliente_look)) { $cliente_look = $this->cliente; }
?>
<span id="id_read_on_cliente" class="css_cliente_line" style="<?php echo $sStyleReadLab_cliente; ?>"><?php echo $this->form_format_readonly("cliente", $this->form_encode_input($cliente_look)); ?></span><span id="id_read_off_cliente" class="css_read_off_cliente css_cliente_line" style="<?php echo $sStyleReadInp_cliente; ?>"><?php echo "<div id=\"idAjaxCheckbox_cliente\" style=\"display: inline-block\" class=\"css_cliente_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_cliente_line"><?php $tempOptionId = "id-opt-cliente" . $sc_seq_vert . "-1"; ?>
 <div class="sc switch">
 <input type=checkbox id="<?php echo $tempOptionId ?>" class="sc-ui-checkbox-cliente sc-ui-checkbox-cliente sc-js-input" name="cliente[]" value="SI"
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_cliente'][] = 'SI'; ?>
<?php  if (in_array("SI", $this->cliente_1))  { echo " checked" ;} ?><?php  if (empty($this->cliente)) { echo " checked" ;} ?> onClick="" ><span></span>
<label for="<?php echo $tempOptionId ?>">SI</label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php 
  if ($this->nmgp_opcao != "recarga") 
  {
      $this->proveedor_1 = explode(";", trim($this->proveedor));
  } 
  else
  {
      if (empty($this->proveedor))
      {
          $this->proveedor_1= array(); 
          $this->proveedor= "NO";
      } 
      else
      {
          $this->proveedor_1= $this->proveedor; 
          $this->proveedor= ""; 
          foreach ($this->proveedor_1 as $cada_proveedor)
          {
             if (!empty($proveedor))
             {
                 $this->proveedor.= ";"; 
             } 
             $this->proveedor.= $cada_proveedor; 
          } 
      } 
  } 
?> 
...
$proveedor_look = "";
 ...
 if (empty($proveedor_look)) { $proveedor_look = $this->proveedor; }
?>
<span id="id_read_on_proveedor" class="css_proveedor_line" style="<?php echo $sStyleReadLab_proveedor; ?>"><?php echo $this->form_format_readonly("proveedor", $this->form_encode_input($proveedor_look)); ?></span><span id="id_read_off_proveedor" class="css_read_off_proveedor css_proveedor_line" style="<?php echo $sStyleReadInp_proveedor; ?>"><?php echo "<div id=\"idAjaxCheckbox_proveedor\" style=\"display: inline-block\" class=\"css_proveedor_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_proveedor_line"><?php $tempOptionId = "id-opt-proveedor" . $sc_seq_vert . "-1"; ?>
 <div class="sc switch">
 <input type=checkbox id="<?php echo $tempOptionId ?>" class="sc-ui-checkbox-proveedor sc-ui-checkbox-proveedor sc-js-input" name="proveedor[]" value="SI"
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_proveedor'][] = 'SI'; ?>
<?php  if (in_array("SI", $this->proveedor_1))  { echo " checked" ;} ?> onClick="" ><span></span>
<label for="<?php echo $tempOptionId ?>">SI</label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php 
  if ($this->nmgp_opcao != "recarga") 
  {
      $this->empleado_1 = explode(";", trim($this->empleado));
  } 
  else
  {
      if (empty($this->empleado))
      {
          $this->empleado_1= array(); 
          $this->empleado= "NO";
      } 
      else
      {
          $this->empleado_1= $this->empleado; 
          $this->empleado= ""; 
          foreach ($this->empleado_1 as $cada_empleado)
          {
             if (!empty($empleado))
             {
                 $this->empleado.= ";"; 
             } 
             $this->empleado.= $cada_empleado; 
          } 
      } 
  } 
?> 
...
$empleado_look = "";
 ...
 if (empty($empleado_look)) { $empleado_look = $this->empleado; }
?>
<span id="id_read_on_empleado" class="css_empleado_line" style="<?php echo $sStyleReadLab_empleado; ?>"><?php echo $this->form_format_readonly("empleado", $this->form_encode_input($empleado_look)); ?></span><span id="id_read_off_empleado" class="css_read_off_empleado css_empleado_line" style="<?php echo $sStyleReadInp_empleado; ?>"><?php echo "<div id=\"idAjaxCheckbox_empleado\" style=\"display: inline-block\" class=\"css_empleado_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_empleado_line"><?php $tempOptionId = "id-opt-empleado" . $sc_seq_vert . "-1"; ?>
 <div class="sc switch">
 <input type=checkbox id="<?php echo $tempOptionId ?>" class="sc-ui-checkbox-empleado sc-ui-checkbox-empleado sc-js-input" name="empleado[]" value="SI"
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_empleado'][] = 'SI'; ?>
<?php  if (in_array("SI", $this->empleado_1))  { echo " checked" ;} ?> onClick="" ><span></span>
<label for="<?php echo $tempOptionId ?>">SI</label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php 
  if ($this->nmgp_opcao != "recarga") 
  {
      $this->es_tecnico_1 = explode(";", trim($this->es_tecnico));
  } 
  else
  {
      if (empty($this->es_tecnico))
      {
          $this->es_tecnico_1= array(); 
          $this->es_tecnico= "NO";
      } 
      else
      {
          $this->es_tecnico_1= $this->es_tecnico; 
          $this->es_tecnico= ""; 
          foreach ($this->es_tecnico_1 as $cada_es_tecnico)
          {
             if (!empty($es_tecnico))
             {
                 $this->es_tecnico.= ";"; 
             } 
             $this->es_tecnico.= $cada_es_tecnico; 
          } 
      } 
  } 
?> 
...
$es_tecnico_look = "";
 ...
 if (empty($es_tecnico_look)) { $es_tecnico_look = $this->es_tecnico; }
?>
<span id="id_read_on_es_tecnico" class="css_es_tecnico_line" style="<?php echo $sStyleReadLab_es_tecnico; ?>"><?php echo $this->form_format_readonly("es_tecnico", $this->form_encode_input($es_tecnico_look)); ?></span><span id="id_read_off_es_tecnico" class="css_read_off_es_tecnico css_es_tecnico_line" style="<?php echo $sStyleReadInp_es_tecnico; ?>"><?php echo "<div id=\"idAjaxCheckbox_es_tecnico\" style=\"display: inline-block\" class=\"css_es_tecnico_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_es_tecnico_line"><?php $tempOptionId = "id-opt-es_tecnico" . $sc_seq_vert . "-1"; ?>
 <div class="sc switch">
 <input type=checkbox id="<?php echo $tempOptionId ?>" class="sc-ui-checkbox-es_tecnico sc-ui-checkbox-es_tecnico sc-js-input" name="es_tecnico[]" value="SI"
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_es_tecnico'][] = 'SI'; ?>
<?php  if (in_array("SI", $this->es_tecnico_1))  { echo " checked" ;} ?> onClick="" ><span></span>
<label for="<?php echo $tempOptionId ?>">SI</label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<span id="id_read_on_activo" class="css_activo_line" style="<?php echo $sStyleReadLab_activo; ?>"><?php echo $this->form_format_readonly("activo", $this->form_encode_input($activo_look)); ?></span><span id="id_read_off_activo" class="css_read_off_activo css_activo_line" style="<?php echo $sStyleReadInp_activo; ?>"><?php echo "<div id=\"idAjaxCheckbox_activo\" style=\"display: inline-block\" class=\"css_activo_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 <div class="sc switch">
 <input type=checkbox id="<?php echo $tempOptionId ?>" class="sc-ui-checkbox-activo sc-ui-checkbox-activo sc-js-input" name="activo[]" value="SI"
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_mob']['Lookup_activo'][] = 'SI'; ?>
<?php  if (in_array("SI", $this->activo_1))  { echo " checked" ;} ?><?php  if (empty($this->activo)) { echo " checked" ;} ?> onClick="" ><span></span>
<label for="<?php echo $tempOptionId ?>">SI</label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
