...
?>
<?php $sStyleHidden_saldoapagar_dumb = ('' == $sStyleHidden_saldoapagar) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_saldoapagar_dumb" style="<?php echo $sStyleHidden_saldoapagar_dumb; ?>"></TD>
...
<?php $sStyleHidden_codigo_ter_dumb = ('' == $sStyleHidden_codigo_ter) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_codigo_ter_dumb" style="<?php echo $sStyleHidden_codigo_ter_dumb; ?>"></TD>
<?php $sStyleHidden_zona_clientes_dumb = ('' == $sStyleHidden_zona_clientes) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_zona_clientes_dumb" style="<?php echo $sStyleHidden_zona_clientes_dumb; ?>"></TD>
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_puc_auxiliar_deudores'][] = ''; 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_cliente']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_cliente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_cliente']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_cliente'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_cliente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_cliente'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;"," ") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "SC_glo_par_gidcta*scingIdcta1*scoutnm_evt_ret_edit*scindo_ajax_terceros_lkpedt_refresh_id_pucaux_cliente*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@terceros@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "SC_glo_par_gidcta*scingIdcta1*scoutnm_evt_ret_edit*scindo_ajax_terceros_lkpedt_refresh_id_pucaux_cliente*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php $sStyleHidden_id_pucaux_cliente_dumb = ('' == $sStyleHidden_id_pucaux_cliente) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_id_pucaux_cliente_dumb" style="<?php echo $sStyleHidden_id_pucaux_cliente_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_puc_retefuente_ventas'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;"," ") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_retteventas']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_retteventas'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_retteventas']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_retteventas'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_retteventas'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_retteventas'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;"," ") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   echo "\r" ; 
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "SC_glo_par_gidcta*scingIdcta2*scoutnm_evt_ret_edit*scindo_ajax_terceros_lkpedt_refresh_id_pucaux_retteventas*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@terceros@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "SC_glo_par_gidcta*scingIdcta2*scoutnm_evt_ret_edit*scindo_ajax_terceros_lkpedt_refresh_id_pucaux_retteventas*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php $sStyleHidden_id_pucaux_retteventas_dumb = ('' == $sStyleHidden_id_pucaux_retteventas) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_id_pucaux_retteventas_dumb" style="<?php echo $sStyleHidden_id_pucaux_retteventas_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_puc_retefuente_servicios_clie'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;"," ") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_retteservicios']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_retteservicios'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_retteservicios']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_retteservicios'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_retteservicios'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_retteservicios'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;"," ") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   echo "\r" ; 
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "SC_glo_par_gidcta*scingIdcta3*scoutnm_evt_ret_edit*scindo_ajax_terceros_lkpedt_refresh_id_pucaux_retteservicios*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@terceros@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "SC_glo_par_gidcta*scingIdcta3*scoutnm_evt_ret_edit*scindo_ajax_terceros_lkpedt_refresh_id_pucaux_retteservicios*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php $sStyleHidden_id_pucaux_retteservicios_dumb = ('' == $sStyleHidden_id_pucaux_retteservicios) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_id_pucaux_retteservicios_dumb" style="<?php echo $sStyleHidden_id_pucaux_retteservicios_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_puc_auxiliar_proveedores'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;"," ") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_proveedor']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_proveedor'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_proveedor']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_proveedor'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_proveedor'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_proveedor'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;"," ") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   echo "\r" ; 
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "SC_glo_par_gidcta*scingIdcta4*scoutnm_evt_ret_edit*scindo_ajax_terceros_lkpedt_refresh_id_pucaux_proveedor*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@terceros@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "SC_glo_par_gidcta*scingIdcta4*scoutnm_evt_ret_edit*scindo_ajax_terceros_lkpedt_refresh_id_pucaux_proveedor*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php $sStyleHidden_id_pucaux_proveedor_dumb = ('' == $sStyleHidden_id_pucaux_proveedor) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_id_pucaux_proveedor_dumb" style="<?php echo $sStyleHidden_id_pucaux_proveedor_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_puc_retefuente_compras'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;"," ") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_rettecompras']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_rettecompras'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_rettecompras']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_rettecompras'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_rettecompras'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_rettecompras'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;"," ") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   echo "\r" ; 
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "SC_glo_par_gidcta*scingIdcta5*scoutnm_evt_ret_edit*scindo_ajax_terceros_lkpedt_refresh_id_pucaux_rettecompras*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@terceros@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "SC_glo_par_gidcta*scingIdcta5*scoutnm_evt_ret_edit*scindo_ajax_terceros_lkpedt_refresh_id_pucaux_rettecompras*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php $sStyleHidden_id_pucaux_rettecompras_dumb = ('' == $sStyleHidden_id_pucaux_rettecompras) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_id_pucaux_rettecompras_dumb" style="<?php echo $sStyleHidden_id_pucaux_rettecompras_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_puc_retefuente_servicios_prov'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;"," ") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_rettesercomp']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_rettesercomp'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_rettesercomp']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_rettesercomp'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_rettesercomp'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_pucaux_rettesercomp'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;"," ") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   echo "\r" ; 
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "SC_glo_par_gidcta*scingIdcta6*scoutnm_evt_ret_edit*scindo_ajax_terceros_lkpedt_refresh_id_pucaux_rettesercomp*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@terceros@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "SC_glo_par_gidcta*scingIdcta6*scoutnm_evt_ret_edit*scindo_ajax_terceros_lkpedt_refresh_id_pucaux_rettesercomp*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
?> 
<img id="archivo_rut_img_uploading" style="display: none" border="0" src="<?php echo $this->Ini->path_icones; ?>/scriptcase__NM__ajax_load.gif" align="absmiddle" /><span id="id_ajax_doc_archivo_rut"><a href="javascript:nm_mostra_doc('2', '<?php echo str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_archivo_rut, 3)); ?>', 'terceros')"><?php echo $archivo_rut ?></a></span><div id="id_img_loader_archivo_rut" class="progress progress-success progress-striped active scProgressBarStart" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" style="display: none"><div class="bar scProgressBarLoading">&nbsp;</div></div><img id="id_ajax_loader_archivo_rut" src="<?php echo $this->Ini->path_icones ?>/scriptcase__NM__ajax_load.gif" style="display: none" /></span><?php } ?>
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["archivo_nit"]) &&  $this->nmgp_cmp_readonly["archivo_nit"] == "on") { 
 ...
 ?>
<input type="hidden" name="archivo_nit" value="<?php echo $this->form_encode_input($archivo_nit) . "\"><img id=\"archivo_nit_img_uploading\" style=\"display: none\" border=\"0\" src=\"" . $this->Ini->path_icones . "/scriptcase__NM__ajax_load.gif\" align=\"absmiddle\" /><span id=\"id_ajax_doc_archivo_nit\"><a href=\"javascript:nm_mostra_doc('3', '" . str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_archivo_nit, 3)) . "', 'terceros')\">" . $archivo_nit . "</a></span>"; ?>
<?php } else { ?>
...
?> 
<img id="archivo_nit_img_uploading" style="display: none" border="0" src="<?php echo $this->Ini->path_icones; ?>/scriptcase__NM__ajax_load.gif" align="absmiddle" /><span id="id_ajax_doc_archivo_nit"><a href="javascript:nm_mostra_doc('3', '<?php echo str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_archivo_nit, 3)); ?>', 'terceros')"><?php echo $archivo_nit ?></a></span><div id="id_img_loader_archivo_nit" class="progress progress-success progress-striped active scProgressBarStart" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" style="display: none"><div class="bar scProgressBarLoading">&nbsp;</div></div><img id="id_ajax_loader_archivo_nit" src="<?php echo $this->Ini->path_icones ?>/scriptcase__NM__ajax_load.gif" style="display: none" /></span><?php } ?>
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["archivo_pago"]) &&  $this->nmgp_cmp_readonly["archivo_pago"] == "on") { 
 ...
 ?>
<input type="hidden" name="archivo_pago" value="<?php echo $this->form_encode_input($archivo_pago) . "\"><img id=\"archivo_pago_img_uploading\" style=\"display: none\" border=\"0\" src=\"" . $this->Ini->path_icones . "/scriptcase__NM__ajax_load.gif\" align=\"absmiddle\" /><span id=\"id_ajax_doc_archivo_pago\"><a href=\"javascript:nm_mostra_doc('4', '" . str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_archivo_pago, 3)) . "', 'terceros')\">" . $archivo_pago . "</a></span>"; ?>
<?php } else { ?>
...
?> 
<img id="archivo_pago_img_uploading" style="display: none" border="0" src="<?php echo $this->Ini->path_icones; ?>/scriptcase__NM__ajax_load.gif" align="absmiddle" /><span id="id_ajax_doc_archivo_pago"><a href="javascript:nm_mostra_doc('4', '<?php echo str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_archivo_pago, 3)); ?>', 'terceros')"><?php echo $archivo_pago ?></a></span><div id="id_img_loader_archivo_pago" class="progress progress-success progress-striped active scProgressBarStart" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" style="display: none"><div class="bar scProgressBarLoading">&nbsp;</div></div><img id="id_ajax_loader_archivo_pago" src="<?php echo $this->Ini->path_icones ?>/scriptcase__NM__ajax_load.gif" style="display: none" /></span><?php } ?>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_plan']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_plan'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_plan']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_plan'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_plan'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_id_plan'][] = ''; 
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_estado'][] = ''; ?>
 <option value="">SIN ESTADO</option>
 <option  value="PENDIENTE" <?php  if ($this->estado == "PENDIENTE") { echo " selected" ;} ?>>PENDIENTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_estado'][] = 'PENDIENTE'; ?>
 <option  value="ASIGNADO" <?php  if ($this->estado == "ASIGNADO") { echo " selected" ;} ?>>ASIGNADO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_estado'][] = 'ASIGNADO'; ?>
 <option  value="PRODUCCION" <?php  if ($this->estado == "PRODUCCION") { echo " selected" ;} ?>>PRODUCCION</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_estado'][] = 'PRODUCCION'; ?>
 <option  value="SUSPENDIDO" <?php  if ($this->estado == "SUSPENDIDO") { echo " selected" ;} ?>>SUSPENDIDO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_estado'][] = 'SUSPENDIDO'; ?>
 <option  value="INACTIVO" <?php  if ($this->estado == "INACTIVO") { echo " selected" ;} ?>>INACTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_estado'][] = 'INACTIVO'; ?>
 </select></span>
</span><?php  }?>
...
<span id="id_read_on_si_nomina" class="css_si_nomina_line" style="<?php echo $sStyleReadLab_si_nomina; ?>"><?php echo $this->form_format_readonly("si_nomina", $this->form_encode_input($si_nomina_look)); ?></span><span id="id_read_off_si_nomina" class="css_read_off_si_nomina css_si_nomina_line" style="<?php echo $sStyleReadInp_si_nomina; ?>"><?php echo "<div id=\"idAjaxCheckbox_si_nomina\" style=\"display: inline-block\" class=\"css_si_nomina_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_si_nomina'][] = 'SI'; ?>
...
<span id="id_read_on_si_factura_electronica" class="css_si_factura_electronica_line" style="<?php echo $sStyleReadLab_si_factura_electronica; ?>"><?php echo $this->form_format_readonly("si_factura_electronica", $this->form_encode_input($si_factura_electronica_look)); ?></span><span id="id_read_off_si_factura_electronica" class="css_read_off_si_factura_electronica css_si_factura_electronica_line" style="<?php echo $sStyleReadInp_si_factura_electronica; ?>"><?php echo "<div id=\"idAjaxCheckbox_si_factura_electronica\" style=\"display: inline-block\" class=\"css_si_factura_electronica_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_si_factura_electronica'][] = 'SI'; ?>
