...
?>
  ...
  function do_ajax_terceros_mob_validate_puc_auxiliar_deudores()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_mob_validate_puc_auxiliar_deudores(var_puc_auxiliar_deudores, var_script_case_init, do_ajax_terceros_mob_validate_puc_auxiliar_deudores_cb);
  ...
  function do_ajax_terceros_mob_validate_id_pucaux_cliente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_mob_validate_id_pucaux_cliente(var_id_pucaux_cliente, var_script_case_init, do_ajax_terceros_mob_validate_id_pucaux_cliente_cb);
  } // do_ajax_terceros_mob_validate_id_pucaux_cliente

  function do_ajax_terceros_mob_validate_id_pucaux_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_mob_validate_id_pucaux_cliente_cb
  ...
  function do_ajax_terceros_mob_validate_puc_retefuente_ventas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_mob_validate_puc_retefuente_ventas(var_puc_retefuente_ventas, var_script_case_init, do_ajax_terceros_mob_validate_puc_retefuente_ventas_cb);
  ...
  function do_ajax_terceros_mob_validate_id_pucaux_retteventas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_mob_validate_id_pucaux_retteventas(var_id_pucaux_retteventas, var_script_case_init, do_ajax_terceros_mob_validate_id_pucaux_retteventas_cb);
  } // do_ajax_terceros_mob_validate_id_pucaux_retteventas

  function do_ajax_terceros_mob_validate_id_pucaux_retteventas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_mob_validate_id_pucaux_retteventas_cb
  ...
  function do_ajax_terceros_mob_validate_puc_retefuente_servicios_clie()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_mob_validate_puc_retefuente_servicios_clie(var_puc_retefuente_servicios_clie, var_script_case_init, do_ajax_terceros_mob_validate_puc_retefuente_servicios_clie_cb);
  ...
  function do_ajax_terceros_mob_validate_id_pucaux_retteservicios()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_mob_validate_id_pucaux_retteservicios(var_id_pucaux_retteservicios, var_script_case_init, do_ajax_terceros_mob_validate_id_pucaux_retteservicios_cb);
  } // do_ajax_terceros_mob_validate_id_pucaux_retteservicios

  function do_ajax_terceros_mob_validate_id_pucaux_retteservicios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_mob_validate_id_pucaux_retteservicios_cb
  ...
  function do_ajax_terceros_mob_validate_puc_auxiliar_proveedores()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_mob_validate_puc_auxiliar_proveedores(var_puc_auxiliar_proveedores, var_script_case_init, do_ajax_terceros_mob_validate_puc_auxiliar_proveedores_cb);
  ...
  function do_ajax_terceros_mob_validate_id_pucaux_proveedor()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_mob_validate_id_pucaux_proveedor(var_id_pucaux_proveedor, var_script_case_init, do_ajax_terceros_mob_validate_id_pucaux_proveedor_cb);
  } // do_ajax_terceros_mob_validate_id_pucaux_proveedor

  function do_ajax_terceros_mob_validate_id_pucaux_proveedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_mob_validate_id_pucaux_proveedor_cb
  ...
  function do_ajax_terceros_mob_validate_puc_retefuente_compras()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_mob_validate_puc_retefuente_compras(var_puc_retefuente_compras, var_script_case_init, do_ajax_terceros_mob_validate_puc_retefuente_compras_cb);
  ...
  function do_ajax_terceros_mob_validate_id_pucaux_rettecompras()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_mob_validate_id_pucaux_rettecompras(var_id_pucaux_rettecompras, var_script_case_init, do_ajax_terceros_mob_validate_id_pucaux_rettecompras_cb);
  } // do_ajax_terceros_mob_validate_id_pucaux_rettecompras

  function do_ajax_terceros_mob_validate_id_pucaux_rettecompras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_mob_validate_id_pucaux_rettecompras_cb
  ...
  function do_ajax_terceros_mob_validate_puc_retefuente_servicios_prov()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_mob_validate_puc_retefuente_servicios_prov(var_puc_retefuente_servicios_prov, var_script_case_init, do_ajax_terceros_mob_validate_puc_retefuente_servicios_prov_cb);
  ...
  function do_ajax_terceros_mob_validate_id_pucaux_rettesercomp()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_mob_validate_id_pucaux_rettesercomp(var_id_pucaux_rettesercomp, var_script_case_init, do_ajax_terceros_mob_validate_id_pucaux_rettesercomp_cb);
  } // do_ajax_terceros_mob_validate_id_pucaux_rettesercomp

  function do_ajax_terceros_mob_validate_id_pucaux_rettesercomp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_mob_validate_id_pucaux_rettesercomp_cb
  ...
  function do_ajax_terceros_mob_refresh_puc_auxiliar_deudores()
  {
    var var_puc_auxiliar_deudores = scAjaxGetFieldSelect("puc_auxiliar_deudores");
    var var_nmgp_refresh_fields = "id_pucaux_cliente";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_mob_refresh_puc_auxiliar_deudores(var_puc_auxiliar_deudores, var_nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_mob_refresh_puc_auxiliar_deudores_cb);
  } // do_ajax_terceros_mob_refresh_puc_auxiliar_deudores

  function do_ajax_terceros_mob_refresh_puc_auxiliar_deudores_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_mob_refresh_puc_auxiliar_deudores_cb

  // ---------- Refresh puc_retefuente_ventas
  function do_ajax_terceros_mob_refresh_puc_retefuente_ventas()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_mob_refresh_puc_retefuente_ventas(var_puc_retefuente_ventas, var_nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_mob_refresh_puc_retefuente_ventas_cb);
  } // do_ajax_terceros_mob_refresh_puc_retefuente_ventas

  function do_ajax_terceros_mob_refresh_puc_retefuente_ventas_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_mob_refresh_puc_retefuente_ventas_cb

  // ---------- Refresh puc_retefuente_servicios_clie
  function do_ajax_terceros_mob_refresh_puc_retefuente_servicios_clie()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_mob_refresh_puc_retefuente_servicios_clie(var_puc_retefuente_servicios_clie, var_nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_mob_refresh_puc_retefuente_servicios_clie_cb);
  } // do_ajax_terceros_mob_refresh_puc_retefuente_servicios_clie

  function do_ajax_terceros_mob_refresh_puc_retefuente_servicios_clie_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_mob_refresh_puc_retefuente_servicios_clie_cb

  // ---------- Refresh puc_auxiliar_proveedores
  function do_ajax_terceros_mob_refresh_puc_auxiliar_proveedores()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_mob_refresh_puc_auxiliar_proveedores(var_puc_auxiliar_proveedores, var_puc_auxiliar_proveedor, var_nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_mob_refresh_puc_auxiliar_proveedores_cb);
  } // do_ajax_terceros_mob_refresh_puc_auxiliar_proveedores

  function do_ajax_terceros_mob_refresh_puc_auxiliar_proveedores_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_mob_refresh_puc_auxiliar_proveedores_cb

  // ---------- Refresh puc_retefuente_compras
  function do_ajax_terceros_mob_refresh_puc_retefuente_compras()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_mob_refresh_puc_retefuente_compras(var_puc_retefuente_compras, var_nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_mob_refresh_puc_retefuente_compras_cb);
  } // do_ajax_terceros_mob_refresh_puc_retefuente_compras

  function do_ajax_terceros_mob_refresh_puc_retefuente_compras_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_mob_refresh_puc_retefuente_compras_cb

  // ---------- Refresh puc_retefuente_servicios_prov
  function do_ajax_terceros_mob_refresh_puc_retefuente_servicios_prov()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_mob_refresh_puc_retefuente_servicios_prov(var_puc_retefuente_servicios_prov, var_nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_mob_refresh_puc_retefuente_servicios_prov_cb);
  } // do_ajax_terceros_mob_refresh_puc_retefuente_servicios_prov

  function do_ajax_terceros_mob_refresh_puc_retefuente_servicios_prov_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_mob_refresh_puc_retefuente_servicios_prov_cb
  ...
  function do_ajax_terceros_mob_event_puc_auxiliar_deudores_onchange()
  {
    var var_puc_auxiliar_deudores = scAjaxGetFieldSelect("puc_auxiliar_deudores");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_mob_event_puc_auxiliar_deudores_onchange(var_puc_auxiliar_deudores, var_script_case_init, do_ajax_terceros_mob_event_puc_auxiliar_deudores_onchange_cb);
  } // do_ajax_terceros_mob_event_puc_auxiliar_deudores_onchange

  function do_ajax_terceros_mob_event_puc_auxiliar_deudores_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "puc_auxiliar_deudores";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_mob_event_puc_auxiliar_deudores_onchange_cb_after_alert);
  } // do_ajax_terceros_mob_event_puc_auxiliar_deudores_onchange_cb
  function do_ajax_terceros_mob_event_puc_auxiliar_deudores_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_terceros_mob_refresh_puc_auxiliar_deudores();
    scAjaxRedir();
  } // do_ajax_terceros_mob_event_puc_auxiliar_deudores_onchange_cb_after_alert

  // ---------- Event onchange puc_auxiliar_proveedores
  function do_ajax_terceros_mob_event_puc_auxiliar_proveedores_onchange()
  {
    var var_puc_auxiliar_proveedores = scAjaxGetFieldSelect("puc_auxiliar_proveedores");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_mob_event_puc_auxiliar_proveedores_onchange(var_puc_auxiliar_proveedores, var_script_case_init, do_ajax_terceros_mob_event_puc_auxiliar_proveedores_onchange_cb);
  } // do_ajax_terceros_mob_event_puc_auxiliar_proveedores_onchange

  function do_ajax_terceros_mob_event_puc_auxiliar_proveedores_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "puc_auxiliar_proveedores";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_mob_event_puc_auxiliar_proveedores_onchange_cb_after_alert);
  } // do_ajax_terceros_mob_event_puc_auxiliar_proveedores_onchange_cb
  function do_ajax_terceros_mob_event_puc_auxiliar_proveedores_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_terceros_mob_refresh_puc_auxiliar_proveedores();
    scAjaxRedir();
  } // do_ajax_terceros_mob_event_puc_auxiliar_proveedores_onchange_cb_after_alert

  // ---------- Event onchange puc_retefuente_compras
  function do_ajax_terceros_mob_event_puc_retefuente_compras_onchange()
  {
    var var_puc_retefuente_compras = scAjaxGetFieldSelect("puc_retefuente_compras");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_mob_event_puc_retefuente_compras_onchange(var_puc_retefuente_compras, var_script_case_init, do_ajax_terceros_mob_event_puc_retefuente_compras_onchange_cb);
  } // do_ajax_terceros_mob_event_puc_retefuente_compras_onchange

  function do_ajax_terceros_mob_event_puc_retefuente_compras_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "puc_retefuente_compras";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_mob_event_puc_retefuente_compras_onchange_cb_after_alert);
  } // do_ajax_terceros_mob_event_puc_retefuente_compras_onchange_cb
  function do_ajax_terceros_mob_event_puc_retefuente_compras_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_terceros_mob_refresh_puc_retefuente_compras();
    scAjaxRedir();
  } // do_ajax_terceros_mob_event_puc_retefuente_compras_onchange_cb_after_alert

  // ---------- Event onchange puc_retefuente_servicios_clie
  function do_ajax_terceros_mob_event_puc_retefuente_servicios_clie_onchange()
  {
    var var_puc_retefuente_servicios_clie = scAjaxGetFieldSelect("puc_retefuente_servicios_clie");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_mob_event_puc_retefuente_servicios_clie_onchange(var_puc_retefuente_servicios_clie, var_script_case_init, do_ajax_terceros_mob_event_puc_retefuente_servicios_clie_onchange_cb);
  } // do_ajax_terceros_mob_event_puc_retefuente_servicios_clie_onchange

  function do_ajax_terceros_mob_event_puc_retefuente_servicios_clie_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "puc_retefuente_servicios_clie";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_mob_event_puc_retefuente_servicios_clie_onchange_cb_after_alert);
  } // do_ajax_terceros_mob_event_puc_retefuente_servicios_clie_onchange_cb
  function do_ajax_terceros_mob_event_puc_retefuente_servicios_clie_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_terceros_mob_refresh_puc_retefuente_servicios_clie();
    scAjaxRedir();
  } // do_ajax_terceros_mob_event_puc_retefuente_servicios_clie_onchange_cb_after_alert

  // ---------- Event onchange puc_retefuente_servicios_prov
  function do_ajax_terceros_mob_event_puc_retefuente_servicios_prov_onchange()
  {
    var var_puc_retefuente_servicios_prov = scAjaxGetFieldSelect("puc_retefuente_servicios_prov");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_mob_event_puc_retefuente_servicios_prov_onchange(var_puc_retefuente_servicios_prov, var_script_case_init, do_ajax_terceros_mob_event_puc_retefuente_servicios_prov_onchange_cb);
  } // do_ajax_terceros_mob_event_puc_retefuente_servicios_prov_onchange

  function do_ajax_terceros_mob_event_puc_retefuente_servicios_prov_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "puc_retefuente_servicios_prov";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_mob_event_puc_retefuente_servicios_prov_onchange_cb_after_alert);
  } // do_ajax_terceros_mob_event_puc_retefuente_servicios_prov_onchange_cb
  function do_ajax_terceros_mob_event_puc_retefuente_servicios_prov_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_terceros_mob_refresh_puc_retefuente_servicios_prov();
    scAjaxRedir();
  } // do_ajax_terceros_mob_event_puc_retefuente_servicios_prov_onchange_cb_after_alert

  // ---------- Event onchange puc_retefuente_ventas
  function do_ajax_terceros_mob_event_puc_retefuente_ventas_onchange()
  {
    var var_puc_retefuente_ventas = scAjaxGetFieldSelect("puc_retefuente_ventas");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_mob_event_puc_retefuente_ventas_onchange(var_puc_retefuente_ventas, var_script_case_init, do_ajax_terceros_mob_event_puc_retefuente_ventas_onchange_cb);
  } // do_ajax_terceros_mob_event_puc_retefuente_ventas_onchange

  function do_ajax_terceros_mob_event_puc_retefuente_ventas_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "puc_retefuente_ventas";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_mob_event_puc_retefuente_ventas_onchange_cb_after_alert);
  } // do_ajax_terceros_mob_event_puc_retefuente_ventas_onchange_cb
  function do_ajax_terceros_mob_event_puc_retefuente_ventas_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_terceros_mob_refresh_puc_retefuente_ventas();
    scAjaxRedir();
  } // do_ajax_terceros_mob_event_puc_retefuente_ventas_onchange_cb_after_alert
...
?>
  ...
  function do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_cliente()
  {
    var var_id_pucaux_cliente = scAjaxGetFieldSelect("id_pucaux_cliente");
    var var_puc_auxiliar_deudores = scAjaxGetFieldSelect("puc_auxiliar_deudores");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_pucaux_cliente";
    x_ajax_terceros_mob_lkpedt_refresh_id_pucaux_cliente(var_id_pucaux_cliente, var_puc_auxiliar_deudores, nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_cliente_cb);
  } // do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_cliente

  function do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_cliente_cb

  function do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_retteventas()
  {
    var var_id_pucaux_retteventas = scAjaxGetFieldSelect("id_pucaux_retteventas");
    var var_puc_retefuente_ventas = scAjaxGetFieldSelect("puc_retefuente_ventas");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_pucaux_retteventas";
    x_ajax_terceros_mob_lkpedt_refresh_id_pucaux_retteventas(var_id_pucaux_retteventas, var_puc_retefuente_ventas, nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_retteventas_cb);
  } // do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_retteventas

  function do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_retteventas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_retteventas_cb

  function do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_retteservicios()
  {
    var var_id_pucaux_retteservicios = scAjaxGetFieldSelect("id_pucaux_retteservicios");
    var var_puc_retefuente_servicios_clie = scAjaxGetFieldSelect("puc_retefuente_servicios_clie");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_pucaux_retteservicios";
    x_ajax_terceros_mob_lkpedt_refresh_id_pucaux_retteservicios(var_id_pucaux_retteservicios, var_puc_retefuente_servicios_clie, nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_retteservicios_cb);
  } // do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_retteservicios

  function do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_retteservicios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_retteservicios_cb

  function do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_proveedor()
  {
    var var_id_pucaux_proveedor = scAjaxGetFieldSelect("id_pucaux_proveedor");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_pucaux_proveedor";
    x_ajax_terceros_mob_lkpedt_refresh_id_pucaux_proveedor(var_id_pucaux_proveedor, nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_proveedor_cb);
  } // do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_proveedor

  function do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_proveedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_proveedor_cb

  function do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_rettecompras()
  {
    var var_id_pucaux_rettecompras = scAjaxGetFieldSelect("id_pucaux_rettecompras");
    var var_puc_retefuente_compras = scAjaxGetFieldSelect("puc_retefuente_compras");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_pucaux_rettecompras";
    x_ajax_terceros_mob_lkpedt_refresh_id_pucaux_rettecompras(var_id_pucaux_rettecompras, var_puc_retefuente_compras, nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_rettecompras_cb);
  } // do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_rettecompras

  function do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_rettecompras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_rettecompras_cb

  function do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_rettesercomp()
  {
    var var_id_pucaux_rettesercomp = scAjaxGetFieldSelect("id_pucaux_rettesercomp");
    var var_puc_retefuente_servicios_prov = scAjaxGetFieldSelect("puc_retefuente_servicios_prov");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_pucaux_rettesercomp";
    x_ajax_terceros_mob_lkpedt_refresh_id_pucaux_rettesercomp(var_id_pucaux_rettesercomp, var_puc_retefuente_servicios_prov, nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_rettesercomp_cb);
  } // do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_rettesercomp

  function do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_rettesercomp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_terceros_mob_lkpedt_refresh_id_pucaux_rettesercomp_cb
