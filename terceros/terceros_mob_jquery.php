...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'es_tecnico':
      case 'activo':
        sc_exib_ocult_pag('terceros_mob_form0');
        break;
      case 'credito':
      case 'cupo':
      case 'cupodis':
      ...
      case 'saldo':
      case 'afiliacion':
        sc_exib_ocult_pag('terceros_mob_form1');
        break;
      case 'es_cajero':
      case 'cupo_vendedor':
        sc_exib_ocult_pag('terceros_mob_form2');
        break;
      case 'autoretenedor':
      case 'creditoprov':
      case 'dias':
      ...
      case 'fechultcomp':
      case 'saldoapagar':
        sc_exib_ocult_pag('terceros_mob_form3');
        break;
      case 'codigo_ter':
      case 'zona_clientes':
      ...
      case 'nombre_empresa_bd':
        ...
        break;
      case 'archivos':
        sc_exib_ocult_pag('terceros_mob_form5');
        break;
      case 'es_restaurante':
      case 'porcentaje_propina_sugerida':
        sc_exib_ocult_pag('terceros_mob_form6');
        break;
    }
  }
...
function scHidePage(pageNo) {
	$("#id_terceros_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_nacimiento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros_mob_validate_nacimiento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechault" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros_mob_validate_fechault(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_afiliacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros_mob_validate_afiliacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_con_actual" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_terceros_mob_validate_con_actual(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_terceros_mob_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'terceros_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
