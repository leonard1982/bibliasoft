<div id="terceros_form5" style='<?php echo ($this->tabCssClass["terceros_form5"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Archivos'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Archivos'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['grid_gestor_archivos_tercero_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Archivos'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['grid_gestor_archivos_tercero_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['grid_gestor_archivos_tercero_script_case_init'] ]['grid_gestor_archivos_tercero']['embutida_form_full']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['grid_gestor_archivos_tercero_script_case_init'] ]['grid_gestor_archivos_tercero']['embutida_form']       = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['grid_gestor_archivos_tercero_script_case_init'] ]['grid_gestor_archivos_tercero']['embutida_pai']        = "terceros";
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'terceros_empty.htm' : $this->Ini->link_grid_gestor_archivos_tercero_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=500' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_Archivos']) && 'nmsc_iframe_liga_grid_gestor_archivos_tercero' != $this->Ini->sc_lig_target['C_@scinf_Archivos'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Archivos'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['grid_gestor_archivos_tercero_script_case_init']);
    }
?>
