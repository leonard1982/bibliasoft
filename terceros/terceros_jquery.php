...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_id_pucaux_cliente' + iSeqRow).bind('blur', function() { sc_terceros_id_pucaux_cliente_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_terceros_id_pucaux_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_id_pucaux_retteventas' + iSeqRow).bind('blur', function() { sc_terceros_id_pucaux_retteventas_onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_terceros_id_pucaux_retteventas_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_id_pucaux_retteservicios' + iSeqRow).bind('blur', function() { sc_terceros_id_pucaux_retteservicios_onblur(this, iSeqRow) })
                                                      .bind('change', function() { sc_terceros_id_pucaux_retteservicios_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_id_pucaux_proveedor' + iSeqRow).bind('blur', function() { sc_terceros_id_pucaux_proveedor_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_terceros_id_pucaux_proveedor_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_id_pucaux_rettecompras' + iSeqRow).bind('blur', function() { sc_terceros_id_pucaux_rettecompras_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_terceros_id_pucaux_rettecompras_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_id_pucaux_rettesercomp' + iSeqRow).bind('blur', function() { sc_terceros_id_pucaux_rettesercomp_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_terceros_id_pucaux_rettesercomp_onchange(this, iSeqRow) })
...
function sc_terceros_id_pucaux_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_id_pucaux_retteventas_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_id_pucaux_retteservicios_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_id_pucaux_proveedor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_id_pucaux_rettecompras_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_terceros_id_pucaux_rettesercomp_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
