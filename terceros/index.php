...
//
   if (!session_id())
   {
   include_once('terceros_session.php');
   ...
   @session_start() ;
       ...
       {
          include_once('terceros_mob.php');
          exit;
       }
   }

   $_SESSION['scriptcase']['terceros']['error_buffer'] = '';

   $_SESSION['scriptcase']['terceros']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['terceros']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['terceros']['glo_nm_path_imagens']    = "";
   ...
   //check prod
   if(empty($_SESSION['scriptcase']['terceros']['glo_nm_path_prod']))
   {
           /*check prod*/$_SESSION['scriptcase']['terceros']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
   }
   //check img
   if(empty($_SESSION['scriptcase']['terceros']['glo_nm_path_imagens']))
   {
           /*check img*/$_SESSION['scriptcase']['terceros']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
   }
   //check tmp
   if(empty($_SESSION['scriptcase']['terceros']['glo_nm_path_imag_temp']))
   {
           /*check tmp*/$_SESSION['scriptcase']['terceros']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   //check cache
   if(empty($_SESSION['scriptcase']['terceros']['glo_nm_path_cache']))
   {
           /*check cache*/$_SESSION['scriptcase']['terceros']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
   }
   //check doc
   if(empty($_SESSION['scriptcase']['terceros']['glo_nm_path_doc']))
   {
           /*check doc*/$_SESSION['scriptcase']['terceros']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
   }
...
// 
      ...
      $this->path_prod       = $_SESSION['scriptcase']['terceros']['glo_nm_path_prod'];
      $this->path_imagens    = $_SESSION['scriptcase']['terceros']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['terceros']['glo_nm_path_imag_temp'];
      $this->path_cache      = $_SESSION['scriptcase']['terceros']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['terceros']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/terceros';
      ...
      if (isset($_SESSION['scriptcase']['terceros']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['terceros']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['terceros']['actual_lang']) || $_SESSION['scriptcase']['terceros']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['terceros']['actual_lang'] = $this->str_lang;
      ...
      if (isset($_SESSION['scriptcase']['user_logout']))
      {
          foreach ($_SESSION['scriptcase']['user_logout'] as $ind => $parms)
          {
              if (isset($_SESSION[$parms['V']]) && $_SESSION[$parms['V']] == $parms['U'])
              {
                  ...
                  if (isset($inicial_terceros->contr_terceros->NM_ajax_flag) && $inicial_terceros->contr_terceros->NM_ajax_flag)
                  {
                      $inicial_terceros->contr_terceros->NM_ajax_info['redir']['action']  = $nm_apl_dest;
                      $inicial_terceros->contr_terceros->NM_ajax_info['redir']['target']  = $parms['T'];
                      $inicial_terceros->contr_terceros->NM_ajax_info['redir']['metodo']  = "post";
                      $inicial_terceros->contr_terceros->NM_ajax_info['redir']['script_case_init']  = $this->sc_page;
...
<?php
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['terceros']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['scriptcase']['terceros']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['terceros']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['terceros']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['terceros']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['terceros']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['terceros']['session_timeout']);
      ...
      {
          $inicial_terceros->contr_terceros->NM_ajax_info['redir']['action']  = "./";
          $inicial_terceros->contr_terceros->NM_ajax_info['redir']['target']  = "_self";
          $inicial_terceros->contr_terceros->NM_ajax_info['redir']['metodo']  = "post";
          $inicial_terceros->contr_terceros->NM_ajax_info['redir']['script_case_init']  = $this->sc_page;
          terceros_pack_ajax_response();
          exit;
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['terceros']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['terceros']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['terceros']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['terceros']['sc_outra_jan']) || $_SESSION['sc_session'][$script_case_init]['terceros']['sc_outra_jan'] != 'terceros')) 
          { 
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      ...
      $this->link_terceros_inline = $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('terceros') . "/terceros_inline.php";
      if ($_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['terceros']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["terceros"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["terceros"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
...
// 
      ...
      if(function_exists('set_php_timezone'))  set_php_timezone('terceros'); 
      ...
      global $inicial_terceros, $NM_run_iframe;
      if ((isset($inicial_terceros->contr_terceros->NM_ajax_flag) && $inicial_terceros->contr_terceros->NM_ajax_flag) || (isset($_SESSION['sc_session'][$this->sc_page]['terceros']['embutida_call']) && $_SESSION['sc_session'][$this->sc_page]['terceros']['embutida_call']) || $NM_run_iframe == 1)
      {
           $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      }
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['terceros']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['terceros']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['terceros']['glo_nm_conexao']) && $_SESSION['scriptcase']['terceros']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['terceros']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['terceros']['glo_nm_perfil']) && $_SESSION['scriptcase']['terceros']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['terceros']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['terceros']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['terceros']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      ...
      if (isset($_SESSION['scriptcase']['terceros']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['terceros']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['terceros']['glo_nm_perfil'];
      }
...
// 
      ...
      {
         $_SESSION['sc_session'][$this->sc_page]['terceros']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['terceros']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['terceros']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
          {
              $_SESSION['sc_session'][$this->sc_page]['terceros']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['terceros']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['terceros']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['terceros']['SC_sep_date1'];
      }
...
// 
      if (!empty($this->nm_falta_var) || !empty($this->nm_falta_var_db) || $nm_crit_perfil)
      {
          ...
          echo "</table>";
          if (!$_SESSION['sc_session'][$this->sc_page]['terceros']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['terceros']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['terceros']['sc_outra_jan'] != 'terceros')) 
          { 
              if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno'])) 
              { 
?>
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['terceros']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
...
// 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['terceros']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['terceros']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['terceros']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8);
    }
    else {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['terceros']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['terceros']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['terceros']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['terceros']['SC_sep_date1'];
           }
...
class terceros_edit
{
    ...
    function inicializa()
    {
        ...
        require_once("terceros_apl.php");
        $this->contr_terceros = new terceros_apl();
    }
}
...
//----------------  
//
    $_SESSION['scriptcase']['terceros']['contr_erro'] = 'off';
    if (!function_exists("NM_is_utf8"))
    {
        include_once("../_lib/lib/php/nm_utf8.php");
    }
    ...
    if (!empty($_POST))
    {
        foreach ($_POST as $nmgp_var => $nmgp_val)
        {
             ...
             nm_limpa_str_terceros($nmgp_val);
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['terceros']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['terceros']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
        }
        if (isset($apl_def)) {
            if ($apl_def[0] != "terceros") {
                $_SESSION['scriptcase']['sem_session'] = true;
                if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                    $_SESSION['scriptcase']['terceros']['session_timeout']['redir'] = $apl_def[0];
                }
                else {
                    $_SESSION['scriptcase']['terceros']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
                }
                $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
                $_SESSION['scriptcase']['terceros']['session_timeout']['redir_tp'] = $Redir_tp;
            }
            if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
                $_SESSION['scriptcase']['terceros']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
            }
        }
    }
    ...
    {
        $_SESSION['sc_session'][$script_case_init]['terceros']['where_filter'] = $SC_where_pdf;
    }

    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['terceros']['session_timeout']['redir']))
    {
        if ('ajax_terceros_validate_tipo' == $_POST['rs'])
        {
            $tipo = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_regimen' == $_POST['rs'])
        {
            $regimen = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_tipo_documento' == $_POST['rs'])
        {
            $tipo_documento = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_documento' == $_POST['rs'])
        {
            $documento = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_dv' == $_POST['rs'])
        {
            $dv = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_imagenter' == $_POST['rs'])
        {
            $imagenter = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_codigo_tercero' == $_POST['rs'])
        {
            $codigo_tercero = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_sexo' == $_POST['rs'])
        {
            $sexo = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_notificar' == $_POST['rs'])
        {
            $notificar = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_nombre1' == $_POST['rs'])
        {
            $nombre1 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_nombre2' == $_POST['rs'])
        {
            $nombre2 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_apellido1' == $_POST['rs'])
        {
            $apellido1 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_apellido2' == $_POST['rs'])
        {
            $apellido2 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_tel_cel' == $_POST['rs'])
        {
            $tel_cel = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_urlmail' == $_POST['rs'])
        {
            $urlmail = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_idtercero' == $_POST['rs'])
        {
            $idtercero = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_r_social' == $_POST['rs'])
        {
            $r_social = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_nombres' == $_POST['rs'])
        {
            $nombres = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_nombre_comercil' == $_POST['rs'])
        {
            $nombre_comercil = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_representante' == $_POST['rs'])
        {
            $representante = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_direccion' == $_POST['rs'])
        {
            $direccion = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_departamento' == $_POST['rs'])
        {
            $departamento = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_idmuni' == $_POST['rs'])
        {
            $idmuni = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_ciudad' == $_POST['rs'])
        {
            $ciudad = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_codigo_postal' == $_POST['rs'])
        {
            $codigo_postal = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_observaciones' == $_POST['rs'])
        {
            $observaciones = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_lenguaje' == $_POST['rs'])
        {
            $lenguaje = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_c_postal' == $_POST['rs'])
        {
            $c_postal = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_correo_notificafe' == $_POST['rs'])
        {
            $correo_notificafe = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_celular_notificafe' == $_POST['rs'])
        {
            $celular_notificafe = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_cliente' == $_POST['rs'])
        {
            $cliente = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_proveedor' == $_POST['rs'])
        {
            $proveedor = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_empleado' == $_POST['rs'])
        {
            $empleado = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_es_tecnico' == $_POST['rs'])
        {
            $es_tecnico = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_activo' == $_POST['rs'])
        {
            $activo = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_credito' == $_POST['rs'])
        {
            $credito = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_cupo' == $_POST['rs'])
        {
            $cupo = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_cupodis' == $_POST['rs'])
        {
            $cupodis = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_dias_credito' == $_POST['rs'])
        {
            $dias_credito = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_dias_mora' == $_POST['rs'])
        {
            $dias_mora = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_efec_retencion' == $_POST['rs'])
        {
            $efec_retencion = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_listaprecios' == $_POST['rs'])
        {
            $listaprecios = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_loatiende' == $_POST['rs'])
        {
            $loatiende = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_autorizado' == $_POST['rs'])
        {
            $autorizado = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_relleno2' == $_POST['rs'])
        {
            $relleno2 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_nacimiento' == $_POST['rs'])
        {
            $nacimiento = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_detalle_tributario' == $_POST['rs'])
        {
            $detalle_tributario = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_responsabilidad_fiscal' == $_POST['rs'])
        {
            $responsabilidad_fiscal = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_ciiu' == $_POST['rs'])
        {
            $ciiu = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_sucur_cliente' == $_POST['rs'])
        {
            $sucur_cliente = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_sucursales' == $_POST['rs'])
        {
            $sucursales = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_fechault' == $_POST['rs'])
        {
            $fechault = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_saldo' == $_POST['rs'])
        {
            $saldo = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_afiliacion' == $_POST['rs'])
        {
            $afiliacion = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_es_cajero' == $_POST['rs'])
        {
            $es_cajero = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_cupo_vendedor' == $_POST['rs'])
        {
            $cupo_vendedor = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_autoretenedor' == $_POST['rs'])
        {
            $autoretenedor = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_creditoprov' == $_POST['rs'])
        {
            $creditoprov = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_dias' == $_POST['rs'])
        {
            $dias = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_url' == $_POST['rs'])
        {
            $url = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_contacto' == $_POST['rs'])
        {
            $contacto = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_telefonos_prov' == $_POST['rs'])
        {
            $telefonos_prov = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_email' == $_POST['rs'])
        {
            $email = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_fechultcomp' == $_POST['rs'])
        {
            $fechultcomp = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_saldoapagar' == $_POST['rs'])
        {
            $saldoapagar = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_codigo_ter' == $_POST['rs'])
        {
            $codigo_ter = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_zona_clientes' == $_POST['rs'])
        {
            $zona_clientes = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_clasificacion_clientes' == $_POST['rs'])
        {
            $clasificacion_clientes = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_validate_puc_auxiliar_deudores' == $_POST['rs'])
        {
        ...
        if ('ajax_terceros_lkpedt_refresh_clasificacion_clientes' == $_POST['rs'])
        {
            $clasificacion_clientes = NM_utf8_urldecode($_POST['rsargs'][0]);
            $nmgp_refresh_fields = NM_utf8_urldecode($_POST['rsargs'][1]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][2]);
        ...
        if ('ajax_terceros_event_apellido2_onchange' == $_POST['rs'])
        {
            $nombre1 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $apellido2 = NM_utf8_urldecode($_POST['rsargs'][1]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][2]);
        }
        if ('ajax_terceros_event_cliente_onchange' == $_POST['rs'])
        {
            $idtercero = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_terceros_event_credito_onchange' == $_POST['rs'])
        {
            $credito = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_terceros_event_creditoprov_onchange' == $_POST['rs'])
        {
            $creditoprov = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_event_cupo_onchange' == $_POST['rs'])
        {
            $cupodis = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_terceros_event_documento_onchange' == $_POST['rs'])
        {
            $tipo_documento = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_terceros_event_nombre1_onchange' == $_POST['rs'])
        {
            $nombre1 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_event_nombre2_onchange' == $_POST['rs'])
        {
            $nombre1 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $nombre2 = NM_utf8_urldecode($_POST['rsargs'][1]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][2]);
        }
        if ('ajax_terceros_event_nombre_comercil_onchange' == $_POST['rs'])
        {
            $tipo = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_terceros_event_nombres_onblur' == $_POST['rs'])
        {
            $nombres = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_terceros_event_nombres_onfocus' == $_POST['rs'])
        {
            $nombre1 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $nombres = NM_utf8_urldecode($_POST['rsargs'][1]);
        ...
        if ('ajax_terceros_event_proveedor_onchange' == $_POST['rs'])
        {
            $proveedor = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_terceros_event_regimen_onchange' == $_POST['rs'])
        {
            $regimen = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_terceros_event_sucur_cliente_onchange' == $_POST['rs'])
        {
            $idtercero = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_terceros_event_tipo_documento_onchange' == $_POST['rs'])
        {
            $tipo_documento = NM_utf8_urldecode($_POST['rsargs'][0]);
            $dv = NM_utf8_urldecode($_POST['rsargs'][1]);
            $documento = NM_utf8_urldecode($_POST['rsargs'][2]);
        ...
        if ('ajax_terceros_event_tipo_onchange' == $_POST['rs'])
        {
            $tipo = NM_utf8_urldecode($_POST['rsargs'][0]);
    ...
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['terceros']['lig_edit_lookup']))
    { 
        $_SESSION['sc_session'][$script_case_init]['terceros']['lig_edit_lookup']     = false;
        $_SESSION['sc_session'][$script_case_init]['terceros']['lig_edit_lookup_cb']  = '';
        $_SESSION['sc_session'][$script_case_init]['terceros']['lig_edit_lookup_row'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['terceros']['embutida_call']))
    { 
        $_SESSION['sc_session'][$script_case_init]['terceros']['embutida_call'] = false;
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['terceros']['embutida_proc']))
    { 
        $_SESSION['sc_session'][$script_case_init]['terceros']['embutida_proc'] = false;
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_form_insert']))
    { 
        $_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_form_insert'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_form_update']))
    { 
        $_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_form_update'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_form_delete']))
    { 
        $_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_form_delete'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_form_btn_nav']))
    { 
        $_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_form_btn_nav'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_grid_edit']))
    { 
        $_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_grid_edit'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_grid_edit_link']))
    { 
        $_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_grid_edit_link'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_qtd_reg']))
    { 
        $_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_qtd_reg'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_tp_pag']))
    { 
        $_SESSION['sc_session'][$script_case_init]['terceros']['embutida_liga_tp_pag'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['terceros']['run_modal']))
    { 
        $_SESSION['sc_session'][$script_case_init]['terceros']['run_modal'] = isset($_GET['nmgp_url_saida']) && 'modal' == $_GET['nmgp_url_saida'];
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && $_SESSION['sc_session'][$script_case_init]['terceros']['embutida_proc'])
    {
        return;
    }
    if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['terceros']['embutida_parms']))
    { 
        $tmp_nmgp_parms = '';
        ...
        $nmgp_parms = $tmp_nmgp_parms . $_SESSION['sc_session'][$script_case_init]['terceros']['embutida_parms'];
        unset($_SESSION['sc_session'][$script_case_init]['terceros']['embutida_parms']);
    } 
    ...
    { 
        ...
        while (!empty($todo[$ix]))
        {
           ...
           if (1 < sizeof($cadapar))
           {
               ...
               nm_limpa_str_terceros($cadapar[1]);
    ...
    elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['terceros']['parms']))
    {
        ...
        {
            $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['terceros']['parms']);
            $todo  = explode("?@?", $todox);
            $ix = 0;
            while (!empty($todo[$ix]))
            {
    ...
    $salva_run = "N";
    $salva_iframe = false;
    if (isset($_SESSION['sc_session'][$script_case_init]['terceros']['iframe_menu']))
    {
        $salva_iframe = $_SESSION['sc_session'][$script_case_init]['terceros']['iframe_menu'];
        unset($_SESSION['sc_session'][$script_case_init]['terceros']['iframe_menu']);
    }
    if (isset($_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe']))
    {
        $salva_run = $_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe'];
        unset($_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe']);
    }
    if (isset($nm_run_menu) && $nm_run_menu == 1)
    {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "terceros";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'terceros' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['terceros']['iframe_menu']  = true;
        $_SESSION['sc_session'][$script_case_init]['terceros']['mostra_cab']   = "S";
        $_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe']   = "N";
        $_SESSION['sc_session'][$script_case_init]['terceros']['retorno_edit'] = "";
    }
    else
    {
        $_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe']  = $salva_run;
        $_SESSION['sc_session'][$script_case_init]['terceros']['iframe_menu'] = $salva_iframe;
    }

    if (!isset($_SESSION['sc_session'][$script_case_init]['terceros']['db_changed']))
    {
        $_SESSION['sc_session'][$script_case_init]['terceros']['db_changed'] = false;
    }
    ...
    if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'terceros')
    {
        $_SESSION['sc_session'][$script_case_init]['terceros']['sc_outra_jan'] = true;
    ...
    if (isset($nmgp_outra_jan) && $nmgp_outra_jan == 'true')
    {
        ...
        {
            $_SESSION['sc_session'][$script_case_init]['terceros']['sc_modal'] = true;
            $nm_url_saida = "terceros_fim.php"; 
        }
        $nm_apl_dependente = 0;
        $_SESSION['sc_session'][$script_case_init]['terceros']['sc_outra_jan'] = true;
    }
    ...
    if (!isset($_SESSION['sc_session'][$script_case_init]['terceros']['initialize']))
    {
        $_SESSION['sc_session'][$script_case_init]['terceros']['initialize'] = true;
    }
    elseif (!isset($_SERVER['HTTP_REFERER']))
    {
        $_SESSION['sc_session'][$script_case_init]['terceros']['initialize'] = false;
    }
    elseif (false === strpos($_SERVER['HTTP_REFERER'], '/terceros/'))
    {
        $_SESSION['sc_session'][$script_case_init]['terceros']['initialize'] = true;
    }
    else
    ...
    if (isset($_SESSION['sc_session'][$script_case_init]['terceros']['first_time']))
    {
        $_SESSION['sc_session'][$script_case_init]['terceros']['first_time'] = false;
    }
    else
    {
        $_SESSION['sc_session'][$script_case_init]['terceros']['first_time'] = true;
    }

    $_SESSION['sc_session'][$script_case_init]['terceros']['menu_desenv'] = false;   
    if (!defined("SC_ERROR_HANDLER"))
    {
        define("SC_ERROR_HANDLER", 1);
    }
    include_once(dirname(__FILE__) . "/terceros_erro.php");
    ...
    else
    {
        if (!empty($nmgp_opcao))  
        {
            $_SESSION['sc_session'][$script_case_init]['terceros']['opcao'] = $nmgp_opcao ; 
        }
        if (isset($_POST["pa"])) 
        {
            $_SESSION['pa'] = $_POST["pa"];
            nm_limpa_str_terceros($_SESSION['pa']);
        }
        if (isset($_GET["pa"])) 
        {
            $_SESSION['pa'] = $_GET["pa"];
        ...
        if (isset($_POST["sa"])) 
        {
            ...
            nm_limpa_str_terceros($_SESSION['sa']);
        }
        if (isset($_GET["sa"])) 
        {
            $_SESSION['sa'] = $_GET["sa"];
        ...
        if (isset($_POST["id_tercero"])) 
        {
            ...
            nm_limpa_str_terceros($_SESSION['id_tercero']);
        }
        ...
        if (isset($_POST["nomb"])) 
        {
            ...
            nm_limpa_str_terceros($_SESSION['nomb']);
        }
        if (isset($_GET["nomb"])) 
        {
        ...
        if (isset($_POST["pn"])) 
        {
            ...
            nm_limpa_str_terceros($_SESSION['pn']);
        }
        if (isset($_GET["pn"])) 
        {
            $_SESSION['pn'] = $_GET["pn"];
        ...
        {
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['terceros']['volta_redirect_apl']; 
            $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['terceros']['volta_redirect_tp']; 
            $_SESSION['sc_session'][$script_case_init]['terceros']['volta_redirect_apl'] = "";
            $_SESSION['sc_session'][$script_case_init]['terceros']['volta_redirect_tp'] = "";
            $nm_url_saida = "terceros_fim.php"; 
        }
        elseif (isset($_SESSION['sc_session'][$script_case_init]['terceros']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['terceros']['sc_outra_jan'] == 'true')
        {
               $nm_url_saida = "terceros_fim.php"; 
        }
        elseif ($_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe'] != "R")
        {
           $nm_url_saida = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : ""; 
           $nm_url_saida = str_replace("_fim.php", ".php", $nm_url_saida); 
            $nm_saida_global = $nm_url_saida;
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['terceros']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['terceros']['retorno_edit'] = $nmgp_url_saida ; 
            } 
            if (!empty($_SESSION['sc_session'][$script_case_init]['terceros']['retorno_edit'])) 
            {
                $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['terceros']['retorno_edit'] . "?script_case_init=" . $script_case_init;  
                $nm_apl_dependente = 1 ; 
                $nm_saida_global = $nm_url_saida;
            } 
            ...
            if ($_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe'] != "R" && (!isset($_SESSION['sc_session'][$script_case_init]['terceros']['embutida_call']) || !$_SESSION['sc_session'][$script_case_init]['terceros']['embutida_call']))
            { 
        ...
        if (empty($_SESSION['sc_session'][$script_case_init]['terceros']['volta_tp']) && $_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe'] != "R")
        {
            $_SESSION['sc_session'][$script_case_init]['terceros']['volta_php'] = $nm_url_saida;
            $_SESSION['sc_session'][$script_case_init]['terceros']['volta_apl'] = $nm_saida_global;
            $_SESSION['sc_session'][$script_case_init]['terceros']['volta_ss']  = (isset($_SESSION['scriptcase']['sc_url_saida'][$script_case_init])) ? $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] : "";
            $_SESSION['sc_session'][$script_case_init]['terceros']['volta_dep'] = $nm_apl_dependente;
            $_SESSION['sc_session'][$script_case_init]['terceros']['volta_tp']  = (isset($_SESSION['scriptcase']['sc_tp_saida'])) ? $_SESSION['scriptcase']['sc_tp_saida'] : "";
        }
        $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['terceros']['volta_php'];
        $nm_saida_global = $_SESSION['sc_session'][$script_case_init]['terceros']['volta_php'];
        $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['terceros']['volta_dep'];
        if ($_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe'] != "R" && !empty($_SESSION['sc_session'][$script_case_init]['terceros']['volta_ss'])) 
        { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['terceros']['volta_ss'];
            $_SESSION['scriptcase']['sc_tp_saida']  = $_SESSION['sc_session'][$script_case_init]['terceros']['volta_tp'];
        } 
        if ($_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe'] == "F" || $_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe'] == "R") 
        { 
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['terceros']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['terceros']['retorno_edit'] = $nmgp_url_saida . "?script_case_init=" . $script_case_init; 
            } 
        } 
        if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['terceros']['run_iframe'] != "R") 
        { 
            $_SESSION['sc_session'][$script_case_init]['terceros']['menu_desenv'] = true;   
        } 
    }
    if (isset($nmgp_redir)) 
    { 
        $_SESSION['sc_session'][$script_case_init]['terceros']['redir'] = $nmgp_redir;   
    } 
    if (isset($nmgp_outra_jan) && $nmgp_outra_jan == 'true')
    {
        $_SESSION['sc_session'][$script_case_init]['terceros']['sc_outra_jan'] = true;
    ...
    if (isset($_SESSION['sc_session'][$script_case_init]['terceros']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['terceros']['sc_outra_jan'])
    {
        $nm_apl_dependente = 0;
    }
    $GLOBALS["NM_ERRO_IBASE"] = 0;  
    $inicial_terceros = new terceros_edit();
    $inicial_terceros->inicializa();

    $inicial_terceros->contr_terceros->NM_ajax_info['select_html'] = array();
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['tipo'] = "class=\"sc-js-input scFormObjectOdd css_tipo_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_tipo\" name=\"tipo\" size=\"1\" alt=\"{type: \'select\', enterTab: true}\"";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['regimen'] = "class=\"sc-js-input scFormObjectOdd css_regimen_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_regimen\" name=\"regimen\" size=\"1\" alt=\"{type: \'select\', enterTab: true}\"";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['tipo_documento'] = "class=\"sc-js-input scFormObjectOdd css_tipo_documento_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_tipo_documento\" name=\"tipo_documento\" size=\"1\" alt=\"{type: \'select\', enterTab: true}\"";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['sexo'] = "class=\"sc-js-input scFormObjectOdd css_sexo_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_sexo\" name=\"sexo\" size=\"1\" alt=\"{type: \'select\', enterTab: true}\"";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['notificar'] = " onClick=\"\" ";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['departamento'] = "class=\"sc-js-input scFormObjectOdd css_departamento_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_departamento\" name=\"departamento\" size=\"1\" alt=\"{type: 'select', enterTab: true}\"";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['idmuni'] = "class=\"sc-js-input scFormObjectOdd css_idmuni_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_idmuni\" name=\"idmuni\" size=\"1\" alt=\"{type: 'select', enterTab: true}\"";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['ciudad'] = "class=\"sc-js-input scFormObjectOdd css_ciudad_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_ciudad\" name=\"ciudad\" size=\"1\" alt=\"{type: 'select', enterTab: true}\"";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['codigo_postal'] = "class=\"sc-js-input scFormObjectOdd css_codigo_postal_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_codigo_postal\" name=\"codigo_postal\" size=\"1\" alt=\"{type: 'select', enterTab: true}\"";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['lenguaje'] = "class=\"sc-js-input scFormObjectOdd css_lenguaje_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_lenguaje\" name=\"lenguaje\" size=\"1\" alt=\"{type: 'select', enterTab: true}\"";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['cliente'] = " onClick=\"\" ";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['proveedor'] = " onClick=\"\" ";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['empleado'] = " onClick=\"\" ";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['es_tecnico'] = " onClick=\"\" ";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['activo'] = " onClick=\"\" ";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['credito'] = "class=\"sc-js-input scFormObjectOdd css_credito_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_credito\" name=\"credito\" size=\"1\" alt=\"{type: \'select\', enterTab: true}\"";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['efec_retencion'] = "class=\"sc-js-input scFormObjectOdd css_efec_retencion_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_efec_retencion\" name=\"efec_retencion\" size=\"1\" alt=\"{type: \'select\', enterTab: true}\"";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['listaprecios'] = "class=\"sc-js-input scFormObjectOdd css_listaprecios_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_listaprecios\" name=\"listaprecios\" size=\"1\" alt=\"{type: \'select\', enterTab: true}\"";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['loatiende'] = "class=\"sc-js-input scFormObjectOdd css_loatiende_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_loatiende\" name=\"loatiende\" size=\"1\" alt=\"{type: 'select', enterTab: true}\"";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['autorizado'] = " onClick=\"\" ";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['sucur_cliente'] = " onClick=\"\" ";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['es_cajero'] = " onClick=\"\" ";
    $inicial_terceros->contr_terceros->NM_ajax_info['select_html']['autoretenedor'] = "class=\"sc-js-input scFormObjectOdd css_autoretenedor_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_autoretenedor\" name=\"autoretenedor\" size=\"1\" alt=\"{type: \'select\', enterTab: true}\"";
    ...
    {
        include_once(dirname(__FILE__) . '/terceros_sajax.php');
        define('SC_SAJAX_LOADED', 'YES');
    }
    if (!class_exists('Services_JSON'))
    {
        include_once(dirname(__FILE__) . '/terceros_json.php');
    }
    $sajax_request_type = "POST";
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_terceros_validate_tipo");
    sajax_export("ajax_terceros_validate_regimen");
    sajax_export("ajax_terceros_validate_tipo_documento");
    sajax_export("ajax_terceros_validate_documento");
    sajax_export("ajax_terceros_validate_dv");
    sajax_export("ajax_terceros_validate_imagenter");
    sajax_export("ajax_terceros_validate_codigo_tercero");
    sajax_export("ajax_terceros_validate_sexo");
    sajax_export("ajax_terceros_validate_notificar");
    sajax_export("ajax_terceros_validate_nombre1");
    sajax_export("ajax_terceros_validate_nombre2");
    sajax_export("ajax_terceros_validate_apellido1");
    sajax_export("ajax_terceros_validate_apellido2");
    sajax_export("ajax_terceros_validate_tel_cel");
    sajax_export("ajax_terceros_validate_urlmail");
    sajax_export("ajax_terceros_validate_idtercero");
    sajax_export("ajax_terceros_validate_r_social");
    sajax_export("ajax_terceros_validate_nombres");
    sajax_export("ajax_terceros_validate_nombre_comercil");
    sajax_export("ajax_terceros_validate_representante");
    sajax_export("ajax_terceros_validate_direccion");
    sajax_export("ajax_terceros_validate_departamento");
    sajax_export("ajax_terceros_validate_idmuni");
    sajax_export("ajax_terceros_validate_ciudad");
    sajax_export("ajax_terceros_validate_codigo_postal");
    sajax_export("ajax_terceros_validate_observaciones");
    sajax_export("ajax_terceros_validate_lenguaje");
    sajax_export("ajax_terceros_validate_c_postal");
    sajax_export("ajax_terceros_validate_correo_notificafe");
    sajax_export("ajax_terceros_validate_celular_notificafe");
    sajax_export("ajax_terceros_validate_cliente");
    sajax_export("ajax_terceros_validate_proveedor");
    sajax_export("ajax_terceros_validate_empleado");
    sajax_export("ajax_terceros_validate_es_tecnico");
    sajax_export("ajax_terceros_validate_activo");
    sajax_export("ajax_terceros_validate_credito");
    sajax_export("ajax_terceros_validate_cupo");
    sajax_export("ajax_terceros_validate_cupodis");
    sajax_export("ajax_terceros_validate_dias_credito");
    sajax_export("ajax_terceros_validate_dias_mora");
    sajax_export("ajax_terceros_validate_efec_retencion");
    sajax_export("ajax_terceros_validate_listaprecios");
    sajax_export("ajax_terceros_validate_loatiende");
    sajax_export("ajax_terceros_validate_autorizado");
    sajax_export("ajax_terceros_validate_relleno2");
    sajax_export("ajax_terceros_validate_nacimiento");
    sajax_export("ajax_terceros_validate_detalle_tributario");
    sajax_export("ajax_terceros_validate_responsabilidad_fiscal");
    sajax_export("ajax_terceros_validate_ciiu");
    sajax_export("ajax_terceros_validate_sucur_cliente");
    sajax_export("ajax_terceros_validate_sucursales");
    sajax_export("ajax_terceros_validate_fechault");
    sajax_export("ajax_terceros_validate_saldo");
    sajax_export("ajax_terceros_validate_afiliacion");
    sajax_export("ajax_terceros_validate_es_cajero");
    sajax_export("ajax_terceros_validate_cupo_vendedor");
    sajax_export("ajax_terceros_validate_autoretenedor");
    sajax_export("ajax_terceros_validate_creditoprov");
    sajax_export("ajax_terceros_validate_dias");
    sajax_export("ajax_terceros_validate_url");
    sajax_export("ajax_terceros_validate_contacto");
    sajax_export("ajax_terceros_validate_telefonos_prov");
    sajax_export("ajax_terceros_validate_email");
    sajax_export("ajax_terceros_validate_fechultcomp");
    sajax_export("ajax_terceros_validate_saldoapagar");
    sajax_export("ajax_terceros_validate_codigo_ter");
    ...
    sajax_export("ajax_terceros_event_credito_onchange");
    sajax_export("ajax_terceros_event_creditoprov_onchange");
    sajax_export("ajax_terceros_event_cupo_onchange");
    sajax_export("ajax_terceros_event_documento_onchange");
    sajax_export("ajax_terceros_event_nombre1_onchange");
    sajax_export("ajax_terceros_event_nombre2_onchange");
    sajax_export("ajax_terceros_event_nombre_comercil_onchange");
...
if (isset($_POST['wizard_action']) && 'change_step' == $_POST['wizard_action']) {
    $inicial_terceros->contr_terceros->NM_ajax_info['param']['buffer_output'] = true;
    ob_start();
}

    $inicial_terceros->contr_terceros->controle();
//
    function nm_limpa_str_terceros(&$str)
    {
    ...
    function ajax_terceros_validate_tipo($tipo, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_tipo';
    ...
    function ajax_terceros_validate_regimen($regimen, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_regimen';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_tipo_documento($tipo_documento, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_tipo_documento';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_documento($documento, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_documento';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_dv($dv, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_dv';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_imagenter($imagenter, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_imagenter';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_codigo_tercero($codigo_tercero, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_codigo_tercero';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_sexo($sexo, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_sexo';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_notificar($notificar, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_notificar';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_nombre1($nombre1, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_nombre1';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_nombre2($nombre2, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_nombre2';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_apellido1($apellido1, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_apellido1';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_apellido2($apellido2, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_apellido2';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_tel_cel($tel_cel, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_tel_cel';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_urlmail($urlmail, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_urlmail';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_idtercero($idtercero, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_idtercero';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_r_social($r_social, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_r_social';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_nombres($nombres, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_nombres';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_nombre_comercil($nombre_comercil, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_nombre_comercil';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_representante($representante, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_representante';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_direccion($direccion, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_direccion';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_departamento($departamento, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_departamento';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_idmuni($idmuni, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_idmuni';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_ciudad($ciudad, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_ciudad';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_codigo_postal($codigo_postal, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_codigo_postal';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_observaciones($observaciones, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_observaciones';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_lenguaje($lenguaje, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_lenguaje';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_c_postal($c_postal, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_c_postal';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_correo_notificafe($correo_notificafe, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_correo_notificafe';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_celular_notificafe($celular_notificafe, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_celular_notificafe';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_cliente($cliente, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_cliente';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_proveedor($proveedor, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_proveedor';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_empleado($empleado, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_empleado';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_es_tecnico($es_tecnico, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_es_tecnico';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_activo($activo, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_activo';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_credito($credito, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_credito';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_cupo($cupo, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_cupo';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_cupodis($cupodis, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_cupodis';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_dias_credito($dias_credito, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_dias_credito';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_dias_mora($dias_mora, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_dias_mora';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_efec_retencion($efec_retencion, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_efec_retencion';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_listaprecios($listaprecios, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_listaprecios';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_loatiende($loatiende, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_loatiende';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_autorizado($autorizado, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_autorizado';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_relleno2($relleno2, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_relleno2';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_nacimiento($nacimiento, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_nacimiento';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_detalle_tributario($detalle_tributario, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_detalle_tributario';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_responsabilidad_fiscal($responsabilidad_fiscal, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_responsabilidad_fiscal';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_ciiu($ciiu, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_ciiu';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_sucur_cliente($sucur_cliente, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_sucur_cliente';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_sucursales($sucursales, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_sucursales';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_fechault($fechault, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_fechault';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_saldo($saldo, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_saldo';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_afiliacion($afiliacion, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_afiliacion';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_es_cajero($es_cajero, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_es_cajero';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_cupo_vendedor($cupo_vendedor, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_cupo_vendedor';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_autoretenedor($autoretenedor, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_autoretenedor';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_creditoprov($creditoprov, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_creditoprov';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_dias($dias, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_dias';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_url($url, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_url';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_contacto($contacto, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_contacto';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_telefonos_prov($telefonos_prov, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_telefonos_prov';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_email($email, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_email';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_fechultcomp($fechultcomp, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_fechultcomp';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_saldoapagar($saldoapagar, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_saldoapagar';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_codigo_ter($codigo_ter, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_codigo_ter';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_zona_clientes($zona_clientes, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_zona_clientes';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_clasificacion_clientes($clasificacion_clientes, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_clasificacion_clientes';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_puc_auxiliar_deudores($puc_auxiliar_deudores, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_puc_auxiliar_deudores';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_puc_retefuente_ventas($puc_retefuente_ventas, $script_case_init)
    {
        ...
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_puc_retefuente_ventas';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_puc_retefuente_servicios_clie($puc_retefuente_servicios_clie, $script_case_init)
    {
        ...
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_puc_retefuente_servicios_clie';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_puc_auxiliar_proveedores($puc_auxiliar_proveedores, $script_case_init)
    {
        ...
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_puc_auxiliar_proveedores';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_puc_retefuente_compras($puc_retefuente_compras, $script_case_init)
    {
        ...
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_puc_retefuente_compras';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_puc_retefuente_servicios_prov($puc_retefuente_servicios_prov, $script_case_init)
    {
        ...
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_puc_retefuente_servicios_prov';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_archivos($archivos, $script_case_init)
    {
        ...
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_archivos';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_es_restaurante($es_restaurante, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_es_restaurante';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_validate_porcentaje_propina_sugerida($porcentaje_propina_sugerida, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'validate_porcentaje_propina_sugerida';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
    ...
    function ajax_terceros_refresh_departamento($departamento, $nmgp_refresh_fields, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'refresh_departamento';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'departamento' => NM_utf8_urldecode($departamento),
    ...
    function ajax_terceros_refresh_idmuni($idmuni, $nmgp_refresh_fields, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'refresh_idmuni';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'idmuni' => NM_utf8_urldecode($idmuni),
                  'nmgp_refresh_fields' => NM_utf8_urldecode($nmgp_refresh_fields),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
    ...
    function ajax_terceros_lkpedt_refresh_zona_clientes($zona_clientes, $nmgp_refresh_fields, $script_case_init)
    {
        ...
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'lkpedt_refresh_zona_clientes';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'zona_clientes' => NM_utf8_urldecode($zona_clientes),
                  'nmgp_refresh_fields' => NM_utf8_urldecode($nmgp_refresh_fields),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
    ...
    function ajax_terceros_lkpedt_refresh_clasificacion_clientes($clasificacion_clientes, $nmgp_refresh_fields, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'lkpedt_refresh_clasificacion_clientes';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'clasificacion_clientes' => NM_utf8_urldecode($clasificacion_clientes),
                  'nmgp_refresh_fields' => NM_utf8_urldecode($nmgp_refresh_fields),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
    ...
    function ajax_terceros_event_apellido1_onchange($nombre1, $apellido1, $script_case_init)
    {
        ...
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_apellido1_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'nombre1' => NM_utf8_urldecode($nombre1),
                  'apellido1' => NM_utf8_urldecode($apellido1),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
    ...
    function ajax_terceros_event_apellido2_onchange($nombre1, $apellido2, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_apellido2_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'nombre1' => NM_utf8_urldecode($nombre1),
                  'apellido2' => NM_utf8_urldecode($apellido2),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
    ...
    function ajax_terceros_event_cliente_onchange($idtercero, $cliente, $credito, $cupodis, $cupo, $efec_retencion, $listaprecios, $loatiende, $proveedor, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_cliente_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'idtercero' => NM_utf8_urldecode($idtercero),
                  'cliente' => NM_utf8_urldecode($cliente),
                  'credito' => NM_utf8_urldecode($credito),
    ...
    function ajax_terceros_event_credito_onchange($credito, $dias_credito, $dias_mora, $cupo, $cupodis, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_credito_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'credito' => NM_utf8_urldecode($credito),
                  'dias_credito' => NM_utf8_urldecode($dias_credito),
                  'dias_mora' => NM_utf8_urldecode($dias_mora),
    ...
    function ajax_terceros_event_creditoprov_onchange($creditoprov, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_creditoprov_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'creditoprov' => NM_utf8_urldecode($creditoprov),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
    ...
    function ajax_terceros_event_cupo_onchange($cupodis, $cupo, $saldo, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_cupo_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'cupodis' => NM_utf8_urldecode($cupodis),
                  'cupo' => NM_utf8_urldecode($cupo),
                  'saldo' => NM_utf8_urldecode($saldo),
    ...
    function ajax_terceros_event_documento_onchange($tipo_documento, $dv, $documento, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_documento_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'tipo_documento' => NM_utf8_urldecode($tipo_documento),
                  'dv' => NM_utf8_urldecode($dv),
                  'documento' => NM_utf8_urldecode($documento),
    ...
    function ajax_terceros_event_nombre1_onchange($nombre1, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_nombre1_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'nombre1' => NM_utf8_urldecode($nombre1),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
    ...
    function ajax_terceros_event_nombre2_onchange($nombre1, $nombre2, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_nombre2_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'nombre1' => NM_utf8_urldecode($nombre1),
                  'nombre2' => NM_utf8_urldecode($nombre2),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
    ...
    function ajax_terceros_event_nombre_comercil_onchange($tipo, $nombres, $nombre_comercil, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_nombre_comercil_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'tipo' => NM_utf8_urldecode($tipo),
                  'nombres' => NM_utf8_urldecode($nombres),
                  'nombre_comercil' => NM_utf8_urldecode($nombre_comercil),
    ...
    function ajax_terceros_event_nombres_onblur($nombres, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_nombres_onblur';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'nombres' => NM_utf8_urldecode($nombres),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
    ...
    function ajax_terceros_event_nombres_onfocus($nombre1, $nombres, $nombre2, $apellido1, $apellido2, $tipo, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_nombres_onfocus';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'nombre1' => NM_utf8_urldecode($nombre1),
                  'nombres' => NM_utf8_urldecode($nombres),
                  'nombre2' => NM_utf8_urldecode($nombre2),
    ...
    function ajax_terceros_event_proveedor_onchange($proveedor, $autoretenedor, $creditoprov, $dias, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_proveedor_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'proveedor' => NM_utf8_urldecode($proveedor),
                  'autoretenedor' => NM_utf8_urldecode($autoretenedor),
                  'creditoprov' => NM_utf8_urldecode($creditoprov),
    ...
    function ajax_terceros_event_r_social_onchange($tipo, $r_social, $nombre2, $apellido2, $nombres, $nombre1, $apellido1, $script_case_init)
    {
        ...
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_r_social_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'tipo' => NM_utf8_urldecode($tipo),
                  'r_social' => NM_utf8_urldecode($r_social),
                  'nombre2' => NM_utf8_urldecode($nombre2),
    ...
    function ajax_terceros_event_regimen_onchange($regimen, $tipo_documento, $dv, $documento, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_regimen_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'regimen' => NM_utf8_urldecode($regimen),
                  'tipo_documento' => NM_utf8_urldecode($tipo_documento),
                  'dv' => NM_utf8_urldecode($dv),
    ...
    function ajax_terceros_event_sucur_cliente_onchange($idtercero, $sucur_cliente, $idmuni, $direccion, $tel_cel, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_sucur_cliente_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'idtercero' => NM_utf8_urldecode($idtercero),
                  'sucur_cliente' => NM_utf8_urldecode($sucur_cliente),
                  'idmuni' => NM_utf8_urldecode($idmuni),
    ...
    function ajax_terceros_event_tipo_documento_onchange($tipo_documento, $dv, $documento, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_tipo_documento_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'tipo_documento' => NM_utf8_urldecode($tipo_documento),
                  'dv' => NM_utf8_urldecode($dv),
                  'documento' => NM_utf8_urldecode($documento),
    ...
    function ajax_terceros_event_tipo_onchange($tipo, $regimen, $efec_retencion, $tipo_documento, $nombre_comercil, $representante, $nombre1, $apellido1, $nombre2, $apellido2, $r_social, $documento, $dv, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'event_tipo_onchange';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'tipo' => NM_utf8_urldecode($tipo),
                  'regimen' => NM_utf8_urldecode($regimen),
                  'efec_retencion' => NM_utf8_urldecode($efec_retencion),
    ...
    function ajax_terceros_submit_form($tipo, $regimen, $tipo_documento, $documento, $dv, $imagenter, $codigo_tercero, $sexo, $notificar, $nombre1, $nombre2, $apellido1, $apellido2, $tel_cel, $urlmail, $idtercero, $r_social, $nombres, $nombre_comercil, $representante, $direccion, $departamento, $idmuni, $ciudad, $codigo_postal, $observaciones, $lenguaje, $c_postal, $correo_notificafe, $celular_notificafe, $cliente, $proveedor, $empleado, $es_tecnico, $activo, $credito, $cupo, $cupodis, $dias_credito, $dias_mora, $efec_retencion, $listaprecios, $loatiende, $autorizado, $relleno2, $nacimiento, $detalle_tributario, $responsabilidad_fiscal, $ciiu, $sucur_cliente, $sucursales, $fechault, $saldo, $afiliacion, $es_cajero, $cupo_vendedor, $autoretenedor, $creditoprov, $dias, $url, $contacto, $telefonos_prov, $email, $fechultcomp, $saldoapagar, $codigo_ter, $zona_clientes, $clasificacion_clientes, $puc_auxiliar_deudores, $puc_retefuente_ventas, $puc_retefuente_servicios_clie, $puc_auxiliar_proveedores, $puc_retefuente_compras, $puc_retefuente_servicios_prov, $archivo_cedula, $archivo_rut, $archivo_nit, $archivo_pago, $id_plan, $valor_plan, $fecha_registro_fe, $nombre_contador, $estado, $si_nomina, $n_trabajadores, $si_factura_electronica, $nombre_empresa_bd, $es_restaurante, $porcentaje_propina_sugerida, $imagenter_ul_name, $imagenter_ul_type, $archivo_cedula_ul_name, $archivo_cedula_ul_type, $archivo_rut_ul_name, $archivo_rut_ul_type, $archivo_nit_ul_name, $archivo_nit_ul_type, $archivo_pago_ul_name, $archivo_pago_ul_type, $imagenter_limpa, $archivo_cedula_salva, $archivo_cedula_limpa, $archivo_rut_salva, $archivo_rut_limpa, $archivo_nit_salva, $archivo_nit_limpa, $archivo_pago_salva, $archivo_pago_limpa, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        ...
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'submit_form';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'tipo' => NM_utf8_urldecode($tipo),
                  'regimen' => NM_utf8_urldecode($regimen),
                  'tipo_documento' => NM_utf8_urldecode($tipo_documento),
    ...
    function ajax_terceros_navigate_form($idtercero, $nm_form_submit, $nmgp_opcao, $nmgp_ordem, $nmgp_fast_search, $nmgp_cond_fast_search, $nmgp_arg_fast_search, $nmgp_arg_dyn_search, $script_case_init)
    {
        global $inicial_terceros;
        //register_shutdown_function("terceros_pack_ajax_response");
        $inicial_terceros->contr_terceros->NM_ajax_flag          = true;
        $inicial_terceros->contr_terceros->NM_ajax_opcao         = 'navigate_form';
        $inicial_terceros->contr_terceros->NM_ajax_info['param'] = array(
                  'idtercero' => NM_utf8_urldecode($idtercero),
                  'nm_form_submit' => NM_utf8_urldecode($nm_form_submit),
                  'nmgp_opcao' => NM_utf8_urldecode($nmgp_opcao),
   ...
   function terceros_pack_ajax_response()
   {
      global $inicial_terceros;
      $aResp = array();

      if (isset($inicial_terceros->contr_terceros->NM_ajax_info['wizard']))
      {
          $aResp['wizard'] = $inicial_terceros->contr_terceros->NM_ajax_info['wizard'];
      }
      if (isset($inicial_terceros->contr_terceros->NM_ajax_info['empty_filter']))
      {
          $aResp['empty_filter'] = $inicial_terceros->contr_terceros->NM_ajax_info['empty_filter'];
      }
      if (isset($inicial_terceros->contr_terceros->NM_ajax_info['dyn_search']['NM_Dynamic_Search']))
      {
          $aResp['dyn_search']['NM_Dynamic_Search'] = $inicial_terceros->contr_terceros->NM_ajax_info['dyn_search']['NM_Dynamic_Search'];
      }
      if (isset($inicial_terceros->contr_terceros->NM_ajax_info['dyn_search']['id_dyn_search_cmd_str']))
      {
          $aResp['dyn_search']['id_dyn_search_cmd_str'] = $inicial_terceros->contr_terceros->NM_ajax_info['dyn_search']['id_dyn_search_cmd_str'];
      }
      if ($inicial_terceros->contr_terceros->NM_ajax_info['calendarReload'])
      {
         $aResp['result'] = 'CALENDARRELOAD';
      }
      elseif ('' != $inicial_terceros->contr_terceros->NM_ajax_info['autoComp'])
      {
         $aResp['result'] = 'AUTOCOMP';
      }
//mestre_detalhe
      elseif (!empty($inicial_terceros->contr_terceros->NM_ajax_info['newline']))
      {
         $aResp['result'] = 'NEWLINE';
         ob_end_clean();
      }
      elseif (!empty($inicial_terceros->contr_terceros->NM_ajax_info['tableRefresh']))
      {
         $aResp['result'] = 'TABLEREFRESH';
      }
//-----
      elseif (!empty($inicial_terceros->contr_terceros->NM_ajax_info['errList']))
      {
         $aResp['result'] = 'ERROR';
      }
      elseif (!empty($inicial_terceros->contr_terceros->NM_ajax_info['fldList']))
      {
         $aResp['result'] = 'SET';
      }
      else
      ...
      {
         $aResp = $inicial_terceros->contr_terceros->NM_ajax_info['autoComp'];
      }
//mestre_detalhe
      elseif ('NEWLINE' == $aResp['result'])
      {
         $aResp = $inicial_terceros->contr_terceros->NM_ajax_info['newline'];
      }
      else
//-----
      {
         $aResp['ajaxRequest'] = $inicial_terceros->contr_terceros->NM_ajax_opcao;
         if ('CALENDARRELOAD' == $aResp['result'])
         {
            terceros_pack_calendar_reload($aResp);
         }
         elseif ('ERROR' == $aResp['result'])
         {
            terceros_pack_ajax_errors($aResp);
         }
         elseif ('SET' == $aResp['result'])
         {
            terceros_pack_ajax_set_fields($aResp);
         }
         elseif ('TABLEREFRESH' == $aResp['result'])
         {
            terceros_pack_ajax_set_fields($aResp);
            $aResp['tableRefresh'] = terceros_pack_protect_string($inicial_terceros->contr_terceros->NM_ajax_info['tableRefresh']);
         }
         if ('OK' == $aResp['result'] || 'SET' == $aResp['result'])
         {
            terceros_pack_ajax_ok($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['focus']) && '' != $inicial_terceros->contr_terceros->NM_ajax_info['focus'])
         {
            $aResp['setFocus'] = $inicial_terceros->contr_terceros->NM_ajax_info['focus'];
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['closeLine']) && '' != $inicial_terceros->contr_terceros->NM_ajax_info['closeLine'])
         {
            $aResp['closeLine'] = $inicial_terceros->contr_terceros->NM_ajax_info['closeLine'];
         }
         else
         {
            $aResp['closeLine'] = 'N';
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['clearUpload']) && '' != $inicial_terceros->contr_terceros->NM_ajax_info['clearUpload'])
         {
            $aResp['clearUpload'] = $inicial_terceros->contr_terceros->NM_ajax_info['clearUpload'];
         }
         else
         {
            $aResp['clearUpload'] = 'N';
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['btnDisabled']) && '' != $inicial_terceros->contr_terceros->NM_ajax_info['btnDisabled'])
         {
            terceros_pack_btn_disabled($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['btnLabel']) && '' != $inicial_terceros->contr_terceros->NM_ajax_info['btnLabel'])
         {
            terceros_pack_btn_label($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['varList']) && !empty($inicial_terceros->contr_terceros->NM_ajax_info['varList']))
         {
            terceros_pack_var_list($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['masterValue']) && '' != $inicial_terceros->contr_terceros->NM_ajax_info['masterValue'])
         {
            terceros_pack_master_value($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxAlert']) && '' != $inicial_terceros->contr_terceros->NM_ajax_info['ajaxAlert'])
         {
            terceros_pack_ajax_alert($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']) && '' != $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage'])
         {
            terceros_pack_ajax_message($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxJavascript']) && '' != $inicial_terceros->contr_terceros->NM_ajax_info['ajaxJavascript'])
         {
            terceros_pack_ajax_javascript($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['redir']) && !empty($inicial_terceros->contr_terceros->NM_ajax_info['redir']))
         {
            terceros_pack_ajax_redir($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['redirExit']) && !empty($inicial_terceros->contr_terceros->NM_ajax_info['redirExit']))
         {
            terceros_pack_ajax_redir_exit($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['blockDisplay']) && !empty($inicial_terceros->contr_terceros->NM_ajax_info['blockDisplay']))
         {
            terceros_pack_ajax_block_display($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['fieldDisplay']) && !empty($inicial_terceros->contr_terceros->NM_ajax_info['fieldDisplay']))
         {
            terceros_pack_ajax_field_display($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['buttonDisplay']) && !empty($inicial_terceros->contr_terceros->NM_ajax_info['buttonDisplay']))
         {
            $inicial_terceros->contr_terceros->NM_ajax_info['buttonDisplay'] = $inicial_terceros->contr_terceros->nmgp_botoes;
            terceros_pack_ajax_button_display($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['buttonDisplayVert']) && !empty($inicial_terceros->contr_terceros->NM_ajax_info['buttonDisplayVert']))
         {
            terceros_pack_ajax_button_display_vert($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['fieldLabel']) && !empty($inicial_terceros->contr_terceros->NM_ajax_info['fieldLabel']))
         {
            terceros_pack_ajax_field_label($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['readOnly']) && !empty($inicial_terceros->contr_terceros->NM_ajax_info['readOnly']))
         {
            terceros_pack_ajax_readonly($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['navStatus']) && !empty($inicial_terceros->contr_terceros->NM_ajax_info['navStatus']))
         {
            terceros_pack_ajax_nav_status($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['navSummary']) && !empty($inicial_terceros->contr_terceros->NM_ajax_info['navSummary']))
         {
            terceros_pack_ajax_nav_Summary($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['navPage']))
         {
            terceros_pack_ajax_navPage($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['btnVars']) && !empty($inicial_terceros->contr_terceros->NM_ajax_info['btnVars']))
         {
            terceros_pack_ajax_btn_vars($aResp);
         }
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['quickSearchRes']) && $inicial_terceros->contr_terceros->NM_ajax_info['quickSearchRes'])
         {
         ...
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['event_field']) && '' != $inicial_terceros->contr_terceros->NM_ajax_info['event_field'])
         {
            $aResp['eventField'] = $inicial_terceros->contr_terceros->NM_ajax_info['event_field'];
         }
         else
         {
         ...
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['param']['buffer_output']) && $inicial_terceros->contr_terceros->NM_ajax_info['param']['buffer_output'])
         {
            ...
            {
               $aResp['htmOutput'] = terceros_pack_protect_string(NM_charset_to_utf8($aResp['htmOutput']));
               ob_end_clean();
            }
         }
      }
   ...
   function terceros_pack_calendar_reload(&$aResp)
   {
      global $inicial_terceros;
      $aResp['calendarReload'] = 'OK';
   } // terceros_pack_calendar_reload

   function terceros_pack_ajax_errors(&$aResp)
   {
      global $inicial_terceros;
      $aResp['errList'] = array();
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['errList'] as $sField => $aMsg)
      {
         if ('geral_terceros' == $sField)
         {
             $aMsg = terceros_pack_ajax_remove_erros($aMsg);
         }
         foreach ($aMsg as $sMsg)
         {
            $iNumLinha = (isset($inicial_terceros->contr_terceros->NM_ajax_info['param']['nmgp_refresh_row']) && 'geral_terceros' != $sField)
                       ? $inicial_terceros->contr_terceros->NM_ajax_info['param']['nmgp_refresh_row'] : "";
            $aResp['errList'][] = array('fldName'  => $sField,
                                        'msgText'  => terceros_pack_protect_string(NM_charset_to_utf8($sMsg)),
                                        'numLinha' => $iNumLinha);
         }
      }
   } // terceros_pack_ajax_errors

   function terceros_pack_ajax_remove_erros($aErrors)
   {
       $aNewErrors = array();
       if (!empty($aErrors))
       {
       ...
       return $aNewErrors;
   } // terceros_pack_ajax_remove_erros

   function terceros_pack_ajax_ok(&$aResp)
   {
      global $inicial_terceros;
      $iNumLinha = (isset($inicial_terceros->contr_terceros->NM_ajax_info['param']['nmgp_refresh_row']))
                 ? $inicial_terceros->contr_terceros->NM_ajax_info['param']['nmgp_refresh_row'] : "";
      $aResp['msgDisplay'] = array('msgText'  => terceros_pack_protect_string($inicial_terceros->contr_terceros->NM_ajax_info['msgDisplay']),
                                   'numLinha' => $iNumLinha);
   } // terceros_pack_ajax_ok

   function terceros_pack_ajax_set_fields(&$aResp)
   {
      global $inicial_terceros;
      $iNumLinha = (isset($inicial_terceros->contr_terceros->NM_ajax_info['param']['nmgp_refresh_row']))
                 ? $inicial_terceros->contr_terceros->NM_ajax_info['param']['nmgp_refresh_row'] : "";
      if ('' != $inicial_terceros->contr_terceros->NM_ajax_info['rsSize'])
      {
         $aResp['rsSize'] = $inicial_terceros->contr_terceros->NM_ajax_info['rsSize'];
      }
      $aResp['fldList'] = array();
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['fldList'] as $sField => $aData)
      {
         $aField = array();
         ...
         {
            $aField['imgFile'] = terceros_pack_protect_string($aData['imgFile']);
         }
         if (isset($aData['imgOrig']))
         {
            $aField['imgOrig'] = terceros_pack_protect_string($aData['imgOrig']);
         }
         if (isset($aData['imgLink']))
         {
            $aField['imgLink'] = terceros_pack_protect_string($aData['imgLink']);
         }
         ...
         {
            $aField['docLink'] = terceros_pack_protect_string($aData['docLink']);
         }
         if (isset($aData['docIcon']))
         {
            $aField['docIcon'] = terceros_pack_protect_string($aData['docIcon']);
         }
         if (isset($aData['docReadonly']))
         {
            $aField['docReadonly'] = terceros_pack_protect_string($aData['docReadonly']);
         }
         ...
         {
            $aField['imgHtml'] = terceros_pack_protect_string($aData['imgHtml']);
         }
         if (isset($aData['mulHtml']))
         {
            $aField['mulHtml'] = terceros_pack_protect_string($aData['mulHtml']);
         }
         ...
         foreach ($aData['valList'] as $iIndex => $sValue)
         {
            ...
            {
               $aValue['label'] = terceros_pack_protect_string($aData['labList'][$iIndex]);
            }
            $aValue['value']     = ('_autocomp' != substr($sField, -9)) ? terceros_pack_protect_string($sValue) : $sValue;
            ...
            if (is_array($aData['optList']))
            {
               ...
               foreach ($aData['optList'] as $aOptList)
               {
                  foreach ($aOptList as $sValue => $sLabel)
                  {
                     ...
                     $aField['optList'][] = array('value' => terceros_pack_protect_string($sOpt),
                                                  'label' => terceros_pack_protect_string($sLabel));
                  }
               }
            }
            else
   ...
   } // terceros_pack_ajax_set_fields

   function terceros_pack_ajax_redir(&$aResp)
   {
      global $inicial_terceros;
      ...
      {
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['redir'][$sTag]))
         {
            $aResp['redirInfo'][$sTag] = $inicial_terceros->contr_terceros->NM_ajax_info['redir'][$sTag];
         }
      }
   } // terceros_pack_ajax_redir

   function terceros_pack_ajax_redir_exit(&$aResp)
   {
      global $inicial_terceros;
      ...
      foreach ($aInfo as $sTag)
      {
         if (isset($inicial_terceros->contr_terceros->NM_ajax_info['redirExit'][$sTag]))
         {
            $aResp['redirExitInfo'][$sTag] = $inicial_terceros->contr_terceros->NM_ajax_info['redirExit'][$sTag];
         }
      }
   } // terceros_pack_ajax_redir_exit

   function terceros_pack_var_list(&$aResp)
   {
      global $inicial_terceros;
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['varList'] as $varData)
      {
         $aResp['varList'][] = array('index' => key($varData),
                                      'value' => current($varData));
      }
   } // terceros_pack_var_list

   function terceros_pack_master_value(&$aResp)
   {
      global $inicial_terceros;
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['masterValue'] as $sIndex => $sValue)
      {
         $aResp['masterValue'][] = array('index' => $sIndex,
                                         'value' => $sValue);
      }
   } // terceros_pack_master_value

   function terceros_pack_btn_disabled(&$aResp)
   {
      global $inicial_terceros;
      $aResp['btnDisabled'] = array();
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['btnDisabled'] as $btnName => $btnStatus) {
        $aResp['btnDisabled'][$btnName] = $btnStatus;
      }
   } // terceros_pack_ajax_alert

   function terceros_pack_btn_label(&$aResp)
   {
      global $inicial_terceros;
      $aResp['btnLabel'] = array();
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['btnLabel'] as $btnName => $btnLabel) {
        $aResp['btnLabel'][$btnName] = $btnLabel;
      }
   } // terceros_pack_ajax_alert

   function terceros_pack_ajax_alert(&$aResp)
   {
      global $inicial_terceros;
      $aResp['ajaxAlert'] = array('message' => $inicial_terceros->contr_terceros->NM_ajax_info['ajaxAlert']['message'], 'params' =>  $inicial_terceros->contr_terceros->NM_ajax_info['ajaxAlert']['params']);
   } // terceros_pack_ajax_alert

   function terceros_pack_ajax_message(&$aResp)
   {
      global $inicial_terceros;
      $aResp['ajaxMessage'] = array('message'      => terceros_pack_protect_string($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['message']),
                                    'title'        => terceros_pack_protect_string($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['title']),
                                    'modal'        => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['modal'])        ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['modal']        : 'N',
                                    'timeout'      => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['timeout'])      ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['timeout']      : '',
                                    'button'       => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['button'])       ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['button']       : '',
                                    'button_label' => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['button_label']) ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['button_label'] : 'Ok',
                                    'top'          => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['top'])          ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['top']          : '',
                                    'left'         => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['left'])         ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['left']         : '',
                                    'width'        => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['width'])        ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['width']        : '',
                                    'height'       => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['height'])       ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['height']       : '',
                                    'redir'        => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['redir'])        ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['redir']        : '',
                                    'show_close'   => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['show_close'])   ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['show_close']   : 'Y',
                                    'body_icon'    => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['body_icon'])    ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['body_icon']    : 'Y',
                                    'toast'        => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['toast'])        ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['toast']        : 'N',
                                    'toast_pos'    => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['toast_pos'])    ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['toast_pos']    : '',
                                    'type'         => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['type'])         ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['type']         : '',
                                    'redir_target' => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['redir_target']) ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['redir_target'] : '',
                                    'redir_par'    => isset($inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['redir_par'])    ? $inicial_terceros->contr_terceros->NM_ajax_info['ajaxMessage']['redir_par']    : '');
   } // terceros_pack_ajax_message

   function terceros_pack_ajax_javascript(&$aResp)
   {
      global $inicial_terceros;
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['ajaxJavascript'] as $aJsFunc)
      {
         $aResp['ajaxJavascript'][] = $aJsFunc;
      }
   } // terceros_pack_ajax_javascript

   function terceros_pack_ajax_block_display(&$aResp)
   {
      global $inicial_terceros;
      $aResp['blockDisplay'] = array();
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['blockDisplay'] as $sBlockName => $sBlockStatus)
      {
        $aResp['blockDisplay'][] = array($sBlockName, $sBlockStatus);
      }
   } // terceros_pack_ajax_block_display

   function terceros_pack_ajax_field_display(&$aResp)
   {
      global $inicial_terceros;
      $aResp['fieldDisplay'] = array();
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['fieldDisplay'] as $sFieldName => $sFieldStatus)
      {
        $aResp['fieldDisplay'][] = array($sFieldName, $sFieldStatus);
      }
   } // terceros_pack_ajax_field_display

   function terceros_pack_ajax_button_display(&$aResp)
   {
      global $inicial_terceros;
      $aResp['buttonDisplay'] = array();
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['buttonDisplay'] as $sButtonName => $sButtonStatus)
      {
        $aResp['buttonDisplay'][] = array($sButtonName, $sButtonStatus);
      }
   } // terceros_pack_ajax_button_display

   function terceros_pack_ajax_button_display_vert(&$aResp)
   {
      global $inicial_terceros;
      $aResp['buttonDisplayVert'] = array();
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['buttonDisplayVert'] as $aButtonData)
      {
        $aResp['buttonDisplayVert'][] = $aButtonData;
      }
   } // terceros_pack_ajax_button_display

   function terceros_pack_ajax_field_label(&$aResp)
   {
      global $inicial_terceros;
      $aResp['fieldLabel'] = array();
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['fieldLabel'] as $sFieldName => $sFieldLabel)
      {
        $aResp['fieldLabel'][] = array($sFieldName, terceros_pack_protect_string($sFieldLabel));
      }
   } // terceros_pack_ajax_field_label

   function terceros_pack_ajax_readonly(&$aResp)
   {
      global $inicial_terceros;
      $aResp['readOnly'] = array();
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['readOnly'] as $sFieldName => $sFieldStatus)
      {
        $aResp['readOnly'][] = array($sFieldName, $sFieldStatus);
      }
   } // terceros_pack_ajax_readonly

   function terceros_pack_ajax_nav_status(&$aResp)
   {
      global $inicial_terceros;
      $aResp['navStatus'] = array();
      if (isset($inicial_terceros->contr_terceros->NM_ajax_info['navStatus']['ret']) && '' != $inicial_terceros->contr_terceros->NM_ajax_info['navStatus']['ret'])
      {
         $aResp['navStatus']['ret'] = $inicial_terceros->contr_terceros->NM_ajax_info['navStatus']['ret'];
      }
      if (isset($inicial_terceros->contr_terceros->NM_ajax_info['navStatus']['ava']) && '' != $inicial_terceros->contr_terceros->NM_ajax_info['navStatus']['ava'])
      {
         $aResp['navStatus']['ava'] = $inicial_terceros->contr_terceros->NM_ajax_info['navStatus']['ava'];
      }
   } // terceros_pack_ajax_nav_status

   function terceros_pack_ajax_nav_Summary(&$aResp)
   {
      global $inicial_terceros;
      $aResp['navSummary'] = array();
      $aResp['navSummary']['reg_ini'] = $inicial_terceros->contr_terceros->NM_ajax_info['navSummary']['reg_ini'];
      $aResp['navSummary']['reg_qtd'] = $inicial_terceros->contr_terceros->NM_ajax_info['navSummary']['reg_qtd'];
      $aResp['navSummary']['reg_tot'] = $inicial_terceros->contr_terceros->NM_ajax_info['navSummary']['reg_tot'];
   } // terceros_pack_ajax_nav_Summary

   function terceros_pack_ajax_navPage(&$aResp)
   {
      global $inicial_terceros;
      $aResp['navPage'] = $inicial_terceros->contr_terceros->NM_ajax_info['navPage'];
   } // terceros_pack_ajax_navPage


   function terceros_pack_ajax_btn_vars(&$aResp)
   {
      global $inicial_terceros;
      $aResp['btnVars'] = array();
      foreach ($inicial_terceros->contr_terceros->NM_ajax_info['btnVars'] as $sBtnName => $sBtnValue)
      {
        $aResp['btnVars'][] = array($sBtnName, terceros_pack_protect_string($sBtnValue));
      }
   } // terceros_pack_ajax_btn_vars

   function terceros_pack_protect_string($sString)
   {
