<div id="terceros_form1" style='<?php echo ($this->tabCssClass["terceros_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $sStyleHidden_empleado_dumb = ('' == $sStyleHidden_empleado) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_empleado_dumb" style="<?php echo $sStyleHidden_empleado_dumb; ?>"></TD>
<?php $sStyleHidden_es_tecnico_dumb = ('' == $sStyleHidden_es_tecnico) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_es_tecnico_dumb" style="<?php echo $sStyleHidden_es_tecnico_dumb; ?>"></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_credito'][] = 'NO'; ?>
 <option  value="SI" <?php  if ($this->credito == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_credito'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<?php $sStyleHidden_dias_credito_dumb = ('' == $sStyleHidden_dias_credito) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dias_credito_dumb" style="<?php echo $sStyleHidden_dias_credito_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_efec_retencion'][] = 'N'; ?>
 <option  value="S" <?php  if ($this->efec_retencion == "S") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_efec_retencion'][] = 'S'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_listaprecios'][] = '1'; ?>
 <option  value="2" <?php  if ($this->listaprecios == "2") { echo " selected" ;} ?>>Precio Intermedio</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_listaprecios'][] = '2'; ?>
 <option  value="3" <?php  if ($this->listaprecios == "3") { echo " selected" ;} ?>>Precio Mínimo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_listaprecios'][] = '3'; ?>
 </select></span>
</span><?php  }?>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_loatiende']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_loatiende'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_loatiende']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_loatiende'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_loatiende'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_loatiende'][] = ''; 
...
<?php } 
?> 
<?php $sStyleHidden_dias_mora_dumb = ('' == $sStyleHidden_dias_mora) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dias_mora_dumb" style="<?php echo $sStyleHidden_dias_mora_dumb; ?>"></TD>
<?php $sStyleHidden_efec_retencion_dumb = ('' == $sStyleHidden_efec_retencion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_efec_retencion_dumb" style="<?php echo $sStyleHidden_efec_retencion_dumb; ?>"></TD>
<?php $sStyleHidden_listaprecios_dumb = ('' == $sStyleHidden_listaprecios) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_listaprecios_dumb" style="<?php echo $sStyleHidden_listaprecios_dumb; ?>"></TD>
<?php $sStyleHidden_loatiende_dumb = ('' == $sStyleHidden_loatiende) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_loatiende_dumb" style="<?php echo $sStyleHidden_loatiende_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<span id="id_read_on_autorizado" class="css_autorizado_line" style="<?php echo $sStyleReadLab_autorizado; ?>"><?php echo $this->form_format_readonly("autorizado", $this->form_encode_input($autorizado_look)); ?></span><span id="id_read_off_autorizado" class="css_read_off_autorizado css_autorizado_line" style="<?php echo $sStyleReadInp_autorizado; ?>"><?php echo "<div id=\"idAjaxCheckbox_autorizado\" style=\"display: inline-block\" class=\"css_autorizado_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros']['Lookup_autorizado'][] = 'SI'; ?>
...
<?php } ?>
<?php $sStyleHidden_autorizado_dumb = ('' == $sStyleHidden_autorizado) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_autorizado_dumb" style="<?php echo $sStyleHidden_autorizado_dumb; ?>"></TD>
...
<?php $sStyleHidden_detalle_tributario_dumb = ('' == $sStyleHidden_detalle_tributario) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_detalle_tributario_dumb" style="<?php echo $sStyleHidden_detalle_tributario_dumb; ?>"></TD>
<?php $sStyleHidden_responsabilidad_fiscal_dumb = ('' == $sStyleHidden_responsabilidad_fiscal) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_responsabilidad_fiscal_dumb" style="<?php echo $sStyleHidden_responsabilidad_fiscal_dumb; ?>"></TD>
