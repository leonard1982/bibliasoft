...
class grid_facturaven_LN_111019_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_facturaven_LN_111019.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['grid_facturaven_LN_111019']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_LN_111019']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_LN_111019']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_LN_111019']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_LN_111019']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_LN_111019']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_LN_111019']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_facturaven_LN_111019']['contr_erro'] = 'off'; 
   ...
   function NM_export_estadofe()
   {
         ...
         $this->estadofe = str_replace('<', '&lt;', $this->estadofe);
         $this->estadofe = str_replace('>', '&gt;', $this->estadofe);
         $this->Texto_tag .= "<td>" . $this->estadofe . "</td>\r\n";
   }
   //----- enviarfe
   function NM_export_enviarfe()
   {
         ...
         $this->enviarfe = str_replace('<', '&lt;', $this->enviarfe);
         $this->enviarfe = str_replace('>', '&gt;', $this->enviarfe);
         $this->Texto_tag .= "<td>" . $this->enviarfe . "</td>\r\n";
   }
   //----- pdf
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_LN_111019']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_LN_111019']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
