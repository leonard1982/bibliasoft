...
<?php
   ...
   $Ord_Cmp = new grid_facturaven_LN_111019_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_facturaven_LN_111019_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["resolucion"] : "PJ";
   $tab_ger_campos['numfacven'] = "on";
   $tab_def_campos['numfacven'] = "numfacven";
   $tab_labels["numfacven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["numfacven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["numfacven"] : "Número";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["idcli"] : "Cliente";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["fechaven"] : "Fecha";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["total"] : "Total";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["pagada"] : "Pagada";
   $tab_ger_campos['asentada'] = "on";
   $tab_def_campos['asentada'] = "asentada";
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["asentada"] : "Asentada";
   $tab_ger_campos['credito'] = "on";
   $tab_def_campos['credito'] = "credito";
   $tab_labels["credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["credito"] : "Crédito";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["imprimir"] : "imprimir";
   ...
   $tab_labels["imprmirtirilla"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["imprmirtirilla"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["imprmirtirilla"] : "POS";
   $tab_ger_campos['estadofe'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['estadofe'] = "estadofe";
   }
   else
   {
       $tab_def_campos['estadofe'] = "";
   }
   $tab_labels["estadofe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["estadofe"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["estadofe"] : "Estado";
   $tab_ger_campos['enviarfe'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['enviarfe'] = "enviarfe";
   }
   else
   {
       $tab_def_campos['enviarfe'] = "";
   }
   $tab_labels["enviarfe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["enviarfe"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["enviarfe"] : "Enviar";
   ...
   $tab_labels["pdf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["pdf"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['labels']["pdf"] : "PDF";
   $tab_ger_campos['imprimir'] = "none";
   $tab_ger_campos['imprmirtirilla'] = "none";
   $tab_ger_campos['estadofe'] = "none";
   $tab_ger_campos['enviarfe'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['graf_lab'] = "";
?>
    <script language="javascript"> 
<?php
   if (!$embbed)
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_facturaven_LN_111019_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_facturaven_LN_111019']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
