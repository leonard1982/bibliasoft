...
class grid_ventas_por_cliente_gantt
{
    var $Db;
    var $Erro;
    var $Ini;
    ...
    function grid_ventas_por_cliente_gantt()
    {
    ...
    function displayChart()
    {
        ...
        if (!$this->chart_only)
        {
            ...
            $nm_saida->saida(" <title>grid_ventas_por_cliente</title>\r\n");
        ...
        else
        {
            ...
            @fwrite($rTempXml, "<chart dateFormat='" . $this->output_formatted . "' caption='grid_ventas_por_cliente' ganttPaneDuration='12' ganttPaneDurationUnit='m'>\n");
