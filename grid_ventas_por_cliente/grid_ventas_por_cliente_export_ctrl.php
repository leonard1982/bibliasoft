<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ventas_por_cliente']['sc_process_barr'] = true;
require_once('../grid_ventas_por_cliente/index.php');
unset($_SESSION['scriptcase']['grid_ventas_por_cliente']['sc_process_barr']);
$ExportCtrl = new grid_ventas_por_cliente_export_control;
$ExportCtrl->Export_barr();

class grid_ventas_por_cliente_export_control
{
