<?php
@session_start() ;
$_SESSION['scriptcase']['grid_importar_articulos_TNS_0602020']['sc_process_barr'] = true;
require_once('../grid_importar_articulos_TNS_0602020/index.php');
unset($_SESSION['scriptcase']['grid_importar_articulos_TNS_0602020']['sc_process_barr']);
$ExportCtrl = new grid_importar_articulos_TNS_0602020_export_control;
$ExportCtrl->Export_barr();

class grid_importar_articulos_TNS_0602020_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_importar_articulos_TNS_0602020']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_importar_articulos_TNS_0602020']['glo_nm_path_imag_temp'];
