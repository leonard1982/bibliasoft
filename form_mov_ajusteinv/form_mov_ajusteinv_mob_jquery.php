...
function sc_form_mov_ajusteinv_idtipotran_onblur(oThis, iSeqRow) {
  do_ajax_form_mov_ajusteinv_mob_validate_idtipotran();
  scCssBlur(oThis);
}
...
function sc_form_mov_ajusteinv_fecha_onblur(oThis, iSeqRow) {
  do_ajax_form_mov_ajusteinv_mob_validate_fecha();
  scCssBlur(oThis);
}
...
function sc_form_mov_ajusteinv_idpro_onblur(oThis, iSeqRow) {
  do_ajax_form_mov_ajusteinv_mob_validate_idpro();
  scCssBlur(oThis);
}

function sc_form_mov_ajusteinv_idpro_onchange(oThis, iSeqRow) {
  do_ajax_form_mov_ajusteinv_mob_event_idpro_onchange();
}
...
function sc_form_mov_ajusteinv_cantidad_onblur(oThis, iSeqRow) {
  do_ajax_form_mov_ajusteinv_mob_validate_cantidad();
  scCssBlur(oThis);
}
...
function sc_form_mov_ajusteinv_idbodorig_onblur(oThis, iSeqRow) {
  do_ajax_form_mov_ajusteinv_mob_validate_idbodorig();
  scCssBlur(oThis);
}

function sc_form_mov_ajusteinv_idbodorig_onchange(oThis, iSeqRow) {
  do_ajax_form_mov_ajusteinv_mob_event_idbodorig_onchange();
}
...
function sc_form_mov_ajusteinv_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_form_mov_ajusteinv_mob_validate_observaciones();
  scCssBlur(oThis);
}
...
function sc_form_mov_ajusteinv_prefijonota_onblur(oThis, iSeqRow) {
  do_ajax_form_mov_ajusteinv_mob_validate_prefijonota();
  scCssBlur(oThis);
}
...
function sc_form_mov_ajusteinv_presentacion_onblur(oThis, iSeqRow) {
  do_ajax_form_mov_ajusteinv_mob_validate_presentacion();
  scCssBlur(oThis);
}
...
function sc_form_mov_ajusteinv_stcock_onblur(oThis, iSeqRow) {
  do_ajax_form_mov_ajusteinv_mob_validate_stcock();
  scCssBlur(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_mov_ajusteinv_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_mov_ajusteinv_mob_validate_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_vence" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_mov_ajusteinv_mob_validate_vence(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_mov_ajusteinv_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
