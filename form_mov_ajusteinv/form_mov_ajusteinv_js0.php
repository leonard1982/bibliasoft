...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_mov_ajusteinv"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_form_mov_ajusteinv_navigate_form();
    }
} 
...
function sc_form_onload()
{
   ...
   nm_field_disabled("prefijonota=disabled;numeronota=disabled;idtipotran=disabled;fecha=disabled;idpro=disabled;colores=disabled;tallas=disabled;sabor=disabled;cantidad=disabled;idbodorig=disabled;observaciones=disabled", "U");
