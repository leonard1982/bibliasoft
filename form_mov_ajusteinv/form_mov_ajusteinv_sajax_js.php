  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mov_ajusteinv" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_mov_ajusteinv_form();
	}
  ...
  function do_ajax_form_mov_ajusteinv_validate_prefijonota()
  {
    var nomeCampo_prefijonota = "prefijonota";
    var var_prefijonota = scAjaxGetFieldSelect(nomeCampo_prefijonota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_validate_prefijonota(var_prefijonota, var_script_case_init, do_ajax_form_mov_ajusteinv_validate_prefijonota_cb);
  } // do_ajax_form_mov_ajusteinv_validate_prefijonota

  function do_ajax_form_mov_ajusteinv_validate_prefijonota_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_validate_prefijonota_cb

  // ---------- Validate numeronota
  function do_ajax_form_mov_ajusteinv_validate_numeronota()
  {
    var nomeCampo_numeronota = "numeronota";
    var var_numeronota = scAjaxGetFieldHidden(nomeCampo_numeronota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_validate_numeronota(var_numeronota, var_script_case_init, do_ajax_form_mov_ajusteinv_validate_numeronota_cb);
  } // do_ajax_form_mov_ajusteinv_validate_numeronota

  function do_ajax_form_mov_ajusteinv_validate_numeronota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_validate_numeronota_cb

  // ---------- Validate idtipotran
  function do_ajax_form_mov_ajusteinv_validate_idtipotran()
  {
    var nomeCampo_idtipotran = "idtipotran";
    var var_idtipotran = scAjaxGetFieldSelect(nomeCampo_idtipotran);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_validate_idtipotran(var_idtipotran, var_script_case_init, do_ajax_form_mov_ajusteinv_validate_idtipotran_cb);
  } // do_ajax_form_mov_ajusteinv_validate_idtipotran

  function do_ajax_form_mov_ajusteinv_validate_idtipotran_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_validate_idtipotran_cb

  // ---------- Validate fecha
  function do_ajax_form_mov_ajusteinv_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_mov_ajusteinv_validate_fecha_cb);
  } // do_ajax_form_mov_ajusteinv_validate_fecha

  function do_ajax_form_mov_ajusteinv_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_validate_fecha_cb

  // ---------- Validate idpro
  function do_ajax_form_mov_ajusteinv_validate_idpro()
  {
    var nomeCampo_idpro = "idpro";
    var var_idpro = scAjaxGetFieldSelect(nomeCampo_idpro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_validate_idpro(var_idpro, var_script_case_init, do_ajax_form_mov_ajusteinv_validate_idpro_cb);
  } // do_ajax_form_mov_ajusteinv_validate_idpro

  function do_ajax_form_mov_ajusteinv_validate_idpro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpro";
  ...
  function do_ajax_form_mov_ajusteinv_validate_presentacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_validate_presentacion(var_presentacion, var_script_case_init, do_ajax_form_mov_ajusteinv_validate_presentacion_cb);
  } // do_ajax_form_mov_ajusteinv_validate_presentacion

  function do_ajax_form_mov_ajusteinv_validate_presentacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_mov_ajusteinv_validate_cantidad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_mov_ajusteinv_validate_cantidad_cb);
  } // do_ajax_form_mov_ajusteinv_validate_cantidad

  function do_ajax_form_mov_ajusteinv_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_validate_cantidad_cb

  // ---------- Validate idbodorig
  function do_ajax_form_mov_ajusteinv_validate_idbodorig()
  {
    var nomeCampo_idbodorig = "idbodorig";
    var var_idbodorig = scAjaxGetFieldSelect(nomeCampo_idbodorig);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_validate_idbodorig(var_idbodorig, var_script_case_init, do_ajax_form_mov_ajusteinv_validate_idbodorig_cb);
  } // do_ajax_form_mov_ajusteinv_validate_idbodorig

  function do_ajax_form_mov_ajusteinv_validate_idbodorig_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_validate_idbodorig_cb

  // ---------- Validate stcock
  function do_ajax_form_mov_ajusteinv_validate_stcock()
  {
    var nomeCampo_stcock = "stcock";
    var var_stcock = scAjaxGetFieldHidden(nomeCampo_stcock);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_validate_stcock(var_stcock, var_script_case_init, do_ajax_form_mov_ajusteinv_validate_stcock_cb);
  } // do_ajax_form_mov_ajusteinv_validate_stcock

  function do_ajax_form_mov_ajusteinv_validate_stcock_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stcock";
  ...
  function do_ajax_form_mov_ajusteinv_validate_observaciones()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_mov_ajusteinv_validate_observaciones_cb);
  } // do_ajax_form_mov_ajusteinv_validate_observaciones

  function do_ajax_form_mov_ajusteinv_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_validate_observaciones_cb

  // ---------- Refresh idpro
  function do_ajax_form_mov_ajusteinv_refresh_idpro()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_mov_ajusteinv_refresh_idpro(var_idpro, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_mov_ajusteinv_refresh_idpro_cb);
  } // do_ajax_form_mov_ajusteinv_refresh_idpro

  function do_ajax_form_mov_ajusteinv_refresh_idpro_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_refresh_idpro_cb
  ...
  function do_ajax_form_mov_ajusteinv_event_idbodorig_onchange_cb(sResp)
  {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_mov_ajusteinv_event_idbodorig_onchange_cb_after_alert);
  } // do_ajax_form_mov_ajusteinv_event_idbodorig_onchange_cb
  function do_ajax_form_mov_ajusteinv_event_idbodorig_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_mov_ajusteinv_event_idbodorig_onchange_cb_after_alert

  // ---------- Event onchange idpro
  function do_ajax_form_mov_ajusteinv_event_idpro_onchange()
  {
    var var_idpro = scAjaxGetFieldSelect("idpro");
    var var_presentacion = scAjaxGetFieldText("presentacion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_mov_ajusteinv_event_idpro_onchange(var_idpro, var_presentacion, var_script_case_init, do_ajax_form_mov_ajusteinv_event_idpro_onchange_cb);
  } // do_ajax_form_mov_ajusteinv_event_idpro_onchange

  function do_ajax_form_mov_ajusteinv_event_idpro_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idpro";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_mov_ajusteinv_event_idpro_onchange_cb_after_alert);
  } // do_ajax_form_mov_ajusteinv_event_idpro_onchange_cb
  function do_ajax_form_mov_ajusteinv_event_idpro_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_mov_ajusteinv_refresh_idpro();
    scAjaxRedir();
  } // do_ajax_form_mov_ajusteinv_event_idpro_onchange_cb_after_alert
  ...
  function do_ajax_form_mov_ajusteinv_event_seleccionarlfs_onchange_cb(sResp)
  {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_mov_ajusteinv_event_seleccionarlfs_onchange_cb_after_alert);
  } // do_ajax_form_mov_ajusteinv_event_seleccionarlfs_onchange_cb
  function do_ajax_form_mov_ajusteinv_event_seleccionarlfs_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_mov_ajusteinv_event_seleccionarlfs_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_mov_ajusteinv_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mov_ajusteinv_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mov_ajusteinv_submit_form_cb_after_alert);
  } // do_ajax_form_mov_ajusteinv_submit_form_cb
  function do_ajax_form_mov_ajusteinv_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mov_ajusteinv_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mov_ajusteinv_navigate_form()
  {
    perform_ajax_form_mov_ajusteinv_navigate_form();
  }

  function perform_ajax_form_mov_ajusteinv_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_mov_ajusteinv_navigate_form(var_idmov, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mov_ajusteinv_navigate_form_cb);
  } // do_ajax_form_mov_ajusteinv_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mov_ajusteinv_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mov_ajusteinv_navigate_form_cb_after_alert);
  } // do_ajax_form_mov_ajusteinv_navigate_form_cb
  function do_ajax_form_mov_ajusteinv_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_mov_ajusteinv_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_mov_ajusteinv_navigate_form_cb_after_alert
  function sc_hide_form_mov_ajusteinv_form()
  {
