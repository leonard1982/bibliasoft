...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->post_producto) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['post_producto'] = $this->post_producto;
      }
      if (isset($_POST["post_producto"]) && isset($this->post_producto)) 
      {
          $_SESSION['post_producto'] = $this->post_producto;
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['embutida_parms'];
      ...
      { 
          ...
          if (isset($this->post_producto)) 
          {
              $_SESSION['post_producto'] = $this->post_producto;
          }
          if (isset($this->NM_where_filter_form))
          {
              $_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->post_producto)) 
          {
              $_SESSION['post_producto'] = $this->post_producto;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_mov_ajusteinv_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_mov_ajusteinv']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_mov_ajusteinv'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_mov_ajusteinv']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_mov_ajusteinv']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_mov_ajusteinv') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_mov_ajusteinv']['label'] = "Ver Movimiento de Ajuste al Inventario";
      ...
      $_SESSION['scriptcase']['error_icon']['form_mov_ajusteinv']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_mov_ajusteinv'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_mov_ajusteinv'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_mov_ajusteinv'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_mov_ajusteinv", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_mov_ajusteinv/form_mov_ajusteinv_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_mov_ajusteinv_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_mov_ajusteinv_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_mov_ajusteinv_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_mov_ajusteinv/form_mov_ajusteinv_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_mov_ajusteinv_erro.class.php"); 
      }
      $this->Erro      = new form_mov_ajusteinv_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao']))
         { 
             if ($this->idmov != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_mov_ajusteinv']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_mov_ajusteinv']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- stcock
      $this->field_config['stcock']               = array();
      $this->field_config['stcock']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['stcock']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
...
//
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_idbodorig_onchange' == $this->NM_ajax_opcao)
          {
              $this->idbodorig_onChange();
          }
          if ('event_idpro_onchange' == $this->NM_ajax_opcao)
          {
              $this->idpro_onChange();
          }
          if ('event_seleccionarlfs_onchange' == $this->NM_ajax_opcao)
          {
              $this->seleccionarlfs_onChange();
          }
          form_mov_ajusteinv_pack_ajax_response();
          exit;
      }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['prefijonota']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->prefijonota = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['prefijonota'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['numeronota']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->numeronota = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['numeronota'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['idtipotran']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idtipotran = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['idtipotran'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['fecha']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['fecha'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['idpro']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idpro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['idpro'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['colores']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->colores = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['colores'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['tallas']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tallas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['tallas'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['sabor']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->sabor = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['sabor'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['presentacion']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->presentacion = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['presentacion'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['cantidad']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cantidad = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['cantidad'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['idbodorig']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idbodorig = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['idbodorig'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['observaciones']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->observaciones = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select']['observaciones'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['recarga'] = $this->nmgp_opcao;
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_mov_ajusteinv.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("Ver Movimiento de Ajuste al Inventario") ?></TITLE>
...
<form name="Fdown" method="get" action="form_mov_ajusteinv_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_mov_ajusteinv"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_mov_ajusteinv']) || !is_array($this->NM_ajax_info['errList']['geral_form_mov_ajusteinv']))
              {
                  $this->NM_ajax_info['errList']['geral_form_mov_ajusteinv'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_mov_ajusteinv'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ('' == $filtro || 'seleccionarlfs' == $filtro)
...
//---
      ...
      {
      $_SESSION['scriptcase']['form_mov_ajusteinv']['contr_erro'] = 'on';
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_cantidad = $this->cantidad;
    $original_stcock = $this->stcock;
}
  if(($this->stcock +$this->cantidad )<0)
	{
		
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "¡Cantidad a dar debaja supera la Existencia!";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6))
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_mov_ajusteinv' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "¡Cantidad a dar debaja supera la Existencia!";
 }
;
	}
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_stcock != $this->stcock || (isset($bFlagRead_stcock) && $bFlagRead_stcock)))
    {
        $this->ajax_return_values_stcock(true);
    }
}
$_SESSION['scriptcase']['form_mov_ajusteinv']['contr_erro'] = 'off'; 
      }
    ...
    function ValidateField_prefijonota(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
               if (!empty($this->prefijonota) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_prefijonota']) && !in_array($this->prefijonota, $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_prefijonota']))
               {
                   $hasError = true;
    ...
    function ValidateField_numeronota(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "No. Nota:: " . $this->Ini->Nm_lang['lang_errm_size']; 
    ...
    function ValidateField_idtipotran(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idtipotran) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_idtipotran']) && !in_array($this->idtipotran, $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_idtipotran']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idpro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idpro == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['php_cmp_required']['idpro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['php_cmp_required']['idpro'] == "on"))
      {
          $hasError = true;
          ...
          $Campos_Erros['idpro'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          if (!isset($this->NM_ajax_info['errList']['idpro']) || !is_array($this->NM_ajax_info['errList']['idpro']))
          {
              $this->NM_ajax_info['errList']['idpro'] = array();
          }
          $this->NM_ajax_info['errList']['idpro'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->idpro) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_idpro']) && !in_array($this->idpro, $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_idpro']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idpro']))
    ...
    function ValidateField_colores(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->colores) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_colores']) && !in_array($this->colores, $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_colores']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_tallas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->tallas) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_tallas']) && !in_array($this->tallas, $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_tallas']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_sabor(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->sabor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_sabor']) && !in_array($this->sabor, $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_sabor']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_seleccionarlfs(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->seleccionarlfs) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_seleccionarlfs']) && !in_array($this->seleccionarlfs, $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_seleccionarlfs']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cantidad(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->cantidad, 7, 3, 0, 0, "S") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['php_cmp_required']['cantidad']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['php_cmp_required']['cantidad'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_idbodorig(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idbodorig == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['php_cmp_required']['idbodorig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['php_cmp_required']['idbodorig'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idbodorig) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_idbodorig']) && !in_array($this->idbodorig, $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_idbodorig']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idbodorig']))
    ...
    function ValidateField_stcock(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->stcock === "" || is_null($this->stcock))  
      { 
          $this->stcock = 0;
          $this->sc_force_zero[] = 'stcock';
      } 
      if (!empty($this->field_config['stcock']['symbol_dec']))
      {
          nm_limpa_valor($this->stcock, $this->field_config['stcock']['symbol_dec'], $this->field_config['stcock']['symbol_grp']) ; 
          if ('.' == substr($this->stcock, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->stcock, 1)))
              {
                  $this->stcock = '';
              }
              else
              {
                  $this->stcock = '0' . $this->stcock;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              ...
              elseif ('-' == substr($this->stcock, -1))
              {
                  $iTestSize++;
                  $this->stcock = '-' . substr($this->stcock, 0, -1);
              }
              if (strlen($this->stcock) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Existencia en ubicación: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['stcock']))
                  {
                      $Campos_Erros['stcock'] = array();
                  }
                  $Campos_Erros['stcock'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['stcock']) || !is_array($this->NM_ajax_info['errList']['stcock']))
                  {
                      $this->NM_ajax_info['errList']['stcock'] = array();
                  }
                  $this->NM_ajax_info['errList']['stcock'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->stcock, 17, 3, 0, 0, "S") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Existencia en ubicación; " ; 
                  if (!isset($Campos_Erros['stcock']))
                  {
                      $Campos_Erros['stcock'] = array();
                  }
                  $Campos_Erros['stcock'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['stcock']) || !is_array($this->NM_ajax_info['errList']['stcock']))
                  {
                      $this->NM_ajax_info['errList']['stcock'] = array();
                  }
                  $this->NM_ajax_info['errList']['stcock'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['stcock'] = $this->stcock;
      if (!empty($this->field_config['stcock']['symbol_dec']))
      {
         nm_limpa_valor($this->stcock, $this->field_config['stcock']['symbol_dec'], $this->field_config['stcock']['symbol_grp']);
      }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      {
          nmgp_Form_Num_Val($this->cantidad, $this->field_config['cantidad']['symbol_grp'], $this->field_config['cantidad']['symbol_dec'], "3", "S", $this->field_config['cantidad']['format_neg'], "", "", "-", $this->field_config['cantidad']['symbol_fmt']) ; 
      }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idmov']['keyVal'] = form_mov_ajusteinv_pack_protect_string($this->nmgp_dados_form['idmov']);
          }
   } // ajax_return_values
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_mov_ajusteinv_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_mov_ajusteinv_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['prefijonota']['valList'][$i] = form_mov_ajusteinv_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipotran']['valList'][$i] = form_mov_ajusteinv_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_mov_ajusteinv_pack_protect_string('') => str_replace('<', '&lt;',form_mov_ajusteinv_pack_protect_string('Seleccione producto a ajustar')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_idpro'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idpro']['valList'][$i] = form_mov_ajusteinv_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_mov_ajusteinv_pack_protect_string('0') => str_replace('<', '&lt;',form_mov_ajusteinv_pack_protect_string(' ')));
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['colores']['valList'][$i] = form_mov_ajusteinv_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tallas']['valList'][$i] = form_mov_ajusteinv_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['sabor']['valList'][$i] = form_mov_ajusteinv_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_mov_ajusteinv_pack_protect_string('') => str_replace('<', '&lt;',form_mov_ajusteinv_pack_protect_string('Vencimiento/Lote/Bodega')));
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['seleccionarlfs']['valList'][$i] = form_mov_ajusteinv_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_mov_ajusteinv_pack_protect_string('') => str_replace('<', '&lt;',form_mov_ajusteinv_pack_protect_string('Seleccione Ubicación')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['Lookup_idbodorig'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idbodorig']['valList'][$i] = form_mov_ajusteinv_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          //----- stcock
   function ajax_return_values_stcock($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("stcock", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->stcock);
              $aLookup = array();
          $aLookupOrig = $aLookup;
   ...
   function ajax_return_values_observaciones($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['scriptcase']['form_mov_ajusteinv']['contr_erro'] = 'on';
if (!isset($this->sc_temp_post_producto)) {$this->sc_temp_post_producto = (isset($_SESSION['post_producto'])) ? $_SESSION['post_producto'] : "";}
  $vsql = "select idgrup from productos where idprod='".$this->sc_temp_post_producto."' and idgrup='1'";
      ...
      { 
          ...
          { 
                 ...
                 { 
                      $this->vSiServ[$SCy] [$SCx] = $SCrx->fields[$SCx];
                      $this->vsiserv[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vSiServ = false;
          $this->vSiServ_erro = $this->Db->ErrorMsg();
          $this->vsiserv = false;
          $this->vsiserv_erro = $this->Db->ErrorMsg();
      } 
;
if(isset($this->vsiserv[0][0]))
{
	echo "<script>if(confirm('No se puede agregar existencias a un servicio.')){window.close();}else{window.close();}</script>";
}
if (isset($this->sc_temp_post_producto)) { $_SESSION['post_producto'] = $this->sc_temp_post_producto;}
$_SESSION['scriptcase']['form_mov_ajusteinv']['contr_erro'] = 'off'; 
      }
      $this->nm_guardar_campos();
...
//
   ...
   { 
      ...
      $this->stcock = str_replace($sc_parm1, $sc_parm2, $this->stcock); 
   } 
   function nm_poe_aspas_decimal() 
   { 
      $this->cantidad = "'" . $this->cantidad . "'";
      $this->stcock = "'" . $this->stcock . "'";
   } 
   function nm_tira_aspas_decimal() 
   { 
      $this->cantidad = str_replace("'", "", $this->cantidad); 
      $this->stcock = str_replace("'", "", $this->stcock); 
   } 
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idmov)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao'] = '';
     ...
     { 
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->vSiLFS[$SCy] [$SCx] = $SCrx->fields[$SCx];
                      $this->vsilfs[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vSiLFS = false;
          $this->vSiLFS_erro = $this->Db->ErrorMsg();
          $this->vsilfs = false;
          $this->vsilfs_erro = $this->Db->ErrorMsg();
      } 
     } 
...
if(isset($this->vsilfs[0][0]))
{
	if($this->vsilfs[0][0]=='LFS')
	{
		if(empty($this->lote ) and $this->vence ==0)
		{
			
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Este producto maneja lote o vencimiento por favor diligencie el que sea necesario.";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6))
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_mov_ajusteinv' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "Este producto maneja lote o vencimiento por favor diligencie el que sea necesario.";
 }
;
		}
	}
...
if(!empty($this->ds[0][0]))
	{
	$this->numeronota =intval($this->ds[0][0])+1;
	}
else
	{
	$this->numeronota =1;
...
$_SESSION['scriptcase']['form_mov_ajusteinv']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (idtipotran, fecha, idpro, cantidad, idbodorig, idboddes, observaciones, colores, tallas, sabor, numeronota, prefijonota, lote, vence) VALUES ($this->idtipotran, #$this->fecha#, $this->idpro, $this->cantidad, $this->idbodorig, $this->idboddes, '$this->observaciones', $this->colores, $this->tallas, $this->sabor, $this->numeronota, $this->prefijonota, '$this->lote', #$this->vence#)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "idtipotran, fecha, idpro, cantidad, idbodorig, idboddes, observaciones, colores, tallas, sabor, numeronota, prefijonota, lote, vence) VALUES (" . $NM_seq_auto . "$this->idtipotran, " . $this->Ini->date_delim . $this->fecha . $this->Ini->date_delim1 . ", $this->idpro, $this->cantidad, $this->idbodorig, $this->idboddes, '$this->observaciones', $this->colores, $this->tallas, $this->sabor, $this->numeronota, $this->prefijonota, '$this->lote', " . $this->Ini->date_delim . $this->vence . $this->Ini->date_delim1 . ")"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "idtipotran, fecha, idpro, cantidad, idbodorig, idboddes, observaciones, colores, tallas, sabor, numeronota, prefijonota, lote, vence) VALUES (" . $NM_seq_auto . "$this->idtipotran, EXTEND('$this->fecha', YEAR TO DAY), $this->idpro, $this->cantidad, $this->idbodorig, $this->idboddes, '$this->observaciones', $this->colores, $this->tallas, $this->sabor, $this->numeronota, $this->prefijonota, '$this->lote', EXTEND('$this->vence', YEAR TO DAY))"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "idtipotran, fecha, idpro, cantidad, idbodorig, idboddes, observaciones, colores, tallas, sabor, numeronota, prefijonota, lote, vence) VALUES (" . $NM_seq_auto . "$this->idtipotran, " . $this->Ini->date_delim . $this->fecha . $this->Ini->date_delim1 . ", $this->idpro, $this->cantidad, $this->idbodorig, $this->idboddes, '$this->observaciones', $this->colores, $this->tallas, $this->sabor, $this->numeronota, $this->prefijonota, '$this->lote', " . $this->Ini->date_delim . $this->vence . $this->Ini->date_delim1 . ")"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start'] = 0; 
              }
...
$sql="select costomen from productos where idprod=$this->idpro ";
...
;
$cost=floatval(substr($this->ds , 8));
$valpar=$cost*floatval($this->cantidad );

$vfechavenc = "null";
if($this->vence !="null" and !empty($this->vence ))
{
	$vfechavenc = "'".$this->vence ."'";
}

$vlote2 = "null";
if($this->lote !="null" and !empty($this->lote ))
{
	$vlote2 = "'".$this->lote ."'";
}
...
switch($this->idtipotran )
{
	case 4:
		$vtipotras="Traslado producción a Bodega";
	break;
	
	case 1:
		$vtipotras="Ajuste por perdida o daño";
	break;
...
;
$cant=substr($this->ds , 8);
$cant=floatval($cant)+floatval($this->cantidad );
$sql="UPDATE productos SET stockmen = $cant WHERE idprod=$proid";
...
$_SESSION['scriptcase']['form_mov_ajusteinv']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['parms'] = "idmov?#?$this->idmov?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_mov_ajusteinv = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total'] = $qt_geral_reg_form_mov_ajusteinv;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idmov))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_mov_ajusteinv = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start'] > $qt_geral_reg_form_mov_ajusteinv)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start'] = $qt_geral_reg_form_mov_ajusteinv; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_mov_ajusteinv) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start'] = 0;
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
          { 
              $nmgp_select = "SELECT idmov, idtipotran, str_replace (convert(char(10),fecha,102), '.', '-') + ' ' + convert(char(8),fecha,20), idpro, cantidad, idbodorig, idboddes, observaciones, colores, tallas, sabor, numeronota, prefijonota, lote, str_replace (convert(char(10),vence,102), '.', '-') + ' ' + convert(char(8),vence,20) from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT idmov, idtipotran, convert(char(23),fecha,121), idpro, cantidad, idbodorig, idboddes, observaciones, colores, tallas, sabor, numeronota, prefijonota, lote, convert(char(23),vence,121) from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT idmov, idtipotran, fecha, idpro, cantidad, idbodorig, idboddes, observaciones, colores, tallas, sabor, numeronota, prefijonota, lote, vence from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT idmov, idtipotran, EXTEND(fecha, YEAR TO DAY), idpro, cantidad, idbodorig, idboddes, observaciones, colores, tallas, sabor, numeronota, prefijonota, lote, EXTEND(vence, YEAR TO DAY) from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT idmov, idtipotran, fecha, idpro, cantidad, idbodorig, idboddes, observaciones, colores, tallas, sabor, numeronota, prefijonota, lote, vence from " . $this->Ini->nm_tabela ; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start']) ;  
              } 
          } 
          ...
          { 
              ...
              $this->lote = $rs->fields[13] ; 
              $this->nmgp_dados_select['lote'] = $this->lote;
              $this->vence = $rs->fields[14] ; 
              $this->nmgp_dados_select['vence'] = $this->vence;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->nm_troca_decimal(",", ".");
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start'] < $qt_geral_reg_form_mov_ajusteinv;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              $this->idpro = "" . $_SESSION['post_producto'] . "";  
              $this->nmgp_dados_form["idpro"] = $this->idpro;
              $this->cantidad = "";  
              $this->nmgp_dados_form["cantidad"] = $this->cantidad;
              $this->idbodorig = "";  
...
//-- 
   ...
   {  
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idmov) from " . $this->Ini->nm_tabela . " where idmov < $this->idmov" . $str_where_filter; 
         $rs = $this->Db->Execute("select max(idmov) from " . $this->Ini->nm_tabela . " where idmov < $this->idmov" . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idmov) from " . $this->Ini->nm_tabela . " where idmov < $this->idmov" . $str_where_filter; 
     ...
     { 
         $this->idmov = substr($this->Db->qstr($rs->fields[0]), 1, -1); 
         $rs->Close();  
         $this->nmgp_opcao = "igual";  
         return ;  
     } 
...
//-- 
   ...
   {  
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idmov) from " . $this->Ini->nm_tabela . " where idmov > $this->idmov" . $str_where_filter; 
         $rs = $this->Db->Execute("select min(idmov) from " . $this->Ini->nm_tabela . " where idmov > $this->idmov" . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idmov) from " . $this->Ini->nm_tabela . " where idmov > $this->idmov" . $str_where_filter; 
...
//-- 
   ...
   {   
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idmov) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select min(idmov) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idmov) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
...
//-- 
   ...
   { 
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idmov) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select max(idmov) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idmov) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['reg_start'] + 1;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
if ($original_stcock !== $modificado_stcock || isset($this->nmgp_cmp_readonly['stcock']) || (isset($bFlagRead_stcock) && $bFlagRead_stcock))
{
    $this->ajax_return_values_stcock(true);
}
$this->NM_ajax_info['event_field'] = 'idbodorig';
form_mov_ajusteinv_pack_ajax_response();
exit;
...
if($resp=="SI")
	...
	$this->nm_mens_alert[] = "Producto maneja unidad Mayor! - Stock en unidad Mayor"; $this->nm_params_alert[] = array(); if ($this->NM_ajax_flag) { $this->sc_ajax_alert("Producto maneja unidad Mayor! - Stock en unidad Mayor"); }}
else
	{
...
$this->nm_formatar_campos('idpro', 'presentacion');
if ($original_idpro !== $modificado_idpro || isset($this->nmgp_cmp_readonly['idpro']) || (isset($bFlagRead_idpro) && $bFlagRead_idpro))
{
    $this->ajax_return_values_idpro(true);
}
...
function seleccionarlfs_onChange()
{
$_SESSION['scriptcase']['form_mov_ajusteinv']['contr_erro'] = 'on';
...
if(!empty($this->seleccionarlfs ))
{
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_select = "select idproducto,idbodega,lote,str_replace (convert(char(10),fecha_vencimiento,102), '.', '-') + ' ' + convert(char(8),fecha_vencimiento,20),existencia from vencimiento_lote where idvenclote='".$this->seleccionarlfs ."'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_select = "select idproducto,idbodega,lote,convert(char(19),fecha_vencimiento,121),existencia from vencimiento_lote where idvenclote='".$this->seleccionarlfs ."'"; 
      }
      else
      { 
          $nm_select = "select idproducto,idbodega,lote,fecha_vencimiento,existencia from vencimiento_lote where idvenclote='".$this->seleccionarlfs ."'"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vDatos = array();
...
;
	...
	{
		$this->idbodorig  = $this->vdatos[0][1];
		
		if(!empty($this->vdatos[0][2]))
		{
			$this->lote  = $this->vdatos[0][2];
		}
		
		if($this->vdatos[0][3]>0)
		{
			$this->vence  = $this->vdatos[0][3];
		}
		
		$this->cantidad   = $this->vdatos[0][4]*-1;
		$this->stcock     = $this->vdatos[0][4];
	}
}
else
{
...
$this->NM_ajax_info['event_field'] = 'seleccionarlfs';
form_mov_ajusteinv_pack_ajax_response();
exit;
$_SESSION['scriptcase']['form_mov_ajusteinv']['contr_erro'] = 'off';
}
...
if($this->idpro >0)
	...
	if (!empty($this->tallas ))
		...
		if(!empty($this->sabor ))
			...
			WHERE idpro = $this->idpro  AND idbod=$this->idbodorig  and colores=$this->colores  and tallas=$this->tallas  and sabor=$this->sabor ";
			}
		else
			{
			$sql="SELECT SUM(cantidad) AS cantidad FROM inventario
			WHERE idpro = $this->idpro  AND idbod=$this->idbodorig  and colores=$this->colores  and tallas=$this->tallas ";
			}
		}
	else
		{
		if(!empty($this->sabor ))
			{
			$sql="SELECT SUM(cantidad) AS cantidad FROM inventario
			WHERE idpro = $this->idpro  AND idbod=$this->idbodorig  and colores=$this->colores  and sabor=$this->sabor ";
			}
		else
			{
			$sql="SELECT SUM(cantidad) AS cantidad FROM inventario
			WHERE idpro = $this->idpro  AND idbod=$this->idbodorig  and colores=$this->colores ";
			}
		}
	}
else
	...
	if (!empty($this->tallas ))
		...
		if(!empty($this->sabor ))
			{
			$sql="SELECT SUM(cantidad) AS cantidad FROM inventario
		WHERE idpro = $this->idpro  AND idbod=$this->idbodorig  and tallas=$this->tallas  and sabor=$this->sabor ";
			}
		else
			{
			$sql="SELECT SUM(cantidad) AS cantidad FROM inventario
		WHERE idpro = $this->idpro  AND idbod=$this->idbodorig  and tallas=$this->tallas ";
			}
		}
	else
		{
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    $this->fecha_Dt_max = date('Ymd'); 
        $this->initFormPages();
    include_once("form_mov_ajusteinv_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_mov_ajusteinv = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['total'] = $qt_geral_reg_form_mov_ajusteinv;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_mov_ajusteinv_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "idmov";$nm_numeric[] = "idtipotran";$nm_numeric[] = "idpro";$nm_numeric[] = "cantidad";$nm_numeric[] = "idbodorig";$nm_numeric[] = "idboddes";$nm_numeric[] = "colores";$nm_numeric[] = "tallas";$nm_numeric[] = "sabor";$nm_numeric[] = "numeronota";$nm_numeric[] = "prefijonota";$nm_numeric[] = "";
      ...
      $Nm_datas['fecha'] = "date";$Nm_datas['vence'] = "date";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_idtipotran($condicao, $campo)
   {
       ...
       {
           $nm_comando = "SELECT nombre, idtipo FROM tipotransfe WHERE (CAST (idtipo AS TEXT) LIKE '%$campo%') AND (idtipo !=2)" ; 
       }
       else
       {
           $nm_comando = "SELECT nombre, idtipo FROM tipotransfe WHERE (nombre LIKE '%$campo%') AND (idtipo !=2)" ; 
       }
       if ($condicao == "ii")
       {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_mov_ajusteinv_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_mov_ajusteinv_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv']['masterValue']))
{
