...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv_mob']['insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_mov_ajusteinv_mob']['insert'];
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['embutida_liga_form_insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['embutida_liga_form_insert'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv_mob']['insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_mov_ajusteinv_mob']['insert'];
      }
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['opcao'] = "inicio";
...
//------------ 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['dados_select'];
                  ...
                  $this->vence = $this->nmgp_dados_select['vence'];  
              }
          }
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['foreign_key']))
          {
