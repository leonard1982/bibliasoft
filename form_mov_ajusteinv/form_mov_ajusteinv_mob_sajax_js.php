  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mov_ajusteinv_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_mov_ajusteinv_mob_form();
	}
  ...
  function do_ajax_form_mov_ajusteinv_mob_validate_prefijonota()
  {
    var nomeCampo_prefijonota = "prefijonota";
    var var_prefijonota = scAjaxGetFieldSelect(nomeCampo_prefijonota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_prefijonota(var_prefijonota, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_prefijonota_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_prefijonota

  function do_ajax_form_mov_ajusteinv_mob_validate_prefijonota_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_prefijonota_cb

  // ---------- Validate numeronota
  function do_ajax_form_mov_ajusteinv_mob_validate_numeronota()
  {
    var nomeCampo_numeronota = "numeronota";
    var var_numeronota = scAjaxGetFieldHidden(nomeCampo_numeronota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_numeronota(var_numeronota, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_numeronota_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_numeronota

  function do_ajax_form_mov_ajusteinv_mob_validate_numeronota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_numeronota_cb

  // ---------- Validate idtipotran
  function do_ajax_form_mov_ajusteinv_mob_validate_idtipotran()
  {
    var nomeCampo_idtipotran = "idtipotran";
    var var_idtipotran = scAjaxGetFieldSelect(nomeCampo_idtipotran);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_idtipotran(var_idtipotran, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_idtipotran_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_idtipotran

  function do_ajax_form_mov_ajusteinv_mob_validate_idtipotran_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_idtipotran_cb

  // ---------- Validate fecha
  function do_ajax_form_mov_ajusteinv_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_fecha_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_fecha

  function do_ajax_form_mov_ajusteinv_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_fecha_cb

  // ---------- Validate idpro
  function do_ajax_form_mov_ajusteinv_mob_validate_idpro()
  {
    var nomeCampo_idpro = "idpro";
    var var_idpro = scAjaxGetFieldSelect(nomeCampo_idpro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_idpro(var_idpro, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_idpro_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_idpro

  function do_ajax_form_mov_ajusteinv_mob_validate_idpro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_idpro_cb

  // ---------- Validate colores
  function do_ajax_form_mov_ajusteinv_mob_validate_colores()
  {
    var nomeCampo_colores = "colores";
    var var_colores = scAjaxGetFieldSelect(nomeCampo_colores);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_colores(var_colores, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_colores_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_colores

  function do_ajax_form_mov_ajusteinv_mob_validate_colores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "colores";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_colores_cb

  // ---------- Validate tallas
  function do_ajax_form_mov_ajusteinv_mob_validate_tallas()
  {
    var nomeCampo_tallas = "tallas";
    var var_tallas = scAjaxGetFieldSelect(nomeCampo_tallas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_tallas(var_tallas, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_tallas_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_tallas

  function do_ajax_form_mov_ajusteinv_mob_validate_tallas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tallas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_tallas_cb

  // ---------- Validate sabor
  function do_ajax_form_mov_ajusteinv_mob_validate_sabor()
  {
    var nomeCampo_sabor = "sabor";
    var var_sabor = scAjaxGetFieldSelect(nomeCampo_sabor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_sabor(var_sabor, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_sabor_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_sabor

  function do_ajax_form_mov_ajusteinv_mob_validate_sabor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sabor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_sabor_cb

  // ---------- Validate presentacion
  function do_ajax_form_mov_ajusteinv_mob_validate_presentacion()
  {
    var nomeCampo_presentacion = "presentacion";
    var var_presentacion = scAjaxGetFieldText(nomeCampo_presentacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_presentacion(var_presentacion, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_presentacion_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_presentacion

  function do_ajax_form_mov_ajusteinv_mob_validate_presentacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_presentacion_cb

  // ---------- Validate seleccionarlfs
  function do_ajax_form_mov_ajusteinv_mob_validate_seleccionarlfs()
  {
    var nomeCampo_seleccionarlfs = "seleccionarlfs";
    var var_seleccionarlfs = scAjaxGetFieldSelect(nomeCampo_seleccionarlfs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_seleccionarlfs(var_seleccionarlfs, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_seleccionarlfs_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_seleccionarlfs

  function do_ajax_form_mov_ajusteinv_mob_validate_seleccionarlfs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_seleccionarlfs_cb

  // ---------- Validate cantidad
  function do_ajax_form_mov_ajusteinv_mob_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_cantidad_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_cantidad

  function do_ajax_form_mov_ajusteinv_mob_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_cantidad_cb

  // ---------- Validate idbodorig
  function do_ajax_form_mov_ajusteinv_mob_validate_idbodorig()
  {
    var nomeCampo_idbodorig = "idbodorig";
    var var_idbodorig = scAjaxGetFieldSelect(nomeCampo_idbodorig);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_idbodorig(var_idbodorig, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_idbodorig_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_idbodorig

  function do_ajax_form_mov_ajusteinv_mob_validate_idbodorig_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_idbodorig_cb

  // ---------- Validate stcock
  function do_ajax_form_mov_ajusteinv_mob_validate_stcock()
  {
    var nomeCampo_stcock = "stcock";
    var var_stcock = scAjaxGetFieldHidden(nomeCampo_stcock);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_stcock(var_stcock, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_stcock_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_stcock

  function do_ajax_form_mov_ajusteinv_mob_validate_stcock_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stcock";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_stcock_cb

  // ---------- Validate lote
  function do_ajax_form_mov_ajusteinv_mob_validate_lote()
  {
    var nomeCampo_lote = "lote";
    var var_lote = scAjaxGetFieldText(nomeCampo_lote);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_lote(var_lote, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_lote_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_lote

  function do_ajax_form_mov_ajusteinv_mob_validate_lote_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lote";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_lote_cb

  // ---------- Validate vence
  function do_ajax_form_mov_ajusteinv_mob_validate_vence()
  {
    var nomeCampo_vence = "vence";
    var var_vence = scAjaxGetFieldText(nomeCampo_vence);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_vence(var_vence, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_vence_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_vence

  function do_ajax_form_mov_ajusteinv_mob_validate_vence_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vence";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_vence_cb

  // ---------- Validate observaciones
  function do_ajax_form_mov_ajusteinv_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_ajusteinv_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_validate_observaciones_cb);
  } // do_ajax_form_mov_ajusteinv_mob_validate_observaciones

  function do_ajax_form_mov_ajusteinv_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_validate_observaciones_cb

  // ---------- Refresh idpro
  function do_ajax_form_mov_ajusteinv_mob_refresh_idpro()
  {
    var var_idpro = scAjaxGetFieldSelect("idpro");
    var var_nmgp_refresh_fields = "idbodorig_#fld#_colores_#fld#_tallas_#fld#_sabor";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_mov_ajusteinv_mob_refresh_idpro(var_idpro, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_refresh_idpro_cb);
  } // do_ajax_form_mov_ajusteinv_mob_refresh_idpro

  function do_ajax_form_mov_ajusteinv_mob_refresh_idpro_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_ajusteinv_mob_refresh_idpro_cb

  // ---------- Event onchange idbodorig
  function do_ajax_form_mov_ajusteinv_mob_event_idbodorig_onchange()
  {
    var var_idpro = scAjaxGetFieldSelect("idpro");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_mov_ajusteinv_mob_event_idbodorig_onchange(var_idpro, var_colores, var_tallas, var_sabor, var_idbodorig, var_stcock, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_event_idbodorig_onchange_cb);
  } // do_ajax_form_mov_ajusteinv_mob_event_idbodorig_onchange

  function do_ajax_form_mov_ajusteinv_mob_event_idbodorig_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idbodorig";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_mov_ajusteinv_mob_event_idbodorig_onchange_cb_after_alert);
  } // do_ajax_form_mov_ajusteinv_mob_event_idbodorig_onchange_cb
  function do_ajax_form_mov_ajusteinv_mob_event_idbodorig_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_mov_ajusteinv_mob_event_idbodorig_onchange_cb_after_alert

  // ---------- Event onchange idpro
  function do_ajax_form_mov_ajusteinv_mob_event_idpro_onchange()
  {
    var var_idpro = scAjaxGetFieldSelect("idpro");
    var var_presentacion = scAjaxGetFieldText("presentacion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_mov_ajusteinv_mob_event_idpro_onchange(var_idpro, var_presentacion, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_event_idpro_onchange_cb);
  } // do_ajax_form_mov_ajusteinv_mob_event_idpro_onchange

  function do_ajax_form_mov_ajusteinv_mob_event_idpro_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idpro";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_mov_ajusteinv_mob_event_idpro_onchange_cb_after_alert);
  } // do_ajax_form_mov_ajusteinv_mob_event_idpro_onchange_cb
  function do_ajax_form_mov_ajusteinv_mob_event_idpro_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_mov_ajusteinv_mob_refresh_idpro();
    scAjaxRedir();
  } // do_ajax_form_mov_ajusteinv_mob_event_idpro_onchange_cb_after_alert

  // ---------- Event onchange seleccionarlfs
  function do_ajax_form_mov_ajusteinv_mob_event_seleccionarlfs_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_mov_ajusteinv_mob_event_seleccionarlfs_onchange(var_seleccionarlfs, var_idbodorig, var_lote, var_vence, var_cantidad, var_stcock, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_event_seleccionarlfs_onchange_cb);
  } // do_ajax_form_mov_ajusteinv_mob_event_seleccionarlfs_onchange

  function do_ajax_form_mov_ajusteinv_mob_event_seleccionarlfs_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "seleccionarlfs";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_mov_ajusteinv_mob_event_seleccionarlfs_onchange_cb_after_alert);
  } // do_ajax_form_mov_ajusteinv_mob_event_seleccionarlfs_onchange_cb
  function do_ajax_form_mov_ajusteinv_mob_event_seleccionarlfs_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_mov_ajusteinv_mob_event_seleccionarlfs_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_mov_ajusteinv_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mov_ajusteinv_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_prefijonota = scAjaxGetFieldSelect("prefijonota");
    var var_numeronota = scAjaxGetFieldHidden("numeronota");
    ...
    scAjaxProcOn();
    x_ajax_form_mov_ajusteinv_mob_submit_form(var_prefijonota, var_numeronota, var_idtipotran, var_fecha, var_idpro, var_colores, var_tallas, var_sabor, var_presentacion, var_seleccionarlfs, var_cantidad, var_idbodorig, var_stcock, var_lote, var_vence, var_observaciones, var_idmov, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mov_ajusteinv_mob_submit_form_cb);
  } // do_ajax_form_mov_ajusteinv_mob_submit_form

  function do_ajax_form_mov_ajusteinv_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mov_ajusteinv_mob_submit_form_cb_after_alert);
  } // do_ajax_form_mov_ajusteinv_mob_submit_form_cb
  function do_ajax_form_mov_ajusteinv_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mov_ajusteinv_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mov_ajusteinv_mob_navigate_form()
  {
    perform_ajax_form_mov_ajusteinv_mob_navigate_form();
  }

  function perform_ajax_form_mov_ajusteinv_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_mov_ajusteinv_mob_navigate_form(var_idmov, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_navigate_form_cb);
  } // do_ajax_form_mov_ajusteinv_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_ajusteinv_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mov_ajusteinv_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mov_ajusteinv_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_mov_ajusteinv_mob_navigate_form_cb
  function do_ajax_form_mov_ajusteinv_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_mov_ajusteinv_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_mov_ajusteinv_mob_navigate_form_cb_after_alert
  function sc_hide_form_mov_ajusteinv_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "numeronota": {"label": "No. Nota:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
