...
?>
  ...
  function do_ajax_form_mov_ajusteinv_mob_event_idbodorig_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_mov_ajusteinv_mob_event_idbodorig_onchange(var_idpro, var_idbodorig, var_stcock, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_event_idbodorig_onchange_cb);
  ...
  function do_ajax_form_mov_ajusteinv_mob_event_seleccionarlfs_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_mov_ajusteinv_mob_event_seleccionarlfs_onchange(var_idbodorig, var_cantidad, var_stcock, var_script_case_init, do_ajax_form_mov_ajusteinv_mob_event_seleccionarlfs_onchange_cb);
