<?php
   include_once('grid_NC_ND_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class grid_NC_ND_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "grid_NC_ND"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_NC_ND']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_NC_ND']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['grid_NC_ND']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/grid_NC_ND';
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['grid_NC_ND']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['grid_NC_ND']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['grid_NC_ND']['actual_lang']) || $_SESSION['scriptcase']['grid_NC_ND']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['grid_NC_ND']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("grid_NC_ND_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $Tmp_apl_lig = "form_notas";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/form_notas_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/form_notas_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/form_notas_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/form_notas_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["form_notas"] = 'S';
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['dashboard_info']['under_dashboard'])
      {
          ...
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_NC_ND"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_NC_ND"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['grid_NC_ND']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "grid_NC_ND_erro.class.php"); 
      $this->Erro = new grid_NC_ND_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('grid_NC_ND'); 
// 
      ...
      $this->arr_buttons_usr['FoliosRestantes']['hint']             = "";
      $this->arr_buttons_usr['FoliosRestantes']['type']             = "button";
      $this->arr_buttons_usr['FoliosRestantes']['value']            = "Folios F.E.";
      $this->arr_buttons_usr['FoliosRestantes']['display']          = "only_text";
      $this->arr_buttons_usr['FoliosRestantes']['display_position'] = "text_right";
      $this->arr_buttons_usr['FoliosRestantes']['style']            = "default";
      $this->arr_buttons_usr['FoliosRestantes']['image']            = "";

      $this->arr_buttons_usr['SC_btn_1']['hint']             = "";
      $this->arr_buttons_usr['SC_btn_1']['type']             = "button";
      $this->arr_buttons_usr['SC_btn_1']['value']            = "Nueva Nota";
      ...
      $this->arr_buttons_usr['btn_enviarfe']['hint']             = "Enviar documento electrónico";
      $this->arr_buttons_usr['btn_enviarfe']['type']             = "image";
      $this->arr_buttons_usr['btn_enviarfe']['value']            = "Enviar documento electrónico";
      $this->arr_buttons_usr['btn_enviarfe']['display']          = "only_img";
      $this->arr_buttons_usr['btn_enviarfe']['display_position'] = "text_right";
      $this->arr_buttons_usr['btn_enviarfe']['style']            = "";
      $this->arr_buttons_usr['btn_enviarfe']['image']            = "scriptcase__NM__ico__NM__server_mail_download_32.png";

      $this->arr_buttons_usr['btn_reenviar']['hint']             = "Enviar documento electrónico al correo";
      $this->arr_buttons_usr['btn_reenviar']['type']             = "image";
      $this->arr_buttons_usr['btn_reenviar']['value']            = "Enviar documento electrónico al correo";
      $this->arr_buttons_usr['btn_reenviar']['display']          = "only_img";
      $this->arr_buttons_usr['btn_reenviar']['display_position'] = "text_right";
      $this->arr_buttons_usr['btn_reenviar']['style']            = "";
      $this->arr_buttons_usr['btn_reenviar']['image']            = "scriptcase__NM__ico__NM__mail_forward_all_32.png";

      $this->arr_buttons_usr['btn_enviar_hka_tech']['hint']             = "Firmar documento electrónico (Enviar documento)";
      $this->arr_buttons_usr['btn_enviar_hka_tech']['type']             = "image";
      $this->arr_buttons_usr['btn_enviar_hka_tech']['value']            = "btn_enviar_hka_tech";
      $this->arr_buttons_usr['btn_enviar_hka_tech']['display']          = "only_img";
      $this->arr_buttons_usr['btn_enviar_hka_tech']['display_position'] = "text_right";
      $this->arr_buttons_usr['btn_enviar_hka_tech']['style']            = "";
      $this->arr_buttons_usr['btn_enviar_hka_tech']['image']            = "scriptcase__NM__ico__NM__server_mail_download_32.png";

      $this->arr_buttons_usr['btn_pdf']['hint']             = "PDF";
      $this->arr_buttons_usr['btn_pdf']['type']             = "image";
      $this->arr_buttons_usr['btn_pdf']['value']            = "grp__NM__ico__NM__ico_pdf_32x32.png";
      $this->arr_buttons_usr['btn_pdf']['display']          = "only_img";
      $this->arr_buttons_usr['btn_pdf']['display_position'] = "text_right";
      $this->arr_buttons_usr['btn_pdf']['style']            = "";
      $this->arr_buttons_usr['btn_pdf']['image']            = "grp__NM__ico__NM__ico_pdf_32x32.png";
      ...
      if (isset($_SESSION['scriptcase']['grid_NC_ND']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['grid_NC_ND']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['grid_NC_ND']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['grid_NC_ND']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['grid_NC_ND']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['grid_NC_ND']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_conexao']) && $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_perfil']) && $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_NC_ND']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['grid_NC_ND']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv_2022', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_NC_ND']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
class grid_NC_ND_sub_css
{
   function __construct()
   {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['grid_NC_ND']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['grid_NC_ND'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class grid_NC_ND_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_NC_ND']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_NC_ND'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida'] || $Parms_form_pdf)
      { 
      ...
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_NC_ND_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida_ibase'] = true;
      }
      ...
      $this->Change_Menu = false;
       ...
       { 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_NC_ND']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_NC_ND'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_NC_ND']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_NC_ND']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('grid_NC_ND') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_NC_ND']['label'] = "Notas Crédito/Débito";
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      include_once($this->Ini->path_aplicacao . 'webservice_receptor2.php');
      $this->nm_data = new nm_data("es");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "grid_NC_ND/grid_NC_ND_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "grid_NC_ND_erro.class.php"); 
      } 
      $this->Erro      = new grid_NC_ND_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "grid_NC_ND/grid_NC_ND_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "grid_NC_ND_lookup.class.php"); 
      } 
      $this->Lookup       = new grid_NC_ND_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_grid_NC_ND_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['pivot_tabular']);
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Gb_date_format'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Gb_date_format']['fecha']['fechaven'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Gb_date_format']['fecha']['fechaven'] = 'YYYYMMDD2';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Gb_def_sql']['fecha']['fechaven'] = 'fechaven';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Gb_date_format']['vencimiento']['fechavenc'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Gb_date_format']['vencimiento']['fechavenc'] = 'YYYYMMDD2';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Gb_def_sql']['vencimiento']['fechavenc'] = 'fechavenc';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_All_Groupby'] = array('_NM_SC_' => 'grid', 'fecha' => 'all', 'vencimiento' => 'all', 'credito' => 'all', 'vendedor' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Ind_Groupby'] == "fecha")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['Labels_GB'][] = "Fecha";
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Ind_Groupby'] == "vencimiento")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['Labels_GB'][] = "Vence";
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Ind_Groupby'] == "credito")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['Labels_GB'][] = "Crédito";
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Ind_Groupby'] == "vendedor")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['Labels_GB'][] = "Vendedor";
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Ind_Groupby'] == "_NM_SC_")
      {
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['fecha']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['fecha'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['fecha'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['fecha'][3] = array('label' => "Total Venta(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['fecha'][] = 3;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['fecha'][4] = array('label' => "SubTotal(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['fecha'][] = 4;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['fecha'][5] = array('label' => "IVA(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['fecha'][] = 5;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['fecha'][6] = array('label' => "Base Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['fecha'][] = 6;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['fecha'][7] = array('label' => "Valor Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['fecha'][] = 7;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['fecha'][8] = array('label' => "Base Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['fecha'][] = 8;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['fecha'][9] = array('label' => "Valor Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['fecha'][] = 9;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['fecha'][10] = array('label' => "Excento(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['fecha'][] = 10;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_control']['fecha']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_control']['fecha'] = array(
               array(
                   'cmp_res' => "NM_Count",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vencimiento'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][3] = array('label' => "Total Venta(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vencimiento'][] = 3;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][4] = array('label' => "SubTotal(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vencimiento'][] = 4;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][5] = array('label' => "IVA(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vencimiento'][] = 5;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][6] = array('label' => "Base Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vencimiento'][] = 6;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][7] = array('label' => "Valor Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vencimiento'][] = 7;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][8] = array('label' => "Base Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vencimiento'][] = 8;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][9] = array('label' => "Valor Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vencimiento'][] = 9;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][10] = array('label' => "Excento(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vencimiento'][] = 10;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_control']['vencimiento']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_control']['vencimiento'] = array(
               array(
                   'cmp_res' => "NM_Count",
                   'label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['credito']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['credito'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['credito'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['credito'][3] = array('label' => "Total Venta(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['credito'][] = 3;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['credito'][4] = array('label' => "SubTotal(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['credito'][] = 4;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['credito'][5] = array('label' => "IVA(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['credito'][] = 5;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['credito'][6] = array('label' => "Base Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['credito'][] = 6;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['credito'][7] = array('label' => "Valor Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['credito'][] = 7;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['credito'][8] = array('label' => "Base Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['credito'][] = 8;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['credito'][9] = array('label' => "Valor Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['credito'][] = 9;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['credito'][10] = array('label' => "Excento(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['credito'][] = 10;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_control']['credito']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_control']['credito'] = array(
               array(
                   'cmp_res' => "NM_Count",
                   'label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vendedor'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][3] = array('label' => "Total Venta(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vendedor'][] = 3;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][4] = array('label' => "SubTotal(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vendedor'][] = 4;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][5] = array('label' => "IVA(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vendedor'][] = 5;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][6] = array('label' => "Base Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vendedor'][] = 6;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][7] = array('label' => "Valor Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vendedor'][] = 7;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][8] = array('label' => "Base Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vendedor'][] = 8;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][9] = array('label' => "Valor Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vendedor'][] = 9;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][10] = array('label' => "Excento(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vendedor'][] = 10;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_control']['vendedor']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_control']['vendedor'] = array(
               array(
                   'cmp_res' => "NM_Count",
                   'label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "grid_NC_ND_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "grid_NC_ND_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_grid_NC_ND_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_grid_NC_ND_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf')
      { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
          }
          else
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_disp']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_disp']        = array('Bar', 'Pie', 'Line', 'Area');
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_tipo']        = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_larg']        = '800';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_alt']         = '600';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_exibe_val']    = '0';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_barra_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cfg_graf']['graf_pyram_forma'] = 'S';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida_treeview'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order'][] = "num";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order'][] = "adicional3";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order'][] = "vendedor";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order'][] = "pedido";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order'][] = "resolucion";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order'][] = "base_iva_19";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order'][] = "valor_iva_19";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order'][] = "base_iva_5";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order'][] = "valor_iva_5";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order'][] = "excento";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order'][] = "imprimir";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order'][] = "print";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['field_order'];
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['idfacven'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['numfacven'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['credito'] = "off";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['adicional3'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['vendedor'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['pedido'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['resolucion'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['base_iva_19'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['valor_iva_19'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['base_iva_5'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['valor_iva_5'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['excento'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['imprimir'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel']['print'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_NC_ND']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_NC_ND']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['grid_NC_ND']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_NC_ND']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_NC_ND']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opc_liga'] = $NMSC_conf_apl;  
          }   
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opc_liga']['inicial'];
          }
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq'])
          { 
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['orig_pesq'] = 'grid';
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['interativ_refresh'] = true;
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "interativ_search")
      { 
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['tot_geral']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = 'inicio';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opc_int_search'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['interativ_refresh'] = true;
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['prim_cons'] = true;  
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['campos_busca']      = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['grid_pesq']         = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['Grid_search']       = "";
      ...
      { 
          ...
          if ($nm_call_php == "btn_enviarfe")
          { 
              $this->btn_enviarfe();
          } 
          if ($nm_call_php == "btn_reenviar")
          { 
              $this->btn_reenviar();
          } 
          if ($nm_call_php == "btn_enviar_hka_tech")
          { 
              $this->btn_enviar_hka_tech();
          } 
      ...
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_NC_ND_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_NC_ND.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_NC_ND_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grid_NC_ND_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_name']))
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_name'] .= ".doc";
              }
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_grid_NC_ND_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_NC_ND/grid_NC_ND_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_NC_ND_xls.class.php"); 
          } 
          $this->xls  = new grid_NC_ND_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_NC_ND/grid_NC_ND_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_NC_ND_res_xls.class.php"); 
          } 
          $this->xls  = new grid_NC_ND_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_NC_ND/grid_NC_ND_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_NC_ND_xml.class.php"); 
          } 
          $this->xml  = new grid_NC_ND_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_NC_ND/grid_NC_ND_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_NC_ND_res_xml.class.php"); 
          } 
          $this->xml  = new grid_NC_ND_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_NC_ND/grid_NC_ND_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_NC_ND_json.class.php"); 
          } 
          $this->json  = new grid_NC_ND_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_NC_ND/grid_NC_ND_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_NC_ND_csv.class.php"); 
          } 
          $this->csv  = new grid_NC_ND_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_NC_ND/grid_NC_ND_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_NC_ND_res_csv.class.php"); 
          } 
          $this->csv  = new grid_NC_ND_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_NC_ND/grid_NC_ND_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_NC_ND_rtf.class.php"); 
          } 
          $this->rtf  = new grid_NC_ND_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_NC_ND/grid_NC_ND_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_NC_ND_res_rtf.class.php"); 
          } 
          $this->rtf  = new grid_NC_ND_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . grid_NC_ND . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
          ...
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_NC_ND_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_NC_ND_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new grid_NC_ND_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_NC_ND/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new grid_NC_ND_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_grid_NC_ND_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_NC_ND/grid_NC_ND_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_NC_ND_grid.class.php"); 
          } 
          $this->grid  = new grid_NC_ND_grid();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['ajax_nav'])
         {
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] != "ajax_detalhe")  
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_NC_ND_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                    fwrite($this->grid->progress_fp, ($this->grid->progress_tot) . "_#NM#_" . $lang_protect . "...\n");
                    fclose($this->grid->progress_fp);
                }
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_NC_ND_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_NC_ND_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pdf_file'] = $nm_arquivo_pdf_serv;
}
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "grid_NC_ND.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['sc_sql_btn_run']))
{
    foreach ($NM_index_reg as $Run_register)
    {
       if (!is_numeric($Run_register)) { continue; }
       $this->rs_grid->fields = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['sc_sql_btn_run'][$Run_register];
...
if($this->asentada ==1)
{
	if(!empty($this->cufe ))
	{
		echo "EL DOCUMENTO YA HA SIDO ENVIADO.";
	}
	else
	{

		$vwebservice_proveedor = "";
		$vserver1 = "";
		$vserver2 = "";
		$vtk      = "";
		$vtk_pass = "";
		...
		$vidfv = $this->idfacven ;
		$vsql = "select idfacven, numfacven, fechaven, fechavenc, total,if(observaciones='TEMPORAL','',observaciones) as observ from facturaven where idfacven='".$vidfv."'";
		 
      $nm_select = $vsql; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vCabecera = array();
      $this->vcabecera = array();
      ...
      { 
          ...
          { 
                 ...
                 { 
                        $this->vCabecera[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vcabecera[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vCabecera = false;
          $this->vCabecera_erro = $this->Db->ErrorMsg();
          $this->vcabecera = false;
          $this->vcabecera_erro = $this->Db->ErrorMsg();
      } 
;
		if(isset($this->vcabecera[0][0]))
		{
			$vidfacven    = $this->vcabecera[0][0];
			$vconsecutivo = $this->vcabecera[0][1];
			$vfechaven    = $this->vcabecera[0][2];
			$vfechavenc   = $this->vcabecera[0][3];	
			$vTotf        = $this->vcabecera[0][4];
			$vobservacion_dataico = $this->vcabecera[0][5];
		}
...
;	
		...
		{
			$vwebservice_proveedor = $this->vws[0][0];
			$vserver1 = $this->vws[0][2];
			$vserver2 = $this->vws[0][2];
			$vtk      = $this->vws[0][3];
			$vtk_pass = $this->vws[0][4];

			if($this->vws[0][5]=="PRODUCCION")
			{
				$vmodo = 0;
			}

			$venvio_dian    = $this->vws[0][6];
			$venvio_cliente = $this->vws[0][7];
		}
      ...
      $nm_select = "select f.id_trans_fe from facturaven f inner join resdian r on f.resolucion=r.Idres where idfacven='".$this->id_fact  ."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vFact = array();
      $this->vfact = array();
...
;
		...
		{
			$vuuid_devolver = $this->vfact[0][0];
		}

		$vprimerfac=1;

		 
      $nm_select = "SELECT prefijo, prefijo_fe, pref_ncr, primerfactura, desde, resolucion, contador_pruebas FROM resdian WHERE Idres = $this->resolucion  "; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds_res = array();
     if ($this->resolucion !== "")
...
;
		if(isset($this->ds_res[0][1]))
		{
			...
			$vdesde = $this->ds_res[0][4];
			$vresolucion = $this->ds_res[0][5];
			$vconsecutivo_pruebas = $this->ds_res[0][6];
		}
...
;	
					...
					{
						$vnombre1   = $this->ds_fe[0][15];
						$vnombre2   = $this->ds_fe[0][16];
						$vapellido1 = $this->ds_fe[0][17];
						$vapellido2 = $this->ds_fe[0][18]; 
...
;
      ...
      $nm_select = "select round(d.cantidad,2) as cantidad, p.codigobar, if(d.obs is not null and d.obs<>'',concat(d.descr,' ',d.obs),d.descr) as descripcion, p.codigoprod, (d.valorpar-(d.descuento+d.iva)) as base, (if(iv.tipo_impuesto='CONSUMO','02','01')) as codigoimpuesto, d.adicional as porciva, d.iva, d.adicional1 as porcdesc, (d.valorpar/((d.adicional/100)+1)) as bas_br, p.tipo_producto, p.preciomen FROM detalleventa d inner join productos p on d.idpro=p.idprod inner join iva iv on p.idiva=iv.idiva where d.numfac='".$vidfacven."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vDetalle = array();
      $this->vdetalle = array();
...
;
						...
						{	
							...
							for($i=0;$i<count($this->vdetalle );$i++)
							{
								...
								$vtipo_producto = $this->vdetalle[$i][10];
								$vtax_amount = $this->vdetalle[$i][11];
								$tot	=$base+$eliva;
								$tot	=strval ($tot);
								...
								$vsql = "select t.documento,t.dv, t.tipo_documento from productos p inner join terceros t on p.idpro1=t.idtercero where p.codigobar='".$codbp."' and p.tipo_producto='RE'";
								 
      $nm_select = $vsql; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vMandatorio = array();
      $this->vmandatorio = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vMandatorio[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vmandatorio[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vMandatorio = false;
          $this->vMandatorio_erro = $this->Db->ErrorMsg();
          $this->vmandatorio = false;
          $this->vmandatorio_erro = $this->Db->ErrorMsg();
      } 
;
								if(isset($this->vmandatorio[0][0]))
								{
									$vid_mandatorio = $this->vmandatorio[0][0];
									$vdv_mandatorio = $this->vmandatorio[0][1];
									$vid_tipo       = $this->vmandatorio[0][2]; 
								...
								{
									$factDetalle[$i]->tax_amount = $vtax_amount*$cant;
								}
...
;
						...
						switch($vwebservice_proveedor)
						{
							...
							case 'DATAICO':
								...
								$vparametros["uuid"] = $vuuid_devolver;
								...
								$vcliente['email'] = $this->factura->cliente->destinatario[0]->email->string;
								$vcliente['phone'] = $this->factura->cliente->telefono;
								if($this->factura->cliente->tipoPersona==2)
								{
								...
								$vcliente['party_identification'] = $this->factura->cliente->informacionLegalCliente->numeroIdentificacion;
								switch($this->factura->cliente->informacionLegalCliente->tipoIdentificacion)
								{
									case 13:
								...
								$vcliente['address_line'] = $this->factura->cliente->direccionCliente->direccion;
								$vcliente['country_code'] = 'CO';
								if($this->factura->cliente->tipoPersona==2)
								{

									$vnombres   = $vnombre1." ".$vnombre2;
									$vapellidos = $vapellido1." ".$vapellido2;
									$vcliente['first_name'] = trim($vnombres);
									$vcliente['family_name'] = trim($vapellidos);

								}
								else
								{
									$vcliente['company_name'] = $this->factura->cliente->informacionLegalCliente->nombreRegistroRUT;
								}

								if($this->factura->cliente->responsabilidadesRut[0]->regimen==48)
								{
								...
								$vcliente['city']  = $vcodmuni;
								$vcliente['department'] = $this->factura->cliente->direccionCliente->codigoDepartamento;

								$vfecha2      = date_create($this->factura->fechaEmision);
								$vencabezado["fecha"]      = date_format($vfecha2,'d/m/Y');
								$vencabezado["fecha_pago"] = date_format($vfecha2,'d/m/Y H:i:s');
								
								$vencabezado["numero"] = $this->factura->consecutivoDocumento;
								
								if($this->factura->mediosDePago[0]->metodoDePago=="1")
								{
								...
								$vencabezado["prefijo"]    = $vPref;


								if(count($this->factura->detalleDeFactura)>0)
								{
									for($i=0;$i<count($this->factura->detalleDeFactura);$i++)
									{
										$this->vdetalle[$i]["codigo"]       = $this->factura->detalleDeFactura[$i]->codigoProducto;
										$this->vdetalle[$i]["cantidad"]     = round($this->factura->detalleDeFactura[$i]->cantidadReal,1);
										$this->vdetalle[$i]["descripcion"]  = $this->factura->detalleDeFactura[$i]->descripcion;
										$this->vdetalle[$i]["precio"]       = ($this->factura->detalleDeFactura[$i]->precioTotal/$this->factura->detalleDeFactura[$i]->cantidadReal) / ((intval($this->factura->detalleDeFactura[$i]->impuestosDetalles[0]->porcentajeTOTALImp)/100)+1);
										
										if($this->factura->detalleDeFactura[$i]->tax_amount>0)
										{
											$this->vdetalle[$i]["tax_amount"]     = round($this->factura->detalleDeFactura[$i]->tax_amount,1);

											$this->vdetalle[$i]["tax_category"] = 'IMP_BOLSA_PLASTICA';
										}
										else
										{
											$this->vdetalle[$i]["tax_rate"]     = intval($this->factura->detalleDeFactura[$i]->impuestosDetalles[0]->porcentajeTOTALImp);

											$this->vdetalle[$i]["tax_category"] = 'IVA';
										}
										
										if(!empty($this->factura->detalleDeFactura[$i]->mandatorioNumeroIdentificacion))
										{
											$this->vdetalle[$i]["mandante_identification"] = $this->factura->detalleDeFactura[$i]->mandatorioNumeroIdentificacion;
											if($this->factura->detalleDeFactura[$i]->mandatorioTipoIdentificacion==31)
											{
												$this->vdetalle[$i]["mandante_identification_type"] = 'NIT';
											}
											else
											{
												$this->vdetalle[$i]["mandante_identification_type"] = 'CC';
											}
										}
								...
								$vretorno = $this->fEnviarDataico($vparametros, $vcliente, $vencabezado, $this->vdetalle, $vrete);
								...
								if(!empty($vretorno2->cufe))
								{
									...
									$sql="UPDATE facturaven SET cufe = '".$vcufe."', enlacepdf='".$venlace_pdf."', estado='200', qr_base64='".$vqr_code."',fecha_validacion=concat(fechaven,' ".date("H:i:s")."'),id_trans_fe='".$vuuid."',avisos='".$venlace_xml."' WHERE idfacven='".$vidfacven."'";
     ...
     $nm_select = $sql; 
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vCF[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vcf[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vCF = false;
          $this->vCF_erro = $this->Db->ErrorMsg();
          $this->vcf = false;
          $this->vcf_erro = $this->Db->ErrorMsg();
      } 
;
									if(isset($this->vcf[0][0]))
									{
										echo "<div style='font-size:20px;'>DOCUMENTO ENVIADO CON ÉXITO!!!</div><br>";
									}
									else
									{
										echo "<div style='font-size:20px;'>HUBO UN PROBLEMA AL ENVIAR EL DOCUMENTO!!!</div><br>";
										print_r($vretorno);
									}
								}
		...
		{
			echo "EL DOCUMENTO NO ES DE FACTURACIÓN ELECTRÓNICA!";
		}
	}
}
else
{
	echo "<div style='font-size:20px;'>NO SE PUEDE ENVIAR UN DOCUMENTO SIN ASENTAR!!!</div><br>";
}
$_SESSION['scriptcase']['grid_NC_ND']['contr_erro'] = 'off'; 
    }  
    $_SESSION['scriptcase']['grid_NC_ND']['contr_erro'] = 'on';
...
if($this->asentada ==1)
{
	if(empty($this->cufe ))
	{
		echo "EL DOCUMENTO NO HA SIDO ENVIADO, PRIMERO ENVÍE EL DOCUMENTO ELECTRÓNICO.";
	}
	else
	{
		...
		$vidfv = $this->idfacven ;
		$vsql = "select idfacven, numfacven, fechaven, fechavenc, total,if(observaciones='TEMPORAL','',observaciones) as observ, id_trans_fe from facturaven where idfacven='".$vidfv."'";
...
;
						...
						switch($vwebservice_proveedor)
						{
							...
							case 'DATAICO':
								...
								if(!empty($vuuid))
								{
									$vemail_cliente = trim($this->factura->cliente->destinatario[0]->email->string);
									$vconsulta = 'curl -X PUT "'.$vServidor.'/'.$vuuid.' " -H  "accept: application/json" -H  "auth-token: '.$TokenEnterprise.'" -H  "Content-Type: application/json" -d "{  \"send_dian\": false,  \"send_email\": true,  \"email\": \"'.$vemail_cliente.'\",  \"pdf\": \"\"}"';
									$response = shell_exec($vconsulta);
									$vrespuesta = json_decode($response);
									if(isset($vrespuesta->email_status))
									{
										echo "<div>CORREO ENVIADO CON ÉXITO A: ".$vemail_cliente."!!!</div>";
									}
									else
									{
										echo "<div>HUBO PROBLEMA AL ENVIAR UN CORREO A: ".$vemail_cliente."!!!</div>";
									}
								}
								else
								{
									echo "<div>NO SE PUDO ENVIAR EL CORREO, POR FAVOR TRATE DE REENVIAR EL DOCUMENTO!!!</div>";
								}
...
if($vaccion=="EnviarNC"){
    ...
    $this->factura->cliente = new Cliente();
	$this->factura->cantidadDecimales = "2";
    $this->factura->cliente->actividadEconomicaCIIU = $ciuu;
	$destinatarios = new Destinatario();	
		$destinatarios->canalDeEntrega = "0";
...
;
	...
	$this->factura->cliente->direccionFiscal = $DireccionFiscal;
...
;
		...
		case 'EnviarND':
			...
			$this->factura->documentosReferenciados[0] =$DocRef2;
			...
			$this->factura->documentosReferenciados[1] =$DocRef3;
		break;
	}
	...
	if($resultado["codigo"]==200 or $resultado["codigo"]==201)
		{
			echo "<div>La nota crédito: ", $vPref."-".$vconsecutivo, " se ha enviado con éxito!</div>";
     ...
     $nm_select = $sql; 
      ...
      ;
	...
	else
		{
			...
			{
				echo "<div>La nota crédito: ", $vPref."-".$vconsecutivo, " no se puede enviar porque ya ha sido enviada.</div>";
...
?>
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          $tmp_cmd = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_fast'] = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_orig'])) 
          {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_orig']; 
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_filtro'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_filtro'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_filtro'] . ")"; 
              }
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_interativ'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_interativ'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_interativ'] . ")"; 
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq'] = $tmp_cmd;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_fast'] = $comando;
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_orig'])) 
      {
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_orig']; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_interativ'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_interativ'] . ")";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['fast_search'][0] = $in_fields;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['fast_search'][2] = $sv_data;
   }
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      if (isset($Nm_datas[$campo_join]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_sep_date']))
      {
   ...
   function SC_proc_interativ_search($Parms)
   {
       ...
       $cmd_sql = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['int_search_sql'][$tmp[0]];
       $vls     = "";
       $bol_numeric = false;
       if ($tmp[3] == "clear_interativ_all") {
           ...
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['interativ_search'][$tmp[0]]);
           if ($tmp[3] != "clear_interativ")
           {
               ...
               if ($tmp[2] == "dt" || $tmp[2] == "dh" || $tmp[2] == "hh")
               {
                   ...
                   {
                       $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_sep_date'];
                       $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_sep_date1'];
                   }
               }
           }
       }
       if (!empty($vls))
       {
           $prep = "";
           $bol_has_empty = false;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['interativ_search'][$tmp[0]]['tp_obj'] = $tmp[2];
           foreach ($vls as $cada_val)
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['interativ_search'][$tmp[0]]['lab'][$tmp[1]][] = $descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['interativ_search'][$tmp[0]]['val_sel'][] = $cada_val;
               if ($cada_val == "")
               {
                   $bol_has_empty = true;
               }
           ...
           if ($prep == "" && $bol_numeric)
           {
               if (in_array(strtolower($this->nm_tpbanco), $this->nm_bases_postgres))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " is null";
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " = '' or " . $cmd_sql . " is null";
               }
           }
           elseif ($prep == "" && $delim != "")
           {
           ...
           elseif ( $tmp[2] == "bw")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " between " . $delim . $range_bw[0] .  $delim1 . " and " . $delim . $range_bw[1] .  $delim1 . $str_add_null_or;
           }
           elseif ( $tmp[2] == "dt")
           {
               if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " IN (" . $prep . ")" . $str_add_null_or;
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " IN (" . $prep . ")" . $str_add_null_or;
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_fast'])) 
      {
          if (!empty($tmp_cmd)) 
          {
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_fast'] . ")";
          }
          else 
          {
              $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_fast'] . ")";
          }
      }
      ...
      { 
          if (empty($tmp_where)) 
          { 
              $tmp_cmd = "where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_resumo']; 
          } 
          else
          { 
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_resumo'] . ")"; 
          } 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_sem_interativ']  = $tmp_cmd;
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['interativ_search'])) 
      {
          $prim = true;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['interativ_search'] as $cmp => $val) 
          {
              if (!$prim)
              {
                 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_interativ'] .= " AND ";
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_interativ'] .= "(" . $val['val'] . ")";
              $prim = false;
          }
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq_interativ'])) 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_pesq'] = $tmp_cmd;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['refresh_interativ'] = (isset($tmp[5])) ? $tmp[5] : "S";
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>Notas Crédito/Débito :: Doc</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 <META http-equiv="Expires" content="Fri, Jan 01 1900 00:00:00 GMT"/>
 <META http-equiv="Last-Modified" content="<?php echo gmdate("D, d M Y H:i:s"); ?> GMT"/>
 <META http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"/>
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['grid_NC_ND']['sc_process_barr'])) {
       return;
   }
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_grid_NC_ND($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_grid_NC_ND($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "grid_NC_ND") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['grid_NC_ND']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['grid_NC_ND']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['grid_NC_ND']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv_2022'])) {
               $_SESSION['scriptcase']['grid_NC_ND']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv_2022'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['grid_NC_ND']['master_pai']) && $_SESSION['sc_session'][$init_filho]['grid_NC_ND']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['grid_NC_ND']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['grid_NC_ND']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['grid_NC_ND']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['grid_NC_ND']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['grid_NC_ND']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['grid_NC_ND']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['grid_NC_ND']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_NC_ND']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_NC_ND']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']);
               $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['grid_NC_ND']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['grid_NC_ND']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['grid_NC_ND']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['grid_NC_ND']['protect_modal']) && !empty($_SESSION['scriptcase']['grid_NC_ND']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['grid_NC_ND']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "grid_NC_ND";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'grid_NC_ND' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/grid_NC_ND/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['contr_total_geral'] = "NAO";
   }
   ...
   {
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'grid_NC_ND')
   {
       $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/grid_NC_ND_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opcao'] = $nmgp_opcao ;  
       }   
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['volta_redirect_tp'] = "";
           $nm_url_saida = "grid_NC_ND_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['sc_modal'] = true;
               }
               $nm_url_saida = "grid_NC_ND_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['mostra_edit'] = "N";   
           } 
       ...
       $contr_grid_NC_ND = new grid_NC_ND_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opcao'] = "busca";
          $contr_grid_NC_ND->NM_ajax_flag = true;
          $contr_grid_NC_ND->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opcao'] = "busca";
          $contr_grid_NC_ND->NM_ajax_flag = true;
          $contr_grid_NC_ND->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opcao'] = "busca";
          $contr_grid_NC_ND->NM_ajax_flag = true;
          $contr_grid_NC_ND->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opcao'] = "busca";
          $contr_grid_NC_ND->NM_ajax_flag = true;
          $contr_grid_NC_ND->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_grid_NC_ND->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_grid_NC_ND(&$str)
   {
   ...
   function nm_protect_num_grid_NC_ND($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function grid_NC_ND_pack_protect_string($sString)
   {
    ...
    function grid_NC_ND_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
