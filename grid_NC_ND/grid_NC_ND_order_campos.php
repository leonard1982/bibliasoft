<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_NC_ND_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_NC_ND_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["num"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['labels']["num"])) ? $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['labels']["num"] : "Número";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['labels']["idcli"] : "Cliente";
   ...
   {
       $tab_def_campos['factura'] = "";
   }
   $tab_labels["factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['labels']["factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['labels']["factura"] : "Factura Afectada";
   ...
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['labels']["pagada"] : "Pagada";
   $tab_ger_campos['asentada'] = "on";
   $tab_def_campos['asentada'] = "asentada";
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['labels']["asentada"] : "Asentada";
   $tab_ger_campos['pdf2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pdf2'] = "pdf2";
   }
   else
   {
       $tab_def_campos['pdf2'] = "";
   }
   $tab_labels["pdf2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['labels']["pdf2"])) ? $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['labels']["pdf2"] : "PDF";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_NC_ND_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_NC_ND']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
