...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Notas Crédito/Débito</span></td>
...
<?php
 ...
 <OPTION value="NO##@@NO"<?php if ($pagada == "NO") { echo " selected" ;} ?>>NO</option>
      ...
      <TD id='SC_credito_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['credito'])) ? $this->New_label['credito'] : "Crédito"; ?></TD>
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_NC_ND";
