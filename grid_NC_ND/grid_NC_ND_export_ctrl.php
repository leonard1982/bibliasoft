<?php
@session_start() ;
$_SESSION['scriptcase']['grid_NC_ND']['sc_process_barr'] = true;
require_once('../grid_NC_ND/index.php');
unset($_SESSION['scriptcase']['grid_NC_ND']['sc_process_barr']);
$ExportCtrl = new grid_NC_ND_export_control;
$ExportCtrl->Export_barr();

class grid_NC_ND_export_control
{
