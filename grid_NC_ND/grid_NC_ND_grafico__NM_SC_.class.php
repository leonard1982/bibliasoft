...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['contr_label_graf']['vendedor']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['contr_label_graf']['vendedor']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['contr_label_graf']['vendedor'];
      }
   }
...
//
   function grafico_col($campo_grafico)
   {
     ...
     if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_lab']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_lab']))
     {
         $this->calcula_graf_col();
     }
     if ($campo_grafico == "total")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['using_column_chart'] = "total";
         $array_lab        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_lab']['total'];
         $array_val[" "] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_val']['total'];
         $this->Decimais = 0;
         $graf_lab  = "Cliente";
         $graf_val  = "Total";
         $pos = true;
...
// GROUP BY idcli
     ...
     {  
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_lab']['total'][] = trim($idcli); 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['graf_val']['total'][] = $sum_total; 
         $rs_graf->MoveNext();
     }  
     $rs_graf->Close();
   }
...
<?php
   ...
   {
       $sChartTheme = '__app';
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['using_column_chart']) && "total" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['using_column_chart'])
       {
       $sChartTheme = 'scriptcase__NM__sc_Color.php';
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['using_column_chart']);
       }
