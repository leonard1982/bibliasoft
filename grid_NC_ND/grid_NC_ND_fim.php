...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_NC_ND"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_NC_ND"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_notas'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_NC_ND']['embutida_filho'] as $ind => $sc_init)
          {
