...
class grid_NC_ND_resumo
{
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
...
$_SESSION['scriptcase']['grid_NC_ND']['contr_erro'] = 'off'; 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['contr_total_geral'] == "OK")
      {
          $this->array_total_vendedor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['arr_total']['vendedor'];
      }
      else
      {
          $this->array_total_vendedor = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['tot_geral'][3];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['tot_geral'][4];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['tot_geral'][5];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['tot_geral'][6];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['tot_geral'][7];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['tot_geral'][8];
      $this->array_total_geral[8] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['tot_geral'][9];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['arr_total']['vendedor'] = $this->array_total_vendedor;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['json_use_label'])
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['num']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['num'] = "Número"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['idcli']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['idcli'] = "Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['factura'] = "Factura Afectada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['fechaven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['fechaven'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['motivo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['motivo'] = "Motivo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['pagada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['pagada'] = "Pagada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['asentada']))
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['enviar_propio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['enviar_propio'] = "Enviar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['reenviar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['reenviar'] = "Reenviar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['idfacven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['idfacven'] = "Idfacven"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['numfacven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['numfacven'] = "#"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['credito']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['credito'] = "Crédito"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['fechavenc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['fechavenc'] = "Vence"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['subtotal'] = "SubTotal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['valoriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['valoriva'] = "IVA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['observaciones'] = "Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['saldo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['saldo'] = "Saldo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['adicional']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['adicional'] = "Adicional"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['adicional2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['adicional2'] = "Adicional 2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['adicional3']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['adicional3'] = "Adicional 3"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['vendedor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['vendedor'] = "Vendedor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['pedido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['pedido'] = "Pedido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['resolucion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['resolucion'] = "Prefijo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['base_iva_19']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['base_iva_19'] = "Base Iva 19"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['valor_iva_19']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['valor_iva_19'] = "Valor Iva 19"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['base_iva_5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['base_iva_5'] = "Base Iva 5"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['valor_iva_5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['valor_iva_5'] = "Valor Iva 5"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['excento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['excento'] = "Excento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['imprimir']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['imprimir'] = "imprimir"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['print']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['print'] = "print"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['tipo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['tipo'] = "Tipo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['id_fact']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['id_fact'] = "Id Fact"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['cufe']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['cufe'] = "Cufe"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['enlacepdf']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['enlacepdf'] = "Enlacepdf"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['id_trans_fe']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['id_trans_fe'] = "Id Trans Fe"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['enviarfe']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['enviarfe'] = "Enviar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['estadofe']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['estadofe'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['imprmirtirilla']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['imprmirtirilla'] = "POS"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['pdf']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['labels']['pdf'] = "PDF"; 
       }
       //-----
       $this->comp_field_nm = array(
           'vendedor' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vendedor']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vendedor'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vendedor'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vendedor'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_NC_ND@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_NC_ND_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_NC_ND_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_NC_ND_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_NC_ND/grid_NC_ND_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_NC_ND_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_NC_ND_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_NC_ND_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_NC_ND/grid_NC_ND_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_NC_ND/grid_NC_ND_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_NC_ND/grid_NC_ND_config_graf_flash.php?nome_apl=grid_NC_ND&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_NC_ND_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_NC_ND']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_NC_ND_config_pivot.php?nome_apl=grid_NC_ND&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_NC_ND_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_NC_ND/grid_NC_ND_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->adicional = $rs_res->fields[15] ;  
            $this->adicional2 = $rs_res->fields[16] ;  
            $this->adicional3 = $rs_res->fields[17] ;  
            $this->vendedor = $rs_res->fields[18] ;  
            $this->pedido = $rs_res->fields[19] ;  
            $this->resolucion = $rs_res->fields[20] ;  
            $this->base_iva_19 = $rs_res->fields[21] ;  
            $this->base_iva_19 =  str_replace(",", ".", $this->base_iva_19);
            $this->valor_iva_19 = $rs_res->fields[22] ;  
            $this->valor_iva_19 =  str_replace(",", ".", $this->valor_iva_19);
            $this->base_iva_5 = $rs_res->fields[23] ;  
            $this->base_iva_5 =  str_replace(",", ".", $this->base_iva_5);
            $this->valor_iva_5 = $rs_res->fields[24] ;  
            $this->valor_iva_5 =  str_replace(",", ".", $this->valor_iva_5);
            $this->excento = $rs_res->fields[25] ;  
            $this->excento =  str_replace(",", ".", $this->excento);
            $this->tipo = $rs_res->fields[26] ;  
            $this->id_fact = $rs_res->fields[27] ;  
            $this->cufe = $rs_res->fields[28] ;  
            $this->enlacepdf = $rs_res->fields[29] ;  
            $this->estado = $rs_res->fields[30] ;  
