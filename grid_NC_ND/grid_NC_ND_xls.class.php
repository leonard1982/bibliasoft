...
$_SESSION['scriptcase']['grid_NC_ND']['contr_erro'] = 'off'; 
   ...
   function NM_export_motivo()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_motivo, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_motivo, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- total
   ...
   function NM_sub_cons_motivo()
   {
         ...
         $this->look_motivo = strip_tags($this->look_motivo);
         $this->look_motivo = NM_charset_to_utf8($this->look_motivo);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_motivo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
