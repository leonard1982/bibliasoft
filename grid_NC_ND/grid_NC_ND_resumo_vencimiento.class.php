...
$_SESSION['scriptcase']['grid_NC_ND']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_fechavenc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['arr_total']['fechavenc'];
      }
      else
      {
          $this->array_total_fechavenc = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['arr_total']['fechavenc'] = $this->array_total_fechavenc;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vencimiento']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vencimiento'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_order']['vencimiento'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NC_ND']['summarizing_fields_display']['vencimiento'] as $i_sum => $d_sum)
           {
