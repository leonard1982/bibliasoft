...
@session_start() ;
class control_recuperar_password_help
{
...
<?php echo "<b>CC/NIT</b><br>" . nl2br("El NIT sin el dígito de verificación"); ?>
</body>
</html>
<?php
        }
        if ($nm_cod_campo ==  "usuario")
        {
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
...
<body class="scFormHelpPage">
<?php echo "<b>Usuario</b><br>" . nl2br("Nombre del usuario"); ?>
</body>
</html>
<?php
        }
...
$exec_help = new control_recuperar_password_help();
?>
