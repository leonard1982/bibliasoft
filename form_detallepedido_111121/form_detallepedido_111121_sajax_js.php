  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detallepedido_111121" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detallepedido_111121_form();
	}
...
?>
  ...
  // ---------- Validate idpro_
  function do_ajax_form_detallepedido_111121_validate_idpro_(iNumLinha)
  {
  } // do_ajax_form_detallepedido_111121_validate_idpro_

  function do_ajax_form_detallepedido_111121_validate_idpro__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_idpro__cb

  // ---------- Validate descrip_
  function do_ajax_form_detallepedido_111121_validate_descrip_(iNumLinha)
  {
    var nomeCampo_descrip_ = "descrip_" + iNumLinha;
    var var_descrip_ = scAjaxGetFieldText(nomeCampo_descrip_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_descrip_(var_descrip_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_descrip__cb);
  } // do_ajax_form_detallepedido_111121_validate_descrip_

  function do_ajax_form_detallepedido_111121_validate_descrip__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "descrip_" + iLineNumber;
    }
    else
    {
      sFieldValid = "descrip_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "descrip_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "descrip_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_descrip__cb

  // ---------- Validate idbod_
  function do_ajax_form_detallepedido_111121_validate_idbod_(iNumLinha)
  {
    var nomeCampo_idbod_ = "idbod_" + iNumLinha;
    var var_idbod_ = scAjaxGetFieldSelect(nomeCampo_idbod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_idbod_(var_idbod_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_idbod__cb);
  } // do_ajax_form_detallepedido_111121_validate_idbod_

  function do_ajax_form_detallepedido_111121_validate_idbod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_idbod__cb

  // ---------- Validate unidad_
  function do_ajax_form_detallepedido_111121_validate_unidad_(iNumLinha)
  {
    var nomeCampo_unidad_ = "unidad_" + iNumLinha;
    var var_unidad_ = scAjaxGetFieldHidden(nomeCampo_unidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_unidad_(var_unidad_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_unidad__cb);
  } // do_ajax_form_detallepedido_111121_validate_unidad_

  function do_ajax_form_detallepedido_111121_validate_unidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_unidad__cb

  // ---------- Validate cantidad_
  function do_ajax_form_detallepedido_111121_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_cantidad__cb);
  } // do_ajax_form_detallepedido_111121_validate_cantidad_

  function do_ajax_form_detallepedido_111121_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_cantidad__cb

  // ---------- Validate valorunit_
  function do_ajax_form_detallepedido_111121_validate_valorunit_(iNumLinha)
  {
    var nomeCampo_valorunit_ = "valorunit_" + iNumLinha;
    var var_valorunit_ = scAjaxGetFieldText(nomeCampo_valorunit_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_valorunit_(var_valorunit_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_valorunit__cb);
  } // do_ajax_form_detallepedido_111121_validate_valorunit_

  function do_ajax_form_detallepedido_111121_validate_valorunit__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_valorunit__cb

  // ---------- Validate adicional_
  function do_ajax_form_detallepedido_111121_validate_adicional_(iNumLinha)
  {
    var nomeCampo_adicional_ = "adicional_" + iNumLinha;
    var var_adicional_ = scAjaxGetFieldHidden(nomeCampo_adicional_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_adicional_(var_adicional_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_adicional__cb);
  } // do_ajax_form_detallepedido_111121_validate_adicional_

  function do_ajax_form_detallepedido_111121_validate_adicional__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_adicional__cb

  // ---------- Validate descuento_
  function do_ajax_form_detallepedido_111121_validate_descuento_(iNumLinha)
  {
    var nomeCampo_descuento_ = "descuento_" + iNumLinha;
    var var_descuento_ = scAjaxGetFieldHidden(nomeCampo_descuento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_descuento_(var_descuento_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_descuento__cb);
  } // do_ajax_form_detallepedido_111121_validate_descuento_

  function do_ajax_form_detallepedido_111121_validate_descuento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_descuento__cb

  // ---------- Validate valorpar_
  function do_ajax_form_detallepedido_111121_validate_valorpar_(iNumLinha)
  {
    var nomeCampo_valorpar_ = "valorpar_" + iNumLinha;
    var var_valorpar_ = scAjaxGetFieldHidden(nomeCampo_valorpar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_valorpar_(var_valorpar_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_valorpar__cb);
  } // do_ajax_form_detallepedido_111121_validate_valorpar_

  function do_ajax_form_detallepedido_111121_validate_valorpar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_valorpar__cb

  // ---------- Validate unidadmayor_
  function do_ajax_form_detallepedido_111121_validate_unidadmayor_(iNumLinha)
  {
    var nomeCampo_unidadmayor_ = "unidadmayor_" + iNumLinha;
    var var_unidadmayor_ = scAjaxGetFieldSelect(nomeCampo_unidadmayor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_unidadmayor_(var_unidadmayor_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_unidadmayor__cb);
  } // do_ajax_form_detallepedido_111121_validate_unidadmayor_

  function do_ajax_form_detallepedido_111121_validate_unidadmayor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_unidadmayor__cb

  // ---------- Validate stockubica_
  function do_ajax_form_detallepedido_111121_validate_stockubica_(iNumLinha)
  {
    var nomeCampo_stockubica_ = "stockubica_" + iNumLinha;
    var var_stockubica_ = scAjaxGetFieldHidden(nomeCampo_stockubica_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_stockubica_(var_stockubica_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_stockubica__cb);
  } // do_ajax_form_detallepedido_111121_validate_stockubica_

  function do_ajax_form_detallepedido_111121_validate_stockubica__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_stockubica__cb

  // ---------- Validate obs_
  function do_ajax_form_detallepedido_111121_validate_obs_(iNumLinha)
  {
    var nomeCampo_obs_ = "obs_" + iNumLinha;
    var var_obs_ = scAjaxGetFieldText(nomeCampo_obs_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_obs_(var_obs_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_obs__cb);
  } // do_ajax_form_detallepedido_111121_validate_obs_

  function do_ajax_form_detallepedido_111121_validate_obs__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_obs__cb

  // ---------- Validate iddet_
  function do_ajax_form_detallepedido_111121_validate_iddet_(iNumLinha)
  {
    var nomeCampo_iddet_ = "iddet_" + iNumLinha;
    var var_iddet_ = scAjaxGetFieldHidden(nomeCampo_iddet_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_iddet_(var_iddet_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_iddet__cb);
  } // do_ajax_form_detallepedido_111121_validate_iddet_

  function do_ajax_form_detallepedido_111121_validate_iddet__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_iddet__cb

  // ---------- Validate colores_
  function do_ajax_form_detallepedido_111121_validate_colores_(iNumLinha)
  {
    var nomeCampo_colores_ = "colores_" + iNumLinha;
    var var_colores_ = scAjaxGetFieldSelect(nomeCampo_colores_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_colores_(var_colores_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_colores__cb);
  } // do_ajax_form_detallepedido_111121_validate_colores_

  function do_ajax_form_detallepedido_111121_validate_colores__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_colores__cb

  // ---------- Validate tallas_
  function do_ajax_form_detallepedido_111121_validate_tallas_(iNumLinha)
  {
    var nomeCampo_tallas_ = "tallas_" + iNumLinha;
    var var_tallas_ = scAjaxGetFieldSelect(nomeCampo_tallas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_tallas_(var_tallas_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_tallas__cb);
  } // do_ajax_form_detallepedido_111121_validate_tallas_

  function do_ajax_form_detallepedido_111121_validate_tallas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_tallas__cb

  // ---------- Validate sabor_
  function do_ajax_form_detallepedido_111121_validate_sabor_(iNumLinha)
  {
    var nomeCampo_sabor_ = "sabor_" + iNumLinha;
    var var_sabor_ = scAjaxGetFieldSelect(nomeCampo_sabor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_sabor_(var_sabor_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_sabor__cb);
  } // do_ajax_form_detallepedido_111121_validate_sabor_

  function do_ajax_form_detallepedido_111121_validate_sabor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_sabor__cb

  // ---------- Validate adicional1_
  function do_ajax_form_detallepedido_111121_validate_adicional1_(iNumLinha)
  {
    var nomeCampo_adicional1_ = "adicional1_" + iNumLinha;
    var var_adicional1_ = scAjaxGetFieldText(nomeCampo_adicional1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_adicional1_(var_adicional1_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_adicional1__cb);
  } // do_ajax_form_detallepedido_111121_validate_adicional1_

  function do_ajax_form_detallepedido_111121_validate_adicional1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_adicional1__cb

  // ---------- Validate factor_
  function do_ajax_form_detallepedido_111121_validate_factor_(iNumLinha)
  {
    var nomeCampo_factor_ = "factor_" + iNumLinha;
    var var_factor_ = scAjaxGetFieldText(nomeCampo_factor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_factor_(var_factor_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_factor__cb);
  } // do_ajax_form_detallepedido_111121_validate_factor_

  function do_ajax_form_detallepedido_111121_validate_factor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_factor__cb

  // ---------- Validate iva_
  function do_ajax_form_detallepedido_111121_validate_iva_(iNumLinha)
  {
    var nomeCampo_iva_ = "iva_" + iNumLinha;
    var var_iva_ = scAjaxGetFieldHidden(nomeCampo_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_iva_(var_iva_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_iva__cb);
  } // do_ajax_form_detallepedido_111121_validate_iva_

  function do_ajax_form_detallepedido_111121_validate_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_iva__cb

  // ---------- Validate costop_
  function do_ajax_form_detallepedido_111121_validate_costop_(iNumLinha)
  {
    var nomeCampo_costop_ = "costop_" + iNumLinha;
    var var_costop_ = scAjaxGetFieldText(nomeCampo_costop_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_costop_(var_costop_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_costop__cb);
  } // do_ajax_form_detallepedido_111121_validate_costop_

  function do_ajax_form_detallepedido_111121_validate_costop__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_costop__cb

  // ---------- Validate autorizarborrado_
  function do_ajax_form_detallepedido_111121_validate_autorizarborrado_(iNumLinha)
  {
    var nomeCampo_autorizarborrado_ = "autorizarborrado_" + iNumLinha;
    var var_autorizarborrado_ = scAjaxGetFieldRadio(nomeCampo_autorizarborrado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_autorizarborrado_(var_autorizarborrado_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_autorizarborrado__cb);
  } // do_ajax_form_detallepedido_111121_validate_autorizarborrado_

  function do_ajax_form_detallepedido_111121_validate_autorizarborrado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "autorizarborrado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "autorizarborrado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "autorizarborrado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "autorizarborrado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_autorizarborrado__cb

  // ---------- Validate estado_comanda_
  function do_ajax_form_detallepedido_111121_validate_estado_comanda_(iNumLinha)
  {
    var nomeCampo_estado_comanda_ = "estado_comanda_" + iNumLinha;
    var var_estado_comanda_ = scAjaxGetFieldHidden(nomeCampo_estado_comanda_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_estado_comanda_(var_estado_comanda_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_estado_comanda__cb);
  } // do_ajax_form_detallepedido_111121_validate_estado_comanda_

  function do_ajax_form_detallepedido_111121_validate_estado_comanda__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "estado_comanda_" + iLineNumber;
    }
    else
    {
      sFieldValid = "estado_comanda_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "estado_comanda_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "estado_comanda_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_estado_comanda__cb

  // ---------- Validate idpedid_
  function do_ajax_form_detallepedido_111121_validate_idpedid_(iNumLinha)
  {
    var nomeCampo_idpedid_ = "idpedid_" + iNumLinha;
    var var_idpedid_ = scAjaxGetFieldText(nomeCampo_idpedid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_validate_idpedid_(var_idpedid_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_111121_validate_idpedid__cb);
  } // do_ajax_form_detallepedido_111121_validate_idpedid_

  function do_ajax_form_detallepedido_111121_validate_idpedid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_validate_idpedid__cb

  // ---------- Refresh idpro_
  function do_ajax_form_detallepedido_111121_refresh_idpro_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_111121_refresh_idpro_(var_idpro_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_detallepedido_111121_refresh_idpro__cb);
  } // do_ajax_form_detallepedido_111121_refresh_idpro_

  function do_ajax_form_detallepedido_111121_refresh_idpro__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_111121_refresh_idpro__cb

  // ---------- Event onclick autorizarborrado_
  function do_ajax_form_detallepedido_111121_event_autorizarborrado__onclick(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("idpro_" + iSeqForm);
    var var_iddet_ = scAjaxGetFieldHidden("iddet_" + iSeqForm);
    var var_estado_comanda_ = scAjaxGetFieldHidden("estado_comanda_" + iSeqForm);
    var var_idpedid_ = scAjaxGetFieldText("idpedid_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_111121_event_autorizarborrado__onclick(var_idpro_, var_iddet_, var_estado_comanda_, var_idpedid_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_111121_event_autorizarborrado__onclick_cb);
  } // do_ajax_form_detallepedido_111121_event_autorizarborrado__onclick

  function do_ajax_form_detallepedido_111121_event_autorizarborrado__onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_111121_event_autorizarborrado__onclick_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_event_autorizarborrado__onclick_cb
  function do_ajax_form_detallepedido_111121_event_autorizarborrado__onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_111121_event_autorizarborrado__onclick_cb_after_alert

  // ---------- Event onblur cantidad_
  function do_ajax_form_detallepedido_111121_event_cantidad__onblur(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("idpro_" + iSeqForm);
    ...
    var var_adicional_ = scAjaxGetFieldHidden("adicional_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_111121_event_cantidad__onblur(var_idpro_, var_valorunit_, var_cantidad_, var_stockubica_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_idbod_, var_unidadmayor_, var_factor_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_111121_event_cantidad__onblur_cb);
  } // do_ajax_form_detallepedido_111121_event_cantidad__onblur

  function do_ajax_form_detallepedido_111121_event_cantidad__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_111121_event_cantidad__onblur_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_event_cantidad__onblur_cb
  function do_ajax_form_detallepedido_111121_event_cantidad__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_111121_event_cantidad__onblur_cb_after_alert

  // ---------- Event onchange cantidad_
  function do_ajax_form_detallepedido_111121_event_cantidad__onchange(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_stockubica_ = scAjaxGetFieldHidden("stockubica_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_111121_event_cantidad__onchange(var_cantidad_, var_stockubica_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_111121_event_cantidad__onchange_cb);
  } // do_ajax_form_detallepedido_111121_event_cantidad__onchange

  function do_ajax_form_detallepedido_111121_event_cantidad__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_111121_event_cantidad__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_event_cantidad__onchange_cb
  function do_ajax_form_detallepedido_111121_event_cantidad__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_111121_event_cantidad__onchange_cb_after_alert

  // ---------- Event onfocus cantidad_
  function do_ajax_form_detallepedido_111121_event_cantidad__onfocus(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn();
    x_ajax_form_detallepedido_111121_event_cantidad__onfocus(var_cantidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_111121_event_cantidad__onfocus_cb);
  } // do_ajax_form_detallepedido_111121_event_cantidad__onfocus

  function do_ajax_form_detallepedido_111121_event_cantidad__onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_111121_event_cantidad__onfocus_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_event_cantidad__onfocus_cb
  function do_ajax_form_detallepedido_111121_event_cantidad__onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_111121_event_cantidad__onfocus_cb_after_alert

  // ---------- Event onchange colores_
  function do_ajax_form_detallepedido_111121_event_colores__onchange(iSeqForm)
  {
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_111121_event_colores__onchange(var_colores_, var_idpro_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_111121_event_colores__onchange_cb);
  } // do_ajax_form_detallepedido_111121_event_colores__onchange

  function do_ajax_form_detallepedido_111121_event_colores__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_111121_event_colores__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_event_colores__onchange_cb
  function do_ajax_form_detallepedido_111121_event_colores__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_111121_event_colores__onchange_cb_after_alert

  // ---------- Event onblur idbod_
  function do_ajax_form_detallepedido_111121_event_idbod__onblur(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    var var_unidadmayor_ = scAjaxGetFieldSelect("unidadmayor_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_111121_event_idbod__onblur(var_idpro_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_111121_event_idbod__onblur_cb);
  } // do_ajax_form_detallepedido_111121_event_idbod__onblur

  function do_ajax_form_detallepedido_111121_event_idbod__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_111121_event_idbod__onblur_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_event_idbod__onblur_cb
  function do_ajax_form_detallepedido_111121_event_idbod__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_111121_event_idbod__onblur_cb_after_alert

  // ---------- Event onchange idbod_
  function do_ajax_form_detallepedido_111121_event_idbod__onchange(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    var var_unidadmayor_ = scAjaxGetFieldSelect("unidadmayor_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_111121_event_idbod__onchange(var_idpro_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_111121_event_idbod__onchange_cb);
  } // do_ajax_form_detallepedido_111121_event_idbod__onchange

  function do_ajax_form_detallepedido_111121_event_idbod__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_111121_event_idbod__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_event_idbod__onchange_cb
  function do_ajax_form_detallepedido_111121_event_idbod__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_111121_event_idbod__onchange_cb_after_alert

  // ---------- Event onchange idpro_
  function do_ajax_form_detallepedido_111121_event_idpro__onchange(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_111121_event_idpro__onchange(var_cantidad_, var_idpro_, var_valorunit_, var_unidadmayor_, var_costop_, var_factor_, var_idbod_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_colores_, var_tallas_, var_sabor_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_111121_event_idpro__onchange_cb);
  } // do_ajax_form_detallepedido_111121_event_idpro__onchange

  function do_ajax_form_detallepedido_111121_event_idpro__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_111121_event_idpro__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_event_idpro__onchange_cb
  function do_ajax_form_detallepedido_111121_event_idpro__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_detallepedido_111121_refresh_idpro_(iLineNumber);
    scAjaxRedir();
  } // do_ajax_form_detallepedido_111121_event_idpro__onchange_cb_after_alert

  // ---------- Event onchange sabor_
  function do_ajax_form_detallepedido_111121_event_sabor__onchange(iSeqForm)
  {
    var var_sabor_ = scAjaxGetFieldSelect("sabor_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_111121_event_sabor__onchange(var_sabor_, var_idpro_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_111121_event_sabor__onchange_cb);
  } // do_ajax_form_detallepedido_111121_event_sabor__onchange

  function do_ajax_form_detallepedido_111121_event_sabor__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_111121_event_sabor__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_event_sabor__onchange_cb
  function do_ajax_form_detallepedido_111121_event_sabor__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_111121_event_sabor__onchange_cb_after_alert

  // ---------- Event onchange tallas_
  function do_ajax_form_detallepedido_111121_event_tallas__onchange(iSeqForm)
  {
    var var_tallas_ = scAjaxGetFieldSelect("tallas_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_111121_event_tallas__onchange(var_tallas_, var_idpro_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_111121_event_tallas__onchange_cb);
  } // do_ajax_form_detallepedido_111121_event_tallas__onchange

  function do_ajax_form_detallepedido_111121_event_tallas__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_111121_event_tallas__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_event_tallas__onchange_cb
  function do_ajax_form_detallepedido_111121_event_tallas__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_111121_event_tallas__onchange_cb_after_alert

  // ---------- Event onchange unidadmayor_
  function do_ajax_form_detallepedido_111121_event_unidadmayor__onchange(iSeqForm)
  {
    var var_unidadmayor_ = scAjaxGetFieldSelect("unidadmayor_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_111121_event_unidadmayor__onchange(var_unidadmayor_, var_idpro_, var_valorunit_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_cantidad_, var_idbod_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_111121_event_unidadmayor__onchange_cb);
  } // do_ajax_form_detallepedido_111121_event_unidadmayor__onchange

  function do_ajax_form_detallepedido_111121_event_unidadmayor__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_111121_event_unidadmayor__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_event_unidadmayor__onchange_cb
  function do_ajax_form_detallepedido_111121_event_unidadmayor__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_111121_event_unidadmayor__onchange_cb_after_alert

  // ---------- Event onchange valorunit_
  function do_ajax_form_detallepedido_111121_event_valorunit__onchange(iSeqForm)
  {
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    var var_costop_ = scAjaxGetFieldText("costop_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_111121_event_valorunit__onchange(var_valorunit_, var_costop_, var_idpro_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_cantidad_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_111121_event_valorunit__onchange_cb);
  } // do_ajax_form_detallepedido_111121_event_valorunit__onchange

  function do_ajax_form_detallepedido_111121_event_valorunit__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_111121_event_valorunit__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_event_valorunit__onchange_cb
  function do_ajax_form_detallepedido_111121_event_valorunit__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_111121_event_valorunit__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detallepedido_111121_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detallepedido_111121_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_111121_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detallepedido_111121_add_new_line_cb);
  } // do_ajax_form_detallepedido_111121_add_new_line

  function do_ajax_form_detallepedido_111121_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_detallepedido_111121_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detallepedido_111121_backup_line(iNumLinha)
  {
    var var_iddet_ = scAjaxGetFieldHidden("iddet_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_111121_backup_line(var_iddet_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detallepedido_111121_backup_line_cb);
  } // do_ajax_form_detallepedido_111121_backup_line

  function do_ajax_form_detallepedido_111121_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detallepedido_111121_backup_line_cb

  function do_ajax_form_detallepedido_111121_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detallepedido_111121_cancel_insert

  function do_ajax_form_detallepedido_111121_cancel_update(iSeqVert)
  {
    do_ajax_form_detallepedido_111121_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detallepedido_111121_cancel_update

  function do_ajax_form_detallepedido_111121_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detallepedido_111121_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detallepedido_111121_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallepedido_111121_table_refresh(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallepedido_111121_table_refresh_cb);
  } //  do_ajax_form_detallepedido_111121_table_refresh

  function do_ajax_form_detallepedido_111121_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_detallepedido_111121_table_refresh_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_table_refresh_cb
  function do_ajax_form_detallepedido_111121_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_detallepedido_111121_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detallepedido_111121_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detallepedido_111121_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_adicional_ = scAjaxGetFieldHidden("adicional_" + iNumLinha);
    ...
    var var_autorizarborrado_ = scAjaxGetFieldRadio("autorizarborrado_" + iNumLinha);
    var var_estado_comanda_ = scAjaxGetFieldHidden("estado_comanda_" + iNumLinha);
...
?>
    x_ajax_form_detallepedido_111121_submit_form(var_idpro_, var_descrip_, var_idbod_, var_unidad_, var_cantidad_, var_valorunit_, var_adicional_, var_descuento_, var_valorpar_, var_unidadmayor_, var_stockubica_, var_obs_, var_iddet_, var_colores_, var_tallas_, var_sabor_, var_adicional1_, var_factor_, var_iva_, var_costop_, var_autorizarborrado_, var_estado_comanda_, var_idpedid_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detallepedido_111121_submit_form_cb);
  } // do_ajax_form_detallepedido_111121_submit_form

  function do_ajax_form_detallepedido_111121_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("descrip_" + sc_num_ult_line);
      ...
      scAjaxHideErrorDisplay("autorizarborrado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("estado_comanda_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_111121_submit_form_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_submit_form_cb
  function do_ajax_form_detallepedido_111121_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detallepedido_111121_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detallepedido_111121_navigate_form()
  {
    perform_ajax_form_detallepedido_111121_navigate_form();
  }

  function perform_ajax_form_detallepedido_111121_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("descrip_" + iNavForm);
      ...
      scAjaxHideErrorDisplay("autorizarborrado_" + iNavForm);
      scAjaxHideErrorDisplay("estado_comanda_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallepedido_111121_navigate_form(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallepedido_111121_navigate_form_cb);
  } // do_ajax_form_detallepedido_111121_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_111121']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detallepedido_111121_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detallepedido_111121_navigate_form_cb_after_alert);
  } // do_ajax_form_detallepedido_111121_navigate_form_cb
  function do_ajax_form_detallepedido_111121_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_detallepedido_111121_navigate_form_cb_after_alert
  function sc_hide_form_detallepedido_111121_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descrip_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "autorizarborrado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "estado_comanda_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["descrip_" + iNumLinha] = {"label": "Desc. Artículo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idbod_" + iNumLinha] = {"label": " Bodega<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["valorunit_" + iNumLinha] = {"label": "Unitario<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["adicional_" + iNumLinha] = {"label": "Impuesto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["valorpar_" + iNumLinha] = {"label": "Parcial<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["obs_" + iNumLinha] = {"label": "Desc. Artículo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["autorizarborrado_" + iNumLinha] = {"label": "Borrar<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["estado_comanda_" + iNumLinha] = {"label": "Estado<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["descrip_"][iNumLinha] = "descrip_" + iNumLinha;
    ...
    ajax_field_mult["autorizarborrado_"][iNumLinha] = "autorizarborrado_" + iNumLinha;
    ajax_field_mult["estado_comanda_"][iNumLinha] = "estado_comanda_" + iNumLinha;
    ...
    ajax_field_id["descrip_" + iNumLinha] = new Array("hidden_field_label_descrip_", "hidden_field_data_descrip_" + iNumLinha);
    ...
    ajax_error_count["descrip_" + iNumLinha] = "off";
    ...
    ajax_error_count["autorizarborrado_" + iNumLinha] = "off";
    ajax_error_count["estado_comanda_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["descrip_" + iNumLinha] = "off";
    ...
    ajax_read_only["autorizarborrado_" + iNumLinha] = "off";
    ajax_read_only["estado_comanda_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["descrip_" + iNumLinha] = "on";
    ...
    ajax_read_only["autorizarborrado_" + iNumLinha] = "on";
    ajax_read_only["estado_comanda_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["descrip_" + iNumLinha] = null;
    ...
    ajax_error_list["autorizarborrado_" + iNumLinha] = null;
    ajax_error_list["estado_comanda_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    ...
    "iva_": new Array(),
    "costop_": new Array(),
    "autorizarborrado_": new Array(),
    "estado_comanda_": new Array(),
    "idpedid_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["descrip_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["descrip_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["descrip_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["descrip_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["descrip_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["autorizarborrado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["autorizarborrado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["autorizarborrado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["autorizarborrado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["autorizarborrado_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["estado_comanda_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["estado_comanda_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["estado_comanda_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["estado_comanda_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["estado_comanda_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['descrip_'])) ? $this->nmgp_cmp_readonly['descrip_'] : 'off';
?>
    scAjaxFieldRead("descrip_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['autorizarborrado_'])) ? $this->nmgp_cmp_readonly['autorizarborrado_'] : 'off';
?>
    scAjaxFieldRead("autorizarborrado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['estado_comanda_'])) ? $this->nmgp_cmp_readonly['estado_comanda_'] : 'off';
?>
    scAjaxFieldRead("estado_comanda_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("descrip_" + iSeq, "on");
    ...
    scAjaxFieldRead("autorizarborrado_" + iSeq, "on");
    scAjaxFieldRead("estado_comanda_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idpro_" + iRow] || "on" == ajax_error_count["descrip_" + iRow] || "on" == ajax_error_count["idbod_" + iRow] || "on" == ajax_error_count["unidad_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["valorunit_" + iRow] || "on" == ajax_error_count["adicional_" + iRow] || "on" == ajax_error_count["descuento_" + iRow] || "on" == ajax_error_count["valorpar_" + iRow] || "on" == ajax_error_count["unidadmayor_" + iRow] || "on" == ajax_error_count["stockubica_" + iRow] || "on" == ajax_error_count["obs_" + iRow] || "on" == ajax_error_count["iddet_" + iRow] || "on" == ajax_error_count["colores_" + iRow] || "on" == ajax_error_count["tallas_" + iRow] || "on" == ajax_error_count["sabor_" + iRow] || "on" == ajax_error_count["adicional1_" + iRow] || "on" == ajax_error_count["factor_" + iRow] || "on" == ajax_error_count["iva_" + iRow] || "on" == ajax_error_count["costop_" + iRow] || "on" == ajax_error_count["autorizarborrado_" + iRow] || "on" == ajax_error_count["estado_comanda_" + iRow] || "on" == ajax_error_count["idpedid_" + iRow]))
    {
      ...
      $("#hidden_field_data_descrip_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_autorizarborrado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_estado_comanda_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idpro_" + iRow] && "off" == ajax_error_count["descrip_" + iRow] && "off" == ajax_error_count["idbod_" + iRow] && "off" == ajax_error_count["unidad_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["valorunit_" + iRow] && "off" == ajax_error_count["adicional_" + iRow] && "off" == ajax_error_count["descuento_" + iRow] && "off" == ajax_error_count["valorpar_" + iRow] && "off" == ajax_error_count["unidadmayor_" + iRow] && "off" == ajax_error_count["stockubica_" + iRow] && "off" == ajax_error_count["obs_" + iRow] && "off" == ajax_error_count["iddet_" + iRow] && "off" == ajax_error_count["colores_" + iRow] && "off" == ajax_error_count["tallas_" + iRow] && "off" == ajax_error_count["sabor_" + iRow] && "off" == ajax_error_count["adicional1_" + iRow] && "off" == ajax_error_count["factor_" + iRow] && "off" == ajax_error_count["iva_" + iRow] && "off" == ajax_error_count["costop_" + iRow] && "off" == ajax_error_count["autorizarborrado_" + iRow] && "off" == ajax_error_count["estado_comanda_" + iRow] && "off" == ajax_error_count["idpedid_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idpro_" + iRow] = "off";
        ajax_error_count["descrip_" + iRow] = "off";
        ...
        ajax_error_count["autorizarborrado_" + iRow] = "off";
        ajax_error_count["estado_comanda_" + iRow] = "off";
      ...
      $("#hidden_field_data_descrip_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_autorizarborrado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_estado_comanda_" + iRow).removeClass("scFormErrorLine");
