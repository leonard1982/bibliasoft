  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contactos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_contactos_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_contacto
  function do_ajax_form_contactos_mob_validate_id_contacto()
  {
    var nomeCampo_id_contacto = "id_contacto";
    var var_id_contacto = scAjaxGetFieldHidden(nomeCampo_id_contacto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_id_contacto(var_id_contacto, var_script_case_init, do_ajax_form_contactos_mob_validate_id_contacto_cb);
  } // do_ajax_form_contactos_mob_validate_id_contacto

  function do_ajax_form_contactos_mob_validate_id_contacto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_contacto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_id_contacto_cb

  // ---------- Validate nombres
  function do_ajax_form_contactos_mob_validate_nombres()
  {
    var nomeCampo_nombres = "nombres";
    var var_nombres = scAjaxGetFieldText(nomeCampo_nombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_nombres(var_nombres, var_script_case_init, do_ajax_form_contactos_mob_validate_nombres_cb);
  } // do_ajax_form_contactos_mob_validate_nombres

  function do_ajax_form_contactos_mob_validate_nombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombres";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_nombres_cb

  // ---------- Validate direccion
  function do_ajax_form_contactos_mob_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_contactos_mob_validate_direccion_cb);
  } // do_ajax_form_contactos_mob_validate_direccion

  function do_ajax_form_contactos_mob_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_direccion_cb

  // ---------- Validate observaciones
  function do_ajax_form_contactos_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_contactos_mob_validate_observaciones_cb);
  } // do_ajax_form_contactos_mob_validate_observaciones

  function do_ajax_form_contactos_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_observaciones_cb

  // ---------- Validate pais
  function do_ajax_form_contactos_mob_validate_pais()
  {
    var nomeCampo_pais = "pais";
    var var_pais = scAjaxGetFieldSelect(nomeCampo_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_pais(var_pais, var_script_case_init, do_ajax_form_contactos_mob_validate_pais_cb);
  } // do_ajax_form_contactos_mob_validate_pais

  function do_ajax_form_contactos_mob_validate_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pais";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_pais_cb

  // ---------- Validate ciudad
  function do_ajax_form_contactos_mob_validate_ciudad()
  {
    var nomeCampo_ciudad = "ciudad";
    var var_ciudad = scAjaxGetFieldText(nomeCampo_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_ciudad(var_ciudad, var_script_case_init, do_ajax_form_contactos_mob_validate_ciudad_cb);
  } // do_ajax_form_contactos_mob_validate_ciudad

  function do_ajax_form_contactos_mob_validate_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ciudad";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_ciudad_cb

  // ---------- Validate clasificacion
  function do_ajax_form_contactos_mob_validate_clasificacion()
  {
    var nomeCampo_clasificacion = "clasificacion";
    var var_clasificacion = scAjaxGetFieldSelect(nomeCampo_clasificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_clasificacion(var_clasificacion, var_script_case_init, do_ajax_form_contactos_mob_validate_clasificacion_cb);
  } // do_ajax_form_contactos_mob_validate_clasificacion

  function do_ajax_form_contactos_mob_validate_clasificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "clasificacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_clasificacion_cb

  // ---------- Validate asesor
  function do_ajax_form_contactos_mob_validate_asesor()
  {
    var nomeCampo_asesor = "asesor";
    var var_asesor = scAjaxGetFieldSelect(nomeCampo_asesor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_asesor(var_asesor, var_script_case_init, do_ajax_form_contactos_mob_validate_asesor_cb);
  } // do_ajax_form_contactos_mob_validate_asesor

  function do_ajax_form_contactos_mob_validate_asesor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asesor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_asesor_cb

  // ---------- Validate inactivo
  function do_ajax_form_contactos_mob_validate_inactivo()
  {
    var nomeCampo_inactivo = "inactivo";
    var var_inactivo = scAjaxGetFieldCheckbox(nomeCampo_inactivo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_inactivo(var_inactivo, var_script_case_init, do_ajax_form_contactos_mob_validate_inactivo_cb);
  } // do_ajax_form_contactos_mob_validate_inactivo

  function do_ajax_form_contactos_mob_validate_inactivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "inactivo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_inactivo_cb

  // ---------- Validate ultimo_contacto
  function do_ajax_form_contactos_mob_validate_ultimo_contacto()
  {
    var nomeCampo_ultimo_contacto = "ultimo_contacto";
    var var_ultimo_contacto = scAjaxGetFieldHidden(nomeCampo_ultimo_contacto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_ultimo_contacto(var_ultimo_contacto, var_script_case_init, do_ajax_form_contactos_mob_validate_ultimo_contacto_cb);
  } // do_ajax_form_contactos_mob_validate_ultimo_contacto

  function do_ajax_form_contactos_mob_validate_ultimo_contacto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ultimo_contacto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_ultimo_contacto_cb

  // ---------- Validate numero_contactos
  function do_ajax_form_contactos_mob_validate_numero_contactos()
  {
    var nomeCampo_numero_contactos = "numero_contactos";
    var var_numero_contactos = scAjaxGetFieldHidden(nomeCampo_numero_contactos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_numero_contactos(var_numero_contactos, var_script_case_init, do_ajax_form_contactos_mob_validate_numero_contactos_cb);
  } // do_ajax_form_contactos_mob_validate_numero_contactos

  function do_ajax_form_contactos_mob_validate_numero_contactos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero_contactos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_numero_contactos_cb

  // ---------- Validate clientes
  function do_ajax_form_contactos_mob_validate_clientes()
  {
    var nomeCampo_clientes = "clientes";
    var var_clientes = scAjaxGetFieldText(nomeCampo_clientes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_clientes(var_clientes, var_script_case_init, do_ajax_form_contactos_mob_validate_clientes_cb);
  } // do_ajax_form_contactos_mob_validate_clientes

  function do_ajax_form_contactos_mob_validate_clientes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "clientes";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_clientes_cb

  // ---------- Validate correos
  function do_ajax_form_contactos_mob_validate_correos()
  {
    var nomeCampo_correos = "correos";
    var var_correos = scAjaxGetFieldText(nomeCampo_correos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_correos(var_correos, var_script_case_init, do_ajax_form_contactos_mob_validate_correos_cb);
  } // do_ajax_form_contactos_mob_validate_correos

  function do_ajax_form_contactos_mob_validate_correos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_correos_cb

  // ---------- Validate telefonos
  function do_ajax_form_contactos_mob_validate_telefonos()
  {
    var nomeCampo_telefonos = "telefonos";
    var var_telefonos = scAjaxGetFieldText(nomeCampo_telefonos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_telefonos(var_telefonos, var_script_case_init, do_ajax_form_contactos_mob_validate_telefonos_cb);
  } // do_ajax_form_contactos_mob_validate_telefonos

  function do_ajax_form_contactos_mob_validate_telefonos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_telefonos_cb

  // ---------- Validate archivos
  function do_ajax_form_contactos_mob_validate_archivos()
  {
    var nomeCampo_archivos = "archivos";
    var var_archivos = scAjaxGetFieldText(nomeCampo_archivos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_mob_validate_archivos(var_archivos, var_script_case_init, do_ajax_form_contactos_mob_validate_archivos_cb);
  } // do_ajax_form_contactos_mob_validate_archivos

  function do_ajax_form_contactos_mob_validate_archivos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_mob_validate_archivos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_contactos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_contactos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_contacto = scAjaxGetFieldHidden("id_contacto");
    ...
    var var_pais = scAjaxGetFieldSelect("pais");
    var var_ciudad = scAjaxGetFieldText("ciudad");
    var var_clasificacion = scAjaxGetFieldSelect("clasificacion");
    var var_asesor = scAjaxGetFieldSelect("asesor");
    var var_inactivo = scAjaxGetFieldCheckbox("inactivo", ";");
    var var_ultimo_contacto = scAjaxGetFieldHidden("ultimo_contacto");
    var var_numero_contactos = scAjaxGetFieldHidden("numero_contactos");
    ...
    scAjaxProcOn();
    x_ajax_form_contactos_mob_submit_form(var_id_contacto, var_nombres, var_direccion, var_observaciones, var_pais, var_ciudad, var_clasificacion, var_asesor, var_inactivo, var_ultimo_contacto, var_numero_contactos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contactos_mob_submit_form_cb);
  } // do_ajax_form_contactos_mob_submit_form

  function do_ajax_form_contactos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_contacto");
      ...
      scAjaxHideErrorDisplay("clasificacion");
      scAjaxHideErrorDisplay("asesor");
      scAjaxHideErrorDisplay("inactivo");
      scAjaxHideErrorDisplay("ultimo_contacto");
      scAjaxHideErrorDisplay("numero_contactos");
      scAjaxHideErrorDisplay("clientes");
      scAjaxHideErrorDisplay("correos");
      scAjaxHideErrorDisplay("telefonos");
      scAjaxHideErrorDisplay("archivos");
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contactos_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contactos_mob']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contactos_mob']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_contactos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_contactos_mob_submit_form_cb
  function do_ajax_form_contactos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contactos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_contacto_clientes_mob"] = "off";
  scStatusDetail["form_contacto_correos_mob"] = "off";
  scStatusDetail["form_contacto_telefonos_mob"] = "off";
  scStatusDetail["form_contacto_cotizaciones_mob"] = "off";

  function do_ajax_form_contactos_mob_navigate_form()
  {
    perform_ajax_form_contactos_mob_navigate_form();
  }

  function perform_ajax_form_contactos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("telefonos");
    scAjaxHideErrorDisplay("archivos");
    var var_id_contacto = document.F2.id_contacto.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_contacto_clientes_mob"] = "on";
    scStatusDetail["form_contacto_correos_mob"] = "on";
    scStatusDetail["form_contacto_telefonos_mob"] = "on";
    scStatusDetail["form_contacto_cotizaciones_mob"] = "on";
    x_ajax_form_contactos_mob_navigate_form(var_id_contacto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contactos_mob_navigate_form_cb);
  } // do_ajax_form_contactos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contactos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contactos_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_contacto.value = scAjaxGetKeyValue("id_contacto");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_contacto_clientes_mob"] && "nmsc_iframe_liga_form_contacto_clientes_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_contacto_clientes_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_contacto_clientes_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_contacto_clientes_mob').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_contacto_clientes_mob').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_contacto_clientes_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_contacto_correos_mob"] && "nmsc_iframe_liga_form_contacto_correos_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_contacto_correos_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_contacto_correos_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_contacto_correos_mob').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_contacto_correos_mob').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_contacto_correos_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_contacto_telefonos_mob"] && "nmsc_iframe_liga_form_contacto_telefonos_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_contacto_telefonos_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_contacto_telefonos_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_contacto_telefonos_mob').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_contacto_telefonos_mob').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_contacto_telefonos_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_contacto_cotizaciones_mob"] && "nmsc_iframe_liga_form_contacto_cotizaciones_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_contacto_cotizaciones_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_contacto_cotizaciones_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_contacto_cotizaciones_mob').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_contacto_cotizaciones_mob').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_contacto_cotizaciones_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contactos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_contactos_mob_navigate_form_cb
  function do_ajax_form_contactos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_contactos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_contactos_mob_navigate_form_cb_after_alert
  function sc_hide_form_contactos_mob_form()
  {
  ...
  function do_ajax_form_contactos_mob_lkpedt_refresh_clasificacion()
  {
    var var_clasificacion = scAjaxGetFieldSelect("clasificacion");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "clasificacion";
    x_ajax_form_contactos_mob_lkpedt_refresh_clasificacion(var_clasificacion, nmgp_refresh_fields, var_script_case_init, do_ajax_form_contactos_mob_lkpedt_refresh_clasificacion_cb);
  } // do_ajax_form_contactos_mob_lkpedt_refresh_clasificacion

  function do_ajax_form_contactos_mob_lkpedt_refresh_clasificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_contactos_mob_lkpedt_refresh_clasificacion_cb
  ...
  {
    if ("off" == scStatusDetail["form_contacto_clientes_mob"] && "off" == scStatusDetail["form_contacto_correos_mob"] && "off" == scStatusDetail["form_contacto_telefonos_mob"] && "off" == scStatusDetail["form_contacto_cotizaciones_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "id_contacto";
  ajax_field_list[1] = "nombres";
  ajax_field_list[2] = "direccion";
  ajax_field_list[3] = "observaciones";
  ajax_field_list[4] = "pais";
  ajax_field_list[5] = "ciudad";
  ajax_field_list[6] = "clasificacion";
  ajax_field_list[7] = "asesor";
  ajax_field_list[8] = "inactivo";
  ajax_field_list[9] = "ultimo_contacto";
  ajax_field_list[10] = "numero_contactos";
  ajax_field_list[11] = "clientes";
  ajax_field_list[12] = "correos";
  ajax_field_list[13] = "telefonos";
  ajax_field_list[14] = "archivos";
  ...
  var ajax_error_list = {
    "id_contacto": {"label": "Id Contacto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "clasificacion": {"label": "Clasificacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "asesor": {"label": "Asesor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inactivo": {"label": "Inactivo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ultimo_contacto": {"label": "Ultimo Contacto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "numero_contactos": {"label": "Numero Contactos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "clientes": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "correos": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "telefonos": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "id_contacto": new Array(),
    "nombres": new Array(),
    "direccion": new Array(),
    "observaciones": new Array(),
    "pais": new Array(),
    "ciudad": new Array(),
    "clasificacion": new Array(),
    "asesor": new Array(),
    "inactivo": new Array(),
    "ultimo_contacto": new Array(),
    "numero_contactos": new Array(),
    "clientes": new Array(),
    "correos": new Array(),
    "telefonos": new Array(),
    "archivos": new Array()
  };
  ajax_field_mult["id_contacto"][1] = "id_contacto";
  ...
  ajax_field_mult["clasificacion"][1] = "clasificacion";
  ajax_field_mult["asesor"][1] = "asesor";
  ajax_field_mult["inactivo"][1] = "inactivo";
  ajax_field_mult["ultimo_contacto"][1] = "ultimo_contacto";
  ajax_field_mult["numero_contactos"][1] = "numero_contactos";
  ajax_field_mult["clientes"][1] = "clientes";
  ajax_field_mult["correos"][1] = "correos";
  ...
  var ajax_field_id = {
    ...
    "clasificacion": new Array("hidden_field_label_clasificacion", "hidden_field_data_clasificacion"),
    "asesor": new Array("hidden_field_label_asesor", "hidden_field_data_asesor"),
    "inactivo": new Array("hidden_field_label_inactivo", "hidden_field_data_inactivo"),
    "ultimo_contacto": new Array("hidden_field_label_ultimo_contacto", "hidden_field_data_ultimo_contacto"),
    "numero_contactos": new Array("hidden_field_label_numero_contactos", "hidden_field_data_numero_contactos"),
    "clientes": new Array("hidden_field_label_clientes", "hidden_field_data_clientes"),
    "correos": new Array("hidden_field_label_correos", "hidden_field_data_correos"),
