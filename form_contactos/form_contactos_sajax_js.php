  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contactos" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_contactos_validate_id_contacto()
  {
    var nomeCampo_id_contacto = "id_contacto";
    var var_id_contacto = scAjaxGetFieldHidden(nomeCampo_id_contacto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_id_contacto(var_id_contacto, var_script_case_init, do_ajax_form_contactos_validate_id_contacto_cb);
  } // do_ajax_form_contactos_validate_id_contacto

  function do_ajax_form_contactos_validate_id_contacto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_id_contacto_cb

  // ---------- Validate nombres
  function do_ajax_form_contactos_validate_nombres()
  {
    var nomeCampo_nombres = "nombres";
    var var_nombres = scAjaxGetFieldText(nomeCampo_nombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_nombres(var_nombres, var_script_case_init, do_ajax_form_contactos_validate_nombres_cb);
  } // do_ajax_form_contactos_validate_nombres

  function do_ajax_form_contactos_validate_nombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombres";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_nombres_cb

  // ---------- Validate direccion
  function do_ajax_form_contactos_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_contactos_validate_direccion_cb);
  } // do_ajax_form_contactos_validate_direccion

  function do_ajax_form_contactos_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_direccion_cb

  // ---------- Validate observaciones
  function do_ajax_form_contactos_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_contactos_validate_observaciones_cb);
  } // do_ajax_form_contactos_validate_observaciones

  function do_ajax_form_contactos_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_observaciones_cb

  // ---------- Validate pais
  function do_ajax_form_contactos_validate_pais()
  {
    var nomeCampo_pais = "pais";
    var var_pais = scAjaxGetFieldSelect(nomeCampo_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_pais(var_pais, var_script_case_init, do_ajax_form_contactos_validate_pais_cb);
  } // do_ajax_form_contactos_validate_pais

  function do_ajax_form_contactos_validate_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pais";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_pais_cb

  // ---------- Validate ciudad
  function do_ajax_form_contactos_validate_ciudad()
  {
    var nomeCampo_ciudad = "ciudad";
    var var_ciudad = scAjaxGetFieldText(nomeCampo_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_ciudad(var_ciudad, var_script_case_init, do_ajax_form_contactos_validate_ciudad_cb);
  } // do_ajax_form_contactos_validate_ciudad

  function do_ajax_form_contactos_validate_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ciudad";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_ciudad_cb

  // ---------- Validate clasificacion
  function do_ajax_form_contactos_validate_clasificacion()
  {
    var nomeCampo_clasificacion = "clasificacion";
    var var_clasificacion = scAjaxGetFieldSelect(nomeCampo_clasificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_clasificacion(var_clasificacion, var_script_case_init, do_ajax_form_contactos_validate_clasificacion_cb);
  } // do_ajax_form_contactos_validate_clasificacion

  function do_ajax_form_contactos_validate_clasificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_clasificacion_cb

  // ---------- Validate asesor
  function do_ajax_form_contactos_validate_asesor()
  {
    var nomeCampo_asesor = "asesor";
    var var_asesor = scAjaxGetFieldSelect(nomeCampo_asesor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_asesor(var_asesor, var_script_case_init, do_ajax_form_contactos_validate_asesor_cb);
  } // do_ajax_form_contactos_validate_asesor

  function do_ajax_form_contactos_validate_asesor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asesor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_asesor_cb

  // ---------- Validate inactivo
  function do_ajax_form_contactos_validate_inactivo()
  {
    var nomeCampo_inactivo = "inactivo";
    var var_inactivo = scAjaxGetFieldCheckbox(nomeCampo_inactivo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_inactivo(var_inactivo, var_script_case_init, do_ajax_form_contactos_validate_inactivo_cb);
  } // do_ajax_form_contactos_validate_inactivo

  function do_ajax_form_contactos_validate_inactivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_inactivo_cb

  // ---------- Validate ultimo_contacto
  function do_ajax_form_contactos_validate_ultimo_contacto()
  {
    var nomeCampo_ultimo_contacto = "ultimo_contacto";
    var var_ultimo_contacto = scAjaxGetFieldHidden(nomeCampo_ultimo_contacto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_ultimo_contacto(var_ultimo_contacto, var_script_case_init, do_ajax_form_contactos_validate_ultimo_contacto_cb);
  } // do_ajax_form_contactos_validate_ultimo_contacto

  function do_ajax_form_contactos_validate_ultimo_contacto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_ultimo_contacto_cb

  // ---------- Validate numero_contactos
  function do_ajax_form_contactos_validate_numero_contactos()
  {
    var nomeCampo_numero_contactos = "numero_contactos";
    var var_numero_contactos = scAjaxGetFieldHidden(nomeCampo_numero_contactos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_numero_contactos(var_numero_contactos, var_script_case_init, do_ajax_form_contactos_validate_numero_contactos_cb);
  } // do_ajax_form_contactos_validate_numero_contactos

  function do_ajax_form_contactos_validate_numero_contactos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_numero_contactos_cb

  // ---------- Validate clientes
  function do_ajax_form_contactos_validate_clientes()
  {
    var nomeCampo_clientes = "clientes";
    var var_clientes = scAjaxGetFieldText(nomeCampo_clientes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_clientes(var_clientes, var_script_case_init, do_ajax_form_contactos_validate_clientes_cb);
  } // do_ajax_form_contactos_validate_clientes

  function do_ajax_form_contactos_validate_clientes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_clientes_cb

  // ---------- Validate correos
  function do_ajax_form_contactos_validate_correos()
  {
    var nomeCampo_correos = "correos";
    var var_correos = scAjaxGetFieldText(nomeCampo_correos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_correos(var_correos, var_script_case_init, do_ajax_form_contactos_validate_correos_cb);
  } // do_ajax_form_contactos_validate_correos

  function do_ajax_form_contactos_validate_correos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_correos_cb

  // ---------- Validate telefonos
  function do_ajax_form_contactos_validate_telefonos()
  {
    var nomeCampo_telefonos = "telefonos";
    var var_telefonos = scAjaxGetFieldText(nomeCampo_telefonos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_telefonos(var_telefonos, var_script_case_init, do_ajax_form_contactos_validate_telefonos_cb);
  } // do_ajax_form_contactos_validate_telefonos

  function do_ajax_form_contactos_validate_telefonos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_telefonos_cb

  // ---------- Validate archivos
  function do_ajax_form_contactos_validate_archivos()
  {
    var nomeCampo_archivos = "archivos";
    var var_archivos = scAjaxGetFieldText(nomeCampo_archivos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contactos_validate_archivos(var_archivos, var_script_case_init, do_ajax_form_contactos_validate_archivos_cb);
  } // do_ajax_form_contactos_validate_archivos

  function do_ajax_form_contactos_validate_archivos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contactos_validate_archivos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_contactos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_contactos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_contactos_submit_form(var_id_contacto, var_nombres, var_direccion, var_observaciones, var_pais, var_ciudad, var_clasificacion, var_asesor, var_inactivo, var_ultimo_contacto, var_numero_contactos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contactos_submit_form_cb);
  } // do_ajax_form_contactos_submit_form

  function do_ajax_form_contactos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_contactos_submit_form_cb_after_alert);
  } // do_ajax_form_contactos_submit_form_cb
  function do_ajax_form_contactos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contactos_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_contacto_clientes"] = "off";
  scStatusDetail["form_contacto_correos"] = "off";
  scStatusDetail["form_contacto_telefonos"] = "off";
  scStatusDetail["form_contacto_cotizaciones"] = "off";

  function do_ajax_form_contactos_navigate_form()
  {
    perform_ajax_form_contactos_navigate_form();
  }

  function perform_ajax_form_contactos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_contacto_clientes"] = "on";
    scStatusDetail["form_contacto_correos"] = "on";
    scStatusDetail["form_contacto_telefonos"] = "on";
    scStatusDetail["form_contacto_cotizaciones"] = "on";
    x_ajax_form_contactos_navigate_form(var_id_contacto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contactos_navigate_form_cb);
  } // do_ajax_form_contactos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contactos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contactos_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_contacto_clientes"] && "nmsc_iframe_liga_form_contacto_clientes" != scMasterDetailIframe["nmsc_iframe_liga_form_contacto_clientes"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_contacto_clientes"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_contacto_clientes').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_contacto_clientes').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_contacto_clientes').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_contacto_correos"] && "nmsc_iframe_liga_form_contacto_correos" != scMasterDetailIframe["nmsc_iframe_liga_form_contacto_correos"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_contacto_correos"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_contacto_correos').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_contacto_correos').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_contacto_correos').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_contacto_telefonos"] && "nmsc_iframe_liga_form_contacto_telefonos" != scMasterDetailIframe["nmsc_iframe_liga_form_contacto_telefonos"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_contacto_telefonos"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_contacto_telefonos').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_contacto_telefonos').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_contacto_telefonos').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_contacto_cotizaciones"] && "nmsc_iframe_liga_form_contacto_cotizaciones" != scMasterDetailIframe["nmsc_iframe_liga_form_contacto_cotizaciones"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_contacto_cotizaciones"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_contacto_cotizaciones').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_contacto_cotizaciones').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_contacto_cotizaciones').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contactos_navigate_form_cb_after_alert);
  } // do_ajax_form_contactos_navigate_form_cb
  function do_ajax_form_contactos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_contactos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_contactos_navigate_form_cb_after_alert
  function sc_hide_form_contactos_form()
  {
  ...
  function do_ajax_form_contactos_lkpedt_refresh_clasificacion()
  {
    var var_clasificacion = scAjaxGetFieldSelect("clasificacion");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "clasificacion";
    x_ajax_form_contactos_lkpedt_refresh_clasificacion(var_clasificacion, nmgp_refresh_fields, var_script_case_init, do_ajax_form_contactos_lkpedt_refresh_clasificacion_cb);
  } // do_ajax_form_contactos_lkpedt_refresh_clasificacion

  function do_ajax_form_contactos_lkpedt_refresh_clasificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_contactos_lkpedt_refresh_clasificacion_cb
  ...
  {
    if ("off" == scStatusDetail["form_contacto_clientes"] && "off" == scStatusDetail["form_contacto_correos"] && "off" == scStatusDetail["form_contacto_telefonos"] && "off" == scStatusDetail["form_contacto_cotizaciones"])
    {
      return true;
    }
    return false;
