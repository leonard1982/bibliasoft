...
$old_error_handler = set_error_handler("form_facturaven_automaticas_detalleventa_scriptcase_error_handler");

function form_facturaven_automaticas_detalleventa_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_facturaven_automaticas_detalleventa']['contr_erro']) && $_SESSION['scriptcase']['form_facturaven_automaticas_detalleventa']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            global $inicial_form_facturaven_automaticas_detalleventa;
            $inicial_form_facturaven_automaticas_detalleventa->contr_form_facturaven_automaticas_detalleventa->Apl_com_erro = true;
            if ($inicial_form_facturaven_automaticas_detalleventa->contr_form_facturaven_automaticas_detalleventa->NM_ajax_flag)
            {
                $inicial_form_facturaven_automaticas_detalleventa->contr_form_facturaven_automaticas_detalleventa->NM_ajax_info['errList']['geral_form_facturaven_automaticas_detalleventa'][] = $msg;
                return;
            }
            form_facturaven_automaticas_detalleventa_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_facturaven_automaticas_detalleventa_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_facturaven_automaticas_detalleventa'])  && '' != $_SESSION['scriptcase']['error_icon']['form_facturaven_automaticas_detalleventa'])  ? $_SESSION['scriptcase']['error_icon']['form_facturaven_automaticas_detalleventa']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_facturaven_automaticas_detalleventa']) && '' != $_SESSION['scriptcase']['error_span_title']['form_facturaven_automaticas_detalleventa']) ? $_SESSION['scriptcase']['error_span_title']['form_facturaven_automaticas_detalleventa'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_facturaven_automaticas_detalleventa']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_facturaven_automaticas_detalleventa']) ? $_SESSION['scriptcase']['error_icon_title']['form_facturaven_automaticas_detalleventa'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_facturaven_automaticas_detalleventa']['error_buffer'] .= ob_get_flush();
}
