  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_facturaven_automaticas_detalleventa" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_facturaven_automaticas_detalleventa_form();
	}
  ...
  // ---------- Validate numfac_
  function do_ajax_form_facturaven_automaticas_detalleventa_validate_numfac_(iNumLinha)
  {
    var nomeCampo_numfac_ = "numfac_" + iNumLinha;
    var var_numfac_ = scAjaxGetFieldText(nomeCampo_numfac_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_detalleventa_validate_numfac_(var_numfac_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_automaticas_detalleventa_validate_numfac__cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_numfac_

  function do_ajax_form_facturaven_automaticas_detalleventa_validate_numfac__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_numfac__cb

  // ---------- Validate idpro_
  function do_ajax_form_facturaven_automaticas_detalleventa_validate_idpro_(iNumLinha)
  {
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_idpro_

  function do_ajax_form_facturaven_automaticas_detalleventa_validate_idpro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_idpro__cb

  // ---------- Validate obs_
  function do_ajax_form_facturaven_automaticas_detalleventa_validate_obs_(iNumLinha)
  {
    var nomeCampo_obs_ = "obs_" + iNumLinha;
    var var_obs_ = scAjaxGetFieldText(nomeCampo_obs_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_detalleventa_validate_obs_(var_obs_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_automaticas_detalleventa_validate_obs__cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_obs_

  function do_ajax_form_facturaven_automaticas_detalleventa_validate_obs__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_obs__cb

  // ---------- Validate cantidad_
  function do_ajax_form_facturaven_automaticas_detalleventa_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_detalleventa_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_automaticas_detalleventa_validate_cantidad__cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_cantidad_

  function do_ajax_form_facturaven_automaticas_detalleventa_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_cantidad__cb

  // ---------- Validate valorunit_
  function do_ajax_form_facturaven_automaticas_detalleventa_validate_valorunit_(iNumLinha)
  {
    var nomeCampo_valorunit_ = "valorunit_" + iNumLinha;
    var var_valorunit_ = scAjaxGetFieldText(nomeCampo_valorunit_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_detalleventa_validate_valorunit_(var_valorunit_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_automaticas_detalleventa_validate_valorunit__cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_valorunit_

  function do_ajax_form_facturaven_automaticas_detalleventa_validate_valorunit__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_valorunit__cb

  // ---------- Validate valorpar_
  function do_ajax_form_facturaven_automaticas_detalleventa_validate_valorpar_(iNumLinha)
  {
    var nomeCampo_valorpar_ = "valorpar_" + iNumLinha;
    var var_valorpar_ = scAjaxGetFieldHidden(nomeCampo_valorpar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_detalleventa_validate_valorpar_(var_valorpar_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_automaticas_detalleventa_validate_valorpar__cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_valorpar_

  function do_ajax_form_facturaven_automaticas_detalleventa_validate_valorpar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_valorpar__cb

  // ---------- Validate descr_
  function do_ajax_form_facturaven_automaticas_detalleventa_validate_descr_(iNumLinha)
  {
    var nomeCampo_descr_ = "descr_" + iNumLinha;
    var var_descr_ = scAjaxGetFieldText(nomeCampo_descr_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_detalleventa_validate_descr_(var_descr_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_automaticas_detalleventa_validate_descr__cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_descr_

  function do_ajax_form_facturaven_automaticas_detalleventa_validate_descr__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "descr_" + iLineNumber;
    }
    else
    {
      sFieldValid = "descr_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "descr_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "descr_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_descr__cb

  // ---------- Validate tbase_
  function do_ajax_form_facturaven_automaticas_detalleventa_validate_tbase_(iNumLinha)
  {
    var nomeCampo_tbase_ = "tbase_" + iNumLinha;
    var var_tbase_ = scAjaxGetFieldText(nomeCampo_tbase_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_detalleventa_validate_tbase_(var_tbase_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_automaticas_detalleventa_validate_tbase__cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_tbase_

  function do_ajax_form_facturaven_automaticas_detalleventa_validate_tbase__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tbase_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tbase_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tbase_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tbase_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_tbase__cb

  // ---------- Validate tneto_
  function do_ajax_form_facturaven_automaticas_detalleventa_validate_tneto_(iNumLinha)
  {
    var nomeCampo_tneto_ = "tneto_" + iNumLinha;
    var var_tneto_ = scAjaxGetFieldText(nomeCampo_tneto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_detalleventa_validate_tneto_(var_tneto_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_automaticas_detalleventa_validate_tneto__cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_tneto_

  function do_ajax_form_facturaven_automaticas_detalleventa_validate_tneto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tneto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tneto_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tneto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tneto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_detalleventa_validate_tneto__cb

  // ---------- Event onchange cantidad_
  function do_ajax_form_facturaven_automaticas_detalleventa_event_cantidad__onchange(iSeqForm)
  {
    ...
    var var_tbase_ = scAjaxGetFieldText("tbase_" + iSeqForm);
    var var_tneto_ = scAjaxGetFieldText("tneto_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_facturaven_automaticas_detalleventa_event_cantidad__onchange(var_idpro_, var_cantidad_, var_valorunit_, var_valorpar_, var_tbase_, var_tneto_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_facturaven_automaticas_detalleventa_event_cantidad__onchange_cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_event_cantidad__onchange

  function do_ajax_form_facturaven_automaticas_detalleventa_event_cantidad__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_facturaven_automaticas_detalleventa_event_cantidad__onchange_cb_after_alert);
  } // do_ajax_form_facturaven_automaticas_detalleventa_event_cantidad__onchange_cb
  function do_ajax_form_facturaven_automaticas_detalleventa_event_cantidad__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_facturaven_automaticas_detalleventa_event_cantidad__onchange_cb_after_alert

  // ---------- Event onchange idpro_
  function do_ajax_form_facturaven_automaticas_detalleventa_event_idpro__onchange(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_facturaven_automaticas_detalleventa_event_idpro__onchange(var_idpro_, var_cantidad_, var_valorunit_, var_valorpar_, var_tbase_, var_tneto_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_facturaven_automaticas_detalleventa_event_idpro__onchange_cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_event_idpro__onchange

  function do_ajax_form_facturaven_automaticas_detalleventa_event_idpro__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_facturaven_automaticas_detalleventa_event_idpro__onchange_cb_after_alert);
  } // do_ajax_form_facturaven_automaticas_detalleventa_event_idpro__onchange_cb
  function do_ajax_form_facturaven_automaticas_detalleventa_event_idpro__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_facturaven_automaticas_detalleventa_event_idpro__onchange_cb_after_alert

  // ---------- Event onchange valorunit_
  function do_ajax_form_facturaven_automaticas_detalleventa_event_valorunit__onchange(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_facturaven_automaticas_detalleventa_event_valorunit__onchange(var_idpro_, var_cantidad_, var_valorunit_, var_valorpar_, var_tbase_, var_tneto_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_facturaven_automaticas_detalleventa_event_valorunit__onchange_cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_event_valorunit__onchange

  function do_ajax_form_facturaven_automaticas_detalleventa_event_valorunit__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_facturaven_automaticas_detalleventa_event_valorunit__onchange_cb_after_alert);
  } // do_ajax_form_facturaven_automaticas_detalleventa_event_valorunit__onchange_cb
  function do_ajax_form_facturaven_automaticas_detalleventa_event_valorunit__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_facturaven_automaticas_detalleventa_event_valorunit__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_facturaven_automaticas_detalleventa_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_facturaven_automaticas_detalleventa_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_facturaven_automaticas_detalleventa_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_facturaven_automaticas_detalleventa_add_new_line_cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_add_new_line

  function do_ajax_form_facturaven_automaticas_detalleventa_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_facturaven_automaticas_detalleventa_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_facturaven_automaticas_detalleventa_backup_line(iNumLinha)
  {
    var var_iddet_ = scAjaxGetFieldText("iddet_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_detalleventa_backup_line(var_iddet_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_facturaven_automaticas_detalleventa_backup_line_cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_backup_line

  function do_ajax_form_facturaven_automaticas_detalleventa_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_facturaven_automaticas_detalleventa_backup_line_cb

  function do_ajax_form_facturaven_automaticas_detalleventa_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_facturaven_automaticas_detalleventa_cancel_insert

  function do_ajax_form_facturaven_automaticas_detalleventa_cancel_update(iSeqVert)
  {
    do_ajax_form_facturaven_automaticas_detalleventa_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_facturaven_automaticas_detalleventa_cancel_update

  function do_ajax_form_facturaven_automaticas_detalleventa_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_facturaven_automaticas_detalleventa_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_facturaven_automaticas_detalleventa_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_facturaven_automaticas_detalleventa_table_refresh(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_facturaven_automaticas_detalleventa_table_refresh_cb);
  } //  do_ajax_form_facturaven_automaticas_detalleventa_table_refresh

  function do_ajax_form_facturaven_automaticas_detalleventa_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_facturaven_automaticas_detalleventa_table_refresh_cb_after_alert);
  } // do_ajax_form_facturaven_automaticas_detalleventa_table_refresh_cb
  function do_ajax_form_facturaven_automaticas_detalleventa_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_facturaven_automaticas_detalleventa_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_facturaven_automaticas_detalleventa_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_facturaven_automaticas_detalleventa_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_descr_ = scAjaxGetFieldText("descr_" + iNumLinha);
    var var_tbase_ = scAjaxGetFieldText("tbase_" + iNumLinha);
    var var_tneto_ = scAjaxGetFieldText("tneto_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_facturaven_automaticas_detalleventa_submit_form(var_numfac_, var_idpro_, var_obs_, var_cantidad_, var_valorunit_, var_valorpar_, var_descr_, var_tbase_, var_tneto_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_facturaven_automaticas_detalleventa_submit_form_cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_submit_form

  function do_ajax_form_facturaven_automaticas_detalleventa_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("descr_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tbase_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tneto_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_facturaven_automaticas_detalleventa_submit_form_cb_after_alert);
  } // do_ajax_form_facturaven_automaticas_detalleventa_submit_form_cb
  function do_ajax_form_facturaven_automaticas_detalleventa_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_facturaven_automaticas_detalleventa_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_facturaven_automaticas_detalleventa_navigate_form()
  {
    perform_ajax_form_facturaven_automaticas_detalleventa_navigate_form();
  }

  function perform_ajax_form_facturaven_automaticas_detalleventa_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_facturaven_automaticas_detalleventa_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("descr_" + iNavForm);
      scAjaxHideErrorDisplay("tbase_" + iNavForm);
      scAjaxHideErrorDisplay("tneto_" + iNavForm);
    }
    var var_iddet_ = document.F2.iddet_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_facturaven_automaticas_detalleventa_navigate_form(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_facturaven_automaticas_detalleventa_navigate_form_cb);
  } // do_ajax_form_facturaven_automaticas_detalleventa_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas_detalleventa']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_facturaven_automaticas_detalleventa_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_facturaven_automaticas_detalleventa_navigate_form_cb_after_alert);
  } // do_ajax_form_facturaven_automaticas_detalleventa_navigate_form_cb
  function do_ajax_form_facturaven_automaticas_detalleventa_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_facturaven_automaticas_detalleventa_navigate_form_cb_after_alert
  function sc_hide_form_facturaven_automaticas_detalleventa_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descr_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tbase_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tneto_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["obs_" + iNumLinha] = {"label": "Ampliada<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["descr_" + iNumLinha] = {"label": "Descr<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tbase_" + iNumLinha] = {"label": "Tbase<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tneto_" + iNumLinha] = {"label": "Tneto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["descr_"][iNumLinha] = "descr_" + iNumLinha;
    ajax_field_mult["tbase_"][iNumLinha] = "tbase_" + iNumLinha;
    ajax_field_mult["tneto_"][iNumLinha] = "tneto_" + iNumLinha;
    ...
    ajax_error_count["descr_" + iNumLinha] = "off";
    ajax_error_count["tbase_" + iNumLinha] = "off";
    ajax_error_count["tneto_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["descr_" + iNumLinha] = "off";
    ajax_read_only["tbase_" + iNumLinha] = "off";
    ajax_read_only["tneto_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["descr_" + iNumLinha] = "on";
    ajax_read_only["tbase_" + iNumLinha] = "on";
    ajax_read_only["tneto_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["descr_" + iNumLinha] = null;
    ajax_error_list["tbase_" + iNumLinha] = null;
    ajax_error_list["tneto_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["descr_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["descr_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["descr_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["descr_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["descr_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tbase_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tbase_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tbase_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tbase_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tbase_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tneto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tneto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tneto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tneto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tneto_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['descr_'])) ? $this->nmgp_cmp_readonly['descr_'] : 'off';
?>
    scAjaxFieldRead("descr_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tbase_'])) ? $this->nmgp_cmp_readonly['tbase_'] : 'off';
?>
    scAjaxFieldRead("tbase_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tneto_'])) ? $this->nmgp_cmp_readonly['tneto_'] : 'off';
?>
    scAjaxFieldRead("tneto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("descr_" + iSeq, "on");
    scAjaxFieldRead("tbase_" + iSeq, "on");
    scAjaxFieldRead("tneto_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["numfac_" + iRow] || "on" == ajax_error_count["idpro_" + iRow] || "on" == ajax_error_count["obs_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["valorunit_" + iRow] || "on" == ajax_error_count["valorpar_" + iRow] || "on" == ajax_error_count["descr_" + iRow] || "on" == ajax_error_count["tbase_" + iRow] || "on" == ajax_error_count["tneto_" + iRow]))
    {
      ...
      $("#hidden_field_data_descr_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tbase_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tneto_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["numfac_" + iRow] && "off" == ajax_error_count["idpro_" + iRow] && "off" == ajax_error_count["obs_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["valorunit_" + iRow] && "off" == ajax_error_count["valorpar_" + iRow] && "off" == ajax_error_count["descr_" + iRow] && "off" == ajax_error_count["tbase_" + iRow] && "off" == ajax_error_count["tneto_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["descr_" + iRow] = "off";
        ajax_error_count["tbase_" + iRow] = "off";
        ajax_error_count["tneto_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_descr_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tbase_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tneto_" + iRow).removeClass("scFormErrorLine");
    }
  }
