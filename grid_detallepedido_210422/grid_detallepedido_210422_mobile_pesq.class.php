...
class grid_detallepedido_210422_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_detallepedido_210422_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_detallepedido_210422_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_detallepedido_210422_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_iddet')
      {
          $iddet = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_iddet($iddet);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idpedid')
      {
          $idpedid = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idpedid($idpedid);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_numfac')
      {
          $numfac = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_numfac($numfac);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_remision')
      {
          $remision = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_remision($remision);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_iddet($iddet)
   {
      $iddet = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $iddet);
      $iddet = substr($this->Db->qstr($iddet), 1, -1);
            $iddet_look = substr($this->Db->qstr($iddet), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and   CAST (iddet AS TEXT)  like '%" . $iddet . "%' order by iddet"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and   CAST (iddet AS VARCHAR)  like '%" . $iddet . "%' order by iddet"; 
      }
      else
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and  iddet like '%" . $iddet . "%' order by iddet"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_idpedid($idpedid)
   {
      $idpedid = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idpedid);
      $idpedid = substr($this->Db->qstr($idpedid), 1, -1);
            $idpedid_look = substr($this->Db->qstr($idpedid), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idpedid from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and   CAST (idpedid AS TEXT)  like '%" . $idpedid . "%' order by idpedid"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idpedid from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and   CAST (idpedid AS VARCHAR)  like '%" . $idpedid . "%' order by idpedid"; 
      }
      else
      {
          $nm_comando = "select distinct idpedid from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and  idpedid like '%" . $idpedid . "%' order by idpedid"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_numfac($numfac)
   {
      $numfac = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $numfac);
      $numfac = substr($this->Db->qstr($numfac), 1, -1);
            $numfac_look = substr($this->Db->qstr($numfac), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numfac from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and   CAST (numfac AS TEXT)  like '%" . $numfac . "%' order by numfac"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfac from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and   CAST (numfac AS VARCHAR)  like '%" . $numfac . "%' order by numfac"; 
      }
      else
      {
          $nm_comando = "select distinct numfac from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and  numfac like '%" . $numfac . "%' order by numfac"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_remision($remision)
   {
      $remision = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $remision);
      $remision = substr($this->Db->qstr($remision), 1, -1);
            $remision_look = substr($this->Db->qstr($remision), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct remision from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and   CAST (remision AS TEXT)  like '%" . $remision . "%' order by remision"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct remision from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and   CAST (remision AS VARCHAR)  like '%" . $remision . "%' order by remision"; 
      }
      else
      {
          $nm_comando = "select distinct remision from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and  remision like '%" . $remision . "%' order by remision"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_detallepedido_210422/grid_detallepedido_210422_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_detallepedido_210422_ajax_search.js"></script>
 <script type="text/javascript" src="grid_detallepedido_210422_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_detallepedido_210422_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detallepedido_210422']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detallepedido_210422']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['ajax_nav'])
           { 
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_iddet_cond#NMF#' + search_get_sel_txt('SC_iddet_cond') + '@NMF@';
  str_out += 'SC_iddet#NMF#' + search_get_text('SC_iddet') + '@NMF@';
  str_out += 'id_ac_iddet#NMF#' + search_get_title('select2-id_ac_iddet-container') + '@NMF@';
  str_out += 'SC_iddet_input_2#NMF#' + search_get_text('SC_iddet_input_2') + '@NMF@';
  str_out += 'SC_idpedid_cond#NMF#' + search_get_sel_txt('SC_idpedid_cond') + '@NMF@';
  str_out += 'SC_idpedid#NMF#' + search_get_text('SC_idpedid') + '@NMF@';
  str_out += 'id_ac_idpedid#NMF#' + search_get_title('select2-id_ac_idpedid-container') + '@NMF@';
  str_out += 'SC_idpedid_input_2#NMF#' + search_get_text('SC_idpedid_input_2') + '@NMF@';
  str_out += 'SC_numfac_cond#NMF#' + search_get_sel_txt('SC_numfac_cond') + '@NMF@';
  str_out += 'SC_numfac#NMF#' + search_get_text('SC_numfac') + '@NMF@';
  str_out += 'id_ac_numfac#NMF#' + search_get_title('select2-id_ac_numfac-container') + '@NMF@';
  str_out += 'SC_numfac_input_2#NMF#' + search_get_text('SC_numfac_input_2') + '@NMF@';
  str_out += 'SC_remision_cond#NMF#' + search_get_sel_txt('SC_remision_cond') + '@NMF@';
  str_out += 'SC_remision#NMF#' + search_get_text('SC_remision') + '@NMF@';
  str_out += 'id_ac_remision#NMF#' + search_get_title('select2-id_ac_remision-container') + '@NMF@';
  str_out += 'SC_remision_input_2#NMF#' + search_get_text('SC_remision_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-iddet").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_iddet",
      max_itens: "10",
   ...
   $("#SC_iddet").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-idpedid").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_idpedid",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_idpedid").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-numfac").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_numfac",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_numfac").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-remision").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_remision",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_remision").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - detallepedido</span></td>
...
<?php
   ...
   {
      global 
             $iddet_cond, $iddet, $iddet_input_2, $iddet_autocomp,
             $idpedid_cond, $idpedid, $idpedid_input_2, $idpedid_autocomp,
             $numfac_cond, $numfac, $numfac_input_2, $numfac_autocomp,
             $remision_cond, $remision, $remision_input_2, $remision_autocomp,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepedido_210422']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepedido_210422']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepedido_210422']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_detallepedido_210422", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $iddet = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['iddet']; 
          $iddet_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['iddet_input_2']; 
          $iddet_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['iddet_cond']; 
          $idpedid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['idpedid']; 
          $idpedid_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['idpedid_input_2']; 
          $idpedid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['idpedid_cond']; 
          $numfac = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['numfac']; 
          $numfac_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['numfac_input_2']; 
          $numfac_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['numfac_cond']; 
          $remision = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['remision']; 
          $remision_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['remision_input_2']; 
          $remision_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['remision_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['NM_operador']; 
      } 
      if (!isset($iddet_cond) || empty($iddet_cond))
      {
         $iddet_cond = "gt";
      }
      if (!isset($idpedid_cond) || empty($idpedid_cond))
      {
         $idpedid_cond = "gt";
      }
      if (!isset($numfac_cond) || empty($numfac_cond))
      {
         $numfac_cond = "gt";
      }
      if (!isset($remision_cond) || empty($remision_cond))
      {
         $remision_cond = "gt";
      }
      ...
      $str_hide_iddet = (in_array($iddet_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idpedid = (in_array($idpedid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_numfac = (in_array($numfac_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_remision = (in_array($remision_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_iddet = ('bw' == $iddet_cond) ? $display_aberto : $display_fechado;
      $str_display_idpedid = ('bw' == $idpedid_cond) ? $display_aberto : $display_fechado;
      $str_display_numfac = ('bw' == $numfac_cond) ? $display_aberto : $display_fechado;
      $str_display_remision = ('bw' == $remision_cond) ? $display_aberto : $display_fechado;

      if (!isset($iddet) || $iddet == "")
      {
          $iddet = "";
      }
      if (isset($iddet) && !empty($iddet))
      {
         $tmp_pos = strpos($iddet, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $iddet = substr($iddet, 0, $tmp_pos);
         }
      }
      if (!isset($idpedid) || $idpedid == "")
      {
          $idpedid = "";
      }
      if (isset($idpedid) && !empty($idpedid))
      {
         $tmp_pos = strpos($idpedid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idpedid = substr($idpedid, 0, $tmp_pos);
         }
      }
      if (!isset($numfac) || $numfac == "")
      {
          $numfac = "";
      }
      if (isset($numfac) && !empty($numfac))
      {
      ...
      if (isset($remision) && !empty($remision))
      {
         $tmp_pos = strpos($remision, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $remision = substr($remision, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_iddet_cond" name="iddet_cond" onChange="nm_campos_between(document.getElementById('id_vis_iddet'), this, 'iddet')">
       <OPTION value="gt" <?php if ("gt" == $iddet_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $iddet_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $iddet_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $iddet_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_iddet"  <?php echo $str_hide_iddet?>><?php
      if ($iddet != "")
      {
      $iddet_look = substr($this->Db->qstr($iddet), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and iddet = $iddet_look order by iddet"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and iddet = $iddet_look order by iddet"; 
      ...
      if (isset($nmgp_def_dados[0][$iddet]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$iddet];
      }
      else
      {
            nmgp_Form_Num_Val($iddet, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $iddet;
      }
?>
<INPUT  type="text" id="SC_iddet" name="iddet" value="<?php echo NM_encode_input($iddet) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-iddet" id="id_ac_iddet" name="iddet_autocomp"><?php if ('' !=  $iddet) { ?><option value="<?php echo $iddet ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_iddet"  <?php echo $str_display_iddet; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_iddet_input_2" name="iddet_input_2" value="<?php echo NM_encode_input($iddet_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
 ...
 $nmgp_tab_label .= "idpedid?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idpedid_cond" name="idpedid_cond" onChange="nm_campos_between(document.getElementById('id_vis_idpedid'), this, 'idpedid')">
       <OPTION value="gt" <?php if ("gt" == $idpedid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idpedid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idpedid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idpedid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_idpedid"  <?php echo $str_hide_idpedid?>><?php
      if ($idpedid != "")
      {
      $idpedid_look = substr($this->Db->qstr($idpedid), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($idpedid))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idpedid from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and idpedid = $idpedid_look order by idpedid"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idpedid from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and idpedid = $idpedid_look order by idpedid"; 
      ...
      if (isset($nmgp_def_dados[0][$idpedid]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idpedid];
      }
      else
      {
            nmgp_Form_Num_Val($idpedid, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idpedid;
      }
?>
<INPUT  type="text" id="SC_idpedid" name="idpedid" value="<?php echo NM_encode_input($idpedid) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-idpedid" id="id_ac_idpedid" name="idpedid_autocomp"><?php if ('' !=  $idpedid) { ?><option value="<?php echo $idpedid ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_idpedid"  <?php echo $str_display_idpedid; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idpedid_input_2" name="idpedid_input_2" value="<?php echo NM_encode_input($idpedid_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
 ...
 $nmgp_tab_label .= "numfac?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_numfac_cond" name="numfac_cond" onChange="nm_campos_between(document.getElementById('id_vis_numfac'), this, 'numfac')">
       <OPTION value="gt" <?php if ("gt" == $numfac_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $numfac_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $numfac_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $numfac_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_numfac"  <?php echo $str_hide_numfac?>><?php
      if ($numfac != "")
      {
      $numfac_look = substr($this->Db->qstr($numfac), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numfac from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and numfac = $numfac_look order by numfac"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfac from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and numfac = $numfac_look order by numfac"; 
      ...
      if (isset($nmgp_def_dados[0][$numfac]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$numfac];
      }
      else
      {
            nmgp_Form_Num_Val($numfac, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $numfac;
      }
?>
<INPUT  type="text" id="SC_numfac" name="numfac" value="<?php echo NM_encode_input($numfac) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numfac" id="id_ac_numfac" name="numfac_autocomp"><?php if ('' !=  $numfac) { ?><option value="<?php echo $numfac ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_numfac"  <?php echo $str_display_numfac; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_numfac_input_2" name="numfac_input_2" value="<?php echo NM_encode_input($numfac_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
 ...
 $nmgp_tab_label .= "remision?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_remision_cond" name="remision_cond" onChange="nm_campos_between(document.getElementById('id_vis_remision'), this, 'remision')">
       <OPTION value="gt" <?php if ("gt" == $remision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $remision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $remision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $remision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_remision"  <?php echo $str_hide_remision?>><?php
      if ($remision != "")
      {
      $remision_look = substr($this->Db->qstr($remision), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct remision from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and remision = $remision_look order by remision"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct remision from " . $this->Ini->nm_tabela . " where idpedid=" . $_SESSION['par_idpedio'] . " and remision = $remision_look order by remision"; 
      ...
      if (isset($nmgp_def_dados[0][$remision]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$remision];
      }
      else
      {
            nmgp_Form_Num_Val($remision, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $remision;
      }
?>
<INPUT  type="text" id="SC_remision" name="remision" value="<?php echo NM_encode_input($remision) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-remision" id="id_ac_remision" name="remision_autocomp"><?php if ('' !=  $remision) { ?><option value="<?php echo $remision ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_remision"  <?php echo $str_display_remision; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_remision_input_2" name="remision_input_2" value="<?php echo NM_encode_input($remision_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
?>
<?php
   if (is_file("grid_detallepedido_210422_help.txt"))
   {
      $Arq_WebHelp = file("grid_detallepedido_210422_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepedido_210422']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_detallepedido_210422']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepedido_210422']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_detallepedido_210422']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.iddet_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_iddet'), document.F1.iddet_cond, 'iddet');
   document.F1.iddet.value = "";
   document.F1.iddet_autocomp.value = "";
   $('#select2-id_ac_iddet-container').html('<?php echo $this->Val_init_iddet['desc'] ?>');;
   document.F1.iddet_input_2.value = "";
   document.F1.idpedid_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idpedid'), document.F1.idpedid_cond, 'idpedid');
   document.F1.idpedid.value = "";
   document.F1.idpedid_autocomp.value = "";
   $('#select2-id_ac_idpedid-container').html('<?php echo $this->Val_init_idpedid['desc'] ?>');;
   document.F1.idpedid_input_2.value = "";
   document.F1.numfac_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_numfac'), document.F1.numfac_cond, 'numfac');
   document.F1.numfac.value = "";
   document.F1.numfac_autocomp.value = "";
   $('#select2-id_ac_numfac-container').html('<?php echo $this->Val_init_numfac['desc'] ?>');;
   document.F1.numfac_input_2.value = "";
   document.F1.remision_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_remision'), document.F1.remision_cond, 'remision');
   document.F1.remision.value = "";
   document.F1.remision_autocomp.value = "";
   $('#select2-id_ac_remision-container').html('<?php echo $this->Val_init_remision['desc'] ?>');;
   document.F1.remision_input_2.value = "";
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_detallepedido_210422";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_detallepedido_210422/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_iddet_cond'] = 'cond';
      $tp_fields['SC_iddet'] = 'text_aut';
      $tp_fields['id_ac_iddet'] = 'select2_aut';
      $tp_fields['SC_iddet_input_2'] = 'text';
      $tp_fields['SC_idpedid_cond'] = 'cond';
      $tp_fields['SC_idpedid'] = 'text_aut';
      $tp_fields['id_ac_idpedid'] = 'select2_aut';
      $tp_fields['SC_idpedid_input_2'] = 'text';
      $tp_fields['SC_numfac_cond'] = 'cond';
      $tp_fields['SC_numfac'] = 'text_aut';
      $tp_fields['id_ac_numfac'] = 'select2_aut';
      $tp_fields['SC_numfac_input_2'] = 'text';
      $tp_fields['SC_remision_cond'] = 'cond';
      $tp_fields['SC_remision'] = 'text_aut';
      $tp_fields['id_ac_remision'] = 'select2_aut';
      $tp_fields['SC_remision_input_2'] = 'text';
   ...
   {
      global $iddet_cond, $iddet, $iddet_input_2, $iddet_autocomp,
             $idpedid_cond, $idpedid, $idpedid_input_2, $idpedid_autocomp,
             $numfac_cond, $numfac, $numfac_input_2, $numfac_autocomp,
             $remision_cond, $remision, $remision_input_2, $remision_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($iddet_autocomp) && empty($iddet))
      {
          $iddet = $iddet_autocomp;
      }
      if (!empty($idpedid_autocomp) && empty($idpedid))
      {
          $idpedid = $idpedid_autocomp;
      }
      if (!empty($numfac_autocomp) && empty($numfac))
      {
          $numfac = $numfac_autocomp;
      }
      if (!empty($remision_autocomp) && empty($remision))
      {
          $remision = $remision_autocomp;
      }
      $iddet_cond_salva = $iddet_cond; 
      if (!isset($iddet_input_2) || $iddet_input_2 == "")
      {
          $iddet_input_2 = $iddet;
      }
      $idpedid_cond_salva = $idpedid_cond; 
      if (!isset($idpedid_input_2) || $idpedid_input_2 == "")
      {
          $idpedid_input_2 = $idpedid;
      }
      $numfac_cond_salva = $numfac_cond; 
      if (!isset($numfac_input_2) || $numfac_input_2 == "")
      {
          $numfac_input_2 = $numfac;
      }
      $remision_cond_salva = $remision_cond; 
      if (!isset($remision_input_2) || $remision_input_2 == "")
      {
          $remision_input_2 = $remision;
      }
      if ($iddet_cond != "in")
      {
          nm_limpa_numero($iddet, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($iddet_cond != "in")
      {
          nm_limpa_numero($iddet_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idpedid_cond != "in")
      {
          nm_limpa_numero($idpedid, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idpedid_cond != "in")
      {
          nm_limpa_numero($idpedid_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($numfac_cond != "in")
      {
          nm_limpa_numero($numfac, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($numfac_cond != "in")
      {
          nm_limpa_numero($numfac_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($remision_cond != "in")
      {
          nm_limpa_numero($remision, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($remision_cond != "in")
      {
          nm_limpa_numero($remision_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['iddet'] = $iddet; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['iddet_input_2'] = $iddet_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['iddet_cond'] = $iddet_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['idpedid'] = $idpedid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['idpedid_input_2'] = $idpedid_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['idpedid_cond'] = $idpedid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['numfac'] = $numfac; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['numfac_input_2'] = $numfac_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['numfac_cond'] = $numfac_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['remision'] = $remision; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['remision_input_2'] = $remision_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['remision_cond'] = $remision_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca'] = $Temp_Busca;
      }
      if ($iddet_cond != "in" && $iddet_cond != "bw" && !empty($iddet) && !is_numeric($iddet))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Iddet";
      }
      if ($iddet_cond == "bw" && ((!empty($iddet) && !is_numeric($iddet)) || (!empty($iddet_input_2) && !is_numeric($iddet_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Iddet";
      }
      if ($idpedid_cond != "in" && $idpedid_cond != "bw" && !empty($idpedid) && !is_numeric($idpedid))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idpedid";
      }
      if ($idpedid_cond == "bw" && ((!empty($idpedid) && !is_numeric($idpedid)) || (!empty($idpedid_input_2) && !is_numeric($idpedid_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idpedid";
      }
      if ($numfac_cond != "in" && $numfac_cond != "bw" && !empty($numfac) && !is_numeric($numfac))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Numfac";
      }
      if ($numfac_cond == "bw" && ((!empty($numfac) && !is_numeric($numfac)) || (!empty($numfac_input_2) && !is_numeric($numfac_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Numfac";
      }
      if ($remision_cond != "in" && $remision_cond != "bw" && !empty($remision) && !is_numeric($remision))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Remision";
      }
      if ($remision_cond == "bw" && ((!empty($remision) && !is_numeric($remision)) || (!empty($remision_input_2) && !is_numeric($remision_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Remision";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      $Conteudo = $iddet_input_2;
      if (strtoupper($iddet_cond) != "II" && strtoupper($iddet_cond) != "QP" && strtoupper($iddet_cond) != "NP" && strtoupper($iddet_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['iddet_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($idpedid != '') {
      $idpedid_look = substr($this->Db->qstr($idpedid), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idpedid'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['idpedid'] = $cmp1;
      }
      else
      {
          $cmp1 = $idpedid;
      ...
      $Conteudo = $idpedid_input_2;
      if (strtoupper($idpedid_cond) != "II" && strtoupper($idpedid_cond) != "QP" && strtoupper($idpedid_cond) != "NP" && strtoupper($idpedid_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idpedid_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($numfac != '') {
      $numfac_look = substr($this->Db->qstr($numfac), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['numfac'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['numfac'] = $cmp1;
      }
      else
      {
          $cmp1 = $numfac;
      ...
      $Conteudo = $numfac_input_2;
      if (strtoupper($numfac_cond) != "II" && strtoupper($numfac_cond) != "QP" && strtoupper($numfac_cond) != "NP" && strtoupper($numfac_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['numfac_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($remision != '') {
      $remision_look = substr($this->Db->qstr($remision), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['remision'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['remision'] = $cmp1;
      }
      else
      {
          $cmp1 = $remision;
      ...
      $Conteudo = $remision_input_2;
      if (strtoupper($remision_cond) != "II" && strtoupper($remision_cond) != "QP" && strtoupper($remision_cond) != "NP" && strtoupper($remision_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['remision_input_2'] = $Conteudo;

      //----- $iddet
      $this->Date_part = false;
      if (isset($iddet) || $iddet_cond == "nu" || $iddet_cond == "nn" || $iddet_cond == "ep" || $iddet_cond == "ne")
      {
         $this->monta_condicao("iddet", $iddet_cond, $iddet, $iddet_input_2, "iddet");
      }

      //----- $idpedid
      $this->Date_part = false;
      if (isset($idpedid) || $idpedid_cond == "nu" || $idpedid_cond == "nn" || $idpedid_cond == "ep" || $idpedid_cond == "ne")
      {
         $this->monta_condicao("idpedid", $idpedid_cond, $idpedid, $idpedid_input_2, "idpedid");
      }

      //----- $numfac
      $this->Date_part = false;
      if (isset($numfac) || $numfac_cond == "nu" || $numfac_cond == "nn" || $numfac_cond == "ep" || $numfac_cond == "ne")
      {
         $this->monta_condicao("numfac", $numfac_cond, $numfac, $numfac_input_2, "numfac");
      }

      //----- $remision
      $this->Date_part = false;
      if (isset($remision) || $remision_cond == "nu" || $remision_cond == "nn" || $remision_cond == "ep" || $remision_cond == "ne")
      {
         $this->monta_condicao("remision", $remision_cond, $remision, $remision_input_2, "remision");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepedido_210422']['where_pesq'];
