...
<?php
   ...
   $Ord_Cmp = new grid_detallepedido_210422_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detallepedido_210422_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigoprod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["codigoprod"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["codigoprod"] : "Codigo";
   ...
   $tab_labels["codigobar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["codigobar"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["codigobar"] : "CodBarra";
   $tab_ger_campos['idpro'] = "on";
   $tab_def_campos['idpro'] = "idpro";
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["idpro"] : "Producto";
   $tab_ger_campos['colores'] = "on";
   $tab_def_campos['colores'] = "colores";
   $tab_labels["colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["colores"] : "Color";
   $tab_ger_campos['tallas'] = "on";
   $tab_def_campos['tallas'] = "tallas";
   $tab_labels["tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["tallas"] : "Talla";
   $tab_ger_campos['sabor'] = "on";
   $tab_def_campos['sabor'] = "sabor";
   $tab_labels["sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["sabor"] : "Sabor";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['valorunit'] = "on";
   $tab_def_campos['valorunit'] = "valorunit";
   $tab_labels["valorunit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["valorunit"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["valorunit"] : "Valor. unit.";
   $tab_ger_campos['descuento'] = "on";
   $tab_def_campos['descuento'] = "descuento";
   $tab_labels["descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["descuento"] : "Desc. x U.";
   $tab_ger_campos['valorpar'] = "on";
   $tab_def_campos['valorpar'] = "valorpar";
   $tab_labels["valorpar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["valorpar"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["valorpar"] : "Valor par.";
   $tab_ger_campos['iva'] = "on";
   $tab_def_campos['iva'] = "iva";
   $tab_labels["iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["iva"] : "Impuesto";
   ...
   $tab_labels["unidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["unidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["unidad"] : "Unidad";
   $tab_ger_campos['estado_comanda'] = "on";
   $tab_def_campos['estado_comanda'] = "estado_comanda";
   $tab_labels["estado_comanda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["estado_comanda"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["estado_comanda"] : "Estado";
   $tab_ger_campos['hora_inicio'] = "on";
   $tab_def_campos['hora_inicio'] = "hora_inicio";
   $tab_labels["hora_inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["hora_inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["hora_inicio"] : "Inicio comanda";
   $tab_ger_campos['hora_final'] = "on";
   $tab_def_campos['hora_final'] = "hora_final";
   $tab_labels["hora_final"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["hora_final"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["hora_final"] : "Fin comanda";
   $tab_ger_campos['observ'] = "on";
   $tab_def_campos['observ'] = "observ";
   $tab_labels["observ"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["observ"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["observ"] : "Observacion";
   $tab_ger_campos['cerrado'] = "on";
   $tab_def_campos['cerrado'] = "cerrado";
   $tab_labels["cerrado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["cerrado"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['labels']["cerrado"] : "Cerrado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detallepedido_210422_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detallepedido_210422']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
