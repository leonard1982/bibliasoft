...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_cuentas_porpagar_mob']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_cuentas_porpagar_mob']['sc_max_reg']) == "all")
      {
...
//------------ 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_terceros_cuentas_porpagar_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_cuentas_porpagar_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_cuentas_porpagar_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_cuentas_porpagar_mob']['reg_start'] + 1;
