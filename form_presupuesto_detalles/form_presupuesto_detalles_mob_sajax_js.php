  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_presupuesto_detalles_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_presupuesto_detalles_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_presupuesto_detalle
  function do_ajax_form_presupuesto_detalles_mob_validate_id_presupuesto_detalle()
  {
    var nomeCampo_id_presupuesto_detalle = "id_presupuesto_detalle";
    var var_id_presupuesto_detalle = scAjaxGetFieldHidden(nomeCampo_id_presupuesto_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_detalles_mob_validate_id_presupuesto_detalle(var_id_presupuesto_detalle, var_script_case_init, do_ajax_form_presupuesto_detalles_mob_validate_id_presupuesto_detalle_cb);
  } // do_ajax_form_presupuesto_detalles_mob_validate_id_presupuesto_detalle

  function do_ajax_form_presupuesto_detalles_mob_validate_id_presupuesto_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_presupuesto_detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_detalles_mob_validate_id_presupuesto_detalle_cb

  // ---------- Validate id_categoria
  function do_ajax_form_presupuesto_detalles_mob_validate_id_categoria()
  {
    var nomeCampo_id_categoria = "id_categoria";
    var var_id_categoria = scAjaxGetFieldSelect(nomeCampo_id_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_detalles_mob_validate_id_categoria(var_id_categoria, var_script_case_init, do_ajax_form_presupuesto_detalles_mob_validate_id_categoria_cb);
  } // do_ajax_form_presupuesto_detalles_mob_validate_id_categoria

  function do_ajax_form_presupuesto_detalles_mob_validate_id_categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_categoria";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_detalles_mob_validate_id_categoria_cb

  // ---------- Validate presupuesto
  function do_ajax_form_presupuesto_detalles_mob_validate_presupuesto()
  {
    var nomeCampo_presupuesto = "presupuesto";
    var var_presupuesto = scAjaxGetFieldText(nomeCampo_presupuesto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_detalles_mob_validate_presupuesto(var_presupuesto, var_script_case_init, do_ajax_form_presupuesto_detalles_mob_validate_presupuesto_cb);
  } // do_ajax_form_presupuesto_detalles_mob_validate_presupuesto

  function do_ajax_form_presupuesto_detalles_mob_validate_presupuesto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_detalles_mob_validate_presupuesto_cb

  // ---------- Validate descripcion
  function do_ajax_form_presupuesto_detalles_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_detalles_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_presupuesto_detalles_mob_validate_descripcion_cb);
  } // do_ajax_form_presupuesto_detalles_mob_validate_descripcion

  function do_ajax_form_presupuesto_detalles_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_detalles_mob_validate_descripcion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_presupuesto_detalles_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_presupuesto_detalles_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_presupuesto_detalle = scAjaxGetFieldHidden("id_presupuesto_detalle");
    var var_id_categoria = scAjaxGetFieldSelect("id_categoria");
    ...
    scAjaxProcOn();
    x_ajax_form_presupuesto_detalles_mob_submit_form(var_id_presupuesto_detalle, var_id_categoria, var_presupuesto, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_presupuesto_detalles_mob_submit_form_cb);
  } // do_ajax_form_presupuesto_detalles_mob_submit_form

  function do_ajax_form_presupuesto_detalles_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_presupuesto_detalle");
      scAjaxHideErrorDisplay("id_categoria");
      scAjaxHideErrorDisplay("presupuesto");
      scAjaxHideErrorDisplay("descripcion");
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_detalles_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_detalles_mob']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_detalles_mob']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_presupuesto_detalles_mob_submit_form_cb_after_alert);
  } // do_ajax_form_presupuesto_detalles_mob_submit_form_cb
  function do_ajax_form_presupuesto_detalles_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_presupuesto_detalles_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_presupuesto_detalles_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_presupuesto_detalles_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_presupuesto_detalles_mob_navigate_form();
    }
  }

  function perform_ajax_form_presupuesto_detalles_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("presupuesto");
    scAjaxHideErrorDisplay("descripcion");
    var var_id_presupuesto_detalle = document.F2.id_presupuesto_detalle.value;
    ...
    scAjaxProcOn();
    x_ajax_form_presupuesto_detalles_mob_navigate_form(var_id_presupuesto_detalle, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_presupuesto_detalles_mob_navigate_form_cb);
  } // do_ajax_form_presupuesto_detalles_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_detalles_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_presupuesto_detalles_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_presupuesto_detalle.value = scAjaxGetKeyValue("id_presupuesto_detalle");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_presupuesto_detalles_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_presupuesto_detalles_mob_navigate_form_cb
  function do_ajax_form_presupuesto_detalles_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_presupuesto_detalles_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_presupuesto_detalles_mob_navigate_form_cb_after_alert
  function sc_hide_form_presupuesto_detalles_mob_form()
  {
  ...
  ajax_field_list[0] = "id_presupuesto_detalle";
  ajax_field_list[1] = "id_categoria";
  ajax_field_list[2] = "presupuesto";
  ...
  var ajax_error_list = {
    "id_presupuesto_detalle": {"label": "Id Presupuesto Detalle", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_categoria": {"label": "Categoría", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "presupuesto": {"label": "Presupuesto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "id_presupuesto_detalle": new Array(),
    "id_categoria": new Array(),
    "presupuesto": new Array(),
    "descripcion": new Array()
  };
  ajax_field_mult["id_presupuesto_detalle"][1] = "id_presupuesto_detalle";
  ajax_field_mult["id_categoria"][1] = "id_categoria";
  ajax_field_mult["presupuesto"][1] = "presupuesto";
  ajax_field_mult["descripcion"][1] = "descripcion";

  var ajax_field_id = {
    "id_categoria": new Array("hidden_field_label_id_categoria", "hidden_field_data_id_categoria"),
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("id_presupuesto_detalle" == sIndex)
    {
