...
function scEventControl_onCalculator_presupuesto() {
  if (!_scCalculatorControl["id_sc_field_presupuesto"]) {
    ...
    do_ajax_form_presupuesto_detalles_mob_event_presupuesto_onblur();
  }
...
function scHidePage(pageNo) {
	$("#id_form_presupuesto_detalles_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_presupuesto_detalles_mob_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_actualizado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_presupuesto_detalles_mob_validate_actualizado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_presupuesto_detalles_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
