...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____seg_permisos_group"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____seg_permisos_group"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['seg_permisos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['seg_permisos_group']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['seg_permisos_group']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['seg_permisos_group']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['seg_permisos_group']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['seg_permisos_group']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>seg_permisos_group</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['seg_permisos_group']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['seg_permisos_group']['embutida_filho'] as $ind => $sc_init)
          {
