...
<?php
   ...
   $Ord_Cmp = new grid_kardex_nc_tns_03022020_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_kardex_nc_tns_03022020_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codcomp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["codcomp"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["codcomp"] : "TIPO";
   $tab_ger_campos['codprefijo'] = "on";
   $tab_def_campos['codprefijo'] = "CODPREFIJO";
   $tab_labels["codprefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["codprefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["codprefijo"] : "PJ";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "NUMERO";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["numero"] : "NUMERO";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "FECHA";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["fecha"] : "FECHA";
   $tab_ger_campos['nit_tercero'] = "on";
   $tab_def_campos['nit_tercero'] = "NIT_TERCERO";
   $tab_labels["nit_tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["nit_tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["nit_tercero"] : "ID";
   $tab_ger_campos['cliente'] = "on";
   $tab_def_campos['cliente'] = "CLIENTE";
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["cliente"] : "CLIENTE";
   ...
   $tab_labels["ico_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["ico_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["ico_cliente"] : "";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "TOTAL";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["total"] : "TOTAL";
   ...
   $tab_labels["pdf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["pdf"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["pdf"] : "PDF";
   ...
   $tab_labels["avisos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["avisos"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["avisos"] : "AVISOS";
   ...
   $tab_labels["qr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["qr"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['labels']["qr"] : "QR";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_kardex_nc_tns_03022020_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_03022020']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
