<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_compregreso']['sc_process_barr'] = true;
require_once('../pdfreport_compregreso/index.php');
unset($_SESSION['scriptcase']['pdfreport_compregreso']['sc_process_barr']);
$ExportCtrl = new pdfreport_compregreso_export_control;
$ExportCtrl->Export_barr();

class pdfreport_compregreso_export_control
{
