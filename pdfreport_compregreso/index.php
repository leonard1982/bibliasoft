<?php
   include_once('pdfreport_compregreso_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class pdfreport_compregreso_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "pdfreport_compregreso"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20180527"; 
      $this->nm_hr_criacao   = "162931"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['pdfreport_compregreso']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['pdfreport_compregreso']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['pdfreport_compregreso']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/pdfreport_compregreso';
      ...
      $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['pdfreport_compregreso']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['pdfreport_compregreso']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['pdfreport_compregreso']['actual_lang']) || $_SESSION['scriptcase']['pdfreport_compregreso']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['pdfreport_compregreso']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("pdfreport_compregreso_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["pdfreport_compregreso"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["pdfreport_compregreso"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['pdfreport_compregreso']['session_timeout']['redir']))
      {
      ...
      $this->nm_path_pdf     = $this->path_imag_temp . "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_pdfreport_compregreso" . ".pdf";
      $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['sc_outra_jan'])) 
          { 
...
<?php
      ...
      if (!isset($_SESSION['scriptcase'][$script_case_init]['pdfreport_compregreso']['nm_contr_attrs']))
      {
          $_SESSION['scriptcase'][$script_case_init]['pdfreport_compregreso']['nm_contr_attrs'] = "ok";
          $_SESSION['pdfreport_compregreso']['empresa_nombre'] = ""; 
          $_SESSION['pdfreport_compregreso']['nit'] = ""; 
          $_SESSION['pdfreport_compregreso']['direccion1'] = ""; 
          $_SESSION['pdfreport_compregreso']['telefono1'] = ""; 
      }
// 
      include_once($this->path_aplicacao . "pdfreport_compregreso_erro.class.php"); 
      $this->Erro = new pdfreport_compregreso_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('pdfreport_compregreso'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['pdfreport_compregreso']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['pdfreport_compregreso']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['pdfreport_compregreso']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['pdfreport_compregreso']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['pdfreport_compregreso']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['pdfreport_compregreso']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_conexao']) && $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_perfil']) && $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['pdfreport_compregreso']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['pdfreport_compregreso']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['embutida_init']) 
      {
          if (!isset($_SESSION['par_comegreso'])) 
          {
              $this->nm_falta_var .= "par_comegreso; ";
          }
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv_2022', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['pdfreport_compregreso']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class pdfreport_compregreso_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['pdfreport_compregreso']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['pdfreport_compregreso'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class pdfreport_compregreso_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_ibase'])) 
      { 
          $this->Ini = new pdfreport_compregreso_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['pdfreport_compregreso']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['pdfreport_compregreso'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['pdfreport_compregreso']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['pdfreport_compregreso']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('pdfreport_compregreso') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['pdfreport_compregreso']['label'] = "" . $this->Ini->Nm_lang['lang_othr_chart_titl'] . " - recibocaja";
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      include_once($this->Ini->path_aplicacao . "pdfreport_compregreso_erro.class.php"); 
      $this->Erro      = new pdfreport_compregreso_erro();
      $this->Erro->Ini = $this->Ini;
      require_once($this->Ini->path_aplicacao . "pdfreport_compregreso_lookup.class.php"); 
      $this->Lookup       = new pdfreport_compregreso_lookup();
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_compregreso']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_compregreso']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_compregreso']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida'])
      { 
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_compregreso']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_compregreso']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] = "grid" ;  
      }   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['prim_cons'] = true;  
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['campos_busca']      = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['grid_pesq']         = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['Grid_search']       = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['tot_geral']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['contr_array_resumo'] = "NAO";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['where_pesq_ant'];  
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['word_name']))
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['word_name'] .= ".doc";
              }
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_pdfreport_compregreso_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "pdfreport_compregreso/pdfreport_compregreso_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "pdfreport_compregreso_xls.class.php"); 
          } 
          $this->xls  = new pdfreport_compregreso_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "pdfreport_compregreso/pdfreport_compregreso_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "pdfreport_compregreso_res_xls.class.php"); 
          } 
          $this->xls  = new pdfreport_compregreso_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "pdfreport_compregreso/pdfreport_compregreso_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "pdfreport_compregreso_xml.class.php"); 
          } 
          $this->xml  = new pdfreport_compregreso_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "pdfreport_compregreso/pdfreport_compregreso_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "pdfreport_compregreso_res_xml.class.php"); 
          } 
          $this->xml  = new pdfreport_compregreso_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "pdfreport_compregreso/pdfreport_compregreso_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "pdfreport_compregreso_json.class.php"); 
          } 
          $this->json  = new pdfreport_compregreso_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "pdfreport_compregreso/pdfreport_compregreso_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "pdfreport_compregreso_csv.class.php"); 
          } 
          $this->csv  = new pdfreport_compregreso_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "pdfreport_compregreso/pdfreport_compregreso_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "pdfreport_compregreso_res_csv.class.php"); 
          } 
          $this->csv  = new pdfreport_compregreso_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "pdfreport_compregreso/pdfreport_compregreso_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "pdfreport_compregreso_rtf.class.php"); 
          } 
          $this->rtf  = new pdfreport_compregreso_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "pdfreport_compregreso/pdfreport_compregreso_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "pdfreport_compregreso_res_rtf.class.php"); 
          } 
          $this->rtf  = new pdfreport_compregreso_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "pdfreport_compregreso_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "pdfreport_compregreso_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new pdfreport_compregreso_pesq();
      ...
      { 
           require_once($this->Ini->path_aplicacao . "pdfreport_compregreso_grid.class.php"); 
           $this->grid  = new pdfreport_compregreso_grid();
...
$_SESSION['scriptcase']['pdfreport_compregreso']['contr_erro'] = 'off';
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_titl'] ?> - recibocaja :: Doc</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 <META http-equiv="Expires" content="Fri, Jan 01 1900 00:00:00 GMT"/>
 <META http-equiv="Last-Modified" content="<?php echo gmdate("D, d M Y H:i:s"); ?> GMT"/>
 <META http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"/>
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_compregreso'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['pdfreport_compregreso']['sc_process_barr'])) {
       return;
   }
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_pdfreport_compregreso($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_pdfreport_compregreso($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['pdfreport_compregreso']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "pdfreport_compregreso") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['pdfreport_compregreso']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['pdfreport_compregreso']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['pdfreport_compregreso']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv_2022'])) {
               $_SESSION['scriptcase']['pdfreport_compregreso']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv_2022'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['pdfreport_compregreso']['master_pai']) && $_SESSION['sc_session'][$init_filho]['pdfreport_compregreso']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['pdfreport_compregreso']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['pdfreport_compregreso']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['pdfreport_compregreso']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['pdfreport_compregreso']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['pdfreport_compregreso']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['pdfreport_compregreso']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['pdfreport_compregreso']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['pdfreport_compregreso']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['pdfreport_compregreso']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']);
               $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida']) && $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['pdfreport_compregreso']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['pdfreport_compregreso']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['pdfreport_compregreso']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['pdfreport_compregreso']['protect_modal']) && !empty($_SESSION['scriptcase']['pdfreport_compregreso']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['pdfreport_compregreso']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "pdfreport_compregreso";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'pdfreport_compregreso' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/pdfreport_compregreso/'))
   {
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['contr_total_geral'] = "NAO";
   }

   $_POST['script_case_init'] = $script_case_init;
   if (isset($nmgp_opcao) && $nmgp_opcao == "busca" && isset($nmgp_orig_pesq))
   {
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'pdfreport_compregreso')
   {
       $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/pdfreport_compregreso_erro.php");
   }
   ...
   if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['pdfreport_compregreso']))
   { 
       return;
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['opcao'] = $nmgp_opcao ;  
       }   
       ...
       {
          $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['volta_redirect_tp'] = "";
           $nm_url_saida = "pdfreport_compregreso_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['sc_modal'] = true;
               }
               $nm_url_saida = "pdfreport_compregreso_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['mostra_edit'] = "N";   
           } 
       ...
       $contr_pdfreport_compregreso = new pdfreport_compregreso_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['opcao'] = "busca";
          $contr_pdfreport_compregreso->NM_ajax_flag = true;
          $contr_pdfreport_compregreso->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['opcao'] = "busca";
          $contr_pdfreport_compregreso->NM_ajax_flag = true;
          $contr_pdfreport_compregreso->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['opcao'] = "busca";
          $contr_pdfreport_compregreso->NM_ajax_flag = true;
          $contr_pdfreport_compregreso->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['opcao'] = "busca";
          $contr_pdfreport_compregreso->NM_ajax_flag = true;
          $contr_pdfreport_compregreso->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_pdfreport_compregreso->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['pdfreport_compregreso']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_pdfreport_compregreso(&$str)
   {
   ...
   function nm_protect_num_pdfreport_compregreso($name, &$val)
   {
       if (empty($val))
       {
          return;
       ...
       $Nm_numeric[] = "val_ica";
       $Nm_numeric[] = "porc_ica";
       $Nm_numeric[] = "porc_reteiva";
       $Nm_numeric[] = "val_reteiva";
       $Nm_numeric[] = "iddetall";
       $Nm_numeric[] = "idfact";
       $Nm_numeric[] = "idfp";
       $Nm_numeric[] = "idrc";
   ...
   function pdfreport_compregreso_pack_protect_string($sString)
   {
    ...
    function pdfreport_compregreso_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
