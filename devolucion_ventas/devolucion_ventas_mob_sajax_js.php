  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_devolucion_ventas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_devolucion_ventas_mob_form();
	}
  ...
  // ---------- Validate numerodev
  function do_ajax_devolucion_ventas_mob_validate_numerodev()
  {
    var nomeCampo_numerodev = "numerodev";
    var var_numerodev = scAjaxGetFieldHidden(nomeCampo_numerodev);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_ventas_mob_validate_numerodev(var_numerodev, var_script_case_init, do_ajax_devolucion_ventas_mob_validate_numerodev_cb);
  } // do_ajax_devolucion_ventas_mob_validate_numerodev

  function do_ajax_devolucion_ventas_mob_validate_numerodev_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_ventas_mob_validate_numerodev_cb

  // ---------- Validate fecha
  function do_ajax_devolucion_ventas_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldHidden(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_ventas_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_devolucion_ventas_mob_validate_fecha_cb);
  } // do_ajax_devolucion_ventas_mob_validate_fecha

  function do_ajax_devolucion_ventas_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_ventas_mob_validate_fecha_cb

  // ---------- Validate resolucion
  function do_ajax_devolucion_ventas_mob_validate_resolucion()
  {
    var nomeCampo_resolucion = "resolucion";
    var var_resolucion = scAjaxGetFieldSelect(nomeCampo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_ventas_mob_validate_resolucion(var_resolucion, var_script_case_init, do_ajax_devolucion_ventas_mob_validate_resolucion_cb);
  } // do_ajax_devolucion_ventas_mob_validate_resolucion

  function do_ajax_devolucion_ventas_mob_validate_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_ventas_mob_validate_resolucion_cb

  // ---------- Validate numfacven
  function do_ajax_devolucion_ventas_mob_validate_numfacven()
  {
    var nomeCampo_numfacven = "numfacven";
    var var_numfacven = scAjaxGetFieldSelect(nomeCampo_numfacven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_ventas_mob_validate_numfacven(var_numfacven, var_script_case_init, do_ajax_devolucion_ventas_mob_validate_numfacven_cb);
  } // do_ajax_devolucion_ventas_mob_validate_numfacven

  function do_ajax_devolucion_ventas_mob_validate_numfacven_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_ventas_mob_validate_numfacven_cb

  // ---------- Validate fechafactura
  function do_ajax_devolucion_ventas_mob_validate_fechafactura()
  {
    var nomeCampo_fechafactura = "fechafactura";
    var var_fechafactura = scAjaxGetFieldHidden(nomeCampo_fechafactura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_ventas_mob_validate_fechafactura(var_fechafactura, var_script_case_init, do_ajax_devolucion_ventas_mob_validate_fechafactura_cb);
  } // do_ajax_devolucion_ventas_mob_validate_fechafactura

  function do_ajax_devolucion_ventas_mob_validate_fechafactura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_ventas_mob_validate_fechafactura_cb

  // ---------- Validate confirma
  function do_ajax_devolucion_ventas_mob_validate_confirma()
  {
    var nomeCampo_confirma = "confirma";
    var var_confirma = scAjaxGetFieldCheckbox(nomeCampo_confirma, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_ventas_mob_validate_confirma(var_confirma, var_script_case_init, do_ajax_devolucion_ventas_mob_validate_confirma_cb);
  } // do_ajax_devolucion_ventas_mob_validate_confirma

  function do_ajax_devolucion_ventas_mob_validate_confirma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "confirma";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_ventas_mob_validate_confirma_cb

  // ---------- Validate vdesc
  function do_ajax_devolucion_ventas_mob_validate_vdesc()
  {
    var nomeCampo_vdesc = "vdesc";
    var var_vdesc = scAjaxGetFieldHidden(nomeCampo_vdesc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_ventas_mob_validate_vdesc(var_vdesc, var_script_case_init, do_ajax_devolucion_ventas_mob_validate_vdesc_cb);
  } // do_ajax_devolucion_ventas_mob_validate_vdesc

  function do_ajax_devolucion_ventas_mob_validate_vdesc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vdesc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_ventas_mob_validate_vdesc_cb

  // ---------- Validate vparc
  function do_ajax_devolucion_ventas_mob_validate_vparc()
  {
    var nomeCampo_vparc = "vparc";
    var var_vparc = scAjaxGetFieldHidden(nomeCampo_vparc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_ventas_mob_validate_vparc(var_vparc, var_script_case_init, do_ajax_devolucion_ventas_mob_validate_vparc_cb);
  } // do_ajax_devolucion_ventas_mob_validate_vparc

  function do_ajax_devolucion_ventas_mob_validate_vparc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vparc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_ventas_mob_validate_vparc_cb

  // ---------- Validate viva
  function do_ajax_devolucion_ventas_mob_validate_viva()
  {
    var nomeCampo_viva = "viva";
    var var_viva = scAjaxGetFieldHidden(nomeCampo_viva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_ventas_mob_validate_viva(var_viva, var_script_case_init, do_ajax_devolucion_ventas_mob_validate_viva_cb);
  } // do_ajax_devolucion_ventas_mob_validate_viva

  function do_ajax_devolucion_ventas_mob_validate_viva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "viva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_ventas_mob_validate_viva_cb

  // ---------- Validate vunit
  function do_ajax_devolucion_ventas_mob_validate_vunit()
  {
    var nomeCampo_vunit = "vunit";
    var var_vunit = scAjaxGetFieldHidden(nomeCampo_vunit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_ventas_mob_validate_vunit(var_vunit, var_script_case_init, do_ajax_devolucion_ventas_mob_validate_vunit_cb);
  } // do_ajax_devolucion_ventas_mob_validate_vunit

  function do_ajax_devolucion_ventas_mob_validate_vunit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vunit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_ventas_mob_validate_vunit_cb

  // ---------- Validate observa
  function do_ajax_devolucion_ventas_mob_validate_observa()
  {
    var nomeCampo_observa = "observa";
    var var_observa = scAjaxGetFieldText(nomeCampo_observa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_ventas_mob_validate_observa(var_observa, var_script_case_init, do_ajax_devolucion_ventas_mob_validate_observa_cb);
  } // do_ajax_devolucion_ventas_mob_validate_observa

  function do_ajax_devolucion_ventas_mob_validate_observa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "observa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_ventas_mob_validate_observa_cb

  // ---------- Refresh resolucion
  function do_ajax_devolucion_ventas_mob_refresh_resolucion()
  {
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_nmgp_refresh_fields = "numfacven";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_devolucion_ventas_mob_refresh_resolucion(var_resolucion, var_nmgp_refresh_fields, var_script_case_init, do_ajax_devolucion_ventas_mob_refresh_resolucion_cb);
  } // do_ajax_devolucion_ventas_mob_refresh_resolucion

  function do_ajax_devolucion_ventas_mob_refresh_resolucion_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_ventas_mob_refresh_resolucion_cb

  // ---------- Event onclick confirma
  function do_ajax_devolucion_ventas_mob_event_confirma_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_devolucion_ventas_mob_event_confirma_onclick(var_numerodev, var_fecha, var_resolucion, var_numfacven, var_fechafactura, var_vdesc, var_vparc, var_viva, var_vunit, var_observa, var_script_case_init, do_ajax_devolucion_ventas_mob_event_confirma_onclick_cb);
  } // do_ajax_devolucion_ventas_mob_event_confirma_onclick

  function do_ajax_devolucion_ventas_mob_event_confirma_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "confirma";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_devolucion_ventas_mob_event_confirma_onclick_cb_after_alert);
  } // do_ajax_devolucion_ventas_mob_event_confirma_onclick_cb
  function do_ajax_devolucion_ventas_mob_event_confirma_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_devolucion_ventas_mob_event_confirma_onclick_cb_after_alert

  // ---------- Event onchange numfacven
  function do_ajax_devolucion_ventas_mob_event_numfacven_onchange()
  {
    var var_numfacven = scAjaxGetFieldSelect("numfacven");
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_confirma = scAjaxGetFieldCheckbox("confirma", ";");
    var var_vparc = scAjaxGetFieldHidden("vparc");
    var var_viva = scAjaxGetFieldHidden("viva");
    var var_vunit = scAjaxGetFieldHidden("vunit");
    var var_vdesc = scAjaxGetFieldHidden("vdesc");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_devolucion_ventas_mob_event_numfacven_onchange(var_numfacven, var_resolucion, var_confirma, var_vparc, var_viva, var_vunit, var_vdesc, var_fechafactura, var_script_case_init, do_ajax_devolucion_ventas_mob_event_numfacven_onchange_cb);
  } // do_ajax_devolucion_ventas_mob_event_numfacven_onchange

  function do_ajax_devolucion_ventas_mob_event_numfacven_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "numfacven";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_devolucion_ventas_mob_event_numfacven_onchange_cb_after_alert);
  } // do_ajax_devolucion_ventas_mob_event_numfacven_onchange_cb
  function do_ajax_devolucion_ventas_mob_event_numfacven_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_devolucion_ventas_mob_event_numfacven_onchange_cb_after_alert

  // ---------- Event onchange resolucion
  function do_ajax_devolucion_ventas_mob_event_resolucion_onchange()
  {
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_devolucion_ventas_mob_event_resolucion_onchange(var_resolucion, var_script_case_init, do_ajax_devolucion_ventas_mob_event_resolucion_onchange_cb);
  } // do_ajax_devolucion_ventas_mob_event_resolucion_onchange

  function do_ajax_devolucion_ventas_mob_event_resolucion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "resolucion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_devolucion_ventas_mob_event_resolucion_onchange_cb_after_alert);
  } // do_ajax_devolucion_ventas_mob_event_resolucion_onchange_cb
  function do_ajax_devolucion_ventas_mob_event_resolucion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_devolucion_ventas_mob_refresh_resolucion();
    scAjaxRedir();
  } // do_ajax_devolucion_ventas_mob_event_resolucion_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_devolucion_ventas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_devolucion_ventas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_numerodev = scAjaxGetFieldHidden("numerodev");
    ...
    scAjaxProcOn();
    x_ajax_devolucion_ventas_mob_submit_form(var_numerodev, var_fecha, var_resolucion, var_numfacven, var_fechafactura, var_confirma, var_vdesc, var_vparc, var_viva, var_vunit, var_observa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_devolucion_ventas_mob_submit_form_cb);
  } // do_ajax_devolucion_ventas_mob_submit_form

  function do_ajax_devolucion_ventas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_devolucion_ventas_mob_submit_form_cb_after_alert);
  } // do_ajax_devolucion_ventas_mob_submit_form_cb
  function do_ajax_devolucion_ventas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_devolucion_ventas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_devolucion_ventas_mob_navigate_form()
  {
    perform_ajax_devolucion_ventas_mob_navigate_form();
  }

  function perform_ajax_devolucion_ventas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_devolucion_ventas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion_ventas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_devolucion_ventas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_devolucion_ventas_mob_navigate_form_cb_after_alert);
  } // do_ajax_devolucion_ventas_mob_navigate_form_cb
  function do_ajax_devolucion_ventas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_devolucion_ventas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_devolucion_ventas_mob_navigate_form_cb_after_alert
  function sc_hide_devolucion_ventas_mob_form()
  {
  ...
  ajax_field_list[4] = "fechafactura";
  ajax_field_list[5] = "confirma";
  ...
  var ajax_error_list = {
    "numerodev": {"label": "Número de Devolución", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha": {"label": "Fecha de la Devolución", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "confirma": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "viva": {"label": "IVA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vunit": {"label": "Valor total devolución", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["confirma"][1] = "confirma";
  ...
  var ajax_field_id = {
    ...
    "confirma": new Array("hidden_field_label_confirma", "hidden_field_data_confirma"),
