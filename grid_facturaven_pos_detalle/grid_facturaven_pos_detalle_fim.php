...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_facturaven_pos_detalle"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_facturaven_pos_detalle"]);
   }
