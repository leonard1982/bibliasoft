<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_facturaven_pos_detalle']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_facturaven_pos_detalle_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_facturaven_pos_detalle_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idpro2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["idpro2"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["idpro2"] : "CodBarras";
   $tab_ger_campos['codigoprod'] = "on";
   $tab_def_campos['codigoprod'] = "codigoprod";
   $tab_labels["codigoprod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["codigoprod"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["codigoprod"] : "Código";
   $tab_ger_campos['descripcion_ampliada'] = "on";
   $tab_def_campos['descripcion_ampliada'] = "descripcion_ampliada";
   $tab_labels["descripcion_ampliada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["descripcion_ampliada"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["descripcion_ampliada"] : "Descripción";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['und'] = "on";
   $tab_def_campos['und'] = "und";
   $tab_labels["und"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["und"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["und"] : "Und";
   $tab_ger_campos['valorunit'] = "on";
   $tab_def_campos['valorunit'] = "valorunit";
   $tab_labels["valorunit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["valorunit"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["valorunit"] : "Unitario";
   $tab_ger_campos['adicional'] = "on";
   $tab_def_campos['adicional'] = "adicional";
   $tab_labels["adicional"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["adicional"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["adicional"] : "%IVA";
   $tab_ger_campos['tbase'] = "on";
   $tab_def_campos['tbase'] = "tbase";
   $tab_labels["tbase"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["tbase"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["tbase"] : "Base";
   $tab_ger_campos['iva'] = "on";
   $tab_def_campos['iva'] = "iva";
   $tab_labels["iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["iva"] : "IVA";
   $tab_ger_campos['tneto'] = "on";
   $tab_def_campos['tneto'] = "tneto";
   $tab_labels["tneto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["tneto"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["tneto"] : "Neto";
   $tab_ger_campos['adicional1'] = "on";
   $tab_def_campos['adicional1'] = "adicional1";
   $tab_labels["adicional1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["adicional1"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["adicional1"] : "%/Desc.";
   $tab_ger_campos['descuento'] = "on";
   $tab_def_campos['descuento'] = "descuento";
   $tab_labels["descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['labels']["descuento"] : "V/Desc.";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_facturaven_pos_detalle_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_detalle']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
