<?php
@session_start() ;
$_SESSION['scriptcase']['grid_inventario_fisico_porproducto']['sc_process_barr'] = true;
require_once('../grid_inventario_fisico_porproducto/index.php');
unset($_SESSION['scriptcase']['grid_inventario_fisico_porproducto']['sc_process_barr']);
$ExportCtrl = new grid_inventario_fisico_porproducto_export_control;
$ExportCtrl->Export_barr();

class grid_inventario_fisico_porproducto_export_control
{
