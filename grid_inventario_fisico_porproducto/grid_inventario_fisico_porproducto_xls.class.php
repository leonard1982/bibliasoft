...
class grid_inventario_fisico_porproducto_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_inventario_fisico_porproducto/grid_inventario_fisico_porproducto_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_inventario_fisico_porproducto_res_xls.class.php");
              $this->Res_xls = new grid_inventario_fisico_porproducto_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_inventario_fisico_porproducto.zip";
          $this->Arquivo   .= "_grid_inventario_fisico_porproducto" . $this->Xls_tp;
          $this->Tit_doc    = "grid_inventario_fisico_porproducto" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_m_fecha()
   {
      ...
      if (!empty($this->m_fecha))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->m_fecha, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->m_fecha, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- numero
   ...
   function NM_export_m_observaciones()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->m_observaciones, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->m_observaciones, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- producto
   function NM_export_producto()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->producto, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->producto, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- b_bodega
   function NM_export_b_bodega()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->b_bodega, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->b_bodega, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- d_cantidad
   function NM_export_d_cantidad()
   {
         ...
         if (is_numeric($this->d_cantidad))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.000';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->d_cantidad);
         $this->Xls_col++;
   }
   //----- d_presentacion
   function NM_export_d_presentacion()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->d_presentacion, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->d_presentacion, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- vence
   function NM_export_vence()
   {
      ...
      if (!empty($this->vence))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->vence, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->vence, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- d_lote
   function NM_export_d_lote()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->d_lote, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->d_lote, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- m_idmov
   function NM_export_m_idmov()
   {
         ...
         if (is_numeric($this->m_idmov))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->m_idmov);
         $this->Xls_col++;
   }
   //----- m_fecha
   function NM_sub_cons_m_fecha()
   {
      if (!empty($this->m_fecha))
      {
         $conteudo_x =  $this->m_fecha;
         ...
         $this->m_fecha = NM_charset_to_utf8($this->m_fecha);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->m_fecha;
   ...
   //----- m_observaciones
   function NM_sub_cons_m_observaciones()
   {
         $this->m_observaciones = html_entity_decode($this->m_observaciones, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->m_observaciones = strip_tags($this->m_observaciones);
         $this->m_observaciones = NM_charset_to_utf8($this->m_observaciones);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->m_observaciones;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- producto
   function NM_sub_cons_producto()
   {
         $this->producto = html_entity_decode($this->producto, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->producto = strip_tags($this->producto);
         $this->producto = NM_charset_to_utf8($this->producto);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->producto;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- b_bodega
   function NM_sub_cons_b_bodega()
   {
         $this->b_bodega = html_entity_decode($this->b_bodega, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->b_bodega = strip_tags($this->b_bodega);
         $this->b_bodega = NM_charset_to_utf8($this->b_bodega);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->b_bodega;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- d_cantidad
   function NM_sub_cons_d_cantidad()
   {
         $this->d_cantidad = NM_charset_to_utf8($this->d_cantidad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->d_cantidad;
   ...
   //----- d_presentacion
   function NM_sub_cons_d_presentacion()
   {
         $this->d_presentacion = html_entity_decode($this->d_presentacion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->d_presentacion = strip_tags($this->d_presentacion);
         $this->d_presentacion = NM_charset_to_utf8($this->d_presentacion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->d_presentacion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_vence()
   {
      if (!empty($this->vence))
      {
         ...
         $this->vence = NM_charset_to_utf8($this->vence);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->vence;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- d_lote
   function NM_sub_cons_d_lote()
   {
         $this->d_lote = html_entity_decode($this->d_lote, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->d_lote = strip_tags($this->d_lote);
         $this->d_lote = NM_charset_to_utf8($this->d_lote);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->d_lote;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- m_idmov
   function NM_sub_cons_m_idmov()
   {
         $this->m_idmov = NM_charset_to_utf8($this->m_idmov);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->m_idmov;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['nolabel'])
       {
 ...
 function quebra_d_lote_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   function quebra_m_fecha_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_m_fecha as $cada_campo) {
           if ($cont_col == $lim_col) {
   ...
   function quebra_m_fecha_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0.000";
               $Cmp_Tot    = $this->sum_m_fecha_d_cantidad;
               $prim_cmp = false;
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_numero_sc_free_group_by_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0.000";
               $Cmp_Tot    = $this->sum_numero_d_cantidad;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_producto_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_producto_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0.000";
               $Cmp_Tot    = $this->sum_producto_d_cantidad;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_b_bodega_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_b_bodega_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0.000";
               $Cmp_Tot    = $this->sum_b_bodega_d_cantidad;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_vence_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_vence as $cada_campo) {
           if ($cont_col == $lim_col) {
               $temp_cmp = html_entity_decode($temp_cmp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
               $temp_cmp = strip_tags($temp_cmp);
               $temp_cmp = NM_charset_to_utf8($temp_cmp);
   ...
   function quebra_vence_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0.000";
               $Cmp_Tot    = $this->sum_vence_d_cantidad;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_d_lote_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_d_lote as $cada_campo) {
           if ($cont_col == $lim_col) {
               $temp_cmp = html_entity_decode($temp_cmp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
               $temp_cmp = strip_tags($temp_cmp);
               $temp_cmp = NM_charset_to_utf8($temp_cmp);
   ...
   function quebra_d_lote_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0.000";
               $Cmp_Tot    = $this->sum_d_lote_d_cantidad;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_geral_sc_free_group_by_bot()
   {
       ...
       $prim_cmp = true;
       $mens_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['tot_geral'][1] . ")";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['field_order'] as $Cada_cmp)
       {
           if ($Cada_cmp == "d_cantidad" && (!isset($this->NM_cmp_hidden['d_cantidad']) || $this->NM_cmp_hidden['d_cantidad'] != "off"))
           {
               $Format_Num = "#,##0.000";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['tot_geral'][2];
               $prim_cmp = false;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>Inventario Físico por Producto :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_fisico_porproducto']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
