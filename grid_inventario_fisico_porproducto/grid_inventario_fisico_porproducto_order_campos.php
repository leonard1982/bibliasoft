...
<?php
   ...
   $Ord_Cmp = new grid_inventario_fisico_porproducto_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_inventario_fisico_porproducto_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['m_fecha'] = "m_fecha";
   }
   else
   {
       $tab_def_campos['m_fecha'] = "m.fecha";
   }
   $tab_labels["m_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["m_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["m_fecha"] : "Fecha";
   ...
   {
       $tab_def_campos['numero'] = "concat(r.prefijo,'-',m.numeronota)";
   }
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["numero"] : "Numero";
   $tab_ger_campos['m_observaciones'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['m_observaciones'] = "m_observaciones";
   }
   else
   {
       $tab_def_campos['m_observaciones'] = "m.observaciones";
   }
   $tab_labels["m_observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["m_observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["m_observaciones"] : "Observaciones";
   ...
   $tab_labels["producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["producto"] : "Producto";
   ...
   $tab_labels["b_bodega"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["b_bodega"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["b_bodega"] : "Bodega";
   ...
   $tab_labels["d_cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["d_cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["d_cantidad"] : "Cantidad";
   $tab_ger_campos['d_presentacion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['d_presentacion'] = "d_presentacion";
   }
   else
   {
       $tab_def_campos['d_presentacion'] = "d.presentacion";
   }
   $tab_labels["d_presentacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["d_presentacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["d_presentacion"] : "Presentacion";
   ...
   {
       $tab_def_campos['vence'] = "d.fechavenc";
   }
   $tab_labels["vence"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["vence"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["vence"] : "Vence";
   $tab_ger_campos['d_lote'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['d_lote'] = "d_lote";
   }
   else
   {
       $tab_def_campos['d_lote'] = "d.lote";
   }
   $tab_labels["d_lote"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["d_lote"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['labels']["d_lote"] : "Lote";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_inventario_fisico_porproducto_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_inventario_fisico_porproducto']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
