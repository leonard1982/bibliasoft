...
<?php
   ...
   $Ord_Cmp = new grid_grupos_contables_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_grupos_contables_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["descripcion"] : "Descripcion";
   $tab_ger_campos['puc_inventario'] = "on";
   $tab_def_campos['puc_inventario'] = "puc_inventario";
   $tab_labels["puc_inventario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["puc_inventario"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["puc_inventario"] : "Puc Inventario";
   $tab_ger_campos['puc_devolucion_compra'] = "on";
   $tab_def_campos['puc_devolucion_compra'] = "puc_devolucion_compra";
   $tab_labels["puc_devolucion_compra"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["puc_devolucion_compra"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["puc_devolucion_compra"] : "Puc Devolucion Compra";
   $tab_ger_campos['puc_ingresos'] = "on";
   $tab_def_campos['puc_ingresos'] = "puc_ingresos";
   $tab_labels["puc_ingresos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["puc_ingresos"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["puc_ingresos"] : "Puc Ingresos";
   $tab_ger_campos['puc_devolucion_ventas'] = "on";
   $tab_def_campos['puc_devolucion_ventas'] = "puc_devolucion_ventas";
   $tab_labels["puc_devolucion_ventas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["puc_devolucion_ventas"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["puc_devolucion_ventas"] : "Puc Devolucion Ventas";
   $tab_ger_campos['puc_costo_ventas'] = "on";
   $tab_def_campos['puc_costo_ventas'] = "puc_costo_ventas";
   $tab_labels["puc_costo_ventas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["puc_costo_ventas"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['labels']["puc_costo_ventas"] : "Puc Costo Ventas";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_grupos_contables_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_grupos_contables']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
