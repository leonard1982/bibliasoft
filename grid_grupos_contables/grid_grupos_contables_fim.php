...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_grupos_contables"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_grupos_contables"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_grupos_contables'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_grupos_contables']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_grupos_contables']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_grupos_contables']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_grupos_contables']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_grupos_contables']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_grupos_contables</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_grupos_contables']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_grupos_contables']['embutida_filho'] as $ind => $sc_init)
          {
