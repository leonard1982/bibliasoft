<?php
@session_start() ;
$_SESSION['scriptcase']['grid_mov_ajusteinv']['sc_process_barr'] = true;
require_once('../grid_mov_ajusteinv/index.php');
unset($_SESSION['scriptcase']['grid_mov_ajusteinv']['sc_process_barr']);
$ExportCtrl = new grid_mov_ajusteinv_export_control;
$ExportCtrl->Export_barr();

class grid_mov_ajusteinv_export_control
{
