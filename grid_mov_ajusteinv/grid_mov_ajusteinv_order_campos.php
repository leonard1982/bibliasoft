...
<?php
   ...
   $Ord_Cmp = new grid_mov_ajusteinv_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_mov_ajusteinv_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idtipotran"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["idtipotran"])) ? $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["idtipotran"] : "Motivo Ajuste";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['idpro'] = "on";
   $tab_def_campos['idpro'] = "idpro";
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["idpro"] : "Artículo o Producto";
   $tab_ger_campos['colores'] = "on";
   $tab_def_campos['colores'] = "colores";
   $tab_labels["colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["colores"] : "Color";
   $tab_ger_campos['tallas'] = "on";
   $tab_def_campos['tallas'] = "tallas";
   $tab_labels["tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["tallas"] : "Talla";
   $tab_ger_campos['sabor'] = "on";
   $tab_def_campos['sabor'] = "sabor";
   $tab_labels["sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["sabor"] : "Sabor";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['idbodorig'] = "on";
   $tab_def_campos['idbodorig'] = "idbodorig";
   $tab_labels["idbodorig"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["idbodorig"])) ? $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["idbodorig"] : "Ubicación";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["observaciones"] : "Observaciones";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["imprimir"] : "Imprimir comprobante";
   ...
   $tab_labels["presentacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["presentacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['labels']["presentacion"] : "Presentación";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE>Ajuste Inventrio - (de un solo producto) </TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_mov_ajusteinv_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_mov_ajusteinv']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
