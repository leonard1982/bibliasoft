...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_mov_ajusteinv"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_mov_ajusteinv"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_mov_ajusteinv'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mov_ajusteinv']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_mov_ajusteinv']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mov_ajusteinv']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_mov_ajusteinv']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_mov_ajusteinv']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_mov_ajusteinv</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_mov_ajusteinv']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_mov_ajusteinv']['embutida_filho'] as $ind => $sc_init)
          {
