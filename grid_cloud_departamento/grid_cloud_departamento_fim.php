...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_cloud_departamento"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_cloud_departamento"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_departamento']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cloud_departamento']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_departamento']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cloud_departamento']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cloud_departamento']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_cloud_departamento</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_departamento']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cloud_departamento']['embutida_filho'] as $ind => $sc_init)
          {
