  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_presupuestos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_presupuestos_form();
	}
...
?>
  ...
  function do_ajax_form_presupuestos_validate_id_presupuesto()
  {
    ...
    x_ajax_form_presupuestos_validate_id_presupuesto(var_id_presupuesto, var_script_case_init, do_ajax_form_presupuestos_validate_id_presupuesto_cb);
  } // do_ajax_form_presupuestos_validate_id_presupuesto

  function do_ajax_form_presupuestos_validate_id_presupuesto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuestos_validate_id_presupuesto_cb

  // ---------- Validate fecha
  function do_ajax_form_presupuestos_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuestos_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_presupuestos_validate_fecha_cb);
  } // do_ajax_form_presupuestos_validate_fecha

  function do_ajax_form_presupuestos_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuestos_validate_fecha_cb

  // ---------- Validate descripcion
  function do_ajax_form_presupuestos_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuestos_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_presupuestos_validate_descripcion_cb);
  } // do_ajax_form_presupuestos_validate_descripcion

  function do_ajax_form_presupuestos_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuestos_validate_descripcion_cb

  // ---------- Validate activo
  function do_ajax_form_presupuestos_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldRadio(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuestos_validate_activo(var_activo, var_script_case_init, do_ajax_form_presupuestos_validate_activo_cb);
  } // do_ajax_form_presupuestos_validate_activo

  function do_ajax_form_presupuestos_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuestos_validate_activo_cb

  // ---------- Validate detalle
  function do_ajax_form_presupuestos_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuestos_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_presupuestos_validate_detalle_cb);
  } // do_ajax_form_presupuestos_validate_detalle

  function do_ajax_form_presupuestos_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuestos_validate_detalle_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_presupuestos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_presupuestos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_presupuestos_submit_form(var_id_presupuesto, var_fecha, var_descripcion, var_activo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_presupuestos_submit_form_cb);
  } // do_ajax_form_presupuestos_submit_form

  function do_ajax_form_presupuestos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuestos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuestos']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuestos']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_presupuestos_submit_form_cb_after_alert);
  } // do_ajax_form_presupuestos_submit_form_cb
  function do_ajax_form_presupuestos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_presupuestos_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_presupuesto_detalles"] = "off";

  function do_ajax_form_presupuestos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_presupuestos_navigate_form, function() {});
    } else {
      perform_ajax_form_presupuestos_navigate_form();
    }
  }

  function perform_ajax_form_presupuestos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_presupuestos_navigate_form(var_id_presupuesto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_presupuestos_navigate_form_cb);
  } // do_ajax_form_presupuestos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuestos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_presupuestos_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_presupuestos_navigate_form_cb_after_alert);
  } // do_ajax_form_presupuestos_navigate_form_cb
  function do_ajax_form_presupuestos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_presupuestos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_presupuestos_navigate_form_cb_after_alert
  function sc_hide_form_presupuestos_form()
  {
