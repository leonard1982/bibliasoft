...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_presupuesto' + iSeqRow).bind('blur', function() { sc_form_presupuestos_id_presupuesto_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_presupuestos_id_presupuesto_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha' + iSeqRow).bind('blur', function() { sc_form_presupuestos_fecha_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_presupuestos_fecha_onfocus(this, iSeqRow) });
  $('#id_sc_field_descripcion' + iSeqRow).bind('blur', function() { sc_form_presupuestos_descripcion_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_presupuestos_descripcion_onfocus(this, iSeqRow) });
  $('#id_sc_field_activo' + iSeqRow).bind('blur', function() { sc_form_presupuestos_activo_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_presupuestos_activo_onfocus(this, iSeqRow) });
  $('#id_sc_field_detalle' + iSeqRow).bind('blur', function() { sc_form_presupuestos_detalle_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_presupuestos_detalle_onfocus(this, iSeqRow) });
  $('.sc-ui-radio-activo' + iSeqRow).on('click', function() { scMarkFormAsChanged(); });
} // scJQEventsAdd

function sc_form_presupuestos_id_presupuesto_onblur(oThis, iSeqRow) {
  do_ajax_form_presupuestos_mob_validate_id_presupuesto();
  scCssBlur(oThis);
}

function sc_form_presupuestos_id_presupuesto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_presupuestos_fecha_onblur(oThis, iSeqRow) {
  do_ajax_form_presupuestos_mob_validate_fecha();
  scCssBlur(oThis);
}

function sc_form_presupuestos_fecha_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_presupuestos_descripcion_onblur(oThis, iSeqRow) {
  do_ajax_form_presupuestos_mob_validate_descripcion();
  scCssBlur(oThis);
}

function sc_form_presupuestos_descripcion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_presupuestos_activo_onblur(oThis, iSeqRow) {
  do_ajax_form_presupuestos_mob_validate_activo();
  scCssBlur(oThis);
}

function sc_form_presupuestos_activo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_presupuestos_detalle_onblur(oThis, iSeqRow) {
  do_ajax_form_presupuestos_mob_validate_detalle();
  scCssBlur(oThis);
}

function sc_form_presupuestos_detalle_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_field_detalle(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_grid_presupuesto_detalles")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_grid_presupuesto_detalles")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_presupuestos_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_presupuestos_mob_validate_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_presupuestos_mob_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_editado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_presupuestos_mob_validate_editado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_presupuestos_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
