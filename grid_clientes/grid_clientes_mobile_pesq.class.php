...
class grid_clientes_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_clientes_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_clientes_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_clientes_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_documento($documento)
   {
      ...
      $nm_comando = "select distinct documento from " . $this->Ini->nm_tabela . " where cliente='SI' and  documento like '%" . $documento . "%' order by documento"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_nombres($nombres)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombres from " . $this->Ini->nm_tabela . " where cliente='SI' and  nombres like '%" . $nombres . "%' order by nombres"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_saldo($saldo)
   {
      ...
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where cliente='SI' and   CAST (saldo AS TEXT)  like '%" . $saldo . "%' order by saldo"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where cliente='SI' and   CAST (saldo AS VARCHAR)  like '%" . $saldo . "%' order by saldo"; 
      }
      else
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where cliente='SI' and  saldo like '%" . $saldo . "%' order by saldo"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "nacimiento";$Nm_datas[] = "nacimiento";$Nm_datas[] = "fechault";$Nm_datas[] = "fechault";$Nm_datas[] = "afiliacion";$Nm_datas[] = "afiliacion";$Nm_numeric[] = "idtercero";$Nm_numeric[] = "saldo";$Nm_numeric[] = "idmuni";$Nm_numeric[] = "loatiende";$Nm_numeric[] = "dv";
      ...
      $Nm_datas[] = "nacimiento";$Nm_datas[] = "nacimiento";$Nm_datas[] = "fechault";$Nm_datas[] = "fechault";$Nm_datas[] = "afiliacion";$Nm_datas[] = "afiliacion";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_clientes/grid_clientes_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_clientes_ajax_search.js"></script>
 <script type="text/javascript" src="grid_clientes_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_clientes_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_clientes']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_clientes']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_fechault_cond#NMF#' + search_get_sel_txt('SC_fechault_cond') + '@NMF@';
  str_out += 'SC_fechault_dia#NMF#' + search_get_sel_txt('SC_fechault_dia') + '@NMF@';
  str_out += 'SC_fechault_mes#NMF#' + search_get_sel_txt('SC_fechault_mes') + '@NMF@';
  str_out += 'SC_fechault_ano#NMF#' + search_get_sel_txt('SC_fechault_ano') + '@NMF@';
  str_out += 'SC_fechault_input_2_dia#NMF#' + search_get_sel_txt('SC_fechault_input_2_dia') + '@NMF@';
  str_out += 'SC_fechault_input_2_mes#NMF#' + search_get_sel_txt('SC_fechault_input_2_mes') + '@NMF@';
  str_out += 'SC_fechault_input_2_ano#NMF#' + search_get_sel_txt('SC_fechault_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Lista de Clientes</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $fechault_cond, $fechault, $fechault_dia, $fechault_mes, $fechault_ano, $fechault_input_2_dia, $fechault_input_2_mes, $fechault_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $documento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['documento']; 
          $documento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['documento_cond']; 
          $nombres = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['nombres']; 
          $nombres_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['nombres_cond']; 
          $saldo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['saldo']; 
          $saldo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['saldo_input_2']; 
          $saldo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['saldo_cond']; 
          $fechault_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_dia']; 
          $fechault_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_mes']; 
          $fechault_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_ano']; 
          $fechault_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_input_2_dia']; 
          $fechault_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_input_2_mes']; 
          $fechault_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_input_2_ano']; 
          $fechault_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['NM_operador']; 
      } 
      if (!isset($documento_cond) || empty($documento_cond))
      {
         $documento_cond = "qp";
      }
      ...
      if (!isset($fechault_cond) || empty($fechault_cond))
      {
         $fechault_cond = "eq";
      }
      ...
      $str_hide_fechault = (in_array($fechault_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_documento = ('bw' == $documento_cond) ? $display_aberto : $display_fechado;
      $str_display_nombres = ('bw' == $nombres_cond) ? $display_aberto : $display_fechado;
      $str_display_saldo = ('bw' == $saldo_cond) ? $display_aberto : $display_fechado;
      $str_display_fechault = ('bw' == $fechault_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($fechault) || $fechault == "")
      {
          $fechault = "";
      }
      if (isset($fechault) && !empty($fechault))
      {
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_documento_cond" name="documento_cond" onChange="nm_campos_between(document.getElementById('id_vis_documento'), this, 'documento')">
       <OPTION value="qp" <?php if ("qp" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $documento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_documento"  <?php echo $str_hide_documento?>><?php
      if ($documento != "")
      {
      $documento_look = substr($this->Db->qstr($documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct documento from " . $this->Ini->nm_tabela . " where cliente='SI' and documento = '$documento_look' order by documento"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nombres_cond" name="nombres_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombres'), this, 'nombres')">
       <OPTION value="qp" <?php if ("qp" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_nombres"  <?php echo $str_hide_nombres?>><?php
      if ($nombres != "")
      {
      $nombres_look = substr($this->Db->qstr($nombres), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombres from " . $this->Ini->nm_tabela . " where cliente='SI' and nombres = '$nombres_look' order by nombres"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_nombres" name="nombres" value="<?php echo NM_encode_input($nombres) ?>"  size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where cliente='SI' and saldo = $saldo_look order by saldo"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where cliente='SI' and saldo = $saldo_look order by saldo"; 
...
?>
<INPUT  type="text" id="SC_saldo" name="saldo" value="<?php echo NM_encode_input($saldo) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-saldo" id="id_ac_saldo" name="saldo_autocomp"><?php if ('' !=  $saldo) { ?><option value="<?php echo $saldo ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_saldo"  <?php echo $str_display_saldo; ?> class="scFilterFieldFontOdd">
         ...
         <BR>
         <INPUT type="text" id="SC_saldo_input_2" name="saldo_input_2" value="<?php echo NM_encode_input($saldo_input_2) ?>"  size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
 ...
 $nmgp_tab_label .= "fechault?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_fechault_cond" name="fechault_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechault'), this, 'fechault')">
       <OPTION value="eq" <?php if ("eq" == $fechault_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $fechault_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $fechault_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $fechault_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_fechault"  <?php echo $str_hide_fechault?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
<?php
  ...
  {
?>
<span id='id_date_part_fechault_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechault_dia" name="fechault_dia" value="<?php echo NM_encode_input($fechault_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechault_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechault_mes" name="fechault_mes" value="<?php echo NM_encode_input($fechault_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechault_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechault_ano" name="fechault_ano" value="<?php echo NM_encode_input($fechault_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_fechault"  class="scFilterFieldFontEven">
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fechault"  <?php echo $str_display_fechault; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?> 
         <BR>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechault_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechault_input_2_dia" name="fechault_input_2_dia" value="<?php echo NM_encode_input($fechault_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechault_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechault_input_2_mes" name="fechault_input_2_mes" value="<?php echo NM_encode_input($fechault_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechault_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechault_input_2_ano" name="fechault_input_2_ano" value="<?php echo NM_encode_input($fechault_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
<?php
   if (is_file("grid_clientes_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_clientes']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_clientes']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.documento_cond.value = 'qp';
   ...
   document.F1.fechault_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fechault'), document.F1.fechault_cond, 'fechault');
   document.F1.fechault_dia.value = "";
   document.F1.fechault_mes.value = "";
   document.F1.fechault_ano.value = "";
   document.F1.fechault_input_2_dia.value = "";
   document.F1.fechault_input_2_mes.value = "";
   document.F1.fechault_input_2_ano.value = "";
   Sc_carga_select2('all');
 }
 ...
 {
    $('#SC_fechault_dia').bind('change', function() {sc_grid_clientes_valida_dia(this)});
    $('#SC_fechault_input_2_dia').bind('change', function() {sc_grid_clientes_valida_dia(this)});
    $('#SC_fechault_input_2_mes').bind('change', function() {sc_grid_clientes_valida_mes(this)});
    $('#SC_fechault_mes').bind('change', function() {sc_grid_clientes_valida_mes(this)});
 }
 function sc_grid_clientes_valida_dia(obj)
 {
 ...
 function sc_grid_clientes_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_clientes";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fechault_cond'] = 'cond';
      $tp_fields['SC_fechault_dia'] = 'text';
      $tp_fields['SC_fechault_mes'] = 'text';
      $tp_fields['SC_fechault_ano'] = 'text';
      $tp_fields['SC_fechault_input_2_dia'] = 'text';
      $tp_fields['SC_fechault_input_2_mes'] = 'text';
      $tp_fields['SC_fechault_input_2_ano'] = 'text';
   ...
   function trata_campos()
   {
      global $documento_cond, $documento, $documento_autocomp,
             $nombres_cond, $nombres, $nombres_autocomp,
             $saldo_cond, $saldo, $saldo_input_2, $saldo_autocomp,
             $fechault_cond, $fechault, $fechault_dia, $fechault_mes, $fechault_ano, $fechault_input_2_dia, $fechault_input_2_mes, $fechault_input_2_ano, $nmgp_tab_label;
      ...
      $fechault_cond_salva = $fechault_cond; 
      if (!isset($fechault_input_2_dia) || $fechault_input_2_dia == "")
      {
          $fechault_input_2_dia = $fechault_dia;
      }
      if (!isset($fechault_input_2_mes) || $fechault_input_2_mes == "")
      {
          $fechault_input_2_mes = $fechault_mes;
      }
      if (!isset($fechault_input_2_ano) || $fechault_input_2_ano == "")
      {
          $fechault_input_2_ano = $fechault_ano;
      }
      if ($saldo_cond != "in")
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['documento'] = $documento; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['documento_cond'] = $documento_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['nombres'] = $nombres; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['nombres_cond'] = $nombres_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['saldo'] = $saldo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['saldo_input_2'] = $saldo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['saldo_cond'] = $saldo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_dia'] = $fechault_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_mes'] = $fechault_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_ano'] = $fechault_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_input_2_dia'] = $fechault_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_input_2_mes'] = $fechault_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_input_2_ano'] = $fechault_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_cond'] = $fechault_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      //----- $fechault
      $this->Date_part = false;
      if ($fechault_cond != "bi_TP")
      {
          $fechault_cond = strtoupper($fechault_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $fechault_ano;
          $Dtxt .= $fechault_mes;
          $Dtxt .= $fechault_dia;
          $val[0]['ano'] = $fechault_ano;
          $val[0]['mes'] = $fechault_mes;
          $val[0]['dia'] = $fechault_dia;
          if ($fechault_cond == "BW")
          {
              $val[1]['ano'] = $fechault_input_2_ano;
              $val[1]['mes'] = $fechault_input_2_mes;
              $val[1]['dia'] = $fechault_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $fechault_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $fechault_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fechault = $val[0];
          $this->cmp_formatado['fechault'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fechault'], "YYYY-MM-DD");
          $this->cmp_formatado['fechault'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($fechault_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $fechault_input_2     = $val[1];
              $this->cmp_formatado['fechault_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['fechault_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fechault_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['fechault_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $fechault_cond == "NU" || $fechault_cond == "NN"|| $fechault_cond == "EP"|| $fechault_cond == "NE")
          {
              $this->monta_condicao("fechault", $fechault_cond, $fechault, $fechault_input_2, 'fechault', 'DATE');
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['cond_pesq'] .= $this->NM_operador;
