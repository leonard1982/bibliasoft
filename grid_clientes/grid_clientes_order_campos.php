...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["documento"] : "Cédula/Nit";
   $tab_ger_campos['dv'] = "on";
   $tab_def_campos['dv'] = "dv";
   $tab_labels["dv"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["dv"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["dv"] : "DV";
   $tab_ger_campos['nombres'] = "on";
   $tab_def_campos['nombres'] = "nombres";
   $tab_labels["nombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["nombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["nombres"] : "Razón Social";
   $tab_ger_campos['nombrecompleto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['nombrecompleto'] = "nombrecompleto";
   }
   else
   {
       $tab_def_campos['nombrecompleto'] = "concat(nombre1,' ',nombre2,' ',apellido1,' ',apellido2)";
   }
   $tab_labels["nombrecompleto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["nombrecompleto"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["nombrecompleto"] : "Nombre";
   $tab_ger_campos['idmuni'] = "on";
   $tab_def_campos['idmuni'] = "idmuni";
   $tab_labels["idmuni"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["idmuni"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["idmuni"] : "Ciudad";
   $tab_ger_campos['tel_cel'] = "on";
   $tab_def_campos['tel_cel'] = "tel_cel";
   $tab_labels["tel_cel"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["tel_cel"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["tel_cel"] : "Tel. o celular";
   $tab_ger_campos['urlmail'] = "on";
   $tab_def_campos['urlmail'] = "urlmail";
   $tab_labels["urlmail"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["urlmail"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["urlmail"] : "E-mail";
   $tab_ger_campos['saldo'] = "on";
   $tab_def_campos['saldo'] = "saldo";
   $tab_labels["saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["saldo"] : "Saldo";
   ...
   $tab_labels["facturas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["facturas"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["facturas"] : "Listar Cartera";
   $tab_ger_campos['loatiende'] = "on";
   $tab_def_campos['loatiende'] = "loatiende";
   $tab_labels["loatiende"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["loatiende"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["loatiende"] : "Vendedor";
   $tab_ger_campos['historial'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['historial'] = "historial";
   }
   else
   {
       $tab_def_campos['historial'] = "";
   }
   $tab_labels["historial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["historial"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["historial"] : "Historial";
   $tab_ger_campos['facturas'] = "none";
   $tab_ger_campos['historial'] = "none";
