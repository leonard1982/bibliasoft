...
class grid_clientes_resumo
{
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_clientes']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_clientes']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['contr_total_geral'] == "OK")
      {
          $this->array_total_idmuni = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['arr_total']['idmuni'];
      }
      else
      {
          $this->array_total_idmuni = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['arr_total']['idmuni'] = $this->array_total_idmuni;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['json_use_label'])
       {
          $Lab_idmuni = "idmuni";
       }
       else
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['documento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['documento'] = "Cédula/Nit"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['dv']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['dv'] = "DV"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nombres']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nombres'] = "Razón Social"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nombrecompleto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nombrecompleto'] = "Nombre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['idmuni']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['idmuni'] = "Ciudad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['tel_cel']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['tel_cel'] = "Tel. o celular"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['urlmail']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['urlmail'] = "E-mail"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['saldo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['saldo'] = "Saldo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['facturas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['facturas'] = "Listar Cartera"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['loatiende']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['loatiende'] = "Vendedor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['historial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['historial'] = "Historial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['direccion'] = "Dirección"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nacimiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nacimiento'] = "Fec. Nacimiento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['fechault']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['fechault'] = "Última comp."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['observaciones'] = "Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['idtercero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['idtercero'] = "Idtercero"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['sexo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['sexo'] = "Género"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['afiliacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['afiliacion'] = "Cliente desde"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['regimen']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['regimen'] = "Regimen"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['tipo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['tipo'] = "Tipo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nombre1']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nombre1'] = "Nombre 1"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nombre2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nombre2'] = "Nombre 2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['apellido1']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['apellido1'] = "Apellido 1"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['apellido2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['apellido2'] = "Apellido 2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nombrecompleto2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nombrecompleto2'] = "Nombrecompleto 2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nombrecompleto3']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['labels']['nombrecompleto3'] = "Nombrecompleto 3"; 
       }
       //-----
       $this->comp_field_nm = array(
           'idmuni' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['summarizing_fields_order']['ciudad']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['summarizing_fields_order']['ciudad'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['summarizing_fields_order']['ciudad'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['summarizing_fields_display']['ciudad'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['summarizing_fields_display']['ciudad'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['summarizing_fields_display']['ciudad'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['summarizing_fields_display']['ciudad'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['summarizing_fields_display']['ciudad'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['summarizing_fields_display']['ciudad'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['summarizing_fields_display']['ciudad'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_idmuni as $i_idmuni => $d_idmuni) {
           if (!in_array($i_idmuni, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_idmuni[3] ] = $d_idmuni[2];
               $this->comp_label[0][ $d_idmuni[3] ] = $d_idmuni[2];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_idmuni => $l_idmuni) {
           if (isset($this->array_total_idmuni[$i_idmuni])) {
               $this->comp_group[$i_idmuni] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_idmuni;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_clientes@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_idmuni)),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_clientes_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_clientes_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_clientes_total.class.php"); 
      }
      ...
      $this->Total   = new grid_clientes_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_ciudad("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_idmuni);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_clientes/grid_clientes_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_clientes_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_clientes_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_clientes_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_clientes/grid_clientes_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_clientes/grid_clientes_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_clientes/grid_clientes_config_graf_flash.php?nome_apl=grid_clientes&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_clientes/grid_clientes_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_clientes/grid_clientes_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_clientes_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_clientes']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_clientes']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_clientes_config_pivot.php?nome_apl=grid_clientes&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_clientes_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_clientes/grid_clientes_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $saldo = $Busca_temp['saldo']; 
          $tmp_pos = strpos($saldo, "##@@");
          if ($tmp_pos !== false && !is_array($saldo))
          {
              $saldo = substr($saldo, 0, $tmp_pos);
          }
          $saldo_2 = $Busca_temp['saldo_input_2']; 
          $fechault = $Busca_temp['fechault']; 
          $tmp_pos = strpos($fechault, "##@@");
          if ($tmp_pos !== false && !is_array($fechault))
          {
              $fechault = substr($fechault, 0, $tmp_pos);
          }
          $fechault_2 = $Busca_temp['fechault_input_2']; 
      } 
   ...
   //---- 
   function adiciona_registro($quebra_idmuni, $quebra_idmuni_orig)
   {
      //----- Ciudad
      if (!isset($this->array_total_idmuni[$quebra_idmuni_orig]))
      {
         $this->array_total_idmuni[$quebra_idmuni_orig][0] = 1;
         $this->array_total_idmuni[$quebra_idmuni_orig][1] = 1;
         $this->array_total_idmuni[$quebra_idmuni_orig][2] = $quebra_idmuni;
         $this->array_total_idmuni[$quebra_idmuni_orig][3] = $quebra_idmuni_orig;
      }
      else
      {
         $this->array_total_idmuni[$quebra_idmuni_orig][0]++;
         $this->array_total_idmuni[$quebra_idmuni_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'idmuni');
     $campos_order = $this->Ini->Get_date_order_groupby("idmuni", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->nombrecompleto = $rs_res->fields[3] ;  
            $this->idmuni = $rs_res->fields[4] ;  
            $this->tel_cel = $rs_res->fields[5] ;  
            $this->urlmail = $rs_res->fields[6] ;  
            $this->saldo = $rs_res->fields[7] ;  
            $this->saldo =  str_replace(",", ".", $this->saldo);
            $this->loatiende = $rs_res->fields[8] ;  
            $this->direccion = $rs_res->fields[9] ;  
            $this->nacimiento = $rs_res->fields[10] ;  
            $this->fechault = $rs_res->fields[11] ;  
            $this->observaciones = $rs_res->fields[12] ;  
            $this->idtercero = $rs_res->fields[13] ;  
            ...
            $this->idmuni_orig = $this->idmuni;
            $this->idmuni = $this->look_idmuni ;
            $this->loatiende = $this->look_loatiende ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->idmuni, $this->idmuni_orig);
            }
   }
//
