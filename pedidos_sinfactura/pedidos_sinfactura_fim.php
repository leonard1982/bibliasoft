...
//----- 
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pedidos_sinfactura']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['pedidos_sinfactura']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pedidos_sinfactura']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['pedidos_sinfactura']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['pedidos_sinfactura']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>pedidos_sinfactura</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['pedidos_sinfactura']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['pedidos_sinfactura']['embutida_filho'] as $ind => $sc_init)
          {
