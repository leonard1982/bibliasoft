...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-numpedido" id="id_ac_numpedido" name="numpedido_autocomp"><?php if ('' !=  $numpedido) { ?><option value="<?php echo $numpedido ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_numpedido"  <?php echo $str_display_numpedido; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_numpedido_input_2" name="numpedido_input_2" value="<?php echo NM_encode_input($numpedido_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_idcli"  <?php echo $str_hide_idcli?>><?php
      if ($idcli != "")
      {
      $idcli_look = substr($this->Db->qstr($idcli), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idcli" id="id_ac_idcli" name="idcli_autocomp"><?php if ('' !=  $idcli) { ?><option value="<?php echo $idcli ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
