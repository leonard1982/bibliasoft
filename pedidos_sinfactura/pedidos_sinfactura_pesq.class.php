...
class pedidos_sinfactura_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . pedidos_sinfactura_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . pedidos_sinfactura_pack_protect_string($Tipo_filter[0]) . "\">.." . pedidos_sinfactura_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_numpedido($numpedido)
   {
      ...
      {
          $nm_comando = "select distinct numpedido from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and facturado ='NO' and   CAST (numpedido AS TEXT)  like '%" . $numpedido . "%' order by numpedido"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numpedido from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and facturado ='NO' and   CAST (numpedido AS VARCHAR)  like '%" . $numpedido . "%' order by numpedido"; 
      }
      else
      {
          $nm_comando = "select distinct numpedido from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and facturado ='NO' and  numpedido like '%" . $numpedido . "%' order by numpedido"; 
      }
      unset($cmp1,$cmp2);
   ...
   {
      $idcli = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idcli);
      $idcli = substr($this->Db->qstr($idcli), 1, -1);
            $idcli_look = substr($this->Db->qstr($idcli), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idcli from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and facturado ='NO' and   CAST (idcli AS TEXT)  like '%" . $idcli . "%' order by idcli"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idcli from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and facturado ='NO' and   CAST (idcli AS VARCHAR)  like '%" . $idcli . "%' order by idcli"; 
      }
      else
      {
          $nm_comando = "select distinct idcli from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and facturado ='NO' and  idcli like '%" . $idcli . "%' order by idcli"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Seleccione Pedido a Facturar</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>pedidos_sinfactura/pedidos_sinfactura_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="pedidos_sinfactura_ajax_search.js"></script>
 <script type="text/javascript" src="pedidos_sinfactura_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="pedidos_sinfactura_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['pedidos_sinfactura']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['pedidos_sinfactura']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['ajax_nav'])
           { 
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_numpedido_input_2#NMF#' + search_get_text('SC_numpedido_input_2') + '@NMF@';
  ...
  str_out += 'SC_idcli_input_2#NMF#' + search_get_text('SC_idcli_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  ...
  $(".sc-ui-autocomp-idcli").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Seleccione Pedido a Facturar</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $numpedido_cond, $numpedido, $numpedido_input_2, $numpedido_autocomp,
             $idcli_cond, $idcli, $idcli_input_2, $idcli_autocomp,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['pedidos_sinfactura']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pedidos_sinfactura']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['pedidos_sinfactura']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("pedidos_sinfactura", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fechaven_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_dia']; 
          $fechaven_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_mes']; 
          $fechaven_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_ano']; 
          $fechaven_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_input_2_dia']; 
          $fechaven_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_input_2_mes']; 
          $fechaven_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_input_2_ano']; 
          $fechaven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_cond']; 
          $numpedido = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['numpedido']; 
          $numpedido_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['numpedido_input_2']; 
          $numpedido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['numpedido_cond']; 
          $idcli = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['idcli']; 
          $idcli_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['idcli_input_2']; 
          $idcli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['idcli_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['NM_operador']; 
      } 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fechaven_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fechaven'])) ? $this->New_label['fechaven'] : "Fecha Pedido"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_fechaven_cond" name="fechaven_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechaven'), this, 'fechaven')">
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fechaven" <?php echo $str_hide_fechaven?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fechaven'])) ? $this->New_label['fechaven'] : "Fecha Pedido";
...
?>
      ...
      <TD id='SC_numpedido_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['numpedido'])) ? $this->New_label['numpedido'] : "No. del  pedido"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_numpedido_cond" name="numpedido_cond" onChange="nm_campos_between(document.getElementById('id_vis_numpedido'), this, 'numpedido')">
       <OPTION value="gt" <?php if ("gt" == $numpedido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $numpedido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $numpedido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $numpedido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_numpedido" <?php echo $str_hide_numpedido?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['numpedido'])) ? $this->New_label['numpedido'] : "No. del  pedido";
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numpedido from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and facturado ='NO' and numpedido = $numpedido_look order by numpedido"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numpedido from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and facturado ='NO' and numpedido = $numpedido_look order by numpedido"; 
      ...
      {
            nmgp_Form_Num_Val($numpedido, "", "", "0", "S", "2", "", "N:4", "-") ; 
          $sAutocompValue = $numpedido;
      }
?>
<INPUT  type="text" id="SC_numpedido" name="numpedido" value="<?php echo NM_encode_input($numpedido) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-numpedido" id="id_ac_numpedido" name="numpedido_autocomp"><?php if ('' !=  $numpedido) { ?><option value="<?php echo $numpedido ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_numpedido"  <?php echo $str_display_numpedido; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_numpedido_input_2" name="numpedido_input_2" value="<?php echo NM_encode_input($numpedido_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idcli_cond" name="idcli_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcli'), this, 'idcli')">
       <OPTION value="gt" <?php if ("gt" == $idcli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idcli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idcli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idcli_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idcli from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and facturado ='NO' and idcli = $idcli_look order by idcli"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idcli from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and facturado ='NO' and idcli = $idcli_look order by idcli"; 
      ...
      {
            nmgp_Form_Num_Val($idcli, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idcli;
      }
?>
<INPUT  type="text" id="SC_idcli" name="idcli" value="<?php echo NM_encode_input($idcli) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idcli" id="id_ac_idcli" name="idcli_autocomp"><?php if ('' !=  $idcli) { ?><option value="<?php echo $idcli ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idcli"  <?php echo $str_display_idcli; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idcli_input_2" name="idcli_input_2" value="<?php echo NM_encode_input($idcli_input_2) ?>"  size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (is_file("pedidos_sinfactura_help.txt"))
   {
      $Arq_WebHelp = file("pedidos_sinfactura_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pedidos_sinfactura']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['pedidos_sinfactura']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pedidos_sinfactura']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['pedidos_sinfactura']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.numpedido_cond.value = 'gt';
   ...
   document.F1.numpedido_input_2.value = "";
   document.F1.idcli_cond.value = 'gt';
   ...
   document.F1.idcli_input_2.value = "";
   Sc_carga_select2('all');
 }
 ...
 {
    $('#SC_fechaven_dia').bind('change', function() {sc_pedidos_sinfactura_valida_dia(this)});
    $('#SC_fechaven_input_2_dia').bind('change', function() {sc_pedidos_sinfactura_valida_dia(this)});
    $('#SC_fechaven_input_2_mes').bind('change', function() {sc_pedidos_sinfactura_valida_mes(this)});
    $('#SC_fechaven_mes').bind('change', function() {sc_pedidos_sinfactura_valida_mes(this)});
 }
 function sc_pedidos_sinfactura_valida_dia(obj)
 {
 ...
 function sc_pedidos_sinfactura_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/pedidos_sinfactura";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      global $fechaven_cond, $fechaven, $fechaven_dia, $fechaven_mes, $fechaven_ano, $fechaven_input_2_dia, $fechaven_input_2_mes, $fechaven_input_2_ano,
             $numpedido_cond, $numpedido, $numpedido_input_2, $numpedido_autocomp,
             $idcli_cond, $idcli, $idcli_input_2, $idcli_autocomp, $nmgp_tab_label;
      ...
      if ($numpedido_cond != "in")
      {
          nm_limpa_numero($numpedido_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idcli_cond != "in")
      {
          nm_limpa_numero($idcli, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idcli_cond != "in")
      {
          nm_limpa_numero($idcli_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_dia'] = $fechaven_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_mes'] = $fechaven_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_ano'] = $fechaven_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_input_2_dia'] = $fechaven_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_input_2_mes'] = $fechaven_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_input_2_ano'] = $fechaven_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_cond'] = $fechaven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['numpedido'] = $numpedido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['numpedido_input_2'] = $numpedido_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['numpedido_cond'] = $numpedido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['idcli'] = $idcli; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['idcli_input_2'] = $idcli_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['idcli_cond'] = $idcli_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca'] = $Temp_Busca;
      }
      if ($numpedido_cond != "in" && $numpedido_cond != "bw" && !empty($numpedido) && !is_numeric($numpedido))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : No. del  pedido";
      }
   ...
   { 
      ...
      $Conteudo = $numpedido_input_2;
      if (strtoupper($numpedido_cond) != "II" && strtoupper($numpedido_cond) != "QP" && strtoupper($numpedido_cond) != "NP" && strtoupper($numpedido_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['numpedido_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($idcli != '') {
      $idcli_look = substr($this->Db->qstr($idcli), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      $Conteudo = $idcli_input_2;
      if (strtoupper($idcli_cond) != "II" && strtoupper($idcli_cond) != "QP" && strtoupper($idcli_cond) != "NP" && strtoupper($idcli_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idcli_input_2'] = $Conteudo;
      ...
      if ($fechaven_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven'] = $val[0];
          ...
          if ($fechaven_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']['fechaven_input_2'] = $val[1];
      ...
      {
         $this->monta_condicao("numpedido", $numpedido_cond, $numpedido, $numpedido_input_2, "numpedido");
      }
      ...
      {
         $this->monta_condicao("idcli", $idcli_cond, $idcli, $idcli_input_2, "idcli");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['fast_search']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['interativ_search'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['int_search_dados'] = array();
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pedidos_sinfactura']['where_pesq'];
