...
<?php
   ...
   $Ord_Cmp = new pedidos_sinfactura_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class pedidos_sinfactura_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["prefijo_ped"]   = (isset($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["prefijo_ped"])) ? $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["prefijo_ped"] : "Prefijo";
   $tab_ger_campos['numpedido'] = "on";
   $tab_def_campos['numpedido'] = "numpedido";
   $tab_labels["numpedido"]   = (isset($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["numpedido"])) ? $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["numpedido"] : "No. del  pedido";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["idcli"] : "Cliente";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["fechaven"] : "Fecha Pedido";
   $tab_ger_campos['facturado'] = "on";
   $tab_def_campos['facturado'] = "facturado";
   $tab_labels["facturado"]   = (isset($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["facturado"])) ? $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["facturado"] : "Facturado";
   $tab_ger_campos['vendedor'] = "on";
   $tab_def_campos['vendedor'] = "vendedor";
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["vendedor"] : "Asesor";
   $tab_ger_campos['idpedido'] = "on";
   $tab_def_campos['idpedido'] = "idpedido";
   $tab_labels["idpedido"]   = (isset($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["idpedido"])) ? $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['labels']["idpedido"] : "Id";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "pedidos_sinfactura_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['pedidos_sinfactura']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
