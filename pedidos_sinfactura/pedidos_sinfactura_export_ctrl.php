<?php
@session_start() ;
$_SESSION['scriptcase']['pedidos_sinfactura']['sc_process_barr'] = true;
require_once('../pedidos_sinfactura/index.php');
unset($_SESSION['scriptcase']['pedidos_sinfactura']['sc_process_barr']);
$ExportCtrl = new pedidos_sinfactura_export_control;
$ExportCtrl->Export_barr();

class pedidos_sinfactura_export_control
{
