...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idcombo";$Nm_numeric[] = "idproducto";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "precio";$Nm_numeric[] = "idcombo";$Nm_numeric[] = "idproducto";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "precio";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idcombo_cond" name="idcombo_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcombo'), this, 'idcombo')">
      ...
      <br><span id="id_hide_idcombo"  <?php echo $str_hide_idcombo?>><?php
      if ($idcombo != "")
      {
      $idcombo_look = substr($this->Db->qstr($idcombo), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idcombo" id="id_ac_idcombo" name="idcombo_autocomp"><?php if ('' !=  $idcombo) { ?><option value="<?php echo $idcombo ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_idcombo"  <?php echo $str_display_idcombo; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idcombo_input_2" name="idcombo_input_2" value="<?php echo NM_encode_input($idcombo_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idproducto_cond" name="idproducto_cond" onChange="nm_campos_between(document.getElementById('id_vis_idproducto'), this, 'idproducto')">
      ...
      <br><span id="id_hide_idproducto"  <?php echo $str_hide_idproducto?>><?php
      if ($idproducto != "")
      {
      $idproducto_look = substr($this->Db->qstr($idproducto), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-idproducto" id="id_ac_idproducto" name="idproducto_autocomp"><?php if ('' !=  $idproducto) { ?><option value="<?php echo $idproducto ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_idproducto"  <?php echo $str_display_idproducto; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idproducto_input_2" name="idproducto_input_2" value="<?php echo NM_encode_input($idproducto_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_precio"  <?php echo $str_hide_precio?>><?php
      if ($precio != "")
      {
      $precio_look = substr($this->Db->qstr($precio), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-precio" id="id_ac_precio" name="precio_autocomp"><?php if ('' !=  $precio) { ?><option value="<?php echo $precio ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_precio"  <?php echo $str_display_precio; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
