...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_inventario_productos_combo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_inventario_productos_combo"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_productos_combo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_inventario_productos_combo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_productos_combo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_inventario_productos_combo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_inventario_productos_combo']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_inventario_productos_combo</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_productos_combo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_inventario_productos_combo']['embutida_filho'] as $ind => $sc_init)
          {
