...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_inventario_productos_combo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_inventario_productos_combo"]);
   }
