...
class grid_inventario_productos_combo_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_inventario_productos_combo_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_inventario_productos_combo_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_inventario_productos_combo_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_precio')
      {
          $precio = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_precio($precio);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   {
      $idcombo = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idcombo);
      $idcombo = substr($this->Db->qstr($idcombo), 1, -1);
            $idcombo_look = substr($this->Db->qstr($idcombo), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idcombo from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and   CAST (idcombo AS TEXT)  like '%" . $idcombo . "%' order by idcombo"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idcombo from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and   CAST (idcombo AS VARCHAR)  like '%" . $idcombo . "%' order by idcombo"; 
      }
      else
      {
          $nm_comando = "select distinct idcombo from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and  idcombo like '%" . $idcombo . "%' order by idcombo"; 
      }
      unset($cmp1,$cmp2);
   ...
   {
      $idproducto = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idproducto);
      $idproducto = substr($this->Db->qstr($idproducto), 1, -1);
            $idproducto_look = substr($this->Db->qstr($idproducto), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idproducto from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and   CAST (idproducto AS TEXT)  like '%" . $idproducto . "%' order by idproducto"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idproducto from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and   CAST (idproducto AS VARCHAR)  like '%" . $idproducto . "%' order by idproducto"; 
      }
      else
      {
          $nm_comando = "select distinct idproducto from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and  idproducto like '%" . $idproducto . "%' order by idproducto"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_cantidad($cantidad)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct cantidad from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and   CAST (cantidad AS TEXT)  like '%" . $cantidad . "%' order by cantidad"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct cantidad from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and   CAST (cantidad AS VARCHAR)  like '%" . $cantidad . "%' order by cantidad"; 
      }
      else
      {
          $nm_comando = "select distinct cantidad from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and  cantidad like '%" . $cantidad . "%' order by cantidad"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_precio($precio)
   {
      $precio = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $precio);
      $precio = substr($this->Db->qstr($precio), 1, -1);
            $precio_look = substr($this->Db->qstr($precio), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct precio from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and   CAST (precio AS TEXT)  like '%" . $precio . "%' order by precio"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct precio from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and   CAST (precio AS VARCHAR)  like '%" . $precio . "%' order by precio"; 
      }
      else
      {
          $nm_comando = "select distinct precio from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and  precio like '%" . $precio . "%' order by precio"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - detallecombos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_inventario_productos_combo/grid_inventario_productos_combo_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_inventario_productos_combo_ajax_search.js"></script>
 <script type="text/javascript" src="grid_inventario_productos_combo_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_inventario_productos_combo_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_inventario_productos_combo']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_inventario_productos_combo']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'id_ac_idcombo#NMF#' + search_get_title('select2-id_ac_idcombo-container') + '@NMF@';
  str_out += 'SC_idcombo_input_2#NMF#' + search_get_text('SC_idcombo_input_2') + '@NMF@';
  ...
  str_out += 'id_ac_idproducto#NMF#' + search_get_title('select2-id_ac_idproducto-container') + '@NMF@';
  str_out += 'SC_idproducto_input_2#NMF#' + search_get_text('SC_idproducto_input_2') + '@NMF@';
  ...
  str_out += 'id_ac_precio#NMF#' + search_get_title('select2-id_ac_precio-container') + '@NMF@';
  str_out += 'SC_precio_input_2#NMF#' + search_get_text('SC_precio_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-idproducto").on("focus", function() {
  }).on("blur", function() {
   ...
   $("#SC_idproducto").val(e.params.data.id);
  });
  ...
  $(".sc-ui-autocomp-precio").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_precio",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_precio").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-idcombo").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   $("#SC_idcombo").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - detallecombos</span></td>
...
<?php
   ...
   {
      global 
             $idcombo_cond, $idcombo, $idcombo_input_2, $idcombo_autocomp,
             $idproducto_cond, $idproducto, $idproducto_input_2, $idproducto_autocomp,
             $cantidad_cond, $cantidad, $cantidad_autocomp,
             $precio_cond, $precio, $precio_input_2, $precio_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idcombo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['idcombo']; 
          $idcombo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['idcombo_input_2']; 
          $idcombo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['idcombo_cond']; 
          $idproducto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['idproducto']; 
          $idproducto_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['idproducto_input_2']; 
          $idproducto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['idproducto_cond']; 
          $cantidad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['cantidad']; 
          $cantidad_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['cantidad_cond']; 
          $precio = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['precio']; 
          $precio_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['precio_input_2']; 
          $precio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['precio_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_display_precio = ('bw' == $precio_cond) ? $display_aberto : $display_fechado;
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idcombo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idcombo'])) ? $this->New_label['idcombo'] : "Idcombo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idcombo_cond" name="idcombo_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcombo'), this, 'idcombo')">
       <OPTION value="gt" <?php if ("gt" == $idcombo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idcombo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idcombo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idcombo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idcombo from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and idcombo = $idcombo_look order by idcombo"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idcombo from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and idcombo = $idcombo_look order by idcombo"; 
      ...
      {
            nmgp_Form_Num_Val($idcombo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idcombo;
      }
?>
<INPUT  type="text" id="SC_idcombo" name="idcombo" value="<?php echo NM_encode_input($idcombo) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idcombo" id="id_ac_idcombo" name="idcombo_autocomp"><?php if ('' !=  $idcombo) { ?><option value="<?php echo $idcombo ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idcombo"  <?php echo $str_display_idcombo; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idcombo_input_2" name="idcombo_input_2" value="<?php echo NM_encode_input($idcombo_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_idproducto_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idproducto'])) ? $this->New_label['idproducto'] : "Producto"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idproducto_cond" name="idproducto_cond" onChange="nm_campos_between(document.getElementById('id_vis_idproducto'), this, 'idproducto')">
       <OPTION value="gt" <?php if ("gt" == $idproducto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idproducto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idproducto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idproducto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idproducto from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and idproducto = $idproducto_look order by idproducto"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idproducto from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and idproducto = $idproducto_look order by idproducto"; 
      ...
      {
            nmgp_Form_Num_Val($idproducto, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idproducto;
      }
?>
<INPUT  type="text" id="SC_idproducto" name="idproducto" value="<?php echo NM_encode_input($idproducto) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-idproducto" id="id_ac_idproducto" name="idproducto_autocomp"><?php if ('' !=  $idproducto) { ?><option value="<?php echo $idproducto ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idproducto"  <?php echo $str_display_idproducto; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idproducto_input_2" name="idproducto_input_2" value="<?php echo NM_encode_input($idproducto_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cantidad_cond" name="cantidad_cond" onChange="nm_campos_between(document.getElementById('id_vis_cantidad'), this, 'cantidad')">
       ...
       <OPTION value="ii" <?php if ("ii" == $cantidad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $cantidad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $cantidad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct cantidad from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and cantidad = $cantidad_look order by cantidad"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct cantidad from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and cantidad = $cantidad_look order by cantidad"; 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cantidad" id="id_ac_cantidad" name="cantidad_autocomp"><?php if ('' !=  $cantidad) { ?><option value="<?php echo $cantidad ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_precio_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['precio'])) ? $this->New_label['precio'] : "Precio"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_precio_cond" name="precio_cond" onChange="nm_campos_between(document.getElementById('id_vis_precio'), this, 'precio')">
       ...
       <OPTION value="bw" <?php if ("bw" == $precio_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct precio from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and precio = $precio_look order by precio"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct precio from " . $this->Ini->nm_tabela . " where idcombo='" . $_SESSION['giddelcombo'] . "' and precio = $precio_look order by precio"; 
      ...
      if (isset($nmgp_def_dados[0][$precio]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$precio];
      }
      else
      {
            nmgp_Form_Num_Val($precio, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $precio;
      }
?>
<INPUT  type="text" id="SC_precio" name="precio" value="<?php echo NM_encode_input($precio) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-precio" id="id_ac_precio" name="precio_autocomp"><?php if ('' !=  $precio) { ?><option value="<?php echo $precio ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_precio"  <?php echo $str_display_precio; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_precio_input_2" name="precio_input_2" value="<?php echo NM_encode_input($precio_input_2) ?>"  size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
...
?>
<?php
   if (is_file("grid_inventario_productos_combo_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_inventario_productos_combo']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_inventario_productos_combo']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idcombo_cond.value = 'gt';
   ...
   $('#select2-id_ac_idcombo-container').html('<?php echo $this->Val_init_idcombo['desc'] ?>');;
   document.F1.idcombo_input_2.value = "";
   document.F1.idproducto_cond.value = 'gt';
   ...
   $('#select2-id_ac_idproducto-container').html('<?php echo $this->Val_init_idproducto['desc'] ?>');;
   document.F1.idproducto_input_2.value = "";
   document.F1.cantidad_cond.value = 'eq';
   ...
   document.F1.precio_autocomp.value = "";
   $('#select2-id_ac_precio-container').html('<?php echo $this->Val_init_precio['desc'] ?>');;
   document.F1.precio_input_2.value = "";
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEB_V2_SIN/grid_inventario_productos_combo";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_inventario_productos_combo/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['id_ac_idcombo'] = 'select2_aut';
      $tp_fields['SC_idcombo_input_2'] = 'text';
      $tp_fields['SC_idproducto_cond'] = 'cond';
      $tp_fields['SC_idproducto'] = 'text_aut';
      $tp_fields['id_ac_idproducto'] = 'select2_aut';
      $tp_fields['SC_idproducto_input_2'] = 'text';
      ...
      $tp_fields['SC_precio'] = 'text_aut';
      $tp_fields['id_ac_precio'] = 'select2_aut';
      $tp_fields['SC_precio_input_2'] = 'text';
   ...
   {
      global $idcombo_cond, $idcombo, $idcombo_input_2, $idcombo_autocomp,
             $idproducto_cond, $idproducto, $idproducto_input_2, $idproducto_autocomp,
             $cantidad_cond, $cantidad, $cantidad_autocomp,
             $precio_cond, $precio, $precio_input_2, $precio_autocomp, $nmgp_tab_label;
      ...
      if (!empty($precio_autocomp) && empty($precio))
      {
          $precio = $precio_autocomp;
      }
      ...
      if ($idcombo_cond != "in")
      {
          nm_limpa_numero($idcombo, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idcombo_cond != "in")
      {
          nm_limpa_numero($idcombo_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idproducto_cond != "in")
      {
          nm_limpa_numero($idproducto, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idproducto_cond != "in")
      {
          nm_limpa_numero($idproducto_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($cantidad_cond != "in")
      {
          if ($C_formatado)
      ...
      if ($precio_cond != "in")
      {
          nm_limpa_numero($precio_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['idcombo'] = $idcombo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['idcombo_input_2'] = $idcombo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['idcombo_cond'] = $idcombo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['idproducto'] = $idproducto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['idproducto_input_2'] = $idproducto_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['idproducto_cond'] = $idproducto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['cantidad'] = $cantidad; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['cantidad_cond'] = $cantidad_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['precio'] = $precio; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['precio_input_2'] = $precio_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['precio_cond'] = $precio_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca'] = $Temp_Busca;
      }
      if ($idcombo_cond != "in" && $idcombo_cond != "bw" && !empty($idcombo) && !is_numeric($idcombo))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idcombo";
      }
      ...
      if ($precio_cond != "in" && $precio_cond != "bw" && !empty($precio) && !is_numeric($precio))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Precio";
      }
      if ($precio_cond == "bw" && ((!empty($precio) && !is_numeric($precio)) || (!empty($precio_input_2) && !is_numeric($precio_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Precio";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      $Conteudo = $idcombo_input_2;
      if (strtoupper($idcombo_cond) != "II" && strtoupper($idcombo_cond) != "QP" && strtoupper($idcombo_cond) != "NP" && strtoupper($idcombo_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idcombo_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($idproducto != '') {
      $idproducto_look = substr($this->Db->qstr($idproducto), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      $Conteudo = $idproducto_input_2;
      if (strtoupper($idproducto_cond) != "II" && strtoupper($idproducto_cond) != "QP" && strtoupper($idproducto_cond) != "NP" && strtoupper($idproducto_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idproducto_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($cantidad != '') {
      $cantidad_look = substr($this->Db->qstr($cantidad), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['precio'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['precio'] = $cmp1;
      }
      else
      {
          $cmp1 = $precio;
      ...
      {
         $this->monta_condicao("idproducto", $idproducto_cond, $idproducto, $idproducto_input_2, "idproducto");
      }
      ...
      {
         $this->monta_condicao("precio", $precio_cond, $precio, $precio_input_2, "precio");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_productos_combo']['cond_pesq'] .= $this->NM_operador;
