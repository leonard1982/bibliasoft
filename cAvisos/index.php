<?php
   include_once('cAvisos_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['cAvisos']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['cAvisos']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['cAvisos']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['cAvisos']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['cAvisos']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['cAvisos']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['cAvisos']['glo_nm_path_doc']        = "";
   $_SESSION['scriptcase']['cAvisos']['glo_con_conn_firebird']         = "conn_firebird";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['cAvisos']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['cAvisos']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['cAvisos']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['cAvisos']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['cAvisos']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['cAvisos']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['cAvisos']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['cAvisos']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['cAvisos']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['cAvisos']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['cAvisos']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "cAvisos"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['cAvisos']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['cAvisos']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['cAvisos']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['cAvisos']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['cAvisos']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['cAvisos']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['cAvisos']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['cAvisos']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['cAvisos']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/cAvisos';
      ...
      $_SESSION['sc_session'][$this->sc_page]['cAvisos']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['cAvisos']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['cAvisos']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['cAvisos']['actual_lang']) || $_SESSION['scriptcase']['cAvisos']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['cAvisos']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("cAvisos_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['cAvisos']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['cAvisos']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['cAvisos']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['cAvisos']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['cAvisos']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["cAvisos"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["cAvisos"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['cAvisos']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['cAvisos']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['cAvisos']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['cAvisos']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['cAvisos']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['cAvisos']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "cAvisos_erro.class.php"); 
      $this->Erro = new cAvisos_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('cAvisos'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['cAvisos']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['cAvisos']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['cAvisos']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['cAvisos']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['cAvisos']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['cAvisos']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['cAvisos']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['cAvisos']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
      $this->conectExtra();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['cAvisos']['glo_nm_conexao']) && $_SESSION['scriptcase']['cAvisos']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['cAvisos']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['cAvisos']['glo_nm_perfil']) && $_SESSION['scriptcase']['cAvisos']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['cAvisos']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['cAvisos']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['cAvisos']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['cAvisos']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['cAvisos']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['cAvisos']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['cAvisos']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['cAvisos']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['cAvisos']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['cAvisos']['glo_nm_perfil'];
      }
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['cAvisos']['glo_con_conn_firebird'], $this->path_libs, "S", $this->path_conf);
          $this->nm_con_conn_firebird['servidor']               = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_conn_firebird['usuario']                = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_conn_firebird['banco']                  = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_conn_firebird['senha']                  = $_SESSION['scriptcase']['glo_senha'];
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['cAvisos']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['cAvisos']['embutida_init']) 
      {
          if (!isset($_SESSION['gpj'])) 
          {
              $this->nm_falta_var .= "gpj; ";
          }
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['cAvisos']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['cAvisos']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['cAvisos']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['cAvisos']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEB_FE_73', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['cAvisos']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new cAvisos_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cAvisos']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['cAvisos']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['cAvisos']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['cAvisos'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cAvisos']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cAvisos']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('cAvisos') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cAvisos']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cAvisos']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['cAvisos']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['cAvisos']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "cAvisos_erro.class.php"); 
      $this->Erro      = new cAvisos_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['cAvisos']['contr_erro'] = 'on';
if (!isset($_SESSION['gnum'])) {$_SESSION['gnum'] = "";}
if (!isset($this->sc_temp_gnum)) {$this->sc_temp_gnum = (isset($_SESSION['gnum'])) ? $_SESSION['gnum'] : "";}
if (!isset($_SESSION['gpj'])) {$_SESSION['gpj'] = "";}
if (!isset($this->sc_temp_gpj)) {$this->sc_temp_gpj = (isset($_SESSION['gpj'])) ? $_SESSION['gpj'] : "";}
  if(isset($this->sc_temp_gpj))
{
	
	
	
	$vsql = "select kardexid from kardex where codcomp='FV' and codprefijo='".$this->sc_temp_gpj."' and numero='".$this->sc_temp_gnum."'";
      ...
      { 
          ...
          { 
                 ...
                 { 
                        $this->vkdx[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->vkdx = false;
          $this->vkdx_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
      } 
;
	
	if(isset($this->vkdx[0][0]))
	{
		$vkardexid = $this->vkdx[0][0];
		$this->fEnviarFE($vkardexid);
	}
}
if (isset($this->sc_temp_gpj)) {$_SESSION['gpj'] = $this->sc_temp_gpj;}
if (isset($this->sc_temp_gnum)) {$_SESSION['gnum'] = $this->sc_temp_gnum;}
$_SESSION['scriptcase']['cAvisos']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
...
if (!isset($this->sc_temp_gidempresa)) {$this->sc_temp_gidempresa = (isset($_SESSION['gidempresa'])) ? $_SESSION['gidempresa'] : "";}
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $vSiExiste1[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $vsiexiste1[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $vSiExiste1 = false;
          $vSiExiste1_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
          $vsiexiste1 = false;
          $vsiexiste1_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
      } 
;
		if(!isset($vsiexiste1[0][0]))
		{
     ...
     $nm_select = "ALTER TABLE KARDEX ADD SN_CUFE VARCHAR(300)"; 
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $vSiExiste2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $vsiexiste2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $vSiExiste2 = false;
          $vSiExiste2_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
          $vsiexiste2 = false;
          $vsiexiste2_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
      } 
;
		if(!isset($vsiexiste2[0][0]))
		{
     ...
     $nm_select = "ALTER TABLE KARDEX ADD SN_PJFE VARCHAR(10)"; 
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $vSiExiste3[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $vsiexiste3[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $vSiExiste3 = false;
          $vSiExiste3_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
          $vsiexiste3 = false;
          $vsiexiste3_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
      } 
;
		if(!isset($vsiexiste3[0][0]))
		{
     ...
     $nm_select = "ALTER TABLE KARDEX ADD SN_RUTAQR VARCHAR(200)"; 
      ...
      ;
		...
		$vsql1 = "select k.codprefijo,k.numero,k.total,t.nittri,k.fecha,k.fecvence,k.formapago,t.nit from kardex k inner join terceros t on k.cliente=t.terid where k.kardexid='".$vkardexid."'";
      ...
      { 
          $vDatosKardex = false;
          $vDatosKardex_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
          $vdatoskardex = false;
          $vdatoskardex_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
      } 
;
...
;
      ...
      { 
          $ds_fe = false;
          $ds_fe_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
      } 
;	
...
;
      ...
      $nm_select = "select ccnit,celular,correo from cloud_empresas where id_empresa='".$this->sc_temp_gidempresa."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $vDataEmisor = array();
      $vdataemisor = array();
      ...
      { 
          $vDataEmisor = false;
          $vDataEmisor_erro = $this->Db->ErrorMsg();
          $vdataemisor = false;
          $vdataemisor_erro = $this->Db->ErrorMsg();
      } 
;
			...
			$DireccionFiscal->direccion  = $vdirecc1;

			$factura->cliente->direccionFiscal = $DireccionFiscal;
			$factura->cliente->direccion       = $vdirecc1;
      ...
      { 
          $vDetalle = false;
          $vDetalle_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
          $vdetalle = false;
          $vdetalle_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
      } 
;
      ...
      { 
          $vseriale = false;
          $vseriale_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
      } 
;
			...
			$vsql_tipo_impuesto = "select sum(preciobase*canmat) as base, iif(porciva='08','02','01') as codigoimpuesto, porciva as porcentaje, sum(precioiva*canlista) as iva from dekardex where kardexid='".$vkardexid."' group by porciva";
      ...
      { 
          $dt_impfac = false;
          $dt_impfac_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
      } 
;
			...
			$vsql_iva = "select (iif(porciva='08','02','01')) as codigoimpuesto, sum(precioiva*canlista) as iva, sum(preciobase*canlista) as base from dekardex where kardexid='".$vkardexid."' group by iif(porciva='08','02','01')";
      ...
      { 
          $dt_impTfac = false;
          $dt_impTfac_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
          $dt_imptfac = false;
          $dt_imptfac_erro = $this->Ini->nm_db_conn_firebird->ErrorMsg();
      } 
;
			...
			{
				$vmensaje   = $resultado["mensajesValidacion"];
				$vavisos	= addslashes($vmensaje);
			}
			else
			{
			...
			if($resultado["codigo"]==200 or $resultado["codigo"]==201)
			{
				...
				{
					$vpasos      .= "9. Descarga del pdf, ";
					
					$decoded 	= $descargas["documento"];
					
					$vdoc64  = base64_decode($decoded);
					$file    = "../blank_generar_pdf_fe/".$vcodprefijo.$vnumero.'.pdf';
					file_put_contents($file, $vdoc64);
				...
				$sql="insert into cloud_kardex SET cufe = '".$vcufe."', enlace_pdf='".$decoded."', estado='".$vestado."', avisos='".$vavisos."', id_empresa='".$this->sc_temp_gidempresa."',tipo='FV',prefijo='".$vcodprefijo."',numero='".$vnumero."',tercero='".$vnit."'";
...
;
				...
				if(isset($vsi[0][0]))
				{
					$sql="update cloud_kardex SET cufe = '".$vcufe."', enlace_pdf='".$decoded."', estado='".$vestado."', avisos='".$vavisos."' where id_empresa='".$this->sc_temp_gidempresa."' and tipo='FV' and prefijo='".$vcodprefijo."' and numero='".$vnumero."'";
				}
     ...
     $nm_select = $sql; 
      ...
      ;
				...
				$vsql_update = "update kardex set sn_cufe='".$vcufe."',sn_pjfe='".$vpjfe."' where kardexid='".$vkardexid."'";
     ...
     $nm_select = $vsql_update; 
      ...
      ;
				...
				if(!empty($vcufe))
				{
					...
					$vsql_update = "update kardex set sn_rutaqr='//caja/qr/".$vcodprefijo.$vnumero.".bmp' where kardexid='".$vkardexid."'";
     ...
     $nm_select = $vsql_update; 
      ...
      ;
			...
			else
			{
				...
				$sql="insert into cloud_kardex_rechazos SET estado='".$vestado."', avisos='".$vavisos."', id_empresa='".$this->sc_temp_gidempresa."',tipo='FV',prefijo='".$vcodprefijo."',numero='".$vnumero."',tercero='".$vnit."'";
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['cAvisos']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['cAvisos']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "cAvisos") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['cAvisos']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['cAvisos']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['cAvisos']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEB_FE_73'])) {
               $_SESSION['scriptcase']['cAvisos']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEB_FE_73'];
           }
       }
   }
   ...
   if (isset($_POST["gpj"])) 
   {
       $_SESSION["gpj"] = $_POST["gpj"];
       nm_limpa_str_cAvisos($_SESSION["gpj"]);
   }
   if (isset($_GET["gpj"])) 
   {
       $_SESSION["gpj"] = $_GET["gpj"];
       nm_limpa_str_cAvisos($_SESSION["gpj"]);
   }
   if (!isset($_SESSION["gpj"])) 
   {
   ...
   if (isset($_POST["gidempresa"])) 
   {
       ...
       nm_limpa_str_cAvisos($_SESSION["gidempresa"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['cAvisos']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['cAvisos']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['cAvisos']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "cAvisos";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'cAvisos' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['cAvisos']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['cAvisos']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['cAvisos']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['cAvisos']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['cAvisos']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('cAvisos' == $sReferer || 'cAvisos_' == substr($sReferer, 0, 8))
       {
           $_SESSION['sc_session'][$script_case_init]['cAvisos']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'cAvisos')
   {
       $_SESSION['sc_session'][$script_case_init]['cAvisos']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['cAvisos']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/cAvisos_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_cAvisos($cadapar[1]);
   ...
   $contr_cAvisos = new cAvisos_apl();
   $contr_cAvisos->controle();
//
   function nm_limpa_str_cAvisos(&$str)
   {
