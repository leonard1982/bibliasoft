<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalleprod']['sc_process_barr'] = true;
require_once('../grid_detalleprod/index.php');
unset($_SESSION['scriptcase']['grid_detalleprod']['sc_process_barr']);
$ExportCtrl = new grid_detalleprod_export_control;
$ExportCtrl->Export_barr();

class grid_detalleprod_export_control
{
