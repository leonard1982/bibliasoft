...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_numproducc_cond" name="numproducc_cond" onChange="nm_campos_between(document.getElementById('id_vis_numproducc'), this, 'numproducc')">
      ...
      <br><span id="id_hide_numproducc"  <?php echo $str_hide_numproducc?>><?php
      if ($numproducc != "")
      {
      $numproducc_look = substr($this->Db->qstr($numproducc), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-numproducc" id="id_ac_numproducc" name="numproducc_autocomp"><?php if ('' !=  $numproducc) { ?><option value="<?php echo $numproducc ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_numproducc"  <?php echo $str_display_numproducc; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idpro_cond" name="idpro_cond" onChange="nm_campos_between(document.getElementById('id_vis_idpro'), this, 'idpro')">
      ...
      <br><span id="id_hide_idpro"  <?php echo $str_hide_idpro?>><?php
      if ($idpro != "")
      {
      $idpro_look = substr($this->Db->qstr($idpro), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idpro" id="id_ac_idpro" name="idpro_autocomp"><?php if ('' !=  $idpro) { ?><option value="<?php echo $idpro ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_idpro"  <?php echo $str_display_idpro; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_unidadmayor_cond" name="unidadmayor_cond" onChange="nm_campos_between(document.getElementById('id_vis_unidadmayor'), this, 'unidadmayor')">
      ...
      <br><span id="id_hide_unidadmayor"  <?php echo $str_hide_unidadmayor?>><?php
      if ($unidadmayor != "")
      {
      $unidadmayor_look = substr($this->Db->qstr($unidadmayor), 1, -1); 
      $nmgp_def_dados = array(); 
