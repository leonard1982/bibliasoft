...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detalleprod"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detalleprod"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleprod']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleprod']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleprod']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleprod']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalleprod']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalleprod']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalleprod']['embutida_filho'] as $ind => $sc_init)
          {
