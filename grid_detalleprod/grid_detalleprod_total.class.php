...
class grid_detalleprod_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_detalleprod']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_detalleprod']['campos_busca']))
      { 
          ...
          $numproducc_2 = $Busca_temp['numproducc_input_2']; 
   ...
   {
      global $nada, $nm_lang , $idpro, $idbod, $colores, $tallas, $sabor;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(valorpar) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['tot_geral'][0] = "Total Costo Materia Prima"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['contr_total_geral'] = "OK";
   } 
