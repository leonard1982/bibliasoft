<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_detalleprod']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_detalleprod_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detalleprod_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["idpro"] : "Materia Prima";
   $tab_ger_campos['idbod'] = "on";
   $tab_def_campos['idbod'] = "idbod";
   $tab_labels["idbod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["idbod"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["idbod"] : "Origen";
   $tab_ger_campos['colores'] = "on";
   $tab_def_campos['colores'] = "colores";
   $tab_labels["colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["colores"] : "Color";
   $tab_ger_campos['tallas'] = "on";
   $tab_def_campos['tallas'] = "tallas";
   $tab_labels["tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["tallas"] : "Talla";
   $tab_ger_campos['sabor'] = "on";
   $tab_def_campos['sabor'] = "sabor";
   $tab_labels["sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["sabor"] : "Sabor";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['costop'] = "on";
   $tab_def_campos['costop'] = "costop";
   $tab_labels["costop"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["costop"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["costop"] : "Costop";
   $tab_ger_campos['valorpar'] = "on";
   $tab_def_campos['valorpar'] = "valorpar";
   $tab_labels["valorpar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["valorpar"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["valorpar"] : "Valorpar";
   $tab_ger_campos['presenta'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['presenta'] = "presenta";
   }
   else
   {
       $tab_def_campos['presenta'] = "";
   }
   $tab_labels["presenta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["presenta"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['labels']["presenta"] : "Presentación";
   $tab_ger_campos['presenta'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - detalleprod</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detalleprod_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detalleprod']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
