...
class grid_detalleprod_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_detalleprod_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_detalleprod_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_detalleprod_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_numproducc')
      {
          $numproducc = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_numproducc($numproducc);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_unidadmayor')
      {
          $unidadmayor = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_unidadmayor($unidadmayor);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_iddet($iddet)
   {
      ...
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and   CAST (iddet AS TEXT)  like '%" . $iddet . "%' order by iddet"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and   CAST (iddet AS VARCHAR)  like '%" . $iddet . "%' order by iddet"; 
      }
      else
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and  iddet like '%" . $iddet . "%' order by iddet"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_numproducc($numproducc)
   {
      $numproducc = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $numproducc);
      $numproducc = substr($this->Db->qstr($numproducc), 1, -1);
            $numproducc_look = substr($this->Db->qstr($numproducc), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numproducc from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and   CAST (numproducc AS TEXT)  like '%" . $numproducc . "%' order by numproducc"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numproducc from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and   CAST (numproducc AS VARCHAR)  like '%" . $numproducc . "%' order by numproducc"; 
      }
      else
      {
          $nm_comando = "select distinct numproducc from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and  numproducc like '%" . $numproducc . "%' order by numproducc"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   {
      $idpro = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idpro);
      $idpro = substr($this->Db->qstr($idpro), 1, -1);
            $idpro_look = substr($this->Db->qstr($idpro), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idpro from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and   CAST (idpro AS TEXT)  like '%" . $idpro . "%' order by idpro"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idpro from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and   CAST (idpro AS VARCHAR)  like '%" . $idpro . "%' order by idpro"; 
      }
      else
      {
          $nm_comando = "select distinct idpro from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and  idpro like '%" . $idpro . "%' order by idpro"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_unidadmayor($unidadmayor)
   {
      $unidadmayor = substr($this->Db->qstr($unidadmayor), 1, -1);
            $unidadmayor_look = substr($this->Db->qstr($unidadmayor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct unidadmayor from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and  unidadmayor like '%" . $unidadmayor . "%' order by unidadmayor"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - detalleprod</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_detalleprod/grid_detalleprod_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_detalleprod_ajax_search.js"></script>
 <script type="text/javascript" src="grid_detalleprod_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_detalleprod_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detalleprod']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detalleprod']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_numproducc_cond#NMF#' + search_get_sel_txt('SC_numproducc_cond') + '@NMF@';
  str_out += 'SC_numproducc#NMF#' + search_get_text('SC_numproducc') + '@NMF@';
  str_out += 'id_ac_numproducc#NMF#' + search_get_title('select2-id_ac_numproducc-container') + '@NMF@';
  str_out += 'SC_numproducc_input_2#NMF#' + search_get_text('SC_numproducc_input_2') + '@NMF@';
  str_out += 'SC_idpro_cond#NMF#' + search_get_sel_txt('SC_idpro_cond') + '@NMF@';
  str_out += 'SC_idpro#NMF#' + search_get_text('SC_idpro') + '@NMF@';
  str_out += 'id_ac_idpro#NMF#' + search_get_title('select2-id_ac_idpro-container') + '@NMF@';
  str_out += 'SC_idpro_input_2#NMF#' + search_get_text('SC_idpro_input_2') + '@NMF@';
  str_out += 'SC_unidadmayor_cond#NMF#' + search_get_sel_txt('SC_unidadmayor_cond') + '@NMF@';
  str_out += 'SC_unidadmayor#NMF#' + search_get_text('SC_unidadmayor') + '@NMF@';
  str_out += 'id_ac_unidadmayor#NMF#' + search_get_title('select2-id_ac_unidadmayor-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-idpro").on("focus", function() {
  }).on("blur", function() {
  ...
  $(".sc-ui-autocomp-numproducc").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_numproducc",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_numproducc").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-unidadmayor").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_unidadmayor",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_unidadmayor").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - detalleprod</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $numproducc_cond, $numproducc, $numproducc_input_2, $numproducc_autocomp,
             $idpro_cond, $idpro, $idpro_input_2, $idpro_autocomp,
             $unidadmayor_cond, $unidadmayor, $unidadmayor_autocomp,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detalleprod']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_detalleprod']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_detalleprod']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_detalleprod", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $iddet = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['iddet']; 
          $iddet_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['iddet_input_2']; 
          $iddet_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['iddet_cond']; 
          $numproducc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['numproducc']; 
          $numproducc_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['numproducc_input_2']; 
          $numproducc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['numproducc_cond']; 
          $idpro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['idpro']; 
          $idpro_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['idpro_input_2']; 
          $idpro_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['idpro_cond']; 
          $unidadmayor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['unidadmayor']; 
          $unidadmayor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['unidadmayor_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['NM_operador']; 
      } 
      if (!isset($iddet_cond) || empty($iddet_cond))
      {
         $iddet_cond = "gt";
      }
      if (!isset($numproducc_cond) || empty($numproducc_cond))
      {
         $numproducc_cond = "gt";
      }
      ...
      if (!isset($unidadmayor_cond) || empty($unidadmayor_cond))
      {
         $unidadmayor_cond = "qp";
      }
      ...
      $str_hide_numproducc = (in_array($numproducc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idpro = (in_array($idpro_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_unidadmayor = (in_array($unidadmayor_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_iddet = ('bw' == $iddet_cond) ? $display_aberto : $display_fechado;
      $str_display_numproducc = ('bw' == $numproducc_cond) ? $display_aberto : $display_fechado;
      $str_display_idpro = ('bw' == $idpro_cond) ? $display_aberto : $display_fechado;
      $str_display_unidadmayor = ('bw' == $unidadmayor_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($numproducc) || $numproducc == "")
      {
          $numproducc = "";
      }
      if (isset($numproducc) && !empty($numproducc))
      {
         $tmp_pos = strpos($numproducc, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $numproducc = substr($numproducc, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($unidadmayor) || $unidadmayor == "")
      {
          $unidadmayor = "";
      }
      if (isset($unidadmayor) && !empty($unidadmayor))
      {
         $tmp_pos = strpos($unidadmayor, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $unidadmayor = substr($unidadmayor, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and iddet = $iddet_look order by iddet"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct iddet from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and iddet = $iddet_look order by iddet"; 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-iddet" id="id_ac_iddet" name="iddet_autocomp"><?php if ('' !=  $iddet) { ?><option value="<?php echo $iddet ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
      ...
      <TD id='SC_numproducc_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['numproducc'])) ? $this->New_label['numproducc'] : "Numproducc"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_numproducc_cond" name="numproducc_cond" onChange="nm_campos_between(document.getElementById('id_vis_numproducc'), this, 'numproducc')">
       <OPTION value="gt" <?php if ("gt" == $numproducc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $numproducc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $numproducc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $numproducc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_numproducc" <?php echo $str_hide_numproducc?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['numproducc'])) ? $this->New_label['numproducc'] : "Numproducc";
 $nmgp_tab_label .= "numproducc?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $numproducc_look = substr($this->Db->qstr($numproducc), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($numproducc))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numproducc from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and numproducc = $numproducc_look order by numproducc"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numproducc from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and numproducc = $numproducc_look order by numproducc"; 
      ...
      if (isset($nmgp_def_dados[0][$numproducc]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$numproducc];
      }
      else
      {
            nmgp_Form_Num_Val($numproducc, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $numproducc;
      }
?>
<INPUT  type="text" id="SC_numproducc" name="numproducc" value="<?php echo NM_encode_input($numproducc) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-numproducc" id="id_ac_numproducc" name="numproducc_autocomp"><?php if ('' !=  $numproducc) { ?><option value="<?php echo $numproducc ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_numproducc"  <?php echo $str_display_numproducc; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_numproducc_input_2" name="numproducc_input_2" value="<?php echo NM_encode_input($numproducc_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_idpro_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idpro'])) ? $this->New_label['idpro'] : "Materia Prima"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idpro_cond" name="idpro_cond" onChange="nm_campos_between(document.getElementById('id_vis_idpro'), this, 'idpro')">
       <OPTION value="gt" <?php if ("gt" == $idpro_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idpro_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idpro_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idpro_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idpro from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and idpro = $idpro_look order by idpro"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idpro from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and idpro = $idpro_look order by idpro"; 
      ...
      {
            nmgp_Form_Num_Val($idpro, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idpro;
      }
?>
<INPUT  type="text" id="SC_idpro" name="idpro" value="<?php echo NM_encode_input($idpro) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idpro" id="id_ac_idpro" name="idpro_autocomp"><?php if ('' !=  $idpro) { ?><option value="<?php echo $idpro ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idpro"  <?php echo $str_display_idpro; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idpro_input_2" name="idpro_input_2" value="<?php echo NM_encode_input($idpro_input_2) ?>"  size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_unidadmayor_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['unidadmayor'])) ? $this->New_label['unidadmayor'] : "Unidadmayor"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_unidadmayor_cond" name="unidadmayor_cond" onChange="nm_campos_between(document.getElementById('id_vis_unidadmayor'), this, 'unidadmayor')">
       <OPTION value="qp" <?php if ("qp" == $unidadmayor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $unidadmayor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $unidadmayor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $unidadmayor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_unidadmayor" <?php echo $str_hide_unidadmayor?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['unidadmayor'])) ? $this->New_label['unidadmayor'] : "Unidadmayor";
 $nmgp_tab_label .= "unidadmayor?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $unidadmayor_look = substr($this->Db->qstr($unidadmayor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct unidadmayor from " . $this->Ini->nm_tabela . " where numproducc=" . $_SESSION['par_numero'] . " and unidadmayor = '$unidadmayor_look' order by unidadmayor"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$unidadmayor]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$unidadmayor];
      }
      else
      {
          $sAutocompValue = $unidadmayor;
      }
?>
<INPUT  type="text" id="SC_unidadmayor" name="unidadmayor" value="<?php echo NM_encode_input($unidadmayor) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-unidadmayor" id="id_ac_unidadmayor" name="unidadmayor_autocomp"><?php if ('' !=  $unidadmayor) { ?><option value="<?php echo $unidadmayor ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
?>
<?php
   if (is_file("grid_detalleprod_help.txt"))
   {
      $Arq_WebHelp = file("grid_detalleprod_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detalleprod']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_detalleprod']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.numproducc_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_numproducc'), document.F1.numproducc_cond, 'numproducc');
   document.F1.numproducc.value = "";
   document.F1.numproducc_autocomp.value = "";
   $('#select2-id_ac_numproducc-container').html('<?php echo $this->Val_init_numproducc['desc'] ?>');;
   document.F1.numproducc_input_2.value = "";
   document.F1.idpro_cond.value = 'gt';
   ...
   $('#select2-id_ac_idpro-container').html('<?php echo $this->Val_init_idpro['desc'] ?>');;
   document.F1.idpro_input_2.value = "";
   document.F1.unidadmayor_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_unidadmayor'), document.F1.unidadmayor_cond, 'unidadmayor');
   document.F1.unidadmayor.value = "";
   document.F1.unidadmayor_autocomp.value = "";
   $('#select2-id_ac_unidadmayor-container').html('<?php echo $this->Val_init_unidadmayor['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_detalleprod";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_numproducc_cond'] = 'cond';
      $tp_fields['SC_numproducc'] = 'text_aut';
      $tp_fields['id_ac_numproducc'] = 'select2_aut';
      $tp_fields['SC_numproducc_input_2'] = 'text';
      $tp_fields['SC_idpro_cond'] = 'cond';
      $tp_fields['SC_idpro'] = 'text_aut';
      $tp_fields['id_ac_idpro'] = 'select2_aut';
      $tp_fields['SC_idpro_input_2'] = 'text';
      $tp_fields['SC_unidadmayor_cond'] = 'cond';
      $tp_fields['SC_unidadmayor'] = 'text_aut';
      $tp_fields['id_ac_unidadmayor'] = 'select2_aut';
   ...
   function trata_campos()
   {
      global $iddet_cond, $iddet, $iddet_input_2, $iddet_autocomp,
             $numproducc_cond, $numproducc, $numproducc_input_2, $numproducc_autocomp,
             $idpro_cond, $idpro, $idpro_input_2, $idpro_autocomp,
             $unidadmayor_cond, $unidadmayor, $unidadmayor_autocomp, $nmgp_tab_label;
      ...
      if (!empty($numproducc_autocomp) && empty($numproducc))
      {
          $numproducc = $numproducc_autocomp;
      }
      if (!empty($idpro_autocomp) && empty($idpro))
      {
          $idpro = $idpro_autocomp;
      }
      if (!empty($unidadmayor_autocomp) && empty($unidadmayor))
      {
          $unidadmayor = $unidadmayor_autocomp;
      }
      ...
      $numproducc_cond_salva = $numproducc_cond; 
      if (!isset($numproducc_input_2) || $numproducc_input_2 == "")
      {
          $numproducc_input_2 = $numproducc;
      }
      ...
      $unidadmayor_cond_salva = $unidadmayor_cond; 
      if (!isset($unidadmayor_input_2) || $unidadmayor_input_2 == "")
      {
          $unidadmayor_input_2 = $unidadmayor;
      }
      if ($iddet_cond != "in")
      {
      ...
      if ($numproducc_cond != "in")
      {
          nm_limpa_numero($numproducc, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($numproducc_cond != "in")
      {
          nm_limpa_numero($numproducc_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idpro_cond != "in")
      {
          nm_limpa_numero($idpro, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idpro_cond != "in")
      {
          nm_limpa_numero($idpro_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['iddet'] = $iddet; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['iddet_input_2'] = $iddet_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['iddet_cond'] = $iddet_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['numproducc'] = $numproducc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['numproducc_input_2'] = $numproducc_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['numproducc_cond'] = $numproducc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['idpro'] = $idpro; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['idpro_input_2'] = $idpro_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['idpro_cond'] = $idpro_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['unidadmayor'] = $unidadmayor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['unidadmayor_cond'] = $unidadmayor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca'] = $Temp_Busca;
      }
      ...
      if ($numproducc_cond != "in" && $numproducc_cond != "bw" && !empty($numproducc) && !is_numeric($numproducc))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Numproducc";
      }
      if ($numproducc_cond == "bw" && ((!empty($numproducc) && !is_numeric($numproducc)) || (!empty($numproducc_input_2) && !is_numeric($numproducc_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Numproducc";
      }
      if ($idpro_cond != "in" && $idpro_cond != "bw" && !empty($idpro) && !is_numeric($idpro))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Materia Prima";
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['numproducc'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['numproducc'] = $cmp1;
      }
      else
      {
          $cmp1 = $numproducc;
      ...
      $Conteudo = $numproducc_input_2;
      if (strtoupper($numproducc_cond) != "II" && strtoupper($numproducc_cond) != "QP" && strtoupper($numproducc_cond) != "NP" && strtoupper($numproducc_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['numproducc_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($idpro != '') {
      $idpro_look = substr($this->Db->qstr($idpro), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      $Conteudo = $idpro_input_2;
      if (strtoupper($idpro_cond) != "II" && strtoupper($idpro_cond) != "QP" && strtoupper($idpro_cond) != "NP" && strtoupper($idpro_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idpro_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($unidadmayor != '') {
      $unidadmayor_look = substr($this->Db->qstr($unidadmayor), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['unidadmayor'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['unidadmayor'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['unidadmayor'] = $unidadmayor;
      }
      ...
      //----- $numproducc
      $this->Date_part = false;
      if (isset($numproducc) || $numproducc_cond == "nu" || $numproducc_cond == "nn" || $numproducc_cond == "ep" || $numproducc_cond == "ne")
      {
         $this->monta_condicao("numproducc", $numproducc_cond, $numproducc, $numproducc_input_2, "numproducc");
      }
      ...
      {
         $this->monta_condicao("idpro", $idpro_cond, $idpro, $idpro_input_2, "idpro");
      }

      //----- $unidadmayor
      $this->Date_part = false;
      if (isset($unidadmayor) || $unidadmayor_cond == "nu" || $unidadmayor_cond == "nn" || $unidadmayor_cond == "ep" || $unidadmayor_cond == "ne")
      {
         $this->monta_condicao("unidadmayor", $unidadmayor_cond, $unidadmayor, "", "unidadmayor");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleprod']['cond_pesq'] .= $this->NM_operador;
