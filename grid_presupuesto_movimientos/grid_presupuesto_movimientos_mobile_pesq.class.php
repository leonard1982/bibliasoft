...
class grid_presupuesto_movimientos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_presupuesto_movimientos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_presupuesto_movimientos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_presupuesto_movimientos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha";$Nm_numeric[] = "id_presupuesto_movimiento";$Nm_numeric[] = "id_presupuesto";$Nm_numeric[] = "id_detalle_presupuesto";$Nm_numeric[] = "gastado";$Nm_numeric[] = "id_banco";$Nm_numeric[] = "id_documento";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$campo_join]);
              return;
          }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         $nome_sum = "presupuesto_movimientos.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE> presupuesto_movimientos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_presupuesto_movimientos/grid_presupuesto_movimientos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_presupuesto_movimientos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_presupuesto_movimientos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_presupuesto_movimientos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_presupuesto_movimientos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_presupuesto_movimientos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_id_presupuesto_movimiento_cond#NMF#' + search_get_sel_txt('SC_id_presupuesto_movimiento_cond') + '@NMF@';
  str_out += 'SC_id_presupuesto_movimiento#NMF#' + search_get_text('SC_id_presupuesto_movimiento') + '@NMF@';
  str_out += 'SC_id_presupuesto_cond#NMF#' + search_get_sel_txt('SC_id_presupuesto_cond') + '@NMF@';
  str_out += 'SC_id_presupuesto#NMF#' + search_get_text('SC_id_presupuesto') + '@NMF@';
  str_out += 'SC_id_detalle_presupuesto_cond#NMF#' + search_get_sel_txt('SC_id_detalle_presupuesto_cond') + '@NMF@';
  str_out += 'SC_id_detalle_presupuesto#NMF#' + search_get_text('SC_id_detalle_presupuesto') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> presupuesto_movimientos</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $id_presupuesto_movimiento_cond, $id_presupuesto_movimiento,
             $id_presupuesto_cond, $id_presupuesto,
             $id_detalle_presupuesto_cond, $id_detalle_presupuesto,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_cond']; 
          $id_presupuesto_movimiento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['id_presupuesto_movimiento']; 
          $id_presupuesto_movimiento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['id_presupuesto_movimiento_cond']; 
          $id_presupuesto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['id_presupuesto']; 
          $id_presupuesto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['id_presupuesto_cond']; 
          $id_detalle_presupuesto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['id_detalle_presupuesto']; 
          $id_detalle_presupuesto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['id_detalle_presupuesto_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['NM_operador']; 
          if (strtoupper($id_presupuesto_movimiento_cond) != "II" && strtoupper($id_presupuesto_movimiento_cond) != "QP" && strtoupper($id_presupuesto_movimiento_cond) != "NP" && strtoupper($id_presupuesto_movimiento_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_presupuesto_movimiento, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($id_presupuesto_cond) != "II" && strtoupper($id_presupuesto_cond) != "QP" && strtoupper($id_presupuesto_cond) != "NP" && strtoupper($id_presupuesto_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_presupuesto, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($id_detalle_presupuesto_cond) != "II" && strtoupper($id_detalle_presupuesto_cond) != "QP" && strtoupper($id_detalle_presupuesto_cond) != "NP" && strtoupper($id_detalle_presupuesto_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_detalle_presupuesto, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($id_presupuesto_movimiento_cond) || empty($id_presupuesto_movimiento_cond))
      {
         $id_presupuesto_movimiento_cond = "gt";
      }
      if (!isset($id_presupuesto_cond) || empty($id_presupuesto_cond))
      {
         $id_presupuesto_cond = "gt";
      }
      if (!isset($id_detalle_presupuesto_cond) || empty($id_detalle_presupuesto_cond))
      {
         $id_detalle_presupuesto_cond = "gt";
      }
      ...
      $str_hide_id_presupuesto_movimiento = (in_array($id_presupuesto_movimiento_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_presupuesto = (in_array($id_presupuesto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_detalle_presupuesto = (in_array($id_detalle_presupuesto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_fecha = ('bw' == $fecha_cond) ? $display_aberto : $display_fechado;
      $str_display_id_presupuesto_movimiento = ('bw' == $id_presupuesto_movimiento_cond) ? $display_aberto : $display_fechado;
      $str_display_id_presupuesto = ('bw' == $id_presupuesto_cond) ? $display_aberto : $display_fechado;
      $str_display_id_detalle_presupuesto = ('bw' == $id_detalle_presupuesto_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($id_presupuesto_movimiento) || $id_presupuesto_movimiento == "")
      {
          $id_presupuesto_movimiento = "";
      }
      if (isset($id_presupuesto_movimiento) && !empty($id_presupuesto_movimiento))
      {
         $tmp_pos = strpos($id_presupuesto_movimiento, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_presupuesto_movimiento = substr($id_presupuesto_movimiento, 0, $tmp_pos);
         }
      }
      if (!isset($id_presupuesto) || $id_presupuesto == "")
      {
          $id_presupuesto = "";
      }
      if (isset($id_presupuesto) && !empty($id_presupuesto))
      {
         $tmp_pos = strpos($id_presupuesto, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_presupuesto = substr($id_presupuesto, 0, $tmp_pos);
         }
      }
      if (!isset($id_detalle_presupuesto) || $id_detalle_presupuesto == "")
      {
          $id_detalle_presupuesto = "";
      }
      if (isset($id_detalle_presupuesto) && !empty($id_detalle_presupuesto))
      {
         $tmp_pos = strpos($id_detalle_presupuesto, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_detalle_presupuesto = substr($id_detalle_presupuesto, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fecha_cond" name="fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha'), this, 'fecha')">
...
?>
 ...
 $nmgp_tab_label .= "id_presupuesto_movimiento?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_presupuesto_movimiento_cond" name="id_presupuesto_movimiento_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_presupuesto_movimiento'), this, 'id_presupuesto_movimiento')">
       <OPTION value="gt" <?php if ("gt" == $id_presupuesto_movimiento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_presupuesto_movimiento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_presupuesto_movimiento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_id_presupuesto_movimiento"  <?php echo $str_hide_id_presupuesto_movimiento?>><INPUT  type="text" id="SC_id_presupuesto_movimiento" name="id_presupuesto_movimiento" value="<?php echo NM_encode_input($id_presupuesto_movimiento) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
 ...
 $nmgp_tab_label .= "id_presupuesto?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_presupuesto_cond" name="id_presupuesto_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_presupuesto'), this, 'id_presupuesto')">
       <OPTION value="gt" <?php if ("gt" == $id_presupuesto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_presupuesto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_presupuesto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_id_presupuesto"  <?php echo $str_hide_id_presupuesto?>><INPUT  type="text" id="SC_id_presupuesto" name="id_presupuesto" value="<?php echo NM_encode_input($id_presupuesto) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
 ...
 $nmgp_tab_label .= "id_detalle_presupuesto?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_detalle_presupuesto_cond" name="id_detalle_presupuesto_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_detalle_presupuesto'), this, 'id_detalle_presupuesto')">
       <OPTION value="gt" <?php if ("gt" == $id_detalle_presupuesto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_detalle_presupuesto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_detalle_presupuesto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_id_detalle_presupuesto"  <?php echo $str_hide_id_detalle_presupuesto?>><INPUT  type="text" id="SC_id_detalle_presupuesto" name="id_detalle_presupuesto" value="<?php echo NM_encode_input($id_detalle_presupuesto) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_presupuesto_movimientos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_presupuesto_movimientos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_presupuesto_movimientos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_presupuesto_movimientos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_presupuesto_movimientos']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_presupuesto_movimiento_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_presupuesto_movimiento'), document.F1.id_presupuesto_movimiento_cond, 'id_presupuesto_movimiento');
   document.F1.id_presupuesto_movimiento.value = "";
   document.F1.id_presupuesto_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_presupuesto'), document.F1.id_presupuesto_cond, 'id_presupuesto');
   document.F1.id_presupuesto.value = "";
   document.F1.id_detalle_presupuesto_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_detalle_presupuesto'), document.F1.id_detalle_presupuesto_cond, 'id_detalle_presupuesto');
   document.F1.id_detalle_presupuesto.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_presupuesto_movimientos_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_presupuesto_movimientos_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_presupuesto_movimientos_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_presupuesto_movimientos_valida_mes(this)});
 }
 function sc_grid_presupuesto_movimientos_valida_dia(obj)
 {
 ...
 function sc_grid_presupuesto_movimientos_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_presupuesto_movimientos/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_presupuesto_movimiento_cond'] = 'cond';
      $tp_fields['SC_id_presupuesto_movimiento'] = 'text';
      $tp_fields['SC_id_presupuesto_cond'] = 'cond';
      $tp_fields['SC_id_presupuesto'] = 'text';
      $tp_fields['SC_id_detalle_presupuesto_cond'] = 'cond';
      $tp_fields['SC_id_detalle_presupuesto'] = 'text';
   ...
   {
      global $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano, $fecha_input_2_dia, $fecha_input_2_mes, $fecha_input_2_ano,
             $id_presupuesto_movimiento_cond, $id_presupuesto_movimiento,
             $id_presupuesto_cond, $id_presupuesto,
             $id_detalle_presupuesto_cond, $id_detalle_presupuesto, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq'] = array();
      ...
      $id_presupuesto_movimiento_cond_salva = $id_presupuesto_movimiento_cond; 
      if (!isset($id_presupuesto_movimiento_input_2) || $id_presupuesto_movimiento_input_2 == "")
      {
          $id_presupuesto_movimiento_input_2 = $id_presupuesto_movimiento;
      }
      $id_presupuesto_cond_salva = $id_presupuesto_cond; 
      if (!isset($id_presupuesto_input_2) || $id_presupuesto_input_2 == "")
      {
          $id_presupuesto_input_2 = $id_presupuesto;
      }
      $id_detalle_presupuesto_cond_salva = $id_detalle_presupuesto_cond; 
      if (!isset($id_detalle_presupuesto_input_2) || $id_detalle_presupuesto_input_2 == "")
      {
          $id_detalle_presupuesto_input_2 = $id_detalle_presupuesto;
      }
      if ($id_presupuesto_movimiento_cond != "in")
      {
          nm_limpa_numero($id_presupuesto_movimiento, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_presupuesto_cond != "in")
      {
          nm_limpa_numero($id_presupuesto, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_detalle_presupuesto_cond != "in")
      {
          nm_limpa_numero($id_detalle_presupuesto, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fecha_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fecha_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fecha_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fecha_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fecha_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fecha_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['cmp'] = "fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['opc'] = $fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq']['fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['id_presupuesto_movimiento'] = $id_presupuesto_movimiento; 
      if (is_array($id_presupuesto_movimiento) && !empty($id_presupuesto_movimiento))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['val'][0] = $id_presupuesto_movimiento;
      }
      elseif ($id_presupuesto_movimiento_cond_salva == "nu" || $id_presupuesto_movimiento_cond_salva == "nn" || $id_presupuesto_movimiento_cond_salva == "ep" || $id_presupuesto_movimiento_cond_salva == "ne" || !empty($id_presupuesto_movimiento))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['val'][0][0] = $id_presupuesto_movimiento;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['id_presupuesto_movimiento_cond'] = $id_presupuesto_movimiento_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['cmp'] = "id_presupuesto_movimiento"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['opc'] = $id_presupuesto_movimiento_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq']['id_presupuesto_movimiento'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['id_presupuesto'] = $id_presupuesto; 
      if (is_array($id_presupuesto) && !empty($id_presupuesto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['val'][0] = $id_presupuesto;
      }
      elseif ($id_presupuesto_cond_salva == "nu" || $id_presupuesto_cond_salva == "nn" || $id_presupuesto_cond_salva == "ep" || $id_presupuesto_cond_salva == "ne" || !empty($id_presupuesto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['val'][0][0] = $id_presupuesto;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['id_presupuesto_cond'] = $id_presupuesto_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['cmp'] = "id_presupuesto"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['opc'] = $id_presupuesto_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq']['id_presupuesto'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['id_detalle_presupuesto'] = $id_detalle_presupuesto; 
      if (is_array($id_detalle_presupuesto) && !empty($id_detalle_presupuesto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['val'][0] = $id_detalle_presupuesto;
      }
      elseif ($id_detalle_presupuesto_cond_salva == "nu" || $id_detalle_presupuesto_cond_salva == "nn" || $id_detalle_presupuesto_cond_salva == "ep" || $id_detalle_presupuesto_cond_salva == "ne" || !empty($id_detalle_presupuesto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['val'][0][0] = $id_detalle_presupuesto;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['id_detalle_presupuesto_cond'] = $id_detalle_presupuesto_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['cmp'] = "id_detalle_presupuesto"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid]['opc'] = $id_detalle_presupuesto_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq']['id_detalle_presupuesto'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $id_presupuesto_movimiento;
      if (strtoupper($id_presupuesto_movimiento_cond) != "II" && strtoupper($id_presupuesto_movimiento_cond) != "QP" && strtoupper($id_presupuesto_movimiento_cond) != "NP" && strtoupper($id_presupuesto_movimiento_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_presupuesto_movimiento'] = $Conteudo;
      $Conteudo = $id_presupuesto;
      if (strtoupper($id_presupuesto_cond) != "II" && strtoupper($id_presupuesto_cond) != "QP" && strtoupper($id_presupuesto_cond) != "NP" && strtoupper($id_presupuesto_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['id_presupuesto'] = $Conteudo;
      $Conteudo = $id_detalle_presupuesto;
      if (strtoupper($id_detalle_presupuesto_cond) != "II" && strtoupper($id_detalle_presupuesto_cond) != "QP" && strtoupper($id_detalle_presupuesto_cond) != "NP" && strtoupper($id_detalle_presupuesto_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['id_detalle_presupuesto'] = $Conteudo;
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']['fecha_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq']['fecha']['label'] = $nmgp_tab_label['fecha'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq']['fecha']['descr'] = $nmgp_tab_label['fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['grid_pesq']['fecha']['hint']  = $nmgp_tab_label['fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $id_presupuesto_movimiento
      $this->Date_part = false;
      if (isset($id_presupuesto_movimiento) || $id_presupuesto_movimiento_cond == "nu" || $id_presupuesto_movimiento_cond == "nn" || $id_presupuesto_movimiento_cond == "ep" || $id_presupuesto_movimiento_cond == "ne")
      {
         $this->monta_condicao("id_presupuesto_movimiento", $id_presupuesto_movimiento_cond, $id_presupuesto_movimiento, "", "id_presupuesto_movimiento");
      }

      //----- $id_presupuesto
      $this->Date_part = false;
      if (isset($id_presupuesto) || $id_presupuesto_cond == "nu" || $id_presupuesto_cond == "nn" || $id_presupuesto_cond == "ep" || $id_presupuesto_cond == "ne")
      {
         $this->monta_condicao("id_presupuesto", $id_presupuesto_cond, $id_presupuesto, "", "id_presupuesto");
      }

      //----- $id_detalle_presupuesto
      $this->Date_part = false;
      if (isset($id_detalle_presupuesto) || $id_detalle_presupuesto_cond == "nu" || $id_detalle_presupuesto_cond == "nn" || $id_detalle_presupuesto_cond == "ep" || $id_detalle_presupuesto_cond == "ne")
      {
         $this->monta_condicao("id_detalle_presupuesto", $id_detalle_presupuesto_cond, $id_detalle_presupuesto, "", "id_detalle_presupuesto");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_dyn_search'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq_filtro'] = "";
      }
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuesto_movimientos']['where_pesq'];
