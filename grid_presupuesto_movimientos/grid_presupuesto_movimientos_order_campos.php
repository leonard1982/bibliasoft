...
<?php
   ...
   $Ord_Cmp = new grid_presupuesto_movimientos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_presupuesto_movimientos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_presupuesto_movimiento'] = "on";
   $tab_def_campos['id_presupuesto_movimiento'] = "id_presupuesto_movimiento";
   $tab_labels["id_presupuesto_movimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['labels']["id_presupuesto_movimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['labels']["id_presupuesto_movimiento"] : "Id Presupuesto Movimiento";
   $tab_ger_campos['id_presupuesto'] = "on";
   $tab_def_campos['id_presupuesto'] = "id_presupuesto";
   $tab_labels["id_presupuesto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['labels']["id_presupuesto"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['labels']["id_presupuesto"] : "Id Presupuesto";
   $tab_ger_campos['id_detalle_presupuesto'] = "on";
   $tab_def_campos['id_detalle_presupuesto'] = "id_detalle_presupuesto";
   $tab_labels["id_detalle_presupuesto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['labels']["id_detalle_presupuesto"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['labels']["id_detalle_presupuesto"] : "Id Detalle Presupuesto";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['gastado'] = "on";
   $tab_def_campos['gastado'] = "gastado";
   $tab_labels["gastado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['labels']["gastado"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['labels']["gastado"] : "Gastado";
   $tab_ger_campos['id_banco'] = "on";
   $tab_def_campos['id_banco'] = "id_banco";
   $tab_labels["id_banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['labels']["id_banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['labels']["id_banco"] : "Id Banco";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> presupuesto_movimientos</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_presupuesto_movimientos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_presupuesto_movimientos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
