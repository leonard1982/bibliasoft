...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> presupuesto_movimientos</TITLE>
...
?>
      ...
      <TD id='SC_id_presupuesto_movimiento_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_presupuesto_movimiento'])) ? $this->New_label['id_presupuesto_movimiento'] : "Id Presupuesto Movimiento"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_presupuesto_movimiento_cond" name="id_presupuesto_movimiento_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_presupuesto_movimiento'), this, 'id_presupuesto_movimiento')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_presupuesto_movimiento" <?php echo $str_hide_id_presupuesto_movimiento?> valign="top">
...
<INPUT  type="text" id="SC_id_presupuesto_movimiento" name="id_presupuesto_movimiento" value="<?php echo NM_encode_input($id_presupuesto_movimiento) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_id_presupuesto_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_presupuesto'])) ? $this->New_label['id_presupuesto'] : "Id Presupuesto"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_presupuesto_cond" name="id_presupuesto_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_presupuesto'), this, 'id_presupuesto')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_presupuesto" <?php echo $str_hide_id_presupuesto?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
?>
<INPUT  type="text" id="SC_id_presupuesto" name="id_presupuesto" value="<?php echo NM_encode_input($id_presupuesto) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_id_detalle_presupuesto_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_detalle_presupuesto'])) ? $this->New_label['id_detalle_presupuesto'] : "Id Detalle Presupuesto"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_detalle_presupuesto_cond" name="id_detalle_presupuesto_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_detalle_presupuesto'), this, 'id_detalle_presupuesto')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_detalle_presupuesto" <?php echo $str_hide_id_detalle_presupuesto?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
