...
<?php
   ...
   $Ord_Cmp = new grid_recibos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_recibos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_recibos']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_recibos']['labels']["fecha"] : "Fecha";
   ...
   {
       $tab_def_campos['num'] = "concat(prefijo,'/',numero)";
   }
   $tab_labels["num"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_recibos']['labels']["num"])) ? $_SESSION['sc_session'][$sc_init]['grid_recibos']['labels']["num"] : "Numero";
   $tab_ger_campos['id_cliente'] = "on";
   $tab_def_campos['id_cliente'] = "id_cliente";
   $tab_labels["id_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_recibos']['labels']["id_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_recibos']['labels']["id_cliente"] : "Cliente";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_recibos']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_recibos']['labels']["observaciones"] : "Observaciones";
   $tab_ger_campos['asentado'] = "on";
   $tab_def_campos['asentado'] = "asentado";
   $tab_labels["asentado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_recibos']['labels']["asentado"])) ? $_SESSION['sc_session'][$sc_init]['grid_recibos']['labels']["asentado"] : "Asentado";
   $tab_ger_campos['monto_a_pagar'] = "on";
   $tab_def_campos['monto_a_pagar'] = "monto_a_pagar";
   $tab_labels["monto_a_pagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_recibos']['labels']["monto_a_pagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_recibos']['labels']["monto_a_pagar"] : "Neto";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_recibos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_recibos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_recibos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_recibos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_recibos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
