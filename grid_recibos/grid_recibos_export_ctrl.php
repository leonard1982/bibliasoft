<?php
@session_start() ;
$_SESSION['scriptcase']['grid_recibos']['sc_process_barr'] = true;
require_once('../grid_recibos/index.php');
unset($_SESSION['scriptcase']['grid_recibos']['sc_process_barr']);
$ExportCtrl = new grid_recibos_export_control;
$ExportCtrl->Export_barr();

class grid_recibos_export_control
{
