  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detalle_notasDC" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detalle_notasDC_form();
	}
...
?>
  ...
  // ---------- Validate numfac_
  function do_ajax_form_detalle_notasDC_validate_numfac_(iNumLinha)
  {
    var nomeCampo_numfac_ = "numfac_" + iNumLinha;
    var var_numfac_ = scAjaxGetFieldText(nomeCampo_numfac_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_numfac_(var_numfac_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_numfac__cb);
  } // do_ajax_form_detalle_notasDC_validate_numfac_

  function do_ajax_form_detalle_notasDC_validate_numfac__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "numfac_" + iLineNumber;
    }
    else
    {
      sFieldValid = "numfac_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "numfac_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "numfac_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_numfac__cb

  // ---------- Validate idpro_
  function do_ajax_form_detalle_notasDC_validate_idpro_(iNumLinha)
  {
  } // do_ajax_form_detalle_notasDC_validate_idpro_

  function do_ajax_form_detalle_notasDC_validate_idpro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idpro_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idpro_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idpro_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idpro_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_idpro__cb

  // ---------- Validate desc_
  function do_ajax_form_detalle_notasDC_validate_desc_(iNumLinha)
  {
    var nomeCampo_desc_ = "desc_" + iNumLinha;
    var var_desc_ = scAjaxGetFieldText(nomeCampo_desc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_desc_(var_desc_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_desc__cb);
  } // do_ajax_form_detalle_notasDC_validate_desc_

  function do_ajax_form_detalle_notasDC_validate_desc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "desc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "desc_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_desc__cb

  // ---------- Validate obs_
  function do_ajax_form_detalle_notasDC_validate_obs_(iNumLinha)
  {
    var nomeCampo_obs_ = "obs_" + iNumLinha;
    var var_obs_ = scAjaxGetFieldText(nomeCampo_obs_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_obs_(var_obs_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_obs__cb);
  } // do_ajax_form_detalle_notasDC_validate_obs_

  function do_ajax_form_detalle_notasDC_validate_obs__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_obs__cb

  // ---------- Validate existencia_
  function do_ajax_form_detalle_notasDC_validate_existencia_(iNumLinha)
  {
    var nomeCampo_existencia_ = "existencia_" + iNumLinha;
    var var_existencia_ = scAjaxGetFieldText(nomeCampo_existencia_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_existencia_(var_existencia_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_existencia__cb);
  } // do_ajax_form_detalle_notasDC_validate_existencia_

  function do_ajax_form_detalle_notasDC_validate_existencia__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "existencia_" + iLineNumber;
    }
    else
    {
      sFieldValid = "existencia_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "existencia_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "existencia_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_existencia__cb

  // ---------- Validate colores_
  function do_ajax_form_detalle_notasDC_validate_colores_(iNumLinha)
  {
    var nomeCampo_colores_ = "colores_" + iNumLinha;
    var var_colores_ = scAjaxGetFieldSelect(nomeCampo_colores_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_colores_(var_colores_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_colores__cb);
  } // do_ajax_form_detalle_notasDC_validate_colores_

  function do_ajax_form_detalle_notasDC_validate_colores__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_colores__cb

  // ---------- Validate elcolor_
  function do_ajax_form_detalle_notasDC_validate_elcolor_(iNumLinha)
  {
    var nomeCampo_elcolor_ = "elcolor_" + iNumLinha;
    var var_elcolor_ = scAjaxGetFieldSelect(nomeCampo_elcolor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_elcolor_(var_elcolor_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_elcolor__cb);
  } // do_ajax_form_detalle_notasDC_validate_elcolor_

  function do_ajax_form_detalle_notasDC_validate_elcolor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "elcolor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "elcolor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "elcolor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "elcolor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_elcolor__cb

  // ---------- Validate tallas_
  function do_ajax_form_detalle_notasDC_validate_tallas_(iNumLinha)
  {
    var nomeCampo_tallas_ = "tallas_" + iNumLinha;
    var var_tallas_ = scAjaxGetFieldSelect(nomeCampo_tallas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_tallas_(var_tallas_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_tallas__cb);
  } // do_ajax_form_detalle_notasDC_validate_tallas_

  function do_ajax_form_detalle_notasDC_validate_tallas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_tallas__cb

  // ---------- Validate latalla_
  function do_ajax_form_detalle_notasDC_validate_latalla_(iNumLinha)
  {
    var nomeCampo_latalla_ = "latalla_" + iNumLinha;
    var var_latalla_ = scAjaxGetFieldSelect(nomeCampo_latalla_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_latalla_(var_latalla_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_latalla__cb);
  } // do_ajax_form_detalle_notasDC_validate_latalla_

  function do_ajax_form_detalle_notasDC_validate_latalla__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "latalla_" + iLineNumber;
    }
    else
    {
      sFieldValid = "latalla_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "latalla_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "latalla_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_latalla__cb

  // ---------- Validate sabor_
  function do_ajax_form_detalle_notasDC_validate_sabor_(iNumLinha)
  {
    var nomeCampo_sabor_ = "sabor_" + iNumLinha;
    var var_sabor_ = scAjaxGetFieldSelect(nomeCampo_sabor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_sabor_(var_sabor_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_sabor__cb);
  } // do_ajax_form_detalle_notasDC_validate_sabor_

  function do_ajax_form_detalle_notasDC_validate_sabor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_sabor__cb

  // ---------- Validate elsabor_
  function do_ajax_form_detalle_notasDC_validate_elsabor_(iNumLinha)
  {
    var nomeCampo_elsabor_ = "elsabor_" + iNumLinha;
    var var_elsabor_ = scAjaxGetFieldSelect(nomeCampo_elsabor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_elsabor_(var_elsabor_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_elsabor__cb);
  } // do_ajax_form_detalle_notasDC_validate_elsabor_

  function do_ajax_form_detalle_notasDC_validate_elsabor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "elsabor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "elsabor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "elsabor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "elsabor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_elsabor__cb

  // ---------- Validate idbod_
  function do_ajax_form_detalle_notasDC_validate_idbod_(iNumLinha)
  {
    var nomeCampo_idbod_ = "idbod_" + iNumLinha;
    var var_idbod_ = scAjaxGetFieldSelect(nomeCampo_idbod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_idbod_(var_idbod_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_idbod__cb);
  } // do_ajax_form_detalle_notasDC_validate_idbod_

  function do_ajax_form_detalle_notasDC_validate_idbod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_idbod__cb

  // ---------- Validate unidadmayor_
  function do_ajax_form_detalle_notasDC_validate_unidadmayor_(iNumLinha)
  {
    var nomeCampo_unidadmayor_ = "unidadmayor_" + iNumLinha;
    var var_unidadmayor_ = scAjaxGetFieldHidden(nomeCampo_unidadmayor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_unidadmayor_(var_unidadmayor_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_unidadmayor__cb);
  } // do_ajax_form_detalle_notasDC_validate_unidadmayor_

  function do_ajax_form_detalle_notasDC_validate_unidadmayor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_unidadmayor__cb

  // ---------- Validate stockubica_
  function do_ajax_form_detalle_notasDC_validate_stockubica_(iNumLinha)
  {
    var nomeCampo_stockubica_ = "stockubica_" + iNumLinha;
    var var_stockubica_ = scAjaxGetFieldHidden(nomeCampo_stockubica_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_stockubica_(var_stockubica_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_stockubica__cb);
  } // do_ajax_form_detalle_notasDC_validate_stockubica_

  function do_ajax_form_detalle_notasDC_validate_stockubica__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_stockubica__cb

  // ---------- Validate unidad_
  function do_ajax_form_detalle_notasDC_validate_unidad_(iNumLinha)
  {
    var nomeCampo_unidad_ = "unidad_" + iNumLinha;
    var var_unidad_ = scAjaxGetFieldHidden(nomeCampo_unidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_unidad_(var_unidad_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_unidad__cb);
  } // do_ajax_form_detalle_notasDC_validate_unidad_

  function do_ajax_form_detalle_notasDC_validate_unidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_unidad__cb

  // ---------- Validate cantidad_
  function do_ajax_form_detalle_notasDC_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_cantidad__cb);
  } // do_ajax_form_detalle_notasDC_validate_cantidad_

  function do_ajax_form_detalle_notasDC_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_cantidad__cb

  // ---------- Validate valorunit_
  function do_ajax_form_detalle_notasDC_validate_valorunit_(iNumLinha)
  {
    var nomeCampo_valorunit_ = "valorunit_" + iNumLinha;
    var var_valorunit_ = scAjaxGetFieldText(nomeCampo_valorunit_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_valorunit_(var_valorunit_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_valorunit__cb);
  } // do_ajax_form_detalle_notasDC_validate_valorunit_

  function do_ajax_form_detalle_notasDC_validate_valorunit__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_valorunit__cb

  // ---------- Validate valorpar_
  function do_ajax_form_detalle_notasDC_validate_valorpar_(iNumLinha)
  {
    var nomeCampo_valorpar_ = "valorpar_" + iNumLinha;
    var var_valorpar_ = scAjaxGetFieldHidden(nomeCampo_valorpar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_valorpar_(var_valorpar_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_valorpar__cb);
  } // do_ajax_form_detalle_notasDC_validate_valorpar_

  function do_ajax_form_detalle_notasDC_validate_valorpar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "valorpar_" + iLineNumber;
    }
    else
    {
      sFieldValid = "valorpar_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "valorpar_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "valorpar_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_valorpar__cb

  // ---------- Validate descuento_
  function do_ajax_form_detalle_notasDC_validate_descuento_(iNumLinha)
  {
    var nomeCampo_descuento_ = "descuento_" + iNumLinha;
    var var_descuento_ = scAjaxGetFieldHidden(nomeCampo_descuento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_descuento_(var_descuento_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_descuento__cb);
  } // do_ajax_form_detalle_notasDC_validate_descuento_

  function do_ajax_form_detalle_notasDC_validate_descuento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_descuento__cb

  // ---------- Validate adicional_
  function do_ajax_form_detalle_notasDC_validate_adicional_(iNumLinha)
  {
    var nomeCampo_adicional_ = "adicional_" + iNumLinha;
    var var_adicional_ = scAjaxGetFieldText(nomeCampo_adicional_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_adicional_(var_adicional_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_adicional__cb);
  } // do_ajax_form_detalle_notasDC_validate_adicional_

  function do_ajax_form_detalle_notasDC_validate_adicional__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_adicional__cb

  // ---------- Validate adicional1_
  function do_ajax_form_detalle_notasDC_validate_adicional1_(iNumLinha)
  {
    var nomeCampo_adicional1_ = "adicional1_" + iNumLinha;
    var var_adicional1_ = scAjaxGetFieldText(nomeCampo_adicional1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_adicional1_(var_adicional1_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_adicional1__cb);
  } // do_ajax_form_detalle_notasDC_validate_adicional1_

  function do_ajax_form_detalle_notasDC_validate_adicional1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_adicional1__cb

  // ---------- Validate factor_
  function do_ajax_form_detalle_notasDC_validate_factor_(iNumLinha)
  {
    var nomeCampo_factor_ = "factor_" + iNumLinha;
    var var_factor_ = scAjaxGetFieldText(nomeCampo_factor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_factor_(var_factor_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_factor__cb);
  } // do_ajax_form_detalle_notasDC_validate_factor_

  function do_ajax_form_detalle_notasDC_validate_factor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_factor__cb

  // ---------- Validate iva_
  function do_ajax_form_detalle_notasDC_validate_iva_(iNumLinha)
  {
    var nomeCampo_iva_ = "iva_" + iNumLinha;
    var var_iva_ = scAjaxGetFieldHidden(nomeCampo_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_iva_(var_iva_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_iva__cb);
  } // do_ajax_form_detalle_notasDC_validate_iva_

  function do_ajax_form_detalle_notasDC_validate_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_iva__cb

  // ---------- Validate costop_
  function do_ajax_form_detalle_notasDC_validate_costop_(iNumLinha)
  {
    var nomeCampo_costop_ = "costop_" + iNumLinha;
    var var_costop_ = scAjaxGetFieldText(nomeCampo_costop_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_costop_(var_costop_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_costop__cb);
  } // do_ajax_form_detalle_notasDC_validate_costop_

  function do_ajax_form_detalle_notasDC_validate_costop__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_costop__cb

  // ---------- Validate tipo_tran_
  function do_ajax_form_detalle_notasDC_validate_tipo_tran_(iNumLinha)
  {
    var nomeCampo_tipo_tran_ = "tipo_tran_" + iNumLinha;
    var var_tipo_tran_ = scAjaxGetFieldSelect(nomeCampo_tipo_tran_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_tipo_tran_(var_tipo_tran_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_tipo_tran__cb);
  } // do_ajax_form_detalle_notasDC_validate_tipo_tran_

  function do_ajax_form_detalle_notasDC_validate_tipo_tran__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tipo_tran_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipo_tran_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tipo_tran_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tipo_tran_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_tipo_tran__cb

  // ---------- Validate vencimiento_
  function do_ajax_form_detalle_notasDC_validate_vencimiento_(iNumLinha)
  {
    var nomeCampo_vencimiento_ = "vencimiento_" + iNumLinha;
    var var_vencimiento_ = scAjaxGetFieldHidden(nomeCampo_vencimiento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_vencimiento_(var_vencimiento_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_vencimiento__cb);
  } // do_ajax_form_detalle_notasDC_validate_vencimiento_

  function do_ajax_form_detalle_notasDC_validate_vencimiento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "vencimiento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "vencimiento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "vencimiento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "vencimiento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_vencimiento__cb

  // ---------- Validate lote_
  function do_ajax_form_detalle_notasDC_validate_lote_(iNumLinha)
  {
    var nomeCampo_lote_ = "lote_" + iNumLinha;
    var var_lote_ = scAjaxGetFieldHidden(nomeCampo_lote_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_lote_(var_lote_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_lote__cb);
  } // do_ajax_form_detalle_notasDC_validate_lote_

  function do_ajax_form_detalle_notasDC_validate_lote__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "lote_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "lote_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_lote__cb

  // ---------- Validate serial_codbarra_
  function do_ajax_form_detalle_notasDC_validate_serial_codbarra_(iNumLinha)
  {
    var nomeCampo_serial_codbarra_ = "serial_codbarra_" + iNumLinha;
    var var_serial_codbarra_ = scAjaxGetFieldHidden(nomeCampo_serial_codbarra_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_serial_codbarra_(var_serial_codbarra_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_serial_codbarra__cb);
  } // do_ajax_form_detalle_notasDC_validate_serial_codbarra_

  function do_ajax_form_detalle_notasDC_validate_serial_codbarra__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "serial_codbarra_" + iLineNumber;
    }
    else
    {
      sFieldValid = "serial_codbarra_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "serial_codbarra_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "serial_codbarra_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_serial_codbarra__cb

  // ---------- Validate iddet_
  function do_ajax_form_detalle_notasDC_validate_iddet_(iNumLinha)
  {
    var nomeCampo_iddet_ = "iddet_" + iNumLinha;
    var var_iddet_ = scAjaxGetFieldHidden(nomeCampo_iddet_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_validate_iddet_(var_iddet_, iNumLinha, var_script_case_init, do_ajax_form_detalle_notasDC_validate_iddet__cb);
  } // do_ajax_form_detalle_notasDC_validate_iddet_

  function do_ajax_form_detalle_notasDC_validate_iddet__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "iddet_" + iLineNumber;
    }
    else
    {
      sFieldValid = "iddet_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "iddet_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "iddet_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_validate_iddet__cb

  // ---------- Refresh idpro_
  function do_ajax_form_detalle_notasDC_refresh_idpro_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_detalle_notasDC_refresh_idpro_(var_idpro_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_detalle_notasDC_refresh_idpro__cb);
  } // do_ajax_form_detalle_notasDC_refresh_idpro_

  function do_ajax_form_detalle_notasDC_refresh_idpro__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_notasDC_refresh_idpro__cb

  // ---------- Event onblur cantidad_
  function do_ajax_form_detalle_notasDC_event_cantidad__onblur(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("idpro_" + iSeqForm);
    ...
    var var_unidadmayor_ = scAjaxGetFieldHidden("unidadmayor_" + iSeqForm);
    var var_factor_ = scAjaxGetFieldText("factor_" + iSeqForm);
    var var_unidad_ = scAjaxGetFieldHidden("unidad_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detalle_notasDC_event_cantidad__onblur(var_idpro_, var_colores_, var_tallas_, var_sabor_, var_valorunit_, var_cantidad_, var_stockubica_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_idbod_, var_unidadmayor_, var_factor_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalle_notasDC_event_cantidad__onblur_cb);
  } // do_ajax_form_detalle_notasDC_event_cantidad__onblur

  function do_ajax_form_detalle_notasDC_event_cantidad__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalle_notasDC_event_cantidad__onblur_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_event_cantidad__onblur_cb
  function do_ajax_form_detalle_notasDC_event_cantidad__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalle_notasDC_event_cantidad__onblur_cb_after_alert

  // ---------- Event onfocus cantidad_
  function do_ajax_form_detalle_notasDC_event_cantidad__onfocus(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn();
    x_ajax_form_detalle_notasDC_event_cantidad__onfocus(var_cantidad_, var_idpro_, var_idbod_, var_colores_, var_tallas_, var_sabor_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalle_notasDC_event_cantidad__onfocus_cb);
  } // do_ajax_form_detalle_notasDC_event_cantidad__onfocus

  function do_ajax_form_detalle_notasDC_event_cantidad__onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalle_notasDC_event_cantidad__onfocus_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_event_cantidad__onfocus_cb
  function do_ajax_form_detalle_notasDC_event_cantidad__onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalle_notasDC_event_cantidad__onfocus_cb_after_alert

  // ---------- Event onchange colores_
  function do_ajax_form_detalle_notasDC_event_colores__onchange(iSeqForm)
  {
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detalle_notasDC_event_colores__onchange(var_idpro_, var_idbod_, var_colores_, var_tallas_, var_sabor_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalle_notasDC_event_colores__onchange_cb);
  } // do_ajax_form_detalle_notasDC_event_colores__onchange

  function do_ajax_form_detalle_notasDC_event_colores__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalle_notasDC_event_colores__onchange_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_event_colores__onchange_cb
  function do_ajax_form_detalle_notasDC_event_colores__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalle_notasDC_event_colores__onchange_cb_after_alert

  // ---------- Event onblur idbod_
  function do_ajax_form_detalle_notasDC_event_idbod__onblur(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    var var_colores_ = scAjaxGetFieldSelect("colores_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detalle_notasDC_event_idbod__onblur(var_idpro_, var_idbod_, var_colores_, var_tallas_, var_sabor_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalle_notasDC_event_idbod__onblur_cb);
  } // do_ajax_form_detalle_notasDC_event_idbod__onblur

  function do_ajax_form_detalle_notasDC_event_idbod__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalle_notasDC_event_idbod__onblur_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_event_idbod__onblur_cb
  function do_ajax_form_detalle_notasDC_event_idbod__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalle_notasDC_event_idbod__onblur_cb_after_alert

  // ---------- Event onchange idbod_
  function do_ajax_form_detalle_notasDC_event_idbod__onchange(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    var var_colores_ = scAjaxGetFieldSelect("colores_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detalle_notasDC_event_idbod__onchange(var_idpro_, var_idbod_, var_colores_, var_tallas_, var_sabor_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalle_notasDC_event_idbod__onchange_cb);
  } // do_ajax_form_detalle_notasDC_event_idbod__onchange

  function do_ajax_form_detalle_notasDC_event_idbod__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalle_notasDC_event_idbod__onchange_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_event_idbod__onchange_cb
  function do_ajax_form_detalle_notasDC_event_idbod__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalle_notasDC_event_idbod__onchange_cb_after_alert

  // ---------- Event onchange idpro_
  function do_ajax_form_detalle_notasDC_event_idpro__onchange(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_numfac_ = scAjaxGetFieldText("numfac_" + iSeqForm);
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    var var_unidadmayor_ = scAjaxGetFieldHidden("unidadmayor_" + iSeqForm);
    ...
    var var_tallas_ = scAjaxGetFieldSelect("tallas_" + iSeqForm);
    var var_sabor_ = scAjaxGetFieldSelect("sabor_" + iSeqForm);
    var var_iddet_ = scAjaxGetFieldHidden("iddet_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detalle_notasDC_event_idpro__onchange(var_idpro_, var_numfac_, var_valorunit_, var_unidadmayor_, var_costop_, var_factor_, var_adicional_, var_adicional1_, var_descuento_, var_valorpar_, var_iva_, var_cantidad_, var_colores_, var_tallas_, var_sabor_, var_iddet_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalle_notasDC_event_idpro__onchange_cb);
  } // do_ajax_form_detalle_notasDC_event_idpro__onchange

  function do_ajax_form_detalle_notasDC_event_idpro__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalle_notasDC_event_idpro__onchange_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_event_idpro__onchange_cb
  function do_ajax_form_detalle_notasDC_event_idpro__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_detalle_notasDC_refresh_idpro_(iLineNumber);
    scAjaxRedir();
  } // do_ajax_form_detalle_notasDC_event_idpro__onchange_cb_after_alert

  // ---------- Event onchange sabor_
  function do_ajax_form_detalle_notasDC_event_sabor__onchange(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    var var_colores_ = scAjaxGetFieldSelect("colores_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detalle_notasDC_event_sabor__onchange(var_idpro_, var_idbod_, var_colores_, var_tallas_, var_sabor_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalle_notasDC_event_sabor__onchange_cb);
  } // do_ajax_form_detalle_notasDC_event_sabor__onchange

  function do_ajax_form_detalle_notasDC_event_sabor__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalle_notasDC_event_sabor__onchange_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_event_sabor__onchange_cb
  function do_ajax_form_detalle_notasDC_event_sabor__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalle_notasDC_event_sabor__onchange_cb_after_alert

  // ---------- Event onchange tallas_
  function do_ajax_form_detalle_notasDC_event_tallas__onchange(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    var var_colores_ = scAjaxGetFieldSelect("colores_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detalle_notasDC_event_tallas__onchange(var_idpro_, var_idbod_, var_colores_, var_tallas_, var_sabor_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalle_notasDC_event_tallas__onchange_cb);
  } // do_ajax_form_detalle_notasDC_event_tallas__onchange

  function do_ajax_form_detalle_notasDC_event_tallas__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalle_notasDC_event_tallas__onchange_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_event_tallas__onchange_cb
  function do_ajax_form_detalle_notasDC_event_tallas__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalle_notasDC_event_tallas__onchange_cb_after_alert

  // ---------- Event onchange unidadmayor_
  function do_ajax_form_detalle_notasDC_event_unidadmayor__onchange(iSeqForm)
  {
    var var_unidadmayor_ = scAjaxGetFieldHidden("unidadmayor_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detalle_notasDC_event_unidadmayor__onchange(var_unidadmayor_, var_idpro_, var_valorunit_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_cantidad_, var_idbod_, var_colores_, var_tallas_, var_sabor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalle_notasDC_event_unidadmayor__onchange_cb);
  } // do_ajax_form_detalle_notasDC_event_unidadmayor__onchange

  function do_ajax_form_detalle_notasDC_event_unidadmayor__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalle_notasDC_event_unidadmayor__onchange_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_event_unidadmayor__onchange_cb
  function do_ajax_form_detalle_notasDC_event_unidadmayor__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalle_notasDC_event_unidadmayor__onchange_cb_after_alert

  // ---------- Event onblur valorunit_
  function do_ajax_form_detalle_notasDC_event_valorunit__onblur(iSeqForm)
  {
    var var_iddet_ = scAjaxGetFieldHidden("iddet_" + iSeqForm);
    var var_costop_ = scAjaxGetFieldText("costop_" + iSeqForm);
    var var_factor_ = scAjaxGetFieldText("factor_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detalle_notasDC_event_valorunit__onblur(var_iddet_, var_costop_, var_factor_, var_valorunit_, var_idpro_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_cantidad_, var_idbod_, var_colores_, var_tallas_, var_sabor_, var_unidadmayor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalle_notasDC_event_valorunit__onblur_cb);
  } // do_ajax_form_detalle_notasDC_event_valorunit__onblur

  function do_ajax_form_detalle_notasDC_event_valorunit__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalle_notasDC_event_valorunit__onblur_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_event_valorunit__onblur_cb
  function do_ajax_form_detalle_notasDC_event_valorunit__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalle_notasDC_event_valorunit__onblur_cb_after_alert

  // ---------- Event onfocus valorunit_
  function do_ajax_form_detalle_notasDC_event_valorunit__onfocus(iSeqForm)
  {
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn();
    x_ajax_form_detalle_notasDC_event_valorunit__onfocus(var_valorunit_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalle_notasDC_event_valorunit__onfocus_cb);
  } // do_ajax_form_detalle_notasDC_event_valorunit__onfocus

  function do_ajax_form_detalle_notasDC_event_valorunit__onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalle_notasDC_event_valorunit__onfocus_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_event_valorunit__onfocus_cb
  function do_ajax_form_detalle_notasDC_event_valorunit__onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalle_notasDC_event_valorunit__onfocus_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detalle_notasDC_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detalle_notasDC_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detalle_notasDC_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detalle_notasDC_add_new_line_cb);
  } // do_ajax_form_detalle_notasDC_add_new_line

  function do_ajax_form_detalle_notasDC_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("elcolor_=disabled;latalla_=disabled;elsabor_=disabled", "I", iAjaxNewLine, 'novo');
  } // do_ajax_form_detalle_notasDC_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detalle_notasDC_backup_line(iNumLinha)
  {
    var var_iddet_ = scAjaxGetFieldHidden("iddet_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_notasDC_backup_line(var_iddet_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detalle_notasDC_backup_line_cb);
  } // do_ajax_form_detalle_notasDC_backup_line

  function do_ajax_form_detalle_notasDC_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detalle_notasDC_backup_line_cb

  function do_ajax_form_detalle_notasDC_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detalle_notasDC_cancel_insert

  function do_ajax_form_detalle_notasDC_cancel_update(iSeqVert)
  {
    do_ajax_form_detalle_notasDC_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detalle_notasDC_cancel_update

  function do_ajax_form_detalle_notasDC_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detalle_notasDC_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detalle_notasDC_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detalle_notasDC_table_refresh(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detalle_notasDC_table_refresh_cb);
  } //  do_ajax_form_detalle_notasDC_table_refresh

  function do_ajax_form_detalle_notasDC_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.iddet_.value = scAjaxGetKeyValue("iddet_");
    ...
    scAjaxAlert(do_ajax_form_detalle_notasDC_table_refresh_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_table_refresh_cb
  function do_ajax_form_detalle_notasDC_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_detalle_notasDC_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detalle_notasDC_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detalle_notasDC_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_numfac_ = scAjaxGetFieldText("numfac_" + iNumLinha);
    ...
    var var_elcolor_ = scAjaxGetFieldSelect("elcolor_" + iNumLinha);
    var var_tallas_ = scAjaxGetFieldSelect("tallas_" + iNumLinha);
    var var_latalla_ = scAjaxGetFieldSelect("latalla_" + iNumLinha);
    var var_sabor_ = scAjaxGetFieldSelect("sabor_" + iNumLinha);
    var var_elsabor_ = scAjaxGetFieldSelect("elsabor_" + iNumLinha);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iNumLinha);
    var var_unidadmayor_ = scAjaxGetFieldHidden("unidadmayor_" + iNumLinha);
    ...
    var var_tipo_tran_ = scAjaxGetFieldSelect("tipo_tran_" + iNumLinha);
    var var_vencimiento_ = scAjaxGetFieldHidden("vencimiento_" + iNumLinha);
    var var_lote_ = scAjaxGetFieldHidden("lote_" + iNumLinha);
    var var_serial_codbarra_ = scAjaxGetFieldHidden("serial_codbarra_" + iNumLinha);
    var var_iddet_ = scAjaxGetFieldHidden("iddet_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_detalle_notasDC_submit_form(var_numfac_, var_idpro_, var_desc_, var_obs_, var_existencia_, var_colores_, var_elcolor_, var_tallas_, var_latalla_, var_sabor_, var_elsabor_, var_idbod_, var_unidadmayor_, var_stockubica_, var_unidad_, var_cantidad_, var_valorunit_, var_valorpar_, var_descuento_, var_adicional_, var_adicional1_, var_factor_, var_iva_, var_costop_, var_tipo_tran_, var_vencimiento_, var_lote_, var_serial_codbarra_, var_iddet_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detalle_notasDC_submit_form_cb);
  } // do_ajax_form_detalle_notasDC_submit_form

  function do_ajax_form_detalle_notasDC_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("numfac_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idpro_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("desc_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("obs_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("existencia_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("colores_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("elcolor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tallas_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("latalla_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sabor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("elsabor_" + sc_num_ult_line);
      ...
      scAjaxHideErrorDisplay("tipo_tran_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("vencimiento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("lote_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("serial_codbarra_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalle_notasDC_submit_form_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_submit_form_cb
  function do_ajax_form_detalle_notasDC_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detalle_notasDC_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detalle_notasDC_navigate_form()
  {
    perform_ajax_form_detalle_notasDC_navigate_form();
  }

  function perform_ajax_form_detalle_notasDC_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("numfac_" + iNavForm);
      scAjaxHideErrorDisplay("idpro_" + iNavForm);
      scAjaxHideErrorDisplay("desc_" + iNavForm);
      scAjaxHideErrorDisplay("obs_" + iNavForm);
      scAjaxHideErrorDisplay("existencia_" + iNavForm);
      scAjaxHideErrorDisplay("colores_" + iNavForm);
      scAjaxHideErrorDisplay("elcolor_" + iNavForm);
      scAjaxHideErrorDisplay("tallas_" + iNavForm);
      scAjaxHideErrorDisplay("latalla_" + iNavForm);
      scAjaxHideErrorDisplay("sabor_" + iNavForm);
      scAjaxHideErrorDisplay("elsabor_" + iNavForm);
      ...
      scAjaxHideErrorDisplay("tipo_tran_" + iNavForm);
      scAjaxHideErrorDisplay("vencimiento_" + iNavForm);
      scAjaxHideErrorDisplay("lote_" + iNavForm);
      scAjaxHideErrorDisplay("serial_codbarra_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detalle_notasDC_navigate_form(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detalle_notasDC_navigate_form_cb);
  } // do_ajax_form_detalle_notasDC_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detalle_notasDC_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.iddet_.value = scAjaxGetKeyValue("iddet_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detalle_notasDC_navigate_form_cb_after_alert);
  } // do_ajax_form_detalle_notasDC_navigate_form_cb
  function do_ajax_form_detalle_notasDC_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_detalle_notasDC_navigate_form_cb_after_alert
  function sc_hide_form_detalle_notasDC_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "numfac_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idpro_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "desc_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "obs_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "existencia_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "colores_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "elcolor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tallas_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "latalla_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sabor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "elsabor_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valorunit_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tipo_tran_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "vencimiento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lote_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "serial_codbarra_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "iddet_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["numfac_" + iNumLinha] = {"label": "Numfac<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["desc_" + iNumLinha] = {"label": "Desc. Art.<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["obs_" + iNumLinha] = {"label": "Comp. Descr.<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["existencia_" + iNumLinha] = {"label": "Existencia detallada<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["elcolor_" + iNumLinha] = {"label": "Colores<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["latalla_" + iNumLinha] = {"label": "Tallas<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["elsabor_" + iNumLinha] = {"label": "Sabores<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idbod_" + iNumLinha] = {"label": "Ubicación<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["stockubica_" + iNumLinha] = {"label": "Stock Ubic.<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["descuento_" + iNumLinha] = {"label": "Desc.<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["tipo_tran_" + iNumLinha] = {"label": "Motivo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["vencimiento_" + iNumLinha] = {"label": "Fecha Vencimiento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["lote_" + iNumLinha] = {"label": "Lote<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["serial_codbarra_" + iNumLinha] = {"label": "Serial/Codbarras<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["numfac_"][iNumLinha] = "numfac_" + iNumLinha;
    ajax_field_mult["idpro_"][iNumLinha] = "idpro_" + iNumLinha;
    ajax_field_mult["desc_"][iNumLinha] = "desc_" + iNumLinha;
    ajax_field_mult["obs_"][iNumLinha] = "obs_" + iNumLinha;
    ajax_field_mult["existencia_"][iNumLinha] = "existencia_" + iNumLinha;
    ajax_field_mult["colores_"][iNumLinha] = "colores_" + iNumLinha;
    ajax_field_mult["elcolor_"][iNumLinha] = "elcolor_" + iNumLinha;
    ajax_field_mult["tallas_"][iNumLinha] = "tallas_" + iNumLinha;
    ajax_field_mult["latalla_"][iNumLinha] = "latalla_" + iNumLinha;
    ajax_field_mult["sabor_"][iNumLinha] = "sabor_" + iNumLinha;
    ajax_field_mult["elsabor_"][iNumLinha] = "elsabor_" + iNumLinha;
    ...
    ajax_field_mult["tipo_tran_"][iNumLinha] = "tipo_tran_" + iNumLinha;
    ajax_field_mult["vencimiento_"][iNumLinha] = "vencimiento_" + iNumLinha;
    ajax_field_mult["lote_"][iNumLinha] = "lote_" + iNumLinha;
    ajax_field_mult["serial_codbarra_"][iNumLinha] = "serial_codbarra_" + iNumLinha;
    ...
    ajax_field_id["desc_" + iNumLinha] = new Array("hidden_field_label_desc_", "hidden_field_data_desc_" + iNumLinha);
    ajax_field_id["existencia_" + iNumLinha] = new Array("hidden_field_label_existencia_", "hidden_field_data_existencia_" + iNumLinha);
    ajax_field_id["idbod_" + iNumLinha] = new Array("hidden_field_label_idbod_", "hidden_field_data_idbod_" + iNumLinha);
    ajax_field_id["unidad_" + iNumLinha] = new Array("hidden_field_label_unidad_", "hidden_field_data_unidad_" + iNumLinha);
    ...
    ajax_field_id["tipo_tran_" + iNumLinha] = new Array("hidden_field_label_tipo_tran_", "hidden_field_data_tipo_tran_" + iNumLinha);
    ajax_error_count["numfac_" + iNumLinha] = "off";
    ajax_error_count["idpro_" + iNumLinha] = "off";
    ajax_error_count["desc_" + iNumLinha] = "off";
    ajax_error_count["obs_" + iNumLinha] = "off";
    ajax_error_count["existencia_" + iNumLinha] = "off";
    ajax_error_count["colores_" + iNumLinha] = "off";
    ajax_error_count["elcolor_" + iNumLinha] = "off";
    ajax_error_count["tallas_" + iNumLinha] = "off";
    ajax_error_count["latalla_" + iNumLinha] = "off";
    ajax_error_count["sabor_" + iNumLinha] = "off";
    ajax_error_count["elsabor_" + iNumLinha] = "off";
    ...
    ajax_error_count["tipo_tran_" + iNumLinha] = "off";
    ajax_error_count["vencimiento_" + iNumLinha] = "off";
    ajax_error_count["lote_" + iNumLinha] = "off";
    ajax_error_count["serial_codbarra_" + iNumLinha] = "off";
    ajax_error_count["iddet_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["numfac_" + iNumLinha] = "off";
    ajax_read_only["idpro_" + iNumLinha] = "off";
    ajax_read_only["desc_" + iNumLinha] = "off";
    ajax_read_only["obs_" + iNumLinha] = "off";
    ajax_read_only["existencia_" + iNumLinha] = "off";
    ajax_read_only["colores_" + iNumLinha] = "off";
    ajax_read_only["elcolor_" + iNumLinha] = "off";
    ajax_read_only["tallas_" + iNumLinha] = "off";
    ajax_read_only["latalla_" + iNumLinha] = "off";
    ajax_read_only["sabor_" + iNumLinha] = "off";
    ajax_read_only["elsabor_" + iNumLinha] = "off";
    ...
    ajax_read_only["tipo_tran_" + iNumLinha] = "off";
    ajax_read_only["vencimiento_" + iNumLinha] = "off";
    ajax_read_only["lote_" + iNumLinha] = "off";
    ajax_read_only["serial_codbarra_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["numfac_" + iNumLinha] = "on";
    ajax_read_only["idpro_" + iNumLinha] = "on";
    ajax_read_only["desc_" + iNumLinha] = "on";
    ajax_read_only["obs_" + iNumLinha] = "on";
    ajax_read_only["existencia_" + iNumLinha] = "on";
    ajax_read_only["colores_" + iNumLinha] = "on";
    ajax_read_only["elcolor_" + iNumLinha] = "on";
    ajax_read_only["tallas_" + iNumLinha] = "on";
    ajax_read_only["latalla_" + iNumLinha] = "on";
    ajax_read_only["sabor_" + iNumLinha] = "on";
    ajax_read_only["elsabor_" + iNumLinha] = "on";
    ...
    ajax_read_only["tipo_tran_" + iNumLinha] = "on";
    ajax_read_only["vencimiento_" + iNumLinha] = "on";
    ajax_read_only["lote_" + iNumLinha] = "on";
    ajax_read_only["serial_codbarra_" + iNumLinha] = "on";
    ajax_read_only["iddet_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["numfac_" + iNumLinha] = null;
    ajax_error_list["idpro_" + iNumLinha] = null;
    ajax_error_list["desc_" + iNumLinha] = null;
    ajax_error_list["obs_" + iNumLinha] = null;
    ajax_error_list["existencia_" + iNumLinha] = null;
    ajax_error_list["colores_" + iNumLinha] = null;
    ajax_error_list["elcolor_" + iNumLinha] = null;
    ajax_error_list["tallas_" + iNumLinha] = null;
    ajax_error_list["latalla_" + iNumLinha] = null;
    ajax_error_list["sabor_" + iNumLinha] = null;
    ajax_error_list["elsabor_" + iNumLinha] = null;
    ...
    ajax_error_list["tipo_tran_" + iNumLinha] = null;
    ajax_error_list["vencimiento_" + iNumLinha] = null;
    ajax_error_list["lote_" + iNumLinha] = null;
    ajax_error_list["serial_codbarra_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    ...
    "iva_": new Array(),
    "costop_": new Array(),
    "tipo_tran_": new Array(),
    "vencimiento_": new Array(),
    "lote_": new Array(),
    "serial_codbarra_": new Array(),
    "iddet_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["numfac_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["numfac_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["numfac_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["numfac_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["numfac_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["desc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["desc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["desc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["desc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["desc_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["existencia_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["existencia_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["existencia_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["existencia_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["existencia_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["elcolor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["elcolor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["elcolor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["elcolor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["elcolor_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["latalla_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["latalla_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["latalla_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["latalla_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["latalla_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["elsabor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["elsabor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["elsabor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["elsabor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["elsabor_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["idbod_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idbod_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["valorunit_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["valorunit_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["valorunit_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["valorunit_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["valorunit_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["valorpar_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["valorpar_" + iNumLinha]["onblur"] = new Array();
      ...
      ajax_error_list["tipo_tran_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipo_tran_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipo_tran_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipo_tran_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipo_tran_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["vencimiento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["vencimiento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["vencimiento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["vencimiento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["vencimiento_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["lote_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["lote_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["lote_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["lote_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["lote_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["serial_codbarra_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["serial_codbarra_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["serial_codbarra_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["serial_codbarra_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["serial_codbarra_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["iddet_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["iddet_" + iNumLinha]["onblur"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['numfac_'])) ? $this->nmgp_cmp_readonly['numfac_'] : 'off';
?>
    scAjaxFieldRead("numfac_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['desc_'])) ? $this->nmgp_cmp_readonly['desc_'] : 'off';
?>
    scAjaxFieldRead("desc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['existencia_'])) ? $this->nmgp_cmp_readonly['existencia_'] : 'off';
?>
    scAjaxFieldRead("existencia_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['elcolor_'])) ? $this->nmgp_cmp_readonly['elcolor_'] : 'off';
?>
    scAjaxFieldRead("elcolor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['latalla_'])) ? $this->nmgp_cmp_readonly['latalla_'] : 'off';
?>
    scAjaxFieldRead("latalla_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['elsabor_'])) ? $this->nmgp_cmp_readonly['elsabor_'] : 'off';
?>
    scAjaxFieldRead("elsabor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idbod_'])) ? $this->nmgp_cmp_readonly['idbod_'] : 'off';
?>
    scAjaxFieldRead("idbod_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['valorunit_'])) ? $this->nmgp_cmp_readonly['valorunit_'] : 'off';
?>
    scAjaxFieldRead("valorunit_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['valorpar_'])) ? $this->nmgp_cmp_readonly['valorpar_'] : 'off';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipo_tran_'])) ? $this->nmgp_cmp_readonly['tipo_tran_'] : 'off';
?>
    scAjaxFieldRead("tipo_tran_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['vencimiento_'])) ? $this->nmgp_cmp_readonly['vencimiento_'] : 'off';
?>
    scAjaxFieldRead("vencimiento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['lote_'])) ? $this->nmgp_cmp_readonly['lote_'] : 'off';
?>
    scAjaxFieldRead("lote_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['serial_codbarra_'])) ? $this->nmgp_cmp_readonly['serial_codbarra_'] : 'off';
?>
    scAjaxFieldRead("serial_codbarra_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['iddet_'])) ? $this->nmgp_cmp_readonly['iddet_'] : 'on';
?>
  ...
  {
    scAjaxFieldRead("numfac_" + iSeq, "on");
    scAjaxFieldRead("idpro_" + iSeq, "on");
    scAjaxFieldRead("desc_" + iSeq, "on");
    scAjaxFieldRead("obs_" + iSeq, "on");
    scAjaxFieldRead("existencia_" + iSeq, "on");
    scAjaxFieldRead("colores_" + iSeq, "on");
    scAjaxFieldRead("elcolor_" + iSeq, "on");
    scAjaxFieldRead("tallas_" + iSeq, "on");
    scAjaxFieldRead("latalla_" + iSeq, "on");
    scAjaxFieldRead("sabor_" + iSeq, "on");
    scAjaxFieldRead("elsabor_" + iSeq, "on");
    ...
    scAjaxFieldRead("tipo_tran_" + iSeq, "on");
    scAjaxFieldRead("vencimiento_" + iSeq, "on");
    scAjaxFieldRead("lote_" + iSeq, "on");
    scAjaxFieldRead("serial_codbarra_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["numfac_" + iRow] || "on" == ajax_error_count["idpro_" + iRow] || "on" == ajax_error_count["desc_" + iRow] || "on" == ajax_error_count["obs_" + iRow] || "on" == ajax_error_count["existencia_" + iRow] || "on" == ajax_error_count["colores_" + iRow] || "on" == ajax_error_count["elcolor_" + iRow] || "on" == ajax_error_count["tallas_" + iRow] || "on" == ajax_error_count["latalla_" + iRow] || "on" == ajax_error_count["sabor_" + iRow] || "on" == ajax_error_count["elsabor_" + iRow] || "on" == ajax_error_count["idbod_" + iRow] || "on" == ajax_error_count["unidadmayor_" + iRow] || "on" == ajax_error_count["stockubica_" + iRow] || "on" == ajax_error_count["unidad_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["valorunit_" + iRow] || "on" == ajax_error_count["valorpar_" + iRow] || "on" == ajax_error_count["descuento_" + iRow] || "on" == ajax_error_count["adicional_" + iRow] || "on" == ajax_error_count["adicional1_" + iRow] || "on" == ajax_error_count["factor_" + iRow] || "on" == ajax_error_count["iva_" + iRow] || "on" == ajax_error_count["costop_" + iRow] || "on" == ajax_error_count["tipo_tran_" + iRow] || "on" == ajax_error_count["vencimiento_" + iRow] || "on" == ajax_error_count["lote_" + iRow] || "on" == ajax_error_count["serial_codbarra_" + iRow] || "on" == ajax_error_count["iddet_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_numfac_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idpro_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_desc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_obs_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_existencia_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_colores_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_elcolor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tallas_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_latalla_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sabor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_elsabor_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_tipo_tran_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_vencimiento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_lote_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_serial_codbarra_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["numfac_" + iRow] && "off" == ajax_error_count["idpro_" + iRow] && "off" == ajax_error_count["desc_" + iRow] && "off" == ajax_error_count["obs_" + iRow] && "off" == ajax_error_count["existencia_" + iRow] && "off" == ajax_error_count["colores_" + iRow] && "off" == ajax_error_count["elcolor_" + iRow] && "off" == ajax_error_count["tallas_" + iRow] && "off" == ajax_error_count["latalla_" + iRow] && "off" == ajax_error_count["sabor_" + iRow] && "off" == ajax_error_count["elsabor_" + iRow] && "off" == ajax_error_count["idbod_" + iRow] && "off" == ajax_error_count["unidadmayor_" + iRow] && "off" == ajax_error_count["stockubica_" + iRow] && "off" == ajax_error_count["unidad_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["valorunit_" + iRow] && "off" == ajax_error_count["valorpar_" + iRow] && "off" == ajax_error_count["descuento_" + iRow] && "off" == ajax_error_count["adicional_" + iRow] && "off" == ajax_error_count["adicional1_" + iRow] && "off" == ajax_error_count["factor_" + iRow] && "off" == ajax_error_count["iva_" + iRow] && "off" == ajax_error_count["costop_" + iRow] && "off" == ajax_error_count["tipo_tran_" + iRow] && "off" == ajax_error_count["vencimiento_" + iRow] && "off" == ajax_error_count["lote_" + iRow] && "off" == ajax_error_count["serial_codbarra_" + iRow] && "off" == ajax_error_count["iddet_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["numfac_" + iRow] = "off";
        ajax_error_count["idpro_" + iRow] = "off";
        ajax_error_count["desc_" + iRow] = "off";
        ajax_error_count["obs_" + iRow] = "off";
        ajax_error_count["existencia_" + iRow] = "off";
        ajax_error_count["colores_" + iRow] = "off";
        ajax_error_count["elcolor_" + iRow] = "off";
        ajax_error_count["tallas_" + iRow] = "off";
        ajax_error_count["latalla_" + iRow] = "off";
        ajax_error_count["sabor_" + iRow] = "off";
        ajax_error_count["elsabor_" + iRow] = "off";
        ...
        ajax_error_count["tipo_tran_" + iRow] = "off";
        ajax_error_count["vencimiento_" + iRow] = "off";
        ajax_error_count["lote_" + iRow] = "off";
        ajax_error_count["serial_codbarra_" + iRow] = "off";
      ...
      $("#hidden_field_data_numfac_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idpro_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_desc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_obs_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_existencia_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_colores_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_elcolor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tallas_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_latalla_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sabor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_elsabor_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_tipo_tran_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_vencimiento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_lote_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_serial_codbarra_" + iRow).removeClass("scFormErrorLine");
