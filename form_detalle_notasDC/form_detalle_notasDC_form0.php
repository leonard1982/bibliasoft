<?php
class form_detalle_notasDC_form extends form_detalle_notasDC_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_detalle_notasDC/form_detalle_notasDC_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_detalle_notasDC_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_detalle_notasDC_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-idpro_", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "idpro_" != sId ? sId.substr(6) : "";
   sc_form_detalle_notasDC_idpro__onfocus("id_sc_field_" + sId, sRow);
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_detalle_notasDC_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_detalle_notasDC'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_detalle_notasDC'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "R")
{
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['balterarsel']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['balterarsel']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['balterarsel']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['balterarsel']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['balterarsel'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['bexcluirsel']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['bexcluirsel']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['bexcluirsel']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['bexcluirsel']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['bexcluirsel'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['empty_filter'] = true;
       }
       echo "<tr><td>";
  }
?>
...
<?php
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['tipo_tran_']) && $this->nmgp_cmp_hidden['tipo_tran_'] == 'off') { $sStyleHidden_tipo_tran_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['tipo_tran_']) || $this->nmgp_cmp_hidden['tipo_tran_'] == 'on') {
      if (!isset($this->nm_new_label['tipo_tran_'])) {
          $this->nm_new_label['tipo_tran_'] = "Motivo"; } ?>

    <TD class="scFormLabelOddMult css_tipo_tran__label" id="hidden_field_label_tipo_tran_" style="<?php echo $sStyleHidden_tipo_tran_; ?>" > <?php echo $this->nm_new_label['tipo_tran_'] ?> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['vencimiento_']) && $this->nmgp_cmp_hidden['vencimiento_'] == 'off') { $sStyleHidden_vencimiento_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['vencimiento_'])) {
          $this->nm_new_label['vencimiento_'] = "Fecha Vencimiento"; } ?>
<?php
...
?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['serial_codbarra_']) && $this->nmgp_cmp_hidden['serial_codbarra_'] == 'off') { $sStyleHidden_serial_codbarra_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['serial_codbarra_'])) {
          $this->nm_new_label['serial_codbarra_'] = "Serial/Codbarras"; } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_detalle_notasDC);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_detalle_notasDC = $this->form_vert_form_detalle_notasDC;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_detalle_notasDC))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_detalle_notasDC as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->remision_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['remision_'];
       $this->devuelto_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['devuelto_'];
       $this->numdevo_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['numdevo_'];
       $this->iddeta_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['iddeta_'];
       $this->descr_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['descr_'];
       $this->fecha_fab_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['fecha_fab_'];
       $this->tipo_doc_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['tipo_doc_'];
       $this->id_nota_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['id_nota_'];
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           ...
           $this->nmgp_cmp_readonly['tipo_tran_'] = true;
       ...
       elseif ($Line_Add)
       {
           ...
           if (!isset($this->nmgp_cmp_readonly['tipo_tran_']) || $this->nmgp_cmp_readonly['tipo_tran_'] != "on") {$this->nmgp_cmp_readonly['tipo_tran_'] = false;}
        ...
        $this->numfac_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['numfac_']; 
       ...
       $this->idpro_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['idpro_']; 
       $idpro_ = $this->idpro_; 
       $sStyleHidden_idpro_ = '';
       ...
       $this->desc_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['desc_']; 
       $desc_ = $this->desc_; 
       $sStyleHidden_desc_ = '';
       ...
       $this->obs_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['obs_']; 
       $obs_ = $this->obs_; 
       ...
       $this->existencia_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['existencia_']; 
       ...
       $this->colores_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['colores_']; 
       ...
       $this->elcolor_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['elcolor_']; 
       ...
       $this->tallas_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['tallas_']; 
       ...
       $this->latalla_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['latalla_']; 
       ...
       $this->sabor_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['sabor_']; 
       $sabor_ = $this->sabor_; 
       if (!isset($this->nmgp_cmp_hidden['sabor_']))
       {
           $this->nmgp_cmp_hidden['sabor_'] = 'off';
       ...
       $this->elsabor_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['elsabor_']; 
       ...
       $this->idbod_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['idbod_']; 
       $idbod_ = $this->idbod_; 
       $sStyleHidden_idbod_ = '';
       ...
       $this->unidadmayor_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['unidadmayor_']; 
       ...
       $this->stockubica_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['stockubica_']; 
       ...
       $this->unidad_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['unidad_']; 
       ...
       $this->cantidad_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['cantidad_']; 
       ...
       $this->valorunit_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['valorunit_']; 
       ...
       $this->valorpar_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['valorpar_']; 
       ...
       $this->descuento_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['descuento_']; 
       ...
       $this->adicional_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['adicional_']; 
       ...
       $this->adicional1_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['adicional1_']; 
       ...
       $this->factor_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['factor_']; 
       ...
       $this->iva_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['iva_']; 
       $iva_ = $this->iva_; 
       $sStyleHidden_iva_ = '';
       ...
       $this->costop_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['costop_']; 
       ...
       $this->tipo_tran_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['tipo_tran_']; 
       $tipo_tran_ = $this->tipo_tran_; 
       $sStyleHidden_tipo_tran_ = '';
       if (isset($sCheckRead_tipo_tran_))
       {
           unset($sCheckRead_tipo_tran_);
       }
       if (isset($this->nmgp_cmp_readonly['tipo_tran_']))
       {
           $sCheckRead_tipo_tran_ = $this->nmgp_cmp_readonly['tipo_tran_'];
       }
       if (isset($this->nmgp_cmp_hidden['tipo_tran_']) && $this->nmgp_cmp_hidden['tipo_tran_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['tipo_tran_']);
           $sStyleHidden_tipo_tran_ = 'display: none;';
       }
       $bTestReadOnly_tipo_tran_ = true;
       $sStyleReadLab_tipo_tran_ = 'display: none;';
       $sStyleReadInp_tipo_tran_ = '';
       if (isset($this->nmgp_cmp_readonly['tipo_tran_']) && $this->nmgp_cmp_readonly['tipo_tran_'] == 'on')
       {
           $bTestReadOnly_tipo_tran_ = false;
           unset($this->nmgp_cmp_readonly['tipo_tran_']);
           $sStyleReadLab_tipo_tran_ = '';
           $sStyleReadInp_tipo_tran_ = 'display: none;';
       }
       $this->vencimiento_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['vencimiento_']; 
       ...
       $this->lote_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['lote_']; 
       $lote_ = $this->lote_; 
       if (!isset($this->nmgp_cmp_hidden['lote_']))
       {
           $this->nmgp_cmp_hidden['lote_'] = 'off';
       ...
       $this->serial_codbarra_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['serial_codbarra_']; 
       ...
       $this->iddet_ = $this->form_vert_form_detalle_notasDC[$sc_seq_vert]['iddet_']; 
       $iddet_ = $this->iddet_; 
       if (!isset($this->nmgp_cmp_hidden['iddet_']))
       {
           $this->nmgp_cmp_hidden['iddet_'] = 'off';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_detalle_notasDC_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_detalle_notasDC_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_detalle_notasDC_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_detalle_notasDC_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_detalle_notasDC_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_detalle_notasDC_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
$aLookup = array();
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_idpro_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_idpro_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_idpro_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_idpro_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_idpro_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
?>
<span id="id_imghtml_desc_<?php echo $sc_seq_vert; ?>"><a href="javascript:nm_gp_submit('<?php echo $this->Ini->link_form_detalleventa_observ_edit . "', '$this->nm_location', 'SC_glo_par_par_numfacventa*scinpar_numfacventa*scoutdetalle*scin" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dados_form'][$sc_seq_vert]['iddet_'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout', '', '_self', '0', '0', 'form_detalleventa_observ')\"><font color=\"" . $this->Ini->cor_link_dados . "\">" . $desc_ ; ?></font></a></span>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_colores_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_colores_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_colores_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_colores_'] = array(); 
}
if ($this->idpro_ != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_colores_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_colores_'][] = '0'; 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_elcolor_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_elcolor_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_elcolor_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_elcolor_'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_elcolor_'][] = $rs->fields[0];
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_tallas_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_tallas_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_tallas_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_tallas_'] = array(); 
}
if ($this->idpro_ != "")
{ 
   $this->nm_clear_val("idpro_");
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_tallas_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_tallas_'][] = '0'; 
   echo "  <option value=\"0\">" . str_replace("<", "&lt;"," ") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_latalla_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_latalla_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_latalla_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_latalla_'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_latalla_'][] = $rs->fields[0];
              $nmgp_def_dados .= $rs->fields[0] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $rs->MoveNext() ; 
       } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_sabor_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_sabor_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_sabor_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_sabor_'] = array(); 
}
if ($this->idpro_ != "")
{ 
   $this->nm_clear_val("idpro_");
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_sabor_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_sabor_'][] = '0'; 
   echo "  <option value=\"0\">" . str_replace("<", "&lt;"," ") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_elsabor_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_elsabor_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_elsabor_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_elsabor_'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_elsabor_'][] = $rs->fields[0];
              $nmgp_def_dados .= $rs->fields[0] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $rs->MoveNext() ; 
       } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_idbod_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_idbod_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_idbod_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_idbod_'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_idbod_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_unidadmayor__line" id="hidden_field_data_unidadmayor_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_unidadmayor_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_unidadmayor__line" style="padding: 0px"><input type="hidden" name="unidadmayor_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($unidadmayor_); ?>"><span id="id_ajax_label_unidadmayor_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($unidadmayor_); ?></span>
...
<span style="display: inline-block"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "nm_mostra_mens('cantidad_')", "nm_mostra_mens('cantidad_')", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_cantidad_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_cantidad_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<span style="display: inline-block"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "nm_mostra_mens('valorunit_')", "nm_mostra_mens('valorunit_')", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_valorunit_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_valorunit_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<span id="id_read_on_costop_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-costop_<?php echo $sc_seq_vert ?> css_costop__line" style="<?php echo $sStyleReadLab_costop_; ?>"><?php echo $this->form_format_readonly("costop_", $this->form_encode_input($this->costop_)); ?></span><span id="id_read_off_costop_<?php echo $sc_seq_vert ?>" class="css_read_off_costop_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_costop_; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=12"; } ?> alt="{datatype: 'decimal', maxLength: 12, precision: 0, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['costop_']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['costop_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['costop_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['costop_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: true, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['tipo_tran_']) && $this->nmgp_cmp_hidden['tipo_tran_'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="tipo_tran_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($this->tipo_tran_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_tipo_tran__line" id="hidden_field_data_tipo_tran_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_tipo_tran_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_tipo_tran__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_tipo_tran_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["tipo_tran_"]) &&  $this->nmgp_cmp_readonly["tipo_tran_"] == "on") { 

$tipo_tran__look = "";
 if ($this->tipo_tran_ == "VENTA") { $tipo_tran__look .= "Seleccione" ;} 
 if ($this->tipo_tran_ == "DESC") { $tipo_tran__look .= "Descontar" ;} 
 if ($this->tipo_tran_ == "DEV") { $tipo_tran__look .= "Devolver" ;} 
 if ($this->tipo_tran_ == "INC") { $tipo_tran__look .= "Incremento" ;} 
 if (empty($tipo_tran__look)) { $tipo_tran__look = $this->tipo_tran_; }
?>
<input type="hidden" name="tipo_tran_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($tipo_tran_) . "\">" . $tipo_tran__look . ""; ?>
<?php } else { ?>
<?php
...
$tipo_tran__look = "";
 ...
 if (empty($tipo_tran__look)) { $tipo_tran__look = $this->tipo_tran_; }
?>
<span id="id_read_on_tipo_tran_<?php echo $sc_seq_vert ; ?>" class="css_tipo_tran__line"  style="<?php echo $sStyleReadLab_tipo_tran_; ?>"><?php echo $this->form_format_readonly("tipo_tran_", $this->form_encode_input($tipo_tran__look)); ?></span><span id="id_read_off_tipo_tran_<?php echo $sc_seq_vert ; ?>" class="css_read_off_tipo_tran_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap; <?php echo $sStyleReadInp_tipo_tran_; ?>">
 <span id="idAjaxSelect_tipo_tran_<?php echo $sc_seq_vert ?>" class="<?php echo $this->classes_100perc_fields['span_select'] ?>"><select class="sc-js-input scFormObjectOddMult css_tipo_tran__obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_tipo_tran_<?php echo $sc_seq_vert ?>" name="tipo_tran_<?php echo $sc_seq_vert ?>" size="1" alt="{type: 'select', enterTab: true}">
 <option  value="VENTA" <?php  if ($this->tipo_tran_ == "VENTA") { echo " selected" ;} ?><?php  if (empty($this->tipo_tran_)) { echo " selected" ;} ?>>Seleccione</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_tipo_tran_'][] = 'VENTA'; ?>
 <option  value="DESC" <?php  if ($this->tipo_tran_ == "DESC") { echo " selected" ;} ?>>Descontar</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_tipo_tran_'][] = 'DESC'; ?>
 <option  value="DEV" <?php  if ($this->tipo_tran_ == "DEV") { echo " selected" ;} ?>>Devolver</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_tipo_tran_'][] = 'DEV'; ?>
 <option  value="INC" <?php  if ($this->tipo_tran_ == "INC") { echo " selected" ;} ?>>Incremento</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['Lookup_tipo_tran_'][] = 'INC'; ?>
 </select></span>
</span><?php  }?>
<span style="display: inline-block"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "nm_mostra_mens('tipo_tran_')", "nm_mostra_mens('tipo_tran_')", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_tipo_tran_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_tipo_tran_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_vencimiento__line" id="hidden_field_data_vencimiento_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_vencimiento_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_vencimiento__line" style="vertical-align: top;padding: 0px"><input type="hidden" name="vencimiento_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($vencimiento_); ?>"><span id="id_ajax_label_vencimiento_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($vencimiento_); ?></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_lote__line" id="hidden_field_data_lote_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_lote_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_lote__line" style="vertical-align: top;padding: 0px"><input type="hidden" name="lote_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($lote_); ?>"><span id="id_ajax_label_lote_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($lote_); ?></span>
...
<?php   
       ...
       if (isset($sCheckRead_tipo_tran_))
       {
           $this->nmgp_cmp_readonly['tipo_tran_'] = $sCheckRead_tipo_tran_;
       }
       if ('display: none;' == $sStyleHidden_tipo_tran_)
       {
           $this->nmgp_cmp_hidden['tipo_tran_'] = 'off';
       }
       if (isset($sCheckRead_vencimiento_))
       {
   ...
   { 
       ...
       $this->form_vert_form_detalle_notasDC = $guarda_form_vert_form_detalle_notasDC;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['run_modal'])
{
?>
...
?>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['masterValue'] as $cmp_master => $val_master)
        {
?>
    dbParentFrame[0].contentWindow.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
        }
        unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['masterValue']);
?>
}
<?php
    }
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_detalle_notasDC");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_detalle_notasDC");
 parent.scAjaxDetailHeight("form_detalle_notasDC", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['sc_modal'])
{
?>
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			...
			do_ajax_form_detalle_notasDC_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_notasDC']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
