...
class grid_bancos_280422_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   function gera_texto_tag()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['pivot_group_by'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['pivot_tabular'];
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['arr_export']['data'];
