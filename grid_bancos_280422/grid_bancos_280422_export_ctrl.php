<?php
@session_start() ;
$_SESSION['scriptcase']['grid_bancos_280422']['sc_process_barr'] = true;
require_once('../grid_bancos_280422/index.php');
unset($_SESSION['scriptcase']['grid_bancos_280422']['sc_process_barr']);
$ExportCtrl = new grid_bancos_280422_export_control;
$ExportCtrl->Export_barr();

class grid_bancos_280422_export_control
{
