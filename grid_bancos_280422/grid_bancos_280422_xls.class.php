...
class grid_bancos_280422_xls
{
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_bancos_280422/grid_bancos_280422_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_bancos_280422_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_bancos_280422.zip";
          $this->Arquivo   .= "_grid_bancos_280422" . $this->Xls_tp;
          $this->Tit_doc    = "grid_bancos_280422" . $this->Xls_tp;
          $this->Tit_zip    = "grid_bancos_280422.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_codigo_banco()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->codigo_banco, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->codigo_banco, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- descripcion
   ...
   function NM_export_comportamiento()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->comportamiento, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->comportamiento, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- cajero
   function NM_export_cajero()
   {
         ...
         if (is_numeric($this->look_cajero))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_cajero);
         $this->Xls_col++;
   }
   //----- entrada
   function NM_export_entrada()
   {
         ...
         if (is_numeric($this->entrada))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->entrada);
         $this->Xls_col++;
   }
   //----- salida
   function NM_export_salida()
   {
         ...
         if (is_numeric($this->salida))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->salida);
         $this->Xls_col++;
   }
   //----- saldo
   ...
   function NM_export_idcaja_vta()
   {
         ...
         if (is_numeric($this->idcaja_vta))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->idcaja_vta);
         $this->Xls_col++;
   }
   //----- fech_hora
   function NM_export_fech_hora()
   {
      ...
      if (!empty($this->fech_hora))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fech_hora, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fech_hora, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- codigo_banco
   function NM_sub_cons_codigo_banco()
   {
         $this->codigo_banco = html_entity_decode($this->codigo_banco, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->codigo_banco = strip_tags($this->codigo_banco);
         $this->codigo_banco = NM_charset_to_utf8($this->codigo_banco);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->codigo_banco;
   ...
   //----- comportamiento
   function NM_sub_cons_comportamiento()
   {
         $this->comportamiento = html_entity_decode($this->comportamiento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->comportamiento = strip_tags($this->comportamiento);
         $this->comportamiento = NM_charset_to_utf8($this->comportamiento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->comportamiento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- cajero
   function NM_sub_cons_cajero()
   {
         $this->look_cajero = NM_charset_to_utf8($this->look_cajero);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_cajero;
   ...
   //----- entrada
   function NM_sub_cons_entrada()
   {
         $this->entrada = NM_charset_to_utf8($this->entrada);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->entrada;
   ...
   //----- salida
   function NM_sub_cons_salida()
   {
         $this->salida = NM_charset_to_utf8($this->salida);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->salida;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- idcaja_vta
   function NM_sub_cons_idcaja_vta()
   {
         $this->idcaja_vta = NM_charset_to_utf8($this->idcaja_vta);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->idcaja_vta;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- fech_hora
   function NM_sub_cons_fech_hora()
   {
      if (!empty($this->fech_hora))
      {
         if (substr($this->fech_hora, 10, 1) == "-") 
         ...
         $this->fech_hora = NM_charset_to_utf8($this->fech_hora);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fech_hora;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bancos_280422']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
