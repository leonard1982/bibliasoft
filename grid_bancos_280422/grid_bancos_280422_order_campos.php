...
<?php
   ...
   $Ord_Cmp = new grid_bancos_280422_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_bancos_280422_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['codigo_banco'] = "codigo_banco";
   $tab_labels["codigo_banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["codigo_banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["codigo_banco"] : "Codigo";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["descripcion"] : "Descripcion";
   $tab_ger_campos['comportamiento'] = "on";
   $tab_def_campos['comportamiento'] = "comportamiento";
   $tab_labels["comportamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["comportamiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["comportamiento"] : "Apertura/Cierre";
   $tab_ger_campos['cajero'] = "on";
   $tab_def_campos['cajero'] = "cajero";
   $tab_labels["cajero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["cajero"])) ? $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["cajero"] : "Cajero";
   $tab_ger_campos['entrada'] = "on";
   $tab_def_campos['entrada'] = "entrada";
   $tab_labels["entrada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["entrada"])) ? $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["entrada"] : "Entrada";
   $tab_ger_campos['salida'] = "on";
   $tab_def_campos['salida'] = "salida";
   $tab_labels["salida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["salida"])) ? $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["salida"] : "Salida";
   $tab_ger_campos['saldo'] = "on";
   $tab_def_campos['saldo'] = "saldo";
   $tab_labels["saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['labels']["saldo"] : "Saldo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_bancos_280422_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_bancos_280422']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
