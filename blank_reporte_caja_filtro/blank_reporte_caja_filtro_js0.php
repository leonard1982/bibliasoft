...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['blank_reporte_caja_filtro']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="blank_reporte_caja_filtro"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_limpiar() 
{ 
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_limpiar(); }, 500);
      return;
    }
    document.F1.reset();
} 
function sc_btn_limpiar_cancel()
{
}
function sc_btn_limpiar_ok()
{
    document.F1.reset();
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_reporte_caja_filtro']['where_detal']))
  {
?>  
...
function nm_saida_glo()
{
  ...
  document.F4.action = "blank_reporte_caja_filtro_fim.php";
  document.F4.submit();
}
