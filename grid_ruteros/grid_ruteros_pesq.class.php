 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_dia_semana_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['dia_semana'])) ? $this->New_label['dia_semana'] : "Dia"; ?></TD>
      
      <INPUT type="hidden" id="SC_dia_semana_cond" name="dia_semana_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dia_semana" <?php echo $str_hide_dia_semana?> valign="top">
...
<?php
 ...
 <OPTION value="DOMINGO##@@DOMINGO"<?php if ($dia_semana == "DOMINGO") { echo " selected" ;} ?>>DOMINGO</option>
      ...
      <TD id='SC_asesor_zona_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['asesor_zona'])) ? $this->New_label['asesor_zona'] : "Asesor/Zona"; ?></TD>
      
      <INPUT type="hidden" id="SC_asesor_zona_cond" name="asesor_zona_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_asesor_zona" <?php echo $str_hide_asesor_zona?> valign="top">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cliente" name="cliente_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_razon_social_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['razon_social'])) ? $this->New_label['razon_social'] : "Razon/Social"; ?></TD>
