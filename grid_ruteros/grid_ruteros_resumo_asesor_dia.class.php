...
class grid_ruteros_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['contr_total_geral'] == "OK")
      {
          ...
          $this->array_total_dia_semana = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['arr_total']['dia_semana'];
      }
      else
      {
          $this->array_total_asesor_zona = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_order']['asesor_dia']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_order']['asesor_dia'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_order']['asesor_dia'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['asesor_dia'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['asesor_dia'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['asesor_dia'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['asesor_dia'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['asesor_dia'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['asesor_dia'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['asesor_dia'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_asesor_zona as $i_asesor_zona => $d_asesor_zona) {
           ...
           foreach ($this->array_total_dia_semana[$i_asesor_zona] as $i_dia_semana => $d_dia_semana) {
               if (!in_array($i_dia_semana, $this->comp_label[1][ $d_asesor_zona[3] ], true)) {
                   $this->comp_index[1][ $d_dia_semana[3] ] = $d_dia_semana[2];
                   $this->comp_label[1][ $d_asesor_zona[3] ][ $d_dia_semana[3] ] = $d_dia_semana[2];
               }
           }
       }
       ...
       $this->comp_links_fl = array(
           ...
           array('name' => 'dia_semana', 'prot' => '@aspass@'),
       );
       ...
       foreach ($this->comp_label[0] as $i_asesor_zona => $l_asesor_zona) {
           ...
           foreach ($this->comp_label[1][$i_asesor_zona] as $i_dia_semana => $l_dia_semana) {
               if (isset($this->array_total_dia_semana[$i_asesor_zona][$i_dia_semana])) {
                   $this->comp_group[$i_asesor_zona][$i_dia_semana] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       ...
       elseif (1 == $level) {
           $return = $this->array_total_dia_semana;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_asesor_dia("res");
      ...
      ksort($this->array_total_dia_semana);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_asesor_zona, $quebra_dia_semana, $quebra_asesor_zona_orig, $quebra_dia_semana_orig)
   {
      //----- Asesor/Zona
      ...
      //----- Dia
      if (!isset($this->array_total_dia_semana[$quebra_asesor_zona_orig][$quebra_dia_semana_orig]))
      {
         $this->array_total_dia_semana[$quebra_asesor_zona_orig][$quebra_dia_semana_orig][0] = 1;
         $this->array_total_dia_semana[$quebra_asesor_zona_orig][$quebra_dia_semana_orig][1] = 1;
         $this->array_total_dia_semana[$quebra_asesor_zona_orig][$quebra_dia_semana_orig][2] = $quebra_dia_semana;
         $this->array_total_dia_semana[$quebra_asesor_zona_orig][$quebra_dia_semana_orig][3] = $quebra_dia_semana_orig;
      }
      else
      {
         $this->array_total_dia_semana[$quebra_asesor_zona_orig][$quebra_dia_semana_orig][0]++;
         $this->array_total_dia_semana[$quebra_asesor_zona_orig][$quebra_dia_semana_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $format       = $this->Ini->Get_Gb_date_format('', 'dia_semana');
     $campos_order = $this->Ini->Get_date_order_groupby("dia_semana", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->asesor_zona, $this->dia_semana, $this->asesor_zona_orig,  $this->dia_semana_orig);
            }
   }
//
