...
class grid_ruteros_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['arr_total']['dia_semana'] = $this->array_total_dia_semana;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['arr_total']['asesor_zona'] = $this->array_total_asesor_zona;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['arr_total']['cliente'] = $this->array_total_cliente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['arr_total']['nom_cliente'] = $this->array_total_nom_cliente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['arr_total']['direccion'] = $this->array_total_direccion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['arr_total']['barrio'] = $this->array_total_barrio;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['arr_total']['razon_social'] = $this->array_total_razon_social;
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_dia_semana = "dia_semana";
          $Lab_asesor_zona = "asesor_zona";
          $Lab_cliente = "cliente";
          $Lab_nom_cliente = "nom_cliente";
          $Lab_direccion = "direccion";
          $Lab_barrio = "barrio";
          $Lab_razon_social = "razon_social";
       }
       else
       {
       $Lab_dia_semana = "Dia";
       ...
       $Lab_cliente = "Cliente";
       $Lab_nom_cliente = "Nom Cliente";
       $Lab_direccion = "Direccion";
       $Lab_barrio = "Barrio";
       $Lab_razon_social = "Razon/Social";
       }
       $prep_field = array();
       $prep_field['dia_semana'] = $Lab_dia_semana;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['labels']['dia_semana'] = $Lab_dia_semana; 
       $prep_field['asesor_zona'] = $Lab_asesor_zona;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['labels']['asesor_zona'] = $Lab_asesor_zona; 
       $prep_field['cliente'] = $Lab_cliente;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['labels']['cliente'] = $Lab_cliente; 
       $prep_field['nom_cliente'] = $Lab_nom_cliente;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['labels']['nom_cliente'] = $Lab_nom_cliente; 
       $prep_field['direccion'] = $Lab_direccion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['labels']['direccion'] = $Lab_direccion; 
       $prep_field['barrio'] = $Lab_barrio;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['labels']['barrio'] = $Lab_barrio; 
       $prep_field['razon_social'] = $Lab_razon_social;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['labels']['razon_social'] = $Lab_razon_social; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['dia_semana']['alin'] = "''";
       $Arr_parms['dia_semana']['link'] = "S";
       $Arr_parms['asesor_zona']['alin'] = "''";
       $Arr_parms['asesor_zona']['link'] = "S";
       $Arr_parms['cliente']['alin'] = "''";
       $Arr_parms['cliente']['link'] = "S";
       $Arr_parms['nom_cliente']['alin'] = "''";
       $Arr_parms['nom_cliente']['link'] = "S";
       $Arr_parms['direccion']['alin'] = "''";
       $Arr_parms['direccion']['link'] = "S";
       $Arr_parms['barrio']['alin'] = "''";
       $Arr_parms['barrio']['link'] = "S";
       $Arr_parms['razon_social']['alin'] = "''";
       $Arr_parms['razon_social']['link'] = "S";
       $Arr_parms['dia_semana']['fill'] = "true";
       $Arr_parms['dia_semana']['order'] = "label";
       $Arr_parms['dia_semana']['order_start'] = 'asc';
       $Arr_parms['dia_semana']['order_invert'] = 'false';
       $Arr_parms['dia_semana']['order_enabled'] = 'false';
       $Arr_parms['asesor_zona']['fill'] = "true";
       $Arr_parms['asesor_zona']['order'] = "label";
       $Arr_parms['asesor_zona']['order_start'] = 'asc';
       $Arr_parms['asesor_zona']['order_invert'] = 'false';
       $Arr_parms['asesor_zona']['order_enabled'] = 'false';
       ...
       $Arr_parms['nom_cliente']['fill'] = "true";
       $Arr_parms['nom_cliente']['order'] = "label";
       $Arr_parms['nom_cliente']['order_start'] = 'asc';
       $Arr_parms['nom_cliente']['order_invert'] = 'false';
       $Arr_parms['nom_cliente']['order_enabled'] = 'false';
       ...
       $Arr_parms['razon_social']['fill'] = "true";
       $Arr_parms['razon_social']['order'] = "label";
       $Arr_parms['razon_social']['order_start'] = 'asc';
       $Arr_parms['razon_social']['order_invert'] = 'false';
       $Arr_parms['razon_social']['order_enabled'] = 'false';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['dia_semana'] = array(0 => 'dia_semana', 1 => '@aspass@');
       $prep_links_fl['asesor_zona'] = array(0 => 'asesor_zona', 1 => '@aspass@');
       $prep_links_fl['cliente'] = array(0 => 'cliente', 1 => '@aspass@');
       $prep_links_fl['nom_cliente'] = array(0 => 'nom_cliente', 1 => '@aspass@');
       $prep_links_fl['direccion'] = array(0 => 'direccion', 1 => '@aspass@');
       $prep_links_fl['barrio'] = array(0 => 'barrio', 1 => '@aspass@');
       $prep_links_fl['razon_social'] = array(0 => 'razon_social', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['pivot_order_level'] = 0;
       }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_dia_semana)),
           ...
           '1' => array(
               ...
               'field_x'  => 'nom_cliente',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_nom_cliente)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'field_x'  => 'barrio',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_barrio)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'razon_social',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_razon_social)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
{ 
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_ruteros/grid_ruteros_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_dia_semana, $quebra_asesor_zona, $quebra_cliente, $quebra_nom_cliente, $quebra_direccion, $quebra_barrio, $quebra_razon_social, $quebra_dia_semana_orig, $quebra_asesor_zona_orig, $quebra_cliente_orig, $quebra_nom_cliente_orig, $quebra_direccion_orig, $quebra_barrio_orig, $quebra_razon_social_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->dia_semana_orig = $this->dia_semana;
            $this->asesor_zona_orig = $this->asesor_zona;
            $this->cliente_orig = $this->cliente;
            $this->nom_cliente_orig = $this->nom_cliente;
            $this->direccion_orig = $this->direccion;
            $this->barrio_orig = $this->barrio;
            $this->razon_social_orig = $this->razon_social;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->dia_semana, $this->asesor_zona, $this->cliente, $this->nom_cliente, $this->direccion, $this->barrio, $this->razon_social, $this->dia_semana_orig,  $this->asesor_zona_orig,  $this->cliente_orig,  $this->nom_cliente_orig,  $this->direccion_orig,  $this->barrio_orig,  $this->razon_social_orig);
            }
   }
//
