...
class grid_ruteros_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['arr_total']['cliente'];
      }
      else
      {
          $this->array_total_cliente = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_order']['cliente']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_order']['cliente'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_order']['cliente'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['cliente'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['cliente'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['cliente'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['cliente'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['cliente'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['cliente'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['cliente'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_cliente as $i_cliente => $d_cliente) {
           if (!in_array($i_cliente, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_cliente[3] ] = $d_cliente[2];
               $this->comp_label[0][ $d_cliente[3] ] = $d_cliente[2];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'cliente', 'prot' => '@aspass@'),
       );
       ...
       //-----
       foreach ($this->comp_label[0] as $i_cliente => $l_cliente) {
           if (isset($this->array_total_cliente[$i_cliente])) {
               $this->comp_group[$i_cliente] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_cliente;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      ksort($this->array_total_cliente);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_cliente, $quebra_cliente_orig)
   {
      //----- Cliente
      if (!isset($this->array_total_cliente[$quebra_cliente_orig]))
      {
         $this->array_total_cliente[$quebra_cliente_orig][0] = 1;
         $this->array_total_cliente[$quebra_cliente_orig][1] = 1;
         $this->array_total_cliente[$quebra_cliente_orig][2] = $quebra_cliente;
         $this->array_total_cliente[$quebra_cliente_orig][3] = $quebra_cliente_orig;
      }
      else
      {
         $this->array_total_cliente[$quebra_cliente_orig][0]++;
         $this->array_total_cliente[$quebra_cliente_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'cliente');
     $campos_order = $this->Ini->Get_date_order_groupby("cliente", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cliente, $this->cliente_orig);
            }
   }
//
