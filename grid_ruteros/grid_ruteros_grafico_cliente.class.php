...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['contr_label_graf']['cliente']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['contr_label_graf']['cliente']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['contr_label_graf']['cliente'];
      }
   }
