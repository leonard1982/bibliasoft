...
<?php
   ...
   $Ord_Cmp = new grid_ruteros_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_ruteros_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['dia_semana'] = "dia_semana";
   $tab_labels["dia_semana"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["dia_semana"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["dia_semana"] : "Dia";
   $tab_ger_campos['asesor_zona'] = "on";
   $tab_def_campos['asesor_zona'] = "asesor_zona";
   $tab_labels["asesor_zona"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["asesor_zona"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["asesor_zona"] : "Asesor/Zona";
   $tab_ger_campos['cliente'] = "on";
   $tab_def_campos['cliente'] = "cliente";
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["cliente"] : "Cliente";
   $tab_ger_campos['nom_cliente'] = "on";
   $tab_def_campos['nom_cliente'] = "nom_cliente";
   $tab_labels["nom_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["nom_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["nom_cliente"] : "Nom Cliente";
   $tab_ger_campos['direccion'] = "on";
   $tab_def_campos['direccion'] = "direccion";
   $tab_labels["direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["direccion"] : "Direccion";
   $tab_ger_campos['barrio'] = "on";
   $tab_def_campos['barrio'] = "barrio";
   $tab_labels["barrio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["barrio"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["barrio"] : "Barrio";
   $tab_ger_campos['razon_social'] = "on";
   $tab_def_campos['razon_social'] = "razon_social";
   $tab_labels["razon_social"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["razon_social"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["razon_social"] : "Razon/Social";
   $tab_ger_campos['telefono'] = "on";
   $tab_def_campos['telefono'] = "telefono";
   $tab_labels["telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_ruteros']['labels']["telefono"] : "Telefono";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ruteros']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ruteros']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ruteros']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_ruteros_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_ruteros']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
