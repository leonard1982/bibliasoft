...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "Dia";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['contr_label_graf']['dia_semana']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['contr_label_graf']['dia_semana']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['contr_label_graf']['dia_semana'];
      }
   }
