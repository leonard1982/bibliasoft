<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ruteros']['sc_process_barr'] = true;
require_once('../grid_ruteros/index.php');
unset($_SESSION['scriptcase']['grid_ruteros']['sc_process_barr']);
$ExportCtrl = new grid_ruteros_export_control;
$ExportCtrl->Export_barr();

class grid_ruteros_export_control
{
