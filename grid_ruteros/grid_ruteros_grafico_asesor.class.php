...
<?php
   ...
   function inicializa_vars()
   {
      ...
      //---- Label
      $this->label    = array();
      $this->label[0] = "Asesor/Zona";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['contr_label_graf']['asesor_zona']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['contr_label_graf']['asesor_zona']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['contr_label_graf']['asesor_zona'];
      }
   }
