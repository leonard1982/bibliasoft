...
class grid_ruteros_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_order']['dia']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_order']['dia'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_order']['dia'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['dia'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['dia'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['dia'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['dia'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['dia'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['dia'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['summarizing_fields_display']['dia'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_dia_semana as $i_dia_semana => $d_dia_semana) {
           if (!in_array($i_dia_semana, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_dia_semana[3] ] = $d_dia_semana[2];
               $this->comp_label[0][ $d_dia_semana[3] ] = $d_dia_semana[2];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_dia_semana => $l_dia_semana) {
           if (isset($this->array_total_dia_semana[$i_dia_semana])) {
               $this->comp_group[$i_dia_semana] = array();
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_dia("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_dia_semana, $quebra_dia_semana_orig)
   {
      //----- Dia
      if (!isset($this->array_total_dia_semana[$quebra_dia_semana_orig]))
      {
         $this->array_total_dia_semana[$quebra_dia_semana_orig][0] = 1;
         $this->array_total_dia_semana[$quebra_dia_semana_orig][1] = 1;
         $this->array_total_dia_semana[$quebra_dia_semana_orig][2] = $quebra_dia_semana;
         $this->array_total_dia_semana[$quebra_dia_semana_orig][3] = $quebra_dia_semana_orig;
      }
      else
      {
         $this->array_total_dia_semana[$quebra_dia_semana_orig][0]++;
         $this->array_total_dia_semana[$quebra_dia_semana_orig][2]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->dia_semana, $this->dia_semana_orig);
            }
   }
//
