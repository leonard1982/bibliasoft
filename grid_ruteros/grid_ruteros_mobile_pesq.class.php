...
class grid_ruteros_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_ruteros_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_ruteros_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_ruteros_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_razon_social')
      {
          $razon_social = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_razon_social($razon_social);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_cliente($cliente)
   {
      ...
      $nm_comando = "select documento, nombres from terceros where  nombres like '%" . $cliente . "%' order by nombres"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_razon_social($razon_social)
   {
      $razon_social = substr($this->Db->qstr($razon_social), 1, -1);
            $razon_social_look = substr($this->Db->qstr($razon_social), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct razon_social from " . $this->Ini->nm_tabela . " where  razon_social like '%" . $razon_social . "%' order by razon_social"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_rutero";$Nm_numeric[] = "id_rutero";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_ruteros/grid_ruteros_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_ruteros_ajax_search.js"></script>
 <script type="text/javascript" src="grid_ruteros_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_ruteros_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_ruteros']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_ruteros']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_dia_semana_cond#NMF#' + search_get_sel_txt('SC_dia_semana_cond') + '@NMF@';
  str_out += 'SC_dia_semana#NMF#' + search_get_select('SC_dia_semana') + '@NMF@';
  str_out += 'SC_asesor_zona_cond#NMF#' + search_get_sel_txt('SC_asesor_zona_cond') + '@NMF@';
  str_out += 'SC_asesor_zona#NMF#' + search_get_select('SC_asesor_zona') + '@NMF@';
  ...
  str_out += 'SC_razon_social_cond#NMF#' + search_get_sel_txt('SC_razon_social_cond') + '@NMF@';
  str_out += 'SC_razon_social#NMF#' + search_get_text('SC_razon_social') + '@NMF@';
  str_out += 'id_ac_razon_social#NMF#' + search_get_title('select2-id_ac_razon_social-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  ...
  $(".sc-ui-autocomp-razon_social").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_razon_social",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_razon_social").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Rutero</span></td>
...
<?php
   ...
   {
      global 
             $dia_semana_cond, $dia_semana,
             $asesor_zona_cond, $asesor_zona,
             $cliente_cond, $cliente, $cliente_autocomp,
             $razon_social_cond, $razon_social, $razon_social_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $dia_semana = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['dia_semana']; 
          $dia_semana_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['dia_semana_cond']; 
          $asesor_zona = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['asesor_zona']; 
          $asesor_zona_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['asesor_zona_cond']; 
          $cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['cliente']; 
          $cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['cliente_cond']; 
          $razon_social = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['razon_social']; 
          $razon_social_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['razon_social_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['NM_operador']; 
      } 
      if (!isset($dia_semana_cond) || empty($dia_semana_cond))
      {
         $dia_semana_cond = "eq";
      }
      if (!isset($asesor_zona_cond) || empty($asesor_zona_cond))
      {
         $asesor_zona_cond = "eq";
      }
      ...
      if (!isset($razon_social_cond) || empty($razon_social_cond))
      {
         $razon_social_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_dia_semana = (in_array($dia_semana_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_asesor_zona = (in_array($asesor_zona_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cliente = (in_array($cliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_razon_social = (in_array($razon_social_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($dia_semana) || $dia_semana == "")
      {
          $dia_semana = "";
      }
      if (isset($dia_semana) && !empty($dia_semana))
      {
      ...
      if (!isset($asesor_zona) || $asesor_zona == "")
      {
          $asesor_zona = "";
      }
      if (isset($asesor_zona) && !empty($asesor_zona))
      {
      ...
      if (isset($razon_social) && !empty($razon_social))
      {
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <INPUT type="hidden" id="SC_dia_semana_cond" name="dia_semana_cond" value="eq">
 ...
 $nmgp_tab_label .= "dia_semana?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_dia_semana"  <?php echo $str_hide_dia_semana?>> 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['psq_check_ret']['dia_semana'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['psq_check_ret']['dia_semana'][] = "LUNES";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['psq_check_ret']['dia_semana'][] = "MARTES";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['psq_check_ret']['dia_semana'][] = "MIERCOLES";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['psq_check_ret']['dia_semana'][] = "JUEVES";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['psq_check_ret']['dia_semana'][] = "VIERNES";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['psq_check_ret']['dia_semana'][] = "SABADO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['psq_check_ret']['dia_semana'][] = "DOMINGO";
 ?>

 <SELECT class="scFilterObjectOdd" id="SC_dia_semana"  name="dia_semana"  size="1">
 <OPTION value="">SELECCIONE</option>
 <OPTION value="LUNES##@@LUNES"<?php if ($dia_semana == "LUNES") { echo " selected" ;} ?>>LUNES</option>
 <OPTION value="MARTES##@@MARTES"<?php if ($dia_semana == "MARTES") { echo " selected" ;} ?>>MARTES</option>
 <OPTION value="MIERCOLES##@@MIERCOLES"<?php if ($dia_semana == "MIERCOLES") { echo " selected" ;} ?>>MIERCOLES</option>
 <OPTION value="JUEVES##@@JUEVES"<?php if ($dia_semana == "JUEVES") { echo " selected" ;} ?>>JUEVES</option>
 <OPTION value="VIERNES##@@VIERNES"<?php if ($dia_semana == "VIERNES") { echo " selected" ;} ?>>VIERNES</option>
 <OPTION value="SABADO##@@SABADO"<?php if ($dia_semana == "SABADO") { echo " selected" ;} ?>>SABADO</option>
 <OPTION value="DOMINGO##@@DOMINGO"<?php if ($dia_semana == "DOMINGO") { echo " selected" ;} ?>>DOMINGO</option>
 </SELECT>
 </TD>
      ...
      <INPUT type="hidden" id="SC_asesor_zona_cond" name="asesor_zona_cond" value="eq">
 ...
 $nmgp_tab_label .= "asesor_zona?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_asesor_zona"  <?php echo $str_hide_asesor_zona?>>
<?php
      $asesor_zona_look = substr($this->Db->qstr($asesor_zona), 1, -1); 
      $nmgp_def_dados = "" ; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['psq_check_ret']['asesor_zona'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['psq_check_ret']['asesor_zona'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_asesor_zona">
      <SELECT class="scFilterObjectEven" id="SC_asesor_zona" name="asesor_zona"  size="1">
       <OPTION value="">SELECCIONE</OPTION>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $asesor_zona)
            {
                    $asesor_zona_sel = ($nm_opc_cod === $asesor_zona) ? "selected" : "";
            }
            else
            {
               $asesor_zona_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $asesor_zona_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_cliente"  <?php echo $str_hide_cliente?>><?php
      ...
      $cliente_look = substr($this->Db->qstr($cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select documento, nombres from terceros where documento = '$cliente_look' order by nombres"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_cliente" name="cliente" value="<?php echo NM_encode_input($cliente) ?>"  size=14 alt="{datatype: 'text', maxLength: 14, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cliente" name="cliente_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}">
      ...
      <INPUT type="hidden" id="SC_razon_social_cond" name="razon_social_cond" value="qp">

    <TD nowrap class="scFilterLabelEven" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['razon_social'])) ? $this->New_label['razon_social'] : "Razon/Social";
 $nmgp_tab_label .= "razon_social?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_razon_social"  <?php echo $str_hide_razon_social?>><?php
      if ($razon_social != "")
      {
      $razon_social_look = substr($this->Db->qstr($razon_social), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct razon_social from " . $this->Ini->nm_tabela . " where razon_social = '$razon_social_look' order by razon_social"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$razon_social]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$razon_social];
      }
      else
      {
          $sAutocompValue = $razon_social;
      }
?>
<INPUT  type="text" id="SC_razon_social" name="razon_social" value="<?php echo NM_encode_input($razon_social) ?>"  size=50 alt="{datatype: 'text', maxLength: 120, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-razon_social" id="id_ac_razon_social" name="razon_social_autocomp"><?php if ('' !=  $razon_social) { ?><option value="<?php echo $razon_social ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
<?php
   if (is_file("grid_ruteros_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.dia_semana_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_dia_semana'), document.F1.dia_semana_cond, 'dia_semana');
   document.F1.dia_semana.value = "";
   document.F1.asesor_zona_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_asesor_zona'), document.F1.asesor_zona_cond, 'asesor_zona');
   document.F1.asesor_zona.value = "";
   ...
   document.F1.razon_social_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_razon_social'), document.F1.razon_social_cond, 'razon_social');
   document.F1.razon_social.value = "";
   document.F1.razon_social_autocomp.value = "";
   $('#select2-id_ac_razon_social-container').html('<?php echo $this->Val_init_razon_social['desc'] ?>');;
   Sc_carga_select2('all');
 }
 function Sc_carga_select2(Field)
 {
    if (Field == 'all' || Field == 'dia_semana') {
       Sc_carga_select2_dia_semana();
    }
    if (Field == 'all' || Field == 'asesor_zona') {
       Sc_carga_select2_asesor_zona();
    }
 }
 function Sc_carga_select2_dia_semana()
 {
  $("#SC_dia_semana").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
 ...
 function Sc_carga_select2_asesor_zona()
 {
  $("#SC_asesor_zona").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_ruteros";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_dia_semana_cond'] = 'cond';
      $tp_fields['SC_dia_semana'] = 'select';
      $tp_fields['SC_asesor_zona_cond'] = 'cond';
      $tp_fields['SC_asesor_zona'] = 'select';
      $tp_fields['SC_cliente_cond'] = 'cond';
      $tp_fields['SC_cliente'] = 'text_aut';
      $tp_fields['id_ac_cliente'] = 'text_aut';
      $tp_fields['SC_razon_social_cond'] = 'cond';
      $tp_fields['SC_razon_social'] = 'text_aut';
      $tp_fields['id_ac_razon_social'] = 'select2_aut';
   ...
   {
      global $dia_semana_cond, $dia_semana,
             $asesor_zona_cond, $asesor_zona,
             $cliente_cond, $cliente, $cliente_autocomp,
             $razon_social_cond, $razon_social, $razon_social_autocomp, $nmgp_tab_label;
      ...
      if (!empty($razon_social_autocomp) && empty($razon_social))
      {
          $razon_social = $razon_social_autocomp;
      }
      $dia_semana_cond_salva = $dia_semana_cond; 
      if (!isset($dia_semana_input_2) || $dia_semana_input_2 == "")
      {
          $dia_semana_input_2 = $dia_semana;
      }
      $asesor_zona_cond_salva = $asesor_zona_cond; 
      if (!isset($asesor_zona_input_2) || $asesor_zona_input_2 == "")
      {
          $asesor_zona_input_2 = $asesor_zona;
      }
      ...
      $razon_social_cond_salva = $razon_social_cond; 
      if (!isset($razon_social_input_2) || $razon_social_input_2 == "")
      {
          $razon_social_input_2 = $razon_social;
      }
      $tmp_pos = strpos($dia_semana, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $dia_semana;
          ...
          $L_lookup = substr($dia_semana, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['psq_check_ret']['dia_semana'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Dia : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($asesor_zona, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $asesor_zona;
      }
      else {
          $L_lookup = substr($asesor_zona, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['psq_check_ret']['asesor_zona'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Asesor/Zona : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['dia_semana'] = $dia_semana; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['dia_semana_cond'] = $dia_semana_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['asesor_zona'] = $asesor_zona; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['asesor_zona_cond'] = $asesor_zona_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['cliente'] = $cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['cliente_cond'] = $cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['razon_social'] = $razon_social; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['razon_social_cond'] = $razon_social_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['dia_semana'] = $Conteudo;
      $Conteudo = $asesor_zona;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['asesor_zona'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($cliente != '') {
      $cliente_look = substr($this->Db->qstr($cliente), 1, -1); 
      $nmgp_def_dados = array(); 
    ...
    if ($razon_social != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['razon_social'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['razon_social'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['razon_social'] = $razon_social;
      }
      ...
      if (isset($dia_semana))
      {
         $this->monta_condicao("dia_semana", $dia_semana_cond, $dia_semana, "", "dia_semana");
      }

      //----- $asesor_zona
      $this->Date_part = false;
      if (isset($asesor_zona))
      {
         $this->monta_condicao("asesor_zona", $asesor_zona_cond, $asesor_zona, "", "asesor_zona");
      }
      ...
      //----- $razon_social
      $this->Date_part = false;
      if (isset($razon_social) || $razon_social_cond == "nu" || $razon_social_cond == "nn" || $razon_social_cond == "ep" || $razon_social_cond == "ne")
      {
         $this->monta_condicao("razon_social", $razon_social_cond, $razon_social, "", "razon_social");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ruteros']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "asesor_zona" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
