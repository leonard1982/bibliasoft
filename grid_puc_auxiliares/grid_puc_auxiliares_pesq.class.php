 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_cuenta_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cuenta'])) ? $this->New_label['cuenta'] : "Cuenta"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cuenta_cond" name="cuenta_cond" onChange="nm_campos_between(document.getElementById('id_vis_cuenta'), this, 'cuenta')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cuenta" <?php echo $str_hide_cuenta?> valign="top">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nombre" name="nombre_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 120, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_codigo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['codigo'])) ? $this->New_label['codigo'] : "Auxiliar"; ?></TD>
     <TD class="scFilterFieldOdd"> 
