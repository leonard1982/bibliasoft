<?php
@session_start() ;
$_SESSION['scriptcase']['grid_puc_auxiliares']['sc_process_barr'] = true;
require_once('../grid_puc_auxiliares/index.php');
unset($_SESSION['scriptcase']['grid_puc_auxiliares']['sc_process_barr']);
$ExportCtrl = new grid_puc_auxiliares_export_control;
$ExportCtrl->Export_barr();

class grid_puc_auxiliares_export_control
{
