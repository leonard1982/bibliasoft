...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_puc_auxiliares"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_puc_auxiliares"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_puc_auxiliares'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_puc_auxiliares']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_puc_auxiliares']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_puc_auxiliares']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_puc_auxiliares']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_puc_auxiliares']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_puc_auxiliares</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_puc_auxiliares']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_puc_auxiliares']['embutida_filho'] as $ind => $sc_init)
          {
