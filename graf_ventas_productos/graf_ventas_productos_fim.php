...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____graf_ventas_productos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____graf_ventas_productos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['graf_ventas_productos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['graf_ventas_productos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['graf_ventas_productos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['graf_ventas_productos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['graf_ventas_productos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>graf_ventas_productos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['graf_ventas_productos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['graf_ventas_productos']['embutida_filho'] as $ind => $sc_init)
          {
