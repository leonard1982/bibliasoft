<?php
@session_start() ;
$_SESSION['scriptcase']['graf_ventas_productos']['sc_process_barr'] = true;
require_once('../graf_ventas_productos/index.php');
unset($_SESSION['scriptcase']['graf_ventas_productos']['sc_process_barr']);
$ExportCtrl = new graf_ventas_productos_export_control;
$ExportCtrl->Export_barr();

class graf_ventas_productos_export_control
{
