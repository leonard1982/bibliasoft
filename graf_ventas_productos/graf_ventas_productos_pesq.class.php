...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "month(f_fechaven)";$Nm_numeric[] = "d_valorpar";
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_p_nompro_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['p_nompro'])) ? $this->New_label['p_nompro'] : "Nompro"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_p_nompro_cond" name="p_nompro_cond" onChange="nm_campos_between(document.getElementById('id_vis_p_nompro'), this, 'p_nompro')">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_p_nompro" name="p_nompro_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 600, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_d_valorpar_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['d_valorpar'])) ? $this->New_label['d_valorpar'] : "Valorpar"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_d_valorpar_cond" name="d_valorpar_cond" onChange="nm_campos_between(document.getElementById('id_vis_d_valorpar'), this, 'd_valorpar')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_d_valorpar" <?php echo $str_hide_d_valorpar?> valign="top">
