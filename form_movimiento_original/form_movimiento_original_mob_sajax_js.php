  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_movimiento_original_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_movimiento_original_mob_form();
	}
  ...
  // ---------- Validate fecha
  function do_ajax_form_movimiento_original_mob_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_movimiento_original_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_movimiento_original_mob_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_movimiento_original_mob_validate_fecha

  function do_ajax_form_movimiento_original_mob_validate_fecha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_validate_fecha_cb

  // ---------- Validate idpro
  function do_ajax_form_movimiento_original_mob_validate_idpro()
  {
    var nomeCampo_idpro = "idpro";
    var var_idpro = scAjaxGetFieldSelect(nomeCampo_idpro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_original_mob_validate_idpro(var_idpro, var_script_case_init, do_ajax_form_movimiento_original_mob_validate_idpro_cb);
  } // do_ajax_form_movimiento_original_mob_validate_idpro

  function do_ajax_form_movimiento_original_mob_validate_idpro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_validate_idpro_cb

  // ---------- Validate presentacion
  function do_ajax_form_movimiento_original_mob_validate_presentacion()
  {
    var nomeCampo_presentacion = "presentacion";
    var var_presentacion = scAjaxGetFieldText(nomeCampo_presentacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_original_mob_validate_presentacion(var_presentacion, var_script_case_init, do_ajax_form_movimiento_original_mob_validate_presentacion_cb);
  } // do_ajax_form_movimiento_original_mob_validate_presentacion

  function do_ajax_form_movimiento_original_mob_validate_presentacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_validate_presentacion_cb

  // ---------- Validate cantidad
  function do_ajax_form_movimiento_original_mob_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_original_mob_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_movimiento_original_mob_validate_cantidad_cb);
  } // do_ajax_form_movimiento_original_mob_validate_cantidad

  function do_ajax_form_movimiento_original_mob_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_validate_cantidad_cb

  // ---------- Validate colores
  function do_ajax_form_movimiento_original_mob_validate_colores()
  {
    var nomeCampo_colores = "colores";
    var var_colores = scAjaxGetFieldSelect(nomeCampo_colores);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_original_mob_validate_colores(var_colores, var_script_case_init, do_ajax_form_movimiento_original_mob_validate_colores_cb);
  } // do_ajax_form_movimiento_original_mob_validate_colores

  function do_ajax_form_movimiento_original_mob_validate_colores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "colores";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_validate_colores_cb

  // ---------- Validate tallas
  function do_ajax_form_movimiento_original_mob_validate_tallas()
  {
    var nomeCampo_tallas = "tallas";
    var var_tallas = scAjaxGetFieldSelect(nomeCampo_tallas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_original_mob_validate_tallas(var_tallas, var_script_case_init, do_ajax_form_movimiento_original_mob_validate_tallas_cb);
  } // do_ajax_form_movimiento_original_mob_validate_tallas

  function do_ajax_form_movimiento_original_mob_validate_tallas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tallas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_validate_tallas_cb

  // ---------- Validate sabor
  function do_ajax_form_movimiento_original_mob_validate_sabor()
  {
    var nomeCampo_sabor = "sabor";
    var var_sabor = scAjaxGetFieldSelect(nomeCampo_sabor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_original_mob_validate_sabor(var_sabor, var_script_case_init, do_ajax_form_movimiento_original_mob_validate_sabor_cb);
  } // do_ajax_form_movimiento_original_mob_validate_sabor

  function do_ajax_form_movimiento_original_mob_validate_sabor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sabor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_validate_sabor_cb

  // ---------- Validate idbodorig
  function do_ajax_form_movimiento_original_mob_validate_idbodorig()
  {
    var nomeCampo_idbodorig = "idbodorig";
    var var_idbodorig = scAjaxGetFieldSelect(nomeCampo_idbodorig);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_original_mob_validate_idbodorig(var_idbodorig, var_script_case_init, do_ajax_form_movimiento_original_mob_validate_idbodorig_cb);
  } // do_ajax_form_movimiento_original_mob_validate_idbodorig

  function do_ajax_form_movimiento_original_mob_validate_idbodorig_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_validate_idbodorig_cb

  // ---------- Validate stockorigen
  function do_ajax_form_movimiento_original_mob_validate_stockorigen()
  {
    var nomeCampo_stockorigen = "stockorigen";
    var var_stockorigen = scAjaxGetFieldHidden(nomeCampo_stockorigen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_original_mob_validate_stockorigen(var_stockorigen, var_script_case_init, do_ajax_form_movimiento_original_mob_validate_stockorigen_cb);
  } // do_ajax_form_movimiento_original_mob_validate_stockorigen

  function do_ajax_form_movimiento_original_mob_validate_stockorigen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stockorigen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_validate_stockorigen_cb

  // ---------- Validate idboddes
  function do_ajax_form_movimiento_original_mob_validate_idboddes()
  {
    var nomeCampo_idboddes = "idboddes";
    var var_idboddes = scAjaxGetFieldSelect(nomeCampo_idboddes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_original_mob_validate_idboddes(var_idboddes, var_script_case_init, do_ajax_form_movimiento_original_mob_validate_idboddes_cb);
  } // do_ajax_form_movimiento_original_mob_validate_idboddes

  function do_ajax_form_movimiento_original_mob_validate_idboddes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_validate_idboddes_cb

  // ---------- Validate stckdestino
  function do_ajax_form_movimiento_original_mob_validate_stckdestino()
  {
    var nomeCampo_stckdestino = "stckdestino";
    var var_stckdestino = scAjaxGetFieldHidden(nomeCampo_stckdestino);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_original_mob_validate_stckdestino(var_stckdestino, var_script_case_init, do_ajax_form_movimiento_original_mob_validate_stckdestino_cb);
  } // do_ajax_form_movimiento_original_mob_validate_stckdestino

  function do_ajax_form_movimiento_original_mob_validate_stckdestino_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stckdestino";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_validate_stckdestino_cb

  // ---------- Validate idtipotran
  function do_ajax_form_movimiento_original_mob_validate_idtipotran()
  {
    var nomeCampo_idtipotran = "idtipotran";
    var var_idtipotran = scAjaxGetFieldText(nomeCampo_idtipotran);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_original_mob_validate_idtipotran(var_idtipotran, var_script_case_init, do_ajax_form_movimiento_original_mob_validate_idtipotran_cb);
  } // do_ajax_form_movimiento_original_mob_validate_idtipotran

  function do_ajax_form_movimiento_original_mob_validate_idtipotran_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_validate_idtipotran_cb

  // ---------- Refresh idpro
  function do_ajax_form_movimiento_original_mob_refresh_idpro()
  {
    var var_idpro = scAjaxGetFieldSelect("idpro");
    var var_nmgp_refresh_fields = "colores_#fld#_tallas_#fld#_sabor";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_movimiento_original_mob_refresh_idpro(var_idpro, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_movimiento_original_mob_refresh_idpro_cb);
  } // do_ajax_form_movimiento_original_mob_refresh_idpro

  function do_ajax_form_movimiento_original_mob_refresh_idpro_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_refresh_idpro_cb

  // ---------- Refresh idbodorig
  function do_ajax_form_movimiento_original_mob_refresh_idbodorig()
  {
    var var_idbodorig = scAjaxGetFieldSelect("idbodorig");
    var var_nmgp_refresh_fields = "idboddes";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_movimiento_original_mob_refresh_idbodorig(var_idbodorig, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_movimiento_original_mob_refresh_idbodorig_cb);
  } // do_ajax_form_movimiento_original_mob_refresh_idbodorig

  function do_ajax_form_movimiento_original_mob_refresh_idbodorig_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_original_mob_refresh_idbodorig_cb

  // ---------- Event onchange idboddes
  function do_ajax_form_movimiento_original_mob_event_idboddes_onchange()
  {
    ...
    var var_stckdestino = scAjaxGetFieldHidden("stckdestino");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_movimiento_original_mob_event_idboddes_onchange(var_colores, var_tallas, var_sabor, var_idpro, var_idboddes, var_stckdestino, var_script_case_init, do_ajax_form_movimiento_original_mob_event_idboddes_onchange_cb);
  } // do_ajax_form_movimiento_original_mob_event_idboddes_onchange

  function do_ajax_form_movimiento_original_mob_event_idboddes_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idboddes";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_movimiento_original_mob_event_idboddes_onchange_cb_after_alert);
  } // do_ajax_form_movimiento_original_mob_event_idboddes_onchange_cb
  function do_ajax_form_movimiento_original_mob_event_idboddes_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_movimiento_original_mob_event_idboddes_onchange_cb_after_alert

  // ---------- Event onchange idbodorig
  function do_ajax_form_movimiento_original_mob_event_idbodorig_onchange()
  {
    var var_colores = scAjaxGetFieldSelect("colores");
    var var_tallas = scAjaxGetFieldSelect("tallas");
    var var_sabor = scAjaxGetFieldSelect("sabor");
    var var_idpro = scAjaxGetFieldSelect("idpro");
    var var_idbodorig = scAjaxGetFieldSelect("idbodorig");
    var var_stockorigen = scAjaxGetFieldHidden("stockorigen");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_movimiento_original_mob_event_idbodorig_onchange(var_colores, var_tallas, var_sabor, var_idpro, var_idbodorig, var_stockorigen, var_script_case_init, do_ajax_form_movimiento_original_mob_event_idbodorig_onchange_cb);
  } // do_ajax_form_movimiento_original_mob_event_idbodorig_onchange

  function do_ajax_form_movimiento_original_mob_event_idbodorig_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idbodorig";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_movimiento_original_mob_event_idbodorig_onchange_cb_after_alert);
  } // do_ajax_form_movimiento_original_mob_event_idbodorig_onchange_cb
  function do_ajax_form_movimiento_original_mob_event_idbodorig_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_movimiento_original_mob_refresh_idbodorig();
    scAjaxRedir();
  } // do_ajax_form_movimiento_original_mob_event_idbodorig_onchange_cb_after_alert

  // ---------- Event onchange idpro
  function do_ajax_form_movimiento_original_mob_event_idpro_onchange()
  {
    var var_idpro = scAjaxGetFieldSelect("idpro");
    var var_presentacion = scAjaxGetFieldText("presentacion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_movimiento_original_mob_event_idpro_onchange(var_idpro, var_presentacion, var_script_case_init, do_ajax_form_movimiento_original_mob_event_idpro_onchange_cb);
  } // do_ajax_form_movimiento_original_mob_event_idpro_onchange

  function do_ajax_form_movimiento_original_mob_event_idpro_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idpro";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_movimiento_original_mob_event_idpro_onchange_cb_after_alert);
  } // do_ajax_form_movimiento_original_mob_event_idpro_onchange_cb
  function do_ajax_form_movimiento_original_mob_event_idpro_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_movimiento_original_mob_refresh_idpro();
    scAjaxRedir();
  } // do_ajax_form_movimiento_original_mob_event_idpro_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_movimiento_original_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_movimiento_original_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_idboddes = scAjaxGetFieldSelect("idboddes");
    var var_stckdestino = scAjaxGetFieldHidden("stckdestino");
    var var_idtipotran = scAjaxGetFieldText("idtipotran");
    var var_idmov = scAjaxGetFieldText("idmov");
    ...
    scAjaxProcOn();
    x_ajax_form_movimiento_original_mob_submit_form(var_fecha, var_idpro, var_presentacion, var_cantidad, var_colores, var_tallas, var_sabor, var_idbodorig, var_stockorigen, var_idboddes, var_stckdestino, var_idtipotran, var_idmov, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_movimiento_original_mob_submit_form_cb);
  } // do_ajax_form_movimiento_original_mob_submit_form

  function do_ajax_form_movimiento_original_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("stockorigen");
      scAjaxHideErrorDisplay("idboddes");
      scAjaxHideErrorDisplay("stckdestino");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_movimiento_original_mob_submit_form_cb_after_alert);
  } // do_ajax_form_movimiento_original_mob_submit_form_cb
  function do_ajax_form_movimiento_original_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_movimiento_original_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_movimiento_original_mob_navigate_form()
  {
    perform_ajax_form_movimiento_original_mob_navigate_form();
  }

  function perform_ajax_form_movimiento_original_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_movimiento_original_mob_navigate_form(var_idmov, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_movimiento_original_mob_navigate_form_cb);
  } // do_ajax_form_movimiento_original_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movimiento_original_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_movimiento_original_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_movimiento_original_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_movimiento_original_mob_navigate_form_cb
  function do_ajax_form_movimiento_original_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_movimiento_original_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_movimiento_original_mob_navigate_form_cb_after_alert
  function sc_hide_form_movimiento_original_mob_form()
  {
  ...
  ajax_field_list[1] = "idpro";
  ajax_field_list[2] = "presentacion";
  ajax_field_list[3] = "cantidad";
  ajax_field_list[4] = "colores";
  ajax_field_list[5] = "tallas";
  ajax_field_list[6] = "sabor";
  ajax_field_list[7] = "idbodorig";
  ajax_field_list[8] = "stockorigen";
  ajax_field_list[9] = "idboddes";
  ajax_field_list[10] = "stckdestino";
  ajax_field_list[11] = "idtipotran";
  ...
  var ajax_error_list = {
    ...
    "stockorigen": {"label": "Stock Origen", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idboddes": {"label": "Destino", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "stckdestino": {"label": "Stocck Destino", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idtipotran": {"label": "Idtipotran", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "sabor": new Array(),
    "idbodorig": new Array(),
    "stockorigen": new Array(),
    "idboddes": new Array(),
    "stckdestino": new Array(),
  ...
  ajax_field_mult["stockorigen"][1] = "stockorigen";
  ajax_field_mult["idboddes"][1] = "idboddes";
  ajax_field_mult["stckdestino"][1] = "stckdestino";
  ...
  var ajax_field_id = {
    ...
    "stockorigen": new Array("hidden_field_label_stockorigen", "hidden_field_data_stockorigen"),
    "idboddes": new Array("hidden_field_label_idboddes", "hidden_field_data_idboddes"),
    "stckdestino": new Array("hidden_field_label_stckdestino", "hidden_field_data_stckdestino")
  };
