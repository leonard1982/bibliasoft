...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_movimiento_original']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_movimiento_original"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movimiento_original']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_form_movimiento_original_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_movimiento_original_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
...
function sc_form_onload()
{
   ...
   nm_field_disabled("fecha=disabled;idpro=disabled;cantidad=disabled;colores=disabled;tallas=disabled;sabor=disabled;idbodorig=disabled;idboddes=disabled", "U");
