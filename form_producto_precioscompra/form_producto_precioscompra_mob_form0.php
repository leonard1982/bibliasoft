...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra_mob']['btn_disabled']['out']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra_mob']['btn_disabled']['out']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra_mob']['btn_label']['out']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra_mob']['btn_label']['out']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra_mob']['btn_label']['out'];
        }
?>
