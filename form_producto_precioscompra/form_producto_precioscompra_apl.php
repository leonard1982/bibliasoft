<?php
//
class form_producto_precioscompra_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->gtmpidprod) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['gtmpidprod'] = $this->gtmpidprod;
      }
      if (isset($_POST["gtmpidprod"]) && isset($this->gtmpidprod)) 
      {
          $_SESSION['gtmpidprod'] = $this->gtmpidprod;
      }
      if (isset($_GET["gtmpidprod"]) && isset($this->gtmpidprod)) 
      {
          $_SESSION['gtmpidprod'] = $this->gtmpidprod;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['embutida_parms'];
      ...
      { 
          ...
          if (isset($this->gtmpidprod)) 
          {
              $_SESSION['gtmpidprod'] = $this->gtmpidprod;
          }
          if (isset($this->NM_where_filter_form))
          {
              $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->gtmpidprod)) 
          {
              $_SESSION['gtmpidprod'] = $this->gtmpidprod;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_producto_precioscompra_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_producto_precioscompra']['upload_field_info']['imagenprod'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_producto_precioscompra',
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_producto_precioscompra']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_producto_precioscompra'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_producto_precioscompra']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_producto_precioscompra']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_producto_precioscompra') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_producto_precioscompra']['label'] = "Actualizar Precios";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_producto_precioscompra")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->arr_buttons['out']['hint']             = "";
      $this->arr_buttons['out']['type']             = "button";
      $this->arr_buttons['out']['value']            = "Salir";
      $this->arr_buttons['out']['display']          = "only_text";
      $this->arr_buttons['out']['display_position'] = "text_right";
      $this->arr_buttons['out']['style']            = "default";
      $this->arr_buttons['out']['image']            = "";


      $_SESSION['scriptcase']['error_icon']['form_producto_precioscompra']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_producto_precioscompra'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_orig'] = " where idprod='" . $_SESSION['gtmpidprod'] . "'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_pesq'] = " where idprod='" . $_SESSION['gtmpidprod'] . "'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_producto_precioscompra']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_producto_precioscompra'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_producto_precioscompra'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_producto_precioscompra", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_producto_precioscompra_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_producto_precioscompra_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_producto_precioscompra/form_producto_precioscompra_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_producto_precioscompra_erro.class.php"); 
      }
      $this->Erro      = new form_producto_precioscompra_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['opcao']))
         { 
             if ($this->idprod != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_producto_precioscompra']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "novo")  
      {
          $this->nmgp_botoes['out'] = "off";
      }
      elseif ($this->nmgp_opcao == "incluir")  
      {
          $this->nmgp_botoes['out'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['botoes']['out'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_producto_precioscompra']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_producto_precioscompra']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_producto_precioscompra.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_producto_precioscompra_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_producto_precioscompra"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_producto_precioscompra']) || !is_array($this->NM_ajax_info['errList']['geral_form_producto_precioscompra']))
              {
                  $this->NM_ajax_info['errList']['geral_form_producto_precioscompra'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_producto_precioscompra'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_codigoprod(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->codigoprod) > 20) 
          { 
              $hasError = true;
              ...
              $Campos_Erros['codigoprod'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['codigoprod'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_precio_editable(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->precio_editable) > 255) 
          { 
              $hasError = true;
              $Campos_Crit .= "Precio Editable " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['precio_editable']))
              {
                  $Campos_Erros['precio_editable'] = array();
              }
              $Campos_Erros['precio_editable'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['precio_editable'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idprod']['keyVal'] = form_producto_precioscompra_pack_protect_string($this->nmgp_dados_form['idprod']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_producto_precioscompra_pack_protect_string('SI') => str_replace('<', '&lt;',form_producto_precioscompra_pack_protect_string("SI")));
$aLookup[] = array(form_producto_precioscompra_pack_protect_string('NO') => str_replace('<', '&lt;',form_producto_precioscompra_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['Lookup_fecha_vencimiento'][] = 'SI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['Lookup_fecha_vencimiento'][] = 'NO';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['fecha_vencimiento']['valList'][$i] = form_producto_precioscompra_pack_protect_string($v);
          }
...
$aLookup[] = array(form_producto_precioscompra_pack_protect_string('SI') => str_replace('<', '&lt;',form_producto_precioscompra_pack_protect_string("SI")));
$aLookup[] = array(form_producto_precioscompra_pack_protect_string('NO') => str_replace('<', '&lt;',form_producto_precioscompra_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['Lookup_lote'][] = 'SI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['Lookup_lote'][] = 'NO';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"lote\"";
          ...
          {
              $this->NM_ajax_info['fldList']['lote']['valList'][$i] = form_producto_precioscompra_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_producto_precioscompra_pack_protect_string('SI') => str_replace('<', '&lt;',form_producto_precioscompra_pack_protect_string("SI")));
$aLookup[] = array(form_producto_precioscompra_pack_protect_string('NO') => str_replace('<', '&lt;',form_producto_precioscompra_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['Lookup_serial_codbarras'][] = 'SI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['Lookup_serial_codbarras'][] = 'NO';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['serial_codbarras']['valList'][$i] = form_producto_precioscompra_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['form_producto_precioscompra']['contr_erro'] = 'on';
             /* detallecompra */
...
;
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_producto_precioscompra';
...
$_SESSION['scriptcase']['form_producto_precioscompra']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $aUpdateOk = array();
              ...
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_ukey'] . " CodBarra"); 
                  $this->nmgp_opcao = "nada"; 
                  $aUpdateOk[] = 'codigobar';
                  $rsUni->Close();
              }
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "codigobar = '$this->codigobar', codigoprod = '$this->codigoprod', nompro = '$this->nompro', preciomen = $this->preciomen, preciomen2 = $this->preciomen2, preciomen3 = $this->preciomen3, precio2 = $this->precio2, preciomay = $this->preciomay, preciofull = $this->preciofull, precio_editable = '$this->precio_editable', fecha_vencimiento = '$this->fecha_vencimiento', lote = '$this->lote', serial_codbarras = '$this->serial_codbarras'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['escombo']) && $NM_val_form['escombo'] != $this->nmgp_dados_select['escombo']) 
              { 
                  $SC_fields_update[] = "escombo = '$this->escombo'"; 
              } 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('codigobar', 'codigoprod', 'nompro', 'preciomen', 'preciomen2', 'preciomen3', 'precio2', 'preciomay', 'preciofull', 'precio_editable', 'fecha_vencimiento', 'lote', 'serial_codbarras'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          $aInsertOk = array(); 
              ...
              elseif (0 < $rsUni->fields[0])
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_inst_uniq'] . " CodBarra"); 
                  $this->nmgp_opcao = "nada"; 
                  $GLOBALS["erro_incl"] = 1; 
                  $aInsertOk[] = 'codigobar';
                  $rsUni->Close();
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              { 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (codigobar, codigoprod, nompro, unimay, unimen, costomay, costomen, preciomen, preciomen2, preciomen3, precio2, preciomay, preciofull, idgrup, idpro1, idpro2, idiva, otro, otro2, colores, tallas, sabores, imagenprod, imconsumo, escombo, idcombo, precio_editable, cod_cuenta, fecha_vencimiento, fecha_fab, lote, serial_codbarras $compl_insert) VALUES ('$this->codigobar', '$this->codigoprod', '$this->nompro', '$this->unimay', '$this->unimen', $this->costomay, $this->costomen, $this->preciomen, $this->preciomen2, $this->preciomen3, $this->precio2, $this->preciomay, $this->preciofull, $this->idgrup, $this->idpro1, $this->idpro2, $this->idiva, $this->otro, $this->otro2, '$this->colores', '$this->tallas', '$this->sabores', '$this->imagenprod', $this->imconsumo, '$this->escombo', $this->idcombo, '$this->precio_editable', '$this->cod_cuenta', '$this->fecha_vencimiento', '$this->fecha_fab', '$this->lote', '$this->serial_codbarras' $compl_insert_val)"; 
              }
              ...
              { 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (codigobar, codigoprod, nompro, unimay, unimen, costomay, costomen, preciomen, preciomen2, preciomen3, precio2, preciomay, preciofull, idgrup, idpro1, idpro2, idiva, otro, otro2, colores, tallas, sabores, imagenprod, imconsumo, escombo, idcombo, precio_editable, cod_cuenta, fecha_vencimiento, fecha_fab, lote, serial_codbarras $compl_insert) VALUES ('$this->codigobar', '$this->codigoprod', '$this->nompro', '$this->unimay', '$this->unimen', $this->costomay, $this->costomen, $this->preciomen, $this->preciomen2, $this->preciomen3, $this->precio2, $this->preciomay, $this->preciofull, $this->idgrup, $this->idpro1, $this->idpro2, $this->idiva, $this->otro, $this->otro2, '$this->colores', '$this->tallas', '$this->sabores', '', $this->imconsumo, '$this->escombo', $this->idcombo, '$this->precio_editable', '$this->cod_cuenta', '$this->fecha_vencimiento', '$this->fecha_fab', '$this->lote', '$this->serial_codbarras' $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $compl_insert     = ""; 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "codigobar, codigoprod, nompro, unimay, unimen, costomay, costomen, preciomen, preciomen2, preciomen3, precio2, preciomay, preciofull, idgrup, idpro1, idpro2, idiva, otro, otro2, colores, tallas, sabores, imagenprod, imconsumo, escombo, idcombo, precio_editable, cod_cuenta, fecha_vencimiento, fecha_fab, lote, serial_codbarras $compl_insert) VALUES (" . $NM_seq_auto . "'$this->codigobar', '$this->codigoprod', '$this->nompro', '$this->unimay', '$this->unimen', $this->costomay, $this->costomen, $this->preciomen, $this->preciomen2, $this->preciomen3, $this->precio2, $this->preciomay, $this->preciofull, $this->idgrup, $this->idpro1, $this->idpro2, $this->idiva, $this->otro, $this->otro2, '$this->colores', '$this->tallas', '$this->sabores', EMPTY_BLOB(), $this->imconsumo, '$this->escombo', $this->idcombo, '$this->precio_editable', '$this->cod_cuenta', '$this->fecha_vencimiento', '$this->fecha_fab', '$this->lote', '$this->serial_codbarras' $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $compl_insert     = ""; 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "codigobar, codigoprod, nompro, unimay, unimen, costomay, costomen, preciomen, preciomen2, preciomen3, precio2, preciomay, preciofull, idgrup, idpro1, idpro2, idiva, otro, otro2, colores, tallas, sabores, imagenprod, imconsumo, escombo, idcombo, precio_editable, cod_cuenta, fecha_vencimiento, fecha_fab, lote, serial_codbarras $compl_insert) VALUES (" . $NM_seq_auto . "'$this->codigobar', '$this->codigoprod', '$this->nompro', '$this->unimay', '$this->unimen', $this->costomay, $this->costomen, $this->preciomen, $this->preciomen2, $this->preciomen3, $this->precio2, $this->preciomay, $this->preciofull, $this->idgrup, $this->idpro1, $this->idpro2, $this->idiva, $this->otro, $this->otro2, '$this->colores', '$this->tallas', '$this->sabores', null, $this->imconsumo, '$this->escombo', $this->idcombo, '$this->precio_editable', '$this->cod_cuenta', '$this->fecha_vencimiento', '$this->fecha_fab', '$this->lote', '$this->serial_codbarras' $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              {
                  $compl_insert     = ""; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['reg_start'] = 0; 
              }
...
if (!isset($this->sc_temp_gidtercero)) {$this->sc_temp_gidtercero = (isset($_SESSION['gidtercero'])) ? $_SESSION['gidtercero'] : "";}
     ...
     $nm_select ="insert into log set usuario='".$this->sc_temp_gidtercero."',accion='EDITAR', observaciones='EL USUARIO EDITÓ LOS PRECIOS EL PRODUCTO: $this->codigobar  - $this->nompro , PRECIO MENUDEO: ".number_format($this->preciomen ).",ESPECIAL MENUDEO: ".number_format($this->preciomen2 ).",MAYOR MENUDEO: ".number_format($this->preciomen3 ).",PRECIO FULL: ".number_format($this->precio2 ).", PRECIO ESPECIAL: ".number_format($this->preciomay ).", PRECIO MAYOR: ".number_format($this->preciofull )." ,POR EL FORMULARIO DE PRODUCTOS SIMPLE.' "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
$_SESSION['scriptcase']['form_producto_precioscompra']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['parms'] = "idprod?#?$this->idprod?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
          ...
          $aWhere = array();
          $aWhere[] = "idprod='" . $_SESSION['gtmpidprod'] . "'";
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['reg_start']) ;  
              } 
          } 
          ...
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['out'] = $this->nmgp_botoes['out'] = "off";
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['parms'] = "idprod?#?$this->idprod?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['sub_dir'][0]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['reg_start'] < $qt_geral_reg_form_producto_precioscompra;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_producto_precioscompra_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        $searchOk = false;
        if ('SC_all_Cmp' == $this->nmgp_fast_search && in_array($field, array("codigobar", "codigoprod", "nompro"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter_form'] . " and (idprod='" . $_SESSION['gtmpidprod'] . "') and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where idprod='" . $_SESSION['gtmpidprod'] . "' and (" . $comando . ")";
      }
      ...
      $qt_geral_reg_form_producto_precioscompra = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['total'] = $qt_geral_reg_form_producto_precioscompra;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_producto_precioscompra_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_producto_precioscompra_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_producto_precioscompra_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra']['masterValue']))
{
