  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_producto_precioscompra_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_producto_precioscompra_mob_form();
	}
...
?>
  ...
  // ---------- Validate codigobar
  function do_ajax_form_producto_precioscompra_mob_validate_codigobar()
  {
    var nomeCampo_codigobar = "codigobar";
    var var_codigobar = scAjaxGetFieldHidden(nomeCampo_codigobar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_precioscompra_mob_validate_codigobar(var_codigobar, var_script_case_init, do_ajax_form_producto_precioscompra_mob_validate_codigobar_cb);
  } // do_ajax_form_producto_precioscompra_mob_validate_codigobar

  function do_ajax_form_producto_precioscompra_mob_validate_codigobar_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_precioscompra_mob_validate_codigobar_cb

  // ---------- Validate codigoprod
  function do_ajax_form_producto_precioscompra_mob_validate_codigoprod()
  {
    var nomeCampo_codigoprod = "codigoprod";
    var var_codigoprod = scAjaxGetFieldHidden(nomeCampo_codigoprod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_precioscompra_mob_validate_codigoprod(var_codigoprod, var_script_case_init, do_ajax_form_producto_precioscompra_mob_validate_codigoprod_cb);
  } // do_ajax_form_producto_precioscompra_mob_validate_codigoprod

  function do_ajax_form_producto_precioscompra_mob_validate_codigoprod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_precioscompra_mob_validate_codigoprod_cb

  // ---------- Validate nompro
  function do_ajax_form_producto_precioscompra_mob_validate_nompro()
  {
    var nomeCampo_nompro = "nompro";
    var var_nompro = scAjaxGetFieldHidden(nomeCampo_nompro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_precioscompra_mob_validate_nompro(var_nompro, var_script_case_init, do_ajax_form_producto_precioscompra_mob_validate_nompro_cb);
  } // do_ajax_form_producto_precioscompra_mob_validate_nompro

  function do_ajax_form_producto_precioscompra_mob_validate_nompro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nompro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_precioscompra_mob_validate_nompro_cb

  // ---------- Validate preciomen
  function do_ajax_form_producto_precioscompra_mob_validate_preciomen()
  {
    var nomeCampo_preciomen = "preciomen";
    var var_preciomen = scAjaxGetFieldText(nomeCampo_preciomen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_precioscompra_mob_validate_preciomen(var_preciomen, var_script_case_init, do_ajax_form_producto_precioscompra_mob_validate_preciomen_cb);
  } // do_ajax_form_producto_precioscompra_mob_validate_preciomen

  function do_ajax_form_producto_precioscompra_mob_validate_preciomen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_precioscompra_mob_validate_preciomen_cb

  // ---------- Validate preciomen2
  function do_ajax_form_producto_precioscompra_mob_validate_preciomen2()
  {
    var nomeCampo_preciomen2 = "preciomen2";
    var var_preciomen2 = scAjaxGetFieldText(nomeCampo_preciomen2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_precioscompra_mob_validate_preciomen2(var_preciomen2, var_script_case_init, do_ajax_form_producto_precioscompra_mob_validate_preciomen2_cb);
  } // do_ajax_form_producto_precioscompra_mob_validate_preciomen2

  function do_ajax_form_producto_precioscompra_mob_validate_preciomen2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_precioscompra_mob_validate_preciomen2_cb

  // ---------- Validate preciomen3
  function do_ajax_form_producto_precioscompra_mob_validate_preciomen3()
  {
    var nomeCampo_preciomen3 = "preciomen3";
    var var_preciomen3 = scAjaxGetFieldText(nomeCampo_preciomen3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_precioscompra_mob_validate_preciomen3(var_preciomen3, var_script_case_init, do_ajax_form_producto_precioscompra_mob_validate_preciomen3_cb);
  } // do_ajax_form_producto_precioscompra_mob_validate_preciomen3

  function do_ajax_form_producto_precioscompra_mob_validate_preciomen3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_precioscompra_mob_validate_preciomen3_cb

  // ---------- Validate precio2
  function do_ajax_form_producto_precioscompra_mob_validate_precio2()
  {
    var nomeCampo_precio2 = "precio2";
    var var_precio2 = scAjaxGetFieldText(nomeCampo_precio2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_precioscompra_mob_validate_precio2(var_precio2, var_script_case_init, do_ajax_form_producto_precioscompra_mob_validate_precio2_cb);
  } // do_ajax_form_producto_precioscompra_mob_validate_precio2

  function do_ajax_form_producto_precioscompra_mob_validate_precio2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "precio2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_precioscompra_mob_validate_precio2_cb

  // ---------- Validate preciomay
  function do_ajax_form_producto_precioscompra_mob_validate_preciomay()
  {
    var nomeCampo_preciomay = "preciomay";
    var var_preciomay = scAjaxGetFieldText(nomeCampo_preciomay);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_precioscompra_mob_validate_preciomay(var_preciomay, var_script_case_init, do_ajax_form_producto_precioscompra_mob_validate_preciomay_cb);
  } // do_ajax_form_producto_precioscompra_mob_validate_preciomay

  function do_ajax_form_producto_precioscompra_mob_validate_preciomay_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_precioscompra_mob_validate_preciomay_cb

  // ---------- Validate preciofull
  function do_ajax_form_producto_precioscompra_mob_validate_preciofull()
  {
    var nomeCampo_preciofull = "preciofull";
    var var_preciofull = scAjaxGetFieldText(nomeCampo_preciofull);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_precioscompra_mob_validate_preciofull(var_preciofull, var_script_case_init, do_ajax_form_producto_precioscompra_mob_validate_preciofull_cb);
  } // do_ajax_form_producto_precioscompra_mob_validate_preciofull

  function do_ajax_form_producto_precioscompra_mob_validate_preciofull_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_precioscompra_mob_validate_preciofull_cb

  // ---------- Validate precio_editable
  function do_ajax_form_producto_precioscompra_mob_validate_precio_editable()
  {
    var nomeCampo_precio_editable = "precio_editable";
    var var_precio_editable = scAjaxGetFieldText(nomeCampo_precio_editable);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_precioscompra_mob_validate_precio_editable(var_precio_editable, var_script_case_init, do_ajax_form_producto_precioscompra_mob_validate_precio_editable_cb);
  } // do_ajax_form_producto_precioscompra_mob_validate_precio_editable

  function do_ajax_form_producto_precioscompra_mob_validate_precio_editable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_precioscompra_mob_validate_precio_editable_cb

  // ---------- Validate fecha_vencimiento
  function do_ajax_form_producto_precioscompra_mob_validate_fecha_vencimiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_precioscompra_mob_validate_fecha_vencimiento(var_fecha_vencimiento, var_script_case_init, do_ajax_form_producto_precioscompra_mob_validate_fecha_vencimiento_cb);
  } // do_ajax_form_producto_precioscompra_mob_validate_fecha_vencimiento

  function do_ajax_form_producto_precioscompra_mob_validate_fecha_vencimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_precioscompra_mob_validate_fecha_vencimiento_cb

  // ---------- Validate lote
  function do_ajax_form_producto_precioscompra_mob_validate_lote()
  {
    var nomeCampo_lote = "lote";
    var var_lote = scAjaxGetFieldSelect(nomeCampo_lote);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_precioscompra_mob_validate_lote(var_lote, var_script_case_init, do_ajax_form_producto_precioscompra_mob_validate_lote_cb);
  } // do_ajax_form_producto_precioscompra_mob_validate_lote

  function do_ajax_form_producto_precioscompra_mob_validate_lote_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lote";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_precioscompra_mob_validate_lote_cb

  // ---------- Validate serial_codbarras
  function do_ajax_form_producto_precioscompra_mob_validate_serial_codbarras()
  {
    var nomeCampo_serial_codbarras = "serial_codbarras";
    var var_serial_codbarras = scAjaxGetFieldSelect(nomeCampo_serial_codbarras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_precioscompra_mob_validate_serial_codbarras(var_serial_codbarras, var_script_case_init, do_ajax_form_producto_precioscompra_mob_validate_serial_codbarras_cb);
  } // do_ajax_form_producto_precioscompra_mob_validate_serial_codbarras

  function do_ajax_form_producto_precioscompra_mob_validate_serial_codbarras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_precioscompra_mob_validate_serial_codbarras_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_producto_precioscompra_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_producto_precioscompra_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_idprod = scAjaxGetFieldText("idprod");
    ...
    scAjaxProcOn();
    x_ajax_form_producto_precioscompra_mob_submit_form(var_codigobar, var_codigoprod, var_nompro, var_preciomen, var_preciomen2, var_preciomen3, var_precio2, var_preciomay, var_preciofull, var_precio_editable, var_fecha_vencimiento, var_lote, var_serial_codbarras, var_idprod, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_producto_precioscompra_mob_submit_form_cb);
  } // do_ajax_form_producto_precioscompra_mob_submit_form

  function do_ajax_form_producto_precioscompra_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_producto_precioscompra_mob_submit_form_cb_after_alert);
  } // do_ajax_form_producto_precioscompra_mob_submit_form_cb
  function do_ajax_form_producto_precioscompra_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_producto_precioscompra_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_producto_precioscompra_mob_navigate_form()
  {
    perform_ajax_form_producto_precioscompra_mob_navigate_form();
  }

  function perform_ajax_form_producto_precioscompra_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_producto_precioscompra_mob_navigate_form(var_idprod, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_producto_precioscompra_mob_navigate_form_cb);
  } // do_ajax_form_producto_precioscompra_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_producto_precioscompra_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_producto_precioscompra_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_producto_precioscompra_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_producto_precioscompra_mob_navigate_form_cb
  function do_ajax_form_producto_precioscompra_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_producto_precioscompra_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_producto_precioscompra_mob_navigate_form_cb_after_alert
  function sc_hide_form_producto_precioscompra_mob_form()
  {
